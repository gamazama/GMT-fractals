...
| **Mandelbulb3D importer** — `.m3p`/text parse, hybrid weave, x87 `[CODE]` decompiler + cross-check, fused FractalDefinition | [`plans/mb3d/converter-design.md`](./plans/mb3d/converter-design.md) + `engine-gmt/utils/mb3d/*` | ADR-0083 |
