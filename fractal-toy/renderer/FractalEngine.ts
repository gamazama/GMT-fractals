...
export class FractalEngine {
    ...
    constructor(public readonly canvas: HTMLCanvasElement, options: FractalEngineOptions = {}) {
        // preserveDrawingBuffer: true keeps the back buffer across swaps.
        // Required for PNG export (SceneIO reads pixels on demand) and for
        // Playwright smoke tests to readPixels without racing RAF.
