...
This rotation is bound to 'ParamC' (Slider below). Try dragging it!`},{id:"rot-1",type:"Rotate",enabled:!0,params:{x:0,y:0,z:0},bindings:{z:"ParamC"}},{id:"bulb-1",type:"Mandelbulb",enabled:!0,params:{power:8}},{id:"add-c",type:"AddConstant",enabled:!0,params:{scale:1}}],Ra=(e,o)=>({pipeline:Kt,pipelineRevision:1,graph:qt(Kt),setGraph:t=>{const a=Ut(t.nodes,t.edges),r=o(),i=!Co(r.pipeline,a),n=i||!wa(r.pipeline,a);if(i&&r.autoCompile){const l=r.pipelineRevision+1;e({graph:t,pipeline:a,pipelineRevision:l}),R.emit(oe.CONFIG,{pipeline:a,graph:t,pipelineRevision:l})}else i?e({graph:t}):n?(e({graph:t,pipeline:a}),R.emit(oe.CONFIG,{pipeline:a})):e({graph:t})},setPipeline:t=>{const a=o().pipelineRevision+1,r=qt(t);e({pipeline:t,graph:r,pipelineRevision:a}),R.emit(oe.CONFIG,{pipeline:t,graph:r,pipelineRevision:a})},refreshPipeline:()=>{const t=o(),a=Ut(t.graph.nodes,t.graph.edges),r=t.pipelineRevision+1;e({pipeline:a,pipelineRevision:r}),R.emit(oe.CONFIG,{pipeline:a,graph:t.graph,pipelineRevision:r})}}),Jt=`
...
`,defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:2}},qa={id:"decoupled",label:"Decoupled",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,extraParams:{hybridFoldingValue:{type:"vec3",default:new j(2,2,2),label:"Folding Value",shortId:"hfv",uniform:"uHybridFoldingValue",min:.1,max:5,step:.01,group:"hybrid"}},defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2,hybridFoldingValue:{x:2,y:2,z:2}}},Wa={id:"kali",label:"Kali",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = uHybridKaliConstant - abs(z);
}
`,rotMode:"post",extraParams:{hybridKaliConstant:{type:"vec3",default:new j(1,1,1),label:"Kali Constant",shortId:"hkc",uniform:"uHybridKaliConstant",min:-3,max:3,step:.01,group:"hybrid"}},defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.6,hybridFixedR:1,hybridIter:3,hybridKaliConstant:{x:.5,y:.5,z:.5}}},Xa={id:"tetra",label:"Tetrahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    if (z.x + z.y < 0.0) z.xy = -z.yx;
    if (z.x + z.z < 0.0) z.xz = -z.zx;
    if (z.y + z.z < 0.0) z.yz = -z.zy;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.25,hybridFixedR:1,hybridIter:3}},Ya={id:"octa",label:"Octahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},Ka={id:"icosa",label:"Icosahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:4}},Ja={id:"menger",label:"Menger (Cubic)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,selfContained:!0,extraParams:{hybridMengerOffset:{type:"vec3",default:new j(1,1,1),label:"Offset",shortId:"hmo",uniform:"uHybridMengerOffset",min:0,max:2,step:.01,group:"hybrid",linkable:!0},hybridMengerCenterZ:{type:"boolean",default:!0,label:"Center Z",shortId:"hmz",uniform:"uHybridMengerCenterZ",group:"hybrid"}},defaults:{hybridScale:3,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3,hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0}},dt=[Va,Ga,Ua,qa,Wa,Xa,Ya,Ka,Ja],Za=dt.map((e,o)=>({label:e.label,value:o}));function Qa(e){return dt[e]??dt[0]}const er=`
...
`,tr=["xyz","xzy","yxz","yzx","zxy","zyx"];function or(e){const o=tr[e]??"xyz";return o==="xyz"?"vec3 c_perm = c.xyz;":`vec3 c_perm = c.${o};`}function ar(e,o,t=!1){return`
mat3 hybridRotMat;
bool hybridHasRot;
...
`,l+=`
                ...
                `}e.addHybridFold("",n,l)}},Qt=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF"],eo=["uVec2A","uVec2B","uVec2C"],to=["uVec3A","uVec3B","uVec3C"],oo=["uVec4A","uVec4B","uVec4C"],Ro=["uInterlaceParamA","uInterlaceParamB","uInterlaceParamC","uInterlaceParamD","uInterlaceParamE","uInterlaceParamF"],Lo=["uInterlaceVec2A","uInterlaceVec2B","uInterlaceVec2C"],Po=["uInterlaceVec3A","uInterlaceVec3B","uInterlaceVec3C"],To=["uInterlaceVec4A","uInterlaceVec4B","uInterlaceVec4C"];function nr(){const e=[];for(let o=0;o<Qt.length;o++)e.push([new RegExp(`\\b${Qt[o]}\\b`,"g"),Ro[o]]);for(let o=0;o<eo.length;o++)e.push([new RegExp(`\\b${eo[o]}\\b`,"g"),Lo[o]]);for(let o=0;o<to.length;o++)e.push([new RegExp(`\\b${to[o]}\\b`,"g"),Po[o]]);for(let o=0;o<oo.length;o++)e.push([new RegExp(`\\b${oo[o]}\\b`,"g"),To[o]]);return e}const sr=nr();function Pt(e){let o=e;for(const[t,a]of sr)o=o.replace(t,a);return o}function Tt(e,o){const t=[...o].sort((r,i)=>i.length-r.length);let a=e;for(const r of t)a=a.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return a}function lr(e,o,t){let a=e;return a=a.replace(new RegExp(`\\b${o}_\\w+\\b`,"g"),r=>`interlace_${r}`),t&&t.length>0&&(a=Tt(a,t)),a=Pt(a),a}function cr(e,o,t){let a=e;return a=a.replace(new RegExp(`\\bformula_${o}\\b`,"g"),"formula_Interlace"),a=Pt(a),t&&t.length>0&&(a=Tt(a,t)),a}function dr(e,o){return e.replace(new RegExp(`\\bformula_${o}\\b`,"g"),"formula_Interlace")}function ur(e,o,t){let a=e;return a=a.replace(new RegExp(`\\b${o}_\\w+\\b`,"g"),r=>`interlace_${r}`),a=Pt(a),t&&t.length>0&&(a=Tt(a,t)),a}function fr(e,o,t){let a="";o&&(a=`
...
`});U.register({id:"Custom",label:"Custom (Legacy)",category:"Utils",description:"Legacy node.",inputs:[],glsl:e=>""});const vr=e=>{const o=new Map;return e.forEach(t=>{o.has(t.target)||o.set(t.target,[]),o.get(t.target).push(t)}),o},xr=e=>{const o=new Set,t=["root-end"],a=new Set;for(;t.length>0;){const r=t.pop();a.has(r)||(a.add(r),r!=="root-end"&&r!=="root-start"&&o.add(r),(e.get(r)??[]).forEach(i=>t.push(i.source)))}return o},Sr=(e,o)=>{const t=vr(o),a=xr(t),r=e.filter(u=>a.has(u.id));if(!r||r.length===0)return`
    ...
    `;const n=new Map;n.set("root-start","v_start");let l=0;r.forEach((u,h)=>{const p=`v_${u.id.replace(/[^a-zA-Z0-9]/g,"")}`;n.set(u.id,p);const g=t.get(u.id)??[],b=g.find(w=>!w.targetHandle||w.targetHandle==="a"),m=g.find(w=>w.targetHandle==="b"),y=b&&n.get(b.source)||"v_start",v=m&&n.get(m.source)||"v_start";if(i+=`    // Node: ${u.type} (${u.id})
`,i+=`    vec3 ${p}_p = ${y}_p;
`,i+=`    float ${p}_d = ${y}_d;
`,i+=`    float ${p}_dr = ${y}_dr;
`,u.enabled){const w=U.get(u.type);if(w){const k=u.condition&&u.condition.active;let S="    ";if(k){const L=l<Ge?`uModularParams[${l++}]`:"2.0",T=l<Ge?`uModularParams[${l++}]`:"0.0";i+=`    { int ${p}_cmod = max(1, int(${L})); int ${p}_crem = int(${T});
`,i+=`    if ( (i - (i/${p}_cmod)*${p}_cmod) == ${p}_crem ) {
`,S="        "}const C=L=>u.bindings&&u.bindings[L]?`u${u.bindings[L]}`:l<Ge?`uModularParams[${l++}]`:"0.0";i+=w.glsl({varName:p,in1:y,in2:v,getParam:C,indent:S}),k&&(i+=`    }}
`)}}i+=`
...
`},wr=e=>{let o="d = 0.5 * log(max(r, 1.0e-5)) * r / dr_safe;";return e<.5?o=`
        float logR2 = log2(m2);
        ...
        }`},_r={id:"coreMath",shortId:"cm",name:"Formula Math",category:"Formulas",tabConfig:{label:"Formula",componentId:"panel-formula",order:10},extraUniforms:[{name:ue.ModularParams,type:"float",arraySize:Ge,default:new Float32Array(Ge),backingOnly:!0}],params:{iterations:{type:"float",default:16,label:"Iterations",shortId:"it",uniform:"uIterations",min:1,max:500,step:1,group:"main"},paramA:{type:"float",default:8,label:"Param A",shortId:"pa",uniform:"uParamA",min:-10,max:10,step:.001,group:"params"},paramB:{type:"float",default:0,label:"Param B",shortId:"pb",uniform:"uParamB",min:-10,max:10,step:.001,group:"params"},paramC:{type:"float",default:0,label:"Param C",shortId:"pc",uniform:"uParamC",min:-10,max:10,step:.001,group:"params"},paramD:{type:"float",default:0,label:"Param D",shortId:"pd",uniform:"uParamD",min:-10,max:10,step:.001,group:"params"},paramE:{type:"float",default:0,label:"Param E",shortId:"pe",uniform:"uParamE",min:-10,max:10,step:.001,group:"params"},paramF:{type:"float",default:0,label:"Param F",shortId:"pf",uniform:"uParamF",min:-10,max:10,step:.001,group:"params"},vec2A:{type:"vec2",default:{x:0,y:0},label:"Vec2 A",shortId:"v2a",uniform:"uVec2A",min:-10,max:10,step:.001,group:"params"},vec2B:{type:"vec2",default:{x:0,y:0},label:"Vec2 B",shortId:"v2b",uniform:"uVec2B",min:-10,max:10,step:.001,group:"params"},vec2C:{type:"vec2",default:{x:0,y:0},label:"Vec2 C",shortId:"v2c",uniform:"uVec2C",min:-10,max:10,step:.001,group:"params"},vec3A:{type:"vec3",default:new j(0,0,0),label:"Vec3 A",shortId:"v3a",uniform:"uVec3A",min:-10,max:10,step:.001,group:"params"},vec3B:{type:"vec3",default:new j(0,0,0),label:"Vec3 B",shortId:"v3b",uniform:"uVec3B",min:-10,max:10,step:.001,group:"params"},vec3C:{type:"vec3",default:new j(0,0,0),label:"Vec3 C",shortId:"v3c",uniform:"uVec3C",min:-10,max:10,step:.001,group:"params"},vec4A:{type:"vec4",default:new ht(0,0,0,0),label:"Vec4 A",shortId:"v4a",uniform:"uVec4A",min:-10,max:10,step:.001,group:"params"},vec4B:{type:"vec4",default:new ht(0,0,0,0),label:"Vec4 B",shortId:"v4b",uniform:"uVec4B",min:-10,max:10,step:.001,group:"params"},vec4C:{type:"vec4",default:new ht(0,0,0,0),label:"Vec4 C",shortId:"v4c",uniform:"uVec4C",min:-10,max:10,step:.001,group:"params"}},inject:(e,o)=>{var u;const t=o.formula,a=o.quality;t==="Modular"&&(e.addDefine("PIPELINE_REV",(o.pipelineRevision||0).toString()),e.addUniform(ue.ModularParams,"float",Ge)),["JuliaMorph","MandelTerrain"].includes(t)&&e.addDefine("SKIP_PRE_BAILOUT","1");const r=he.get(t);let i="",n="",l="";const s=(a==null?void 0:a.estimator)||0;let c=wr(s);if(t==="Modular"){const h=Sr(o.pipeline||[],((u=o.graph)==null?void 0:u.edges)||[]);i+=h+`
...
`,n=r.shader.loopBody,l=r.shader.loopInit||"",r.shader.preamble&&e.addPreamble(r.shader.preamble),r.shader.getDist&&(c=`vec2 getDist(float r, float dr, float iter, vec4 z) { ${r.shader.getDist} }`));e.addFunction(i),e.setFormula(n,l,c)}};let Ir=0;function Ue(){return`l${++Ir}`}const Cr=(e,o)=>{if(!e)return`
...
`,ri=`
    ...
    col += fogScatter;
`,ii={id:"volumetric",shortId:"vol",name:"Volumetric Scatter",category:"Rendering",engineConfig:{toggleParam:"ptVolumetric",mode:"compile",label:"Volumetric Scattering",description:"Henyey-Greenstein single scatter. Enables god rays, colored haze, and directional fog.",groupFilter:"engine_settings"},panelConfig:{compileParam:"ptVolumetric",runtimeToggleParam:"volEnabled",label:"Volumetric Scatter",compileMessage:"Compiling Volumetric Shader...",helpId:"render.volumetric"},groups:{density:{label:"Density & Shadow Rays",collapsible:!0},emissive:{label:"Color Scatter",collapsible:!0},height:{label:"Height Fog",collapsible:!0}},params:{ptVolumetric:{type:"boolean",default:!1,label:"Volume Scatter",shortId:"pvs",group:"engine_settings",noReset:!0,onUpdate:"compile",estCompileMs:5500},volEnabled:{type:"boolean",default:!1,label:"Enabled",shortId:"ven",uniform:"uVolEnabled",hidden:!0},volDensity:{type:"float",default:.01,label:"Density",shortId:"vd",uniform:"uVolDensity",min:.001,max:5,step:.01,scale:"log",group:"density",condition:{param:"ptVolumetric",bool:!0}},volAnisotropy:{type:"float",default:.3,label:"Anisotropy (g)",shortId:"va",uniform:"uVolAnisotropy",min:-.99,max:.99,step:.01,group:"density",parentId:"volDensity",condition:{gt:0},description:"0=isotropic, +0.9=forward (god rays), -0.9=back scatter."},volMaxLights:{type:"float",default:1,label:"Light Sources",shortId:"vml",uniform:"uVolMaxLights",min:1,max:3,step:1,group:"density",parentId:"volDensity",condition:{gt:0},isAdvanced:!0,description:"Max lights for shadow rays. More = more expensive."},volScatterTint:{type:"color",default:new le(1,1,1),label:"Scatter Tint",shortId:"vst",uniform:"uVolScatterTint",group:"density",parentId:"volDensity",condition:{gt:0}},volEmissive:{type:"float",default:0,label:"Color Scatter",shortId:"ves",uniform:"uVolEmissive",min:0,max:100,step:.1,scale:"log",group:"emissive",condition:{param:"ptVolumetric",bool:!0},description:"Orbit trap color field scattered through the volume. No shadow rays needed."},volStepJitter:{type:"float",default:1,label:"Step Jitter",shortId:"vsj",uniform:"uVolStepJitter",min:0,max:1,step:.01,group:"density",parentId:"volDensity",condition:{gt:0},description:"1 = smooth (temporal accumulation removes noise). 0 = fixed slicing pattern (artistic, broken fog look)."},volEmissiveFalloff:{type:"float",default:0,label:"Surface Falloff",shortId:"vef",uniform:"uVolEmissiveFalloff",min:0,max:5,step:.01,scale:"log",group:"emissive",parentId:"volEmissive",condition:{gt:0},description:"Concentrate color near fractal surface."},volHeightFalloff:{type:"float",default:0,label:"Height Falloff",shortId:"vhf",uniform:"uVolHeightFalloff",min:0,max:5,step:.01,scale:"log",group:"height",condition:{param:"ptVolumetric",bool:!0},description:"Density varies with Y. Creates ground fog, rising mist."},volHeightOrigin:{type:"float",default:0,label:"Height Origin",shortId:"vho",uniform:"uVolHeightOrigin",min:-5,max:5,step:.01,group:"height",parentId:"volHeightFalloff",condition:{gt:0}}},inject:(e,o,t)=>{if(t!=="Main")return;const a=o.volumetric;a!=null&&a.ptVolumetric&&(e.addDefine("PT_VOLUMETRIC","1"),e.addVolumeTracing(ai,""),e.addPostProcessLogic(ri))}},ni=()=>{N.register(_r),N.register(ir),N.register(gr),N.register(Ar),N.register(Dr),N.register(qr),N.register(Kr),N.register(Ea),N.register(ii),N.register(ja),N.register(ti),N.register(Ha),N.register($a),N.register(yr),N.register(za),N.register(Aa),N.register(Na),N.register(Fr),N.register(Or),N.register(oi),N.register(jr),N.register(Nr),N.register($r),N.register(Br),N.register(Hr),N.register(Gr)},Ve=e=>{const o=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return o?{r:parseInt(o[1],16),g:parseInt(o[2],16),b:parseInt(o[3],16)}:null},Fo=(e,o,t)=>(typeof e=="object"&&(o=e.g,t=e.b,e=e.r),"#"+((1<<24)+(Math.round(e)<<16)+(Math.round(o)<<8)+Math.round(t)).toString(16).slice(1).toUpperCase()),ut=({r:e,g:o,b:t})=>{e/=255,o/=255,t/=255;const a=Math.max(e,o,t),r=Math.min(e,o,t);let i=0,n=0,l=a;const s=a-r;if(n=a===0?0:s/a,a!==r){switch(a){case e:i=(o-t)/s+(o<t?6:0);break;case o:i=(t-e)/s+2;break;case t:i=(e-o)/s+4;break}i/=6}return{h:i*360,s:n*100,v:l*100}},Oo=(e,o,t)=>{e/=360,o/=100,t/=100;let a=0,r=0,i=0;const n=Math.floor(e*6),l=e*6-n,s=t*(1-o),c=t*(1-l*o),u=t*(1-(1-l)*o);switch(n%6){case 0:a=t,r=u,i=s;break;case 1:a=c,r=t,i=s;break;case 2:a=s,r=t,i=u;break;case 3:a=s,r=c,i=t;break;case 4:a=u,r=s,i=t;break;case 5:a=t,r=s,i=c;break}return{r:a*255,g:r*255,b:i*255}},si=(e,o,t)=>({r:e.r+(o.r-e.r)*t,g:e.g+(o.g-e.g)*t,b:e.b+(o.b-e.b)*t}),li=(e,o,t)=>{const a=ut(e),r=ut(o);let i=r.h-a.h;i>180&&(i-=360),i<-180&&(i+=360);const n=((a.h+i*t)%360+360)%360,l=a.s+(r.s-a.s)*t,s=a.v+(r.v-a.v)*t;return Oo(n,l,s)},ci=(e,o,t)=>{const a=ut(e),r=ut(o);let i=r.h-a.h;i>=0&&i<=180&&(i-=360),i<0&&i>=-180&&(i+=360);const n=((a.h+i*t)%360+360)%360,l=a.s+(r.s-a.s)*t,s=a.v+(r.v-a.v)*t;return Oo(n,l,s)},st=e=>{const o=e/255;return o<=.04045?o/12.92:Math.pow((o+.055)/1.055,2.4)},yt=e=>{const o=Math.max(0,Math.min(1,e));return(o<=.0031308?o*12.92:1.055*Math.pow(o,1/2.4)-.055)*255},so=e=>{const o=st(e.r),t=st(e.g),a=st(e.b),r=Math.cbrt(.4122214708*o+.5363325363*t+.0514459929*a),i=Math.cbrt(.2119034982*o+.6806995451*t+.1073969566*a),n=Math.cbrt(.0883024619*o+.2817188376*t+.6299787005*a);return{L:.2104542553*r+.793617785*i-.0040720468*n,a:1.9779984951*r-2.428592205*i+.4505937099*n,b:.0259040371*r+.7827717662*i-.808675766*n}},lo=e=>{const o=e.L+.3963377774*e.a+.2158037573*e.b,t=e.L-.1055613458*e.a-.0638541728*e.b,a=e.L-.0894841775*e.a-1.291485548*e.b,r=o*o*o,i=t*t*t,n=a*a*a;return{r:yt(4.0767416621*r-3.3077115913*i+.2309699292*n),g:yt(-1.2684380046*r+2.6097574011*i-.3413193965*n),b:yt(-.0041960863*r-.7034186147*i+1.707614701*n)}},di=(e,o,t)=>{const a=so(e),r=so(o),i=Math.sqrt(a.a*a.a+a.b*a.b),n=Math.sqrt(r.a*r.a+r.b*r.b);if(i<.005||n<.005)return lo({L:a.L+(r.L-a.L)*t,a:a.a+(r.a-a.a)*t,b:a.b+(r.b-a.b)*t});const l=Math.atan2(a.b,a.a);let c=Math.atan2(r.b,r.a)-l;c>Math.PI&&(c-=2*Math.PI),c<-Math.PI&&(c+=2*Math.PI);const u=l+c*t,h=i+(n-i)*t,f=a.L+(r.L-a.L)*t;return lo({L:f,a:h*Math.cos(u),b:h*Math.sin(u)})},jo=(e,o,t,a)=>{switch(a){case"hsv":return li(e,o,t);case"hsv-far":return ci(e,o,t);case"oklab":return di(e,o,t);default:return si(e,o,t)}},No=(e,o)=>{if(Math.abs(o-.5)<.001)return e;const t=Math.max(.001,Math.min(.999,o)),a=Math.log(.5)/Math.log(t);return Math.pow(e,a)},kn=(e,o=1)=>{let t,a="rgb";if(!e)return"linear-gradient(90deg, #000 0%, #fff 100%)";if(Array.isArray(e))t=e;else if(e&&Array.isArray(e.stops))t=e.stops,a=e.blendSpace||"oklab";else return"linear-gradient(90deg, #000 0%, #fff 100%)";if(!t||t.length===0)return"linear-gradient(90deg, #000 0%, #fff 100%)";const r=[...t].sort((l,s)=>l.position-s.position),i=a!=="rgb",n=[];for(let l=0;l<r.length;l++){const s=r[l];let c=Math.pow(s.position,1/o);if(c=Math.max(0,Math.min(1,c))*100,n.push(`${s.color} ${c.toFixed(2)}%`),l<r.length-1){const u=r[l+1],h=s.bias??.5,f=s.interpolation||"linear";if(f==="step"){let p=Math.pow(u.position,1/o);p=Math.max(0,Math.min(1,p))*100,n.push(`${s.color} ${p.toFixed(2)}%`),n.push(`${u.color} ${p.toFixed(2)}%`)}else if(i){const p=Ve(s.color)||{r:0,g:0,b:0},g=Ve(u.color)||{r:0,g:0,b:0},b=12;for(let m=1;m<b;m++){let y=m/b;Math.abs(h-.5)>.001&&(y=No(y,h)),(f==="smooth"||f==="cubic")&&(y=y*y*(3-2*y));const v=jo(p,g,y,a),w=s.position+(u.position-s.position)*(m/b);let k=Math.pow(w,1/o)*100;k=Math.max(0,Math.min(100,k)),n.push(`${Fo(v)} ${k.toFixed(2)}%`)}}else if(Math.abs(h-.5)>.001){const p=s.position+(u.position-s.position)*h;let g=Math.pow(p,1/o)*100;g=Math.max(0,Math.min(100,g)),n.push(`${g.toFixed(2)}%`)}}}return`linear-gradient(90deg, ${n.join(", ")})`},bt=e=>st(e)*255,vt=e=>{const o=e/255;if(o>=.99)return 255;const t=(Math.sqrt(-10127*o*o+13702*o+9)+59*o-3)/(502-486*o);return Math.max(0,t)*255},co=e=>{const t=new Uint8Array(1024);let a,r="srgb",i="oklab";if(Array.isArray(e))a=e;else if(e&&Array.isArray(e.stops))a=e.stops,r=e.colorSpace||"srgb",i=e.blendSpace||"oklab";else return t;if(a.length===0){for(let s=0;s<256;s++){const c=Math.floor(s/255*255);t[s*4]=c,t[s*4+1]=c,t[s*4+2]=c,t[s*4+3]=255}return t}const n=[...a].sort((s,c)=>s.position-c.position),l=s=>{let c={r:0,g:0,b:0};if(s<=n[0].position)c=Ve(n[0].color)||{r:0,g:0,b:0};else if(s>=n[n.length-1].position)c=Ve(n[n.length-1].color)||{r:0,g:0,b:0};else for(let u=0;u<n.length-1;u++)if(s>=n[u].position&&s<=n[u+1].position){const h=n[u],f=n[u+1];let p=(s-h.position)/(f.position-h.position);const g=h.bias??.5;Math.abs(g-.5)>.001&&(p=No(p,g));const b=h.interpolation||"linear";b==="step"?p=0:(b==="smooth"||b==="cubic")&&(p=p*p*(3-2*p));const m=Ve(h.color)||{r:0,g:0,b:0},y=Ve(f.color)||{r:0,g:0,b:0};c=jo(m,y,p,i);break}return r==="linear"?{r:bt(c.r),g:bt(c.g),b:bt(c.b)}:r==="aces_inverse"?{r:vt(c.r),g:vt(c.g),b:vt(c.b)}:c};for(let s=0;s<256;s++){const c=s/255,u=l(c);t[s*4]=u.r,t[s*4+1]=u.g,t[s*4+2]=u.b,t[s*4+3]=255}return t},ui=e=>{const o=Math.max(1e3,Math.min(4e4,e))/100;let t,a,r;return o<=66?t=255:(t=o-60,t=329.698727446*Math.pow(t,-.1332047592),t=Math.max(0,Math.min(255,t))),o<=66?(a=o,a=99.4708025861*Math.log(a)-161.1195681661,a=Math.max(0,Math.min(255,a))):(a=o-60,a=288.1221695283*Math.pow(a,-.0755148492),a=Math.max(0,Math.min(255,a))),o>=66?r=255:o<=19?r=0:(r=o-10,r=138.5177312231*Math.log(r)-305.0447927307,r=Math.max(0,Math.min(255,r))),{r:Math.round(t),g:Math.round(a),b:Math.round(r)}},zn=e=>{const{r:o,g:t,b:a}=ui(e);return Fo(o,t,a)},fi=(e,o)=>{const t={};return ni(),N.getAll().forEach(r=>{const i={},n={};r.state&&Object.assign(i,r.state),Object.entries(r.params).forEach(([s,c])=>{c.composeFrom?c.composeFrom.forEach(u=>{n[u]=s}):i[s]===void 0&&(i[s]=c.default)}),t[r.id]=i;const l=`set${r.id.charAt(0).toUpperCase()+r.id.slice(1)}`;t[l]=s=>{let c=!1;const u={};e(h=>{const f=h[r.id],p={...s};Object.keys(s).forEach(m=>{const y=r.params[m];if(y){const v=s[m];if(v==null)return;y.type==="vec2"&&!(v instanceof ve)&&(p[m]=new ve(v.x,v.y)),y.type==="vec3"&&!(v instanceof j)&&(p[m]=new j(v.x,v.y,v.z)),y.type==="color"&&!(v instanceof le)&&(typeof v=="string"?p[m]=new le(v):typeof v=="number"?p[m]=new le(v):typeof v=="object"&&"r"in v&&(p[m]=new le(v.r,v.g,v.b)))}}),Object.keys(p).forEach(m=>{const y=r.params[m];if(y!=null&&y.onSet){const v=y.onSet(p[m],f);v&&Object.entries(v).forEach(([w,k])=>{s[w]===void 0&&(p[w]=k)})}});const g={...f,...p},b=new Set;return Object.keys(p).forEach(m=>{const y=r.params[m];if(n[m]&&b.add(n[m]),y&&(y.noReset||(c=!0),y.type!=="image"&&(u[r.id]||(u[r.id]={}),u[r.id][m]=g[m]),y.uniform)){const v=g[m];if(y.type==="image"){const w=y.uniform.toLowerCase().includes("env")?"env":"color";v&&typeof v=="string"?(R.emit("texture",{textureType:w,dataUrl:v}),m==="envMapData"&&g.useEnvMap===!1&&(g.useEnvMap=!0,R.emit("uniform",{key:"uUseEnvMap",value:1,noReset:!1})),m==="layer1Data"&&g.active===!1&&(g.active=!0,R.emit("uniform",{key:"uUseTexture",value:1,noReset:!1}))):(R.emit("texture",{textureType:w,dataUrl:null}),m==="envMapData"&&g.useEnvMap===!0&&(g.useEnvMap=!1,R.emit("uniform",{key:"uUseEnvMap",value:0,noReset:!1})),m==="layer1Data"&&g.active===!0&&(g.active=!1,R.emit("uniform",{key:"uUseTexture",value:0,noReset:!1})))}else if(y.type==="gradient"){const w=co(v);R.emit("uniform",{key:y.uniform,value:{isGradientBuffer:!0,buffer:w},noReset:!!y.noReset})}else{let w=v;y.type==="boolean"&&(w=v?1:0),y.type==="color"&&!(w instanceof le)&&(w=new le(w)),R.emit("uniform",{key:y.uniform,value:w,noReset:!!y.noReset})}}}),b.forEach(m=>{const y=r.params[m];if(y&&y.composeFrom&&y.uniform){const v=y.composeFrom.map(w=>g[w]);if(y.type==="gradient"){const w=g[m];if(w){const k=co(w);R.emit("uniform",{key:y.uniform,value:{isGradientBuffer:!0,buffer:k},noReset:!!y.noReset}),y.noReset||(c=!0)}}else if(y.type==="vec2"){const w=new ve(v[0],v[1]);R.emit("uniform",{key:y.uniform,value:w,noReset:!!y.noReset}),y.noReset||(c=!0)}else if(y.type==="vec3"){const w=new j(v[0],v[1],v[2]);R.emit("uniform",{key:y.uniform,value:w,noReset:!!y.noReset}),y.noReset||(c=!0)}}}),{[r.id]:g}}),Object.keys(u).length>0&&R.emit("config",u),c&&R.emit("reset_accum",void 0)},r.actions&&Object.entries(r.actions).forEach(([s,c])=>{t[s]=u=>{const f=o()[r.id],p=c(f,u);p&&Object.keys(p).length>0&&(e({[r.id]:{...f,...p}}),R.emit("reset_accum",void 0))}})}),t},pi={id:"shadows",label:"Shadows",renderContext:"direct",controlledParams:["lighting.shadowsCompile","lighting.shadowAlgorithm","lighting.ptStochasticShadows"],tiers:[{label:"Off",overrides:{lighting:{shadows:!1,shadowsCompile:!1,ptStochasticShadows:!1}},estCompileMs:0},{label:"Hard",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:2,ptStochasticShadows:!1}},estCompileMs:500},{label:"Soft",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!1}},estCompileMs:3e3},{label:"Full",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!0}},estCompileMs:3800}]},hi={id:"reflections",label:"Reflections (Direct)",renderContext:"direct",controlledParams:["reflections.reflectionMode","reflections.bounceShadows","reflections.bounces"],tiers:[{label:"Off",overrides:{reflections:{reflectionMode:0,bounceShadows:!1}},estCompileMs:0},{label:"Env Map",overrides:{reflections:{reflectionMode:1,bounceShadows:!1}},estCompileMs:0},{label:"Raymarched",overrides:{reflections:{reflectionMode:3,bounceShadows:!1,bounces:1}},estCompileMs:7500},{label:"Full",overrides:{reflections:{reflectionMode:3,bounceShadows:!0,bounces:2}},estCompileMs:12e3}]},mi={id:"lighting_quality",label:"Lighting",isAdvanced:!0,controlledParams:["lighting.specularModel","lighting.ptEnabled","lighting.ptNEEAllLights","lighting.ptEnvNEE"],tiers:[{label:"Preview",overrides:{lighting:{advancedLighting:!1,ptEnabled:!1}},estCompileMs:-2500},{label:"Path Traced",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!1,ptEnvNEE:!1}},estCompileMs:1900},{label:"PT + NEE",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!0,ptEnvNEE:!0}},estCompileMs:2500}]},gi={id:"atmosphere_quality",label:"Atmosphere",controlledParams:["atmosphere.glowEnabled","atmosphere.glowQuality","volumetric.ptVolumetric"],tiers:[{label:"Off",overrides:{atmosphere:{glowEnabled:!1},volumetric:{ptVolumetric:!1}},estCompileMs:0},{label:"Fast Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:1},volumetric:{ptVolumetric:!1}},estCompileMs:200},{label:"Color Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!1}},estCompileMs:400},{label:"Volumetric",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!0}},estCompileMs:5900}]},Et=[pi,hi,mi,gi],ot=[{id:"preview",label:"Preview",description:"Instant preview shader — navigate without waiting for compile.",subsystems:{shadows:0,reflections:0,lighting_quality:0,atmosphere_quality:0}},{id:"fastest",label:"Fastest",description:"Path traced lighting with fast glow.",subsystems:{shadows:0,reflections:0,lighting_quality:1,atmosphere_quality:1}},{id:"lite",label:"Lite",description:"Hard shadows, env map reflections, color glow.",subsystems:{shadows:1,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"balanced",label:"Balanced",description:"Soft shadows, env map reflections, color glow.",subsystems:{shadows:2,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"full",label:"Full",description:"Full shadows, raymarched reflections, volumetric.",subsystems:{shadows:3,reflections:3,lighting_quality:1,atmosphere_quality:3}},{id:"ultra",label:"Ultra",description:"Full + PT NEE. Experimental.",isAdvanced:!0,subsystems:{shadows:3,reflections:3,lighting_quality:2,atmosphere_quality:3}}],yi={activePreset:"balanced",subsystems:{...ot[3].subsystems},isCustomized:!1};function bi(e){return ot.find(o=>o.id===e)}function vi(e){for(const o of ot)if(Object.keys(o.subsystems).every(a=>o.subsystems[a]===e[a]))return o.id;return null}function An(e){if(!e.activePreset)return"Custom";const o=bi(e.activePreset);if(!o)return"Custom";if(!e.isCustomized)return o.label;const t=[];for(const a of Et){const r=o.subsystems[a.id],i=e.subsystems[a.id];if(r!==i){const n=a.tiers[i];t.push(`${a.label}=${(n==null?void 0:n.label)??"?"}`)}}return`${o.label} (${t.join(", ")})`}const xi=4200;function Dn(e){let o=xi;for(const t of Et){const a=e[t.id]??0,r=t.tiers[a];r&&(o+=r.estCompileMs)}return o}let Ct=null;function Si(e){Ct=e}function uo(e,o){const t=o(),a={};for(const r of Et){const i=e[r.id]??0,n=r.tiers[i];if(n)for(const[l,s]of Object.entries(n.overrides))a[l]||(a[l]={}),Object.assign(a[l],s)}for(const[r,i]of Object.entries(a)){const n=`set${r.charAt(0).toUpperCase()+r.slice(1)}`,l=t[n];typeof l=="function"&&l(i)}}function wi(e){if(!Ct)return;const o=Ct(e());R.emit(oe.CONFIG,o)}const _i=(e,o)=>({scalability:{...yi},hardwareProfile:null,applyScalabilityPreset:t=>{const a=ot.find(r=>r.id===t);a&&(e({scalability:{activePreset:t,subsystems:{...a.subsystems},isCustomized:!1}}),uo(a.subsystems,o))},setSubsystemTier:(t,a)=>{const r=o().scalability,i={...r.subsystems,[t]:a};let n=!1;if(r.activePreset){const s=ot.find(c=>c.id===r.activePreset);s&&(n=Object.keys(i).some(c=>i[c]!==s.subsystems[c]))}else n=!0;const l=vi(i);e({scalability:{activePreset:l??r.activePreset,subsystems:i,isCustomized:l?!1:n}}),uo(i,o)},setHardwareProfile:t=>{e({hardwareProfile:t});const r=o().setQuality;typeof r=="function"&&r({compilerHardCap:t.caps.compilerHardCap,precisionMode:t.caps.precisionMode,bufferPrecision:t.caps.bufferPrecision}),wi(o)}});class Mt{constructor(o,t=null){M(this,"defaultState");M(this,"dictionary");M(this,"reverseDictCache",new Map);this.defaultState=o,this.dictionary=t}encode(o,t){try{const a=this.getDiff(o,this.defaultState);if(!a||Object.keys(a).length===0)return"";let r=this.quantize(a);if(!r||Object.keys(r).length===0)return"";this.dictionary&&(r=this.applyDictionary(r,this.dictionary,!0));const i=JSON.stringify(r),n=$t.deflate(i),l=Array.from(n).map(c=>String.fromCharCode(c)).join("");return btoa(l).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}catch(a){return console.error("UrlStateEncoder: Error encoding",a),""}}decode(o){try{if(!o)return null;let t=o.replace(/-/g,"+").replace(/_/g,"/");for(;t.length%4;)t+="=";const a=atob(t),r=new Uint8Array(a.length);for(let l=0;l<a.length;l++)r[l]=a.charCodeAt(l);const i=$t.inflate(r,{to:"string"});let n=JSON.parse(i);return this.dictionary&&(n=this.applyDictionary(n,this.dictionary,!1)),this.deepMerge({...this.defaultState},n)}catch(t){return console.error("UrlStateEncoder: Error decoding",t),null}}getReverseDict(o){if(this.reverseDictCache.has(o))return this.reverseDictCache.get(o);const t={};return Object.keys(o).forEach(a=>{const r=o[a];typeof r=="string"?t[r]=a:t[r._alias]=a}),this.reverseDictCache.set(o,t),t}applyDictionary(o,t,a){if(!o||typeof o!="object"||Array.isArray(o))return o;const r={};if(a)Object.keys(o).forEach(i=>{let n=i,l=null;const s=t[i];s&&(typeof s=="string"?n=s:(n=s._alias,l=s.children));const c=o[i];l&&c&&typeof c=="object"&&!Array.isArray(c)?r[n]=this.applyDictionary(c,l,!0):r[n]=c});else{const i=this.getReverseDict(t);Object.keys(o).forEach(n=>{const l=i[n]||n,s=o[n],c=t[l],u=c&&typeof c=="object"?c.children:null;u&&s&&typeof s=="object"&&!Array.isArray(s)?r[l]=this.applyDictionary(s,u,!1):r[l]=s})}return r}isEqual(o,t){if(o===t)return!0;if(o==null||t==null)return o===t;if(typeof o=="number"&&typeof t=="number")return Math.abs(o-t)<1e-4;if(Array.isArray(o)&&Array.isArray(t))return o.length!==t.length?!1:o.every((a,r)=>this.isEqual(a,t[r]));if(typeof o=="object"&&typeof t=="object"){const a=o,r=t,i=Object.keys(a).filter(l=>!l.startsWith("is")),n=Object.keys(r).filter(l=>!l.startsWith("is"));return i.length!==n.length?!1:i.every(l=>this.isEqual(a[l],r[l]))}return!1}quantize(o){if(typeof o=="string")return o.startsWith("data:image")?void 0:o;if(typeof o=="number")return o===0||Math.abs(o)<1e-9?0:parseFloat(o.toFixed(5));if(Array.isArray(o))return o.map(t=>this.quantize(t));if(o!==null&&typeof o=="object"){const t={};let a=!1;const r=Object.keys(o).filter(i=>!i.startsWith("is"));for(const i of r){const n=this.quantize(o[i]);n!==void 0&&(t[i]=n,a=!0)}return a?t:void 0}return o}getDiff(o,t){if(this.isEqual(o,t))return;if(typeof o!="object"||o===null||typeof t!="object"||t===null||Array.isArray(o))return o;const a={};let r=!1;const i=o,n=t;return Object.keys(i).forEach(l=>{if(l.startsWith("is")||l==="histogramData"||l==="interactionSnapshot"||l==="liveModulations"||l.endsWith("Stack"))return;const s=this.getDiff(i[l],n[l]);s!==void 0&&(a[l]=s,r=!0)}),r?a:void 0}deepMerge(o,t){if(typeof t!="object"||t===null)return t;const a={...o};return Object.keys(t).forEach(r=>{typeof t[r]=="object"&&t[r]!==null&&!Array.isArray(t[r])?a[r]=this.deepMerge(o[r]||{},t[r]):a[r]=t[r]}),a}}const Ii=(e,o)=>({isPlaying:!1,isRecording:!1,isScrubbing:!1,recordCamera:!0,isCameraInteracting:!1,currentFrame:0,fps:30,durationFrames:300,loopMode:"Loop",isArmingModulation:!1,isRecordingModulation:!1,recordingSnapshot:null,play:()=>{const t=o();if(t.currentFrame>=t.durationFrames-.1&&e({currentFrame:0}),t.isArmingModulation){t.snapshot();const a=JSON.parse(JSON.stringify(t.sequence));e({isRecordingModulation:!0,isArmingModulation:!1,recordingSnapshot:a,isPlaying:!0,currentFrame:0})}else e({isPlaying:!0})},pause:()=>e({isPlaying:!1,isRecordingModulation:!1,recordingSnapshot:null}),stop:()=>e({isPlaying:!1,currentFrame:0,isRecordingModulation:!1,recordingSnapshot:null}),toggleRecording:()=>e(t=>({isRecording:!t.isRecording})),toggleRecordCamera:()=>e(t=>({recordCamera:!t.recordCamera})),toggleArmModulation:()=>e(t=>({isArmingModulation:!t.isArmingModulation,isRecording:!1})),stopModulationRecording:()=>e({isRecordingModulation:!1,isPlaying:!1,recordingSnapshot:null}),setLoopMode:t=>e({loopMode:t}),setIsScrubbing:t=>e({isScrubbing:t}),setIsCameraInteracting:t=>e({isCameraInteracting:t}),seek:t=>e({currentFrame:Math.max(0,Math.min(o().durationFrames,t))}),setDuration:t=>{e({durationFrames:t})},setFps:t=>{e({fps:t})}}),Ci=(e,o)=>({selectedTrackIds:[],selectedKeyframeIds:[],softSelectionRadius:0,softSelectionEnabled:!1,softSelectionType:"S-Curve",bounceTension:.5,bounceFriction:.6,selectTrack:(t,a)=>e(r=>({selectedTrackIds:a?r.selectedTrackIds.includes(t)?r.selectedTrackIds.filter(i=>i!==t):[...r.selectedTrackIds,t]:[t]})),selectTracks:(t,a)=>e(r=>{const i=new Set(r.selectedTrackIds);return a?t.forEach(n=>i.add(n)):t.forEach(n=>i.delete(n)),{selectedTrackIds:Array.from(i)}}),selectKeyframe:(t,a,r)=>e(i=>{const n=`${t}::${a}`;return{selectedKeyframeIds:r?i.selectedKeyframeIds.includes(n)?i.selectedKeyframeIds.filter(l=>l!==n):[...i.selectedKeyframeIds,n]:[n]}}),selectKeyframes:(t,a)=>e(r=>({selectedKeyframeIds:a?Array.from(new Set([...r.selectedKeyframeIds,...t])):t})),deselectAll:()=>e({selectedTrackIds:[],selectedKeyframeIds:[]}),deselectAllKeys:()=>e({selectedKeyframeIds:[]}),setSoftSelection:(t,a)=>e({softSelectionRadius:t,softSelectionEnabled:a}),setSoftSelectionType:t=>e({softSelectionType:t}),setBouncePhysics:(t,a)=>e({bounceTension:t,bounceFriction:a})});function $o(e,o,t,a,r){const i=1-e,n=e*e,l=i*i,s=l*i,c=n*e;return s*o+3*l*e*t+3*i*n*a+c*r}function fo(e,o){let t=o[0],a=o[o.length-1];for(let u=0;u<o.length-1;u++)if(e>=o[u].frame&&e<o[u+1].frame){t=o[u],a=o[u+1];break}if(e>=a.frame)return a.value;if(e<=t.frame)return t.value;const r=a.frame-t.frame,i=(e-t.frame)/r;if(t.interpolation==="Step")return t.value;if(t.interpolation==="Linear")return t.value+(a.value-t.value)*i;const n=t.value,l=t.value+(t.rightTangent?t.rightTangent.y:0),s=a.value+(a.leftTangent?a.leftTangent.y:0),c=a.value;return $o(i,n,l,s,c)}function Mi(e,o=1){const t=[],a=e[0].frame,r=e[e.length-1].frame,i=Math.max(o,(r-a)/50);for(let n=a;n<=r;n+=i)t.push({t:n,val:fo(n,e)});return t.length>0&&t[t.length-1].t<r&&t.push({t:r,val:fo(r,e)}),t}function Ri(e,o,t){let a=0,r=0,i=0,n=0,l=0,s=0,c=0;for(let m=0;m<e.length;m++){const y=e[m].t,v=1-y,w=e[m].val;s+=w,c+=w*w;const k=3*v*v*y,S=3*v*y*y,C=v*v*v*o+y*y*y*t,L=w-C;a+=k*k,r+=k*S,i+=S*S,n+=L*k,l+=L*S}const u=e.length,h=s/u;if(c/u-h*h<1e-9)return null;const p=a*i-r*r;if(Math.abs(p)<1e-9)return null;const g=(i*n-r*l)/p,b=(a*l-r*n)/p;return{h1:g,h2:b}}function Li(e,o){const t=e.length;if(t<2){const p=e[0].val;return{leftY:p,rightY:p}}const a=e[0].val,r=e[t-1].val,i=r-a,n=a+i*.333,l=a+i*.666,s=Ri(e,a,r);let c=n,u=l;s&&(c=s.h1,u=s.h2);const h=n+(c-n)*o,f=l+(u-l)*o;return{leftY:h,rightY:f}}function Rt(e,o,t,a){if(e.length<2)return;const r=e[0],i=e[e.length-1],n=i.t-r.t,l=e.map(f=>({t:(f.t-r.t)/n,val:f.val})),{leftY:s,rightY:c}=Li(l,a);let u=0,h=-1;if(n<1)u=0;else for(let f=1;f<l.length-1;f++){const p=l[f].t,g=$o(p,r.val,s,c,i.val),b=Math.abs(g-l[f].val);b>u&&(u=b,h=f)}if(u<=t||e.length<=2){const f=o[o.length-1];f&&(f.rightTangent={x:n*.333,y:s-r.val});const p={id:_e(),frame:i.t,value:i.val,interpolation:"Bezier",brokenTangents:!1,autoTangent:!1,leftTangent:{x:-n*.333,y:c-i.val},rightTangent:{x:1,y:0}};o.push(p)}else{const f=e.slice(0,h+1),p=e.slice(h);Rt(f,o,t,a),Rt(p,o,t,a)}}const Pi=(e,o,t=1)=>{if(e.length<2)return e;t=Math.max(0,Math.min(1,t));const a=[...e].sort((l,s)=>l.frame-s.frame),r=Mi(a,1),i=[],n=r[0];return i.push({id:_e(),frame:n.t,value:n.val,interpolation:"Bezier",brokenTangents:!1,autoTangent:!1,leftTangent:{x:-1,y:0},rightTangent:{x:1,y:0}}),Rt(r,i,o,t),i.length>0&&(i[0].leftTangent={x:-1,y:0},i[i.length-1].rightTangent={x:1,y:0}),i},Ti=4;function Bo(e,o,t,a,r){const i=1-e,n=e*e,l=i*i,s=l*i,c=n*e;return s*o+3*l*e*t+3*i*n*a+c*r}function Ei(e,o,t,a,r){const i=1-e;return 3*i*i*(t-o)+6*i*e*(a-t)+3*e*e*(r-a)}function ki(e,o,t,a,r){const i=r-o;if(i<=1e-9)return 0;let n=(e-o)/i;for(let l=0;l<Ti;++l){const s=Bo(n,o,t,a,r),c=Ei(n,o,t,a,r);if(Math.abs(c)<1e-9)break;const u=s-e;n-=u/c}return Math.max(0,Math.min(1,n))}function zi(e,o,t,a,r,i,n,l,s){const c=o,u=t,h=o+a,f=t+r,p=i+l,g=n+s,b=i,m=n,y=ki(e,c,h,p,b);return Bo(y,u,f,g,m)}const be=.333,ke={interpolate:(e,o,t,a=!1)=>{if(o.interpolation==="Step")return o.value;let r=o.value,i=t.value;if(a){const s=Math.PI*2,c=i-r;c>Math.PI?i-=s:c<-Math.PI&&(i+=s)}if(o.interpolation==="Bezier"){const s=o.rightTangent?o.rightTangent.x:(t.frame-o.frame)*be,c=o.rightTangent?o.rightTangent.y:0,u=t.leftTangent?t.leftTangent.x:-(t.frame-o.frame)*be,h=t.leftTangent?t.leftTangent.y:0;return zi(e,o.frame,r,s,c,t.frame,i,u,h)}const n=t.frame-o.frame;if(n<1e-9)return r;const l=(e-o.frame)/n;return r+(i-r)*l},scaleHandles:(e,o,t,a,r)=>{const i={};if(e.interpolation!=="Bezier")return i;if(o&&e.leftTangent){const n=a-o.frame,l=r-o.frame;if(Math.abs(n)>1e-5&&Math.abs(l)>1e-5){const s=l/n;i.leftTangent={x:e.leftTangent.x*s,y:e.leftTangent.y*s}}}if(t&&e.rightTangent){const n=t.frame-a,l=t.frame-r;if(Math.abs(n)>1e-5&&Math.abs(l)>1e-5){const s=l/n;i.rightTangent={x:e.rightTangent.x*s,y:e.rightTangent.y*s}}}return i},calculateTangents:(e,o,t,a)=>{if(a==="Ease"){const m=o?(e.frame-o.frame)*be:10,y=t?(t.frame-e.frame)*be:10;return{l:{x:-m,y:0},r:{x:y,y:0}}}if(!o&&!t)return{l:{x:-10,y:0},r:{x:10,y:0}};if(!o){const m=(t.value-e.value)/(t.frame-e.frame),y=(t.frame-e.frame)*be;return{l:{x:-10,y:0},r:{x:y,y:y*m}}}if(!t){const m=(e.value-o.value)/(e.frame-o.frame),y=(e.frame-o.frame)*be;return{l:{x:-y,y:-y*m},r:{x:10,y:0}}}const r=e.frame-o.frame,i=e.value-o.value,n=r===0?0:i/r,l=t.frame-e.frame,s=t.value-e.value,c=l===0?0:s/l;if(n*c<=0){const m=r*be,y=l*be;return{l:{x:-m,y:0},r:{x:y,y:0}}}const u=t.frame-o.frame,h=t.value-o.value;let f=u===0?0:h/u;const p=3*Math.min(Math.abs(n),Math.abs(c));Math.abs(f)>p&&(f=Math.sign(f)*p);const g=r*be,b=l*be;return{l:{x:-g,y:-g*f},r:{x:b,y:b*f}}},constrainHandles:(e,o,t)=>{var r,i;const a={};if(e.leftTangent&&o){const n=e.frame-o.frame;if(n>.001){const l=n*be;if(Math.abs(e.leftTangent.x)>l){const s=l/Math.abs(e.leftTangent.x);a.leftTangent={x:e.leftTangent.x*s,y:e.leftTangent.y*s}}e.leftTangent.x>0&&(a.leftTangent={x:0,y:((r=a.leftTangent)==null?void 0:r.y)??e.leftTangent.y})}}if(e.rightTangent&&t){const n=t.frame-e.frame;if(n>.001){const l=n*be;if(Math.abs(e.rightTangent.x)>l){const s=l/Math.abs(e.rightTangent.x);a.rightTangent={x:e.rightTangent.x*s,y:e.rightTangent.y*s}}e.rightTangent.x<0&&(a.rightTangent={x:0,y:((i=a.rightTangent)==null?void 0:i.y)??e.rightTangent.y})}}return a},calculateSoftFalloff:(e,o,t)=>{if(e>=o)return 0;const a=e/o;switch(t){case"Linear":return 1-a;case"Dome":return Math.sqrt(1-a*a);case"Pinpoint":return Math.pow(1-a,4);case"S-Curve":return .5*(1+Math.cos(a*Math.PI));default:return 1-a}}},xt={updateNeighbors:(e,o)=>{const t=e[o],a=o===e.length-1,r=o-1;if(r>=0){const n={...e[r]};if(e[r]=n,n.interpolation==="Bezier"){const l=t.frame-n.frame;if(n.autoTangent){const s=e[r-1],{l:c,r:u}=ke.calculateTangents(n,s,t,"Auto");n.leftTangent=c,n.rightTangent=u}else{const s=ke.constrainHandles(n,e[r-1],t);Object.assign(n,s)}if(a&&l>1e-4){const s=l*.3,c=n.rightTangent||{x:10,y:0};if(c.x<s){const u=s/Math.max(1e-4,Math.abs(c.x));n.rightTangent={x:s,y:c.y*u}}}}}const i=o+1;if(i<e.length){const n={...e[i]};if(e[i]=n,n.interpolation==="Bezier")if(n.autoTangent){const l=e[i+1],{l:s,r:c}=ke.calculateTangents(n,t,l,"Auto");n.leftTangent=s,n.rightTangent=c}else{const l=ke.constrainHandles(n,t,e[i+1]);Object.assign(n,l)}}},inferInterpolation:(e,o)=>{const t=e.filter(a=>a.frame<o).sort((a,r)=>r.frame-a.frame);return t.length===0||t[0].interpolation==="Linear"?"Linear":t[0].interpolation==="Step"?"Step":"Bezier"}},Ai=je(),Di={durationFrames:300,fps:30,tracks:{}},Fi=(e,o)=>({sequence:Di,clipboard:null,undoStack:[],redoStack:[],snapshot:()=>{const t=o().sequence,a=JSON.parse(JSON.stringify(t));e(r=>{const i=[...r.undoStack,{type:"SEQUENCE",data:a}];return{undoStack:i.length>50?i.slice(1):i,redoStack:[]}})},undo:()=>{const{undoStack:t,redoStack:a,sequence:r}=o();if(t.length===0)return!1;const i=t[t.length-1],n=t.slice(0,-1),s={type:"SEQUENCE",data:JSON.parse(JSON.stringify(r))};return e({sequence:i.data,undoStack:n,redoStack:[...a,s]}),!0},redo:()=>{const{undoStack:t,redoStack:a,sequence:r}=o();if(a.length===0)return!1;const i=a[a.length-1],n=a.slice(0,-1),s={type:"SEQUENCE",data:JSON.parse(JSON.stringify(r))};return e({sequence:i.data,undoStack:[...t,s],redoStack:n}),!0},setSequence:t=>{o().snapshot(),e({sequence:t})},addTrack:(t,a)=>{o().snapshot(),e(r=>r.sequence.tracks[t]?r:{sequence:{...r.sequence,tracks:{...r.sequence.tracks,[t]:{id:t,type:"float",label:a,keyframes:[]}}}})},removeTrack:t=>{o().snapshot(),e(a=>{const r={...a.sequence.tracks};return delete r[t],{sequence:{...a.sequence,tracks:r},selectedTrackIds:a.selectedTrackIds.filter(i=>i!==t)}})},setTrackBehavior:(t,a)=>{o().snapshot(),e(r=>{const i=r.sequence.tracks[t];return i?{sequence:{...r.sequence,tracks:{...r.sequence.tracks,[t]:{...i,postBehavior:a}}}}:r})},addKeyframe:(t,a,r,i)=>{e(n=>{const l=n.sequence.tracks[t];if(!l)return n;let s=i||"Bezier";i||(s=xt.inferInterpolation(l.keyframes,a));const c=s==="Bezier",u={id:_e(),frame:a,value:r,interpolation:s,autoTangent:c,brokenTangents:!1},f=[...l.keyframes.filter(g=>Math.abs(g.frame-a)>.001),u].sort((g,b)=>g.frame-b.frame),p=f.findIndex(g=>g.id===u.id);if(s==="Bezier"){const g=p>0?f[p-1]:void 0,b=p<f.length-1?f[p+1]:void 0,{l:m,r:y}=ke.calculateTangents(u,g,b,"Auto");u.leftTangent=m,u.rightTangent=y}return xt.updateNeighbors(f,p),{sequence:{...n.sequence,tracks:{...n.sequence.tracks,[t]:{...l,keyframes:f}}}}})},batchAddKeyframes:(t,a,r)=>{e(i=>{const n={...i.sequence.tracks};let l=!1;return a.forEach(({trackId:s,value:c})=>{n[s]||(n[s]={id:s,type:"float",label:s,keyframes:[]},l=!0);const u=n[s],h=[...u.keyframes],f=h.length>0?h[h.length-1]:null,p={id:_e(),frame:t,value:c,interpolation:r||"Linear",autoTangent:r==="Bezier",brokenTangents:!1};if(f)if(t>f.frame)h.push(p);else if(Math.abs(t-f.frame)<.001)p.id=f.id,h[h.length-1]=p;else{const g=h.filter(b=>Math.abs(b.frame-t)>.001);g.push(p),g.sort((b,m)=>b.frame-m.frame),u.keyframes=g,l=!0;return}else h.push(p);u.keyframes=h,l=!0}),l?{sequence:{...i.sequence,tracks:n}}:i})},removeKeyframe:(t,a)=>{o().snapshot(),e(r=>{const i=r.sequence.tracks[t];return i?{sequence:{...r.sequence,tracks:{...r.sequence.tracks,[t]:{...i,keyframes:i.keyframes.filter(n=>n.id!==a)}}}}:r})},updateKeyframe:(t,a,r)=>{e(i=>{const n=i.sequence.tracks[t];if(!n)return i;const l=n.keyframes.map(s=>s.id===a?{...s,...r}:s).sort((s,c)=>s.frame-c.frame);return{sequence:{...i.sequence,tracks:{...i.sequence.tracks,[t]:{...n,keyframes:l}}}}})},updateKeyframes:t=>{e(a=>{const r={...a.sequence.tracks};return t.forEach(({trackId:i,keyId:n,patch:l})=>{const s=r[i];if(s){const c=s.keyframes.findIndex(u=>u.id===n);if(c!==-1){const u=s.keyframes[c];l.interpolation==="Bezier"&&u.interpolation!=="Bezier"&&(l.autoTangent=!0),s.keyframes[c]={...u,...l}}}}),Object.keys(r).forEach(i=>{r[i].keyframes.sort((n,l)=>n.frame-l.frame)}),{sequence:{...a.sequence,tracks:r}}})},deleteSelectedKeyframes:()=>{o().snapshot(),e(t=>{const a={...t.sequence.tracks},r=new Set(t.selectedKeyframeIds);return Object.keys(a).forEach(i=>{a[i]={...a[i],keyframes:a[i].keyframes.filter(n=>!r.has(`${i}::${n.id}`))}}),{sequence:{...t.sequence,tracks:a},selectedKeyframeIds:[]}})},deleteAllKeys:()=>{o().snapshot(),e(t=>{const a={...t.sequence.tracks};return Object.keys(a).forEach(r=>{a[r]={...a[r],keyframes:[]}}),{sequence:{...t.sequence,tracks:a},selectedKeyframeIds:[]}})},deleteAllTracks:()=>{o().snapshot(),e({sequence:{...o().sequence,tracks:{}},selectedTrackIds:[],selectedKeyframeIds:[]})},setTangents:t=>{o().snapshot(),e(a=>{const r={...a.sequence.tracks};return a.selectedKeyframeIds.forEach(i=>{const[n,l]=i.split("::"),s=r[n];if(s){const c=s.keyframes.findIndex(h=>h.id===l);if(c===-1)return;const u=s.keyframes[c];if(t==="Split")s.keyframes[c]={...u,brokenTangents:!0,autoTangent:!1};else if(t==="Unified"){let h=u.rightTangent,f=u.leftTangent;if(h&&f){const p=Math.sqrt(h.x*h.x+h.y*h.y),g=Math.sqrt(f.x*f.x+f.y*f.y);h={x:-f.x*(p/Math.max(.001,g)),y:-f.y*(p/Math.max(.001,g))}}s.keyframes[c]={...u,rightTangent:h,brokenTangents:!1,autoTangent:!1}}else if(t==="Auto"||t==="Ease"){const h=s.keyframes[c-1],f=s.keyframes[c+1],{l:p,r:g}=ke.calculateTangents(u,h,f,t);s.keyframes[c]={...u,autoTangent:t==="Auto",brokenTangents:!1,leftTangent:p,rightTangent:g}}}}),{sequence:{...a.sequence,tracks:r}}})},setGlobalInterpolation:(t,a)=>{o().snapshot(),e(r=>{const i={...r.sequence.tracks};return Object.keys(i).forEach(n=>{const l=i[n];l.keyframes.length!==0&&l.keyframes.forEach((s,c)=>{if(s.interpolation=t,t==="Bezier"&&a){const u=l.keyframes[c-1],h=l.keyframes[c+1],{l:f,r:p}=ke.calculateTangents(s,u,h,a);s.leftTangent=f,s.rightTangent=p,s.autoTangent=a==="Auto",s.brokenTangents=!1}})}),{sequence:{...r.sequence,tracks:i}}})},copySelectedKeyframes:()=>{const{sequence:t,selectedKeyframeIds:a}=o();if(a.length===0)return;let r=1/0;a.forEach(n=>{var u,h;const[l,s]=n.split("::"),c=(h=(u=t.tracks[l])==null?void 0:u.keyframes.find(f=>f.id===s))==null?void 0:h.frame;c!==void 0&&c<r&&(r=c)});const i=[];a.forEach(n=>{var u;const[l,s]=n.split("::"),c=(u=t.tracks[l])==null?void 0:u.keyframes.find(h=>h.id===s);c&&i.push({relativeFrame:c.frame-r,value:c.value,interpolation:c.interpolation,leftTangent:c.leftTangent,rightTangent:c.rightTangent,originalTrackId:l})}),i.length>0&&e({clipboard:i})},pasteKeyframes:t=>{const{clipboard:a,currentFrame:r}=o();a&&(o().snapshot(),e(i=>{const n={...i.sequence.tracks},l=t!==void 0?t:r;return a.forEach(s=>{const c=n[s.originalTrackId];if(c){const u=l+s.relativeFrame,h={id:_e(),frame:u,value:s.value,interpolation:s.interpolation,leftTangent:s.leftTangent,rightTangent:s.rightTangent,autoTangent:!1,brokenTangents:!1};c.keyframes=[...c.keyframes.filter(f=>Math.abs(f.frame-u)>.001),h].sort((f,p)=>f.frame-p.frame)}}),{sequence:{...i.sequence,tracks:n}}}))},duplicateSelection:()=>{o().copySelectedKeyframes(),o().pasteKeyframes(o().currentFrame)},loopSelection:t=>{const a=o();if(a.selectedKeyframeIds.length<1)return;a.snapshot();let r=1/0,i=-1/0;if(a.selectedKeyframeIds.forEach(l=>{const[s,c]=l.split("::"),u=a.sequence.tracks[s],h=u==null?void 0:u.keyframes.find(f=>f.id===c);h&&(h.frame<r&&(r=h.frame),h.frame>i&&(i=h.frame))}),r===1/0||i===-1/0)return;const n=Math.max(1,i-r);e(l=>{const s={...l.sequence.tracks};for(let c=1;c<=t;c++){const u=n*c;l.selectedKeyframeIds.forEach(h=>{const[f,p]=h.split("::"),g=s[f];if(!g)return;const b=g.keyframes.find(m=>m.id===p);if(b){const m=b.frame+u,y={...b,id:_e(),frame:m};g.keyframes=[...g.keyframes.filter(v=>Math.abs(v.frame-m)>.001),y]}})}return Object.values(s).forEach(c=>c.keyframes.sort((u,h)=>u.frame-h.frame)),{sequence:{...l.sequence,tracks:s}}})},captureCameraFrame:(t,a=!1,r)=>{const i=He()||Ai.activeCamera;if(!i)return;a||o().snapshot();const n=Fe.getUnifiedFromEngine(),l=i.quaternion,s=new qe().setFromQuaternion(l),c=[{id:"camera.unified.x",val:n.x,label:"Position X"},{id:"camera.unified.y",val:n.y,label:"Position Y"},{id:"camera.unified.z",val:n.z,label:"Position Z"},{id:"camera.rotation.x",val:s.x,label:"Rotation X"},{id:"camera.rotation.y",val:s.y,label:"Rotation Y"},{id:"camera.rotation.z",val:s.z,label:"Rotation Z"}];e(u=>{const h={...u.sequence.tracks},f=h["camera.unified.x"],p=!f||f.keyframes.length===0,g=r||(p?"Linear":"Bezier");return c.forEach(b=>{let m=h[b.id];m||(m={id:b.id,type:"float",label:b.label,keyframes:[],hidden:!1},h[b.id]=m);const y={id:_e(),frame:t,value:b.val,interpolation:g,autoTangent:g==="Bezier",brokenTangents:!1},w=[...m.keyframes.filter(S=>Math.abs(S.frame-t)>.001),y].sort((S,C)=>S.frame-C.frame),k=w.findIndex(S=>S.id===y.id);if(g==="Bezier"){const S=k>0?w[k-1]:void 0,C=k<w.length-1?w[k+1]:void 0,{l:L,r:T}=ke.calculateTangents(y,S,C,"Auto");y.leftTangent=L,y.rightTangent=T}xt.updateNeighbors(w,k),m.keyframes=w}),{sequence:{...u.sequence,tracks:h}}})},simplifySelectedKeys:(t=.01)=>{o().snapshot(),e(a=>{const r=a,i={...r.sequence.tracks},n=new Set(r.selectedKeyframeIds),l={};r.selectedKeyframeIds.forEach(c=>{const[u,h]=c.split("::");l[u]||(l[u]=[]);const f=r.sequence.tracks[u],p=f==null?void 0:f.keyframes.find(g=>g.id===h);p&&l[u].push(p)});const s=[];return Object.entries(l).forEach(([c,u])=>{const h=i[c];if(!h)return;const f={...h};if(i[c]=f,u.length<3)return;const p=u.sort((b,m)=>b.frame-m.frame);f.keyframes=f.keyframes.filter(b=>!n.has(`${c}::${b.id}`));const g=Pi(p,t);f.keyframes=[...f.keyframes,...g].sort((b,m)=>b.frame-m.frame),g.forEach(b=>s.push(`${c}::${b.id}`))}),{sequence:{...r.sequence,tracks:i},selectedKeyframeIds:s}})}}),Lt=vo()(xo((e,o,t)=>({...Ii(e,o),...Ci(e),...Fi(e,o)})));typeof window<"u"&&(window.useAnimationStore=Lt);const Ze=je(),lt=e=>{const o={};return e&&Object.keys(e).forEach(t=>{if(t.startsWith("is"))return;const a=e[t];if(a&&typeof a=="object"&&"isColor"in a)o[t]="#"+a.getHexString();else if(a&&typeof a=="object"&&("isVector2"in a||"isVector3"in a)){const r={...a};delete r.isVector2,delete r.isVector3,o[t]=r}else o[t]=a}),o},Ho=e=>{const o=he.get(e),t=o&&o.defaultPreset?o.defaultPreset:{},a={version:5,name:e,formula:e,features:{}};return N.getAll().forEach(r=>{const i={};Object.entries(r.params).forEach(([n,l])=>{l.composeFrom||(i[n]=l.default)}),a.features[r.id]=lt(i)}),t.features&&Object.entries(t.features).forEach(([r,i])=>{a.features[r]?a.features[r]={...a.features[r],...lt(i)}:a.features[r]=lt(i)}),t.lights&&(a.features.lighting||(a.features.lighting={}),a.features.lighting.lights=t.lights),t.renderMode&&(a.features.lighting||(a.features.lighting={}),a.features.lighting.renderMode=t.renderMode==="PathTracing"?1:0),a.cameraMode=t.cameraMode||"Orbit",a.quality={aaMode:"Always",aaLevel:1,msaa:1,accumulation:!0,...t.quality||{}},a.lights=[],a.animations=t.animations||[],a.navigation={flySpeed:.5,autoSlow:!0,...t.navigation||{}},a.sceneOffset=t.sceneOffset||{x:0,y:0,z:0,xL:0,yL:0,zL:0},a.cameraPos=t.cameraPos||{x:0,y:0,z:3.5},a.cameraRot=t.cameraRot||{x:0,y:0,z:0,w:1},a.targetDistance=t.targetDistance||3.5,a.duration=t.duration||300,a.sequence=t.sequence||{durationFrames:300,fps:30,tracks:{}},a},Oi=(e,o,t)=>{const a=t(),r=e.features||{};if(e.renderMode&&(r.lighting||(r.lighting={}),r.lighting.renderMode===void 0&&(r.lighting.renderMode=e.renderMode==="PathTracing"?1:0)),r.atmosphere&&!r.ao){const v={};r.atmosphere.aoIntensity!==void 0&&(v.aoIntensity=r.atmosphere.aoIntensity),r.atmosphere.aoSpread!==void 0&&(v.aoSpread=r.atmosphere.aoSpread),r.atmosphere.aoMode!==void 0&&(v.aoMode=r.atmosphere.aoMode),r.atmosphere.aoEnabled!==void 0&&(v.aoEnabled=r.atmosphere.aoEnabled),Object.keys(v).length>0&&(r.ao=v)}const i=new Set(["compilerHardCap","precisionMode","bufferPrecision"]);if(N.getAll().forEach(v=>{const w=`set${v.id.charAt(0).toUpperCase()+v.id.slice(1)}`,k=a[w];if(typeof k=="function"){const S=r[v.id],C={},L=v.id==="quality"?t().quality:null;if(v.state&&Object.assign(C,v.state),Object.entries(v.params).forEach(([T,O])=>{if(v.id==="quality"&&i.has(T)&&L){C[T]=L[T];return}if(S&&S[T]!==void 0){let x=S[T];O.type==="vec2"&&x&&!(x instanceof ve)?x=new ve(x.x,x.y):O.type==="vec3"&&x&&!(x instanceof j)?x=new j(x.x,x.y,x.z):O.type==="color"&&x&&!(x instanceof le)&&(x=new le(x)),C[T]=x}else if(C[T]===void 0){let x=O.default;x&&typeof x=="object"&&(typeof x.clone=="function"?x=x.clone():Array.isArray(x)?x=[...x]:x={...x}),C[T]=x}}),v.id==="lighting"&&S){if(S.lights)C.lights=ro(S.lights.map(T=>({...T,type:T.type||"Point",rotation:T.rotation||{x:0,y:0,z:0}})));else if(S.light0_posX!==void 0){const T=[];for(let O=0;O<3;O++)if(S[`light${O}_posX`]!==void 0){let x=S[`light${O}_color`]||"#ffffff";x.getHexString&&(x="#"+x.getHexString()),T.push({type:"Point",position:{x:S[`light${O}_posX`],y:S[`light${O}_posY`],z:S[`light${O}_posZ`]},rotation:{x:0,y:0,z:0},color:x,intensity:S[`light${O}_intensity`]??1,falloff:S[`light${O}_falloff`]??0,falloffType:S[`light${O}_type`]?"Linear":"Quadratic",fixed:S[`light${O}_fixed`]??!1,visible:S[`light${O}_visible`]??O===0,castShadow:S[`light${O}_castShadow`]??!0})}T.length>0&&(C.lights=T)}}v.id==="materials"&&S&&S.envMapVisible!==void 0&&S.envBackgroundStrength===void 0&&(C.envBackgroundStrength=S.envMapVisible?1:0),k(C)}}),e.lights&&e.lights.length>0){const v=a.setLighting;if(typeof v=="function"){const w=ro(e.lights.map(k=>({...k,type:k.type||"Point",rotation:k.rotation||{x:0,y:0,z:0}})));v({lights:w})}}e.sequence&&Lt.getState().setSequence(e.sequence),a.setAnimations(e.animations||[]),e.savedCameras&&Array.isArray(e.savedCameras)&&e.savedCameras.length>0&&o({savedCameras:e.savedCameras,activeCameraId:e.savedCameras[0].id||null});const n=e.cameraPos||{x:0,y:0,z:3.5},l=e.sceneOffset||{x:0,y:0,z:0,xL:0,yL:0,zL:0},s=e.targetDistance||3.5,c=e.cameraRot||{x:0,y:0,z:0,w:1},u=l.x+l.xL+n.x,h=l.y+l.yL+n.y,f=l.z+l.zL+n.z,p=B.split(u),g=B.split(h),b=B.split(f),m={x:p.high,y:g.high,z:b.high,xL:p.low,yL:g.low,zL:b.low};o({cameraRot:c,targetDistance:s,sceneOffset:m,cameraMode:e.cameraMode||t().cameraMode}),Ze.activeCamera&&Ze.virtualSpace&&Ze.virtualSpace.applyCameraState(Ze.activeCamera,{position:{x:0,y:0,z:0},rotation:c,sceneOffset:m,targetDistance:s});const y={position:{x:0,y:0,z:0},rotation:c,sceneOffset:m,targetDistance:s};Ze.pendingTeleport=y,R.emit("camera_teleport",y),e.duration&&Lt.getState().setDuration(e.duration),e.formula==="Modular"&&a.refreshPipeline(),a.refreshHistogram(),R.emit("reset_accum",void 0)},ji={formula:"Mandelbulb",cameraPos:{x:0,y:0,z:0},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:0,xL:0,yL:0,zL:0},targetDistance:3.5,cameraMode:"Orbit"},Ni=(e,o,t={includeAnimations:!0})=>{try{e.quality&&(delete e.quality.aaLevel,delete e.quality.aaMode,delete e.quality.msaa),e.features&&e.features.quality&&delete e.features.quality.resolutionMode,t.includeAnimations===!1&&(delete e.sequence,delete e.animations);const a=Ho(e.formula);a.formula="";const r=N.getDictionary();return new Mt(a,r).encode(e,o)}catch(a){return console.error("Sharing: Failed to generate share string",a),""}},Fn=e=>{if(!e)return null;try{const o=N.getDictionary(),a=new Mt(ji,o).decode(e);if(a&&a.formula){const r=Ho(a.formula);return new Mt(r,o).decode(e)}}catch(o){console.error("Sharing: Failed to load share string",o)}return null},St=je();class $i{constructor(){M(this,"pendingCam");M(this,"binders",new Map);M(this,"overriddenTracks",new Set);M(this,"lastCameraIndex",-1);M(this,"animStore",null);M(this,"fractalStore",null);this.pendingCam={rot:new qe,unified:new j,rotDirty:!1,unifiedDirty:!1}}connect(o,t){this.animStore=o,this.fractalStore=t}setOverriddenTracks(o){this.overriddenTracks=o}getBinder(o){if(this.binders.has(o))return this.binders.get(o);let t=()=>{};if(o==="camera.active_index")t=a=>{const r=Math.round(a);if(r!==this.lastCameraIndex){const i=this.fractalStore.getState(),n=i.savedCameras;n&&n[r]&&(i.selectCamera(n[r].id),this.lastCameraIndex=r)}};else if(o.startsWith("camera.")){const a=o.split("."),r=a[1],i=a[2];r==="unified"?t=n=>{this.pendingCam.unified[i]=n,this.pendingCam.unifiedDirty=!0}:r==="rotation"&&(t=n=>{this.pendingCam.rot[i]=n,this.pendingCam.rotDirty=!0})}else if(o.startsWith("lights.")){const a=o.split("."),r=parseInt(a[1]),i=a[2];let n="";i==="position"?n=`pos${a[3].toUpperCase()}`:i==="color"?n="color":n=i;const l=`lighting.light${r}_${n}`;return this.getBinder(l)}else if(o.startsWith("lighting.light")){const a=o.match(/lighting\.light(\d+)_(\w+)/);if(a){const r=parseInt(a[1]),i=a[2],n=this.fractalStore.getState();if(i==="intensity")t=l=>n.updateLight({index:r,params:{intensity:l}});else if(i==="falloff")t=l=>n.updateLight({index:r,params:{falloff:l}});else if(i.startsWith("pos")){const l=i.replace("pos","").toLowerCase();t=s=>{var h;const u=(h=this.fractalStore.getState().lighting)==null?void 0:h.lights[r];if(u){const f={...u.position,[l]:s};n.updateLight({index:r,params:{position:f}})}}}else if(i.startsWith("rot")){const l=i.replace("rot","").toLowerCase();t=s=>{var h;const u=(h=this.fractalStore.getState().lighting)==null?void 0:h.lights[r];if(u){const f={...u.rotation,[l]:s};n.updateLight({index:r,params:{rotation:f}})}}}}}else if(o.includes(".")){const a=o.split("."),r=a[0],i=a[1];if(N.get(r)){const l=this.fractalStore.getState(),s=`set${r.charAt(0).toUpperCase()+r.slice(1)}`,c=l[s];if(c&&typeof c=="function"){const u=i.match(/^(vec[23][ABC])_(x|y|z)$/);if(u){const h=u[1],f=u[2];t=p=>{var m;const b=(m=this.fractalStore.getState()[r])==null?void 0:m[h];if(b){const y=b.clone();y[f]=p,c({[h]:y})}}}else t=h=>c({[i]:h})}else console.warn(`AnimationEngine: Setter ${s} not found for feature ${r}`)}}else{const a=this.fractalStore.getState(),r="set"+o.charAt(0).toUpperCase()+o.slice(1);typeof a[r]=="function"&&(t=i=>a[r](i))}return this.binders.set(o,t),t}tick(o){if(!this.animStore)return;const t=this.animStore.getState();if(!t.isPlaying)return;const a=t.fps,r=t.currentFrame,i=t.durationFrames,n=t.loopMode,l=o*a;let s=r+l;if(s>=i)if(n==="Once"||t.isRecordingModulation){s=i,this.scrub(i),this.animStore.setState({isPlaying:!1,currentFrame:i}),t.isRecordingModulation&&t.stopModulationRecording();return}else s=0;this.animStore.setState({currentFrame:s}),this.scrub(s)}scrub(o){if(!this.animStore)return;const{sequence:t,isPlaying:a,isRecording:r,recordCamera:i}=this.animStore.getState(),n=Object.values(t.tracks);this.syncBuffersFromEngine();const l=a&&r&&i;for(let s=0;s<n.length;s++){const c=n[s];if(this.overriddenTracks.has(c.id)||c.keyframes.length===0||c.type!=="float"||c.id.includes("camera.position")||c.id.includes("camera.offset")||l&&c.id.startsWith("camera."))continue;const u=this.interpolate(c,o);this.getBinder(c.id)(u)}this.commitState()}syncBuffersFromEngine(){const o=He()||St.activeCamera;if(o){this.pendingCam.rot.setFromQuaternion(o.quaternion);const t=St.sceneOffset;this.pendingCam.unified.set(t.x+t.xL+o.position.x,t.y+t.yL+o.position.y,t.z+t.zL+o.position.z),this.pendingCam.rotDirty=!1,this.pendingCam.unifiedDirty=!1}}interpolate(o,t){const a=o.keyframes;if(a.length===0)return 0;const r=a[0],i=a[a.length-1],n=o.id.startsWith("camera.rotation")||o.id.includes("rot")||o.id.includes("phase")||o.id.includes("twist");if(t>i.frame){const l=o.postBehavior||"Hold";if(l==="Hold")return i.value;if(l==="Continue"){let p=0;if(a.length>1){const g=a[a.length-2];i.interpolation==="Linear"?p=(i.value-g.value)/(i.frame-g.frame):i.interpolation==="Bezier"&&(i.leftTangent&&Math.abs(i.leftTangent.x)>.001?p=i.leftTangent.y/i.leftTangent.x:p=(i.value-g.value)/(i.frame-g.frame))}return i.value+p*(t-i.frame)}const s=i.frame-r.frame;if(s<=.001)return i.value;const c=t-r.frame,u=Math.floor(c/s),h=r.frame+c%s,f=this.evaluateCurveInternal(a,h,n);if(l==="Loop")return f;if(l==="PingPong"){if(u%2===1){const g=i.frame-c%s;return this.evaluateCurveInternal(a,g,n)}return f}if(l==="OffsetLoop"){const p=i.value-r.value;return f+p*u}}return t<r.frame?r.value:this.evaluateCurveInternal(a,t,n)}evaluateCurveInternal(o,t,a){for(let r=0;r<o.length-1;r++){const i=o[r],n=o[r+1];if(t>=i.frame&&t<=n.frame)return ke.interpolate(t,i,n,a)}return o[o.length-1].value}commitState(){if(this.pendingCam.unifiedDirty||this.pendingCam.rotDirty){St.shouldSnapCamera=!0;const o=new Oe().setFromEuler(this.pendingCam.rot),t={x:o.x,y:o.y,z:o.z,w:o.w},a=B.split(this.pendingCam.unified.x),r=B.split(this.pendingCam.unified.y),i=B.split(this.pendingCam.unified.z);R.emit(oe.CAMERA_TELEPORT,{position:{x:0,y:0,z:0},rotation:t,sceneOffset:{x:a.high,y:r.high,z:i.high,xL:a.low,yL:r.low,zL:i.low}}),this.fractalStore.setState({cameraRot:t})}}}const Bi=new $i;class Hi{constructor(){M(this,"_pendingWork",null);M(this,"_newCyclePending",!1)}queue(o,t){this._pendingWork=t,this._newCyclePending=!0,R.emit(oe.IS_COMPILING,o)}consumeNewCycle(){return this._newCyclePending?(this._newCyclePending=!1,!0):!1}flush(){if(this._pendingWork){const o=this._pendingWork;this._pendingWork=null,o()}}}const po=new Hi,ie=je(),pe=vo()(xo((e,o,t)=>({...da(e,o),...fa(e,o),...xa(e,o),...Ma(e,o),...Ra(e,o),...fi(e,o),..._i(e,o),formula:"Mandelbulb",projectSettings:{name:"Mandelbulb",version:0},lastSavedHash:null,animations:[],liveModulations:{},setFormula:(a,r={})=>{const i=o(),n=i.formula;if(n===a&&a!=="Modular")return;r.skipDefaultPreset||(o().resetParamHistory(),e({undoStack:[],redoStack:[]}));const l=i.projectSettings.name;let s=l;(l===n||l==="Untitled"||l==="Custom Preset")&&(s=a),e({formula:a,projectSettings:{...i.projectSettings,name:s}}),po.queue("Loading Preview...",()=>{if(R.emit(oe.CONFIG,{formula:a,pipeline:i.pipeline,graph:i.graph}),a!=="Modular"&&!r.skipDefaultPreset){const c=he.get(a),u=c&&c.defaultPreset?JSON.parse(JSON.stringify(c.defaultPreset)):{formula:a};u.features||(u.features={});const h=o();if(N.getEngineFeatures().forEach(p=>{const g=h[p.id];if(!g)return;const b=u.features[p.id]||{},m={},y=p.engineConfig.toggleParam;g[y]!==void 0&&b[y]===void 0&&(m[y]=g[y]),Object.entries(p.params).forEach(([v,w])=>{w.onUpdate==="compile"&&g[v]!==void 0&&b[v]===void 0&&(m[v]=g[v])}),u.features[p.id]||(u.features[p.id]={}),Object.assign(u.features[p.id],m)}),o().lockSceneOnSwitch){const p=o().getPreset(),g={...p.features||{}},b=u.features||{};b.coreMath&&(g.coreMath=b.coreMath),b.geometry&&(g.geometry=b.geometry);const m={...p,formula:a,features:g};o().loadPreset(m)}else o().loadPreset(u)}o().handleInteractionEnd(),ie.post({type:"CONFIG_DONE"})})},setProjectSettings:a=>e(r=>{const i={...r.projectSettings,...a};return a.name&&a.name!==r.projectSettings.name?(i.version=0,{projectSettings:i,lastSavedHash:null}):{projectSettings:i}}),prepareExport:()=>{const a=o(),r=a.getPreset({includeScene:!0}),{version:i,name:n,...l}=r,s=JSON.stringify(l);if(a.lastSavedHash===null||a.projectSettings.version===0){const c=Math.max(1,a.projectSettings.version+1);return e({projectSettings:{...a.projectSettings,version:c},lastSavedHash:s}),c}if(a.lastSavedHash!==s){const c=a.projectSettings.version+1;return e({projectSettings:{...a.projectSettings,version:c},lastSavedHash:s}),c}return a.projectSettings.version},setAnimations:a=>{const r=o().animations,i=a.map(n=>{const l=r.find(s=>s.id===n.id);if(!l)return n;if(n.period!==l.period&&n.period>0){const s=performance.now()/1e3,c=(s/l.period+l.phase-s/n.period)%1;return{...n,phase:(c+1)%1}}return n});e({animations:i})},setLiveModulations:a=>e({liveModulations:a}),loadPreset:a=>{a._formulaDef&&!he.get(a.formula)&&he.register(a._formulaDef),o().resetParamHistory();const r=he.get(a.formula),i=r?r.id:a.formula;e({formula:i}),R.emit(oe.CONFIG,{formula:i});let n=a.name;(!n||n==="Untitled"||n==="Custom Preset")&&(n=i),e({projectSettings:{name:n,version:0},lastSavedHash:null}),Oi(a,e,o),setTimeout(()=>{const l=o().getPreset({includeScene:!0}),{version:s,name:c,...u}=l;e({lastSavedHash:JSON.stringify(u)})},50)},loadScene:({def:a,preset:r})=>{if(a&&(he.get(a.id)||he.register(a),R.emit(oe.REGISTER_FORMULA,{id:a.id,shader:a.shader})),!ie.isBooted&&!ie.bootSent){o().loadPreset(r);return}po.queue("Loading Preview...",()=>{o().loadPreset(r);const i=Vo(o());R.emit(oe.CONFIG,i);const n=o().sceneOffset;if(n){const l={x:n.x,y:n.y,z:n.z,xL:n.xL??0,yL:n.yL??0,zL:n.zL??0};ie.setShadowOffset(l),ie.post({type:"OFFSET_SET",offset:l})}ie.post({type:"CONFIG_DONE"})})},getPreset:a=>{var l,s;const r=o(),i={version:r.projectSettings.version,name:r.projectSettings.name,formula:r.formula,features:{}};if((a==null?void 0:a.includeScene)!==!1){if(i.cameraPos={x:0,y:0,z:0},ie.activeCamera&&ie.virtualSpace){const c=ie.virtualSpace.getUnifiedCameraState(ie.activeCamera,r.targetDistance);i.cameraRot=c.rotation,i.sceneOffset=c.sceneOffset,i.targetDistance=c.targetDistance}else i.cameraRot=r.cameraRot,i.sceneOffset=r.sceneOffset,i.targetDistance=r.targetDistance;i.cameraMode=r.cameraMode,i.lights=[],i.renderMode=r.renderMode,i.quality={aaMode:r.aaMode,aaLevel:r.aaLevel,msaa:r.msaaSamples,accumulation:r.accumulation}}N.getAll().forEach(c=>{const u=r[c.id];u&&(i.features||(i.features={}),i.features[c.id]=lt(u))}),i.animations=r.animations,r.savedCameras.length>0&&(i.savedCameras=r.savedCameras.map(c=>({id:c.id,label:c.label,position:c.position,rotation:c.rotation,sceneOffset:c.sceneOffset,targetDistance:c.targetDistance,optics:c.optics}))),r.formula==="Modular"&&(i.graph=r.graph,i.pipeline=r.pipeline);try{const c=(s=(l=window.useAnimationStore)==null?void 0:l.getState)==null?void 0:s.call(l);c&&(i.sequence=c.sequence,i.duration=c.durationFrames)}catch(c){console.warn("Failed to save animation sequence:",c)}return i},getShareString:a=>{const r=o().getPreset({includeScene:!0}),i=o().advancedMode;return Ni(r,i,a)}}))),On=e=>e.isUserInteracting||e.interactionMode!=="none",jn=e=>{var t;if(e.isGizmoDragging||e.interactionMode!=="none"||e.isExporting||e.isBucketRendering||e.tutorialActive&&e.tutorialLessonId===1)return!0;const o=N.getAll();for(const a of o)if((t=a.interactionConfig)!=null&&t.blockCamera&&a.interactionConfig.activeParam){const r=e[a.id];if(r&&r[a.interactionConfig.activeParam])return!0}return!1},Vo=e=>{var a;const o={formula:e.formula,pipeline:e.pipeline,pipelineRevision:e.pipelineRevision,graph:e.graph,msaaSamples:e.msaaSamples,previewMode:e.previewMode,renderMode:e.renderMode,compilerHardCap:e.compilerHardCap,shadows:!0,quality:{...e.quality}};if(N.getAll().forEach(r=>{const i=e[r.id];i&&(o[r.id]={...i})}),e.hardwareProfile){const r=e.hardwareProfile,i=o.quality;i&&(i.precisionMode=Math.max(i.precisionMode??0,r.caps.precisionMode),i.bufferPrecision=Math.max(i.bufferPrecision??0,r.caps.bufferPrecision),i.compilerHardCap=Math.min(i.compilerHardCap??tt,r.caps.compilerHardCap)),o.compilerHardCap=((a=o.quality)==null?void 0:a.compilerHardCap)??o.compilerHardCap}return o};Si(Vo);const Nn=()=>{const e=pe.getState();Bi.connect(window.useAnimationStore,pe),ie.isPaused=e.isPaused,ie.setPreviewSampleCap(e.sampleCap),ie.onBooted=()=>{const t=pe.getState(),a=t.sceneOffset;if(a){const r={x:a.x,y:a.y,z:a.z,xL:a.xL??0,yL:a.yL??0,zL:a.zL??0};ie.setShadowOffset(r),ie.post({type:"OFFSET_SET",offset:r})}ie.setPreviewSampleCap(t.sampleCap)},pe.subscribe(t=>t.isPaused,t=>{ie.isPaused=t}),pe.subscribe(t=>t.sampleCap,t=>{ie.setPreviewSampleCap(t)}),pe.subscribe(t=>{var a;return(a=t.lighting)==null?void 0:a.renderMode},t=>{if(t===void 0)return;const a=t===1?"PathTracing":"Direct";pe.getState().renderMode!==a&&pe.setState({renderMode:a})});let o;pe.subscribe(t=>{var a;return(a=t.optics)==null?void 0:a.camType},t=>{var i;if(t===void 0)return;const a=o!==void 0&&o<.5,r=t>.5&&t<1.5;if(a&&r){const n=pe.getState();if(!n.activeCameraId){const l=((i=n.optics)==null?void 0:i.camFov)||60;let s=ie.lastMeasuredDistance;(!s||s>=1e3||s<=0)&&(s=n.targetDistance||3.5);const c=s*Math.tan(l*Math.PI/360),u=n.setOptics;typeof u=="function"&&u({orthoScale:c})}}o=t}),R.on(oe.BUCKET_STATUS,({isRendering:t})=>{const a=pe.getState();a.setIsBucketRendering(t),a.setIsExporting(t)})};typeof window<"u"&&(window.__store=pe);const Vi=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("polyline",{points:"6 9 12 15 18 9"})}),$n=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("polyline",{points:"18 15 12 9 6 15"})}),Bn=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("polyline",{points:"15 18 9 12 15 6"})}),Hn=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("polyline",{points:"9 18 15 12 9 6"})}),Vn=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("polyline",{points:"9 18 15 12 9 6"})}),Gn=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("path",{d:"M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"})}),Un=()=>d.jsx("svg",{width:"100%",height:"100%",viewBox:"0 0 10 10",children:d.jsx("path",{d:"M 6 10 L 10 6 L 10 10 Z",fill:"currentColor",opacity:"0.5"})}),qn=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"4",y1:"9",x2:"20",y2:"9"}),d.jsx("line",{x1:"4",y1:"15",x2:"20",y2:"15"})]}),Wn=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("path",{d:"M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"})}),Xn=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),d.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]}),Yn=()=>d.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"3",y1:"12",x2:"21",y2:"12"}),d.jsx("line",{x1:"3",y1:"6",x2:"21",y2:"6"}),d.jsx("line",{x1:"3",y1:"18",x2:"21",y2:"18"})]}),Kn=()=>d.jsx("svg",{width:"16",height:"16",viewBox:"0 0 512 512",fill:"currentColor",children:d.jsx("path",{d:"M0,0v512h512V106.9l-6.5-7.3L412.4,6.5L405.1,0H0z M46.5,46.5h69.8v139.6h279.3V56.7l69.8,69.8v338.9h-46.5V256H93.1v209.5H46.5V46.5z M162.9,46.5H256V93h46.5V46.5H349v93.1H162.9V46.5z M139.6,302.5h232.7v162.9H139.6V302.5z"})}),Jn=()=>d.jsx("svg",{width:"16",height:"16",viewBox:"190 230 680 620",fill:"currentColor",children:d.jsx("path",{d:"M257.3312 451.84V332.8c0-42.3936 34.2016-76.8 76.4416-76.8h107.8272c29.5936 0 56.5248 17.152 69.12 44.032l14.8992 31.6416a25.4976 25.4976 0 0 0 23.04 14.6944h192.8192c42.1888 0 76.4416 34.3552 76.4416 76.8v28.672a76.8 76.8 0 0 1 50.9952 88.064l-43.3152 217.6A76.544 76.544 0 0 1 750.6432 819.2H324.5568a76.544 76.544 0 0 1-74.9568-61.7472l-43.3152-217.6a76.8512 76.8512 0 0 1 51.0464-88.0128z m509.5936-3.84v-24.832c0-14.1312-11.4176-25.6-25.4464-25.6h-192.8192a76.4416 76.4416 0 0 1-69.12-44.032l-14.848-31.6928A25.4976 25.4976 0 0 0 441.6 307.2H333.7216a25.5488 25.5488 0 0 0-25.4976 25.6v115.2h458.6496z m-485.6832 51.2a25.6 25.6 0 0 0-24.9856 30.6176l43.3152 217.6c2.4064 11.9808 12.8512 20.5824 24.9856 20.5824h426.0864a25.4976 25.4976 0 0 0 24.9856-20.5824l43.3152-217.6a25.7024 25.7024 0 0 0-24.9856-30.6176H281.2416z"})}),Zn=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("circle",{cx:"12",cy:"12",r:"10"}),d.jsx("line",{x1:"12",cy:"16",x2:"12",y2:"12"}),d.jsx("line",{x1:"12",cy:"8",x2:"12.01",y2:"8"})]}),Qn=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("circle",{cx:"12",cy:"12",r:"10"}),d.jsx("path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"}),d.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]}),es=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M3 10h10a5 5 0 0 1 5 5v2"}),d.jsx("path",{d:"M7 6l-4 4 4 4"})]}),ts=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M21 10h-10a5 5 0 0 0 -5 5v2"}),d.jsx("path",{d:"M17 6l4 4 -4 4"})]}),os=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}),d.jsx("path",{d:"M3 3v5h5"})]}),as=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("polyline",{points:"20 6 9 17 4 12"})}),rs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),d.jsx("polyline",{points:"17 8 12 3 7 8"}),d.jsx("line",{x1:"12",y1:"3",x2:"12",y2:"15"})]}),is=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),d.jsx("polyline",{points:"7 10 12 15 17 10"}),d.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),ns=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"4",children:[d.jsx("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),d.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"})]}),ss=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}),d.jsx("path",{d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"})]}),ls=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("path",{d:"M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"})}),cs=()=>d.jsxs("svg",{width:"64",height:"64",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"5",y:"2",width:"14",height:"20",rx:"2",ry:"2"}),d.jsx("path",{d:"M12 18h.01"})]}),ds=({className:e})=>d.jsxs("svg",{className:e,xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",children:[d.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4"}),d.jsx("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}),us=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"16 18 22 12 16 6"}),d.jsx("polyline",{points:"8 6 2 12 8 18"})]}),fs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("circle",{cx:"12",cy:"12",r:"10"}),d.jsx("path",{d:"M8 14s1.5 2 4 2 4-2 4-2"}),d.jsx("line",{x1:"9",y1:"9",x2:"9.01",y2:"9"}),d.jsx("line",{x1:"15",y1:"9",x2:"15.01",y2:"9"})]}),ps=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"}),d.jsx("polyline",{points:"3.27 6.96 12 12.01 20.73 6.96"}),d.jsx("line",{x1:"12",y1:"22.08",x2:"12",y2:"12"})]}),hs=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",strokeDasharray:"4 4"}),d.jsx("path",{d:"M9 12l2 2 4-4"})]}),ms=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"})}),gs=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("circle",{cx:"12",cy:"12",r:"10"})}),ys=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 512 512",fill:"currentColor",children:d.jsx("path",{d:"M167.4,59.1l-6.2,8l-23.4,31.4h-19.7V78.8H39.4v19.7H0v354.5h512V98.5H374.2l-23.4-31.4l-6.2-8H167.4z M187.1,98.5h137.8l23.4,31.4l6.2,8h118.2v78.8H358.2c-20.5-35.2-58.7-59.1-102.2-59.1s-81.6,23.9-102.2,59.1H39.4v-78.8h118.2l6.2-8L187.1,98.5z M393.8,157.5v39.4h39.4v-39.4H393.8z M256,196.9c43.8,0,78.8,35,78.8,78.8s-35,78.8-78.8,78.8s-78.8-35-78.8-78.8S212.2,196.9,256,196.9z M39.4,256h100.3c-1.1,6.3-1.8,13.1-1.8,19.7c0,65,53.2,118.2,118.2,118.2s118.2-53.2,118.2-118.2c0-6.6-0.8-13.4-1.8-19.7h100.3v157.5H39.4V256z"})}),bs=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 3v18"}),d.jsx("path",{d:"M3 12h18"}),d.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),vs=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"})}),xs=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polygon",{points:"12 2 2 7 12 12 22 7 12 2"}),d.jsx("polyline",{points:"2 17 12 22 22 17"}),d.jsx("polyline",{points:"2 12 12 17 22 12"})]}),Ss=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 2l-5 9h10l-5 9"}),d.jsx("path",{d:"M12 2v20"})]}),ws=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M6 2v14a2 2 0 0 0 2 2h14"}),d.jsx("path",{d:"M18 22V8a2 2 0 0 0-2-2H2"})]}),_s=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),d.jsx("line",{x1:"9",y1:"9",x2:"15",y2:"15"}),d.jsx("line",{x1:"15",y1:"9",x2:"9",y2:"15"})]}),Is=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"14",width:"7",height:"7"}),d.jsx("path",{d:"M3 14h7v7H3z",fill:"currentColor",stroke:"none"})]}),Cs=()=>d.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:d.jsx("path",{d:"M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM7 10h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"})}),Ms=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"14",width:"7",height:"7"}),d.jsx("path",{d:"M10 7h4"}),d.jsx("path",{d:"M17 10v4"})]}),Rs=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 22V8"}),d.jsx("path",{d:"M5 12H2a10 10 0 0 0 20 0h-3"}),d.jsx("circle",{cx:"12",cy:"5",r:"3"})]}),Ls=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 18V8"}),d.jsx("path",{d:"M5 12H2a10 10 0 0 0 20 0h-3"}),d.jsx("circle",{cx:"12",cy:"5",r:"3"}),d.jsx("line",{x1:"3",y1:"21",x2:"21",y2:"3",stroke:"currentColor",opacity:"0.9"})]}),Ps=({status:e})=>{let o="currentColor";e==="keyed"||e==="partial"?o="#f59e0b":(e==="dirty"||e==="keyed-dirty")&&(o="#ef4444");const t=e==="keyed"||e==="keyed-dirty"?o:"none";return d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:o,strokeWidth:"2.5",children:d.jsx("path",{d:"M12 2L2 12l10 10 10-10L12 2z",fill:t})})},Ts=({active:e})=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"#666",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"}),d.jsx("path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"})]}),Es=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M10 13l-4 4"}),d.jsx("path",{d:"M14 11l4 -4"})]}),ks=({active:e})=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:e?"#f59e0b":"#666",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"16 18 22 12 16 6"}),d.jsx("polyline",{points:"8 6 2 12 8 18"})]}),zs=({open:e})=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:`transition-transform ${e?"rotate-90":""}`,children:d.jsx("path",{d:"M9 18l6-6-6-6"})}),As=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"2",y:"2",width:"20",height:"20",rx:"5",ry:"5"}),d.jsx("path",{d:"M16 8h.01"}),d.jsx("path",{d:"M8 8h.01"}),d.jsx("path",{d:"M8 16h.01"}),d.jsx("path",{d:"M16 16h.01"}),d.jsx("path",{d:"M12 12h.01"})]}),Ds=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"16 3 21 3 21 8"}),d.jsx("line",{x1:"4",y1:"20",x2:"21",y2:"3"}),d.jsx("polyline",{points:"21 16 21 21 16 21"}),d.jsx("line",{x1:"15",y1:"15",x2:"21",y2:"21"}),d.jsx("line",{x1:"4",y1:"4",x2:"9",y2:"9"})]}),Fs=()=>d.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:d.jsx("path",{d:"M8 5v14l11-7z"})}),Os=()=>d.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:d.jsx("path",{d:"M6 19h4V5H6v14zm8-14v14h4V5h-4z"})}),js=()=>d.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:d.jsx("path",{d:"M6 6h12v12H6z"})}),Ns=({active:e})=>d.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:e?"currentColor":"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("circle",{cx:"12",cy:"12",r:"10",stroke:e?"none":"currentColor",fill:e?"#ef4444":"none"})}),$s=({active:e})=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",children:d.jsx("path",{d:"M3 18C3 18 6 5 12 12C18 19 21 5 21 5"})}),Bs=({active:e})=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",children:[d.jsx("rect",{x:"3",y:"8",width:"6",height:"8"}),d.jsx("rect",{x:"15",y:"8",width:"6",height:"8"})]}),Hs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"}),d.jsx("path",{d:"M4 22v-7"}),d.jsx("path",{d:"M8 4v10"}),d.jsx("path",{d:"M12 5v10"}),d.jsx("path",{d:"M16 4v10"}),d.jsx("path",{d:"M4 8h16"}),d.jsx("path",{d:"M4 12h16"})]}),Vs=({active:e})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),d.jsx("line",{x1:"3",y1:"9",x2:"21",y2:"9"}),d.jsx("line",{x1:"3",y1:"15",x2:"21",y2:"15"}),d.jsx("line",{x1:"9",y1:"3",x2:"9",y2:"21"}),d.jsx("line",{x1:"15",y1:"3",x2:"15",y2:"21"})]}),Gs=({mode:e})=>d.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e==="Loop"||e==="PingPong"?d.jsx("path",{d:"M17 2l4 4-4 4 M3 11v-1a4 4 0 0 1 4-4h14 M7 22l-4-4 4-4 M21 13v1a4 4 0 0 1-4 4H3"}):d.jsx("path",{d:"M5 12h14 M12 5l7 7-7 7"})}),Us=({active:e,arming:o})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M3 12h18",strokeOpacity:e||o?.3:.2}),d.jsx("path",{d:"M3 12 Q 6 2, 9 12 T 15 12 T 21 12",stroke:e?"#ef4444":o?"#fca5a5":"currentColor"}),o&&!e&&d.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"#fca5a5",stroke:"none"})]}),qs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"4 14 10 14 10 20"}),d.jsx("polyline",{points:"20 10 14 10 14 4"}),d.jsx("line",{x1:"14",y1:"10",x2:"21",y2:"3"}),d.jsx("line",{x1:"3",y1:"21",x2:"10",y2:"14"})]}),Ws=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"}),d.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"currentColor",stroke:"none"})]}),Xs=({active:e})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"4",y1:"20",x2:"20",y2:"20"}),d.jsx("line",{x1:"4",y1:"4",x2:"20",y2:"4"}),d.jsx("polyline",{points:"4 14 8 10 12 14 16 10 20 14"})]}),Ys=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"}),d.jsx("path",{d:"M4 12h16"}),d.jsx("path",{d:"M12 4v16"}),d.jsx("path",{d:"M16 16l-4 4-4-4"})]}),Ks=({active:e})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M19 13l-7-7-7 7"}),d.jsx("path",{d:"M5 19l7-7 7 7"}),d.jsx("path",{d:"M12 5l2-2 2 2-2 2-2-2z",fill:e?"#22d3ee":"none",stroke:"none"}),d.jsx("path",{d:"M12 5l-2-2-2 2 2 2 2-2z",fill:e?"#22d3ee":"none",stroke:"none"})]}),Js=({active:e})=>d.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("path",{d:"M2 12s3-7 7-7 7 7 7 7 3-7 7-7"})}),Zs=({active:e})=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",className:e?"text-gray-200":"text-gray-600",children:[d.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),d.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),Gi=e=>{const{value:o,onChange:t,onDragStart:a,onDragEnd:r,step:i=.01,sensitivity:n=1,hardMin:l,hardMax:s,mapping:c,disabled:u,dragThreshold:h=2}=e,[f,p]=P.useState(!1),g=P.useRef(null),b=P.useRef(0),m=P.useRef(0),y=P.useRef(!1),v=P.useRef(!1),w=P.useRef(!1),k=P.useRef(null),S=P.useCallback((x,z)=>{let J=i*.5*n;return x&&(J*=10),z&&(J*=.1),J},[i,n]),C=P.useCallback(x=>{if(u||x.button!==0)return;x.preventDefault(),x.stopPropagation(),x.currentTarget.setPointerCapture(x.pointerId),k.current=x.pointerId,b.current=x.clientX;const z=c?c.toDisplay(o):o;m.current=isNaN(z)?0:z,y.current=!1,v.current=x.shiftKey,w.current=x.altKey,p(!0),a==null||a()},[o,c,u,a]),L=P.useCallback(x=>{if(u||!f||!x.currentTarget.hasPointerCapture(x.pointerId))return;const z=x.clientX-b.current;if(Math.abs(z)>h&&(y.current=!0),!y.current)return;x.preventDefault(),x.stopPropagation();const J=v.current!==x.shiftKey,ce=w.current!==x.altKey;if(J||ce){const F=S(v.current,w.current),$=m.current+z*F;m.current=$,b.current=x.clientX,v.current=x.shiftKey,w.current=x.altKey}const ae=S(x.shiftKey,x.altKey);let Z=m.current+z*ae;l!==void 0&&(Z=Math.max(l,Z)),s!==void 0&&(Z=Math.min(s,Z));const _=c?c.fromDisplay(Z):Z;isNaN(_)||(g.current=_,t(_))},[f,u,i,l,s,c,t,S,h]),T=P.useCallback(x=>{u||(x.currentTarget.releasePointerCapture(x.pointerId),k.current=null,p(!1),g.current=null,r==null||r())},[u,r]),O=P.useCallback(()=>{const x=!y.current;return y.current=!1,x},[]);return{isDragging:f,immediateValueRef:g,handlePointerDown:C,handlePointerMove:L,handlePointerUp:T,handleClick:O}},Ui=e=>{const{value:o,mapping:t,onChange:a,onDragStart:r,onDragEnd:i,disabled:n,mapTextInput:l=!1}=e,[s,c]=P.useState(!1),[u,h]=P.useState(""),f=P.useRef(null),p=P.useRef(""),g=P.useCallback(()=>{if(n)return;c(!0);const S=l&&t?t.toDisplay(o):o,C=typeof S=="number"?parseFloat(S.toFixed(6)):S??0,L=String(C);h(L),p.current=L,setTimeout(()=>{f.current&&(f.current.focus(),f.current.select())},10)},[o,t,n,l]),b=P.useCallback(()=>{const S=p.current;let C;if(t!=null&&t.parseInput&&l?C=t.parseInput(S):(C=parseFloat(S),isNaN(C)&&(C=null)),C!==null){const L=l&&t?t.fromDisplay(C):C;r==null||r(),a(L),i==null||i()}c(!1)},[t,a,r,i,l]),m=P.useCallback(()=>{c(!1)},[]),y=P.useCallback(S=>{h(S),p.current=S},[]),v=P.useCallback(S=>{S.key==="Enter"?(S.preventDefault(),b()):S.key==="Escape"&&(S.preventDefault(),m()),S.key!=="Tab"&&S.stopPropagation()},[b,m]),w=P.useCallback(()=>{s||g()},[s,g]),k=P.useCallback(()=>{s&&b()},[s,b]);return{isEditing:s,inputValue:u,inputRef:f,startEditing:g,commitEdit:b,cancelEdit:m,handleInputChange:y,handleKeyDown:v,handleFocus:w,handleBlur:k}},Go=e=>e===0||Math.abs(e)<1e-9?"0":parseFloat(e.toFixed(8)).toString(),ho={toDisplay:e=>e/Math.PI,fromDisplay:e=>e*Math.PI,format:e=>{const o=e/Math.PI,t=Math.abs(o),a=o<0?"-":"";if(t<.001)return"0";if(Math.abs(t-1)<.001)return`${a}π`;if(Math.abs(t-.5)<.001)return`${a}π/2`;if(Math.abs(t-.25)<.001)return`${a}π/4`;if(Math.abs(t-.75)<.001)return`${a}3π/4`;if(Math.abs(t-2)<.001)return`${a}2π`;const r=Math.round(t*3);if(Math.abs(t-r/3)<.001&&r!==0){if(r===1)return`${a}π/3`;if(r===2)return`${a}2π/3`;if(r===3)return`${a}π`;if(r===4)return`${a}4π/3`;if(r===5)return`${a}5π/3`}return`${a}${t.toFixed(2)}π`},parseInput:e=>{const o=e.trim().toLowerCase().replace(/\s/g,"");if(o==="π"||o==="pi")return Math.PI;if(o==="-π"||o==="-pi")return-Math.PI;if(o.includes("π")||o.includes("pi")){const a=o.replace(/[πpi]/g,"");if(a.includes("/")){const[n,l]=a.split("/").map(c=>parseFloat(c)||1);return(o.startsWith("-")?-1:1)*(Math.abs(n)/l)*Math.PI}const r=a?parseFloat(a):1;return isNaN(r)?null:(o.startsWith("-")?-1:1)*Math.abs(r)*Math.PI}const t=parseFloat(o);return isNaN(t)?null:t}},Qe={toDisplay:e=>e*(180/Math.PI),fromDisplay:e=>e*(Math.PI/180),format:e=>`${(e*(180/Math.PI)).toFixed(1)}°`,parseInput:e=>{const o=e.trim().replace(/°/g,""),t=parseFloat(o);return isNaN(t)?null:t}},Uo=(e,o,t,a)=>{const r=a?a.toDisplay(e):e,i=a?a.toDisplay(o):o,n=a?a.toDisplay(t):t;return Math.max(0,Math.min(100,(r-i)/(n-i)*100))},wt=({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r=.01,sensitivity:i=1,min:n,max:l,hardMin:s,hardMax:c,mapping:u,format:h,mapTextInput:f,disabled:p=!1,highlight:g=!1,liveValue:b,defaultValue:m,onImmediateChange:y})=>{const v=te.useRef(null),w=te.useCallback(H=>h?h(H):u!=null&&u.format?u.format(H):Go(H),[h,u]),{isDragging:k,immediateValueRef:S,handlePointerDown:C,handlePointerMove:L,handlePointerUp:T,handleClick:O}=Gi({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,sensitivity:i,hardMin:s,hardMax:c,mapping:u,disabled:p}),x=te.useCallback(H=>{L(H);const Q=S.current;Q!==null&&(v.current&&(v.current.textContent=w(Q)),y==null||y(Q))},[L,S,w,y]),{isEditing:z,inputValue:J,inputRef:ce,startEditing:ae,handleInputChange:Z,handleKeyDown:_,handleBlur:F}=Ui({value:e,mapping:u,onChange:o,onDragStart:t,onDragEnd:a,disabled:p,mapTextInput:f}),$=te.useMemo(()=>w(e),[e,w]),de=te.useCallback(()=>{!p&&!z&&ae()},[p,z,ae]),re=te.useCallback(H=>{if(p)return;O()&&ae()},[p,O,ae]),q=`
        ...
        ${k?"bg-cyan-500/20 text-cyan-300":(k||g||b!==void 0&&!p)&&!p?"text-cyan-400":p?"":"text-gray-300 hover:text-white"}
    `;return z?d.jsx("input",{ref:ce,type:"text",value:J,onChange:H=>Z(H.target.value),onBlur:F,onKeyDown:_,className:"w-full h-full bg-gray-900 text-white text-xs border-none outline-none font-mono text-center px-1",onClick:H=>H.stopPropagation(),autoFocus:!0}):d.jsx("div",{ref:v,"data-role":"value",tabIndex:p?-1:0,onPointerDown:C,onPointerMove:x,onPointerUp:T,onClick:re,onFocus:de,className:q,title:p?"Disabled":"Click to edit, Drag to adjust (Shift=Fast, Alt=Slow)",children:$})},qi=({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r=.01,min:i,max:n,hardMin:l,hardMax:s,mapping:c,format:u,overrideText:h,mapTextInput:f,label:p,labelSuffix:g,headerRight:b,showTrack:m=!0,trackPosition:y="below",trackHeight:v=20,variant:w="full",className:k="",defaultValue:S,onReset:C,liveValue:L,showLiveIndicator:T=!0,onContextMenu:O,dataHelpId:x,disabled:z=!1,highlight:J=!1})=>{const ce=te.useRef(null),ae=te.useRef(null),Z=te.useRef(null),_=te.useRef({active:!1,startX:0,startValue:0,lastShift:!1,lastAlt:!1}),F=i!==void 0&&n!==void 0&&i!==n,$=te.useMemo(()=>{if(!F)return 0;const E=c?c.toDisplay(e):e,A=c?c.toDisplay(i):i,fe=c?c.toDisplay(n):n;return Math.max(0,Math.min(100,(E-A)/(fe-A)*100))},[e,i,n,c,F]),de=te.useMemo(()=>{if(!F||L===void 0)return 0;const E=c?c.toDisplay(L):L,A=c?c.toDisplay(i):i,fe=c?c.toDisplay(n):n;return Math.max(0,Math.min(100,(E-A)/(fe-A)*100))},[L,i,n,c,F]),re=te.useMemo(()=>{if(!F||S===void 0)return null;const E=c?c.toDisplay(S):S,A=c?c.toDisplay(i):i,fe=c?c.toDisplay(n):n;return(E-A)/(fe-A)*100},[S,i,n,c,F]),V=te.useCallback(E=>F?Uo(E,i,n,c):0,[F,i,n,c]),q=te.useCallback(E=>{var se;const A=V(E),fe=`${A}%`;ce.current&&(ce.current.style.width=fe),ae.current&&(ae.current.style.width=fe);const Ie=(se=Z.current)==null?void 0:se.querySelector('[data-role="thumb"]');Ie&&(Ie.style.left=`calc(${A}% - 8px)`)},[V]),H=te.useCallback(E=>r?Math.round(E/r)*r:E,[r]),Q=te.useCallback(E=>{if(z||!F||E.button!==0)return;E.preventDefault(),E.stopPropagation(),E.currentTarget.setPointerCapture(E.pointerId);const A=E.currentTarget.getBoundingClientRect(),fe=Math.max(0,Math.min(1,(E.clientX-A.left)/A.width)),Ie=c?c.toDisplay(i):i,se=c?c.toDisplay(n):n,Pe=H(Ie+fe*(se-Ie));let Se=c?c.fromDisplay(Pe):Pe;l!==void 0&&(Se=Math.max(l,Se)),s!==void 0&&(Se=Math.min(s,Se)),o(Se),q(Se);const Ce=_.current;Ce.active=!0,Ce.startX=E.clientX,Ce.startValue=Pe,Ce.lastShift=E.shiftKey,Ce.lastAlt=E.altKey,t==null||t()},[z,F,i,n,c,l,s,o,t,q,H]),X=te.useCallback(E=>{const A=_.current;if(!A.active||z||!F)return;E.preventDefault();const Ie=E.currentTarget.getBoundingClientRect().width,se=c?c.toDisplay(i):i,Pe=c?c.toDisplay(n):n,Ce=(Pe-se)/Ie;if(A.lastShift!==E.shiftKey||A.lastAlt!==E.altKey){const pt=Ce*(A.lastShift?10:1)*(A.lastAlt?.1:1),at=E.clientX-A.startX;A.startValue=A.startValue+at*pt,A.startX=E.clientX,A.lastShift=E.shiftKey,A.lastAlt=E.altKey}let Ke=Ce;E.shiftKey&&(Ke*=10),E.altKey&&(Ke*=.1);const ft=E.clientX-A.startX;let $e=H(A.startValue+ft*Ke);$e=Math.max(se,Math.min(Pe,$e));let Te=c?c.fromDisplay($e):$e;l!==void 0&&(Te=Math.max(l,Te)),s!==void 0&&(Te=Math.min(s,Te)),isNaN(Te)||(o(Te),q(Te))},[z,F,i,n,c,l,s,o,q,H]),ne=te.useCallback(E=>{const A=_.current;A.active&&(A.active=!1,E.currentTarget.releasePointerCapture(E.pointerId),a==null||a())},[a]),De=te.useCallback(()=>{S!==void 0&&!z&&(t==null||t(),o(S),a==null||a(),C==null||C())},[S,z,o,t,a,C]),Le=J||L!==void 0,Ne=w==="compact";return w==="minimal"?d.jsx("div",{className:k,children:d.jsx(wt,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:l,hardMax:s,mapping:c,format:h?()=>h:u,mapTextInput:f,defaultValue:S,disabled:z,highlight:Le,onImmediateChange:q})}):Ne?d.jsxs("div",{className:`relative flex-1 h-9 md:h-[26px] overflow-hidden group transition-all duration-150 ${z?"opacity-70 pointer-events-none":""} ${k}`,onContextMenu:O,"data-help-id":x,children:[d.jsx("div",{className:"absolute inset-0 bg-white/[0.12]",style:z?{}:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255,255,255,0.03) 5px, rgba(255,255,255,0.03) 10px)"}}),m&&F&&d.jsx("div",{ref:ce,"data-role":"fill",className:`absolute top-0 bottom-0 left-0 pointer-events-none ${z?"bg-gray-500/20":Le?"bg-cyan-500/30":"bg-cyan-500/20"}`,style:{width:`${$}%`}}),T&&L!==void 0&&!z&&F&&d.jsx("div",{className:"absolute top-0 bottom-0 w-1.5 bg-purple-500 blur-[1px] transition-all duration-75 ease-out z-0",style:{left:`calc(${de}% - 0.75px)`}}),d.jsx("div",{className:"absolute inset-0",children:d.jsx(wt,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:l,hardMax:s,mapping:c,format:h?()=>h:u,mapTextInput:f,defaultValue:S,disabled:z,highlight:Le,onImmediateChange:q})}),Le&&!z&&d.jsx("div",{className:"absolute inset-0 bg-cyan-500/10 pointer-events-none"})]}):d.jsxs("div",{className:`mb-px animate-slider-entry ${z?"opacity-70 pointer-events-none":""} ${k}`,"data-help-id":x,onContextMenu:O,children:[p&&d.jsxs("div",{className:"flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5",children:[d.jsxs("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:[b,d.jsxs("label",{className:`text-[10px] font-medium tracking-tight select-none flex items-center gap-2 truncate pointer-events-none ${z?"text-gray-600":"text-gray-400"}`,children:[p,g,L!==void 0&&!z&&d.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-purple-500 animate-pulse shadow-[0_0_4px_#a855f7]"})]})]}),d.jsx("div",{className:"w-1/2 relative bg-white/[0.02] border-l border-white/10 group/num-area touch-none",style:z?{}:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255,255,255,0.03) 5px, rgba(255,255,255,0.03) 10px)"},children:d.jsx(wt,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:l,hardMax:s,mapping:c,format:h?()=>h:u,mapTextInput:f,defaultValue:S,disabled:z,highlight:Le,onImmediateChange:q})})]}),m&&F&&d.jsxs("div",{ref:Z,className:`relative flex items-center touch-none overflow-hidden ${z?"cursor-not-allowed":"cursor-ew-resize"}`,style:{touchAction:"none",height:v},onPointerDown:Q,onPointerMove:X,onPointerUp:ne,children:[d.jsxs("div",{className:"absolute inset-0 bg-white/10",children:[d.jsx("div",{ref:ae,className:`absolute top-0 bottom-0 left-0 ${z?"bg-gray-400/20":"bg-cyan-500/30"}`,style:{width:`${$}%`}}),T&&L!==void 0&&!z&&d.jsx("div",{className:"absolute top-0 bottom-0 w-1.5 bg-purple-500 blur-[1px] transition-all duration-75 ease-out z-0",style:{left:`calc(${de}% - 0.75px)`}})]}),d.jsx("div",{"data-role":"thumb",className:"absolute top-0 bottom-0 w-4 z-10 pointer-events-none border-l border-r transition-colors",style:{left:`calc(${$}% - 8px)`,borderColor:z?"rgba(255,255,255,0.1)":"rgba(255,255,255,0.25)"}}),re!==null&&d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"absolute w-0.5 h-full bg-white/40 pointer-events-none z-0 transform -translate-x-1/2",style:{left:`${re}%`}}),d.jsx("button",{onPointerDown:E=>{E.preventDefault(),E.stopPropagation()},onClick:E=>{E.preventDefault(),E.stopPropagation(),De()},className:"absolute top-0 bottom-0 right-0 w-2 bg-gray-500/20 hover:bg-gray-400/50 cursor-pointer z-20 transition-colors border-l border-black/10",title:`Reset to ${S}`,"aria-label":"Reset to default",tabIndex:-1})]})]})]})},Wi=[{label:"X",color:"bg-red-500",text:"text-red-400",border:"group-focus-within:border-red-500/50",hoverBg:"hover:bg-red-500/20",accent:"#ef4444"},{label:"Y",color:"bg-green-500",text:"text-green-400",border:"group-focus-within:border-green-500/50",hoverBg:"hover:bg-green-500/20",accent:"#22c55e"},{label:"Z",color:"bg-blue-500",text:"text-blue-400",border:"group-focus-within:border-blue-500/50",hoverBg:"hover:bg-blue-500/20",accent:"#3b82f6"},{label:"W",color:"bg-purple-500",text:"text-purple-400",border:"group-focus-within:border-purple-500/50",hoverBg:"hover:bg-purple-500/20",accent:"#a855f7"}],mo=e=>e.includes("red")?{on:"bg-red-500/30 text-red-300 border-red-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("green")?{on:"bg-green-500/30 text-green-300 border-green-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("amber")||e.includes("yellow")?{on:"bg-amber-500/30 text-amber-300 border-amber-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("purple")?{on:"bg-purple-500/30 text-purple-300 border-purple-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:{on:"bg-cyan-500/30 text-cyan-300 border-cyan-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"};function Qs({label:e,value:o,onChange:t,options:a,color:r="bg-cyan-600",onLfoToggle:i,isLfoActive:n,icon:l,disabled:s=!1,variant:c="default",labelSuffix:u,onContextMenu:h,...f}){const p=m=>{s||t(m)},g=()=>{s||t(!o)},b=mo(r);if(c==="dense"&&!a&&typeof o=="boolean"){const m=mo(r);return d.jsxs("div",{className:`flex items-center justify-between px-3 py-1 border-b border-white/5 hover:bg-white/5 transition-colors ${s?"opacity-50 pointer-events-none":"cursor-pointer"}`,"data-help-id":f["data-help-id"],onContextMenu:h,onClick:g,children:[d.jsxs("div",{className:"flex items-center gap-2",children:[l,d.jsx("span",{className:"text-[10px] text-gray-400 font-medium tracking-tight truncate select-none",children:e})]}),d.jsx("div",{className:`px-2 py-0.5 text-[8px] font-bold rounded-sm transition-all border ${o?m.on:m.off} ${s?"":"hover:brightness-125"}`,children:o?"ON":"OFF"})]})}return a?d.jsxs("div",{className:`mb-px animate-slider-entry ${s?"opacity-50 pointer-events-none":""}`,"data-help-id":f["data-help-id"],onContextMenu:h,children:[e&&d.jsxs("div",{className:"flex items-center bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5 px-2 gap-2",children:[l,d.jsx("span",{className:"text-[10px] text-gray-400 font-medium tracking-tight truncate select-none pointer-events-none",children:e})]}),d.jsx("div",{className:`flex h-9 md:h-[26px] overflow-hidden ${e?"rounded-b-sm":"rounded-sm"}`,children:a.map(m=>d.jsx("button",{onClick:()=>p(m.value),disabled:s,className:`
                        ...
                        `,children:d.jsx("span",{className:`text-[8px] ${o?"opacity-90":"opacity-50"}`,children:o?"ON":"OFF"})}),i&&d.jsx("button",{onClick:m=>{m.stopPropagation(),s||i()},disabled:s,className:`
                            ...
                            `,title:"LFO",children:d.jsx("span",{className:`text-[8px] ${n?"opacity-90":"opacity-50"}`,children:"LFO"})})]})]})})}const We={text:"text-cyan-400",textSubtle:"text-cyan-600",bgSolid:"bg-cyan-900",bgMed:"bg-cyan-700",bgBright:"bg-cyan-600/40",hoverBg:"hover:bg-cyan-500/50"},el={bgMed:"bg-purple-700"},go={text:"text-amber-400",bg:"bg-amber-900/20",border:"border-amber-500/20",btnBg:"bg-amber-600",btnHover:"hover:bg-amber-500",btnText:"text-black"},Xe={dock:"bg-[#080808]",tabBar:"bg-black/40",nested:"bg-black/20",divider:"bg-neutral-800",panelHeader:"bg-gray-800/80",input:"bg-gray-900",tint:"bg-white/5",hoverSubtle:"hover:bg-white/5",hoverMed:"hover:bg-white/10"},Re={primary:"text-white",label:"text-gray-400",dimLabel:"text-gray-500",faint:"text-gray-600",ghost:"text-gray-700"},qo={subtle:"border-white/5",standard:"border-white/10"},tl=`${Xe.dock} ${We.text} border-x border-t ${qo.standard} z-10 -mb-px pb-2`,ol=`${Re.dimLabel} ${Xe.hoverSubtle} hover:text-gray-300 border border-transparent`,al=`${We.bgSolid} ${We.text}`,rl=`${Re.faint} ${Xe.hoverMed}`,il=`${We.textSubtle}`,nl=`${Re.ghost}`,sl=`${Xe.nested} p-2 rounded border ${qo.subtle}`,ll=`${go.bg} border ${go.border}`,cl=`${We.bgMed} ${Re.primary}`,dl=`${Re.dimLabel} hover:text-gray-300`,ul=`${Re.ghost} cursor-not-allowed opacity-50 bg-transparent`,fl=`${We.bgBright} text-cyan-300 shadow-[inset_0_0_10px_rgba(34,211,238,0.1)]`,pl=`bg-transparent ${Re.dimLabel} hover:text-gray-300 ${Xe.hoverSubtle}`,Xi={primary:`text-[10px] font-bold ${Re.label}`,secondary:`text-[9px] font-bold ${Re.dimLabel}`,tiny:`text-[8px] ${Re.faint}`},Yi=({children:e,variant:o="primary",className:t="",color:a})=>{const r=Xi[o],i=a||"";return d.jsx("span",{className:`${r} ${i} select-none ${t}`,children:e})},hl=()=>d.jsxs(d.Fragment,{children:[d.jsx("div",{className:`h-1.5 ${Xe.divider} rounded-b-lg`}),d.jsx("div",{className:"h-2",style:{background:"linear-gradient(to bottom, transparent, rgba(255,255,255,0.08))"}})]});function ml({label:e,value:o,options:t,onChange:a,fullWidth:r,className:i="",selectClassName:n="",labelSuffix:l,onContextMenu:s,disabled:c=!1,...u}){const h=f=>{var b;const p=f.target.value,g=typeof((b=t[0])==null?void 0:b.value)=="number";a(g?Number(p):p)};return d.jsxs("div",{className:`flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5 ${r?"w-full":""} ${c?"opacity-50 pointer-events-none":""} ${i}`,"data-help-id":u["data-help-id"],onContextMenu:s,children:[e&&d.jsx("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:d.jsxs("label",{className:"text-[10px] font-medium tracking-tight select-none truncate pointer-events-none text-gray-400",children:[e,l]})}),d.jsxs("div",{className:`${e?"w-1/2":"w-full"} relative border-l border-white/10 bg-white/[0.02] border-t border-t-white/5`,children:[d.jsx("select",{value:o,onChange:h,disabled:c,className:`w-full h-full bg-transparent text-[10px] font-medium text-gray-200 px-2 pr-6 outline-none cursor-pointer appearance-none text-center ${n}`,children:t.map(f=>d.jsx("option",{value:String(f.value),className:"bg-[#111] text-gray-300",children:f.label},String(f.value)))}),d.jsx("div",{className:"absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500",children:d.jsx("div",{className:"w-2.5 h-2.5",children:d.jsx(Vi,{})})})]})]})}const Me=({axisIndex:e,value:o,min:t,max:a,step:r,onUpdate:i,onDragStart:n,onDragEnd:l,disabled:s,highlight:c,mapping:u,mapTextInput:h,liveValue:f,defaultValue:p,hardMin:g,hardMax:b,customLabel:m})=>{const y=Wi[e],v=m||y.label;return d.jsxs("div",{"data-axis-index":e,className:`relative flex-1 h-9 md:h-[26px] overflow-hidden group transition-all duration-150 ${s?"opacity-50 pointer-events-none":""}`,children:[d.jsx("div",{className:`
                ...
                `,onDoubleClick:w=>{w.preventDefault(),w.stopPropagation(),p!==void 0&&(n==null||n(),i(p),l==null||l())},title:p!==void 0?`Double-click to reset to ${p}`:"No default value",children:d.jsx("span",{className:`text-[10px] font-bold ${y.text} pointer-events-none`,children:v})}),d.jsx("div",{className:"absolute inset-0 left-5",children:d.jsx(qi,{value:o,onChange:i,onDragStart:n,onDragEnd:l,step:r,min:t,max:a,hardMin:g,hardMax:b,mapping:u,mapTextInput:h,disabled:s,highlight:c,liveValue:f,defaultValue:p,variant:"compact",showTrack:!0})})]})},yo=[{label:"X",color:"bg-red-500",text:"text-red-400",border:"group-focus-within:border-red-500/50",hoverBg:"hover:bg-red-500/20",accent:"#ef4444"},{label:"Y",color:"bg-green-500",text:"text-green-400",border:"group-focus-within:border-green-500/50",hoverBg:"hover:bg-green-500/20",accent:"#22c55e"},{label:"Z",color:"bg-blue-500",text:"text-blue-400",border:"group-focus-within:border-blue-500/50",hoverBg:"hover:bg-blue-500/20",accent:"#3b82f6"},{label:"W",color:"bg-purple-500",text:"text-purple-400",border:"group-focus-within:border-purple-500/50",hoverBg:"hover:bg-purple-500/20",accent:"#a855f7"}],it=({primaryAxis:e,secondaryAxis:o,primaryIndex:t,secondaryIndex:a,primaryValue:r,secondaryValue:i,min:n,max:l,step:s,onUpdate:c,onDragStart:u,onDragEnd:h,disabled:f,onHover:p})=>{const[g,b]=P.useState(!1),m=P.useRef(!1),y=P.useRef(!1),v=P.useRef({x:0,y:0}),w=P.useRef({primary:0,secondary:0}),k=P.useRef(!1),S=P.useRef(!1),C=P.useRef(!1),L=yo[t],T=yo[a],O=()=>{b(!0),p(!0)},x=()=>{m.current||(b(!1),p(!1))},z=_=>{f||_.button!==0&&_.button!==1||(_.preventDefault(),_.stopPropagation(),_.currentTarget.setPointerCapture(_.pointerId),v.current={x:_.clientX,y:_.clientY},w.current={primary:r,secondary:i},k.current=!1,S.current=_.shiftKey,C.current=_.altKey,m.current=!0,y.current=_.button===1,u())},J=_=>{if(f||!m.current||!_.currentTarget.hasPointerCapture(_.pointerId))return;const F=_.clientX-v.current.x,$=_.clientY-v.current.y;if((Math.abs(F)>1||Math.abs($)>1)&&(k.current=!0),!k.current&&Math.abs(F)<1&&Math.abs($)<1)return;_.preventDefault(),_.stopPropagation();const de=S.current!==_.shiftKey,re=C.current!==_.altKey;if(de||re){let V=s*.5;S.current&&(V*=10),C.current&&(V*=.1),w.current.primary=w.current.primary+F*V,w.current.secondary=w.current.secondary-$*V,v.current={x:_.clientX,y:_.clientY},S.current=_.shiftKey,C.current=_.altKey}if(y.current){let V=.01;_.shiftKey&&(V*=3),_.altKey&&(V*=.3);const q=1+$*V;let H=w.current.primary*q,Q=w.current.secondary*q;!isNaN(H)&&!isNaN(Q)&&c(H,Q)}else{let V=s*.5;_.shiftKey&&(V*=10),_.altKey&&(V*=.1);let q=w.current.primary+F*V,H=w.current.secondary-$*V;!isNaN(q)&&!isNaN(H)&&c(q,H)}},ce=_=>{f||(_.currentTarget.releasePointerCapture(_.pointerId),m.current=!1,y.current=!1,h(),k.current=!1,_.currentTarget.matches(":hover")||(b(!1),p(!1)))},ae=_=>{f||(_.preventDefault(),_.stopPropagation(),u(),c(0,0),h())},Z=g||m.current;return d.jsxs("div",{className:`
            ...
            `,onPointerDown:z,onPointerMove:J,onPointerUp:ce,onMouseEnter:O,onMouseLeave:x,onDoubleClick:ae,title:`Drag: Horizontal=${e.toUpperCase()}, Vertical=${o.toUpperCase()} | Middle-click: Scale both proportionally | Double-click: Reset (Shift=Fast, Alt=Slow)`,children:[Z&&d.jsx("div",{className:"absolute inset-0 opacity-30",style:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 3px, rgba(255,255,255,0.05) 3px, rgba(255,255,255,0.05) 6px)"}}),d.jsxs("div",{className:"relative w-full h-full",children:[d.jsx("div",{className:`
                        absolute bottom-0 left-0 h-[2px] ${L.color}
                    ...
                    `,children:[d.jsx("div",{className:`absolute w-2 h-[1px] ${L.color} -translate-x-1/2`}),d.jsx("div",{className:`absolute h-2 w-[1px] ${T.color} -translate-y-1/2`})]}),d.jsx("div",{className:`
                        absolute inset-0 pointer-events-none
                        transition-opacity duration-150
                        ${y.current?"opacity-100":"opacity-0"}
                    `,children:d.jsxs("div",{className:"absolute inset-0 flex items-center justify-center",children:[d.jsx("div",{className:"w-full h-[1px] bg-cyan-400/50 rotate-45"}),d.jsx("div",{className:"absolute w-full h-[1px] bg-cyan-400/50 -rotate-45"})]})})]})]})},bo=({azimuth:e,pitch:o,onChange:t,onDragStart:a,onDragEnd:r,disabled:i=!1,size:n=80})=>{const l=P.useRef(null),s=P.useRef(!1),[c,u]=P.useState(!1),[h,f]=P.useState(!1),[p,g]=P.useState(!1),b=P.useRef({x:0,y:0}),m=P.useRef({azimuth:e,pitch:o}),y=P.useRef({azimuth:e,pitch:o}),v=P.useRef(null);P.useEffect(()=>{m.current={azimuth:e,pitch:o}},[e,o]);const S=h?.05:.5,C=n/2,L=n*.38,T=P.useCallback((_,F,$)=>{const de=_/(Math.PI/2)*$,re=-(F/(Math.PI/2))*$;return{x:de,y:re}},[]),O=P.useMemo(()=>T(e,o,L),[e,o,L,T]),x=P.useMemo(()=>{const _=Math.cos(o),F=Math.sin(o),$=Math.cos(e),re=Math.sin(e)*_,V=F,q=-$*_,H=re,Q=-V,X=Math.sqrt(H*H+Q*Q),ne=q>0,De=X>.001?Math.min(X,1)*L:0,Le=q<=0?1+(1-Math.min(X,1))*.5:1-q*.95,Ne=X>.001?H/X*De:0,xe=X>.001?Q/X*De:0;return{x:Ne,y:xe,isBack:ne,length:De,headScale:Le,dirX:re,dirY:V,dirZ:q}},[e,o,L]),z=P.useCallback((_,F,$)=>{const de=_/$*(Math.PI/2),re=-(F/$)*(Math.PI/2);return{azimuth:de,pitch:re}},[]),J=P.useCallback((_,F)=>{let $=_,de=F;p&&v.current&&(v.current==="x"?de=0:$=0);const re=$*S,V=de*S,q=T(m.current.azimuth,m.current.pitch,L),H=q.x+re,Q=q.y+V,{azimuth:X,pitch:ne}=z(H,Q,L);p&&v.current?v.current==="x"?(m.current={azimuth:X,pitch:y.current.pitch},t(X,y.current.pitch)):(m.current={azimuth:y.current.azimuth,pitch:ne},t(y.current.azimuth,ne)):(m.current={azimuth:X,pitch:ne},t(X,ne))},[T,z,t,L,S,p]),ce=_=>{i||_.button===0&&(_.preventDefault(),_.stopPropagation(),_.currentTarget.setPointerCapture(_.pointerId),s.current=!0,u(!0),b.current={x:_.clientX,y:_.clientY},m.current={azimuth:e,pitch:o},y.current={azimuth:e,pitch:o},v.current=null,a==null||a(),f(_.altKey),g(_.shiftKey))},ae=_=>{if(i||!s.current)return;const F=_.clientX-b.current.x,$=_.clientY-b.current.y;b.current={x:_.clientX,y:_.clientY},f(_.altKey),g(_.shiftKey),p&&!v.current&&(Math.abs(F)>2||Math.abs($)>2)&&(v.current=Math.abs(F)>Math.abs($)?"x":"y"),J(F,$)},Z=_=>{s.current&&(s.current=!1,u(!1),f(!1),g(!1),v.current=null,r==null||r())};return d.jsxs("div",{ref:l,className:`
            ...
            `,style:{width:n,height:n,touchAction:"none",boxShadow:c?"0 0 20px rgba(34, 211, 238, 0.3)":"none"},onPointerDown:ce,onPointerMove:ae,onPointerUp:Z,onPointerLeave:Z,onDoubleClick:_=>{i||(_.preventDefault(),_.stopPropagation(),a==null||a(),t(0,0),r==null||r())},onContextMenu:_=>{},title:"Drag to rotate direction, Double-click to reset",children:[d.jsx("div",{className:"absolute rounded-full border border-white/10 pointer-events-none",style:{width:L*2,height:L*2,left:C-L,top:C-L}}),d.jsx("div",{className:"absolute w-full h-px bg-white/10 pointer-events-none",style:{top:C}}),d.jsx("div",{className:"absolute h-full w-px bg-white/10 pointer-events-none",style:{left:C}}),d.jsx("div",{className:"absolute w-1.5 h-1.5 bg-white/40 rounded-full pointer-events-none",style:{left:C-3,top:C-3}}),d.jsx("div",{className:"absolute pointer-events-none rounded-full transition-transform duration-75",style:{left:C+O.x,top:C+O.y,width:8,height:8,marginLeft:-4,marginTop:-4,background:x.isBack?"#ef4444":"#22d3ee",boxShadow:`0 0 8px ${x.isBack?"#ef4444":"#22d3ee"}`,transform:c?"scale(1.2)":"scale(1)"}}),x.isBack&&d.jsx("div",{className:"absolute inset-0 rounded-full border-2 border-red-500/30 pointer-events-none animate-pulse"}),d.jsxs(d.Fragment,{children:[d.jsxs("svg",{className:"absolute inset-0 pointer-events-none",style:{width:n,height:n},children:[Math.abs(e)>.01&&d.jsxs(d.Fragment,{children:[d.jsx("ellipse",{cx:C,cy:C,rx:L*Math.abs(Math.sin(e)),ry:L,fill:"none",stroke:x.isBack?"#ef4444":"#22d3ee",strokeWidth:"1.5",opacity:x.isBack?.175:.35,clipPath:x.x>0?"url(#longitudeRight)":"url(#longitudeLeft)"}),d.jsx("ellipse",{cx:C,cy:C,rx:L*Math.abs(Math.sin(e)),ry:L,fill:"none",stroke:x.isBack?"#22d3ee":"#ef4444",strokeWidth:"1.5",opacity:x.isBack?.35:.175,clipPath:x.x>0?"url(#longitudeLeft)":"url(#longitudeRight)"})]}),Math.abs(o)>.01&&d.jsxs(d.Fragment,{children:[d.jsx("ellipse",{cx:C,cy:C,rx:L,ry:L*Math.abs(Math.sin(o)),fill:"none",stroke:x.isBack?"#ef4444":"#22d3ee",strokeWidth:"1.5",opacity:x.isBack?.15:.3,clipPath:x.y<0?"url(#latitudeTop)":"url(#latitudeBottom)"}),d.jsx("ellipse",{cx:C,cy:C,rx:L,ry:L*Math.abs(Math.sin(o)),fill:"none",stroke:x.isBack?"#22d3ee":"#ef4444",strokeWidth:"1.5",opacity:x.isBack?.3:.15,clipPath:x.y<0?"url(#latitudeBottom)":"url(#latitudeTop)"})]}),d.jsxs("defs",{children:[d.jsx("clipPath",{id:"longitudeRight",children:d.jsx("rect",{x:C,y:"0",width:C,height:n})}),d.jsx("clipPath",{id:"longitudeLeft",children:d.jsx("rect",{x:"0",y:"0",width:C,height:n})}),d.jsx("clipPath",{id:"latitudeTop",children:d.jsx("rect",{x:"0",y:"0",width:n,height:C})}),d.jsx("clipPath",{id:"latitudeBottom",children:d.jsx("rect",{x:"0",y:C,width:n,height:C})})]}),d.jsx("line",{x1:C,y1:C,x2:C+x.x,y2:C+x.y,stroke:x.isBack?"#ef4444":"#22d3ee",strokeWidth:"2",strokeDasharray:"4 2",opacity:.3+x.length/L*.5}),d.jsx("polygon",{points:"0,-8 -6,4 6,4",fill:x.isBack?"#ef4444":"#22d3ee",opacity:Math.max(.1,.6+(x.headScale-1)*.4),transform:`translate(${C+x.x}, ${C+x.y}) rotate(${Math.atan2(x.y,x.x)*180/Math.PI+90}) scale(${Math.max(.9,.9+x.headScale*.1)}, ${Math.max(.05,x.headScale)})`})]}),c&&d.jsx("div",{className:"absolute -bottom-5 left-1/2 -translate-x-1/2 whitespace-nowrap",children:d.jsxs("span",{className:"text-[9px] text-cyan-400 font-mono bg-black/60 px-1 rounded",children:[(e*180/Math.PI).toFixed(0),"° / ",(o*180/Math.PI).toFixed(0),"°"]})})]})]})},_t=Math.PI/180,Ki=180/Math.PI,Ji=["x","y","z","w"],It={x:0,y:1,z:2,w:3},Zi=e=>{const o=e.length();if(o<1e-9)return{azimuth:0,pitch:0};const t=Math.max(-1,Math.min(1,e.y/o));return{azimuth:Math.atan2(e.x/o,e.z/o),pitch:Math.asin(t)}},Qi=(e,o)=>{const t=Math.cos(o);return new j(t*Math.sin(e),Math.sin(o),t*Math.cos(e))},gl=({label:e,value:o,onChange:t,min:a=-1e4,max:r=1e4,step:i=.01,disabled:n=!1,convertRadToDeg:l=!1,mode:s="normal",modeToggleable:c=!1,showLiveIndicator:u=!1,liveValue:h,defaultValue:f,hardMin:p,hardMax:g,axisMin:b,axisMax:m,axisStep:y,onDragStart:v,onDragEnd:w,headerRight:k,showDualAxisPads:S=!0,linkable:C=!1,scale:L})=>{const[T,O]=P.useState(o.clone()),[x,z]=P.useState(null),[J,ce]=P.useState(s),[ae,Z]=P.useState("degrees"),[_,F]=P.useState("degrees"),[$,de]=P.useState(C),re=P.useRef(!1),V=P.useRef(null),q=P.useRef(null);P.useEffect(()=>{ce(s)},[s]);const H=pe(I=>I.openContextMenu),Q="w"in o,X="z"in o,ne=J==="rotation",De=J==="toggle",Le=J==="mixed",Ne=J==="direction"&&X,xe=Ne?Zi(T):{azimuth:0,pitch:0},Ye=(I,D)=>{const G=Math.max(-Math.PI/2,Math.min(Math.PI/2,D)),W=Qi(I,G);se(0,I),se(1,G),O(W),t(W)};P.useEffect(()=>{if(re.current)return;const I=1e-4,D=Math.abs(o.x-T.x),G=Math.abs(o.y-T.y),W=X?Math.abs(o.z-T.z):0,me=Q?Math.abs(o.w-T.w):0;(D>I||G>I||W>I||me>I)&&O(o.clone())},[o,X,Q]);const E=()=>{re.current=!0,V.current=T.clone(),v&&v()},A=()=>{V.current=null,re.current=!1,w&&w()},fe=I=>{if(ne)return ae==="degrees"?Qe:ho;if(L==="pi")return _==="pi"?ho:Qe;if(l)return Qe},Ie=I=>{if(ne){const ee=ae==="degrees"?60*Math.PI/180:.05;return{min:-2*Math.PI,max:2*Math.PI,step:ee,hardMin:void 0,hardMax:void 0}}const D=b||{x:a,y:a,z:a},G=m||{x:r,y:r,z:r},W=y||{x:i,y:i,z:i},me=L==="pi"&&_==="degrees"?Ki:1;return{min:D[I],max:G[I],step:(W[I]??i)*me,hardMin:p,hardMax:g}},se=(I,D)=>{const G=q.current;if(!G)return;const W=G.querySelector(`[data-axis-index="${I}"]`);if(!W)return;const me=Ji[I],ee=fe(),zt=W.querySelector('[data-role="value"]');zt&&(zt.textContent=ee!=null&&ee.format?ee.format(D):Go(D));const At=W.querySelector('[data-role="fill"]');if(At){const Dt=Ie(me),Ft=Dt.min??a,Ot=Dt.max??r;if(Ft!==Ot){const Qo=Uo(D,Ft,Ot,ee);At.style.width=`${Qo}%`}}},Pe=(I,D)=>{const G=V.current||T,W=G.clone();if($&&!ne){const me=G[I],ee=D-me;W.x=G.x+ee,W.y=G.y+ee,X&&(W.z=G.z+ee),Q&&(W.w=G.w+ee),se(0,W.x),se(1,W.y),X&&se(2,W.z),Q&&se(3,W.w)}else W[I]=D;O(W),t(W)},Se=(I,D,G,W)=>{const ee=(V.current||T).clone();ee[I]=G,ee[D]=W,se(It[I],G),se(It[D],W),O(ee),t(ee)},Ce=x==="xy",Ke=x==="xy"||x==="zy",ft=x==="zy"||x==="wz",$e=x==="wz",Te=I=>{if(h)return h[I]},pt=I=>{if(f)return f[I]},at=T,Xo={x:Ce,y:Ke,z:ft,w:$e},ze=I=>({axisIndex:It[I],value:T[I],...Ie(I),onUpdate:D=>Pe(I,D),onDragStart:E,onDragEnd:A,disabled:n,highlight:Xo[I],mapping:fe(),mapTextInput:ne||L==="pi",liveValue:u?Te(I):void 0,defaultValue:pt(I)}),Yo=[{on:"bg-red-500/30 text-red-300 border-red-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-green-500/30 text-green-300 border-green-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-blue-500/30 text-blue-300 border-blue-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-purple-500/30 text-purple-300 border-purple-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}],kt=(I,D,G)=>{const me=T[I]>.5,ee=Yo[D];return d.jsxs("button",{className:`flex items-center justify-center gap-1 text-[10px] font-bold transition-all border ${me?ee.on:ee.off} ${n?"opacity-40 pointer-events-none":"cursor-pointer hover:brightness-125"} ${G||"flex-1"}`,onClick:()=>Pe(I,me?0:1),disabled:n,children:[G?null:d.jsx("span",{children:I}),d.jsx("span",{className:`text-[8px] ${me?"opacity-80":"opacity-70"}`,children:me?"ON":"OFF"})]},I)},Ko=()=>c?d.jsx("button",{onClick:()=>ce(I=>I==="rotation"?"normal":"rotation"),className:`text-[10px] p-1 rounded transition-colors mr-2 ${J==="rotation"?"text-cyan-400 bg-cyan-500/20":"text-gray-500 hover:text-gray-300"}`,title:J==="rotation"?"Rotation mode (π units)":"Normal mode",children:"⟳"}):null,Jo=()=>!C||ne?null:d.jsx("button",{onClick:()=>de(I=>!I),className:`p-1 rounded transition-colors mr-2 ${$?"text-cyan-400 bg-cyan-500/20":"text-gray-600 hover:text-gray-400"}`,title:$?"Axes linked (uniform)":"Link axes",children:d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"}),d.jsx("path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"})]})}),Zo=I=>{const D=[];ne&&D.push({label:"Rotation Units",action:()=>{},isHeader:!0},{label:"Degrees (°)",checked:ae==="degrees",action:()=>Z("degrees")},{label:"Radians (π)",checked:ae==="radians",action:()=>Z("radians")}),!ne&&L==="pi"&&D.push({label:"Display Units",action:()=>{},isHeader:!0},{label:"Radians (π)",checked:_==="pi",action:()=>F("pi")},{label:"Degrees (°)",checked:_==="degrees",action:()=>F("degrees")}),X&&(s==="rotation"||s==="axes")&&D.push({label:"Display Mode",action:()=>{},isHeader:!0},{label:"Azimuth / Pitch (A/P)",checked:J==="rotation",action:()=>ce("rotation")},{label:"Per-Axis (X/Y/Z)",checked:J==="axes"||J==="normal",action:()=>ce("normal")}),D.length!==0&&(I.preventDefault(),I.stopPropagation(),H(I.clientX,I.clientY,D,["ui.vector"]))};return d.jsxs("div",{className:"mb-px animate-slider-entry",children:[e&&d.jsxs("div",{className:"flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5",children:[d.jsxs("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:[c&&Ko(),k,d.jsx("label",{className:`text-[10px] font-medium tracking-tight select-none flex items-center gap-2 truncate pointer-events-none ${n?"text-gray-600":"text-gray-400"}`,children:e})]}),C&&!ne&&d.jsx("div",{className:"flex items-center px-1 border-l border-white/5",children:Jo()})]}),d.jsx("div",{className:"relative h-9 md:h-[26px] flex items-center touch-none overflow-hidden rounded-b-sm",style:{touchAction:"none"},onContextMenu:Zo,"data-help-id":"ui.vector",children:d.jsx("div",{ref:q,className:"flex gap-px w-full h-full",children:De?d.jsx(d.Fragment,{children:["x","y","z","w"].slice(0,Q?4:X?3:2).map((I,D)=>kt(I,D))}):Le?d.jsxs(d.Fragment,{children:[kt("x",0,"w-14 flex-shrink-0"),d.jsx(Me,{...ze("y"),disabled:n||T.x<.5})]}):Ne?d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"flex items-center justify-center px-1 flex-shrink-0",children:d.jsx(bo,{azimuth:xe.azimuth,pitch:xe.pitch,onChange:(I,D)=>{Ye(I,D)},onDragStart:E,onDragEnd:A,disabled:n,size:56})}),d.jsx(Me,{axisIndex:0,value:xe.azimuth,min:-Math.PI,max:Math.PI,step:_t,onUpdate:I=>Ye(I,xe.pitch),onDragStart:E,onDragEnd:A,disabled:n,mapping:Qe,mapTextInput:!0,customLabel:"Az"}),d.jsx(it,{primaryAxis:"x",secondaryAxis:"y",primaryIndex:0,secondaryIndex:1,primaryValue:xe.azimuth,secondaryValue:xe.pitch,min:-Math.PI,max:Math.PI,step:_t,onUpdate:(I,D)=>Ye(I,D),onDragStart:E,onDragEnd:A,disabled:n,onHover:I=>z(I?"xy":null)}),d.jsx(Me,{axisIndex:1,value:xe.pitch,min:-Math.PI/2,max:Math.PI/2,step:_t,onUpdate:I=>Ye(xe.azimuth,I),onDragStart:E,onDragEnd:A,disabled:n,mapping:Qe,mapTextInput:!0,customLabel:"Pt"})]}):ne?d.jsxs(d.Fragment,{children:[X&&d.jsx(Me,{...ze("z"),customLabel:"∠"}),d.jsx("div",{className:"flex items-center justify-center px-1",children:d.jsx(bo,{azimuth:T.x,pitch:T.y,onChange:(I,D)=>{const G=T.clone();G.x=I,G.y=D,se(0,I),se(1,D),O(G),t(G)},onDragStart:E,onDragEnd:A,disabled:n,size:56})}),d.jsx("div",{className:"contents",children:d.jsx(Me,{...ze("x"),customLabel:"A"})}),d.jsx(Me,{...ze("y"),customLabel:"P"})]}):d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"contents",children:d.jsx(Me,{...ze("x")})}),S&&d.jsx(it,{primaryAxis:"x",secondaryAxis:"y",primaryIndex:0,secondaryIndex:1,primaryValue:T.x,secondaryValue:T.y,min:a,max:r,step:i,onUpdate:(I,D)=>Se("x","y",I,D),onDragStart:E,onDragEnd:A,disabled:n,onHover:I=>z(I?"xy":null)}),d.jsx(Me,{...ze("y")}),X&&S&&d.jsx(it,{primaryAxis:"z",secondaryAxis:"y",primaryIndex:2,secondaryIndex:1,primaryValue:at.z,secondaryValue:at.y,min:a,max:r,step:i,onUpdate:(I,D)=>Se("z","y",I,D),onDragStart:E,onDragEnd:A,disabled:n,onHover:I=>z(I?"zy":null)}),X&&d.jsx(Me,{...ze("z")}),Q&&S&&d.jsx(it,{primaryAxis:"x",secondaryAxis:"z",primaryIndex:3,secondaryIndex:2,primaryValue:T.w,secondaryValue:T.z,min:a,max:r,step:i,onUpdate:(I,D)=>Se("w","z",I,D),onDragStart:E,onDragEnd:A,disabled:n,onHover:I=>z(I?"wz":null)}),Q&&d.jsx(Me,{...ze("w")})]})})})]})},en={default:"",panel:"px-2 py-0.5 text-[9px] font-bold text-gray-500 hover:text-gray-300 bg-neutral-800 rounded-sm"},tn=({open:e})=>d.jsx("svg",{className:`w-2 h-2 transition-transform ${e?"rotate-90":""}`,viewBox:"0 0 6 10",fill:"currentColor",children:d.jsx("path",{d:"M0 0l6 5-6 5z"})}),yl=({label:e,children:o,defaultOpen:t=!0,count:a,labelVariant:r="secondary",labelColor:i,rightContent:n,className:l="",headerClassName:s="",variant:c="default",open:u,onToggle:h})=>{const f=s||en[c],[p,g]=P.useState(t),b=u!==void 0,m=b?u:p,y=()=>{h&&h(),b||g(v=>!v)};return d.jsxs("div",{className:l,children:[d.jsxs("div",{className:`flex items-center gap-1.5 w-full px-2 py-1 text-left select-none hover:bg-white/5 transition-colors rounded-sm ${f}`,children:[d.jsxs("button",{onClick:y,className:"flex items-center gap-1.5 flex-1 min-w-0",children:[d.jsx(tn,{open:m}),d.jsx(Yi,{variant:r,color:i,children:e}),a!==void 0&&d.jsx("span",{className:"text-[8px] bg-white/10 text-gray-400 px-1.5 py-0.5 rounded ml-1",children:a})]}),n&&d.jsx("div",{className:"ml-auto flex items-center gap-1",children:n})]}),m&&o]})},on=`
  /*
...
`)},an=(e,o)=>{var l;const{shader:t,...a}=e,r={};(l=t.preambleVars)!=null&&l.length&&(r.preambleVars=t.preambleVars),t.usesSharedRotation&&(r.usesSharedRotation=!0);const i={...a,...Object.keys(r).length>0?{shaderMeta:r}:{},defaultPreset:o};let n=`<!--
...
`),n},rn=e=>{const o=u=>{const h=new RegExp(`<${u}>([\\s\\S]*?)<\\/${u}>`),f=e.match(h);return f?f[1].trim():null},t=o("Metadata");if(!t){try{const u=JSON.parse(e);if(u.id&&u.shader)return u}catch{}throw new Error("Invalid GMF: Missing Metadata tag")}const a=JSON.parse(t),r=o("Shader_Preamble"),i=o("Shader_Function"),n=o("Shader_Loop"),l=o("Shader_Init"),s=o("Shader_Dist");if(!i||!n)throw new Error("Invalid GMF: Missing essential shader blocks (<Shader_Function> or <Shader_Loop>)");const c={function:i,loopBody:n,preamble:r||void 0,loopInit:l||void 0,getDist:s||void 0};return a.shaderMeta&&(a.shaderMeta.preambleVars&&(c.preambleVars=a.shaderMeta.preambleVars),a.shaderMeta.usesSharedRotation&&(c.usesSharedRotation=!0),delete a.shaderMeta),{...a,shader:c}},nn=e=>{const o=e.trimStart();return o.startsWith("<!--")||o.startsWith("<Metadata>")},bl=e=>{const o=he.get(e.formula);if(!o)return JSON.stringify(e,null,2);let t=an(o,o.defaultPreset);return t+=`<!-- Full scene state (camera, lights, features, quality, animations) -->
`,t+=`<Scene>
${Wo(e)}
</Scene>
`,t},vl=e=>{if(nn(e)){const t=rn(e),a=e.match(/<Scene>([\s\S]*?)<\/Scene>/);if(a){const i=JSON.parse(a[1].trim());return{def:t,preset:i}}const r=t.defaultPreset||{formula:t.id};return r.formula||(r.formula=t.id),{def:t,preset:r}}return{preset:JSON.parse(e)}};export{ts as $,ke as A,zn as B,Fe as C,is as D,ml as E,R as F,Qs as G,gl as H,yl as I,ls as J,Ps as K,hl as L,Yn as M,yn as N,mn as O,Fs as P,Vi as Q,Is as R,qi as S,$n as T,Ls as U,vs as V,bs as W,K as X,ns as Y,ys as Z,es as _,Lt as a,sl as a$,os as a0,Hn as a1,xs as a2,bl as a3,ga as a4,Rn as a5,tt as a6,he as a7,Ts as a8,Kn as a9,Nn as aA,Fn as aB,Bn as aC,al as aD,rl as aE,Xe as aF,qo as aG,tl as aH,ol as aI,il as aJ,nl as aK,qn as aL,We as aM,Un as aN,cs as aO,Cs as aP,ms as aQ,gs as aR,kn as aS,go as aT,Re as aU,ss as aV,As as aW,Ds as aX,an as aY,ll as aZ,U as a_,Jn as aa,us as ab,Gn as ac,fn as ad,vl as ae,Zn as af,fs as ag,rs as ah,Ms as ai,ps as aj,Bi as ak,Xn as al,jn as am,Ln as an,B as ao,po as ap,ds as aq,ro as ar,Wn as as,pn as at,hn as au,gn as av,Vo as aw,bn as ax,Qn as ay,Vn as az,En as b,cl as b0,dl as b1,ul as b2,el as b3,fl as b4,pl as b5,ho as b6,Wi as b7,er as b8,rt as b9,Bs as bA,$s as bB,Hs as bC,Es as bD,wn as bE,Sn as bF,In as bG,_n as bH,ks as bI,xn as bJ,Kt as bK,jo as bL,lr as ba,cr as bb,ur as bc,dr as bd,fr as be,ni as bf,ue as bg,Pi as bh,Cn as bi,Mn as bj,zs as bk,hs as bl,Zs as bm,qs as bn,Ws as bo,Xs as bp,Ys as bq,Ks as br,Vs as bs,Js as bt,Pn as bu,Tn as bv,js as bw,Ns as bx,Us as by,Gs as bz,He as c,oe as d,Go as e,N as f,je as g,as as h,Dn as i,An as j,ot as k,Et as l,vn as m,_e as n,Os as o,Ss as p,_s as q,ws as r,On as s,Ve as t,pe as u,ut as v,Fo as w,Oo as x,Yi as y,Rs as z};
