var xe=Object.defineProperty;var ze=(e,t,o)=>t in e?xe(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o;var q=(e,t,o)=>ze(e,typeof t!="symbol"?t+"":t,o);import{ab as x,al as E,bV as I,a3 as y,aA as m,f,bW as Se,bX as we,bY as _e,bZ as Fe,b_ as Me,b$ as Ie}from"./CollapsibleSection-Cr1XafFZ.js";import{n as w,d as B,p as Ce,q as Pe,r as $,s as Z,c as g,l as O}from"./three-DQWx7qFd.js";import{u as Te,r as De,a as N,s as Ee,b as Ae}from"./FormulaFormat-C8th9DLI.js";import{a as oe,b as Re}from"./gradientSeam-Ba1Kuw2z.js";import{a as Be}from"./three-drei-DwjSMb5v.js";const X=`
...
#endif
            `)),o==="Main"||o==="Histogram"?e.addFunction(Xe()):e.addFunction(`
                float getMappingValue(float mode, vec3 p, vec4 result, vec3 n, float repeatScale) { return 0.0; }
            `)}},Ye={id:"standard",label:"Standard (Tglad)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = clamp(z, -foldLimit, foldLimit) * 2.0 - z;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2}},We={id:"mirror",label:"Mirror",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = foldLimit - abs(abs(z) - foldLimit);
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},Ke={id:"half",label:"Half-fold",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = abs(z + foldLimit);
}
`,defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:2}},Qe={id:"decoupled",label:"Decoupled",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,extraParams:{hybridFoldingValue:{type:"vec3",default:new g(2,2,2),label:"Folding Value",shortId:"hfv",uniform:"uHybridFoldingValue",min:.1,max:5,step:.01,group:"hybrid"}},defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2,hybridFoldingValue:{x:2,y:2,z:2}}},Je={id:"kali",label:"Kali",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = uHybridKaliConstant - abs(z);
}
`,rotMode:"post",extraParams:{hybridKaliConstant:{type:"vec3",default:new g(1,1,1),label:"Kali Constant",shortId:"hkc",uniform:"uHybridKaliConstant",min:-3,max:3,step:.01,group:"hybrid"}},defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.6,hybridFixedR:1,hybridIter:3,hybridKaliConstant:{x:.5,y:.5,z:.5}}},et={id:"tetra",label:"Tetrahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    if (z.x + z.y < 0.0) z.xy = -z.yx;
    if (z.x + z.z < 0.0) z.xz = -z.zx;
    if (z.y + z.z < 0.0) z.yz = -z.zy;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.25,hybridFixedR:1,hybridIter:3}},tt={id:"octa",label:"Octahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},at={id:"icosa",label:"Icosahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:4}},ot={id:"menger",label:"Menger (Cubic)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,selfContained:!0,extraParams:{hybridMengerOffset:{type:"vec3",default:new g(1,1,1),label:"Offset",shortId:"hmo",uniform:"uHybridMengerOffset",min:0,max:2,step:.01,group:"hybrid",linkable:!0},hybridMengerCenterZ:{type:"boolean",default:!0,label:"Center Z",shortId:"hmz",uniform:"uHybridMengerCenterZ",group:"hybrid"}},defaults:{hybridScale:3,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3,hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0}},L=[Ye,We,Ke,Qe,Je,et,tt,at,ot],it=L.map((e,t)=>({label:e.label,value:t}));function rt(e){return L[e]??L[0]}const nt=`
...
`,lt=["xyz","xzy","yxz","yzx","zxy","zyx"];function st(e){const t=lt[e]??"xyz";return t==="xyz"?"vec3 c_perm = c.xyz;":`vec3 c_perm = c.${t};`}function dt(e,t,o=!1){return`
mat3 hybridRotMat;
bool hybridHasRot;
...
void formula_Hybrid(inout vec4 z, inout float dr, inout float trap, vec4 c) {
    ...
    ${o?"// selfContained fold — scaling + DR handled inside foldOperation":`
...
void formula_Hybrid(inout vec4 z, inout float dr, inout float trap, vec4 c) {}`);else{const h=(o==null?void 0:o.hybridFoldType)??0,d=rt(h);e.addFunction(d.glsl);const b=(o==null?void 0:o.hybridPermute)??0,M=st(b);e.addFunction(dt(M,d.rotMode??"wrap",d.selfContained??!1))}let l="",n="";const c=t.formula,p=((v=x.get(c))==null?void 0:v.shader.selfContainedSDE)??!1,s=(o==null?void 0:o.burningEnabled)??!1;if(!p&&s&&(n+="z.xyz = mix(z.xyz, abs(z.xyz), uBurningRuntime * uBurningMix);"),r&&!p)if(!(o&&o.hybridComplex))l+=`
                ...
                `;else{const d=(o==null?void 0:o.hybridSwap)??!1;l+=`if (uHybrid > 0.5) { initHybridTransform(); }
`,n+=`
                if (uHybrid > 0.5) {
                ...
                `}e.addHybridFold("",l,n)}},Y=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF"],W=["uVec2A","uVec2B","uVec2C"],K=["uVec3A","uVec3B","uVec3C"],Q=["uVec4A","uVec4B","uVec4C"],re=["uInterlaceParamA","uInterlaceParamB","uInterlaceParamC","uInterlaceParamD","uInterlaceParamE","uInterlaceParamF"],ne=["uInterlaceVec2A","uInterlaceVec2B","uInterlaceVec2C"],le=["uInterlaceVec3A","uInterlaceVec3B","uInterlaceVec3C"],se=["uInterlaceVec4A","uInterlaceVec4B","uInterlaceVec4C"];function ft(){const e=[];for(let t=0;t<Y.length;t++)e.push([new RegExp(`\\b${Y[t]}\\b`,"g"),re[t]]);for(let t=0;t<W.length;t++)e.push([new RegExp(`\\b${W[t]}\\b`,"g"),ne[t]]);for(let t=0;t<K.length;t++)e.push([new RegExp(`\\b${K[t]}\\b`,"g"),le[t]]);for(let t=0;t<Q.length;t++)e.push([new RegExp(`\\b${Q[t]}\\b`,"g"),se[t]]);return e}const ut=ft();function j(e){let t=e;for(const[o,a]of ut)t=t.replace(o,a);return t}function k(e,t){const o=[...t].sort((i,r)=>r.length-i.length);let a=e;for(const i of o)a=a.replace(new RegExp(`\\b${i}\\b`,"g"),`interlace_${i}`);return a}function R(e){const t=[],o=/\b(?:void|vec[234]|float|int|mat[234]|bool)\s+(\w+)\s*\(/g,a=/^\s*(?:const\s+)?(?:vec[234]|float|int|mat[234]|bool)\s+([^;]+);/,i=/^\s*(\w+)/;let r=0;for(const l of e.split(`
`)){if(r===0){o.lastIndex=0;let n;for(;(n=o.exec(l))!==null;){const p=n[1];!p.startsWith("formula_")&&!t.includes(p)&&t.push(p)}const c=a.exec(l);if(c){const p=[];let s=0,v="";for(const h of c[1]){if(h==="(")s++;else if(h===")")s--;else if(h===","&&s===0){p.push(v),v="";continue}v+=h}v&&p.push(v);for(const h of p){const d=i.exec(h);d&&!t.includes(d[1])&&t.push(d[1])}}}for(const n of l)n==="{"?r++:n==="}"&&r--}return t}function mt(e,t,o){let a=e;a=a.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`);const i=R(e);for(const r of i)a=a.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return o&&o.length>0&&(a=k(a,o)),a=j(a),a}function ht(e,t,o,a){let i=e;if(i=i.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace"),i=j(i),o&&o.length>0&&(i=k(i,o)),a&&a.length>0)for(const r of a)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function gt(e,t,o){let a=e.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace");return a=a.replace(/(\bformula_Interlace\s*\(\s*[^,]+,\s*[^,]+,\s*[^,]+,\s*)c\b/,"$1cInterlace"),o&&o.length>0&&(a=k(a,o)),a}function yt(e,t,o,a){let i=e;if(i=i.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`),i=j(i),o&&o.length>0&&(i=k(i,o)),a&&a.length>0)for(const r of a)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function bt(e,t,o){let a=`
    vec4 cInterlace = vec4(c.xyz, uInterlaceParamA);`;t&&(a+=`
    ...
    }`;return{preLoop:a,inLoop:l}}const A={scalars:re,vec2s:ne,vec3s:le,vec4s:se},J=["shape:self-contained","shape:modular"];function vt(){return x.getAll().filter(e=>e.id!=="Modular").map(e=>({label:e.name,value:e.id}))}const de={interlaceParamA:"paramA",interlaceParamB:"paramB",interlaceParamC:"paramC",interlaceParamD:"paramD",interlaceParamE:"paramE",interlaceParamF:"paramF",interlaceVec3A:"vec3A",interlaceVec3B:"vec3B",interlaceVec3C:"vec3C",interlaceVec2A:"vec2A",interlaceVec2B:"vec2B",interlaceVec2C:"vec2C",interlaceVec4A:"vec4A",interlaceVec4B:"vec4B",interlaceVec4C:"vec4C"},xt=Object.fromEntries(Object.entries(de).map(([e,t])=>[t,e]));function zt(e){const t=x.get(e);if(!t)return{};const o={};for(const a of t.parameters){if(!a)continue;const i=xt[a.id];i!==void 0&&(o[i]=a.default)}return o}function ce(e,t){const o=e==null?void 0:e.interlaceFormula;if(!o)return;const a=x.get(o);if(!a)return;const i=de[t];return a.parameters.find(r=>r&&r.id===i)??void 0}function z(e){return t=>{const o=ce(t,e);if(!o)return;const a={label:o.label};return o.min!==void 0&&(a.min=o.min),o.max!==void 0&&(a.max=o.max),o.step!==void 0&&(a.step=o.step),o.mode&&(a.mode=o.mode),o.scale&&(a.scale=o.scale),o.linkable!==void 0&&(a.linkable=o.linkable),o.options&&(a.options=o.options),a}}function S(e){return t=>!!ce(t,e)}const St={id:"interlace",shortId:"il",name:"Formula Interlace",category:"Formulas",dependsOn:["coreMath","geometry"],requires:{rejects:{primary:J,secondary:J}},engineConfig:{toggleParam:"interlaceCompiled",mode:"compile",label:"Formula Interlacing",description:"Alternate between two formulas per iteration (like Mandelbulber hybrid).",groupFilter:"engine_settings"},panelConfig:{compileParam:"interlaceCompiled",runtimeToggleParam:"interlaceEnabled",compileSettingsParams:["interlaceFormula"],runtimeGroup:"interlace_runtime",label:"Interlace",compileMessage:"Compiling interlaced formula..."},params:{interlaceCompiled:{type:"boolean",default:!1,label:"Formula Interlacing",shortId:"ilc",group:"engine_settings",ui:"checkbox",description:"Compiles a secondary formula into the shader for per-iteration alternation.",onUpdate:"compile",noReset:!0,estCompileMs:1500},interlaceFormula:{type:"float",default:"Mandelbulb",label:"Secondary Formula",shortId:"ilf",group:"engine_settings",get options(){return vt().map(e=>({label:e.label,value:e.value,estCompileMs:800}))},description:"Formula to alternate with the primary formula each iteration.",onUpdate:"compile",noReset:!0,condition:{param:"interlaceCompiled",bool:!0},onSet:e=>zt(e)},interlaceEnabled:{type:"boolean",default:!1,label:"Interlace Active",shortId:"ile",uniform:"uInterlaceEnabled",group:"interlace_runtime",hidden:!0},interlaceInterval:{type:"float",default:2,label:"Interval",shortId:"ili",uniform:"uInterlaceInterval",min:1,max:10,step:1,group:"interlace_runtime",description:"Run secondary formula every N iterations.",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}]},interlaceStartIter:{type:"float",default:0,label:"Start Iter",shortId:"ils",uniform:"uInterlaceStartIter",min:0,max:20,step:1,group:"interlace_runtime",description:"First iteration where secondary formula runs.",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}]},interlaceParamA:{type:"float",default:8,label:"Param A",shortId:"ila",uniform:"uInterlaceParamA",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceParamA"),dynamicVisible:S("interlaceParamA")},interlaceParamB:{type:"float",default:0,label:"Param B",shortId:"ilb",uniform:"uInterlaceParamB",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceParamB"),dynamicVisible:S("interlaceParamB")},interlaceParamC:{type:"float",default:0,label:"Param C",shortId:"ilc2",uniform:"uInterlaceParamC",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceParamC"),dynamicVisible:S("interlaceParamC")},interlaceParamD:{type:"float",default:0,label:"Param D",shortId:"ild",uniform:"uInterlaceParamD",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceParamD"),dynamicVisible:S("interlaceParamD")},interlaceParamE:{type:"float",default:0,label:"Param E",shortId:"ile2",uniform:"uInterlaceParamE",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceParamE"),dynamicVisible:S("interlaceParamE")},interlaceParamF:{type:"float",default:0,label:"Param F",shortId:"ilf2",uniform:"uInterlaceParamF",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceParamF"),dynamicVisible:S("interlaceParamF")},interlaceVec3A:{type:"vec3",default:new g(0,0,0),label:"Vec3 A",shortId:"ilv3a",uniform:"uInterlaceVec3A",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceVec3A"),dynamicVisible:S("interlaceVec3A")},interlaceVec3B:{type:"vec3",default:new g(0,0,0),label:"Vec3 B",shortId:"ilv3b",uniform:"uInterlaceVec3B",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceVec3B"),dynamicVisible:S("interlaceVec3B")},interlaceVec3C:{type:"vec3",default:new g(0,0,0),label:"Vec3 C",shortId:"ilv3c",uniform:"uInterlaceVec3C",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceVec3C"),dynamicVisible:S("interlaceVec3C")},interlaceVec2A:{type:"vec2",default:{x:0,y:0},label:"Vec2 A",shortId:"ilv2a",uniform:"uInterlaceVec2A",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceVec2A"),dynamicVisible:S("interlaceVec2A")},interlaceVec2B:{type:"vec2",default:{x:0,y:0},label:"Vec2 B",shortId:"ilv2b",uniform:"uInterlaceVec2B",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceVec2B"),dynamicVisible:S("interlaceVec2B")},interlaceVec2C:{type:"vec2",default:{x:0,y:0},label:"Vec2 C",shortId:"ilv2c",uniform:"uInterlaceVec2C",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceVec2C"),dynamicVisible:S("interlaceVec2C")},interlaceVec4A:{type:"vec4",default:{x:0,y:0,z:0,w:0},label:"Vec4 A",shortId:"ilv4a",uniform:"uInterlaceVec4A",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceVec4A"),dynamicVisible:S("interlaceVec4A")},interlaceVec4B:{type:"vec4",default:{x:0,y:0,z:0,w:0},label:"Vec4 B",shortId:"ilv4b",uniform:"uInterlaceVec4B",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceVec4B"),dynamicVisible:S("interlaceVec4B")},interlaceVec4C:{type:"vec4",default:{x:0,y:0,z:0,w:0},label:"Vec4 C",shortId:"ilv4c",uniform:"uInterlaceVec4C",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:z("interlaceVec4C"),dynamicVisible:S("interlaceVec4C")}},groups:{interlace_runtime:{label:"Interlace Controls"}},inject:(e,t,o)=>{var d;const a=t.interlace;if(!(a!=null&&a.interlaceCompiled))return;const i=a.interlaceFormula;if(!i||i==="Modular"||t.formula==="Modular"||(d=x.get(t.formula))!=null&&d.shader.selfContainedSDE)return;const r=x.get(i);if(!r||r.shader.selfContainedSDE)return;if(o==="Mesh"){for(const b of A.scalars)e.addUniform(b,"float");for(const b of A.vec2s)e.addUniform(b,"vec2");for(const b of A.vec3s)e.addUniform(b,"vec3");for(const b of A.vec4s)e.addUniform(b,"vec4");e.addUniform("uInterlaceEnabled","float"),e.addUniform("uInterlaceInterval","float"),e.addUniform("uInterlaceStartIter","float")}const l=[...R(r.shader.preamble??""),...R(r.shader.function??""),...R(r.shader.loopInit??"")].filter((b,M,P)=>P.indexOf(b)===M);if(r.shader.preamble){const b=mt(r.shader.preamble,r.id,r.shader.preambleVars);e.addPreamble(b)}const n=ht(r.shader.function,r.id,r.shader.preambleVars,l);e.addFunction(n);const c=gt(r.shader.loopBody,r.id,r.shader.preambleVars);let p="";r.shader.loopInit&&(p=yt(r.shader.loopInit,r.id,r.shader.preambleVars,l));const s=!!r.shader.usesSharedRotation,{preLoop:v,inLoop:h}=bt(c,p,s);e.addHybridFold("",v,h)}},wt={id:"quality",shortId:"q",name:"Quality",category:"Rendering",tabConfig:{label:"Quality"},engineConfig:{toggleParam:"engineQuality",mode:"compile",label:"Loop Limits & Precision",groupFilter:"engine_settings"},params:{engineQuality:{type:"boolean",default:!0,label:"Quality Core",shortId:"qc",group:"main",noReset:!0,hidden:!0},compilerHardCap:{type:"int",default:E,label:"Hard Loop Cap",shortId:"hc",min:64,max:E,step:1,group:"engine_settings",ui:"numeric",description:"Safety limit for ray/DE loops (MAX_HARD_ITERATIONS define). Requires recompile but does not affect compile time — ANGLE/D3D does not unroll define-bounded loops.",onUpdate:"compile",noReset:!0,userScoped:!0,hidden:!0},precisionMode:{type:"float",default:0,label:"Ray Precision",shortId:"pm",group:"engine_settings",options:[{label:"High (Desktop)",value:0},{label:"Standard (Mobile)",value:1}],description:"Sets the minimum epsilon (ray hit distance). Standard prevents GPU hangs on mobile.",onUpdate:"compile",noReset:!0,userScoped:!0,hidden:!0},bufferPrecision:{type:"float",default:0,label:"Texture Buffer",shortId:"bp",group:"engine_settings",options:[{label:"Float32 (HDR)",value:0},{label:"HalfFloat16",value:1}],description:"Controls render target bit-depth. 16-bit is faster and required on some mobile GPUs.",onUpdate:"compile",noReset:!0,userScoped:!0,hidden:!0},maxSteps:{type:"int",default:300,label:"Max Ray Steps",shortId:"ms",uniform:"uMaxSteps",min:32,max:E,step:1,group:"kernel",description:"Runtime limit. Rays stop after this many steps. Artistic tool for limiting depth. Maximum is limited by Hard Loop Cap.",helpId:"quality.steps",dynamicMaxRef:"compilerHardCap"},distanceMetric:{type:"float",default:0,label:"Distance Metric",shortId:"dm",uniform:"uDistanceMetric",group:"metric",options:[{label:"Euclidean (Sphere)",value:0},{label:"Chebyshev (Box)",value:1},{label:"Manhattan (Diamond)",value:2},{label:"Minkowski 4 (Rounded)",value:3}],description:'The shape of "distance". Changes the aesthetic of the fractal surface.',helpId:"quality.metric"},estimator:{type:"float",default:0,label:"Estimator",shortId:"es",group:"metric",options:[{label:"Analytic (Log)",value:0},{label:"Linear (Unit 1.0)",value:1},{label:"Linear (Offset 2.0)",value:4},{label:"Pseudo (Raw)",value:2},{label:"Dampened",value:3},{label:"Cutting Plane",value:5,disabledIf:e=>{const t=x.get(e==null?void 0:e.formula);if(t!=null&&t.shader.supportsCuttingPlane)return!1;const o=e==null?void 0:e.interlace;if(o!=null&&o.interlaceCompiled&&o.interlaceFormula){const a=x.get(o.interlaceFormula);if(a!=null&&a.shader.supportsCuttingPlane)return!1}return!0}}],description:"Algorithm for calculating distance. Log=Smooth, Linear=Sharp/IFS, Pseudo=Artifact Fix, Cutting Plane=Knighty fold-and-cut polyhedra.",helpId:"quality.estimator",onUpdate:"compile",noReset:!0},deBailout:{type:"float",default:100,label:"DE Bailout",shortId:"eb",uniform:"uDeBailout",min:1,max:1e3,step:.01,scale:"log",group:"metric",description:"Radius² at which the raymarch DE stops iterating. High (default) keeps surfaces sharp and true to the boundary; low bails early, slicing the fractal into rounded shells (a stylistic effect). Fast-escaping formulas only respond near their structure scale.",helpId:"quality.metric"},fudgeFactor:{type:"float",default:1,label:"Slice Optimization",shortId:"ff",uniform:"uFudgeFactor",min:.01,max:1,step:.01,group:"kernel",description:"Multiplies step size. Lower = Higher quality but slower. Set to < 0.2 for deep zooms.",helpId:"quality.fudge",format:e=>e.toFixed(2)},stepRelaxation:{type:"float",default:0,label:"Step Relaxation",shortId:"sr",uniform:"uStepRelaxation",min:0,max:1,step:.01,group:"kernel",description:"Dynamic Step Size. 0 = Fixed Fudge. 1 = Variable (Fudge near surface, 1.0 in void). Saves steps.",helpId:"quality.relaxation",isAdvanced:!0},stepJitter:{type:"float",default:.15,label:"Step Jitter",shortId:"sj",uniform:"uStepJitter",min:0,max:1,step:.01,group:"kernel",description:"Stochastic step variation. Breaks banding artifacts. Higher = softer edges, artistic blur.",helpId:"quality.jitter",format:e=>e.toFixed(2)},refinementSteps:{type:"int",default:0,label:"Edge Polish",shortId:"rf",uniform:"uRefinementSteps",min:0,max:5,step:1,group:"kernel",description:"Extra micro-steps after hitting surface. Fixes slicing/banding artifacts.",helpId:"quality.detail",isAdvanced:!0},detail:{type:"float",default:1,label:"Ray detail",shortId:"rd",uniform:"uDetail",min:.1,max:10,step:.1,group:"kernel",description:"Tightens the hit threshold; higher values resolve finer surface detail.",helpId:"quality.detail"},pixelThreshold:{type:"float",default:.5,label:"Pixel threshold",shortId:"pt",uniform:"uPixelThreshold",min:.1,max:2,step:.1,group:"kernel",description:"Pixel size at which a ray is considered to have hit the surface.",helpId:"quality.threshold"},overstepTolerance:{type:"float",default:0,label:"Overstep Fix",shortId:"ot",uniform:"uOverstepTolerance",min:0,max:1e3,step:.1,scale:"log",group:"kernel",description:"Recovers details missed by the raymarcher. 0=Off. Higher values fix more holes but may create noise.",helpId:"quality.fudge"},dynamicScaling:{type:"boolean",default:!0,label:"Adaptive Resolution",shortId:"ds",group:"performance",noReset:!0,userScoped:!0,description:"Drop resolution while moving and during slow frames; restore when idle.",helpId:"quality.scale"},interactionDownsample:{type:"float",default:2,label:"Move Quality",shortId:"id",min:1,max:4,step:.5,group:"performance",condition:{and:[{param:"dynamicScaling",bool:!0},{param:"adaptiveTarget",eq:0}]},format:e=>`1/${e}x`,noReset:!0,userScoped:!0,description:"How aggressively to downscale resolution during camera movement.",helpId:"quality.scale"},adaptiveTarget:{type:"float",default:30,label:"Target FPS",shortId:"at",min:15,max:60,step:5,group:"performance",condition:{param:"dynamicScaling",bool:!0},noReset:!0,userScoped:!0,description:"Frame rate the adaptive resolver tries to maintain.",helpId:"quality.scale"},physicsProbeMode:{type:"float",default:0,label:"Distance Probe",shortId:"dp",group:"performance",isAdvanced:!0,options:[{label:"GPU Probe",value:0},{label:"Manual",value:2}],description:"GPU Probe: Reads distance from render target. Manual: Fixed value for orbit control.",helpId:"panel.quality",noReset:!0},manualDistance:{type:"float",default:10,label:"Manual Distance",shortId:"md",min:.1,max:1e3,step:.1,group:"performance",isAdvanced:!0,parentId:"physicsProbeMode",condition:{param:"physicsProbeMode",eq:2},description:"Manual distance value. Used for orbit control calculations.",helpId:"panel.quality",format:e=>e.toFixed(1),noReset:!0}},inject:(e,t)=>{const o=t.quality,a=(o==null?void 0:o.compilerHardCap)||E;e.addDefine("MAX_HARD_ITERATIONS",Math.floor(a).toString())}};function _t(e,t,o){var a,i;return!!((a=e.shader.capabilities)!=null&&a.has(o)||(i=t==null?void 0:t.shader.capabilities)!=null&&i.has(o))}class Ft{constructor(){q(this,"nodes",new Map)}register(t){this.nodes.set(t.id,t)}get(t){return this.nodes.get(t)}getAll(){return Array.from(this.nodes.values())}getGrouped(){const t={};return this.nodes.forEach(o=>{t[o.category]||(t[o.category]=[]),t[o.category].push(o.id)}),t}}const u=new Ft;u.register({id:"Note",label:"Comment / Note",category:"Utils",description:"A text block for leaving comments. Ignored by renderer.",inputs:[],glsl:e=>""});u.register({id:"AddConstant",label:"Add C (Julia/Pixel)",category:"Utils",description:"Adds the Julia Constant (or Pixel Coordinate) to the position. Essential for Mandelbrot/Julia hybrids.",inputs:[{id:"scale",label:"Strength",min:0,max:2,step:.01,default:1}],glsl:e=>`${e.indent}${e.varName}_p += c.xyz * ${e.getParam("scale")};`});u.register({id:"Scale",label:"Scale (Mult)",category:"Transforms",description:"Simple multiplication. Warning: For fractals, use IFS Scale to keep centered.",inputs:[{id:"scale",label:"Scale",min:.1,max:5,step:.01,default:2,hardMin:.001}],glsl:e=>`
...
`});u.register({id:"Custom",label:"Custom (Legacy)",category:"Utils",description:"Legacy node.",inputs:[],glsl:e=>""});const Mt=e=>{const t=new Map;return e.forEach(o=>{t.has(o.target)||t.set(o.target,[]),t.get(o.target).push(o)}),t},It=e=>{const t=new Set,o=["root-end"],a=new Set;for(;o.length>0;){const i=o.pop();a.has(i)||(a.add(i),i!=="root-end"&&i!=="root-start"&&t.add(i),(e.get(i)??[]).forEach(r=>o.push(r.source)))}return t},Ct=(e,t)=>{const o=Mt(t),a=It(o),i=e.filter(s=>a.has(s.id));if(!i||i.length===0)return`
    ...
    `;const l=new Map;l.set("root-start","v_start");let n=0;i.forEach((s,v)=>{const d=`v_${s.id.replace(/[^a-zA-Z0-9]/g,"")}`;l.set(s.id,d);const b=o.get(s.id)??[],M=b.find(F=>!F.targetHandle||F.targetHandle==="a"),P=b.find(F=>F.targetHandle==="b"),T=M&&l.get(M.source)||"v_start",ye=P&&l.get(P.source)||"v_start";if(r+=`    // Node: ${s.type} (${s.id})
`,r+=`    vec3 ${d}_p = ${T}_p;
`,r+=`    float ${d}_d = ${T}_d;
`,r+=`    float ${d}_dr = ${T}_dr;
`,s.enabled){const F=u.get(s.type);if(F){const H=s.condition&&s.condition.active;let G="    ";if(H){const D=n<I?`uModularParams[${n++}]`:"2.0",ve=n<I?`uModularParams[${n++}]`:"0.0";r+=`    { int ${d}_cmod = max(1, int(${D})); int ${d}_crem = int(${ve});
`,r+=`    if ( (i - (i/${d}_cmod)*${d}_cmod) == ${d}_crem ) {
`,G="        "}const be=D=>s.bindings&&s.bindings[D]?`u${s.bindings[D]}`:n<I?`uModularParams[${n++}]`:"0.0";r+=F.glsl({varName:d,in1:T,in2:ye,getParam:be,indent:G}),H&&(r+=`    }}
`)}}r+=`
`});const c=t.find(s=>s.target==="root-end");let p="v_start";return c&&c.source!=="root-start"&&(p=l.get(c.source)||"v_start"),r+=`
    z.xyz = ${p}_p;
    dr = ${p}_dr;
...
`},Pt=(e,t=!1)=>{if(e>4.5&&t)return`
        vec2 getDist(float r, float dr, float iter, vec4 z) {
            return vec2(abs(cp_dmin), cp_trap);
        }`;e>4.5&&(e=1);let o="d = 0.5 * log(max(r, 1.0e-5)) * r / dr_safe;";return e<.5?o=`
        float logR2 = log2(m2);
...
cp_scale = 1.0;
cp_trap = 1e10;
`,Et={id:"coreMath",shortId:"cm",name:"Formula Math",category:"Formulas",tabConfig:{label:"Formula"},extraUniforms:[{name:y.ModularParams,type:"float",arraySize:I,default:new Float32Array(I),backingOnly:!0}],params:{iterations:{type:"float",default:16,label:"Iterations",shortId:"it",uniform:"uIterations",min:1,max:500,step:1,group:"main"},paramA:{type:"float",default:8,label:"Param A",shortId:"pa",uniform:"uParamA",min:-10,max:10,step:.001,group:"params"},paramB:{type:"float",default:0,label:"Param B",shortId:"pb",uniform:"uParamB",min:-10,max:10,step:.001,group:"params"},paramC:{type:"float",default:0,label:"Param C",shortId:"pc",uniform:"uParamC",min:-10,max:10,step:.001,group:"params"},paramD:{type:"float",default:0,label:"Param D",shortId:"pd",uniform:"uParamD",min:-10,max:10,step:.001,group:"params"},paramE:{type:"float",default:0,label:"Param E",shortId:"pe",uniform:"uParamE",min:-10,max:10,step:.001,group:"params"},paramF:{type:"float",default:0,label:"Param F",shortId:"pf",uniform:"uParamF",min:-10,max:10,step:.001,group:"params"},vec2A:{type:"vec2",default:{x:0,y:0},label:"Vec2 A",shortId:"v2a",uniform:"uVec2A",min:-10,max:10,step:.001,group:"params"},vec2B:{type:"vec2",default:{x:0,y:0},label:"Vec2 B",shortId:"v2b",uniform:"uVec2B",min:-10,max:10,step:.001,group:"params"},vec2C:{type:"vec2",default:{x:0,y:0},label:"Vec2 C",shortId:"v2c",uniform:"uVec2C",min:-10,max:10,step:.001,group:"params"},vec3A:{type:"vec3",default:new g(0,0,0),label:"Vec3 A",shortId:"v3a",uniform:"uVec3A",min:-10,max:10,step:.001,group:"params"},vec3B:{type:"vec3",default:new g(0,0,0),label:"Vec3 B",shortId:"v3b",uniform:"uVec3B",min:-10,max:10,step:.001,group:"params"},vec3C:{type:"vec3",default:new g(0,0,0),label:"Vec3 C",shortId:"v3c",uniform:"uVec3C",min:-10,max:10,step:.001,group:"params"},vec4A:{type:"vec4",default:new O(0,0,0,0),label:"Vec4 A",shortId:"v4a",uniform:"uVec4A",min:-10,max:10,step:.001,group:"params"},vec4B:{type:"vec4",default:new O(0,0,0,0),label:"Vec4 B",shortId:"v4b",uniform:"uVec4B",min:-10,max:10,step:.001,group:"params"},vec4C:{type:"vec4",default:new O(0,0,0,0),label:"Vec4 C",shortId:"v4c",uniform:"uVec4C",min:-10,max:10,step:.001,group:"params"}},inject:(e,t)=>{var d;const o=t.formula,a=t.quality;o==="Modular"&&(e.addDefine("PIPELINE_REV",(t.pipelineRevision||0).toString()),e.addUniform(y.ModularParams,"float",I));const i=x.get(o);i!=null&&i.shader.selfContainedSDE&&(e.addDefine("SKIP_PRE_BAILOUT","1"),e.addDefine("SELF_CONTAINED_SDE","1"));let r="",l="",n="";const c=t.interlace,p=c!=null&&c.interlaceCompiled&&c.interlaceFormula?x.get(c.interlaceFormula):void 0,s=i?_t(i,p,"estimator:cutting-plane"):!1,v=(a==null?void 0:a.estimator)||0;let h=Pt(v,s);if(o==="Modular"){const b=Ct(t.pipeline||[],((d=t.graph)==null?void 0:d.edges)||[]);r+=b+`
...
`,l=i.shader.loopBody,n=i.shader.loopInit||"",i.shader.preamble&&e.addPreamble(i.shader.preamble),s&&(e.addPreamble(Tt),n=Dt+n),i.shader.getDist&&v<4.5&&(h=`vec2 getDist(float r, float dr, float iter, vec4 z) { ${i.shader.getDist} }`));e.addFunction(r),e.setFormula(l,n,h)}};let At=0;function C(){return`l${++At}`}const Rt={id:"shadows",label:"Shadows",renderContext:"direct",controlledParams:["lighting.shadowsCompile","lighting.shadowAlgorithm","lighting.ptStochasticShadows"],tiers:[{label:"Off",overrides:{lighting:{shadows:!1,shadowsCompile:!1,ptStochasticShadows:!1}},estCompileMs:0},{label:"Hard",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:2,ptStochasticShadows:!1}},estCompileMs:500},{label:"Soft",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!1}},estCompileMs:3e3},{label:"Full",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!0}},estCompileMs:3800}]},Bt={id:"reflections",label:"Reflections (Direct)",renderContext:"direct",controlledParams:["reflections.reflectionMode","reflections.bounceShadows","reflections.bounces"],tiers:[{label:"Off",overrides:{reflections:{reflectionMode:0,bounceShadows:!1}},estCompileMs:0},{label:"Env Map",overrides:{reflections:{reflectionMode:1,bounceShadows:!1}},estCompileMs:0},{label:"Raymarched",overrides:{reflections:{reflectionMode:3,bounceShadows:!1,bounces:1}},estCompileMs:7500},{label:"Full",overrides:{reflections:{reflectionMode:3,bounceShadows:!0,bounces:2}},estCompileMs:12e3}]},Lt={id:"lighting_quality",label:"Lighting",isAdvanced:!0,controlledParams:["lighting.specularModel","lighting.ptEnabled","lighting.ptNEEAllLights","lighting.ptEnvNEE"],tiers:[{label:"Preview",overrides:{lighting:{advancedLighting:!1,ptEnabled:!1}},estCompileMs:-2500},{label:"Path Traced",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!1,ptEnvNEE:!1}},estCompileMs:1900},{label:"PT + NEE",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!0,ptEnvNEE:!0}},estCompileMs:2500}]},kt={id:"atmosphere_quality",label:"Atmosphere",controlledParams:["atmosphere.glowEnabled","atmosphere.glowQuality","volumetric.ptVolumetric"],tiers:[{label:"Off",overrides:{atmosphere:{glowEnabled:!1},volumetric:{ptVolumetric:!1}},estCompileMs:0},{label:"Fast Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:1},volumetric:{ptVolumetric:!1}},estCompileMs:200},{label:"Color Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!1}},estCompileMs:400},{label:"Volumetric",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!0}},estCompileMs:5900}]},pe=[Rt,Bt,Lt,kt],fe=[{id:"preview",label:"Preview",description:"Instant preview shader — navigate without waiting for compile.",subsystems:{shadows:0,reflections:0,lighting_quality:0,atmosphere_quality:0}},{id:"fastest",label:"Fastest",description:"Hard shadows, path traced lighting with fast glow.",subsystems:{shadows:1,reflections:0,lighting_quality:1,atmosphere_quality:1}},{id:"lite",label:"Lite",description:"Soft shadows, env map reflections, color glow.",subsystems:{shadows:2,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"balanced",label:"Balanced",description:"Full shadows, env map reflections, color glow.",subsystems:{shadows:3,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"full",label:"Full",description:"Full shadows, raymarched reflections, volumetric.",subsystems:{shadows:3,reflections:3,lighting_quality:1,atmosphere_quality:3}},{id:"ultra",label:"Ultra",description:"Full + PT NEE. Experimental.",isAdvanced:!0,subsystems:{shadows:3,reflections:3,lighting_quality:2,atmosphere_quality:3}}];({...fe[3].subsystems});function Ot(e){return fe.find(t=>t.id===e)}function zo(e){if(!e.activePreset)return"Custom";const t=Ot(e.activePreset);if(!t)return"Custom";if(!e.isCustomized)return t.label;const o=[];for(const a of pe){const i=t.subsystems[a.id],r=e.subsystems[a.id];if(i!==r){const l=a.tiers[r];o.push(`${a.label}=${(l==null?void 0:l.label)??"?"}`)}}return`${t.label} (${o.join(", ")})`}const Vt=4200;function So(e){let t=Vt;for(const o of pe){const a=e[o.id]??0,i=o.tiers[a];i&&(t+=i.estCompileMs)}return t}const Nt=(e,t)=>{if(!e)return`
...
`;const o=256,a=t<1.5?`
    ...
    `;return`
// ------------------------------------------------------------------
// SHADOWS (${t<1.5?"Lite Soft":"Robust Soft"})
// ------------------------------------------------------------------
...
`;function ge(e){return e.id&&e.type&&e.position&&e.rotation?e:{...e,id:e.id??C(),type:e.type??"Point",position:e.position??{x:0,y:0,z:0},rotation:e.rotation??{x:0,y:0,z:0}}}function wo(e){let t=-1;for(let a=0;a<e.length;a++){const i=e[a];if(!i.id||!i.type||!i.position||!i.rotation){t=a;break}}if(t===-1)return e;const o=e.slice();for(let a=t;a<o.length;a++)o[a]=ge(o[a]);return o}const _o=(e,t)=>!e||!e.lights||t>=e.lights.length?{id:"",type:"Point",position:{x:0,y:0,z:0},rotation:{x:0,y:0,z:0},color:"#ffffff",intensity:0,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!0,radius:0,range:0,intensityUnit:"raw"}:ge(e.lights[t]),Ut=[{id:C(),type:"Point",position:{x:-2,y:1,z:2},rotation:{x:0,y:0,z:0},color:"#fff4e6",intensity:1.5,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:5500},{id:C(),type:"Point",position:{x:2,y:-1,z:1},rotation:{x:0,y:0,z:0},color:"#FFD6AA",intensity:.5,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:3500},{id:C(),type:"Point",position:{x:0,y:-5,z:2},rotation:{x:0,y:0,z:0},color:"#E0EEFF",intensity:.25,falloff:0,falloffType:"Quadratic",fixed:!0,visible:!1,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:7500}],Yt={id:"lighting",shortId:"l",name:"Lighting",category:"Rendering",tabConfig:{label:"Light",condition:{param:"$advancedMode",bool:!0}},viewportConfig:{componentId:"overlay-lighting",renderOrder:50,type:"dom"},engineConfig:{toggleParam:"advancedLighting",mode:"compile",label:"Lighting Engine",groupFilter:"engine_settings"},groups:{shadows:{label:"Shadows",description:"Per-light shadow tracing and softness.",helpId:"shadows"}},extraUniforms:[{name:y.LightCount,type:"int",default:0},{name:y.LightType,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:y.LightPos,type:"vec3",arraySize:m,default:new Array(m).fill(new g)},{name:y.LightDir,type:"vec3",arraySize:m,default:new Array(m).fill(new g(0,-1,0))},{name:y.LightColor,type:"vec3",arraySize:m,default:new Array(m).fill(new w(1,1,1))},{name:y.LightIntensity,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:y.LightShadows,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:y.LightFalloff,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:y.LightFalloffType,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:y.LightRadius,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:y.LightSoftness,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:y.LightHideEmitter,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:y.EnvCDFMarginal,type:"sampler2D",default:null},{name:y.EnvCDFConditional,type:"sampler2D",default:null},{name:y.EnvCDFSize,type:"vec2",default:new B(1,1)},{name:y.EnvLumIntegral,type:"float",default:1},{name:y.EnvCDFMipBias,type:"float",default:0}],params:{advancedLighting:{type:"boolean",default:!0,label:"Light Engine",shortId:"le",group:"main",noReset:!0,hidden:!0,onUpdate:"compile",description:"Master switch for lighting logic. Disabling provides stubs only."},ptEnabled:{type:"boolean",default:!0,label:"Path Tracing Core",shortId:"pe",group:"engine_settings",ui:"checkbox",description:"Compiles the Path Tracing module. Disable to reduce shader size.",onUpdate:"compile",noReset:!0,estCompileMs:1500},renderMode:{type:"float",default:0,label:"Active Mode",shortId:"rm",group:"engine_settings",parentId:"ptEnabled",options:[{label:"Direct (Fast)",value:0},{label:"Path Tracing (GI)",value:1}],description:"Switches between fast direct lighting and physically based Global Illumination.",onUpdate:"compile",noReset:!0},ptBounces:{type:"int",default:3,label:"Max Bounces",shortId:"pb",uniform:"uPTBounces",min:1,max:8,step:1,group:"engine_settings",parentId:"ptEnabled",ui:"numeric",description:"Recursion depth. Higher = Brighter interiors, Slower render."},ptGIStrength:{type:"float",default:1,label:"GI Strength",shortId:"pg",uniform:"uPTGIStrength",min:0,max:5,step:.01,group:"engine_settings",parentId:"ptEnabled",description:"Artistic boost for bounced light intensity."},specularModel:{type:"float",default:0,label:"Specular Model",shortId:"sm",group:"engine_settings",options:[{label:"Blinn-Phong (Fast)",value:0,estCompileMs:0},{label:"Cook-Torrance (Quality)",value:1,estCompileMs:400}],description:"BRDF model for direct lighting. Cook-Torrance is physically accurate but increases shader compile time.",onUpdate:"compile",noReset:!0},shadowsCompile:{type:"boolean",default:!0,label:"Shadow Engine",shortId:"sc",group:"engine_settings",ui:"checkbox",noReset:!0,onUpdate:"compile",description:"Compiles the shadow raymarching loop. Disable to save ~5s compile time.",estCompileMs:1500},shadowAlgorithm:{type:"float",default:0,label:"Shadow Quality",shortId:"sa",group:"engine_settings",parentId:"shadowsCompile",options:[{label:"Hard Only (Fastest)",value:2,estCompileMs:500},{label:"Lite Soft (Fast)",value:1,estCompileMs:1500},{label:"Robust Soft (Quality)",value:0,estCompileMs:3e3}],description:"Shadow algorithm. Hard = binary occlusion, Lite = fast penumbra, Robust = accurate penumbra.",onUpdate:"compile",noReset:!0},ptStochasticShadows:{type:"boolean",default:!0,label:"Soft Shadow Jitter",shortId:"ps",group:"engine_settings",parentId:"shadowsCompile",ui:"checkbox",onUpdate:"compile",noReset:!0,estCompileMs:800,description:"Stochastic shadow jitter for Point lights — fakes soft penumbras via accumulation. Independent of True Area Lights (which uses physical sphere sampling for type=Sphere lights)."},ptAreaLights:{type:"boolean",default:!1,label:"True Area Lights",shortId:"pal2",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noReset:!0,estCompileMs:600,description:"Physically-correct sphere area light integration (sphere-surface sampling + MIS). Required for lights with type=Sphere. Enable + change a light type to Sphere via the per-light menu. Costs ~600ms compile + one extra sphere intersection per bounce."},ptNEEAllLights:{type:"boolean",default:!1,label:"Sample All Lights",shortId:"pal",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noReset:!0,description:"Evaluates every active light per bounce instead of one random light. Reduces shadow noise at the cost of N× more shadow rays."},ptReflMode:{type:"float",default:0,label:"Env Sampling",shortId:"prm",group:"engine_settings",parentId:"ptEnabled",options:[{label:"Off",value:0,estCompileMs:0},{label:"Env MIS",value:1,estCompileMs:250},{label:"Env MIS + IS",value:2,estCompileMs:650}],onUpdate:"compile",noReset:!0,description:"Direct env-map sampling with MIS for path-traced reflections. Env MIS handles broad skies; Env MIS + IS adds importance sampling for HDR maps with sun discs / concentrated lights. Replaces the older Environment NEE (which only handled diffuse)."},ptSobolBounce:{type:"boolean",default:!1,label:"Sobol Bounce Sampling",shortId:"psb",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noReset:!0,estCompileMs:50,description:"Low-discrepancy 2D sequence (Sobol) with per-pixel rotation for the bounce-direction seed. Measurably less variance on shiny surfaces; no effect on rough/diffuse-heavy scenes."},ptEnvNEE:{type:"boolean",default:!1,hidden:!0,label:"Environment NEE (legacy)",shortId:"pen",group:"engine_settings",parentId:"ptEnabled",noReset:!0,description:"Deprecated — kept so old scene files load without dropping state. Migrated to ptReflMode at boot."},ptMaxLuminance:{type:"float",default:10,label:"Firefly Clamp",shortId:"pfl",uniform:"uPTMaxLuminance",min:.5,max:200,step:.5,scale:"log",group:"engine_settings",parentId:"ptEnabled",description:"Clamps per-sample luminance to suppress bright firefly spikes. Lower = cleaner but slightly biased. Raise to effectively disable."},shadows:{type:"boolean",default:!0,label:"Enable",shortId:"sh",group:"main",uniform:"uShadows",ui:"checkbox",condition:{param:"shadowsCompile",bool:!0},description:"Toggle shadow casting at runtime without recompiling.",helpId:"shadows"},areaLights:{type:"boolean",default:!1,label:"Area Lights",shortId:"al",uniform:"uAreaLights",group:"shadows",hidden:!0,condition:{param:"ptStochasticShadows",bool:!0},description:"Stochastic area light shadows. Disable for sharp analytical shadows.",helpId:"shadows",onUpdate:"compile",noReset:!0},shadowIntensity:{type:"float",default:1,label:"Opacity",shortId:"si",uniform:"uShadowIntensity",min:0,max:1,step:.01,group:"shadows",condition:{bool:!0},description:"How dark the shadowed regions become (1 = fully black).",helpId:"shadows"},shadowSoftness:{type:"float",default:16,label:"Hardness",shortId:"ss",uniform:"uShadowSoftness",min:2,max:2e3,step:1,group:"shadows",scale:"log",condition:{bool:!0},description:"Higher values give crisper shadows; lower values give wider penumbras. Affects Point and Directional lights only — Sphere area lights derive shadow softness from physical sphere sampling.",helpId:"shadows"},shadowSteps:{type:"int",default:128,label:"Steps",shortId:"st",min:16,max:512,step:16,group:"shadows",condition:{bool:!0},uniform:"uShadowSteps",ui:"numeric",description:"Quality vs Performance.",helpId:"shadows"},shadowBias:{type:"float",default:.002,label:"Bias",shortId:"sb",uniform:"uShadowBias",min:0,max:1,step:1e-6,group:"shadows",scale:"log",condition:{bool:!0},description:"Too low: acne. Too high: detached.",helpId:"shadows"},lights:{type:"complex",default:Ut,label:"Light List",shortId:"ll",group:"data",hidden:!0,noReset:!0}},inject:(e,t,o)=>{if(o!=="Main"){e.addPostDEFunction(`
             float GetSoftShadow(vec3 ro, vec3 rd, float k, float lightDist, float noise) { return 1.0; }
             float GetHardShadow(vec3 ro, vec3 rd, float lightDist) { return 1.0; }
             ...
             `);return}e.addDefine("MAX_LIGHTS",m.toString());const a=t.lighting;if(a&&!a.advancedLighting){e.addDefine("MAX_LIGHTS","0"),e.addPostDEFunction(`
             float GetSoftShadow(vec3 ro, vec3 rd, float k, float lightDist, float noise) { return 1.0; }
             float GetHardShadow(vec3 ro, vec3 rd, float lightDist) { return 1.0; }
...
This rotation is bound to 'ParamC' (Slider below). Try dragging it!`},{id:"rot-1",type:"Rotate",enabled:!0,params:{x:0,y:0,z:0},bindings:{z:"ParamC"}},{id:"bulb-1",type:"Mandelbulb",enabled:!0,params:{power:8}},{id:"add-c",type:"AddConstant",enabled:!0,params:{scale:1}}],ja={id:"Modular",name:"Modular Builder",shortDescription:"Construct custom fractal equations using a Node Graph.",description:"Construct your own fractal equation by chaining operations together. Combine folds, rotations, and logic via the Graph tab.",juliaType:"julia",shader:{function:"",loopBody:"",getDist:"",capabilities:new Set(["shape:modular"])},parameters:[null,null,null,null],defaultPreset:{formula:"Modular",features:{coreMath:{iterations:16,paramA:8,paramB:0,paramC:0,paramD:0,paramE:0,paramF:0},lighting:{shadows:!0,shadowSoftness:16,shadowIntensity:1,shadowBias:.002}},pipeline:Na,cameraPos:{x:0,y:0,z:4},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:0,xL:0,yL:0,zL:0}}},Ha={id:"MandelTerrain",name:"MandelTerrain",shortDescription:'3D Heightmap of the Mandelbrot set. Creates alien landscapes and "Math Mountains".',description:"A 3D Heightmap of the Mandelbrot set. Iterations slider controls terrain detail.",juliaType:"julia",shader:{function:`
...
void kk_invert(inout vec3 z, inout float dr, vec3 cen, float R2) {
    ...
    void formula_Julia3D(inout vec4 z, inout float dr, inout float trap, vec4 c) {
        ...
        if (uParamC < 1.5) {
            ...
            return vec2(d, iter);
        `,capabilities:new Set(["shape:per-iteration","iter:c-constant","iter:shared-rotation","render:writes-trap","render:writes-iter"])},parameters:[{label:"Sphere Radius",id:"paramA",min:1.4,max:2.2,step:1e-4,default:1.7320508},{label:"Centre Distance",id:"paramB",min:1.6,max:2.6,step:1e-4,default:2},{label:"Variant",id:"paramC",min:0,max:2,step:1,default:2,options:[{label:"Limit set — Inflated (Γ̃₁)",value:0},{label:"Limit set — True 3D (Γ̃₂)",value:1},{label:"Julia set (escape-time)",value:2}]},{label:"DE Scale (limit set)",id:"paramD",min:.1,max:1.5,step:.001,default:.7},{label:"Radial Power (Julia set)",id:"paramE",min:1,max:4,step:.001,default:2},{label:"Rotation",id:"vec3B",type:"vec3",min:-6.28,max:6.28,step:.01,default:{x:0,y:0,z:0},mode:"rotation"}],defaultPreset:{formula:"Julia3D",features:{coreMath:{iterations:16,paramA:1.7320508,paramB:2,paramC:2,paramD:.7,paramE:2,vec3B:{x:0,y:0,z:0}},geometry:{juliaMode:!0,juliaX:-1,juliaY:0,juliaZ:0},quality:{detail:3,pixelThreshold:.4,maxSteps:500,fudgeFactor:.6,estimator:0},optics:{camFov:60}},cameraPos:{x:0,y:0,z:0},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:3.2,xL:0,yL:0,zL:0},targetDistance:3.2,cameraMode:"Orbit",lights:[{type:"Directional",position:{x:.6,y:1,z:.5},rotation:{x:0,y:0,z:0},color:"#fff2d9",intensity:1.2,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0}]}},mo=[za,$a,Ta,Da,Ua,Xa,Za,_a,Aa,Fa,Ga,Wa,Ma,Ea,Ha,Ka,fo,uo,co,po,Sa,wa,Ia,lo,so,Ca,Qa,Ja,io,ro,eo,to,ao,no,oo,qa,Pa,Va,Ra,Ba,La,ka,Oa,Ya,ja];mo.forEach(e=>x.register(e));x.registerAlias("UberMenger","MengerAdvanced");x.registerAlias("FoldingBrot","BoxBulb");x.registerAlias("HyperTorus","Mandelorus");x.registerAlias("HyperbolicMandelbrot","MandelBolic");x.registerAlias("RhombicIcosahedron","Coxeter");ya();De();N({id:"coloring-1",label:"Coloring · Layer 1",group:"host",apply:e=>oe(e.config,1)});N({id:"coloring-2",label:"Coloring · Layer 2",group:"host",apply:e=>oe(e.config,2)});N({id:"env-gradient",label:"Environment · Sky",group:"host",apply:e=>Re(e.config)});Ee(()=>{const e=ba.getState();e.setOpen(!e.open)});Ae(()=>window.open("gradient-explorer.html","_blank","noopener"));xa();export{pe as A,it as F,A as I,Na as J,fe as S,u as a,So as b,zo as c,nt as d,Fo as e,ht as f,_o as g,yt as h,gt as i,bt as j,ya as k,wo as n,_t as p,mt as r,ba as u};
