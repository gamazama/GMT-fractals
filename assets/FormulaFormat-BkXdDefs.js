import{bM as g,bN as y,bj as b,bk as M}from"./paletteFiltersPersist-DOEmQJbm.js";import{r as v}from"./accordionReveal-BI7romxl.js";const E=a=>({id:"Favients",dock:a.dock,order:a.order??90,component:"panel-favients",isCore:!1}),L=(a={})=>{var r,n,l,i;const e=typeof window<"u"?window.innerHeight:800,t=a.storageKey?{storageKey:a.storageKey}:void 0;g({x:((r=a.float)==null?void 0:r.x)??20,y:((n=a.float)==null?void 0:n.y)??Math.max(20,Math.round(e/2-160)),w:((l=a.float)==null?void 0:l.w)??296,h:((i=a.float)==null?void 0:i.h)??320,open:a.open??!0,location:a.location,order:a.order},t),y(t),a.paletteFilters!==!1&&(b(),M())},O=()=>{window.open("gradient-explorer.html","_blank","noopener")},I=`
/*
 * ============================================================
