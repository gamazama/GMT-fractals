...
`)}),e+=`
in vec2 vUv;
`,e},Dn=Tn(),lo=(e,t,o={})=>{const{loopInit:n="",perIterInject:s="",distOverrideInit:r="",distOverrideInLoopFull:a="",distOverrideInLoopGeom:i="",distOverridePostFull:l="",distOverridePostGeom:p="",postMapCode:h="",postDistCode:u="",kernel:f={},is4D:g=!1}=o,b=!!f.numericDE,y=g?"length(z)":"getLength(z.xyz)",v=g?"dot(z, z)":"dot(z.xyz, z.xyz)",M=b?`
...
`;if(this.variant==="Histogram"){const m=It({precisionMode:this.precisionMode}),w=co();return`
${t}
${o}
${l}
${Bt}
