const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./HelpBrowser-CUi4FYGf.js","./three-fiber-GKfjny8F.js","./three-DQWx7qFd.js","./Undo-lv2m-MPA.js","./CollapsibleSection-CNCKSNEb.js","./three-drei-D2x72drd.js","./pako-DwGzBETv.js","./CollapsibleSection-kgNuTCD_.css"])))=>i.map(i=>d[i]);
import{u as C,f as _,g as re,s as L,c as z,S as ie,a as le,b as A,d as W,e as $,V as ce,h as de,i as me}from"./CollapsibleSection-CNCKSNEb.js";import{r as l,j as n,C as ue,R as B}from"./three-fiber-GKfjny8F.js";import{_ as pe,r as fe,c as he}from"./three-drei-D2x72drd.js";import{P as ge,u as xe,M as ve}from"./MobileControls-ByGufg63.js";import{A as ye,H as be,a as Se,h as we,i as Re,b as Me,c as De,s as Ce}from"./modulationTick-BHDzur1p.js";import{u as Z,p as Ee,E as Fe,D as Oe,a as ke,P as Te,T as je,b as U,G as Ie,c as Pe,d as He,r as Ae,i as Ne,e as _e,f as ze,g as Be,h as Le}from"./Undo-lv2m-MPA.js";import{C as We,F as $e}from"./CompositionOverlay-I00zmvVF.js";import{C as Ue}from"./CompilingIndicator-CGFTKDb2.js";import{u as Ve}from"./useGlobalContextMenu-BkX1aYgK.js";import{R as Ge}from"./RenderLoop-D-hjMBND.js";import{u as Ye}from"./typedSlices-B_pK4RyH.js";import{M as qe,a as Xe,c as Ze,i as Ke}from"./applyAt-DUa1DcRc.js";import"./pako-DwGzBETv.js";import"./three-DQWx7qFd.js";import"./AudioAnalysisEngine-DyaB3DyZ.js";import"./ModulationEngine-fGx0zqS8.js";import"./renderPopupRegistry-49PcnqqE.js";import"./createSingleSlot-BAHyf9Ga.js";const Je=e=>e,Qe=e=>`set${e.charAt(0).toUpperCase()}${e.slice(1)}`,N=(e,t)=>{const r=C.getState()[Qe(e.id)];typeof r=="function"&&r(t)},H=Je({id:"demo",name:"Demo",category:"Engine",tabConfig:{label:"Demo"},viewportConfig:{componentId:"overlay-demo",type:"dom"},params:{color:{type:"color",default:"#22d3ee",label:"Color",group:"Base"},position:{type:"vec2",default:{x:0,y:0},label:"Position",min:-1,max:1,step:.01,group:"Base"},size:{type:"float",default:120,label:"Size",min:20,max:400,step:1,group:"Base"},opacity:{type:"float",default:.9,label:"Opacity",min:0,max:1,step:.01,group:"Base"},count:{type:"int",default:8,label:"Duplicates",min:1,max:48,step:1,group:"Iteration"},iterOffset:{type:"vec2",default:{x:.04,y:.04},label:"Offset / step",min:-.5,max:.5,step:.005,group:"Iteration"},iterRotation:{type:"float",default:8,label:"Rotation / step (°)",min:-90,max:90,step:.5,group:"Iteration"},iterScale:{type:"float",default:.94,label:"Scale / step",min:.5,max:1.2,step:.005,group:"Iteration"},iterHueShift:{type:"float",default:18,label:"Hue shift / step (°)",min:-180,max:180,step:1,group:"Iteration"}}});_.register(H);const et=({isReady:e,onFinished:t,bootEngine:a,isStartupReady:r})=>{const[s,o]=l.useState(1),[i,c]=l.useState(!0),d=l.useRef(!1);return l.useEffect(()=>{r&&!d.current&&(d.current=!0,a())},[r,a]),l.useEffect(()=>{if(!e)return;const m=setTimeout(()=>o(0),100),u=setTimeout(()=>{c(!1),t()},600);return()=>{clearTimeout(m),clearTimeout(u)}},[e,t]),i?n.jsx("div",{className:"fixed inset-0 z-[100] bg-black flex flex-col items-center justify-center transition-opacity duration-500",style:{opacity:s},children:n.jsx("div",{className:"text-white text-sm font-mono tracking-widest opacity-60",children:r?"Booting…":"Loading…"})}):null},tt=re(),V=({onUpdate:e,onLoadingChange:t,autoUpdate:a,trigger:r,source:s})=>{const o=l.useRef(r);return l.useEffect(()=>{let i=0,c=0;const d=()=>{const m=r!==o.current;m&&(o.current=r),c++,(a&&c%60===0||m)&&(t==null||t(!0),tt.requestHistogramReadback(s).then(v=>{v.length>0&&e(v),t==null||t(!1)})),i=requestAnimationFrame(d)};return d(),()=>cancelAnimationFrame(i)},[a,r,s,e,t]),null},G=12,nt=40,ot=()=>{const e=_.getViewportOverlays().filter(r=>r.type==="dom"),t=C(),a=C();return n.jsx("div",{className:"absolute inset-0 pointer-events-none z-[20]",children:e.map(r=>{const s=z.get(r.componentId),o=r.id,i=t[o];return s&&i?n.jsx(s,{featureId:o,sliceState:i,actions:a},r.id):null})})},st=()=>{const e=_.getViewportOverlays().filter(r=>!r.type||r.type==="scene"),t=C(),a=C();return n.jsx(n.Fragment,{children:e.map(r=>{const s=z.get(r.componentId),o=r.id,i=t[o];return s&&i?n.jsx(s,{featureId:o,sliceState:i,actions:a},r.id):null})})},at=({onSceneReady:e})=>{const t=C(),a=l.useRef(null),r=l.useRef(null),s=l.useRef(!1);Z();const[o,i]=l.useState({w:0,h:0});l.useLayoutEffect(()=>{if(!r.current)return;const p=(O,b)=>{const M=window.devicePixelRatio||1,D=C.getState();D.isBucketRendering||D.setCanvasPixelSize(Math.floor(O*M),Math.floor(b*M))},k=new ResizeObserver(O=>{for(const b of O){const M=Math.max(1,b.contentRect.width),D=Math.max(1,b.contentRect.height);i({w:M,h:D}),p(M,D)}});k.observe(r.current);const f=r.current.getBoundingClientRect();return f.width>0&&f.height>0&&(i({w:f.width,h:f.height}),p(f.width,f.height)),s.current||(s.current=!0,e()),()=>k.disconnect()},[]);const c=t.resolutionMode==="Fixed",[d,m]=t.fixedResolution,u=t.isBroadcastMode,v=40,w=Math.max(1,o.w-v),R=Math.max(1,o.h-v);let y=1;c&&(y=Math.min(1,w/d,R/m));const E=c?{width:d,height:m,transform:`scale(${y})`,transformOrigin:"center center",boxShadow:"0 0 50px rgba(0,0,0,0.5)",border:"1px solid rgba(255,255,255,0.1)",flexShrink:0}:{width:"100%",height:"100%"},h=c?d*y:o.w,g=c?m*y:o.h,x=(o.h-g)/2,S=(o.w-h)/2,F=Math.max(G,x-nt),j=Math.max(G,S);return n.jsxs("div",{ref:r,className:"relative flex-1 flex items-center justify-center overflow-hidden bg-[#050505] touch-none",style:{backgroundImage:c?"radial-gradient(circle at center, #111 0%, #050505 100%)":"none"},onContextMenu:p=>{p.preventDefault(),p.stopPropagation()},onMouseEnter:()=>L(!0),onMouseLeave:()=>L(!1),children:[c&&n.jsx("div",{className:"absolute inset-0 opacity-20 pointer-events-none",style:{backgroundImage:"linear-gradient(#333 1px, transparent 1px), linear-gradient(90deg, #333 1px, transparent 1px)",backgroundSize:"40px 40px"}}),!u&&n.jsx(Ue,{}),!u&&n.jsx(ge,{}),!u&&n.jsx(ye,{}),n.jsxs("div",{ref:a,style:E,className:"relative bg-[#111] group z-0",children:[n.jsx(ue,{gl:{alpha:!0,depth:!1,antialias:!1,powerPreference:"high-performance",preserveDrawingBuffer:!1},camera:{position:[0,0,0],fov:60},style:{position:"absolute",inset:0,pointerEvents:"auto"},dpr:t.dpr,onPointerDown:p=>p.target.setPointerCapture(p.pointerId),children:n.jsx(st,{})}),n.jsx(ot,{}),!u&&n.jsx(We,{width:c?d:o.w,height:c?m:o.h}),!u&&t.histogramActiveCount>0&&n.jsx(V,{onUpdate:p=>t.setHistogramData(p),onLoadingChange:p=>t.setHistogramLoading(p),autoUpdate:t.histogramAutoUpdate,trigger:t.histogramTrigger,source:"geometry"}),!u&&t.sceneHistogramActiveCount>0&&n.jsx(V,{onUpdate:p=>t.setSceneHistogramData(p),autoUpdate:!0,trigger:t.sceneHistogramTrigger,source:"color"})]}),c&&!u&&n.jsx($e,{width:d,height:m,top:F,left:j,maxAvailableWidth:o.w,maxAvailableHeight:o.h,onSetResolution:t.setFixedResolution,onSetMode:t.setResolutionMode})]})},rt=B.lazy(()=>pe(()=>import("./HelpBrowser-CUi4FYGf.js"),__vite__mapDeps([0,1,2,3,4,5,6,7]),import.meta.url)),it=()=>{const e=C(),[t,a]=l.useState(!1),[r,s]=l.useState(!0),o=l.useRef(null),i=l.useRef(null),c=l.useRef(null),d=l.useRef(null),m=l.useRef(null),u=l.useRef(null),v=l.useMemo(()=>({container:i,speed:c,dist:d,reset:m,reticle:u}),[]),{startupMode:w,bootEngine:R,isStartupReady:y}=xe(),{isMobile:E,isPortrait:h}=Z();Ve(),l.useEffect(()=>{Ee()},[]);const g=E,x=e.isBroadcastMode,S=e.interactionMode!=="none",F=()=>{s(!1)},j=g&&!x?"min-h-[120vh] bg-black":"fixed inset-0 w-full h-full bg-black select-none overflow-hidden flex flex-col",p=Object.values(e.panels).filter(f=>f.location==="float"&&f.isOpen),k=l.useMemo(()=>({handleInteractionStart:e.handleInteractionStart,handleInteractionEnd:e.handleInteractionEnd,openContextMenu:e.openContextMenu}),[e.handleInteractionStart,e.handleInteractionEnd,e.openContextMenu]);return n.jsx(ie,{value:k,children:n.jsxs("div",{className:j,children:[n.jsx(Fe,{}),n.jsx(Ge,{}),n.jsx(Oe,{}),p.map(f=>n.jsx(ke,{id:f.id,title:f.id,children:n.jsx(Te,{activeTab:f.id,state:e,actions:e,onSwitchTab:O=>e.togglePanel(O,!0)})},f.id)),n.jsxs("div",{ref:o,className:`relative bg-black select-none ${S?"cursor-crosshair":""} flex flex-col ${g&&!x?"h-[100vh] sticky top-0 overflow-hidden shadow-2xl":"w-full h-full"}`,onContextMenu:f=>f.preventDefault(),children:[n.jsx(et,{isReady:t,onFinished:F,startupMode:w,bootEngine:R,isStartupReady:y}),g&&h&&!r&&!x&&n.jsxs("div",{className:"fixed inset-0 z-[9999] bg-black flex flex-col items-center justify-center p-10 text-center text-white",children:[n.jsx("div",{className:"text-cyan-400 mb-6 animate-bounce",children:n.jsx(le,{})}),n.jsx("h2",{className:"text-2xl font-bold tracking-tight mb-2",children:"Landscape Recommended"}),n.jsx("p",{className:"text-gray-500 text-sm font-mono",children:"Rotate device to access controls."})]}),n.jsx(je,{}),n.jsxs("div",{className:"flex-1 flex overflow-hidden relative",children:[!x&&!g&&n.jsx(U,{side:"left"}),n.jsx(at,{hudRefs:v,onSceneReady:()=>a(!0),activeHint:null,onDismissHint:()=>{}}),n.jsx(be,{}),!x&&n.jsx(U,{side:"right"})]}),n.jsx(Se,{}),!x&&n.jsx(ve,{}),e.contextMenu.visible&&!x&&n.jsx(Ie,{x:e.contextMenu.x,y:e.contextMenu.y,items:e.contextMenu.items,targetHelpIds:e.contextMenu.targetHelpIds,onClose:e.closeContextMenu,onOpenHelp:e.openHelp}),e.helpWindow.visible&&n.jsx(l.Suspense,{fallback:null,children:n.jsx(rt,{activeTopicId:e.helpWindow.activeTopicId,onClose:e.closeHelp,onNavigate:e.openHelp})}),n.jsx(Pe,{hidden:x})]})]})})};let K=null;const Y=e=>{K=e},J=()=>K,Q=`// ─────────────────────────────────────────────────────────────────────────────
...
`,lt=`import { defineFeature, type FeatureState } from '../engine/features/setFeature';
...
`,ct=`import { featureRegistry } from '../engine/FeatureSystem';
...
`,dt=`import { useEngineStore } from '../store/engineStore';
...
`,ut=`import React, { useEffect, useRef } from 'react';
...
`,pt=`// Demo's per-frame export pipeline. Plugged into the engine's render
...
`,ft="// __SHOWCASE_START__",ht="// __SHOWCASE_END__",gt=e=>{const t=e.indexOf(ft),a=e.indexOf(ht);return t===-1||a===-1||a<t?"// (showcase markers missing)":e.slice(e.indexOf(`
`,t)+1,a).replace(/\s+$/g,"")},P=[{path:"index.tsx",code:Q},{path:"demo/DemoFeature.ts",code:lt},{path:"demo/registerFeatures.ts",code:ct},{path:"demo/setup.ts",code:dt},{path:"demo/demoCanvasRef.ts",code:mt},{path:"demo/DemoOverlay.tsx",code:ut},{path:"demo/demoRenderRunner.ts",code:pt}],ee=e=>e.split(`
`).length,te=P.reduce((e,t)=>e+ee(t.code),0),xt=gt(Q),ne=B.memo(()=>{const[e,t]=l.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsxs("div",{className:"absolute top-4 left-4 max-w-[420px] pointer-events-none select-none",children:[n.jsx("div",{className:"text-cyan-500/80 text-[10px] font-mono tracking-wider mb-2",children:"// GMT engine — generic plugin host"}),n.jsxs("p",{className:"text-xs leading-relaxed text-gray-400 mb-3",children:["Everything in this app — the right-dock Demo panel, sliders, undo, save / load, PNG snapshot (Alt+S), video export, keyboard shortcuts, modulation timeline — boots up from the lines below. The ",n.jsx("code",{className:"text-gray-300",children:"DemoFeature"})," itself is a single declarative object whose params become a Zustand slice, an auto-generated panel, and a save/load round-trip — for free."]}),n.jsx("pre",{className:"text-[10px] font-mono leading-relaxed text-gray-500 bg-black/30 border border-white/5 rounded px-3 py-2.5 whitespace-pre overflow-x-auto pointer-events-auto select-text",children:xt}),n.jsx("div",{className:"mt-3 flex items-center gap-3 pointer-events-auto",children:n.jsxs("button",{type:"button",onClick:()=>t(!0),className:"text-[10px] font-mono text-cyan-400 hover:text-cyan-300 border border-cyan-500/30 hover:border-cyan-400/60 rounded px-2.5 py-1 transition-colors",children:["Show full source (",P.length," files, ",te," lines)"]})})]}),e&&n.jsx(vt,{onClose:()=>t(!1)})]})});ne.displayName="DemoExplainer";const vt=({onClose:e})=>{const[t,a]=l.useState(0),r=P[t];return l.useEffect(()=>{const s=o=>{o.key==="Escape"&&e()};return window.addEventListener("keydown",s),()=>window.removeEventListener("keydown",s)},[e]),fe.createPortal(n.jsx("div",{className:"fixed inset-0 z-[1100] flex items-center justify-center bg-black/70 p-6",onClick:e,children:n.jsxs("div",{className:"bg-neutral-950 border border-white/10 rounded-lg shadow-2xl w-[min(960px,100%)] h-[min(800px,100%)] flex flex-col",onClick:s=>s.stopPropagation(),children:[n.jsxs("div",{className:"flex items-center justify-between px-4 py-3 border-b border-white/10",children:[n.jsxs("div",{children:[n.jsx("div",{className:"text-cyan-400 text-sm font-semibold",children:"Demo source"}),n.jsxs("div",{className:"text-gray-500 text-[10px] font-mono",children:[P.length," files · ",te," lines · live from this build"]})]}),n.jsx("button",{type:"button",onClick:e,className:"text-gray-400 hover:text-white text-lg leading-none px-2","aria-label":"Close source viewer",children:"✕"})]}),n.jsx("div",{className:"flex flex-wrap gap-1 px-3 py-2 border-b border-white/10 bg-black/30",children:P.map((s,o)=>n.jsxs("button",{type:"button",onClick:()=>a(o),className:"text-[11px] font-mono px-2.5 py-1 rounded transition-colors "+(o===t?"bg-cyan-500/15 text-cyan-300 border border-cyan-500/40":"text-gray-400 hover:text-white hover:bg-white/5 border border-transparent"),children:[s.path,n.jsxs("span",{className:"text-gray-600 ml-1.5",children:[ee(s.code),"L"]})]},s.path))}),n.jsx("div",{className:"flex-1 overflow-auto bg-black/40 p-4",children:n.jsx("pre",{className:"text-[11px] font-mono leading-relaxed text-gray-300 whitespace-pre select-text",children:r.code.replace(/\s+$/,"")})})]})}),document.body)},yt=e=>{if(typeof e=="string")return e;if(e&&typeof e=="object"&&"getHexString"in e)return`#${e.getHexString()}`;if(e&&typeof e=="object"&&"r"in e){const t=a=>Math.max(0,Math.min(255,Math.round(a*255)));return`rgb(${t(e.r)}, ${t(e.g)}, ${t(e.b)})`}return"#888888"},bt=({sliceState:e})=>{const t=e,a=Ye(),r=l.useRef(null);return l.useEffect(()=>(Y(r.current),()=>Y(null)),[]),l.useEffect(()=>{const s=r.current;if(!s)return;const o=()=>{const c=window.devicePixelRatio||1,d=s.clientWidth,m=s.clientHeight;if(d===0||m===0)return;const u=Math.max(1,Math.floor(d*c)),v=Math.max(1,Math.floor(m*c));s.width!==u&&(s.width=u),s.height!==v&&(s.height=v)};o();const i=new ResizeObserver(o);return i.observe(s),()=>i.disconnect()},[]),l.useEffect(()=>{const s=r.current;if(!s||!t)return;const o=s.getContext("2d");if(!o)return;const i=(b,M)=>{const D=a[b];return typeof D=="number"?D:M},c=i("demo.size",t.size),d=i("demo.opacity",t.opacity),m=i("demo.position_x",t.position.x),u=i("demo.position_y",t.position.y),v=Math.max(1,Math.min(48,Math.round(i("demo.count",t.count)))),w=i("demo.iterOffset_x",t.iterOffset.x),R=i("demo.iterOffset_y",t.iterOffset.y),y=i("demo.iterRotation",t.iterRotation),E=i("demo.iterScale",t.iterScale),h=i("demo.iterHueShift",t.iterHueShift),g=window.devicePixelRatio||1,x=s.width/g,S=s.height/g,F=x*(.5+m*.4),j=S*(.5-u*.4),p=w*200,k=-R*200,f=y*Math.PI/180,O=yt(t.color);o.save(),o.setTransform(g,0,0,g,0,0),o.fillStyle="#111111",o.fillRect(0,0,x,S),o.lineWidth=1,o.strokeStyle="rgba(255, 255, 255, 0.1)";for(let b=v-1;b>=0;b--){const M=Math.pow(E,b),D=v>1?1-b/(v+2):1;o.save(),o.globalAlpha=Math.max(0,Math.min(1,d*D)),o.filter=h?`hue-rotate(${h*b}deg)`:"none",o.translate(F+p*b,j+k*b),o.rotate(f*b),o.scale(M,M),o.fillStyle=O;const I=c*.5,ae=Math.min(8,I);o.beginPath(),typeof o.roundRect=="function"?o.roundRect(-I,-I,c,c,ae):o.rect(-I,-I,c,c),o.fill(),o.stroke(),o.restore()}o.restore()}),t?n.jsxs(n.Fragment,{children:[n.jsx("canvas",{ref:r,className:"absolute inset-0 w-full h-full pointer-events-none"}),n.jsx(ne,{})]}):null},q=()=>"#"+Math.floor(Math.random()*16777215).toString(16).padStart(6,"0"),T=(e,t,a=.001)=>{const r=e+Math.random()*(t-e);return Math.round(r/a)*a},X=()=>{N(H,{count:Math.round(T(5,18,1)),iterOffset:{x:T(-.08,.08,.005),y:T(-.08,.08,.005)},iterRotation:T(-20,20,.5),iterScale:T(.85,1.05,.005),iterHueShift:T(-30,30,1)})},St=()=>{z.register("overlay-demo",bt),He([{id:"Demo",dock:"right",order:0,features:["demo"]},{id:"Animation",dock:"right",order:1,items:[{type:"widget",id:"lfo-list"}]}]);const e=C.getState();e.movePanel("Demo","right",0),e.movePanel("Animation","right",1),e.togglePanel("Demo",!0),A.register({id:"demo.randomize",key:"R",description:"Randomize the demo square color",category:"Demo",handler:()=>N(H,{color:q()})}),A.register({id:"demo.randomizeLayout",key:"L",description:"Randomize the duplicate-stack layout",category:"Demo",handler:X}),A.register({id:"demo.scramble",key:"S",description:"Scramble color + layout",category:"Demo",handler:()=>{N(H,{color:q()}),X()}}),we.registerHudHint({id:"demo.hints",slot:"bottom-left",order:0,badge:"[Demo]",keys:[{key:"R",label:"Randomize color"},{key:"L",label:"Randomize layout"},{key:"S",label:"Scramble both"},{key:"Ctrl+Z",label:"Undo"},{key:"Ctrl+Y",label:"Redo"}]})},oe=e=>new Promise(t=>setTimeout(t,e)),wt=()=>oe(0),Rt=async({cfg:e,flags:t,status:a,isDiskMode:r})=>{const s=J();if(!s){alert("Demo canvas not mounted yet — close this dialog and re-open after the canvas paints."),a.setIsRendering(!1);return}const o=Math.max(2,Math.floor(e.width/2)*2),i=Math.max(2,Math.floor(e.height/2)*2),c=s.width,d=s.height,m=W.getState(),u=m.isPlaying,v=m.currentFrame;s.width=o,s.height=i;const w=new qe,R=Math.max(1,Math.floor((e.endFrame-e.startFrame)/Math.max(1,e.frameStep))+1);a.setIsRendering(!0),a.setProgress(0),a.setStatusText("Starting encoder…");try{await w.start({width:o,height:i,fps:e.fps,bitrate:e.bitrate,formatIndex:e.formatIndex},null),a.setStatusText("Rendering to RAM…");const y=1/e.fps;let E=Date.now();for(let h=0;h<R&&!(t.cancelledRef.current||t.finishEarlyRef.current);h++){for(;t.stoppingRef.current&&!t.cancelledRef.current&&!t.finishEarlyRef.current;)await oe(100);if(t.cancelledRef.current||t.finishEarlyRef.current)break;const g=e.startFrame+h*Math.max(1,e.frameStep),x=g*y;$.scrub(g),Xe(x,y),await wt(),w.encodeCanvas(s,h);const S=Date.now();a.setLastFrameTime((S-E)/1e3),E=S;const F=(S-t.startTimeRef.current)/1e3;a.setElapsedTime(F),a.setEtaRange(Ze(F,h+1,R)),a.setProgress((h+1)/R),a.setStatusText(`Frame ${h+1} / ${R}`)}if(t.cancelledRef.current)w.cancel(),a.setStatusText("Cancelled.");else{a.setStatusText("Finalising file…");const h=await w.finish();if(h){const g=ce[e.formatIndex],x=new Blob([h],{type:g.mime}),S=new Date().toISOString().replace(/[:.]/g,"-").slice(0,19);de(x,`demo-${S}.${g.ext}`),a.setStatusText(t.finishEarlyRef.current?"Finished early.":"Saved.")}}}catch(y){w.cancel(),a.setStatusText(`Error: ${y instanceof Error?y.message:String(y)}`)}finally{s.width=c,s.height=d,$.scrub(v),u&&W.getState().play(),a.setIsRendering(!1),a.setIsStopping(!1)}};Ae();Ne();_e({getCanvas:()=>J()});me();ze();Be();Re();Me();De();Ke({runner:Rt,showSamplesPerFrame:!1,disableDiskMode:!0});Le();Ce({defaultTarget:"demo.position_x"});St();const se=document.getElementById("root");if(!se)throw new Error("Could not find root element to mount to");he.createRoot(se).render(n.jsx(B.StrictMode,{children:n.jsx(it,{})}));
