...
float cp_scale;
float cp_trap;
`;function Wt(e){if(e.shader.getDist)return"custom";const t=e.shader.function+" "+e.shader.loopBody+" "+(e.shader.preamble||"");return/boxFold|sphereFold/.test(t)||/dr\s*=\s*dr\s*\*\s*\w/.test(t)&&!/pow\s*\(/.test(t)||/abs\s*\(\s*z/.test(t)&&/dr\s*[\*=]/.test(t)&&!/pow\s*\(/.test(t)?"ifs":"power"}function Lo(e){return e.deType!=="auto"?e.deType:Wt(e.definition)}function Io(e){return e.shader.getDist?`
vec2 _getDistCustom(float r, float safeDr, float iter, vec4 z) {
  float dr = safeDr;
  ${e.shader.getDist}
}
`:""}function ro(e,t=!1){return e>4.5&&!t&&(e=1),e<.5?`float logR2 = log2(r * r);
    return 0.17328679 * logR2 * r / safeDr;`:e<1.5?"return (r - 1.0) / safeDr;":e<2.5?"return r / safeDr;":e<3.5?`float logR2 = log2(r * r);
    return 0.34657359 * logR2 * r / (safeDr + 8.0);`:e<4.5?"return (r - 2.0) / safeDr;":"return abs(cp_dmin);"}function _o(e,t,o,n,s=!1){const r=n!==void 0&&n>4.5&&s;if(t&&!r)return e==="ifs"?`return _getDistCustom(r, safeDr, iter, z).x - ${o};`:"return _getDistCustom(r, safeDr, iter, z).x;";if(n!==void 0&&n>0){const a=ro(n,s);if(n>=.5&&n<1.5||n>=3.5){const i=a.split(`
...
`)+`
`}function We(e){return fn(e,void 0,"estimator:cutting-plane")}function St(e,t){return`  vec4 z = vec4(pos, 0.0);
...
}`;function wn(e){const t=e.definition;return`#version 300 es
...
}`}function Sn(e){const t=e.definition,o=Lo(e),n=Io(t),s=_o(o,!!t.shader.getDist,"uVoxelSize * 0.5",e.estimator,We(t));return`#version 300 es
precision highp float;
...
}`}function zo(e){const t=e.definition;return`#version 300 es
...
}`}function Cn(e){const t=e.definition,o=Lo(e),n=Io(t),s=o==="ifs"?"0.0":"0.001",r=_o(o,!!t.shader.getDist,s,e.estimator,We(t));return`#version 300 es
...
void main() {
  ...
  fragColor = vec4(col, 1.0);
}`}const Mn=["ParamA","ParamB","ParamC","ParamD","ParamE","ParamF","Vec2A","Vec2B","Vec2C","Vec3A","Vec3B","Vec3C","Vec4A","Vec4B","Vec4C"],En=[...Array.from({length:6},(e,t)=>Mn.map(o=>`uWs${t}${o}`)).flat(),"uWeaveEnabled",...Array.from({length:5},(e,t)=>[`uWeaveInterval${t+1}`,`uWeaveStartIter${t+1}`,`uWeaveBeats${t+1}`]).flat()],qe=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF","uVec2A","uVec2B","uVec2C","uVec3A","uVec3B","uVec3C","uVec4A","uVec4B","uVec4C","uJulia","uJuliaMode","uEscapeThresh","uDeBailout","uDistanceMetric",...En,"uFudgeFactor","uDetail","uPixelThreshold","uSurfaceThreshold","uClipBounds","uBoundsMin","uBoundsMax"];dn();const Bo=[{name:me.Time,type:"float",default:0},{name:me.FrameCount,type:"int",default:0},{name:me.Resolution,type:"vec2",default:new Me(100,100)},{name:me.SceneOffsetHigh,type:"vec3",default:new $e},{name:me.SceneOffsetLow,type:"vec3",default:new $e},{name:me.CameraPosition,type:"vec3",default:new $e},{name:me.CamBasisX,type:"vec3",default:new $e},{name:me.CamBasisY,type:"vec3",default:new $e},{name:me.CamForward,type:"vec3",default:new $e},{name:me.RegionMin,type:"vec2",default:new Me(0,0)},{name:me.RegionMax,type:"vec2",default:new Me(1,1)},{name:me.ImageTileOrigin,type:"vec2",default:new Me(0,0)},{name:me.ImageTileSize,type:"vec2",default:new Me(1,1)},{name:me.FullOutputResolution,type:"vec2",default:new Me(100,100)},{name:me.TilePixelOrigin,type:"vec2",default:new Me(0,0)},{name:me.HistoryTexture,type:"sampler2D",default:null},{name:me.BlendFactor,type:"float",default:1},{name:me.Jitter,type:"vec2",default:new Me(0,0)},{name:me.BlueNoiseTexture,type:"sampler2D",default:null},{name:me.BlueNoiseResolution,type:"vec2",default:new Me(128,128)},{name:me.HistogramLayer,type:"int",default:0},{name:me.InternalScale,type:"float",default:1},{name:me.PixelSizeBase,type:"float",default:.01,comment:"CPU: length(uCamBasisY)/resolution.y*2, avoids per-fragment sqrt"},{name:me.OutputPass,type:"float",default:0,comment:"0=beauty, 1=alpha, 2=depth"},{name:me.DepthMin,type:"float",default:0},{name:me.DepthMax,type:"float",default:5},{name:me.PreRotMatrix,type:"mat3",default:new ke},{name:me.PostRotMatrix,type:"mat3",default:new ke},{name:me.WorldRotMatrix,type:"mat3",default:new ke},{name:me.EnvRotationMatrix,type:"mat2",default:[1,0,0,1]},{name:me.FogColorLinear,type:"vec3",default:new $e(0,0,0),comment:"CPU: InverseACESFilm(uFogColor)"},{name:"uMb3dRotM0",type:"mat3",default:new ke},{name:"uMb3dRotM1",type:"mat3",default:new ke},{name:"uMb3dRotM2",type:"mat3",default:new ke},{name:"uMb3dRotM3",type:"mat3",default:new ke},{name:"uMb3dRotM4",type:"mat3",default:new ke},{name:"uMb3dRotM5",type:"mat3",default:new ke},{name:"uMb3dRotSC0",type:"vec2",default:new Me(0,1)},{name:"uMb3dRotSC1",type:"vec2",default:new Me(0,1)},{name:"uMb3dRotSC2",type:"vec2",default:new Me(0,1)},{name:"uMb3dRotSC3",type:"vec2",default:new Me(0,1)},{name:"uMb3dRotSC4",type:"vec2",default:new Me(0,1)},{name:"uMb3dRotSC5",type:"vec2",default:new Me(0,1)},{name:"uMb3dRot4D0",type:"mat4",default:new no},{name:"uMb3dRot4D1",type:"mat4",default:new no}],Yt=Do.getUniformDefinitions(),Tn=new Set(Bo.map(e=>e.name)),io=Yt.filter(e=>Tn.has(e.name)).map(e=>e.name);if(io.length>0)throw new Error(`[UniformSchema] Feature uniform(s) shadow base schema: ${io.join(", ")}. Rename in the feature def (themed prefix: uPT*/uLight*/uModular*) or remove the base entry.`);const lo=new Set,Ut=[];for(const e of Yt)lo.has(e.name)?Ut.push(e.name):lo.add(e.name);if(Ut.length>0)throw new Error(`[UniformSchema] Two features declare the same uniform: ${Ut.join(", ")}. Rename one (themed prefix convention: uPT*/uLight*/uModular*).`);const ko=[...Bo,...Yt];ko.reduce((e,t)=>(e[t.name]=t.default,e),{});const Dn=()=>{let e=`precision highp float;
precision highp int;

`;return ko.forEach(t=>{t.backingOnly||(t.arraySize?e+=`uniform ${t.type} ${t.name}[${t.arraySize}];
`:e+=`uniform ${t.type} ${t.name};
`)}),e+=`
in vec2 vUv;
`,e},Rn=Dn(),co=(e,t,o={})=>{const{loopInit:n="",perIterInject:s="",distOverrideInit:r="",distOverrideInLoopFull:a="",distOverrideInLoopGeom:i="",distOverridePostFull:l="",distOverridePostGeom:p="",postMapCode:h="",postDistCode:u="",kernel:f={},is4D:g=!1}=o,b=!!f.numericDE,y=g?"length(z)":"getLength(z.xyz)",v=g?"dot(z, z)":"dot(z.xyz, z.xyz)",M=b?`
...
vec4 map(vec3 p) {
    ...
    for (int i = 0; i < MAX_HARD_ITERATIONS; i++) {
        ...
        if (dr > 1.0e10 || ${g?"dot(z, z)":"r2"} > bailout) {
            escaped = true;
            break;
        }
    ...
    ${b?`float finalD = numericDistance(p, uNumDESmooth);
...
float mapDist(vec3 p) {
    ...
    ${b?"float finalD = numericDistance(p, 2.5);":`vec2 distRes = getDist(r, safeDr, iter, z);
...
`;class In{constructor(t){oe(this,"defines",new Map);oe(this,"uniforms",new Map);oe(this,"preDEFunctions",[]);oe(this,"postDEFunctions",[]);oe(this,"integrators",[]);oe(this,"headers",[]);oe(this,"preambles",[]);oe(this,"postMapCode",[]);oe(this,"postDistCode",[]);oe(this,"materialLogic",[]);oe(this,"compositeLogic",[]);oe(this,"missLogic",[]);oe(this,"volumeBody",[]);oe(this,"volumeFinalize",[]);oe(this,"postProcessLogic",[]);oe(this,"shadingReflectionCode",[]);oe(this,"needsShading",!1);oe(this,"perIterInject",[]);oe(this,"formulaLoopBody","");oe(this,"formulaInit","");oe(this,"formulaDist","");oe(this,"distOverrideInit","");oe(this,"distOverrideInLoopFull","");oe(this,"distOverrideInLoopGeom","");oe(this,"distOverridePostFull","");oe(this,"distOverridePostGeom","");oe(this,"useRotation",!0);oe(this,"renderMode","Direct");oe(this,"isLite",!1);oe(this,"precisionMode",0);oe(this,"maxLights",0);oe(this,"enableRefine",!1);oe(this,"numericDE",!1);oe(this,"is4D",!1);oe(this,"physicsRayGen",`
    // Standard Linear Projection
    vec2 uv = vUv * 2.0 - 1.0;
    vec3 rd = normalize(uCamForward + uv.x * uCamBasisX + uv.y * uCamBasisY);
    `);this.variant=t}setRotation(t){this.useRotation=t}setRenderMode(t){this.renderMode=t}setQuality(t,o){this.isLite=t,this.precisionMode=o}enableRefinement(t){this.enableRefine=t}enableNumericDE(t){this.numericDE=t}enableIs4D(t){this.is4D=t}setMaxLights(t){this.maxLights=t}kernelFeatures(){return{refine:this.enableRefine,numericDE:this.numericDE}}deMasterOptions(t){return{loopInit:this.formulaInit,perIterInject:this.perIterInject.join(`
...
`}),t}buildUniformsString(){let t=Rn+`
...
`:t+=`uniform ${s.type} ${r};
`});const o=co(this.formulaLoopBody,this.formulaDist,this.deMasterOptions({})),n=`
${Xt}
${Ht}
...
`);this.integrators.push(Ln(m))}const i=this.integrators.join(`
`),l=yn(this.useRotation),p=co(this.formulaLoopBody,this.formulaDist,this.deMasterOptions(this.kernelFeatures()));if(this.variant==="Physics")return`
${t}
${o}
${l}
${zt}
...
`;if(this.variant==="Histogram"){const m=It({precisionMode:this.precisionMode}),w=uo();return`
${t}
${o}
${l}
${zt}
...
`}const h=Fn(this.materialLogic.join(`
...
`),kernel:this.kernelFeatures()}),b=f?It({isMobile:this.isLite,precisionMode:this.precisionMode,functionName:"traceSceneLean"}):"",y=Pn(f,this.maxLights,this.compositeLogic.join(`
`)),v=uo(this.renderMode),M=An(this.postProcessLogic.join(`
`));return`
${t}
${o}
${n}
...
${M}
${y}
`}}class _n{static generateFragmentShader(t){return this.buildShader(t,"Main")}static generatePhysicsShader(t){return this.buildShader(t,"Physics")}static generateHistogramShader(t){return this.buildShader(t,"Histogram")}static generateMeshSDFLibrary(t){return this.buildShader(t,"Mesh")}static buildShader(t,o){const n=new In(o),s=t.lighting,a=(s==null?void 0:s.ptEnabled)!==!1&&(t.renderMode==="PathTracing"||(s==null?void 0:s.renderMode)===1);n.setRenderMode(a?"PathTracing":"Direct");const i=t.quality||{};return n.setQuality(i.precisionMode===1,i.precisionMode??0),Do.getAll().forEach(p=>{p.inject&&p.inject(n,t,o)}),n.buildFragment()}}class mt{constructor(t=65536){oe(this,"data");oe(this,"length");this.data=new Float32Array(t),this.length=0}push3(t,o,n){if(this.length+3>this.data.length){const s=this.data.length*2,r=new Float32Array(s);r.set(this.data),this.data=r}this.data[this.length++]=t,this.data[this.length++]=o,this.data[this.length++]=n}trim(){return this.data.subarray(0,this.length)}}class Oo{constructor(t=65536){oe(this,"data");oe(this,"length");this.data=new Uint32Array(t),this.length=0}push3(t,o,n){if(this.length+3>this.data.length){const s=this.data.length*2,r=new Uint32Array(s);r.set(this.data),this.data=r}this.data[this.length++]=t,this.data[this.length++]=o,this.data[this.length++]=n}trim(){return this.data.subarray(0,this.length)}}function Ue(e,t,o,n,s){return o=o|0,n=n|0,s=s|0,o=o<0?0:o>=t?t-1:o,n=n<0?0:n>=t?t-1:n,s=s<0?0:s>=t?t-1:s,e[(s*t+n)*t+o]}function He(e,t,o,n,s){const r=Math.floor(o),a=Math.floor(n),i=Math.floor(s),l=o-r,p=n-a,h=s-i,u=Ue(e,t,r,a,i),f=Ue(e,t,r+1,a,i),g=Ue(e,t,r,a+1,i),b=Ue(e,t,r+1,a+1,i),y=Ue(e,t,r,a,i+1),v=Ue(e,t,r+1,a,i+1),M=Ue(e,t,r,a+1,i+1),m=Ue(e,t,r+1,a+1,i+1),w=u*(1-l)+f*l,C=g*(1-l)+b*l,U=y*(1-l)+v*l,B=M*(1-l)+m*l,R=w*(1-p)+C*p,L=U*(1-p)+B*p;return R*(1-h)+L*h}function fo(e,t,o,n,s){const a=He(e,t,o+.5,n,s)-He(e,t,o-.5,n,s),i=He(e,t,o,n+.5,s)-He(e,t,o,n-.5,s),l=He(e,t,o,n,s+.5)-He(e,t,o,n,s-.5),p=Math.sqrt(a*a+i*i+l*l);if(p<1e-10)return[0,1,0];const h=1/p;return[a*h,i*h,l*h]}function Se(e,t,o,n){return o+(e+.5)/t*(n-o)}function Ze(e,t,o,n){return(e-o)/(n-o)*t-.5}const pt=[[0,1],[2,3],[4,5],[6,7],[0,2],[1,3],[4,6],[5,7],[0,4],[1,5],[2,6],[3,7]];function jo(e,t,o){if(e.length===0)return null;let n=0,s=0,r=0;for(let L=0;L<e.length;L++)n+=e[L].point[0],s+=e[L].point[1],r+=e[L].point[2];const a=1/e.length;n*=a,s*=a,r*=a;let i=0,l=0,p=0,h=0,u=0,f=0,g=0,b=0,y=0;for(let L=0;L<e.length;L++){const V=e[L].normal,d=e[L].point,c=V[0]*d[0]+V[1]*d[1]+V[2]*d[2];i+=V[0]*V[0],l+=V[0]*V[1],p+=V[0]*V[2],h+=V[1]*V[1],u+=V[1]*V[2],f+=V[2]*V[2],g+=V[0]*c,b+=V[1]*c,y+=V[2]*c}const v=.01;i+=v,h+=v,f+=v,g+=v*n,b+=v*s,y+=v*r;const M=i*(h*f-u*u)-l*(l*f-u*p)+p*(l*u-h*p);let m,w,C;if(Math.abs(M)<1e-6)m=n,w=s,C=r;else{const L=1/M;m=L*(g*(h*f-u*u)-l*(b*f-u*y)+p*(b*u-h*y)),w=L*(i*(b*f-u*y)-g*(l*f-u*p)+p*(l*y-b*p)),C=L*(i*(h*y-b*u)-l*(l*y-b*p)+g*(l*u-h*p))}const U=(o[0]-t[0])*.1,B=(o[1]-t[1])*.1,R=(o[2]-t[2])*.1;return m=Math.max(t[0]-U,Math.min(o[0]+U,m)),w=Math.max(t[1]-B,Math.min(o[1]+B,w)),C=Math.max(t[2]-R,Math.min(o[2]+R,C)),[m,w,C]}let qt=!1;function zn(){qt=!0}function mo(){qt=!1}function po(){return new Promise(e=>setTimeout(e,0)).then(()=>{if(qt)throw new Error("CANCELLED")})}async function Bn(e,t,o,n,s,r=()=>{}){const a=t-1;r("contouring",0);const i=new Map,l=new mt(8192),p=new mt(8192);let h=0;for(let B=0;B<a;B++){B&7||(r("contouring",Math.round(40*B/a)),await po());for(let R=0;R<a;R++)for(let L=0;L<a;L++){const V=e[(B*t+R)*t+L],d=V>=0,c=[V,e[(B*t+R)*t+L+1],e[(B*t+(R+1))*t+L],e[(B*t+(R+1))*t+L+1],e[((B+1)*t+R)*t+L],e[((B+1)*t+R)*t+L+1],e[((B+1)*t+(R+1))*t+L],e[((B+1)*t+(R+1))*t+L+1]];let I=!1;for(let T=1;T<8;T++)if(c[T]>=0!==d){I=!0;break}if(!I)continue;const F=[];for(let T=0;T<12;T++){const z=pt[T],S=c[z[0]],O=c[z[1]];if(S>=0==O>=0)continue;const D=L+(z[0]&1),P=R+(z[0]>>1&1),G=B+(z[0]>>2&1),H=L+(z[1]&1),X=R+(z[1]>>1&1),$=B+(z[1]>>2&1);let N=D,Z=P,Q=G,ne=H,K=X,ee=$,re=S;for(let q=0;q<8;q++){const te=(N+ne)*.5,ce=(Z+K)*.5,se=(Q+ee)*.5,J=He(e,t,te,ce,se);J>=0==re>=0?(N=te,Z=ce,Q=se,re=J):(ne=te,K=ce,ee=se)}const ie=(N+ne)*.5,le=(Z+K)*.5,ve=(Q+ee)*.5,Y=fo(e,t,ie,le,ve);F.push({point:[Se(ie,t,o[0],n[0]),Se(le,t,o[1],n[1]),Se(ve,t,o[2],n[2])],normal:Y})}if(F.length===0)continue;const _=[Se(L,t,o[0],n[0]),Se(R,t,o[1],n[1]),Se(B,t,o[2],n[2])],k=[Se(L+1,t,o[0],n[0]),Se(R+1,t,o[1],n[1]),Se(B+1,t,o[2],n[2])],E=jo(F,_,k);if(!E)continue;const j=fo(e,t,Ze(E[0],t,o[0],n[0]),Ze(E[1],t,o[1],n[1]),Ze(E[2],t,o[2],n[2])),A=(B*a+R)*a+L;i.set(A,h),l.push3(E[0],E[1],E[2]),p.push3(j[0],j[1],j[2]),h++}}if(r("contouring",50),console.log("DC: "+h+" vertices from "+i.size+" cells"),h===0)return{positions:new Float32Array(0),normals:new Float32Array(0),indices:new Uint32Array(0),vertexCount:0,faceCount:0};const u=new Oo(8192),f=new Set;let g=0,b=0,y=0;const v=i.size,M=Array.from(i.entries());for(let B=0;B<M.length;B++){M[B][1];const R=M[B][0];y++;const L=R%a,V=(R/a|0)%a,d=R/(a*a)|0;for(let c=0;c<12;c++){const I=pt[c],F=L+(I[0]&1),_=V+(I[0]>>1&1),k=d+(I[0]>>2&1),E=L+(I[1]&1),j=V+(I[1]>>1&1),A=d+(I[1]>>2&1),T=e[(k*t+_)*t+F],z=e[(A*t+j)*t+E];if(T>=0==z>=0)continue;let S;const O=Math.min(F,E),D=Math.min(_,j),P=Math.min(k,A);F!==E?S=0:_!==j?S=1:S=2;const G=(P*t+D)*t*4+O*4+S;if(f.has(G))continue;f.add(G),g++;const H=(S+1)%3,X=(S+2)%3,$=[O,D,P],N=[-1,-1,-1,-1];let Z=!0;for(let ne=0;ne<4;ne++){const K=[$[0],$[1],$[2]];if(K[H]-=ne&1?0:1,K[X]-=ne&2?0:1,K[0]<0||K[1]<0||K[2]<0||K[0]>=a||K[1]>=a||K[2]>=a){Z=!1;break}const ee=(K[2]*a+K[1])*a+K[0],re=i.get(ee);if(re===void 0){Z=!1;break}N[ne]=re}if(!Z){b++;continue}const Q=T>=0;N[0]!==N[1]&&N[0]!==N[3]&&N[1]!==N[3]&&(Q?u.push3(N[0],N[3],N[1]):u.push3(N[0],N[1],N[3])),N[0]!==N[2]&&N[0]!==N[3]&&N[2]!==N[3]&&(Q?u.push3(N[0],N[2],N[3]):u.push3(N[0],N[3],N[2]))}y&4095||(r("contouring",50+Math.round(50*y/v)),await po())}r("contouring",100),console.log("DC: "+g+" sign-change edges, "+b+" dropped (boundary), "+u.length/3+" faces");const m=l.trim(),w=p.trim(),C=u.trim(),U=Math.floor(u.length/3);return{positions:m,normals:w,indices:C,vertexCount:h,faceCount:U}}let Zt=!1;function kn(){Zt=!0}function ho(){Zt=!1}function Bt(){return new Promise(e=>setTimeout(e,0)).then(()=>{if(Zt)throw new Error("CANCELLED")})}class On{constructor(t,o=8,n=1){oe(this,"N");oe(this,"blockSize");oe(this,"defaultValue");oe(this,"blocksPerAxis");oe(this,"blockCellCount");oe(this,"blocks");oe(this,"allocatedCount");this.N=t,this.blockSize=o,this.defaultValue=n,this.blocksPerAxis=Math.ceil(t/o),this.blockCellCount=o*o*o,this.blocks=new Map,this.allocatedCount=0}blockKey(t,o,n){return(n*this.blocksPerAxis+o)*this.blocksPerAxis+t}allocateBlock(t,o,n){const s=this.blockKey(t,o,n);if(!this.blocks.has(s)){const r=new Float32Array(this.blockCellCount);r.fill(this.defaultValue),this.blocks.set(s,r),this.allocatedCount++}return this.blocks.get(s)}hasBlock(t,o,n){return this.blocks.has(this.blockKey(t,o,n))}set(t,o,n,s){const r=this.blockSize,a=t/r|0,i=o/r|0,l=n/r|0,p=this.allocateBlock(a,i,l),h=t-a*r,u=o-i*r,f=n-l*r;p[(f*r+u)*r+h]=s}get(t,o,n){if(t<0||o<0||n<0||t>=this.N||o>=this.N||n>=this.N)return this.defaultValue;const s=this.blockSize,r=t/s|0,a=o/s|0,i=n/s|0,l=this.blockKey(r,a,i),p=this.blocks.get(l);if(!p)return this.defaultValue;const h=t-r*s,u=o-a*s,f=n-i*s;return p[(f*s+u)*s+h]}lerp(t,o,n){const s=Math.floor(t),r=Math.floor(o),a=Math.floor(n),i=t-s,l=o-r,p=n-a,h=this.get(s,r,a),u=this.get(s+1,r,a),f=this.get(s,r+1,a),g=this.get(s+1,r+1,a),b=this.get(s,r,a+1),y=this.get(s+1,r,a+1),v=this.get(s,r+1,a+1),M=this.get(s+1,r+1,a+1),m=h*(1-i)+u*i,w=f*(1-i)+g*i,C=b*(1-i)+y*i,U=v*(1-i)+M*i,B=m*(1-l)+w*l,R=C*(1-l)+U*l;return B*(1-p)+R*p}gradient(t,o,n){const r=this.lerp(t+.5,o,n)-this.lerp(t-.5,o,n),a=this.lerp(t,o+.5,n)-this.lerp(t,o-.5,n),i=this.lerp(t,o,n+.5)-this.lerp(t,o,n-.5),l=Math.sqrt(r*r+a*a+i*i);if(l<1e-10)return[0,1,0];const p=1/l;return[r*p,a*p,i*p]}memoryMB(){return this.allocatedCount*this.blockCellCount*4/(1024*1024)}}function jn(e,t,o,n=8,s=2){const r=o/t,a=Math.ceil(o/n),i=new Set;for(let h=0;h<t-1;h++)for(let u=0;u<t-1;u++)for(let f=0;f<t-1;f++){const b=e[(h*t+u)*t+f]>=0;let y=!1;for(let v=0;v<=1&&!y;v++)for(let M=0;M<=1&&!y;M++)for(let m=0;m<=1;m++){if(m===0&&M===0&&v===0)continue;if(e[((h+v)*t+(u+M))*t+(f+m)]>=0!==b){y=!0;break}}if(y)for(let v=-s;v<=s;v++)for(let M=-s;M<=s;M++)for(let m=-s;m<=s;m++){const w=f+m,C=u+M,U=h+v;w>=0&&C>=0&&U>=0&&w<t&&C<t&&U<t&&i.add((U*t+C)*t+w)}}const l=new On(o,n,1);let p=0;return i.forEach(h=>{const u=h%t,f=(h/t|0)%t,g=h/(t*t)|0,b=Math.floor(u*r),y=Math.floor(f*r),v=Math.floor(g*r),M=Math.ceil((u+1)*r),m=Math.ceil((f+1)*r),w=Math.ceil((g+1)*r),C=b/n|0,U=y/n|0,B=v/n|0,R=Math.min(a-1,M/n|0),L=Math.min(a-1,m/n|0),V=Math.min(a-1,w/n|0);for(let d=B;d<=V;d++)for(let c=U;c<=L;c++)for(let I=C;I<=R;I++)l.hasBlock(I,c,d)||(l.allocateBlock(I,c,d),p++)}),console.log("Narrow band: "+i.size+" coarse surface cells -> "+p+" fine blocks ("+l.memoryMB().toFixed(1)+" MB) out of "+a*a*a+" total blocks"),{grid:l,surfaceCells:i,bandBlockCount:p}}function Jt(e,t){const o=e.blockSize,n=e.blocksPerAxis;e.blocks.forEach((s,r)=>{const a=r%n,i=(r/n|0)%n,l=r/(n*n)|0;t(a,i,l,a*o,i*o,l*o)})}async function Nn(e,t,o,n=()=>{}){const s=e.N,r=s-1,a=e.blockSize,i=e.blocksPerAxis;let l=new Map,p=null;function h(E,j,A,T){const z=E/a|0,S=j/a|0,O=A/a|0,D=e.blockKey(z,S,O),P=E-z*a,G=j-S*a,X=((A-O*a)*a+G)*a+P;let $=l.get(D);$||($={locals:[],globals:[]},l.set(D,$)),$.locals.push(X),$.globals.push(T)}function u(E,j,A){const T=E/a|0,z=j/a|0,S=A/a|0,O=e.blockKey(T,z,S),D=p.get(O);if(!D)return-1;const P=E-T*a,G=j-z*a,X=((A-S*a)*a+G)*a+P,$=D.locals;let N=0,Z=$.length-1;for(;N<=Z;){const Q=N+Z>>1;if($[Q]===X)return D.globals[Q];$[Q]<X?N=Q+1:Z=Q-1}return-1}const f=new Map;function g(E,j,A,T){const z=E/a|0,S=j/a|0,O=A/a|0,D=e.blockKey(z,S,O);let P=f.get(D);P||(P=new Uint8Array(e.blockCellCount),f.set(D,P));const G=E-z*a,H=j-S*a,$=((A-O*a)*a+H)*a+G,N=1<<T;return P[$]&N?!0:(P[$]|=N,!1)}n("contouring",0);const b=new mt(262144),y=new mt(262144);let v=0,M=0;const m=e.allocatedCount,w=[];Jt(e,(E,j,A,T,z,S)=>{w.push([E,j,A,T,z,S])});for(let E=0;E<w.length;E++){const j=w[E],A=j[3],T=j[4],z=j[5];M++;const S=Math.min(A+a,r),O=Math.min(T+a,r),D=Math.min(z+a,r);for(let P=z;P<D;P++)for(let G=T;G<O;G++)for(let H=A;H<S;H++){const X=e.get(H,G,P),$=X>=0,N=[X,e.get(H+1,G,P),e.get(H,G+1,P),e.get(H+1,G+1,P),e.get(H,G,P+1),e.get(H+1,G,P+1),e.get(H,G+1,P+1),e.get(H+1,G+1,P+1)];let Z=!1;for(let ie=1;ie<8;ie++)if(N[ie]>=0!==$){Z=!0;break}if(!Z)continue;const Q=[];for(let ie=0;ie<12;ie++){const le=pt[ie],ve=N[le[0]],Y=N[le[1]];if(ve>=0==Y>=0)continue;const q=H+(le[0]&1),te=G+(le[0]>>1&1),ce=P+(le[0]>>2&1),se=H+(le[1]&1),J=G+(le[1]>>1&1),ae=P+(le[1]>>2&1);let fe=q,he=te,be=ce,Re=se,De=J,ue=ae,we=ve;for(let Fe=0;Fe<8;Fe++){const ze=(fe+Re)*.5,Ge=(he+De)*.5,Xe=(be+ue)*.5,et=e.lerp(ze,Ge,Xe);et>=0==we>=0?(fe=ze,he=Ge,be=Xe,we=et):(Re=ze,De=Ge,ue=Xe)}const ye=(fe+Re)*.5,ge=(he+De)*.5,pe=(be+ue)*.5,Ee=e.gradient(ye,ge,pe);Q.push({point:[Se(ye,s,t[0],o[0]),Se(ge,s,t[1],o[1]),Se(pe,s,t[2],o[2])],normal:Ee})}if(Q.length===0)continue;const ne=[Se(H,s,t[0],o[0]),Se(G,s,t[1],o[1]),Se(P,s,t[2],o[2])],K=[Se(H+1,s,t[0],o[0]),Se(G+1,s,t[1],o[1]),Se(P+1,s,t[2],o[2])],ee=jo(Q,ne,K);if(!ee)continue;const re=e.gradient(Ze(ee[0],s,t[0],o[0]),Ze(ee[1],s,t[1],o[1]),Ze(ee[2],s,t[2],o[2]));h(H,G,P,v),b.push3(ee[0],ee[1],ee[2]),y.push3(re[0],re[1],re[2]),v++}M&63||(n("contouring",Math.round(40*M/m)),await Bt())}if(n("contouring",50),console.log("DC sparse: "+v+" vertices ("+((b.data.byteLength+y.data.byteLength)/(1024*1024)).toFixed(0)+" MB vertex data)"),v===0)return{positions:new Float32Array(0),normals:new Float32Array(0),indices:new Uint32Array(0),vertexCount:0,faceCount:0};const C=new Map,U=e.blockCellCount+7>>3,B=e.memoryMB();let R=Array.from(e.blocks.keys());for(let E=0;E<R.length;E++){const j=R[E],A=e.blocks.get(j),T=new Uint8Array(U);for(let z=0;z<A.length;z++)A[z]>=0&&(T[z>>3]|=1<<(z&7));C.set(j,T),e.blocks.delete(j),E&255||await Bt()}R=null,e.allocatedCount=0;const L=(C.size*U/(1024*1024)).toFixed(0);console.log("Sign compression: freed "+B.toFixed(0)+" MB float data, using "+L+" MB sign maps"),p=new Map,l.forEach((E,j)=>{const A=E.locals.length,T=new Array(A);for(let P=0;P<A;P++)T[P]=P;const z=E.locals,S=E.globals;T.sort((P,G)=>z[P]-z[G]);const O=new Uint16Array(A),D=new Uint32Array(A);for(let P=0;P<A;P++)O[P]=z[T[P]],D[P]=S[T[P]];p.set(j,{locals:O,globals:D})}),l.clear(),l=null,console.log("Vertex map compaction: "+p.size+" blocks with vertices");function V(E,j,A){if(E<0||j<0||A<0||E>=s||j>=s||A>=s)return!0;const T=E/a|0,z=j/a|0,S=A/a|0,O=e.blockKey(T,z,S),D=C.get(O);if(!D)return!0;const P=E-T*a,G=j-z*a,X=((A-S*a)*a+G)*a+P;return(D[X>>3]&1<<(X&7))!==0}const d=new Oo(262144);let c=0,I=0,F=0;const _=p.size;let k=Array.from(p.entries());for(let E=0;E<k.length;E++){const j=k[E],A=j[0],T=j[1];F++;const z=A%i,S=(A/i|0)%i,O=A/(i*i)|0,D=z*a,P=S*a,G=O*a;for(let H=0;H<T.locals.length;H++){const X=T.locals[H],$=X%a,N=(X/a|0)%a,Z=X/(a*a)|0,Q=D+$,ne=P+N,K=G+Z;if(!(Q>=r||ne>=r||K>=r))for(let ee=0;ee<12;ee++){const re=pt[ee],ie=Q+(re[0]&1),le=ne+(re[0]>>1&1),ve=K+(re[0]>>2&1),Y=Q+(re[1]&1),q=ne+(re[1]>>1&1),te=K+(re[1]>>2&1),ce=V(ie,le,ve),se=V(Y,q,te);if(ce===se)continue;let J;const ae=Math.min(ie,Y),fe=Math.min(le,q),he=Math.min(ve,te);if(ie!==Y?J=0:le!==q?J=1:J=2,g(ae,fe,he,J))continue;c++;const be=(J+1)%3,Re=(J+2)%3,De=[ae,fe,he],ue=[-1,-1,-1,-1];let we=!0;for(let ge=0;ge<4;ge++){const pe=[De[0],De[1],De[2]];if(pe[be]-=ge&1?0:1,pe[Re]-=ge&2?0:1,pe[0]<0||pe[1]<0||pe[2]<0||pe[0]>=r||pe[1]>=r||pe[2]>=r){we=!1;break}const Ee=u(pe[0],pe[1],pe[2]);if(Ee<0){we=!1;break}ue[ge]=Ee}if(!we){I++;continue}const ye=ce;ue[0]!==ue[1]&&ue[0]!==ue[3]&&ue[1]!==ue[3]&&(ye?d.push3(ue[0],ue[3],ue[1]):d.push3(ue[0],ue[1],ue[3])),ue[0]!==ue[2]&&ue[0]!==ue[3]&&ue[2]!==ue[3]&&(ye?d.push3(ue[0],ue[2],ue[3]):d.push3(ue[0],ue[3],ue[2]))}}F&63||(n("contouring",50+Math.round(50*F/_)),await Bt())}return p=null,k=null,n("contouring",100),console.log("DC sparse: "+c+" sign-change edges, "+I+" dropped, "+d.length/3+" faces"),{positions:b.trim(),normals:y.trim(),indices:d.trim(),vertexCount:v,faceCount:Math.floor(d.length/3)}}const No=new Float32Array(1),Un=new Uint32Array(No.buffer);function Vn(e){No[0]=e;const t=Un[0],o=t>>16&32768,n=(t>>23&255)-127+15,s=t&8388607;return n<=0?o:n>=31?o|31744:o|n<<10|s>>13}const Uo=new Uint16Array(256);for(let e=0;e<256;e++)Uo[e]=Vn(e/255);class Vo{constructor(t){oe(this,"buf");oe(this,"a");oe(this,"v");oe(this,"pos");this.buf=new ArrayBuffer(t||8*1024*1024),this.a=new Uint8Array(this.buf),this.v=new DataView(this.buf),this.pos=0}grow(t){let o=this.pos+t;this.buf.byteLength<256*1024*1024?o=Math.max(this.buf.byteLength*2,o):o=Math.max(Math.round(this.buf.byteLength*1.25),o);const n=new ArrayBuffer(o);new Uint8Array(n).set(this.a),this.buf=n,this.a=new Uint8Array(n),this.v=new DataView(n)}en(t){this.pos+t>this.buf.byteLength&&this.grow(t)}u8(t){this.en(1),this.v.setUint8(this.pos,t),this.pos++}u16(t){this.en(2),this.v.setUint16(this.pos,t,!0),this.pos+=2}u32(t){this.en(4),this.v.setUint32(this.pos,t,!0),this.pos+=4}i32(t){this.en(4),this.v.setInt32(this.pos,t,!0),this.pos+=4}u64(t){this.en(8),this.v.setBigUint64(this.pos,t,!0),this.pos+=8}f64(t){this.en(8),this.v.setFloat64(this.pos,t,!0),this.pos+=8}raw(t){this.en(t.length),this.a.set(t,this.pos),this.pos+=t.length}str(t){this.en(t.length);for(let o=0;o<t.length;o++)this.a[this.pos++]=t.charCodeAt(o)}name(t){this.u32(t.length),this.str(t)}zeros(t){this.en(t),this.pos+=t}bulk64(t){const o=t.length*8;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}bulk16(t){const o=t.length*2;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}bulkF32(t){const o=t.length*4;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}result(){return new Uint8Array(this.buf,0,this.pos)}}const ht=0xFFFFFFFFFFFFFFFFn;function $n(){return{n5childMask:new BigUint64Array(512),n5valueMask:new BigUint64Array(512),n5tileValues:new Uint16Array(32768),n4map:new Map}}function Gn(){return{childMask:new BigUint64Array(64),valueMask:new BigUint64Array(64),tileValues:new Uint16Array(4096),leafMap:new Map}}function Xn(e,t,o,n,s){const r=new BigUint64Array(8),a=new Uint16Array(512);let i=0;for(let b=0;b<512;b++)s[b]>0&&(r[b>>6]|=1n<<BigInt(b&63),a[b]=Uo[s[b]],i++);if(i===0)return 0;const l=t<<3,p=o<<3,h=n<<3,u=(h&4095)>>7|(p&4095)>>7<<5|(l&4095)>>7<<10;e.n5childMask[u>>6]|=1n<<BigInt(u&63);let f=e.n4map.get(u);f||(f=Gn(),e.n4map.set(u,f));const g=(h&127)>>3|(p&127)>>3<<4|(l&127)>>3<<8;return f.childMask[g>>6]|=1n<<BigInt(g&63),f.leafMap.set(g,{mask:r,data:a}),i}function Hn(e){let t=0,o=0;return e.n4map.forEach(function(n,s){const r=[];n.leafMap.forEach(function(a,i){let l=!0;for(let u=0;u<8;u++)if(a.mask[u]!==ht){l=!1;break}if(!l)return;const p=a.data[0];let h=!0;for(let u=1;u<512;u++)if(a.data[u]!==p){h=!1;break}h&&r.push([i,p])});for(let a=0;a<r.length;a++){const i=r[a][0],l=r[a][1];n.leafMap.delete(i),n.childMask[i>>6]&=~(1n<<BigInt(i&63)),n.valueMask[i>>6]|=1n<<BigInt(i&63),n.tileValues[i]=l,t++}if(n.leafMap.size===0){let a=!0;for(let i=0;i<64;i++)if(n.valueMask[i]!==ht){a=!1;break}if(a){const i=n.tileValues[0];let l=!0;for(let p=1;p<4096;p++)if(n.tileValues[p]!==i){l=!1;break}l&&(e.n4map.delete(s),e.n5childMask[s>>6]&=~(1n<<BigInt(s&63)),e.n5valueMask[s>>6]|=1n<<BigInt(s&63),e.n5tileValues[s]=i,o++)}}}),{promotedLeaves:t,promotedN4s:o}}function Wn(){return{n5childMask:new BigUint64Array(512),n5valueMask:new BigUint64Array(512),n5tileValues:new Float32Array(32768*3),n4map:new Map}}function Yn(){return{childMask:new BigUint64Array(64),valueMask:new BigUint64Array(64),tileValues:new Float32Array(4096*3),leafMap:new Map}}function qn(e,t,o,n,s,r,a){const i=new BigUint64Array(8),l=new Float32Array(512*3);let p=0;for(let v=0;v<512;v++)(s[v]>0||r[v]>0||a[v]>0)&&(i[v>>6]|=1n<<BigInt(v&63),l[v*3]=s[v]/255,l[v*3+1]=r[v]/255,l[v*3+2]=a[v]/255,p++);if(p===0)return 0;const h=t<<3,u=o<<3,f=n<<3,g=(f&4095)>>7|(u&4095)>>7<<5|(h&4095)>>7<<10;e.n5childMask[g>>6]|=1n<<BigInt(g&63);let b=e.n4map.get(g);b||(b=Yn(),e.n4map.set(g,b));const y=(f&127)>>3|(u&127)>>3<<4|(h&127)>>3<<8;return b.childMask[y>>6]|=1n<<BigInt(y&63),b.leafMap.set(y,{mask:i,data:l}),p}function Zn(e){let t=0,o=0;return e.n4map.forEach(function(n,s){const r=[];n.leafMap.forEach(function(a,i){let l=!0;for(let g=0;g<8;g++)if(a.mask[g]!==ht){l=!1;break}if(!l)return;const p=a.data[0],h=a.data[1],u=a.data[2];let f=!0;for(let g=1;g<512;g++)if(a.data[g*3]!==p||a.data[g*3+1]!==h||a.data[g*3+2]!==u){f=!1;break}f&&r.push([i,p,h,u])});for(const[a,i,l,p]of r)n.leafMap.delete(a),n.childMask[a>>6]&=~(1n<<BigInt(a&63)),n.valueMask[a>>6]|=1n<<BigInt(a&63),n.tileValues[a*3]=i,n.tileValues[a*3+1]=l,n.tileValues[a*3+2]=p,t++;if(n.leafMap.size===0){let a=!0;for(let i=0;i<64;i++)if(n.valueMask[i]!==ht){a=!1;break}if(a){const i=n.tileValues[0],l=n.tileValues[1],p=n.tileValues[2];let h=!0;for(let u=1;u<4096;u++)if(n.tileValues[u*3]!==i||n.tileValues[u*3+1]!==l||n.tileValues[u*3+2]!==p){h=!1;break}h&&(e.n4map.delete(s),e.n5childMask[s>>6]&=~(1n<<BigInt(s&63)),e.n5valueMask[s>>6]|=1n<<BigInt(s&63),e.n5tileValues[s*3]=i,e.n5tileValues[s*3+1]=l,e.n5tileValues[s*3+2]=p,o++)}}}),{promotedLeaves:t,promotedN4s:o}}function Je(e){return Array.from(e.keys()).sort(function(t,o){return t-o})}function je(e,t,o){e.name(t),e.name("string"),e.name(o)}function Qt(e,t,o){e.name(t),e.name("bool"),e.u32(1),e.u8(o?1:0)}function $o(e,t){e.u32(1),e.u32(0),e.u32(0),e.u32(1),e.i32(0),e.i32(0),e.i32(0),e.bulk64(t.n5childMask),e.bulk64(t.n5valueMask),e.u8(6),e.bulk16(t.n5tileValues);const o=Je(t.n4map);for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]);e.bulk64(s.childMask),e.bulk64(s.valueMask),e.u8(6),e.bulk16(s.tileValues);const r=Je(s.leafMap);for(let a=0;a<r.length;a++)e.bulk64(s.leafMap.get(r[a]).mask)}for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]),r=Je(s.leafMap);for(let a=0;a<r.length;a++){const i=s.leafMap.get(r[a]);e.bulk64(i.mask),e.u8(6),e.bulk16(i.data),i.data=null}}}function Jn(e,t){e.u32(1),e.f64(0),e.u32(0),e.u32(0),e.u32(1),e.i32(0),e.i32(0),e.i32(0),e.bulk64(t.n5childMask),e.bulk64(t.n5valueMask),e.u8(6),e.bulkF32(t.n5tileValues);const o=Je(t.n4map);for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]);e.bulk64(s.childMask),e.bulk64(s.valueMask),e.u8(6),e.bulkF32(s.tileValues);const r=Je(s.leafMap);for(let a=0;a<r.length;a++)e.bulk64(s.leafMap.get(r[a]).mask)}for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]),r=Je(s.leafMap);for(let a=0;a<r.length;a++){const i=s.leafMap.get(r[a]);e.bulk64(i.mask),e.u8(6),e.bulkF32(i.data),i.data=null}}}function Kt(e,t,o,n){const s=n/t;e.name("AffineMap"),e.f64(s),e.f64(0),e.f64(0),e.f64(0),e.f64(0),e.f64(s),e.f64(0),e.f64(0),e.f64(0),e.f64(0),e.f64(s),e.f64(0),e.f64(o[0]+.5*s),e.f64(o[1]+.5*s),e.f64(o[2]+.5*s),e.f64(1)}function Qn(e,t,o,n,s,r){e.u32(0),e.u32(4),je(e,"class","unknown"),je(e,"file_compression","none"),Qt(e,"is_saved_as_half_float",!0),je(e,"name",o),Kt(e,n,s,r),$o(e,t)}function Kn(e,t,o,n,s,r){e.u32(0),e.u32(4),je(e,"class","unknown"),je(e,"file_compression","none"),Qt(e,"is_saved_as_half_float",!1),je(e,"name",o),Kt(e,n,s,r),Jn(e,t)}function ea(e,t,o,n){let s=0;e.n4map.forEach(function(i){s+=i.leafMap.size});const r=2e5+s*1200+e.n4map.size*1e4,a=new Vo(Math.max(r,1024*1024));return a.raw(new Uint8Array([32,66,68,86,0,0,0,0])),a.u32(224),a.u32(8),a.u32(1),a.u8(0),a.str("d2b59639-ac2f-4047-9c50-9648f951180c"),a.u32(0),a.u32(1),a.name("density"),a.name("Tree_float_5_4_3_HalfFloat"),a.u32(0),a.u64(BigInt(a.pos+24)),a.u64(0n),a.u64(0n),a.u32(0),a.u32(4),je(a,"class","unknown"),je(a,"file_compression","none"),Qt(a,"is_saved_as_half_float",!0),je(a,"name","density"),Kt(a,t,o,n),$o(a,e),a.result()}function ta(e,t,o,n,s){let r=0;e.n4map.forEach(function(p){r+=p.leafMap.size});let a=0;t.n4map.forEach(function(p){a+=p.leafMap.size});const i=2e5+r*1200+e.n4map.size*1e4+2e5+a*7200+t.n4map.size*6e4,l=new Vo(Math.max(i,2*1024*1024));return l.raw(new Uint8Array([32,66,68,86,0,0,0,0])),l.u32(224),l.u32(8),l.u32(1),l.u8(0),l.str("d2b59639-ac2f-4047-9c50-9648f951180c"),l.u32(0),l.u32(2),l.name("density"),l.name("Tree_float_5_4_3_HalfFloat"),l.u32(0),l.u64(BigInt(l.pos+24)),l.u64(0n),l.u64(0n),Qn(l,e,"density",o,n,s),l.name("Cd"),l.name("Tree_vec3s_5_4_3"),l.u32(0),l.u64(BigInt(l.pos+24)),l.u64(0n),l.u64(0n),Kn(l,t,"Cd",o,n,s),l.result()}function oa(e,t){return{formula:e.id,pipelineRevision:0,quality:t?{estimator:t.estimator??0,distanceMetric:t.distanceMetric??0}:void 0}}function st(e,t,o){const n=o||{};t.uParamA&&e.uniform1f(t.uParamA,n.paramA??8),t.uParamB&&e.uniform1f(t.uParamB,n.paramB??0),t.uParamC&&e.uniform1f(t.uParamC,n.paramC??0),t.uParamD&&e.uniform1f(t.uParamD,n.paramD??0),t.uParamE&&e.uniform1f(t.uParamE,n.paramE??0),t.uParamF&&e.uniform1f(t.uParamF,n.paramF??0);const s=v=>v?[v.x??v[0]??0,v.y??v[1]??0]:[0,0],r=v=>v?[v.x??v[0]??0,v.y??v[1]??0,v.z??v[2]??0]:[0,0,0],a=v=>v?[v.x??v[0]??0,v.y??v[1]??0,v.z??v[2]??0,v.w??v[3]??0]:[0,0,0,0],i=s(n.vec2A);t.uVec2A&&e.uniform2f(t.uVec2A,i[0],i[1]);const l=s(n.vec2B);t.uVec2B&&e.uniform2f(t.uVec2B,l[0],l[1]);const p=s(n.vec2C);t.uVec2C&&e.uniform2f(t.uVec2C,p[0],p[1]);const h=r(n.vec3A);t.uVec3A&&e.uniform3f(t.uVec3A,h[0],h[1],h[2]);const u=r(n.vec3B);t.uVec3B&&e.uniform3f(t.uVec3B,u[0],u[1],u[2]);const f=r(n.vec3C);t.uVec3C&&e.uniform3f(t.uVec3C,f[0],f[1],f[2]);const g=a(n.vec4A);t.uVec4A&&e.uniform4f(t.uVec4A,g[0],g[1],g[2],g[3]);const b=a(n.vec4B);t.uVec4B&&e.uniform4f(t.uVec4B,b[0],b[1],b[2],b[3]);const y=a(n.vec4C);if(t.uVec4C&&e.uniform4f(t.uVec4C,y[0],y[1],y[2],y[3]),t.uJulia){const v=n.julia;Array.isArray(v)?e.uniform3f(t.uJulia,v[0]??0,v[1]??0,v[2]??0):v&&typeof v=="object"?e.uniform3f(t.uJulia,v.x??0,v.y??0,v.z??0):e.uniform3f(t.uJulia,0,0,0)}t.uJuliaMode&&e.uniform1f(t.uJuliaMode,n.juliaMode?1:0),t.uEscapeThresh&&e.uniform1f(t.uEscapeThresh,n.escapeThresh??10),t.uDeBailout&&e.uniform1f(t.uDeBailout,n.deBailout??100),t.uDistanceMetric&&e.uniform1f(t.uDistanceMetric,n.distanceMetric??0)}function rt(e,t,o){if(t.uWeaveEnabled&&e.uniform1f(t.uWeaveEnabled,(o==null?void 0:o.weaveEnabled)===!1?0:1),!o)return;const n=s=>s.charAt(0).toUpperCase()+s.slice(1);for(const[s,r]of Object.entries(o)){if(s==="weaveEnabled")continue;const a=t["u"+n(s)];a&&(/^ws\d+Vec2/.test(s)?e.uniform2f(a,(r==null?void 0:r.x)??0,(r==null?void 0:r.y)??0):/^ws\d+Vec3/.test(s)?e.uniform3f(a,(r==null?void 0:r.x)??0,(r==null?void 0:r.y)??0,(r==null?void 0:r.z)??0):/^ws\d+Vec4/.test(s)?e.uniform4f(a,(r==null?void 0:r.x)??0,(r==null?void 0:r.y)??0,(r==null?void 0:r.z)??0,(r==null?void 0:r.w)??0):e.uniform1f(a,typeof r=="number"?r:r?1:0))}}function vo(e,t,o,n){const s=e.createShader(t);if(!s)throw new Error("Failed to create shader");if(e.shaderSource(s,o),e.compileShader(s),!e.getShaderParameter(s,e.COMPILE_STATUS)){const r=e.getShaderInfoLog(s)||"",a=t===e.VERTEX_SHADER?"vertex":"fragment";n("Shader compile error ("+a+"): "+r,"error");const i=o.split(`
...
//   mean?) rather than a per-axis one.
//
//   DEFERRED 2026-07-28 by owner decision: mesh-export is still a v2 prototype,
//   so this is to be tackled when the exporter is integrated properly rather
//   than patched now. Note this tree has NO runtime guard of any kind
//   (.claude/rules/sibling-apps.md), so there is nothing that would catch a
//   wrong fix — verify by exporting a deliberately non-cubic box and measuring
//   it in a DCC tool.
uniform float uBoundsRange;
...
}`,h=it(e,Ke,p,s);e.useProgram(h);const u=e.createTexture();e.bindTexture(e.TEXTURE_2D,u),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,t,t);const f=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,f),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,u,0),e.viewport(0,0,t,t),e.bindVertexArray(e.createVertexArray());const g=["uZ","uPower","uIters","uInvRes","uTileOffset","uBoundsMin","uBoundsRange",...qe],b={};for(let y=0;y<g.length;y++)b[g[y]]=e.getUniformLocation(h,g[y]);return{prog:h,loc:b,fbo:f,tex:u}}function lt(e,t,o,n,s,r,a,i,l,p){e.useProgram(t.prog),e.uniform1f(t.loc.uPower,n),e.uniform1i(t.loc.uIters,s),e.uniform1f(t.loc.uInvRes,1/o),e.uniform3f(t.loc.uBoundsMin,r[0],r[1],r[2]),e.uniform1f(t.loc.uBoundsRange,a),t.loc.uSurfaceThreshold&&e.uniform1f(t.loc.uSurfaceThreshold,p??0),st(e,t.loc,i),rt(e,t.loc,l),e.bindFramebuffer(e.FRAMEBUFFER,t.fbo)}async function Go(e,t,o,n,s,r,a,i,l,p,h,u,f){const{log:g,setPhase:b,setStatus:y,tick:v}=p,M=128,m=i[0]-a[0];let w=0,C=n-1;if(n>M){g("Coarse pre-pass: sampling "+M+"³ to detect Z range...","info"),b("Coarse Pre-pass",0),y("Coarse pre-pass ("+M+"³)..."),await v();const U=Qe(e,M,t,1,g,h,u);lt(e,U,M,s,r,a,m,o,h,f),e.viewport(0,0,M,M);const B=new Float32Array(M*M*4);let R=M,L=-1;for(let V=0;V<M;V++){e.uniform1f(U.loc.uZ,(V+.5)/M),e.uniform2f(U.loc.uTileOffset,0,0),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,M,M,e.RGBA,e.FLOAT,B);let d=!1;for(let c=0;c<M*M;c++)if(B[c*4]<l*3){d=!0;break}d&&(V<R&&(R=V),L=V)}if(e.deleteTexture(U.tex),e.deleteFramebuffer(U.fbo),e.deleteProgram(U.prog),L>=R){const d=n/M;w=Math.max(0,Math.floor((R-2)*d)),C=Math.min(n-1,Math.ceil((L+2+1)*d)),w=w&-8,C=Math.min(n-1,C|7);const c=(100*(1-(C-w+1)/n)).toFixed(0);g("Coarse pre-pass: data in Z ["+R+","+L+"] of "+M+" → fine Z ["+w+","+C+"] of "+n+" (skipping "+c+"% of slices)","data")}else g("Coarse pre-pass: no data found — sampling all slices","warn");b("Coarse Pre-pass",100)}return{zSliceMin:w,zSliceMax:C}}function Xo(e,t,o,n,s,r,a,i,l){function p(h,u){if(e.useProgram(t.prog),e.bindFramebuffer(e.FRAMEBUFFER,t.fbo),e.uniform1f(t.loc.uZ,h),o<=n){e.uniform2f(t.loc.uTileOffset,0,0),e.viewport(0,0,o,o),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,o,o,e.RGBA,e.FLOAT,s);for(let f=0;f<o*o;f++)u[f]=s[f*4]}else for(let f=0;f<o;f+=n)for(let g=0;g<o;g+=n){const b=Math.min(n,o-g),y=Math.min(n,o-f);e.uniform2f(t.loc.uTileOffset,g,f),e.viewport(0,0,b,y),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,b,y,e.RGBA,e.FLOAT,s);for(let v=0;v<y;v++)for(let M=0;M<b;M++)u[(f+v)*o+(g+M)]=s[(v*b+M)*4]}}if(!i||i<=1)p((a+.5)/o,r);else{r.fill(0);const h=1/i;for(let u=0;u<i;u++){const f=(a+(u+.5)*h)/o;p(f,l);for(let g=0;g<o*o;g++)r[g]+=l[g]}for(let u=0;u<o*o;u++)r[u]*=h}}function Ho(e,t,o,n){const s=t/n,r=new ImageData(n,n);for(let a=0;a<n;a++){const i=Math.min(Math.round(a*s),t-1);for(let l=0;l<n;l++){const p=Math.min(Math.round(l*s),t-1),h=e[i*t+p],u=Math.abs(h),f=u<o*2?Math.round(255*(1-u/(o*2))):0,g=h<0?50:0,b=(a*n+l)*4;r.data[b]=f+g,r.data[b+1]=h<0?30:f,r.data[b+2]=f,r.data[b+3]=255}}return r}async function go(e,t,o,n,s,r,a,i,l,p,h,u,f,g,b,y){const{setProgress:v,setPhase:M,setStatus:m,tick:w,log:C,onSlicePreview:U}=g,B=Math.min(o,2048),R=i[0]-a[0];(!h||h<1)&&(h=1),u==null&&(u=0),f==null&&(f=o-1),lt(e,t,o,n,s,a,R,r,b,y),e.viewport(0,0,B,B);const L=new Float32Array(B*B*4),V=new Float32Array(o*o*o),d=R/o,c=new Float32Array(o*o),I=h>1?new Float32Array(o*o):null,F=Math.min(o,512);(u>0||f<o-1)&&V.fill(1),h>1&&C("Z sub-slicing: "+h+" sub-samples per voxel layer (smooths Z-axis banding)","info");const _=f-u+1;let k=0;for(let E=u;E<=f;E++){if(Xo(e,t,o,B,L,c,E,h,I),V.set(c,E*o*o),U){const j=Ho(c,o,d,F);U(j,F,F)}k++,v(l+Math.round(k/_*p)),M("SDF Sampling",Math.round(k/_*100)),k&3||(m("Sampling SDF... slice "+k+"/"+_),await w())}return V}function na(e,t,o,n,s,r,a,i,l){const p=a/l,h=new ImageData(l,l);for(let u=0;u<l;u++){const f=Math.round(u*p);for(let g=0;g<l;g++){const b=Math.round(g*p),y=(u*l+g)*4;if(b>=t&&b<n&&f>=o&&f<s){const v=((f-o)*r+(b-t))*4,M=e[v],m=Math.abs(M),w=m<i*2?Math.round(255*(1-m/(i*2))):0,C=M<0?50:0;h.data[y]=w+C,h.data[y+1]=M<0?30:w,h.data[y+2]=w}else h.data[y]=15,h.data[y+1]=15,h.data[y+2]=20;h.data[y+3]=255}}return h}async function aa(e,t,o,n,s,r,a,i,l,p,h,u,f){const{setProgress:g,setPhase:b,setStatus:y,tick:v,onSlicePreview:M}=h,m=o.N,w=o.blockSize,C=Math.min(m,2048),U=i[0]-a[0];lt(e,t,m,n,s,a,U,r,u,f),e.viewport(0,0,C,C);const B=new Map;Jt(o,(F,_,k,E,j,A)=>{for(let T=0;T<w;T++){const z=A+T;if(z>=m)continue;let S=B.get(z);S||(S={entries:[],minX:E,minY:j,maxX:E+w,maxY:j+w},B.set(z,S)),S.entries.push({startX:E,startY:j}),E<S.minX&&(S.minX=E),j<S.minY&&(S.minY=j),E+w>S.maxX&&(S.maxX=E+w),j+w>S.maxY&&(S.maxY=j+w)}});const R=Array.from(B.keys()).sort((F,_)=>F-_);let L=0;for(let F=0;F<R.length;F++){const _=B.get(R[F]),k=Math.min(m,_.maxX)-Math.max(0,_.minX),E=Math.min(m,_.maxY)-Math.max(0,_.minY),j=k*E*4;j>L&&(L=j)}const V=new Float32Array(L),d=Math.min(m,512),c=U/m;let I=0;for(let F=0;F<R.length;F++){const _=R[F],k=B.get(_);e.uniform1f(t.loc.uZ,(_+.5)/m);const E=Math.max(0,k.minX),j=Math.max(0,k.minY),A=Math.min(m,k.maxX),T=Math.min(m,k.maxY),z=A-E,S=T-j;e.uniform2f(t.loc.uTileOffset,E,j),e.viewport(0,0,z,S),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,z,S,e.RGBA,e.FLOAT,V);const O=k.entries;for(let D=0;D<O.length;D++){const P=O[D];for(let G=0;G<w;G++){const H=P.startX+G;if(!(H<E||H>=A))for(let X=0;X<w;X++){const $=P.startY+X;if($<j||$>=T)continue;const N=(($-j)*z+(H-E))*4;o.set(H,$,_,V[N])}}}if(I++,!(I&7)){if(M){const D=na(V,E,j,A,T,z,m,c,d);M(D,d,d)}g(l+Math.round(I/R.length*p)),b("Fine SDF Sampling",Math.round(I/R.length*100)),y("Sampling fine SDF... slice "+I+"/"+R.length+" (narrow-band)"),await v()}}return o}async function sa(e,t,o,n,s,r,a,i,l,p,h,u,f,g,b,y){const{log:v,setProgress:M,setPhase:m,setStatus:w,tick:C,onSlicePreview:U}=u,B=i[0]-a[0],R=B/n,L=8,V=n/L|0,d=Math.min(n,2048);(!h||h<1)&&(h=1);const c=await Go(e,t,o,n,s,r,a,i,R,u,f,g,b),{zSliceMin:I,zSliceMax:F}=c,_=Qe(e,d,t,p||1,v,f,g);lt(e,_,n,s,r,a,B,o,f,b);const k=new Float32Array(d*d*4),E=$n();let j=0;const A=new Array(L);for(let X=0;X<L;X++)A[X]=new Float32Array(n*n);const T=h>1?new Float32Array(n*n):null,z=Math.min(n,512),S=F-I+1;let O=0;h>1&&v("Z sub-slicing: "+h+" sub-samples per voxel layer (smooths Z-axis banding)","info");for(let X=I;X<=F;X++){const $=A[X%L];if(Xo(e,_,n,d,k,$,X,h,T),X%L===L-1){const N=X/L|0;for(let Z=0;Z<V;Z++)for(let Q=0;Q<V;Q++){const ne=new Uint8Array(512);let K=!1;for(let ee=0;ee<L;ee++){const re=A[ee];for(let ie=0;ie<L;ie++)for(let le=0;le<L;le++){const ve=Q*L+le,Y=Z*L+ie,q=re[Y*n+ve],te=ee|ie<<3|le<<6;let ce;q<0?ce=255:ce=Math.round(Math.max(0,Math.min(255,255*(1-q/(R*2.5))))),ne[te]=ce,ce>0&&(K=!0)}}K&&(j+=Xn(E,Q,Z,N,ne))}}if(O++,!(O&7)){const N=Math.round(O/S*80);if(M(N),m("VDB Sampling",Math.round(O/S*100)),w("VDB sampling slice "+O+"/"+S+(I>0||F<n-1?" (Z "+I+"–"+F+")":"")),U){const Z=Ho(A[X%L],n,R,z);U(Z,z,z)}await C()}}if(e.deleteTexture(_.tex),e.deleteFramebuffer(_.fbo),e.deleteProgram(_.prog),u.memAlloc){let X=0;E.n4map.forEach(N=>{X+=N.leafMap.size});const $=Math.round((X*1.1+E.n4map.size*10)/1024);u.memAlloc("vdbDensity","VDB Density",$,"#8c6")}let D=null;if(y){m("VDB Color",0),w("Sampling voxel colors..."),v("Color pass: sampling orbit-trap colors for active voxels","phase");let X=0;if(E.n4map.forEach($=>{$.leafMap.forEach(N=>{for(let Z=0;Z<8;Z++){let Q=N.mask[Z];for(;Q!==0n;)Q&=Q-1n,X++}})}),v("Color pass: "+X.toLocaleString()+" active voxels to colorize","data"),X>0){const $=Wn(),N=Math.min(e.getParameter(e.MAX_TEXTURE_SIZE),2048),Z=N*N,Q=zo({definition:t}),ne=it(e,Ke,Q,v),K=eo(e,ne),ee=e.createVertexArray(),re=e.getUniformLocation(ne,"uPositions"),ie=e.getUniformLocation(ne,"uPower"),le=e.getUniformLocation(ne,"uIters"),ve=e.getUniformLocation(ne,"uWidth"),Y=e.getUniformLocation(ne,"uJitterOffset"),q=[];E.n4map.forEach((ge,pe)=>{ge.leafMap.forEach((Ee,Fe)=>{q.push(pe,Fe)})});const te=q.length>>1,ce=Math.ceil(Math.sqrt(Z)),se=Math.ceil(Z/ce),J=ce*se,ae=new Float32Array(J*4),fe=new Uint8Array(J*4),he=new Uint16Array(Z),be=new Uint32Array(Z),Re=new Uint8Array(512),De=new Uint8Array(512),ue=new Uint8Array(512);let we=0,ye=0;for(;ye<te;){let ge=0,pe=ye;for(;pe<te&&ge+512<=Z;){const Le=q[pe*2],Ne=q[pe*2+1],tt=E.n4map.get(Le).leafMap.get(Ne),Ct=(Le>>10&31)<<7,Mt=(Le>>5&31)<<7,Et=(Le&31)<<7,Tt=(Ne>>8&15)<<3,Dt=(Ne>>4&15)<<3,Rt=(Ne&15)<<3,Ft=Ct+Tt,Pt=Mt+Dt,At=Et+Rt;for(let Pe=0;Pe<512;Pe++){if((tt.mask[Pe>>6]&1n<<BigInt(Pe&63))===0n)continue;const qo=Pe&7,Zo=Pe>>3&7,Jo=Pe>>6&7;ae[ge*4]=a[0]+(Ft+Jo+.5)*R,ae[ge*4+1]=a[1]+(Pt+Zo+.5)*R,ae[ge*4+2]=a[2]+(At+qo+.5)*R,ae[ge*4+3]=1,he[ge]=Pe,be[ge]=pe,ge++}pe++}const Ee=ge;if(Ee===0){ye=pe;continue}const Fe=Math.ceil(Math.sqrt(Ee)),ze=Math.ceil(Ee/Fe);e.useProgram(ne);const Ge=e.createTexture();e.bindTexture(e.TEXTURE_2D,Ge),e.texImage2D(e.TEXTURE_2D,0,e.RGBA32F,Fe,ze,0,e.RGBA,e.FLOAT,ae.subarray(0,Fe*ze*4)),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE);const Xe=e.createTexture();e.bindTexture(e.TEXTURE_2D,Xe),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA8,Fe,ze);const et=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,et),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,Xe,0),e.viewport(0,0,Fe,ze),e.bindVertexArray(ee),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,Ge),e.uniform1i(re,0),e.uniform1f(ie,s),e.uniform1i(le,r),e.uniform1i(ve,Fe),e.uniform3f(Y,0,0,0),st(e,K,o),rt(e,K,f),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,Fe,ze,e.RGBA,e.UNSIGNED_BYTE,fe),e.deleteTexture(Ge),e.deleteTexture(Xe),e.deleteFramebuffer(et);let Be=0;for(let Le=ye;Le<pe;Le++){if(Be>=Ee||be[Be]!==Le)continue;const Ne=q[Le*2],tt=q[Le*2+1],Ct=(Ne>>10&31)<<7,Mt=(Ne>>5&31)<<7,Et=(Ne&31)<<7,Tt=(tt>>8&15)<<3,Dt=(tt>>4&15)<<3,Rt=(tt&15)<<3,Ft=Ct+Tt>>3,Pt=Mt+Dt>>3,At=Et+Rt>>3;for(Re.fill(0),De.fill(0),ue.fill(0);Be<Ee&&be[Be]===Le;){const Pe=he[Be];Re[Pe]=fe[Be*4],De[Pe]=fe[Be*4+1],ue[Pe]=fe[Be*4+2],Be++}qn($,Ft,Pt,At,Re,De,ue)}we+=Ee,ye=pe;const oo=Math.round(we/X*100);M(80+Math.round(oo*.12)),m("VDB Color",oo),w("Color pass: "+we.toLocaleString()+"/"+X.toLocaleString()+" voxels"),await C()}if(e.deleteProgram(ne),e.deleteVertexArray(ee),Zn($),D=$,u.memAlloc){let ge=0;$.n4map.forEach(Ee=>{ge+=Ee.leafMap.size});const pe=Math.round((ge*6.2+$.n4map.size*60)/1024);u.memAlloc("vdbColor","VDB Color",pe,"#e6a")}v("Color pass complete: Cd vec3s grid built","success")}m("VDB Color",100),await C()}M(92),m("VDB Optimize",0),w("Optimizing VDB tree...");const P=Hn(E);M(95),m("VDB Serialize",50),w("Serializing VDB..."),await C();let G=0;E.n4map.forEach(X=>{G+=X.leafMap.size});let H;if(D?H=ta(E,D,n,a,B):H=ea(E,n,a,B),u.memFree&&(u.memFree("vdbDensity"),D&&u.memFree("vdbColor")),u.memAlloc){const X=Math.round(H.byteLength/1048576);u.memAlloc("vdbBlob","VDB File",X,"#5af")}return M(100),m("VDB Complete",100),{blob:new Blob([H.buffer.slice(H.byteOffset,H.byteOffset+H.byteLength)],{type:"application/octet-stream"}),voxelCount:j,leafCount:G,promoted:P,zRange:[I,F],skippedSlices:n-S}}async function ra(e,t,o,n,s,r,a,i,l,p,h){const{log:u,tick:f}=l,g=t.N,b=t.blockSize,y=t.blocksPerAxis,v=Math.min(g,2048),M=i[0]-a[0],m=t.blockCellCount+7>>3,w=wn({definition:o}),C=it(e,Ke,w,u);e.useProgram(C);const U=["uZ","uPower","uIters","uInvRes","uTileOffset","uBoundsMin","uBoundsRange",...qe],B={};for(let k=0;k<U.length;k++)B[U[k]]=e.getUniformLocation(C,U[k]);const R=e.createTexture();e.bindTexture(e.TEXTURE_2D,R),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,v,v);const L=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,L),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,R,0),e.uniform1f(B.uPower,n),e.uniform1i(B.uIters,s),e.uniform1f(B.uInvRes,1/g),e.uniform3f(B.uBoundsMin,a[0],a[1],a[2]),e.uniform1f(B.uBoundsRange,M),st(e,B,r),rt(e,B,h),e.bindVertexArray(e.createVertexArray());const V=new Map;Jt(t,(k,E,j,A,T,z)=>{for(let S=0;S<b;S++){const O=z+S;if(O>=g)continue;let D=V.get(O);D||(D={entries:[],minX:A,minY:T,maxX:A+b,maxY:T+b},V.set(O,D)),D.entries.push({startX:A,startY:T}),A<D.minX&&(D.minX=A),T<D.minY&&(D.minY=T),A+b>D.maxX&&(D.maxX=A+b),T+b>D.maxY&&(D.maxY=T+b)}});const d=Array.from(V.keys()).sort((k,E)=>k-E);let c=0;for(let k=0;k<d.length;k++){const E=V.get(d[k]),j=Math.min(g,E.maxX)-Math.max(0,E.minX),A=Math.min(g,E.maxY)-Math.max(0,E.minY);j*A*4>c&&(c=j*A*4)}const I=new Float32Array(c),F=new Map;t.blocks.forEach((k,E)=>{F.set(E,new Uint8Array(m))});let _=0;for(let k=0;k<d.length;k++){const E=d[k],j=V.get(E);e.uniform1f(B.uZ,(E+.5)/g);const A=Math.max(0,j.minX),T=Math.max(0,j.minY),z=Math.min(g,j.maxX),S=Math.min(g,j.maxY),O=z-A,D=S-T;e.uniform2f(B.uTileOffset,A,T),e.viewport(0,0,O,D),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,O,D,e.RGBA,e.FLOAT,I);const P=j.entries;for(let G=0;G<P.length;G++){const H=P[G],X=H.startX/b|0,$=H.startY/b|0,N=E/b|0,Z=(N*y+$)*y+X,Q=F.get(Z);if(!Q)continue;const ne=E-N*b;for(let K=0;K<b;K++){const ee=H.startX+K;if(!(ee<A||ee>=z))for(let re=0;re<b;re++){const ie=H.startY+re;if(ie<T||ie>=S)continue;const le=((ie-T)*O+(ee-A))*4;if(I[le]>.5){const ve=(ne*b+re)*b+K;Q[ve>>3]|=1<<(ve&7),_++}}}}!(k&7)&&p&&(p(Math.round(k/d.length*100)),await f())}return e.deleteTexture(R),e.deleteFramebuffer(L),e.deleteProgram(C),{escapeMap:F,solidCount:_}}function ia(e,t,o,n,s,r,a,i,l,p){i||(i=6);const h=t.vertexCount,u=Math.ceil(Math.sqrt(h)),f=Math.ceil(h/u),g=new Float32Array(u*f*4);for(let R=0;R<h;R++)g[R*4]=t.positions[R*3],g[R*4+1]=t.positions[R*3+1],g[R*4+2]=t.positions[R*3+2],g[R*4+3]=1;const b=e.createTexture();e.bindTexture(e.TEXTURE_2D,b),e.texImage2D(e.TEXTURE_2D,0,e.RGBA32F,u,f,0,e.RGBA,e.FLOAT,g),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE);const y=e.createTexture();e.bindTexture(e.TEXTURE_2D,y),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,u,f);const v=e.createTexture();e.bindTexture(e.TEXTURE_2D,v),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,u,f);const M=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,M),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,y,0),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT1,e.TEXTURE_2D,v,0),e.drawBuffers([e.COLOR_ATTACHMENT0,e.COLOR_ATTACHMENT1]);const m=Sn({definition:o,deType:"auto"}),w=it(e,Ke,m,l);e.useProgram(w),e.viewport(0,0,u,f),e.bindVertexArray(e.createVertexArray()),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,b),e.uniform1i(e.getUniformLocation(w,"uPositions"),0),e.uniform1f(e.getUniformLocation(w,"uPower"),s),e.uniform1i(e.getUniformLocation(w,"uIters"),r),e.uniform1f(e.getUniformLocation(w,"uVoxelSize"),a),e.uniform1i(e.getUniformLocation(w,"uNewtonSteps"),i);const C=eo(e,w);st(e,C,n),rt(e,C,p),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readBuffer(e.COLOR_ATTACHMENT0);const U=new Float32Array(u*f*4);e.readPixels(0,0,u,f,e.RGBA,e.FLOAT,U),e.readBuffer(e.COLOR_ATTACHMENT1);const B=new Float32Array(u*f*4);e.readPixels(0,0,u,f,e.RGBA,e.FLOAT,B);for(let R=0;R<h;R++)t.positions[R*3]=U[R*4],t.positions[R*3+1]=U[R*4+1],t.positions[R*3+2]=U[R*4+2],t.normals[R*3]=B[R*4],t.normals[R*3+1]=B[R*4+1],t.normals[R*3+2]=B[R*4+2];return e.deleteTexture(b),e.deleteTexture(y),e.deleteTexture(v),e.deleteFramebuffer(M),e.deleteProgram(w),t}async function la(e,t,o,n,s,r,a,i,l,p){const{log:h,setProgress:u,setPhase:f,setStatus:g,tick:b}=l;(!a||a<1)&&(a=1),i||(i=0);const y=t.vertexCount,v=Math.ceil(Math.sqrt(y)),M=Math.ceil(y/v);h("Color texture: "+v+"x"+M+" ("+(v*M*16/(1024*1024)).toFixed(0)+" MB position data)"+(a>1?" | "+a+" samples, radius="+i.toFixed(5):""),"mem");let m=new Float32Array(v*M*4);for(let I=0;I<y;I++)m[I*4]=t.positions[I*3],m[I*4+1]=t.positions[I*3+1],m[I*4+2]=t.positions[I*3+2],m[I*4+3]=1;const w=zo({definition:o}),C=it(e,Ke,w,h);e.useProgram(C);const U=e.createTexture();e.bindTexture(e.TEXTURE_2D,U),e.texImage2D(e.TEXTURE_2D,0,e.RGBA32F,v,M,0,e.RGBA,e.FLOAT,m),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),m=null;const B=a>1,R=e.createTexture();e.bindTexture(e.TEXTURE_2D,R),e.texStorage2D(e.TEXTURE_2D,1,B?e.RGBA32F:e.RGBA8,v,M);const L=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,L),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,R,0),e.viewport(0,0,v,M),e.bindVertexArray(e.createVertexArray());const V=eo(e,C),d=e.getUniformLocation(C,"uJitterOffset");if(e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,U),e.uniform1i(e.getUniformLocation(C,"uPositions"),0),e.uniform1f(e.getUniformLocation(C,"uPower"),s),e.uniform1i(e.getUniformLocation(C,"uIters"),r),e.uniform1i(e.getUniformLocation(C,"uWidth"),v),st(e,V,n),rt(e,V,p),a<=1)e.uniform3f(d,0,0,0),e.drawArrays(e.TRIANGLE_STRIP,0,4);else{e.clearColor(0,0,0,0),e.clear(e.COLOR_BUFFER_BIT),e.enable(e.BLEND),e.blendFunc(e.ONE,e.ONE);const I=Math.PI*(3-Math.sqrt(5));for(let F=0;F<a;F++){const _=Math.acos(1-2*(F+.5)/a),k=I*F,E=i*Math.cbrt((F+.5)/a),j=E*Math.sin(_)*Math.cos(k),A=E*Math.sin(_)*Math.sin(k),T=E*Math.cos(_);if(e.uniform3f(d,j,A,T),e.drawArrays(e.TRIANGLE_STRIP,0,4),!(F&3)||F===a-1){const z=Math.round((F+1)/a*100);u(80+Math.round((F+1)/a*10)),f("Phase 5: Vertex Coloring",z),g("Color sample "+(F+1)+"/"+a),await b()}}e.disable(e.BLEND)}const c=new Uint8Array(y*4);if(B){const I=new Float32Array(v*M*4);e.readPixels(0,0,v,M,e.RGBA,e.FLOAT,I);const F=1/a;for(let _=0;_<y;_++)c[_*4]=Math.min(255,Math.round(I[_*4]*F*255)),c[_*4+1]=Math.min(255,Math.round(I[_*4+1]*F*255)),c[_*4+2]=Math.min(255,Math.round(I[_*4+2]*F*255)),c[_*4+3]=255}else{const I=new Uint8Array(v*M*4);e.readPixels(0,0,v,M,e.RGBA,e.UNSIGNED_BYTE,I);for(let F=0;F<y;F++)c[F*4]=I[F*4],c[F*4+1]=I[F*4+1],c[F*4+2]=I[F*4+2],c[F*4+3]=255}return e.deleteTexture(U),e.deleteTexture(R),e.deleteFramebuffer(L),e.deleteProgram(C),c}async function ca(e,t,o,n,s,r,a){var b;const i=vt(),l=64,p=6,h=[-p/2,-p/2,-p/2],u=p,f=u/l,g=a??0;try{const y=Qe(i,l,e,1,()=>{},s,r);lt(i,y,l,n,o,h,u,t,s,g),i.viewport(0,0,l,l);const v=new Float32Array(l*l*4);let M=1/0,m=1/0,w=1/0,C=-1/0,U=-1/0,B=-1/0,R=!1;for(let F=0;F<l;F++){i.uniform1f(y.loc.uZ,(F+.5)/l),i.uniform2f(y.loc.uTileOffset,0,0),i.drawArrays(i.TRIANGLE_STRIP,0,4),i.readPixels(0,0,l,l,i.RGBA,i.FLOAT,v);const _=h[2]+(F+.5)*f;for(let k=0;k<l;k++)for(let E=0;E<l;E++)if(v[(k*l+E)*4]<f*2){const A=h[0]+(E+.5)*f,T=h[1]+(k+.5)*f;A<M&&(M=A),A>C&&(C=A),T<m&&(m=T),T>U&&(U=T),_<w&&(w=_),_>B&&(B=_),R=!0}}if(i.deleteTexture(y.tex),i.deleteFramebuffer(y.fbo),i.deleteProgram(y.prog),!R)return null;const L=.15,V=(C-M)*(1+L),d=(U-m)*(1+L),c=(B-w)*(1+L),I=Math.max(V,d,c,.5);return{center:[(M+C)/2,(m+U)/2,(w+B)/2],size:[I,I,I]}}finally{(b=i.getExtension("WEBGL_lose_context"))==null||b.loseContext()}}function ua(){const e=W(u=>u.bboxCenter),t=W(u=>u.bboxSize),o=W(u=>u.setBboxCenter),n=W(u=>u.setBboxSize),s=W(u=>u.resetBounds),[r,a]=de.useState(!1),i=u=>{o([u.x,u.y,u.z??0])},l=de.useMemo(()=>new $e(t[0],t[1],t[2]),[t[0],t[1],t[2]]),p=de.useCallback(u=>{n([u.x,u.y,u.z])},[n]),h=async()=>{const u=W.getState(),f=u.loadedDefinition||_e.get(u.selectedFormulaId);if(f){a(!0);try{const g=Gt(u),b=u.qualitySettings,y={estimator:b.estimator,distanceMetric:b.distanceMetric},v=await ca(f,u.formulaParams,u.iters,u.formulaParams.paramA||8,g,y,b.surfaceThreshold);v&&(o(v.center),n(v.size))}catch(g){console.error("Auto-fit failed:",g)}finally{a(!1)}}};return x.jsxs("div",{className:"flex flex-col gap-px mt-1",children:[x.jsx(Nt,{label:"Center",value:{x:e[0],y:e[1],z:e[2]},onChange:i,axisConfig:{min:-100,max:100,step:.1},showDualAxisPads:!1}),x.jsx(on,{label:"Size",value:l,onChange:p,min:.1,max:100,step:.1,showDualAxisPads:!1,linkable:!0}),x.jsxs("div",{className:"flex items-center gap-2 mt-1 px-0.5",children:[x.jsx("button",{onClick:s,className:"text-[10px] px-2 py-0.5 bg-line/10 text-fg-tertiary border border-line/10 rounded-sm hover:bg-line/15 cursor-pointer",children:"Reset"}),x.jsx("button",{onClick:h,disabled:r,className:"text-[10px] px-2 py-0.5 bg-ok/40 text-ok border border-ok/30 rounded-sm hover:bg-ok/40 cursor-pointer disabled:opacity-50 disabled:cursor-default",children:r?"Fitting...":"Auto-fit"}),x.jsxs("span",{className:"text-[10px] text-fg-faint",children:[t[0].toFixed(1)," × ",t[1].toFixed(1)," × ",t[2].toFixed(1)]})]})]})}const xo={info:"text-fg-muted",phase:"text-emerald-400 font-bold",data:"text-sky-400",warn:"text-amber-400",error:"text-red-400 font-bold",success:"text-emerald-400",mem:"text-pink-300"},fa=()=>{const e=W(m=>m.status),t=W(m=>m.progress),o=W(m=>m.phaseName),n=W(m=>m.phaseProgress),s=W(m=>m.memoryBlocks),r=W(m=>m.logEntries),a=W(m=>m.clearLog),i=W(m=>m.lastMesh),l=W(m=>m.lastTimings),p=W(m=>m.smoothingSkipped),h=W(m=>m.useNarrowBand),u=W(m=>m.resolution),f=W(m=>m.newton),g=W(m=>m.isRunning),b=de.useRef(null);de.useEffect(()=>{var m;(m=b.current)==null||m.scrollIntoView({behavior:"smooth"})},[r.length]);const y=s.reduce((m,w)=>m+(w.freed?0:w.mb),0),v=Math.max(1,...s.map(m=>m.mb)),M=()=>{const m=r.map(w=>`[${w.time}] ${w.msg}`).join(`
`);navigator.clipboard.writeText(m).catch(()=>{})};return x.jsxs("div",{className:"font-mono flex flex-col gap-2",children:[e&&x.jsx("div",{className:"text-[13px] text-warn font-bold",children:e}),x.jsx("div",{className:"h-1 bg-surface-header rounded overflow-hidden",children:x.jsx("div",{className:"h-full bg-gradient-to-r from-emerald-700 to-emerald-400 transition-[width] duration-300",style:{width:`${Math.min(100,Math.max(0,t))}%`}})}),o&&x.jsx("div",{className:"text-[11px] text-fg-dim",children:o}),x.jsx("div",{className:"h-[3px] bg-surface-header rounded overflow-hidden",children:x.jsx("div",{className:"h-full bg-gradient-to-r from-sky-700 to-sky-400 transition-[width] duration-300",style:{width:`${Math.min(100,Math.max(0,n))}%`}})}),i&&l&&!g&&x.jsxs("div",{className:"text-[11px] leading-relaxed bg-surface-section border border-line/10 rounded px-2 py-1.5",children:[x.jsxs("span",{className:"text-emerald-400",children:[u,"³ · ",i.vertexCount.toLocaleString()," vertices · ",i.faceCount.toLocaleString()," faces"]})," · ",x.jsxs("span",{className:"text-sky-400",children:[Math.round((i.positions.byteLength+i.normals.byteLength+i.indices.byteLength)/(1024*1024))," MB mesh"]}),f&&x.jsx("span",{className:"text-fg-muted",children:" · Newton projected"}),p&&x.jsx("span",{className:"text-warn",children:" · smoothing skipped (>5M verts)"}),x.jsx("br",{}),x.jsxs("span",{className:"text-fg-dim",children:[h?`Coarse: ${(l.coarse/1e3).toFixed(1)}s · Fine: ${(l.fine/1e3).toFixed(1)}s`:`SDF: ${(l.sdf/1e3).toFixed(1)}s`," · ","DC: ",(l.dc/1e3).toFixed(1),"s",l.newton>100&&` · Newton: ${(l.newton/1e3).toFixed(1)}s`," · ","Post: ",(l.post/1e3).toFixed(1),"s"," · ","Color: ",(l.color/1e3).toFixed(1),"s"," · ","Total: ",(l.total/1e3).toFixed(1),"s"]})]}),s.length>0&&x.jsxs("div",{children:[x.jsx("div",{className:"flex gap-px h-[18px] rounded overflow-hidden",children:s.map(m=>x.jsx("div",{title:`${m.label}: ${m.mb} MB${m.freed?" (freed)":""}`,className:"flex items-center justify-center text-[9px] text-black font-bold overflow-hidden whitespace-nowrap rounded-sm transition-opacity",style:{flex:Math.max(m.mb/v,.08),background:m.color,opacity:m.freed?.25:1},children:m.label},m.id))}),x.jsxs("div",{className:"text-[10px] text-fg-faint mt-0.5",children:["Memory: ",y," MB active"]})]}),r.length>0&&x.jsxs("div",{children:[x.jsxs("div",{className:"max-h-[200px] overflow-y-auto bg-surface border border-line/10 rounded p-1.5 text-[11px] leading-relaxed",children:[r.map((m,w)=>x.jsxs("div",{className:xo[m.type]||xo.info,children:[x.jsx("span",{className:"text-fg-faint",children:m.time})," ",m.msg]},w)),x.jsx("div",{ref:b})]}),x.jsxs("div",{className:"flex gap-1.5 mt-1",children:[x.jsx("button",{onClick:M,className:"text-[10px] px-2 py-0.5 bg-line/10 text-fg-muted border border-line/10 rounded-sm hover:bg-line/15 cursor-pointer",children:"Copy"}),x.jsx("button",{onClick:a,className:"text-[10px] px-2 py-0.5 bg-line/10 text-fg-muted border border-line/10 rounded-sm hover:bg-line/15 cursor-pointer",children:"Clear"})]})]})]})};function da(e,t,o){let n=0;for(let s=0;s<e.length;s++)e[s]<-o&&(e[s]=o,n++);return n}function ma(e,t){let o=0;return e.blocks.forEach(n=>{for(let s=0;s<n.length;s++)n[s]<-t&&(n[s]=t,o++)}),o}function bo(e,t,o,n,s){const r=new Float32Array(e.length);for(let i=0;i<o;i++)for(let l=0;l<o;l++){const p=i*o*o+l*o;for(let h=0;h<o;h++){let u=e[p+h];for(let f=-n;f<=n;f++){const g=h+f;g>=0&&g<o&&(u=s(u,e[p+g]))}r[p+h]=u}}const a=new Float32Array(e.length);for(let i=0;i<o;i++)for(let l=0;l<o;l++)for(let p=0;p<o;p++){const h=i*o*o+p*o+l;let u=r[h];for(let f=-n;f<=n;f++){const g=p+f;g>=0&&g<o&&(u=s(u,r[i*o*o+g*o+l]))}a[h]=u}for(let i=0;i<o;i++)for(let l=0;l<o;l++)for(let p=0;p<o;p++){const h=p*o*o+i*o+l;let u=a[h];for(let f=-n;f<=n;f++){const g=p+f;g>=0&&g<o&&(u=s(u,a[g*o*o+i*o+l]))}t[h]=u}}async function pa(e,t,o,n){const s=n||(()=>{});if(o<=0)return;const r=Math.round(o),a=t*t*t,i=new Float32Array(a);s(0),bo(e,i,t,r,Math.min),s(25),await new Promise(l=>{setTimeout(l,0)}),bo(i,e,t,r,Math.max),s(50)}async function ha(e,t,o){const n=o||(()=>{});if(t<=0)return;const s=Math.round(t);e.N;const r=e.blockSize;for(let a=0;a<2;a++){const i=a===0?Math.min:Math.max,l=new Map;e.blocks.forEach((p,h)=>{const u=new Float32Array(p.length),f=e.blocksPerAxis,g=h%f,b=(h/f|0)%f,y=h/(f*f)|0,v=g*r,M=b*r,m=y*r;for(let w=0;w<r;w++)for(let C=0;C<r;C++)for(let U=0;U<r;U++){let B=p[(w*r+C)*r+U];for(let R=-s;R<=s;R++)for(let L=-s;L<=s;L++)for(let V=-s;V<=s;V++){const d=v+U+V,c=M+C+L,I=m+w+R;B=i(B,e.get(d,c,I))}u[(w*r+C)*r+U]=B}l.set(h,u)}),l.forEach((p,h)=>{e.blocks.set(h,p)}),n(a===0?50:100),await new Promise(p=>{setTimeout(p,0)})}}async function va(e,t,o,n){const s=o||(()=>{}),r=n||(()=>{}),a=t*t*t,i=a+7>>3,l=new Uint8Array(i),p=(L,V,d)=>(d*t+V)*t+L,h=L=>(l[L>>3]&1<<(L&7))!==0,u=L=>{l[L>>3]|=1<<(L&7)};let f=Math.min(a,4*1024*1024),g=new Int32Array(f),b=0,y=0,v=0;const M=L=>{if(v>=f){const V=f*2,d=new Int32Array(V);for(let c=0;c<v;c++)d[c]=g[(b+c)%f];g=d,b=0,y=v,f=V}g[y]=L,y=(y+1)%f,v++},m=()=>{const L=g[b];return b=(b+1)%f,v--,L};for(let L=0;L<t;L++)for(let V=0;V<t;V++)for(let d=0;d<t;d++)if(d===0||d===t-1||V===0||V===t-1||L===0||L===t-1){const c=p(d,V,L);e[c]>=0&&!h(c)&&(u(c),M(c))}s(5);let w=0;const C=[-1,1,0,0,0,0],U=[0,0,-1,1,0,0],B=[0,0,0,0,-1,1];for(;v>0;){const L=m(),V=L%t,d=(L/t|0)%t,c=L/(t*t)|0;for(let I=0;I<6;I++){const F=V+C[I],_=d+U[I],k=c+B[I];if(F<0||_<0||k<0||F>=t||_>=t||k>=t)continue;const E=p(F,_,k);h(E)||e[E]>=0&&(u(E),M(E))}w++,w&1048575||(s(5+Math.round(85*w/a)),await new Promise(I=>{setTimeout(I,0)}),r())}let R=0;for(let L=0;L<a;L++)e[L]>=0&&!h(L)&&(e[L]=-Math.abs(e[L])-.001,R++);return s(100),R}async function ga(e,t,o,n){const s=o||(()=>{}),r=n||(()=>{}),a=e.N,i=e.blockSize,l=e.blocksPerAxis,p=e.blockCellCount+7>>3;function h(z,S,O,D){if(S<0||O<0||D<0||S>=a||O>=a||D>=a)return!1;const P=S/i|0,G=O/i|0,H=D/i|0,X=(H*l+G)*l+P,$=z.get(X);if(!$)return!1;const N=S-P*i,Z=O-G*i,ne=((D-H*i)*i+Z)*i+N;return($[ne>>3]&1<<(ne&7))!==0}function u(z,S,O,D){const P=S/i|0,G=O/i|0,H=D/i|0,X=(H*l+G)*l+P,$=z.get(X);if(!$)return;const N=S-P*i,Z=O-G*i,ne=((D-H*i)*i+Z)*i+N;$[ne>>3]|=1<<(ne&7)}let f=2*1024*1024,g=new Int32Array(f),b=new Uint8Array(f),y=0,v=0;function M(){const z=v-y,S=f*2,O=new Int32Array(S),D=new Uint8Array(S);for(let P=0;P<z;P++)O[P]=g[(y+P)%f],D[P]=b[(y+P)%f];g=O,b=D,y=0,v=z,f=S}function m(z,S){v-y>=f-1&&M(),g[v%f]=z,b[v%f]=S,v++}function w(){const z=g[y%f],S=b[y%f];return y++,{coord:z,dist:S}}let C=2*1024*1024,U=new Int32Array(C),B=0,R=0;function L(){const z=R-B,S=C*2,O=new Int32Array(S);for(let D=0;D<z;D++)O[D]=U[(B+D)%C];U=O,B=0,R=z,C=S}function V(z){R-B>=C-1&&L(),U[R++%C]=z}function d(){return U[B++%C]}const c=new Map;e.blocks.forEach((z,S)=>{const O=new Uint8Array(p);for(let D=0;D<z.length;D++)z[D]<0&&(O[D>>3]|=1<<(D&7));c.set(S,O)});let I=0;e.blocks.forEach((z,S)=>{const O=S%l,D=(S/l|0)%l,P=S/(l*l)|0,G=O*i,H=D*i,X=P*i;for(let $=0;$<i;$++)for(let N=0;N<i;N++)for(let Z=0;Z<i;Z++){const Q=($*i+N)*i+Z;if(z[Q]<0)continue;const ne=G+Z,K=H+N,ee=X+$;let re=!1;for(let ie=0;ie<6&&!re;ie++){const le=ne+(ie===0?-1:ie===1?1:0),ve=K+(ie===2?-1:ie===3?1:0),Y=ee+(ie===4?-1:ie===5?1:0);e.get(le,ve,Y)<0&&(re=!0)}re&&(u(c,ne,K,ee),m((ee*a+K)*a+ne,1),I++)}}),console.log("[CavityFill] Dilate by "+t+": "+I+" surface seeds"),s(5);let F=0,_=0;for(;y<v;){const z=w(),S=z.coord,O=z.dist,D=S%a,P=(S/a|0)%a,G=S/(a*a)|0;for(let H=0;H<6;H++){const X=D+(H===0?-1:H===1?1:0),$=P+(H===2?-1:H===3?1:0),N=G+(H===4?-1:H===5?1:0);X<0||$<0||N<0||X>=a||$>=a||N>=a||h(c,X,$,N)||(u(c,X,$,N),F++,O+1<t&&m((N*a+$)*a+X,O+1))}++_&262143||(s(5+Math.round(20*Math.min(1,F/(I*t+1)))),await new Promise(H=>{setTimeout(H,0)}),r())}console.log("[CavityFill] Dilate done: "+F+" cells expanded"),s(30);const k=new Map;e.blocks.forEach((z,S)=>{k.set(S,new Uint8Array(p))}),e.blocks.forEach((z,S)=>{const O=c.get(S),D=S%l,P=(S/l|0)%l,G=S/(l*l)|0,H=D*i,X=P*i,$=G*i;for(let N=0;N<i;N++)for(let Z=0;Z<i;Z++)for(let Q=0;Q<i;Q++){const ne=(N*i+Z)*i+Q;if(O[ne>>3]&1<<(ne&7))continue;const K=H+Q,ee=X+Z,re=$+N;let ie=!1;if(K===0||K===a-1||ee===0||ee===a-1||re===0||re===a-1)ie=!0;else if(Q===0||Q===i-1||Z===0||Z===i-1||N===0||N===i-1)for(let le=0;le<6&&!ie;le++){const ve=K+(le===0?-1:le===1?1:0),Y=ee+(le===2?-1:le===3?1:0),q=re+(le===4?-1:le===5?1:0),te=ve/i|0,ce=Y/i|0,se=q/i|0;e.hasBlock(te,ce,se)||(ie=!0)}if(ie){const le=k.get(S);le[ne>>3]|=1<<(ne&7),V((re*a+ee)*a+K)}}}),console.log("[CavityFill] Flood fill: "+R+" boundary seeds"),s(40);let j=0,A=0;for(;B<R;){const z=d(),S=z%a,O=(z/a|0)%a,D=z/(a*a)|0;for(let P=0;P<6;P++){const G=S+(P===0?-1:P===1?1:0),H=O+(P===2?-1:P===3?1:0),X=D+(P===4?-1:P===5?1:0);if(G<0||H<0||X<0||G>=a||H>=a||X>=a)continue;const $=G/i|0,N=H/i|0,Z=X/i|0,Q=(Z*l+N)*l+$,ne=G-$*i,K=H-N*i,re=((X-Z*i)*i+K)*i+ne,ie=k.get(Q);ie&&(ie[re>>3]&1<<(re&7)||h(c,G,H,X)||(ie[re>>3]|=1<<(re&7),V((X*a+H)*a+G),j++))}++A&262143||(s(40+Math.round(40*j/(j+(R-B)+1))),await new Promise(P=>{setTimeout(P,0)}),r())}console.log("[CavityFill] Flood done: "+j+" cells reached"),s(85);let T=0;return e.blocks.forEach((z,S)=>{const O=k.get(S);for(let D=0;D<z.length;D++)z[D]>=0&&!(O[D>>3]&1<<(D&7))&&(z[D]=-Math.abs(z[D])-.001,T++)}),s(100),console.log("[CavityFill] Filled: "+T+" cavity cells"),{filled:T,dilated:F,seeds:I}}function xa(e,t){const o=new Array(t);for(let s=0;s<t;s++)o[s]=new Set;for(let s=0,r=e.length;s<r;s+=3){const a=e[s],i=e[s+1],l=e[s+2];o[a].add(i),o[a].add(l),o[i].add(a),o[i].add(l),o[l].add(a),o[l].add(i)}const n=new Array(t);for(let s=0;s<t;s++){const r=o[s],a=new Uint32Array(r.size);let i=0;for(const l of r)a[i++]=l;n[s]=a}return n}function yo(e,t,o,n){const s=t.length;n.set(e);for(let r=0;r<s;r++){const a=t[r],i=a.length;if(i===0)continue;const l=r*3,p=n[l],h=n[l+1],u=n[l+2];let f=0,g=0,b=0;for(let v=0;v<i;v++){const M=a[v]*3;f+=n[M]-p,g+=n[M+1]-h,b+=n[M+2]-u}const y=o/i;e[l]=p+f*y,e[l+1]=h+g*y,e[l+2]=u+b*y}}function ba(e,t=.5,o=-.53,n=5){const s=xa(e.indices,e.vertexCount),r=new Float32Array(e.positions.length);for(let a=0;a<n;a++)yo(e.positions,s,t,r),yo(e.positions,s,o,r);return e}function ya(e,t=1e-6){const o=e.positions,n=e.normals,s=e.indices,r=e.vertexCount,i=1/(t>0?t:1e-6),l=new Map,p=new Int32Array(r);p.fill(-1);const h=[],u=[];let f=0;function g(y,v,M){return y+","+v+","+M}for(let y=0;y<r;y++){const v=y*3,M=o[v],m=o[v+1],w=o[v+2],C=Math.floor(M*i),U=Math.floor(m*i),B=Math.floor(w*i);let R=!1;for(let d=-1;d<=1&&!R;d++)for(let c=-1;c<=1&&!R;c++)for(let I=-1;I<=1&&!R;I++){const F=g(C+d,U+c,B+I),_=l.get(F);if(_!==void 0)for(let k=0;k<_.length;k++){const E=_[k],j=E*3,A=o[j]-M,T=o[j+1]-m,z=o[j+2]-w;if(A*A+T*T+z*z<=t*t){p[y]=p[E],R=!0;break}}}R||(p[y]=f,h.push(M,m,w),u.push(n[v],n[v+1],n[v+2]),f++);const L=g(C,U,B),V=l.get(L);V===void 0?l.set(L,[y]):V.push(y)}const b=new Uint32Array(s.length);for(let y=0,v=s.length;y<v;y++)b[y]=p[s[y]];return{positions:new Float32Array(h),normals:new Float32Array(u),indices:b,vertexCount:f,faceCount:e.faceCount}}function wa(e){const t=e.positions,o=e.indices,n=e.faceCount,s=[];for(let r=0;r<n;r++){const a=r*3,i=o[a]*3,l=o[a+1]*3,p=o[a+2]*3,h=t[l]-t[i],u=t[l+1]-t[i+1],f=t[l+2]-t[i+2],g=t[p]-t[i],b=t[p+1]-t[i+1],y=t[p+2]-t[i+2],v=u*y-f*b,M=f*g-h*y,m=h*b-u*g;v*v+M*M+m*m>=1e-20&&s.push(o[a],o[a+1],o[a+2])}return{positions:e.positions,normals:e.normals,indices:new Uint32Array(s),vertexCount:e.vertexCount,faceCount:s.length/3}}function Sa(e){const t=e.positions,o=e.indices,n=e.normals,s=e.vertexCount,r=e.faceCount;for(let a=0;a<s*3;a++)n[a]=0;for(let a=0;a<r;a++){const i=a*3,l=o[i],p=o[i+1],h=o[i+2],u=l*3,f=p*3,g=h*3,b=t[f]-t[u],y=t[f+1]-t[u+1],v=t[f+2]-t[u+2],M=t[g]-t[u],m=t[g+1]-t[u+1],w=t[g+2]-t[u+2],C=y*w-v*m,U=v*M-b*w,B=b*m-y*M;n[u]+=C,n[u+1]+=U,n[u+2]+=B,n[f]+=C,n[f+1]+=U,n[f+2]+=B,n[g]+=C,n[g+1]+=U,n[g+2]+=B}for(let a=0;a<s;a++){const i=a*3,l=n[i],p=n[i+1],h=n[i+2],u=Math.sqrt(l*l+p*p+h*h);if(u>1e-12){const f=1/u;n[i]*=f,n[i+1]*=f,n[i+2]*=f}}return e}function Ca(e){const t=e.positions,o=e.indices,n=e.vertexCount,s=e.faceCount;let r=0,a=0,i=0;for(let p=0;p<n;p++){const h=p*3;r+=t[h],a+=t[h+1],i+=t[h+2]}const l=1/n;r*=l,a*=l,i*=l;for(let p=0;p<s;p++){const h=p*3,u=o[h],f=o[h+1],g=o[h+2],b=u*3,y=f*3,v=g*3,M=(t[b]+t[y]+t[v])/3,m=(t[b+1]+t[y+1]+t[v+1])/3,w=(t[b+2]+t[y+2]+t[v+2])/3,C=t[y]-t[b],U=t[y+1]-t[b+1],B=t[y+2]-t[b+2],R=t[v]-t[b],L=t[v+1]-t[b+1],V=t[v+2]-t[b+2],d=U*V-B*L,c=B*R-C*V,I=C*L-U*R;if(d*(M-r)+c*(m-a)+I*(w-i)<0){const F=o[h+1];o[h+1]=o[h+2],o[h+2]=F}}return e}function Ma(e,t){const o=t??{},n=o.smoothing??!0,s=o.smoothIterations??5,r=o.lambda??.5,a=o.mu??-(r+.03);return o.mergeVertices&&(e=ya(e,o.mergeEpsilon??1e-6)),e.faceCount<5e6&&(e=wa(e)),n&&s>0&&(e.vertexCount>5e6?console.warn("Skipping smoothing: "+e.vertexCount.toLocaleString()+" vertices too large (>5M limit)"):e=ba(e,r,a,s)),o.consistentWinding&&(e=Ca(e)),e=Sa(e),e}class Ea{constructor(t){oe(this,"_buf");oe(this,"_view");oe(this,"_u8");oe(this,"_pos");t||(t=1024*1024),this._buf=new ArrayBuffer(t),this._view=new DataView(this._buf),this._u8=new Uint8Array(this._buf),this._pos=0}get pos(){return this._pos}set pos(t){this._pos=t}_grow(t){const o=this._pos+t;if(o<=this._buf.byteLength)return;let n=this._buf.byteLength;for(;n<o;)n*=2;const s=new ArrayBuffer(n);new Uint8Array(s).set(this._u8),this._buf=s,this._view=new DataView(this._buf),this._u8=new Uint8Array(this._buf)}u8(t){this._grow(1),this._view.setUint8(this._pos,t),this._pos+=1}u16(t){this._grow(2),this._view.setUint16(this._pos,t,!0),this._pos+=2}u32(t){this._grow(4),this._view.setUint32(this._pos,t,!0),this._pos+=4}i32(t){this._grow(4),this._view.setInt32(this._pos,t,!0),this._pos+=4}f32(t){this._grow(4),this._view.setFloat32(this._pos,t,!0),this._pos+=4}raw(t){const o=t.length;this._grow(o),this._u8.set(t,this._pos),this._pos+=o}str(t){const o=t.length;this._grow(o);for(let n=0;n<o;n++)this._u8[this._pos++]=t.charCodeAt(n)&127}strNull(t){this.str(t),this.u8(0)}pad(t){this.padWith(t,0)}padWith(t,o){const n=this._pos%t;if(n===0)return;const s=t-n;this._grow(s);for(let r=0;r<s;r++)this._u8[this._pos++]=o}bulkF32(t){const o=t.byteLength;this._grow(o),this._u8.set(new Uint8Array(t.buffer,t.byteOffset,o),this._pos),this._pos+=o}bulkU32(t){const o=t.byteLength;this._grow(o),this._u8.set(new Uint8Array(t.buffer,t.byteOffset,o),this._pos),this._pos+=o}bulkU8(t){this.raw(t)}result(){return this._buf.slice(0,this._pos)}}function Ta(e){const t=e.positions,o=e.normals,n=e.colors,s=e.indices,r=e.vertexCount,a=e.faceCount,i=n!=null&&n.length>0,l=[1/0,1/0,1/0],p=[-1/0,-1/0,-1/0];for(let S=0;S<r;S++){const O=t[S*3],D=t[S*3+1],P=t[S*3+2];O<l[0]&&(l[0]=O),D<l[1]&&(l[1]=D),P<l[2]&&(l[2]=P),O>p[0]&&(p[0]=O),D>p[1]&&(p[1]=D),P>p[2]&&(p[2]=P)}const h=r*12,u=r*12,f=i?r*16:0,g=a*3*4,b=0,y=h,v=h+u,M=h+u+f,m=h+u+f+g,w=(4-m%4)%4,C=m+w,U=[],B=[],R={};let L=0,V=0;U.push({buffer:0,byteOffset:b,byteLength:h,target:34962}),B.push({bufferView:L,byteOffset:0,componentType:5126,count:r,type:"VEC3",min:[l[0],l[1],l[2]],max:[p[0],p[1],p[2]]}),R.POSITION=V,L++,V++,U.push({buffer:0,byteOffset:y,byteLength:u,target:34962}),B.push({bufferView:L,byteOffset:0,componentType:5126,count:r,type:"VEC3"}),R.NORMAL=V,L++,V++,i&&(U.push({buffer:0,byteOffset:v,byteLength:f,target:34962}),B.push({bufferView:L,byteOffset:0,componentType:5126,count:r,type:"VEC4"}),R.COLOR_0=V,L++,V++);const d=V;U.push({buffer:0,byteOffset:M,byteLength:g,target:34963}),B.push({bufferView:L,byteOffset:0,componentType:5125,count:a*3,type:"SCALAR"});const c={attributes:R,indices:d,mode:4},I={asset:{version:"2.0",generator:"GMT Fractal Explorer"},scene:0,scenes:[{nodes:[0]}],nodes:[{mesh:0}],meshes:[{primitives:[c]}],accessors:B,bufferViews:U,buffers:[{byteLength:m}]};i&&(I.materials=[{name:"FractalVertexColor",pbrMetallicRoughness:{baseColorFactor:[1,1,1,1],metallicFactor:0,roughnessFactor:1}}],c.material=0);const F=JSON.stringify(I),_=(4-F.length%4)%4,k=F.length+_,E=20+k+8+C,j=20+k+8,A=new Ea(j+16);A.u32(1179937895),A.u32(2),A.u32(E),A.u32(k),A.u32(1313821514),A.str(F);for(let S=0;S<_;S++)A.u8(32);A.u32(C),A.u32(5130562);const T=S=>S.buffer.slice(S.byteOffset,S.byteOffset+S.byteLength),z=[A._buf.slice(0,A._pos),T(t),T(o)];if(i){const S=new Float32Array(r*4);for(let O=0;O<r*4;O++)S[O]=n[O]/255;z.push(S.buffer)}return z.push(T(s)),w>0&&z.push(new ArrayBuffer(w)),new Blob(z,{type:"application/octet-stream"})}async function Da(e,t){const o=t||function(){},n=e.positions,s=e.indices,r=e.faceCount,a=new ArrayBuffer(84),i=new DataView(a),l="Fractal Mesh Export - GMT Fractal Explorer";for(let f=0;f<l.length;f++)i.setUint8(f,l.charCodeAt(f)&127);for(let f=l.length;f<80;f++)i.setUint8(f,32);i.setUint32(80,r,!0);const p=[new Uint8Array(a)],h=65536,u=Math.ceil(r/h);for(let f=0;f<r;f+=h){const g=Math.min(f+h,r),b=g-f,y=new ArrayBuffer(b*50),v=new DataView(y);let M=0;for(let w=f;w<g;w++){const C=s[w*3],U=s[w*3+1],B=s[w*3+2],R=n[C*3],L=n[C*3+1],V=n[C*3+2],d=n[U*3],c=n[U*3+1],I=n[U*3+2],F=n[B*3],_=n[B*3+1],k=n[B*3+2],E=d-R,j=c-L,A=I-V,T=F-R,z=_-L,S=k-V;let O=j*S-A*z,D=A*T-E*S,P=E*z-j*T;const G=Math.sqrt(O*O+D*D+P*P);G>1e-12&&(O/=G,D/=G,P/=G),v.setFloat32(M,O,!0),v.setFloat32(M+4,D,!0),v.setFloat32(M+8,P,!0),v.setFloat32(M+12,R,!0),v.setFloat32(M+16,L,!0),v.setFloat32(M+20,V,!0),v.setFloat32(M+24,d,!0),v.setFloat32(M+28,c,!0),v.setFloat32(M+32,I,!0),v.setFloat32(M+36,F,!0),v.setFloat32(M+40,_,!0),v.setFloat32(M+44,k,!0),v.setUint16(M+48,0,!0),M+=50}p.push(new Uint8Array(y));const m=f/h|0;m&7||(o(Math.round(100*(m+1)/u)),await new Promise(function(w){setTimeout(w,0)}))}return o(100),new Blob(p,{type:"application/octet-stream"})}function wo(e,t){if(t==="stl")return 84+e.faceCount*50;{const n=e.colors!=null&&e.colors.length>0?e.vertexCount*16:0;return 1024+e.vertexCount*24+n+e.faceCount*12}}function Ra(e,t){const o=document.createElement("a");o.href=URL.createObjectURL(e),o.download=t,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(o.href)}function Ie(e){return e.tick?e.tick():new Promise(t=>setTimeout(t,0))}async function Fa(e,t){const{N:o,iters:n,smoothPasses:s,useNewton:r,newtonSteps:a,smoothLambda:i,definition:l,formulaParams:p,power:h,deType:u,deSamples:f,zSubSlices:g,minFeatureSel:b,closingRadius:y,colorSamples:v,colorJitterMul:M,cavityFillMode:m,cavityFillLevel:w,gridMin:C,gridMax:U,boundsRange:B,weave:R,estimator:L,distanceMetric:V}=e;let d=e.surfaceThreshold??0;const I=(u==="auto"?Wt(l):u)==="ifs"&&L!==void 0&&L>=1.5&&L<2.5?1:L,F=I!==void 0||V!==void 0?{estimator:I??0,distanceMetric:V??0}:void 0,_={log:t.log,setStatus:t.setStatus,setProgress:t.setProgress,setPhase:t.setPhase,tick:t.tick,onSlicePreview:t.onSlicePreview},k=o>256,E=B/o,j=performance.now();let A=null,T=null,z,S,O=0,D=0,P=0,G=0,H=0,X=0,$=null,N=null,Z=!1,Q=!1;const ne=l.name||l.id||"unknown";t.log("=== Generate: "+ne+" ===","phase"),t.log("Resolution: "+o+"³ | Iterations: "+n+" | DE: "+u+" | SS: "+f+"³="+f*f*f+(g>1?" | Z-SS: "+g:"")+" | Newton: "+(r?a+" steps":"off")+" | Smooth: "+s+"×λ"+i+(v>1?" | Color-SS: "+v+"×r"+M:"")+" | MinFeat: "+b+" | CavityFill: "+(m==="escape"?"escape-test":w+"x")+" | Closing: "+y,"data"),t.log("Params: "+JSON.stringify(p).substring(0,200),"data"),t.log("Bounds: min=["+C[0].toFixed(2)+","+C[1].toFixed(2)+","+C[2].toFixed(2)+"] max=["+U[0].toFixed(2)+","+U[1].toFixed(2)+","+U[2].toFixed(2)+"] range="+B.toFixed(2),"data");let K;if(u==="ifs")K=Math.ceil(Math.log2(B/E));else{const ee=Math.max(h,2);K=Math.ceil(Math.log(B/E)/Math.log(ee))}n>K+2&&t.log("Note: At "+o+"³ (voxel="+E.toFixed(5)+"), ~"+K+" iterations resolve detail at voxel scale. Using "+n+" adds "+(n-K)+" levels of sub-voxel interior detail. Min Feature filter will clamp this. Consider reducing iterations for faster export.","warn");try{try{if(t.log("[Phase 1] GPU SDF Sampling","phase"),t.setPhase("Phase 1: SDF Sampling",0),t.memAlloc("webgl","WebGL",8,t.MEM_COLORS.webgl),t.setStatus("Initializing WebGL2..."),await Ie(t),T=vt(),t.log("WebGL2 initialized (max texture: "+T.getParameter(T.MAX_TEXTURE_SIZE)+")","info"),k){t.log("Pass 1: Coarse SDF 128³ ("+(128*128*128*4/(1024*1024)).toFixed(1)+" MB)","info"),t.setStatus("Pass 1: Coarse SDF (128³)..."),await Ie(t);const q=Qe(T,Math.min(128,2048),l,f,t.log,R,F),te=Math.round(128*128*128*4/(1024*1024));t.memAlloc("coarseGrid","Coarse SDF",te,t.MEM_COLORS.coarseGrid);let ce=await go(T,q,128,h,n,p,C,U,0,10,1,null,null,_,R,d);z=performance.now();let se=0,J=0,ae=1/0;for(let ue=0;ue<ce.length;ue++){const we=ce[ue];we>=0?se++:J++,we<ae&&(ae=we)}if(t.log("Coarse: "+se.toLocaleString()+" outside, "+J.toLocaleString()+" inside ("+((z-j)/1e3).toFixed(1)+"s)","data"),J===0&&ae<10&&d===0){const ue=B/128,we=ae+ue*2;t.log("Auto-threshold: DE always positive (IFS/surface fractal), min="+ae.toFixed(6)+" → threshold="+we.toFixed(6)+". Set “Surface Threshold” in Quality to control shell thickness.","warn");for(let ye=0;ye<ce.length;ye++)ce[ye]-=we;d=we,J=0;for(let ye=0;ye<ce.length;ye++)ce[ye]<0&&J++;t.log("After auto-threshold: "+J.toLocaleString()+" interior coarse cells","data")}else J===0&&t.log("WARNING: No interior voxels in coarse grid — surface may not be found","warn");t.setStatus("Building narrow band for "+o+"³..."),await Ie(t);const fe=jn(ce,128,o,8,2);ce=null,t.memFree("coarseGrid"),$=fe.grid;const he=Math.pow(o/$.blockSize,3),be=($.allocatedCount/he*100).toFixed(1),Re=Math.round($.memoryMB());t.memAlloc("sparseGrid","Sparse SDF",Re,t.MEM_COLORS.sparseGrid),t.log("Narrow band: "+$.allocatedCount.toLocaleString()+" blocks ("+be+"% of "+he.toLocaleString()+"), "+Re+" MB","data"),t.log("Pass 2: Fine SDF "+o+"³ (narrow-band, "+$.memoryMB().toFixed(0)+" MB allocated)","info"),t.setStatus("Pass 2: Fine SDF ("+o+"³ narrow-band)..."),await Ie(t),T.deleteTexture(q.tex),T.deleteFramebuffer(q.fbo);const De=Qe(T,Math.min(o,2048),l,f,t.log,R,F);await aa(T,De,$,h,n,p,C,U,10,25,_,R,d),O=performance.now(),S=O,t.log("Fine sampling done: "+((S-z)/1e3).toFixed(1)+"s","success")}else{const Y=Math.round(o*o*o*4/1048576);t.memAlloc("sdfGrid","SDF Grid",Y,t.MEM_COLORS.sdfGrid),t.log("Dense SDF "+o+"³ ("+Y+" MB grid)","info");const q=await Go(T,l,p,o,h,n,C,U,E,_,R,F,d),te=Qe(T,Math.min(o,2048),l,f,t.log,R,F);N=await go(T,te,o,h,n,p,C,U,0,35,g,q.zSliceMin,q.zSliceMax,_,R,d),O=performance.now();let ce=0,se=0,J=0;for(let ae=0;ae<N.length;ae++){const fe=N[ae];isNaN(fe)?J++:fe>0?ce++:se++}if(t.log("SDF: "+ce.toLocaleString()+" outside, "+se.toLocaleString()+" inside"+(J>0?", "+J+" NaN!":"")+" ("+((O-j)/1e3).toFixed(1)+"s)","data"),se===0&&d===0){let ae=1/0;for(let fe=0;fe<N.length;fe++)N[fe]<ae&&(ae=N[fe]);if(ae<10){const fe=ae+E*2;t.log("Auto-threshold: DE always positive (IFS/surface fractal), min="+ae.toFixed(6)+" → threshold="+fe.toFixed(6)+". Set “Surface Threshold” in Quality to control shell thickness.","warn");for(let he=0;he<N.length;he++)N[he]-=fe;d=fe}}}}catch(Y){t.checkCancel();const q=Y;throw t.log("PHASE 1 FAILED: "+q.message,"error"),t.log(q.stack||"","error"),t.setStatus("Error in SDF sampling: "+q.message),Y}t.checkCancel();let ee=0;b==="auto"?ee=E*1.5:parseFloat(b)>0&&(ee=E*parseFloat(b));{let Y=1/0,q=-1/0,te=0,ce=0;if(k&&$)$.blocks.forEach(se=>{for(let J=0;J<se.length;J++){const ae=se[J];ae<Y&&(Y=ae),ae>q&&(q=ae),ae<0&&te++,ce++}});else if(N){ce=N.length;for(let se=0;se<N.length;se++){const J=N[se];J<Y&&(Y=J),J>q&&(q=J),J<0&&te++}}if(t.log("SDF range: ["+Y.toFixed(6)+", "+q.toFixed(6)+"] | "+te.toLocaleString()+" interior cells of "+ce.toLocaleString()+" | threshold="+(ee>0?ee.toFixed(6):"off"),"data"),te===0&&Y>0&&Y<10){const se=Y+E*2;if(t.log("Auto-threshold: no interior found, SDF min="+Y.toFixed(6)+" → applying threshold "+se.toFixed(6)+" (set Surface Threshold manually to control shell thickness)","warn"),k&&$)$.blocks.forEach(J=>{for(let ae=0;ae<J.length;ae++)J[ae]-=se});else if(N)for(let J=0;J<N.length;J++)N[J]-=se;te=k&&$?(()=>{let J=0;return $.blocks.forEach(ae=>{for(let fe=0;fe<ae.length;fe++)ae[fe]<0&&J++}),J})():N?N.reduce((J,ae)=>J+(ae<0?1:0),0):0,t.log("After auto-threshold: "+te.toLocaleString()+" interior cells","data")}if(w>0||ee>0||y>0){if(t.log("[Phase 1b] SDF Filtering","phase"),t.setPhase("Phase 1b: SDF Filtering",0),t.setStatus("Filtering SDF..."),await Ie(t),w>0){if(m==="escape"&&k&&$&&T){t.setStatus("Cavity fill (escape test)..."),t.setPhase("Phase 1b: Escape Test",0);const se=await ra(T,$,l,h,n,p,C,U,_,ae=>{t.setPhase("Phase 1b: Escape Test",ae)},R);let J=0;$.blocks.forEach((ae,fe)=>{const he=se.escapeMap.get(fe);if(he)for(let be=0;be<ae.length;be++)ae[be]>=0&&he[be>>3]&1<<(be&7)&&(ae[be]=-Math.abs(ae[be])-.001,J++)}),t.log("Cavity fill (escape test): "+se.solidCount.toLocaleString()+" escape-interior cells, "+J.toLocaleString()+" positive cells filled","data")}else if(k&&$){t.setStatus("Cavity fill (dilate r="+w+", then flood)..."),t.setPhase("Phase 1b: Cavity Fill",0);const se=await ga($,w,J=>{t.setPhase("Phase 1b: Cavity Fill (r="+w+")",J)},()=>{t.checkCancel()});t.log("Cavity fill: dilate="+w+" | "+se.dilated.toLocaleString()+" dilated, "+se.filled.toLocaleString()+" filled solid","data")}else if(N){t.setStatus("Cavity fill (flood)..."),t.setPhase("Phase 1b: Cavity Fill",0);const se=await va(N,o,J=>{t.setPhase("Phase 1b: Cavity Fill",J)},()=>{t.checkCancel()});t.log("Cavity fill: "+se.toLocaleString()+" cells filled solid","data")}}if(ee>0){let se;k&&$?se=ma($,ee):N?se=da(N,o,ee):se=0,t.log("Min feature clamp: threshold="+ee.toFixed(6)+" ("+(ee/E).toFixed(1)+"x voxel), "+se.toLocaleString()+" cells clamped","data")}y>0&&(t.setStatus("Morphological closing (r="+y+" voxels)..."),k&&$?await ha($,y,se=>{t.setPhase("Phase 1b: Morph Closing",se)}):N&&await pa(N,o,y,se=>{t.setPhase("Phase 1b: Morph Closing",se)}),t.log("Morphological closing: radius="+y+" voxels","data")),t.setPhase("Phase 1b: SDF Filtering",100)}}t.checkCancel();try{if(t.log("[Phase 2] Dual Contouring","phase"),t.setPhase("Phase 2: Dual Contouring",0),t.setProgress(35),await Ie(t),k&&$)t.setStatus("Dual contouring (sparse, "+o+"³)..."),A=await Nn($,C,U,(se,J)=>{t.setProgress(35+Math.round(J*.25)),t.setPhase("Phase 2: Dual Contouring",J)});else if(N){t.setStatus("Dual contouring ("+o+"³)...");const ce=Math.round(Math.log2(o));A=await Bn(N,o,C,U,ce,(J,ae)=>{t.setProgress(35+Math.round(ae*.25)),t.setPhase("Phase 2: Dual Contouring",ae)}),N=null,t.memFree("sdfGrid")}if(D=performance.now(),!A||A.vertexCount===0)return t.log("No surface found — check parameters and bounds","error"),t.setStatus("No surface found! Try different parameters."),{mesh:null,timings:null,baseName:"",newtonApplied:!1,useNarrowBand:k,gl:T};t.log("DC result: "+A.vertexCount.toLocaleString()+" vertices, "+A.faceCount.toLocaleString()+" faces ("+((D-O)/1e3).toFixed(1)+"s)","data");const Y=(A.positions.byteLength/(1024*1024)).toFixed(0),q=(A.normals.byteLength/(1024*1024)).toFixed(0),te=(A.indices.byteLength/(1024*1024)).toFixed(0);t.log("Mesh memory: positions="+Y+"MB normals="+q+"MB indices="+te+"MB (total "+(parseInt(Y)+parseInt(q)+parseInt(te))+"MB)","mem"),$&&($=null,t.memFree("sparseGrid"),t.log("Sparse grid freed","mem")),t.memAlloc("meshPos","Positions",parseInt(Y),t.MEM_COLORS.meshPos),t.memAlloc("meshNrm","Normals",parseInt(q),t.MEM_COLORS.meshNrm),t.memAlloc("meshIdx","Indices",parseInt(te),t.MEM_COLORS.meshIdx),t.setStatus("Mesh: "+A.vertexCount.toLocaleString()+" verts, "+A.faceCount.toLocaleString()+" faces"),t.setProgress(60),await Ie(t)}catch(Y){t.checkCancel();const q=Y;throw t.log("PHASE 2 FAILED: "+q.message,"error"),t.log(q.stack||"","error"),t.setStatus("Error in dual contouring: "+q.message),Y}t.checkCancel(),X=D;const re=B/o;if(r&&A&&T)try{t.log("[Phase 3] Newton Projection","phase"),t.setPhase("Phase 3: Newton Projection",0),t.log("Mode: GPU (float32, generic formula) — "+A.vertexCount.toLocaleString()+" vertices","info");const Y=Math.ceil(Math.sqrt(A.vertexCount));t.log("Newton texture: "+Y+"x"+Y+" ("+(Y*Y*16*3/(1024*1024)).toFixed(0)+" MB GPU)","mem"),t.setStatus("GPU Newton projection ("+A.vertexCount.toLocaleString()+" vertices)..."),t.setPhase("Phase 3: Newton Projection",50),await Ie(t),ia(T,A,l,p,h,n,re,a,t.log,R),X=performance.now(),Q=!0,t.setPhase("Phase 3: Newton Projection",100),t.log("GPU Newton done: "+((X-D)/1e3).toFixed(1)+"s","success")}catch(Y){t.checkCancel(),X=performance.now();const q=Y;t.log("Newton FAILED: "+q.message,"error"),t.log(q.stack||"","error"),t.setStatus("Newton failed — continuing without projection"),await Ie(t)}t.setProgress(70),t.checkCancel();try{t.log("[Phase 4] Post-processing","phase"),t.setPhase("Phase 4: Post-processing",0),t.setStatus("Post-processing (smoothing, normals)..."),await Ie(t),Z=A.vertexCount>5e6,Z&&t.log("Large mesh ("+A.vertexCount.toLocaleString()+" verts) — smoothing disabled to avoid OOM","warn"),A=Ma(A,{smoothing:s>0,smoothIterations:s,lambda:i}),P=performance.now(),t.setPhase("Phase 4: Post-processing",100),t.log("Post-processing done: "+((P-X)/1e3).toFixed(1)+"s","success")}catch(Y){t.checkCancel(),P=performance.now();const q=Y;throw t.log("PHASE 4 FAILED: "+q.message,"error"),t.log(q.stack||"","error"),t.setStatus("Error in post-processing: "+q.message),Y}t.setProgress(80),t.checkCancel();try{t.log("[Phase 5] Vertex Coloring","phase"),t.setPhase("Phase 5: Vertex Coloring",0),t.setStatus("Colorizing vertices..."),await Ie(t),(!T||T.isContextLost())&&(t.log("Re-initializing WebGL for colorizer","warn"),T=vt());const Y=E*M;A.colors=await la(T,A,l,p,h,n,v,Y,_,R),G=performance.now(),t.setPhase("Phase 5: Vertex Coloring",100);const q=(A.vertexCount*3/(1024*1024)).toFixed(1);t.memAlloc("meshCol","Colors",parseFloat(q),t.MEM_COLORS.meshCol),t.log("Coloring done: "+((G-P)/1e3).toFixed(1)+"s"+(v>1?" ("+v+" samples)":""),"success")}catch(Y){t.checkCancel(),G=performance.now();const q=Y;t.log("PHASE 5 FAILED: "+q.message,"error"),t.log(q.stack||"","error"),t.log("Continuing without vertex colors","warn")}t.setProgress(90),t.checkCancel(),H=performance.now(),t.setProgress(100),t.setPhase("Complete",100),t.setStatus("Done — choose format and export");const ie=((H-j)/1e3).toFixed(1);t.log("=== Complete in "+ie+"s ===","phase");const le=(l.name||l.id||"fractal").toLowerCase().replace(/\s+/g,"-"),ve={total:H-j,sdf:O-j,coarse:z?z-j:0,fine:S&&z?S-z:0,dc:D-O,newton:X-D,post:P-X,color:G-P};return{mesh:A,baseName:le,smoothingSkipped:Z,newtonApplied:Q,timings:ve,useNarrowBand:k,gl:T}}catch(ee){if(T)try{const re=T.getExtension("WEBGL_lose_context");re&&re.loseContext()}catch{}throw ee}}async function Pa(e,t,o,n,s){const r=performance.now();let a,i;if(s.log("[Export] Encoding "+e.toUpperCase()+"...","phase"),s.setStatus("Encoding "+e.toUpperCase()+"..."),s.setPhase("Export "+e.toUpperCase(),0),e==="vdb"){const{definition:h,formulaParams:u,N:f,iters:g,power:b,gridMin:y,gridMax:v,deSamples:M,zSubSlices:m,weave:w,estimator:C,distanceMetric:U,surfaceThreshold:B}=n,R=C!==void 0||U!==void 0?{estimator:C??0,distanceMetric:U??0}:void 0,L=h.name||h.id||"unknown";s.log("=== VDB Export: "+L+" ===","phase"),s.log("Resolution: "+f+"³ | Iterations: "+g+" | Mode: solid | Z Sub-slices: "+m,"data");const V=vt(),d={log:s.log,setStatus:s.setStatus,setProgress:s.setProgress,setPhase:s.setPhase,tick:s.tick,onSlicePreview:s.onSlicePreview,memAlloc:s.memAlloc,memFree:s.memFree},c=await sa(V,h,u,f,b,g,y,v,"solid",M,m,d,w,R,B,n.vdbColor);try{const k=V.getExtension("WEBGL_lose_context");k&&k.loseContext()}catch{}a=c.blob;const I=(h.name||h.id||"fractal").toLowerCase().replace(/\s+/g,"-"),F=new Date().toISOString().replace(/[-:T]/g,"").slice(0,12),_=n.vdbColor?"-density-color":"-density";i=I+"-"+f+_+"-"+F+".vdb",s.log("VDB: "+c.voxelCount.toLocaleString()+" active voxels, "+c.leafCount+" leaf blocks"+(c.promoted.promotedLeaves?", "+c.promoted.promotedLeaves+" tiles promoted":"")+(c.skippedSlices>0?", "+c.skippedSlices+" empty slices skipped":""),"data")}else if(e==="glb"){const h=wo(t,e);s.log("Estimated size: ~"+(h/(1024*1024)).toFixed(0)+" MB","mem"),a=Ta(t),i=o+".glb",s.setPhase("Export GLB",100)}else{const h=wo(t,e);s.log("Estimated size: ~"+(h/(1024*1024)).toFixed(0)+" MB","mem"),a=await Da(t,u=>{s.setPhase("Export STL",u),s.setStatus("Encoding STL... "+u+"%")}),i=o+".stl"}const l=performance.now(),p=(a.size/(1024*1024)).toFixed(2);return s.memAlloc("exportBlob",e.toUpperCase()+" Blob",parseFloat(p),s.MEM_COLORS.exportBlob),s.log("Export: "+p+" MB "+e.toUpperCase()+" ("+((l-r)/1e3).toFixed(1)+"s)","success"),s.setStatus(p+" MB "+e.toUpperCase()+" ready"),s.setPhase("Export complete",100),{blob:a,filename:i}}const Aa={webgl:"#47a",coarseGrid:"#7af",sparseGrid:"#5a8",sdfGrid:"#7af",meshPos:"#f80",meshNrm:"#fa0",meshIdx:"#fc0",meshCol:"#f5a",exportBlob:"#5af"},ut="font-mono text-[13px] font-bold border-none rounded px-4 py-2 cursor-pointer transition-opacity disabled:bg-surface-header disabled:text-fg-faint disabled:cursor-default",La=()=>{const e=W(),t=W(m=>m.isRunning),o=W(m=>m.exportFormat),n=W(m=>m.lastMesh),s=W(m=>m.lastBlob),r=W(m=>m.lastFilename),a=W(m=>m.loadedDefinition),i=W(m=>m.selectedFormulaId),l=W(m=>m.customFilename),p=W(m=>m.vdbColor),h=!!(a||_e.get(i)),u=o==="vdb";function f(){const m=W.getState(),w=m.loadedDefinition||_e.get(m.selectedFormulaId),C=m.bboxSize.map(c=>c/2),U=[m.bboxCenter[0]-C[0],m.bboxCenter[1]-C[1],m.bboxCenter[2]-C[2]],B=[m.bboxCenter[0]+C[0],m.bboxCenter[1]+C[1],m.bboxCenter[2]+C[2]];let R,L;m.cavityFill==="escape"?(R="escape",L=1):(R="dilate",L=parseInt(m.cavityFill)||0);const V=Gt(m),d=m.qualitySettings;return{N:m.resolution,iters:m.iters,smoothPasses:m.smoothPasses,useNewton:m.newton,newtonSteps:m.newtonSteps,smoothLambda:m.smoothLambda,definition:w,formulaParams:m.formulaParams,power:m.formulaParams.paramA||8,deType:m.deType,deSamples:m.deSamples,zSubSlices:m.zSubSlices,minFeatureSel:m.minFeature,closingRadius:m.closingRadius,colorSamples:m.colorSamples,colorJitterMul:m.colorJitter,cavityFillMode:R,cavityFillLevel:L,gridMin:U,gridMax:B,boundsRange:B[0]-U[0],weave:V,estimator:d.estimator,distanceMetric:d.distanceMetric,surfaceThreshold:d.surfaceThreshold}}function g(){return{setStatus:m=>W.getState().setStatus(m),setProgress:m=>W.getState().setProgress(m),setPhase:(m,w)=>W.getState().setPhase(m,w),log:(m,w)=>W.getState().addLog(m,w),memAlloc:(m,w,C,U)=>W.getState().memAlloc(m,w,C,U),memFree:m=>W.getState().memFree(m),tick:async()=>{if(await new Promise(m=>setTimeout(m,0)),W.getState().isCancelled)throw new Error("Cancelled")},checkCancel:()=>{if(W.getState().isCancelled)throw new Error("Cancelled")},onSlicePreview:(m,w,C)=>{hn(m,w,C)},MEM_COLORS:Aa}}const b=async()=>{const m=W.getState();m.setMesh(null,""),m.setExportBlob(null,""),m.setRunning(!0),m.setCancelled(!1),m.setProgress(0),m.setPhase("",0),m.clearMemory(),mo(),ho();try{const w=await Fa(f(),g()),C=W.getState();C.setMesh(w.mesh,w.baseName),C.setTimings(w.timings,w.smoothingSkipped??!1,w.useNarrowBand),w.gl&&C.setGL(w.gl)}catch(w){const C=w;C.message!=="Cancelled"?(W.getState().addLog("ERROR: "+C.message,"error"),W.getState().setStatus("Error: "+C.message)):(W.getState().addLog("Cancelled","warn"),W.getState().setStatus("Cancelled"))}finally{W.getState().setRunning(!1)}},y=()=>{zn(),kn(),W.getState().setCancelled(!0)},v=async()=>{const m=W.getState();m.setRunning(!0),m.setCancelled(!1),mo(),ho();try{const w=f(),C=await Pa(m.exportFormat,m.lastMesh,m.lastBaseName,{definition:w.definition,formulaParams:w.formulaParams,N:w.N,iters:w.iters,power:w.power,gridMin:w.gridMin,gridMax:w.gridMax,deSamples:w.deSamples,zSubSlices:w.zSubSlices,weave:w.weave,estimator:w.estimator,distanceMetric:w.distanceMetric,surfaceThreshold:w.surfaceThreshold,vdbColor:m.vdbColor},g()),U=W.getState().customFilename.trim(),B=U?U.replace(/\.[^.]+$/,"")+"."+C.filename.split(".").pop():C.filename;W.getState().setExportBlob(C.blob,B)}catch(w){const C=w;C.message!=="Cancelled"&&(W.getState().addLog("Export error: "+C.message,"error"),W.getState().setStatus("Export error: "+C.message))}finally{W.getState().setRunning(!1)}},M=()=>{s&&r&&Ra(s,r)};return x.jsxs("div",{className:"font-mono flex flex-col gap-2 mt-1",children:[x.jsx(Te,{label:"Format",value:o,options:[{label:"GLB (Binary glTF)",value:"glb"},{label:"STL (Binary)",value:"stl"},{label:"VDB (OpenVDB)",value:"vdb"}],onChange:e.setExportFormat,fullWidth:!0}),x.jsxs("div",{className:"flex items-center gap-2",children:[x.jsx("span",{className:"text-[10px] text-fg-dim uppercase tracking-wide shrink-0",children:"Filename"}),x.jsx("input",{type:"text",value:l,onChange:m=>e.setCustomFilename(m.target.value),placeholder:((a==null?void 0:a.name)||i||"fractal").toLowerCase().replace(/\s+/g,"-"),className:"flex-1 h-[26px] bg-surface-header border border-line/20 rounded px-2 text-[11px] text-fg-secondary font-mono placeholder:text-fg-faint"}),x.jsxs("span",{className:"text-[10px] text-fg-faint",children:[".",o]})]}),u&&x.jsx("div",{className:"text-[11px] text-info bg-info/20 px-2 py-1 rounded",children:"VDB exports directly — no Generate needed"}),u&&x.jsxs("label",{className:"flex items-center gap-2 text-[11px] text-fg-tertiary cursor-pointer select-none",children:[x.jsx("input",{type:"checkbox",checked:p,onChange:m=>e.setVdbColor(m.target.checked),className:"accent-amber-500"}),"Include color grids (slower)"]}),x.jsxs("div",{className:"flex gap-2 flex-wrap",children:[!u&&x.jsxs("button",{disabled:t||!h,onClick:b,className:`${ut} bg-ok-strong text-fg hover:bg-ok-strong`,children:[x.jsx("span",{className:"bg-line/15 rounded px-1 mr-1 text-[10px]",children:"1"}),"Generate"]}),t&&x.jsx("button",{onClick:y,className:`${ut} bg-danger-strong text-fg hover:bg-danger-strong`,children:"Cancel"}),x.jsxs("button",{disabled:t||!n&&!u,onClick:v,className:`${ut} bg-warn-strong text-fg hover:bg-warn-strong`,children:[x.jsx("span",{className:"bg-line/15 rounded px-1 mr-1 text-[10px]",children:u?"1":"2"}),"Export"]}),x.jsxs("button",{disabled:!s,onClick:M,className:`${ut} bg-info text-fg hover:bg-info`,children:[x.jsx("span",{className:"bg-line/15 rounded px-1 mr-1 text-[10px]",children:u?"2":"3"}),"Download",r?` (${r})`:""]})]})]})};function Wo(e,t){return[e[0]-t[0],e[1]-t[1],e[2]-t[2]]}function gt(e,t){return[e[0]+t[0],e[1]+t[1],e[2]+t[2]]}function Vt(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]}function xt(e,t){return[e[0]*t,e[1]*t,e[2]*t]}function Ia(e,t){return[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]]}function to(e,t){const o=Math.cos(e),n=Math.sin(e),s=Math.cos(t),r=Math.sin(t),a=[o,0,-n],i=[-s*n,-r,-s*o],l=Ia(a,i);return{pos:Wo([0,0,0],xt(i,10)),fwd:i,right:a,up:l}}function So(e,t,o,n,s,r,a){const i=to(t,o),l=a||[0,0,0],p=gt(i.pos,l),h=Wo(e,p),u=Vt(h,i.right),f=Vt(h,i.up),g=r/n;return[s*.5+u*g,r*.5-f*g,0]}function kt(e,t,o,n,s,r){const a=r/s,i=to(o,n),l=e/a,p=-t/a;return gt(xt(i.right,l),xt(i.up,p))}const ft=Math.PI*.5,Co=[{angle:0,pitch:0,label:"Front (-Z)"},{angle:Math.PI,pitch:0,label:"Back (+Z)"},{angle:ft,pitch:0,label:"Right (+X)"},{angle:-ft,pitch:0,label:"Left (-X)"},{angle:0,pitch:ft,label:"Top (+Y)"},{angle:0,pitch:-ft,label:"Bottom (-Y)"}],Mo=15*Math.PI/180;function $t(e){return e=e%(2*Math.PI),e>Math.PI&&(e-=2*Math.PI),e<-Math.PI&&(e+=2*Math.PI),e}function Ot(e,t,o){const n=$t(e);let s=null,r=1/0;for(let a=0;a<Co.length;a++){const i=Co[a];let l,p;Math.abs(i.pitch)>1?(l=0,p=Math.abs(t-i.pitch)):(l=Math.abs($t(n-i.angle)),p=Math.abs(t-i.pitch));const h=Math.sqrt(l*l+p*p);h<o&&h<r&&(r=h,s={angle:Math.abs(i.pitch)>1?n:i.angle,pitch:i.pitch,label:i.label})}return s}function _a(){return{positions:null,indices:null,normals:null,vertexCount:0,faceCount:0,rotX:-.4,rotY:.6,zoom:1,cx:0,cy:0,cz:0,scale:1,dragging:!1,lastMX:0,lastMY:0}}function Eo(e,t,o,n,s,r){e.positions=t,e.indices=o,e.vertexCount=n,e.faceCount=s;let a=1/0,i=1/0,l=1/0,p=-1/0,h=-1/0,u=-1/0;for(let f=0;f<n;f++){const g=t[f*3],b=t[f*3+1],y=t[f*3+2];g<a&&(a=g),b<i&&(i=b),y<l&&(l=y),g>p&&(p=g),b>h&&(h=b),y>u&&(u=y)}e.cx=(a+p)/2,e.cy=(i+h)/2,e.cz=(l+u)/2,e.scale=r/(Math.max(p-a,h-i,u-l)*1.15)}function dt(e,t,o,n){if(t.fillStyle="#111",t.fillRect(0,0,o,n),!e.positions||!e.indices||e.vertexCount===0)return;const s=Math.cos(e.rotX),r=Math.sin(e.rotX),a=Math.cos(e.rotY),i=Math.sin(e.rotY),l=e.scale*e.zoom,p=e.positions,h=e.cx,u=e.cy,f=e.cz;function g(M){const m=p[M*3]-h,w=p[M*3+1]-u,C=p[M*3+2]-f,U=m*a-C*i,B=m*i+C*a,R=w*s-B*r;return[U*l+o/2,n/2-R*l]}const b=15e4,y=e.faceCount>b?Math.ceil(e.faceCount/b):1;let v=0;t.strokeStyle="rgba(42,170,85,0.12)",t.lineWidth=.5,t.beginPath();for(let M=0;M<e.faceCount&&v<b;M+=y){const m=g(e.indices[M*3]),w=g(e.indices[M*3+1]),C=g(e.indices[M*3+2]);t.moveTo(m[0],m[1]),t.lineTo(w[0],w[1]),t.lineTo(C[0],C[1]),t.lineTo(m[0],m[1]),v++}t.stroke(),t.fillStyle="#888",t.font="11px monospace",t.fillText(e.vertexCount.toLocaleString()+" verts, "+e.faceCount.toLocaleString()+" faces",4,n-4),t.fillStyle="#555",t.fillText("drag to rotate, scroll to zoom",4,14)}function To(e,t,o){const n=e.createShader(t);if(e.shaderSource(n,o),e.compileShader(n),!e.getShaderParameter(n,e.COMPILE_STATUS)){const s=e.getShaderInfoLog(n)||"";throw e.deleteShader(n),new Error("Shader compile: "+s)}return n}function za(e,t,o){const n=e.createProgram();if(e.attachShader(n,To(e,e.VERTEX_SHADER,t)),e.attachShader(n,To(e,e.FRAGMENT_SHADER,o)),e.linkProgram(n),!e.getProgramParameter(n,e.LINK_STATUS)){const s=e.getProgramInfoLog(n)||"";throw e.deleteProgram(n),new Error("Program link: "+s)}return n}function Ba(e,t,o){var s,r,a,i,l,p,h,u,f,g,b,y,v,M,m,w,C,U,B,R,L,V,d,c,I,F,_,k,E,j;const n=o||{};t.uParamA&&e.uniform1f(t.uParamA,n.paramA??8),t.uParamB&&e.uniform1f(t.uParamB,n.paramB??0),t.uParamC&&e.uniform1f(t.uParamC,n.paramC??0),t.uParamD&&e.uniform1f(t.uParamD,n.paramD??0),t.uParamE&&e.uniform1f(t.uParamE,n.paramE??0),t.uParamF&&e.uniform1f(t.uParamF,n.paramF??0),t.uVec2A&&e.uniform2f(t.uVec2A,((s=n.vec2A)==null?void 0:s.x)??0,((r=n.vec2A)==null?void 0:r.y)??0),t.uVec2B&&e.uniform2f(t.uVec2B,((a=n.vec2B)==null?void 0:a.x)??0,((i=n.vec2B)==null?void 0:i.y)??0),t.uVec2C&&e.uniform2f(t.uVec2C,((l=n.vec2C)==null?void 0:l.x)??0,((p=n.vec2C)==null?void 0:p.y)??0),t.uVec3A&&e.uniform3f(t.uVec3A,((h=n.vec3A)==null?void 0:h.x)??0,((u=n.vec3A)==null?void 0:u.y)??0,((f=n.vec3A)==null?void 0:f.z)??0),t.uVec3B&&e.uniform3f(t.uVec3B,((g=n.vec3B)==null?void 0:g.x)??0,((b=n.vec3B)==null?void 0:b.y)??0,((y=n.vec3B)==null?void 0:y.z)??0),t.uVec3C&&e.uniform3f(t.uVec3C,((v=n.vec3C)==null?void 0:v.x)??0,((M=n.vec3C)==null?void 0:M.y)??0,((m=n.vec3C)==null?void 0:m.z)??0),t.uVec4A&&e.uniform4f(t.uVec4A,((w=n.vec4A)==null?void 0:w.x)??0,((C=n.vec4A)==null?void 0:C.y)??0,((U=n.vec4A)==null?void 0:U.z)??0,((B=n.vec4A)==null?void 0:B.w)??0),t.uVec4B&&e.uniform4f(t.uVec4B,((R=n.vec4B)==null?void 0:R.x)??0,((L=n.vec4B)==null?void 0:L.y)??0,((V=n.vec4B)==null?void 0:V.z)??0,((d=n.vec4B)==null?void 0:d.w)??0),t.uVec4C&&e.uniform4f(t.uVec4C,((c=n.vec4C)==null?void 0:c.x)??0,((I=n.vec4C)==null?void 0:I.y)??0,((F=n.vec4C)==null?void 0:F.z)??0,((_=n.vec4C)==null?void 0:_.w)??0),t.uJulia&&e.uniform3f(t.uJulia,((k=n.julia)==null?void 0:k.x)??0,((E=n.julia)==null?void 0:E.y)??0,((j=n.julia)==null?void 0:j.z)??0),t.uJuliaMode&&e.uniform1f(t.uJuliaMode,n.juliaMode??0),t.uEscapeThresh&&e.uniform1f(t.uEscapeThresh,n.escapeThresh??4),t.uDeBailout&&e.uniform1f(t.uDeBailout,n.deBailout??100),t.uDistanceMetric&&e.uniform1f(t.uDistanceMetric,n.distanceMetric??0)}const xe=512,Ve=Math.PI*.5;function ka(){const e=W(d=>d.isRunning),t=W(d=>d.lastMesh),o=W(d=>d.loadedDefinition),n=W(d=>d.bboxCenter),s=W(d=>d.bboxSize),r=W(d=>d.formulaParams),a=W(d=>d.weaveState),i=W(d=>d.iters),l=W(d=>d.qualitySettings),p=W(d=>d.clipOutsideBounds),h=de.useRef(null),u=de.useRef(null),f=de.useRef(null),g=de.useRef(null),b=de.useRef({gl:null,prog:null,loc:{},defId:null,rawAngle:.6,rawPitch:.3,camAngle:.6,camPitch:.3,camDist:3.5,camTarget:[0,0,0],dragging:!1,dragMode:null,hover:null,lastX:0,lastY:0,shiftHeld:!1,snapped:!1,snapTarget:null,snapAnimId:0,rafId:0}),y=de.useRef(_a()),v=t?"mesh":e?"slice":"fractal",M=de.useCallback(()=>{const d=b.current,c=W.getState(),I=c.loadedDefinition;if(!d.gl||!I)return;const F=d.gl,_=c.qualitySettings,E=Wt(I)==="ifs"&&_.estimator>=1.5&&_.estimator<2.5?1:_.estimator,j=I.id+":e"+(E??0);if(d.defId===j&&d.prog)return;d.prog&&(F.deleteProgram(d.prog),d.prog=null);try{const T=Cn({definition:I,deType:"auto",estimator:E});console.log("[Preview] Compiling shader for",I.id,"| estimator:",E,"| length:",T.length),d.prog=za(F,Ke,T),console.log("[Preview] Shader compiled OK for",I.id)}catch(T){console.warn("Preview shader compile failed for",I.id+":",T.message),d.prog=null,d.defId=null;return}F.useProgram(d.prog),F.bindVertexArray(F.createVertexArray()),d.loc={};const A=["uPower","uIters","uResolution","uCamPos","uCamTarget","uCamRight","uFov","uFudgeFactor","uDetail","uPixelThreshold","uClipBounds","uBoundsMin","uBoundsMax",...qe];for(const T of A)d.loc[T]=F.getUniformLocation(d.prog,T);d.defId=j},[]),m=de.useCallback(()=>{const d=u.current;if(!d)return;const c=d.getContext("2d"),I=d.width,F=d.height;c.clearRect(0,0,I,F);const _=b.current,k=W.getState(),[E,j,A]=k.bboxCenter,[T,z,S]=k.bboxSize,O=T*.5,D=z*.5,P=S*.5,G=Y=>So(Y,_.camAngle,_.camPitch,_.camDist,xe,xe,_.camTarget),H=[];for(let Y=0;Y<2;Y++)for(let q=0;q<2;q++)for(let te=0;te<2;te++)H.push([E+(Y?O:-O),j+(q?D:-D),A+(te?P:-P)]);const X=H.map(G),$=[{color:"#f554",edges:[[0,4],[1,5],[2,6],[3,7]]},{color:"#5f54",edges:[[0,2],[1,3],[4,6],[5,7]]},{color:"#55f4",edges:[[0,1],[2,3],[4,5],[6,7]]}];for(const Y of $){c.strokeStyle=Y.color,c.lineWidth=1,c.setLineDash([4,3]),c.beginPath();for(const[q,te]of Y.edges)c.moveTo(X[q][0],X[q][1]),c.lineTo(X[te][0],X[te][1]);c.stroke()}c.setLineDash([]);const N={"sizeX+":[E+O,j,A],"sizeX-":[E-O,j,A],"sizeY+":[E,j+D,A],"sizeY-":[E,j-D,A],"sizeZ+":[E,j,A+P],"sizeZ-":[E,j,A-P]},Z={"sizeX+":"#f55","sizeX-":"#f55","sizeY+":"#5f5","sizeY-":"#5f5","sizeZ+":"#55f","sizeZ-":"#55f"},Q=Object.keys(N);for(const Y of Q){const q=G(N[Y]),te=_.hover===Y?7:5;c.fillStyle=Z[Y],c.beginPath(),c.moveTo(q[0],q[1]-te),c.lineTo(q[0]+te,q[1]),c.lineTo(q[0],q[1]+te),c.lineTo(q[0]-te,q[1]),c.closePath(),c.fill(),_.hover===Y&&(c.strokeStyle="#fff",c.lineWidth=1,c.stroke())}const ne=[E,j,A],K=G(ne),ee=_.camDist*.12,re=["#f55","#5f5","#55f"],ie=[[1,0,0],[0,1,0],[0,0,1]],le=["X","Y","Z"];for(let Y=0;Y<3;Y++){const q=gt(ne,xt(ie[Y],ee)),te=G(q),ce=te[0]-K[0],se=te[1]-K[1],J=Math.sqrt(ce*ce+se*se);if(J<2)continue;const ae=_.hover==="center";c.strokeStyle=re[Y],c.lineWidth=ae?3:2,c.beginPath(),c.moveTo(K[0],K[1]),c.lineTo(te[0],te[1]),c.stroke();const fe=ce/J,he=se/J;c.fillStyle=re[Y],c.beginPath(),c.moveTo(te[0],te[1]),c.lineTo(te[0]-fe*6+he*3,te[1]-he*6-fe*3),c.lineTo(te[0]-fe*6-he*3,te[1]-he*6+fe*3),c.closePath(),c.fill(),c.font="bold 9px monospace",c.fillStyle=re[Y],c.fillText(le[Y],te[0]+fe*6-3,te[1]+he*6+3)}const ve=_.hover==="center"?5:3;if(c.fillStyle=_.hover==="center"?"#fc0":"#fa0",c.beginPath(),c.arc(K[0],K[1],ve,0,Math.PI*2),c.fill(),_.hover==="center"&&(c.strokeStyle="#fff",c.lineWidth=1,c.stroke()),_.snapTarget){const Y=Ot(_.snapTarget.angle,_.snapTarget.pitch,.1);Y&&(c.font="bold 11px monospace",c.fillStyle="#fa0",c.textAlign="right",c.fillText(Y.label,I-6,14),c.textAlign="left")}else if(_.shiftHeld){const Y=Ot(_.camAngle,_.camPitch,Mo);Y&&(c.font="10px monospace",c.fillStyle="#888",c.textAlign="right",c.fillText("snap: "+Y.label,I-6,14),c.textAlign="left")}},[]),w=de.useCallback(()=>{const d=b.current;if(!d.gl||!d.prog){console.log("[Preview] Render skipped: gl=",!!d.gl,"prog=",!!d.prog);return}const c=d.gl,I=c.canvas;c.viewport(0,0,I.width,I.height),c.useProgram(d.prog);const F=to(d.camAngle,d.camPitch),_=d.camTarget;c.uniform2f(d.loc.uResolution,I.width,I.height),c.uniform3f(d.loc.uCamPos,F.pos[0]+_[0],F.pos[1]+_[1],F.pos[2]+_[2]),c.uniform3f(d.loc.uCamTarget,_[0],_[1],_[2]),c.uniform3f(d.loc.uCamRight,F.right[0],F.right[1],F.right[2]),c.uniform1f(d.loc.uFov,d.camDist);const k=W.getState(),E=k.formulaParams;c.uniform1f(d.loc.uPower,E.paramA??8),c.uniform1i(d.loc.uIters,k.iters),Ba(c,d.loc,E);{const A=Gt(k);d.loc.uWeaveEnabled&&c.uniform1f(d.loc.uWeaveEnabled,(A==null?void 0:A.weaveEnabled)===!1?0:1);const T=z=>z.charAt(0).toUpperCase()+z.slice(1);for(const[z,S]of Object.entries(A??{})){if(z==="weaveEnabled")continue;const O=d.loc["u"+T(z)];O&&(/^ws\d+Vec2/.test(z)?c.uniform2f(O,(S==null?void 0:S.x)??0,(S==null?void 0:S.y)??0):/^ws\d+Vec3/.test(z)?c.uniform3f(O,(S==null?void 0:S.x)??0,(S==null?void 0:S.y)??0,(S==null?void 0:S.z)??0):/^ws\d+Vec4/.test(z)?c.uniform4f(O,(S==null?void 0:S.x)??0,(S==null?void 0:S.y)??0,(S==null?void 0:S.z)??0,(S==null?void 0:S.w)??0):c.uniform1f(O,typeof S=="number"?S:S?1:0))}}const j=k.qualitySettings;if(d.loc.uFudgeFactor&&c.uniform1f(d.loc.uFudgeFactor,(j.fudgeFactor??1)*.75),d.loc.uDetail&&c.uniform1f(d.loc.uDetail,j.detail??1),d.loc.uPixelThreshold&&c.uniform1f(d.loc.uPixelThreshold,j.pixelThreshold??.5),d.loc.uDistanceMetric&&c.uniform1f(d.loc.uDistanceMetric,j.distanceMetric??0),d.loc.uClipBounds&&c.uniform1f(d.loc.uClipBounds,k.clipOutsideBounds?1:0),d.loc.uBoundsMin){const A=k.bboxSize.map(T=>T/2);c.uniform3f(d.loc.uBoundsMin,k.bboxCenter[0]-A[0],k.bboxCenter[1]-A[1],k.bboxCenter[2]-A[2]),c.uniform3f(d.loc.uBoundsMax,k.bboxCenter[0]+A[0],k.bboxCenter[1]+A[1],k.bboxCenter[2]+A[2])}c.drawArrays(c.TRIANGLE_STRIP,0,4),m()},[m]),C=de.useCallback(()=>{const d=b.current;d.rafId||(d.rafId=requestAnimationFrame(()=>{d.rafId=0;const c=W.getState();(c.lastMesh?"mesh":c.isRunning?"slice":"fractal")==="fractal"&&(M(),w())}))},[M,w]),U=de.useCallback((d,c)=>{const I=b.current,F=W.getState(),[_,k,E]=F.bboxCenter,[j,A,T]=F.bboxSize,z=j*.5,S=A*.5,O=T*.5,D=X=>So(X,I.camAngle,I.camPitch,I.camDist,xe,xe,I.camTarget),P=8,G=D([_,k,E]);if(Math.abs(d-G[0])<P&&Math.abs(c-G[1])<P)return"center";const H=[["sizeX+",[_+z,k,E]],["sizeX-",[_-z,k,E]],["sizeY+",[_,k+S,E]],["sizeY-",[_,k-S,E]],["sizeZ+",[_,k,E+O]],["sizeZ-",[_,k,E-O]]];for(const[X,$]of H){const N=D($);if(Math.abs(d-N[0])<P&&Math.abs(c-N[1])<P)return X}return null},[]),B=de.useCallback(()=>{const d=b.current;if(d.shiftHeld){const c=Ot(d.rawAngle,d.rawPitch,Mo);if(c){if(d.snapped=!0,d.snapTarget=c,!d.snapAnimId){const I=()=>{if(d.snapAnimId=0,!d.snapTarget)return;const F=$t(d.snapTarget.angle-d.camAngle),_=d.snapTarget.pitch-d.camPitch;if(Math.sqrt(F*F+_*_)<.002){d.camAngle=d.snapTarget.angle,d.camPitch=d.snapTarget.pitch,C(),d.snapped&&(d.snapAnimId=requestAnimationFrame(I));return}d.camAngle+=F*.2,d.camPitch+=_*.2,C(),d.snapAnimId=requestAnimationFrame(I)};d.snapAnimId=requestAnimationFrame(I)}return}}d.snapped=!1,d.snapTarget=null,d.snapAnimId&&(cancelAnimationFrame(d.snapAnimId),d.snapAnimId=0),d.camAngle=d.rawAngle,d.camPitch=d.rawPitch},[C]);de.useEffect(()=>{const d=h.current;if(!d)return;const c=b.current;return c.gl=d.getContext("webgl2",{antialias:!1,preserveDrawingBuffer:!0}),c.gl||console.warn("Preview: WebGL2 not available"),()=>{c.prog&&c.gl&&c.gl.deleteProgram(c.prog),c.prog=null,c.defId=null}},[]),de.useEffect(()=>{const d=f.current;if(!d)return;const c=d.getContext("2d");if(c)return mn((I,F,_)=>{const k=document.createElement("canvas");k.width=F,k.height=_,k.getContext("2d").putImageData(I,0,0),c.clearRect(0,0,xe,xe),c.imageSmoothingEnabled=!1,c.drawImage(k,0,0,xe,xe)}),()=>{pn()}},[]),de.useEffect(()=>{var I;if(v!=="fractal")return;const d=b.current,c=(o==null?void 0:o.id)??"";o&&!((I=d.defId)!=null&&I.startsWith(c))&&(d.defId=null),C()},[o,v,C]),de.useEffect(()=>{v==="fractal"&&C()},[r,a,i,n,s,p,l,v,C]),de.useEffect(()=>{if(!t)return;const d=g.current;if(!d)return;const c=d.getContext("2d");if(!c)return;const I=y.current;Eo(I,t.positions,t.indices,t.vertexCount,t.faceCount,d.width),dt(I,c,d.width,d.height)},[t]),de.useEffect(()=>{const d=u.current;if(!d)return;const c=b.current,I=T=>{const z=d.getBoundingClientRect(),S=T.clientX-z.left,O=T.clientY-z.top;if(c.lastX=T.clientX,c.lastY=T.clientY,T.button===1||T.button===2){c.dragMode="pan",c.dragging=!0,d.style.cursor="all-scroll",T.preventDefault();return}const D=U(S,O);c.dragMode=D||"orbit",c.dragging=!0,d.style.cursor=c.dragMode==="orbit"?"grabbing":"ew-resize",T.preventDefault()},F=T=>{T.preventDefault()},_=T=>{if(!c.dragging){const O=d.getBoundingClientRect(),D=T.clientX-O.left,P=T.clientY-O.top,G=c.hover;c.hover=U(D,P),d.style.cursor=c.hover?c.hover==="center"?"move":"ew-resize":"grab",c.hover!==G&&C();return}const z=T.clientX-c.lastX,S=T.clientY-c.lastY;if(c.lastX=T.clientX,c.lastY=T.clientY,c.dragMode==="pan"){const O=kt(-z,-S,c.camAngle,c.camPitch,c.camDist,xe);c.camTarget=gt(c.camTarget,O),C()}else if(c.dragMode==="orbit")c.rawAngle+=z*.008,c.rawPitch=Math.max(-Ve,Math.min(Ve,c.rawPitch+S*.008)),B(),C();else if(c.dragMode==="center"){const O=kt(z,S,c.camAngle,c.camPitch,c.camDist,xe),D=W.getState(),[P,G,H]=D.bboxCenter;D.setBboxCenter([P+O[0],G+O[1],H+O[2]]),C()}else if(c.dragMode){const O=c.dragMode.charAt(4),D=c.dragMode.charAt(5)==="+"?1:-1,P=O==="X"?[1,0,0]:O==="Y"?[0,1,0]:[0,0,1],G=kt(z,S,c.camAngle,c.camPitch,c.camDist,xe),H=Vt(G,P)*D,X=O==="X"?0:O==="Y"?1:2,$=W.getState(),N=[...$.bboxSize],Z=[...$.bboxCenter],Q=Math.max(.1,N[X]+H*2),ne=Q-N[X];$.bboxLock?$.setBboxSize([Q,Q,Q]):(N[X]=Q,Z[X]+=ne*.5*D,$.setBboxSize(N),$.setBboxCenter(Z)),C()}},k=()=>{c.dragging=!1,c.dragMode=null,d.style.cursor=c.hover?c.hover==="center"?"move":"ew-resize":"grab"},E=T=>{T.preventDefault(),c.camDist=Math.max(.5,Math.min(20,c.camDist*(1+T.deltaY*.001))),C()},j=T=>{T.key==="Shift"&&!c.shiftHeld&&(c.shiftHeld=!0,B(),C())},A=T=>{T.key==="Shift"&&(c.shiftHeld=!1,B(),C())};return d.addEventListener("mousedown",I),window.addEventListener("mousemove",_),window.addEventListener("mouseup",k),d.addEventListener("wheel",E,{passive:!1}),d.addEventListener("contextmenu",F),window.addEventListener("keydown",j),window.addEventListener("keyup",A),()=>{d.removeEventListener("mousedown",I),window.removeEventListener("mousemove",_),window.removeEventListener("mouseup",k),d.removeEventListener("wheel",E),d.removeEventListener("contextmenu",F),window.removeEventListener("keydown",j),window.removeEventListener("keyup",A)}},[U,B,C]),de.useEffect(()=>{const d=g.current;if(!d)return;const c=y.current;let I=null;const F=()=>{const T=d.getContext("2d");T&&dt(c,T,d.width,d.height)},_=T=>{c.dragging=!0,c.lastMX=T.clientX,c.lastMY=T.clientY,I=T.button===1||T.button===2?"pan":"orbit"},k=()=>{c.dragging=!1,I=null},E=T=>{if(!c.dragging||!c.positions)return;const z=T.clientX-c.lastMX,S=T.clientY-c.lastMY;if(c.lastMX=T.clientX,c.lastMY=T.clientY,I==="pan"){const O=1/(c.scale*c.zoom);c.cx-=z*O,c.cy+=S*O,F()}else c.rotY+=z*.01,c.rotX+=S*.01,c.rotX=Math.max(-Ve,Math.min(Ve,c.rotX)),F()},j=T=>{T.preventDefault(),c.zoom*=T.deltaY>0?.9:1.1,c.zoom=Math.max(.1,Math.min(10,c.zoom)),c.positions&&F()},A=T=>{T.preventDefault()};return d.addEventListener("mousedown",_),window.addEventListener("mouseup",k),window.addEventListener("mousemove",E),d.addEventListener("wheel",j,{passive:!1}),d.addEventListener("contextmenu",A),()=>{d.removeEventListener("mousedown",_),window.removeEventListener("mouseup",k),window.removeEventListener("mousemove",E),d.removeEventListener("wheel",j),d.removeEventListener("contextmenu",A)}},[]);const R=de.useCallback((d,c,I)=>{const F=b.current;F.rawAngle=d,F.rawPitch=c,F.camAngle=d,F.camPitch=c,F.snapped=!1,F.snapTarget=null,F.snapAnimId&&(cancelAnimationFrame(F.snapAnimId),F.snapAnimId=0);const _=y.current;if(_.rotX=-c,_.rotY=d,_.positions){const k=g.current;if(k){const E=k.getContext("2d");E&&dt(_,E,k.width,k.height)}}C()},[C]),L=de.useCallback(()=>{const d=b.current;d.camTarget=[0,0,0];const c=y.current;if(c.positions){Eo(c,c.positions,c.indices,c.vertexCount,c.faceCount,xe);const I=g.current;if(I){const F=I.getContext("2d");F&&dt(c,F,I.width,I.height)}}C()},[C]),V=[{label:"F",title:"Front (-Z)",angle:0,pitch:0},{label:"B",title:"Back (+Z)",angle:Math.PI,pitch:0},{label:"L",title:"Left (-X)",angle:-Ve,pitch:0},{label:"R",title:"Right (+X)",angle:Ve,pitch:0},{label:"T",title:"Top (+Y)",angle:0,pitch:Ve},{label:"D",title:"Bottom (-Y)",angle:0,pitch:-Ve}];return x.jsxs("div",{className:"relative",style:{width:xe,height:xe},children:[x.jsx("canvas",{ref:h,width:xe,height:xe,className:"border border-line/10 rounded-sm",style:{imageRendering:"pixelated",display:v==="fractal"?"block":"none"}}),x.jsx("canvas",{ref:u,width:xe,height:xe,style:{position:"absolute",top:0,left:0,cursor:"grab",display:v==="fractal"?"block":"none"}}),x.jsx("canvas",{ref:f,width:xe,height:xe,className:"border border-line/10 rounded-sm",style:{imageRendering:"pixelated",display:v==="slice"?"block":"none"}}),x.jsx("canvas",{ref:g,width:xe,height:xe,className:"border border-line/10 rounded-sm",style:{cursor:"grab",display:v==="mesh"?"block":"none"}}),x.jsxs("div",{className:"absolute top-2 left-2 text-[10px] text-fg-dim uppercase tracking-wider pointer-events-none",children:[v==="fractal"&&"SDF Preview",v==="slice"&&"Sampling...",v==="mesh"&&"Mesh Preview"]}),v!=="slice"&&x.jsxs("div",{className:"absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-0.5 bg-surface/70 backdrop-blur rounded px-1 py-0.5 pointer-events-auto",children:[V.map(d=>x.jsx("button",{title:d.title,onClick:()=>R(d.angle,d.pitch,d.label),className:"w-[22px] h-[20px] text-[10px] font-bold text-fg-muted hover:text-fg hover:bg-line/10 rounded transition-colors",children:d.label},d.label)),x.jsx("div",{className:"w-px h-3 bg-fg-ghost mx-0.5"}),x.jsx("button",{title:"Reset pan (re-center view)",onClick:L,className:"w-[22px] h-[20px] text-[10px] font-bold text-fg-muted hover:text-fg hover:bg-line/10 rounded transition-colors",children:"C"})]}),v==="fractal"&&x.jsxs("label",{className:"absolute top-2 right-2 flex items-center gap-1 bg-surface/70 backdrop-blur rounded px-1.5 py-0.5 cursor-pointer pointer-events-auto select-none",children:[x.jsx("input",{type:"checkbox",checked:p,onChange:d=>W.getState().setClipOutsideBounds(d.target.checked),className:"accent-amber-500 w-3 h-3"}),x.jsx("span",{className:"text-[9px] text-fg-muted",children:"Clip bounds"})]}),v!=="slice"&&x.jsx("div",{className:"absolute bottom-8 left-1/2 -translate-x-1/2 text-[9px] text-fg-faint pointer-events-none whitespace-nowrap",children:"LMB orbit · RMB pan · Scroll zoom · Shift snap"})]})}function Oa(){const e=W(),t=W(s=>s.weaveState);if(!t)return null;const o=[1,2,3,4,5].filter(s=>t[`weaveInterval${s}`]!==void 0),n=(s,r)=>e.setWeaveState({...t,[s]:r});return x.jsxs("div",{className:"flex flex-col gap-1.5 border border-secondary/40 rounded px-2 py-1.5 bg-secondary/10 mt-1",children:[x.jsxs("div",{className:"text-[11px] text-secondary font-bold flex items-center justify-between",children:[x.jsx("span",{children:"Weave"}),x.jsxs("label",{className:"flex items-center gap-1 cursor-pointer",children:[x.jsx("input",{type:"checkbox",checked:t.weaveEnabled!==!1,onChange:s=>n("weaveEnabled",s.target.checked)}),x.jsx("span",{className:"text-[10px] text-secondary",children:"active"})]})]}),o.map(s=>x.jsxs("div",{className:"flex gap-3 text-[11px] text-fg-muted",children:[x.jsxs("label",{className:"flex items-center gap-1",children:["Layer ",s," every",x.jsx("input",{type:"number",min:1,max:32,step:1,value:Number(t[`weaveInterval${s}`]??2),onChange:r=>n(`weaveInterval${s}`,Math.max(1,parseInt(r.target.value)||1)),className:"w-12 bg-surface-header border border-line/20 rounded px-1 text-fg-secondary text-center"})]}),x.jsxs("label",{className:"flex items-center gap-1",children:["from",x.jsx("input",{type:"number",min:0,max:64,step:1,value:Number(t[`weaveStartIter${s}`]??0),onChange:r=>n(`weaveStartIter${s}`,Math.max(0,parseInt(r.target.value)||0)),className:"w-12 bg-surface-header border border-line/20 rounded px-1 text-fg-secondary text-center"})]})]},s))]})}function ja(){const e=Ce.useRef(null),t=Ce.useRef(null),o=Ce.useRef(0),n=Ce.useRef(!1),s=Ce.useCallback(()=>{n.current=!0,clearTimeout(o.current);const a=e.current,i=t.current;i.style.transition="none",i.style.transform="scale(1)",a.offsetHeight,a.style.transition="max-height 0.35s ease-out",a.style.maxHeight="200px"},[]),r=Ce.useCallback(()=>{n.current=!1;const a=e.current,i=t.current;i.style.transition="transform 0.3s ease-in",i.style.transform="scale(0) translateY(0)",i.style.transformOrigin="bottom center",o.current=window.setTimeout(()=>{n.current||(a.style.transition="none",a.style.maxHeight="0")},310)},[]);return x.jsxs("div",{className:"fixed bottom-5 right-5 z-50 inline-flex flex-col items-stretch",onMouseEnter:s,onMouseLeave:r,children:[x.jsx("div",{ref:e,className:"overflow-hidden",style:{maxHeight:0},children:x.jsx("img",{ref:t,src:"guy.png",alt:"",className:"pointer-events-none object-contain block w-full",style:{transform:"scale(0)",transformOrigin:"bottom center"}})}),x.jsx("a",{href:"https://ko-fi.com/gmtfractals",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center justify-center gap-2 px-3 py-1 rounded bg-[#13C3FF] hover:bg-[#00b0f0] text-fg text-[11px] font-bold transition-colors",children:"Support on Ko-fi"}),x.jsx("a",{href:"https://www.paypal.com/ncp/payment/WHMZWATKN6GEY",target:"_blank",rel:"noopener noreferrer",className:"mt-1 inline-flex items-center justify-center gap-2 px-3 py-1 rounded bg-[#0070ba] hover:bg-[#005ea6] text-fg text-[11px] font-bold transition-colors",children:"Support via PayPal"})]})}function Na(){const e=W(o=>o.iters),t=W(o=>o.setIters);return x.jsxs("div",{className:"font-mono bg-surface-dock text-fg-secondary h-screen flex flex-col overflow-hidden",children:[x.jsx("h1",{className:"text-sm font-bold text-fg tracking-wide px-5 pt-4 pb-2 shrink-0",children:"GMT — Fractal Mesh Export"}),x.jsxs("div",{className:"flex gap-4 flex-1 min-h-0 px-5 pb-4",children:[x.jsxs("div",{className:"flex flex-col gap-2.5 w-[340px] shrink-0 overflow-y-auto pr-1",children:[x.jsx("div",{className:"bg-surface-section border border-line/10 rounded p-3",children:x.jsx(ot,{label:"Export",defaultOpen:!0,children:x.jsx(La,{})})}),x.jsx("div",{className:"bg-surface-section border border-line/10 rounded p-3",children:x.jsx(bn,{})}),x.jsx("div",{className:"bg-surface-section border border-line/10 rounded p-3",children:x.jsx(ot,{label:"Bounds",defaultOpen:!0,children:x.jsx(ua,{})})})]}),x.jsxs("div",{className:"flex flex-col gap-2.5 flex-1 min-w-0 items-center",children:[x.jsx(ka,{}),x.jsx(fa,{})]}),x.jsxs("div",{className:"flex flex-col gap-2.5 w-[300px] shrink-0 overflow-y-auto pl-1",children:[x.jsx("div",{className:"bg-surface-section border border-line/10 rounded p-3",children:x.jsx(ot,{label:"Formula",defaultOpen:!0,children:x.jsxs("div",{className:"flex flex-col gap-2 mt-1",children:[x.jsx(gn,{}),x.jsx(Ae,{label:"Iterations",value:e,onChange:t,min:2,max:64,step:1,variant:"full"})]})})}),x.jsx("div",{className:"bg-surface-section border border-line/10 rounded p-3",children:x.jsx(ot,{label:"Parameters",defaultOpen:!0,children:x.jsxs("div",{className:"flex flex-col gap-1 mt-1",children:[x.jsx(xn,{}),x.jsx(Oa,{})]})})})]})]}),x.jsx(ja,{})]})}function Ua(){const e=de.useRef(!1);return de.useEffect(()=>{if(e.current)return;e.current=!0;try{const o=nn("gmt-mesh-export-scene");if(o){an("gmt-mesh-export-scene"),Fo(o,"(from main app)");return}}catch(o){console.warn("[MeshExport] Auto-load from main app failed:",o)}const t=W.getState();if(!t.loadedDefinition){const o=_e.get(t.selectedFormulaId);o&&(t.setLoadedDefinition(o),t.setFormulaParams(Ro(o)))}},[]),x.jsx(Na,{})}const Yo=document.getElementById("root");if(!Yo)throw new Error("Could not find root element to mount to");const Va=sn.createRoot(Yo);Va.render(x.jsx(rn,{children:x.jsx(Ce.StrictMode,{children:x.jsx(Ua,{})})}));
