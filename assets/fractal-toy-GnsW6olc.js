var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,j,F as p,k as g,u as m,S as D,c as $,z as k,i as O}from"./CollapsibleSection-CWFumHMF.js";import{r as v,j as l,R as B}from"./three-fiber-GKfjny8F.js";import{j as V,k as N,m as S,l as w,v as R,n as G,E as H,D as X,a as q,P as Y,T as W,b as Q,c as Z,G as K,d as J,r as ee,o as te,i as ae,h as oe,e as ie,g as re,f as ne}from"./Undo-Dh8_LtkD.js";import{V as se,i as le,c as ce}from"./Camera-CwTd5iBe.js";import{c as fe}from"./three-drei-D2x72drd.js";import{C as me}from"./CompilingIndicator-oZ52NJcE.js";import{r as ue}from"./cameraKeyRegistry-DtlAACb9.js";import"./pako-DwGzBETv.js";import"./three-DQWx7qFd.js";import"./CompositionOverlay-BTCqRlsK.js";const u=new Map,A=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),V(t.name)||N({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},de=`
...
`}}const Se=(t,e={})=>{const{formula:a}=e;if(a)for(const F of a.uniforms)t.addUniform(F.name,F.type);const o=t.buildDefinesBlock(),i=t.buildUniformsBlock(),r=t.getHeaders().join(`
`),n=t.getPreambles().join(`
`),c=t.getFunctions().join(`
`),I=a?Re(a.call,a.deExpr??"0.5 * log(max(r, 1e-8)) * r / dr",a.escapeRadius??2):we;return`#version 300 es
precision highp float;
...
`,Re=(t,e,a)=>`
    ...
    fragColor = vec4(col, 1.0);
`;let E={},b=!1,s=null;const Ae=(t={})=>{E=t,!b&&(b=!0,Ee())},Ee=()=>{S.register({id:"formula",slot:"left",order:50,label:"Formula",title:"Switch active formula",align:"start",width:"w-56"});for(const t of d.getAll())S.registerItem("formula",{id:`formula:${t.id}`,type:"toggle",label:t.name,title:t.description,isActive:()=>m.getState().formula===t.id,onToggle:()=>{m.getState().formula!==t.id&&m.setState({formula:t.id})}})},U={getCanvas:()=>(s==null?void 0:s.canvas)??null,rebuild:()=>{j.queue("Compiling shader…",()=>{C()})}},C=()=>{const t=s;if(!t){p.emit(g.IS_COMPILING,!1);return}const e=m.getState(),a=d.resolve(e.formula);a||console.warn("[fractalRenderer] no formulas registered — shader will be gradient-only");const o=new Fe("Main");for(const r of h.getAll())r.inject&&r.inject(o,{},"Main");const i=Se(o,{formula:a});try{t.setShader(i)}catch(r){console.error("[fractalRenderer] shader compile failed:",r),p.emit(g.IS_COMPILING,!1);return}Ue(),p.emit(g.RESET_ACCUM,void 0),p.emit(g.IS_COMPILING,!1)},Ue=()=>{const t=s;if(!t)return;const e=m.getState(),a=d.resolve(e.formula);if(a){const o=a.id.toLowerCase(),i=e[o];i&&a.pushUniforms&&a.pushUniforms(T(t),i)}z(e.camera),P(e.lighting)},T=t=>({setF:(e,a)=>t.setUniformF(e,a),setI:(e,a)=>t.setUniformI(e,a),set2F:(e,a,o)=>t.setUniform2F(e,a,o),set3F:(e,a,o,i)=>t.setUniform3F(e,a,o,i),set4F:(e,a,o,i,r)=>t.setUniform4F(e,a,o,i,r)}),z=t=>{if(!s||!t)return;s.setUniformF("uCamOrbitTheta",t.orbitTheta??.6),s.setUniformF("uCamOrbitPhi",t.orbitPhi??.2),s.setUniformF("uCamDistance",t.distance??2.5),s.setUniformF("uCamFov",t.fov??60);const e=t.target;s.setUniform3F("uCamTarget",(e==null?void 0:e.x)??0,(e==null?void 0:e.y)??0,(e==null?void 0:e.z)??0)},P=t=>{if(!s||!t)return;const e=t.direction;s.setUniform3F("uLightDir",(e==null?void 0:e.x)??.5,(e==null?void 0:e.y)??.8,(e==null?void 0:e.z)??.5);const a=t.color;if(a&&typeof a=="object"&&"r"in a)s.setUniform3F("uLightColor",a.r,a.g,a.b);else if(typeof a=="string"){const o=parseInt(a.replace("#",""),16);s.setUniform3F("uLightColor",(o>>16&255)/255,(o>>8&255)/255,(o&255)/255)}else s.setUniform3F("uLightColor",1,1,1);s.setUniformF("uLightIntensity",t.intensity??1),s.setUniformF("uAmbient",t.ambient??.15),s.setUniformF("uAoAmount",t.aoAmount??.4),s.setUniform3F("uAlbedo",t.albedoR??.85,t.albedoG??.72,t.albedoB??.55)},Ce=()=>{b||console.warn("[fractalRenderer] <FractalRendererCanvas /> rendered without installFractalRenderer() — frame telemetry will be missing.");const t=v.useRef(null),e=m(o=>o.canvasPixelSize),a=w();return v.useEffect(()=>{const o=t.current;if(!o)return;try{const n=new ye(o,{onFrameEnd:E.onFrameEnd??(()=>R.frameTick())});s=n,C(),n.start()}catch(n){console.error("[fractalRenderer] failed to start engine:",n);return}const i=m,r=[];return r.push(i.subscribe(n=>n.formula,()=>U.rebuild())),r.push(i.subscribe(n=>{const c=d.resolve(n.formula);return c?n[c.id.toLowerCase()]:null},n=>{if(!s||!n)return;const c=d.resolve(i.getState().formula);c!=null&&c.pushUniforms&&c.pushUniforms(T(s),n)})),r.push(i.subscribe(n=>n.camera,n=>z(n))),r.push(i.subscribe(n=>n.lighting,n=>P(n))),()=>{r.forEach(n=>n()),s==null||s.dispose(),s=null}},[]),v.useEffect(()=>{const o=s;if(!o)return;const[i,r]=e;i<1||r<1||o.resize(Math.max(1,Math.floor(i*a)),Math.max(1,Math.floor(r*a)))},[e,a]),l.jsxs(l.Fragment,{children:[l.jsx("canvas",{ref:t,className:"absolute inset-0 w-full h-full block"}),l.jsx(me,{})]})},Te=()=>{const t=h.getViewportOverlays().filter(a=>a.type==="dom"),e=m();return l.jsx("div",{className:"absolute inset-0 pointer-events-none",style:{zIndex:k("shellViewportOverlay")},children:t.map(a=>{const o=$.get(a.componentId),i=e[a.id];return o&&i?l.jsx(o,{featureId:a.id,sliceState:i,actions:e},a.id):null})})},ze=()=>{const t=m(),e=w(),{fpsSmoothed:a}=G(),o=v.useMemo(()=>({handleInteractionStart:t.handleInteractionStart,handleInteractionEnd:t.handleInteractionEnd,openContextMenu:t.openContextMenu}),[t.handleInteractionStart,t.handleInteractionEnd,t.openContextMenu]),i=Object.values(t.panels).filter(r=>r.location==="float"&&r.isOpen);return l.jsx(D,{value:o,children:l.jsxs("div",{className:"fixed inset-0 w-full h-full bg-black text-fg select-none overflow-hidden flex flex-col",children:[l.jsx(H,{}),l.jsx(X,{}),i.map(r=>l.jsx(q,{id:r.id,title:r.id,children:l.jsx(Y,{activeTab:r.id,state:t,actions:t,onSwitchTab:n=>t.togglePanel(n,!0)})},r.id)),l.jsx(W,{}),l.jsxs("div",{className:"flex-1 flex overflow-hidden relative",children:[l.jsxs(se,{children:[l.jsx(Ce,{}),l.jsx(Te,{})]}),l.jsx(Q,{side:"right"})]}),l.jsx(Z,{}),t.contextMenu.visible&&l.jsx(K,{x:t.contextMenu.x,y:t.contextMenu.y,items:t.contextMenu.items,targetHelpIds:t.contextMenu.targetHelpIds,onClose:t.closeContextMenu,onOpenHelp:t.openHelp}),l.jsxs("div",{className:"absolute bottom-3 left-3 text-[10px] text-fg/40 font-mono pointer-events-none",children:[a.toFixed(0)," fps · q",(e*100).toFixed(0),"%"]}),l.jsxs("div",{className:"absolute top-3 left-3 text-[10px] text-fg/60 font-mono pointer-events-none",children:["Fractal Toy · ",t.formula||"…"]})]})})},Pe=[{id:"Camera",dock:"right",order:1,features:["camera"]},{id:"Lighting",dock:"right",order:2,features:["lighting"]}],Le=()=>J(Pe);ee();te({enabled:!0,targetFps:30,minQuality:.35,interactionDownsample:.55,activityGraceMs:100});ae();oe();ie({getCanvas:()=>U.getCanvas()});re();Ae({onFrameEnd:()=>R.frameTick()});O();ne();le();ce.register({featureId:"camera",captureState:()=>{const e=m.getState().camera;return{orbitTheta:e==null?void 0:e.orbitTheta,orbitPhi:e==null?void 0:e.orbitPhi,distance:e==null?void 0:e.distance,fov:e==null?void 0:e.fov,target:{...e==null?void 0:e.target}}},applyState:t=>{m.getState().setCamera({orbitTheta:t.orbitTheta,orbitPhi:t.orbitPhi,distance:t.distance,fov:t.fov,target:t.target})}});ue(["camera.orbitTheta","camera.orbitPhi","camera.distance","camera.fov","camera.target_x","camera.target_y","camera.target_z"]);Le();m.setState({formula:"Mandelbulb"});const L=document.getElementById("root");if(!L)throw new Error("Could not find root element to mount to");const Ie=fe.createRoot(L);Ie.render(l.jsx(B.StrictMode,{children:l.jsx(ze,{})}));
