var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,j as D,F as p,k as g,u as m,S as j,c as $,z as B,i as O}from"./CollapsibleSection-ndFZBm4A.js";import{r as v,j as l,R as k}from"./three-fiber-BpjhY67l.js";import{g as V,b as N,D as G,a as H}from"./DraggableWindow-CVrwJHqt.js";import{V as X,i as q,c as Y}from"./Camera-DIf4QvN8.js";import{c as W}from"./three-drei-I_uprTuS.js";import{A as Q}from"./AppErrorBoundary-0kkKyk51.js";import{m as S,E as Z,D as K,P as J,a as ee,T as te,c as ae,i as oe,b as ie}from"./PwaUpdate-DkIcigir.js";import{u as w,v as A,b as re,T as ne,G as se,r as le,c as ce,i as fe,a as me}from"./Undo-SdKRvy23.js";import{C as ue}from"./CompilingIndicator-OxQ3yA3L.js";import{r as de}from"./cameraKeyRegistry-CCGlrxdL.js";import"./pako-DwGzBETv.js";import"./three-t6Th-fjv.js";import"./CompositionOverlay-BkDmYkOl.js";import"./accordionReveal-BI7romxl.js";const u=new Map,R=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),V(t.name)||N({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},he=`
