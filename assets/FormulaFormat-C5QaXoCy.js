import{bc as g,bd as y,aN as b,aO as M}from"./paletteFiltersPersist-PCeW2hsv.js";import{r as v}from"./accordionReveal-BI7romxl.js";const E=a=>({id:"Favients",dock:a.dock,order:a.order??90,component:"panel-favients",isCore:!1}),O=(a={})=>{var r,n,l,i;const e=typeof window<"u"?window.innerHeight:800,t=a.storageKey?{storageKey:a.storageKey}:void 0;g({x:((r=a.float)==null?void 0:r.x)??20,y:((n=a.float)==null?void 0:n.y)??Math.max(20,Math.round(e/2-160)),w:((l=a.float)==null?void 0:l.w)??296,h:((i=a.float)==null?void 0:i.h)??320,open:a.open??!0,location:a.location,order:a.order},t),y(t),a.paletteFilters!==!1&&(b(),M())},L=()=>{window.open("gradient-explorer.html","_blank","noopener")},I=`
/*
 * ============================================================
...
`,t},R=a=>{if(T(a)){const t=F(a),r=a.match(/^<Scene>([\s\S]*?)^<\/Scene>/m);if(r){const l=JSON.parse(r[1].trim());return{def:t,preset:l}}const n=t.defaultPreset||{formula:t.id};return n.formula||(n.formula=t.id),{def:t,preset:n}}return{preset:JSON.parse(a)}};export{E as f,w as g,R as l,O as m,L as o,D as s};
