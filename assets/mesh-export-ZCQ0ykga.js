...
`}function wt(e){const t=e.definition;let o="";t.shader.preamble&&(o=en(t.shader.preamble,t.id,t.shader.preambleVars));const n=tn(t.shader.function,t.id,t.shader.preambleVars);let s="";return t.shader.loopInit&&(s=yo(t.shader.loopInit,t.id,t.shader.preambleVars)),{preamble:o,func:n,loopInit:s}}function Ct(e,t,o){let n="",s="";if(o){const a=on(o.definition.shader.loopBody,o.definition.id);let r="";o.definition.shader.loopInit&&(r=yo(o.definition.shader.loopInit,o.definition.id,o.definition.shader.preambleVars));const l=!!o.definition.shader.usesSharedRotation;({preLoop:n,inLoop:s}=nn(a,r,l))}const i=o?`if (!skipMainFormula) { ${e.shader.loopBody} }`:e.shader.loopBody;return`  vec4 z = vec4(pos, 0.0);
...
}`;function pn(e){const t=e.definition,o=e.interlace,n=o?wt(o):null;return`#version 300 es
...
void main() {
  ...
  fragColor = vec4(col, 1.0);
}`}const Ye=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF","uVec2A","uVec2B","uVec2C","uVec3A","uVec3B","uVec3C","uVec4A","uVec4B","uVec4C","uJulia","uJuliaMode","uEscapeThresh","uDistanceMetric",...tt.scalars,...tt.vec2s,...tt.vec3s,...tt.vec4s,"uInterlaceEnabled","uInterlaceInterval","uInterlaceStartIter","uFudgeFactor","uDetail","uPixelThreshold","uSurfaceThreshold","uClipBounds","uBoundsMin","uBoundsMax"];So();const Do=[{name:me.Time,type:"float",default:0},{name:me.FrameCount,type:"int",default:0},{name:me.Resolution,type:"vec2",default:new Be(100,100)},{name:me.SceneOffsetHigh,type:"vec3",default:new Ne},{name:me.SceneOffsetLow,type:"vec3",default:new Ne},{name:me.CameraPosition,type:"vec3",default:new Ne},{name:me.CamBasisX,type:"vec3",default:new Ne},{name:me.CamBasisY,type:"vec3",default:new Ne},{name:me.CamForward,type:"vec3",default:new Ne},{name:me.RegionMin,type:"vec2",default:new Be(0,0)},{name:me.RegionMax,type:"vec2",default:new Be(1,1)},{name:me.ImageTileOrigin,type:"vec2",default:new Be(0,0)},{name:me.ImageTileSize,type:"vec2",default:new Be(1,1)},{name:me.FullOutputResolution,type:"vec2",default:new Be(100,100)},{name:me.TilePixelOrigin,type:"vec2",default:new Be(0,0)},{name:me.HistoryTexture,type:"sampler2D",default:null},{name:me.BlendFactor,type:"float",default:1},{name:me.Jitter,type:"vec2",default:new Be(0,0)},{name:me.BlueNoiseTexture,type:"sampler2D",default:null},{name:me.BlueNoiseResolution,type:"vec2",default:new Be(128,128)},{name:me.HistogramLayer,type:"int",default:0},{name:me.InternalScale,type:"float",default:1},{name:me.PixelSizeBase,type:"float",default:.01,comment:"CPU: length(uCamBasisY)/resolution.y*2, avoids per-fragment sqrt"},{name:me.PreRotMatrix,type:"mat3",default:new Lt},{name:me.PostRotMatrix,type:"mat3",default:new Lt},{name:me.WorldRotMatrix,type:"mat3",default:new Lt},{name:me.EnvRotationMatrix,type:"mat2",default:[1,0,0,1]},{name:me.FogColorLinear,type:"vec3",default:new Ne(0,0,0),comment:"CPU: InverseACESFilm(uFogColor)"}],bn=wo.getUniformDefinitions(),gn=new Set(Do.map(e=>e.name)),yn=bn.filter(e=>!gn.has(e.name)),Lo=[...Do,...yn];Lo.reduce((e,t)=>(e[t.name]=t.default,e),{});const Sn=()=>{let e=`precision highp float;
precision highp int;
...
`)}),e+=`
in vec2 vUv;
`,e},wn=Sn(),oo=(e,t="",o,n="",s="",i="",a="",r="",l="",m="",x="",d="",f="")=>{const v=i.includes("skipMainFormula");return`
${o}
...
`);this.integrators.push(En(y))}const r=this.integrators.join(`
`),l=hn(this.useRotation),m=oo(this.formulaLoopBody,this.formulaInit,this.formulaDist,this.hybridInit.join(`
`),this.hybridPreLoop.join(`
`),this.hybridInLoop.join(`
`),this.distOverrideInit,this.distOverrideInLoopFull,this.distOverrideInLoopGeom,this.distOverridePostFull,this.distOverridePostGeom,this.postMapCode.join(`
`),this.postDistCode.join(`
...
`)),p=no(this.renderMode),E=Fn(this.postProcessLogic.join(`
`)),h=[["Defines",t],["Uniforms",o],["Headers",n],["Math",l],["BlueNoise",ut],["Coloring",ct],["Preambles",s],["Formulas",i],["DE",m],["PostDE",a],["MatEval",x],["MissHandler",d],["Ray",p],["Trace",v],["TraceLean",g],["Integrators",r],["Post",E],["Main",M]];return h.filter(([,y])=>y.length>0).map(([y,w])=>`${y}: ${(w.length/1024).toFixed(1)}kb`).join(" | "),h.reduce((y,[,w])=>y+w.length,0),`
${t}
${o}
${n}
${l}
...
${E}
${M}
`}}class Pn{static generateFragmentShader(t){return this.buildShader(t,"Main")}static generatePhysicsShader(t){return this.buildShader(t,"Physics")}static generateHistogramShader(t){return this.buildShader(t,"Histogram")}static generateMeshSDFLibrary(t){return this.buildShader(t,"Mesh")}static buildShader(t,o){const n=new Tn(o),s=t.lighting,a=(s==null?void 0:s.ptEnabled)!==!1&&(t.renderMode==="PathTracing"||(s==null?void 0:s.renderMode)===1);n.setRenderMode(a?"PathTracing":"Direct");const r=t.quality||{};return n.setQuality(r.precisionMode===1,r.precisionMode??0),wo.getAll().forEach(m=>{m.inject&&m.inject(n,t,o)}),n.buildFragment()}}class ht{constructor(t=65536){ae(this,"data");ae(this,"length");this.data=new Float32Array(t),this.length=0}push3(t,o,n){if(this.length+3>this.data.length){const s=this.data.length*2,i=new Float32Array(s);i.set(this.data),this.data=i}this.data[this.length++]=t,this.data[this.length++]=o,this.data[this.length++]=n}trim(){return this.data.subarray(0,this.length)}}class _o{constructor(t=65536){ae(this,"data");ae(this,"length");this.data=new Uint32Array(t),this.length=0}push3(t,o,n){if(this.length+3>this.data.length){const s=this.data.length*2,i=new Uint32Array(s);i.set(this.data),this.data=i}this.data[this.length++]=t,this.data[this.length++]=o,this.data[this.length++]=n}trim(){return this.data.subarray(0,this.length)}}function Ue(e,t,o,n,s){return o=o|0,n=n|0,s=s|0,o=o<0?0:o>=t?t-1:o,n=n<0?0:n>=t?t-1:n,s=s<0?0:s>=t?t-1:s,e[(s*t+n)*t+o]}function Xe(e,t,o,n,s){const i=Math.floor(o),a=Math.floor(n),r=Math.floor(s),l=o-i,m=n-a,x=s-r,d=Ue(e,t,i,a,r),f=Ue(e,t,i+1,a,r),v=Ue(e,t,i,a+1,r),g=Ue(e,t,i+1,a+1,r),M=Ue(e,t,i,a,r+1),p=Ue(e,t,i+1,a,r+1),E=Ue(e,t,i,a+1,r+1),h=Ue(e,t,i+1,a+1,r+1),y=d*(1-l)+f*l,w=v*(1-l)+g*l,V=M*(1-l)+p*l,k=E*(1-l)+h*l,R=y*(1-m)+w*m,D=V*(1-m)+k*m;return R*(1-x)+D*x}function ao(e,t,o,n,s){const a=Xe(e,t,o+.5,n,s)-Xe(e,t,o-.5,n,s),r=Xe(e,t,o,n+.5,s)-Xe(e,t,o,n-.5,s),l=Xe(e,t,o,n,s+.5)-Xe(e,t,o,n,s-.5),m=Math.sqrt(a*a+r*r+l*l);if(m<1e-10)return[0,1,0];const x=1/m;return[a*x,r*x,l*x]}function ye(e,t,o,n){return o+e/(t-1)*(n-o)}function qe(e,t,o,n){return(e-o)/(n-o)*(t-1)}const pt=[[0,1],[2,3],[4,5],[6,7],[0,2],[1,3],[4,6],[5,7],[0,4],[1,5],[2,6],[3,7]];function Bo(e,t,o){if(e.length===0)return null;let n=0,s=0,i=0;for(let D=0;D<e.length;D++)n+=e[D].point[0],s+=e[D].point[1],i+=e[D].point[2];const a=1/e.length;n*=a,s*=a,i*=a;let r=0,l=0,m=0,x=0,d=0,f=0,v=0,g=0,M=0;for(let D=0;D<e.length;D++){const N=e[D].normal,u=e[D].point,c=N[0]*u[0]+N[1]*u[1]+N[2]*u[2];r+=N[0]*N[0],l+=N[0]*N[1],m+=N[0]*N[2],x+=N[1]*N[1],d+=N[1]*N[2],f+=N[2]*N[2],v+=N[0]*c,g+=N[1]*c,M+=N[2]*c}const p=.01;r+=p,x+=p,f+=p,v+=p*n,g+=p*s,M+=p*i;const E=r*(x*f-d*d)-l*(l*f-d*m)+m*(l*d-x*m);let h,y,w;if(Math.abs(E)<1e-6)h=n,y=s,w=i;else{const D=1/E;h=D*(v*(x*f-d*d)-l*(g*f-d*M)+m*(g*d-x*M)),y=D*(r*(g*f-d*M)-v*(l*f-d*m)+m*(l*M-g*m)),w=D*(r*(x*M-g*d)-l*(l*M-g*m)+v*(l*d-x*m))}const V=(o[0]-t[0])*.1,k=(o[1]-t[1])*.1,R=(o[2]-t[2])*.1;return h=Math.max(t[0]-V,Math.min(o[0]+V,h)),y=Math.max(t[1]-k,Math.min(o[1]+k,y)),w=Math.max(t[2]-R,Math.min(o[2]+R,w)),[h,y,w]}let Ht=!1;function An(){Ht=!0}function so(){Ht=!1}function ro(){return new Promise(e=>setTimeout(e,0)).then(()=>{if(Ht)throw new Error("CANCELLED")})}async function In(e,t,o,n,s,i=()=>{}){const a=t-1;i("contouring",0);const r=new Map,l=new ht(8192),m=new ht(8192);let x=0;for(let k=0;k<a;k++){k&7||(i("contouring",Math.round(40*k/a)),await ro());for(let R=0;R<a;R++)for(let D=0;D<a;D++){const N=e[(k*t+R)*t+D],u=N>=0,c=[N,e[(k*t+R)*t+D+1],e[(k*t+(R+1))*t+D],e[(k*t+(R+1))*t+D+1],e[((k+1)*t+R)*t+D],e[((k+1)*t+R)*t+D+1],e[((k+1)*t+(R+1))*t+D],e[((k+1)*t+(R+1))*t+D+1]];let _=!1;for(let C=1;C<8;C++)if(c[C]>=0!==u){_=!0;break}if(!_)continue;const P=[];for(let C=0;C<12;C++){const L=pt[C],A=c[L[0]],O=c[L[1]];if(A>=0==O>=0)continue;const S=D+(L[0]&1),T=R+(L[0]>>1&1),G=k+(L[0]>>2&1),H=D+(L[1]&1),X=R+(L[1]>>1&1),$=k+(L[1]>>2&1);let j=S,W=T,oe=G,ne=H,Z=X,re=$,le=A;for(let se=0;se<8;se++){const K=(j+ne)*.5,ee=(W+Z)*.5,Q=(oe+re)*.5,te=Xe(e,t,K,ee,Q);te>=0==le>=0?(j=K,W=ee,oe=Q,le=te):(ne=K,Z=ee,re=Q)}const ie=(j+ne)*.5,ce=(W+Z)*.5,J=(oe+re)*.5,q=ao(e,t,ie,ce,J);P.push({point:[ye(ie,t,o[0],n[0]),ye(ce,t,o[1],n[1]),ye(J,t,o[2],n[2])],normal:q})}if(P.length===0)continue;const B=[ye(D,t,o[0],n[0]),ye(R,t,o[1],n[1]),ye(k,t,o[2],n[2])],z=[ye(D+1,t,o[0],n[0]),ye(R+1,t,o[1],n[1]),ye(k+1,t,o[2],n[2])],F=Bo(P,B,z);if(!F)continue;const U=ao(e,t,qe(F[0],t,o[0],n[0]),qe(F[1],t,o[1],n[1]),qe(F[2],t,o[2],n[2])),I=(k*a+R)*a+D;r.set(I,x),l.push3(F[0],F[1],F[2]),m.push3(U[0],U[1],U[2]),x++}}if(i("contouring",50),console.log("DC: "+x+" vertices from "+r.size+" cells"),x===0)return{positions:new Float32Array(0),normals:new Float32Array(0),indices:new Uint32Array(0),vertexCount:0,faceCount:0};const d=new _o(8192),f=new Set;let v=0,g=0,M=0;const p=r.size,E=Array.from(r.entries());for(let k=0;k<E.length;k++){E[k][1];const R=E[k][0];M++;const D=R%a,N=(R/a|0)%a,u=R/(a*a)|0;for(let c=0;c<12;c++){const _=pt[c],P=D+(_[0]&1),B=N+(_[0]>>1&1),z=u+(_[0]>>2&1),F=D+(_[1]&1),U=N+(_[1]>>1&1),I=u+(_[1]>>2&1),C=e[(z*t+B)*t+P],L=e[(I*t+U)*t+F];if(C>=0==L>=0)continue;let A;const O=Math.min(P,F),S=Math.min(B,U),T=Math.min(z,I);P!==F?A=0:B!==U?A=1:A=2;const G=(T*t+S)*t*4+O*4+A;if(f.has(G))continue;f.add(G),v++;const H=(A+1)%3,X=(A+2)%3,$=[O,S,T],j=[-1,-1,-1,-1];let W=!0;for(let ne=0;ne<4;ne++){const Z=[$[0],$[1],$[2]];if(Z[H]-=ne&1?0:1,Z[X]-=ne&2?0:1,Z[0]<0||Z[1]<0||Z[2]<0||Z[0]>=a||Z[1]>=a||Z[2]>=a){W=!1;break}const re=(Z[2]*a+Z[1])*a+Z[0],le=r.get(re);if(le===void 0){W=!1;break}j[ne]=le}if(!W){g++;continue}const oe=C>=0;j[0]!==j[1]&&j[0]!==j[3]&&j[1]!==j[3]&&(oe?d.push3(j[0],j[3],j[1]):d.push3(j[0],j[1],j[3])),j[0]!==j[2]&&j[0]!==j[3]&&j[2]!==j[3]&&(oe?d.push3(j[0],j[2],j[3]):d.push3(j[0],j[3],j[2]))}M&4095||(i("contouring",50+Math.round(50*M/p)),await ro())}i("contouring",100),console.log("DC: "+v+" sign-change edges, "+g+" dropped (boundary), "+d.length/3+" faces");const h=l.trim(),y=m.trim(),w=d.trim(),V=Math.floor(d.length/3);return{positions:h,normals:y,indices:w,vertexCount:x,faceCount:V}}let Yt=!1;function Rn(){Yt=!0}function io(){Yt=!1}function zt(){return new Promise(e=>setTimeout(e,0)).then(()=>{if(Yt)throw new Error("CANCELLED")})}class Dn{constructor(t,o=8,n=1){ae(this,"N");ae(this,"blockSize");ae(this,"defaultValue");ae(this,"blocksPerAxis");ae(this,"blockCellCount");ae(this,"blocks");ae(this,"allocatedCount");this.N=t,this.blockSize=o,this.defaultValue=n,this.blocksPerAxis=Math.ceil(t/o),this.blockCellCount=o*o*o,this.blocks=new Map,this.allocatedCount=0}blockKey(t,o,n){return(n*this.blocksPerAxis+o)*this.blocksPerAxis+t}allocateBlock(t,o,n){const s=this.blockKey(t,o,n);if(!this.blocks.has(s)){const i=new Float32Array(this.blockCellCount);i.fill(this.defaultValue),this.blocks.set(s,i),this.allocatedCount++}return this.blocks.get(s)}hasBlock(t,o,n){return this.blocks.has(this.blockKey(t,o,n))}set(t,o,n,s){const i=this.blockSize,a=t/i|0,r=o/i|0,l=n/i|0,m=this.allocateBlock(a,r,l),x=t-a*i,d=o-r*i,f=n-l*i;m[(f*i+d)*i+x]=s}get(t,o,n){if(t<0||o<0||n<0||t>=this.N||o>=this.N||n>=this.N)return this.defaultValue;const s=this.blockSize,i=t/s|0,a=o/s|0,r=n/s|0,l=this.blockKey(i,a,r),m=this.blocks.get(l);if(!m)return this.defaultValue;const x=t-i*s,d=o-a*s,f=n-r*s;return m[(f*s+d)*s+x]}lerp(t,o,n){const s=Math.floor(t),i=Math.floor(o),a=Math.floor(n),r=t-s,l=o-i,m=n-a,x=this.get(s,i,a),d=this.get(s+1,i,a),f=this.get(s,i+1,a),v=this.get(s+1,i+1,a),g=this.get(s,i,a+1),M=this.get(s+1,i,a+1),p=this.get(s,i+1,a+1),E=this.get(s+1,i+1,a+1),h=x*(1-r)+d*r,y=f*(1-r)+v*r,w=g*(1-r)+M*r,V=p*(1-r)+E*r,k=h*(1-l)+y*l,R=w*(1-l)+V*l;return k*(1-m)+R*m}gradient(t,o,n){const i=this.lerp(t+.5,o,n)-this.lerp(t-.5,o,n),a=this.lerp(t,o+.5,n)-this.lerp(t,o-.5,n),r=this.lerp(t,o,n+.5)-this.lerp(t,o,n-.5),l=Math.sqrt(i*i+a*a+r*r);if(l<1e-10)return[0,1,0];const m=1/l;return[i*m,a*m,r*m]}memoryMB(){return this.allocatedCount*this.blockCellCount*4/(1024*1024)}}function Ln(e,t,o,n=8,s=2){const i=o/t,a=Math.ceil(o/n),r=new Set;for(let x=0;x<t-1;x++)for(let d=0;d<t-1;d++)for(let f=0;f<t-1;f++){const g=e[(x*t+d)*t+f]>=0;let M=!1;for(let p=0;p<=1&&!M;p++)for(let E=0;E<=1&&!M;E++)for(let h=0;h<=1;h++){if(h===0&&E===0&&p===0)continue;if(e[((x+p)*t+(d+E))*t+(f+h)]>=0!==g){M=!0;break}}if(M)for(let p=-s;p<=s;p++)for(let E=-s;E<=s;E++)for(let h=-s;h<=s;h++){const y=f+h,w=d+E,V=x+p;y>=0&&w>=0&&V>=0&&y<t&&w<t&&V<t&&r.add((V*t+w)*t+y)}}const l=new Dn(o,n,1);let m=0;return r.forEach(x=>{const d=x%t,f=(x/t|0)%t,v=x/(t*t)|0,g=Math.floor(d*i),M=Math.floor(f*i),p=Math.floor(v*i),E=Math.ceil((d+1)*i),h=Math.ceil((f+1)*i),y=Math.ceil((v+1)*i),w=g/n|0,V=M/n|0,k=p/n|0,R=Math.min(a-1,E/n|0),D=Math.min(a-1,h/n|0),N=Math.min(a-1,y/n|0);for(let u=k;u<=N;u++)for(let c=V;c<=D;c++)for(let _=w;_<=R;_++)l.hasBlock(_,c,u)||(l.allocateBlock(_,c,u),m++)}),console.log("Narrow band: "+r.size+" coarse surface cells -> "+m+" fine blocks ("+l.memoryMB().toFixed(1)+" MB) out of "+a*a*a+" total blocks"),{grid:l,surfaceCells:r,bandBlockCount:m}}function qt(e,t){const o=e.blockSize,n=e.blocksPerAxis;e.blocks.forEach((s,i)=>{const a=i%n,r=(i/n|0)%n,l=i/(n*n)|0;t(a,r,l,a*o,r*o,l*o)})}async function _n(e,t,o,n=()=>{}){const s=e.N,i=s-1,a=e.blockSize,r=e.blocksPerAxis;let l=new Map,m=null;function x(F,U,I,C){const L=F/a|0,A=U/a|0,O=I/a|0,S=e.blockKey(L,A,O),T=F-L*a,G=U-A*a,X=((I-O*a)*a+G)*a+T;let $=l.get(S);$||($={locals:[],globals:[]},l.set(S,$)),$.locals.push(X),$.globals.push(C)}function d(F,U,I){const C=F/a|0,L=U/a|0,A=I/a|0,O=e.blockKey(C,L,A),S=m.get(O);if(!S)return-1;const T=F-C*a,G=U-L*a,X=((I-A*a)*a+G)*a+T,$=S.locals;let j=0,W=$.length-1;for(;j<=W;){const oe=j+W>>1;if($[oe]===X)return S.globals[oe];$[oe]<X?j=oe+1:W=oe-1}return-1}const f=new Map;function v(F,U,I,C){const L=F/a|0,A=U/a|0,O=I/a|0,S=e.blockKey(L,A,O);let T=f.get(S);T||(T=new Uint8Array(e.blockCellCount),f.set(S,T));const G=F-L*a,H=U-A*a,$=((I-O*a)*a+H)*a+G,j=1<<C;return T[$]&j?!0:(T[$]|=j,!1)}n("contouring",0);const g=new ht(262144),M=new ht(262144);let p=0,E=0;const h=e.allocatedCount,y=[];qt(e,(F,U,I,C,L,A)=>{y.push([F,U,I,C,L,A])});for(let F=0;F<y.length;F++){const U=y[F],I=U[3],C=U[4],L=U[5];E++;const A=Math.min(I+a,i),O=Math.min(C+a,i),S=Math.min(L+a,i);for(let T=L;T<S;T++)for(let G=C;G<O;G++)for(let H=I;H<A;H++){const X=e.get(H,G,T),$=X>=0,j=[X,e.get(H+1,G,T),e.get(H,G+1,T),e.get(H+1,G+1,T),e.get(H,G,T+1),e.get(H+1,G,T+1),e.get(H,G+1,T+1),e.get(H+1,G+1,T+1)];let W=!1;for(let ie=1;ie<8;ie++)if(j[ie]>=0!==$){W=!0;break}if(!W)continue;const oe=[];for(let ie=0;ie<12;ie++){const ce=pt[ie],J=j[ce[0]],q=j[ce[1]];if(J>=0==q>=0)continue;const se=H+(ce[0]&1),K=G+(ce[0]>>1&1),ee=T+(ce[0]>>2&1),Q=H+(ce[1]&1),te=G+(ce[1]>>1&1),fe=T+(ce[1]>>2&1);let he=se,xe=K,Fe=ee,Ae=Q,Se=te,ue=fe,ge=J;for(let Ee=0;Ee<8;Ee++){const Le=(he+Ae)*.5,$e=(xe+Se)*.5,Ge=(Fe+ue)*.5,Qe=e.lerp(Le,$e,Ge);Qe>=0==ge>=0?(he=Le,xe=$e,Fe=Ge,ge=Qe):(Ae=Le,Se=$e,ue=Ge)}const Ie=(he+Ae)*.5,ve=(xe+Se)*.5,pe=(Fe+ue)*.5,Ce=e.gradient(Ie,ve,pe);oe.push({point:[ye(Ie,s,t[0],o[0]),ye(ve,s,t[1],o[1]),ye(pe,s,t[2],o[2])],normal:Ce})}if(oe.length===0)continue;const ne=[ye(H,s,t[0],o[0]),ye(G,s,t[1],o[1]),ye(T,s,t[2],o[2])],Z=[ye(H+1,s,t[0],o[0]),ye(G+1,s,t[1],o[1]),ye(T+1,s,t[2],o[2])],re=Bo(oe,ne,Z);if(!re)continue;const le=e.gradient(qe(re[0],s,t[0],o[0]),qe(re[1],s,t[1],o[1]),qe(re[2],s,t[2],o[2]));x(H,G,T,p),g.push3(re[0],re[1],re[2]),M.push3(le[0],le[1],le[2]),p++}E&63||(n("contouring",Math.round(40*E/h)),await zt())}if(n("contouring",50),console.log("DC sparse: "+p+" vertices ("+((g.data.byteLength+M.data.byteLength)/(1024*1024)).toFixed(0)+" MB vertex data)"),p===0)return{positions:new Float32Array(0),normals:new Float32Array(0),indices:new Uint32Array(0),vertexCount:0,faceCount:0};const w=new Map,V=e.blockCellCount+7>>3,k=e.memoryMB();let R=Array.from(e.blocks.keys());for(let F=0;F<R.length;F++){const U=R[F],I=e.blocks.get(U),C=new Uint8Array(V);for(let L=0;L<I.length;L++)I[L]>=0&&(C[L>>3]|=1<<(L&7));w.set(U,C),e.blocks.delete(U),F&255||await zt()}R=null,e.allocatedCount=0;const D=(w.size*V/(1024*1024)).toFixed(0);console.log("Sign compression: freed "+k.toFixed(0)+" MB float data, using "+D+" MB sign maps"),m=new Map,l.forEach((F,U)=>{const I=F.locals.length,C=new Array(I);for(let T=0;T<I;T++)C[T]=T;const L=F.locals,A=F.globals;C.sort((T,G)=>L[T]-L[G]);const O=new Uint16Array(I),S=new Uint32Array(I);for(let T=0;T<I;T++)O[T]=L[C[T]],S[T]=A[C[T]];m.set(U,{locals:O,globals:S})}),l.clear(),l=null,console.log("Vertex map compaction: "+m.size+" blocks with vertices");function N(F,U,I){if(F<0||U<0||I<0||F>=s||U>=s||I>=s)return!0;const C=F/a|0,L=U/a|0,A=I/a|0,O=e.blockKey(C,L,A),S=w.get(O);if(!S)return!0;const T=F-C*a,G=U-L*a,X=((I-A*a)*a+G)*a+T;return(S[X>>3]&1<<(X&7))!==0}const u=new _o(262144);let c=0,_=0,P=0;const B=m.size;let z=Array.from(m.entries());for(let F=0;F<z.length;F++){const U=z[F],I=U[0],C=U[1];P++;const L=I%r,A=(I/r|0)%r,O=I/(r*r)|0,S=L*a,T=A*a,G=O*a;for(let H=0;H<C.locals.length;H++){const X=C.locals[H],$=X%a,j=(X/a|0)%a,W=X/(a*a)|0,oe=S+$,ne=T+j,Z=G+W;if(!(oe>=i||ne>=i||Z>=i))for(let re=0;re<12;re++){const le=pt[re],ie=oe+(le[0]&1),ce=ne+(le[0]>>1&1),J=Z+(le[0]>>2&1),q=oe+(le[1]&1),se=ne+(le[1]>>1&1),K=Z+(le[1]>>2&1),ee=N(ie,ce,J),Q=N(q,se,K);if(ee===Q)continue;let te;const fe=Math.min(ie,q),he=Math.min(ce,se),xe=Math.min(J,K);if(ie!==q?te=0:ce!==se?te=1:te=2,v(fe,he,xe,te))continue;c++;const Fe=(te+1)%3,Ae=(te+2)%3,Se=[fe,he,xe],ue=[-1,-1,-1,-1];let ge=!0;for(let ve=0;ve<4;ve++){const pe=[Se[0],Se[1],Se[2]];if(pe[Fe]-=ve&1?0:1,pe[Ae]-=ve&2?0:1,pe[0]<0||pe[1]<0||pe[2]<0||pe[0]>=i||pe[1]>=i||pe[2]>=i){ge=!1;break}const Ce=d(pe[0],pe[1],pe[2]);if(Ce<0){ge=!1;break}ue[ve]=Ce}if(!ge){_++;continue}const Ie=ee;ue[0]!==ue[1]&&ue[0]!==ue[3]&&ue[1]!==ue[3]&&(Ie?u.push3(ue[0],ue[3],ue[1]):u.push3(ue[0],ue[1],ue[3])),ue[0]!==ue[2]&&ue[0]!==ue[3]&&ue[2]!==ue[3]&&(Ie?u.push3(ue[0],ue[2],ue[3]):u.push3(ue[0],ue[3],ue[2]))}}P&63||(n("contouring",50+Math.round(50*P/B)),await zt())}return m=null,z=null,n("contouring",100),console.log("DC sparse: "+c+" sign-change edges, "+_+" dropped, "+u.length/3+" faces"),{positions:g.trim(),normals:M.trim(),indices:u.trim(),vertexCount:p,faceCount:Math.floor(u.length/3)}}const zo=new Float32Array(1),Bn=new Uint32Array(zo.buffer);function zn(e){zo[0]=e;const t=Bn[0],o=t>>16&32768,n=(t>>23&255)-127+15,s=t&8388607;return n<=0?o:n>=31?o|31744:o|n<<10|s>>13}const ko=new Uint16Array(256);for(let e=0;e<256;e++)ko[e]=zn(e/255);class Oo{constructor(t){ae(this,"buf");ae(this,"a");ae(this,"v");ae(this,"pos");this.buf=new ArrayBuffer(t||8*1024*1024),this.a=new Uint8Array(this.buf),this.v=new DataView(this.buf),this.pos=0}grow(t){let o=this.pos+t;this.buf.byteLength<256*1024*1024?o=Math.max(this.buf.byteLength*2,o):o=Math.max(Math.round(this.buf.byteLength*1.25),o);const n=new ArrayBuffer(o);new Uint8Array(n).set(this.a),this.buf=n,this.a=new Uint8Array(n),this.v=new DataView(n)}en(t){this.pos+t>this.buf.byteLength&&this.grow(t)}u8(t){this.en(1),this.v.setUint8(this.pos,t),this.pos++}u16(t){this.en(2),this.v.setUint16(this.pos,t,!0),this.pos+=2}u32(t){this.en(4),this.v.setUint32(this.pos,t,!0),this.pos+=4}i32(t){this.en(4),this.v.setInt32(this.pos,t,!0),this.pos+=4}u64(t){this.en(8),this.v.setBigUint64(this.pos,t,!0),this.pos+=8}f64(t){this.en(8),this.v.setFloat64(this.pos,t,!0),this.pos+=8}raw(t){this.en(t.length),this.a.set(t,this.pos),this.pos+=t.length}str(t){this.en(t.length);for(let o=0;o<t.length;o++)this.a[this.pos++]=t.charCodeAt(o)}name(t){this.u32(t.length),this.str(t)}zeros(t){this.en(t),this.pos+=t}bulk64(t){const o=t.length*8;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}bulk16(t){const o=t.length*2;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}bulkF32(t){const o=t.length*4;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}result(){return new Uint8Array(this.buf,0,this.pos)}}const xt=0xFFFFFFFFFFFFFFFFn;function kn(){return{n5childMask:new BigUint64Array(512),n5valueMask:new BigUint64Array(512),n5tileValues:new Uint16Array(32768),n4map:new Map}}function On(){return{childMask:new BigUint64Array(64),valueMask:new BigUint64Array(64),tileValues:new Uint16Array(4096),leafMap:new Map}}function jn(e,t,o,n,s){const i=new BigUint64Array(8),a=new Uint16Array(512);let r=0;for(let g=0;g<512;g++)s[g]>0&&(i[g>>6]|=1n<<BigInt(g&63),a[g]=ko[s[g]],r++);if(r===0)return 0;const l=t<<3,m=o<<3,x=n<<3,d=(x&4095)>>7|(m&4095)>>7<<5|(l&4095)>>7<<10;e.n5childMask[d>>6]|=1n<<BigInt(d&63);let f=e.n4map.get(d);f||(f=On(),e.n4map.set(d,f));const v=(x&127)>>3|(m&127)>>3<<4|(l&127)>>3<<8;return f.childMask[v>>6]|=1n<<BigInt(v&63),f.leafMap.set(v,{mask:i,data:a}),r}function Un(e){let t=0,o=0;return e.n4map.forEach(function(n,s){const i=[];n.leafMap.forEach(function(a,r){let l=!0;for(let d=0;d<8;d++)if(a.mask[d]!==xt){l=!1;break}if(!l)return;const m=a.data[0];let x=!0;for(let d=1;d<512;d++)if(a.data[d]!==m){x=!1;break}x&&i.push([r,m])});for(let a=0;a<i.length;a++){const r=i[a][0],l=i[a][1];n.leafMap.delete(r),n.childMask[r>>6]&=~(1n<<BigInt(r&63)),n.valueMask[r>>6]|=1n<<BigInt(r&63),n.tileValues[r]=l,t++}if(n.leafMap.size===0){let a=!0;for(let r=0;r<64;r++)if(n.valueMask[r]!==xt){a=!1;break}if(a){const r=n.tileValues[0];let l=!0;for(let m=1;m<4096;m++)if(n.tileValues[m]!==r){l=!1;break}l&&(e.n4map.delete(s),e.n5childMask[s>>6]&=~(1n<<BigInt(s&63)),e.n5valueMask[s>>6]|=1n<<BigInt(s&63),e.n5tileValues[s]=r,o++)}}}),{promotedLeaves:t,promotedN4s:o}}function Vn(){return{n5childMask:new BigUint64Array(512),n5valueMask:new BigUint64Array(512),n5tileValues:new Float32Array(32768*3),n4map:new Map}}function Nn(){return{childMask:new BigUint64Array(64),valueMask:new BigUint64Array(64),tileValues:new Float32Array(4096*3),leafMap:new Map}}function $n(e,t,o,n,s,i,a){const r=new BigUint64Array(8),l=new Float32Array(512*3);let m=0;for(let p=0;p<512;p++)(s[p]>0||i[p]>0||a[p]>0)&&(r[p>>6]|=1n<<BigInt(p&63),l[p*3]=s[p]/255,l[p*3+1]=i[p]/255,l[p*3+2]=a[p]/255,m++);if(m===0)return 0;const x=t<<3,d=o<<3,f=n<<3,v=(f&4095)>>7|(d&4095)>>7<<5|(x&4095)>>7<<10;e.n5childMask[v>>6]|=1n<<BigInt(v&63);let g=e.n4map.get(v);g||(g=Nn(),e.n4map.set(v,g));const M=(f&127)>>3|(d&127)>>3<<4|(x&127)>>3<<8;return g.childMask[M>>6]|=1n<<BigInt(M&63),g.leafMap.set(M,{mask:r,data:l}),m}function Gn(e){let t=0,o=0;return e.n4map.forEach(function(n,s){const i=[];n.leafMap.forEach(function(a,r){let l=!0;for(let v=0;v<8;v++)if(a.mask[v]!==xt){l=!1;break}if(!l)return;const m=a.data[0],x=a.data[1],d=a.data[2];let f=!0;for(let v=1;v<512;v++)if(a.data[v*3]!==m||a.data[v*3+1]!==x||a.data[v*3+2]!==d){f=!1;break}f&&i.push([r,m,x,d])});for(const[a,r,l,m]of i)n.leafMap.delete(a),n.childMask[a>>6]&=~(1n<<BigInt(a&63)),n.valueMask[a>>6]|=1n<<BigInt(a&63),n.tileValues[a*3]=r,n.tileValues[a*3+1]=l,n.tileValues[a*3+2]=m,t++;if(n.leafMap.size===0){let a=!0;for(let r=0;r<64;r++)if(n.valueMask[r]!==xt){a=!1;break}if(a){const r=n.tileValues[0],l=n.tileValues[1],m=n.tileValues[2];let x=!0;for(let d=1;d<4096;d++)if(n.tileValues[d*3]!==r||n.tileValues[d*3+1]!==l||n.tileValues[d*3+2]!==m){x=!1;break}x&&(e.n4map.delete(s),e.n5childMask[s>>6]&=~(1n<<BigInt(s&63)),e.n5valueMask[s>>6]|=1n<<BigInt(s&63),e.n5tileValues[s*3]=r,e.n5tileValues[s*3+1]=l,e.n5tileValues[s*3+2]=m,o++)}}}),{promotedLeaves:t,promotedN4s:o}}function Ze(e){return Array.from(e.keys()).sort(function(t,o){return t-o})}function ke(e,t,o){e.name(t),e.name("string"),e.name(o)}function Zt(e,t,o){e.name(t),e.name("bool"),e.u32(1),e.u8(o?1:0)}function jo(e,t){e.u32(1),e.u32(0),e.u32(0),e.u32(1),e.i32(0),e.i32(0),e.i32(0),e.bulk64(t.n5childMask),e.bulk64(t.n5valueMask),e.u8(6),e.bulk16(t.n5tileValues);const o=Ze(t.n4map);for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]);e.bulk64(s.childMask),e.bulk64(s.valueMask),e.u8(6),e.bulk16(s.tileValues);const i=Ze(s.leafMap);for(let a=0;a<i.length;a++)e.bulk64(s.leafMap.get(i[a]).mask)}for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]),i=Ze(s.leafMap);for(let a=0;a<i.length;a++){const r=s.leafMap.get(i[a]);e.bulk64(r.mask),e.u8(6),e.bulk16(r.data),r.data=null}}}function Xn(e,t){e.u32(1),e.f64(0),e.u32(0),e.u32(0),e.u32(1),e.i32(0),e.i32(0),e.i32(0),e.bulk64(t.n5childMask),e.bulk64(t.n5valueMask),e.u8(6),e.bulkF32(t.n5tileValues);const o=Ze(t.n4map);for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]);e.bulk64(s.childMask),e.bulk64(s.valueMask),e.u8(6),e.bulkF32(s.tileValues);const i=Ze(s.leafMap);for(let a=0;a<i.length;a++)e.bulk64(s.leafMap.get(i[a]).mask)}for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]),i=Ze(s.leafMap);for(let a=0;a<i.length;a++){const r=s.leafMap.get(i[a]);e.bulk64(r.mask),e.u8(6),e.bulkF32(r.data),r.data=null}}}function Uo(e,t,o,n){const s=n/t;e.name("AffineMap"),e.f64(s),e.f64(0),e.f64(0),e.f64(0),e.f64(0),e.f64(s),e.f64(0),e.f64(0),e.f64(0),e.f64(0),e.f64(s),e.f64(0),e.f64(o[0]),e.f64(o[1]),e.f64(o[2]),e.f64(1)}function Hn(e,t,o,n,s,i){e.u32(0),e.u32(4),ke(e,"class","unknown"),ke(e,"file_compression","none"),Zt(e,"is_saved_as_half_float",!0),ke(e,"name",o),Uo(e,n,s,i),jo(e,t)}function Yn(e,t,o,n,s,i){e.u32(0),e.u32(4),ke(e,"class","unknown"),ke(e,"file_compression","none"),Zt(e,"is_saved_as_half_float",!1),ke(e,"name",o),Uo(e,n,s,i),Xn(e,t)}function qn(e,t,o,n){let s=0;e.n4map.forEach(function(l){s+=l.leafMap.size});const i=2e5+s*1200+e.n4map.size*1e4,a=new Oo(Math.max(i,1024*1024));a.raw(new Uint8Array([32,66,68,86,0,0,0,0])),a.u32(224),a.u32(8),a.u32(1),a.u8(0),a.str("d2b59639-ac2f-4047-9c50-9648f951180c"),a.u32(0),a.u32(1),a.name("density"),a.name("Tree_float_5_4_3_HalfFloat"),a.u32(0),a.u64(BigInt(a.pos+24)),a.u64(0n),a.u64(0n),a.u32(0),a.u32(4),ke(a,"class","unknown"),ke(a,"file_compression","none"),Zt(a,"is_saved_as_half_float",!0),ke(a,"name","density");const r=n/t;return a.name("AffineMap"),a.f64(r),a.f64(0),a.f64(0),a.f64(0),a.f64(0),a.f64(r),a.f64(0),a.f64(0),a.f64(0),a.f64(0),a.f64(r),a.f64(0),a.f64(o[0]),a.f64(o[1]),a.f64(o[2]),a.f64(1),jo(a,e),a.result()}function Zn(e,t,o,n,s){let i=0;e.n4map.forEach(function(m){i+=m.leafMap.size});let a=0;t.n4map.forEach(function(m){a+=m.leafMap.size});const r=2e5+i*1200+e.n4map.size*1e4+2e5+a*7200+t.n4map.size*6e4,l=new Oo(Math.max(r,2*1024*1024));return l.raw(new Uint8Array([32,66,68,86,0,0,0,0])),l.u32(224),l.u32(8),l.u32(1),l.u8(0),l.str("d2b59639-ac2f-4047-9c50-9648f951180c"),l.u32(0),l.u32(2),l.name("density"),l.name("Tree_float_5_4_3_HalfFloat"),l.u32(0),l.u64(BigInt(l.pos+24)),l.u64(0n),l.u64(0n),Hn(l,e,"density",o,n,s),l.name("Cd"),l.name("Tree_vec3s_5_4_3"),l.u32(0),l.u64(BigInt(l.pos+24)),l.u64(0n),l.u64(0n),Yn(l,t,"Cd",o,n,s),l.result()}function Wn(e,t,o){return{formula:e.id,pipelineRevision:0,quality:o?{estimator:o.estimator??0,distanceMetric:o.distanceMetric??0}:void 0,interlace:t?{interlaceCompiled:!0,interlaceFormula:t.definition.id,interlaceEnabled:t.enabled,interlaceInterval:t.interval,interlaceStartIter:t.startIter,interlaceParamA:0,interlaceParamB:0,interlaceParamC:0,interlaceParamD:0,interlaceParamE:0,interlaceParamF:0,interlaceVec2A:{x:0,y:0},interlaceVec2B:{x:0,y:0},interlaceVec2C:{x:0,y:0},interlaceVec3A:{x:0,y:0,z:0},interlaceVec3B:{x:0,y:0,z:0},interlaceVec3C:{x:0,y:0,z:0}}:void 0}}function at(e,t,o){const n=o||{};t.uParamA&&e.uniform1f(t.uParamA,n.paramA??8),t.uParamB&&e.uniform1f(t.uParamB,n.paramB??0),t.uParamC&&e.uniform1f(t.uParamC,n.paramC??0),t.uParamD&&e.uniform1f(t.uParamD,n.paramD??0),t.uParamE&&e.uniform1f(t.uParamE,n.paramE??0),t.uParamF&&e.uniform1f(t.uParamF,n.paramF??0);const s=p=>p?[p.x??p[0]??0,p.y??p[1]??0]:[0,0],i=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0]:[0,0,0],a=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0,p.w??p[3]??0]:[0,0,0,0],r=s(n.vec2A);t.uVec2A&&e.uniform2f(t.uVec2A,r[0],r[1]);const l=s(n.vec2B);t.uVec2B&&e.uniform2f(t.uVec2B,l[0],l[1]);const m=s(n.vec2C);t.uVec2C&&e.uniform2f(t.uVec2C,m[0],m[1]);const x=i(n.vec3A);t.uVec3A&&e.uniform3f(t.uVec3A,x[0],x[1],x[2]);const d=i(n.vec3B);t.uVec3B&&e.uniform3f(t.uVec3B,d[0],d[1],d[2]);const f=i(n.vec3C);t.uVec3C&&e.uniform3f(t.uVec3C,f[0],f[1],f[2]);const v=a(n.vec4A);t.uVec4A&&e.uniform4f(t.uVec4A,v[0],v[1],v[2],v[3]);const g=a(n.vec4B);t.uVec4B&&e.uniform4f(t.uVec4B,g[0],g[1],g[2],g[3]);const M=a(n.vec4C);if(t.uVec4C&&e.uniform4f(t.uVec4C,M[0],M[1],M[2],M[3]),t.uJulia){const p=n.julia;Array.isArray(p)?e.uniform3f(t.uJulia,p[0]??0,p[1]??0,p[2]??0):p&&typeof p=="object"?e.uniform3f(t.uJulia,p.x??0,p.y??0,p.z??0):e.uniform3f(t.uJulia,0,0,0)}t.uJuliaMode&&e.uniform1f(t.uJuliaMode,n.juliaMode?1:0),t.uEscapeThresh&&e.uniform1f(t.uEscapeThresh,n.escapeThresh??10),t.uDistanceMetric&&e.uniform1f(t.uDistanceMetric,n.distanceMetric??0)}function st(e,t,o){if(!o){t.uInterlaceEnabled&&e.uniform1f(t.uInterlaceEnabled,0);return}t.uInterlaceEnabled&&e.uniform1f(t.uInterlaceEnabled,o.enabled?1:0),t.uInterlaceInterval&&e.uniform1f(t.uInterlaceInterval,o.interval??2),t.uInterlaceStartIter&&e.uniform1f(t.uInterlaceStartIter,o.startIter??0);const n=o.params||{},s=p=>p?[p.x??p[0]??0,p.y??p[1]??0]:[0,0],i=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0]:[0,0,0],a=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0,p.w??p[3]??0]:[0,0,0,0];t.uInterlaceParamA&&e.uniform1f(t.uInterlaceParamA,n.paramA??0),t.uInterlaceParamB&&e.uniform1f(t.uInterlaceParamB,n.paramB??0),t.uInterlaceParamC&&e.uniform1f(t.uInterlaceParamC,n.paramC??0),t.uInterlaceParamD&&e.uniform1f(t.uInterlaceParamD,n.paramD??0),t.uInterlaceParamE&&e.uniform1f(t.uInterlaceParamE,n.paramE??0),t.uInterlaceParamF&&e.uniform1f(t.uInterlaceParamF,n.paramF??0);const r=s(n.vec2A);t.uInterlaceVec2A&&e.uniform2f(t.uInterlaceVec2A,r[0],r[1]);const l=s(n.vec2B);t.uInterlaceVec2B&&e.uniform2f(t.uInterlaceVec2B,l[0],l[1]);const m=s(n.vec2C);t.uInterlaceVec2C&&e.uniform2f(t.uInterlaceVec2C,m[0],m[1]);const x=i(n.vec3A);t.uInterlaceVec3A&&e.uniform3f(t.uInterlaceVec3A,x[0],x[1],x[2]);const d=i(n.vec3B);t.uInterlaceVec3B&&e.uniform3f(t.uInterlaceVec3B,d[0],d[1],d[2]);const f=i(n.vec3C);t.uInterlaceVec3C&&e.uniform3f(t.uInterlaceVec3C,f[0],f[1],f[2]);const v=a(n.vec4A);t.uInterlaceVec4A&&e.uniform4f(t.uInterlaceVec4A,v[0],v[1],v[2],v[3]);const g=a(n.vec4B);t.uInterlaceVec4B&&e.uniform4f(t.uInterlaceVec4B,g[0],g[1],g[2],g[3]);const M=a(n.vec4C);t.uInterlaceVec4C&&e.uniform4f(t.uInterlaceVec4C,M[0],M[1],M[2],M[3])}function lo(e,t,o,n){const s=e.createShader(t);if(!s)throw new Error("Failed to create shader");if(e.shaderSource(s,o),e.compileShader(s),!e.getShaderParameter(s,e.COMPILE_STATUS)){const i=e.getShaderInfoLog(s)||"",a=t===e.VERTEX_SHADER?"vertex":"fragment";n("Shader compile error ("+a+"): "+i,"error");const r=o.split(`
`),l=i.match(/\d+:\d+/g)||[];for(let m=0;m<Math.min(l.length,5);m++){const x=parseInt(l[m].split(":")[1])-1;x>=0&&x<r.length&&n("  Line "+(x+1)+": "+r[x].trim(),"error")}throw new Error("Shader compile: "+i.split(`
`)[0])}return s}function rt(e,t,o,n){const s=e.createProgram();if(!s)throw new Error("Failed to create program");if(e.attachShader(s,lo(e,e.VERTEX_SHADER,t,n)),e.attachShader(s,lo(e,e.FRAGMENT_SHADER,o,n)),e.linkProgram(s),!e.getProgramParameter(s,e.LINK_STATUS)){const i=e.getProgramInfoLog(s)||"";throw n("Program link error: "+i,"error"),new Error("Program link: "+i)}return s}function vt(){const e=document.createElement("canvas");e.width=2048,e.height=2048;const t=e.getContext("webgl2",{antialias:!1});if(!t)throw new Error("WebGL2 not supported");return t.getExtension("EXT_color_buffer_float"),t.getExtension("OES_texture_float_linear"),t}function Wt(e,t){const o={};for(let n=0;n<Ye.length;n++)o[Ye[n]]=e.getUniformLocation(t,Ye[n]);return o}function We(e,t,o,n,s,i,a){Oe.register(o),i&&Oe.register(i.definition);const r=Pn.generateMeshSDFLibrary(Wn(o,i,a)),l=n,m=`#version 300 es
precision highp float;
uniform float uZ;
uniform float uPower;
uniform int   uIters;
...
}`,x=rt(e,Je,m,s);e.useProgram(x);const d=e.createTexture();e.bindTexture(e.TEXTURE_2D,d),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,t,t);const f=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,f),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,d,0),e.viewport(0,0,t,t),e.bindVertexArray(e.createVertexArray());const v=["uZ","uPower","uIters","uInvRes","uTileOffset","uBoundsMin","uBoundsRange",...Ye],g={};for(let M=0;M<v.length;M++)g[v[M]]=e.getUniformLocation(x,v[M]);return{prog:x,loc:g,fbo:f,tex:d}}function it(e,t,o,n,s,i,a,r,l,m){e.useProgram(t.prog),e.uniform1f(t.loc.uPower,n),e.uniform1i(t.loc.uIters,s),e.uniform1f(t.loc.uInvRes,1/o),e.uniform3f(t.loc.uBoundsMin,i[0],i[1],i[2]),e.uniform1f(t.loc.uBoundsRange,a),t.loc.uSurfaceThreshold&&e.uniform1f(t.loc.uSurfaceThreshold,m??0),at(e,t.loc,r),st(e,t.loc,l),e.bindFramebuffer(e.FRAMEBUFFER,t.fbo)}async function Vo(e,t,o,n,s,i,a,r,l,m,x,d,f){const{log:v,setPhase:g,setStatus:M,tick:p}=m,E=128,h=r[0]-a[0];let y=0,w=n-1;if(n>E){v("Coarse pre-pass: sampling "+E+"³ to detect Z range...","info"),g("Coarse Pre-pass",0),M("Coarse pre-pass ("+E+"³)..."),await p();const V=We(e,E,t,1,v,x,d);it(e,V,E,s,i,a,h,o,x,f),e.viewport(0,0,E,E);const k=new Float32Array(E*E*4);let R=E,D=-1;for(let N=0;N<E;N++){e.uniform1f(V.loc.uZ,(N+.5)/E),e.uniform2f(V.loc.uTileOffset,0,0),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,E,E,e.RGBA,e.FLOAT,k);let u=!1;for(let c=0;c<E*E;c++)if(k[c*4]<l*3){u=!0;break}u&&(N<R&&(R=N),D=N)}if(e.deleteTexture(V.tex),e.deleteFramebuffer(V.fbo),e.deleteProgram(V.prog),D>=R){const u=n/E;y=Math.max(0,Math.floor((R-2)*u)),w=Math.min(n-1,Math.ceil((D+2+1)*u)),y=y&-8,w=Math.min(n-1,w|7);const c=(100*(1-(w-y+1)/n)).toFixed(0);v("Coarse pre-pass: data in Z ["+R+","+D+"] of "+E+" → fine Z ["+y+","+w+"] of "+n+" (skipping "+c+"% of slices)","data")}else v("Coarse pre-pass: no data found — sampling all slices","warn");g("Coarse Pre-pass",100)}return{zSliceMin:y,zSliceMax:w}}function No(e,t,o,n,s,i,a,r,l){function m(x,d){if(e.useProgram(t.prog),e.bindFramebuffer(e.FRAMEBUFFER,t.fbo),e.uniform1f(t.loc.uZ,x),o<=n){e.uniform2f(t.loc.uTileOffset,0,0),e.viewport(0,0,o,o),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,o,o,e.RGBA,e.FLOAT,s);for(let f=0;f<o*o;f++)d[f]=s[f*4]}else for(let f=0;f<o;f+=n)for(let v=0;v<o;v+=n){const g=Math.min(n,o-v),M=Math.min(n,o-f);e.uniform2f(t.loc.uTileOffset,v,f),e.viewport(0,0,g,M),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,g,M,e.RGBA,e.FLOAT,s);for(let p=0;p<M;p++)for(let E=0;E<g;E++)d[(f+p)*o+(v+E)]=s[(p*g+E)*4]}}if(!r||r<=1)m((a+.5)/o,i);else{i.fill(0);const x=1/r;for(let d=0;d<r;d++){const f=(a+(d+.5)*x)/o;m(f,l);for(let v=0;v<o*o;v++)i[v]+=l[v]}for(let d=0;d<o*o;d++)i[d]*=x}}function $o(e,t,o,n){const s=t/n,i=new ImageData(n,n);for(let a=0;a<n;a++){const r=Math.min(Math.round(a*s),t-1);for(let l=0;l<n;l++){const m=Math.min(Math.round(l*s),t-1),x=e[r*t+m],d=Math.abs(x),f=d<o*2?Math.round(255*(1-d/(o*2))):0,v=x<0?50:0,g=(a*n+l)*4;i.data[g]=f+v,i.data[g+1]=x<0?30:f,i.data[g+2]=f,i.data[g+3]=255}}return i}async function co(e,t,o,n,s,i,a,r,l,m,x,d,f,v,g,M){const{setProgress:p,setPhase:E,setStatus:h,tick:y,log:w,onSlicePreview:V}=v,k=Math.min(o,2048),R=r[0]-a[0];(!x||x<1)&&(x=1),d==null&&(d=0),f==null&&(f=o-1),it(e,t,o,n,s,a,R,i,g,M),e.viewport(0,0,k,k);const D=new Float32Array(k*k*4),N=new Float32Array(o*o*o),u=R/o,c=new Float32Array(o*o),_=x>1?new Float32Array(o*o):null,P=Math.min(o,512);(d>0||f<o-1)&&N.fill(1),x>1&&w("Z sub-slicing: "+x+" sub-samples per voxel layer (smooths Z-axis banding)","info");const B=f-d+1;let z=0;for(let F=d;F<=f;F++){if(No(e,t,o,k,D,c,F,x,_),N.set(c,F*o*o),V){const U=$o(c,o,u,P);V(U,P,P)}z++,p(l+Math.round(z/B*m)),E("SDF Sampling",Math.round(z/B*100)),z&3||(h("Sampling SDF... slice "+z+"/"+B),await y())}return N}function Jn(e,t,o,n,s,i,a,r,l){const m=a/l,x=new ImageData(l,l);for(let d=0;d<l;d++){const f=Math.round(d*m);for(let v=0;v<l;v++){const g=Math.round(v*m),M=(d*l+v)*4;if(g>=t&&g<n&&f>=o&&f<s){const p=((f-o)*i+(g-t))*4,E=e[p],h=Math.abs(E),y=h<r*2?Math.round(255*(1-h/(r*2))):0,w=E<0?50:0;x.data[M]=y+w,x.data[M+1]=E<0?30:y,x.data[M+2]=y}else x.data[M]=15,x.data[M+1]=15,x.data[M+2]=20;x.data[M+3]=255}}return x}async function Qn(e,t,o,n,s,i,a,r,l,m,x,d,f){const{setProgress:v,setPhase:g,setStatus:M,tick:p,onSlicePreview:E}=x,h=o.N,y=o.blockSize,w=Math.min(h,2048),V=r[0]-a[0];it(e,t,h,n,s,a,V,i,d,f),e.viewport(0,0,w,w);const k=new Map;qt(o,(P,B,z,F,U,I)=>{for(let C=0;C<y;C++){const L=I+C;if(L>=h)continue;let A=k.get(L);A||(A={entries:[],minX:F,minY:U,maxX:F+y,maxY:U+y},k.set(L,A)),A.entries.push({startX:F,startY:U}),F<A.minX&&(A.minX=F),U<A.minY&&(A.minY=U),F+y>A.maxX&&(A.maxX=F+y),U+y>A.maxY&&(A.maxY=U+y)}});const R=Array.from(k.keys()).sort((P,B)=>P-B);let D=0;for(let P=0;P<R.length;P++){const B=k.get(R[P]),z=Math.min(h,B.maxX)-Math.max(0,B.minX),F=Math.min(h,B.maxY)-Math.max(0,B.minY),U=z*F*4;U>D&&(D=U)}const N=new Float32Array(D),u=Math.min(h,512),c=V/h;let _=0;for(let P=0;P<R.length;P++){const B=R[P],z=k.get(B);e.uniform1f(t.loc.uZ,(B+.5)/h);const F=Math.max(0,z.minX),U=Math.max(0,z.minY),I=Math.min(h,z.maxX),C=Math.min(h,z.maxY),L=I-F,A=C-U;e.uniform2f(t.loc.uTileOffset,F,U),e.viewport(0,0,L,A),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,L,A,e.RGBA,e.FLOAT,N);const O=z.entries;for(let S=0;S<O.length;S++){const T=O[S];for(let G=0;G<y;G++){const H=T.startX+G;if(!(H<F||H>=I))for(let X=0;X<y;X++){const $=T.startY+X;if($<U||$>=C)continue;const j=(($-U)*L+(H-F))*4;o.set(H,$,B,N[j])}}}if(_++,!(_&7)){if(E){const S=Jn(N,F,U,I,C,L,h,c,u);E(S,u,u)}v(l+Math.round(_/R.length*m)),g("Fine SDF Sampling",Math.round(_/R.length*100)),M("Sampling fine SDF... slice "+_+"/"+R.length+" (narrow-band)"),await p()}}return o}async function Kn(e,t,o,n,s,i,a,r,l,m,x,d,f,v,g,M){const{log:p,setProgress:E,setPhase:h,setStatus:y,tick:w,onSlicePreview:V}=d,k=r[0]-a[0],R=k/n,D=8,N=n/D|0,u=Math.min(n,2048);(!x||x<1)&&(x=1);const c=await Vo(e,t,o,n,s,i,a,r,R,d,f,v,g),{zSliceMin:_,zSliceMax:P}=c,B=We(e,u,t,m||1,p,f,v);it(e,B,n,s,i,a,k,o,f,g);const z=new Float32Array(u*u*4),F=kn();let U=0;const I=new Array(D);for(let X=0;X<D;X++)I[X]=new Float32Array(n*n);const C=x>1?new Float32Array(n*n):null,L=Math.min(n,512),A=P-_+1;let O=0;x>1&&p("Z sub-slicing: "+x+" sub-samples per voxel layer (smooths Z-axis banding)","info");for(let X=_;X<=P;X++){const $=I[X%D];if(No(e,B,n,u,z,$,X,x,C),X%D===D-1){const j=X/D|0;for(let W=0;W<N;W++)for(let oe=0;oe<N;oe++){const ne=new Uint8Array(512);let Z=!1;for(let re=0;re<D;re++){const le=I[re];for(let ie=0;ie<D;ie++)for(let ce=0;ce<D;ce++){const J=oe*D+ce,q=W*D+ie,se=le[q*n+J],K=re|ie<<3|ce<<6;let ee;se<0?ee=255:ee=Math.round(Math.max(0,Math.min(255,255*(1-se/(R*2.5))))),ne[K]=ee,ee>0&&(Z=!0)}}Z&&(U+=jn(F,oe,W,j,ne))}}if(O++,!(O&7)){const j=Math.round(O/A*80);if(E(j),h("VDB Sampling",Math.round(O/A*100)),y("VDB sampling slice "+O+"/"+A+(_>0||P<n-1?" (Z "+_+"–"+P+")":"")),V){const W=$o(I[X%D],n,R,L);V(W,L,L)}await w()}}if(e.deleteTexture(B.tex),e.deleteFramebuffer(B.fbo),e.deleteProgram(B.prog),d.memAlloc){let X=0;F.n4map.forEach(j=>{X+=j.leafMap.size});const $=Math.round((X*1.1+F.n4map.size*10)/1024);d.memAlloc("vdbDensity","VDB Density",$,"#8c6")}let S=null;if(M){h("VDB Color",0),y("Sampling voxel colors..."),p("Color pass: sampling orbit-trap colors for active voxels","phase");let X=0;if(F.n4map.forEach($=>{$.leafMap.forEach(j=>{for(let W=0;W<8;W++){let oe=j.mask[W];for(;oe!==0n;)oe&=oe-1n,X++}})}),p("Color pass: "+X.toLocaleString()+" active voxels to colorize","data"),X>0){const $=Vn(),j=Math.min(e.getParameter(e.MAX_TEXTURE_SIZE),2048),W=j*j,oe=Ro({definition:t,interlace:f}),ne=rt(e,Je,oe,p),Z=Wt(e,ne),re=e.createVertexArray(),le=e.getUniformLocation(ne,"uPositions"),ie=e.getUniformLocation(ne,"uPower"),ce=e.getUniformLocation(ne,"uIters"),J=e.getUniformLocation(ne,"uWidth"),q=e.getUniformLocation(ne,"uJitterOffset"),se=[];F.n4map.forEach((ve,pe)=>{ve.leafMap.forEach((Ce,Ee)=>{se.push(pe,Ee)})});const K=se.length>>1,ee=Math.ceil(Math.sqrt(W)),Q=Math.ceil(W/ee),te=ee*Q,fe=new Float32Array(te*4),he=new Uint8Array(te*4),xe=new Uint16Array(W),Fe=new Uint32Array(W),Ae=new Uint8Array(512),Se=new Uint8Array(512),ue=new Uint8Array(512);let ge=0,Ie=0;for(;Ie<K;){let ve=0,pe=Ie;for(;pe<K&&ve+512<=W;){const Re=se[pe*2],je=se[pe*2+1],Ke=F.n4map.get(Re).leafMap.get(je),Mt=(Re>>10&31)<<7,Ft=(Re>>5&31)<<7,Et=(Re&31)<<7,Tt=(je>>8&15)<<3,Pt=(je>>4&15)<<3,At=(je&15)<<3,It=Mt+Tt,Rt=Ft+Pt,Dt=Et+At;for(let Te=0;Te<512;Te++){if((Ke.mask[Te>>6]&1n<<BigInt(Te&63))===0n)continue;const Ho=Te&7,Yo=Te>>3&7,qo=Te>>6&7;fe[ve*4]=a[0]+(It+qo+.5)*R,fe[ve*4+1]=a[1]+(Rt+Yo+.5)*R,fe[ve*4+2]=a[2]+(Dt+Ho+.5)*R,fe[ve*4+3]=1,xe[ve]=Te,Fe[ve]=pe,ve++}pe++}const Ce=ve;if(Ce===0){Ie=pe;continue}const Ee=Math.ceil(Math.sqrt(Ce)),Le=Math.ceil(Ce/Ee);e.useProgram(ne);const $e=e.createTexture();e.bindTexture(e.TEXTURE_2D,$e),e.texImage2D(e.TEXTURE_2D,0,e.RGBA32F,Ee,Le,0,e.RGBA,e.FLOAT,fe.subarray(0,Ee*Le*4)),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE);const Ge=e.createTexture();e.bindTexture(e.TEXTURE_2D,Ge),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA8,Ee,Le);const Qe=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,Qe),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,Ge,0),e.viewport(0,0,Ee,Le),e.bindVertexArray(re),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,$e),e.uniform1i(le,0),e.uniform1f(ie,s),e.uniform1i(ce,i),e.uniform1i(J,Ee),e.uniform3f(q,0,0,0),at(e,Z,o),st(e,Z,f),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,Ee,Le,e.RGBA,e.UNSIGNED_BYTE,he),e.deleteTexture($e),e.deleteTexture(Ge),e.deleteFramebuffer(Qe);let _e=0;for(let Re=Ie;Re<pe;Re++){if(_e>=Ce||Fe[_e]!==Re)continue;const je=se[Re*2],Ke=se[Re*2+1],Mt=(je>>10&31)<<7,Ft=(je>>5&31)<<7,Et=(je&31)<<7,Tt=(Ke>>8&15)<<3,Pt=(Ke>>4&15)<<3,At=(Ke&15)<<3,It=Mt+Tt>>3,Rt=Ft+Pt>>3,Dt=Et+At>>3;for(Ae.fill(0),Se.fill(0),ue.fill(0);_e<Ce&&Fe[_e]===Re;){const Te=xe[_e];Ae[Te]=he[_e*4],Se[Te]=he[_e*4+1],ue[Te]=he[_e*4+2],_e++}$n($,It,Rt,Dt,Ae,Se,ue)}ge+=Ce,Ie=pe;const Qt=Math.round(ge/X*100);E(80+Math.round(Qt*.12)),h("VDB Color",Qt),y("Color pass: "+ge.toLocaleString()+"/"+X.toLocaleString()+" voxels"),await w()}if(e.deleteProgram(ne),e.deleteVertexArray(re),Gn($),S=$,d.memAlloc){let ve=0;$.n4map.forEach(Ce=>{ve+=Ce.leafMap.size});const pe=Math.round((ve*6.2+$.n4map.size*60)/1024);d.memAlloc("vdbColor","VDB Color",pe,"#e6a")}p("Color pass complete: Cd vec3s grid built","success")}h("VDB Color",100),await w()}E(92),h("VDB Optimize",0),y("Optimizing VDB tree...");const T=Un(F);E(95),h("VDB Serialize",50),y("Serializing VDB..."),await w();let G=0;F.n4map.forEach(X=>{G+=X.leafMap.size});let H;if(S?H=Zn(F,S,n,a,k):H=qn(F,n,a,k),d.memFree&&(d.memFree("vdbDensity"),S&&d.memFree("vdbColor")),d.memAlloc){const X=Math.round(H.byteLength/1048576);d.memAlloc("vdbBlob","VDB File",X,"#5af")}return E(100),h("VDB Complete",100),{blob:new Blob([H.buffer.slice(H.byteOffset,H.byteOffset+H.byteLength)],{type:"application/octet-stream"}),voxelCount:U,leafCount:G,promoted:T,zRange:[_,P],skippedSlices:n-A}}async function ea(e,t,o,n,s,i,a,r,l,m,x){const{log:d,tick:f}=l,v=t.N,g=t.blockSize,M=t.blocksPerAxis,p=Math.min(v,2048),E=r[0]-a[0],h=t.blockCellCount+7>>3,y=pn({definition:o,interlace:x}),w=rt(e,Je,y,d);e.useProgram(w);const V=["uZ","uPower","uIters","uInvRes","uTileOffset","uBoundsMin","uBoundsRange",...Ye],k={};for(let z=0;z<V.length;z++)k[V[z]]=e.getUniformLocation(w,V[z]);const R=e.createTexture();e.bindTexture(e.TEXTURE_2D,R),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,p,p);const D=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,D),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,R,0),e.uniform1f(k.uPower,n),e.uniform1i(k.uIters,s),e.uniform1f(k.uInvRes,1/v),e.uniform3f(k.uBoundsMin,a[0],a[1],a[2]),e.uniform1f(k.uBoundsRange,E),at(e,k,i),st(e,k,x),e.bindVertexArray(e.createVertexArray());const N=new Map;qt(t,(z,F,U,I,C,L)=>{for(let A=0;A<g;A++){const O=L+A;if(O>=v)continue;let S=N.get(O);S||(S={entries:[],minX:I,minY:C,maxX:I+g,maxY:C+g},N.set(O,S)),S.entries.push({startX:I,startY:C}),I<S.minX&&(S.minX=I),C<S.minY&&(S.minY=C),I+g>S.maxX&&(S.maxX=I+g),C+g>S.maxY&&(S.maxY=C+g)}});const u=Array.from(N.keys()).sort((z,F)=>z-F);let c=0;for(let z=0;z<u.length;z++){const F=N.get(u[z]),U=Math.min(v,F.maxX)-Math.max(0,F.minX),I=Math.min(v,F.maxY)-Math.max(0,F.minY);U*I*4>c&&(c=U*I*4)}const _=new Float32Array(c),P=new Map;t.blocks.forEach((z,F)=>{P.set(F,new Uint8Array(h))});let B=0;for(let z=0;z<u.length;z++){const F=u[z],U=N.get(F);e.uniform1f(k.uZ,(F+.5)/v);const I=Math.max(0,U.minX),C=Math.max(0,U.minY),L=Math.min(v,U.maxX),A=Math.min(v,U.maxY),O=L-I,S=A-C;e.uniform2f(k.uTileOffset,I,C),e.viewport(0,0,O,S),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,O,S,e.RGBA,e.FLOAT,_);const T=U.entries;for(let G=0;G<T.length;G++){const H=T[G],X=H.startX/g|0,$=H.startY/g|0,j=F/g|0,W=(j*M+$)*M+X,oe=P.get(W);if(!oe)continue;const ne=F-j*g;for(let Z=0;Z<g;Z++){const re=H.startX+Z;if(!(re<I||re>=L))for(let le=0;le<g;le++){const ie=H.startY+le;if(ie<C||ie>=A)continue;const ce=((ie-C)*O+(re-I))*4;if(_[ce]>.5){const J=(ne*g+le)*g+Z;oe[J>>3]|=1<<(J&7),B++}}}}!(z&7)&&m&&(m(Math.round(z/u.length*100)),await f())}return e.deleteTexture(R),e.deleteFramebuffer(D),e.deleteProgram(w),{escapeMap:P,solidCount:B}}function ta(e,t,o,n,s,i,a,r,l,m){r||(r=6);const x=t.vertexCount,d=Math.ceil(Math.sqrt(x)),f=Math.ceil(x/d),v=new Float32Array(d*f*4);for(let R=0;R<x;R++)v[R*4]=t.positions[R*3],v[R*4+1]=t.positions[R*3+1],v[R*4+2]=t.positions[R*3+2],v[R*4+3]=1;const g=e.createTexture();e.bindTexture(e.TEXTURE_2D,g),e.texImage2D(e.TEXTURE_2D,0,e.RGBA32F,d,f,0,e.RGBA,e.FLOAT,v),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE);const M=e.createTexture();e.bindTexture(e.TEXTURE_2D,M),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,d,f);const p=e.createTexture();e.bindTexture(e.TEXTURE_2D,p),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,d,f);const E=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,E),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,M,0),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT1,e.TEXTURE_2D,p,0),e.drawBuffers([e.COLOR_ATTACHMENT0,e.COLOR_ATTACHMENT1]);const h=xn({definition:o,deType:"auto",interlace:m}),y=rt(e,Je,h,l);e.useProgram(y),e.viewport(0,0,d,f),e.bindVertexArray(e.createVertexArray()),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,g),e.uniform1i(e.getUniformLocation(y,"uPositions"),0),e.uniform1f(e.getUniformLocation(y,"uPower"),s),e.uniform1i(e.getUniformLocation(y,"uIters"),i),e.uniform1f(e.getUniformLocation(y,"uVoxelSize"),a),e.uniform1i(e.getUniformLocation(y,"uNewtonSteps"),r);const w=Wt(e,y);at(e,w,n),st(e,w,m),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readBuffer(e.COLOR_ATTACHMENT0);const V=new Float32Array(d*f*4);e.readPixels(0,0,d,f,e.RGBA,e.FLOAT,V),e.readBuffer(e.COLOR_ATTACHMENT1);const k=new Float32Array(d*f*4);e.readPixels(0,0,d,f,e.RGBA,e.FLOAT,k);for(let R=0;R<x;R++)t.positions[R*3]=V[R*4],t.positions[R*3+1]=V[R*4+1],t.positions[R*3+2]=V[R*4+2],t.normals[R*3]=k[R*4],t.normals[R*3+1]=k[R*4+1],t.normals[R*3+2]=k[R*4+2];return e.deleteTexture(g),e.deleteTexture(M),e.deleteTexture(p),e.deleteFramebuffer(E),e.deleteProgram(y),t}async function oa(e,t,o,n,s,i,a,r,l,m){const{log:x,setProgress:d,setPhase:f,setStatus:v,tick:g}=l;(!a||a<1)&&(a=1),r||(r=0);const M=t.vertexCount,p=Math.ceil(Math.sqrt(M)),E=Math.ceil(M/p);x("Color texture: "+p+"x"+E+" ("+(p*E*16/(1024*1024)).toFixed(0)+" MB position data)"+(a>1?" | "+a+" samples, radius="+r.toFixed(5):""),"mem");let h=new Float32Array(p*E*4);for(let _=0;_<M;_++)h[_*4]=t.positions[_*3],h[_*4+1]=t.positions[_*3+1],h[_*4+2]=t.positions[_*3+2],h[_*4+3]=1;const y=Ro({definition:o,interlace:m}),w=rt(e,Je,y,x);e.useProgram(w);const V=e.createTexture();e.bindTexture(e.TEXTURE_2D,V),e.texImage2D(e.TEXTURE_2D,0,e.RGBA32F,p,E,0,e.RGBA,e.FLOAT,h),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),h=null;const k=a>1,R=e.createTexture();e.bindTexture(e.TEXTURE_2D,R),e.texStorage2D(e.TEXTURE_2D,1,k?e.RGBA32F:e.RGBA8,p,E);const D=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,D),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,R,0),e.viewport(0,0,p,E),e.bindVertexArray(e.createVertexArray());const N=Wt(e,w),u=e.getUniformLocation(w,"uJitterOffset");if(e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,V),e.uniform1i(e.getUniformLocation(w,"uPositions"),0),e.uniform1f(e.getUniformLocation(w,"uPower"),s),e.uniform1i(e.getUniformLocation(w,"uIters"),i),e.uniform1i(e.getUniformLocation(w,"uWidth"),p),at(e,N,n),st(e,N,m),a<=1)e.uniform3f(u,0,0,0),e.drawArrays(e.TRIANGLE_STRIP,0,4);else{e.clearColor(0,0,0,0),e.clear(e.COLOR_BUFFER_BIT),e.enable(e.BLEND),e.blendFunc(e.ONE,e.ONE);const _=Math.PI*(3-Math.sqrt(5));for(let P=0;P<a;P++){const B=Math.acos(1-2*(P+.5)/a),z=_*P,F=r*Math.cbrt((P+.5)/a),U=F*Math.sin(B)*Math.cos(z),I=F*Math.sin(B)*Math.sin(z),C=F*Math.cos(B);if(e.uniform3f(u,U,I,C),e.drawArrays(e.TRIANGLE_STRIP,0,4),!(P&3)||P===a-1){const L=Math.round((P+1)/a*100);d(80+Math.round((P+1)/a*10)),f("Phase 5: Vertex Coloring",L),v("Color sample "+(P+1)+"/"+a),await g()}}e.disable(e.BLEND)}const c=new Uint8Array(M*4);if(k){const _=new Float32Array(p*E*4);e.readPixels(0,0,p,E,e.RGBA,e.FLOAT,_);const P=1/a;for(let B=0;B<M;B++)c[B*4]=Math.min(255,Math.round(_[B*4]*P*255)),c[B*4+1]=Math.min(255,Math.round(_[B*4+1]*P*255)),c[B*4+2]=Math.min(255,Math.round(_[B*4+2]*P*255)),c[B*4+3]=255}else{const _=new Uint8Array(p*E*4);e.readPixels(0,0,p,E,e.RGBA,e.UNSIGNED_BYTE,_);for(let P=0;P<M;P++)c[P*4]=_[P*4],c[P*4+1]=_[P*4+1],c[P*4+2]=_[P*4+2],c[P*4+3]=255}return e.deleteTexture(V),e.deleteTexture(R),e.deleteFramebuffer(D),e.deleteProgram(w),c}async function na(e,t,o,n,s,i,a){var g;const r=vt(),l=64,m=6,x=[-m/2,-m/2,-m/2],d=m,f=d/l,v=a??0;try{const M=We(r,l,e,1,()=>{},s,i);it(r,M,l,n,o,x,d,t,s,v),r.viewport(0,0,l,l);const p=new Float32Array(l*l*4);let E=1/0,h=1/0,y=1/0,w=-1/0,V=-1/0,k=-1/0,R=!1;for(let P=0;P<l;P++){r.uniform1f(M.loc.uZ,(P+.5)/l),r.uniform2f(M.loc.uTileOffset,0,0),r.drawArrays(r.TRIANGLE_STRIP,0,4),r.readPixels(0,0,l,l,r.RGBA,r.FLOAT,p);const B=x[2]+(P+.5)*f;for(let z=0;z<l;z++)for(let F=0;F<l;F++)if(p[(z*l+F)*4]<f*2){const I=x[0]+(F+.5)*f,C=x[1]+(z+.5)*f;I<E&&(E=I),I>w&&(w=I),C<h&&(h=C),C>V&&(V=C),B<y&&(y=B),B>k&&(k=B),R=!0}}if(r.deleteTexture(M.tex),r.deleteFramebuffer(M.fbo),r.deleteProgram(M.prog),!R)return null;const D=.15,N=(w-E)*(1+D),u=(V-h)*(1+D),c=(k-y)*(1+D),_=Math.max(N,u,c,.5);return{center:[(E+w)/2,(h+V)/2,(y+k)/2],size:[_,_,_]}}finally{(g=r.getExtension("WEBGL_lose_context"))==null||g.loseContext()}}function aa(){const e=Y(d=>d.bboxCenter),t=Y(d=>d.bboxSize),o=Y(d=>d.setBboxCenter),n=Y(d=>d.setBboxSize),s=Y(d=>d.resetBounds),[i,a]=de.useState(!1),r=d=>{o([d.x,d.y,d.z??0])},l=de.useMemo(()=>new Ne(t[0],t[1],t[2]),[t[0],t[1],t[2]]),m=de.useCallback(d=>{n([d.x,d.y,d.z])},[n]),x=async()=>{const d=Y.getState(),f=d.loadedDefinition||Oe.get(d.selectedFormulaId);if(f){a(!0);try{let v;d.interlaceState&&(v={definition:d.interlaceState.definition,params:d.interlaceState.params,enabled:d.interlaceState.enabled,interval:d.interlaceState.interval,startIter:d.interlaceState.startIter});const g=d.qualitySettings,M={estimator:g.estimator,distanceMetric:g.distanceMetric},p=await na(f,d.formulaParams,d.iters,d.formulaParams.paramA||8,v,M,g.surfaceThreshold);p&&(o(p.center),n(p.size))}catch(v){console.error("Auto-fit failed:",v)}finally{a(!1)}}};return b.jsxs("div",{className:"flex flex-col gap-px mt-1",children:[b.jsx(Ut,{label:"Center",value:{x:e[0],y:e[1],z:e[2]},onChange:r,axisConfig:{min:-100,max:100,step:.1},showDualAxisPads:!1}),b.jsx(an,{label:"Size",value:l,onChange:m,min:.1,max:100,step:.1,showDualAxisPads:!1,linkable:!0}),b.jsxs("div",{className:"flex items-center gap-2 mt-1 px-0.5",children:[b.jsx("button",{onClick:s,className:"text-[10px] px-2 py-0.5 bg-white/10 text-gray-300 border border-white/10 rounded-sm hover:bg-white/15 cursor-pointer",children:"Reset"}),b.jsx("button",{onClick:x,disabled:i,className:"text-[10px] px-2 py-0.5 bg-emerald-900/40 text-emerald-300 border border-emerald-700/30 rounded-sm hover:bg-emerald-800/40 cursor-pointer disabled:opacity-50 disabled:cursor-default",children:i?"Fitting...":"Auto-fit"}),b.jsxs("span",{className:"text-[10px] text-gray-600",children:[t[0].toFixed(1)," × ",t[1].toFixed(1)," × ",t[2].toFixed(1)]})]})]})}const uo={info:"text-gray-400",phase:"text-emerald-400 font-bold",data:"text-sky-400",warn:"text-amber-400",error:"text-red-400 font-bold",success:"text-emerald-400",mem:"text-pink-300"},sa=()=>{const e=Y(h=>h.status),t=Y(h=>h.progress),o=Y(h=>h.phaseName),n=Y(h=>h.phaseProgress),s=Y(h=>h.memoryBlocks),i=Y(h=>h.logEntries),a=Y(h=>h.clearLog),r=Y(h=>h.lastMesh),l=Y(h=>h.lastTimings),m=Y(h=>h.smoothingSkipped),x=Y(h=>h.useNarrowBand),d=Y(h=>h.resolution),f=Y(h=>h.newton),v=Y(h=>h.isRunning),g=de.useRef(null);de.useEffect(()=>{var h;(h=g.current)==null||h.scrollIntoView({behavior:"smooth"})},[i.length]);const M=s.reduce((h,y)=>h+(y.freed?0:y.mb),0),p=Math.max(1,...s.map(h=>h.mb)),E=()=>{const h=i.map(y=>`[${y.time}] ${y.msg}`).join(`
`);navigator.clipboard.writeText(h).catch(()=>{})};return b.jsxs("div",{className:"font-mono flex flex-col gap-2",children:[e&&b.jsx("div",{className:"text-[13px] text-amber-400 font-bold",children:e}),b.jsx("div",{className:"h-1 bg-gray-800 rounded overflow-hidden",children:b.jsx("div",{className:"h-full bg-gradient-to-r from-emerald-700 to-emerald-400 transition-[width] duration-300",style:{width:`${Math.min(100,Math.max(0,t))}%`}})}),o&&b.jsx("div",{className:"text-[11px] text-gray-500",children:o}),b.jsx("div",{className:"h-[3px] bg-gray-800 rounded overflow-hidden",children:b.jsx("div",{className:"h-full bg-gradient-to-r from-sky-700 to-sky-400 transition-[width] duration-300",style:{width:`${Math.min(100,Math.max(0,n))}%`}})}),r&&l&&!v&&b.jsxs("div",{className:"text-[11px] leading-relaxed bg-black/40 border border-white/10 rounded px-2 py-1.5",children:[b.jsxs("span",{className:"text-emerald-400",children:[d,"³ · ",r.vertexCount.toLocaleString()," vertices · ",r.faceCount.toLocaleString()," faces"]})," · ",b.jsxs("span",{className:"text-sky-400",children:[Math.round((r.positions.byteLength+r.normals.byteLength+r.indices.byteLength)/(1024*1024))," MB mesh"]}),f&&b.jsx("span",{className:"text-gray-400",children:" · Newton projected"}),m&&b.jsx("span",{className:"text-amber-400",children:" · smoothing skipped (>5M verts)"}),b.jsx("br",{}),b.jsxs("span",{className:"text-gray-500",children:[x?`Coarse: ${(l.coarse/1e3).toFixed(1)}s · Fine: ${(l.fine/1e3).toFixed(1)}s`:`SDF: ${(l.sdf/1e3).toFixed(1)}s`," · ","DC: ",(l.dc/1e3).toFixed(1),"s",l.newton>100&&` · Newton: ${(l.newton/1e3).toFixed(1)}s`," · ","Post: ",(l.post/1e3).toFixed(1),"s"," · ","Color: ",(l.color/1e3).toFixed(1),"s"," · ","Total: ",(l.total/1e3).toFixed(1),"s"]})]}),s.length>0&&b.jsxs("div",{children:[b.jsx("div",{className:"flex gap-px h-[18px] rounded overflow-hidden",children:s.map(h=>b.jsx("div",{title:`${h.label}: ${h.mb} MB${h.freed?" (freed)":""}`,className:"flex items-center justify-center text-[9px] text-black font-bold overflow-hidden whitespace-nowrap rounded-sm transition-opacity",style:{flex:Math.max(h.mb/p,.08),background:h.color,opacity:h.freed?.25:1},children:h.label},h.id))}),b.jsxs("div",{className:"text-[10px] text-gray-600 mt-0.5",children:["Memory: ",M," MB active"]})]}),i.length>0&&b.jsxs("div",{children:[b.jsxs("div",{className:"max-h-[200px] overflow-y-auto bg-black/80 border border-white/10 rounded p-1.5 text-[11px] leading-relaxed",children:[i.map((h,y)=>b.jsxs("div",{className:uo[h.type]||uo.info,children:[b.jsx("span",{className:"text-gray-600",children:h.time})," ",h.msg]},y)),b.jsx("div",{ref:g})]}),b.jsxs("div",{className:"flex gap-1.5 mt-1",children:[b.jsx("button",{onClick:E,className:"text-[10px] px-2 py-0.5 bg-white/10 text-gray-400 border border-white/10 rounded-sm hover:bg-white/15 cursor-pointer",children:"Copy"}),b.jsx("button",{onClick:a,className:"text-[10px] px-2 py-0.5 bg-white/10 text-gray-400 border border-white/10 rounded-sm hover:bg-white/15 cursor-pointer",children:"Clear"})]})]})]})};function ra(e,t,o){let n=0;for(let s=0;s<e.length;s++)e[s]<-o&&(e[s]=o,n++);return n}function ia(e,t){let o=0;return e.blocks.forEach(n=>{for(let s=0;s<n.length;s++)n[s]<-t&&(n[s]=t,o++)}),o}function fo(e,t,o,n,s){const i=new Float32Array(e.length);for(let r=0;r<o;r++)for(let l=0;l<o;l++){const m=r*o*o+l*o;for(let x=0;x<o;x++){let d=e[m+x];for(let f=-n;f<=n;f++){const v=x+f;v>=0&&v<o&&(d=s(d,e[m+v]))}i[m+x]=d}}const a=new Float32Array(e.length);for(let r=0;r<o;r++)for(let l=0;l<o;l++)for(let m=0;m<o;m++){const x=r*o*o+m*o+l;let d=i[x];for(let f=-n;f<=n;f++){const v=m+f;v>=0&&v<o&&(d=s(d,i[r*o*o+v*o+l]))}a[x]=d}for(let r=0;r<o;r++)for(let l=0;l<o;l++)for(let m=0;m<o;m++){const x=m*o*o+r*o+l;let d=a[x];for(let f=-n;f<=n;f++){const v=m+f;v>=0&&v<o&&(d=s(d,a[v*o*o+r*o+l]))}t[x]=d}}async function la(e,t,o,n){const s=n||(()=>{});if(o<=0)return;const i=Math.round(o),a=t*t*t,r=new Float32Array(a);s(0),fo(e,r,t,i,Math.min),s(25),await new Promise(l=>{setTimeout(l,0)}),fo(r,e,t,i,Math.max),s(50)}async function ca(e,t,o){const n=o||(()=>{});if(t<=0)return;const s=Math.round(t);e.N;const i=e.blockSize;for(let a=0;a<2;a++){const r=a===0?Math.min:Math.max,l=new Map;e.blocks.forEach((m,x)=>{const d=new Float32Array(m.length),f=e.blocksPerAxis,v=x%f,g=(x/f|0)%f,M=x/(f*f)|0,p=v*i,E=g*i,h=M*i;for(let y=0;y<i;y++)for(let w=0;w<i;w++)for(let V=0;V<i;V++){let k=m[(y*i+w)*i+V];for(let R=-s;R<=s;R++)for(let D=-s;D<=s;D++)for(let N=-s;N<=s;N++){const u=p+V+N,c=E+w+D,_=h+y+R;k=r(k,e.get(u,c,_))}d[(y*i+w)*i+V]=k}l.set(x,d)}),l.forEach((m,x)=>{e.blocks.set(x,m)}),n(a===0?50:100),await new Promise(m=>{setTimeout(m,0)})}}async function ua(e,t,o,n){const s=o||(()=>{}),i=n||(()=>{}),a=t*t*t,r=a+7>>3,l=new Uint8Array(r),m=(D,N,u)=>(u*t+N)*t+D,x=D=>(l[D>>3]&1<<(D&7))!==0,d=D=>{l[D>>3]|=1<<(D&7)};let f=Math.min(a,4*1024*1024),v=new Int32Array(f),g=0,M=0,p=0;const E=D=>{if(p>=f){const N=f*2,u=new Int32Array(N);for(let c=0;c<p;c++)u[c]=v[(g+c)%f];v=u,g=0,M=p,f=N}v[M]=D,M=(M+1)%f,p++},h=()=>{const D=v[g];return g=(g+1)%f,p--,D};for(let D=0;D<t;D++)for(let N=0;N<t;N++)for(let u=0;u<t;u++)if(u===0||u===t-1||N===0||N===t-1||D===0||D===t-1){const c=m(u,N,D);e[c]>=0&&!x(c)&&(d(c),E(c))}s(5);let y=0;const w=[-1,1,0,0,0,0],V=[0,0,-1,1,0,0],k=[0,0,0,0,-1,1];for(;p>0;){const D=h(),N=D%t,u=(D/t|0)%t,c=D/(t*t)|0;for(let _=0;_<6;_++){const P=N+w[_],B=u+V[_],z=c+k[_];if(P<0||B<0||z<0||P>=t||B>=t||z>=t)continue;const F=m(P,B,z);x(F)||e[F]>=0&&(d(F),E(F))}y++,y&1048575||(s(5+Math.round(85*y/a)),await new Promise(_=>{setTimeout(_,0)}),i())}let R=0;for(let D=0;D<a;D++)e[D]>=0&&!x(D)&&(e[D]=-Math.abs(e[D])-.001,R++);return s(100),R}async function fa(e,t,o,n){const s=o||(()=>{}),i=n||(()=>{}),a=e.N,r=e.blockSize,l=e.blocksPerAxis,m=e.blockCellCount+7>>3;function x(L,A,O,S){if(A<0||O<0||S<0||A>=a||O>=a||S>=a)return!1;const T=A/r|0,G=O/r|0,H=S/r|0,X=(H*l+G)*l+T,$=L.get(X);if(!$)return!1;const j=A-T*r,W=O-G*r,ne=((S-H*r)*r+W)*r+j;return($[ne>>3]&1<<(ne&7))!==0}function d(L,A,O,S){const T=A/r|0,G=O/r|0,H=S/r|0,X=(H*l+G)*l+T,$=L.get(X);if(!$)return;const j=A-T*r,W=O-G*r,ne=((S-H*r)*r+W)*r+j;$[ne>>3]|=1<<(ne&7)}let f=2*1024*1024,v=new Int32Array(f),g=new Uint8Array(f),M=0,p=0;function E(){const L=p-M,A=f*2,O=new Int32Array(A),S=new Uint8Array(A);for(let T=0;T<L;T++)O[T]=v[(M+T)%f],S[T]=g[(M+T)%f];v=O,g=S,M=0,p=L,f=A}function h(L,A){p-M>=f-1&&E(),v[p%f]=L,g[p%f]=A,p++}function y(){const L=v[M%f],A=g[M%f];return M++,{coord:L,dist:A}}let w=2*1024*1024,V=new Int32Array(w),k=0,R=0;function D(){const L=R-k,A=w*2,O=new Int32Array(A);for(let S=0;S<L;S++)O[S]=V[(k+S)%w];V=O,k=0,R=L,w=A}function N(L){R-k>=w-1&&D(),V[R++%w]=L}function u(){return V[k++%w]}const c=new Map;e.blocks.forEach((L,A)=>{const O=new Uint8Array(m);for(let S=0;S<L.length;S++)L[S]<0&&(O[S>>3]|=1<<(S&7));c.set(A,O)});let _=0;e.blocks.forEach((L,A)=>{const O=A%l,S=(A/l|0)%l,T=A/(l*l)|0,G=O*r,H=S*r,X=T*r;for(let $=0;$<r;$++)for(let j=0;j<r;j++)for(let W=0;W<r;W++){const oe=($*r+j)*r+W;if(L[oe]<0)continue;const ne=G+W,Z=H+j,re=X+$;let le=!1;for(let ie=0;ie<6&&!le;ie++){const ce=ne+(ie===0?-1:ie===1?1:0),J=Z+(ie===2?-1:ie===3?1:0),q=re+(ie===4?-1:ie===5?1:0);e.get(ce,J,q)<0&&(le=!0)}le&&(d(c,ne,Z,re),h((re*a+Z)*a+ne,1),_++)}}),console.log("[CavityFill] Dilate by "+t+": "+_+" surface seeds"),s(5);let P=0,B=0;for(;M<p;){const L=y(),A=L.coord,O=L.dist,S=A%a,T=(A/a|0)%a,G=A/(a*a)|0;for(let H=0;H<6;H++){const X=S+(H===0?-1:H===1?1:0),$=T+(H===2?-1:H===3?1:0),j=G+(H===4?-1:H===5?1:0);X<0||$<0||j<0||X>=a||$>=a||j>=a||x(c,X,$,j)||(d(c,X,$,j),P++,O+1<t&&h((j*a+$)*a+X,O+1))}++B&262143||(s(5+Math.round(20*Math.min(1,P/(_*t+1)))),await new Promise(H=>{setTimeout(H,0)}),i())}console.log("[CavityFill] Dilate done: "+P+" cells expanded"),s(30);const z=new Map;e.blocks.forEach((L,A)=>{z.set(A,new Uint8Array(m))}),e.blocks.forEach((L,A)=>{const O=c.get(A),S=A%l,T=(A/l|0)%l,G=A/(l*l)|0,H=S*r,X=T*r,$=G*r;for(let j=0;j<r;j++)for(let W=0;W<r;W++)for(let oe=0;oe<r;oe++){const ne=(j*r+W)*r+oe;if(O[ne>>3]&1<<(ne&7))continue;const Z=H+oe,re=X+W,le=$+j;let ie=!1;if(Z===0||Z===a-1||re===0||re===a-1||le===0||le===a-1)ie=!0;else if(oe===0||oe===r-1||W===0||W===r-1||j===0||j===r-1)for(let ce=0;ce<6&&!ie;ce++){const J=Z+(ce===0?-1:ce===1?1:0),q=re+(ce===2?-1:ce===3?1:0),se=le+(ce===4?-1:ce===5?1:0),K=J/r|0,ee=q/r|0,Q=se/r|0;e.hasBlock(K,ee,Q)||(ie=!0)}if(ie){const ce=z.get(A);ce[ne>>3]|=1<<(ne&7),N((le*a+re)*a+Z)}}}),console.log("[CavityFill] Flood fill: "+R+" boundary seeds"),s(40);let U=0,I=0;for(;k<R;){const L=u(),A=L%a,O=(L/a|0)%a,S=L/(a*a)|0;for(let T=0;T<6;T++){const G=A+(T===0?-1:T===1?1:0),H=O+(T===2?-1:T===3?1:0),X=S+(T===4?-1:T===5?1:0);if(G<0||H<0||X<0||G>=a||H>=a||X>=a)continue;const $=G/r|0,j=H/r|0,W=X/r|0,oe=(W*l+j)*l+$,ne=G-$*r,Z=H-j*r,le=((X-W*r)*r+Z)*r+ne,ie=z.get(oe);ie&&(ie[le>>3]&1<<(le&7)||x(c,G,H,X)||(ie[le>>3]|=1<<(le&7),N((X*a+H)*a+G),U++))}++I&262143||(s(40+Math.round(40*U/(U+(R-k)+1))),await new Promise(T=>{setTimeout(T,0)}),i())}console.log("[CavityFill] Flood done: "+U+" cells reached"),s(85);let C=0;return e.blocks.forEach((L,A)=>{const O=z.get(A);for(let S=0;S<L.length;S++)L[S]>=0&&!(O[S>>3]&1<<(S&7))&&(L[S]=-Math.abs(L[S])-.001,C++)}),s(100),console.log("[CavityFill] Filled: "+C+" cavity cells"),{filled:C,dilated:P,seeds:_}}function da(e,t){const o=new Array(t);for(let s=0;s<t;s++)o[s]=new Set;for(let s=0,i=e.length;s<i;s+=3){const a=e[s],r=e[s+1],l=e[s+2];o[a].add(r),o[a].add(l),o[r].add(a),o[r].add(l),o[l].add(a),o[l].add(r)}const n=new Array(t);for(let s=0;s<t;s++){const i=o[s],a=new Uint32Array(i.size);let r=0;for(const l of i)a[r++]=l;n[s]=a}return n}function mo(e,t,o,n){const s=t.length;n.set(e);for(let i=0;i<s;i++){const a=t[i],r=a.length;if(r===0)continue;const l=i*3,m=n[l],x=n[l+1],d=n[l+2];let f=0,v=0,g=0;for(let p=0;p<r;p++){const E=a[p]*3;f+=n[E]-m,v+=n[E+1]-x,g+=n[E+2]-d}const M=o/r;e[l]=m+f*M,e[l+1]=x+v*M,e[l+2]=d+g*M}}function ma(e,t=.5,o=-.53,n=5){const s=da(e.indices,e.vertexCount),i=new Float32Array(e.positions.length);for(let a=0;a<n;a++)mo(e.positions,s,t,i),mo(e.positions,s,o,i);return e}function ha(e){const t=e.positions,o=e.indices,n=e.faceCount,s=[];for(let i=0;i<n;i++){const a=i*3,r=o[a]*3,l=o[a+1]*3,m=o[a+2]*3,x=t[l]-t[r],d=t[l+1]-t[r+1],f=t[l+2]-t[r+2],v=t[m]-t[r],g=t[m+1]-t[r+1],M=t[m+2]-t[r+2],p=d*M-f*g,E=f*v-x*M,h=x*g-d*v;p*p+E*E+h*h>=1e-20&&s.push(o[a],o[a+1],o[a+2])}return{positions:e.positions,normals:e.normals,indices:new Uint32Array(s),vertexCount:e.vertexCount,faceCount:s.length/3}}function pa(e){const t=e.positions,o=e.indices,n=e.normals,s=e.vertexCount,i=e.faceCount;for(let a=0;a<s*3;a++)n[a]=0;for(let a=0;a<i;a++){const r=a*3,l=o[r],m=o[r+1],x=o[r+2],d=l*3,f=m*3,v=x*3,g=t[f]-t[d],M=t[f+1]-t[d+1],p=t[f+2]-t[d+2],E=t[v]-t[d],h=t[v+1]-t[d+1],y=t[v+2]-t[d+2],w=M*y-p*h,V=p*E-g*y,k=g*h-M*E;n[d]+=w,n[d+1]+=V,n[d+2]+=k,n[f]+=w,n[f+1]+=V,n[f+2]+=k,n[v]+=w,n[v+1]+=V,n[v+2]+=k}for(let a=0;a<s;a++){const r=a*3,l=n[r],m=n[r+1],x=n[r+2],d=Math.sqrt(l*l+m*m+x*x);if(d>1e-12){const f=1/d;n[r]*=f,n[r+1]*=f,n[r+2]*=f}}return e}function xa(e,t){const o=t??{},n=o.smoothing??!0,s=o.smoothIterations??5,i=o.lambda??.5,a=o.mu??-(i+.03);return e.faceCount<5e6&&(e=ha(e)),n&&s>0&&(e.vertexCount>5e6?console.warn("Skipping smoothing: "+e.vertexCount.toLocaleString()+" vertices too large (>5M limit)"):e=ma(e,i,a,s)),e=pa(e),e}class va{constructor(t){ae(this,"_buf");ae(this,"_view");ae(this,"_u8");ae(this,"_pos");t||(t=1024*1024),this._buf=new ArrayBuffer(t),this._view=new DataView(this._buf),this._u8=new Uint8Array(this._buf),this._pos=0}get pos(){return this._pos}set pos(t){this._pos=t}_grow(t){const o=this._pos+t;if(o<=this._buf.byteLength)return;let n=this._buf.byteLength;for(;n<o;)n*=2;const s=new ArrayBuffer(n);new Uint8Array(s).set(this._u8),this._buf=s,this._view=new DataView(this._buf),this._u8=new Uint8Array(this._buf)}u8(t){this._grow(1),this._view.setUint8(this._pos,t),this._pos+=1}u16(t){this._grow(2),this._view.setUint16(this._pos,t,!0),this._pos+=2}u32(t){this._grow(4),this._view.setUint32(this._pos,t,!0),this._pos+=4}i32(t){this._grow(4),this._view.setInt32(this._pos,t,!0),this._pos+=4}f32(t){this._grow(4),this._view.setFloat32(this._pos,t,!0),this._pos+=4}raw(t){const o=t.length;this._grow(o),this._u8.set(t,this._pos),this._pos+=o}str(t){const o=t.length;this._grow(o);for(let n=0;n<o;n++)this._u8[this._pos++]=t.charCodeAt(n)&127}strNull(t){this.str(t),this.u8(0)}pad(t){this.padWith(t,0)}padWith(t,o){const n=this._pos%t;if(n===0)return;const s=t-n;this._grow(s);for(let i=0;i<s;i++)this._u8[this._pos++]=o}bulkF32(t){const o=t.byteLength;this._grow(o),this._u8.set(new Uint8Array(t.buffer,t.byteOffset,o),this._pos),this._pos+=o}bulkU32(t){const o=t.byteLength;this._grow(o),this._u8.set(new Uint8Array(t.buffer,t.byteOffset,o),this._pos),this._pos+=o}bulkU8(t){this.raw(t)}result(){return this._buf.slice(0,this._pos)}}function ba(e){const t=e.positions,o=e.normals,n=e.colors,s=e.indices,i=e.vertexCount,a=e.faceCount,r=n!=null&&n.length>0,l=[1/0,1/0,1/0],m=[-1/0,-1/0,-1/0];for(let A=0;A<i;A++){const O=t[A*3],S=t[A*3+1],T=t[A*3+2];O<l[0]&&(l[0]=O),S<l[1]&&(l[1]=S),T<l[2]&&(l[2]=T),O>m[0]&&(m[0]=O),S>m[1]&&(m[1]=S),T>m[2]&&(m[2]=T)}const x=i*12,d=i*12,f=r?i*16:0,v=a*3*4,g=0,M=x,p=x+d,E=x+d+f,h=x+d+f+v,y=(4-h%4)%4,w=h+y,V=[],k=[],R={};let D=0,N=0;V.push({buffer:0,byteOffset:g,byteLength:x,target:34962}),k.push({bufferView:D,byteOffset:0,componentType:5126,count:i,type:"VEC3",min:[l[0],l[1],l[2]],max:[m[0],m[1],m[2]]}),R.POSITION=N,D++,N++,V.push({buffer:0,byteOffset:M,byteLength:d,target:34962}),k.push({bufferView:D,byteOffset:0,componentType:5126,count:i,type:"VEC3"}),R.NORMAL=N,D++,N++,r&&(V.push({buffer:0,byteOffset:p,byteLength:f,target:34962}),k.push({bufferView:D,byteOffset:0,componentType:5126,count:i,type:"VEC4"}),R.COLOR_0=N,D++,N++);const u=N;V.push({buffer:0,byteOffset:E,byteLength:v,target:34963}),k.push({bufferView:D,byteOffset:0,componentType:5125,count:a*3,type:"SCALAR"});const c={attributes:R,indices:u,mode:4},_={asset:{version:"2.0",generator:"GMT Fractal Explorer"},scene:0,scenes:[{nodes:[0]}],nodes:[{mesh:0}],meshes:[{primitives:[c]}],accessors:k,bufferViews:V,buffers:[{byteLength:h}]};r&&(_.materials=[{name:"FractalVertexColor",pbrMetallicRoughness:{baseColorFactor:[1,1,1,1],metallicFactor:0,roughnessFactor:1}}],c.material=0);const P=JSON.stringify(_),B=(4-P.length%4)%4,z=P.length+B,F=20+z+8+w,U=20+z+8,I=new va(U+16);I.u32(1179937895),I.u32(2),I.u32(F),I.u32(z),I.u32(1313821514),I.str(P);for(let A=0;A<B;A++)I.u8(32);I.u32(w),I.u32(5130562);const C=A=>A.buffer.slice(A.byteOffset,A.byteOffset+A.byteLength),L=[I._buf.slice(0,I._pos),C(t),C(o)];if(r){const A=new Float32Array(i*4);for(let O=0;O<i*4;O++)A[O]=n[O]/255;L.push(A.buffer)}return L.push(C(s)),y>0&&L.push(new ArrayBuffer(y)),new Blob(L,{type:"application/octet-stream"})}async function ga(e,t){const o=t||function(){},n=e.positions,s=e.indices,i=e.faceCount,a=new ArrayBuffer(84),r=new DataView(a),l="Fractal Mesh Export - GMT Fractal Explorer";for(let f=0;f<l.length;f++)r.setUint8(f,l.charCodeAt(f)&127);for(let f=l.length;f<80;f++)r.setUint8(f,32);r.setUint32(80,i,!0);const m=[new Uint8Array(a)],x=65536,d=Math.ceil(i/x);for(let f=0;f<i;f+=x){const v=Math.min(f+x,i),g=v-f,M=new ArrayBuffer(g*50),p=new DataView(M);let E=0;for(let y=f;y<v;y++){const w=s[y*3],V=s[y*3+1],k=s[y*3+2],R=n[w*3],D=n[w*3+1],N=n[w*3+2],u=n[V*3],c=n[V*3+1],_=n[V*3+2],P=n[k*3],B=n[k*3+1],z=n[k*3+2],F=u-R,U=c-D,I=_-N,C=P-R,L=B-D,A=z-N;let O=U*A-I*L,S=I*C-F*A,T=F*L-U*C;const G=Math.sqrt(O*O+S*S+T*T);G>1e-12&&(O/=G,S/=G,T/=G),p.setFloat32(E,O,!0),p.setFloat32(E+4,S,!0),p.setFloat32(E+8,T,!0),p.setFloat32(E+12,R,!0),p.setFloat32(E+16,D,!0),p.setFloat32(E+20,N,!0),p.setFloat32(E+24,u,!0),p.setFloat32(E+28,c,!0),p.setFloat32(E+32,_,!0),p.setFloat32(E+36,P,!0),p.setFloat32(E+40,B,!0),p.setFloat32(E+44,z,!0),p.setUint16(E+48,0,!0),E+=50}m.push(new Uint8Array(M));const h=f/x|0;h&7||(o(Math.round(100*(h+1)/d)),await new Promise(function(y){setTimeout(y,0)}))}return o(100),new Blob(m,{type:"application/octet-stream"})}function ho(e,t){if(t==="stl")return 84+e.faceCount*50;{const n=e.colors!=null&&e.colors.length>0?e.vertexCount*16:0;return 1024+e.vertexCount*24+n+e.faceCount*12}}function ya(e,t){const o=document.createElement("a");o.href=URL.createObjectURL(e),o.download=t,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(o.href)}function De(e){return e.tick?e.tick():new Promise(t=>setTimeout(t,0))}async function Sa(e,t){const{N:o,iters:n,smoothPasses:s,useNewton:i,newtonSteps:a,smoothLambda:r,definition:l,formulaParams:m,power:x,deType:d,deSamples:f,zSubSlices:v,minFeatureSel:g,closingRadius:M,colorSamples:p,colorJitterMul:E,cavityFillMode:h,cavityFillLevel:y,gridMin:w,gridMax:V,boundsRange:k,interlace:R,estimator:D,distanceMetric:N}=e;let u=e.surfaceThreshold??0;const _=(d==="auto"?Xt(l):d)==="ifs"&&D!==void 0&&D>=1.5&&D<2.5?1:D,P=_!==void 0||N!==void 0?{estimator:_??0,distanceMetric:N??0}:void 0,B={log:t.log,setStatus:t.setStatus,setProgress:t.setProgress,setPhase:t.setPhase,tick:t.tick,onSlicePreview:t.onSlicePreview},z=o>256,F=k/o,U=performance.now();let I=null,C=null,L,A,O=0,S=0,T=0,G=0,H=0,X=0,$=null,j=null,W=!1;const oe=l.name||l.id||"unknown";t.log("=== Generate: "+oe+" ===","phase"),t.log("Resolution: "+o+"³ | Iterations: "+n+" | DE: "+d+" | SS: "+f+"³="+f*f*f+(v>1?" | Z-SS: "+v:"")+" | Newton: "+(i?a+" steps":"off")+" | Smooth: "+s+"×λ"+r+(p>1?" | Color-SS: "+p+"×r"+E:"")+" | MinFeat: "+g+" | CavityFill: "+(h==="escape"?"escape-test":y+"x")+" | Closing: "+M,"data"),t.log("Params: "+JSON.stringify(m).substring(0,200),"data"),t.log("Bounds: min=["+w[0].toFixed(2)+","+w[1].toFixed(2)+","+w[2].toFixed(2)+"] max=["+V[0].toFixed(2)+","+V[1].toFixed(2)+","+V[2].toFixed(2)+"] range="+k.toFixed(2),"data");let ne;if(d==="ifs")ne=Math.ceil(Math.log2(k/F));else{const Z=Math.max(x,2);ne=Math.ceil(Math.log(k/F)/Math.log(Z))}n>ne+2&&t.log("Note: At "+o+"³ (voxel="+F.toFixed(5)+"), ~"+ne+" iterations resolve detail at voxel scale. Using "+n+" adds "+(n-ne)+" levels of sub-voxel interior detail. Min Feature filter will clamp this. Consider reducing iterations for faster export.","warn");try{try{if(t.log("[Phase 1] GPU SDF Sampling","phase"),t.setPhase("Phase 1: SDF Sampling",0),t.memAlloc("webgl","WebGL",8,t.MEM_COLORS.webgl),t.setStatus("Initializing WebGL2..."),await De(t),C=vt(),t.log("WebGL2 initialized (max texture: "+C.getParameter(C.MAX_TEXTURE_SIZE)+")","info"),z){t.log("Pass 1: Coarse SDF 128³ ("+(128*128*128*4/(1024*1024)).toFixed(1)+" MB)","info"),t.setStatus("Pass 1: Coarse SDF (128³)..."),await De(t);const q=We(C,Math.min(128,2048),l,f,t.log,R,P),se=Math.round(128*128*128*4/(1024*1024));t.memAlloc("coarseGrid","Coarse SDF",se,t.MEM_COLORS.coarseGrid);let K=await co(C,q,128,x,n,m,w,V,0,10,1,null,null,B,R,u);L=performance.now();let ee=0,Q=0,te=1/0;for(let Se=0;Se<K.length;Se++){const ue=K[Se];ue>=0?ee++:Q++,ue<te&&(te=ue)}if(t.log("Coarse: "+ee.toLocaleString()+" outside, "+Q.toLocaleString()+" inside ("+((L-U)/1e3).toFixed(1)+"s)","data"),Q===0&&te<10&&u===0){const Se=k/128,ue=te+Se*2;t.log("Auto-threshold: DE always positive (IFS/surface fractal), min="+te.toFixed(6)+" → threshold="+ue.toFixed(6)+". Set “Surface Threshold” in Quality to control shell thickness.","warn");for(let ge=0;ge<K.length;ge++)K[ge]-=ue;u=ue,Q=0;for(let ge=0;ge<K.length;ge++)K[ge]<0&&Q++;t.log("After auto-threshold: "+Q.toLocaleString()+" interior coarse cells","data")}else Q===0&&t.log("WARNING: No interior voxels in coarse grid — surface may not be found","warn");t.setStatus("Building narrow band for "+o+"³..."),await De(t);const fe=Ln(K,128,o,8,2);K=null,t.memFree("coarseGrid"),$=fe.grid;const he=Math.pow(o/$.blockSize,3),xe=($.allocatedCount/he*100).toFixed(1),Fe=Math.round($.memoryMB());t.memAlloc("sparseGrid","Sparse SDF",Fe,t.MEM_COLORS.sparseGrid),t.log("Narrow band: "+$.allocatedCount.toLocaleString()+" blocks ("+xe+"% of "+he.toLocaleString()+"), "+Fe+" MB","data"),t.log("Pass 2: Fine SDF "+o+"³ (narrow-band, "+$.memoryMB().toFixed(0)+" MB allocated)","info"),t.setStatus("Pass 2: Fine SDF ("+o+"³ narrow-band)..."),await De(t),C.deleteTexture(q.tex),C.deleteFramebuffer(q.fbo);const Ae=We(C,Math.min(o,2048),l,f,t.log,R,P);await Qn(C,Ae,$,x,n,m,w,V,10,25,B,R,u),O=performance.now(),A=O,t.log("Fine sampling done: "+((A-L)/1e3).toFixed(1)+"s","success")}else{const J=Math.round(o*o*o*4/1048576);t.memAlloc("sdfGrid","SDF Grid",J,t.MEM_COLORS.sdfGrid),t.log("Dense SDF "+o+"³ ("+J+" MB grid)","info");const q=await Vo(C,l,m,o,x,n,w,V,F,B,R,P,u),se=We(C,Math.min(o,2048),l,f,t.log,R,P);j=await co(C,se,o,x,n,m,w,V,0,35,v,q.zSliceMin,q.zSliceMax,B,R,u),O=performance.now();let K=0,ee=0,Q=0;for(let te=0;te<j.length;te++){const fe=j[te];isNaN(fe)?Q++:fe>0?K++:ee++}if(t.log("SDF: "+K.toLocaleString()+" outside, "+ee.toLocaleString()+" inside"+(Q>0?", "+Q+" NaN!":"")+" ("+((O-U)/1e3).toFixed(1)+"s)","data"),ee===0&&u===0){let te=1/0;for(let fe=0;fe<j.length;fe++)j[fe]<te&&(te=j[fe]);if(te<10){const fe=te+F*2;t.log("Auto-threshold: DE always positive (IFS/surface fractal), min="+te.toFixed(6)+" → threshold="+fe.toFixed(6)+". Set “Surface Threshold” in Quality to control shell thickness.","warn");for(let he=0;he<j.length;he++)j[he]-=fe;u=fe}}}}catch(J){t.checkCancel();const q=J;throw t.log("PHASE 1 FAILED: "+q.message,"error"),t.log(q.stack||"","error"),t.setStatus("Error in SDF sampling: "+q.message),J}t.checkCancel();let Z=0;g==="auto"?Z=F*1.5:parseFloat(g)>0&&(Z=F*parseFloat(g));{let J=1/0,q=-1/0,se=0,K=0;if(z&&$)$.blocks.forEach(ee=>{for(let Q=0;Q<ee.length;Q++){const te=ee[Q];te<J&&(J=te),te>q&&(q=te),te<0&&se++,K++}});else if(j){K=j.length;for(let ee=0;ee<j.length;ee++){const Q=j[ee];Q<J&&(J=Q),Q>q&&(q=Q),Q<0&&se++}}if(t.log("SDF range: ["+J.toFixed(6)+", "+q.toFixed(6)+"] | "+se.toLocaleString()+" interior cells of "+K.toLocaleString()+" | threshold="+(Z>0?Z.toFixed(6):"off"),"data"),se===0&&J>0&&J<10){const ee=J+F*2;if(t.log("Auto-threshold: no interior found, SDF min="+J.toFixed(6)+" → applying threshold "+ee.toFixed(6)+" (set Surface Threshold manually to control shell thickness)","warn"),z&&$)$.blocks.forEach(Q=>{for(let te=0;te<Q.length;te++)Q[te]-=ee});else if(j)for(let Q=0;Q<j.length;Q++)j[Q]-=ee;se=z&&$?(()=>{let Q=0;return $.blocks.forEach(te=>{for(let fe=0;fe<te.length;fe++)te[fe]<0&&Q++}),Q})():j?j.reduce((Q,te)=>Q+(te<0?1:0),0):0,t.log("After auto-threshold: "+se.toLocaleString()+" interior cells","data")}if(y>0||Z>0||M>0){if(t.log("[Phase 1b] SDF Filtering","phase"),t.setPhase("Phase 1b: SDF Filtering",0),t.setStatus("Filtering SDF..."),await De(t),y>0){if(h==="escape"&&z&&$&&C){t.setStatus("Cavity fill (escape test)..."),t.setPhase("Phase 1b: Escape Test",0);const ee=await ea(C,$,l,x,n,m,w,V,B,te=>{t.setPhase("Phase 1b: Escape Test",te)},R);let Q=0;$.blocks.forEach((te,fe)=>{const he=ee.escapeMap.get(fe);if(he)for(let xe=0;xe<te.length;xe++)te[xe]>=0&&he[xe>>3]&1<<(xe&7)&&(te[xe]=-Math.abs(te[xe])-.001,Q++)}),t.log("Cavity fill (escape test): "+ee.solidCount.toLocaleString()+" escape-interior cells, "+Q.toLocaleString()+" positive cells filled","data")}else if(z&&$){t.setStatus("Cavity fill (dilate r="+y+", then flood)..."),t.setPhase("Phase 1b: Cavity Fill",0);const ee=await fa($,y,Q=>{t.setPhase("Phase 1b: Cavity Fill (r="+y+")",Q)},()=>{t.checkCancel()});t.log("Cavity fill: dilate="+y+" | "+ee.dilated.toLocaleString()+" dilated, "+ee.filled.toLocaleString()+" filled solid","data")}else if(j){t.setStatus("Cavity fill (flood)..."),t.setPhase("Phase 1b: Cavity Fill",0);const ee=await ua(j,o,Q=>{t.setPhase("Phase 1b: Cavity Fill",Q)},()=>{t.checkCancel()});t.log("Cavity fill: "+ee.toLocaleString()+" cells filled solid","data")}}if(Z>0){let ee;z&&$?ee=ia($,Z):j?ee=ra(j,o,Z):ee=0,t.log("Min feature clamp: threshold="+Z.toFixed(6)+" ("+(Z/F).toFixed(1)+"x voxel), "+ee.toLocaleString()+" cells clamped","data")}M>0&&(t.setStatus("Morphological closing (r="+M+" voxels)..."),z&&$?await ca($,M,ee=>{t.setPhase("Phase 1b: Morph Closing",ee)}):j&&await la(j,o,M,ee=>{t.setPhase("Phase 1b: Morph Closing",ee)}),t.log("Morphological closing: radius="+M+" voxels","data")),t.setPhase("Phase 1b: SDF Filtering",100)}}t.checkCancel();try{if(t.log("[Phase 2] Dual Contouring","phase"),t.setPhase("Phase 2: Dual Contouring",0),t.setProgress(35),await De(t),z&&$)t.setStatus("Dual contouring (sparse, "+o+"³)..."),I=await _n($,w,V,(ee,Q)=>{t.setProgress(35+Math.round(Q*.25)),t.setPhase("Phase 2: Dual Contouring",Q)});else if(j){t.setStatus("Dual contouring ("+o+"³)...");const K=Math.round(Math.log2(o));I=await In(j,o,w,V,K,(Q,te)=>{t.setProgress(35+Math.round(te*.25)),t.setPhase("Phase 2: Dual Contouring",te)}),j=null,t.memFree("sdfGrid")}if(S=performance.now(),!I||I.vertexCount===0)return t.log("No surface found — check parameters and bounds","error"),t.setStatus("No surface found! Try different parameters."),{mesh:null,timings:null,baseName:"",useNarrowBand:z,gl:C};t.log("DC result: "+I.vertexCount.toLocaleString()+" vertices, "+I.faceCount.toLocaleString()+" faces ("+((S-O)/1e3).toFixed(1)+"s)","data");const J=(I.positions.byteLength/(1024*1024)).toFixed(0),q=(I.normals.byteLength/(1024*1024)).toFixed(0),se=(I.indices.byteLength/(1024*1024)).toFixed(0);t.log("Mesh memory: positions="+J+"MB normals="+q+"MB indices="+se+"MB (total "+(parseInt(J)+parseInt(q)+parseInt(se))+"MB)","mem"),$&&($=null,t.memFree("sparseGrid"),t.log("Sparse grid freed","mem")),t.memAlloc("meshPos","Positions",parseInt(J),t.MEM_COLORS.meshPos),t.memAlloc("meshNrm","Normals",parseInt(q),t.MEM_COLORS.meshNrm),t.memAlloc("meshIdx","Indices",parseInt(se),t.MEM_COLORS.meshIdx),t.setStatus("Mesh: "+I.vertexCount.toLocaleString()+" verts, "+I.faceCount.toLocaleString()+" faces"),t.setProgress(60),await De(t)}catch(J){t.checkCancel();const q=J;throw t.log("PHASE 2 FAILED: "+q.message,"error"),t.log(q.stack||"","error"),t.setStatus("Error in dual contouring: "+q.message),J}t.checkCancel(),X=S;const re=k/o;if(i&&I&&C)try{t.log("[Phase 3] Newton Projection","phase"),t.setPhase("Phase 3: Newton Projection",0),t.log("Mode: GPU (float32, generic formula) — "+I.vertexCount.toLocaleString()+" vertices","info");const J=Math.ceil(Math.sqrt(I.vertexCount));t.log("Newton texture: "+J+"x"+J+" ("+(J*J*16*3/(1024*1024)).toFixed(0)+" MB GPU)","mem"),t.setStatus("GPU Newton projection ("+I.vertexCount.toLocaleString()+" vertices)..."),t.setPhase("Phase 3: Newton Projection",50),await De(t),ta(C,I,l,m,x,n,re,a,t.log,R),X=performance.now(),t.setPhase("Phase 3: Newton Projection",100),t.log("GPU Newton done: "+((X-S)/1e3).toFixed(1)+"s","success")}catch(J){t.checkCancel(),X=performance.now();const q=J;t.log("Newton FAILED: "+q.message,"error"),t.log(q.stack||"","error"),t.setStatus("Newton failed — continuing without projection"),await De(t)}t.setProgress(70),t.checkCancel();try{t.log("[Phase 4] Post-processing","phase"),t.setPhase("Phase 4: Post-processing",0),t.setStatus("Post-processing (smoothing, normals)..."),await De(t),W=I.vertexCount>5e6,W&&t.log("Large mesh ("+I.vertexCount.toLocaleString()+" verts) — smoothing disabled to avoid OOM","warn"),I=xa(I,{smoothing:s>0,smoothIterations:s,lambda:r}),T=performance.now(),t.setPhase("Phase 4: Post-processing",100),t.log("Post-processing done: "+((T-X)/1e3).toFixed(1)+"s","success")}catch(J){t.checkCancel(),T=performance.now();const q=J;throw t.log("PHASE 4 FAILED: "+q.message,"error"),t.log(q.stack||"","error"),t.setStatus("Error in post-processing: "+q.message),J}t.setProgress(80),t.checkCancel();try{t.log("[Phase 5] Vertex Coloring","phase"),t.setPhase("Phase 5: Vertex Coloring",0),t.setStatus("Colorizing vertices..."),await De(t),(!C||C.isContextLost())&&(t.log("Re-initializing WebGL for colorizer","warn"),C=vt());const J=F*E;I.colors=await oa(C,I,l,m,x,n,p,J,B,R),G=performance.now(),t.setPhase("Phase 5: Vertex Coloring",100);const q=(I.vertexCount*3/(1024*1024)).toFixed(1);t.memAlloc("meshCol","Colors",parseFloat(q),t.MEM_COLORS.meshCol),t.log("Coloring done: "+((G-T)/1e3).toFixed(1)+"s"+(p>1?" ("+p+" samples)":""),"success")}catch(J){t.checkCancel(),G=performance.now();const q=J;t.log("PHASE 5 FAILED: "+q.message,"error"),t.log(q.stack||"","error"),t.log("Continuing without vertex colors","warn")}t.setProgress(90),t.checkCancel(),H=performance.now(),t.setProgress(100),t.setPhase("Complete",100),t.setStatus("Done — choose format and export");const le=((H-U)/1e3).toFixed(1);t.log("=== Complete in "+le+"s ===","phase");const ie=(l.name||l.id||"fractal").toLowerCase().replace(/\s+/g,"-"),ce={total:H-U,sdf:O-U,coarse:L?L-U:0,fine:A&&L?A-L:0,dc:S-O,newton:X-S,post:T-X,color:G-T};return{mesh:I,baseName:ie,smoothingSkipped:W,timings:ce,useNarrowBand:z,gl:C}}catch(Z){if(C)try{const re=C.getExtension("WEBGL_lose_context");re&&re.loseContext()}catch{}throw Z}}async function wa(e,t,o,n,s){const i=performance.now();let a,r;if(s.log("[Export] Encoding "+e.toUpperCase()+"...","phase"),s.setStatus("Encoding "+e.toUpperCase()+"..."),s.setPhase("Export "+e.toUpperCase(),0),e==="vdb"){const{definition:x,formulaParams:d,N:f,iters:v,power:g,gridMin:M,gridMax:p,deSamples:E,zSubSlices:h,interlace:y,estimator:w,distanceMetric:V,surfaceThreshold:k}=n,R=w!==void 0||V!==void 0?{estimator:w??0,distanceMetric:V??0}:void 0,D=x.name||x.id||"unknown";s.log("=== VDB Export: "+D+" ===","phase"),s.log("Resolution: "+f+"³ | Iterations: "+v+" | Mode: solid | Z Sub-slices: "+h,"data");const N=vt(),u={log:s.log,setStatus:s.setStatus,setProgress:s.setProgress,setPhase:s.setPhase,tick:s.tick,onSlicePreview:s.onSlicePreview,memAlloc:s.memAlloc,memFree:s.memFree},c=await Kn(N,x,d,f,g,v,M,p,"solid",E,h,u,y,R,k,n.vdbColor);try{const z=N.getExtension("WEBGL_lose_context");z&&z.loseContext()}catch{}a=c.blob;const _=(x.name||x.id||"fractal").toLowerCase().replace(/\s+/g,"-"),P=new Date().toISOString().replace(/[-:T]/g,"").slice(0,12),B=n.vdbColor?"-density-color":"-density";r=_+"-"+f+B+"-"+P+".vdb",s.log("VDB: "+c.voxelCount.toLocaleString()+" active voxels, "+c.leafCount+" leaf blocks"+(c.promoted.promotedLeaves?", "+c.promoted.promotedLeaves+" tiles promoted":"")+(c.skippedSlices>0?", "+c.skippedSlices+" empty slices skipped":""),"data")}else if(e==="glb"){const x=ho(t,e);s.log("Estimated size: ~"+(x/(1024*1024)).toFixed(0)+" MB","mem"),a=ba(t),r=o+".glb",s.setPhase("Export GLB",100)}else{const x=ho(t,e);s.log("Estimated size: ~"+(x/(1024*1024)).toFixed(0)+" MB","mem"),a=await ga(t,d=>{s.setPhase("Export STL",d),s.setStatus("Encoding STL... "+d+"%")}),r=o+".stl"}const l=performance.now(),m=(a.size/(1024*1024)).toFixed(2);return s.memAlloc("exportBlob",e.toUpperCase()+" Blob",parseFloat(m),s.MEM_COLORS.exportBlob),s.log("Export: "+m+" MB "+e.toUpperCase()+" ("+((l-i)/1e3).toFixed(1)+"s)","success"),s.setStatus(m+" MB "+e.toUpperCase()+" ready"),s.setPhase("Export complete",100),{blob:a,filename:r}}const Ca={webgl:"#47a",coarseGrid:"#7af",sparseGrid:"#5a8",sdfGrid:"#7af",meshPos:"#f80",meshNrm:"#fa0",meshIdx:"#fc0",meshCol:"#f5a",exportBlob:"#5af"},ft="font-mono text-[13px] font-bold border-none rounded px-4 py-2 cursor-pointer transition-opacity disabled:bg-gray-800 disabled:text-gray-600 disabled:cursor-default",Ma=()=>{const e=Y(),t=Y(h=>h.isRunning),o=Y(h=>h.exportFormat),n=Y(h=>h.lastMesh),s=Y(h=>h.lastBlob),i=Y(h=>h.lastFilename),a=Y(h=>h.loadedDefinition),r=Y(h=>h.selectedFormulaId),l=Y(h=>h.customFilename),m=Y(h=>h.vdbColor),x=!!(a||Oe.get(r)),d=o==="vdb";function f(){const h=Y.getState(),y=h.loadedDefinition||Oe.get(h.selectedFormulaId),w=h.bboxSize.map(c=>c/2),V=[h.bboxCenter[0]-w[0],h.bboxCenter[1]-w[1],h.bboxCenter[2]-w[2]],k=[h.bboxCenter[0]+w[0],h.bboxCenter[1]+w[1],h.bboxCenter[2]+w[2]];let R,D;h.cavityFill==="escape"?(R="escape",D=1):(R="dilate",D=parseInt(h.cavityFill)||0);let N;h.interlaceState&&(N={definition:h.interlaceState.definition,params:h.interlaceState.params,enabled:h.interlaceState.enabled,interval:h.interlaceState.interval,startIter:h.interlaceState.startIter});const u=h.qualitySettings;return{N:h.resolution,iters:h.iters,smoothPasses:h.smoothPasses,useNewton:h.newton,newtonSteps:h.newtonSteps,smoothLambda:h.smoothLambda,definition:y,formulaParams:h.formulaParams,power:h.formulaParams.paramA||8,deType:h.deType,deSamples:h.deSamples,zSubSlices:h.zSubSlices,minFeatureSel:h.minFeature,closingRadius:h.closingRadius,colorSamples:h.colorSamples,colorJitterMul:h.colorJitter,cavityFillMode:R,cavityFillLevel:D,gridMin:V,gridMax:k,boundsRange:k[0]-V[0],interlace:N,estimator:u.estimator,distanceMetric:u.distanceMetric,surfaceThreshold:u.surfaceThreshold}}function v(){return{setStatus:h=>Y.getState().setStatus(h),setProgress:h=>Y.getState().setProgress(h),setPhase:(h,y)=>Y.getState().setPhase(h,y),log:(h,y)=>Y.getState().addLog(h,y),memAlloc:(h,y,w,V)=>Y.getState().memAlloc(h,y,w,V),memFree:h=>Y.getState().memFree(h),tick:async()=>{if(await new Promise(h=>setTimeout(h,0)),Y.getState().isCancelled)throw new Error("Cancelled")},checkCancel:()=>{if(Y.getState().isCancelled)throw new Error("Cancelled")},onSlicePreview:(h,y,w)=>{un(h,y,w)},MEM_COLORS:Ca}}const g=async()=>{const h=Y.getState();h.setMesh(null,""),h.setExportBlob(null,""),h.setRunning(!0),h.setCancelled(!1),h.setProgress(0),h.setPhase("",0),h.clearMemory(),so(),io();try{const y=await Sa(f(),v()),w=Y.getState();w.setMesh(y.mesh,y.baseName),w.setTimings(y.timings,y.smoothingSkipped??!1,y.useNarrowBand),y.gl&&w.setGL(y.gl)}catch(y){const w=y;w.message!=="Cancelled"?(Y.getState().addLog("ERROR: "+w.message,"error"),Y.getState().setStatus("Error: "+w.message)):(Y.getState().addLog("Cancelled","warn"),Y.getState().setStatus("Cancelled"))}finally{Y.getState().setRunning(!1)}},M=()=>{An(),Rn(),Y.getState().setCancelled(!0)},p=async()=>{const h=Y.getState();h.setRunning(!0),h.setCancelled(!1),so(),io();try{const y=f(),w=await wa(h.exportFormat,h.lastMesh,h.lastBaseName,{definition:y.definition,formulaParams:y.formulaParams,N:y.N,iters:y.iters,power:y.power,gridMin:y.gridMin,gridMax:y.gridMax,deSamples:y.deSamples,zSubSlices:y.zSubSlices,interlace:y.interlace,estimator:y.estimator,distanceMetric:y.distanceMetric,surfaceThreshold:y.surfaceThreshold,vdbColor:h.vdbColor},v()),V=Y.getState().customFilename.trim(),k=V?V.replace(/\.[^.]+$/,"")+"."+w.filename.split(".").pop():w.filename;Y.getState().setExportBlob(w.blob,k)}catch(y){const w=y;w.message!=="Cancelled"&&(Y.getState().addLog("Export error: "+w.message,"error"),Y.getState().setStatus("Export error: "+w.message))}finally{Y.getState().setRunning(!1)}},E=()=>{s&&i&&ya(s,i)};return b.jsxs("div",{className:"font-mono flex flex-col gap-2 mt-1",children:[b.jsx(Me,{label:"Format",value:o,options:[{label:"GLB (Binary glTF)",value:"glb"},{label:"STL (Binary)",value:"stl"},{label:"VDB (OpenVDB)",value:"vdb"}],onChange:e.setExportFormat,fullWidth:!0}),b.jsxs("div",{className:"flex items-center gap-2",children:[b.jsx("span",{className:"text-[10px] text-gray-500 uppercase tracking-wide shrink-0",children:"Filename"}),b.jsx("input",{type:"text",value:l,onChange:h=>e.setCustomFilename(h.target.value),placeholder:((a==null?void 0:a.name)||r||"fractal").toLowerCase().replace(/\s+/g,"-"),className:"flex-1 h-[26px] bg-gray-800 border border-gray-700 rounded px-2 text-[11px] text-gray-200 font-mono placeholder:text-gray-600"}),b.jsxs("span",{className:"text-[10px] text-gray-600",children:[".",o]})]}),d&&b.jsx("div",{className:"text-[11px] text-sky-400 bg-sky-900/20 px-2 py-1 rounded",children:"VDB exports directly — no Generate needed"}),d&&b.jsxs("label",{className:"flex items-center gap-2 text-[11px] text-gray-300 cursor-pointer select-none",children:[b.jsx("input",{type:"checkbox",checked:m,onChange:h=>e.setVdbColor(h.target.checked),className:"accent-amber-500"}),"Include color grids (slower)"]}),b.jsxs("div",{className:"flex gap-2 flex-wrap",children:[!d&&b.jsxs("button",{disabled:t||!x,onClick:g,className:`${ft} bg-emerald-700 text-white hover:bg-emerald-600`,children:[b.jsx("span",{className:"bg-white/15 rounded px-1 mr-1 text-[10px]",children:"1"}),"Generate"]}),t&&b.jsx("button",{onClick:M,className:`${ft} bg-red-700 text-white hover:bg-red-600`,children:"Cancel"}),b.jsxs("button",{disabled:t||!n&&!d,onClick:p,className:`${ft} bg-amber-700 text-white hover:bg-amber-600`,children:[b.jsx("span",{className:"bg-white/15 rounded px-1 mr-1 text-[10px]",children:d?"1":"2"}),"Export"]}),b.jsxs("button",{disabled:!s,onClick:E,className:`${ft} bg-sky-700 text-white hover:bg-sky-600`,children:[b.jsx("span",{className:"bg-white/15 rounded px-1 mr-1 text-[10px]",children:d?"2":"3"}),"Download",i?` (${i})`:""]})]})]})};function Go(e,t){return[e[0]-t[0],e[1]-t[1],e[2]-t[2]]}function bt(e,t){return[e[0]+t[0],e[1]+t[1],e[2]+t[2]]}function Vt(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]}function gt(e,t){return[e[0]*t,e[1]*t,e[2]*t]}function Fa(e,t){return[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]]}function Jt(e,t){const o=Math.cos(e),n=Math.sin(e),s=Math.cos(t),i=Math.sin(t),a=[o,0,-n],r=[-s*n,-i,-s*o],l=Fa(a,r);return{pos:Go([0,0,0],gt(r,10)),fwd:r,right:a,up:l}}function po(e,t,o,n,s,i,a){const r=Jt(t,o),l=a||[0,0,0],m=bt(r.pos,l),x=Go(e,m),d=Vt(x,r.right),f=Vt(x,r.up),v=i/n;return[s*.5+d*v,i*.5-f*v,0]}function kt(e,t,o,n,s,i){const a=i/s,r=Jt(o,n),l=e/a,m=-t/a;return bt(gt(r.right,l),gt(r.up,m))}const dt=Math.PI*.5,xo=[{angle:0,pitch:0,label:"Front (-Z)"},{angle:Math.PI,pitch:0,label:"Back (+Z)"},{angle:dt,pitch:0,label:"Right (+X)"},{angle:-dt,pitch:0,label:"Left (-X)"},{angle:0,pitch:dt,label:"Top (+Y)"},{angle:0,pitch:-dt,label:"Bottom (-Y)"}],vo=15*Math.PI/180;function Nt(e){return e=e%(2*Math.PI),e>Math.PI&&(e-=2*Math.PI),e<-Math.PI&&(e+=2*Math.PI),e}function Ot(e,t,o){const n=Nt(e);let s=null,i=1/0;for(let a=0;a<xo.length;a++){const r=xo[a];let l,m;Math.abs(r.pitch)>1?(l=0,m=Math.abs(t-r.pitch)):(l=Math.abs(Nt(n-r.angle)),m=Math.abs(t-r.pitch));const x=Math.sqrt(l*l+m*m);x<o&&x<i&&(i=x,s={angle:Math.abs(r.pitch)>1?n:r.angle,pitch:r.pitch,label:r.label})}return s}function Ea(){return{positions:null,indices:null,normals:null,vertexCount:0,faceCount:0,rotX:-.4,rotY:.6,zoom:1,cx:0,cy:0,cz:0,scale:1,dragging:!1,lastMX:0,lastMY:0}}function bo(e,t,o,n,s,i){e.positions=t,e.indices=o,e.vertexCount=n,e.faceCount=s;let a=1/0,r=1/0,l=1/0,m=-1/0,x=-1/0,d=-1/0;for(let f=0;f<n;f++){const v=t[f*3],g=t[f*3+1],M=t[f*3+2];v<a&&(a=v),g<r&&(r=g),M<l&&(l=M),v>m&&(m=v),g>x&&(x=g),M>d&&(d=M)}e.cx=(a+m)/2,e.cy=(r+x)/2,e.cz=(l+d)/2,e.scale=i/(Math.max(m-a,x-r,d-l)*1.15)}function mt(e,t,o,n){if(t.fillStyle="#111",t.fillRect(0,0,o,n),!e.positions||!e.indices||e.vertexCount===0)return;const s=Math.cos(e.rotX),i=Math.sin(e.rotX),a=Math.cos(e.rotY),r=Math.sin(e.rotY),l=e.scale*e.zoom,m=e.positions,x=e.cx,d=e.cy,f=e.cz;function v(E){const h=m[E*3]-x,y=m[E*3+1]-d,w=m[E*3+2]-f,V=h*a-w*r,k=h*r+w*a,R=y*s-k*i;return[V*l+o/2,n/2-R*l]}const g=15e4,M=e.faceCount>g?Math.ceil(e.faceCount/g):1;let p=0;t.strokeStyle="rgba(42,170,85,0.12)",t.lineWidth=.5,t.beginPath();for(let E=0;E<e.faceCount&&p<g;E+=M){const h=v(e.indices[E*3]),y=v(e.indices[E*3+1]),w=v(e.indices[E*3+2]);t.moveTo(h[0],h[1]),t.lineTo(y[0],y[1]),t.lineTo(w[0],w[1]),t.lineTo(h[0],h[1]),p++}t.stroke(),t.fillStyle="#888",t.font="11px monospace",t.fillText(e.vertexCount.toLocaleString()+" verts, "+e.faceCount.toLocaleString()+" faces",4,n-4),t.fillStyle="#555",t.fillText("drag to rotate, scroll to zoom",4,14)}function go(e,t,o){const n=e.createShader(t);if(e.shaderSource(n,o),e.compileShader(n),!e.getShaderParameter(n,e.COMPILE_STATUS)){const s=e.getShaderInfoLog(n)||"";throw e.deleteShader(n),new Error("Shader compile: "+s)}return n}function Ta(e,t,o){const n=e.createProgram();if(e.attachShader(n,go(e,e.VERTEX_SHADER,t)),e.attachShader(n,go(e,e.FRAGMENT_SHADER,o)),e.linkProgram(n),!e.getProgramParameter(n,e.LINK_STATUS)){const s=e.getProgramInfoLog(n)||"";throw e.deleteProgram(n),new Error("Program link: "+s)}return n}function Pa(e,t,o){var s,i,a,r,l,m,x,d,f,v,g,M,p,E,h,y,w,V,k,R,D,N,u,c,_,P,B,z,F,U;const n=o||{};t.uParamA&&e.uniform1f(t.uParamA,n.paramA??8),t.uParamB&&e.uniform1f(t.uParamB,n.paramB??0),t.uParamC&&e.uniform1f(t.uParamC,n.paramC??0),t.uParamD&&e.uniform1f(t.uParamD,n.paramD??0),t.uParamE&&e.uniform1f(t.uParamE,n.paramE??0),t.uParamF&&e.uniform1f(t.uParamF,n.paramF??0),t.uVec2A&&e.uniform2f(t.uVec2A,((s=n.vec2A)==null?void 0:s.x)??0,((i=n.vec2A)==null?void 0:i.y)??0),t.uVec2B&&e.uniform2f(t.uVec2B,((a=n.vec2B)==null?void 0:a.x)??0,((r=n.vec2B)==null?void 0:r.y)??0),t.uVec2C&&e.uniform2f(t.uVec2C,((l=n.vec2C)==null?void 0:l.x)??0,((m=n.vec2C)==null?void 0:m.y)??0),t.uVec3A&&e.uniform3f(t.uVec3A,((x=n.vec3A)==null?void 0:x.x)??0,((d=n.vec3A)==null?void 0:d.y)??0,((f=n.vec3A)==null?void 0:f.z)??0),t.uVec3B&&e.uniform3f(t.uVec3B,((v=n.vec3B)==null?void 0:v.x)??0,((g=n.vec3B)==null?void 0:g.y)??0,((M=n.vec3B)==null?void 0:M.z)??0),t.uVec3C&&e.uniform3f(t.uVec3C,((p=n.vec3C)==null?void 0:p.x)??0,((E=n.vec3C)==null?void 0:E.y)??0,((h=n.vec3C)==null?void 0:h.z)??0),t.uVec4A&&e.uniform4f(t.uVec4A,((y=n.vec4A)==null?void 0:y.x)??0,((w=n.vec4A)==null?void 0:w.y)??0,((V=n.vec4A)==null?void 0:V.z)??0,((k=n.vec4A)==null?void 0:k.w)??0),t.uVec4B&&e.uniform4f(t.uVec4B,((R=n.vec4B)==null?void 0:R.x)??0,((D=n.vec4B)==null?void 0:D.y)??0,((N=n.vec4B)==null?void 0:N.z)??0,((u=n.vec4B)==null?void 0:u.w)??0),t.uVec4C&&e.uniform4f(t.uVec4C,((c=n.vec4C)==null?void 0:c.x)??0,((_=n.vec4C)==null?void 0:_.y)??0,((P=n.vec4C)==null?void 0:P.z)??0,((B=n.vec4C)==null?void 0:B.w)??0),t.uJulia&&e.uniform3f(t.uJulia,((z=n.julia)==null?void 0:z.x)??0,((F=n.julia)==null?void 0:F.y)??0,((U=n.julia)==null?void 0:U.z)??0),t.uJuliaMode&&e.uniform1f(t.uJuliaMode,n.juliaMode??0),t.uEscapeThresh&&e.uniform1f(t.uEscapeThresh,n.escapeThresh??4),t.uDistanceMetric&&e.uniform1f(t.uDistanceMetric,n.distanceMetric??0)}const be=512,Ve=Math.PI*.5;function Aa(){const e=Y(u=>u.isRunning),t=Y(u=>u.lastMesh),o=Y(u=>u.loadedDefinition),n=Y(u=>u.bboxCenter),s=Y(u=>u.bboxSize),i=Y(u=>u.formulaParams),a=Y(u=>u.interlaceState),r=Y(u=>u.iters),l=Y(u=>u.qualitySettings),m=Y(u=>u.clipOutsideBounds),x=de.useRef(null),d=de.useRef(null),f=de.useRef(null),v=de.useRef(null),g=de.useRef({gl:null,prog:null,loc:{},defId:null,rawAngle:.6,rawPitch:.3,camAngle:.6,camPitch:.3,camDist:3.5,camTarget:[0,0,0],dragging:!1,dragMode:null,hover:null,lastX:0,lastY:0,shiftHeld:!1,snapped:!1,snapTarget:null,snapAnimId:0,rafId:0}),M=de.useRef(Ea()),p=t?"mesh":e?"slice":"fractal",E=de.useCallback(()=>{const u=g.current,c=Y.getState(),_=c.loadedDefinition;if(!u.gl||!_)return;const P=u.gl;let B;c.interlaceState&&(B={definition:c.interlaceState.definition,params:c.interlaceState.params,enabled:c.interlaceState.enabled,interval:c.interlaceState.interval,startIter:c.interlaceState.startIter});const z=c.qualitySettings,U=Xt(_)==="ifs"&&z.estimator>=1.5&&z.estimator<2.5?1:z.estimator,I=_.id+(B?"+"+B.definition.id:"")+":e"+(U??0);if(u.defId===I&&u.prog)return;u.prog&&(P.deleteProgram(u.prog),u.prog=null);try{const L=vn({definition:_,deType:"auto",interlace:B,estimator:U});console.log("[Preview] Compiling shader for",_.id,"| estimator:",U,"| length:",L.length),u.prog=Ta(P,Je,L),console.log("[Preview] Shader compiled OK for",_.id)}catch(L){console.warn("Preview shader compile failed for",_.id+":",L.message),u.prog=null,u.defId=null;return}P.useProgram(u.prog),P.bindVertexArray(P.createVertexArray()),u.loc={};const C=["uPower","uIters","uResolution","uCamPos","uCamTarget","uCamRight","uFov","uFudgeFactor","uDetail","uPixelThreshold","uClipBounds","uBoundsMin","uBoundsMax",...Ye];for(const L of C)u.loc[L]=P.getUniformLocation(u.prog,L);u.defId=I},[]),h=de.useCallback(()=>{const u=d.current;if(!u)return;const c=u.getContext("2d"),_=u.width,P=u.height;c.clearRect(0,0,_,P);const B=g.current,z=Y.getState(),[F,U,I]=z.bboxCenter,[C,L,A]=z.bboxSize,O=C*.5,S=L*.5,T=A*.5,G=q=>po(q,B.camAngle,B.camPitch,B.camDist,be,be,B.camTarget),H=[];for(let q=0;q<2;q++)for(let se=0;se<2;se++)for(let K=0;K<2;K++)H.push([F+(q?O:-O),U+(se?S:-S),I+(K?T:-T)]);const X=H.map(G),$=[{color:"#f554",edges:[[0,4],[1,5],[2,6],[3,7]]},{color:"#5f54",edges:[[0,2],[1,3],[4,6],[5,7]]},{color:"#55f4",edges:[[0,1],[2,3],[4,5],[6,7]]}];for(const q of $){c.strokeStyle=q.color,c.lineWidth=1,c.setLineDash([4,3]),c.beginPath();for(const[se,K]of q.edges)c.moveTo(X[se][0],X[se][1]),c.lineTo(X[K][0],X[K][1]);c.stroke()}c.setLineDash([]);const j={"sizeX+":[F+O,U,I],"sizeX-":[F-O,U,I],"sizeY+":[F,U+S,I],"sizeY-":[F,U-S,I],"sizeZ+":[F,U,I+T],"sizeZ-":[F,U,I-T]},W={"sizeX+":"#f55","sizeX-":"#f55","sizeY+":"#5f5","sizeY-":"#5f5","sizeZ+":"#55f","sizeZ-":"#55f"},oe=Object.keys(j);for(const q of oe){const se=G(j[q]),K=B.hover===q?7:5;c.fillStyle=W[q],c.beginPath(),c.moveTo(se[0],se[1]-K),c.lineTo(se[0]+K,se[1]),c.lineTo(se[0],se[1]+K),c.lineTo(se[0]-K,se[1]),c.closePath(),c.fill(),B.hover===q&&(c.strokeStyle="#fff",c.lineWidth=1,c.stroke())}const ne=[F,U,I],Z=G(ne),re=B.camDist*.12,le=["#f55","#5f5","#55f"],ie=[[1,0,0],[0,1,0],[0,0,1]],ce=["X","Y","Z"];for(let q=0;q<3;q++){const se=bt(ne,gt(ie[q],re)),K=G(se),ee=K[0]-Z[0],Q=K[1]-Z[1],te=Math.sqrt(ee*ee+Q*Q);if(te<2)continue;const fe=B.hover==="center";c.strokeStyle=le[q],c.lineWidth=fe?3:2,c.beginPath(),c.moveTo(Z[0],Z[1]),c.lineTo(K[0],K[1]),c.stroke();const he=ee/te,xe=Q/te;c.fillStyle=le[q],c.beginPath(),c.moveTo(K[0],K[1]),c.lineTo(K[0]-he*6+xe*3,K[1]-xe*6-he*3),c.lineTo(K[0]-he*6-xe*3,K[1]-xe*6+he*3),c.closePath(),c.fill(),c.font="bold 9px monospace",c.fillStyle=le[q],c.fillText(ce[q],K[0]+he*6-3,K[1]+xe*6+3)}const J=B.hover==="center"?5:3;if(c.fillStyle=B.hover==="center"?"#fc0":"#fa0",c.beginPath(),c.arc(Z[0],Z[1],J,0,Math.PI*2),c.fill(),B.hover==="center"&&(c.strokeStyle="#fff",c.lineWidth=1,c.stroke()),B.snapTarget){const q=Ot(B.snapTarget.angle,B.snapTarget.pitch,.1);q&&(c.font="bold 11px monospace",c.fillStyle="#fa0",c.textAlign="right",c.fillText(q.label,_-6,14),c.textAlign="left")}else if(B.shiftHeld){const q=Ot(B.camAngle,B.camPitch,vo);q&&(c.font="10px monospace",c.fillStyle="#888",c.textAlign="right",c.fillText("snap: "+q.label,_-6,14),c.textAlign="left")}},[]),y=de.useCallback(()=>{const u=g.current;if(!u.gl||!u.prog){console.log("[Preview] Render skipped: gl=",!!u.gl,"prog=",!!u.prog);return}const c=u.gl,_=c.canvas;c.viewport(0,0,_.width,_.height),c.useProgram(u.prog);const P=Jt(u.camAngle,u.camPitch),B=u.camTarget;c.uniform2f(u.loc.uResolution,_.width,_.height),c.uniform3f(u.loc.uCamPos,P.pos[0]+B[0],P.pos[1]+B[1],P.pos[2]+B[2]),c.uniform3f(u.loc.uCamTarget,B[0],B[1],B[2]),c.uniform3f(u.loc.uCamRight,P.right[0],P.right[1],P.right[2]),c.uniform1f(u.loc.uFov,u.camDist);const z=Y.getState(),F=z.formulaParams;if(c.uniform1f(u.loc.uPower,F.paramA??8),c.uniform1i(u.loc.uIters,z.iters),Pa(c,u.loc,F),z.interlaceState){const I=z.interlaceState,C=I.params||{};u.loc.uInterlaceEnabled&&c.uniform1f(u.loc.uInterlaceEnabled,I.enabled?1:0),u.loc.uInterlaceInterval&&c.uniform1f(u.loc.uInterlaceInterval,I.interval??2),u.loc.uInterlaceStartIter&&c.uniform1f(u.loc.uInterlaceStartIter,I.startIter??0),u.loc.uInterlaceParamA&&c.uniform1f(u.loc.uInterlaceParamA,C.paramA??0),u.loc.uInterlaceParamB&&c.uniform1f(u.loc.uInterlaceParamB,C.paramB??0),u.loc.uInterlaceParamC&&c.uniform1f(u.loc.uInterlaceParamC,C.paramC??0),u.loc.uInterlaceParamD&&c.uniform1f(u.loc.uInterlaceParamD,C.paramD??0),u.loc.uInterlaceParamE&&c.uniform1f(u.loc.uInterlaceParamE,C.paramE??0),u.loc.uInterlaceParamF&&c.uniform1f(u.loc.uInterlaceParamF,C.paramF??0);const L=(O,S)=>{u.loc[O]&&c.uniform2f(u.loc[O],(S==null?void 0:S.x)??0,(S==null?void 0:S.y)??0)},A=(O,S)=>{u.loc[O]&&c.uniform3f(u.loc[O],(S==null?void 0:S.x)??0,(S==null?void 0:S.y)??0,(S==null?void 0:S.z)??0)};L("uInterlaceVec2A",C.vec2A),L("uInterlaceVec2B",C.vec2B),L("uInterlaceVec2C",C.vec2C),A("uInterlaceVec3A",C.vec3A),A("uInterlaceVec3B",C.vec3B),A("uInterlaceVec3C",C.vec3C)}else u.loc.uInterlaceEnabled&&c.uniform1f(u.loc.uInterlaceEnabled,0);const U=z.qualitySettings;if(u.loc.uFudgeFactor&&c.uniform1f(u.loc.uFudgeFactor,(U.fudgeFactor??1)*.75),u.loc.uDetail&&c.uniform1f(u.loc.uDetail,U.detail??1),u.loc.uPixelThreshold&&c.uniform1f(u.loc.uPixelThreshold,U.pixelThreshold??.5),u.loc.uDistanceMetric&&c.uniform1f(u.loc.uDistanceMetric,U.distanceMetric??0),u.loc.uClipBounds&&c.uniform1f(u.loc.uClipBounds,z.clipOutsideBounds?1:0),u.loc.uBoundsMin){const I=z.bboxSize.map(C=>C/2);c.uniform3f(u.loc.uBoundsMin,z.bboxCenter[0]-I[0],z.bboxCenter[1]-I[1],z.bboxCenter[2]-I[2]),c.uniform3f(u.loc.uBoundsMax,z.bboxCenter[0]+I[0],z.bboxCenter[1]+I[1],z.bboxCenter[2]+I[2])}c.drawArrays(c.TRIANGLE_STRIP,0,4),h()},[h]),w=de.useCallback(()=>{const u=g.current;u.rafId||(u.rafId=requestAnimationFrame(()=>{u.rafId=0;const c=Y.getState();(c.lastMesh?"mesh":c.isRunning?"slice":"fractal")==="fractal"&&(E(),y())}))},[E,y]),V=de.useCallback((u,c)=>{const _=g.current,P=Y.getState(),[B,z,F]=P.bboxCenter,[U,I,C]=P.bboxSize,L=U*.5,A=I*.5,O=C*.5,S=X=>po(X,_.camAngle,_.camPitch,_.camDist,be,be,_.camTarget),T=8,G=S([B,z,F]);if(Math.abs(u-G[0])<T&&Math.abs(c-G[1])<T)return"center";const H=[["sizeX+",[B+L,z,F]],["sizeX-",[B-L,z,F]],["sizeY+",[B,z+A,F]],["sizeY-",[B,z-A,F]],["sizeZ+",[B,z,F+O]],["sizeZ-",[B,z,F-O]]];for(const[X,$]of H){const j=S($);if(Math.abs(u-j[0])<T&&Math.abs(c-j[1])<T)return X}return null},[]),k=de.useCallback(()=>{const u=g.current;if(u.shiftHeld){const c=Ot(u.rawAngle,u.rawPitch,vo);if(c){if(u.snapped=!0,u.snapTarget=c,!u.snapAnimId){const _=()=>{if(u.snapAnimId=0,!u.snapTarget)return;const P=Nt(u.snapTarget.angle-u.camAngle),B=u.snapTarget.pitch-u.camPitch;if(Math.sqrt(P*P+B*B)<.002){u.camAngle=u.snapTarget.angle,u.camPitch=u.snapTarget.pitch,w(),u.snapped&&(u.snapAnimId=requestAnimationFrame(_));return}u.camAngle+=P*.2,u.camPitch+=B*.2,w(),u.snapAnimId=requestAnimationFrame(_)};u.snapAnimId=requestAnimationFrame(_)}return}}u.snapped=!1,u.snapTarget=null,u.snapAnimId&&(cancelAnimationFrame(u.snapAnimId),u.snapAnimId=0),u.camAngle=u.rawAngle,u.camPitch=u.rawPitch},[w]);de.useEffect(()=>{const u=x.current;if(!u)return;const c=g.current;return c.gl=u.getContext("webgl2",{antialias:!1,preserveDrawingBuffer:!0}),c.gl||console.warn("Preview: WebGL2 not available"),()=>{c.prog&&c.gl&&c.gl.deleteProgram(c.prog),c.prog=null,c.defId=null}},[]),de.useEffect(()=>{const u=f.current;if(!u)return;const c=u.getContext("2d");if(c)return ln((_,P,B)=>{const z=document.createElement("canvas");z.width=P,z.height=B,z.getContext("2d").putImageData(_,0,0),c.clearRect(0,0,be,be),c.imageSmoothingEnabled=!1,c.drawImage(z,0,0,be,be)}),()=>{cn()}},[]),de.useEffect(()=>{if(p!=="fractal")return;const u=g.current,_=Y.getState().interlaceState,P=((o==null?void 0:o.id)??"")+(_?"+"+_.definition.id:"");o&&u.defId!==P&&(u.defId=null),w()},[o,a,p,w]),de.useEffect(()=>{p==="fractal"&&w()},[i,a,r,n,s,m,l,p,w]),de.useEffect(()=>{if(!t)return;const u=v.current;if(!u)return;const c=u.getContext("2d");if(!c)return;const _=M.current;bo(_,t.positions,t.indices,t.vertexCount,t.faceCount,u.width),mt(_,c,u.width,u.height)},[t]),de.useEffect(()=>{const u=d.current;if(!u)return;const c=g.current,_=C=>{const L=u.getBoundingClientRect(),A=C.clientX-L.left,O=C.clientY-L.top;if(c.lastX=C.clientX,c.lastY=C.clientY,C.button===1||C.button===2){c.dragMode="pan",c.dragging=!0,u.style.cursor="all-scroll",C.preventDefault();return}const S=V(A,O);c.dragMode=S||"orbit",c.dragging=!0,u.style.cursor=c.dragMode==="orbit"?"grabbing":"ew-resize",C.preventDefault()},P=C=>{C.preventDefault()},B=C=>{if(!c.dragging){const O=u.getBoundingClientRect(),S=C.clientX-O.left,T=C.clientY-O.top,G=c.hover;c.hover=V(S,T),u.style.cursor=c.hover?c.hover==="center"?"move":"ew-resize":"grab",c.hover!==G&&w();return}const L=C.clientX-c.lastX,A=C.clientY-c.lastY;if(c.lastX=C.clientX,c.lastY=C.clientY,c.dragMode==="pan"){const O=kt(-L,-A,c.camAngle,c.camPitch,c.camDist,be);c.camTarget=bt(c.camTarget,O),w()}else if(c.dragMode==="orbit")c.rawAngle+=L*.008,c.rawPitch=Math.max(-Ve,Math.min(Ve,c.rawPitch+A*.008)),k(),w();else if(c.dragMode==="center"){const O=kt(L,A,c.camAngle,c.camPitch,c.camDist,be),S=Y.getState(),[T,G,H]=S.bboxCenter;S.setBboxCenter([T+O[0],G+O[1],H+O[2]]),w()}else if(c.dragMode){const O=c.dragMode.charAt(4),S=c.dragMode.charAt(5)==="+"?1:-1,T=O==="X"?[1,0,0]:O==="Y"?[0,1,0]:[0,0,1],G=kt(L,A,c.camAngle,c.camPitch,c.camDist,be),H=Vt(G,T)*S,X=O==="X"?0:O==="Y"?1:2,$=Y.getState(),j=[...$.bboxSize],W=[...$.bboxCenter],oe=Math.max(.1,j[X]+H*2),ne=oe-j[X];$.bboxLock?$.setBboxSize([oe,oe,oe]):(j[X]=oe,W[X]+=ne*.5*S,$.setBboxSize(j),$.setBboxCenter(W)),w()}},z=()=>{c.dragging=!1,c.dragMode=null,u.style.cursor=c.hover?c.hover==="center"?"move":"ew-resize":"grab"},F=C=>{C.preventDefault(),c.camDist=Math.max(.5,Math.min(20,c.camDist*(1+C.deltaY*.001))),w()},U=C=>{C.key==="Shift"&&!c.shiftHeld&&(c.shiftHeld=!0,k(),w())},I=C=>{C.key==="Shift"&&(c.shiftHeld=!1,k(),w())};return u.addEventListener("mousedown",_),window.addEventListener("mousemove",B),window.addEventListener("mouseup",z),u.addEventListener("wheel",F,{passive:!1}),u.addEventListener("contextmenu",P),window.addEventListener("keydown",U),window.addEventListener("keyup",I),()=>{u.removeEventListener("mousedown",_),window.removeEventListener("mousemove",B),window.removeEventListener("mouseup",z),u.removeEventListener("wheel",F),u.removeEventListener("contextmenu",P),window.removeEventListener("keydown",U),window.removeEventListener("keyup",I)}},[V,k,w]),de.useEffect(()=>{const u=v.current;if(!u)return;const c=M.current;let _=null;const P=()=>{const C=u.getContext("2d");C&&mt(c,C,u.width,u.height)},B=C=>{c.dragging=!0,c.lastMX=C.clientX,c.lastMY=C.clientY,_=C.button===1||C.button===2?"pan":"orbit"},z=()=>{c.dragging=!1,_=null},F=C=>{if(!c.dragging||!c.positions)return;const L=C.clientX-c.lastMX,A=C.clientY-c.lastMY;if(c.lastMX=C.clientX,c.lastMY=C.clientY,_==="pan"){const O=1/(c.scale*c.zoom);c.cx-=L*O,c.cy+=A*O,P()}else c.rotY+=L*.01,c.rotX+=A*.01,c.rotX=Math.max(-Ve,Math.min(Ve,c.rotX)),P()},U=C=>{C.preventDefault(),c.zoom*=C.deltaY>0?.9:1.1,c.zoom=Math.max(.1,Math.min(10,c.zoom)),c.positions&&P()},I=C=>{C.preventDefault()};return u.addEventListener("mousedown",B),window.addEventListener("mouseup",z),window.addEventListener("mousemove",F),u.addEventListener("wheel",U,{passive:!1}),u.addEventListener("contextmenu",I),()=>{u.removeEventListener("mousedown",B),window.removeEventListener("mouseup",z),window.removeEventListener("mousemove",F),u.removeEventListener("wheel",U),u.removeEventListener("contextmenu",I)}},[]);const R=de.useCallback((u,c,_)=>{const P=g.current;P.rawAngle=u,P.rawPitch=c,P.camAngle=u,P.camPitch=c,P.snapped=!1,P.snapTarget=null,P.snapAnimId&&(cancelAnimationFrame(P.snapAnimId),P.snapAnimId=0);const B=M.current;if(B.rotX=-c,B.rotY=u,B.positions){const z=v.current;if(z){const F=z.getContext("2d");F&&mt(B,F,z.width,z.height)}}w()},[w]),D=de.useCallback(()=>{const u=g.current;u.camTarget=[0,0,0];const c=M.current;if(c.positions){bo(c,c.positions,c.indices,c.vertexCount,c.faceCount,be);const _=v.current;if(_){const P=_.getContext("2d");P&&mt(c,P,_.width,_.height)}}w()},[w]),N=[{label:"F",title:"Front (-Z)",angle:0,pitch:0},{label:"B",title:"Back (+Z)",angle:Math.PI,pitch:0},{label:"L",title:"Left (-X)",angle:-Ve,pitch:0},{label:"R",title:"Right (+X)",angle:Ve,pitch:0},{label:"T",title:"Top (+Y)",angle:0,pitch:Ve},{label:"D",title:"Bottom (-Y)",angle:0,pitch:-Ve}];return b.jsxs("div",{className:"relative",style:{width:be,height:be},children:[b.jsx("canvas",{ref:x,width:be,height:be,className:"border border-white/10 rounded-sm",style:{imageRendering:"pixelated",display:p==="fractal"?"block":"none"}}),b.jsx("canvas",{ref:d,width:be,height:be,style:{position:"absolute",top:0,left:0,cursor:"grab",display:p==="fractal"?"block":"none"}}),b.jsx("canvas",{ref:f,width:be,height:be,className:"border border-white/10 rounded-sm",style:{imageRendering:"pixelated",display:p==="slice"?"block":"none"}}),b.jsx("canvas",{ref:v,width:be,height:be,className:"border border-white/10 rounded-sm",style:{cursor:"grab",display:p==="mesh"?"block":"none"}}),b.jsxs("div",{className:"absolute top-2 left-2 text-[10px] text-gray-500 uppercase tracking-wider pointer-events-none",children:[p==="fractal"&&"SDF Preview",p==="slice"&&"Sampling...",p==="mesh"&&"Mesh Preview"]}),p!=="slice"&&b.jsxs("div",{className:"absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-0.5 bg-black/70 backdrop-blur rounded px-1 py-0.5 pointer-events-auto",children:[N.map(u=>b.jsx("button",{title:u.title,onClick:()=>R(u.angle,u.pitch,u.label),className:"w-[22px] h-[20px] text-[10px] font-bold text-gray-400 hover:text-white hover:bg-white/10 rounded transition-colors",children:u.label},u.label)),b.jsx("div",{className:"w-px h-3 bg-gray-700 mx-0.5"}),b.jsx("button",{title:"Reset pan (re-center view)",onClick:D,className:"w-[22px] h-[20px] text-[10px] font-bold text-gray-400 hover:text-white hover:bg-white/10 rounded transition-colors",children:"C"})]}),p==="fractal"&&b.jsxs("label",{className:"absolute top-2 right-2 flex items-center gap-1 bg-black/70 backdrop-blur rounded px-1.5 py-0.5 cursor-pointer pointer-events-auto select-none",children:[b.jsx("input",{type:"checkbox",checked:m,onChange:u=>Y.getState().setClipOutsideBounds(u.target.checked),className:"accent-amber-500 w-3 h-3"}),b.jsx("span",{className:"text-[9px] text-gray-400",children:"Clip bounds"})]}),p!=="slice"&&b.jsx("div",{className:"absolute bottom-8 left-1/2 -translate-x-1/2 text-[9px] text-gray-600 pointer-events-none whitespace-nowrap",children:"LMB orbit · RMB pan · Scroll zoom · Shift snap"})]})}function Ia(){const e=Y(),t=Y(o=>o.interlaceState);return t?b.jsxs("div",{className:"flex flex-col gap-1.5 border border-purple-700/40 rounded px-2 py-1.5 bg-purple-900/10 mt-1",children:[b.jsxs("div",{className:"text-[11px] text-purple-300 font-bold flex items-center justify-between",children:[b.jsxs("span",{children:["Interlace: ",t.definition.name]}),b.jsxs("label",{className:"flex items-center gap-1 cursor-pointer",children:[b.jsx("input",{type:"checkbox",checked:t.enabled,onChange:o=>e.setInterlaceState({...t,enabled:o.target.checked})}),b.jsx("span",{className:"text-[10px] text-purple-400",children:"enabled"})]})]}),b.jsxs("div",{className:"flex gap-3 text-[11px] text-gray-400",children:[b.jsxs("label",{className:"flex items-center gap-1",children:["Interval",b.jsx("input",{type:"number",min:1,max:16,step:1,value:t.interval,onChange:o=>e.setInterlaceState({...t,interval:Math.max(1,parseInt(o.target.value)||1)}),className:"w-12 bg-gray-800 border border-gray-700 rounded px-1 text-gray-200 text-center"})]}),b.jsxs("label",{className:"flex items-center gap-1",children:["Start iter",b.jsx("input",{type:"number",min:0,max:64,step:1,value:t.startIter,onChange:o=>e.setInterlaceState({...t,startIter:Math.max(0,parseInt(o.target.value)||0)}),className:"w-12 bg-gray-800 border border-gray-700 rounded px-1 text-gray-200 text-center"})]})]}),b.jsx(Fo,{definition:t.definition,params:t.params,onUpdate:(o,n)=>e.setInterlaceState({...t,params:{...t.params,[o]:n}})})]}):null}function Ra(){const e=we.useRef(null),t=we.useRef(null),o=we.useRef(0),n=we.useRef(!1),s=we.useCallback(()=>{n.current=!0,clearTimeout(o.current);const a=e.current,r=t.current;r.style.transition="none",r.style.transform="scale(1)",a.offsetHeight,a.style.transition="max-height 0.35s ease-out",a.style.maxHeight="200px"},[]),i=we.useCallback(()=>{n.current=!1;const a=e.current,r=t.current;r.style.transition="transform 0.3s ease-in",r.style.transform="scale(0) translateY(0)",r.style.transformOrigin="bottom center",o.current=window.setTimeout(()=>{n.current||(a.style.transition="none",a.style.maxHeight="0")},310)},[]);return b.jsxs("div",{className:"fixed bottom-5 right-5 z-50 inline-flex flex-col items-stretch",onMouseEnter:s,onMouseLeave:i,children:[b.jsx("div",{ref:e,className:"overflow-hidden",style:{maxHeight:0},children:b.jsx("img",{ref:t,src:"guy.png",alt:"",className:"pointer-events-none object-contain block w-full",style:{transform:"scale(0)",transformOrigin:"bottom center"}})}),b.jsx("a",{href:"https://ko-fi.com/gmtfractals",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 px-3 py-1 rounded bg-[#13C3FF] hover:bg-[#00b0f0] text-white text-[11px] font-bold transition-colors",children:"Support GMT"})]})}function Da(){const e=Y(o=>o.iters),t=Y(o=>o.setIters);return b.jsxs("div",{className:"font-mono bg-[#080808] text-gray-200 h-screen flex flex-col overflow-hidden",children:[b.jsx("h1",{className:"text-sm font-bold text-white tracking-wide px-5 pt-4 pb-2 shrink-0",children:"GMT — Fractal Mesh Export"}),b.jsxs("div",{className:"flex gap-4 flex-1 min-h-0 px-5 pb-4",children:[b.jsxs("div",{className:"flex flex-col gap-2.5 w-[340px] shrink-0 overflow-y-auto pr-1",children:[b.jsx("div",{className:"bg-black/60 border border-white/10 rounded p-3",children:b.jsx(et,{label:"Export",defaultOpen:!0,children:b.jsx(Ma,{})})}),b.jsx("div",{className:"bg-black/60 border border-white/10 rounded p-3",children:b.jsx(mn,{})}),b.jsx("div",{className:"bg-black/60 border border-white/10 rounded p-3",children:b.jsx(et,{label:"Bounds",defaultOpen:!0,children:b.jsx(aa,{})})})]}),b.jsxs("div",{className:"flex flex-col gap-2.5 flex-1 min-w-0 items-center",children:[b.jsx(Aa,{}),b.jsx(sa,{})]}),b.jsxs("div",{className:"flex flex-col gap-2.5 w-[300px] shrink-0 overflow-y-auto pl-1",children:[b.jsx("div",{className:"bg-black/60 border border-white/10 rounded p-3",children:b.jsx(et,{label:"Formula",defaultOpen:!0,children:b.jsxs("div",{className:"flex flex-col gap-2 mt-1",children:[b.jsx(dn,{}),b.jsx(Pe,{label:"Iterations",value:e,onChange:t,min:2,max:64,step:1,variant:"full"})]})})}),b.jsx("div",{className:"bg-black/60 border border-white/10 rounded p-3",children:b.jsx(et,{label:"Parameters",defaultOpen:!0,children:b.jsxs("div",{className:"flex flex-col gap-1 mt-1",children:[b.jsx(Fo,{}),b.jsx(Ia,{})]})})})]})]}),b.jsx(Ra,{})]})}So();function La(){const e=de.useRef(!1);return de.useEffect(()=>{if(e.current)return;e.current=!0;try{const o=localStorage.getItem("gmt-mesh-export-scene");if(o){localStorage.removeItem("gmt-mesh-export-scene"),Mo(o,"(from main app)");return}}catch(o){console.warn("[MeshExport] Auto-load from main app failed:",o)}const t=Y.getState();if(!t.loadedDefinition){const o=Oe.get(t.selectedFormulaId);o&&(t.setLoadedDefinition(o),t.setFormulaParams(Co(o)))}},[]),b.jsx(Da,{})}const Xo=document.getElementById("root");if(!Xo)throw new Error("Could not find root element to mount to");const _a=rn.createRoot(Xo);_a.render(b.jsx(we.StrictMode,{children:b.jsx(La,{})}));
