...
`)}),e+=`
in vec2 vUv;
`,e},An=Pn(),lo=(e,t="",o,n="",s="",r="",a="",i="",l="",f="",v="",m="",d="")=>{const x=r.includes("skipMainFormula");return`
${o}
...
`}const v=In(this.materialLogic.join(`
...
`)),g=d?Bt(this.isLite,!1,this.precisionMode,0,"","","traceSceneLean"):"",y=Dn(d,this.maxLights,this.compositeLogic.join(`
