var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,l as D,F as p,m as g,u as m,j as l,S as j,c as $,z as B,i as O,k}from"./CollapsibleSection-G3oOVzde.js";import{g as V,b as N,D as G,a as H}from"./DraggableWindow-DOMDEqQ8.js";import{V as X,i as q,c as Y}from"./Camera-CMSzKvim.js";import{r as v,R as W}from"./react-KfUPlHYY.js";import{A as Q}from"./AppErrorBoundary-Cabj13YF.js";import{m as S,E as Z,D as K,P as J,a as ee,T as te,c as ae,i as oe,b as ie}from"./PwaUpdate-D4Cm9yR4.js";import{b as w,v as A,c as re,T as ne,G as se,r as le,d as ce,i as fe,a as me}from"./Undo-oh6ZRLp6.js";import{C as ue}from"./CompilingIndicator-CAi6RXRj.js";import{r as de}from"./cameraKeyRegistry-Dpu8jLyQ.js";import"./pako-DwGzBETv.js";import"./three-0VA8E5V9.js";import"./CompositionOverlay-B9OVSzE5.js";import"./accordionReveal-BI7romxl.js";const u=new Map,R=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),V(t.name)||N({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},he=`
