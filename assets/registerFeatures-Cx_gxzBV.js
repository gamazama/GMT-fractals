var Se=Object.defineProperty;var we=(e,t,a)=>t in e?Se(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var $=(e,t,a)=>we(e,typeof t!="symbol"?t+"":t,a);import{an as b,ax as A,ci as M,af as m,cj as _e,aS as f,f as u,ck as Fe,cl as Ie,cm as Me,cn as Ce,co as Pe,cp as Te,x as X,I as Ee,u as Ae,cq as De}from"./CollapsibleSection-DtGwkkFZ.js";import{n as w,d as B,p as Re,q as Be,r as U,s as Z,c as h,l as O}from"./three-DQWx7qFd.js";import{u as Le,r as ke,a as V,s as Oe,b as Ne,aD as Ve}from"./FormulaFormat-DmxxVCdY.js";import{a as re,b as je}from"./gradientSeam-F9vRuw30.js";import{a as Ge}from"./three-drei-D2x72drd.js";const Y=`
...
`,Ze={id:"droste",shortId:"dr",name:"Droste Effect",category:"Effects",params:{active:{type:"boolean",default:!1,label:"Droste Effect",shortId:"ac",uniform:"uDrosteActive",group:"main",noAccumReset:!0,description:"Enable the recursive Droste image-in-image post effect.",helpId:"effect.droste"},tiling:{type:"float",default:1,label:"Tiling Mode",shortId:"tm",uniform:"uDrosteTiling",group:"geometry",noAccumReset:!0,condition:{param:"active",bool:!0},options:[{label:"Repeat",value:0},{label:"Mirror",value:1},{label:"Clamp",value:2},{label:"Transparent",value:3}],description:"How sampled coordinates wrap outside the source rectangle.",helpId:"droste.geometry"},center:{type:"vec2",default:new B(0,0),label:"Center Shift",shortId:"cs",uniform:"uDrosteCenter",min:-100,max:100,step:.1,group:"geometry",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Pixel offset of the spiral centre on screen.",helpId:"droste.geometry"},radiusInside:{type:"float",default:5,label:"Inner Rad",shortId:"r1",uniform:"uDrosteR1",min:.1,max:100,step:.1,group:"geometry",layout:"half",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Inner ring radius of the recursion.",helpId:"droste.geometry"},radiusOutside:{type:"float",default:100,label:"Outer Rad",shortId:"r2",uniform:"uDrosteR2",min:1,max:200,step:.1,group:"geometry",layout:"half",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Outer ring radius; ratio with inner controls scaling per loop.",helpId:"droste.geometry"},strands:{type:"float",default:2,label:"Strands",shortId:"p2",uniform:"uDrosteStrands",min:-12,max:12,step:1,group:"structure",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Number of spiral arms (sign flips chirality).",helpId:"droste.structure"},strandMirror:{type:"boolean",default:!1,label:"Mirror Strand",shortId:"sm",uniform:"uDrosteMirror",group:"structure",parentId:"strands",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Mirrors alternating strands for kaleidoscopic symmetry.",helpId:"droste.structure"},autoPeriodicity:{type:"boolean",default:!1,label:"Auto Period",shortId:"ap",uniform:"uDrosteAuto",group:"structure",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Solve periodicity automatically from inner/outer radii.",helpId:"droste.structure"},periodicity:{type:"float",default:2,label:"Periodicity",shortId:"p1",uniform:"uDrostePeriodicity",min:-10,max:10,step:.1,group:"structure",parentId:"autoPeriodicity",condition:[{param:"active",bool:!0},{param:"autoPeriodicity",bool:!1}],noAccumReset:!0,description:"How many recursion loops complete before tiling repeats.",helpId:"droste.structure"},zoom:{type:"float",default:0,label:"Zoom",shortId:"zm",uniform:"uDrosteZoom",min:-10,max:10,step:.1,group:"transform",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Zoom along the spiral; animate to drive infinite-zoom motion.",helpId:"droste.transform"},rotate:{type:"float",default:0,label:"Spiral Rotate",shortId:"ro",uniform:"uDrosteRotate",min:-360,max:360,step:1,group:"transform",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Twist of the spiral path in degrees.",helpId:"droste.transform"},rotateSpin:{type:"float",default:0,label:"Image Spin",shortId:"sp",uniform:"uDrosteSpin",min:-360,max:360,step:1,group:"transform",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Rotates the sampled image content independently of the spiral.",helpId:"droste.transform"},rotatePolar:{type:"float",default:0,label:"Polar Rotate",shortId:"pr",uniform:"uDrostePolar",min:-360,max:360,step:1,group:"transform",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Rotates the polar coordinate map before applying the spiral.",helpId:"droste.transform"},twist:{type:"boolean",default:!0,label:"Twist (Conformal)",shortId:"tw",uniform:"uDrosteTwist",group:"transform",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Use the conformal Escher mapping; off gives a non-conformal spiral.",helpId:"droste.transform"},hyperDroste:{type:"boolean",default:!1,label:"Hyper Droste",shortId:"hd",uniform:"uDrosteHyper",group:"transform",condition:{param:"active",bool:!0},noAccumReset:!0,description:"Modular multi-point variant of the Droste mapping.",helpId:"droste.transform"},fractalPoints:{type:"float",default:1,label:"Fractal Points",shortId:"fp",uniform:"uDrosteFractal",min:0,max:10,step:1,group:"transform",parentId:"hyperDroste",condition:[{param:"active",bool:!0},{param:"hyperDroste",bool:!0}],noAccumReset:!0,description:"Number of fractal centres in the Hyper Droste mapping.",helpId:"droste.transform"}},postShader:{functions:Ue,mainUV:`
...
`,Ke={id:"materials",shortId:"m",name:"Material",category:"Rendering",tabConfig:{label:"Shader"},groups:{surface:{label:"Surface",description:"Direct-light shading on the fractal surface.",helpId:"mat.surface"},env:{label:"Environment",description:"Image-based lighting and sky source for indirect light.",helpId:"mat.env"},emission:{label:"Self-Illumination",description:"Surface glow that emits its own light independently of scene lighting.",helpId:"mat.emission"}},params:{diffuse:{type:"float",default:1,label:"Diffuse (Color)",shortId:"di",uniform:"uDiffuse",min:0,max:2,step:.01,group:"surface",description:"Strength of the gradient colour applied to lit surfaces.",helpId:"mat.diffuse"},reflection:{type:"float",default:0,label:"Metallic",shortId:"re",uniform:"uReflection",min:0,max:1,step:.01,group:"surface",description:"Tints highlights with the surface colour as the surface gets more metallic.",helpId:"mat.metallic"},specular:{type:"float",default:.3,label:"Reflectivity",shortId:"sp",uniform:"uSpecular",min:0,max:2,step:.01,group:"surface",description:"Brightness of direct-light specular highlights.",helpId:"mat.specular"},roughness:{type:"float",default:.5,label:"Roughness",shortId:"ro",uniform:"uRoughness",min:.001,max:1,step:.001,group:"surface",description:"Spreads highlights wider as roughness increases.",helpId:"mat.roughness"},rim:{type:"float",default:0,label:"Rim Light",shortId:"ri",uniform:"uRim",min:0,max:5,step:.01,group:"surface",description:"Adds a glow along edges that face away from the camera.",helpId:"mat.rim"},rimExponent:{type:"float",default:4,label:"Rim Sharpness",shortId:"rx",uniform:"uRimExponent",min:1,max:16,step:.1,group:"surface",parentId:"rim",condition:{gt:0},description:"Higher values keep the rim glow tight to the silhouette.",helpId:"mat.rim"},rimColor:{type:"color",default:new w(.5,.7,1),label:"Rim Color",shortId:"rc",uniform:"uRimColor",group:"surface",parentId:"rim",condition:{gt:0},description:"Tint of the rim glow.",helpId:"mat.rim"},envStrength:{type:"float",default:0,label:"Environment Light",shortId:"es",uniform:"uEnvStrengthSlider",min:0,max:5,step:.01,group:"env",description:"Brightness of the sky-based reflection on the surface.",helpId:"mat.env"},envBackgroundStrength:{type:"float",default:0,label:"BG Visibility",shortId:"eb",uniform:"uEnvBackgroundStrength",min:0,max:2,step:.01,group:"env",parentId:"envStrength",condition:{gt:0,param:"envStrength"},description:"How visible the sky is behind the fractal (0 = black background).",helpId:"mat.env"},envSource:{type:"float",default:1,label:"Source",shortId:"eo",uniform:"uEnvSource",group:"env",parentId:"envStrength",condition:{gt:0,param:"envStrength"},options:[{label:"Sky Image",value:0},{label:"Gradient",value:1}],description:"Whether the environment uses a panorama image or a procedural gradient.",helpId:"mat.env"},envMapData:{type:"image",default:null,label:"Upload Texture",shortId:"et",group:"env",parentId:"envSource",condition:{eq:0},uniform:"uEnvMapTexture",textureSettings:{mapping:Be,minFilter:Re,generateMipmaps:!0},linkedParams:{colorSpace:"envMapColorSpace"},description:"Equirectangular HDR or LDR image used as the sky.",helpId:"mat.env"},envMapColorSpace:{type:"float",default:0,label:"Env Profile",shortId:"ec",uniform:"uEnvMapColorSpace",group:"env",hidden:!0},useEnvMap:{type:"boolean",default:!1,label:"Use Env Map",shortId:"eu",uniform:"uUseEnvMap",hidden:!0,group:"env"},envRotation:{type:"float",default:0,label:"Rotation",shortId:"er",uniform:"uEnvRotation",min:0,max:6.28,step:.01,group:"env",parentId:"envSource",condition:[{param:"envStrength",gt:0},{param:"envSource",eq:0}],description:"Spins the sky image around the vertical axis.",helpId:"mat.env"},envGradientStops:{type:"gradient",default:[{id:"sky",position:0,color:"#000000",bias:.5,interpolation:"smooth"},{id:"hor",position:.5,color:"#223344",bias:.5,interpolation:"smooth"},{id:"zen",position:1,color:"#88ccff",bias:.5,interpolation:"smooth"}],label:"Sky Gradient",shortId:"eg",uniform:"uEnvGradient",group:"env",parentId:"envSource",condition:{eq:1},description:"Vertical sky gradient: ground colour to zenith.",helpId:"mat.env"},emission:{type:"float",default:0,label:"Self-illumination",shortId:"em",uniform:"uEmission",min:0,max:5,step:.001,scale:"square",group:"emission",description:"How brightly the surface glows on its own, independent of lights.",helpId:"mat.emission"},emissionMode:{type:"float",default:0,label:"Emission Source",shortId:"ec",uniform:"uEmissionMode",min:0,max:4,step:1,group:"emission",parentId:"emission",condition:{gt:1e-4},options:[{label:"Full Surface",value:0},{label:"Layer 1",value:1},{label:"Layer 2",value:2},{label:"Layer 3",value:3},{label:"Solid Color",value:4}],description:"Which part of the surface colour drives the glow.",helpId:"mat.emission"},emissionColor:{type:"color",default:new w(1,1,1),label:"Solid Color",shortId:"el",uniform:"uEmissionColor",group:"emission",parentId:"emissionMode",condition:{eq:4},description:"Constant glow tint when Emission Source is Solid Color.",helpId:"mat.emission"},ptEmissionMult:{type:"float",default:1,label:"Illumination Power",shortId:"ep",uniform:"uPTEmissionMult",min:0,max:10,step:.1,group:"emission",parentId:"emission",condition:[{gt:1e-4},{param:"$renderMode",eq:"PathTracing"}],description:"Path-tracing only: boosts how much light the glow casts onto other surfaces.",helpId:"mat.emission"}},inject:(e,t,a)=>{a!=="Mesh"&&(e.addHeader(We),e.addMaterialLogic(Qe),e.addFunction(Ye))}},Je={id:"texturing",shortId:"tx",name:"Texture",category:"Coloring",groups:{main:{label:"Image",description:"Image texture sampled instead of the gradient for layer 1.",helpId:"grad.texture"},mapping:{label:"Mapping",description:"How the image projects onto fractal surfaces.",helpId:"grad.texture"},transform:{label:"Transform",description:"Rotation and scaling applied to the texture lookup.",helpId:"grad.texture"}},params:{active:{type:"boolean",default:!1,label:"Use Texture",shortId:"ac",uniform:"uUseTexture",group:"main",hidden:!0,onUpdate:"compile",noAccumReset:!0},layer1Data:{type:"image",default:null,label:"Select Image",shortId:"id",group:"main",uniform:"uTexture",textureSettings:{wrapS:Z,wrapT:Z,minFilter:U,magFilter:U},linkedParams:{colorSpace:"colorSpace"}},colorSpace:{type:"float",default:0,label:"Color Profile",shortId:"cs",uniform:"uTextureColorSpace",group:"main",hidden:!0},mapU:{type:"float",default:6,label:"Texture U Mode",shortId:"mu",uniform:"uTextureModeU",group:"mapping",layout:"half",options:[{label:"Orbit Trap",value:0},{label:"Iterations",value:1},{label:"Radial",value:2},{label:"Z-Depth",value:3},{label:"Angle",value:4},{label:"Normal",value:5},{label:"Decomposition",value:6},{label:"Raw Iterations",value:7},{label:"Potential (Log-Log)",value:8},{label:"Green's Flow",value:9}]},mapV:{type:"float",default:1,label:"Texture V Mode",shortId:"mv",uniform:"uTextureModeV",group:"mapping",layout:"half",options:[{label:"Orbit Trap",value:0},{label:"Iterations",value:1},{label:"Radial",value:2},{label:"Z-Depth",value:3},{label:"Angle",value:4},{label:"Normal",value:5},{label:"Decomposition",value:6},{label:"Raw Iterations",value:7},{label:"Potential (Log-Log)",value:8},{label:"Green's Flow",value:9}]},textureScale:{type:"vec2",default:new B(1,1),label:"Scale UV",shortId:"ts",uniform:"uTextureScale",min:.1,max:500,step:.1,scale:"log",group:"transform"},offset:{type:"vec2",default:new B(0,0),label:"Texture Offset",shortId:"of",uniform:"uTextureOffset",min:-2,max:2,step:.01,group:"transform"}},inject:(e,t)=>{const a=t.texturing;a!=null&&a.active&&e.addDefine("USE_TEXTURE")}},ne=[{value:0,label:"Orbit Trap",description:"Colors based on how close the orbit came to the origin or geometric traps.",glsl:"v = logTrap(result.y);"},{value:1,label:"Iterations",description:"Smooth gradients based on how long it took to escape. The classic look.",glsl:`
    ...
    float getMappingValue(float mode, vec3 p, vec4 result, vec3 n, float repeatScale) {
        ...
        switch(int(mode + 0.1)) {
    `;return ne.forEach(t=>{e+=`
        case ${Math.round(t.value)}: { // ${t.label}
            ${t.glsl}
        } break;`}),e+=`
        default: // Fallback
            v = result.z;
    ...
    `,e},Q=ne.map(e=>({label:e.label,value:e.value})),tt={id:"coloring",shortId:"cl",name:"Coloring",category:"Visuals",tabConfig:{label:"Gradient"},groups:{layer1_top:{label:"Mapping",description:"How fractal data feeds the gradient lookup.",helpId:"grad.mapping"},layer1_grad:{label:"Gradient",helpId:"grad.editor"},layer1_hist:{label:"Histogram",helpId:"grad.params"},layer1_bottom:{label:"Output",description:"Final adjustments applied after the gradient lookup.",helpId:"grad.escape"},layer2_top:{label:"Mapping",description:"Layer 2 mapping mode and blend.",helpId:"grad.mapping"},layer2_grad:{label:"Gradient",helpId:"grad.editor"},layer2_hist:{label:"Histogram",helpId:"grad.params"},layer2_bottom:{label:"Output",helpId:"grad.escape"},noise:{label:"Noise",description:"High-frequency noise mixed into the surface colour.",helpId:"grad.noise"},trap_geom:{label:"Geometric Orbit Trap",description:"Geometric shape for orbit trap accumulation (pairs with Geometric Orbit Trap mapping mode)."}},customUI:[{componentId:"coloring-histogram",group:"layer1_hist",props:{layer:1}},{componentId:"coloring-histogram",group:"layer2_hist",props:{layer:2}}],params:{gradient:{type:"gradient",default:[{id:"2",position:1,color:"#ffffff",bias:.5,interpolation:"linear"}],label:"Gradient",shortId:"g1",uniform:"uGradientTexture",group:"layer1_grad",description:"Colour ramp sampled by Layer 1 mapping values.",helpId:"grad.editor"},mode:{type:"float",default:0,label:"Mapping",shortId:"m1",uniform:"uColorMode",group:"layer1_top",options:Q,description:"Which fractal quantity drives the gradient lookup.",helpId:"grad.mapping"},scale:{type:"float",default:1,label:"Scale",shortId:"s1",uniform:"uColorScale",group:"layer1_hist",hidden:!0},offset:{type:"float",default:0,label:"Offset",shortId:"o1",uniform:"uColorOffset",group:"layer1_hist",hidden:!0},repeats:{type:"float",default:1,label:"Repeats",shortId:"r1",min:.1,max:100,step:.1,scale:"log",group:"layer1_hist",hidden:!0},phase:{type:"float",default:0,label:"Phase",shortId:"p1",min:-1,max:1,step:.01,group:"layer1_hist",hidden:!0},bias:{type:"float",default:1,label:"Gamma",shortId:"b1",uniform:"uGradientBias",min:.1,max:10,step:.01,group:"layer1_hist",hidden:!0},colorIter:{type:"float",default:0,label:"Color Iterations",shortId:"ci",uniform:"uColorIter",min:0,max:24,step:1,group:"layer1_bottom",description:"Stop orbit trap capture at this iteration (0 = use all iterations)",helpId:"grad.escape",condition:{or:[{param:"mode",eq:0},{param:"mode",eq:1},{param:"mode",eq:7},{param:"mode",eq:8},{param:"mode",eq:9},{param:"mode",eq:10},{param:"mode",eq:11},{param:"mode",eq:12},{param:"mode",eq:13},{param:"mode",eq:14},{param:"mode2",eq:0},{param:"mode2",eq:1},{param:"mode2",eq:7},{param:"mode2",eq:8},{param:"mode2",eq:9},{param:"mode2",eq:10},{param:"mode2",eq:11},{param:"mode2",eq:12},{param:"mode2",eq:13},{param:"mode2",eq:14}]}},twist:{type:"float",default:0,label:"Twist",shortId:"w1",uniform:"uColorTwist",min:-5,max:5,step:.05,group:"layer1_bottom",description:"Winds the gradient into a logarithmic spiral around the fractal axis. Scale-invariant (looks the same at any zoom). 0 = off. Pair with Arms for multi-armed spirals.",helpId:"grad.escape"},twistArms:{type:"float",default:0,label:"Arms",shortId:"wa1",uniform:"uColorTwistArms",min:-8,max:8,step:1,group:"layer1_bottom",description:"Number of angular colour arms. Integer values are seam-free. 0 = concentric rings; combine with Twist for N-armed spirals.",helpId:"grad.escape"},escape:{type:"float",default:4,label:"Escape Radius",shortId:"e1",uniform:"uEscapeThresh",min:1,max:1e3,step:.1,scale:"log",group:"layer1_bottom",description:"Orbit magnitude² at which a point is treated as escaped, used by the Potential, Decomposition and Green's-Flow coloring modes (and the smooth-iteration normalization). Purely a coloring control — the geometry bailout is the separate Quality → DE Bailout.",helpId:"grad.escape",condition:{or:[{param:"mode",eq:6},{param:"mode",eq:8},{param:"mode",eq:9},{param:"mode2",eq:6},{param:"mode2",eq:8},{param:"mode2",eq:9},{and:[{param:"$texturing.active",bool:!0},{or:[{param:"$texturing.mapU",eq:6},{param:"$texturing.mapU",eq:8},{param:"$texturing.mapU",eq:9},{param:"$texturing.mapV",eq:6},{param:"$texturing.mapV",eq:8},{param:"$texturing.mapV",eq:9}]}]}]}},gradient2:{type:"gradient",default:[{id:"1",position:0,color:"#000000"},{id:"2",position:1,color:"#ffffff"}],label:"Gradient 2",shortId:"g2",uniform:"uGradientTexture2",group:"layer2_grad",description:"Colour ramp sampled by Layer 2 mapping values, blended over Layer 1.",helpId:"grad.editor"},mode2:{type:"float",default:4,label:"Mapping",shortId:"m2",uniform:"uColorMode2",group:"layer2_top",options:Q,description:"Which fractal quantity drives the Layer 2 gradient lookup.",helpId:"grad.mapping"},scale2:{type:"float",default:1,label:"Scale 2",shortId:"s2",uniform:"uColorScale2",group:"layer2_hist",hidden:!0},offset2:{type:"float",default:0,label:"Offset 2",shortId:"o2",uniform:"uColorOffset2",group:"layer2_hist",hidden:!0},repeats2:{type:"float",default:1,label:"Repeats",shortId:"r2",min:.1,max:100,step:.1,scale:"log",group:"layer2_hist",hidden:!0},phase2:{type:"float",default:0,label:"Phase",shortId:"p2",min:-1,max:1,step:.01,group:"layer2_hist",hidden:!0},bias2:{type:"float",default:1,label:"Gamma",shortId:"b2",uniform:"uGradientBias2",min:.1,max:10,step:.01,group:"layer2_hist",hidden:!0},twist2:{type:"float",default:0,label:"Twist",shortId:"w2",uniform:"uColorTwist2",min:-5,max:5,step:.05,group:"layer2_bottom",description:"Winds Layer 2 into a logarithmic spiral around the fractal axis. Scale-invariant. 0 = off. Pair with Arms for multi-armed spirals.",helpId:"grad.escape"},twistArms2:{type:"float",default:0,label:"Arms",shortId:"wa2",uniform:"uColorTwistArms2",min:-8,max:8,step:1,group:"layer2_bottom",description:"Number of angular colour arms for Layer 2. Integer values are seam-free. 0 = concentric rings.",helpId:"grad.escape"},blendMode:{type:"float",default:0,label:"Blend Mode",shortId:"bm",uniform:"uBlendMode",group:"layer2_bottom",options:[{label:"Mix",value:0},{label:"Add",value:1},{label:"Multiply",value:2},{label:"Overlay",value:3},{label:"Screen",value:4},{label:"Bump (Normal)",value:6}],description:"How Layer 2 combines with Layer 1 (mix, add, multiply, overlay, screen, bump).",helpId:"grad.escape"},blendOpacity:{type:"float",default:0,label:"Blend Amount",shortId:"bo",uniform:"uBlendOpacity",min:0,max:1,step:.01,group:"layer2_bottom",description:"Strength of the Layer 2 blend over Layer 1.",helpId:"grad.escape"},layer3Color:{type:"color",default:new w(1,1,1),label:"Noise Color",shortId:"n3c",uniform:"uLayer3Color",group:"noise",layout:"embedded",description:"Tint of the procedural noise overlay.",helpId:"grad.noise"},layer3Scale:{type:"float",default:2,label:"Noise Scale",shortId:"n3s",uniform:"uLayer3Scale",min:.1,max:2e3,step:.1,scale:"log",group:"noise",description:"Frequency of the noise pattern; higher = finer detail.",helpId:"grad.noise"},layer3Strength:{type:"float",default:0,label:"Mix Strength",shortId:"n3a",uniform:"uLayer3Strength",min:0,max:1,step:.01,group:"noise",description:"How strongly the noise tint mixes into the surface colour.",helpId:"grad.noise"},layer3Bump:{type:"float",default:0,label:"Bump",shortId:"n3b",uniform:"uLayer3Bump",min:-1,max:1,step:.01,group:"noise",description:"Perturbs surface normals with the noise pattern for fake displacement.",helpId:"grad.noise"},layer3Turbulence:{type:"float",default:0,label:"Turbulence",shortId:"n3t",uniform:"uLayer3Turbulence",min:0,max:2,step:.01,group:"noise",description:"Adds higher-frequency octaves on top of the base noise.",helpId:"grad.noise"},layer3Enabled:{type:"boolean",default:!0,label:"Load Noise (Layer 3)",shortId:"l3e",group:"engine_settings",ui:"checkbox",description:"Compiles simplex noise into the shader. Disable to reduce compile time when Layer 3 is not needed.",onUpdate:"compile",noAccumReset:!0},trapEnabled:{type:"boolean",default:!1,label:"Geometric Orbit Trap",shortId:"ten",group:"trap_geom",onUpdate:"compile",description:'Compiles per-iteration geometric trap distance into the shader. Select shape + mapping mode "Geometric Orbit Trap" to colour by trap distance.'},trapShape:{type:"float",default:1,label:"Shape",shortId:"tsh",uniform:"uTrapShape",group:"trap_geom",options:[{label:"Point",value:1},{label:"Sphere",value:2},{label:"Cross",value:3},{label:"Plane",value:4}],description:"Geometric shape to measure orbit distance against."},trapCenter:{type:"vec3",default:new h(0,0,0),label:"Center",shortId:"tce",uniform:"uTrapCenter",group:"trap_geom",min:-10,max:10,step:.01},trapRadius:{type:"float",default:1,label:"Radius",shortId:"tra",uniform:"uTrapRadius",group:"trap_geom",min:0,max:10,step:.01,condition:{param:"trapShape",eq:2}},trapNormal:{type:"vec3",default:new h(0,1,0),label:"Normal",shortId:"tno",uniform:"uTrapNormal",group:"trap_geom",min:-1,max:1,step:.01,condition:{param:"trapShape",eq:4}},trapOffset:{type:"float",default:0,label:"Offset",shortId:"tof",uniform:"uTrapOffset",group:"trap_geom",min:-10,max:10,step:.01,condition:{param:"trapShape",eq:4}}},inject:(e,t,a)=>{const o=t.coloring;(o==null?void 0:o.layer3Enabled)!==!1&&e.addDefine("LAYER3_ENABLED","1"),e.addPreamble("vec4 g_orbitTrap = vec4(1e10);"),e.addPreamble("float g_geomTrap = 1e10;"),e.addPreamble("float g_geomTrapFinal = 1e10;"),e.addPreamble("float escape = 0.0;"),o!=null&&o.trapEnabled&&(e.addDefine("TRAP_ENABLED","1"),e.addHybridFold("","",`
...
#endif
            `)),a==="Main"||a==="Histogram"?e.addFunction(et()):e.addFunction(`
                float getMappingValue(float mode, vec3 p, vec4 result, vec3 n, float repeatScale) { return 0.0; }
            `)}},at={id:"standard",label:"Standard (Tglad)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = clamp(z, -foldLimit, foldLimit) * 2.0 - z;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2}},ot={id:"mirror",label:"Mirror",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = foldLimit - abs(abs(z) - foldLimit);
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},it={id:"half",label:"Half-fold",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = abs(z + foldLimit);
}
`,defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:2}},rt={id:"decoupled",label:"Decoupled",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,extraParams:{hybridFoldingValue:{type:"vec3",default:new h(2,2,2),label:"Folding Value",shortId:"hfv",uniform:"uHybridFoldingValue",min:.1,max:5,step:.01,group:"hybrid"}},defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2,hybridFoldingValue:{x:2,y:2,z:2}}},nt={id:"kali",label:"Kali",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = uHybridKaliConstant - abs(z);
}
`,rotMode:"post",extraParams:{hybridKaliConstant:{type:"vec3",default:new h(1,1,1),label:"Kali Constant",shortId:"hkc",uniform:"uHybridKaliConstant",min:-3,max:3,step:.01,group:"hybrid"}},defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.6,hybridFixedR:1,hybridIter:3,hybridKaliConstant:{x:.5,y:.5,z:.5}}},lt={id:"tetra",label:"Tetrahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    if (z.x + z.y < 0.0) z.xy = -z.yx;
    if (z.x + z.z < 0.0) z.xz = -z.zx;
    if (z.y + z.z < 0.0) z.yz = -z.zy;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.25,hybridFixedR:1,hybridIter:3}},st={id:"octa",label:"Octahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},dt={id:"icosa",label:"Icosahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:4}},ct={id:"menger",label:"Menger (Cubic)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,selfContained:!0,extraParams:{hybridMengerOffset:{type:"vec3",default:new h(1,1,1),label:"Offset",shortId:"hmo",uniform:"uHybridMengerOffset",min:0,max:2,step:.01,group:"hybrid",linkable:!0},hybridMengerCenterZ:{type:"boolean",default:!0,label:"Center Z",shortId:"hmz",uniform:"uHybridMengerCenterZ",group:"hybrid"}},defaults:{hybridScale:3,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3,hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0}},L=[at,ot,it,rt,nt,lt,st,dt,ct],pt=L.map((e,t)=>({label:e.label,value:t}));function ft(e){return L[e]??L[0]}const ut=`
...
`,mt=["xyz","xzy","yxz","yzx","zxy","zyx"];function ht(e){const t=mt[e]??"xyz";return t==="xyz"?"vec3 c_perm = c.xyz;":`vec3 c_perm = c.${t};`}function gt(e,t,a=!1){return`
mat3 hybridRotMat;
bool hybridHasRot;
...
void formula_Hybrid(inout vec4 z, inout float dr, inout float trap, vec4 c) {
    ...
    ${t==="wrap"?"if (hybridHasRot) z3 = hybridRotMat * z3;":""}
    z3 += uHybridShift;
...
`}function yt(){const e={};return L.forEach((t,a)=>{t.extraParams&&Object.entries(t.extraParams).forEach(([o,i])=>{e[o]={...i,condition:[{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0},{param:"hybridFoldType",eq:a}]}})}),e}const bt={id:"geometry",shortId:"g",name:"Geometry",category:"Formulas",customUI:[{componentId:"interaction-picker",group:"julia",parentId:"juliaMode",condition:{bool:!0},props:{targetMode:"picking_julia",label:"Pick Coordinate",activeLabel:"Cancel Picking",helpText:"Click any point on the fractal surface to set Julia coordinates.",variant:"primary"}},{componentId:"julia-randomize",group:"julia",parentId:"juliaMode",condition:{bool:!0}}],engineConfig:{toggleParam:"applyTransformLogic",mode:"compile",label:"Geometry Modifiers",groupFilter:"engine_settings"},panelConfig:{compileParam:"hybridCompiled",runtimeToggleParam:"hybridMode",compileSettingsParams:["hybridFoldType","hybridComplex","hybridSwap","hybridPermute"],runtimeGroup:"hybrid",runtimeExcludeParams:["hybridMode"],label:"Hybrid Box Fold",compileMessage:"Compiling Hybrid Shader...",helpId:"hybrid.mode"},params:{applyTransformLogic:{type:"boolean",default:!0,label:"Geometry Engine",shortId:"gt",group:"main",description:"Master switch for geometry modifiers (Julia, Rotation, Hybrid).",noAccumReset:!0,hidden:!0},preRotMaster:{type:"boolean",default:!0,label:"Enable Rotation",shortId:"rm",group:"engine_settings",ui:"checkbox",description:"Compiles rotation matrix logic. Disable for speed.",onUpdate:"compile",noAccumReset:!0,estCompileMs:600},hybridCompiled:{type:"boolean",default:!1,label:"Hybrid Box Fold",shortId:"hcm",group:"engine_settings",ui:"checkbox",description:"Compiles hybrid box fold system into shader. Toggle effect on/off instantly from Formula panel.",onUpdate:"compile",noAccumReset:!0,estCompileMs:1200},hybridMode:{type:"boolean",default:!1,label:"Hybrid Active",shortId:"hm",uniform:"uHybrid",group:"hybrid",hidden:!0},hybridFoldType:{type:"float",default:0,label:"Fold Type",shortId:"hft",group:"engine_settings",options:pt.map(e=>({...e,estCompileMs:400})),description:"Box fold algorithm. Each type produces fundamentally different geometry.",onUpdate:"compile",noAccumReset:!0,condition:{param:"hybridCompiled",bool:!0}},hybridComplex:{type:"boolean",default:!1,label:"Interleaved Mode",shortId:"hx",group:"engine_settings",ui:"checkbox",description:"Interleaves fold with fractal formula (Box → Fractal → Box). Slow compile.",onUpdate:"compile",noAccumReset:!0,estCompileMs:1500,condition:{param:"hybridCompiled",bool:!0}},hybridPermute:{type:"float",default:0,label:"Axis Permutation",shortId:"hpe",group:"engine_settings",options:[{label:"XYZ (Default)",value:0},{label:"XZY",value:1},{label:"YXZ",value:2},{label:"YZX",value:3},{label:"ZXY",value:4},{label:"ZYX",value:5}],description:"Permutes the constant (c) axis mapping. Changes fractal topology.",onUpdate:"compile",noAccumReset:!0,condition:{param:"hybridCompiled",bool:!0}},burningEnabled:{type:"boolean",default:!1,label:"Burning Mode",shortId:"bm",group:"burning",description:'Applies absolute value to coordinates every iteration. Creates "Burning Ship" variations.',uniform:"uBurningEnabled",onUpdate:"compile",noAccumReset:!0},burningRuntime:{type:"boolean",default:!1,label:"Burning Active",shortId:"br",uniform:"uBurningRuntime",group:"burning",hidden:!0},burningMix:{type:"float",default:1,label:"Mix",shortId:"bmx",uniform:"uBurningMix",min:0,max:1,step:.01,group:"burning",condition:{param:"burningEnabled",bool:!0},description:"Blend between original coordinates (0) and absolute-value coordinates (1)."},hybridIter:{type:"float",default:2,label:"Iterations",shortId:"hi",uniform:"uHybridIter",min:0,max:10,step:1,group:"hybrid",condition:[{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0}]},hybridFoldLimit:{type:"float",default:1,label:"Fold Limit",shortId:"hl",uniform:"uHybridFoldLimit",min:.1,max:2,step:.01,group:"hybrid",condition:[{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0}],hidden:!0},hybridFoldLimitVec:{type:"vec3",default:new h(1,1,1),label:"Fold Limit",shortId:"hlv",uniform:"uHybridFoldLimitVec",min:.1,max:3,step:.01,group:"hybrid",condition:[{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0},{param:"hybridFoldType",lt:4}],linkable:!0},hybridScale:{type:"float",default:2,label:"Scale",shortId:"hs",uniform:"uHybridScale",min:.5,max:3,step:.01,group:"hybrid",condition:[{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0}]},hybridScaleVary:{type:"float",default:0,label:"Scale Variation",shortId:"hsv",uniform:"uHybridScaleVary",min:-1,max:1,step:.01,group:"hybrid",condition:[{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0}],description:"Dynamic scale feedback per iteration (ABoxVaryScale)."},hybridMinR:{type:"float",default:.5,label:"Min Radius",shortId:"hn",uniform:"uHybridMinR",min:0,max:1.5,step:.01,group:"hybrid",condition:[{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0}]},hybridFixedR:{type:"float",default:1,label:"Fixed Radius",shortId:"hf",uniform:"uHybridFixedR",min:.1,max:3,step:.01,group:"hybrid",condition:[{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0}]},hybridAddC:{type:"boolean",default:!1,label:"Add Constant",shortId:"hc",uniform:"uHybridAddC",group:"hybrid",condition:[{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0}]},hybridShift:{type:"vec3",default:new h(0,0,0),label:"Hybrid Shift",shortId:"hs2",uniform:"uHybridShift",min:-2,max:2,step:.01,group:"hybrid",condition:[{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0}]},hybridRot:{type:"vec3",default:new h(0,0,0),label:"Hybrid Rotation",shortId:"hr",uniform:"uHybridRot",min:-Math.PI,max:Math.PI,step:.01,scale:"pi",mode:"rotation",group:"hybrid",condition:[{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0}]},...yt(),hybridSwap:{type:"boolean",default:!1,label:"Swap Order",shortId:"hw",group:"engine_settings",ui:"checkbox",description:"Start with fractal formula instead of box fold.",onUpdate:"compile",noAccumReset:!0,condition:[{param:"hybridCompiled",bool:!0},{param:"hybridComplex",bool:!0}]},hybridSkip:{type:"int",default:1,label:"Hybrid Interval",shortId:"hk",uniform:"uHybridSkip",min:1,max:8,step:1,group:"hybrid",condition:[{param:"hybridComplex",bool:!0},{param:"hybridCompiled",bool:!0},{param:"hybridMode",bool:!0}]},preRotEnabled:{type:"boolean",default:!1,label:"Local Rotation",shortId:"re",group:"transform",condition:{param:"preRotMaster",bool:!0}},preRotX:{type:"float",default:0,label:"Pre Rotation X",shortId:"rx",min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0},hidden:!0},preRotY:{type:"float",default:0,label:"Pre Rotation Y",shortId:"ry",min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0},hidden:!0},preRotZ:{type:"float",default:0,label:"Pre Rotation Z",shortId:"rz",min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0},hidden:!0},preRot:{type:"vec3",default:new h(0,0,0),label:"Pre Rotation",composeFrom:["preRotX","preRotY","preRotZ"],min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0}},postRotX:{type:"float",default:0,label:"Post Rotation X",shortId:"qx",min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0},hidden:!0},postRotY:{type:"float",default:0,label:"Post Rotation Y",shortId:"qy",min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0},hidden:!0},postRotZ:{type:"float",default:0,label:"Post Rotation Z",shortId:"qz",min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0},hidden:!0},postRot:{type:"vec3",default:new h(0,0,0),label:"Post Rotation",composeFrom:["postRotX","postRotY","postRotZ"],min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0}},worldRotX:{type:"float",default:0,label:"World Rotation X",shortId:"wx",min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0},hidden:!0},worldRotY:{type:"float",default:0,label:"World Rotation Y",shortId:"wy",min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0},hidden:!0},worldRotZ:{type:"float",default:0,label:"World Rotation Z",shortId:"wz",min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0},hidden:!0},worldRot:{type:"vec3",default:new h(0,0,0),label:"World Rotation",composeFrom:["worldRotX","worldRotY","worldRotZ"],min:-Math.PI,max:Math.PI,step:.01,scale:"pi",group:"transform",parentId:"preRotEnabled",condition:{bool:!0}},juliaMode:{type:"boolean",default:!1,label:"Julia Mode",shortId:"jm",uniform:"uJuliaMode",group:"julia",description:"Replaces the iterating variable with a fixed coordinate, producing connected Julia set slices."},juliaX:{type:"float",default:0,label:"Julia X",shortId:"jx",min:-2,max:2,step:.01,group:"julia_params",condition:{param:"juliaMode",bool:!0},hidden:!0},juliaY:{type:"float",default:0,label:"Julia Y",shortId:"jy",min:-2,max:2,step:.01,group:"julia_params",condition:{param:"juliaMode",bool:!0},hidden:!0},juliaZ:{type:"float",default:0,label:"Julia Z",shortId:"jz",min:-2,max:2,step:.01,group:"julia_params",condition:{param:"juliaMode",bool:!0},hidden:!0},julia:{type:"vec3",default:new h(0,0,0),label:"Julia Coordinate",uniform:"uJulia",composeFrom:["juliaX","juliaY","juliaZ"],min:-2,max:2,step:.01,group:"julia",parentId:"juliaMode",condition:{bool:!0}}},inject:(e,t)=>{var S;const a=t.geometry;if((a?a.applyTransformLogic:!0)===!1){e.addFunction(`void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {}
void initHybridTransform() {}
void formula_Hybrid(inout vec4 z, inout float dr, inout float trap, vec4 c) {}`);return}const i=a?a.preRotMaster!==!1:!0;e.setRotation(i),e.addPreamble(ut);const r=(a==null?void 0:a.hybridCompiled)??!1;if(!r)e.addFunction(`void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {}
void initHybridTransform() {}
void formula_Hybrid(inout vec4 z, inout float dr, inout float trap, vec4 c) {}`);else{const v=(a==null?void 0:a.hybridFoldType)??0,s=ft(v);e.addFunction(s.glsl);const y=(a==null?void 0:a.hybridPermute)??0,I=ht(y);e.addFunction(gt(I,s.rotMode??"wrap",s.selfContained??!1))}let c="",l="";const g=t.formula,p=((S=b.get(g))==null?void 0:S.shader.selfContainedSDE)??!1,n=(a==null?void 0:a.burningEnabled)??!1;if(!p&&n&&(l+="z.xyz = mix(z.xyz, abs(z.xyz), uBurningRuntime * uBurningMix);"),r&&!p)if(!(a&&a.hybridComplex))c+=`
                if (uHybrid > 0.5) {
                    initHybridTransform();
                ...
                `;else{const s=(a==null?void 0:a.hybridSwap)??!1;c+=`if (uHybrid > 0.5) { initHybridTransform(); }
`,l+=`
                if (uHybrid > 0.5) {
                ...
                `}e.addHybridFold("",c,l)}},W=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF"],K=["uVec2A","uVec2B","uVec2C"],J=["uVec3A","uVec3B","uVec3C"],ee=["uVec4A","uVec4B","uVec4C"],le=["uInterlaceParamA","uInterlaceParamB","uInterlaceParamC","uInterlaceParamD","uInterlaceParamE","uInterlaceParamF"],se=["uInterlaceVec2A","uInterlaceVec2B","uInterlaceVec2C"],de=["uInterlaceVec3A","uInterlaceVec3B","uInterlaceVec3C"],ce=["uInterlaceVec4A","uInterlaceVec4B","uInterlaceVec4C"];function vt(){const e=[];for(let t=0;t<W.length;t++)e.push([new RegExp(`\\b${W[t]}\\b`,"g"),le[t]]);for(let t=0;t<K.length;t++)e.push([new RegExp(`\\b${K[t]}\\b`,"g"),se[t]]);for(let t=0;t<J.length;t++)e.push([new RegExp(`\\b${J[t]}\\b`,"g"),de[t]]);for(let t=0;t<ee.length;t++)e.push([new RegExp(`\\b${ee[t]}\\b`,"g"),ce[t]]);return e}const xt=vt();function j(e){let t=e;for(const[a,o]of xt)t=t.replace(a,o);return t}function k(e,t){const a=[...t].sort((i,r)=>r.length-i.length);let o=e;for(const i of a)o=o.replace(new RegExp(`\\b${i}\\b`,"g"),`interlace_${i}`);return o}function R(e){const t=[],a=/\b(?:void|vec[234]|float|int|mat[234]|bool)\s+(\w+)\s*\(/g,o=/^\s*(?:const\s+)?(?:vec[234]|float|int|mat[234]|bool)\s+([^;]+);/,i=/^\s*(\w+)/;let r=0;for(const c of e.split(`
`)){if(r===0){a.lastIndex=0;let l;for(;(l=a.exec(c))!==null;){const p=l[1];!p.startsWith("formula_")&&!t.includes(p)&&t.push(p)}const g=o.exec(c);if(g){const p=[];let n=0,S="";for(const v of g[1]){if(v==="(")n++;else if(v===")")n--;else if(v===","&&n===0){p.push(S),S="";continue}S+=v}S&&p.push(S);for(const v of p){const s=i.exec(v);s&&!t.includes(s[1])&&t.push(s[1])}}}for(const l of c)l==="{"?r++:l==="}"&&r--}return t}function zt(e,t,a){let o=e;o=o.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`);const i=R(e);for(const r of i)o=o.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return a&&a.length>0&&(o=k(o,a)),o=j(o),o}function St(e,t,a,o){let i=e;if(i=i.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace"),i=j(i),a&&a.length>0&&(i=k(i,a)),o&&o.length>0)for(const r of o)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function wt(e,t,a){let o=e.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace");return o=o.replace(/(\bformula_Interlace\s*\(\s*[^,]+,\s*[^,]+,\s*[^,]+,\s*)c\b/,"$1cInterlace"),a&&a.length>0&&(o=k(o,a)),o}function _t(e,t,a,o){let i=e;if(i=i.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`),i=j(i),a&&a.length>0&&(i=k(i,a)),o&&o.length>0)for(const r of o)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function Ft(e,t,a){let o=`
    vec4 cInterlace = vec4(c.xyz, uInterlaceParamA);`;t&&(o+=`
    ...
    gmt_rotSin = _il_savedSin;`);const c=`
    ...
    }`;return{preLoop:o,inLoop:c}}const D={scalars:le,vec2s:se,vec3s:de,vec4s:ce},te=["shape:self-contained","shape:modular"];function It(){return b.getAll().filter(e=>e.id!=="Modular").map(e=>({label:e.name,value:e.id}))}const pe={interlaceParamA:"paramA",interlaceParamB:"paramB",interlaceParamC:"paramC",interlaceParamD:"paramD",interlaceParamE:"paramE",interlaceParamF:"paramF",interlaceVec3A:"vec3A",interlaceVec3B:"vec3B",interlaceVec3C:"vec3C",interlaceVec2A:"vec2A",interlaceVec2B:"vec2B",interlaceVec2C:"vec2C",interlaceVec4A:"vec4A",interlaceVec4B:"vec4B",interlaceVec4C:"vec4C"},Mt=Object.fromEntries(Object.entries(pe).map(([e,t])=>[t,e]));function Ct(e){const t=b.get(e);if(!t)return{};const a={};for(const o of t.parameters){if(!o)continue;const i=Mt[o.id];i!==void 0&&(a[i]=o.default)}return a}function fe(e,t){const a=e==null?void 0:e.interlaceFormula;if(!a)return;const o=b.get(a);if(!o)return;const i=pe[t];return o.parameters.find(r=>r&&r.id===i)??void 0}function x(e){return t=>{const a=fe(t,e);if(!a)return;const o={label:a.label};return a.min!==void 0&&(o.min=a.min),a.max!==void 0&&(o.max=a.max),a.step!==void 0&&(o.step=a.step),a.mode&&(o.mode=a.mode),a.scale&&(o.scale=a.scale),a.linkable!==void 0&&(o.linkable=a.linkable),a.options&&(o.options=a.options),o}}function z(e){return t=>!!fe(t,e)}const Pt={id:"interlace",shortId:"il",name:"Formula Interlace",category:"Formulas",dependsOn:["coreMath","geometry"],requires:{rejects:{primary:te,secondary:te}},engineConfig:{toggleParam:"interlaceCompiled",mode:"compile",label:"Formula Interlacing",description:"Alternate between two formulas per iteration (like Mandelbulber hybrid).",groupFilter:"engine_settings"},panelConfig:{compileParam:"interlaceCompiled",runtimeToggleParam:"interlaceEnabled",compileSettingsParams:["interlaceFormula"],runtimeGroup:"interlace_runtime",label:"Interlace",compileMessage:"Compiling interlaced formula..."},params:{interlaceCompiled:{type:"boolean",default:!1,label:"Formula Interlacing",shortId:"ilc",group:"engine_settings",ui:"checkbox",description:"Compiles a secondary formula into the shader for per-iteration alternation.",onUpdate:"compile",noAccumReset:!0,estCompileMs:1500},interlaceFormula:{type:"float",default:"Mandelbulb",label:"Secondary Formula",shortId:"ilf",group:"engine_settings",get options(){return It().map(e=>({label:e.label,value:e.value,estCompileMs:800}))},description:"Formula to alternate with the primary formula each iteration.",onUpdate:"compile",noAccumReset:!0,condition:{param:"interlaceCompiled",bool:!0},onSet:e=>Ct(e)},interlaceEnabled:{type:"boolean",default:!1,label:"Interlace Active",shortId:"ile",uniform:"uInterlaceEnabled",group:"interlace_runtime",hidden:!0},interlaceInterval:{type:"float",default:2,label:"Interval",shortId:"ili",uniform:"uInterlaceInterval",min:1,max:10,step:1,group:"interlace_runtime",description:"Run secondary formula every N iterations.",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}]},interlaceStartIter:{type:"float",default:0,label:"Start Iter",shortId:"ils",uniform:"uInterlaceStartIter",min:0,max:20,step:1,group:"interlace_runtime",description:"First iteration where secondary formula runs.",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}]},interlaceParamA:{type:"float",default:8,label:"Param A",shortId:"ila",uniform:"uInterlaceParamA",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceParamA"),dynamicVisible:z("interlaceParamA")},interlaceParamB:{type:"float",default:0,label:"Param B",shortId:"ilb",uniform:"uInterlaceParamB",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceParamB"),dynamicVisible:z("interlaceParamB")},interlaceParamC:{type:"float",default:0,label:"Param C",shortId:"ilc2",uniform:"uInterlaceParamC",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceParamC"),dynamicVisible:z("interlaceParamC")},interlaceParamD:{type:"float",default:0,label:"Param D",shortId:"ild",uniform:"uInterlaceParamD",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceParamD"),dynamicVisible:z("interlaceParamD")},interlaceParamE:{type:"float",default:0,label:"Param E",shortId:"ile2",uniform:"uInterlaceParamE",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceParamE"),dynamicVisible:z("interlaceParamE")},interlaceParamF:{type:"float",default:0,label:"Param F",shortId:"ilf2",uniform:"uInterlaceParamF",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceParamF"),dynamicVisible:z("interlaceParamF")},interlaceVec3A:{type:"vec3",default:new h(0,0,0),label:"Vec3 A",shortId:"ilv3a",uniform:"uInterlaceVec3A",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceVec3A"),dynamicVisible:z("interlaceVec3A")},interlaceVec3B:{type:"vec3",default:new h(0,0,0),label:"Vec3 B",shortId:"ilv3b",uniform:"uInterlaceVec3B",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceVec3B"),dynamicVisible:z("interlaceVec3B")},interlaceVec3C:{type:"vec3",default:new h(0,0,0),label:"Vec3 C",shortId:"ilv3c",uniform:"uInterlaceVec3C",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceVec3C"),dynamicVisible:z("interlaceVec3C")},interlaceVec2A:{type:"vec2",default:{x:0,y:0},label:"Vec2 A",shortId:"ilv2a",uniform:"uInterlaceVec2A",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceVec2A"),dynamicVisible:z("interlaceVec2A")},interlaceVec2B:{type:"vec2",default:{x:0,y:0},label:"Vec2 B",shortId:"ilv2b",uniform:"uInterlaceVec2B",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceVec2B"),dynamicVisible:z("interlaceVec2B")},interlaceVec2C:{type:"vec2",default:{x:0,y:0},label:"Vec2 C",shortId:"ilv2c",uniform:"uInterlaceVec2C",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceVec2C"),dynamicVisible:z("interlaceVec2C")},interlaceVec4A:{type:"vec4",default:{x:0,y:0,z:0,w:0},label:"Vec4 A",shortId:"ilv4a",uniform:"uInterlaceVec4A",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceVec4A"),dynamicVisible:z("interlaceVec4A")},interlaceVec4B:{type:"vec4",default:{x:0,y:0,z:0,w:0},label:"Vec4 B",shortId:"ilv4b",uniform:"uInterlaceVec4B",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceVec4B"),dynamicVisible:z("interlaceVec4B")},interlaceVec4C:{type:"vec4",default:{x:0,y:0,z:0,w:0},label:"Vec4 C",shortId:"ilv4c",uniform:"uInterlaceVec4C",min:-10,max:10,step:.001,group:"interlace_runtime",condition:[{param:"interlaceCompiled",bool:!0},{param:"interlaceEnabled",bool:!0}],dynamicConfig:x("interlaceVec4C"),dynamicVisible:z("interlaceVec4C")}},groups:{interlace_runtime:{label:"Interlace Controls"}},inject:(e,t,a)=>{var s;const o=t.interlace;if(!(o!=null&&o.interlaceCompiled))return;const i=o.interlaceFormula;if(!i||i==="Modular"||t.formula==="Modular"||(s=b.get(t.formula))!=null&&s.shader.selfContainedSDE)return;const r=b.get(i);if(!r||r.shader.selfContainedSDE)return;if(a==="Mesh"){for(const y of D.scalars)e.addUniform(y,"float");for(const y of D.vec2s)e.addUniform(y,"vec2");for(const y of D.vec3s)e.addUniform(y,"vec3");for(const y of D.vec4s)e.addUniform(y,"vec4");e.addUniform("uInterlaceEnabled","float"),e.addUniform("uInterlaceInterval","float"),e.addUniform("uInterlaceStartIter","float")}const c=[...R(r.shader.preamble??""),...R(r.shader.function??""),...R(r.shader.loopInit??"")].filter((y,I,P)=>P.indexOf(y)===I);if(r.shader.preamble){const y=zt(r.shader.preamble,r.id,r.shader.preambleVars);e.addPreamble(y)}const l=St(r.shader.function,r.id,r.shader.preambleVars,c);e.addFunction(l);const g=wt(r.shader.loopBody,r.id,r.shader.preambleVars);let p="";r.shader.loopInit&&(p=_t(r.shader.loopInit,r.id,r.shader.preambleVars,c));const n=!!r.shader.usesSharedRotation,{preLoop:S,inLoop:v}=Ft(g,p,n);e.addHybridFold("",S,v)}},Tt={id:"quality",shortId:"q",name:"Quality",category:"Rendering",tabConfig:{label:"Quality"},engineConfig:{toggleParam:"engineQuality",mode:"compile",label:"Loop Limits & Precision",groupFilter:"engine_settings"},params:{engineQuality:{type:"boolean",default:!0,label:"Quality Core",shortId:"qc",group:"main",noAccumReset:!0,hidden:!0},compilerHardCap:{type:"int",default:A,label:"Hard Loop Cap",shortId:"hc",min:64,max:A,step:1,group:"engine_settings",ui:"numeric",description:"Safety limit for ray/DE loops (MAX_HARD_ITERATIONS define). Requires recompile but does not affect compile time — ANGLE/D3D does not unroll define-bounded loops.",onUpdate:"compile",noAccumReset:!0,userScoped:!0,hidden:!0},precisionMode:{type:"float",default:0,label:"Ray Precision",shortId:"pm",group:"engine_settings",options:[{label:"High (Desktop)",value:0},{label:"Standard (Mobile)",value:1}],description:"Sets the minimum epsilon (ray hit distance). Standard prevents GPU hangs on mobile.",onUpdate:"compile",noAccumReset:!0,userScoped:!0,hidden:!0},bufferPrecision:{type:"float",default:0,label:"Texture Buffer",shortId:"bp",group:"engine_settings",options:[{label:"Float32 (HDR)",value:0},{label:"HalfFloat16",value:1}],description:"Controls render target bit-depth. 16-bit is faster and required on some mobile GPUs.",onUpdate:"compile",noAccumReset:!0,userScoped:!0,hidden:!0},maxSteps:{type:"int",default:300,label:"Max Ray Steps",shortId:"ms",uniform:"uMaxSteps",min:32,max:A,step:1,group:"kernel",description:"Runtime limit. Rays stop after this many steps. Artistic tool for limiting depth. Maximum is limited by Hard Loop Cap.",helpId:"quality.steps",dynamicMaxRef:"compilerHardCap"},distanceMetric:{type:"float",default:0,label:"Distance Metric",shortId:"dm",uniform:"uDistanceMetric",group:"metric",options:[{label:"Euclidean (Sphere)",value:0},{label:"Chebyshev (Box)",value:1},{label:"Manhattan (Diamond)",value:2},{label:"Minkowski 4 (Rounded)",value:3}],description:'The shape of "distance". Changes the aesthetic of the fractal surface.',helpId:"quality.metric"},estimator:{type:"float",default:0,label:"Estimator",shortId:"es",group:"metric",options:[{label:"Analytic (Log)",value:0},{label:"Linear (Unit 1.0)",value:1},{label:"Linear (Offset 2.0)",value:4},{label:"Pseudo (Raw)",value:2},{label:"Dampened",value:3},{label:"Cutting Plane",value:5,disabledIf:e=>{const t=b.get(e==null?void 0:e.formula);if(t!=null&&t.shader.supportsCuttingPlane)return!1;const a=e==null?void 0:e.interlace;if(a!=null&&a.interlaceCompiled&&a.interlaceFormula){const o=b.get(a.interlaceFormula);if(o!=null&&o.shader.supportsCuttingPlane)return!1}return!0}}],description:"Algorithm for calculating distance. Log=Smooth, Linear=Sharp/IFS, Pseudo=Artifact Fix, Cutting Plane=Knighty fold-and-cut polyhedra.",helpId:"quality.estimator",onUpdate:"compile",noAccumReset:!0},deBailout:{type:"float",default:100,label:"DE Bailout",shortId:"eb",uniform:"uDeBailout",min:1,max:1e3,step:.01,scale:"log",group:"metric",description:"Radius² at which the raymarch DE stops iterating. High (default) keeps surfaces sharp and true to the boundary; low bails early, slicing the fractal into rounded shells (a stylistic effect). Fast-escaping formulas only respond near their structure scale.",helpId:"quality.metric"},fudgeFactor:{type:"float",default:1,label:"Slice Optimization",shortId:"ff",uniform:"uFudgeFactor",min:.01,max:1,step:.01,group:"kernel",description:"Multiplies step size. Lower = Higher quality but slower. Set to < 0.2 for deep zooms.",helpId:"quality.fudge",format:e=>e.toFixed(2)},stepJitter:{type:"float",default:.15,label:"Step Jitter",shortId:"sj",uniform:"uStepJitter",min:0,max:1,step:.01,group:"kernel",description:"Stochastic step variation. Breaks banding artifacts. Higher = softer edges, artistic blur.",helpId:"quality.jitter",format:e=>e.toFixed(2)},detail:{type:"float",default:1,label:"Ray detail",shortId:"rd",uniform:"uDetail",min:.1,max:10,step:.1,group:"kernel",description:"Tightens the hit threshold; higher values resolve finer surface detail.",helpId:"quality.detail"},pixelThreshold:{type:"float",default:.5,label:"Pixel threshold",shortId:"pt",uniform:"uPixelThreshold",min:.1,max:2,step:.1,group:"kernel",description:"Pixel size at which a ray is considered to have hit the surface.",helpId:"quality.threshold"},overstepTolerance:{type:"float",default:0,label:"Overstep Fix",shortId:"ot",uniform:"uOverstepTolerance",min:0,max:1e3,step:.1,scale:"log",group:"kernel",description:"Recovers details missed by the raymarcher. 0=Off. Higher values fix more holes but may create noise.",helpId:"quality.fudge"},dynamicScaling:{type:"boolean",default:!0,label:"Adaptive Resolution",shortId:"ds",group:"performance",noAccumReset:!0,userScoped:!0,hidden:!0,description:"Drop resolution while moving and during slow frames; restore when idle.",helpId:"quality.scale"},adaptiveTarget:{type:"float",default:30,label:"UI Responsiveness",shortId:"at",min:0,max:60,step:5,group:"performance",format:e=>e<=0?"Off":`${e} fps`,noAccumReset:!0,userScoped:!0,description:"Target frame rate the adaptive resolver + progressive banding hold during interaction. Higher = smoother UI (more downscaling/banding, less GPU load). 0 = off: full-resolution, un-banded frames — chugs the GPU for the fastest accumulation.",helpId:"quality.scale"},physicsProbeMode:{type:"float",default:0,label:"Distance Probe",shortId:"dp",group:"performance",isAdvanced:!0,options:[{label:"GPU Probe",value:0},{label:"Manual",value:2}],description:"GPU Probe: Reads distance from render target. Manual: Fixed value for orbit control.",helpId:"panel.quality",noAccumReset:!0,preserveOnApply:!0},manualDistance:{type:"float",default:10,label:"Manual Distance",shortId:"md",min:.1,max:1e3,step:.1,group:"performance",isAdvanced:!0,parentId:"physicsProbeMode",condition:{param:"physicsProbeMode",eq:2},description:"Manual distance value. Used for orbit control calculations.",helpId:"panel.quality",format:e=>e.toFixed(1),noAccumReset:!0,preserveOnApply:!0}},inject:(e,t)=>{const a=t.quality,o=(a==null?void 0:a.compilerHardCap)||A;e.addDefine("MAX_HARD_ITERATIONS",Math.floor(o).toString())}};function Et(e,t,a){var o,i;return!!((o=e.shader.capabilities)!=null&&o.has(a)||(i=t==null?void 0:t.shader.capabilities)!=null&&i.has(a))}class At{constructor(){$(this,"nodes",new Map)}register(t){this.nodes.set(t.id,t)}get(t){return this.nodes.get(t)}getAll(){return Array.from(this.nodes.values())}getGrouped(){const t={};return this.nodes.forEach(a=>{t[a.category]||(t[a.category]=[]),t[a.category].push(a.id)}),t}}const d=new At;d.register({id:"Note",label:"Comment / Note",category:"Utils",description:"A text block for leaving comments. Ignored by renderer.",inputs:[],glsl:e=>""});d.register({id:"AddConstant",label:"Add C (Julia/Pixel)",category:"Utils",description:"Adds the Julia Constant (or Pixel Coordinate) to the position. Essential for Mandelbrot/Julia hybrids.",inputs:[{id:"scale",label:"Strength",min:0,max:2,step:.01,default:1}],glsl:e=>`${e.indent}${e.varName}_p += c.xyz * ${e.getParam("scale")};`});d.register({id:"Scale",label:"Scale (Mult)",category:"Transforms",description:"Simple multiplication. Warning: For fractals, use IFS Scale to keep centered.",inputs:[{id:"scale",label:"Scale",min:.1,max:5,step:.01,default:2,hardMin:.001}],glsl:e=>`
${e.indent}${e.varName}_p *= ${e.getParam("scale")};
${e.indent}${e.varName}_dr *= abs(${e.getParam("scale")});
`});d.register({id:"IFSScale",label:"IFS Scale (Homothety)",category:"Transforms",description:"Scales space while shifting to maintain a center. Critical for Menger/Sierpinski.",inputs:[{id:"scale",label:"Scale",min:1,max:5,step:.01,default:2},{id:"offset",label:"Offset",min:0,max:5,step:.01,default:1}],glsl:e=>`
${e.indent}{
...
${e.indent}}
`});d.register({id:"Rotate",label:"Rotate",category:"Transforms",description:"Rotates space around X, Y, Z axes.",inputs:[{id:"x",label:"Rot X",min:-180,max:180,step:1,default:0},{id:"y",label:"Rot Y",min:-180,max:180,step:1,default:0},{id:"z",label:"Rot Z",min:-180,max:180,step:1,default:0}],glsl:e=>`
${e.indent}{
...
${e.indent}}
`});d.register({id:"Translate",label:"Translate",category:"Transforms",description:"Linear shift of coordinates.",inputs:[{id:"x",label:"X",min:-5,max:5,step:.01,default:0},{id:"y",label:"Y",min:-5,max:5,step:.01,default:0},{id:"z",label:"Z",min:-5,max:5,step:.01,default:0}],glsl:e=>`
${e.indent}${e.varName}_p += vec3(${e.getParam("x")}, ${e.getParam("y")}, ${e.getParam("z")});
`});d.register({id:"Mod",label:"Modulo (Repeat)",category:"Transforms",description:"Tiles space infinitely in a grid.",inputs:[{id:"x",label:"X Period",min:0,max:10,step:.1,default:0},{id:"y",label:"Y Period",min:0,max:10,step:.1,default:0},{id:"z",label:"Z Period",min:0,max:10,step:.1,default:0}],glsl:e=>`
${e.indent}{
...
`});d.register({id:"Abs",label:"Abs (Mirror)",category:"Folds",description:"Absolute value fold on all axes. Creates cubic symmetries.",inputs:[],glsl:e=>`${e.indent}${e.varName}_p = abs(${e.varName}_p);`});d.register({id:"BoxFold",label:"Box Fold",category:"Folds",description:"Clamps space inside a box limit. The core of the Mandelbox.",inputs:[{id:"limit",label:"Limit",min:.1,max:3,step:.01,default:1,hardMin:.001}],glsl:e=>`${e.indent}boxFold(${e.varName}_p, ${e.varName}_dr, ${e.getParam("limit")});`});d.register({id:"SphereFold",label:"Sphere Fold",category:"Folds",description:"Inverts space inside a sphere. Creates spherical voids.",inputs:[{id:"minR",label:"Min Radius",min:0,max:2,step:.01,default:.5},{id:"fixedR",label:"Fixed Radius",min:0,max:3,step:.01,default:1}],glsl:e=>`${e.indent}sphereFold(${e.varName}_p, ${e.varName}_dr, ${e.getParam("minR")}, ${e.getParam("fixedR")});`});d.register({id:"PlaneFold",label:"Plane Fold",category:"Folds",description:"Reflects space across a plane defined by a Normal and Distance.",inputs:[{id:"x",label:"Normal X",min:-1,max:1,step:.01,default:0},{id:"y",label:"Normal Y",min:-1,max:1,step:.01,default:1},{id:"z",label:"Normal Z",min:-1,max:1,step:.01,default:0},{id:"d",label:"Offset",min:-2,max:2,step:.01,default:0}],glsl:e=>`
${e.indent}{
...
${e.indent}}
`});d.register({id:"MengerFold",label:"Menger Fold",category:"Folds",description:"Permutes coordinates (sorts xyz). Essential for Menger Sponges.",inputs:[],glsl:e=>`
...
`});d.register({id:"SierpinskiFold",label:"Sierpinski Fold",category:"Folds",description:"Diagonal folding for Tetrahedral fractals (MixPinski).",inputs:[],glsl:e=>`
...
${e.indent}}
`});d.register({id:"Sphere",label:"Sphere",category:"Primitives",description:"SDF Sphere.",inputs:[{id:"r",label:"Radius",min:.1,max:5,step:.01,default:1}],glsl:e=>`${e.indent}${e.varName}_d = length(${e.varName}_p) - ${e.getParam("r")};`});d.register({id:"Box",label:"Box",category:"Primitives",description:"SDF Box.",inputs:[{id:"x",label:"Size X",min:.1,max:5,step:.01,default:1},{id:"y",label:"Size Y",min:.1,max:5,step:.01,default:1},{id:"z",label:"Size Z",min:.1,max:5,step:.01,default:1}],glsl:e=>`
${e.indent}{
...
${e.indent}}
`});d.register({id:"Twist",label:"Twist (Z)",category:"Distortion",description:"Twists space along the Z-axis.",inputs:[{id:"amount",label:"Amount",min:-5,max:5,step:.01,default:1}],glsl:e=>`
${e.indent}{
...
${e.indent}}
`});d.register({id:"Bend",label:"Bend (Y)",category:"Distortion",description:"Bends space along the Y-axis.",inputs:[{id:"amount",label:"Amount",min:-2,max:2,step:.01,default:.5}],glsl:e=>`
${e.indent}{
...
${e.indent}}
`});d.register({id:"SineWave",label:"Sine Wave",category:"Distortion",description:"Adds a sinusoidal ripple to the position.",inputs:[{id:"freq",label:"Frequency",min:.1,max:10,step:.1,default:2},{id:"amp",label:"Amplitude",min:0,max:1,step:.01,default:.1}],glsl:e=>`
${e.indent}${e.varName}_p += sin(${e.varName}_p.yzx * ${e.getParam("freq")}) * ${e.getParam("amp")};
`});d.register({id:"Union",label:"Union",category:"Combiners (CSG)",description:"Combines two shapes (min).",inputs:[],glsl:e=>`
...
`});d.register({id:"Subtract",label:"Subtract",category:"Combiners (CSG)",description:"Carves B out of A.",inputs:[],glsl:e=>`
${e.indent}float negB = -${e.in2}_d;
${e.indent}bool winA = ${e.varName}_d > negB; 
${e.indent}${e.varName}_d = winA ? ${e.varName}_d : negB;
${e.indent}${e.varName}_p = winA ? ${e.varName}_p : ${e.in2}_p;
${e.indent}${e.varName}_dr = winA ? ${e.varName}_dr : ${e.in2}_dr;
`});d.register({id:"Intersect",label:"Intersect",category:"Combiners (CSG)",description:"Area where A and B overlap.",inputs:[],glsl:e=>`
${e.indent}bool winA = ${e.varName}_d > ${e.in2}_d;
${e.indent}${e.varName}_d = winA ? ${e.varName}_d : ${e.in2}_d;
${e.indent}${e.varName}_p = winA ? ${e.varName}_p : ${e.in2}_p;
${e.indent}${e.varName}_dr = winA ? ${e.varName}_dr : ${e.in2}_dr;
`});d.register({id:"SmoothUnion",label:"Smooth Union",category:"Combiners (CSG)",description:"Merges shapes organically.",inputs:[{id:"k",label:"Smoothness",min:.01,max:2,step:.01,default:.5}],glsl:e=>`
...
`});d.register({id:"Mix",label:"Mix (Lerp)",category:"Combiners (CSG)",description:"Linear interpolation between shapes.",inputs:[{id:"factor",label:"Factor",min:0,max:1,step:.01,default:.5}],glsl:e=>`
...
`});d.register({id:"Custom",label:"Custom (Legacy)",category:"Utils",description:"Legacy node.",inputs:[],glsl:e=>""});const Dt=e=>{const t=new Map;return e.forEach(a=>{t.has(a.target)||t.set(a.target,[]),t.get(a.target).push(a)}),t},Rt=e=>{const t=new Set,a=["root-end"],o=new Set;for(;a.length>0;){const i=a.pop();o.has(i)||(o.add(i),i!=="root-end"&&i!=="root-start"&&t.add(i),(e.get(i)??[]).forEach(r=>a.push(r.source)))}return t},Bt=(e,t)=>{const a=Dt(t),o=Rt(a),i=e.filter(n=>o.has(n.id));if(!i||i.length===0)return`
    ...
    `;const c=new Map;c.set("root-start","v_start");let l=0;i.forEach((n,S)=>{const s=`v_${n.id.replace(/[^a-zA-Z0-9]/g,"")}`;c.set(n.id,s);const y=a.get(n.id)??[],I=y.find(F=>!F.targetHandle||F.targetHandle==="a"),P=y.find(F=>F.targetHandle==="b"),T=I&&c.get(I.source)||"v_start",ve=P&&c.get(P.source)||"v_start";if(r+=`    // Node: ${n.type} (${n.id})
`,r+=`    vec3 ${s}_p = ${T}_p;
`,r+=`    float ${s}_d = ${T}_d;
`,r+=`    float ${s}_dr = ${T}_dr;
`,n.enabled){const F=d.get(n.type);if(F){const H=n.condition&&n.condition.active;let q="    ";if(H){const E=l<M?`uModularParams[${l++}]`:"2.0",ze=l<M?`uModularParams[${l++}]`:"0.0";r+=`    { int ${s}_cmod = max(1, int(${E})); int ${s}_crem = int(${ze});
`,r+=`    if ( (i - (i/${s}_cmod)*${s}_cmod) == ${s}_crem ) {
`,q="        "}const xe=E=>n.bindings&&n.bindings[E]?`u${n.bindings[E]}`:l<M?`uModularParams[${l++}]`:"0.0";r+=F.glsl({varName:s,in1:T,in2:ve,getParam:xe,indent:q}),H&&(r+=`    }}
`)}}r+=`
`});const g=t.find(n=>n.target==="root-end");let p="v_start";return g&&g.source!=="root-start"&&(p=c.get(g.source)||"v_start"),r+=`
    z.xyz = ${p}_p;
    dr = ${p}_dr;
...
`},Lt=(e,t=!1)=>{if(e>4.5&&t)return`
        vec2 getDist(float r, float dr, float iter, vec4 z) {
            return vec2(abs(cp_dmin), cp_trap);
        }`;e>4.5&&(e=1);let a="d = 0.5 * log(max(r, 1.0e-5)) * r / dr_safe;";return e<.5?a=`
        float logR2 = log2(m2);
...
cp_scale = 1.0;
cp_trap = 1e10;
`,Nt={id:"coreMath",shortId:"cm",name:"Formula Math",category:"Formulas",tabConfig:{label:"Formula"},extraUniforms:[{name:m.ModularParams,type:"float",arraySize:M,default:new Float32Array(M),backingOnly:!0}],params:{iterations:{type:"float",default:16,label:"Iterations",shortId:"it",uniform:"uIterations",min:1,max:500,step:1,group:"main"},paramA:{type:"float",default:8,label:"Param A",shortId:"pa",uniform:"uParamA",min:-10,max:10,step:.001,group:"params"},paramB:{type:"float",default:0,label:"Param B",shortId:"pb",uniform:"uParamB",min:-10,max:10,step:.001,group:"params"},paramC:{type:"float",default:0,label:"Param C",shortId:"pc",uniform:"uParamC",min:-10,max:10,step:.001,group:"params"},paramD:{type:"float",default:0,label:"Param D",shortId:"pd",uniform:"uParamD",min:-10,max:10,step:.001,group:"params"},paramE:{type:"float",default:0,label:"Param E",shortId:"pe",uniform:"uParamE",min:-10,max:10,step:.001,group:"params"},paramF:{type:"float",default:0,label:"Param F",shortId:"pf",uniform:"uParamF",min:-10,max:10,step:.001,group:"params"},vec2A:{type:"vec2",default:{x:0,y:0},label:"Vec2 A",shortId:"v2a",uniform:"uVec2A",min:-10,max:10,step:.001,group:"params"},vec2B:{type:"vec2",default:{x:0,y:0},label:"Vec2 B",shortId:"v2b",uniform:"uVec2B",min:-10,max:10,step:.001,group:"params"},vec2C:{type:"vec2",default:{x:0,y:0},label:"Vec2 C",shortId:"v2c",uniform:"uVec2C",min:-10,max:10,step:.001,group:"params"},vec3A:{type:"vec3",default:new h(0,0,0),label:"Vec3 A",shortId:"v3a",uniform:"uVec3A",min:-10,max:10,step:.001,group:"params"},vec3B:{type:"vec3",default:new h(0,0,0),label:"Vec3 B",shortId:"v3b",uniform:"uVec3B",min:-10,max:10,step:.001,group:"params"},vec3C:{type:"vec3",default:new h(0,0,0),label:"Vec3 C",shortId:"v3c",uniform:"uVec3C",min:-10,max:10,step:.001,group:"params"},vec4A:{type:"vec4",default:new O(0,0,0,0),label:"Vec4 A",shortId:"v4a",uniform:"uVec4A",min:-10,max:10,step:.001,group:"params"},vec4B:{type:"vec4",default:new O(0,0,0,0),label:"Vec4 B",shortId:"v4b",uniform:"uVec4B",min:-10,max:10,step:.001,group:"params"},vec4C:{type:"vec4",default:new O(0,0,0,0),label:"Vec4 C",shortId:"v4c",uniform:"uVec4C",min:-10,max:10,step:.001,group:"params"}},inject:(e,t)=>{var s;const a=t.formula,o=t.quality;a==="Modular"&&(e.addDefine("PIPELINE_REV",(t.pipelineRevision||0).toString()),e.addUniform(m.ModularParams,"float",M));const i=b.get(a);i!=null&&i.shader.selfContainedSDE&&(e.addDefine("SKIP_PRE_BAILOUT","1"),e.addDefine("SELF_CONTAINED_SDE","1"));let r="",c="",l="";const g=t.interlace,p=g!=null&&g.interlaceCompiled&&g.interlaceFormula?b.get(g.interlaceFormula):void 0,n=i?Et(i,p,"estimator:cutting-plane"):!1,S=(o==null?void 0:o.estimator)||0;let v=Lt(S,n);if(a==="Modular"){const y=Bt(t.pipeline||[],((s=t.graph)==null?void 0:s.edges)||[]);r+=y+`
`,c="formula_Modular(z, dr, trap, distOverride, c, i);",e.setDistOverride({init:"float distOverride = 1e10;",inLoopFull:"if (distOverride < 999.0) { escaped = true; break; }",inLoopGeom:"if (distOverride < 999.0) break;",postFull:"if (distOverride < 999.0) { finalD = distOverride; smoothIter = iter; }",postGeom:"if (distOverride < 999.0) finalD = distOverride;"})}else i&&(r+=i.shader.function+`
`,c=i.shader.loopBody,l=i.shader.loopInit||"",i.shader.preamble&&e.addPreamble(i.shader.preamble),n&&(e.addPreamble(kt),l=Ot+l),i.shader.getDist&&S<4.5&&(v=`vec2 getDist(float r, float dr, float iter, vec4 z) { ${i.shader.getDist} }`));e.addFunction(r),e.setFormula(c,l,v)}};let Vt=0;function C(){return`l${++Vt}`}const jt={id:"shadows",label:"Shadows",renderContext:"direct",controlledParams:["lighting.shadowsCompile","lighting.shadowAlgorithm"],tiers:[{label:"Off",desc:"No shadows — fastest.",overrides:{lighting:{shadows:!1,shadowsCompile:!1}}},{label:"Soft",desc:"Lite soft shadows — fast march with a soft penumbra. Best FPS with shadows.",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:1}}},{label:"Soft HQ",desc:"Robust soft shadows — accurate analytic penumbra. Slowest, cleanest.",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0}}}]},Gt={id:"reflections",label:"Reflections (Direct)",renderContext:"direct",controlledParams:["reflections.reflectionMode","reflections.bounceShadows","reflections.bounces"],tiers:[{label:"Off",desc:"No reflections.",overrides:{reflections:{reflectionMode:0,bounceShadows:!1}}},{label:"Env Map",desc:"Cheap environment-map reflections (sky only, not the scene).",overrides:{reflections:{reflectionMode:1,bounceShadows:!1}}},{label:"Raymarched",desc:"Marched reflections of the actual scene, single bounce.",overrides:{reflections:{reflectionMode:3,bounceShadows:!1,bounces:1}}},{label:"Full",desc:"Marched reflections with shadows and 2 bounces. Slowest.",overrides:{reflections:{reflectionMode:3,bounceShadows:!0,bounces:2}}}]},Ht={id:"lighting_quality",label:"Lighting",isAdvanced:!0,controlledParams:["lighting.specularModel","lighting.ptEnabled","lighting.ptNEEAllLights","lighting.ptEnvNEE"],tiers:[{label:"Preview",desc:"Flat preview shading — strips advanced lighting for an instant compile.",overrides:{lighting:{advancedLighting:!1,ptEnabled:!1}},estCompileMs:-2500},{label:"Path Traced",desc:"Full PBR shading + path-tracer capability (free until you switch to PT render mode).",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!1,ptEnvNEE:!1}}},{label:"PT + NEE",desc:"Adds next-event estimation (direct-light sampling) — cleaner lighting, more compile time.",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!0,ptEnvNEE:!0}}}]},qt={id:"pathtracer",label:"Path Tracer",renderContext:"pathtracer",controlledParams:["lighting.ptReflMode","lighting.ptAreaLights","lighting.ptNEEAllLights"],tiers:[{label:"Balanced",desc:"Faster. Full bounce lighting + direct-light sampling; skips sky importance-sampling, so bright sun discs converge a little slower.",overrides:{lighting:{ptReflMode:0,ptAreaLights:!1,ptNEEAllLights:!0,ptSobolBounce:!0}}},{label:"Full",desc:"Best quality. Adds sky importance-sampling (cleaner bright suns) and soft area-light shadows. Slower to converge.",overrides:{lighting:{ptReflMode:2,ptAreaLights:!0,ptNEEAllLights:!0,ptSobolBounce:!0}}}]},$t={id:"atmosphere_quality",label:"Atmosphere",controlledParams:["atmosphere.glowEnabled","atmosphere.glowQuality","volumetric.ptVolumetric"],tiers:[{label:"Off",desc:"No glow or volumetrics.",overrides:{atmosphere:{glowEnabled:!1},volumetric:{ptVolumetric:!1}}},{label:"Fast Glow",desc:"Cheap bloom-style glow.",overrides:{atmosphere:{glowEnabled:!0,glowQuality:1},volumetric:{ptVolumetric:!1}}},{label:"Color Glow",desc:"Higher-quality coloured glow.",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!1}}},{label:"Volumetric",desc:"Coloured glow + volumetric fog/light (path-traced). Slowest.",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!0}}}]},Xt=[jt,Gt,Ht,$t,qt],ue=[{id:"preview",label:"Preview",description:"Instant preview shader — navigate without waiting for compile.",subsystems:{shadows:0,reflections:0,lighting_quality:0,atmosphere_quality:0,pathtracer:0}},{id:"fastest",label:"Fastest",description:"Highest FPS — Lite soft shadows, no reflections / glow.",subsystems:{shadows:1,reflections:0,lighting_quality:1,atmosphere_quality:0,pathtracer:0}},{id:"balanced",label:"Balanced",description:"Soft shadows, env map reflections, color glow.",subsystems:{shadows:2,reflections:1,lighting_quality:1,atmosphere_quality:2,pathtracer:0}},{id:"full",label:"Full",description:"Soft shadows, raymarched reflections, volumetric.",subsystems:{shadows:2,reflections:3,lighting_quality:1,atmosphere_quality:3,pathtracer:1}},{id:"ultra",label:"Ultra",description:"Full + PT NEE. Experimental.",isAdvanced:!0,subsystems:{shadows:2,reflections:3,lighting_quality:2,atmosphere_quality:3,pathtracer:1}}],Ut={activePreset:"balanced",subsystems:{...ue.find(e=>e.id==="balanced").subsystems},isCustomized:!1};function Zt(){_e({subsystems:Xt,presets:ue,default:Ut})}const Yt=e=>{if(!e)return`
...
#endif
`,ye=e=>`
vec3 ${e}(vec3 n, vec3 viewDir, float roughness, vec2 u) {
...
`,aa=(e,t,a=!0)=>{const o=e?"2":"maxBounces",r=a&&!e?`
        vec3 shadowDir = lDir;
        float shadowDist = distToLight;
        if (uAreaLights > 0.5) {
...
`};function be(e){return e.id&&e.type&&e.position&&e.rotation?e:{...e,id:e.id??C(),type:e.type??"Point",position:e.position??{x:0,y:0,z:0},rotation:e.rotation??{x:0,y:0,z:0}}}function Po(e){let t=-1;for(let o=0;o<e.length;o++){const i=e[o];if(!i.id||!i.type||!i.position||!i.rotation){t=o;break}}if(t===-1)return e;const a=e.slice();for(let o=t;o<a.length;o++)a[o]=be(a[o]);return a}const To=(e,t)=>!e||!e.lights||t>=e.lights.length?{id:"",type:"Point",position:{x:0,y:0,z:0},rotation:{x:0,y:0,z:0},color:"#ffffff",intensity:0,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!0,radius:0,range:0,intensityUnit:"raw"}:be(e.lights[t]),oa=[{id:C(),type:"Point",position:{x:-2,y:1,z:2},rotation:{x:0,y:0,z:0},color:"#fff4e6",intensity:1.5,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:5500},{id:C(),type:"Point",position:{x:2,y:-1,z:1},rotation:{x:0,y:0,z:0},color:"#FFD6AA",intensity:.5,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:3500},{id:C(),type:"Point",position:{x:0,y:-5,z:2},rotation:{x:0,y:0,z:0},color:"#E0EEFF",intensity:.25,falloff:0,falloffType:"Quadratic",fixed:!0,visible:!1,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:7500}],ia={id:"lighting",shortId:"l",name:"Lighting",category:"Rendering",tabConfig:{label:"Light",condition:{param:"$advancedMode",bool:!0}},viewportConfig:{componentId:"overlay-lighting",renderOrder:50,type:"dom"},engineConfig:{toggleParam:"advancedLighting",mode:"compile",label:"Lighting Engine",groupFilter:"engine_settings"},groups:{shadows:{label:"Shadows",description:"Per-light shadow tracing and softness.",helpId:"shadows"}},extraUniforms:[{name:m.LightCount,type:"int",default:0},{name:m.LightType,type:"float",arraySize:f,default:new Float32Array(f).fill(0)},{name:m.LightPos,type:"vec3",arraySize:f,default:new Array(f).fill(new h)},{name:m.LightDir,type:"vec3",arraySize:f,default:new Array(f).fill(new h(0,-1,0))},{name:m.LightColor,type:"vec3",arraySize:f,default:new Array(f).fill(new w(1,1,1))},{name:m.LightIntensity,type:"float",arraySize:f,default:new Float32Array(f).fill(0)},{name:m.LightShadows,type:"float",arraySize:f,default:new Float32Array(f).fill(0)},{name:m.LightFalloff,type:"float",arraySize:f,default:new Float32Array(f).fill(0)},{name:m.LightFalloffType,type:"float",arraySize:f,default:new Float32Array(f).fill(0)},{name:m.LightRadius,type:"float",arraySize:f,default:new Float32Array(f).fill(0)},{name:m.LightSoftness,type:"float",arraySize:f,default:new Float32Array(f).fill(0)},{name:m.LightHideEmitter,type:"float",arraySize:f,default:new Float32Array(f).fill(0)},{name:m.EnvCDFMarginal,type:"sampler2D",default:null},{name:m.EnvCDFConditional,type:"sampler2D",default:null},{name:m.EnvCDFSize,type:"vec2",default:new B(1,1)},{name:m.EnvLumIntegral,type:"float",default:1},{name:m.EnvCDFMipBias,type:"float",default:0},{name:m.EnvMaxMip,type:"float",default:8},{name:m.EnvAvgColor,type:"vec3",default:new h(-1,-1,-1)}],params:{advancedLighting:{type:"boolean",default:!0,label:"Light Engine",shortId:"le",group:"main",noAccumReset:!0,hidden:!0,onUpdate:"compile",description:"Master switch for lighting logic. Disabling provides stubs only."},ptEnabled:{type:"boolean",default:!0,label:"Path Tracing Core",shortId:"pe",group:"engine_settings",ui:"checkbox",description:"Compiles the Path Tracing module. Disable to reduce shader size.",onUpdate:"compile",noAccumReset:!0,estCompileMs:2500},renderMode:{type:"float",default:0,label:"Active Mode",shortId:"rm",group:"engine_settings",parentId:"ptEnabled",options:[{label:"Direct (Fast)",value:0},{label:"Path Tracing (GI)",value:1}],description:"Switches between fast direct lighting and physically based Global Illumination.",onUpdate:"compile",noAccumReset:!0},ptBounces:{type:"int",default:3,label:"Max Bounces",shortId:"pb",uniform:"uPTBounces",min:1,max:8,step:1,group:"engine_settings",parentId:"ptEnabled",ui:"numeric",description:"Recursion depth. Higher = Brighter interiors, Slower render."},ptGIStrength:{type:"float",default:1,label:"GI Strength",shortId:"pg",uniform:"uPTGIStrength",min:0,max:5,step:.01,group:"engine_settings",parentId:"ptEnabled",description:"Artistic boost for bounced light intensity."},specularModel:{type:"float",default:0,label:"Specular Model",shortId:"sm",group:"engine_settings",options:[{label:"Blinn-Phong (Fast)",value:0,estCompileMs:0},{label:"Cook-Torrance (Quality)",value:1,estCompileMs:30}],description:"BRDF model for direct lighting. Cook-Torrance is physically accurate, with negligible compile cost.",onUpdate:"compile",noAccumReset:!0},shadowsCompile:{type:"boolean",default:!0,label:"Shadow Engine",shortId:"sc",group:"engine_settings",ui:"checkbox",noAccumReset:!0,onUpdate:"compile",description:"Compiles the shadow raymarching loop. Disable to save ~5s compile time.",estCompileMs:500},shadowAlgorithm:{type:"float",default:0,label:"Shadow Quality",shortId:"sa",group:"shadows",parentId:"shadowsCompile",uniform:"uShadowQuality",hidden:!0,options:[{label:"Lite (Fast)",value:1},{label:"HQ (Robust)",value:0}],description:"Soft-shadow penumbra quality (runtime): Lite = fast step-floor, HQ = accurate IQ penumbra (~2x slower). Toggle via the HQ button next to Jitter."},ptStochasticShadows:{type:"boolean",default:!0,label:"Soft Shadow Jitter",shortId:"ps",group:"engine_settings",parentId:"shadowsCompile",ui:"checkbox",hidden:!0,noAccumReset:!0,description:"Deprecated — jitter capability is always compiled with shadows now. Use the runtime Jitter button (areaLights). Retained for scene back-compat."},ptAreaLights:{type:"boolean",default:!1,label:"True Area Lights",shortId:"pal2",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noAccumReset:!0,estCompileMs:400,description:"Physically-correct sphere area light integration (sphere-surface sampling + MIS). Required for lights with type=Sphere. Enable + change a light type to Sphere via the per-light menu. Costs ~1s compile + one extra sphere intersection per bounce."},ptNEEAllLights:{type:"boolean",default:!1,label:"Sample All Lights",shortId:"pal",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noAccumReset:!0,estCompileMs:80,description:"Evaluates every active light per bounce instead of one random light. Reduces shadow noise at the cost of N× more shadow rays."},ptReflMode:{type:"float",default:2,label:"Env Sampling",shortId:"prm",group:"engine_settings",parentId:"ptEnabled",options:[{label:"Off",value:0,estCompileMs:0},{label:"Env MIS",value:1,estCompileMs:1150},{label:"Env MIS + IS",value:2,estCompileMs:1700}],onUpdate:"compile",noAccumReset:!0,description:"Direct env-map sampling with MIS for path-traced reflections. Env MIS handles broad skies; Env MIS + IS adds importance sampling for HDR maps with sun discs / concentrated lights. Replaces the older Environment NEE (which only handled diffuse)."},ptSobolBounce:{type:"boolean",default:!0,label:"Sobol Bounce Sampling",shortId:"psb",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noAccumReset:!0,estCompileMs:25,description:"Low-discrepancy 2D sequence (Sobol) with per-pixel rotation for the bounce-direction seed. Measurably less variance on shiny surfaces; no effect on rough/diffuse-heavy scenes."},ptEnvNEE:{type:"boolean",default:!1,hidden:!0,label:"Environment NEE (legacy)",shortId:"pen",group:"engine_settings",parentId:"ptEnabled",noAccumReset:!0,description:"Deprecated — kept so old scene files load without dropping state. Migrated to ptReflMode at boot."},ptMaxLuminance:{type:"float",default:10,label:"Firefly Clamp",shortId:"pfl",uniform:"uPTMaxLuminance",min:.5,max:200,step:.5,scale:"log",group:"engine_settings",parentId:"ptEnabled",description:"Clamps per-sample luminance to suppress bright firefly spikes. Lower = cleaner but slightly biased. Raise to effectively disable."},shadows:{type:"boolean",default:!0,label:"Enable",shortId:"sh",group:"main",uniform:"uShadows",ui:"checkbox",condition:{param:"shadowsCompile",bool:!0},description:"Toggle shadow casting at runtime without recompiling.",helpId:"shadows"},areaLights:{type:"boolean",default:!1,label:"Shadow Jitter",shortId:"al",uniform:"uAreaLights",group:"shadows",hidden:!0,condition:{param:"shadowsCompile",bool:!0},description:"Stochastic soft-shadow jitter for Point/Directional lights (penumbra via accumulation). Off = sharp analytic shadows.",helpId:"shadows"},shadowIntensity:{type:"float",default:1,label:"Opacity",shortId:"si",uniform:"uShadowIntensity",min:0,max:1,step:.01,group:"shadows",condition:{bool:!0},description:"How dark the shadowed regions become (1 = fully black).",helpId:"shadows"},shadowSoftness:{type:"float",default:16,label:"Hardness",shortId:"ss",uniform:"uShadowSoftness",min:2,max:2e3,step:1,group:"shadows",scale:"log",condition:{bool:!0},description:"Higher values give crisper shadows; lower values give wider penumbras. Affects Point and Directional lights only — Sphere area lights derive shadow softness from physical sphere sampling.",helpId:"shadows"},shadowSteps:{type:"int",default:128,label:"Quality (Steps)",shortId:"st",min:16,max:512,step:16,group:"shadows",condition:{bool:!0},uniform:"uShadowSteps",ui:"numeric",description:"Quality vs Performance.",helpId:"shadows"},shadowBias:{type:"float",default:.002,label:"Bias",shortId:"sb",uniform:"uShadowBias",min:0,max:1,step:1e-6,group:"shadows",scale:"log",condition:{bool:!0},isAdvanced:!0,description:"Too low: acne. Too high: detached.",helpId:"shadows"},lights:{type:"complex",default:oa,label:"Light List",shortId:"ll",group:"data",hidden:!0,noAccumReset:!0,preserveOnApply:!0}},inject:(e,t,a)=>{if(a!=="Main"){e.addPostDEFunction(`
             float GetSoftShadow(vec3 ro, vec3 rd, float k, float lightDist, float noise) { return 1.0; }
             float GetHardShadow(vec3 ro, vec3 rd, float lightDist) { return 1.0; }
             ...
             `);return}e.addDefine("MAX_LIGHTS",f.toString());const o=t.lighting;if(o&&!o.advancedLighting){e.addDefine("MAX_LIGHTS","0"),e.addPostDEFunction(`
             float GetSoftShadow(vec3 ro, vec3 rd, float k, float lightDist, float noise) { return 1.0; }
             float GetHardShadow(vec3 ro, vec3 rd, float lightDist) { return 1.0; }
             ...
             `);return}const i=(o==null?void 0:o.shadowsCompile)!==!1;if(e.addPostDEFunction(Yt(i)),!i&&!(o!=null&&o.shadows)&&e.addDefine("DISABLE_SHADOWS","1"),(o==null?void 0:o.ptEnabled)!==!1){e.addDefine("PT_ENABLED","1"),o!=null&&o.ptNEEAllLights&&e.addDefine("PT_NEE_ALL_LIGHTS","1"),o!=null&&o.ptAreaLights&&e.addDefine("PT_AREA_LIGHTS","1");const p=o==null?void 0:o.ptReflMode;let n;p===void 0&&(o==null?void 0:o.ptEnvNEE)===!0?n=1:n=p??0,n>=1&&e.addDefine("PT_ENV_MIS","1"),n>=2&&e.addDefine("PT_ENV_MIS_IS","1"),o!=null&&o.ptSobolBounce&&e.addDefine("PT_SOBOL_BOUNCE","1")}const r=i,c=t.renderMode==="PathTracing"||(o==null?void 0:o.renderMode)===1,l=t.quality,g=(l==null?void 0:l.precisionMode)===1;if(c)e.addIntegrator(ae),e.setRenderMode("PathTracing"),e.addDefine("RENDER_MODE_PATHTRACING","1"),e.addIntegrator(aa(g,f,r));else{const p=(o==null?void 0:o.specularModel)===1;e.addIntegrator(p?ae:ge),e.setRenderMode("Direct"),e.addIntegrator(p?Wt(r):Qt(r)),e.requestShading()}},actions:{updateLight:(e,t)=>{const{index:a,params:o}=t;if(!e.lights||a>=e.lights.length)return{};const i=[...e.lights];return i[a]={...i[a],...o},{lights:i}},addLight:e=>{if(e.lights.length>=f)return{};const t={id:C(),type:"Point",position:{x:0,y:0,z:2},rotation:{x:0,y:0,z:0},color:"#ffffff",intensity:1,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0,radius:0,range:0,intensityUnit:"raw"};return{lights:[...e.lights,t]}},removeLight:(e,t)=>{if(t<0||t>=e.lights.length)return{};const a=[...e.lights];return a.splice(t,1),{lights:a}},duplicateLight:(e,t)=>{if(t<0||t>=e.lights.length||e.lights.length>=f)return{};const a={...e.lights[t],id:C()},o=[...e.lights];return o.splice(t+1,0,a),{lights:o}}}},ra={id:"lightSpheres",shortId:"ls",name:"Light Spheres",category:"Rendering",dependsOn:["lighting"],engineConfig:{toggleParam:"lightSpheres",mode:"compile",label:"Light Spheres",groupFilter:"engine_settings"},params:{lightSpheres:{type:"boolean",default:!0,label:"Light Spheres",shortId:"lsp",group:"engine_settings",ui:"checkbox",onUpdate:"compile",noAccumReset:!0,description:"Compiles visible emitter sphere rendering for point lights with radius > 0.",estCompileMs:150}},inject:(e,t,a)=>{if(a!=="Main")return;const o=t.lightSpheres;!o||o.lightSpheres===!1||(e.addDefine("LIGHT_SPHERES","1"),e.addPostDEFunction(Jt),e.addIntegrator(ta()),e.addMissLogic(ea),e.addCompositeLogic("compositeLightSpheres(ro, rd, col, d, hit, stochasticSeed);"))}},na={id:"optics",shortId:"o",name:"Camera Optics",category:"Scene",tabConfig:{label:"Scene"},customUI:[{componentId:"optics-controls",group:"projection",parentId:"camType",condition:{eq:0}},{componentId:"optics-dof-controls",group:"dof",parentId:"dofStrength",condition:{gt:0}}],params:{camType:{type:"float",default:0,label:"Projection",shortId:"ct",uniform:"uCamType",group:"projection",options:[{label:"Perspective",value:0},{label:"Orthographic",value:1},{label:"360° Skybox",value:2}],description:"Camera projection: perspective, orthographic, or equirectangular skybox.",helpId:"cam.mode"},camFov:{type:"float",default:60,label:"Field of View",shortId:"fv",min:10,max:150,step:1,group:"projection",hidden:!0,condition:{param:"camType",eq:0}},orthoScale:{type:"float",default:2,label:"Ortho Scale",shortId:"os",min:.1,max:10,step:.1,scale:"log",group:"projection",parentId:"camType",condition:{param:"camType",eq:1},description:"World-space size of the orthographic view rectangle.",helpId:"cam.fov"},dofStrength:{type:"float",default:0,label:"Camera Blur",shortId:"ds",uniform:"uDOFStrength",min:0,max:1,step:1e-4,scale:"log",group:"dof",format:e=>e===0?"0.0 (off)":Math.abs(e)<.001?e.toFixed(6):Math.abs(e)<10?e.toFixed(4):e.toFixed(2),description:"Aperture strength for depth-of-field blur.",helpId:"dof.settings"},dofFocus:{type:"float",default:10,label:"Focus Distance",shortId:"df",uniform:"uDOFFocus",min:1e-6,max:1e4,step:1e-6,scale:"log",group:"dof",parentId:"dofStrength",condition:{gt:0},description:"Distance from the camera that stays in sharp focus.",helpId:"dof.settings"}}},la={id:"navigation",shortId:"n",name:"Navigation",category:"Scene",customUI:[{componentId:"navigation-controls",group:"controls"}],params:{flySpeed:{type:"float",default:.5,label:"Fly Speed %",shortId:"fs",min:.001,max:1,step:.001,group:"movement",format:e=>`${(e*100).toFixed(1)}%`},autoSlow:{type:"boolean",default:!0,label:"Auto-slow on collision",shortId:"as",group:"movement"},orbitCursorAnchor:{type:"boolean",default:!0,label:"Orbit/zoom around cursor",shortId:"oca",group:"movement",hidden:!0}}},sa={id:"drawing",shortId:"dr",name:"Drawing Tools",category:"Tools",tabConfig:{label:"Drawing",condition:{param:"enabled",bool:!0}},viewportConfig:{componentId:"overlay-drawing",type:"dom"},menuConfig:{label:"Drawing Tools",toggleParam:"enabled"},interactionConfig:{blockCamera:!0,activeParam:"active"},params:{enabled:{type:"boolean",default:!1,label:"Show Tab",shortId:"en",group:"system",hidden:!0,noAccumReset:!0,preserveOnApply:!0},active:{type:"boolean",default:!1,label:"Enable Tool",shortId:"ac",group:"main",noAccumReset:!0,preserveOnApply:!0,hidden:!0},activeTool:{type:"float",default:0,label:"Tool Type",shortId:"tt",group:"main",noAccumReset:!0,preserveOnApply:!0,hidden:!0},originMode:{type:"float",default:1,label:"Origin Plane",shortId:"om",group:"settings",noAccumReset:!0,preserveOnApply:!0,options:[{label:"Global Zero",value:0},{label:"Surface (Probe)",value:1}],description:"Where the drawing plane starts."},color:{type:"color",default:new w("#00ffff"),label:"Line Color",shortId:"cl",group:"settings",noAccumReset:!0,preserveOnApply:!0},lineWidth:{type:"float",default:1,label:"Line Width",shortId:"lw",min:1,max:10,step:1,group:"settings",noAccumReset:!0,preserveOnApply:!0,hidden:!0},showLabels:{type:"boolean",default:!0,label:"Show Measurements",shortId:"sl",group:"settings",noAccumReset:!0,preserveOnApply:!0},showAxes:{type:"boolean",default:!1,label:"Show Axis Ruler",shortId:"ax",group:"settings",noAccumReset:!0,preserveOnApply:!0,description:"Displays a reference grid at the drawing origin."},shapes:{type:"complex",default:[],label:"Shapes",shortId:"sh",group:"data",hidden:!0,noAccumReset:!0,preserveOnApply:!0},refreshTrigger:{type:"float",default:0,label:"Refresh Trigger",group:"system",hidden:!0,noAccumReset:!0,preserveOnApply:!0}},state:{activeTool:"rect"},actions:{addDrawnShape:(e,t)=>({shapes:[...e.shapes||[],t]}),removeDrawnShape:(e,t)=>({shapes:(e.shapes||[]).filter(a=>a.id!==t)}),updateDrawnShape:(e,t)=>({shapes:(e.shapes||[]).map(a=>a.id===t.id?{...a,...t.updates}:a)}),clearDrawnShapes:e=>({shapes:[]})}},da={id:"shaderCompiler",shortId:"eng",name:"Shader Compiler",category:"System",tabConfig:{label:"Shader Compiler",condition:{param:"showEngineTab",bool:!0}},params:{showEngineTab:{type:"boolean",default:!1,label:"Show Shader Compiler Tab",shortId:"se",group:"system",noAccumReset:!0,preserveOnApply:!0,hidden:!0}}},ca=(e,t,a=32)=>{if(!e)return`
...
`,ha={id:"reflections",shortId:"rf",name:"Reflections",category:"Rendering",engineConfig:{toggleParam:"enabled",mode:"compile",label:"Reflection Tracing",groupFilter:"engine_settings"},groups:{shading:{label:"Reflections",description:"Screen-space reflection tracing for glossy surfaces.",helpId:"render.reflections"}},params:{reflectionMode:{type:"float",default:N,label:"Reflection Method",shortId:"rm",group:"engine_settings",options:[{label:"Off",value:oe,estCompileMs:0},{label:"Environment Map",value:N,estCompileMs:0},{label:"Raymarched (Quality)",value:_,estCompileMs:1500}],description:"Reflection technique. Higher quality = longer compile time. Raymarched adds ~1.5-2s.",onUpdate:"compile",noAccumReset:!0},bounceShadows:{type:"boolean",default:!1,label:"Bounce Shadows",shortId:"bs",group:"engine_settings",ui:"checkbox",condition:{param:"reflectionMode",eq:_},description:"Compute shadows on reflected surfaces. Negligible extra compile time.",onUpdate:"compile",noAccumReset:!0,estCompileMs:50},mixStrength:{type:"float",default:1,label:"Raymarch Mix",shortId:"mx",uniform:"uReflStrength",min:0,max:1,step:.01,group:"engine_settings",condition:{param:"reflectionMode",eq:_},description:"Blends between Raymarched Reflections (1.0) and Environment Map (0.0)."},roughnessThreshold:{type:"float",default:.62,label:"Roughness Cutoff",shortId:"rc",uniform:"uReflRoughnessCutoff",min:0,max:1,step:.01,group:"engine_settings",condition:{param:"reflectionMode",eq:_},description:"Surfaces rougher than this will skip raymarching to save performance."},bounces:{type:"int",default:1,label:"Max Bounces",shortId:"rb",min:1,max:3,step:1,group:"engine_settings",uniform:"uReflBounces",ui:"numeric",description:"Maximum recursion depth. Clamped to 3. Default 1 for performance.",noAccumReset:!0,onUpdate:"compile",condition:{param:"reflectionMode",eq:_}},steps:{type:"int",default:64,label:"Trace Steps",shortId:"rs",min:16,max:128,step:8,group:"engine_settings",uniform:"uReflSteps",ui:"numeric",description:"Precision of the reflection ray.",noAccumReset:!0,condition:{param:"reflectionMode",eq:_}},enabled:{type:"boolean",default:!0,label:"Enable Reflections",shortId:"re",group:"main",hidden:!0,noAccumReset:!0,onUpdate:"compile"}},inject:(e,t,a)=>{if(a!=="Main")return;const o=t.reflections;if(!o||o.enabled===!1)return;const i=o.reflectionMode??N;if(i!==oe){if(i!==_){e.addShadingLogic(ua);return}if(i===_){e.addPostDEFunction(fa());const r=Math.max(1,Math.min(3,o.bounces??1));e.addDefine("MAX_REFL_BOUNCES",r.toString()),o.bounceShadows&&e.addDefine("REFL_BOUNCE_SHADOWS","1"),e.addShadingLogic(ma)}}}},ga=`
// --- WATER PLANE LOGIC ---
...
`,wa=`
    ...
    col += fogScatter;
`,_a={id:"volumetric",shortId:"vol",name:"Volumetric Scatter",category:"Rendering",engineConfig:{toggleParam:"ptVolumetric",mode:"compile",label:"Volumetric Scattering",description:"Henyey-Greenstein single scatter. Enables god rays, colored haze, and directional fog.",groupFilter:"engine_settings"},panelConfig:{compileParam:"ptVolumetric",runtimeToggleParam:"volEnabled",label:"Volumetric Scatter",compileMessage:"Compiling Volumetric Shader...",helpId:"render.volumetric"},groups:{density:{label:"Density & Shadow Rays",collapsible:!0},emissive:{label:"Color Scatter",collapsible:!0},height:{label:"Height Fog",collapsible:!0}},params:{ptVolumetric:{type:"boolean",default:!1,label:"Volume Scatter",shortId:"pvs",group:"engine_settings",noAccumReset:!0,onUpdate:"compile",estCompileMs:5500},volEnabled:{type:"boolean",default:!1,label:"Enabled",shortId:"ven",uniform:"uVolEnabled",hidden:!0},volQuality:{type:"float",default:0,label:"Quality",shortId:"vq",uniform:"uVolQuality",min:0,max:1,step:.01,condition:{param:"ptVolumetric",bool:!0},description:"0 = 1/128 cheap preview (clean after many frames). 1 = 1/8 full sampling (converges fast, ~16× per-frame cost). Same final image either way; tradeoff is per-frame FPS vs frames-to-converge.",helpId:"render.volumetric"},volDensity:{type:"float",default:.01,label:"Density",shortId:"vd",uniform:"uVolDensity",min:.001,max:5,step:.01,scale:"log",group:"density",condition:{param:"ptVolumetric",bool:!0},description:"How thick the participating medium is along each ray.",helpId:"render.volumetric"},volAnisotropy:{type:"float",default:.3,label:"Anisotropy (g)",shortId:"va",uniform:"uVolAnisotropy",min:-.99,max:.99,step:.01,group:"density",parentId:"volDensity",condition:{gt:0},description:"0=isotropic, +0.9=forward (god rays), -0.9=back scatter.",helpId:"render.volumetric"},volMaxLights:{type:"float",default:1,label:"Light Sources",shortId:"vml",uniform:"uVolMaxLights",min:1,max:3,step:1,group:"density",parentId:"volDensity",condition:{gt:0},isAdvanced:!0,description:"Max lights for shadow rays. More = more expensive.",helpId:"render.volumetric"},volScatterTint:{type:"color",default:new w(1,1,1),label:"Scatter Tint",shortId:"vst",uniform:"uVolScatterTint",group:"density",parentId:"volDensity",condition:{gt:0},description:"Tint applied to scattered light along each ray.",helpId:"render.volumetric"},volEmissive:{type:"float",default:0,label:"Color Scatter",shortId:"ves",uniform:"uVolEmissive",min:0,max:100,step:.1,scale:"log",group:"emissive",condition:{param:"ptVolumetric",bool:!0},description:"Orbit trap color field scattered through the volume. No shadow rays needed.",helpId:"render.volumetric"},volStepJitter:{type:"float",default:1,label:"Step Jitter",shortId:"vsj",uniform:"uVolStepJitter",min:0,max:1,step:.01,group:"density",parentId:"volDensity",condition:{gt:0},description:"1 = smooth (temporal accumulation removes noise). 0 = fixed slicing pattern (artistic, broken fog look).",helpId:"render.volumetric"},volEmissiveFalloff:{type:"float",default:0,label:"Surface Falloff",shortId:"vef",uniform:"uVolEmissiveFalloff",min:0,max:5,step:.01,scale:"log",group:"emissive",parentId:"volEmissive",condition:{gt:0},description:"Concentrate color near fractal surface.",helpId:"render.volumetric"},volHeightFalloff:{type:"float",default:0,label:"Height Falloff",shortId:"vhf",uniform:"uVolHeightFalloff",min:0,max:5,step:.01,scale:"log",group:"height",condition:{param:"ptVolumetric",bool:!0},description:"Density varies with Y. Creates ground fog, rising mist.",helpId:"render.volumetric"},volHeightOrigin:{type:"float",default:0,label:"Height Origin",shortId:"vho",uniform:"uVolHeightOrigin",min:-5,max:5,step:.01,group:"height",parentId:"volHeightFalloff",condition:{gt:0},description:"Y level where height-based fog density peaks.",helpId:"render.volumetric"}},inject:(e,t,a)=>{if(a!=="Main")return;const o=t.volumetric;o!=null&&o.ptVolumetric&&(e.addDefine("PT_VOLUMETRIC","1"),e.addVolumeTracing(Sa,""),e.addPostProcessLogic(wa))}},Fa=()=>{u.register(Nt),u.register(bt),u.register(Pt),u.register(ia),u.register(ra),u.register(pa),u.register(ha),u.register(Xe),u.register(_a),u.register(Ke),u.register(xa),u.register(tt),u.register(Je),u.register(Tt),u.register(Ze),u.register(Fe),u.register(Ie),u.register(na),u.register(la),u.register(za),u.register(Me),u.register(sa),u.register(Ce),u.register(Pe),u.register(Te),u.register(da)},Ia=Ge(e=>({open:!1,setOpen:t=>e({open:t})})),Ma="gmt.savedGradients.v1",ie="gmt.favients.migratedFromLibrary",Ca=()=>{var e;try{if(typeof localStorage>"u"||X(ie))return;Ee(ie,"1");const t=X(Ma);if(!t)return;const a=JSON.parse(t);if(!Array.isArray(a)||!a.length)return;const o=Le.getState();for(let i=a.length-1;i>=0;i--){const r=(e=a[i])==null?void 0:e.state;r&&Array.isArray(r.stops)&&r.stops.length&&!o.isFav(r)&&o.add(r,a[i].label||"Saved gradient","Library")}}catch{}},Pa={id:"Mandelbulb",name:"Mandelbulb",shortDescription:"The classic 3D extension of the Mandelbrot set. Features organic, broccoli-like recursive structures.",description:'The classic 3D extension of the Mandelbrot set. Features standard Power controls plus the "Radiolaria" mutation for skeletal/hollow effects.',juliaType:"julia",shader:{function:`
    ...
    const float dodeca_faceDist = 1.7320508; // sqrt(3) — multiplied by paramB at runtime`,function:`
    ...
    vec3 phoenixBulbPow(vec3 z, float power, vec2 phase) {
        ...
        float dr_prev2 = 0.0;
        `,preambleVars:["z_prev","dr_prev","z_prev2","dr_prev2"],capabilities:new Set(["shape:per-iteration","iter:c-constant","render:writes-trap","render:writes-iter"])},parameters:[{label:"Power (p)",id:"paramA",min:1.5,max:12,step:.01,default:2},{label:"History Exp",id:"paramB",min:0,max:3,step:.01,default:1},{label:"Twist",id:"paramC",min:-2,max:2,step:.01,default:0},{label:"History Depth",id:"paramD",min:0,max:1,step:.01,default:1},{label:"Distortion (Re, Im)",id:"vec2A",type:"vec2",min:-1.5,max:1.5,step:.001,default:{x:-.5,y:0}},{label:"Phase (θ, φ)",id:"vec2B",type:"vec2",min:-6.28,max:6.28,step:.01,default:{x:-3.211593,y:0},scale:"pi"},{label:"Stretch",id:"vec3A",type:"vec3",min:.1,max:3,step:.01,default:{x:1,y:1,z:1},linkable:!0},{label:"Abs Fold",id:"vec3B",type:"vec3",min:0,max:1,step:1,default:{x:0,y:0,z:1},mode:"toggle"},{label:"Pre-Rotation",id:"vec3C",type:"vec3",min:-6.28,max:6.28,step:.01,default:{x:0,y:0,z:0},mode:"rotation"}],defaultPreset:{formula:"Phoenix",features:{coreMath:{iterations:12,paramA:2,paramB:1,paramC:0,paramD:1,paramE:0,paramF:0,vec2A:{x:-.5,y:0},vec2B:{x:-3.211593,y:0},vec2C:{x:0,y:0},vec3A:{x:1,y:1,z:1},vec3B:{x:0,y:0,z:1},vec3C:{x:0,y:0,z:0},vec4A:{x:0,y:0,z:0,w:0},vec4B:{x:0,y:0,z:0,w:0},vec4C:{x:0,y:0,z:0,w:0}},geometry:{applyTransformLogic:!0,preRotMaster:!0,hybridCompiled:!1,hybridMode:!1,hybridFoldType:0,hybridComplex:!1,hybridPermute:0,burningEnabled:!1,burningRuntime:!1,burningMix:1,hybridIter:2,hybridFoldLimit:1,hybridFoldLimitVec:{x:1,y:1,z:1},hybridScale:2,hybridScaleVary:0,hybridMinR:.5,hybridFixedR:1,hybridAddC:!1,hybridShift:{x:0,y:0,z:0},hybridRot:{x:0,y:0,z:0},hybridFoldingValue:{x:2,y:2,z:2},hybridKaliConstant:{x:1,y:1,z:1},hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0,hybridSwap:!1,hybridSkip:1,preRotEnabled:!1,preRotX:0,preRotY:0,preRotZ:0,postRotX:0,postRotY:0,postRotZ:0,worldRotX:0,worldRotY:0,worldRotZ:0,juliaMode:!0,juliaX:.56667,juliaY:0,juliaZ:0,preRot:{x:0,y:0,z:0},postRot:{x:0,y:0,z:0},worldRot:{x:0,y:0,z:0},julia:{x:0,y:0,z:0}},coloring:{gradient:{stops:[{id:"8",position:0,color:"#EDFFFF",bias:.5,interpolation:"linear"},{id:"7",position:.125,color:"#BAFFFD",bias:.5,interpolation:"linear"},{id:"6",position:.25,color:"#86B5E5",bias:.5,interpolation:"linear"},{id:"5",position:.375,color:"#57A5D9",bias:.5,interpolation:"linear"},{id:"4",position:.5,color:"#397DD1",bias:.5,interpolation:"linear"},{id:"3",position:.625,color:"#206BCB",bias:.5,interpolation:"linear"},{id:"2",position:.75,color:"#1852B1",bias:.5,interpolation:"linear"},{id:"1",position:.875,color:"#0C2C8A",bias:.5,interpolation:"linear"},{id:"0",position:1,color:"#000764",bias:.5,interpolation:"linear"}],colorSpace:"linear",blendSpace:"oklab"},mode:0,scale:4.136851,offset:.987341,repeats:1,phase:0,bias:1.296576,colorIter:0,twist:0,twistArms:0,escape:4,gradient2:{stops:[{id:"0",position:0,color:"#000000"},{id:"1",position:1,color:"#ffffff"}],colorSpace:"linear",blendSpace:"oklab"},mode2:5,scale2:1,offset2:0,repeats2:1,phase2:0,bias2:1,twist2:0,twistArms2:0,blendMode:3,blendOpacity:0,layer3Color:"#ffffff",layer3Scale:245.44,layer3Strength:0,layer3Bump:.3,layer3Turbulence:.65,layer3Enabled:!0,trapEnabled:!1,trapShape:1,trapCenter:{x:0,y:0,z:0},trapRadius:1,trapNormal:{x:0,y:1,z:0},trapOffset:0},materials:{diffuse:1.01,reflection:.55,specular:1.15,roughness:.493,rim:0,rimExponent:4,rimColor:"#bcdaff",envStrength:0,envBackgroundStrength:0,envSource:1,envMapData:null,envMapColorSpace:0,useEnvMap:!1,envRotation:0,envGradientStops:{stops:[{id:"hor",position:0,color:"#223344",bias:.5,interpolation:"smooth"},{id:"zen",position:1,color:"#88ccff",bias:.5,interpolation:"smooth"}],colorSpace:"linear",blendSpace:"oklab"},emission:.464637,emissionMode:0,emissionColor:"#ffffff",ptEmissionMult:1},reflections:{reflectionMode:3,bounceShadows:!0,mixStrength:1,roughnessThreshold:.62,bounces:2,steps:64,enabled:!0},ao:{aoIntensity:.372,aoSpread:.138395,aoSamples:10,aoMode:!1,aoColor:"#07005a",aoMaxSamples:32,aoStochasticCp:!0,aoEnabled:!0},atmosphere:{glowEnabled:!0,glowQuality:0,fogIntensity:0,fogNear:1e-4,fogFar:501.187,fogColor:"#15284c",fogDensity:0,glowIntensity:0,glowSharpness:825,glowMode:!1,glowColor:"#ffffff"},lighting:{advancedLighting:!0,ptEnabled:!0,renderMode:0,ptBounces:3,ptGIStrength:1,specularModel:1,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!0,ptAreaLights:!1,ptNEEAllLights:!0,ptReflMode:0,ptSobolBounce:!0,ptEnvNEE:!1,ptMaxLuminance:10,shadows:!0,areaLights:!1,shadowIntensity:1,shadowSoftness:2e3,shadowSteps:128,shadowBias:.002},quality:{engineQuality:!0,compilerHardCap:2e3,precisionMode:0,bufferPrecision:0,maxSteps:901,distanceMetric:0,estimator:0,deBailout:100,fudgeFactor:.25,stepJitter:.01,detail:1,pixelThreshold:.5,overstepTolerance:0,dynamicScaling:!0,adaptiveTarget:30,physicsProbeMode:0,manualDistance:10},optics:{camType:0,camFov:45,orthoScale:2,dofStrength:0,dofFocus:2.380234}},cameraRot:{x:.349883,y:-.344047,z:-.61069,w:.621508},sceneOffset:{x:-1.071173,y:-.008802,z:1.564088,xL:-.152661,yL:.007317,zL:-.252248},targetDistance:.443495,cameraMode:"Orbit",lights:[{type:"Point",position:{x:.62723,y:.240437,z:2.202913},rotation:{x:0,y:0,z:0},color:"#ffffff",intensity:40.5769,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0,id:"l7",range:7.015838},{type:"Point",position:{x:-.473801,y:-1.102272,z:.725389},rotation:{x:0,y:0,z:0},color:"#FF6C00",useTemperature:!0,temperature:1500,intensity:22.7529,falloff:.5,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0,id:"l8"},{type:"Point",position:{x:.25,y:.075,z:-.1},rotation:{x:0,y:0,z:0},color:"#E0EEFF",useTemperature:!0,temperature:7500,intensity:.5,falloff:.5,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!1,id:"l9"}]}},Oa={id:"MixPinski",name:"MixPinski",shortDescription:"4D Sierpinski-Menger hybrid by Darkbeam. Rich geometric detail.",description:"Darkbeam's MixPinski — a 4D hybrid combining Sierpinski tetrahedron folds (extended to 4D with w-component) and a Menger-like fold-scale transform. The interplay of these two IFS systems produces extraordinary geometric complexity.",juliaType:"offset",shader:{function:`
...
This rotation is bound to 'ParamC' (Slider below). Try dragging it!`},{id:"rot-1",type:"Rotate",enabled:!0,params:{x:0,y:0,z:0},bindings:{z:"ParamC"}},{id:"bulb-1",type:"Mandelbulb",enabled:!0,params:{power:8}},{id:"add-c",type:"AddConstant",enabled:!0,params:{scale:1}}],Ya={id:"Modular",name:"Modular Builder",shortDescription:"Construct custom fractal equations using a Node Graph.",description:"Construct your own fractal equation by chaining operations together. Combine folds, rotations, and logic via the Graph tab.",juliaType:"julia",shader:{function:"",loopBody:"",getDist:"",capabilities:new Set(["shape:modular"])},parameters:[null,null,null,null],defaultPreset:{formula:"Modular",features:{coreMath:{iterations:16,paramA:8,paramB:0,paramC:0,paramD:0,paramE:0,paramF:0},lighting:{shadows:!0,shadowSoftness:16,shadowIntensity:1,shadowBias:.002}},pipeline:Za,cameraPos:{x:0,y:0,z:4},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:0,xL:0,yL:0,zL:0}}},Qa={id:"MandelTerrain",name:"MandelTerrain",shortDescription:'3D Heightmap of the Mandelbrot set. Creates alien landscapes and "Math Mountains".',description:"A 3D Heightmap of the Mandelbrot set. Iterations slider controls terrain detail.",juliaType:"julia",shader:{function:`
    ...
    void formula_MandelMap(inout vec4 z, inout float dr, inout float trap, inout vec4 c) {
        ...
        }`,loopBody:"formula_MandelBolic(z, dr, trap, c);",getDist:`
            float m2 = r * r;
            if (m2 < 1.0e-20) return vec2(0.0, iter);
            float smoothIter = iter;
            if (m2 > 1.0) {
    ...
    void formula_Octahedron(inout vec4 z, inout float dr, inout float trap, vec4 c) {
        ...
        // Cutting-plane DE: octahedron face perpendicular to vertex direction (+x).
        // After fold, x is the dominant axis; face plane sits at z3.x = paramB.
        // Engine ignores cp_* writes when estimator != 5 (dead store).
        float d_face = z3.x - uParamB;
        cp_dmin = max(cp_dmin, cp_scale * d_face);
    ...
    // cp_dmin / cp_scale / cp_trap are engine-provided (shader.supportsCuttingPlane).`,function:`
    ...
    }`,preambleVars:["uCox_nc","uCox_nor","uCox_pca"],function:`
...
`,capabilities:new Set(["shape:per-iteration","iter:c-constant","render:writes-trap","render:writes-iter"])},parameters:[{label:"Foam",id:"paramA",min:.1,max:3,step:.001,default:1.032},{label:"Foam 2",id:"paramB",min:.1,max:3,step:.001,default:.92},{label:"Modulation",id:"paramC",min:0,max:2,step:.001,default:.658},{label:"Inversion",id:"paramD",min:0,max:1,step:1,default:0,mode:"toggle"},{label:"Fold Scale",id:"vec3A",type:"vec3",min:-1,max:4,step:.001,default:{x:.946,y:-.009,z:-.055}},{label:"Inv Center",id:"vec3B",type:"vec3",min:-5,max:5,step:.001,default:{x:.758,y:.312,z:.61}},{label:"Inv Radius / Angle",id:"vec2A",type:"vec2",min:-6.3,max:10,step:.001,default:{x:2.74,y:.07}},{label:"Twist",id:"paramF",min:-2,max:2,step:.01,default:0}],defaultPreset:{formula:"Apollonian",features:{coreMath:{iterations:13,paramA:1.4,paramB:1,paramC:0,paramD:1,paramF:0,vec2A:{x:1,y:.502},vec3A:{x:0,y:0,z:0},vec3B:{x:1.3525,y:.3285,z:.61}},coloring:{gradient:{stops:[{id:"apo_0",position:0,color:"#0D0221",bias:.5,interpolation:"linear"},{id:"apo_1",position:.15,color:"#2A0845",bias:.5,interpolation:"linear"},{id:"apo_2",position:.3,color:"#6B1D6B",bias:.5,interpolation:"linear"},{id:"apo_3",position:.5,color:"#D4418E",bias:.5,interpolation:"linear"},{id:"apo_4",position:.7,color:"#FF7F50",bias:.2247,interpolation:"linear"},{id:"apo_5",position:.85,color:"#FFD700",bias:.2837,interpolation:"linear"},{id:"apo_6",position:1,color:"#1A0533",bias:.5,interpolation:"linear"}],colorSpace:"srgb"},mode:0,scale:9.5331,offset:1.1556,repeats:1,phase:.11,bias:1,colorIter:0,twist:0,escape:2,gradient2:[{id:"1",position:.3,color:"#FFFFFF"},{id:"2",position:.8,color:"#D4418E"}],mode2:5,scale2:1,offset2:0,repeats2:1,phase2:0,bias2:1,twist2:0,blendMode:2,blendOpacity:0,layer3Color:"#ffffff",layer3Scale:89,layer3Strength:0,layer3Bump:0,layer3Turbulence:0,layer3Enabled:!0},ao:{aoIntensity:.411,aoSpread:.0032,aoSamples:5,aoMode:!1,aoColor:"#000000",aoMaxSamples:32,aoStochasticCp:!0,aoEnabled:!0},texturing:{active:!1,layer1Data:null,colorSpace:0,mapU:6,mapV:8,textureScale:{x:1,y:1},offset:{x:0,y:0}},materials:{diffuse:2,reflection:.12,specular:.19,roughness:.187,rim:0,rimExponent:4.5,envStrength:.77,envBackgroundStrength:.5,envSource:1,envMapData:null,envMapColorSpace:0,useEnvMap:!1,envRotation:0,envGradientStops:{stops:[{id:"0",position:0,color:"#0D0221",bias:.5,interpolation:"linear"},{id:"1",position:.3,color:"#2A0845",bias:.5,interpolation:"linear"},{id:"2",position:.6,color:"#6B1D6B",bias:.5,interpolation:"linear"},{id:"3",position:1,color:"#D4418E",bias:.5,interpolation:"linear"}],colorSpace:"linear"},emission:0,emissionMode:0,emissionColor:"#ffffff",ptEmissionMult:1},atmosphere:{glowEnabled:!0,glowQuality:0,fogIntensity:0,fogNear:1e-4,fogFar:501,fogColor:"#000000",fogDensity:0,glowIntensity:0,glowSharpness:1,glowMode:!1,glowColor:"#ffffff"},geometry:{applyTransformLogic:!0,preRotMaster:!0,hybridCompiled:!1,hybridMode:!1,hybridFoldType:0,hybridComplex:!1,hybridPermute:0,burningEnabled:!1,hybridIter:2,hybridFoldLimit:1,hybridFoldLimitVec:{x:1,y:1,z:1},hybridScale:2,hybridScaleVary:0,hybridMinR:.5,hybridFixedR:1,hybridAddC:!1,hybridShift:{x:0,y:0,z:0},hybridRot:{x:0,y:0,z:0},hybridFoldingValue:{x:2,y:2,z:2},hybridKaliConstant:{x:1,y:1,z:1},hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0,hybridSwap:!1,hybridSkip:1,preRotEnabled:!1,preRotX:0,preRotY:0,preRotZ:0,postRotX:0,postRotY:0,postRotZ:0,worldRotX:0,worldRotY:0,worldRotZ:0,juliaMode:!1,juliaX:0,juliaY:0,juliaZ:0,preRot:{x:0,y:0,z:0},postRot:{x:0,y:0,z:0},worldRot:{x:0,y:0,z:0},julia:{x:0,y:0,z:0}},lighting:{advancedLighting:!0,ptEnabled:!0,renderMode:0,ptBounces:3,ptGIStrength:1,specularModel:0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!0,ptNEEAllLights:!1,ptEnvNEE:!1,ptMaxLuminance:10,shadows:!0,areaLights:!1,shadowIntensity:1,shadowSoftness:300,shadowSteps:128,shadowBias:0,lights:[{type:"Point",position:{x:3.3724,y:-.0794,z:.9973},rotation:{x:-.18,y:-.04,z:0},color:"#FFE6D1",intensity:14.8996,falloff:6.4,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0,useTemperature:!0,temperature:5500,id:"l7",range:8.7754},{type:"Point",position:{x:.05,y:.075,z:-.1},rotation:{x:0,y:0,z:0},color:"#FFD6AA",useTemperature:!0,temperature:3500,intensity:.5,falloff:.5,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!1,id:"l8"},{type:"Point",position:{x:.25,y:.075,z:-.1},rotation:{x:0,y:0,z:0},color:"#E0EEFF",useTemperature:!0,temperature:7500,intensity:.5,falloff:.5,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!1,id:"l9"}]},quality:{engineQuality:!0,compilerHardCap:2e3,maxSteps:500,distanceMetric:2,estimator:0,fudgeFactor:1,stepRelaxation:0,stepJitter:.15,refinementSteps:0,detail:2.5,pixelThreshold:.2,overstepTolerance:0,physicsProbeMode:0,manualDistance:10},colorGrading:{active:!1,toneMapping:0,saturation:1,levelsMin:0,levelsMax:1,levelsGamma:1},optics:{camType:0,camFov:40,orthoScale:2,dofStrength:0,dofFocus:5}},cameraPos:{x:0,y:0,z:0},cameraRot:{x:.41,y:.2424,z:.8532,w:.2125},cameraFov:40,sceneOffset:{x:4,y:1.5,z:1.8,xL:.2077,yL:-.4379,zL:.2855},targetDistance:2.4689,cameraMode:"Orbit",lights:[{type:"Directional",position:{x:.4,y:1.1,z:2.5},rotation:{x:-.18,y:-.04,z:0},color:"#FFE6D1",intensity:.5,falloff:6.4,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0,useTemperature:!0,temperature:5500},{type:"Point",position:{x:.05,y:.075,z:-.1},rotation:{x:0,y:0,z:0},color:"#FFD6AA",useTemperature:!0,temperature:3500,intensity:.5,falloff:.5,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!1},{type:"Point",position:{x:.25,y:.075,z:-.1},rotation:{x:0,y:0,z:0},color:"#E0EEFF",useTemperature:!0,temperature:7500,intensity:.5,falloff:.5,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!1}]}},uo={id:"Cuboctahedron",name:"Cuboctahedron",shortDescription:"Archimedean solid fractal with cutting-plane DE.",description:"Kaleidoscopic IFS fractal with true cuboctahedral geometry. Uses Knighty's fold-and-cut approach: octahedral symmetry fold combined with cutting-plane distance estimation. The cuboctahedron vertex sits at the edge midpoint of the octahedral Schwarz triangle. Unlike r/dr estimation, the cutting-plane DE naturally handles fold boundary points, producing exact geometry.",juliaType:"offset",tags:["archimedean","ifs","knighty"],shader:{preamble:`
    ...
    const float co_d_pca = 0.57735027;  // 1/sqrt(3)`,function:`
    ...
    }`,preambleVars:["gsd_faceNor","gsd_faceOff"],function:`
...
}`,preambleVars:["ks_DF","ks_d","ks_d2","ks_de_prev","ks_de_curr","ks_xings"],loopInit:`
ks_DF      = 1.0;
ks_d       = 0.0;
ks_d2      = 0.0;
ks_de_prev = 1e10;
...
vec2 kj_wrap(vec2 x, vec2 a, vec2 s) {
    x -= s;
    return (x - a * floor(x / a)) + s;
}`,preambleVars:["kj_DF","kj_d","kj_d2","kj_de_prev","kj_de_curr","kj_xings"],loopInit:`
kj_DF      = 1.0;
kj_d       = 0.0;
kj_d2      = 0.0;
kj_de_prev = 1e10;
...
`,capabilities:new Set(["shape:per-iteration","iter:c-constant","render:writes-trap","render:writes-iter"])},parameters:[{label:"Klein R",id:"paramA",min:.5,max:3,step:.001,default:1.9605},{label:"Klein I",id:"paramB",min:-2,max:2,step:.001,default:.0179},{label:"Scale",id:"paramC",min:.1,max:3,step:.001,default:1},{label:"Rot Z",id:"paramD",min:-2,max:2,step:.001,default:0},{label:"DE Min",id:"paramE",min:.01,max:1,step:.001,default:.056},{label:"Twist",id:"paramF",min:-5,max:5,step:.01,default:0},{label:"Box Size XZ",id:"vec2A",type:"vec2",min:-4,max:4,step:.001,default:{x:-.9702,y:.526}},{label:"Inv Sphere (xyz=center, w=radius)",id:"vec4A",type:"vec4",min:-3,max:3,step:.001,default:{x:-.18,y:1.032,z:1.022,w:1.147}},{label:"Box Offset",id:"vec3C",type:"vec3",min:-3,max:3,step:.001,default:{x:0,y:0,z:0}}],defaultPreset:{formula:"KleinianJos",features:{coreMath:{iterations:24,paramA:1.9605,paramB:.0179,paramC:1,paramD:0,paramE:.056,paramF:0,vec2A:{x:-.9702,y:.526},vec4A:{x:-.18,y:1.032,z:1.022,w:1.147},vec3C:{x:0,y:0,z:0}},coloring:{mode:0,gradient:[{id:"kj0",position:0,color:"#050210",bias:.5,interpolation:"linear"},{id:"kj1",position:.3,color:"#1A3060",bias:.5,interpolation:"linear"},{id:"kj2",position:.6,color:"#4090C0",bias:.5,interpolation:"linear"},{id:"kj3",position:.85,color:"#90D0F0",bias:.5,interpolation:"linear"},{id:"kj4",position:1,color:"#F0F8FF",bias:.5,interpolation:"linear"}],scale:3,offset:0,repeats:1,phase:0,bias:1,twist:0,escape:2,gradient2:[{id:"1",position:0,color:"#000000",bias:.5,interpolation:"linear"},{id:"2",position:1,color:"#ffffff",bias:.5,interpolation:"linear"}],mode2:0,blendMode:0,blendOpacity:0,layer3Color:"#ffffff",layer3Scale:89,layer3Strength:0,layer3Bump:0,layer3Turbulence:0},atmosphere:{fogIntensity:.5,fogNear:0,fogFar:20,fogColor:"#020408",fogDensity:.05,glowIntensity:0,glowSharpness:3,glowMode:!1,glowColor:"#ffffff",aoIntensity:.3,aoSpread:.1,aoMode:!1},lighting:{shadows:!0,shadowSoftness:12,shadowIntensity:1,shadowBias:.002},quality:{detail:2,fudgeFactor:.9,pixelThreshold:.5,maxSteps:220,estimator:1,distanceMetric:0},geometry:{juliaMode:!0},materials:{diffuse:1.2,reflection:.05,specular:.8,roughness:.55,rim:.1,rimExponent:3,envStrength:0,envBackgroundStrength:1,envSource:1,useEnvMap:!1,envRotation:0,emission:0,emissionMode:0,emissionColor:"#ffffff",envGradientStops:[{id:"bg0",position:0,color:"#050210"},{id:"bg1",position:.5,color:"#0A1830"},{id:"bg2",position:1,color:"#050210"}]},optics:{camFov:60,dofStrength:0,dofFocus:5}},cameraPos:{x:0,y:0,z:0},cameraRot:{x:.763,y:-.1644,z:0,w:.6254},sceneOffset:{x:.42,y:1.6998,z:2.3338,xL:0,yL:0,zL:0},targetDistance:1.587,cameraMode:"Orbit",lights:[{type:"Point",position:{x:10,y:10,z:10},rotation:{x:0,y:0,z:0},color:"#FFFFFF",intensity:3.6,falloff:.5,falloffType:"Quadratic",fixed:!0,visible:!0,castShadow:!0},{type:"Point",position:{x:-10,y:-10,z:-10},rotation:{x:0,y:0,z:0},color:"#AACCFF",intensity:1,falloff:.5,falloffType:"Quadratic",fixed:!0,visible:!0,castShadow:!1}]}},xo={id:"SineJulia3D",name:"Sine Julia 3D",shortDescription:"Julia sets of a 3D extension of s·sin(z)+c (amoser). Kleinian-like limit-set forms.",description:`Julia sets of a 3D extension of the complex family s·sin(z)+c. The 3D map and its distance estimator are from amoser's "Sine Fractal 3D" Shadertoy (2026, CC-BY-NC-SA); the family is discussed on fractalforums.org thread 5591, where Pupukuusikko developed an independent DE. The map is not conformal, so the Julia sets stretch and distort — but for many parameters they look strikingly like Kleinian limit groups. A pre-iteration sphere inversion and per-axis rotation control the framing. Only the formula + DE are ported; shading is GMT's standard pipeline, not the original Shadertoy's post-stack.`,juliaType:"julia",shader:{preamble:`
    ...
    void formula_SineJulia3D(inout vec4 z, inout float dr, inout float trap, vec4 c) {
        ...
        dr = sqrt(sj_dz2);
        `,loopBody:"formula_SineJulia3D(z, dr, trap, c);",getDist:`
            float d = 0.25 * uParamA / max(dr, 1e-5);
            return vec2(d, iter);
        `,preambleVars:["sj_dz2","sj_cWrap"],capabilities:new Set(["shape:per-iteration","iter:c-constant","render:writes-trap","render:writes-iter"])},parameters:[{label:"Scale",id:"paramA",min:.4,max:2.5,step:.001,default:1},{label:"Inv. Center",id:"vec3A",type:"vec3",min:-3.14159,max:3.14159,step:.001,default:{x:1.5708,y:0,z:0},scale:"pi"},{label:"Inv. Radius",id:"paramC",min:.3,max:2.5,step:.001,default:1},{label:"Pre-Rotation",id:"vec3B",type:"vec3",min:-3.14159,max:3.14159,step:.001,default:{x:0,y:0,z:0},scale:"pi",mode:"axes"}],defaultPreset:{formula:"SineJulia3D",features:{coreMath:{iterations:12,paramA:1,paramC:1,vec3A:{x:1.5708,y:0,z:0},vec3B:{x:0,y:0,z:0}},geometry:{juliaMode:!0,juliaX:0,juliaY:0,juliaZ:0},quality:{detail:3,pixelThreshold:.5,maxSteps:500,fudgeFactor:.5,distanceMetric:0},coloring:{mode:1,scale:1,offset:0,repeats:1,phase:0,bias:1,escape:1e10},optics:{camFov:60}},cameraPos:{x:0,y:0,z:0},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:2.5,xL:0,yL:0,zL:0},targetDistance:2.5,cameraMode:"Orbit",lights:[{type:"Directional",position:{x:0,y:1,z:.3},rotation:{x:0,y:0,z:0},color:"#fff2d9",intensity:1.2,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0}]}},zo={id:"Julia3D",name:"Julia 3D (Kučera)",shortDescription:"Kučera's 3D Julia generalization (Bridges 2019) — both the Kleinian limit set and the escape-time Julia set, by Variant.",description:"Václav Kučera's 3D generalization of quadratic Julia sets (Bridges 2019). The Variant selector switches between the two objects in the paper, which share the same sphere-inversion group. LIMIT SET: the limit set of five radius-√3 spheres orthogonal to the unit sphere — an Apollonian-like 3D packing (Inflated Γ̃₁ drops the third sphere pair; True 3D Γ̃₂ adds it). JULIA SET: a reconstruction of the paper's omitted escape-time construction, H(w)=r²·h(w/|w|)+c, where h is built from the generators with their shared reflection lifted to 3D as a 180° x-rotation (the recovered detail that prevents cracking). Default c=(-1,0,0) gives the 3D Basilica.",juliaType:"julia",tags:["julia","kleinian","inversion","apollonian","bridges","limit-set","basilica"],shader:{preamble:`
...
void kk_invert(inout vec3 z, inout float dr, vec3 cen, float R2) {
...
}`,preambleVars:["kk_minSurf"],function:`
    void formula_Julia3D(inout vec4 z, inout float dr, inout float trap, vec4 c) {
        ...
        if (uParamC < 1.5) {
    ...
    }`,loopBody:"formula_Julia3D(z, dr, trap, c);",loopInit:"gmt_precalcRodrigues(uVec3B); kk_minSurf = 1e10;",usesSharedRotation:!0,getDist:`
            if (uParamC < 1.5) {
            ...
            return vec2(d, iter);
        `,capabilities:new Set(["shape:per-iteration","iter:c-constant","iter:shared-rotation","render:writes-trap","render:writes-iter"])},parameters:[{label:"Sphere Radius",id:"paramA",min:1.4,max:2.2,step:1e-4,default:1.7320508},{label:"Centre Distance",id:"paramB",min:1.6,max:2.6,step:1e-4,default:2},{label:"Variant",id:"paramC",min:0,max:2,step:1,default:2,options:[{label:"Limit set — Inflated (Γ̃₁)",value:0},{label:"Limit set — True 3D (Γ̃₂)",value:1},{label:"Julia set (escape-time)",value:2}]},{label:"DE Scale (limit set)",id:"paramD",min:.1,max:1.5,step:.001,default:.7},{label:"Radial Power (Julia set)",id:"paramE",min:1,max:4,step:.001,default:2},{label:"Rotation",id:"vec3B",type:"vec3",min:-6.28,max:6.28,step:.01,default:{x:0,y:0,z:0},mode:"rotation"}],defaultPreset:{formula:"Julia3D",features:{coreMath:{iterations:16,paramA:1.7320508,paramB:2,paramC:2,paramD:.7,paramE:2,vec3B:{x:0,y:0,z:0}},geometry:{juliaMode:!0,juliaX:-1,juliaY:0,juliaZ:0},quality:{detail:3,pixelThreshold:.4,maxSteps:500,fudgeFactor:.6,estimator:0},optics:{camFov:60}},cameraPos:{x:0,y:0,z:0},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:3.2,xL:0,yL:0,zL:0},targetDistance:3.2,cameraMode:"Orbit",lights:[{type:"Directional",position:{x:.6,y:1,z:.5},rotation:{x:0,y:0,z:0},color:"#fff2d9",intensity:1.2,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0}]}},So=[Pa,Ja,Oa,Na,ao,to,eo,Aa,ja,Da,Wa,io,Ra,Va,Qa,ro,xo,zo,bo,vo,Ta,Ea,Ba,go,yo,La,no,lo,uo,mo,so,co,po,ho,fo,Ka,ka,Ua,Ga,Ha,qa,$a,Xa,oo,Ya];So.forEach(e=>b.register(e));b.registerAlias("UberMenger","MengerAdvanced");b.registerAlias("FoldingBrot","BoxBulb");b.registerAlias("HyperTorus","Mandelorus");b.registerAlias("HyperbolicMandelbrot","MandelBolic");b.registerAlias("RhombicIcosahedron","Coxeter");Fa();Zt();ke();const G=(e,t)=>{const a=Ae.getState().setActiveTab;a==null||a(e),t&&requestAnimationFrame(()=>De(t))};V({id:"coloring-1",label:"Coloring · Layer 1",group:"host",apply:e=>re(e.config,1),editsParam:{featureId:"coloring",paramKey:"gradient"},reveal:()=>G("Gradient","layer1")});V({id:"coloring-2",label:"Coloring · Layer 2",group:"host",apply:e=>re(e.config,2),editsParam:{featureId:"coloring",paramKey:"gradient2"},reveal:()=>G("Gradient","layer2")});V({id:"env-gradient",label:"Environment · Sky",group:"host",apply:e=>je(e.config),editsParam:{featureId:"materials",paramKey:"envGradientStops"},reveal:()=>G("Shader")});Oe(()=>{const e=Ia.getState();e.setOpen(!e.open)});Ne(Ve);Ca();export{pt as F,D as I,Za as J,ut as S,d as a,St as b,_t as c,wt as d,Ft as e,Fa as f,To as g,Po as n,Et as p,zt as r,Ia as u};
