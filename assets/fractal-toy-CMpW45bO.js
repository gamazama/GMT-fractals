var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,j,F as p,k as g,u as m,S as D,c as $,i as k}from"./CollapsibleSection-CYwz2bPS.js";import{r as v,j as l,R as B}from"./three-fiber-GKfjny8F.js";import{j as O,k as N,m as S,l as w,v as R,n as V,E as G,D as H,a as X,P as q,T as Y,b as W,c as Q,G as Z,d as K,r as J,o as ee,i as te,h as ae,e as ie,g as oe,f as re}from"./Undo-A0bwgh52.js";import{V as ne,i as se,c as le}from"./Camera-BVCK8SN3.js";import{c as ce}from"./three-drei-DwjSMb5v.js";import{C as fe}from"./CompilingIndicator-CJOFyiIM.js";import{r as me}from"./cameraKeyRegistry-csW3AwU6.js";import"./pako-DwGzBETv.js";import"./three-DQWx7qFd.js";import"./CompositionOverlay-DSOOl2_m.js";const u=new Map,A=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),O(t.name)||N({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},ue=`
...
`}}const Fe=(t,e={})=>{const{formula:a}=e;if(a)for(const F of a.uniforms)t.addUniform(F.name,F.type);const i=t.buildDefinesBlock(),o=t.buildUniformsBlock(),r=t.getHeaders().join(`
`),n=t.getPreambles().join(`
`),c=t.getFunctions().join(`
`),I=a?we(a.call,a.deExpr??"0.5 * log(max(r, 1e-8)) * r / dr",a.escapeRadius??2):Se;return`#version 300 es
precision highp float;
...
`,we=(t,e,a)=>`
    ...
    fragColor = vec4(col, 1.0);
`;let E={},b=!1,s=null;const Re=(t={})=>{E=t,!b&&(b=!0,Ae())},Ae=()=>{S.register({id:"formula",slot:"left",order:50,label:"Formula",title:"Switch active formula",align:"start",width:"w-56"});for(const t of d.getAll())S.registerItem("formula",{id:`formula:${t.id}`,type:"toggle",label:t.name,title:t.description,isActive:()=>m.getState().formula===t.id,onToggle:()=>{m.getState().formula!==t.id&&m.setState({formula:t.id})}})},U={getCanvas:()=>(s==null?void 0:s.canvas)??null,rebuild:()=>{j.queue("Compiling shader…",()=>{C()})}},C=()=>{const t=s;if(!t){p.emit(g.IS_COMPILING,!1);return}const e=m.getState(),a=d.resolve(e.formula);a||console.warn("[fractalRenderer] no formulas registered — shader will be gradient-only");const i=new ye("Main");for(const r of h.getAll())r.inject&&r.inject(i,{},"Main");const o=Fe(i,{formula:a});try{t.setShader(o)}catch(r){console.error("[fractalRenderer] shader compile failed:",r),p.emit(g.IS_COMPILING,!1);return}Ee(),p.emit(g.RESET_ACCUM,void 0),p.emit(g.IS_COMPILING,!1)},Ee=()=>{const t=s;if(!t)return;const e=m.getState(),a=d.resolve(e.formula);if(a){const i=a.id.toLowerCase(),o=e[i];o&&a.pushUniforms&&a.pushUniforms(T(t),o)}P(e.camera),z(e.lighting)},T=t=>({setF:(e,a)=>t.setUniformF(e,a),setI:(e,a)=>t.setUniformI(e,a),set2F:(e,a,i)=>t.setUniform2F(e,a,i),set3F:(e,a,i,o)=>t.setUniform3F(e,a,i,o),set4F:(e,a,i,o,r)=>t.setUniform4F(e,a,i,o,r)}),P=t=>{if(!s||!t)return;s.setUniformF("uCamOrbitTheta",t.orbitTheta??.6),s.setUniformF("uCamOrbitPhi",t.orbitPhi??.2),s.setUniformF("uCamDistance",t.distance??2.5),s.setUniformF("uCamFov",t.fov??60);const e=t.target;s.setUniform3F("uCamTarget",(e==null?void 0:e.x)??0,(e==null?void 0:e.y)??0,(e==null?void 0:e.z)??0)},z=t=>{if(!s||!t)return;const e=t.direction;s.setUniform3F("uLightDir",(e==null?void 0:e.x)??.5,(e==null?void 0:e.y)??.8,(e==null?void 0:e.z)??.5);const a=t.color;if(a&&typeof a=="object"&&"r"in a)s.setUniform3F("uLightColor",a.r,a.g,a.b);else if(typeof a=="string"){const i=parseInt(a.replace("#",""),16);s.setUniform3F("uLightColor",(i>>16&255)/255,(i>>8&255)/255,(i&255)/255)}else s.setUniform3F("uLightColor",1,1,1);s.setUniformF("uLightIntensity",t.intensity??1),s.setUniformF("uAmbient",t.ambient??.15),s.setUniformF("uAoAmount",t.aoAmount??.4),s.setUniform3F("uAlbedo",t.albedoR??.85,t.albedoG??.72,t.albedoB??.55)},Ue=()=>{b||console.warn("[fractalRenderer] <FractalRendererCanvas /> rendered without installFractalRenderer() — frame telemetry will be missing.");const t=v.useRef(null),e=m(i=>i.canvasPixelSize),a=w();return v.useEffect(()=>{const i=t.current;if(!i)return;try{const n=new xe(i,{onFrameEnd:E.onFrameEnd??(()=>R.frameTick())});s=n,C(),n.start()}catch(n){console.error("[fractalRenderer] failed to start engine:",n);return}const o=m,r=[];return r.push(o.subscribe(n=>n.formula,()=>U.rebuild())),r.push(o.subscribe(n=>{const c=d.resolve(n.formula);return c?n[c.id.toLowerCase()]:null},n=>{if(!s||!n)return;const c=d.resolve(o.getState().formula);c!=null&&c.pushUniforms&&c.pushUniforms(T(s),n)})),r.push(o.subscribe(n=>n.camera,n=>P(n))),r.push(o.subscribe(n=>n.lighting,n=>z(n))),()=>{r.forEach(n=>n()),s==null||s.dispose(),s=null}},[]),v.useEffect(()=>{const i=s;if(!i)return;const[o,r]=e;o<1||r<1||i.resize(Math.max(1,Math.floor(o*a)),Math.max(1,Math.floor(r*a)))},[e,a]),l.jsxs(l.Fragment,{children:[l.jsx("canvas",{ref:t,className:"absolute inset-0 w-full h-full block"}),l.jsx(fe,{})]})},Ce=()=>{const t=h.getViewportOverlays().filter(a=>a.type==="dom"),e=m();return l.jsx("div",{className:"absolute inset-0 pointer-events-none z-[20]",children:t.map(a=>{const i=$.get(a.componentId),o=e[a.id];return i&&o?l.jsx(i,{featureId:a.id,sliceState:o,actions:e},a.id):null})})},Te=()=>{const t=m(),e=w(),{fpsSmoothed:a}=V(),i=v.useMemo(()=>({handleInteractionStart:t.handleInteractionStart,handleInteractionEnd:t.handleInteractionEnd,openContextMenu:t.openContextMenu}),[t.handleInteractionStart,t.handleInteractionEnd,t.openContextMenu]),o=Object.values(t.panels).filter(r=>r.location==="float"&&r.isOpen);return l.jsx(D,{value:i,children:l.jsxs("div",{className:"fixed inset-0 w-full h-full bg-black text-white select-none overflow-hidden flex flex-col",children:[l.jsx(G,{}),l.jsx(H,{}),o.map(r=>l.jsx(X,{id:r.id,title:r.id,children:l.jsx(q,{activeTab:r.id,state:t,actions:t,onSwitchTab:n=>t.togglePanel(n,!0)})},r.id)),l.jsx(Y,{}),l.jsxs("div",{className:"flex-1 flex overflow-hidden relative",children:[l.jsxs(ne,{children:[l.jsx(Ue,{}),l.jsx(Ce,{})]}),l.jsx(W,{side:"right"})]}),l.jsx(Q,{}),t.contextMenu.visible&&l.jsx(Z,{x:t.contextMenu.x,y:t.contextMenu.y,items:t.contextMenu.items,targetHelpIds:t.contextMenu.targetHelpIds,onClose:t.closeContextMenu,onOpenHelp:t.openHelp}),l.jsxs("div",{className:"absolute bottom-3 left-3 text-[10px] text-white/40 font-mono pointer-events-none",children:[a.toFixed(0)," fps · q",(e*100).toFixed(0),"%"]}),l.jsxs("div",{className:"absolute top-3 left-3 text-[10px] text-white/60 font-mono pointer-events-none",children:["Fractal Toy · ",t.formula||"…"]})]})})},Pe=[{id:"Camera",dock:"right",order:1,features:["camera"]},{id:"Lighting",dock:"right",order:2,features:["lighting"]}],ze=()=>K(Pe);J();ee({enabled:!0,targetFps:30,minQuality:.35,interactionDownsample:.55,activityGraceMs:100});te();ae();ie({getCanvas:()=>U.getCanvas()});oe();Re({onFrameEnd:()=>R.frameTick()});k();re();se();le.register({featureId:"camera",captureState:()=>{const e=m.getState().camera;return{orbitTheta:e==null?void 0:e.orbitTheta,orbitPhi:e==null?void 0:e.orbitPhi,distance:e==null?void 0:e.distance,fov:e==null?void 0:e.fov,target:{...e==null?void 0:e.target}}},applyState:t=>{m.getState().setCamera({orbitTheta:t.orbitTheta,orbitPhi:t.orbitPhi,distance:t.distance,fov:t.fov,target:t.target})}});me(["camera.orbitTheta","camera.orbitPhi","camera.distance","camera.fov","camera.target_x","camera.target_y","camera.target_z"]);ze();m.setState({formula:"Mandelbulb"});const L=document.getElementById("root");if(!L)throw new Error("Could not find root element to mount to");const Le=ce.createRoot(L);Le.render(l.jsx(B.StrictMode,{children:l.jsx(Te,{})}));
