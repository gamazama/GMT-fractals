var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,j,F as p,k as g,u as m,S as D,c as $,z as k,i as O}from"./CollapsibleSection-Cz5TC5MG.js";import{r as v,j as l,R as B}from"./three-fiber-BpjhY67l.js";import{j as V,k as N,m as S,l as w,v as R,n as G,E as H,D as X,a as q,P as Y,T as W,b as Q,c as Z,G as K,d as J,r as ee,o as te,i as ae,h as oe,e as ie,g as re,f as ne}from"./Undo-Brkn6KDF.js";import{V as se,i as le,c as ce}from"./Camera-CaM6zYkB.js";import{c as fe}from"./three-drei-BAIjpXNR.js";import{C as me}from"./CompilingIndicator-C04JnIyX.js";import{r as ue}from"./cameraKeyRegistry-CWwiJyFL.js";import"./pako-DwGzBETv.js";import"./three-t6Th-fjv.js";import"./CompositionOverlay-BEyI0mkJ.js";const u=new Map,A=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),V(t.name)||N({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},de=`
