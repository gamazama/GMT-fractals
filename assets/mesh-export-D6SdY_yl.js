...
}`}function wn(e){const t=e.definition,o=Lo(e),n=Io(t),s=_o(o,!!t.shader.getDist,"uVoxelSize * 0.5",e.estimator,We(t));return`#version 300 es
precision highp float;
...
}`}function Sn(e){const t=e.definition,o=Lo(e),n=Io(t),s=o==="ifs"?"0.0":"0.001",r=_o(o,!!t.shader.getDist,s,e.estimator,We(t));return`#version 300 es
...
`)}),e+=`
in vec2 vUv;
`,e},Dn=Tn(),co=(e,t,o={})=>{const{loopInit:n="",perIterInject:s="",distOverrideInit:r="",distOverrideInLoopFull:a="",distOverrideInLoopGeom:i="",distOverridePostFull:l="",distOverridePostGeom:p="",postMapCode:h="",postDistCode:u="",kernel:f={},is4D:g=!1}=o,b=!!f.numericDE,y=g?"length(z)":"getLength(z.xyz)",v=g?"dot(z, z)":"dot(z.xyz, z.xyz)",M=b?`
...
`),l=bn(this.useRotation),p=co(this.formulaLoopBody,this.formulaDist,this.deMasterOptions(this.kernelFeatures()));if(this.variant==="Physics")return`
${t}
${o}
${l}
${zt}
...
`)),v=uo(this.renderMode),M=Pn(this.postProcessLogic.join(`
`));return`
${t}
${o}
${n}
