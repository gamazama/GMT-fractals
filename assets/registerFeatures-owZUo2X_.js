var we=Object.defineProperty;var _e=(e,t,a)=>t in e?we(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var $=(e,t,a)=>_e(e,typeof t!="symbol"?t+"":t,a);import{ag as x,at as D,ca as I,a8 as g,aM as m,f,cb as Fe,cc as Me,cd as Ie,ce as Ce,cf as Pe,cg as Te,v as X,E as Ee,u as De,ch as Ae}from"./CollapsibleSection-a0do5d-5.js";import{n as w,d as B,p as Re,q as Be,r as U,s as Z,c as y,l as O}from"./three-DQWx7qFd.js";import{u as Le,r as ke,a as V,s as Oe,b as Ne,aD as Ve}from"./FormulaFormat-CseRkJYH.js";import{a as re,b as je}from"./gradientSeam-CYgc3p6h.js";import{a as Ge}from"./three-drei-D2x72drd.js";const Y=`
...
`,extraParams:{hybridFoldingValue:{type:"vec3",default:new y(2,2,2),label:"Folding Value",shortId:"hfv",uniform:"uHybridFoldingValue",min:.1,max:5,step:.01,group:"hybrid"}},defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2,hybridFoldingValue:{x:2,y:2,z:2}}},nt={id:"kali",label:"Kali",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = uHybridKaliConstant - abs(z);
}
`,rotMode:"post",extraParams:{hybridKaliConstant:{type:"vec3",default:new y(1,1,1),label:"Kali Constant",shortId:"hkc",uniform:"uHybridKaliConstant",min:-3,max:3,step:.01,group:"hybrid"}},defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.6,hybridFixedR:1,hybridIter:3,hybridKaliConstant:{x:.5,y:.5,z:.5}}},lt={id:"tetra",label:"Tetrahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
void initHybridTransform() {}
void formula_Hybrid(inout vec4 z, inout float dr, inout float trap, vec4 c) {}`);else{const h=(a==null?void 0:a.hybridFoldType)??0,d=ft(h);e.addFunction(d.glsl);const b=(a==null?void 0:a.hybridPermute)??0,M=ht(b);e.addFunction(gt(M,d.rotMode??"wrap",d.selfContained??!1))}let l="",n="";const c=t.formula,p=((v=x.get(c))==null?void 0:v.shader.selfContainedSDE)??!1,s=(a==null?void 0:a.burningEnabled)??!1;if(!p&&s&&(n+="z.xyz = mix(z.xyz, abs(z.xyz), uBurningRuntime * uBurningMix);"),r&&!p)if(!(a&&a.hybridComplex))l+=`
                if (uHybrid > 0.5) {
                    initHybridTransform();
                ...
                `;else{const d=(a==null?void 0:a.hybridSwap)??!1;l+=`if (uHybrid > 0.5) { initHybridTransform(); }
`,n+=`
                if (uHybrid > 0.5) {
...
`});u.register({id:"Custom",label:"Custom (Legacy)",category:"Utils",description:"Legacy node.",inputs:[],glsl:e=>""});const At=e=>{const t=new Map;return e.forEach(a=>{t.has(a.target)||t.set(a.target,[]),t.get(a.target).push(a)}),t},Rt=e=>{const t=new Set,a=["root-end"],o=new Set;for(;a.length>0;){const i=a.pop();o.has(i)||(o.add(i),i!=="root-end"&&i!=="root-start"&&t.add(i),(e.get(i)??[]).forEach(r=>a.push(r.source)))}return t},Bt=(e,t)=>{const a=At(t),o=Rt(a),i=e.filter(s=>o.has(s.id));if(!i||i.length===0)return`
    ...
    `;const l=new Map;l.set("root-start","v_start");let n=0;i.forEach((s,v)=>{const d=`v_${s.id.replace(/[^a-zA-Z0-9]/g,"")}`;l.set(s.id,d);const b=a.get(s.id)??[],M=b.find(F=>!F.targetHandle||F.targetHandle==="a"),P=b.find(F=>F.targetHandle==="b"),T=M&&l.get(M.source)||"v_start",xe=P&&l.get(P.source)||"v_start";if(r+=`    // Node: ${s.type} (${s.id})
`,r+=`    vec3 ${d}_p = ${T}_p;
`,r+=`    float ${d}_d = ${T}_d;
`,r+=`    float ${d}_dr = ${T}_dr;
`,s.enabled){const F=u.get(s.type);if(F){const H=s.condition&&s.condition.active;let q="    ";if(H){const E=n<I?`uModularParams[${n++}]`:"2.0",Se=n<I?`uModularParams[${n++}]`:"0.0";r+=`    { int ${d}_cmod = max(1, int(${E})); int ${d}_crem = int(${Se});
`,r+=`    if ( (i - (i/${d}_cmod)*${d}_cmod) == ${d}_crem ) {
`,q="        "}const ze=E=>s.bindings&&s.bindings[E]?`u${s.bindings[E]}`:n<I?`uModularParams[${n++}]`:"0.0";r+=F.glsl({varName:d,in1:T,in2:xe,getParam:ze,indent:q}),H&&(r+=`    }}
`)}}r+=`
...
cp_scale = 1.0;
cp_trap = 1e10;
`,Nt={id:"coreMath",shortId:"cm",name:"Formula Math",category:"Formulas",tabConfig:{label:"Formula"},extraUniforms:[{name:g.ModularParams,type:"float",arraySize:I,default:new Float32Array(I),backingOnly:!0}],params:{iterations:{type:"float",default:16,label:"Iterations",shortId:"it",uniform:"uIterations",min:1,max:500,step:1,group:"main"},paramA:{type:"float",default:8,label:"Param A",shortId:"pa",uniform:"uParamA",min:-10,max:10,step:.001,group:"params"},paramB:{type:"float",default:0,label:"Param B",shortId:"pb",uniform:"uParamB",min:-10,max:10,step:.001,group:"params"},paramC:{type:"float",default:0,label:"Param C",shortId:"pc",uniform:"uParamC",min:-10,max:10,step:.001,group:"params"},paramD:{type:"float",default:0,label:"Param D",shortId:"pd",uniform:"uParamD",min:-10,max:10,step:.001,group:"params"},paramE:{type:"float",default:0,label:"Param E",shortId:"pe",uniform:"uParamE",min:-10,max:10,step:.001,group:"params"},paramF:{type:"float",default:0,label:"Param F",shortId:"pf",uniform:"uParamF",min:-10,max:10,step:.001,group:"params"},vec2A:{type:"vec2",default:{x:0,y:0},label:"Vec2 A",shortId:"v2a",uniform:"uVec2A",min:-10,max:10,step:.001,group:"params"},vec2B:{type:"vec2",default:{x:0,y:0},label:"Vec2 B",shortId:"v2b",uniform:"uVec2B",min:-10,max:10,step:.001,group:"params"},vec2C:{type:"vec2",default:{x:0,y:0},label:"Vec2 C",shortId:"v2c",uniform:"uVec2C",min:-10,max:10,step:.001,group:"params"},vec3A:{type:"vec3",default:new y(0,0,0),label:"Vec3 A",shortId:"v3a",uniform:"uVec3A",min:-10,max:10,step:.001,group:"params"},vec3B:{type:"vec3",default:new y(0,0,0),label:"Vec3 B",shortId:"v3b",uniform:"uVec3B",min:-10,max:10,step:.001,group:"params"},vec3C:{type:"vec3",default:new y(0,0,0),label:"Vec3 C",shortId:"v3c",uniform:"uVec3C",min:-10,max:10,step:.001,group:"params"},vec4A:{type:"vec4",default:new O(0,0,0,0),label:"Vec4 A",shortId:"v4a",uniform:"uVec4A",min:-10,max:10,step:.001,group:"params"},vec4B:{type:"vec4",default:new O(0,0,0,0),label:"Vec4 B",shortId:"v4b",uniform:"uVec4B",min:-10,max:10,step:.001,group:"params"},vec4C:{type:"vec4",default:new O(0,0,0,0),label:"Vec4 C",shortId:"v4c",uniform:"uVec4C",min:-10,max:10,step:.001,group:"params"}},inject:(e,t)=>{var d;const a=t.formula,o=t.quality;a==="Modular"&&(e.addDefine("PIPELINE_REV",(t.pipelineRevision||0).toString()),e.addUniform(g.ModularParams,"float",I));const i=x.get(a);i!=null&&i.shader.selfContainedSDE&&(e.addDefine("SKIP_PRE_BAILOUT","1"),e.addDefine("SELF_CONTAINED_SDE","1"));let r="",l="",n="";const c=t.interlace,p=c!=null&&c.interlaceCompiled&&c.interlaceFormula?x.get(c.interlaceFormula):void 0,s=i?Et(i,p,"estimator:cutting-plane"):!1,v=(o==null?void 0:o.estimator)||0;let h=Lt(v,s);if(a==="Modular"){const b=Bt(t.pipeline||[],((d=t.graph)==null?void 0:d.edges)||[]);r+=b+`
...
`,l=i.shader.loopBody,n=i.shader.loopInit||"",i.shader.preamble&&e.addPreamble(i.shader.preamble),s&&(e.addPreamble(kt),n=Ot+n),i.shader.getDist&&v<4.5&&(h=`vec2 getDist(float r, float dr, float iter, vec4 z) { ${i.shader.getDist} }`));e.addFunction(r),e.setFormula(l,n,h)}};let Vt=0;function C(){return`l${++Vt}`}const jt={id:"shadows",label:"Shadows",renderContext:"direct",controlledParams:["lighting.shadowsCompile","lighting.shadowAlgorithm","lighting.ptStochasticShadows"],tiers:[{label:"Off",overrides:{lighting:{shadows:!1,shadowsCompile:!1,ptStochasticShadows:!1}},estCompileMs:0},{label:"Hard",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:2,ptStochasticShadows:!1}},estCompileMs:500},{label:"Soft",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!1}},estCompileMs:3e3},{label:"Full",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!0}},estCompileMs:3800}]},Gt={id:"reflections",label:"Reflections (Direct)",renderContext:"direct",controlledParams:["reflections.reflectionMode","reflections.bounceShadows","reflections.bounces"],tiers:[{label:"Off",overrides:{reflections:{reflectionMode:0,bounceShadows:!1}},estCompileMs:0},{label:"Env Map",overrides:{reflections:{reflectionMode:1,bounceShadows:!1}},estCompileMs:0},{label:"Raymarched",overrides:{reflections:{reflectionMode:3,bounceShadows:!1,bounces:1}},estCompileMs:7500},{label:"Full",overrides:{reflections:{reflectionMode:3,bounceShadows:!0,bounces:2}},estCompileMs:12e3}]},Ht={id:"lighting_quality",label:"Lighting",isAdvanced:!0,controlledParams:["lighting.specularModel","lighting.ptEnabled","lighting.ptNEEAllLights","lighting.ptEnvNEE"],tiers:[{label:"Preview",overrides:{lighting:{advancedLighting:!1,ptEnabled:!1}},estCompileMs:-2500},{label:"Path Traced",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!1,ptEnvNEE:!1}},estCompileMs:1900},{label:"PT + NEE",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!0,ptEnvNEE:!0}},estCompileMs:2500}]},qt={id:"atmosphere_quality",label:"Atmosphere",controlledParams:["atmosphere.glowEnabled","atmosphere.glowQuality","volumetric.ptVolumetric"],tiers:[{label:"Off",overrides:{atmosphere:{glowEnabled:!1},volumetric:{ptVolumetric:!1}},estCompileMs:0},{label:"Fast Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:1},volumetric:{ptVolumetric:!1}},estCompileMs:200},{label:"Color Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!1}},estCompileMs:400},{label:"Volumetric",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!0}},estCompileMs:5900}]},ue=[jt,Gt,Ht,qt],me=[{id:"preview",label:"Preview",description:"Instant preview shader — navigate without waiting for compile.",subsystems:{shadows:0,reflections:0,lighting_quality:0,atmosphere_quality:0}},{id:"fastest",label:"Fastest",description:"Hard shadows, path traced lighting with fast glow.",subsystems:{shadows:1,reflections:0,lighting_quality:1,atmosphere_quality:1}},{id:"lite",label:"Lite",description:"Soft shadows, env map reflections, color glow.",subsystems:{shadows:2,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"balanced",label:"Balanced",description:"Full shadows, env map reflections, color glow.",subsystems:{shadows:3,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"full",label:"Full",description:"Full shadows, raymarched reflections, volumetric.",subsystems:{shadows:3,reflections:3,lighting_quality:1,atmosphere_quality:3}},{id:"ultra",label:"Ultra",description:"Full + PT NEE. Experimental.",isAdvanced:!0,subsystems:{shadows:3,reflections:3,lighting_quality:2,atmosphere_quality:3}}];({...me[3].subsystems});function $t(e){return me.find(t=>t.id===e)}function Co(e){if(!e.activePreset)return"Custom";const t=$t(e.activePreset);if(!t)return"Custom";if(!e.isCustomized)return t.label;const a=[];for(const o of ue){const i=t.subsystems[o.id],r=e.subsystems[o.id];if(i!==r){const l=o.tiers[r];a.push(`${o.label}=${(l==null?void 0:l.label)??"?"}`)}}return`${t.label} (${a.join(", ")})`}const Xt=4200;function Po(e){let t=Xt;for(const a of ue){const o=e[a.id]??0,i=a.tiers[o];i&&(t+=i.estCompileMs)}return t}const Ut=(e,t)=>{if(!e)return`
...
`,ea=(e,t,a=!0,o=!1)=>{const i=e?"2":"maxBounces",n=`
...
`};function ve(e){return e.id&&e.type&&e.position&&e.rotation?e:{...e,id:e.id??C(),type:e.type??"Point",position:e.position??{x:0,y:0,z:0},rotation:e.rotation??{x:0,y:0,z:0}}}function To(e){let t=-1;for(let o=0;o<e.length;o++){const i=e[o];if(!i.id||!i.type||!i.position||!i.rotation){t=o;break}}if(t===-1)return e;const a=e.slice();for(let o=t;o<a.length;o++)a[o]=ve(a[o]);return a}const Eo=(e,t)=>!e||!e.lights||t>=e.lights.length?{id:"",type:"Point",position:{x:0,y:0,z:0},rotation:{x:0,y:0,z:0},color:"#ffffff",intensity:0,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!0,radius:0,range:0,intensityUnit:"raw"}:ve(e.lights[t]),ta=[{id:C(),type:"Point",position:{x:-2,y:1,z:2},rotation:{x:0,y:0,z:0},color:"#fff4e6",intensity:1.5,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:5500},{id:C(),type:"Point",position:{x:2,y:-1,z:1},rotation:{x:0,y:0,z:0},color:"#FFD6AA",intensity:.5,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:3500},{id:C(),type:"Point",position:{x:0,y:-5,z:2},rotation:{x:0,y:0,z:0},color:"#E0EEFF",intensity:.25,falloff:0,falloffType:"Quadratic",fixed:!0,visible:!1,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:7500}],aa={id:"lighting",shortId:"l",name:"Lighting",category:"Rendering",tabConfig:{label:"Light",condition:{param:"$advancedMode",bool:!0}},viewportConfig:{componentId:"overlay-lighting",renderOrder:50,type:"dom"},engineConfig:{toggleParam:"advancedLighting",mode:"compile",label:"Lighting Engine",groupFilter:"engine_settings"},groups:{shadows:{label:"Shadows",description:"Per-light shadow tracing and softness.",helpId:"shadows"}},extraUniforms:[{name:g.LightCount,type:"int",default:0},{name:g.LightType,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:g.LightPos,type:"vec3",arraySize:m,default:new Array(m).fill(new y)},{name:g.LightDir,type:"vec3",arraySize:m,default:new Array(m).fill(new y(0,-1,0))},{name:g.LightColor,type:"vec3",arraySize:m,default:new Array(m).fill(new w(1,1,1))},{name:g.LightIntensity,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:g.LightShadows,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:g.LightFalloff,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:g.LightFalloffType,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:g.LightRadius,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:g.LightSoftness,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:g.LightHideEmitter,type:"float",arraySize:m,default:new Float32Array(m).fill(0)},{name:g.EnvCDFMarginal,type:"sampler2D",default:null},{name:g.EnvCDFConditional,type:"sampler2D",default:null},{name:g.EnvCDFSize,type:"vec2",default:new B(1,1)},{name:g.EnvLumIntegral,type:"float",default:1},{name:g.EnvCDFMipBias,type:"float",default:0},{name:g.EnvMaxMip,type:"float",default:8},{name:g.EnvAvgColor,type:"vec3",default:new y(-1,-1,-1)}],params:{advancedLighting:{type:"boolean",default:!0,label:"Light Engine",shortId:"le",group:"main",noReset:!0,hidden:!0,onUpdate:"compile",description:"Master switch for lighting logic. Disabling provides stubs only."},ptEnabled:{type:"boolean",default:!0,label:"Path Tracing Core",shortId:"pe",group:"engine_settings",ui:"checkbox",description:"Compiles the Path Tracing module. Disable to reduce shader size.",onUpdate:"compile",noReset:!0,estCompileMs:1500},renderMode:{type:"float",default:0,label:"Active Mode",shortId:"rm",group:"engine_settings",parentId:"ptEnabled",options:[{label:"Direct (Fast)",value:0},{label:"Path Tracing (GI)",value:1}],description:"Switches between fast direct lighting and physically based Global Illumination.",onUpdate:"compile",noReset:!0},ptBounces:{type:"int",default:3,label:"Max Bounces",shortId:"pb",uniform:"uPTBounces",min:1,max:8,step:1,group:"engine_settings",parentId:"ptEnabled",ui:"numeric",description:"Recursion depth. Higher = Brighter interiors, Slower render."},ptGIStrength:{type:"float",default:1,label:"GI Strength",shortId:"pg",uniform:"uPTGIStrength",min:0,max:5,step:.01,group:"engine_settings",parentId:"ptEnabled",description:"Artistic boost for bounced light intensity."},specularModel:{type:"float",default:0,label:"Specular Model",shortId:"sm",group:"engine_settings",options:[{label:"Blinn-Phong (Fast)",value:0,estCompileMs:0},{label:"Cook-Torrance (Quality)",value:1,estCompileMs:400}],description:"BRDF model for direct lighting. Cook-Torrance is physically accurate but increases shader compile time.",onUpdate:"compile",noReset:!0},shadowsCompile:{type:"boolean",default:!0,label:"Shadow Engine",shortId:"sc",group:"engine_settings",ui:"checkbox",noReset:!0,onUpdate:"compile",description:"Compiles the shadow raymarching loop. Disable to save ~5s compile time.",estCompileMs:1500},shadowAlgorithm:{type:"float",default:0,label:"Shadow Quality",shortId:"sa",group:"engine_settings",parentId:"shadowsCompile",options:[{label:"Hard Only (Fastest)",value:2,estCompileMs:500},{label:"Lite Soft (Fast)",value:1,estCompileMs:1500},{label:"Robust Soft (Quality)",value:0,estCompileMs:3e3}],description:"Shadow algorithm. Hard = binary occlusion, Lite = fast penumbra, Robust = accurate penumbra.",onUpdate:"compile",noReset:!0},ptStochasticShadows:{type:"boolean",default:!0,label:"Soft Shadow Jitter",shortId:"ps",group:"engine_settings",parentId:"shadowsCompile",ui:"checkbox",onUpdate:"compile",noReset:!0,estCompileMs:800,description:"Stochastic shadow jitter for Point lights — fakes soft penumbras via accumulation. Independent of True Area Lights (which uses physical sphere sampling for type=Sphere lights)."},ptAreaLights:{type:"boolean",default:!1,label:"True Area Lights",shortId:"pal2",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noReset:!0,estCompileMs:600,description:"Physically-correct sphere area light integration (sphere-surface sampling + MIS). Required for lights with type=Sphere. Enable + change a light type to Sphere via the per-light menu. Costs ~600ms compile + one extra sphere intersection per bounce."},ptNEEAllLights:{type:"boolean",default:!1,label:"Sample All Lights",shortId:"pal",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noReset:!0,description:"Evaluates every active light per bounce instead of one random light. Reduces shadow noise at the cost of N× more shadow rays."},ptReflMode:{type:"float",default:2,label:"Env Sampling",shortId:"prm",group:"engine_settings",parentId:"ptEnabled",options:[{label:"Off",value:0,estCompileMs:0},{label:"Env MIS",value:1,estCompileMs:250},{label:"Env MIS + IS",value:2,estCompileMs:650}],onUpdate:"compile",noReset:!0,description:"Direct env-map sampling with MIS for path-traced reflections. Env MIS handles broad skies; Env MIS + IS adds importance sampling for HDR maps with sun discs / concentrated lights. Replaces the older Environment NEE (which only handled diffuse)."},ptSobolBounce:{type:"boolean",default:!0,label:"Sobol Bounce Sampling",shortId:"psb",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noReset:!0,estCompileMs:50,description:"Low-discrepancy 2D sequence (Sobol) with per-pixel rotation for the bounce-direction seed. Measurably less variance on shiny surfaces; no effect on rough/diffuse-heavy scenes."},ptEnvNEE:{type:"boolean",default:!1,hidden:!0,label:"Environment NEE (legacy)",shortId:"pen",group:"engine_settings",parentId:"ptEnabled",noReset:!0,description:"Deprecated — kept so old scene files load without dropping state. Migrated to ptReflMode at boot."},ptMaxLuminance:{type:"float",default:10,label:"Firefly Clamp",shortId:"pfl",uniform:"uPTMaxLuminance",min:.5,max:200,step:.5,scale:"log",group:"engine_settings",parentId:"ptEnabled",description:"Clamps per-sample luminance to suppress bright firefly spikes. Lower = cleaner but slightly biased. Raise to effectively disable."},shadows:{type:"boolean",default:!0,label:"Enable",shortId:"sh",group:"main",uniform:"uShadows",ui:"checkbox",condition:{param:"shadowsCompile",bool:!0},description:"Toggle shadow casting at runtime without recompiling.",helpId:"shadows"},areaLights:{type:"boolean",default:!1,label:"Area Lights",shortId:"al",uniform:"uAreaLights",group:"shadows",hidden:!0,condition:{param:"ptStochasticShadows",bool:!0},description:"Stochastic area light shadows. Disable for sharp analytical shadows.",helpId:"shadows",onUpdate:"compile",noReset:!0},shadowIntensity:{type:"float",default:1,label:"Opacity",shortId:"si",uniform:"uShadowIntensity",min:0,max:1,step:.01,group:"shadows",condition:{bool:!0},description:"How dark the shadowed regions become (1 = fully black).",helpId:"shadows"},shadowSoftness:{type:"float",default:16,label:"Hardness",shortId:"ss",uniform:"uShadowSoftness",min:2,max:2e3,step:1,group:"shadows",scale:"log",condition:{bool:!0},description:"Higher values give crisper shadows; lower values give wider penumbras. Affects Point and Directional lights only — Sphere area lights derive shadow softness from physical sphere sampling.",helpId:"shadows"},shadowSteps:{type:"int",default:128,label:"Steps",shortId:"st",min:16,max:512,step:16,group:"shadows",condition:{bool:!0},uniform:"uShadowSteps",ui:"numeric",description:"Quality vs Performance.",helpId:"shadows"},shadowBias:{type:"float",default:.002,label:"Bias",shortId:"sb",uniform:"uShadowBias",min:0,max:1,step:1e-6,group:"shadows",scale:"log",condition:{bool:!0},description:"Too low: acne. Too high: detached.",helpId:"shadows"},lights:{type:"complex",default:ta,label:"Light List",shortId:"ll",group:"data",hidden:!0,noReset:!0}},inject:(e,t,a)=>{if(a!=="Main"){e.addPostDEFunction(`
             ...
             `);return}e.addDefine("MAX_LIGHTS",m.toString());const o=t.lighting;if(o&&!o.advancedLighting){e.addDefine("MAX_LIGHTS","0"),e.addPostDEFunction(`
             float GetSoftShadow(vec3 ro, vec3 rd, float k, float lightDist, float noise) { return 1.0; }
             float GetHardShadow(vec3 ro, vec3 rd, float lightDist) { return 1.0; }
...
void kk_invert(inout vec3 z, inout float dr, vec3 cen, float R2) {
    ...
    void formula_Julia3D(inout vec4 z, inout float dr, inout float trap, vec4 c) {
        ...
        if (uParamC < 1.5) {
            ...
            return vec2(d, iter);
        `,capabilities:new Set(["shape:per-iteration","iter:c-constant","iter:shared-rotation","render:writes-trap","render:writes-iter"])},parameters:[{label:"Sphere Radius",id:"paramA",min:1.4,max:2.2,step:1e-4,default:1.7320508},{label:"Centre Distance",id:"paramB",min:1.6,max:2.6,step:1e-4,default:2},{label:"Variant",id:"paramC",min:0,max:2,step:1,default:2,options:[{label:"Limit set — Inflated (Γ̃₁)",value:0},{label:"Limit set — True 3D (Γ̃₂)",value:1},{label:"Julia set (escape-time)",value:2}]},{label:"DE Scale (limit set)",id:"paramD",min:.1,max:1.5,step:.001,default:.7},{label:"Radial Power (Julia set)",id:"paramE",min:1,max:4,step:.001,default:2},{label:"Rotation",id:"vec3B",type:"vec3",min:-6.28,max:6.28,step:.01,default:{x:0,y:0,z:0},mode:"rotation"}],defaultPreset:{formula:"Julia3D",features:{coreMath:{iterations:16,paramA:1.7320508,paramB:2,paramC:2,paramD:.7,paramE:2,vec3B:{x:0,y:0,z:0}},geometry:{juliaMode:!0,juliaX:-1,juliaY:0,juliaZ:0},quality:{detail:3,pixelThreshold:.4,maxSteps:500,fudgeFactor:.6,estimator:0},optics:{camFov:60}},cameraPos:{x:0,y:0,z:0},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:3.2,xL:0,yL:0,zL:0},targetDistance:3.2,cameraMode:"Orbit",lights:[{type:"Directional",position:{x:.6,y:1,z:.5},rotation:{x:0,y:0,z:0},color:"#fff2d9",intensity:1.2,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0}]}},zo=[Ca,Qa,ka,Oa,to,eo,Ja,Ea,Va,Da,Wa,oo,Aa,Na,Ya,io,vo,xo,yo,bo,Pa,Ta,Ra,ho,go,Ba,ro,no,fo,uo,lo,so,co,mo,po,Ka,La,Xa,ja,Ga,Ha,qa,$a,ao,Za];zo.forEach(e=>x.register(e));x.registerAlias("UberMenger","MengerAdvanced");x.registerAlias("FoldingBrot","BoxBulb");x.registerAlias("HyperTorus","Mandelorus");x.registerAlias("HyperbolicMandelbrot","MandelBolic");x.registerAlias("RhombicIcosahedron","Coxeter");_a();ke();const G=(e,t)=>{const a=De.getState().setActiveTab;a==null||a(e),t&&requestAnimationFrame(()=>Ae(t))};V({id:"coloring-1",label:"Coloring · Layer 1",group:"host",apply:e=>re(e.config,1),editsParam:{featureId:"coloring",paramKey:"gradient"},reveal:()=>G("Gradient","layer1")});V({id:"coloring-2",label:"Coloring · Layer 2",group:"host",apply:e=>re(e.config,2),editsParam:{featureId:"coloring",paramKey:"gradient2"},reveal:()=>G("Gradient","layer2")});V({id:"env-gradient",label:"Environment · Sky",group:"host",apply:e=>je(e.config),editsParam:{featureId:"materials",paramKey:"envGradientStops"},reveal:()=>G("Shader")});Oe(()=>{const e=Fa.getState();e.setOpen(!e.open)});Ne(Ve);Ia();export{ue as A,pt as F,A as I,Ua as J,me as S,u as a,Po as b,Co as c,ut as d,Do as e,St as f,Eo as g,_t as h,wt as i,Ft as j,_a as k,To as n,Et as p,zt as r,Fa as u};
