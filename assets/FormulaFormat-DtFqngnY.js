...
`,extraParams:{hybridFoldingValue:{type:"vec3",default:new N(2,2,2),label:"Folding Value",shortId:"hfv",uniform:"uHybridFoldingValue",min:.1,max:5,step:.01,group:"hybrid"}},defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2,hybridFoldingValue:{x:2,y:2,z:2}}},qa={id:"kali",label:"Kali",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = uHybridKaliConstant - abs(z);
}
`,rotMode:"post",extraParams:{hybridKaliConstant:{type:"vec3",default:new N(1,1,1),label:"Kali Constant",shortId:"hkc",uniform:"uHybridKaliConstant",min:-3,max:3,step:.01,group:"hybrid"}},defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.6,hybridFixedR:1,hybridIter:3,hybridKaliConstant:{x:.5,y:.5,z:.5}}},Wa={id:"tetra",label:"Tetrahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    if (z.x + z.y < 0.0) z.xy = -z.yx;
    if (z.x + z.z < 0.0) z.xz = -z.zx;
    if (z.y + z.z < 0.0) z.yz = -z.zy;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.25,hybridFixedR:1,hybridIter:3}},Xa={id:"octa",label:"Octahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},Ya={id:"icosa",label:"Icosahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:4}},Ka={id:"menger",label:"Menger (Cubic)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,selfContained:!0,extraParams:{hybridMengerOffset:{type:"vec3",default:new N(1,1,1),label:"Offset",shortId:"hmo",uniform:"uHybridMengerOffset",min:0,max:2,step:.01,group:"hybrid",linkable:!0},hybridMengerCenterZ:{type:"boolean",default:!0,label:"Center Z",shortId:"hmz",uniform:"uHybridMengerCenterZ",group:"hybrid"}},defaults:{hybridScale:3,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3,hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0}},ct=[Ha,Va,Ga,Ua,qa,Wa,Xa,Ya,Ka],Ja=ct.map((e,o)=>({label:e.label,value:o}));function Za(e){return ct[e]??ct[0]}const Qa=`
...
`,er=["xyz","xzy","yxz","yzx","zxy","zyx"];function tr(e){const o=er[e]??"xyz";return o==="xyz"?"vec3 c_perm = c.xyz;":`vec3 c_perm = c.${o};`}function or(e,o,t=!1){return`
mat3 hybridRotMat;
bool hybridHasRot;
...
`,l+=`
                ...
                `}e.addHybridFold("",n,l)}},Zt=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF"],Qt=["uVec2A","uVec2B","uVec2C"],eo=["uVec3A","uVec3B","uVec3C"],to=["uVec4A","uVec4B","uVec4C"],Po=["uInterlaceParamA","uInterlaceParamB","uInterlaceParamC","uInterlaceParamD","uInterlaceParamE","uInterlaceParamF"],Lo=["uInterlaceVec2A","uInterlaceVec2B","uInterlaceVec2C"],Eo=["uInterlaceVec3A","uInterlaceVec3B","uInterlaceVec3C"],ko=["uInterlaceVec4A","uInterlaceVec4B","uInterlaceVec4C"];function ir(){const e=[];for(let o=0;o<Zt.length;o++)e.push([new RegExp(`\\b${Zt[o]}\\b`,"g"),Po[o]]);for(let o=0;o<Qt.length;o++)e.push([new RegExp(`\\b${Qt[o]}\\b`,"g"),Lo[o]]);for(let o=0;o<eo.length;o++)e.push([new RegExp(`\\b${eo[o]}\\b`,"g"),Eo[o]]);for(let o=0;o<to.length;o++)e.push([new RegExp(`\\b${to[o]}\\b`,"g"),ko[o]]);return e}const nr=ir();function Tt(e){let o=e;for(const[t,a]of nr)o=o.replace(t,a);return o}function zt(e,o){const t=[...o].sort((r,i)=>i.length-r.length);let a=e;for(const r of t)a=a.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return a}function sr(e,o,t){let a=e;return a=a.replace(new RegExp(`\\b${o}_\\w+\\b`,"g"),r=>`interlace_${r}`),t&&t.length>0&&(a=zt(a,t)),a=Tt(a),a}function lr(e,o,t){let a=e;return a=a.replace(new RegExp(`\\bformula_${o}\\b`,"g"),"formula_Interlace"),a=Tt(a),t&&t.length>0&&(a=zt(a,t)),a}function cr(e,o){return e.replace(new RegExp(`\\bformula_${o}\\b`,"g"),"formula_Interlace")}function dr(e,o,t){let a=e;return a=a.replace(new RegExp(`\\b${o}_\\w+\\b`,"g"),r=>`interlace_${r}`),a=Tt(a),t&&t.length>0&&(a=zt(a,t)),a}function ur(e,o,t){let a="";o&&(a=`
...
`});U.register({id:"Custom",label:"Custom (Legacy)",category:"Utils",description:"Legacy node.",inputs:[],glsl:e=>""});const br=(e,o)=>{const t=new Set,a=["root-end"],r=new Set;for(;a.length>0;){const f=a.pop();if(r.has(f))continue;r.add(f),f!=="root-end"&&f!=="root-start"&&t.add(f),o.filter(h=>h.target===f).forEach(h=>a.push(h.source))}const i=e.filter(f=>t.has(f.id));if(!i||i.length===0)return`
    ...
    `;const l=new Map;l.set("root-start","v_start");let s=0;i.forEach((f,p)=>{const g=`v_${f.id.replace(/[^a-zA-Z0-9]/g,"")}`;l.set(f.id,g);const v=o.filter(k=>k.target===f.id),m=v.find(k=>!k.targetHandle||k.targetHandle==="a"),y=v.find(k=>k.targetHandle==="b"),b=m&&l.get(m.source)||"v_start",_=y&&l.get(y.source)||"v_start";if(n+=`    // Node: ${f.type} (${f.id})
`,n+=`    vec3 ${g}_p = ${b}_p;
`,n+=`    float ${g}_d = ${b}_d;
`,n+=`    float ${g}_dr = ${b}_dr;
`,f.enabled){const k=U.get(f.type);if(k){const S=f.condition&&f.condition.active;let C="    ";if(S){const P=Math.round(Math.max(1,f.condition.mod)),D=Math.round(f.condition.rem);n+=`    if ( (i - (i/${P})*${P}) == ${D} ) {
`,C="        "}const E=P=>f.bindings&&f.bindings[P]?`u${f.bindings[P]}`:s<Mt?`uModularParams[${s++}]`:"0.0";n+=k.glsl({varName:g,in1:b,in2:_,getParam:E,indent:C}),S&&(n+=`    }
`)}}n+=`
...
`},vr=e=>{let o="d = 0.5 * log(max(r, 1.0e-5)) * r / dr_safe;";return e<.5?o=`
        float logR2 = log2(m2);
...
`,n=r.shader.loopBody,l=r.shader.loopInit||"",r.shader.preamble&&e.addPreamble(r.shader.preamble),r.shader.getDist&&(c=`vec2 getDist(float r, float dr, float iter, vec4 z) { ${r.shader.getDist} }`));e.addFunction(i),e.setFormula(n,l,c)}};let Sr=0;function Ve(){return`l${++Sr}`}const wr=(e,o)=>{if(!e)return`
...
This rotation is bound to 'ParamC' (Slider below). Try dragging it!`},{id:"rot-1",type:"Rotate",enabled:!0,params:{x:0,y:0,z:0},bindings:{z:"ParamC"}},{id:"bulb-1",type:"Mandelbulb",enabled:!0,params:{power:8}},{id:"add-c",type:"AddConstant",enabled:!0,params:{scale:1}}],ie=je();let st=null,kt=!1;function mo(e,o){st=o,kt=!0,R.emit(le.IS_COMPILING,e)}function Fn(){return kt?(kt=!1,!0):!1}function On(){if(st){const e=st;st=null,e()}}const pe=So()(wo((e,o,t)=>({...ua(e,o),...pa(e,o),...Sa(e,o),...Ma(e,o),...ci(e,o),...xi(e,o),formula:"Mandelbulb",pipeline:ho,pipelineRevision:1,graph:po(ho),projectSettings:{name:"Mandelbulb",version:0},lastSavedHash:null,animations:[],liveModulations:{},setFormula:(a,r={})=>{const i=o(),n=i.formula;if(n===a&&a!=="Modular")return;r.skipDefaultPreset||(o().resetParamHistory(),e({undoStack:[],redoStack:[]}));const l=i.projectSettings.name;let s=l;(l===n||l==="Untitled"||l==="Custom Preset")&&(s=a),e({formula:a,projectSettings:{...i.projectSettings,name:s}}),mo("Loading Preview...",()=>{if(R.emit(le.CONFIG,{formula:a,pipeline:i.pipeline,graph:i.graph}),a!=="Modular"&&!r.skipDefaultPreset){const c=he.get(a),u=c&&c.defaultPreset?JSON.parse(JSON.stringify(c.defaultPreset)):{formula:a};u.features||(u.features={});const f=o();if(j.getEngineFeatures().forEach(h=>{const g=f[h.id];if(!g)return;const v=u.features[h.id]||{},m={},y=h.engineConfig.toggleParam;g[y]!==void 0&&v[y]===void 0&&(m[y]=g[y]),Object.entries(h.params).forEach(([b,_])=>{_.onUpdate==="compile"&&g[b]!==void 0&&v[b]===void 0&&(m[b]=g[b])}),u.features[h.id]||(u.features[h.id]={}),Object.assign(u.features[h.id],m)}),o().lockSceneOnSwitch){const h=o().getPreset(),g={...h.features||{}},v=u.features||{};v.coreMath&&(g.coreMath=v.coreMath),v.geometry&&(g.geometry=v.geometry);const m={...h,formula:a,features:g};o().loadPreset(m)}else o().loadPreset(u)}o().handleInteractionEnd(),ie.post({type:"CONFIG_DONE"})})},setProjectSettings:a=>e(r=>{const i={...r.projectSettings,...a};return a.name&&a.name!==r.projectSettings.name?(i.version=0,{projectSettings:i,lastSavedHash:null}):{projectSettings:i}}),prepareExport:()=>{const a=o(),r=a.getPreset({includeScene:!0}),{version:i,name:n,...l}=r,s=JSON.stringify(l);if(a.lastSavedHash===null||a.projectSettings.version===0){const c=Math.max(1,a.projectSettings.version+1);return e({projectSettings:{...a.projectSettings,version:c},lastSavedHash:s}),c}if(a.lastSavedHash!==s){const c=a.projectSettings.version+1;return e({projectSettings:{...a.projectSettings,version:c},lastSavedHash:s}),c}return a.projectSettings.version},setAnimations:a=>{const r=o().animations,i=a.map(n=>{const l=r.find(s=>s.id===n.id);if(!l)return n;if(n.period!==l.period&&n.period>0){const s=performance.now()/1e3,c=(s/l.period+l.phase-s/n.period)%1;return{...n,phase:(c+1)%1}}return n});e({animations:i})},setLiveModulations:a=>e({liveModulations:a}),setGraph:a=>{const r=fo(a.nodes,a.edges),i=o();if(Ni(i.pipeline,r))$i(i.pipeline,r)?e({graph:a}):(e({graph:a,pipeline:r}),R.emit(le.CONFIG,{pipeline:r}));else if(i.autoCompile){const n=i.pipelineRevision+1;e({graph:a,pipeline:r,pipelineRevision:n}),R.emit(le.CONFIG,{pipeline:r,graph:a,pipelineRevision:n})}else e({graph:a})},setPipeline:a=>{const r=o().pipelineRevision+1,i=po(a);e({pipeline:a,graph:i,pipelineRevision:r}),R.emit(le.CONFIG,{pipeline:a,graph:i,pipelineRevision:r})},refreshPipeline:()=>{const a=o(),r=fo(a.graph.nodes,a.graph.edges),i=a.pipelineRevision+1;e({pipeline:r,pipelineRevision:i}),R.emit(le.CONFIG,{pipeline:r,graph:a.graph,pipelineRevision:i})},loadPreset:a=>{a._formulaDef&&!he.get(a.formula)&&he.register(a._formulaDef),o().resetParamHistory();const r=he.get(a.formula),i=r?r.id:a.formula;e({formula:i}),R.emit(le.CONFIG,{formula:i});let n=a.name;(!n||n==="Untitled"||n==="Custom Preset")&&(n=i),e({projectSettings:{name:n,version:0},lastSavedHash:null}),Ai(a,e,o),setTimeout(()=>{const l=o().getPreset({includeScene:!0}),{version:s,name:c,...u}=l;e({lastSavedHash:JSON.stringify(u)})},50)},loadScene:({def:a,preset:r})=>{if(a&&(he.get(a.id)||he.register(a),R.emit(le.REGISTER_FORMULA,{id:a.id,shader:a.shader})),!ie.isBooted&&!ie.bootSent){o().loadPreset(r);return}mo("Loading Preview...",()=>{o().loadPreset(r);const i=Go(o());R.emit(le.CONFIG,i);const n=o().sceneOffset;if(n){const l={x:n.x,y:n.y,z:n.z,xL:n.xL??0,yL:n.yL??0,zL:n.zL??0};ie.setShadowOffset(l),ie.post({type:"OFFSET_SET",offset:l})}ie.post({type:"CONFIG_DONE"})})},getPreset:a=>{var l,s;const r=o(),i={version:r.projectSettings.version,name:r.projectSettings.name,formula:r.formula,features:{}};if((a==null?void 0:a.includeScene)!==!1){if(i.cameraPos={x:0,y:0,z:0},ie.activeCamera&&ie.virtualSpace){const c=ie.virtualSpace.getUnifiedCameraState(ie.activeCamera,r.targetDistance);i.cameraRot=c.rotation,i.sceneOffset=c.sceneOffset,i.targetDistance=c.targetDistance}else i.cameraRot=r.cameraRot,i.sceneOffset=r.sceneOffset,i.targetDistance=r.targetDistance;i.cameraMode=r.cameraMode,i.lights=[],i.renderMode=r.renderMode,i.quality={aaMode:r.aaMode,aaLevel:r.aaLevel,msaa:r.msaaSamples,accumulation:r.accumulation}}j.getAll().forEach(c=>{const u=r[c.id];u&&(i.features||(i.features={}),i.features[c.id]=nt(u))}),i.animations=r.animations,r.savedCameras.length>0&&(i.savedCameras=r.savedCameras.map(c=>({id:c.id,label:c.label,position:c.position,rotation:c.rotation,sceneOffset:c.sceneOffset,targetDistance:c.targetDistance,optics:c.optics}))),r.formula==="Modular"&&(i.graph=r.graph,i.pipeline=r.pipeline);try{const c=(s=(l=window.useAnimationStore)==null?void 0:l.getState)==null?void 0:s.call(l);c&&(i.sequence=c.sequence,i.duration=c.durationFrames)}catch(c){console.warn("Failed to save animation sequence:",c)}return i},getShareString:a=>{const r=o().getPreset({includeScene:!0}),i=o().advancedMode;return Fi(r,i,a)}}))),jn=e=>e.isUserInteracting||e.interactionMode!=="none",Nn=e=>{var t;if(e.isGizmoDragging||e.interactionMode!=="none"||e.isExporting||e.isBucketRendering||e.tutorialActive&&e.tutorialLessonId===1)return!0;const o=j.getAll();for(const a of o)if((t=a.interactionConfig)!=null&&t.blockCamera&&a.interactionConfig.activeParam){const r=e[a.id];if(r&&r[a.interactionConfig.activeParam])return!0}return!1},Go=e=>{var a;const o={formula:e.formula,pipeline:e.pipeline,pipelineRevision:e.pipelineRevision,graph:e.graph,msaaSamples:e.msaaSamples,previewMode:e.previewMode,renderMode:e.renderMode,compilerHardCap:e.compilerHardCap,shadows:!0,quality:{...e.quality}};if(j.getAll().forEach(r=>{const i=e[r.id];i&&(o[r.id]={...i})}),e.hardwareProfile){const r=e.hardwareProfile,i=o.quality;i&&(i.precisionMode=Math.max(i.precisionMode??0,r.caps.precisionMode),i.bufferPrecision=Math.max(i.bufferPrecision??0,r.caps.bufferPrecision),i.compilerHardCap=Math.min(i.compilerHardCap??Qe,r.caps.compilerHardCap)),o.compilerHardCap=((a=o.quality)==null?void 0:a.compilerHardCap)??o.compilerHardCap}return o};bi(Go);const $n=()=>{const e=pe.getState();ji.connect(window.useAnimationStore,pe),ie.isPaused=e.isPaused,ie.setPreviewSampleCap(e.sampleCap),ie.onBooted=()=>{const t=pe.getState(),a=t.sceneOffset;if(a){const r={x:a.x,y:a.y,z:a.z,xL:a.xL??0,yL:a.yL??0,zL:a.zL??0};ie.setShadowOffset(r),ie.post({type:"OFFSET_SET",offset:r})}ie.setPreviewSampleCap(t.sampleCap)},pe.subscribe(t=>t.isPaused,t=>{ie.isPaused=t}),pe.subscribe(t=>t.sampleCap,t=>{ie.setPreviewSampleCap(t)}),pe.subscribe(t=>{var a;return(a=t.lighting)==null?void 0:a.renderMode},t=>{if(t===void 0)return;const a=t===1?"PathTracing":"Direct";pe.getState().renderMode!==a&&pe.setState({renderMode:a})});let o;pe.subscribe(t=>{var a;return(a=t.optics)==null?void 0:a.camType},t=>{var i;if(t===void 0)return;const a=o!==void 0&&o<.5,r=t>.5&&t<1.5;if(a&&r){const n=pe.getState();if(!n.activeCameraId){const l=((i=n.optics)==null?void 0:i.camFov)||60;let s=ie.lastMeasuredDistance;(!s||s>=1e3||s<=0)&&(s=n.targetDistance||3.5);const c=s*Math.tan(l*Math.PI/360),u=n.setOptics;typeof u=="function"&&u({orthoScale:c})}}o=t}),R.on(le.BUCKET_STATUS,({isRendering:t})=>{const a=pe.getState();a.setIsBucketRendering(t),a.setIsExporting(t)})};typeof window<"u"&&(window.__store=pe);const Bi=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("polyline",{points:"6 9 12 15 18 9"})}),Bn=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("polyline",{points:"18 15 12 9 6 15"})}),Hn=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("polyline",{points:"15 18 9 12 15 6"})}),Vn=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("polyline",{points:"9 18 15 12 9 6"})}),Gn=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("polyline",{points:"9 18 15 12 9 6"})}),Un=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("path",{d:"M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"})}),qn=()=>d.jsx("svg",{width:"100%",height:"100%",viewBox:"0 0 10 10",children:d.jsx("path",{d:"M 6 10 L 10 6 L 10 10 Z",fill:"currentColor",opacity:"0.5"})}),Wn=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"4",y1:"9",x2:"20",y2:"9"}),d.jsx("line",{x1:"4",y1:"15",x2:"20",y2:"15"})]}),Xn=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("path",{d:"M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"})}),Yn=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),d.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]}),Kn=()=>d.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"3",y1:"12",x2:"21",y2:"12"}),d.jsx("line",{x1:"3",y1:"6",x2:"21",y2:"6"}),d.jsx("line",{x1:"3",y1:"18",x2:"21",y2:"18"})]}),Jn=()=>d.jsx("svg",{width:"16",height:"16",viewBox:"0 0 512 512",fill:"currentColor",children:d.jsx("path",{d:"M0,0v512h512V106.9l-6.5-7.3L412.4,6.5L405.1,0H0z M46.5,46.5h69.8v139.6h279.3V56.7l69.8,69.8v338.9h-46.5V256H93.1v209.5H46.5V46.5z M162.9,46.5H256V93h46.5V46.5H349v93.1H162.9V46.5z M139.6,302.5h232.7v162.9H139.6V302.5z"})}),Zn=()=>d.jsx("svg",{width:"16",height:"16",viewBox:"190 230 680 620",fill:"currentColor",children:d.jsx("path",{d:"M257.3312 451.84V332.8c0-42.3936 34.2016-76.8 76.4416-76.8h107.8272c29.5936 0 56.5248 17.152 69.12 44.032l14.8992 31.6416a25.4976 25.4976 0 0 0 23.04 14.6944h192.8192c42.1888 0 76.4416 34.3552 76.4416 76.8v28.672a76.8 76.8 0 0 1 50.9952 88.064l-43.3152 217.6A76.544 76.544 0 0 1 750.6432 819.2H324.5568a76.544 76.544 0 0 1-74.9568-61.7472l-43.3152-217.6a76.8512 76.8512 0 0 1 51.0464-88.0128z m509.5936-3.84v-24.832c0-14.1312-11.4176-25.6-25.4464-25.6h-192.8192a76.4416 76.4416 0 0 1-69.12-44.032l-14.848-31.6928A25.4976 25.4976 0 0 0 441.6 307.2H333.7216a25.5488 25.5488 0 0 0-25.4976 25.6v115.2h458.6496z m-485.6832 51.2a25.6 25.6 0 0 0-24.9856 30.6176l43.3152 217.6c2.4064 11.9808 12.8512 20.5824 24.9856 20.5824h426.0864a25.4976 25.4976 0 0 0 24.9856-20.5824l43.3152-217.6a25.7024 25.7024 0 0 0-24.9856-30.6176H281.2416z"})}),Qn=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("circle",{cx:"12",cy:"12",r:"10"}),d.jsx("line",{x1:"12",cy:"16",x2:"12",y2:"12"}),d.jsx("line",{x1:"12",cy:"8",x2:"12.01",y2:"8"})]}),es=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("circle",{cx:"12",cy:"12",r:"10"}),d.jsx("path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"}),d.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]}),ts=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M3 10h10a5 5 0 0 1 5 5v2"}),d.jsx("path",{d:"M7 6l-4 4 4 4"})]}),os=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M21 10h-10a5 5 0 0 0 -5 5v2"}),d.jsx("path",{d:"M17 6l4 4 -4 4"})]}),as=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}),d.jsx("path",{d:"M3 3v5h5"})]}),rs=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("polyline",{points:"20 6 9 17 4 12"})}),is=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),d.jsx("polyline",{points:"17 8 12 3 7 8"}),d.jsx("line",{x1:"12",y1:"3",x2:"12",y2:"15"})]}),ns=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),d.jsx("polyline",{points:"7 10 12 15 17 10"}),d.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),ss=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"4",children:[d.jsx("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),d.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"})]}),ls=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}),d.jsx("path",{d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"})]}),cs=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("path",{d:"M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"})}),ds=()=>d.jsxs("svg",{width:"64",height:"64",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"5",y:"2",width:"14",height:"20",rx:"2",ry:"2"}),d.jsx("path",{d:"M12 18h.01"})]}),us=({className:e})=>d.jsxs("svg",{className:e,xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",children:[d.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4"}),d.jsx("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}),fs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"16 18 22 12 16 6"}),d.jsx("polyline",{points:"8 6 2 12 8 18"})]}),ps=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("circle",{cx:"12",cy:"12",r:"10"}),d.jsx("path",{d:"M8 14s1.5 2 4 2 4-2 4-2"}),d.jsx("line",{x1:"9",y1:"9",x2:"9.01",y2:"9"}),d.jsx("line",{x1:"15",y1:"9",x2:"15.01",y2:"9"})]}),hs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"}),d.jsx("polyline",{points:"3.27 6.96 12 12.01 20.73 6.96"}),d.jsx("line",{x1:"12",y1:"22.08",x2:"12",y2:"12"})]}),ms=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",strokeDasharray:"4 4"}),d.jsx("path",{d:"M9 12l2 2 4-4"})]}),gs=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"})}),ys=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("circle",{cx:"12",cy:"12",r:"10"})}),bs=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 512 512",fill:"currentColor",children:d.jsx("path",{d:"M167.4,59.1l-6.2,8l-23.4,31.4h-19.7V78.8H39.4v19.7H0v354.5h512V98.5H374.2l-23.4-31.4l-6.2-8H167.4z M187.1,98.5h137.8l23.4,31.4l6.2,8h118.2v78.8H358.2c-20.5-35.2-58.7-59.1-102.2-59.1s-81.6,23.9-102.2,59.1H39.4v-78.8h118.2l6.2-8L187.1,98.5z M393.8,157.5v39.4h39.4v-39.4H393.8z M256,196.9c43.8,0,78.8,35,78.8,78.8s-35,78.8-78.8,78.8s-78.8-35-78.8-78.8S212.2,196.9,256,196.9z M39.4,256h100.3c-1.1,6.3-1.8,13.1-1.8,19.7c0,65,53.2,118.2,118.2,118.2s118.2-53.2,118.2-118.2c0-6.6-0.8-13.4-1.8-19.7h100.3v157.5H39.4V256z"})}),vs=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 3v18"}),d.jsx("path",{d:"M3 12h18"}),d.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),xs=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"})}),Ss=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polygon",{points:"12 2 2 7 12 12 22 7 12 2"}),d.jsx("polyline",{points:"2 17 12 22 22 17"}),d.jsx("polyline",{points:"2 12 12 17 22 12"})]}),ws=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 2l-5 9h10l-5 9"}),d.jsx("path",{d:"M12 2v20"})]}),_s=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M6 2v14a2 2 0 0 0 2 2h14"}),d.jsx("path",{d:"M18 22V8a2 2 0 0 0-2-2H2"})]}),Is=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),d.jsx("line",{x1:"9",y1:"9",x2:"15",y2:"15"}),d.jsx("line",{x1:"15",y1:"9",x2:"9",y2:"15"})]}),Cs=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"14",width:"7",height:"7"}),d.jsx("path",{d:"M3 14h7v7H3z",fill:"currentColor",stroke:"none"})]}),Ms=()=>d.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:d.jsx("path",{d:"M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM7 10h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"})}),Rs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"14",width:"7",height:"7"}),d.jsx("path",{d:"M10 7h4"}),d.jsx("path",{d:"M17 10v4"})]}),Ps=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 22V8"}),d.jsx("path",{d:"M5 12H2a10 10 0 0 0 20 0h-3"}),d.jsx("circle",{cx:"12",cy:"5",r:"3"})]}),Ls=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 18V8"}),d.jsx("path",{d:"M5 12H2a10 10 0 0 0 20 0h-3"}),d.jsx("circle",{cx:"12",cy:"5",r:"3"}),d.jsx("line",{x1:"3",y1:"21",x2:"21",y2:"3",stroke:"currentColor",opacity:"0.9"})]}),Es=({status:e})=>{let o="currentColor";e==="keyed"||e==="partial"?o="#f59e0b":(e==="dirty"||e==="keyed-dirty")&&(o="#ef4444");const t=e==="keyed"||e==="keyed-dirty"?o:"none";return d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:o,strokeWidth:"2.5",children:d.jsx("path",{d:"M12 2L2 12l10 10 10-10L12 2z",fill:t})})},ks=({active:e})=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"#666",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"}),d.jsx("path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"})]}),Ts=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M10 13l-4 4"}),d.jsx("path",{d:"M14 11l4 -4"})]}),zs=({active:e})=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:e?"#f59e0b":"#666",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"16 18 22 12 16 6"}),d.jsx("polyline",{points:"8 6 2 12 8 18"})]}),As=({open:e})=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:`transition-transform ${e?"rotate-90":""}`,children:d.jsx("path",{d:"M9 18l6-6-6-6"})}),Ds=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"2",y:"2",width:"20",height:"20",rx:"5",ry:"5"}),d.jsx("path",{d:"M16 8h.01"}),d.jsx("path",{d:"M8 8h.01"}),d.jsx("path",{d:"M8 16h.01"}),d.jsx("path",{d:"M16 16h.01"}),d.jsx("path",{d:"M12 12h.01"})]}),Fs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"16 3 21 3 21 8"}),d.jsx("line",{x1:"4",y1:"20",x2:"21",y2:"3"}),d.jsx("polyline",{points:"21 16 21 21 16 21"}),d.jsx("line",{x1:"15",y1:"15",x2:"21",y2:"21"}),d.jsx("line",{x1:"4",y1:"4",x2:"9",y2:"9"})]}),Os=()=>d.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:d.jsx("path",{d:"M8 5v14l11-7z"})}),js=()=>d.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:d.jsx("path",{d:"M6 19h4V5H6v14zm8-14v14h4V5h-4z"})}),Ns=()=>d.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:d.jsx("path",{d:"M6 6h12v12H6z"})}),$s=({active:e})=>d.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:e?"currentColor":"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("circle",{cx:"12",cy:"12",r:"10",stroke:e?"none":"currentColor",fill:e?"#ef4444":"none"})}),Bs=({active:e})=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",children:d.jsx("path",{d:"M3 18C3 18 6 5 12 12C18 19 21 5 21 5"})}),Hs=({active:e})=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",children:[d.jsx("rect",{x:"3",y:"8",width:"6",height:"8"}),d.jsx("rect",{x:"15",y:"8",width:"6",height:"8"})]}),Vs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"}),d.jsx("path",{d:"M4 22v-7"}),d.jsx("path",{d:"M8 4v10"}),d.jsx("path",{d:"M12 5v10"}),d.jsx("path",{d:"M16 4v10"}),d.jsx("path",{d:"M4 8h16"}),d.jsx("path",{d:"M4 12h16"})]}),Gs=({active:e})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),d.jsx("line",{x1:"3",y1:"9",x2:"21",y2:"9"}),d.jsx("line",{x1:"3",y1:"15",x2:"21",y2:"15"}),d.jsx("line",{x1:"9",y1:"3",x2:"9",y2:"21"}),d.jsx("line",{x1:"15",y1:"3",x2:"15",y2:"21"})]}),Us=({mode:e})=>d.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e==="Loop"||e==="PingPong"?d.jsx("path",{d:"M17 2l4 4-4 4 M3 11v-1a4 4 0 0 1 4-4h14 M7 22l-4-4 4-4 M21 13v1a4 4 0 0 1-4 4H3"}):d.jsx("path",{d:"M5 12h14 M12 5l7 7-7 7"})}),qs=({active:e,arming:o})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M3 12h18",strokeOpacity:e||o?.3:.2}),d.jsx("path",{d:"M3 12 Q 6 2, 9 12 T 15 12 T 21 12",stroke:e?"#ef4444":o?"#fca5a5":"currentColor"}),o&&!e&&d.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"#fca5a5",stroke:"none"})]}),Ws=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"4 14 10 14 10 20"}),d.jsx("polyline",{points:"20 10 14 10 14 4"}),d.jsx("line",{x1:"14",y1:"10",x2:"21",y2:"3"}),d.jsx("line",{x1:"3",y1:"21",x2:"10",y2:"14"})]}),Xs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"}),d.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"currentColor",stroke:"none"})]}),Ys=({active:e})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"4",y1:"20",x2:"20",y2:"20"}),d.jsx("line",{x1:"4",y1:"4",x2:"20",y2:"4"}),d.jsx("polyline",{points:"4 14 8 10 12 14 16 10 20 14"})]}),Ks=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"}),d.jsx("path",{d:"M4 12h16"}),d.jsx("path",{d:"M12 4v16"}),d.jsx("path",{d:"M16 16l-4 4-4-4"})]}),Js=({active:e})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M19 13l-7-7-7 7"}),d.jsx("path",{d:"M5 19l7-7 7 7"}),d.jsx("path",{d:"M12 5l2-2 2 2-2 2-2-2z",fill:e?"#22d3ee":"none",stroke:"none"}),d.jsx("path",{d:"M12 5l-2-2-2 2 2 2 2-2z",fill:e?"#22d3ee":"none",stroke:"none"})]}),Zs=({active:e})=>d.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("path",{d:"M2 12s3-7 7-7 7 7 7 7 3-7 7-7"})}),Qs=({active:e})=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",className:e?"text-gray-200":"text-gray-600",children:[d.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),d.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),Hi=e=>{const{value:o,onChange:t,onDragStart:a,onDragEnd:r,step:i=.01,sensitivity:n=1,hardMin:l,hardMax:s,mapping:c,disabled:u,dragThreshold:f=2}=e,[p,h]=L.useState(!1),g=L.useRef(null),v=L.useRef(0),m=L.useRef(0),y=L.useRef(!1),b=L.useRef(!1),_=L.useRef(!1),k=L.useRef(null),S=L.useCallback((x,z)=>{let K=i*.5*n;return x&&(K*=10),z&&(K*=.1),K},[i,n]),C=L.useCallback(x=>{if(u||x.button!==0)return;x.preventDefault(),x.stopPropagation(),x.currentTarget.setPointerCapture(x.pointerId),k.current=x.pointerId,v.current=x.clientX;const z=c?c.toDisplay(o):o;m.current=isNaN(z)?0:z,y.current=!1,b.current=x.shiftKey,_.current=x.altKey,h(!0),a==null||a()},[o,c,u,a]),E=L.useCallback(x=>{if(u||!p||!x.currentTarget.hasPointerCapture(x.pointerId))return;const z=x.clientX-v.current;if(Math.abs(z)>f&&(y.current=!0),!y.current)return;x.preventDefault(),x.stopPropagation();const K=b.current!==x.shiftKey,de=_.current!==x.altKey;if(K||de){const O=S(b.current,_.current),$=m.current+z*O;m.current=$,v.current=x.clientX,b.current=x.shiftKey,_.current=x.altKey}const oe=S(x.shiftKey,x.altKey);let J=m.current+z*oe;l!==void 0&&(J=Math.max(l,J)),s!==void 0&&(J=Math.min(s,J));const w=c?c.fromDisplay(J):J;isNaN(w)||(g.current=w,t(w))},[p,u,i,l,s,c,t,S,f]),P=L.useCallback(x=>{u||(x.currentTarget.releasePointerCapture(x.pointerId),k.current=null,h(!1),g.current=null,r==null||r())},[u,r]),D=L.useCallback(()=>{const x=!y.current;return y.current=!1,x},[]);return{isDragging:p,immediateValueRef:g,handlePointerDown:C,handlePointerMove:E,handlePointerUp:P,handleClick:D}},Vi=e=>{const{value:o,mapping:t,onChange:a,onDragStart:r,onDragEnd:i,disabled:n,mapTextInput:l=!1}=e,[s,c]=L.useState(!1),[u,f]=L.useState(""),p=L.useRef(null),h=L.useRef(""),g=L.useCallback(()=>{if(n)return;c(!0);const S=l&&t?t.toDisplay(o):o,C=typeof S=="number"?parseFloat(S.toFixed(6)):S??0,E=String(C);f(E),h.current=E,setTimeout(()=>{p.current&&(p.current.focus(),p.current.select())},10)},[o,t,n,l]),v=L.useCallback(()=>{const S=h.current;let C;if(t!=null&&t.parseInput&&l?C=t.parseInput(S):(C=parseFloat(S),isNaN(C)&&(C=null)),C!==null){const E=l&&t?t.fromDisplay(C):C;r==null||r(),a(E),i==null||i()}c(!1)},[t,a,r,i,l]),m=L.useCallback(()=>{c(!1)},[]),y=L.useCallback(S=>{f(S),h.current=S},[]),b=L.useCallback(S=>{S.key==="Enter"?(S.preventDefault(),v()):S.key==="Escape"&&(S.preventDefault(),m()),S.key!=="Tab"&&S.stopPropagation()},[v,m]),_=L.useCallback(()=>{s||g()},[s,g]),k=L.useCallback(()=>{s&&v()},[s,v]);return{isEditing:s,inputValue:u,inputRef:p,startEditing:g,commitEdit:v,cancelEdit:m,handleInputChange:y,handleKeyDown:b,handleFocus:_,handleBlur:k}},Uo=e=>e===0||Math.abs(e)<1e-9?"0":parseFloat(e.toFixed(8)).toString(),go={toDisplay:e=>e/Math.PI,fromDisplay:e=>e*Math.PI,format:e=>{const o=e/Math.PI,t=Math.abs(o),a=o<0?"-":"";if(t<.001)return"0";if(Math.abs(t-1)<.001)return`${a}π`;if(Math.abs(t-.5)<.001)return`${a}π/2`;if(Math.abs(t-.25)<.001)return`${a}π/4`;if(Math.abs(t-.75)<.001)return`${a}3π/4`;if(Math.abs(t-2)<.001)return`${a}2π`;const r=Math.round(t*3);if(Math.abs(t-r/3)<.001&&r!==0){if(r===1)return`${a}π/3`;if(r===2)return`${a}2π/3`;if(r===3)return`${a}π`;if(r===4)return`${a}4π/3`;if(r===5)return`${a}5π/3`}return`${a}${t.toFixed(2)}π`},parseInput:e=>{const o=e.trim().toLowerCase().replace(/\s/g,"");if(o==="π"||o==="pi")return Math.PI;if(o==="-π"||o==="-pi")return-Math.PI;if(o.includes("π")||o.includes("pi")){const a=o.replace(/[πpi]/g,"");if(a.includes("/")){const[n,l]=a.split("/").map(c=>parseFloat(c)||1);return(o.startsWith("-")?-1:1)*(Math.abs(n)/l)*Math.PI}const r=a?parseFloat(a):1;return isNaN(r)?null:(o.startsWith("-")?-1:1)*Math.abs(r)*Math.PI}const t=parseFloat(o);return isNaN(t)?null:t}},Je={toDisplay:e=>e*(180/Math.PI),fromDisplay:e=>e*(Math.PI/180),format:e=>`${(e*(180/Math.PI)).toFixed(1)}°`,parseInput:e=>{const o=e.trim().replace(/°/g,""),t=parseFloat(o);return isNaN(t)?null:t}},qo=(e,o,t,a)=>{const r=a?a.toDisplay(e):e,i=a?a.toDisplay(o):o,n=a?a.toDisplay(t):t;return Math.max(0,Math.min(100,(r-i)/(n-i)*100))},wt=({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r=.01,sensitivity:i=1,min:n,max:l,hardMin:s,hardMax:c,mapping:u,format:f,mapTextInput:p,disabled:h=!1,highlight:g=!1,liveValue:v,defaultValue:m,onImmediateChange:y})=>{const b=te.useRef(null),_=te.useCallback(B=>f?f(B):u!=null&&u.format?u.format(B):Uo(B),[f,u]),{isDragging:k,immediateValueRef:S,handlePointerDown:C,handlePointerMove:E,handlePointerUp:P,handleClick:D}=Hi({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,sensitivity:i,hardMin:s,hardMax:c,mapping:u,disabled:h}),x=te.useCallback(B=>{E(B);const Z=S.current;Z!==null&&(b.current&&(b.current.textContent=_(Z)),y==null||y(Z))},[E,S,_,y]),{isEditing:z,inputValue:K,inputRef:de,startEditing:oe,handleInputChange:J,handleKeyDown:w,handleBlur:O}=Vi({value:e,mapping:u,onChange:o,onDragStart:t,onDragEnd:a,disabled:h,mapTextInput:p}),$=te.useMemo(()=>_(e),[e,_]),ue=te.useCallback(()=>{!h&&!z&&oe()},[h,z,oe]),ae=te.useCallback(B=>{if(h)return;D()&&oe()},[h,D,oe]),q=`
        ...
        ${k?"bg-cyan-500/20 text-cyan-300":(k||g||v!==void 0&&!h)&&!h?"text-cyan-400":h?"":"text-gray-300 hover:text-white"}
    `;return z?d.jsx("input",{ref:de,type:"text",value:K,onChange:B=>J(B.target.value),onBlur:O,onKeyDown:w,className:"w-full h-full bg-gray-900 text-white text-xs border-none outline-none font-mono text-center px-1",onClick:B=>B.stopPropagation(),autoFocus:!0}):d.jsx("div",{ref:b,"data-role":"value",tabIndex:h?-1:0,onPointerDown:C,onPointerMove:x,onPointerUp:P,onClick:ae,onFocus:ue,className:q,title:h?"Disabled":"Click to edit, Drag to adjust (Shift=Fast, Alt=Slow)",children:$})},Gi=({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r=.01,min:i,max:n,hardMin:l,hardMax:s,mapping:c,format:u,overrideText:f,mapTextInput:p,label:h,labelSuffix:g,headerRight:v,showTrack:m=!0,trackPosition:y="below",trackHeight:b=20,variant:_="full",className:k="",defaultValue:S,onReset:C,liveValue:E,showLiveIndicator:P=!0,onContextMenu:D,dataHelpId:x,disabled:z=!1,highlight:K=!1})=>{const de=te.useRef(null),oe=te.useRef(null),J=te.useRef(null),w=te.useRef({active:!1,startX:0,startValue:0,lastShift:!1,lastAlt:!1}),O=i!==void 0&&n!==void 0&&i!==n,$=te.useMemo(()=>{if(!O)return 0;const T=c?c.toDisplay(e):e,A=c?c.toDisplay(i):i,fe=c?c.toDisplay(n):n;return Math.max(0,Math.min(100,(T-A)/(fe-A)*100))},[e,i,n,c,O]),ue=te.useMemo(()=>{if(!O||E===void 0)return 0;const T=c?c.toDisplay(E):E,A=c?c.toDisplay(i):i,fe=c?c.toDisplay(n):n;return Math.max(0,Math.min(100,(T-A)/(fe-A)*100))},[E,i,n,c,O]),ae=te.useMemo(()=>{if(!O||S===void 0)return null;const T=c?c.toDisplay(S):S,A=c?c.toDisplay(i):i,fe=c?c.toDisplay(n):n;return(T-A)/(fe-A)*100},[S,i,n,c,O]),H=te.useCallback(T=>O?qo(T,i,n,c):0,[O,i,n,c]),q=te.useCallback(T=>{var se;const A=H(T),fe=`${A}%`;de.current&&(de.current.style.width=fe),oe.current&&(oe.current.style.width=fe);const _e=(se=J.current)==null?void 0:se.querySelector('[data-role="thumb"]');_e&&(_e.style.left=`calc(${A}% - 8px)`)},[H]),B=te.useCallback(T=>r?Math.round(T/r)*r:T,[r]),Z=te.useCallback(T=>{if(z||!O||T.button!==0)return;T.preventDefault(),T.stopPropagation(),T.currentTarget.setPointerCapture(T.pointerId);const A=T.currentTarget.getBoundingClientRect(),fe=Math.max(0,Math.min(1,(T.clientX-A.left)/A.width)),_e=c?c.toDisplay(i):i,se=c?c.toDisplay(n):n,Le=B(_e+fe*(se-_e));let Se=c?c.fromDisplay(Le):Le;l!==void 0&&(Se=Math.max(l,Se)),s!==void 0&&(Se=Math.min(s,Se)),o(Se),q(Se);const Ie=w.current;Ie.active=!0,Ie.startX=T.clientX,Ie.startValue=Le,Ie.lastShift=T.shiftKey,Ie.lastAlt=T.altKey,t==null||t()},[z,O,i,n,c,l,s,o,t,q,B]),X=te.useCallback(T=>{const A=w.current;if(!A.active||z||!O)return;T.preventDefault();const _e=T.currentTarget.getBoundingClientRect().width,se=c?c.toDisplay(i):i,Le=c?c.toDisplay(n):n,Ie=(Le-se)/_e;if(A.lastShift!==T.shiftKey||A.lastAlt!==T.altKey){const ft=Ie*(A.lastShift?10:1)*(A.lastAlt?.1:1),ot=T.clientX-A.startX;A.startValue=A.startValue+ot*ft,A.startX=T.clientX,A.lastShift=T.shiftKey,A.lastAlt=T.altKey}let Xe=Ie;T.shiftKey&&(Xe*=10),T.altKey&&(Xe*=.1);const ut=T.clientX-A.startX;let $e=B(A.startValue+ut*Xe);$e=Math.max(se,Math.min(Le,$e));let Ee=c?c.fromDisplay($e):$e;l!==void 0&&(Ee=Math.max(l,Ee)),s!==void 0&&(Ee=Math.min(s,Ee)),isNaN(Ee)||(o(Ee),q(Ee))},[z,O,i,n,c,l,s,o,q,B]),ne=te.useCallback(T=>{const A=w.current;A.active&&(A.active=!1,T.currentTarget.releasePointerCapture(T.pointerId),a==null||a())},[a]),De=te.useCallback(()=>{S!==void 0&&!z&&(t==null||t(),o(S),a==null||a(),C==null||C())},[S,z,o,t,a,C]),Pe=K||E!==void 0,Ne=_==="compact";return _==="minimal"?d.jsx("div",{className:k,children:d.jsx(wt,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:l,hardMax:s,mapping:c,format:f?()=>f:u,mapTextInput:p,defaultValue:S,disabled:z,highlight:Pe,onImmediateChange:q})}):Ne?d.jsxs("div",{className:`relative flex-1 h-9 md:h-[26px] overflow-hidden group transition-all duration-150 ${z?"opacity-70 pointer-events-none":""} ${k}`,onContextMenu:D,"data-help-id":x,children:[d.jsx("div",{className:"absolute inset-0 bg-white/[0.12]",style:z?{}:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255,255,255,0.03) 5px, rgba(255,255,255,0.03) 10px)"}}),m&&O&&d.jsx("div",{ref:de,"data-role":"fill",className:`absolute top-0 bottom-0 left-0 pointer-events-none ${z?"bg-gray-500/20":Pe?"bg-cyan-500/30":"bg-cyan-500/20"}`,style:{width:`${$}%`}}),P&&E!==void 0&&!z&&O&&d.jsx("div",{className:"absolute top-0 bottom-0 w-1.5 bg-purple-500 blur-[1px] transition-all duration-75 ease-out z-0",style:{left:`calc(${ue}% - 0.75px)`}}),d.jsx("div",{className:"absolute inset-0",children:d.jsx(wt,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:l,hardMax:s,mapping:c,format:f?()=>f:u,mapTextInput:p,defaultValue:S,disabled:z,highlight:Pe,onImmediateChange:q})}),Pe&&!z&&d.jsx("div",{className:"absolute inset-0 bg-cyan-500/10 pointer-events-none"})]}):d.jsxs("div",{className:`mb-px animate-slider-entry ${z?"opacity-70 pointer-events-none":""} ${k}`,"data-help-id":x,onContextMenu:D,children:[h&&d.jsxs("div",{className:"flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5",children:[d.jsxs("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:[v,d.jsxs("label",{className:`text-[10px] font-medium tracking-tight select-none flex items-center gap-2 truncate pointer-events-none ${z?"text-gray-600":"text-gray-400"}`,children:[h,g,E!==void 0&&!z&&d.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-purple-500 animate-pulse shadow-[0_0_4px_#a855f7]"})]})]}),d.jsx("div",{className:"w-1/2 relative bg-white/[0.02] border-l border-white/10 group/num-area touch-none",style:z?{}:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255,255,255,0.03) 5px, rgba(255,255,255,0.03) 10px)"},children:d.jsx(wt,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:l,hardMax:s,mapping:c,format:f?()=>f:u,mapTextInput:p,defaultValue:S,disabled:z,highlight:Pe,onImmediateChange:q})})]}),m&&O&&d.jsxs("div",{ref:J,className:`relative flex items-center touch-none overflow-hidden ${z?"cursor-not-allowed":"cursor-ew-resize"}`,style:{touchAction:"none",height:b},onPointerDown:Z,onPointerMove:X,onPointerUp:ne,children:[d.jsxs("div",{className:"absolute inset-0 bg-white/10",children:[d.jsx("div",{ref:oe,className:`absolute top-0 bottom-0 left-0 ${z?"bg-gray-400/20":"bg-cyan-500/30"}`,style:{width:`${$}%`}}),P&&E!==void 0&&!z&&d.jsx("div",{className:"absolute top-0 bottom-0 w-1.5 bg-purple-500 blur-[1px] transition-all duration-75 ease-out z-0",style:{left:`calc(${ue}% - 0.75px)`}})]}),d.jsx("div",{"data-role":"thumb",className:"absolute top-0 bottom-0 w-4 z-10 pointer-events-none border-l border-r transition-colors",style:{left:`calc(${$}% - 8px)`,borderColor:z?"rgba(255,255,255,0.1)":"rgba(255,255,255,0.25)"}}),ae!==null&&d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"absolute w-0.5 h-full bg-white/40 pointer-events-none z-0 transform -translate-x-1/2",style:{left:`${ae}%`}}),d.jsx("button",{onPointerDown:T=>{T.preventDefault(),T.stopPropagation()},onClick:T=>{T.preventDefault(),T.stopPropagation(),De()},className:"absolute top-0 bottom-0 right-0 w-2 bg-gray-500/20 hover:bg-gray-400/50 cursor-pointer z-20 transition-colors border-l border-black/10",title:`Reset to ${S}`,"aria-label":"Reset to default",tabIndex:-1})]})]})]})},Ui=[{label:"X",color:"bg-red-500",text:"text-red-400",border:"group-focus-within:border-red-500/50",hoverBg:"hover:bg-red-500/20",accent:"#ef4444"},{label:"Y",color:"bg-green-500",text:"text-green-400",border:"group-focus-within:border-green-500/50",hoverBg:"hover:bg-green-500/20",accent:"#22c55e"},{label:"Z",color:"bg-blue-500",text:"text-blue-400",border:"group-focus-within:border-blue-500/50",hoverBg:"hover:bg-blue-500/20",accent:"#3b82f6"},{label:"W",color:"bg-purple-500",text:"text-purple-400",border:"group-focus-within:border-purple-500/50",hoverBg:"hover:bg-purple-500/20",accent:"#a855f7"}],yo=e=>e.includes("red")?{on:"bg-red-500/30 text-red-300 border-red-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("green")?{on:"bg-green-500/30 text-green-300 border-green-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("amber")||e.includes("yellow")?{on:"bg-amber-500/30 text-amber-300 border-amber-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("purple")?{on:"bg-purple-500/30 text-purple-300 border-purple-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:{on:"bg-cyan-500/30 text-cyan-300 border-cyan-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"};function el({label:e,value:o,onChange:t,options:a,color:r="bg-cyan-600",onLfoToggle:i,isLfoActive:n,icon:l,disabled:s=!1,variant:c="default",labelSuffix:u,onContextMenu:f,...p}){const h=m=>{s||t(m)},g=()=>{s||t(!o)},v=yo(r);if(c==="dense"&&!a&&typeof o=="boolean"){const m=yo(r);return d.jsxs("div",{className:`flex items-center justify-between px-3 py-1 border-b border-white/5 hover:bg-white/5 transition-colors ${s?"opacity-50 pointer-events-none":"cursor-pointer"}`,"data-help-id":p["data-help-id"],onContextMenu:f,onClick:g,children:[d.jsxs("div",{className:"flex items-center gap-2",children:[l,d.jsx("span",{className:"text-[10px] text-gray-400 font-medium tracking-tight truncate select-none",children:e})]}),d.jsx("div",{className:`px-2 py-0.5 text-[8px] font-bold rounded-sm transition-all border ${o?m.on:m.off} ${s?"":"hover:brightness-125"}`,children:o?"ON":"OFF"})]})}return a?d.jsxs("div",{className:`mb-px animate-slider-entry ${s?"opacity-50 pointer-events-none":""}`,"data-help-id":p["data-help-id"],onContextMenu:f,children:[e&&d.jsxs("div",{className:"flex items-center bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5 px-2 gap-2",children:[l,d.jsx("span",{className:"text-[10px] text-gray-400 font-medium tracking-tight truncate select-none pointer-events-none",children:e})]}),d.jsx("div",{className:`flex h-9 md:h-[26px] overflow-hidden ${e?"rounded-b-sm":"rounded-sm"}`,children:a.map(m=>d.jsx("button",{onClick:()=>h(m.value),disabled:s,className:`
                        ...
                        `,children:d.jsx("span",{className:`text-[8px] ${o?"opacity-90":"opacity-50"}`,children:o?"ON":"OFF"})}),i&&d.jsx("button",{onClick:m=>{m.stopPropagation(),s||i()},disabled:s,className:`
                            ...
                            `,title:"LFO",children:d.jsx("span",{className:`text-[8px] ${n?"opacity-90":"opacity-50"}`,children:"LFO"})})]})]})})}const Ue={text:"text-cyan-400",textSubtle:"text-cyan-600",bgSolid:"bg-cyan-900",bgMed:"bg-cyan-700",bgBright:"bg-cyan-600/40",hoverBg:"hover:bg-cyan-500/50"},tl={bgMed:"bg-purple-700"},bo={text:"text-amber-400",bg:"bg-amber-900/20",border:"border-amber-500/20",btnBg:"bg-amber-600",btnHover:"hover:bg-amber-500",btnText:"text-black"},qe={dock:"bg-[#080808]",tabBar:"bg-black/40",nested:"bg-black/20",divider:"bg-neutral-800",panelHeader:"bg-gray-800/80",input:"bg-gray-900",tint:"bg-white/5",hoverSubtle:"hover:bg-white/5",hoverMed:"hover:bg-white/10"},Re={primary:"text-white",label:"text-gray-400",dimLabel:"text-gray-500",faint:"text-gray-600",ghost:"text-gray-700"},Wo={subtle:"border-white/5",standard:"border-white/10"},ol=`${qe.dock} ${Ue.text} border-x border-t ${Wo.standard} z-10 -mb-px pb-2`,al=`${Re.dimLabel} ${qe.hoverSubtle} hover:text-gray-300 border border-transparent`,rl=`${Ue.bgSolid} ${Ue.text}`,il=`${Re.faint} ${qe.hoverMed}`,nl=`${Ue.textSubtle}`,sl=`${Re.ghost}`,ll=`${qe.nested} p-2 rounded border ${Wo.subtle}`,cl=`${bo.bg} border ${bo.border}`,dl=`${Ue.bgMed} ${Re.primary}`,ul=`${Re.dimLabel} hover:text-gray-300`,fl=`${Re.ghost} cursor-not-allowed opacity-50 bg-transparent`,pl=`${Ue.bgBright} text-cyan-300 shadow-[inset_0_0_10px_rgba(34,211,238,0.1)]`,hl=`bg-transparent ${Re.dimLabel} hover:text-gray-300 ${qe.hoverSubtle}`,qi={primary:`text-[10px] font-bold ${Re.label}`,secondary:`text-[9px] font-bold ${Re.dimLabel}`,tiny:`text-[8px] ${Re.faint}`},Wi=({children:e,variant:o="primary",className:t="",color:a})=>{const r=qi[o],i=a||"";return d.jsx("span",{className:`${r} ${i} select-none ${t}`,children:e})},ml=()=>d.jsxs(d.Fragment,{children:[d.jsx("div",{className:`h-1.5 ${qe.divider} rounded-b-lg`}),d.jsx("div",{className:"h-2",style:{background:"linear-gradient(to bottom, transparent, rgba(255,255,255,0.08))"}})]});function gl({label:e,value:o,options:t,onChange:a,fullWidth:r,className:i="",selectClassName:n="",labelSuffix:l,onContextMenu:s,disabled:c=!1,...u}){const f=p=>{var v;const h=p.target.value,g=typeof((v=t[0])==null?void 0:v.value)=="number";a(g?Number(h):h)};return d.jsxs("div",{className:`flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5 ${r?"w-full":""} ${c?"opacity-50 pointer-events-none":""} ${i}`,"data-help-id":u["data-help-id"],onContextMenu:s,children:[e&&d.jsx("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:d.jsxs("label",{className:"text-[10px] font-medium tracking-tight select-none truncate pointer-events-none text-gray-400",children:[e,l]})}),d.jsxs("div",{className:`${e?"w-1/2":"w-full"} relative border-l border-white/10 bg-white/[0.02] border-t border-t-white/5`,children:[d.jsx("select",{value:o,onChange:f,disabled:c,className:`w-full h-full bg-transparent text-[10px] font-medium text-gray-200 px-2 pr-6 outline-none cursor-pointer appearance-none text-center ${n}`,children:t.map(p=>d.jsx("option",{value:String(p.value),className:"bg-[#111] text-gray-300",children:p.label},String(p.value)))}),d.jsx("div",{className:"absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500",children:d.jsx("div",{className:"w-2.5 h-2.5",children:d.jsx(Bi,{})})})]})]})}const Ce=({axisIndex:e,value:o,min:t,max:a,step:r,onUpdate:i,onDragStart:n,onDragEnd:l,disabled:s,highlight:c,mapping:u,mapTextInput:f,liveValue:p,defaultValue:h,hardMin:g,hardMax:v,customLabel:m})=>{const y=Ui[e],b=m||y.label;return d.jsxs("div",{"data-axis-index":e,className:`relative flex-1 h-9 md:h-[26px] overflow-hidden group transition-all duration-150 ${s?"opacity-50 pointer-events-none":""}`,children:[d.jsx("div",{className:`
                ...
                `,onDoubleClick:_=>{_.preventDefault(),_.stopPropagation(),h!==void 0&&(n==null||n(),i(h),l==null||l())},title:h!==void 0?`Double-click to reset to ${h}`:"No default value",children:d.jsx("span",{className:`text-[10px] font-bold ${y.text} pointer-events-none`,children:b})}),d.jsx("div",{className:"absolute inset-0 left-5",children:d.jsx(Gi,{value:o,onChange:i,onDragStart:n,onDragEnd:l,step:r,min:t,max:a,hardMin:g,hardMax:v,mapping:u,mapTextInput:f,disabled:s,highlight:c,liveValue:p,defaultValue:h,variant:"compact",showTrack:!0})})]})},vo=[{label:"X",color:"bg-red-500",text:"text-red-400",border:"group-focus-within:border-red-500/50",hoverBg:"hover:bg-red-500/20",accent:"#ef4444"},{label:"Y",color:"bg-green-500",text:"text-green-400",border:"group-focus-within:border-green-500/50",hoverBg:"hover:bg-green-500/20",accent:"#22c55e"},{label:"Z",color:"bg-blue-500",text:"text-blue-400",border:"group-focus-within:border-blue-500/50",hoverBg:"hover:bg-blue-500/20",accent:"#3b82f6"},{label:"W",color:"bg-purple-500",text:"text-purple-400",border:"group-focus-within:border-purple-500/50",hoverBg:"hover:bg-purple-500/20",accent:"#a855f7"}],rt=({primaryAxis:e,secondaryAxis:o,primaryIndex:t,secondaryIndex:a,primaryValue:r,secondaryValue:i,min:n,max:l,step:s,onUpdate:c,onDragStart:u,onDragEnd:f,disabled:p,onHover:h})=>{const[g,v]=L.useState(!1),m=L.useRef(!1),y=L.useRef(!1),b=L.useRef({x:0,y:0}),_=L.useRef({primary:0,secondary:0}),k=L.useRef(!1),S=L.useRef(!1),C=L.useRef(!1),E=vo[t],P=vo[a],D=()=>{v(!0),h(!0)},x=()=>{m.current||(v(!1),h(!1))},z=w=>{p||w.button!==0&&w.button!==1||(w.preventDefault(),w.stopPropagation(),w.currentTarget.setPointerCapture(w.pointerId),b.current={x:w.clientX,y:w.clientY},_.current={primary:r,secondary:i},k.current=!1,S.current=w.shiftKey,C.current=w.altKey,m.current=!0,y.current=w.button===1,u())},K=w=>{if(p||!m.current||!w.currentTarget.hasPointerCapture(w.pointerId))return;const O=w.clientX-b.current.x,$=w.clientY-b.current.y;if((Math.abs(O)>1||Math.abs($)>1)&&(k.current=!0),!k.current&&Math.abs(O)<1&&Math.abs($)<1)return;w.preventDefault(),w.stopPropagation();const ue=S.current!==w.shiftKey,ae=C.current!==w.altKey;if(ue||ae){let H=s*.5;S.current&&(H*=10),C.current&&(H*=.1),_.current.primary=_.current.primary+O*H,_.current.secondary=_.current.secondary-$*H,b.current={x:w.clientX,y:w.clientY},S.current=w.shiftKey,C.current=w.altKey}if(y.current){let H=.01;w.shiftKey&&(H*=3),w.altKey&&(H*=.3);const q=1+$*H;let B=_.current.primary*q,Z=_.current.secondary*q;!isNaN(B)&&!isNaN(Z)&&c(B,Z)}else{let H=s*.5;w.shiftKey&&(H*=10),w.altKey&&(H*=.1);let q=_.current.primary+O*H,B=_.current.secondary-$*H;!isNaN(q)&&!isNaN(B)&&c(q,B)}},de=w=>{p||(w.currentTarget.releasePointerCapture(w.pointerId),m.current=!1,y.current=!1,f(),k.current=!1,w.currentTarget.matches(":hover")||(v(!1),h(!1)))},oe=w=>{p||(w.preventDefault(),w.stopPropagation(),u(),c(0,0),f())},J=g||m.current;return d.jsxs("div",{className:`
            ...
            `,onPointerDown:z,onPointerMove:K,onPointerUp:de,onMouseEnter:D,onMouseLeave:x,onDoubleClick:oe,title:`Drag: Horizontal=${e.toUpperCase()}, Vertical=${o.toUpperCase()} | Middle-click: Scale both proportionally | Double-click: Reset (Shift=Fast, Alt=Slow)`,children:[J&&d.jsx("div",{className:"absolute inset-0 opacity-30",style:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 3px, rgba(255,255,255,0.05) 3px, rgba(255,255,255,0.05) 6px)"}}),d.jsxs("div",{className:"relative w-full h-full",children:[d.jsx("div",{className:`
                    ...
                    `,children:[d.jsx("div",{className:`absolute w-2 h-[1px] ${E.color} -translate-x-1/2`}),d.jsx("div",{className:`absolute h-2 w-[1px] ${P.color} -translate-y-1/2`})]}),d.jsx("div",{className:`
                        absolute inset-0 pointer-events-none
                        transition-opacity duration-150
                        ${y.current?"opacity-100":"opacity-0"}
                    `,children:d.jsxs("div",{className:"absolute inset-0 flex items-center justify-center",children:[d.jsx("div",{className:"w-full h-[1px] bg-cyan-400/50 rotate-45"}),d.jsx("div",{className:"absolute w-full h-[1px] bg-cyan-400/50 -rotate-45"})]})})]})]})},xo=({azimuth:e,pitch:o,onChange:t,onDragStart:a,onDragEnd:r,disabled:i=!1,size:n=80})=>{const l=L.useRef(null),s=L.useRef(!1),[c,u]=L.useState(!1),[f,p]=L.useState(!1),[h,g]=L.useState(!1),v=L.useRef({x:0,y:0}),m=L.useRef({azimuth:e,pitch:o}),y=L.useRef({azimuth:e,pitch:o}),b=L.useRef(null);L.useEffect(()=>{m.current={azimuth:e,pitch:o}},[e,o]);const S=f?.05:.5,C=n/2,E=n*.38,P=L.useCallback((w,O,$)=>{const ue=w/(Math.PI/2)*$,ae=-(O/(Math.PI/2))*$;return{x:ue,y:ae}},[]),D=L.useMemo(()=>P(e,o,E),[e,o,E,P]),x=L.useMemo(()=>{const w=Math.cos(o),O=Math.sin(o),$=Math.cos(e),ae=Math.sin(e)*w,H=O,q=-$*w,B=ae,Z=-H,X=Math.sqrt(B*B+Z*Z),ne=q>0,De=X>.001?Math.min(X,1)*E:0,Pe=q<=0?1+(1-Math.min(X,1))*.5:1-q*.95,Ne=X>.001?B/X*De:0,xe=X>.001?Z/X*De:0;return{x:Ne,y:xe,isBack:ne,length:De,headScale:Pe,dirX:ae,dirY:H,dirZ:q}},[e,o,E]),z=L.useCallback((w,O,$)=>{const ue=w/$*(Math.PI/2),ae=-(O/$)*(Math.PI/2);return{azimuth:ue,pitch:ae}},[]),K=L.useCallback((w,O)=>{let $=w,ue=O;h&&b.current&&(b.current==="x"?ue=0:$=0);const ae=$*S,H=ue*S,q=P(m.current.azimuth,m.current.pitch,E),B=q.x+ae,Z=q.y+H,{azimuth:X,pitch:ne}=z(B,Z,E);h&&b.current?b.current==="x"?(m.current={azimuth:X,pitch:y.current.pitch},t(X,y.current.pitch)):(m.current={azimuth:y.current.azimuth,pitch:ne},t(y.current.azimuth,ne)):(m.current={azimuth:X,pitch:ne},t(X,ne))},[P,z,t,E,S,h]),de=w=>{i||w.button===0&&(w.preventDefault(),w.stopPropagation(),w.currentTarget.setPointerCapture(w.pointerId),s.current=!0,u(!0),v.current={x:w.clientX,y:w.clientY},m.current={azimuth:e,pitch:o},y.current={azimuth:e,pitch:o},b.current=null,a==null||a(),p(w.altKey),g(w.shiftKey))},oe=w=>{if(i||!s.current)return;const O=w.clientX-v.current.x,$=w.clientY-v.current.y;v.current={x:w.clientX,y:w.clientY},p(w.altKey),g(w.shiftKey),h&&!b.current&&(Math.abs(O)>2||Math.abs($)>2)&&(b.current=Math.abs(O)>Math.abs($)?"x":"y"),K(O,$)},J=w=>{s.current&&(s.current=!1,u(!1),p(!1),g(!1),b.current=null,r==null||r())};return d.jsxs("div",{ref:l,className:`
            ...
            `,style:{width:n,height:n,touchAction:"none",boxShadow:c?"0 0 20px rgba(34, 211, 238, 0.3)":"none"},onPointerDown:de,onPointerMove:oe,onPointerUp:J,onPointerLeave:J,onDoubleClick:w=>{i||(w.preventDefault(),w.stopPropagation(),a==null||a(),t(0,0),r==null||r())},onContextMenu:w=>{},title:"Drag to rotate direction, Double-click to reset",children:[d.jsx("div",{className:"absolute rounded-full border border-white/10 pointer-events-none",style:{width:E*2,height:E*2,left:C-E,top:C-E}}),d.jsx("div",{className:"absolute w-full h-px bg-white/10 pointer-events-none",style:{top:C}}),d.jsx("div",{className:"absolute h-full w-px bg-white/10 pointer-events-none",style:{left:C}}),d.jsx("div",{className:"absolute w-1.5 h-1.5 bg-white/40 rounded-full pointer-events-none",style:{left:C-3,top:C-3}}),d.jsx("div",{className:"absolute pointer-events-none rounded-full transition-transform duration-75",style:{left:C+D.x,top:C+D.y,width:8,height:8,marginLeft:-4,marginTop:-4,background:x.isBack?"#ef4444":"#22d3ee",boxShadow:`0 0 8px ${x.isBack?"#ef4444":"#22d3ee"}`,transform:c?"scale(1.2)":"scale(1)"}}),x.isBack&&d.jsx("div",{className:"absolute inset-0 rounded-full border-2 border-red-500/30 pointer-events-none animate-pulse"}),d.jsxs(d.Fragment,{children:[d.jsxs("svg",{className:"absolute inset-0 pointer-events-none",style:{width:n,height:n},children:[Math.abs(e)>.01&&d.jsxs(d.Fragment,{children:[d.jsx("ellipse",{cx:C,cy:C,rx:E*Math.abs(Math.sin(e)),ry:E,fill:"none",stroke:x.isBack?"#ef4444":"#22d3ee",strokeWidth:"1.5",opacity:x.isBack?.175:.35,clipPath:x.x>0?"url(#longitudeRight)":"url(#longitudeLeft)"}),d.jsx("ellipse",{cx:C,cy:C,rx:E*Math.abs(Math.sin(e)),ry:E,fill:"none",stroke:x.isBack?"#22d3ee":"#ef4444",strokeWidth:"1.5",opacity:x.isBack?.35:.175,clipPath:x.x>0?"url(#longitudeLeft)":"url(#longitudeRight)"})]}),Math.abs(o)>.01&&d.jsxs(d.Fragment,{children:[d.jsx("ellipse",{cx:C,cy:C,rx:E,ry:E*Math.abs(Math.sin(o)),fill:"none",stroke:x.isBack?"#ef4444":"#22d3ee",strokeWidth:"1.5",opacity:x.isBack?.15:.3,clipPath:x.y<0?"url(#latitudeTop)":"url(#latitudeBottom)"}),d.jsx("ellipse",{cx:C,cy:C,rx:E,ry:E*Math.abs(Math.sin(o)),fill:"none",stroke:x.isBack?"#22d3ee":"#ef4444",strokeWidth:"1.5",opacity:x.isBack?.3:.15,clipPath:x.y<0?"url(#latitudeBottom)":"url(#latitudeTop)"})]}),d.jsxs("defs",{children:[d.jsx("clipPath",{id:"longitudeRight",children:d.jsx("rect",{x:C,y:"0",width:C,height:n})}),d.jsx("clipPath",{id:"longitudeLeft",children:d.jsx("rect",{x:"0",y:"0",width:C,height:n})}),d.jsx("clipPath",{id:"latitudeTop",children:d.jsx("rect",{x:"0",y:"0",width:n,height:C})}),d.jsx("clipPath",{id:"latitudeBottom",children:d.jsx("rect",{x:"0",y:C,width:n,height:C})})]}),d.jsx("line",{x1:C,y1:C,x2:C+x.x,y2:C+x.y,stroke:x.isBack?"#ef4444":"#22d3ee",strokeWidth:"2",strokeDasharray:"4 2",opacity:.3+x.length/E*.5}),d.jsx("polygon",{points:"0,-8 -6,4 6,4",fill:x.isBack?"#ef4444":"#22d3ee",opacity:Math.max(.1,.6+(x.headScale-1)*.4),transform:`translate(${C+x.x}, ${C+x.y}) rotate(${Math.atan2(x.y,x.x)*180/Math.PI+90}) scale(${Math.max(.9,.9+x.headScale*.1)}, ${Math.max(.05,x.headScale)})`})]}),c&&d.jsx("div",{className:"absolute -bottom-5 left-1/2 -translate-x-1/2 whitespace-nowrap",children:d.jsxs("span",{className:"text-[9px] text-cyan-400 font-mono bg-black/60 px-1 rounded",children:[(e*180/Math.PI).toFixed(0),"° / ",(o*180/Math.PI).toFixed(0),"°"]})})]})]})},_t=Math.PI/180,Xi=180/Math.PI,Yi=["x","y","z","w"],It={x:0,y:1,z:2,w:3},Ki=e=>{const o=e.length();if(o<1e-9)return{azimuth:0,pitch:0};const t=Math.max(-1,Math.min(1,e.y/o));return{azimuth:Math.atan2(e.x/o,e.z/o),pitch:Math.asin(t)}},Ji=(e,o)=>{const t=Math.cos(o);return new N(t*Math.sin(e),Math.sin(o),t*Math.cos(e))},yl=({label:e,value:o,onChange:t,min:a=-1e4,max:r=1e4,step:i=.01,disabled:n=!1,convertRadToDeg:l=!1,mode:s="normal",modeToggleable:c=!1,showLiveIndicator:u=!1,liveValue:f,defaultValue:p,hardMin:h,hardMax:g,axisMin:v,axisMax:m,axisStep:y,onDragStart:b,onDragEnd:_,headerRight:k,showDualAxisPads:S=!0,linkable:C=!1,scale:E})=>{const[P,D]=L.useState(o.clone()),[x,z]=L.useState(null),[K,de]=L.useState(s),[oe,J]=L.useState("degrees"),[w,O]=L.useState("degrees"),[$,ue]=L.useState(C),ae=L.useRef(!1),H=L.useRef(null),q=L.useRef(null);L.useEffect(()=>{de(s)},[s]);const B=pe(I=>I.openContextMenu),Z="w"in o,X="z"in o,ne=K==="rotation",De=K==="toggle",Pe=K==="mixed",Ne=K==="direction"&&X,xe=Ne?Ki(P):{azimuth:0,pitch:0},We=(I,F)=>{const V=Math.max(-Math.PI/2,Math.min(Math.PI/2,F)),W=Ji(I,V);se(0,I),se(1,V),D(W),t(W)};L.useEffect(()=>{if(ae.current)return;const I=1e-4,F=Math.abs(o.x-P.x),V=Math.abs(o.y-P.y),W=X?Math.abs(o.z-P.z):0,me=Z?Math.abs(o.w-P.w):0;(F>I||V>I||W>I||me>I)&&D(o.clone())},[o,X,Z]);const T=()=>{ae.current=!0,H.current=P.clone(),b&&b()},A=()=>{H.current=null,ae.current=!1,_&&_()},fe=I=>{if(ne)return oe==="degrees"?Je:go;if(E==="pi")return w==="pi"?go:Je;if(l)return Je},_e=I=>{if(ne){const ee=oe==="degrees"?60*Math.PI/180:.05;return{min:-2*Math.PI,max:2*Math.PI,step:ee,hardMin:void 0,hardMax:void 0}}const F=v||{x:a,y:a,z:a},V=m||{x:r,y:r,z:r},W=y||{x:i,y:i,z:i},me=E==="pi"&&w==="degrees"?Xi:1;return{min:F[I],max:V[I],step:(W[I]??i)*me,hardMin:h,hardMax:g}},se=(I,F)=>{const V=q.current;if(!V)return;const W=V.querySelector(`[data-axis-index="${I}"]`);if(!W)return;const me=Yi[I],ee=fe(),Ft=W.querySelector('[data-role="value"]');Ft&&(Ft.textContent=ee!=null&&ee.format?ee.format(F):Uo(F));const Ot=W.querySelector('[data-role="fill"]');if(Ot){const jt=_e(me),Nt=jt.min??a,$t=jt.max??r;if(Nt!==$t){const ea=qo(F,Nt,$t,ee);Ot.style.width=`${ea}%`}}},Le=(I,F)=>{const V=H.current||P,W=V.clone();if($&&!ne){const me=V[I],ee=F-me;W.x=V.x+ee,W.y=V.y+ee,X&&(W.z=V.z+ee),Z&&(W.w=V.w+ee),se(0,W.x),se(1,W.y),X&&se(2,W.z),Z&&se(3,W.w)}else W[I]=F;D(W),t(W)},Se=(I,F,V,W)=>{const ee=(H.current||P).clone();ee[I]=V,ee[F]=W,se(It[I],V),se(It[F],W),D(ee),t(ee)},Ie=x==="xy",Xe=x==="xy"||x==="zy",ut=x==="zy"||x==="wz",$e=x==="wz",Ee=I=>{if(f)return f[I]},ft=I=>{if(p)return p[I]},ot=P,Yo={x:Ie,y:Xe,z:ut,w:$e},ze=I=>({axisIndex:It[I],value:P[I],..._e(I),onUpdate:F=>Le(I,F),onDragStart:T,onDragEnd:A,disabled:n,highlight:Yo[I],mapping:fe(),mapTextInput:ne||E==="pi",liveValue:u?Ee(I):void 0,defaultValue:ft(I)}),Ko=[{on:"bg-red-500/30 text-red-300 border-red-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-green-500/30 text-green-300 border-green-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-blue-500/30 text-blue-300 border-blue-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-purple-500/30 text-purple-300 border-purple-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}],Dt=(I,F,V)=>{const me=P[I]>.5,ee=Ko[F];return d.jsxs("button",{className:`flex items-center justify-center gap-1 text-[10px] font-bold transition-all border ${me?ee.on:ee.off} ${n?"opacity-40 pointer-events-none":"cursor-pointer hover:brightness-125"} ${V||"flex-1"}`,onClick:()=>Le(I,me?0:1),disabled:n,children:[V?null:d.jsx("span",{children:I}),d.jsx("span",{className:`text-[8px] ${me?"opacity-80":"opacity-70"}`,children:me?"ON":"OFF"})]},I)},Jo=()=>c?d.jsx("button",{onClick:()=>de(I=>I==="rotation"?"normal":"rotation"),className:`text-[10px] p-1 rounded transition-colors mr-2 ${K==="rotation"?"text-cyan-400 bg-cyan-500/20":"text-gray-500 hover:text-gray-300"}`,title:K==="rotation"?"Rotation mode (π units)":"Normal mode",children:"⟳"}):null,Zo=()=>!C||ne?null:d.jsx("button",{onClick:()=>ue(I=>!I),className:`p-1 rounded transition-colors mr-2 ${$?"text-cyan-400 bg-cyan-500/20":"text-gray-600 hover:text-gray-400"}`,title:$?"Axes linked (uniform)":"Link axes",children:d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"}),d.jsx("path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"})]})}),Qo=I=>{const F=[];ne&&F.push({label:"Rotation Units",action:()=>{},isHeader:!0},{label:"Degrees (°)",checked:oe==="degrees",action:()=>J("degrees")},{label:"Radians (π)",checked:oe==="radians",action:()=>J("radians")}),!ne&&E==="pi"&&F.push({label:"Display Units",action:()=>{},isHeader:!0},{label:"Radians (π)",checked:w==="pi",action:()=>O("pi")},{label:"Degrees (°)",checked:w==="degrees",action:()=>O("degrees")}),X&&(s==="rotation"||s==="axes")&&F.push({label:"Display Mode",action:()=>{},isHeader:!0},{label:"Azimuth / Pitch (A/P)",checked:K==="rotation",action:()=>de("rotation")},{label:"Per-Axis (X/Y/Z)",checked:K==="axes"||K==="normal",action:()=>de("normal")}),F.length!==0&&(I.preventDefault(),I.stopPropagation(),B(I.clientX,I.clientY,F,["ui.vector"]))};return d.jsxs("div",{className:"mb-px animate-slider-entry",children:[e&&d.jsxs("div",{className:"flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5",children:[d.jsxs("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:[c&&Jo(),k,d.jsx("label",{className:`text-[10px] font-medium tracking-tight select-none flex items-center gap-2 truncate pointer-events-none ${n?"text-gray-600":"text-gray-400"}`,children:e})]}),C&&!ne&&d.jsx("div",{className:"flex items-center px-1 border-l border-white/5",children:Zo()})]}),d.jsx("div",{className:"relative h-9 md:h-[26px] flex items-center touch-none overflow-hidden rounded-b-sm",style:{touchAction:"none"},onContextMenu:Qo,"data-help-id":"ui.vector",children:d.jsx("div",{ref:q,className:"flex gap-px w-full h-full",children:De?d.jsx(d.Fragment,{children:["x","y","z","w"].slice(0,Z?4:X?3:2).map((I,F)=>Dt(I,F))}):Pe?d.jsxs(d.Fragment,{children:[Dt("x",0,"w-14 flex-shrink-0"),d.jsx(Ce,{...ze("y"),disabled:n||P.x<.5})]}):Ne?d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"flex items-center justify-center px-1 flex-shrink-0",children:d.jsx(xo,{azimuth:xe.azimuth,pitch:xe.pitch,onChange:(I,F)=>{We(I,F)},onDragStart:T,onDragEnd:A,disabled:n,size:56})}),d.jsx(Ce,{axisIndex:0,value:xe.azimuth,min:-Math.PI,max:Math.PI,step:_t,onUpdate:I=>We(I,xe.pitch),onDragStart:T,onDragEnd:A,disabled:n,mapping:Je,mapTextInput:!0,customLabel:"Az"}),d.jsx(rt,{primaryAxis:"x",secondaryAxis:"y",primaryIndex:0,secondaryIndex:1,primaryValue:xe.azimuth,secondaryValue:xe.pitch,min:-Math.PI,max:Math.PI,step:_t,onUpdate:(I,F)=>We(I,F),onDragStart:T,onDragEnd:A,disabled:n,onHover:I=>z(I?"xy":null)}),d.jsx(Ce,{axisIndex:1,value:xe.pitch,min:-Math.PI/2,max:Math.PI/2,step:_t,onUpdate:I=>We(xe.azimuth,I),onDragStart:T,onDragEnd:A,disabled:n,mapping:Je,mapTextInput:!0,customLabel:"Pt"})]}):ne?d.jsxs(d.Fragment,{children:[X&&d.jsx(Ce,{...ze("z"),customLabel:"∠"}),d.jsx("div",{className:"flex items-center justify-center px-1",children:d.jsx(xo,{azimuth:P.x,pitch:P.y,onChange:(I,F)=>{const V=P.clone();V.x=I,V.y=F,se(0,I),se(1,F),D(V),t(V)},onDragStart:T,onDragEnd:A,disabled:n,size:56})}),d.jsx("div",{className:"contents",children:d.jsx(Ce,{...ze("x"),customLabel:"A"})}),d.jsx(Ce,{...ze("y"),customLabel:"P"})]}):d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"contents",children:d.jsx(Ce,{...ze("x")})}),S&&d.jsx(rt,{primaryAxis:"x",secondaryAxis:"y",primaryIndex:0,secondaryIndex:1,primaryValue:P.x,secondaryValue:P.y,min:a,max:r,step:i,onUpdate:(I,F)=>Se("x","y",I,F),onDragStart:T,onDragEnd:A,disabled:n,onHover:I=>z(I?"xy":null)}),d.jsx(Ce,{...ze("y")}),X&&S&&d.jsx(rt,{primaryAxis:"z",secondaryAxis:"y",primaryIndex:2,secondaryIndex:1,primaryValue:ot.z,secondaryValue:ot.y,min:a,max:r,step:i,onUpdate:(I,F)=>Se("z","y",I,F),onDragStart:T,onDragEnd:A,disabled:n,onHover:I=>z(I?"zy":null)}),X&&d.jsx(Ce,{...ze("z")}),Z&&S&&d.jsx(rt,{primaryAxis:"x",secondaryAxis:"z",primaryIndex:3,secondaryIndex:2,primaryValue:P.w,secondaryValue:P.z,min:a,max:r,step:i,onUpdate:(I,F)=>Se("w","z",I,F),onDragStart:T,onDragEnd:A,disabled:n,onHover:I=>z(I?"wz":null)}),Z&&d.jsx(Ce,{...ze("w")})]})})})]})},Zi={default:"",panel:"px-2 py-0.5 text-[9px] font-bold text-gray-500 hover:text-gray-300 bg-neutral-800 rounded-sm"},Qi=({open:e})=>d.jsx("svg",{className:`w-2 h-2 transition-transform ${e?"rotate-90":""}`,viewBox:"0 0 6 10",fill:"currentColor",children:d.jsx("path",{d:"M0 0l6 5-6 5z"})}),bl=({label:e,children:o,defaultOpen:t=!0,count:a,labelVariant:r="secondary",labelColor:i,rightContent:n,className:l="",headerClassName:s="",variant:c="default",open:u,onToggle:f})=>{const p=s||Zi[c],[h,g]=L.useState(t),v=u!==void 0,m=v?u:h,y=()=>{f&&f(),v||g(b=>!b)};return d.jsxs("div",{className:l,children:[d.jsxs("div",{className:`flex items-center gap-1.5 w-full px-2 py-1 text-left select-none hover:bg-white/5 transition-colors rounded-sm ${p}`,children:[d.jsxs("button",{onClick:y,className:"flex items-center gap-1.5 flex-1 min-w-0",children:[d.jsx(Qi,{open:m}),d.jsx(Wi,{variant:r,color:i,children:e}),a!==void 0&&d.jsx("span",{className:"text-[8px] bg-white/10 text-gray-400 px-1.5 py-0.5 rounded ml-1",children:a})]}),n&&d.jsx("div",{className:"ml-auto flex items-center gap-1",children:n})]}),m&&o]})},en=`
  /*
...
`)},tn=(e,o)=>{var l;const{shader:t,...a}=e,r={};(l=t.preambleVars)!=null&&l.length&&(r.preambleVars=t.preambleVars),t.usesSharedRotation&&(r.usesSharedRotation=!0);const i={...a,...Object.keys(r).length>0?{shaderMeta:r}:{},defaultPreset:o};let n=`<!--
...
`),n},on=e=>{const o=u=>{const f=new RegExp(`<${u}>([\\s\\S]*?)<\\/${u}>`),p=e.match(f);return p?p[1].trim():null},t=o("Metadata");if(!t){try{const u=JSON.parse(e);if(u.id&&u.shader)return u}catch{}throw new Error("Invalid GMF: Missing Metadata tag")}const a=JSON.parse(t),r=o("Shader_Preamble"),i=o("Shader_Function"),n=o("Shader_Loop"),l=o("Shader_Init"),s=o("Shader_Dist");if(!i||!n)throw new Error("Invalid GMF: Missing essential shader blocks (<Shader_Function> or <Shader_Loop>)");const c={function:i,loopBody:n,preamble:r||void 0,loopInit:l||void 0,getDist:s||void 0};return a.shaderMeta&&(a.shaderMeta.preambleVars&&(c.preambleVars=a.shaderMeta.preambleVars),a.shaderMeta.usesSharedRotation&&(c.usesSharedRotation=!0),delete a.shaderMeta),{...a,shader:c}},an=e=>{const o=e.trimStart();return o.startsWith("<!--")||o.startsWith("<Metadata>")},vl=e=>{const o=he.get(e.formula);if(!o)return JSON.stringify(e,null,2);let t=tn(o,o.defaultPreset);return t+=`<!-- Full scene state (camera, lights, features, quality, animations) -->
`,t+=`<Scene>
${Xo(e)}
</Scene>
`,t},xl=e=>{if(an(e)){const t=on(e),a=e.match(/<Scene>([\s\S]*?)<\/Scene>/);if(a){const i=JSON.parse(a[1].trim());return{def:t,preset:i}}const r=t.defaultPreset||{formula:t.id};return r.formula||(r.formula=t.id),{def:t,preset:r}}return{preset:JSON.parse(e)}};export{Ss as $,Te as A,kn as B,et as C,ns as D,gl as E,R as F,el as G,yl as H,bl as I,cs as J,Es as K,gn as L,hn as M,Bi as N,Bn as O,Os as P,xs as Q,Cs as R,Gi as S,Xn as T,vs as U,Y as V,ss as W,bs as X,ts as Y,os as Z,as as _,Et as a,cl as a$,vl as a0,ya as a1,Cn as a2,Qe as a3,he as a4,ks as a5,Jn as a6,Zn as a7,Kn as a8,fs as a9,Gn as aA,$n as aB,An as aC,Hn as aD,rl as aE,il as aF,qe as aG,Wo as aH,ol as aI,al as aJ,nl as aK,sl as aL,Wn as aM,Ue as aN,qn as aO,ds as aP,Ms as aQ,gs as aR,ys as aS,ml as aT,En as aU,bo as aV,Re as aW,ls as aX,Ds as aY,Fs as aZ,tn as a_,Un as aa,es as ab,ps as ac,dn as ad,xl as ae,Qn as af,is as ag,Rs as ah,hs as ai,ji as aj,Yn as ak,Nn as al,Mn as am,G as an,On as ao,us as ap,Fn as aq,Ls as ar,Ps as as,ao as at,fn as au,pn as av,mn as aw,Go as ax,yn as ay,Vn as az,Ln as b,U as b0,ll as b1,dl as b2,ul as b3,fl as b4,tl as b5,pl as b6,hl as b7,go as b8,Ui as b9,qs as bA,Us as bB,Hs as bC,Bs as bD,Vs as bE,Ts as bF,xn as bG,vn as bH,wn as bI,Sn as bJ,zs as bK,Dn as bL,ho as bM,No as bN,Qa as ba,at as bb,sr as bc,lr as bd,dr as be,cr as bf,ur as bg,ai as bh,re as bi,Mi as bj,_n as bk,In as bl,As as bm,ms as bn,Qs as bo,Ws as bp,Xs as bq,Ys as br,Ks as bs,Js as bt,Gs as bu,Zs as bv,Rn as bw,Pn as bx,Ns as by,$s as bz,Be as c,le as d,Uo as e,j as f,je as g,rs as h,zn as i,Tn as j,tt as k,At as l,bn as m,Me as n,js as o,ws as p,Is as q,un as r,jn as s,_s as t,pe as u,He as v,dt as w,Oo as x,jo as y,Wi as z};
