...
const GlobalContextMenu: React.FC<GlobalContextMenuProps> = ({ x, y, items, targetHelpIds, onClose, onOpenHelp, isSubmenu }) => {
    ...
    const content = (
        <div 
            ref={menuRef}
            className="fractal-context-menu fixed bg-surface-raised border border-line/20 rounded shadow-[0_4px_20px_rgba(0,0,0,0.8)] py-1 min-w-[200px] max-h-[80dvh] overflow-y-auto mobile-scroll animate-fade-in"
