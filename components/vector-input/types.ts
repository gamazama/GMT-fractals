...
export interface BaseVectorInputProps {
    ...
    onChange: (val: THREE.Vector2 | THREE.Vector3) => void;
    min?: number;
    max?: number;
    step?: number;
    disabled?: boolean;
    ...
    liveValue?: THREE.Vector2 | THREE.Vector3;
    /** Default values for reset functionality */
    defaultValue?: THREE.Vector2 | THREE.Vector3;
    /** Hard minimum values (clamped) */
    hardMin?: number;
    /** Hard maximum values (clamped) */
    hardMax?: number;
    /** Per-axis minimum values */
    axisMin?: { x?: number; y?: number; z?: number };
    /** Per-axis maximum values */
    axisMax?: { x?: number; y?: number; z?: number };
