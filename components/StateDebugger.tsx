        ...
        >
            <div className="flex flex-col h-full gap-3">
                <div className="flex flex-col gap-1">
                    <label className="text-[10px] font-bold text-gray-500">Input (URL Hash or Base64)</label>
                ...
                <div className="flex gap-2 border-b border-white/10 pb-2">
                    <button 
                        ...
                        className="px-3 py-1.5 bg-gray-800 hover:bg-gray-700 text-gray-300 text-[10px] font-bold rounded border border-white/10"
                    >
                        Dump Current State
                    </button>
                    {decodedPreset && (
                         <button 
                            onClick={handleApply}
                            className="px-3 py-1.5 bg-green-900/50 hover:bg-green-800 text-green-300 text-[10px] font-bold rounded border border-green-500/30 ml-auto"
                        >
                ...
                <div className="flex-1 flex flex-col min-h-0">
                    <label className="text-[10px] font-bold text-gray-500 mb-1">State Inspector (JSON)</label>
                    <textarea 
