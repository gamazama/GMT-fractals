 ...
 *
 * @assumption Composed-vec decomposition (`config.composeFrom`) MUST
 ...
 * @assumption `onUpdate: 'compile'` default route is HARDCODED to the
 ...
 * @assumption `forcedState` flows through props only; child panels
