...
/** 1-D colormap LUT width (256 × 1 RGBA8). The byte-exact width the GX
 *  ramp seam (`renderStopsToBuffer`) produces and fluid-toy consumes —
 *  ONE source of truth, re-exported by `fluid-toy/constants.ts`. */
export const FRACTAL_GRADIENT_LUT_WIDTH = 256;
