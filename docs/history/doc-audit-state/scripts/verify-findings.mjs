...
lines.push('');
lines.push(`_Add new findings: append to the \`FINDINGS\` array in \`docs/history/doc-audit-state/scripts/verify-findings.mjs\` with id + description + check() returning {status, evidence}._`);
lines.push('');
