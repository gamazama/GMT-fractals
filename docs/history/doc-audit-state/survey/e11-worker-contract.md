...
No existing per-subsystem doc for engine-core worker primitives — skip. (Related references exist in `HANDOFF.md:393`, `docs/CHANGELOG_DEV.md:148`, and `docs/history/gmt/08_File_Structure.md:41`, but no dedicated audit doc.)
