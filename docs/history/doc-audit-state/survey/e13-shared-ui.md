...
## Drift from existing doc (docs/history/engine/05_Shared_UI.md)
...
Orphan-sweep candidate: components/MobileControls.tsx — see docs/history/engine/17_Mobile_Layout.md; verify ownership.
