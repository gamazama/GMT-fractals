...
## Drift from existing doc (docs/history/engine/01_Architecture.md)
...
- The dev warning message at TickRegistry.ts:71 cites `docs/01_Architecture.md § render-loop` — is that the canonical path now that docs live at `docs/history/engine/01_Architecture.md`?
