...
files:
  - docs/history/gmt/01_System_Architecture.md
  - docs/history/gmt/02_Rendering_Internals.md
  - docs/history/gmt/03_Modular_System.md
  - docs/history/gmt/04_Animation_Engine.md
  - docs/history/gmt/05_Data_and_Export.md
  - docs/history/gmt/06_Troubleshooting_and_Quirks.md
  - docs/history/gmt/07_Code_Health.md
  - docs/history/gmt/08_File_Structure.md
  - docs/history/gmt/21_Frag_Importer_Current_Status.md
  - docs/history/gmt/22_Frag_to_Native_Formula_Conversion.md
---
