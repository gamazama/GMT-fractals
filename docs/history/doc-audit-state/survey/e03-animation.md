...
## Drift from existing doc (docs/history/engine/08_Animation.md)
...
PASS — all 13 files read top-to-bottom, blob SHAs recorded, public API enumerated with file:line citations, architecture bullets and invariants captured, drift table populated against `docs/history/engine/08_Animation.md`.
