...
> **Status: SHIPPED (2026-05-01).** This document is the design record. See the *What shipped* section at the bottom for what landed and any deltas from the original plan. For ongoing reference, the canonical doc lives in `docs/history/gmt/02_Rendering_Internals.md` § *Compile Spinner Gate*.
