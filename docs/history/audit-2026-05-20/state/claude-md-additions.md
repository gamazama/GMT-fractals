...
UI primitives. Source: `docs/history/doc-audit-state/harvest/batch-A.md`.

| Working on... | Read first |
|---------------|-----------|
| App boot order, registry freeze timing, share-URL hydration | `docs/history/audit-2026-05-20/archive/app-gmt/boot-shell.md` |
| Boot timeout / splash never fades / `isReady` stuck false (PRODUCTION BUG) | `docs/history/audit-2026-05-20/archive/app-gmt/boot-shell.md` |
| Panel manifest, topbar slots, system menu, light HUD popups | `docs/history/audit-2026-05-20/archive/app-gmt/panels-layout.md` |
| Tutorial / guided lessons, anchors, triggers, step renderers | `docs/history/audit-2026-05-20/archive/app-gmt/tutorial.md` |
| DDFS features, registry freeze, auto-setter contract, typed slices | `docs/history/audit-2026-05-20/archive/engine/feature-system.md` |
| DDFS UI rendering, scalar/vector inputs, CompilableFeatureSection, componentRegistry | `docs/history/audit-2026-05-20/archive/engine/shared-ui.md` |
...
undo. Source: `docs/history/doc-audit-state/harvest/batch-B.md`.

| Working on... | Read first |
|---------------|-----------|
| Animation binders, recording lifecycle, log/camera-pair tracks | `docs/history/audit-2026-05-20/archive/engine/animation.md` |
| RenderPipeline writeIndex semantics, bloom, accumulation | `docs/history/audit-2026-05-20/archive/engine/render-pipeline.md` |
| Shader builder, uniform schema, BASE vs feature merge | `docs/history/audit-2026-05-20/archive/engine/shader-builder.md` |
| Engine plugin host slots (TopBar/Hud/Menu), SceneIO, RenderDialog | `docs/history/audit-2026-05-20/archive/engine/plugins-host.md` |
| Shortcuts scope stack, per-scope undo lanes | `docs/history/audit-2026-05-20/archive/engine/shortcuts-undo.md` |
...
`docs/history/doc-audit-state/harvest/batch-C.md`.

| Working on... | Read first |
|---------------|-----------|
| Adaptive resolution algorithm, viewport plugin, render-scale source | `docs/history/audit-2026-05-20/archive/engine/adaptive-resolution.md` |
| Audio clip sync, export mixdown, file cache | `docs/history/audit-2026-05-20/archive/engine/audio-fps-sync.md` |
| Camera plugin adapters, presetField, appHandles, migrations, StateLibrary slice | `docs/history/audit-2026-05-20/archive/engine/camera-plugin.md` |
| StateLibrary UI primitives (panel, toast, active-snapshot features) | `docs/history/audit-2026-05-20/archive/engine/state-library-ui.md` |
| Worker proxy stub, ViewportRefs, EngineRenderState contract | `docs/history/audit-2026-05-20/archive/engine/worker-contract.md` |
...
GMT-specific engine fork — navigation, formula registry + Modular graph, GMF save/load, features mounting, Camera Manager, Formula Workshop (V3/V4 importer). Source: `docs/history/doc-audit-state/harvest/batch-E.md`. ADRs 0046-0058.

| Working on... | Read first |
|---------------|-----------|
| GMT camera, Orbit/Fly modes, cursor-anchored gestures, sceneOffset treadmill | `docs/history/audit-2026-05-20/archive/engine-gmt/navigation.md` |
| Formula registry, FractalDefinition, alias drift, FormulaType union | `docs/history/audit-2026-05-20/archive/engine-gmt/formula-registry.md` |
| Modular graph compiler, uModularParams slot parity, DCE + topo sort | `docs/history/audit-2026-05-20/archive/engine-gmt/modular-graph.md` |
| GMF format (v1/v2), scene save/load, parseGMF caveats, registry handoff | `docs/history/audit-2026-05-20/archive/engine-gmt/save-load-gmf.md` |
| DDFS feature catalog (engine-gmt), engine-core shared features, compile/runtime split | `docs/history/audit-2026-05-20/archive/engine-gmt/features.md` |
| Camera Manager, savedCameras + slot hotkeys, installStateLibrary factory consumer | `docs/history/audit-2026-05-20/archive/engine-gmt/camera-manager.md` |
| Formula Workshop (Fragmentarium/DEC/Shadertoy import), V3 + V4 pipelines, importSource lifecycle | `docs/history/audit-2026-05-20/archive/engine-gmt/formula-workshop.md` |
...
Bundled engine features, mobile-layout primitives, GMT renderer (FractalEngine + worker bridge), shader pipeline (ShaderBuilder + UniformManager + ConfigManager), bucket-render + worker-export + readbacks. Source: `docs/history/doc-audit-state/harvest/batch-D.md`. ADRs 0036-0045.

| Working on... | Read first |
|---------------|-----------|
| Bundled engine features (audio / modulation / webcam / debug / post / grading) | `docs/history/audit-2026-05-20/archive/engine/features.md` |
| Mobile-layout primitives, address-bar collapse, asymmetric gating | `docs/history/audit-2026-05-20/archive/engine/mobile-layout.md` |
| FractalEngine + MaterialController + CompileScheduler + Worker bridge | `docs/history/audit-2026-05-20/archive/engine-gmt/renderer.md` |
| Shader composition: ShaderBuilder 17-position, SDFShaderBuilder, UniformManager.syncFrame, ConfigManager diff | `docs/history/audit-2026-05-20/archive/engine-gmt/shader-pipeline.md` |
| Bucket render + video/image-sequence export + worker readbacks (depth, histogram) | `docs/history/audit-2026-05-20/archive/engine-gmt/bucket-render.md` |
