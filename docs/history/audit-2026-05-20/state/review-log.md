...
- New sub-pattern: shared-UI-primitive coupling to GMT-app concepts (q-088 Knob vs Slider context, q-089 AutoFeaturePanel hardcoded `movePanel('Engine')` + `engine_queue` route). Coherent Phase 2 story for `docs/history/engine/05_Shared_UI.md`.
