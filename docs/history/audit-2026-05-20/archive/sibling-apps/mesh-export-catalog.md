...
Also referenced: `docs/history/gmt/24_Formula_Interlace_System.md` for the `interlaceCompiled` contract and for the note that the mesh-export interlace path is a parallel branch of the main-app interlace and the two must be kept in sync.
