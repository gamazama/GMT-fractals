...
- `e05-render-pipeline`. `GmtBucketHost` is the GMT consumer of the pipeline's
  ...
  followup `docs/history/doc-audit-state/survey/_followups/q-036.md` for the
...
`docs/history/doc-audit-state/survey/_followups/q-112.md` for the original analysis.
...
cap). A dedicated paragraph in `docs/history/gmt/06_Troubleshooting_and_Quirks.md` near
...
See `docs/history/doc-audit-state/survey/_followups/q-114.md` for the full analysis.
...
This module doc supersedes `docs/history/gmt/43_Bucket_Render_Overhaul.md`, which was
written 2026-04-20 as a draft design plan ("Draft plan | 2026-04-20" —
`docs/history/gmt/43_Bucket_Render_Overhaul.md:3`) before extraction and shipped well
...
- **Two-distinct-concepts terminology.** From the original at
  `docs/history/gmt/43_Bucket_Render_Overhaul.md:29-32`:
...
`docs/history/gmt/43_Bucket_Render_Overhaul.md:60` is implemented as the
