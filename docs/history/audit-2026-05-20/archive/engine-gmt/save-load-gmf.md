...
- **review-#5 (doc-rewrite carry-in):** `docs/history/gmt/05_Data_and_Export.md` doesn't
  ...
  See `docs/history/doc-audit-state/reviews/review-2026-05-20-5.md` and
  `docs/history/doc-audit-state/phase-2-carry-in.json`.
- **Doc-drift items inherited from the survey** (`docs/history/doc-audit-state/survey/g08-save-load-gmf.md`):
...
`docs/history/gmt/05_Data_and_Export.md:1-177` (stable, pre-engine-fork layout). That doc
...
`docs/history/gmt/05_Data_and_Export.md:1-177`; treat that file as the broader reference and
this one as the current-code API capture for the four-file slice.

Cross-link: `docs/history/gmt/05_Data_and_Export.md:1-177`.
