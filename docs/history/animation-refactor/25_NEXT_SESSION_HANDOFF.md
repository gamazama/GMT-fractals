...
**Minimal (push first):**
> *"Read `docs/history/animation-refactor/25_NEXT_SESSION_HANDOFF.md` and execute the immediate next move."*

**With a phase to start after the push:**
> *"Read `docs/history/animation-refactor/25_NEXT_SESSION_HANDOFF.md`. Push first, then draft `19_OFFLINE_MODULATION_BAKE_PROMPT.md` per the architecture in `03_SPEC.md` §3.6 and `02_RATIONALE.md` §9."*

**For continued canvas-pattern work (e.g. HiDPI):**
> *"Read `docs/history/animation-refactor/25_NEXT_SESSION_HANDOFF.md` then `11_CANVAS_GRAPH_REPORT.md` + `16_CANVAS_DOPESHEET_REPORT.md`. Draft a HiDPI/DPR pass prompt that touches both canvas editors and the soft-mask cache."*
...
- The full `docs/history/animation-refactor/` documentation set (24 docs).
