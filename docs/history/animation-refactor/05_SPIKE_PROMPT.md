...
1. **`docs/history/animation-refactor/01_AUDIT.md`** — the 30-entry-point inventory + the diagnosis. Sections 1, 2, 9 are load-bearing.
2. **`docs/history/animation-refactor/02_RATIONALE.md`** — the original refactor proposal, with self-pushback section. Sets the stakes.
3. **`docs/history/animation-refactor/03_SPEC.md`** — the v2 module API spec the refactor will implement. Phase 0 begins after the spike validates the diagnosis.
...
Write `docs/history/animation-refactor/06_SPIKE_FINDINGS.md` with:
...
- [ ] `docs/history/animation-refactor/06_SPIKE_FINDINGS.md` exists on `main`, committed.
...
- [ ] One-line summary in conversation: "Diagnosis [confirmed/partial/invalidated]; see docs/history/animation-refactor/06_SPIKE_FINDINGS.md."
