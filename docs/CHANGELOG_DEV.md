...
**Implementation**
- Plan: `docs/history/plans-archive/area-lights.md`. Live status: `HANDOFF.md`. Architecture notes: `docs/history/gmt/02_Rendering_Internals.md` § Sphere Area Lights & MIS.
...
- Plan: `docs/history/plans-archive/mobile-mode-app-gmt.md`. Reference doc: `docs/history/engine/17_Mobile_Layout.md` (covers detection, preference, layout primitives, mobile-menu architecture, sibling-app adoption checklist, known limitations).
