...
`)}if(e!=="ifs")return`if (r > 2.0) { ${s} }
    ...
    if (r > 2.0) { ${to(0)} }
    return -1.0;`:`return (r - 1.0) / safeDr - ${o};`}function St(){const{scalars:e,vec2s:t,vec3s:o,vec4s:n}=et;return`
...
`}function wt(e){const t=e.definition;let o="";t.shader.preamble&&(o=Ko(t.shader.preamble,t.id,t.shader.preambleVars));const n=en(t.shader.function,t.id,t.shader.preambleVars);let s="";return t.shader.loopInit&&(s=yo(t.shader.loopInit,t.id,t.shader.preambleVars)),{preamble:o,func:n,loopInit:s}}function Ct(e,t,o){let n="",s="";if(o){const a=tn(o.definition.shader.loopBody,o.definition.id);let r="";o.definition.shader.loopInit&&(r=yo(o.definition.shader.loopInit,o.definition.id,o.definition.shader.preambleVars));const l=!!o.definition.shader.usesSharedRotation;({preLoop:n,inLoop:s}=on(a,r,l))}const i=o?`if (!skipMainFormula) { ${e.shader.loopBody} }`:e.shader.loopBody;return`  vec4 z = vec4(pos, 0.0);
...
}`}function vn(e){const t=e.definition,o=Po(e),n=e.interlace,s=n?wt(n):null,i=Ao(t),a=Io(o,!!t.shader.getDist,"uVoxelSize * 0.5",e.estimator);return`#version 300 es
precision highp float;
...
}`}function xn(e){const t=e.definition,o=Po(e),n=e.interlace,s=n?wt(n):null,i=Ao(t),a=o==="ifs"?"0.0":"0.001",r=Io(o,!!t.shader.getDist,a,e.estimator);return`#version 300 es
...
`);this.integrators.push(Tn(y))}const r=this.integrators.join(`
...
`)),p=no(this.renderMode),T=Fn(this.postProcessLogic.join(`
`)),h=[["Defines",t],["Uniforms",o],["Headers",n],["Math",l],["BlueNoise",ut],["Coloring",ct],["Preambles",s],["Formulas",i],["DE",m],["PostDE",a],["MatEval",v],["MissHandler",d],["Ray",p],["Trace",x],["TraceLean",g],["Integrators",r],["Post",T],["Main",M]];return h.filter(([,y])=>y.length>0).map(([y,w])=>`${y}: ${(w.length/1024).toFixed(1)}kb`).join(" | "),h.reduce((y,[,w])=>y+w.length,0),`
${t}
${o}
${n}
${l}
