const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./HelpBrowser-BZA9lRZd.js","./three-fiber-GKfjny8F.js","./three-DQWx7qFd.js","./PwaUpdate-BFxGZJX7.js","./three-drei-BSHBGk0S.js","./SceneFormat-44ZdMSMs.js","./pako-DwGzBETv.js"])))=>i.map(i=>d[i]);
import{u as C,f as _,g as re,s as L,c as z,S as ie,a as A,b as W,d as $,V as le,e as ce,i as de}from"./SceneFormat-44ZdMSMs.js";import{r as l,j as n,C as me,R as B}from"./three-fiber-GKfjny8F.js";import{_ as ue,r as pe,c as fe}from"./three-drei-BSHBGk0S.js";import{P as he,u as ge,M as xe}from"./useAppStartup-CPe0n_it.js";import{A as ve,H as ye,a as be,h as Se,i as we,b as Re,c as Me,s as De}from"./index-7Hhl3eUy.js";import{u as Z,p as Ce,S as Ee,E as Fe,D as Oe,a as ke,P as Te,T as je,b as U,G as Ie,c as He,d as Pe,r as Ae,i as Ne,e as _e,f as ze,g as Be,h as Le}from"./PwaUpdate-BFxGZJX7.js";import{C as We,F as $e}from"./CompositionOverlay-B3GQvnRw.js";import{C as Ue}from"./CompilingIndicator-DuClsL4w.js";import{u as Ve}from"./useGlobalContextMenu-BHrVSWb_.js";import{R as Ye}from"./RenderLoop-BjmPGCER.js";import{u as Ge}from"./typedSlices-DRjIW6js.js";import{M as qe,a as Xe,c as Ze,i as Ke}from"./index-AvnZA4JD.js";import"./three-DQWx7qFd.js";import"./pako-DwGzBETv.js";import"./AudioAnalysisEngine-DyaB3DyZ.js";import"./ModulationEngine-2YEp_bBL.js";import"./renderPopupRegistry-DFd-6fyz.js";const Je=e=>e,Qe=e=>`set${e.charAt(0).toUpperCase()}${e.slice(1)}`,N=(e,t)=>{const r=C.getState()[Qe(e.id)];typeof r=="function"&&r(t)},P=Je({id:"demo",name:"Demo",category:"Engine",tabConfig:{label:"Demo"},viewportConfig:{componentId:"overlay-demo",type:"dom"},params:{color:{type:"color",default:"#22d3ee",label:"Color",group:"Base"},position:{type:"vec2",default:{x:0,y:0},label:"Position",min:-1,max:1,step:.01,group:"Base"},size:{type:"float",default:120,label:"Size",min:20,max:400,step:1,group:"Base"},opacity:{type:"float",default:.9,label:"Opacity",min:0,max:1,step:.01,group:"Base"},count:{type:"int",default:8,label:"Duplicates",min:1,max:48,step:1,group:"Iteration"},iterOffset:{type:"vec2",default:{x:.04,y:.04},label:"Offset / step",min:-.5,max:.5,step:.005,group:"Iteration"},iterRotation:{type:"float",default:8,label:"Rotation / step (°)",min:-90,max:90,step:.5,group:"Iteration"},iterScale:{type:"float",default:.94,label:"Scale / step",min:.5,max:1.2,step:.005,group:"Iteration"},iterHueShift:{type:"float",default:18,label:"Hue shift / step (°)",min:-180,max:180,step:1,group:"Iteration"}}});_.register(P);const et=({isReady:e,onFinished:t,bootEngine:a,isStartupReady:r})=>{const[s,o]=l.useState(1),[i,c]=l.useState(!0),d=l.useRef(!1);return l.useEffect(()=>{r&&!d.current&&(d.current=!0,a())},[r,a]),l.useEffect(()=>{if(!e)return;const m=setTimeout(()=>o(0),100),u=setTimeout(()=>{c(!1),t()},600);return()=>{clearTimeout(m),clearTimeout(u)}},[e,t]),i?n.jsx("div",{className:"fixed inset-0 z-[100] bg-black flex flex-col items-center justify-center transition-opacity duration-500",style:{opacity:s},children:n.jsx("div",{className:"text-white text-sm font-mono tracking-widest opacity-60",children:r?"Booting…":"Loading…"})}):null},tt=re(),V=({onUpdate:e,onLoadingChange:t,autoUpdate:a,trigger:r,source:s})=>{const o=l.useRef(r);return l.useEffect(()=>{let i=0,c=0;const d=()=>{const m=r!==o.current;m&&(o.current=r),c++,(a&&c%60===0||m)&&(t==null||t(!0),tt.requestHistogramReadback(s).then(v=>{v.length>0&&e(v),t==null||t(!1)})),i=requestAnimationFrame(d)};return d(),()=>cancelAnimationFrame(i)},[a,r,s,e,t]),null},Y=12,nt=40,ot=()=>{const e=_.getViewportOverlays().filter(r=>r.type==="dom"),t=C(),a=C();return n.jsx("div",{className:"absolute inset-0 pointer-events-none z-[20]",children:e.map(r=>{const s=z.get(r.componentId),o=r.id,i=t[o];return s&&i?n.jsx(s,{featureId:o,sliceState:i,actions:a},r.id):null})})},st=()=>{const e=_.getViewportOverlays().filter(r=>!r.type||r.type==="scene"),t=C(),a=C();return n.jsx(n.Fragment,{children:e.map(r=>{const s=z.get(r.componentId),o=r.id,i=t[o];return s&&i?n.jsx(s,{featureId:o,sliceState:i,actions:a},r.id):null})})},at=({onSceneReady:e})=>{const t=C(),a=l.useRef(null),r=l.useRef(null),s=l.useRef(!1);Z();const[o,i]=l.useState({w:0,h:0});l.useLayoutEffect(()=>{if(!r.current)return;const p=(O,b)=>{const M=window.devicePixelRatio||1,D=C.getState();D.isBucketRendering||D.setCanvasPixelSize(Math.floor(O*M),Math.floor(b*M))},k=new ResizeObserver(O=>{for(const b of O){const M=Math.max(1,b.contentRect.width),D=Math.max(1,b.contentRect.height);i({w:M,h:D}),p(M,D)}});k.observe(r.current);const f=r.current.getBoundingClientRect();return f.width>0&&f.height>0&&(i({w:f.width,h:f.height}),p(f.width,f.height)),s.current||(s.current=!0,e()),()=>k.disconnect()},[]);const c=t.resolutionMode==="Fixed",[d,m]=t.fixedResolution,u=t.isBroadcastMode,v=40,w=Math.max(1,o.w-v),R=Math.max(1,o.h-v);let y=1;c&&(y=Math.min(1,w/d,R/m));const E=c?{width:d,height:m,transform:`scale(${y})`,transformOrigin:"center center",boxShadow:"0 0 50px rgba(0,0,0,0.5)",border:"1px solid rgba(255,255,255,0.1)",flexShrink:0}:{width:"100%",height:"100%"},h=c?d*y:o.w,g=c?m*y:o.h,x=(o.h-g)/2,S=(o.w-h)/2,F=Math.max(Y,x-nt),j=Math.max(Y,S);return n.jsxs("div",{ref:r,className:"relative flex-1 flex items-center justify-center overflow-hidden bg-[#050505] touch-none",style:{backgroundImage:c?"radial-gradient(circle at center, #111 0%, #050505 100%)":"none"},onContextMenu:p=>{p.preventDefault(),p.stopPropagation()},onMouseEnter:()=>L(!0),onMouseLeave:()=>L(!1),children:[c&&n.jsx("div",{className:"absolute inset-0 opacity-20 pointer-events-none",style:{backgroundImage:"linear-gradient(#333 1px, transparent 1px), linear-gradient(90deg, #333 1px, transparent 1px)",backgroundSize:"40px 40px"}}),!u&&n.jsx(Ue,{}),!u&&n.jsx(he,{}),!u&&n.jsx(ve,{}),n.jsxs("div",{ref:a,style:E,className:"relative bg-[#111] group z-0",children:[n.jsx(me,{gl:{alpha:!0,depth:!1,antialias:!1,powerPreference:"high-performance",preserveDrawingBuffer:!1},camera:{position:[0,0,0],fov:60},style:{position:"absolute",inset:0,pointerEvents:"auto"},dpr:t.dpr,onPointerDown:p=>p.target.setPointerCapture(p.pointerId),children:n.jsx(st,{})}),n.jsx(ot,{}),!u&&n.jsx(We,{width:c?d:o.w,height:c?m:o.h}),!u&&t.histogramActiveCount>0&&n.jsx(V,{onUpdate:p=>t.setHistogramData(p),onLoadingChange:p=>t.setHistogramLoading(p),autoUpdate:t.histogramAutoUpdate,trigger:t.histogramTrigger,source:"geometry"}),!u&&t.sceneHistogramActiveCount>0&&n.jsx(V,{onUpdate:p=>t.setSceneHistogramData(p),autoUpdate:!0,trigger:t.sceneHistogramTrigger,source:"color"})]}),c&&!u&&n.jsx($e,{width:d,height:m,top:F,left:j,maxAvailableWidth:o.w,maxAvailableHeight:o.h,onSetResolution:t.setFixedResolution,onSetMode:t.setResolutionMode})]})},rt=B.lazy(()=>ue(()=>import("./HelpBrowser-BZA9lRZd.js"),__vite__mapDeps([0,1,2,3,4,5,6]),import.meta.url)),it=()=>{const e=C(),[t,a]=l.useState(!1),[r,s]=l.useState(!0),o=l.useRef(null),i=l.useRef(null),c=l.useRef(null),d=l.useRef(null),m=l.useRef(null),u=l.useRef(null),v=l.useMemo(()=>({container:i,speed:c,dist:d,reset:m,reticle:u}),[]),{startupMode:w,bootEngine:R,isStartupReady:y}=ge(),{isMobile:E,isPortrait:h}=Z();Ve(),l.useEffect(()=>{Ce()},[]);const g=E,x=e.isBroadcastMode,S=e.interactionMode!=="none",F=()=>{s(!1)},j=g&&!x?"min-h-[120vh] bg-black":"fixed inset-0 w-full h-full bg-black select-none overflow-hidden flex flex-col",p=Object.values(e.panels).filter(f=>f.location==="float"&&f.isOpen),k=l.useMemo(()=>({handleInteractionStart:e.handleInteractionStart,handleInteractionEnd:e.handleInteractionEnd,openContextMenu:e.openContextMenu}),[e.handleInteractionStart,e.handleInteractionEnd,e.openContextMenu]);return n.jsx(Ee,{value:k,children:n.jsxs("div",{className:j,children:[n.jsx(Fe,{}),n.jsx(Ye,{}),n.jsx(Oe,{}),p.map(f=>n.jsx(ke,{id:f.id,title:f.id,children:n.jsx(Te,{activeTab:f.id,state:e,actions:e,onSwitchTab:O=>e.togglePanel(O,!0)})},f.id)),n.jsxs("div",{ref:o,className:`relative bg-black select-none ${S?"cursor-crosshair":""} flex flex-col ${g&&!x?"h-[100vh] sticky top-0 overflow-hidden shadow-2xl":"w-full h-full"}`,onContextMenu:f=>f.preventDefault(),children:[n.jsx(et,{isReady:t,onFinished:F,startupMode:w,bootEngine:R,isStartupReady:y}),g&&h&&!r&&!x&&n.jsxs("div",{className:"fixed inset-0 z-[9999] bg-black flex flex-col items-center justify-center p-10 text-center text-white",children:[n.jsx("div",{className:"text-cyan-400 mb-6 animate-bounce",children:n.jsx(ie,{})}),n.jsx("h2",{className:"text-2xl font-bold tracking-tight mb-2",children:"Landscape Recommended"}),n.jsx("p",{className:"text-gray-500 text-sm font-mono",children:"Rotate device to access controls."})]}),n.jsx(je,{}),n.jsxs("div",{className:"flex-1 flex overflow-hidden relative",children:[!x&&!g&&n.jsx(U,{side:"left"}),n.jsx(at,{hudRefs:v,onSceneReady:()=>a(!0),activeHint:null,onDismissHint:()=>{}}),n.jsx(ye,{}),!x&&n.jsx(U,{side:"right"})]}),n.jsx(be,{}),!x&&n.jsx(xe,{}),e.contextMenu.visible&&!x&&n.jsx(Ie,{x:e.contextMenu.x,y:e.contextMenu.y,items:e.contextMenu.items,targetHelpIds:e.contextMenu.targetHelpIds,onClose:e.closeContextMenu,onOpenHelp:e.openHelp}),e.helpWindow.visible&&n.jsx(l.Suspense,{fallback:null,children:n.jsx(rt,{activeTopicId:e.helpWindow.activeTopicId,onClose:e.closeHelp,onNavigate:e.openHelp})}),n.jsx(He,{hidden:x})]})]})})};let K=null;const G=e=>{K=e},J=()=>K,Q=`// ─────────────────────────────────────────────────────────────────────────────
