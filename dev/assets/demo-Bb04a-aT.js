const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./HelpBrowser-BbMX428G.js","./three-fiber-GKfjny8F.js","./three-DQWx7qFd.js","./Undo-BA-SV5wv.js","./three-drei-D6d-dyvY.js","./CollapsibleSection-BjKaktlT.js","./pako-DwGzBETv.js"])))=>i.map(i=>d[i]);
import{u as w,f as W,g as te,a as z,b as fe,A as he,C as ge,c as Y,L as xe,d as ve,s as G,S as ye,e as X,V as be}from"./CollapsibleSection-BjKaktlT.js";import{r as i,j as t,C as Se,R as $}from"./three-fiber-GKfjny8F.js";import{_ as we,r as Re,c as Me}from"./three-drei-D6d-dyvY.js";import{u as Ce,M as De}from"./useAppStartup-B2IA4jSB.js";import{A as je,R as Ee,H as Fe,a as ke,h as Oe,M as Ie,b as Te,c as He,i as Pe,d as Ae,e as Ne,f as Le,s as _e}from"./index-BExYvI8z.js";import{c as ne,u as oe,C as ze,F as Be,a as U,p as We,S as $e,E as Ue,D as Ve,b as Ye,P as Ge,T as Xe,d as q,G as qe,e as Ze,f as Qe,s as _,g as Ke,r as Je,i as et,h as tt,j as nt,k as ot,l as st}from"./Undo-BA-SV5wv.js";import{C as at}from"./CompilingIndicator-Bavo62Lh.js";import{u as rt}from"./typedSlices-_euHah-n.js";import"./three-DQWx7qFd.js";import"./pako-DwGzBETv.js";import"./ModulationEngine-CQR5djvq.js";import"./renderPopupRegistry-DFd-6fyz.js";const it=e=>e,lt=e=>`set${e.charAt(0).toUpperCase()}${e.slice(1)}`,B=(e,n)=>{const r=w.getState()[lt(e.id)];typeof r=="function"&&r(n)},L=it({id:"demo",name:"Demo",category:"Engine",tabConfig:{label:"Demo"},viewportConfig:{componentId:"overlay-demo",type:"dom"},params:{color:{type:"color",default:"#22d3ee",label:"Color",group:"Base"},position:{type:"vec2",default:{x:0,y:0},label:"Position",min:-1,max:1,step:.01,group:"Base"},size:{type:"float",default:120,label:"Size",min:20,max:400,step:1,group:"Base"},opacity:{type:"float",default:.9,label:"Opacity",min:0,max:1,step:.01,group:"Base"},count:{type:"int",default:8,label:"Duplicates",min:1,max:48,step:1,group:"Iteration"},iterOffset:{type:"vec2",default:{x:.04,y:.04},label:"Offset / step",min:-.5,max:.5,step:.005,group:"Iteration"},iterRotation:{type:"float",default:8,label:"Rotation / step (°)",min:-90,max:90,step:.5,group:"Iteration"},iterScale:{type:"float",default:.94,label:"Scale / step",min:.5,max:1.2,step:.005,group:"Iteration"},iterHueShift:{type:"float",default:18,label:"Hue shift / step (°)",min:-180,max:180,step:1,group:"Iteration"}}});W.register(L);const ct=({isReady:e,onFinished:n,bootEngine:s,isHydrated:r})=>{const[a,o]=i.useState(1),[l,c]=i.useState(!0),d=i.useRef(!1);return i.useEffect(()=>{r&&!d.current&&(d.current=!0,s())},[r,s]),i.useEffect(()=>{if(!e)return;const m=setTimeout(()=>o(0),100),p=setTimeout(()=>{c(!1),n()},600);return()=>{clearTimeout(m),clearTimeout(p)}},[e,n]),l?t.jsx("div",{className:"fixed inset-0 z-[100] bg-black flex flex-col items-center justify-center transition-opacity duration-500",style:{opacity:a},children:t.jsx("div",{className:"text-white text-sm font-mono tracking-widest opacity-60",children:r?"Booting…":"Loading…"})}):null},dt=te(),Z=({onUpdate:e,onLoadingChange:n,autoUpdate:s,trigger:r,source:a})=>{const o=i.useRef(r);return i.useEffect(()=>{let l=0,c=0;const d=()=>{const m=r!==o.current;m&&(o.current=r),c++,(s&&c%60===0||m)&&(n==null||n(!0),dt.requestHistogramReadback(a).then(y=>{y.length>0&&e(y),n==null||n(!1)})),l=requestAnimationFrame(d)};return d(),()=>cancelAnimationFrame(l)},[s,r,a,e,n]),null},mt=te(),ut=/Firefox/i.test(navigator.userAgent);performance.now();const pt=()=>{const e=i.useRef(0);i.useRef(performance.now()),i.useRef(0);const{resolutionMode:n,setResolutionMode:s,setFixedResolution:r,fixedResolution:a,isExporting:o,isBroadcastMode:l,openContextMenu:c,aaLevel:d,setAALevel:m,renderMode:p,dpr:y}=w(),M=w.getState().quality,C=w(S=>S.isPaused),b=z(S=>S.isScrubbing),[F,f]=i.useState(!1),[x,v]=i.useState(60);i.useEffect(()=>(performance.now(),mt.frameCount,()=>{}),[C,b,o,l,p]);const R=S=>{const H=ne(S.currentTarget);H.length>0&&(S.preventDefault(),S.stopPropagation(),c(S.clientX,S.clientY,[],H))};if(l||!F)return null;const[j,I]=fe(w.getState()),h=j>480,O=()=>{const S=Math.max(320,Math.round(j*.66/8)*8),H=Math.max(240,Math.round(I*.66/8)*8);s("Fixed"),r(S,H),N()},g=d>1,k=()=>{m(1),N()},u=M,D=!((u==null?void 0:u.precisionMode)===1),T=()=>{const S=w.getState().setQuality,H=w.getState().setLighting;S&&S({precisionMode:1,bufferPrecision:1}),H&&H({shadows:!1}),N()},ue=!(u==null?void 0:u.dynamicScaling),pe=()=>{const S=w.getState().setQuality;S&&S({dynamicScaling:!0,adaptiveTarget:30}),N()},N=()=>{f(!1),e.current=-10};return t.jsx("div",{className:"absolute top-2 right-4 z-[50] pointer-events-auto animate-fade-in-left origin-top-right max-w-[200px]","data-help-id":"ui.performance",onContextMenu:R,children:t.jsxs("div",{className:"flex flex-col gap-1 bg-red-950/90 border border-red-500/30 rounded-lg shadow-xl backdrop-blur-md p-2",children:[t.jsxs("div",{className:"flex items-center justify-between mb-1",children:[t.jsxs("div",{className:"flex items-center gap-2 text-red-200 text-[10px] font-bold",children:[t.jsx(he,{}),t.jsxs("span",{children:["Low FPS (",x.toFixed(1),")"]})]}),t.jsx("button",{onClick:()=>{f(!1),e.current=-40},className:"text-red-400 hover:text-white transition-colors p-0.5",title:"Dismiss",children:t.jsx(ge,{})})]}),ut&&t.jsx("p",{className:"text-red-300/70 text-[8px] leading-tight mb-0.5",children:"Firefox has a known rendering overhead with OffscreenCanvas that reduces frame rate."}),t.jsxs("div",{className:"flex flex-col gap-1",children:[ue&&t.jsxs("button",{onClick:pe,className:"flex items-center justify-between bg-black/40 hover:bg-white/10 text-gray-300 text-[9px] px-2 py-1.5 rounded transition-colors border border-white/5",children:[t.jsxs("span",{className:"flex items-center gap-1.5",children:[t.jsx(Y,{})," Adaptive Resolution"]}),t.jsx("span",{className:"text-cyan-400 font-bold",children:"Fix"})]}),g&&t.jsxs("button",{onClick:k,className:"flex items-center justify-between bg-black/40 hover:bg-white/10 text-gray-300 text-[9px] px-2 py-1.5 rounded transition-colors border border-white/5",children:[t.jsxs("span",{className:"flex items-center gap-1.5",children:[t.jsx(xe,{})," Reset Scale (1x)"]}),t.jsx("span",{className:"text-cyan-400 font-bold",children:"Fix"})]}),D&&t.jsxs("button",{onClick:T,className:"flex items-center justify-between bg-black/40 hover:bg-white/10 text-gray-300 text-[9px] px-2 py-1.5 rounded transition-colors border border-white/5",children:[t.jsxs("span",{className:"flex items-center gap-1.5",children:[t.jsx(ve,{})," Enable Lite Mode"]}),t.jsx("span",{className:"text-cyan-400 font-bold",children:"Fix"})]}),h&&t.jsxs("button",{onClick:O,className:"flex items-center justify-between bg-black/40 hover:bg-white/10 text-gray-300 text-[9px] px-2 py-1.5 rounded transition-colors border border-white/5",children:[t.jsxs("span",{className:"flex items-center gap-1.5",children:[t.jsx(Y,{})," Reduce Resolution"]}),t.jsx("span",{className:"text-cyan-400 font-bold",children:"-33%"})]})]})]})})},Q=12,ft=40,ht=()=>{const e=W.getViewportOverlays().filter(r=>r.type==="dom"),n=w(),s=w();return t.jsx("div",{className:"absolute inset-0 pointer-events-none z-[20]",children:e.map(r=>{const a=U.get(r.componentId),o=r.id,l=n[o];return a&&l?t.jsx(a,{featureId:o,sliceState:l,actions:s},r.id):null})})},gt=()=>{const e=W.getViewportOverlays().filter(r=>!r.type||r.type==="scene"),n=w(),s=w();return t.jsx(t.Fragment,{children:e.map(r=>{const a=U.get(r.componentId),o=r.id,l=n[o];return a&&l?t.jsx(a,{featureId:o,sliceState:l,actions:s},r.id):null})})},xt=({onSceneReady:e})=>{const n=w(),s=i.useRef(null),r=i.useRef(null),a=i.useRef(!1);oe();const[o,l]=i.useState({w:0,h:0});i.useLayoutEffect(()=>{if(!r.current)return;const h=(k,u)=>{const E=window.devicePixelRatio||1,D=w.getState();D.isBucketRendering||D.setCanvasPixelSize(Math.floor(k*E),Math.floor(u*E))},O=new ResizeObserver(k=>{for(const u of k){const E=Math.max(1,u.contentRect.width),D=Math.max(1,u.contentRect.height);l({w:E,h:D}),h(E,D)}});O.observe(r.current);const g=r.current.getBoundingClientRect();return g.width>0&&g.height>0&&(l({w:g.width,h:g.height}),h(g.width,g.height)),a.current||(a.current=!0,e()),()=>O.disconnect()},[]);const c=n.resolutionMode==="Fixed",[d,m]=n.fixedResolution,p=n.isBroadcastMode,y=40,M=Math.max(1,o.w-y),C=Math.max(1,o.h-y);let b=1;c&&(b=Math.min(1,M/d,C/m));const F=c?{width:d,height:m,transform:`scale(${b})`,transformOrigin:"center center",boxShadow:"0 0 50px rgba(0,0,0,0.5)",border:"1px solid rgba(255,255,255,0.1)",flexShrink:0}:{width:"100%",height:"100%"},f=c?d*b:o.w,x=c?m*b:o.h,v=(o.h-x)/2,R=(o.w-f)/2,j=Math.max(Q,v-ft),I=Math.max(Q,R);return t.jsxs("div",{ref:r,className:"relative flex-1 flex items-center justify-center overflow-hidden bg-[#050505] touch-none",style:{backgroundImage:c?"radial-gradient(circle at center, #111 0%, #050505 100%)":"none"},onContextMenu:h=>{h.preventDefault(),h.stopPropagation()},onMouseEnter:()=>G(!0),onMouseLeave:()=>G(!1),children:[c&&t.jsx("div",{className:"absolute inset-0 opacity-20 pointer-events-none",style:{backgroundImage:"linear-gradient(#333 1px, transparent 1px), linear-gradient(90deg, #333 1px, transparent 1px)",backgroundSize:"40px 40px"}}),!p&&t.jsx(at,{}),!p&&t.jsx(pt,{}),!p&&t.jsx(je,{}),t.jsxs("div",{ref:s,style:F,className:"relative bg-[#111] group z-0",children:[t.jsx(Se,{gl:{alpha:!0,depth:!1,antialias:!1,powerPreference:"high-performance",preserveDrawingBuffer:!1},camera:{position:[0,0,0],fov:60},style:{position:"absolute",inset:0,pointerEvents:"auto"},dpr:n.dpr,onPointerDown:h=>h.target.setPointerCapture(h.pointerId),children:t.jsx(gt,{})}),t.jsx(ht,{}),!p&&t.jsx(ze,{width:c?d:o.w,height:c?m:o.h}),!p&&n.histogramActiveCount>0&&t.jsx(Z,{onUpdate:h=>n.setHistogramData(h),onLoadingChange:h=>n.setHistogramLoading(h),autoUpdate:n.histogramAutoUpdate,trigger:n.histogramTrigger,source:"geometry"}),!p&&n.sceneHistogramActiveCount>0&&t.jsx(Z,{onUpdate:h=>n.setSceneHistogramData(h),autoUpdate:!0,trigger:n.sceneHistogramTrigger,source:"color"})]}),c&&!p&&t.jsx(Be,{width:d,height:m,top:j,left:I,maxAvailableWidth:o.w,maxAvailableHeight:o.h,onSetResolution:n.setFixedResolution,onSetMode:n.setResolutionMode})]})},vt=()=>{const e=w(n=>n.openContextMenu);i.useEffect(()=>{const n=s=>{if(s.defaultPrevented)return;const r=ne(s.target);r.length>0&&(s.preventDefault(),e(s.clientX,s.clientY,[],r))};return window.addEventListener("contextmenu",n),()=>window.removeEventListener("contextmenu",n)},[e])},yt=$.lazy(()=>we(()=>import("./HelpBrowser-BbMX428G.js"),__vite__mapDeps([0,1,2,3,4,5,6]),import.meta.url)),bt=()=>{const e=w(),[n,s]=i.useState(!1),[r,a]=i.useState(!0),o=i.useRef(null),l=i.useRef(null),c=i.useRef(null),d=i.useRef(null),m=i.useRef(null),p=i.useRef(null),y=i.useMemo(()=>({container:l,speed:c,dist:d,reset:m,reticle:p}),[]),{startupMode:M,bootEngine:C,isHydrated:b}=Ce(),{isMobile:F,isPortrait:f}=oe();vt(),i.useEffect(()=>{We()},[]);const x=F,v=e.isBroadcastMode,R=e.interactionMode!=="none",j=()=>{a(!1)},I=x&&!v?"min-h-[120vh] bg-black":"fixed inset-0 w-full h-full bg-black select-none overflow-hidden flex flex-col",h=Object.values(e.panels).filter(g=>g.location==="float"&&g.isOpen),O=i.useMemo(()=>({handleInteractionStart:e.handleInteractionStart,handleInteractionEnd:e.handleInteractionEnd,openContextMenu:e.openContextMenu}),[e.handleInteractionStart,e.handleInteractionEnd,e.openContextMenu]);return t.jsx($e,{value:O,children:t.jsxs("div",{className:I,children:[t.jsx(Ue,{}),t.jsx(Ee,{}),t.jsx(Ve,{}),h.map(g=>t.jsx(Ye,{id:g.id,title:g.id,children:t.jsx(Ge,{activeTab:g.id,state:e,actions:e,onSwitchTab:k=>e.togglePanel(k,!0)})},g.id)),t.jsxs("div",{ref:o,className:`relative bg-black select-none ${R?"cursor-crosshair":""} flex flex-col ${x&&!v?"h-[100vh] sticky top-0 overflow-hidden shadow-2xl":"w-full h-full"}`,onContextMenu:g=>g.preventDefault(),children:[t.jsx(ct,{isReady:n,onFinished:j,startupMode:M,bootEngine:C,isHydrated:b}),x&&f&&!r&&!v&&t.jsxs("div",{className:"fixed inset-0 z-[9999] bg-black flex flex-col items-center justify-center p-10 text-center text-white",children:[t.jsx("div",{className:"text-cyan-400 mb-6 animate-bounce",children:t.jsx(ye,{})}),t.jsx("h2",{className:"text-2xl font-bold tracking-tight mb-2",children:"Landscape Recommended"}),t.jsx("p",{className:"text-gray-500 text-sm font-mono",children:"Rotate device to access controls."})]}),t.jsx(Xe,{}),t.jsxs("div",{className:"flex-1 flex overflow-hidden relative",children:[!v&&!x&&t.jsx(q,{side:"left"}),t.jsx(xt,{hudRefs:y,onSceneReady:()=>s(!0),activeHint:null,onDismissHint:()=>{}}),t.jsx(Fe,{}),!v&&t.jsx(q,{side:"right"})]}),t.jsx(ke,{}),!v&&t.jsx(De,{}),e.contextMenu.visible&&!v&&t.jsx(qe,{x:e.contextMenu.x,y:e.contextMenu.y,items:e.contextMenu.items,targetHelpIds:e.contextMenu.targetHelpIds,onClose:e.closeContextMenu,onOpenHelp:e.openHelp}),e.helpWindow.visible&&t.jsx(i.Suspense,{fallback:null,children:t.jsx(yt,{activeTopicId:e.helpWindow.activeTopicId,onClose:e.closeHelp,onNavigate:e.openHelp})}),t.jsx(Ze,{hidden:v})]})]})})};let se=null;const K=e=>{se=e},ae=()=>se,re=`// Side-effect import — registers DemoFeature with the engine BEFORE
...
`,St=`import { defineFeature, type FeatureState } from '../engine/features/setFeature';
...
`,wt=`import { featureRegistry } from '../engine/FeatureSystem';
...
`,Rt=`import { useEngineStore } from '../store/engineStore';
...
`,Mt=`// Module-level handle so that SceneIO (installed at boot) can find
...
`,Ct=`import React, { useEffect, useRef } from 'react';
...
`,Dt=`// Demo's per-frame export pipeline. Plugged into the engine's render
