var ye=Object.defineProperty;var be=(e,t,a)=>t in e?ye(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var O=(e,t,a)=>be(e,typeof t!="symbol"?t+"":t,a);import{D,b2 as I,U as z,a2 as u,f as c,b3 as ve,b4 as xe,b5 as ze,b6 as Se,b7 as we,b8 as _e}from"./CollapsibleSection-koiYRr9u.js";import{n as w,d as G,p as Fe,q as Me,r as $,s as Z,c as h,l as V}from"./three-DQWx7qFd.js";const X=`
...
`,defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:2}},He={id:"decoupled",label:"Decoupled",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,rotMode:"post",extraParams:{hybridKaliConstant:{type:"vec3",default:new h(1,1,1),label:"Kali Constant",shortId:"hkc",uniform:"uHybridKaliConstant",min:-3,max:3,step:.01,group:"hybrid"}},defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.6,hybridFixedR:1,hybridIter:3,hybridKaliConstant:{x:.5,y:.5,z:.5}}},$e={id:"tetra",label:"Tetrahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,selfContained:!0,extraParams:{hybridMengerOffset:{type:"vec3",default:new h(1,1,1),label:"Offset",shortId:"hmo",uniform:"uHybridMengerOffset",min:0,max:2,step:.01,group:"hybrid",linkable:!0},hybridMengerCenterZ:{type:"boolean",default:!0,label:"Center Z",shortId:"hmz",uniform:"uHybridMengerCenterZ",group:"hybrid"}},defaults:{hybridScale:3,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3,hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0}},B=[Ne,Ge,je,He,qe,$e,Ze,Xe,Ue],Ye=B.map((e,t)=>({label:e.label,value:t}));function Qe(e){return B[e]??B[0]}const Ke=`
...
void initHybridTransform() {}
void formula_Hybrid(inout vec4 z, inout float dr, inout float trap, vec4 c) {}`);else{const g=(a==null?void 0:a.hybridFoldType)??0,m=Qe(g);e.addFunction(m.glsl);const b=(a==null?void 0:a.hybridPermute)??0,M=et(b);e.addFunction(tt(M,m.rotMode??"wrap",m.selfContained??!1))}let n="",l="";const f=t.formula,d=((y=S.get(f))==null?void 0:y.shader.selfContainedSDE)??!1,s=(a==null?void 0:a.burningEnabled)??!1;if(!d&&s&&(l+="z.xyz = abs(z.xyz);"),r&&!d)if(!(a&&a.hybridComplex))n+=`
                if (uHybrid > 0.5) {
                    initHybridTransform();
                ...
                `;else{const m=(a==null?void 0:a.hybridSwap)??!1;n+=`if (uHybrid > 0.5) { initHybridTransform(); }
`,l+=`
                if (uHybrid > 0.5) {
                ...
                `}e.addHybridFold("",n,l)}},Y=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF"],Q=["uVec2A","uVec2B","uVec2C"],K=["uVec3A","uVec3B","uVec3C"],W=["uVec4A","uVec4B","uVec4C"],ae=["uInterlaceParamA","uInterlaceParamB","uInterlaceParamC","uInterlaceParamD","uInterlaceParamE","uInterlaceParamF"],oe=["uInterlaceVec2A","uInterlaceVec2B","uInterlaceVec2C"],ie=["uInterlaceVec3A","uInterlaceVec3B","uInterlaceVec3C"],re=["uInterlaceVec4A","uInterlaceVec4B","uInterlaceVec4C"];function it(){const e=[];for(let t=0;t<Y.length;t++)e.push([new RegExp(`\\b${Y[t]}\\b`,"g"),ae[t]]);for(let t=0;t<Q.length;t++)e.push([new RegExp(`\\b${Q[t]}\\b`,"g"),oe[t]]);for(let t=0;t<K.length;t++)e.push([new RegExp(`\\b${K[t]}\\b`,"g"),ie[t]]);for(let t=0;t<W.length;t++)e.push([new RegExp(`\\b${W[t]}\\b`,"g"),re[t]]);return e}const rt=it();function j(e){let t=e;for(const[a,o]of rt)t=t.replace(a,o);return t}function k(e,t){const a=[...t].sort((i,r)=>r.length-i.length);let o=e;for(const i of a)o=o.replace(new RegExp(`\\b${i}\\b`,"g"),`interlace_${i}`);return o}function L(e){const t=[],a=/\b(?:void|vec[234]|float|int|mat[234]|bool)\s+(\w+)\s*\(/g,o=/^\s*(?:const\s+)?(?:vec[234]|float|int|mat[234]|bool)\s+([^;]+);/,i=/^\s*(\w+)/;let r=0;for(const n of e.split(`
`)){if(r===0){a.lastIndex=0;let l;for(;(l=a.exec(n))!==null;){const d=l[1];!d.startsWith("formula_")&&!t.includes(d)&&t.push(d)}const f=o.exec(n);if(f){const d=[];let s=0,y="";for(const g of f[1]){if(g==="(")s++;else if(g===")")s--;else if(g===","&&s===0){d.push(y),y="";continue}y+=g}y&&d.push(y);for(const g of d){const m=i.exec(g);m&&!t.includes(m[1])&&t.push(m[1])}}}for(const l of n)l==="{"?r++:l==="}"&&r--}return t}function nt(e,t,a){let o=e;o=o.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`);const i=L(e);for(const r of i)o=o.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return a&&a.length>0&&(o=k(o,a)),o=j(o),o}function lt(e,t,a,o){let i=e;if(i=i.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace"),i=j(i),a&&a.length>0&&(i=k(i,a)),o&&o.length>0)for(const r of o)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function st(e,t,a){let o=e.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace");return a&&a.length>0&&(o=k(o,a)),o}function dt(e,t,a,o){let i=e;if(i=i.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`),i=j(i),a&&a.length>0&&(i=k(i,a)),o&&o.length>0)for(const r of o)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function ct(e,t,a){let o="";t&&(o=`
...
`});p.register({id:"Custom",label:"Custom (Legacy)",category:"Utils",description:"Legacy node.",inputs:[],glsl:e=>""});const yt=e=>{const t=new Map;return e.forEach(a=>{t.has(a.target)||t.set(a.target,[]),t.get(a.target).push(a)}),t},bt=e=>{const t=new Set,a=["root-end"],o=new Set;for(;a.length>0;){const i=a.pop();o.has(i)||(o.add(i),i!=="root-end"&&i!=="root-start"&&t.add(i),(e.get(i)??[]).forEach(r=>a.push(r.source)))}return t},vt=(e,t)=>{const a=yt(t),o=bt(a),i=e.filter(s=>o.has(s.id));if(!i||i.length===0)return`
    ...
    `;const n=new Map;n.set("root-start","v_start");let l=0;i.forEach((s,y)=>{const m=`v_${s.id.replace(/[^a-zA-Z0-9]/g,"")}`;n.set(s.id,m);const b=a.get(s.id)??[],M=b.find(F=>!F.targetHandle||F.targetHandle==="a"),T=b.find(F=>F.targetHandle==="b"),E=M&&n.get(M.source)||"v_start",me=T&&n.get(T.source)||"v_start";if(r+=`    // Node: ${s.type} (${s.id})
`,r+=`    vec3 ${m}_p = ${E}_p;
`,r+=`    float ${m}_d = ${E}_d;
`,r+=`    float ${m}_dr = ${E}_dr;
`,s.enabled){const F=p.get(s.type);if(F){const H=s.condition&&s.condition.active;let q="    ";if(H){const A=l<I?`uModularParams[${l++}]`:"2.0",ge=l<I?`uModularParams[${l++}]`:"0.0";r+=`    { int ${m}_cmod = max(1, int(${A})); int ${m}_crem = int(${ge});
`,r+=`    if ( (i - (i/${m}_cmod)*${m}_cmod) == ${m}_crem ) {
`,q="        "}const he=A=>s.bindings&&s.bindings[A]?`u${s.bindings[A]}`:l<I?`uModularParams[${l++}]`:"0.0";r+=F.glsl({varName:m,in1:E,in2:me,getParam:he,indent:q}),H&&(r+=`    }}
`)}}r+=`
`});const f=t.find(s=>s.target==="root-end");let d="v_start";return f&&f.source!=="root-start"&&(d=n.get(f.source)||"v_start"),r+=`
    z.xyz = ${d}_p;
    dr = ${d}_dr;
...
`},xt=e=>{let t="d = 0.5 * log(max(r, 1.0e-5)) * r / dr_safe;";return e<.5?t=`
        float logR2 = log2(m2);
        // 0.5 * ln(2) / 2 ≈ 0.17328679 — converts log2(r²) to 0.5*r*ln(r) for DE formula
        d = 0.17328679 * logR2 * r / dr_safe;
        `:e<1.5?t="d = (r - 1.0) / dr_safe;":e<2.5?t="d = r / dr_safe;":e<3.5?t=`
        float logR2 = log2(m2);
        ...
        }`},zt={id:"coreMath",shortId:"cm",name:"Formula Math",category:"Formulas",tabConfig:{label:"Formula"},extraUniforms:[{name:z.ModularParams,type:"float",arraySize:I,default:new Float32Array(I),backingOnly:!0}],params:{iterations:{type:"float",default:16,label:"Iterations",shortId:"it",uniform:"uIterations",min:1,max:500,step:1,group:"main"},paramA:{type:"float",default:8,label:"Param A",shortId:"pa",uniform:"uParamA",min:-10,max:10,step:.001,group:"params"},paramB:{type:"float",default:0,label:"Param B",shortId:"pb",uniform:"uParamB",min:-10,max:10,step:.001,group:"params"},paramC:{type:"float",default:0,label:"Param C",shortId:"pc",uniform:"uParamC",min:-10,max:10,step:.001,group:"params"},paramD:{type:"float",default:0,label:"Param D",shortId:"pd",uniform:"uParamD",min:-10,max:10,step:.001,group:"params"},paramE:{type:"float",default:0,label:"Param E",shortId:"pe",uniform:"uParamE",min:-10,max:10,step:.001,group:"params"},paramF:{type:"float",default:0,label:"Param F",shortId:"pf",uniform:"uParamF",min:-10,max:10,step:.001,group:"params"},vec2A:{type:"vec2",default:{x:0,y:0},label:"Vec2 A",shortId:"v2a",uniform:"uVec2A",min:-10,max:10,step:.001,group:"params"},vec2B:{type:"vec2",default:{x:0,y:0},label:"Vec2 B",shortId:"v2b",uniform:"uVec2B",min:-10,max:10,step:.001,group:"params"},vec2C:{type:"vec2",default:{x:0,y:0},label:"Vec2 C",shortId:"v2c",uniform:"uVec2C",min:-10,max:10,step:.001,group:"params"},vec3A:{type:"vec3",default:new h(0,0,0),label:"Vec3 A",shortId:"v3a",uniform:"uVec3A",min:-10,max:10,step:.001,group:"params"},vec3B:{type:"vec3",default:new h(0,0,0),label:"Vec3 B",shortId:"v3b",uniform:"uVec3B",min:-10,max:10,step:.001,group:"params"},vec3C:{type:"vec3",default:new h(0,0,0),label:"Vec3 C",shortId:"v3c",uniform:"uVec3C",min:-10,max:10,step:.001,group:"params"},vec4A:{type:"vec4",default:new V(0,0,0,0),label:"Vec4 A",shortId:"v4a",uniform:"uVec4A",min:-10,max:10,step:.001,group:"params"},vec4B:{type:"vec4",default:new V(0,0,0,0),label:"Vec4 B",shortId:"v4b",uniform:"uVec4B",min:-10,max:10,step:.001,group:"params"},vec4C:{type:"vec4",default:new V(0,0,0,0),label:"Vec4 C",shortId:"v4c",uniform:"uVec4C",min:-10,max:10,step:.001,group:"params"}},inject:(e,t)=>{var s;const a=t.formula,o=t.quality;a==="Modular"&&(e.addDefine("PIPELINE_REV",(t.pipelineRevision||0).toString()),e.addUniform(z.ModularParams,"float",I));const i=S.get(a);i!=null&&i.shader.selfContainedSDE&&e.addDefine("SKIP_PRE_BAILOUT","1");let r="",n="",l="";const f=(o==null?void 0:o.estimator)||0;let d=xt(f);if(a==="Modular"){const y=vt(t.pipeline||[],((s=t.graph)==null?void 0:s.edges)||[]);r+=y+`
...
`,n=i.shader.loopBody,l=i.shader.loopInit||"",i.shader.preamble&&e.addPreamble(i.shader.preamble),i.shader.getDist&&(d=`vec2 getDist(float r, float dr, float iter, vec4 z) { ${i.shader.getDist} }`));e.addFunction(r),e.setFormula(n,l,d)}};let St=0;function C(){return`l${++St}`}const wt={id:"shadows",label:"Shadows",renderContext:"direct",controlledParams:["lighting.shadowsCompile","lighting.shadowAlgorithm","lighting.ptStochasticShadows"],tiers:[{label:"Off",overrides:{lighting:{shadows:!1,shadowsCompile:!1,ptStochasticShadows:!1}},estCompileMs:0},{label:"Hard",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:2,ptStochasticShadows:!1}},estCompileMs:500},{label:"Soft",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!1}},estCompileMs:3e3},{label:"Full",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!0}},estCompileMs:3800}]},_t={id:"reflections",label:"Reflections (Direct)",renderContext:"direct",controlledParams:["reflections.reflectionMode","reflections.bounceShadows","reflections.bounces"],tiers:[{label:"Off",overrides:{reflections:{reflectionMode:0,bounceShadows:!1}},estCompileMs:0},{label:"Env Map",overrides:{reflections:{reflectionMode:1,bounceShadows:!1}},estCompileMs:0},{label:"Raymarched",overrides:{reflections:{reflectionMode:3,bounceShadows:!1,bounces:1}},estCompileMs:7500},{label:"Full",overrides:{reflections:{reflectionMode:3,bounceShadows:!0,bounces:2}},estCompileMs:12e3}]},Ft={id:"lighting_quality",label:"Lighting",isAdvanced:!0,controlledParams:["lighting.specularModel","lighting.ptEnabled","lighting.ptNEEAllLights","lighting.ptEnvNEE"],tiers:[{label:"Preview",overrides:{lighting:{advancedLighting:!1,ptEnabled:!1}},estCompileMs:-2500},{label:"Path Traced",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!1,ptEnvNEE:!1}},estCompileMs:1900},{label:"PT + NEE",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!0,ptEnvNEE:!0}},estCompileMs:2500}]},Mt={id:"atmosphere_quality",label:"Atmosphere",controlledParams:["atmosphere.glowEnabled","atmosphere.glowQuality","volumetric.ptVolumetric"],tiers:[{label:"Off",overrides:{atmosphere:{glowEnabled:!1},volumetric:{ptVolumetric:!1}},estCompileMs:0},{label:"Fast Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:1},volumetric:{ptVolumetric:!1}},estCompileMs:200},{label:"Color Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!1}},estCompileMs:400},{label:"Volumetric",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!0}},estCompileMs:5900}]},se=[wt,_t,Ft,Mt],de=[{id:"preview",label:"Preview",description:"Instant preview shader — navigate without waiting for compile.",subsystems:{shadows:0,reflections:0,lighting_quality:0,atmosphere_quality:0}},{id:"fastest",label:"Fastest",description:"Path traced lighting with fast glow.",subsystems:{shadows:0,reflections:0,lighting_quality:1,atmosphere_quality:1}},{id:"lite",label:"Lite",description:"Hard shadows, env map reflections, color glow.",subsystems:{shadows:1,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"balanced",label:"Balanced",description:"Soft shadows, env map reflections, color glow.",subsystems:{shadows:2,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"full",label:"Full",description:"Full shadows, raymarched reflections, volumetric.",subsystems:{shadows:3,reflections:3,lighting_quality:1,atmosphere_quality:3}},{id:"ultra",label:"Ultra",description:"Full + PT NEE. Experimental.",isAdvanced:!0,subsystems:{shadows:3,reflections:3,lighting_quality:2,atmosphere_quality:3}}];({...de[3].subsystems});function It(e){return de.find(t=>t.id===e)}function ro(e){if(!e.activePreset)return"Custom";const t=It(e.activePreset);if(!t)return"Custom";if(!e.isCustomized)return t.label;const a=[];for(const o of se){const i=t.subsystems[o.id],r=e.subsystems[o.id];if(i!==r){const n=o.tiers[r];a.push(`${o.label}=${(n==null?void 0:n.label)??"?"}`)}}return`${t.label} (${a.join(", ")})`}const Ct=4200;function no(e){let t=Ct;for(const a of se){const o=e[a.id]??0,i=a.tiers[o];i&&(t+=i.estCompileMs)}return t}const Pt=(e,t)=>{if(!e)return`
...
`;function lo(e){let t=!1;const a=e.map(o=>o.id?o:(t=!0,{...o,id:C()}));return t?a:e}const so=(e,t)=>!e||!e.lights||t>=e.lights.length?{id:"",type:"Point",position:{x:0,y:0,z:0},rotation:{x:0,y:0,z:0},color:"#ffffff",intensity:0,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!0,radius:0,range:0,intensityUnit:"raw"}:e.lights[t],kt=[{id:C(),type:"Point",position:{x:-2,y:1,z:2},rotation:{x:0,y:0,z:0},color:"#fff4e6",intensity:1.5,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:5500},{id:C(),type:"Point",position:{x:2,y:-1,z:1},rotation:{x:0,y:0,z:0},color:"#FFD6AA",intensity:.5,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:3500},{id:C(),type:"Point",position:{x:0,y:-5,z:2},rotation:{x:0,y:0,z:0},color:"#E0EEFF",intensity:.25,falloff:0,falloffType:"Quadratic",fixed:!0,visible:!1,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:7500}],Ot={id:"lighting",shortId:"l",name:"Lighting",category:"Rendering",tabConfig:{label:"Light",condition:{param:"$advancedMode",bool:!0}},viewportConfig:{componentId:"overlay-lighting",renderOrder:50,type:"dom"},engineConfig:{toggleParam:"advancedLighting",mode:"compile",label:"Lighting Engine",groupFilter:"engine_settings"},groups:{shadows:{label:"Shadows",description:"Per-light shadow tracing and softness.",helpId:"shadows"}},extraUniforms:[{name:z.LightCount,type:"int",default:0},{name:z.LightType,type:"float",arraySize:u,default:new Float32Array(u).fill(0)},{name:z.LightPos,type:"vec3",arraySize:u,default:new Array(u).fill(new h)},{name:z.LightDir,type:"vec3",arraySize:u,default:new Array(u).fill(new h(0,-1,0))},{name:z.LightColor,type:"vec3",arraySize:u,default:new Array(u).fill(new w(1,1,1))},{name:z.LightIntensity,type:"float",arraySize:u,default:new Float32Array(u).fill(0)},{name:z.LightShadows,type:"float",arraySize:u,default:new Float32Array(u).fill(0)},{name:z.LightFalloff,type:"float",arraySize:u,default:new Float32Array(u).fill(0)},{name:z.LightFalloffType,type:"float",arraySize:u,default:new Float32Array(u).fill(0)},{name:z.LightRadius,type:"float",arraySize:u,default:new Float32Array(u).fill(0)},{name:z.LightSoftness,type:"float",arraySize:u,default:new Float32Array(u).fill(0)},{name:z.LightHideEmitter,type:"float",arraySize:u,default:new Float32Array(u).fill(0)}],params:{advancedLighting:{type:"boolean",default:!0,label:"Light Engine",shortId:"le",group:"main",noReset:!0,hidden:!0,onUpdate:"compile",description:"Master switch for lighting logic. Disabling provides stubs only."},ptEnabled:{type:"boolean",default:!0,label:"Path Tracing Core",shortId:"pe",group:"engine_settings",ui:"checkbox",description:"Compiles the Path Tracing module. Disable to reduce shader size.",onUpdate:"compile",noReset:!0,estCompileMs:1500},renderMode:{type:"float",default:0,label:"Active Mode",shortId:"rm",group:"engine_settings",parentId:"ptEnabled",options:[{label:"Direct (Fast)",value:0},{label:"Path Tracing (GI)",value:1}],description:"Switches between fast direct lighting and physically based Global Illumination.",onUpdate:"compile",noReset:!0},ptBounces:{type:"int",default:3,label:"Max Bounces",shortId:"pb",uniform:"uPTBounces",min:1,max:8,step:1,group:"engine_settings",parentId:"ptEnabled",ui:"numeric",description:"Recursion depth. Higher = Brighter interiors, Slower render."},ptGIStrength:{type:"float",default:1,label:"GI Strength",shortId:"pg",uniform:"uPTGIStrength",min:0,max:5,step:.01,group:"engine_settings",parentId:"ptEnabled",description:"Artistic boost for bounced light intensity."},specularModel:{type:"float",default:0,label:"Specular Model",shortId:"sm",group:"engine_settings",options:[{label:"Blinn-Phong (Fast)",value:0,estCompileMs:0},{label:"Cook-Torrance (Quality)",value:1,estCompileMs:400}],description:"BRDF model for direct lighting. Cook-Torrance is physically accurate but increases shader compile time.",onUpdate:"compile",noReset:!0},shadowsCompile:{type:"boolean",default:!0,label:"Shadow Engine",shortId:"sc",group:"engine_settings",ui:"checkbox",noReset:!0,onUpdate:"compile",description:"Compiles the shadow raymarching loop. Disable to save ~5s compile time.",estCompileMs:1500},shadowAlgorithm:{type:"float",default:0,label:"Shadow Quality",shortId:"sa",group:"engine_settings",parentId:"shadowsCompile",options:[{label:"Hard Only (Fastest)",value:2,estCompileMs:500},{label:"Lite Soft (Fast)",value:1,estCompileMs:1500},{label:"Robust Soft (Quality)",value:0,estCompileMs:3e3}],description:"Shadow algorithm. Hard = binary occlusion, Lite = fast penumbra, Robust = accurate penumbra.",onUpdate:"compile",noReset:!0},ptStochasticShadows:{type:"boolean",default:!0,label:"Soft Shadow Jitter",shortId:"ps",group:"engine_settings",parentId:"shadowsCompile",ui:"checkbox",onUpdate:"compile",noReset:!0,estCompileMs:800,description:"Stochastic shadow jitter for Point lights — fakes soft penumbras via accumulation. Independent of True Area Lights (which uses physical sphere sampling for type=Sphere lights)."},ptAreaLights:{type:"boolean",default:!1,label:"True Area Lights",shortId:"pal2",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noReset:!0,estCompileMs:600,description:"Physically-correct sphere area light integration (sphere-surface sampling + MIS). Required for lights with type=Sphere. Enable + change a light type to Sphere via the per-light menu. Costs ~600ms compile + one extra sphere intersection per bounce."},ptNEEAllLights:{type:"boolean",default:!1,label:"Sample All Lights",shortId:"pal",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noReset:!0,description:"Evaluates every active light per bounce instead of one random light. Reduces shadow noise at the cost of N× more shadow rays."},ptEnvNEE:{type:"boolean",default:!1,label:"Environment NEE",shortId:"pen",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noReset:!0,description:"Directly samples the environment as a light source each bounce. Large noise reduction for sky-lit scenes at the cost of one extra trace per bounce."},ptMaxLuminance:{type:"float",default:10,label:"Firefly Clamp",shortId:"pfl",uniform:"uPTMaxLuminance",min:.5,max:200,step:.5,scale:"log",group:"engine_settings",parentId:"ptEnabled",description:"Clamps per-sample luminance to suppress bright firefly spikes. Lower = cleaner but slightly biased. Raise to effectively disable."},shadows:{type:"boolean",default:!0,label:"Enable",shortId:"sh",group:"main",uniform:"uShadows",ui:"checkbox",condition:{param:"shadowsCompile",bool:!0},description:"Toggle shadow casting at runtime without recompiling.",helpId:"shadows"},areaLights:{type:"boolean",default:!1,label:"Area Lights",shortId:"al",uniform:"uAreaLights",group:"shadows",hidden:!0,condition:{param:"ptStochasticShadows",bool:!0},description:"Stochastic area light shadows. Disable for sharp analytical shadows.",helpId:"shadows",onUpdate:"compile",noReset:!0},shadowIntensity:{type:"float",default:1,label:"Opacity",shortId:"si",uniform:"uShadowIntensity",min:0,max:1,step:.01,group:"shadows",condition:{bool:!0},description:"How dark the shadowed regions become (1 = fully black).",helpId:"shadows"},shadowSoftness:{type:"float",default:16,label:"Hardness",shortId:"ss",uniform:"uShadowSoftness",min:2,max:2e3,step:1,group:"shadows",scale:"log",condition:{bool:!0},description:"Higher values give crisper shadows; lower values give wider penumbras. Affects Point and Directional lights only — Sphere area lights derive shadow softness from physical sphere sampling.",helpId:"shadows"},shadowSteps:{type:"int",default:128,label:"Steps",shortId:"st",min:16,max:512,step:16,group:"shadows",condition:{bool:!0},uniform:"uShadowSteps",ui:"numeric",description:"Quality vs Performance.",helpId:"shadows"},shadowBias:{type:"float",default:.002,label:"Bias",shortId:"sb",uniform:"uShadowBias",min:0,max:1,step:1e-6,group:"shadows",scale:"log",condition:{bool:!0},description:"Too low: acne. Too high: detached.",helpId:"shadows"},lights:{type:"complex",default:kt,label:"Light List",shortId:"ll",group:"data",hidden:!0,noReset:!0}},inject:(e,t,a)=>{if(a!=="Main"){e.addPostDEFunction(`
             ...
             `);return}e.addDefine("MAX_LIGHTS",u.toString());const o=t.lighting;if(o&&!o.advancedLighting){e.addDefine("MAX_LIGHTS","0"),e.addPostDEFunction(`
             float GetSoftShadow(vec3 ro, vec3 rd, float k, float lightDist, float noise) { return 1.0; }
             float GetHardShadow(vec3 ro, vec3 rd, float lightDist) { return 1.0; }
...
This rotation is bound to 'ParamC' (Slider below). Try dragging it!`},{id:"rot-1",type:"Rotate",enabled:!0,params:{x:0,y:0,z:0},bindings:{z:"ParamC"}},{id:"bulb-1",type:"Mandelbulb",enabled:!0,params:{power:8}},{id:"add-c",type:"AddConstant",enabled:!0,params:{scale:1}}],Ia={id:"Modular",name:"Modular Builder",shortDescription:"Construct custom fractal equations using a Node Graph.",description:"Construct your own fractal equation by chaining operations together. Combine folds, rotations, and logic via the Graph tab.",juliaType:"julia",shader:{function:"",loopBody:"",getDist:""},parameters:[null,null,null,null],defaultPreset:{formula:"Modular",features:{coreMath:{iterations:16,paramA:8,paramB:0,paramC:0,paramD:0,paramE:0,paramF:0},lighting:{shadows:!0,shadowSoftness:16,shadowIntensity:1,shadowBias:.002}},pipeline:Ma,cameraPos:{x:0,y:0,z:4},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:0,xL:0,yL:0,zL:0}}},Ca={id:"MandelTerrain",name:"MandelTerrain",shortDescription:'3D Heightmap of the Mandelbrot set. Creates alien landscapes and "Math Mountains".',description:"A 3D Heightmap of the Mandelbrot set. Iterations slider controls terrain detail.",juliaType:"julia",shader:{function:`
...
`)},Ja=(e,t)=>{var l;const{shader:a,...o}=e,i={};(l=a.preambleVars)!=null&&l.length&&(i.preambleVars=a.preambleVars),a.usesSharedRotation&&(i.usesSharedRotation=!0);const r={...o,...Object.keys(i).length>0?{shaderMeta:i}:{},defaultPreset:t};let n=`<!--
...
`),n},eo=e=>{const t=s=>{const y=new RegExp(`<${s}>([\\s\\S]*?)<\\/${s}>`),g=e.match(y);return g?g[1].trim():null},a=t("Metadata");if(!a){try{const s=JSON.parse(e);if(s.id&&s.shader)return s}catch{}throw new Error("Invalid GMF: Missing Metadata tag")}const o=JSON.parse(a),i=t("Shader_Preamble"),r=t("Shader_Function"),n=t("Shader_Loop"),l=t("Shader_Init"),f=t("Shader_Dist");if((!r||!n)&&o.id!=="Modular")throw new Error("Invalid GMF: Missing essential shader blocks (<Shader_Function> or <Shader_Loop>)");const d={function:r??"",loopBody:n??"",preamble:i||void 0,loopInit:l||void 0,getDist:f||void 0};return o.shaderMeta&&(o.shaderMeta.preambleVars&&(d.preambleVars=o.shaderMeta.preambleVars),o.shaderMeta.usesSharedRotation&&(d.usesSharedRotation=!0),delete o.shaderMeta),{...o,shader:d}},to=e=>{const t=e.trimStart();return t.startsWith("<!--")||t.startsWith("<Metadata>")},po=e=>{const t=S.get(e.formula);if(!t)return JSON.stringify(e,null,2);let a=Ja(t,t.defaultPreset);return a+=`<!-- Full scene state (camera, lights, features, quality, animations) -->
`,a+=`<Scene>
${ue(e)}
</Scene>
`,a},fo=e=>{if(to(e)){const a=eo(e),o=e.match(/<Scene>([\s\S]*?)<\/Scene>/);if(o){const r=JSON.parse(o[1].trim());return{def:a,preset:r}}const i=a.defaultPreset||{formula:a.id};return i.formula||(i.formula=a.id),{def:a,preset:i}}return{preset:JSON.parse(e)}};export{se as A,R as I,Ma as J,de as S,so as a,lo as b,no as c,ro as d,co as e,Ke as f,Ja as g,nt as h,lt as i,dt as j,st as k,fo as l,ct as m,p as n,na as o,S as r,po as s};
