...
`);this.integrators.push(Rn(p))}const i=this.integrators.join(`
...
`;if(this.variant==="Histogram"){const p=Bt(!1,!1,this.precisionMode,0,"",""),S=co("Direct");return`
${t}
${o}
${l}
${kt}
...
`)),h=co(this.renderMode),E=In(this.postProcessLogic.join(`
`));return`
${t}
${o}
${n}
