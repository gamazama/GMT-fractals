var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,c as D,F as p,d as g,u as m}from"./FractalRegistry-Bl6DSKSZ.js";import{r as v,j as l,R as j}from"./three-fiber-GKfjny8F.js";import{o as $,q as k,t as S,v as w,w as R,x as B,S as O,E as N,D as V,b as G,P as H,T as q,d as X,e as Y,G as W,c as Q,f as Z,r as K,y as J,i as ee,n as te,j as ae,m as ie,k as oe,l as re}from"./PwaUpdate-brYdj8Tb.js";import{V as ne,i as se,c as le}from"./Camera-BCFQh1lQ.js";import{c as ce}from"./three-drei-D6d-dyvY.js";import{C as fe}from"./CompilingIndicator-CFFRo6TB.js";import{r as me}from"./cameraKeyRegistry-Djjd5jMV.js";import"./three-DQWx7qFd.js";import"./pako-DwGzBETv.js";const u=new Map,A=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),$(t.name)||k({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},ue=`
