...
`,extraParams:{hybridFoldingValue:{type:"vec3",default:new A(2,2,2),label:"Folding Value",shortId:"hfv",uniform:"uHybridFoldingValue",min:.1,max:5,step:.01,group:"hybrid"}},defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2,hybridFoldingValue:{x:2,y:2,z:2}}},Ta={id:"kali",label:"Kali",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = uHybridKaliConstant - abs(z);
}
`,rotMode:"post",extraParams:{hybridKaliConstant:{type:"vec3",default:new A(1,1,1),label:"Kali Constant",shortId:"hkc",uniform:"uHybridKaliConstant",min:-3,max:3,step:.01,group:"hybrid"}},defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.6,hybridFixedR:1,hybridIter:3,hybridKaliConstant:{x:.5,y:.5,z:.5}}},za={id:"tetra",label:"Tetrahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    if (z.x + z.y < 0.0) z.xy = -z.yx;
    if (z.x + z.z < 0.0) z.xz = -z.zx;
    if (z.y + z.z < 0.0) z.yz = -z.zy;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.25,hybridFixedR:1,hybridIter:3}},Da={id:"octa",label:"Octahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:4}},Aa={id:"menger",label:"Menger (Cubic)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,selfContained:!0,extraParams:{hybridMengerOffset:{type:"vec3",default:new A(1,1,1),label:"Offset",shortId:"hmo",uniform:"uHybridMengerOffset",min:0,max:2,step:.01,group:"hybrid",linkable:!0},hybridMengerCenterZ:{type:"boolean",default:!0,label:"Center Z",shortId:"hmz",uniform:"uHybridMengerCenterZ",group:"hybrid"}},defaults:{hybridScale:3,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3,hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0}},Ze=[Pa,La,Ea,ka,Ta,za,Da,Fa,Aa],Oa=Ze.map((e,o)=>({label:e.label,value:o}));function ja(e){return Ze[e]??Ze[0]}const Na=`
...
`,$a=["xyz","xzy","yxz","yzx","zxy","zyx"];function Ba(e){const o=$a[e]??"xyz";return o==="xyz"?"vec3 c_perm = c.xyz;":`vec3 c_perm = c.${o};`}function Ha(e,o,t=!1){return`
mat3 hybridRotMat;
bool hybridHasRot;
...
`,s+=`
                ...
                `}e.addHybridFold("",n,s)}},Nt=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF"],$t=["uVec2A","uVec2B","uVec2C"],Bt=["uVec3A","uVec3B","uVec3C"],Ht=["uVec4A","uVec4B","uVec4C"],uo=["uInterlaceParamA","uInterlaceParamB","uInterlaceParamC","uInterlaceParamD","uInterlaceParamE","uInterlaceParamF"],fo=["uInterlaceVec2A","uInterlaceVec2B","uInterlaceVec2C"],po=["uInterlaceVec3A","uInterlaceVec3B","uInterlaceVec3C"],ho=["uInterlaceVec4A","uInterlaceVec4B","uInterlaceVec4C"];function Ua(){const e=[];for(let o=0;o<Nt.length;o++)e.push([new RegExp(`\\b${Nt[o]}\\b`,"g"),uo[o]]);for(let o=0;o<$t.length;o++)e.push([new RegExp(`\\b${$t[o]}\\b`,"g"),fo[o]]);for(let o=0;o<Bt.length;o++)e.push([new RegExp(`\\b${Bt[o]}\\b`,"g"),po[o]]);for(let o=0;o<Ht.length;o++)e.push([new RegExp(`\\b${Ht[o]}\\b`,"g"),ho[o]]);return e}const qa=Ua();function gt(e){let o=e;for(const[t,a]of qa)o=o.replace(t,a);return o}function mo(e,o){const t=[...o].sort((r,i)=>i.length-r.length);let a=e;for(const r of t)a=a.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return a}function Wa(e,o,t){let a=e;return a=a.replace(new RegExp(`\\b${o}_\\w+\\b`,"g"),r=>`interlace_${r}`),t&&t.length>0&&(a=mo(a,t)),a=gt(a),a}function Xa(e,o,t){let a=e;return a=a.replace(new RegExp(`\\bformula_${o}\\b`,"g"),"formula_Interlace"),a=gt(a),t&&t.length>0&&(a=mo(a,t)),a}function Ya(e,o){return e.replace(new RegExp(`\\bformula_${o}\\b`,"g"),"formula_Interlace")}function Ka(e,o){let t=e;return t=t.replace(new RegExp(`\\b${o}_\\w+\\b`,"g"),a=>`interlace_${a}`),t=gt(t),t}function Ja(e,o,t){let a="";o&&(a=`
...
`});H.register({id:"Custom",label:"Custom (Legacy)",category:"Utils",description:"Legacy node.",inputs:[],glsl:e=>""});const rr=(e,o)=>{const t=new Set,a=["root-end"],r=new Set;for(;a.length>0;){const f=a.pop();if(r.has(f))continue;r.add(f),f!=="root-end"&&f!=="root-start"&&t.add(f),o.filter(h=>h.target===f).forEach(h=>a.push(h.source))}const i=e.filter(f=>t.has(f.id));if(!i||i.length===0)return`
    ...
    `;const s=new Map;s.set("root-start","v_start");let l=0;i.forEach((f,p)=>{const g=`v_${f.id.replace(/[^a-zA-Z0-9]/g,"")}`;s.set(f.id,g);const x=o.filter(k=>k.target===f.id),m=x.find(k=>!k.targetHandle||k.targetHandle==="a"),y=x.find(k=>k.targetHandle==="b"),b=m&&s.get(m.source)||"v_start",C=y&&s.get(y.source)||"v_start";if(n+=`    // Node: ${f.type} (${f.id})
`,n+=`    vec3 ${g}_p = ${b}_p;
`,n+=`    float ${g}_d = ${b}_d;
`,n+=`    float ${g}_dr = ${b}_dr;
`,f.enabled){const k=H.get(f.type);if(k){const w=f.condition&&f.condition.active;let I="    ";if(w){const P=Math.round(Math.max(1,f.condition.mod)),z=Math.round(f.condition.rem);n+=`    if ( (i - (i/${P})*${P}) == ${z} ) {
`,I="        "}const E=P=>f.bindings&&f.bindings[P]?`u${f.bindings[P]}`:l<ut?`uModularParams[${l++}]`:"0.0";n+=k.glsl({varName:g,in1:b,in2:C,getParam:E,indent:I}),w&&(n+=`    }
`)}}n+=`
...
`},ir=e=>{let o="d = 0.5 * log(max(r, 1.0e-5)) * r / dr_safe;";return e<.5?o=`
        float logR2 = log2(m2);
        ...
        }`},nr={id:"coreMath",shortId:"cm",name:"Formula Math",category:"Formulas",tabConfig:{label:"Formula",componentId:"panel-formula",order:10},extraUniforms:[{name:ae.ModularParams,type:"float",arraySize:ut,default:new Float32Array(ut)}],params:{iterations:{type:"float",default:16,label:"Iterations",shortId:"it",uniform:"uIterations",min:1,max:500,step:1,group:"main"},paramA:{type:"float",default:8,label:"Param A",shortId:"pa",uniform:"uParamA",min:-10,max:10,step:.001,group:"params"},paramB:{type:"float",default:0,label:"Param B",shortId:"pb",uniform:"uParamB",min:-10,max:10,step:.001,group:"params"},paramC:{type:"float",default:0,label:"Param C",shortId:"pc",uniform:"uParamC",min:-10,max:10,step:.001,group:"params"},paramD:{type:"float",default:0,label:"Param D",shortId:"pd",uniform:"uParamD",min:-10,max:10,step:.001,group:"params"},paramE:{type:"float",default:0,label:"Param E",shortId:"pe",uniform:"uParamE",min:-10,max:10,step:.001,group:"params"},paramF:{type:"float",default:0,label:"Param F",shortId:"pf",uniform:"uParamF",min:-10,max:10,step:.001,group:"params"},vec2A:{type:"vec2",default:{x:0,y:0},label:"Vec2 A",shortId:"v2a",uniform:"uVec2A",min:-10,max:10,step:.001,group:"params"},vec2B:{type:"vec2",default:{x:0,y:0},label:"Vec2 B",shortId:"v2b",uniform:"uVec2B",min:-10,max:10,step:.001,group:"params"},vec2C:{type:"vec2",default:{x:0,y:0},label:"Vec2 C",shortId:"v2c",uniform:"uVec2C",min:-10,max:10,step:.001,group:"params"},vec3A:{type:"vec3",default:new A(0,0,0),label:"Vec3 A",shortId:"v3a",uniform:"uVec3A",min:-10,max:10,step:.001,group:"params"},vec3B:{type:"vec3",default:new A(0,0,0),label:"Vec3 B",shortId:"v3b",uniform:"uVec3B",min:-10,max:10,step:.001,group:"params"},vec3C:{type:"vec3",default:new A(0,0,0),label:"Vec3 C",shortId:"v3c",uniform:"uVec3C",min:-10,max:10,step:.001,group:"params"},vec4A:{type:"vec4",default:new et(0,0,0,0),label:"Vec4 A",shortId:"v4a",uniform:"uVec4A",min:-10,max:10,step:.001,group:"params"},vec4B:{type:"vec4",default:new et(0,0,0,0),label:"Vec4 B",shortId:"v4b",uniform:"uVec4B",min:-10,max:10,step:.001,group:"params"},vec4C:{type:"vec4",default:new et(0,0,0,0),label:"Vec4 C",shortId:"v4c",uniform:"uVec4C",min:-10,max:10,step:.001,group:"params"}},inject:(e,o)=>{var u;const t=o.formula,a=o.quality;t==="Modular"&&e.addDefine("PIPELINE_REV",(o.pipelineRevision||0).toString()),["JuliaMorph","MandelTerrain"].includes(t)&&e.addDefine("SKIP_PRE_BAILOUT","1");const r=pe.get(t);let i="",n="",s="";const l=(a==null?void 0:a.estimator)||0;let d=ir(l);if(t==="Modular"){const f=rr(o.pipeline||[],((u=o.graph)==null?void 0:u.edges)||[]);i+=f+`
...
`,n=r.shader.loopBody,s=r.shader.loopInit||"",r.shader.preamble&&e.addPreamble(r.shader.preamble),r.shader.getDist&&(d=`vec2 getDist(float r, float dr, float iter, vec4 z) { ${r.shader.getDist} }`));e.addFunction(i),e.setFormula(n,s,d)}};let sr=0;function Fe(){return`l${++sr}`}const lr=(e,o)=>{if(!e)return`
...
`;function Gt(e){let o=!1;const t=e.map(a=>a.id?a:(o=!0,{...a,id:Fe()}));return o?t:e}const un=(e,o)=>!e||!e.lights||o>=e.lights.length?{id:"",type:"Point",position:{x:0,y:0,z:0},rotation:{x:0,y:0,z:0},color:"#ffffff",intensity:0,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!0,radius:0,range:0,intensityUnit:"raw"}:e.lights[o],gr=[{id:Fe(),type:"Point",position:{x:-2,y:1,z:2},rotation:{x:0,y:0,z:0},color:"#fff4e6",intensity:1.5,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!0,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:5500},{id:Fe(),type:"Point",position:{x:2,y:-1,z:1},rotation:{x:0,y:0,z:0},color:"#FFD6AA",intensity:.5,falloff:0,falloffType:"Quadratic",fixed:!1,visible:!1,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:3500},{id:Fe(),type:"Point",position:{x:0,y:-5,z:2},rotation:{x:0,y:0,z:0},color:"#E0EEFF",intensity:.25,falloff:0,falloffType:"Quadratic",fixed:!0,visible:!1,castShadow:!0,radius:0,softness:0,useTemperature:!0,temperature:7500}],yr={id:"lighting",shortId:"l",name:"Lighting",category:"Rendering",tabConfig:{label:"Light",componentId:"panel-light",order:30,condition:{param:"$advancedMode",bool:!0}},viewportConfig:{componentId:"overlay-lighting",renderOrder:50,type:"dom"},engineConfig:{toggleParam:"advancedLighting",mode:"compile",label:"Lighting Engine",groupFilter:"engine_settings"},extraUniforms:[{name:ae.LightCount,type:"int",default:0},{name:ae.LightType,type:"float",arraySize:X,default:new Float32Array(X).fill(0)},{name:ae.LightPos,type:"vec3",arraySize:X,default:new Array(X).fill(new A)},{name:ae.LightDir,type:"vec3",arraySize:X,default:new Array(X).fill(new A(0,-1,0))},{name:ae.LightColor,type:"vec3",arraySize:X,default:new Array(X).fill(new le(1,1,1))},{name:ae.LightIntensity,type:"float",arraySize:X,default:new Float32Array(X).fill(0)},{name:ae.LightShadows,type:"float",arraySize:X,default:new Float32Array(X).fill(0)},{name:ae.LightFalloff,type:"float",arraySize:X,default:new Float32Array(X).fill(0)},{name:ae.LightFalloffType,type:"float",arraySize:X,default:new Float32Array(X).fill(0)},{name:ae.LightRadius,type:"float",arraySize:X,default:new Float32Array(X).fill(0)},{name:ae.LightSoftness,type:"float",arraySize:X,default:new Float32Array(X).fill(0)}],params:{advancedLighting:{type:"boolean",default:!0,label:"Light Engine",shortId:"le",group:"main",noReset:!0,hidden:!0,onUpdate:"compile",description:"Master switch for lighting logic. Disabling provides stubs only."},ptEnabled:{type:"boolean",default:!0,label:"Path Tracing Core",shortId:"pe",group:"engine_settings",ui:"checkbox",description:"Compiles the Path Tracing module. Disable to reduce shader size.",onUpdate:"compile",noReset:!0,estCompileMs:1500},renderMode:{type:"float",default:0,label:"Active Mode",shortId:"rm",group:"engine_settings",parentId:"ptEnabled",options:[{label:"Direct (Fast)",value:0},{label:"Path Tracing (GI)",value:1}],description:"Switches between fast direct lighting and physically based Global Illumination.",onUpdate:"compile",noReset:!0},ptBounces:{type:"int",default:3,label:"Max Bounces",shortId:"pb",uniform:"uPTBounces",min:1,max:8,step:1,group:"engine_settings",parentId:"ptEnabled",ui:"numeric",description:"Recursion depth. Higher = Brighter interiors, Slower render."},ptGIStrength:{type:"float",default:1,label:"GI Strength",shortId:"pg",uniform:"uPTGIStrength",min:0,max:5,step:.01,group:"engine_settings",parentId:"ptEnabled",description:"Artistic boost for bounced light intensity."},specularModel:{type:"float",default:0,label:"Specular Model",shortId:"sm",group:"engine_settings",options:[{label:"Blinn-Phong (Fast)",value:0,estCompileMs:0},{label:"Cook-Torrance (Quality)",value:1,estCompileMs:400}],description:"BRDF model for direct lighting. Cook-Torrance is physically accurate but increases shader compile time.",onUpdate:"compile",noReset:!0},shadowsCompile:{type:"boolean",default:!0,label:"Shadow Engine",shortId:"sc",group:"engine_settings",ui:"checkbox",noReset:!0,onUpdate:"compile",description:"Compiles the shadow raymarching loop. Disable to save ~5s compile time.",estCompileMs:1500},shadowAlgorithm:{type:"float",default:0,label:"Shadow Quality",shortId:"sa",group:"engine_settings",parentId:"shadowsCompile",options:[{label:"Hard Only (Fastest)",value:2,estCompileMs:500},{label:"Lite Soft (Fast)",value:1,estCompileMs:1500},{label:"Robust Soft (Quality)",value:0,estCompileMs:3e3}],description:"Shadow algorithm. Hard = binary occlusion, Lite = fast penumbra, Robust = accurate penumbra.",onUpdate:"compile",noReset:!0},ptStochasticShadows:{type:"boolean",default:!0,label:"Area Lights",shortId:"ps",group:"engine_settings",parentId:"shadowsCompile",ui:"checkbox",onUpdate:"compile",noReset:!0,estCompileMs:800,description:"Compiles stochastic area light shadow code. Creates realistic penumbras via accumulation."},ptNEEAllLights:{type:"boolean",default:!1,label:"Sample All Lights",shortId:"pal",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noReset:!0,description:"Evaluates every active light per bounce instead of one random light. Reduces shadow noise at the cost of N× more shadow rays."},ptEnvNEE:{type:"boolean",default:!1,label:"Environment NEE",shortId:"pen",group:"engine_settings",parentId:"ptEnabled",ui:"checkbox",onUpdate:"compile",noReset:!0,description:"Directly samples the environment as a light source each bounce. Large noise reduction for sky-lit scenes at the cost of one extra trace per bounce."},ptMaxLuminance:{type:"float",default:10,label:"Firefly Clamp",shortId:"pfl",uniform:"uPTMaxLuminance",min:.5,max:200,step:.5,scale:"log",group:"engine_settings",parentId:"ptEnabled",description:"Clamps per-sample luminance to suppress bright firefly spikes. Lower = cleaner but slightly biased. Raise to effectively disable."},shadows:{type:"boolean",default:!0,label:"Enable",shortId:"sh",group:"main",uniform:"uShadows",ui:"checkbox",condition:{param:"shadowsCompile",bool:!0}},areaLights:{type:"boolean",default:!1,label:"Area Lights",shortId:"al",uniform:"uAreaLights",group:"shadows",hidden:!0,condition:{param:"ptStochasticShadows",bool:!0},description:"Stochastic area light shadows. Disable for sharp analytical shadows."},shadowIntensity:{type:"float",default:1,label:"Opacity",shortId:"si",uniform:"uShadowIntensity",min:0,max:1,step:.01,group:"shadows",condition:{bool:!0}},shadowSoftness:{type:"float",default:16,label:"Softness",shortId:"ss",uniform:"uShadowSoftness",min:2,max:2e3,step:1,group:"shadows",scale:"log",condition:{bool:!0}},shadowSteps:{type:"int",default:128,label:"Steps",shortId:"st",min:16,max:512,step:16,group:"shadows",condition:{bool:!0},uniform:"uShadowSteps",ui:"numeric",description:"Quality vs Performance."},shadowBias:{type:"float",default:.002,label:"Bias",shortId:"sb",uniform:"uShadowBias",min:0,max:1,step:1e-6,group:"shadows",scale:"log",condition:{bool:!0},description:"Prevents surface acne."},lights:{type:"complex",default:gr,label:"Light List",shortId:"ll",group:"data",hidden:!0,noReset:!0}},inject:(e,o,t)=>{if(t!=="Main"){e.addPostDEFunction(`
             ...
             `);return}e.addDefine("MAX_LIGHTS",X.toString());const a=o.lighting;if(a&&!a.advancedLighting){e.addDefine("MAX_LIGHTS","0"),e.addPostDEFunction(`
             float GetSoftShadow(vec3 ro, vec3 rd, float k, float lightDist, float noise) { return 1.0; }
             float GetHardShadow(vec3 ro, vec3 rd, float lightDist) { return 1.0; }
...
`,zr={id:"reflections",shortId:"rf",name:"Reflections",category:"Rendering",engineConfig:{toggleParam:"enabled",mode:"compile",label:"Reflection Tracing",groupFilter:"engine_settings"},params:{reflectionMode:{type:"float",default:ot,label:"Reflection Method",shortId:"rm",group:"engine_settings",options:[{label:"Off",value:qt,estCompileMs:0},{label:"Environment Map",value:ot,estCompileMs:0},{label:"Raymarched (Quality)",value:Le,estCompileMs:7500}],description:"Reflection technique. Higher quality = longer compile time. Raymarched adds ~9s.",onUpdate:"compile",noReset:!0},bounceShadows:{type:"boolean",default:!1,label:"Bounce Shadows",shortId:"bs",group:"engine_settings",ui:"checkbox",condition:{param:"reflectionMode",eq:Le},description:"Compute shadows on reflected surfaces. Adds ~3-4s compile time.",onUpdate:"compile",noReset:!0,estCompileMs:4500},mixStrength:{type:"float",default:1,label:"Raymarch Mix",shortId:"mx",uniform:"uReflStrength",min:0,max:1,step:.01,group:"engine_settings",condition:{param:"reflectionMode",eq:Le},description:"Blends between Raymarched Reflections (1.0) and Environment Map (0.0)."},roughnessThreshold:{type:"float",default:.62,label:"Roughness Cutoff",shortId:"rc",uniform:"uReflRoughnessCutoff",min:0,max:1,step:.01,group:"engine_settings",condition:{param:"reflectionMode",eq:Le},description:"Surfaces rougher than this will skip raymarching to save performance."},bounces:{type:"int",default:1,label:"Max Bounces",shortId:"rb",min:1,max:3,step:1,group:"engine_settings",uniform:"uReflBounces",ui:"numeric",description:"Maximum recursion depth. Clamped to 3. Default 1 for performance.",noReset:!0,onUpdate:"compile",condition:{param:"reflectionMode",eq:Le}},steps:{type:"int",default:64,label:"Trace Steps",shortId:"rs",min:16,max:128,step:8,group:"engine_settings",uniform:"uReflSteps",ui:"numeric",description:"Precision of the reflection ray.",noReset:!0,condition:{param:"reflectionMode",eq:Le}},enabled:{type:"boolean",default:!0,label:"Enable Reflections",shortId:"re",group:"main",hidden:!0,noReset:!0,onUpdate:"compile"}},inject:(e,o,t)=>{if(t!=="Main")return;const a=o.reflections;if(!a||a.enabled===!1)return;const r=a.reflectionMode??ot;if(r!==qt){if(r!==Le){e.addShadingLogic(kr);return}if(r===Le){e.addPostDEFunction(Er());const i=Math.max(1,Math.min(3,a.bounces??1));e.addDefine("MAX_REFL_BOUNCES",i.toString()),a.bounceShadows&&e.addDefine("REFL_BOUNCE_SHADOWS","1"),e.addShadingLogic(Tr)}}}},Dr=`
// --- WATER PLANE LOGIC ---
...
`,Br=`
    ...
    col += fogScatter;
`,Hr={id:"volumetric",shortId:"vol",name:"Volumetric Scatter",category:"Rendering",engineConfig:{toggleParam:"ptVolumetric",mode:"compile",label:"Volumetric Scattering",description:"Henyey-Greenstein single scatter. Enables god rays, colored haze, and directional fog.",groupFilter:"engine_settings"},panelConfig:{compileParam:"ptVolumetric",runtimeToggleParam:"volEnabled",label:"Volumetric Scatter",compileMessage:"Compiling Volumetric Shader...",helpId:"render.volumetric"},groups:{density:{label:"Density & Shadow Rays",collapsible:!0},emissive:{label:"Color Scatter",collapsible:!0},height:{label:"Height Fog",collapsible:!0}},params:{ptVolumetric:{type:"boolean",default:!1,label:"Volume Scatter",shortId:"pvs",group:"engine_settings",noReset:!0,onUpdate:"compile",estCompileMs:5500},volEnabled:{type:"boolean",default:!1,label:"Enabled",shortId:"ven",uniform:"uVolEnabled",hidden:!0},volDensity:{type:"float",default:.01,label:"Density",shortId:"vd",uniform:"uVolDensity",min:.001,max:5,step:.01,scale:"log",group:"density",condition:{param:"ptVolumetric",bool:!0}},volAnisotropy:{type:"float",default:.3,label:"Anisotropy (g)",shortId:"va",uniform:"uVolAnisotropy",min:-.99,max:.99,step:.01,group:"density",parentId:"volDensity",condition:{gt:0},description:"0=isotropic, +0.9=forward (god rays), -0.9=back scatter."},volMaxLights:{type:"float",default:1,label:"Light Sources",shortId:"vml",uniform:"uVolMaxLights",min:1,max:3,step:1,group:"density",parentId:"volDensity",condition:{gt:0},isAdvanced:!0,description:"Max lights for shadow rays. More = more expensive."},volScatterTint:{type:"color",default:new le(1,1,1),label:"Scatter Tint",shortId:"vst",uniform:"uVolScatterTint",group:"density",parentId:"volDensity",condition:{gt:0}},volEmissive:{type:"float",default:0,label:"Color Scatter",shortId:"ves",uniform:"uVolEmissive",min:0,max:100,step:.1,scale:"log",group:"emissive",condition:{param:"ptVolumetric",bool:!0},description:"Orbit trap color field scattered through the volume. No shadow rays needed."},volStepJitter:{type:"float",default:1,label:"Step Jitter",shortId:"vsj",uniform:"uVolStepJitter",min:0,max:1,step:.01,group:"density",parentId:"volDensity",condition:{gt:0},description:"1 = smooth (temporal accumulation removes noise). 0 = fixed slicing pattern (artistic, broken fog look)."},volEmissiveFalloff:{type:"float",default:0,label:"Surface Falloff",shortId:"vef",uniform:"uVolEmissiveFalloff",min:0,max:5,step:.01,scale:"log",group:"emissive",parentId:"volEmissive",condition:{gt:0},description:"Concentrate color near fractal surface."},volHeightFalloff:{type:"float",default:0,label:"Height Falloff",shortId:"vhf",uniform:"uVolHeightFalloff",min:0,max:5,step:.01,scale:"log",group:"height",condition:{param:"ptVolumetric",bool:!0},description:"Density varies with Y. Creates ground fog, rising mist."},volHeightOrigin:{type:"float",default:0,label:"Height Origin",shortId:"vho",uniform:"uVolHeightOrigin",min:-5,max:5,step:.01,group:"height",parentId:"volHeightFalloff",condition:{gt:0}}},inject:(e,o,t)=>{if(t!=="Main")return;const a=o.volumetric;a!=null&&a.ptVolumetric&&(e.addDefine("PT_VOLUMETRIC","1"),e.addVolumeTracing($r,""),e.addPostProcessLogic(Br))}},Vr=()=>{F.register(nr),F.register(Ga),F.register(tr),F.register(yr),F.register(br),F.register(Lr),F.register(zr),F.register(ga),F.register(Hr),F.register(_a),F.register(jr),F.register(Ra),F.register(Ca),F.register(or),F.register(ba),F.register(va),F.register(Ia),F.register(vr),F.register(xr),F.register(Nr),F.register(Sr),F.register(wr),F.register(_r),F.register(Ir),F.register(Cr),F.register(Rr)},We=e=>{const o=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return o?{r:parseInt(o[1],16),g:parseInt(o[2],16),b:parseInt(o[3],16)}:null},Gr=(e,o,t)=>(typeof e=="object"&&(o=e.g,t=e.b,e=e.r),"#"+((1<<24)+(Math.round(e)<<16)+(Math.round(o)<<8)+Math.round(t)).toString(16).slice(1).toUpperCase()),fn=({r:e,g:o,b:t})=>{e/=255,o/=255,t/=255;const a=Math.max(e,o,t),r=Math.min(e,o,t);let i=0,n=0,s=a;const l=a-r;if(n=a===0?0:l/a,a!==r){switch(a){case e:i=(o-t)/l+(o<t?6:0);break;case o:i=(t-e)/l+2;break;case t:i=(e-o)/l+4;break}i/=6}return{h:i*360,s:n*100,v:s*100}},pn=(e,o,t)=>{e/=360,o/=100,t/=100;let a=0,r=0,i=0;const n=Math.floor(e*6),s=e*6-n,l=t*(1-o),d=t*(1-s*o),u=t*(1-(1-s)*o);switch(n%6){case 0:a=t,r=u,i=l;break;case 1:a=d,r=t,i=l;break;case 2:a=l,r=t,i=u;break;case 3:a=l,r=d,i=t;break;case 4:a=u,r=l,i=t;break;case 5:a=t,r=l,i=d;break}return{r:a*255,g:r*255,b:i*255}},Ur=(e,o,t)=>({r:e.r+(o.r-e.r)*t,g:e.g+(o.g-e.g)*t,b:e.b+(o.b-e.b)*t}),qr=(e,o)=>{if(Math.abs(o-.5)<.001)return e;const t=Math.max(.001,Math.min(.999,o)),a=Math.log(.5)/Math.log(t);return Math.pow(e,a)},hn=(e,o=1)=>{let t;if(!e)return"linear-gradient(90deg, #000 0%, #fff 100%)";if(Array.isArray(e))t=e;else if(e&&Array.isArray(e.stops))t=e.stops;else return"linear-gradient(90deg, #000 0%, #fff 100%)";if(!t||t.length===0)return"linear-gradient(90deg, #000 0%, #fff 100%)";const a=[...t].sort((i,n)=>i.position-n.position),r=[];for(let i=0;i<a.length;i++){const n=a[i];let s=Math.pow(n.position,1/o);if(s=Math.max(0,Math.min(1,s))*100,r.push(`${n.color} ${s.toFixed(2)}%`),i<a.length-1){const l=a[i+1],d=n.bias??.5;if((n.interpolation||"linear")==="step"){let f=Math.pow(l.position,1/o);f=Math.max(0,Math.min(1,f))*100,r.push(`${n.color} ${f.toFixed(2)}%`),r.push(`${l.color} ${f.toFixed(2)}%`)}else if(Math.abs(d-.5)>.001){const f=n.position+(l.position-n.position)*d;let p=Math.pow(f,1/o)*100;p=Math.max(0,Math.min(100,p)),r.push(`${p.toFixed(2)}%`)}}}return`linear-gradient(90deg, ${r.join(", ")})`},at=e=>Math.pow(e/255,2.2)*255,rt=e=>{const o=e/255;if(o>=.99)return 255;const t=(Math.sqrt(-10127*o*o+13702*o+9)+59*o-3)/(502-486*o);return Math.max(0,t)*255},Wt=e=>{const t=new Uint8Array(1024);let a,r="srgb";if(Array.isArray(e))a=e;else if(e&&Array.isArray(e.stops))a=e.stops,r=e.colorSpace||"srgb";else return t;if(a.length===0){for(let s=0;s<256;s++){const l=Math.floor(s/255*255);t[s*4]=l,t[s*4+1]=l,t[s*4+2]=l,t[s*4+3]=255}return t}const i=[...a].sort((s,l)=>s.position-l.position),n=s=>{let l={r:0,g:0,b:0};if(s<=i[0].position)l=We(i[0].color)||{r:0,g:0,b:0};else if(s>=i[i.length-1].position)l=We(i[i.length-1].color)||{r:0,g:0,b:0};else for(let d=0;d<i.length-1;d++)if(s>=i[d].position&&s<=i[d+1].position){const u=i[d],f=i[d+1];let p=(s-u.position)/(f.position-u.position);const h=u.bias??.5;Math.abs(h-.5)>.001&&(p=qr(p,h));const g=u.interpolation||"linear";g==="step"?p=0:(g==="smooth"||g==="cubic")&&(p=p*p*(3-2*p));const x=We(u.color)||{r:0,g:0,b:0},m=We(f.color)||{r:0,g:0,b:0};l=Ur(x,m,p);break}return r==="linear"?{r:at(l.r),g:at(l.g),b:at(l.b)}:r==="aces_inverse"?{r:rt(l.r),g:rt(l.g),b:rt(l.b)}:l};for(let s=0;s<256;s++){const l=s/255,d=n(l);t[s*4]=d.r,t[s*4+1]=d.g,t[s*4+2]=d.b,t[s*4+3]=255}return t},Wr=e=>{const o=Math.max(1e3,Math.min(4e4,e))/100;let t,a,r;return o<=66?t=255:(t=o-60,t=329.698727446*Math.pow(t,-.1332047592),t=Math.max(0,Math.min(255,t))),o<=66?(a=o,a=99.4708025861*Math.log(a)-161.1195681661,a=Math.max(0,Math.min(255,a))):(a=o-60,a=288.1221695283*Math.pow(a,-.0755148492),a=Math.max(0,Math.min(255,a))),o>=66?r=255:o<=19?r=0:(r=o-10,r=138.5177312231*Math.log(r)-305.0447927307,r=Math.max(0,Math.min(255,r))),{r:Math.round(t),g:Math.round(a),b:Math.round(r)}},mn=e=>{const{r:o,g:t,b:a}=Wr(e);return Gr(o,t,a)},Xr=(e,o)=>{const t={};return Vr(),F.getAll().forEach(r=>{const i={},n={};r.state&&Object.assign(i,r.state),Object.entries(r.params).forEach(([l,d])=>{d.composeFrom?d.composeFrom.forEach(u=>{n[u]=l}):i[l]===void 0&&(i[l]=d.default)}),t[r.id]=i;const s=`set${r.id.charAt(0).toUpperCase()+r.id.slice(1)}`;t[s]=l=>{let d=!1;const u={};e(f=>{const p=f[r.id],h={...l};Object.keys(l).forEach(m=>{const y=r.params[m];if(y){const b=l[m];if(b==null)return;y.type==="vec2"&&!(b instanceof be)&&(h[m]=new be(b.x,b.y)),y.type==="vec3"&&!(b instanceof A)&&(h[m]=new A(b.x,b.y,b.z)),y.type==="color"&&!(b instanceof le)&&(typeof b=="string"?h[m]=new le(b):typeof b=="number"?h[m]=new le(b):typeof b=="object"&&"r"in b&&(h[m]=new le(b.r,b.g,b.b)))}}),Object.keys(h).forEach(m=>{const y=r.params[m];if(y!=null&&y.onSet){const b=y.onSet(h[m],p);b&&Object.entries(b).forEach(([C,k])=>{l[C]===void 0&&(h[C]=k)})}});const g={...p,...h},x=new Set;return Object.keys(h).forEach(m=>{const y=r.params[m];if(n[m]&&x.add(n[m]),y&&(y.noReset||(d=!0),y.type!=="image"&&(u[r.id]||(u[r.id]={}),u[r.id][m]=g[m]),y.uniform)){const b=g[m];if(y.type==="image"){const C=y.uniform.toLowerCase().includes("env")?"env":"color";b&&typeof b=="string"?(R.emit("texture",{textureType:C,dataUrl:b}),m==="envMapData"&&g.useEnvMap===!1&&(g.useEnvMap=!0,R.emit("uniform",{key:"uUseEnvMap",value:1,noReset:!1})),m==="layer1Data"&&g.active===!1&&(g.active=!0,R.emit("uniform",{key:"uUseTexture",value:1,noReset:!1}))):(R.emit("texture",{textureType:C,dataUrl:null}),m==="envMapData"&&g.useEnvMap===!0&&(g.useEnvMap=!1,R.emit("uniform",{key:"uUseEnvMap",value:0,noReset:!1})),m==="layer1Data"&&g.active===!0&&(g.active=!1,R.emit("uniform",{key:"uUseTexture",value:0,noReset:!1})))}else if(y.type==="gradient"){const C=Wt(b);R.emit("uniform",{key:y.uniform,value:{isGradientBuffer:!0,buffer:C},noReset:!!y.noReset})}else{let C=b;y.type==="boolean"&&(C=b?1:0),y.type==="color"&&!(C instanceof le)&&(C=new le(C)),R.emit("uniform",{key:y.uniform,value:C,noReset:!!y.noReset})}}}),x.forEach(m=>{const y=r.params[m];if(y&&y.composeFrom&&y.uniform){const b=y.composeFrom.map(C=>g[C]);if(y.type==="gradient"){const C=g[m];if(C){const k=Wt(C);R.emit("uniform",{key:y.uniform,value:{isGradientBuffer:!0,buffer:k},noReset:!!y.noReset}),y.noReset||(d=!0)}}else if(y.type==="vec2"){const C=new be(b[0],b[1]);R.emit("uniform",{key:y.uniform,value:C,noReset:!!y.noReset}),y.noReset||(d=!0)}else if(y.type==="vec3"){const C=new A(b[0],b[1],b[2]);R.emit("uniform",{key:y.uniform,value:C,noReset:!!y.noReset}),y.noReset||(d=!0)}}}),{[r.id]:g}}),Object.keys(u).length>0&&R.emit("config",u),d&&R.emit("reset_accum",void 0)},r.actions&&Object.entries(r.actions).forEach(([l,d])=>{t[l]=u=>{const p=o()[r.id],h=d(p,u);h&&Object.keys(h).length>0&&(e({[r.id]:{...p,...h}}),R.emit("reset_accum",void 0))}})}),t},Yr={id:"shadows",label:"Shadows",renderContext:"direct",controlledParams:["lighting.shadowsCompile","lighting.shadowAlgorithm","lighting.ptStochasticShadows"],tiers:[{label:"Off",overrides:{lighting:{shadows:!1,shadowsCompile:!1,ptStochasticShadows:!1}},estCompileMs:0},{label:"Hard",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:2,ptStochasticShadows:!1}},estCompileMs:500},{label:"Soft",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!1}},estCompileMs:3e3},{label:"Full",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!0}},estCompileMs:3800}]},Kr={id:"reflections",label:"Reflections (Direct)",renderContext:"direct",controlledParams:["reflections.reflectionMode","reflections.bounceShadows","reflections.bounces"],tiers:[{label:"Off",overrides:{reflections:{reflectionMode:0,bounceShadows:!1}},estCompileMs:0},{label:"Env Map",overrides:{reflections:{reflectionMode:1,bounceShadows:!1}},estCompileMs:0},{label:"Raymarched",overrides:{reflections:{reflectionMode:3,bounceShadows:!1,bounces:1}},estCompileMs:7500},{label:"Full",overrides:{reflections:{reflectionMode:3,bounceShadows:!0,bounces:2}},estCompileMs:12e3}]},Jr={id:"lighting_quality",label:"Lighting",isAdvanced:!0,controlledParams:["lighting.specularModel","lighting.ptEnabled","lighting.ptNEEAllLights","lighting.ptEnvNEE"],tiers:[{label:"Preview",overrides:{lighting:{advancedLighting:!1,ptEnabled:!1}},estCompileMs:-2500},{label:"Path Traced",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!1,ptEnvNEE:!1}},estCompileMs:1900},{label:"PT + NEE",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!0,ptEnvNEE:!0}},estCompileMs:2500}]},Zr={id:"atmosphere_quality",label:"Atmosphere",controlledParams:["atmosphere.glowEnabled","atmosphere.glowQuality","volumetric.ptVolumetric"],tiers:[{label:"Off",overrides:{atmosphere:{glowEnabled:!1},volumetric:{ptVolumetric:!1}},estCompileMs:0},{label:"Fast Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:1},volumetric:{ptVolumetric:!1}},estCompileMs:200},{label:"Color Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!1}},estCompileMs:400},{label:"Volumetric",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!0}},estCompileMs:5900}]},yt=[Yr,Kr,Jr,Zr],Ge=[{id:"preview",label:"Preview",description:"Instant preview shader — navigate without waiting for compile.",subsystems:{shadows:0,reflections:0,lighting_quality:0,atmosphere_quality:0}},{id:"fastest",label:"Fastest",description:"Path traced lighting with fast glow.",subsystems:{shadows:0,reflections:0,lighting_quality:1,atmosphere_quality:1}},{id:"lite",label:"Lite",description:"Hard shadows, env map reflections, color glow.",subsystems:{shadows:1,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"balanced",label:"Balanced",description:"Soft shadows, env map reflections, color glow.",subsystems:{shadows:2,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"full",label:"Full",description:"Full shadows, raymarched reflections, volumetric.",subsystems:{shadows:3,reflections:3,lighting_quality:1,atmosphere_quality:3}},{id:"ultra",label:"Ultra",description:"Full + PT NEE. Experimental.",isAdvanced:!0,subsystems:{shadows:3,reflections:3,lighting_quality:2,atmosphere_quality:3}}],Qr={activePreset:"balanced",subsystems:{...Ge[3].subsystems},isCustomized:!1};function ei(e){return Ge.find(o=>o.id===e)}function ti(e){for(const o of Ge)if(Object.keys(o.subsystems).every(a=>o.subsystems[a]===e[a]))return o.id;return null}function gn(e){if(!e.activePreset)return"Custom";const o=ei(e.activePreset);if(!o)return"Custom";if(!e.isCustomized)return o.label;const t=[];for(const a of yt){const r=o.subsystems[a.id],i=e.subsystems[a.id];if(r!==i){const n=a.tiers[i];t.push(`${a.label}=${(n==null?void 0:n.label)??"?"}`)}}return`${o.label} (${t.join(", ")})`}const oi=4200;function yn(e){let o=oi;for(const t of yt){const a=e[t.id]??0,r=t.tiers[a];r&&(o+=r.estCompileMs)}return o}let ft=null;function ai(e){ft=e}function Xt(e,o){const t=o(),a={};for(const r of yt){const i=e[r.id]??0,n=r.tiers[i];if(n)for(const[s,l]of Object.entries(n.overrides))a[s]||(a[s]={}),Object.assign(a[s],l)}for(const[r,i]of Object.entries(a)){const n=`set${r.charAt(0).toUpperCase()+r.slice(1)}`,s=t[n];typeof s=="function"&&s(i)}}function ri(e){if(!ft)return;const o=ft(e());R.emit(se.CONFIG,o)}const ii=(e,o)=>({scalability:{...Qr},hardwareProfile:null,applyScalabilityPreset:t=>{const a=Ge.find(r=>r.id===t);a&&(e({scalability:{activePreset:t,subsystems:{...a.subsystems},isCustomized:!1}}),Xt(a.subsystems,o))},setSubsystemTier:(t,a)=>{const r=o().scalability,i={...r.subsystems,[t]:a};let n=!1;if(r.activePreset){const l=Ge.find(d=>d.id===r.activePreset);l&&(n=Object.keys(i).some(d=>i[d]!==l.subsystems[d]))}else n=!0;const s=ti(i);e({scalability:{activePreset:s??r.activePreset,subsystems:i,isCustomized:s?!1:n}}),Xt(i,o)},setHardwareProfile:t=>{e({hardwareProfile:t});const r=o().setQuality;typeof r=="function"&&r({compilerHardCap:t.caps.compilerHardCap,precisionMode:t.caps.precisionMode,bufferPrecision:t.caps.bufferPrecision}),ri(o)}});class pt{constructor(o,t=null){M(this,"defaultState");M(this,"dictionary");M(this,"reverseDictCache",new Map);this.defaultState=o,this.dictionary=t}encode(o,t){try{const a=this.getDiff(o,this.defaultState);if(!a||Object.keys(a).length===0)return"";let r=this.quantize(a);if(!r||Object.keys(r).length===0)return"";this.dictionary&&(r=this.applyDictionary(r,this.dictionary,!0));const i=JSON.stringify(r),n=Et.deflate(i),s=Array.from(n).map(d=>String.fromCharCode(d)).join("");return btoa(s).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}catch(a){return console.error("UrlStateEncoder: Error encoding",a),""}}decode(o){try{if(!o)return null;let t=o.replace(/-/g,"+").replace(/_/g,"/");for(;t.length%4;)t+="=";const a=atob(t),r=new Uint8Array(a.length);for(let s=0;s<a.length;s++)r[s]=a.charCodeAt(s);const i=Et.inflate(r,{to:"string"});let n=JSON.parse(i);return this.dictionary&&(n=this.applyDictionary(n,this.dictionary,!1)),this.deepMerge({...this.defaultState},n)}catch(t){return console.error("UrlStateEncoder: Error decoding",t),null}}getReverseDict(o){if(this.reverseDictCache.has(o))return this.reverseDictCache.get(o);const t={};return Object.keys(o).forEach(a=>{const r=o[a];typeof r=="string"?t[r]=a:t[r._alias]=a}),this.reverseDictCache.set(o,t),t}applyDictionary(o,t,a){if(!o||typeof o!="object"||Array.isArray(o))return o;const r={};if(a)Object.keys(o).forEach(i=>{let n=i,s=null;const l=t[i];l&&(typeof l=="string"?n=l:(n=l._alias,s=l.children));const d=o[i];s&&d&&typeof d=="object"&&!Array.isArray(d)?r[n]=this.applyDictionary(d,s,!0):r[n]=d});else{const i=this.getReverseDict(t);Object.keys(o).forEach(n=>{const s=i[n]||n,l=o[n],d=t[s],u=d&&typeof d=="object"?d.children:null;u&&l&&typeof l=="object"&&!Array.isArray(l)?r[s]=this.applyDictionary(l,u,!1):r[s]=l})}return r}isEqual(o,t){if(o===t)return!0;if(o==null||t==null)return o===t;if(typeof o=="number"&&typeof t=="number")return Math.abs(o-t)<1e-4;if(Array.isArray(o)&&Array.isArray(t))return o.length!==t.length?!1:o.every((a,r)=>this.isEqual(a,t[r]));if(typeof o=="object"&&typeof t=="object"){const a=o,r=t,i=Object.keys(a).filter(s=>!s.startsWith("is")),n=Object.keys(r).filter(s=>!s.startsWith("is"));return i.length!==n.length?!1:i.every(s=>this.isEqual(a[s],r[s]))}return!1}quantize(o){if(typeof o=="string")return o.startsWith("data:image")?void 0:o;if(typeof o=="number")return o===0||Math.abs(o)<1e-9?0:parseFloat(o.toFixed(5));if(Array.isArray(o))return o.map(t=>this.quantize(t));if(o!==null&&typeof o=="object"){const t={};let a=!1;const r=Object.keys(o).filter(i=>!i.startsWith("is"));for(const i of r){const n=this.quantize(o[i]);n!==void 0&&(t[i]=n,a=!0)}return a?t:void 0}return o}getDiff(o,t){if(this.isEqual(o,t))return;if(typeof o!="object"||o===null||typeof t!="object"||t===null||Array.isArray(o))return o;const a={};let r=!1;const i=o,n=t;return Object.keys(i).forEach(s=>{if(s.startsWith("is")||s==="histogramData"||s==="interactionSnapshot"||s==="liveModulations"||s.endsWith("Stack"))return;const l=this.getDiff(i[s],n[s]);l!==void 0&&(a[s]=l,r=!0)}),r?a:void 0}deepMerge(o,t){if(typeof t!="object"||t===null)return t;const a={...o};return Object.keys(t).forEach(r=>{typeof t[r]=="object"&&t[r]!==null&&!Array.isArray(t[r])?a[r]=this.deepMerge(o[r]||{},t[r]):a[r]=t[r]}),a}}const ni=(e,o)=>({isPlaying:!1,isRecording:!1,isScrubbing:!1,recordCamera:!0,isCameraInteracting:!1,currentFrame:0,fps:30,durationFrames:300,zoomLevel:1,loopMode:"Loop",isArmingModulation:!1,isRecordingModulation:!1,recordingSnapshot:null,play:()=>{const t=o();if(t.currentFrame>=t.durationFrames-.1&&e({currentFrame:0}),t.isArmingModulation){t.snapshot();const a=JSON.parse(JSON.stringify(t.sequence));e({isRecordingModulation:!0,isArmingModulation:!1,recordingSnapshot:a,isPlaying:!0,currentFrame:0})}else e({isPlaying:!0})},pause:()=>e({isPlaying:!1,isRecordingModulation:!1,recordingSnapshot:null}),stop:()=>e({isPlaying:!1,currentFrame:0,isRecordingModulation:!1,recordingSnapshot:null}),toggleRecording:()=>e(t=>({isRecording:!t.isRecording})),toggleRecordCamera:()=>e(t=>({recordCamera:!t.recordCamera})),toggleArmModulation:()=>e(t=>({isArmingModulation:!t.isArmingModulation,isRecording:!1})),stopModulationRecording:()=>e({isRecordingModulation:!1,isPlaying:!1,recordingSnapshot:null}),setLoopMode:t=>e({loopMode:t}),setIsScrubbing:t=>e({isScrubbing:t}),setIsCameraInteracting:t=>e({isCameraInteracting:t}),seek:t=>e({currentFrame:Math.max(0,Math.min(o().durationFrames,t))}),setDuration:t=>{e({durationFrames:t})},setFps:t=>{e({fps:t})}}),si=(e,o)=>({selectedTrackIds:[],selectedKeyframeIds:[],softSelectionRadius:0,softSelectionEnabled:!1,softSelectionType:"S-Curve",bounceTension:.5,bounceFriction:.6,selectTrack:(t,a)=>e(r=>({selectedTrackIds:a?r.selectedTrackIds.includes(t)?r.selectedTrackIds.filter(i=>i!==t):[...r.selectedTrackIds,t]:[t]})),selectTracks:(t,a)=>e(r=>{const i=new Set(r.selectedTrackIds);return a?t.forEach(n=>i.add(n)):t.forEach(n=>i.delete(n)),{selectedTrackIds:Array.from(i)}}),selectKeyframe:(t,a,r)=>e(i=>{const n=`${t}::${a}`;return{selectedKeyframeIds:r?i.selectedKeyframeIds.includes(n)?i.selectedKeyframeIds.filter(s=>s!==n):[...i.selectedKeyframeIds,n]:[n]}}),selectKeyframes:(t,a)=>e(r=>({selectedKeyframeIds:a?Array.from(new Set([...r.selectedKeyframeIds,...t])):t})),deselectAll:()=>e({selectedTrackIds:[],selectedKeyframeIds:[]}),deselectAllKeys:()=>e({selectedKeyframeIds:[]}),setSoftSelection:(t,a)=>e({softSelectionRadius:t,softSelectionEnabled:a}),setSoftSelectionType:t=>e({softSelectionType:t}),setBouncePhysics:(t,a)=>e({bounceTension:t,bounceFriction:a})});function So(e,o,t,a,r){const i=1-e,n=e*e,s=i*i,l=s*i,d=n*e;return l*o+3*s*e*t+3*i*n*a+d*r}function Yt(e,o){let t=o[0],a=o[o.length-1];for(let u=0;u<o.length-1;u++)if(e>=o[u].frame&&e<o[u+1].frame){t=o[u],a=o[u+1];break}if(e>=a.frame)return a.value;if(e<=t.frame)return t.value;const r=a.frame-t.frame,i=(e-t.frame)/r;if(t.interpolation==="Step")return t.value;if(t.interpolation==="Linear")return t.value+(a.value-t.value)*i;const n=t.value,s=t.value+(t.rightTangent?t.rightTangent.y:0),l=a.value+(a.leftTangent?a.leftTangent.y:0),d=a.value;return So(i,n,s,l,d)}function li(e,o=1){const t=[],a=e[0].frame,r=e[e.length-1].frame,i=Math.max(o,(r-a)/50);for(let n=a;n<=r;n+=i)t.push({t:n,val:Yt(n,e)});return t.length>0&&t[t.length-1].t<r&&t.push({t:r,val:Yt(r,e)}),t}function ci(e,o,t){let a=0,r=0,i=0,n=0,s=0,l=0,d=0;for(let m=0;m<e.length;m++){const y=e[m].t,b=1-y,C=e[m].val;l+=C,d+=C*C;const k=3*b*b*y,w=3*b*y*y,I=b*b*b*o+y*y*y*t,E=C-I;a+=k*k,r+=k*w,i+=w*w,n+=E*k,s+=E*w}const u=e.length,f=l/u;if(d/u-f*f<1e-9)return null;const h=a*i-r*r;if(Math.abs(h)<1e-9)return null;const g=(i*n-r*s)/h,x=(a*s-r*n)/h;return{h1:g,h2:x}}function di(e,o){const t=e.length;if(t<2){const h=e[0].val;return{leftY:h,rightY:h}}const a=e[0].val,r=e[t-1].val,i=r-a,n=a+i*.333,s=a+i*.666,l=ci(e,a,r);let d=n,u=s;l&&(d=l.h1,u=l.h2);const f=n+(d-n)*o,p=s+(u-s)*o;return{leftY:f,rightY:p}}function ht(e,o,t,a){if(e.length<2)return;const r=e[0],i=e[e.length-1],n=i.t-r.t,s=e.map(p=>({t:(p.t-r.t)/n,val:p.val})),{leftY:l,rightY:d}=di(s,a);let u=0,f=-1;if(n<1)u=0;else for(let p=1;p<s.length-1;p++){const h=s[p].t,g=So(h,r.val,l,d,i.val),x=Math.abs(g-s[p].val);x>u&&(u=x,f=p)}if(u<=t||e.length<=2){const p=o[o.length-1];p&&(p.rightTangent={x:n*.333,y:l-r.val});const h={id:we(),frame:i.t,value:i.val,interpolation:"Bezier",brokenTangents:!1,autoTangent:!1,leftTangent:{x:-n*.333,y:d-i.val},rightTangent:{x:1,y:0}};o.push(h)}else{const p=e.slice(0,f+1),h=e.slice(f);ht(p,o,t,a),ht(h,o,t,a)}}const ui=(e,o,t=1)=>{if(e.length<2)return e;t=Math.max(0,Math.min(1,t));const a=[...e].sort((s,l)=>s.frame-l.frame),r=li(a,1),i=[],n=r[0];return i.push({id:we(),frame:n.t,value:n.val,interpolation:"Bezier",brokenTangents:!1,autoTangent:!1,leftTangent:{x:-1,y:0},rightTangent:{x:1,y:0}}),ht(r,i,o,t),i.length>0&&(i[0].leftTangent={x:-1,y:0},i[i.length-1].rightTangent={x:1,y:0}),i},fi=4;function wo(e,o,t,a,r){const i=1-e,n=e*e,s=i*i,l=s*i,d=n*e;return l*o+3*s*e*t+3*i*n*a+d*r}function pi(e,o,t,a,r){const i=1-e;return 3*i*i*(t-o)+6*i*e*(a-t)+3*e*e*(r-a)}function hi(e,o,t,a,r){const i=r-o;if(i<=1e-9)return 0;let n=(e-o)/i;for(let s=0;s<fi;++s){const l=wo(n,o,t,a,r),d=pi(n,o,t,a,r);if(Math.abs(d)<1e-9)break;const u=l-e;n-=u/d}return Math.max(0,Math.min(1,n))}function mi(e,o,t,a,r,i,n,s,l){const d=o,u=t,f=o+a,p=t+r,h=i+s,g=n+l,x=i,m=n,y=hi(e,d,f,h,x);return wo(y,u,p,g,m)}const ye=.333,Re={interpolate:(e,o,t,a=!1)=>{if(o.interpolation==="Step")return o.value;let r=o.value,i=t.value;if(a){const l=Math.PI*2,d=i-r;d>Math.PI?i-=l:d<-Math.PI&&(i+=l)}if(o.interpolation==="Bezier"){const l=o.rightTangent?o.rightTangent.x:(t.frame-o.frame)*ye,d=o.rightTangent?o.rightTangent.y:0,u=t.leftTangent?t.leftTangent.x:-(t.frame-o.frame)*ye,f=t.leftTangent?t.leftTangent.y:0;return mi(e,o.frame,r,l,d,t.frame,i,u,f)}const n=t.frame-o.frame;if(n<1e-9)return r;const s=(e-o.frame)/n;return r+(i-r)*s},scaleHandles:(e,o,t,a,r)=>{const i={};if(e.interpolation!=="Bezier")return i;if(o&&e.leftTangent){const n=a-o.frame,s=r-o.frame;if(Math.abs(n)>1e-5&&Math.abs(s)>1e-5){const l=s/n;i.leftTangent={x:e.leftTangent.x*l,y:e.leftTangent.y*l}}}if(t&&e.rightTangent){const n=t.frame-a,s=t.frame-r;if(Math.abs(n)>1e-5&&Math.abs(s)>1e-5){const l=s/n;i.rightTangent={x:e.rightTangent.x*l,y:e.rightTangent.y*l}}}return i},calculateTangents:(e,o,t,a)=>{if(a==="Ease"){const m=o?(e.frame-o.frame)*ye:10,y=t?(t.frame-e.frame)*ye:10;return{l:{x:-m,y:0},r:{x:y,y:0}}}if(!o&&!t)return{l:{x:-10,y:0},r:{x:10,y:0}};if(!o){const m=(t.value-e.value)/(t.frame-e.frame),y=(t.frame-e.frame)*ye;return{l:{x:-10,y:0},r:{x:y,y:y*m}}}if(!t){const m=(e.value-o.value)/(e.frame-o.frame),y=(e.frame-o.frame)*ye;return{l:{x:-y,y:-y*m},r:{x:10,y:0}}}const r=e.frame-o.frame,i=e.value-o.value,n=r===0?0:i/r,s=t.frame-e.frame,l=t.value-e.value,d=s===0?0:l/s;if(n*d<=0){const m=r*ye,y=s*ye;return{l:{x:-m,y:0},r:{x:y,y:0}}}const u=t.frame-o.frame,f=t.value-o.value;let p=u===0?0:f/u;const h=3*Math.min(Math.abs(n),Math.abs(d));Math.abs(p)>h&&(p=Math.sign(p)*h);const g=r*ye,x=s*ye;return{l:{x:-g,y:-g*p},r:{x,y:x*p}}},constrainHandles:(e,o,t)=>{var r,i;const a={};if(e.leftTangent&&o){const n=e.frame-o.frame;if(n>.001){const s=n*ye;if(Math.abs(e.leftTangent.x)>s){const l=s/Math.abs(e.leftTangent.x);a.leftTangent={x:e.leftTangent.x*l,y:e.leftTangent.y*l}}e.leftTangent.x>0&&(a.leftTangent={x:0,y:((r=a.leftTangent)==null?void 0:r.y)??e.leftTangent.y})}}if(e.rightTangent&&t){const n=t.frame-e.frame;if(n>.001){const s=n*ye;if(Math.abs(e.rightTangent.x)>s){const l=s/Math.abs(e.rightTangent.x);a.rightTangent={x:e.rightTangent.x*l,y:e.rightTangent.y*l}}e.rightTangent.x<0&&(a.rightTangent={x:0,y:((i=a.rightTangent)==null?void 0:i.y)??e.rightTangent.y})}}return a},calculateSoftFalloff:(e,o,t)=>{if(e>=o)return 0;const a=e/o;switch(t){case"Linear":return 1-a;case"Dome":return Math.sqrt(1-a*a);case"Pinpoint":return Math.pow(1-a,4);case"S-Curve":return .5*(1+Math.cos(a*Math.PI));default:return 1-a}}},it={updateNeighbors:(e,o)=>{const t=e[o],a=o===e.length-1,r=o-1;if(r>=0){const n={...e[r]};if(e[r]=n,n.interpolation==="Bezier"){const s=t.frame-n.frame;if(n.autoTangent){const l=e[r-1],{l:d,r:u}=Re.calculateTangents(n,l,t,"Auto");n.leftTangent=d,n.rightTangent=u}else{const l=Re.constrainHandles(n,e[r-1],t);Object.assign(n,l)}if(a&&s>1e-4){const l=s*.3,d=n.rightTangent||{x:10,y:0};if(d.x<l){const u=l/Math.max(1e-4,Math.abs(d.x));n.rightTangent={x:l,y:d.y*u}}}}}const i=o+1;if(i<e.length){const n={...e[i]};if(e[i]=n,n.interpolation==="Bezier")if(n.autoTangent){const s=e[i+1],{l,r:d}=Re.calculateTangents(n,t,s,"Auto");n.leftTangent=l,n.rightTangent=d}else{const s=Re.constrainHandles(n,t,e[i+1]);Object.assign(n,s)}}},inferInterpolation:(e,o)=>{const t=e.filter(a=>a.frame<o).sort((a,r)=>r.frame-a.frame);return t.length===0||t[0].interpolation==="Linear"?"Linear":t[0].interpolation==="Step"?"Step":"Bezier"}},gi=Te(),yi={durationFrames:300,fps:30,tracks:{}},bi=(e,o)=>({sequence:yi,clipboard:null,undoStack:[],redoStack:[],snapshot:()=>{const t=o().sequence,a=JSON.parse(JSON.stringify(t));e(r=>{const i=[...r.undoStack,{type:"SEQUENCE",data:a}];return{undoStack:i.length>50?i.slice(1):i,redoStack:[]}})},undo:()=>{const{undoStack:t,redoStack:a,sequence:r}=o();if(t.length===0)return!1;const i=t[t.length-1],n=t.slice(0,-1),l={type:"SEQUENCE",data:JSON.parse(JSON.stringify(r))};return e({sequence:i.data,undoStack:n,redoStack:[l,...a]}),!0},redo:()=>{const{undoStack:t,redoStack:a,sequence:r}=o();if(a.length===0)return!1;const i=a[0],n=a.slice(1),l={type:"SEQUENCE",data:JSON.parse(JSON.stringify(r))};return e({sequence:i.data,undoStack:[...t,l],redoStack:n}),!0},setSequence:t=>{o().snapshot(),e({sequence:t})},addTrack:(t,a)=>{o().snapshot(),e(r=>r.sequence.tracks[t]?r:{sequence:{...r.sequence,tracks:{...r.sequence.tracks,[t]:{id:t,type:"float",label:a,keyframes:[]}}}})},removeTrack:t=>{o().snapshot(),e(a=>{const r={...a.sequence.tracks};return delete r[t],{sequence:{...a.sequence,tracks:r},selectedTrackIds:a.selectedTrackIds.filter(i=>i!==t)}})},setTrackBehavior:(t,a)=>{o().snapshot(),e(r=>{const i=r.sequence.tracks[t];return i?{sequence:{...r.sequence,tracks:{...r.sequence.tracks,[t]:{...i,postBehavior:a}}}}:r})},addKeyframe:(t,a,r,i)=>{e(n=>{const s=n.sequence.tracks[t];if(!s)return n;let l=i||"Bezier";i||(l=it.inferInterpolation(s.keyframes,a));const d=l==="Bezier",u={id:we(),frame:a,value:r,interpolation:l,autoTangent:d,brokenTangents:!1},p=[...s.keyframes.filter(g=>Math.abs(g.frame-a)>.001),u].sort((g,x)=>g.frame-x.frame),h=p.findIndex(g=>g.id===u.id);if(l==="Bezier"){const g=h>0?p[h-1]:void 0,x=h<p.length-1?p[h+1]:void 0,{l:m,r:y}=Re.calculateTangents(u,g,x,"Auto");u.leftTangent=m,u.rightTangent=y}return it.updateNeighbors(p,h),{sequence:{...n.sequence,tracks:{...n.sequence.tracks,[t]:{...s,keyframes:p}}}}})},batchAddKeyframes:(t,a,r)=>{e(i=>{const n={...i.sequence.tracks};let s=!1;return a.forEach(({trackId:l,value:d})=>{n[l]||(n[l]={id:l,type:"float",label:l,keyframes:[]},s=!0);const u=n[l],f=[...u.keyframes],p=f.length>0?f[f.length-1]:null,h={id:we(),frame:t,value:d,interpolation:r||"Linear",autoTangent:r==="Bezier",brokenTangents:!1};if(p)if(t>p.frame)f.push(h);else if(Math.abs(t-p.frame)<.001)h.id=p.id,f[f.length-1]=h;else{const g=f.filter(x=>Math.abs(x.frame-t)>.001);g.push(h),g.sort((x,m)=>x.frame-m.frame),u.keyframes=g,s=!0;return}else f.push(h);u.keyframes=f,s=!0}),s?{sequence:{...i.sequence,tracks:n}}:i})},removeKeyframe:(t,a)=>{o().snapshot(),e(r=>{const i=r.sequence.tracks[t];return i?{sequence:{...r.sequence,tracks:{...r.sequence.tracks,[t]:{...i,keyframes:i.keyframes.filter(n=>n.id!==a)}}}}:r})},updateKeyframe:(t,a,r)=>{e(i=>{const n=i.sequence.tracks[t];if(!n)return i;const s=n.keyframes.map(l=>l.id===a?{...l,...r}:l).sort((l,d)=>l.frame-d.frame);return{sequence:{...i.sequence,tracks:{...i.sequence.tracks,[t]:{...n,keyframes:s}}}}})},updateKeyframes:t=>{e(a=>{const r={...a.sequence.tracks};return t.forEach(({trackId:i,keyId:n,patch:s})=>{const l=r[i];if(l){const d=l.keyframes.findIndex(u=>u.id===n);if(d!==-1){const u=l.keyframes[d];s.interpolation==="Bezier"&&u.interpolation!=="Bezier"&&(s.autoTangent=!0),l.keyframes[d]={...u,...s}}}}),Object.keys(r).forEach(i=>{r[i].keyframes.sort((n,s)=>n.frame-s.frame)}),{sequence:{...a.sequence,tracks:r}}})},deleteSelectedKeyframes:()=>{o().snapshot(),e(t=>{const a={...t.sequence.tracks},r=new Set(t.selectedKeyframeIds);return Object.keys(a).forEach(i=>{a[i]={...a[i],keyframes:a[i].keyframes.filter(n=>!r.has(`${i}::${n.id}`))}}),{sequence:{...t.sequence,tracks:a},selectedKeyframeIds:[]}})},deleteAllKeys:()=>{o().snapshot(),e(t=>{const a={...t.sequence.tracks};return Object.keys(a).forEach(r=>{a[r]={...a[r],keyframes:[]}}),{sequence:{...t.sequence,tracks:a},selectedKeyframeIds:[]}})},deleteAllTracks:()=>{o().snapshot(),e({sequence:{...o().sequence,tracks:{}},selectedTrackIds:[],selectedKeyframeIds:[]})},setTangents:t=>{o().snapshot(),e(a=>{const r={...a.sequence.tracks};return a.selectedKeyframeIds.forEach(i=>{const[n,s]=i.split("::"),l=r[n];if(l){const d=l.keyframes.findIndex(f=>f.id===s);if(d===-1)return;const u=l.keyframes[d];if(t==="Split")l.keyframes[d]={...u,brokenTangents:!0,autoTangent:!1};else if(t==="Unified"){let f=u.rightTangent,p=u.leftTangent;if(f&&p){const h=Math.sqrt(f.x*f.x+f.y*f.y),g=Math.sqrt(p.x*p.x+p.y*p.y);f={x:-p.x*(h/Math.max(.001,g)),y:-p.y*(h/Math.max(.001,g))}}l.keyframes[d]={...u,rightTangent:f,brokenTangents:!1,autoTangent:!1}}else if(t==="Auto"||t==="Ease"){const f=l.keyframes[d-1],p=l.keyframes[d+1],{l:h,r:g}=Re.calculateTangents(u,f,p,t);l.keyframes[d]={...u,autoTangent:t==="Auto",brokenTangents:!1,leftTangent:h,rightTangent:g}}}}),{sequence:{...a.sequence,tracks:r}}})},setGlobalInterpolation:(t,a)=>{o().snapshot(),e(r=>{const i={...r.sequence.tracks};return Object.keys(i).forEach(n=>{const s=i[n];s.keyframes.length!==0&&s.keyframes.forEach((l,d)=>{if(l.interpolation=t,t==="Bezier"&&a){const u=s.keyframes[d-1],f=s.keyframes[d+1],{l:p,r:h}=Re.calculateTangents(l,u,f,a);l.leftTangent=p,l.rightTangent=h,l.autoTangent=a==="Auto",l.brokenTangents=!1}})}),{sequence:{...r.sequence,tracks:i}}})},copySelectedKeyframes:()=>{const{sequence:t,selectedKeyframeIds:a}=o();if(a.length===0)return;let r=1/0;a.forEach(n=>{var u,f;const[s,l]=n.split("::"),d=(f=(u=t.tracks[s])==null?void 0:u.keyframes.find(p=>p.id===l))==null?void 0:f.frame;d!==void 0&&d<r&&(r=d)});const i=[];a.forEach(n=>{var u;const[s,l]=n.split("::"),d=(u=t.tracks[s])==null?void 0:u.keyframes.find(f=>f.id===l);d&&i.push({relativeFrame:d.frame-r,value:d.value,interpolation:d.interpolation,leftTangent:d.leftTangent,rightTangent:d.rightTangent,originalTrackId:s})}),i.length>0&&e({clipboard:i})},pasteKeyframes:t=>{const{clipboard:a,currentFrame:r}=o();a&&(o().snapshot(),e(i=>{const n={...i.sequence.tracks},s=t!==void 0?t:r;return a.forEach(l=>{const d=n[l.originalTrackId];if(d){const u=s+l.relativeFrame,f={id:we(),frame:u,value:l.value,interpolation:l.interpolation,leftTangent:l.leftTangent,rightTangent:l.rightTangent,autoTangent:!1,brokenTangents:!1};d.keyframes=[...d.keyframes.filter(p=>Math.abs(p.frame-u)>.001),f].sort((p,h)=>p.frame-h.frame)}}),{sequence:{...i.sequence,tracks:n}}}))},duplicateSelection:()=>{o().copySelectedKeyframes(),o().pasteKeyframes(o().currentFrame)},loopSelection:t=>{const a=o();if(a.selectedKeyframeIds.length<1)return;a.snapshot();let r=1/0,i=-1/0;if(a.selectedKeyframeIds.forEach(s=>{const[l,d]=s.split("::"),u=a.sequence.tracks[l],f=u==null?void 0:u.keyframes.find(p=>p.id===d);f&&(f.frame<r&&(r=f.frame),f.frame>i&&(i=f.frame))}),r===1/0||i===-1/0)return;const n=Math.max(1,i-r);e(s=>{const l={...s.sequence.tracks};for(let d=1;d<=t;d++){const u=n*d;s.selectedKeyframeIds.forEach(f=>{const[p,h]=f.split("::"),g=l[p];if(!g)return;const x=g.keyframes.find(m=>m.id===h);if(x){const m=x.frame+u,y={...x,id:we(),frame:m};g.keyframes=[...g.keyframes.filter(b=>Math.abs(b.frame-m)>.001),y]}})}return Object.values(l).forEach(d=>d.keyframes.sort((u,f)=>u.frame-f.frame)),{sequence:{...s.sequence,tracks:l}}})},captureCameraFrame:(t,a=!1,r)=>{const i=De()||gi.activeCamera;if(!i)return;a||o().snapshot();const n=Ve.getUnifiedFromEngine(),s=i.quaternion,l=new Ae().setFromQuaternion(s),d=[{id:"camera.unified.x",val:n.x,label:"Position X"},{id:"camera.unified.y",val:n.y,label:"Position Y"},{id:"camera.unified.z",val:n.z,label:"Position Z"},{id:"camera.rotation.x",val:l.x,label:"Rotation X"},{id:"camera.rotation.y",val:l.y,label:"Rotation Y"},{id:"camera.rotation.z",val:l.z,label:"Rotation Z"}];e(u=>{const f={...u.sequence.tracks},p=f["camera.unified.x"],h=!p||p.keyframes.length===0,g=r||(h?"Linear":"Bezier");return d.forEach(x=>{let m=f[x.id];m||(m={id:x.id,type:"float",label:x.label,keyframes:[],hidden:!1},f[x.id]=m);const y={id:we(),frame:t,value:x.val,interpolation:g,autoTangent:g==="Bezier",brokenTangents:!1},C=[...m.keyframes.filter(w=>Math.abs(w.frame-t)>.001),y].sort((w,I)=>w.frame-I.frame),k=C.findIndex(w=>w.id===y.id);if(g==="Bezier"){const w=k>0?C[k-1]:void 0,I=k<C.length-1?C[k+1]:void 0,{l:E,r:P}=Re.calculateTangents(y,w,I,"Auto");y.leftTangent=E,y.rightTangent=P}it.updateNeighbors(C,k),m.keyframes=C}),{sequence:{...u.sequence,tracks:f}}})},simplifySelectedKeys:(t=.01)=>{o().snapshot(),e(a=>{const r=a,i={...r.sequence.tracks},n=new Set(r.selectedKeyframeIds),s={};r.selectedKeyframeIds.forEach(d=>{const[u,f]=d.split("::");s[u]||(s[u]=[]);const p=r.sequence.tracks[u],h=p==null?void 0:p.keyframes.find(g=>g.id===f);h&&s[u].push(h)});const l=[];return Object.entries(s).forEach(([d,u])=>{const f=i[d];if(!f)return;const p={...f};if(i[d]=p,u.length<3)return;const h=u.sort((x,m)=>x.frame-m.frame);p.keyframes=p.keyframes.filter(x=>!n.has(`${d}::${x.id}`));const g=ui(h,t);p.keyframes=[...p.keyframes,...g].sort((x,m)=>x.frame-m.frame),g.forEach(x=>l.push(`${d}::${x.id}`))}),{sequence:{...r.sequence,tracks:i},selectedKeyframeIds:l}})}}),mt=ro()(io((e,o,t)=>({...ni(e,o),...si(e),...bi(e,o)})));typeof window<"u"&&(window.useAnimationStore=mt);const $e=Te(),Ke=e=>{const o={};return e&&Object.keys(e).forEach(t=>{if(t.startsWith("is"))return;const a=e[t];if(a&&typeof a=="object"&&"isColor"in a)o[t]="#"+a.getHexString();else if(a&&typeof a=="object"&&("isVector2"in a||"isVector3"in a)){const r={...a};delete r.isVector2,delete r.isVector3,o[t]=r}else o[t]=a}),o},_o=e=>{const o=pe.get(e),t=o&&o.defaultPreset?o.defaultPreset:{},a={version:5,name:e,formula:e,features:{}};return F.getAll().forEach(r=>{const i={};Object.entries(r.params).forEach(([n,s])=>{s.composeFrom||(i[n]=s.default)}),a.features[r.id]=Ke(i)}),t.features&&Object.entries(t.features).forEach(([r,i])=>{a.features[r]?a.features[r]={...a.features[r],...Ke(i)}:a.features[r]=Ke(i)}),t.lights&&(a.features.lighting||(a.features.lighting={}),a.features.lighting.lights=t.lights),t.renderMode&&(a.features.lighting||(a.features.lighting={}),a.features.lighting.renderMode=t.renderMode==="PathTracing"?1:0),a.cameraMode=t.cameraMode||"Orbit",a.quality={aaMode:"Always",aaLevel:1,msaa:1,accumulation:!0,...t.quality||{}},a.lights=[],a.animations=t.animations||[],a.navigation={flySpeed:.5,autoSlow:!0,...t.navigation||{}},a.sceneOffset=t.sceneOffset||{x:0,y:0,z:0,xL:0,yL:0,zL:0},a.cameraPos=t.cameraPos||{x:0,y:0,z:3.5},a.cameraRot=t.cameraRot||{x:0,y:0,z:0,w:1},a.targetDistance=t.targetDistance||3.5,a.duration=t.duration||300,a.sequence=t.sequence||{durationFrames:300,fps:30,tracks:{}},a},vi=(e,o,t)=>{const a=t(),r=e.features||{};if(e.renderMode&&(r.lighting||(r.lighting={}),r.lighting.renderMode===void 0&&(r.lighting.renderMode=e.renderMode==="PathTracing"?1:0)),r.atmosphere&&!r.ao){const b={};r.atmosphere.aoIntensity!==void 0&&(b.aoIntensity=r.atmosphere.aoIntensity),r.atmosphere.aoSpread!==void 0&&(b.aoSpread=r.atmosphere.aoSpread),r.atmosphere.aoMode!==void 0&&(b.aoMode=r.atmosphere.aoMode),r.atmosphere.aoEnabled!==void 0&&(b.aoEnabled=r.atmosphere.aoEnabled),Object.keys(b).length>0&&(r.ao=b)}const i=new Set(["compilerHardCap","precisionMode","bufferPrecision"]);if(F.getAll().forEach(b=>{const C=`set${b.id.charAt(0).toUpperCase()+b.id.slice(1)}`,k=a[C];if(typeof k=="function"){const w=r[b.id],I={},E=b.id==="quality"?t().quality:null;if(b.state&&Object.assign(I,b.state),Object.entries(b.params).forEach(([P,z])=>{if(b.id==="quality"&&i.has(P)&&E){I[P]=E[P];return}if(w&&w[P]!==void 0){let v=w[P];z.type==="vec2"&&v&&!(v instanceof be)?v=new be(v.x,v.y):z.type==="vec3"&&v&&!(v instanceof A)?v=new A(v.x,v.y,v.z):z.type==="color"&&v&&!(v instanceof le)&&(v=new le(v)),I[P]=v}else if(I[P]===void 0){let v=z.default;v&&typeof v=="object"&&(typeof v.clone=="function"?v=v.clone():Array.isArray(v)?v=[...v]:v={...v}),I[P]=v}}),b.id==="lighting"&&w){if(w.lights)I.lights=Gt(w.lights.map(P=>({...P,type:P.type||"Point",rotation:P.rotation||{x:0,y:0,z:0}})));else if(w.light0_posX!==void 0){const P=[];for(let z=0;z<3;z++)if(w[`light${z}_posX`]!==void 0){let v=w[`light${z}_color`]||"#ffffff";v.getHexString&&(v="#"+v.getHexString()),P.push({type:"Point",position:{x:w[`light${z}_posX`],y:w[`light${z}_posY`],z:w[`light${z}_posZ`]},rotation:{x:0,y:0,z:0},color:v,intensity:w[`light${z}_intensity`]??1,falloff:w[`light${z}_falloff`]??0,falloffType:w[`light${z}_type`]?"Linear":"Quadratic",fixed:w[`light${z}_fixed`]??!1,visible:w[`light${z}_visible`]??z===0,castShadow:w[`light${z}_castShadow`]??!0})}P.length>0&&(I.lights=P)}}b.id==="materials"&&w&&w.envMapVisible!==void 0&&w.envBackgroundStrength===void 0&&(I.envBackgroundStrength=w.envMapVisible?1:0),k(I)}}),e.lights&&e.lights.length>0){const b=a.setLighting;if(typeof b=="function"){const C=Gt(e.lights.map(k=>({...k,type:k.type||"Point",rotation:k.rotation||{x:0,y:0,z:0}})));b({lights:C})}}e.sequence&&mt.getState().setSequence(e.sequence),a.setAnimations(e.animations||[]),e.savedCameras&&Array.isArray(e.savedCameras)&&e.savedCameras.length>0&&o({savedCameras:e.savedCameras,activeCameraId:e.savedCameras[0].id||null});const n=e.cameraPos||{x:0,y:0,z:3.5},s=e.sceneOffset||{x:0,y:0,z:0,xL:0,yL:0,zL:0},l=e.targetDistance||3.5,d=e.cameraRot||{x:0,y:0,z:0,w:1},u=s.x+s.xL+n.x,f=s.y+s.yL+n.y,p=s.z+s.zL+n.z,h=B.split(u),g=B.split(f),x=B.split(p),m={x:h.high,y:g.high,z:x.high,xL:h.low,yL:g.low,zL:x.low};o({cameraRot:d,targetDistance:l,sceneOffset:m,cameraMode:e.cameraMode||t().cameraMode}),$e.activeCamera&&$e.virtualSpace&&$e.virtualSpace.applyCameraState($e.activeCamera,{position:{x:0,y:0,z:0},rotation:d,sceneOffset:m,targetDistance:l});const y={position:{x:0,y:0,z:0},rotation:d,sceneOffset:m,targetDistance:l};$e.pendingTeleport=y,R.emit("camera_teleport",y),e.duration&&mt.getState().setDuration(e.duration),e.formula==="Modular"&&a.refreshPipeline(),a.refreshHistogram(),R.emit("reset_accum",void 0)},xi={formula:"Mandelbulb",cameraPos:{x:0,y:0,z:0},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:0,xL:0,yL:0,zL:0},targetDistance:3.5,cameraMode:"Orbit"},Si=(e,o,t={includeAnimations:!0})=>{try{e.quality&&(delete e.quality.aaLevel,delete e.quality.aaMode,delete e.quality.msaa),e.features&&e.features.quality&&delete e.features.quality.resolutionMode,t.includeAnimations===!1&&(delete e.sequence,delete e.animations);const a=_o(e.formula);a.formula="";const r=F.getDictionary();return new pt(a,r).encode(e,o)}catch(a){return console.error("Sharing: Failed to generate share string",a),""}},bn=e=>{if(!e)return null;try{const o=F.getDictionary(),a=new pt(xi,o).decode(e);if(a&&a.formula){const r=_o(a.formula);return new pt(r,o).decode(e)}}catch(o){console.error("Sharing: Failed to load share string",o)}return null},nt=Te();class wi{constructor(){M(this,"pendingCam");M(this,"binders",new Map);M(this,"overriddenTracks",new Set);M(this,"lastCameraIndex",-1);M(this,"animStore",null);M(this,"fractalStore",null);this.pendingCam={rot:new Ae,unified:new A,rotDirty:!1,unifiedDirty:!1}}connect(o,t){this.animStore=o,this.fractalStore=t}setOverriddenTracks(o){this.overriddenTracks=o}getBinder(o){if(this.binders.has(o))return this.binders.get(o);let t=()=>{};if(o==="camera.active_index")t=a=>{const r=Math.round(a);if(r!==this.lastCameraIndex){const i=this.fractalStore.getState(),n=i.savedCameras;n&&n[r]&&(i.selectCamera(n[r].id),this.lastCameraIndex=r)}};else if(o.startsWith("camera.")){const a=o.split("."),r=a[1],i=a[2];r==="unified"?t=n=>{this.pendingCam.unified[i]=n,this.pendingCam.unifiedDirty=!0}:r==="rotation"&&(t=n=>{this.pendingCam.rot[i]=n,this.pendingCam.rotDirty=!0})}else if(o.startsWith("lights.")){const a=o.split("."),r=parseInt(a[1]),i=a[2];let n="";i==="position"?n=`pos${a[3].toUpperCase()}`:i==="color"?n="color":n=i;const s=`lighting.light${r}_${n}`;return this.getBinder(s)}else if(o.startsWith("lighting.light")){const a=o.match(/lighting\.light(\d+)_(\w+)/);if(a){const r=parseInt(a[1]),i=a[2],n=this.fractalStore.getState();if(i==="intensity")t=s=>n.updateLight({index:r,params:{intensity:s}});else if(i==="falloff")t=s=>n.updateLight({index:r,params:{falloff:s}});else if(i.startsWith("pos")){const s=i.replace("pos","").toLowerCase();t=l=>{var f;const u=(f=this.fractalStore.getState().lighting)==null?void 0:f.lights[r];if(u){const p={...u.position,[s]:l};n.updateLight({index:r,params:{position:p}})}}}else if(i.startsWith("rot")){const s=i.replace("rot","").toLowerCase();t=l=>{var f;const u=(f=this.fractalStore.getState().lighting)==null?void 0:f.lights[r];if(u){const p={...u.rotation,[s]:l};n.updateLight({index:r,params:{rotation:p}})}}}}}else if(o.includes(".")){const a=o.split("."),r=a[0],i=a[1];if(F.get(r)){const s=this.fractalStore.getState(),l=`set${r.charAt(0).toUpperCase()+r.slice(1)}`,d=s[l];if(d&&typeof d=="function"){const u=i.match(/^(vec[23][ABC])_(x|y|z)$/);if(u){const f=u[1],p=u[2];t=h=>{var m;const x=(m=this.fractalStore.getState()[r])==null?void 0:m[f];if(x){const y=x.clone();y[p]=h,d({[f]:y})}}}else t=f=>d({[i]:f})}else console.warn(`AnimationEngine: Setter ${l} not found for feature ${r}`)}}else{const a=this.fractalStore.getState(),r="set"+o.charAt(0).toUpperCase()+o.slice(1);typeof a[r]=="function"&&(t=i=>a[r](i))}return this.binders.set(o,t),t}tick(o){if(!this.animStore)return;const t=this.animStore.getState();if(!t.isPlaying)return;const a=t.fps,r=t.currentFrame,i=t.durationFrames,n=t.loopMode,s=o*a;let l=r+s;if(l>=i)if(n==="Once"||t.isRecordingModulation){l=i,this.scrub(i),this.animStore.setState({isPlaying:!1,currentFrame:i}),t.isRecordingModulation&&t.stopModulationRecording();return}else l=0;this.animStore.setState({currentFrame:l}),this.scrub(l)}scrub(o){if(!this.animStore)return;const{sequence:t,isPlaying:a,isRecording:r,recordCamera:i}=this.animStore.getState(),n=Object.values(t.tracks);this.syncBuffersFromEngine();const s=a&&r&&i;for(let l=0;l<n.length;l++){const d=n[l];if(this.overriddenTracks.has(d.id)||d.keyframes.length===0||d.type!=="float"||d.id.includes("camera.position")||d.id.includes("camera.offset")||s&&d.id.startsWith("camera."))continue;const u=this.interpolate(d,o);this.getBinder(d.id)(u)}this.commitState()}syncBuffersFromEngine(){const o=De()||nt.activeCamera;if(o){this.pendingCam.rot.setFromQuaternion(o.quaternion);const t=nt.sceneOffset;this.pendingCam.unified.set(t.x+t.xL+o.position.x,t.y+t.yL+o.position.y,t.z+t.zL+o.position.z),this.pendingCam.rotDirty=!1,this.pendingCam.unifiedDirty=!1}}interpolate(o,t){const a=o.keyframes;if(a.length===0)return 0;const r=a[0],i=a[a.length-1],n=o.id.startsWith("camera.rotation")||o.id.includes("rot")||o.id.includes("phase")||o.id.includes("twist");if(t>i.frame){const s=o.postBehavior||"Hold";if(s==="Hold")return i.value;if(s==="Continue"){let h=0;if(a.length>1){const g=a[a.length-2];i.interpolation==="Linear"?h=(i.value-g.value)/(i.frame-g.frame):i.interpolation==="Bezier"&&(i.leftTangent&&Math.abs(i.leftTangent.x)>.001?h=i.leftTangent.y/i.leftTangent.x:h=(i.value-g.value)/(i.frame-g.frame))}return i.value+h*(t-i.frame)}const l=i.frame-r.frame;if(l<=.001)return i.value;const d=t-r.frame,u=Math.floor(d/l),f=r.frame+d%l,p=this.evaluateCurveInternal(a,f,n);if(s==="Loop")return p;if(s==="PingPong"){if(u%2===1){const g=i.frame-d%l;return this.evaluateCurveInternal(a,g,n)}return p}if(s==="OffsetLoop"){const h=i.value-r.value;return p+h*u}}return t<r.frame?r.value:this.evaluateCurveInternal(a,t,n)}evaluateCurveInternal(o,t,a){for(let r=0;r<o.length-1;r++){const i=o[r],n=o[r+1];if(t>=i.frame&&t<=n.frame)return Re.interpolate(t,i,n,a)}return o[o.length-1].value}commitState(){if(this.pendingCam.unifiedDirty||this.pendingCam.rotDirty){nt.shouldSnapCamera=!0;const o=new ke().setFromEuler(this.pendingCam.rot),t={x:o.x,y:o.y,z:o.z,w:o.w},a=B.split(this.pendingCam.unified.x),r=B.split(this.pendingCam.unified.y),i=B.split(this.pendingCam.unified.z);R.emit(se.CAMERA_TELEPORT,{position:{x:0,y:0,z:0},rotation:t,sceneOffset:{x:a.high,y:r.high,z:i.high,xL:a.low,yL:r.low,zL:i.low}}),this.fractalStore.setState({cameraRot:t})}}}const _i=new wi,vn=(e,o)=>{const t={};e.forEach(n=>t[n.id]=[]),o.forEach(n=>{t[n.source]&&t[n.source].push(n.target)});const a=new Set,r=new Set,i=n=>{if(!a.has(n)){a.add(n),r.add(n);const s=t[n]||[];for(const l of s)if(!a.has(l)&&i(l)||r.has(l))return!0}return r.delete(n),!1};for(const n of e)if(i(n.id))return!0;return!1},Kt=(e,o)=>{const t={},a={};e.forEach(n=>{t[n.id]=[],a[n.id]=0}),o.forEach(n=>{t[n.source]&&(t[n.source].push(n.target),a[n.target]=(a[n.target]||0)+1)});const r=[];e.forEach(n=>{a[n.id]===0&&r.push(n.id)});const i=[];for(;r.length>0;){r.sort();const n=r.shift(),s=e.find(l=>l.id===n);if(s){const{position:l,...d}=s;i.push(d)}if(t[n])for(const l of t[n])a[l]--,a[l]===0&&r.push(l)}return i},Jt=e=>{const o=e.map((a,r)=>({...a,position:{x:250,y:150+r*200}})),t=[];if(o.length>0){t.push({id:`e-root-start-${o[0].id}`,source:"root-start",target:o[0].id});for(let a=0;a<o.length-1;a++)t.push({id:`e-${o[a].id}-${o[a+1].id}`,source:o[a].id,target:o[a+1].id});t.push({id:`e-${o[o.length-1].id}-root-end`,source:o[o.length-1].id,target:"root-end"})}return{nodes:o,edges:t}},Ii=(e,o)=>{if(e.length!==o.length)return!1;for(let t=0;t<e.length;t++){const a=e[t],r=o[t];if(a.id!==r.id||a.type!==r.type||a.enabled!==r.enabled)return!1;const i=a.bindings||{},n=r.bindings||{},s=Object.keys(i).filter(f=>i[f]!==void 0),l=Object.keys(n).filter(f=>n[f]!==void 0);if(s.length!==l.length)return!1;for(const f of s)if(i[f]!==n[f])return!1;const d=a.condition||{active:!1,mod:0,rem:0},u=r.condition||{active:!1,mod:0,rem:0};if(d.active!==u.active||d.active&&(d.mod!==u.mod||d.rem!==u.rem))return!1}return!0},Ci=(e,o)=>e.length!==o.length?!1:JSON.stringify(e)===JSON.stringify(o),Zt=[{id:"note-1",type:"Note",enabled:!0,params:{},text:`Infinite Repetition
...
This rotation is bound to 'ParamC' (Slider below). Try dragging it!`},{id:"rot-1",type:"Rotate",enabled:!0,params:{x:0,y:0,z:0},bindings:{z:"ParamC"}},{id:"bulb-1",type:"Mandelbulb",enabled:!0,params:{power:8}},{id:"add-c",type:"AddConstant",enabled:!0,params:{scale:1}}],ne=Te(),fe=ro()(io((e,o,t)=>({...Jo(e,o),...Qo(e,o),...sa(e,o),...fa(e,o),...Xr(e,o),...ii(e,o),formula:"Mandelbulb",pipeline:Zt,pipelineRevision:1,graph:Jt(Zt),projectSettings:{name:"Mandelbulb",version:0},lastSavedHash:null,animations:[],liveModulations:{},setFormula:(a,r={})=>{const i=o(),n=i.formula;if(n===a&&a!=="Modular")return;r.skipDefaultPreset||(o().resetParamHistory(),e({undoStack:[],redoStack:[]}));const s=i.projectSettings.name;let l=s;if((s===n||s==="Untitled"||s==="Custom Preset")&&(l=a),e({formula:a,projectSettings:{...i.projectSettings,name:l}}),R.emit(se.CONFIG,{formula:a,pipeline:i.pipeline,graph:i.graph}),a!=="Modular"&&!r.skipDefaultPreset){const d=pe.get(a),u=d&&d.defaultPreset?JSON.parse(JSON.stringify(d.defaultPreset)):{formula:a};u.features||(u.features={});const f=o();if(F.getEngineFeatures().forEach(h=>{const g=f[h.id];if(!g)return;const x=u.features[h.id]||{},m={},y=h.engineConfig.toggleParam;g[y]!==void 0&&x[y]===void 0&&(m[y]=g[y]),Object.entries(h.params).forEach(([b,C])=>{C.onUpdate==="compile"&&g[b]!==void 0&&x[b]===void 0&&(m[b]=g[b])}),u.features[h.id]||(u.features[h.id]={}),Object.assign(u.features[h.id],m)}),o().lockSceneOnSwitch){const h=o().getPreset(),g={...h.features||{}},x=u.features||{};x.coreMath&&(g.coreMath=x.coreMath),x.geometry&&(g.geometry=x.geometry);const m={...h,formula:a,features:g};o().loadPreset(m)}else o().loadPreset(u)}o().handleInteractionEnd()},setProjectSettings:a=>e(r=>{const i={...r.projectSettings,...a};return a.name&&a.name!==r.projectSettings.name?(i.version=0,{projectSettings:i,lastSavedHash:null}):{projectSettings:i}}),prepareExport:()=>{const a=o(),r=a.getPreset({includeScene:!0}),{version:i,name:n,...s}=r,l=JSON.stringify(s);if(a.lastSavedHash===null||a.projectSettings.version===0){const d=Math.max(1,a.projectSettings.version+1);return e({projectSettings:{...a.projectSettings,version:d},lastSavedHash:l}),d}if(a.lastSavedHash!==l){const d=a.projectSettings.version+1;return e({projectSettings:{...a.projectSettings,version:d},lastSavedHash:l}),d}return a.projectSettings.version},setAnimations:a=>{const r=o().animations,i=a.map(n=>{const s=r.find(l=>l.id===n.id);if(!s)return n;if(n.period!==s.period&&n.period>0){const l=performance.now()/1e3,d=(l/s.period+s.phase-l/n.period)%1;return{...n,phase:(d+1)%1}}return n});e({animations:i})},setLiveModulations:a=>e({liveModulations:a}),setGraph:a=>{const r=Kt(a.nodes,a.edges),i=o();if(Ii(i.pipeline,r))Ci(i.pipeline,r)?e({graph:a}):(e({graph:a,pipeline:r}),R.emit(se.CONFIG,{pipeline:r}));else if(i.autoCompile){const n=i.pipelineRevision+1;e({graph:a,pipeline:r,pipelineRevision:n}),R.emit(se.CONFIG,{pipeline:r,graph:a,pipelineRevision:n})}else e({graph:a})},setPipeline:a=>{const r=o().pipelineRevision+1,i=Jt(a);e({pipeline:a,graph:i,pipelineRevision:r}),R.emit(se.CONFIG,{pipeline:a,graph:i,pipelineRevision:r})},refreshPipeline:()=>{const a=o(),r=Kt(a.graph.nodes,a.graph.edges),i=a.pipelineRevision+1;e({pipeline:r,pipelineRevision:i}),R.emit(se.CONFIG,{pipeline:r,graph:a.graph,pipelineRevision:i})},loadPreset:a=>{a._formulaDef&&!pe.get(a.formula)&&pe.register(a._formulaDef),o().resetParamHistory();const r=pe.get(a.formula),i=r?r.id:a.formula;e({formula:i}),R.emit(se.CONFIG,{formula:i});let n=a.name;(!n||n==="Untitled"||n==="Custom Preset")&&(n=i),e({projectSettings:{name:n,version:0},lastSavedHash:null}),vi(a,e,o),setTimeout(()=>{const s=o().getPreset({includeScene:!0}),{version:l,name:d,...u}=s;e({lastSavedHash:JSON.stringify(u)})},50)},loadScene:({def:a,preset:r})=>{if(a&&(pe.get(a.id)||pe.register(a),R.emit(se.REGISTER_FORMULA,{id:a.id,shader:a.shader})),o().loadPreset(r),!ne.isBooted&&!ne.bootSent)return;const i=Io(o());R.emit(se.CONFIG,i);const n=o().sceneOffset;if(n){const s={x:n.x,y:n.y,z:n.z,xL:n.xL??0,yL:n.yL??0,zL:n.zL??0};ne.setShadowOffset(s),ne.post({type:"OFFSET_SET",offset:s})}},getPreset:a=>{var s,l;const r=o(),i={version:r.projectSettings.version,name:r.projectSettings.name,formula:r.formula,features:{}};if((a==null?void 0:a.includeScene)!==!1){if(i.cameraPos={x:0,y:0,z:0},ne.activeCamera&&ne.virtualSpace){const d=ne.virtualSpace.getUnifiedCameraState(ne.activeCamera,r.targetDistance);i.cameraRot=d.rotation,i.sceneOffset=d.sceneOffset,i.targetDistance=d.targetDistance}else i.cameraRot=r.cameraRot,i.sceneOffset=r.sceneOffset,i.targetDistance=r.targetDistance;i.cameraMode=r.cameraMode,i.lights=[],i.renderMode=r.renderMode,i.quality={aaMode:r.aaMode,aaLevel:r.aaLevel,msaa:r.msaaSamples,accumulation:r.accumulation}}F.getAll().forEach(d=>{const u=r[d.id];u&&(i.features||(i.features={}),i.features[d.id]=Ke(u))}),i.animations=r.animations,r.savedCameras.length>0&&(i.savedCameras=r.savedCameras.map(d=>({id:d.id,label:d.label,position:d.position,rotation:d.rotation,sceneOffset:d.sceneOffset,targetDistance:d.targetDistance,optics:d.optics}))),r.formula==="Modular"&&(i.graph=r.graph,i.pipeline=r.pipeline);try{const d=(l=(s=window.useAnimationStore)==null?void 0:s.getState)==null?void 0:l.call(s);d&&(i.sequence=d.sequence,i.duration=d.durationFrames)}catch(d){console.warn("Failed to save animation sequence:",d)}return i},getShareString:a=>{const r=o().getPreset({includeScene:!0}),i=o().advancedMode;return Si(r,i,a)}}))),xn=e=>e.isUserInteracting||e.interactionMode!=="none",Sn=e=>{var t;if(e.isGizmoDragging||e.interactionMode!=="none"||e.isExporting||e.isBucketRendering)return!0;const o=F.getAll();for(const a of o)if((t=a.interactionConfig)!=null&&t.blockCamera&&a.interactionConfig.activeParam){const r=e[a.id];if(r&&r[a.interactionConfig.activeParam])return!0}return!1},Io=e=>{var a;const o={formula:e.formula,pipeline:e.pipeline,pipelineRevision:e.pipelineRevision,graph:e.graph,msaaSamples:e.msaaSamples,previewMode:e.previewMode,renderMode:e.renderMode,compilerHardCap:e.compilerHardCap,shadows:!0,quality:{...e.quality}};if(F.getAll().forEach(r=>{const i=e[r.id];i&&(o[r.id]={...i})}),e.hardwareProfile){const r=e.hardwareProfile,i=o.quality;i&&(i.precisionMode=Math.max(i.precisionMode??0,r.caps.precisionMode),i.bufferPrecision=Math.max(i.bufferPrecision??0,r.caps.bufferPrecision),i.compilerHardCap=Math.min(i.compilerHardCap??500,r.caps.compilerHardCap)),o.compilerHardCap=((a=o.quality)==null?void 0:a.compilerHardCap)??o.compilerHardCap}return o};ai(Io);const wn=()=>{const e=fe.getState();_i.connect(window.useAnimationStore,fe),ne.isPaused=e.isPaused,ne.setPreviewSampleCap(e.sampleCap),ne.onBooted=()=>{const t=fe.getState(),a=t.sceneOffset;if(a){const r={x:a.x,y:a.y,z:a.z,xL:a.xL??0,yL:a.yL??0,zL:a.zL??0};ne.setShadowOffset(r),ne.post({type:"OFFSET_SET",offset:r})}ne.setPreviewSampleCap(t.sampleCap)},fe.subscribe(t=>t.isPaused,t=>{ne.isPaused=t}),fe.subscribe(t=>t.sampleCap,t=>{ne.setPreviewSampleCap(t)}),fe.subscribe(t=>{var a;return(a=t.lighting)==null?void 0:a.renderMode},t=>{if(t===void 0)return;const a=t===1?"PathTracing":"Direct";fe.getState().renderMode!==a&&fe.setState({renderMode:a})});let o;fe.subscribe(t=>{var a;return(a=t.optics)==null?void 0:a.camType},t=>{var i;if(t===void 0)return;const a=o!==void 0&&o<.5,r=t>.5&&t<1.5;if(a&&r){const n=fe.getState();if(!n.activeCameraId){const s=((i=n.optics)==null?void 0:i.camFov)||60;let l=ne.lastMeasuredDistance;(!l||l>=1e3||l<=0)&&(l=n.targetDistance||3.5);const d=l*Math.tan(s*Math.PI/360),u=n.setOptics;typeof u=="function"&&u({orthoScale:d})}}o=t}),R.on(se.BUCKET_STATUS,({isRendering:t})=>{const a=fe.getState();a.setIsBucketRendering(t),a.setIsExporting(t)})};typeof window<"u"&&(window.__store=fe);const Mi=()=>c.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:c.jsx("polyline",{points:"6 9 12 15 18 9"})}),_n=()=>c.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:c.jsx("polyline",{points:"18 15 12 9 6 15"})}),In=()=>c.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:c.jsx("polyline",{points:"15 18 9 12 15 6"})}),Cn=()=>c.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:c.jsx("polyline",{points:"9 18 15 12 9 6"})}),Mn=()=>c.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:c.jsx("polyline",{points:"9 18 15 12 9 6"})}),Rn=()=>c.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:c.jsx("path",{d:"M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"})}),Pn=()=>c.jsx("svg",{width:"100%",height:"100%",viewBox:"0 0 10 10",children:c.jsx("path",{d:"M 6 10 L 10 6 L 10 10 Z",fill:"currentColor",opacity:"0.5"})}),Ln=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("line",{x1:"4",y1:"9",x2:"20",y2:"9"}),c.jsx("line",{x1:"4",y1:"15",x2:"20",y2:"15"})]}),En=()=>c.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:c.jsx("path",{d:"M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"})}),kn=()=>c.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),c.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]}),Tn=()=>c.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("line",{x1:"3",y1:"12",x2:"21",y2:"12"}),c.jsx("line",{x1:"3",y1:"6",x2:"21",y2:"6"}),c.jsx("line",{x1:"3",y1:"18",x2:"21",y2:"18"})]}),zn=()=>c.jsx("svg",{width:"16",height:"16",viewBox:"0 0 512 512",fill:"currentColor",children:c.jsx("path",{d:"M0,0v512h512V106.9l-6.5-7.3L412.4,6.5L405.1,0H0z M46.5,46.5h69.8v139.6h279.3V56.7l69.8,69.8v338.9h-46.5V256H93.1v209.5H46.5V46.5z M162.9,46.5H256V93h46.5V46.5H349v93.1H162.9V46.5z M139.6,302.5h232.7v162.9H139.6V302.5z"})}),Dn=()=>c.jsx("svg",{width:"16",height:"16",viewBox:"190 230 680 620",fill:"currentColor",children:c.jsx("path",{d:"M257.3312 451.84V332.8c0-42.3936 34.2016-76.8 76.4416-76.8h107.8272c29.5936 0 56.5248 17.152 69.12 44.032l14.8992 31.6416a25.4976 25.4976 0 0 0 23.04 14.6944h192.8192c42.1888 0 76.4416 34.3552 76.4416 76.8v28.672a76.8 76.8 0 0 1 50.9952 88.064l-43.3152 217.6A76.544 76.544 0 0 1 750.6432 819.2H324.5568a76.544 76.544 0 0 1-74.9568-61.7472l-43.3152-217.6a76.8512 76.8512 0 0 1 51.0464-88.0128z m509.5936-3.84v-24.832c0-14.1312-11.4176-25.6-25.4464-25.6h-192.8192a76.4416 76.4416 0 0 1-69.12-44.032l-14.848-31.6928A25.4976 25.4976 0 0 0 441.6 307.2H333.7216a25.5488 25.5488 0 0 0-25.4976 25.6v115.2h458.6496z m-485.6832 51.2a25.6 25.6 0 0 0-24.9856 30.6176l43.3152 217.6c2.4064 11.9808 12.8512 20.5824 24.9856 20.5824h426.0864a25.4976 25.4976 0 0 0 24.9856-20.5824l43.3152-217.6a25.7024 25.7024 0 0 0-24.9856-30.6176H281.2416z"})}),Fn=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("circle",{cx:"12",cy:"12",r:"10"}),c.jsx("line",{x1:"12",cy:"16",x2:"12",y2:"12"}),c.jsx("line",{x1:"12",cy:"8",x2:"12.01",y2:"8"})]}),An=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("circle",{cx:"12",cy:"12",r:"10"}),c.jsx("path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"}),c.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]}),On=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[c.jsx("path",{d:"M3 10h10a5 5 0 0 1 5 5v2"}),c.jsx("path",{d:"M7 6l-4 4 4 4"})]}),jn=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[c.jsx("path",{d:"M21 10h-10a5 5 0 0 0 -5 5v2"}),c.jsx("path",{d:"M17 6l4 4 -4 4"})]}),Nn=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[c.jsx("path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}),c.jsx("path",{d:"M3 3v5h5"})]}),$n=()=>c.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:c.jsx("polyline",{points:"20 6 9 17 4 12"})}),Bn=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),c.jsx("polyline",{points:"17 8 12 3 7 8"}),c.jsx("line",{x1:"12",y1:"3",x2:"12",y2:"15"})]}),Hn=()=>c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),c.jsx("polyline",{points:"7 10 12 15 17 10"}),c.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),Vn=()=>c.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"4",children:[c.jsx("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),c.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"})]}),Gn=()=>c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("rect",{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}),c.jsx("path",{d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"})]}),Un=()=>c.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:c.jsx("path",{d:"M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"})}),qn=()=>c.jsxs("svg",{width:"64",height:"64",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("rect",{x:"5",y:"2",width:"14",height:"20",rx:"2",ry:"2"}),c.jsx("path",{d:"M12 18h.01"})]}),Wn=({className:e})=>c.jsxs("svg",{className:e,xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",children:[c.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4"}),c.jsx("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}),Xn=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("polyline",{points:"16 18 22 12 16 6"}),c.jsx("polyline",{points:"8 6 2 12 8 18"})]}),Yn=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("circle",{cx:"12",cy:"12",r:"10"}),c.jsx("path",{d:"M8 14s1.5 2 4 2 4-2 4-2"}),c.jsx("line",{x1:"9",y1:"9",x2:"9.01",y2:"9"}),c.jsx("line",{x1:"15",y1:"9",x2:"15.01",y2:"9"})]}),Kn=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"}),c.jsx("polyline",{points:"3.27 6.96 12 12.01 20.73 6.96"}),c.jsx("line",{x1:"12",y1:"22.08",x2:"12",y2:"12"})]}),Jn=()=>c.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",strokeDasharray:"4 4"}),c.jsx("path",{d:"M9 12l2 2 4-4"})]}),Zn=()=>c.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:c.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"})}),Qn=()=>c.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:c.jsx("circle",{cx:"12",cy:"12",r:"10"})}),es=()=>c.jsx("svg",{width:"14",height:"14",viewBox:"0 0 512 512",fill:"currentColor",children:c.jsx("path",{d:"M167.4,59.1l-6.2,8l-23.4,31.4h-19.7V78.8H39.4v19.7H0v354.5h512V98.5H374.2l-23.4-31.4l-6.2-8H167.4z M187.1,98.5h137.8l23.4,31.4l6.2,8h118.2v78.8H358.2c-20.5-35.2-58.7-59.1-102.2-59.1s-81.6,23.9-102.2,59.1H39.4v-78.8h118.2l6.2-8L187.1,98.5z M393.8,157.5v39.4h39.4v-39.4H393.8z M256,196.9c43.8,0,78.8,35,78.8,78.8s-35,78.8-78.8,78.8s-78.8-35-78.8-78.8S212.2,196.9,256,196.9z M39.4,256h100.3c-1.1,6.3-1.8,13.1-1.8,19.7c0,65,53.2,118.2,118.2,118.2s118.2-53.2,118.2-118.2c0-6.6-0.8-13.4-1.8-19.7h100.3v157.5H39.4V256z"})}),ts=()=>c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M12 3v18"}),c.jsx("path",{d:"M3 12h18"}),c.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),os=()=>c.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:c.jsx("path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"})}),as=()=>c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("polygon",{points:"12 2 2 7 12 12 22 7 12 2"}),c.jsx("polyline",{points:"2 17 12 22 22 17"}),c.jsx("polyline",{points:"2 12 12 17 22 12"})]}),rs=()=>c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M12 2l-5 9h10l-5 9"}),c.jsx("path",{d:"M12 2v20"})]}),is=()=>c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M6 2v14a2 2 0 0 0 2 2h14"}),c.jsx("path",{d:"M18 22V8a2 2 0 0 0-2-2H2"})]}),ns=()=>c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),c.jsx("line",{x1:"9",y1:"9",x2:"15",y2:"15"}),c.jsx("line",{x1:"15",y1:"9",x2:"9",y2:"15"})]}),ss=()=>c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("rect",{x:"3",y:"3",width:"7",height:"7"}),c.jsx("rect",{x:"14",y:"3",width:"7",height:"7"}),c.jsx("rect",{x:"14",y:"14",width:"7",height:"7"}),c.jsx("path",{d:"M3 14h7v7H3z",fill:"currentColor",stroke:"none"})]}),ls=()=>c.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:c.jsx("path",{d:"M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM7 10h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"})}),cs=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("rect",{x:"3",y:"3",width:"7",height:"7"}),c.jsx("rect",{x:"14",y:"3",width:"7",height:"7"}),c.jsx("rect",{x:"14",y:"14",width:"7",height:"7"}),c.jsx("path",{d:"M10 7h4"}),c.jsx("path",{d:"M17 10v4"})]}),ds=()=>c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M12 22V8"}),c.jsx("path",{d:"M5 12H2a10 10 0 0 0 20 0h-3"}),c.jsx("circle",{cx:"12",cy:"5",r:"3"})]}),us=()=>c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M12 18V8"}),c.jsx("path",{d:"M5 12H2a10 10 0 0 0 20 0h-3"}),c.jsx("circle",{cx:"12",cy:"5",r:"3"}),c.jsx("line",{x1:"3",y1:"21",x2:"21",y2:"3",stroke:"currentColor",opacity:"0.9"})]}),fs=({status:e})=>{let o="currentColor";e==="keyed"||e==="partial"?o="#f59e0b":(e==="dirty"||e==="keyed-dirty")&&(o="#ef4444");const t=e==="keyed"||e==="keyed-dirty"?o:"none";return c.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:o,strokeWidth:"2.5",children:c.jsx("path",{d:"M12 2L2 12l10 10 10-10L12 2z",fill:t})})},ps=({active:e})=>c.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"#666",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"}),c.jsx("path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"})]}),hs=()=>c.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[c.jsx("path",{d:"M10 13l-4 4"}),c.jsx("path",{d:"M14 11l4 -4"})]}),ms=({active:e})=>c.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:e?"#f59e0b":"#666",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("polyline",{points:"16 18 22 12 16 6"}),c.jsx("polyline",{points:"8 6 2 12 8 18"})]}),gs=({open:e})=>c.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:`transition-transform ${e?"rotate-90":""}`,children:c.jsx("path",{d:"M9 18l6-6-6-6"})}),ys=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("rect",{x:"2",y:"2",width:"20",height:"20",rx:"5",ry:"5"}),c.jsx("path",{d:"M16 8h.01"}),c.jsx("path",{d:"M8 8h.01"}),c.jsx("path",{d:"M8 16h.01"}),c.jsx("path",{d:"M16 16h.01"}),c.jsx("path",{d:"M12 12h.01"})]}),bs=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("polyline",{points:"16 3 21 3 21 8"}),c.jsx("line",{x1:"4",y1:"20",x2:"21",y2:"3"}),c.jsx("polyline",{points:"21 16 21 21 16 21"}),c.jsx("line",{x1:"15",y1:"15",x2:"21",y2:"21"}),c.jsx("line",{x1:"4",y1:"4",x2:"9",y2:"9"})]}),vs=()=>c.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:c.jsx("path",{d:"M8 5v14l11-7z"})}),xs=()=>c.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:c.jsx("path",{d:"M6 19h4V5H6v14zm8-14v14h4V5h-4z"})}),Ss=()=>c.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:c.jsx("path",{d:"M6 6h12v12H6z"})}),ws=({active:e})=>c.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:e?"currentColor":"none",stroke:"currentColor",strokeWidth:"2",children:c.jsx("circle",{cx:"12",cy:"12",r:"10",stroke:e?"none":"currentColor",fill:e?"#ef4444":"none"})}),_s=({active:e})=>c.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",children:c.jsx("path",{d:"M3 18C3 18 6 5 12 12C18 19 21 5 21 5"})}),Is=({active:e})=>c.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",children:[c.jsx("rect",{x:"3",y:"8",width:"6",height:"8"}),c.jsx("rect",{x:"15",y:"8",width:"6",height:"8"})]}),Cs=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"}),c.jsx("path",{d:"M4 22v-7"}),c.jsx("path",{d:"M8 4v10"}),c.jsx("path",{d:"M12 5v10"}),c.jsx("path",{d:"M16 4v10"}),c.jsx("path",{d:"M4 8h16"}),c.jsx("path",{d:"M4 12h16"})]}),Ms=({active:e})=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),c.jsx("line",{x1:"3",y1:"9",x2:"21",y2:"9"}),c.jsx("line",{x1:"3",y1:"15",x2:"21",y2:"15"}),c.jsx("line",{x1:"9",y1:"3",x2:"9",y2:"21"}),c.jsx("line",{x1:"15",y1:"3",x2:"15",y2:"21"})]}),Rs=({mode:e})=>c.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e==="Loop"||e==="PingPong"?c.jsx("path",{d:"M17 2l4 4-4 4 M3 11v-1a4 4 0 0 1 4-4h14 M7 22l-4-4 4-4 M21 13v1a4 4 0 0 1-4 4H3"}):c.jsx("path",{d:"M5 12h14 M12 5l7 7-7 7"})}),Ps=({active:e,arming:o})=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M3 12h18",strokeOpacity:e||o?.3:.2}),c.jsx("path",{d:"M3 12 Q 6 2, 9 12 T 15 12 T 21 12",stroke:e?"#ef4444":o?"#fca5a5":"currentColor"}),o&&!e&&c.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"#fca5a5",stroke:"none"})]}),Ls=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("polyline",{points:"4 14 10 14 10 20"}),c.jsx("polyline",{points:"20 10 14 10 14 4"}),c.jsx("line",{x1:"14",y1:"10",x2:"21",y2:"3"}),c.jsx("line",{x1:"3",y1:"21",x2:"10",y2:"14"})]}),Es=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"}),c.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"currentColor",stroke:"none"})]}),ks=({active:e})=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("line",{x1:"4",y1:"20",x2:"20",y2:"20"}),c.jsx("line",{x1:"4",y1:"4",x2:"20",y2:"4"}),c.jsx("polyline",{points:"4 14 8 10 12 14 16 10 20 14"})]}),Ts=()=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"}),c.jsx("path",{d:"M4 12h16"}),c.jsx("path",{d:"M12 4v16"}),c.jsx("path",{d:"M16 16l-4 4-4-4"})]}),zs=({active:e})=>c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M19 13l-7-7-7 7"}),c.jsx("path",{d:"M5 19l7-7 7 7"}),c.jsx("path",{d:"M12 5l2-2 2 2-2 2-2-2z",fill:e?"#22d3ee":"none",stroke:"none"}),c.jsx("path",{d:"M12 5l-2-2-2 2 2 2 2-2z",fill:e?"#22d3ee":"none",stroke:"none"})]}),Ds=({active:e})=>c.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:c.jsx("path",{d:"M2 12s3-7 7-7 7 7 7 7 3-7 7-7"})}),Fs=({active:e})=>c.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",className:e?"text-gray-200":"text-gray-600",children:[c.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),c.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),Ri=e=>{const{value:o,onChange:t,onDragStart:a,onDragEnd:r,step:i=.01,sensitivity:n=1,hardMin:s,hardMax:l,mapping:d,disabled:u,dragThreshold:f=2}=e,[p,h]=L.useState(!1),g=L.useRef(null),x=L.useRef(0),m=L.useRef(0),y=L.useRef(!1),b=L.useRef(!1),C=L.useRef(!1),k=L.useRef(null),w=L.useCallback((v,T)=>{let Y=i*.5*n;return v&&(Y*=10),T&&(Y*=.1),Y},[i,n]),I=L.useCallback(v=>{if(u||v.button!==0)return;v.preventDefault(),v.stopPropagation(),v.currentTarget.setPointerCapture(v.pointerId),k.current=v.pointerId,x.current=v.clientX;const T=d?d.toDisplay(o):o;m.current=isNaN(T)?0:T,y.current=!1,b.current=v.shiftKey,C.current=v.altKey,h(!0),a==null||a()},[o,d,u,a]),E=L.useCallback(v=>{if(u||!p||!v.currentTarget.hasPointerCapture(v.pointerId))return;const T=v.clientX-x.current;if(Math.abs(T)>f&&(y.current=!0),!y.current)return;v.preventDefault(),v.stopPropagation();const Y=b.current!==v.shiftKey,ce=C.current!==v.altKey;if(Y||ce){const V=w(b.current,C.current),O=m.current+T*V;m.current=O,x.current=v.clientX,b.current=v.shiftKey,C.current=v.altKey}const te=w(v.shiftKey,v.altKey);let W=m.current+T*te;s!==void 0&&(W=Math.max(s,W)),l!==void 0&&(W=Math.min(l,W));const S=d?d.fromDisplay(W):W;isNaN(S)||(g.current=S,t(S))},[p,u,i,s,l,d,t,w,f]),P=L.useCallback(v=>{u||(v.currentTarget.releasePointerCapture(v.pointerId),k.current=null,h(!1),g.current=null,r==null||r())},[u,r]),z=L.useCallback(()=>{const v=!y.current;return y.current=!1,v},[]);return{isDragging:p,immediateValueRef:g,handlePointerDown:I,handlePointerMove:E,handlePointerUp:P,handleClick:z}},Pi=e=>{const{value:o,mapping:t,onChange:a,onDragStart:r,onDragEnd:i,disabled:n,mapTextInput:s=!1}=e,[l,d]=L.useState(!1),[u,f]=L.useState(""),p=L.useRef(null),h=L.useRef(""),g=L.useCallback(()=>{if(n)return;d(!0);const w=s&&t?t.toDisplay(o):o,I=typeof w=="number"?parseFloat(w.toFixed(6)):w??0,E=String(I);f(E),h.current=E,setTimeout(()=>{p.current&&(p.current.focus(),p.current.select())},10)},[o,t,n,s]),x=L.useCallback(()=>{const w=h.current;let I;if(t!=null&&t.parseInput&&s?I=t.parseInput(w):(I=parseFloat(w),isNaN(I)&&(I=null)),I!==null){const E=s&&t?t.fromDisplay(I):I;r==null||r(),a(E),i==null||i()}d(!1)},[t,a,r,i,s]),m=L.useCallback(()=>{d(!1)},[]),y=L.useCallback(w=>{f(w),h.current=w},[]),b=L.useCallback(w=>{w.key==="Enter"?(w.preventDefault(),x()):w.key==="Escape"&&(w.preventDefault(),m()),w.key!=="Tab"&&w.stopPropagation()},[x,m]),C=L.useCallback(()=>{l||g()},[l,g]),k=L.useCallback(()=>{l&&x()},[l,x]);return{isEditing:l,inputValue:u,inputRef:p,startEditing:g,commitEdit:x,cancelEdit:m,handleInputChange:y,handleKeyDown:b,handleFocus:C,handleBlur:k}},Co=e=>e===0||Math.abs(e)<1e-9?"0":parseFloat(e.toFixed(8)).toString(),Qt={toDisplay:e=>e/Math.PI,fromDisplay:e=>e*Math.PI,format:e=>{const o=e/Math.PI,t=Math.abs(o),a=o<0?"-":"";if(t<.001)return"0";if(Math.abs(t-1)<.001)return`${a}π`;if(Math.abs(t-.5)<.001)return`${a}π/2`;if(Math.abs(t-.25)<.001)return`${a}π/4`;if(Math.abs(t-.75)<.001)return`${a}3π/4`;if(Math.abs(t-2)<.001)return`${a}2π`;const r=Math.round(t*3);if(Math.abs(t-r/3)<.001&&r!==0){if(r===1)return`${a}π/3`;if(r===2)return`${a}2π/3`;if(r===3)return`${a}π`;if(r===4)return`${a}4π/3`;if(r===5)return`${a}5π/3`}return`${a}${t.toFixed(2)}π`},parseInput:e=>{const o=e.trim().toLowerCase().replace(/\s/g,"");if(o==="π"||o==="pi")return Math.PI;if(o==="-π"||o==="-pi")return-Math.PI;if(o.includes("π")||o.includes("pi")){const a=o.replace(/[πpi]/g,"");if(a.includes("/")){const[n,s]=a.split("/").map(d=>parseFloat(d)||1);return(o.startsWith("-")?-1:1)*(Math.abs(n)/s)*Math.PI}const r=a?parseFloat(a):1;return isNaN(r)?null:(o.startsWith("-")?-1:1)*Math.abs(r)*Math.PI}const t=parseFloat(o);return isNaN(t)?null:t}},Be={toDisplay:e=>e*(180/Math.PI),fromDisplay:e=>e*(Math.PI/180),format:e=>`${(e*(180/Math.PI)).toFixed(1)}°`,parseInput:e=>{const o=e.trim().replace(/°/g,""),t=parseFloat(o);return isNaN(t)?null:t}},Mo=(e,o,t,a)=>{const r=a?a.toDisplay(e):e,i=a?a.toDisplay(o):o,n=a?a.toDisplay(t):t;return Math.max(0,Math.min(100,(r-i)/(n-i)*100))},st=({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r=.01,sensitivity:i=1,min:n,max:s,hardMin:l,hardMax:d,mapping:u,format:f,mapTextInput:p,disabled:h=!1,highlight:g=!1,liveValue:x,defaultValue:m,onImmediateChange:y})=>{const b=ue.useRef(null),C=ue.useCallback(G=>f?f(G):u!=null&&u.format?u.format(G):Co(G),[f,u]),{isDragging:k,immediateValueRef:w,handlePointerDown:I,handlePointerMove:E,handlePointerUp:P,handleClick:z}=Ri({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,sensitivity:i,hardMin:l,hardMax:d,mapping:u,disabled:h}),v=ue.useCallback(G=>{E(G);const N=w.current;N!==null&&(b.current&&(b.current.textContent=C(N)),y==null||y(N))},[E,w,C,y]),{isEditing:T,inputValue:Y,inputRef:ce,startEditing:te,handleInputChange:W,handleKeyDown:S,handleBlur:V}=Pi({value:e,mapping:u,onChange:o,onDragStart:t,onDragEnd:a,disabled:h,mapTextInput:p}),O=ue.useMemo(()=>C(e),[e,C]),de=ue.useCallback(()=>{!h&&!T&&te()},[h,T,te]),oe=ue.useCallback(G=>{if(h)return;z()&&te()},[h,z,te]),Q=`
        ...
        ${k?"bg-cyan-500/20 text-cyan-300":(k||g||x!==void 0&&!h)&&!h?"text-cyan-400":h?"":"text-gray-300 hover:text-white"}
    `;return T?c.jsx("input",{ref:ce,type:"text",value:Y,onChange:G=>W(G.target.value),onBlur:V,onKeyDown:S,className:"w-full h-full bg-gray-900 text-white text-xs border-none outline-none font-mono text-center px-1",onClick:G=>G.stopPropagation(),autoFocus:!0}):c.jsx("div",{ref:b,"data-role":"value",tabIndex:h?-1:0,onPointerDown:I,onPointerMove:v,onPointerUp:P,onClick:oe,onFocus:de,className:Q,title:h?"Disabled":"Click to edit, Drag to adjust (Shift=Fast, Alt=Slow)",children:O})},Li=({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r=.01,min:i,max:n,hardMin:s,hardMax:l,mapping:d,format:u,overrideText:f,mapTextInput:p,label:h,labelSuffix:g,headerRight:x,showTrack:m=!0,trackPosition:y="below",trackHeight:b=20,variant:C="full",className:k="",defaultValue:w,onReset:I,liveValue:E,showLiveIndicator:P=!0,onContextMenu:z,dataHelpId:v,disabled:T=!1,highlight:Y=!1})=>{const ce=ue.useRef(null),te=ue.useRef(null),W=ue.useRef(null),S=i!==void 0&&n!==void 0&&i!==n,V=ue.useMemo(()=>{if(!S)return 0;const K=d?d.toDisplay(e):e,ie=d?d.toDisplay(i):i,J=d?d.toDisplay(n):n;return Math.max(0,Math.min(100,(K-ie)/(J-ie)*100))},[e,i,n,d,S]),O=ue.useMemo(()=>{if(!S||E===void 0)return 0;const K=d?d.toDisplay(E):E,ie=d?d.toDisplay(i):i,J=d?d.toDisplay(n):n;return Math.max(0,Math.min(100,(K-ie)/(J-ie)*100))},[E,i,n,d,S]),de=ue.useMemo(()=>{if(!S||w===void 0)return null;const K=d?d.toDisplay(w):w,ie=d?d.toDisplay(i):i,J=d?d.toDisplay(n):n;return(K-ie)/(J-ie)*100},[w,i,n,d,S]),oe=ue.useCallback(K=>S?Mo(K,i,n,d):0,[S,i,n,d]),j=ue.useCallback(K=>{const J=`${oe(K)}%`;ce.current&&(ce.current.style.width=J),te.current&&(te.current.style.width=J),W.current&&(W.current.value=String(d?d.toDisplay(K):K))},[oe,d]),Q=ue.useCallback(K=>{if(T)return;const ie=parseFloat(K.target.value),J=d?d.fromDisplay(ie):ie;o(J)},[T,d,o]),G=ue.useCallback(()=>{w!==void 0&&!T&&(t==null||t(),o(w),a==null||a(),I==null||I())},[w,T,o,t,a,I]),N=Y||E!==void 0,q=C==="compact";return C==="minimal"?c.jsx("div",{className:k,children:c.jsx(st,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:s,hardMax:l,mapping:d,format:f?()=>f:u,mapTextInput:p,defaultValue:w,disabled:T,highlight:N,onImmediateChange:j})}):q?c.jsxs("div",{className:`relative flex-1 h-9 md:h-[26px] overflow-hidden group transition-all duration-150 ${T?"opacity-70 pointer-events-none":""} ${k}`,onContextMenu:z,"data-help-id":v,children:[c.jsx("div",{className:"absolute inset-0 bg-white/[0.12]",style:T?{}:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255,255,255,0.03) 5px, rgba(255,255,255,0.03) 10px)"}}),m&&S&&c.jsx("div",{ref:ce,"data-role":"fill",className:`absolute top-0 bottom-0 left-0 pointer-events-none ${T?"bg-gray-500/20":N?"bg-cyan-500/30":"bg-cyan-500/20"}`,style:{width:`${V}%`}}),P&&E!==void 0&&!T&&S&&c.jsx("div",{className:"absolute top-0 bottom-0 w-1.5 bg-purple-500 blur-[1px] transition-all duration-75 ease-out z-0",style:{left:`calc(${O}% - 0.75px)`}}),c.jsx("div",{className:"absolute inset-0",children:c.jsx(st,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:s,hardMax:l,mapping:d,format:f?()=>f:u,mapTextInput:p,defaultValue:w,disabled:T,highlight:N,onImmediateChange:j})}),N&&!T&&c.jsx("div",{className:"absolute inset-0 bg-cyan-500/10 pointer-events-none"})]}):c.jsxs("div",{className:`mb-px animate-slider-entry ${T?"opacity-70 pointer-events-none":""} ${k}`,"data-help-id":v,onContextMenu:z,children:[h&&c.jsxs("div",{className:"flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5",children:[c.jsxs("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:[x,c.jsxs("label",{className:`text-[10px] font-medium tracking-tight select-none flex items-center gap-2 truncate pointer-events-none ${T?"text-gray-600":"text-gray-400"}`,children:[h,g,E!==void 0&&!T&&c.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-purple-500 animate-pulse shadow-[0_0_4px_#a855f7]"})]})]}),c.jsx("div",{className:"w-1/2 relative bg-white/[0.02] border-l border-white/10 group/num-area touch-none",style:T?{}:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255,255,255,0.03) 5px, rgba(255,255,255,0.03) 10px)"},children:c.jsx(st,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:s,hardMax:l,mapping:d,format:f?()=>f:u,mapTextInput:p,defaultValue:w,disabled:T,highlight:N,onImmediateChange:j})})]}),m&&S&&c.jsxs("div",{className:"relative flex items-center touch-none overflow-hidden",style:{touchAction:"none",height:b},children:[c.jsx("input",{ref:W,type:"range",min:d?d.toDisplay(i):i,max:d?d.toDisplay(n):n,step:r,value:d?d.toDisplay(e):e,onChange:Q,disabled:T,onPointerDown:K=>{T||(K.stopPropagation(),t==null||t())},onPointerUp:()=>{T||a==null||a()},className:`precision-slider w-full h-full appearance-none cursor-pointer focus:outline-none z-10 ${N&&!T?"accent-cyan-500":"accent-gray-400"}`,style:{background:"transparent",touchAction:"none"},tabIndex:-1}),c.jsxs("div",{className:"absolute inset-0 bg-white/10 pointer-events-none",children:[c.jsx("div",{ref:te,className:`absolute top-0 bottom-0 left-0 ${T?"bg-gray-400/20":"bg-cyan-500/30"}`,style:{width:`${V}%`}}),P&&E!==void 0&&!T&&c.jsx("div",{className:"absolute top-0 bottom-0 w-1.5 bg-purple-500 blur-[1px] transition-all duration-75 ease-out z-0",style:{left:`calc(${O}% - 0.75px)`}})]}),de!==null&&c.jsxs(c.Fragment,{children:[c.jsx("div",{className:"absolute w-0.5 h-full bg-white/40 pointer-events-none z-0 transform -translate-x-1/2",style:{left:`${de}%`}}),c.jsx("button",{onClick:K=>{K.preventDefault(),K.stopPropagation(),G()},className:"absolute top-0 bottom-0 right-0 w-2 bg-gray-500/20 hover:bg-gray-400/50 cursor-pointer z-20 transition-colors border-l border-black/10",title:`Reset to ${w}`,"aria-label":"Reset to default",tabIndex:-1})]})]})]})},Ei=[{label:"X",color:"bg-red-500",text:"text-red-400",border:"group-focus-within:border-red-500/50",hoverBg:"hover:bg-red-500/20",accent:"#ef4444"},{label:"Y",color:"bg-green-500",text:"text-green-400",border:"group-focus-within:border-green-500/50",hoverBg:"hover:bg-green-500/20",accent:"#22c55e"},{label:"Z",color:"bg-blue-500",text:"text-blue-400",border:"group-focus-within:border-blue-500/50",hoverBg:"hover:bg-blue-500/20",accent:"#3b82f6"},{label:"W",color:"bg-purple-500",text:"text-purple-400",border:"group-focus-within:border-purple-500/50",hoverBg:"hover:bg-purple-500/20",accent:"#a855f7"}],eo=e=>e.includes("red")?{on:"bg-red-500/30 text-red-300 border-red-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("green")?{on:"bg-green-500/30 text-green-300 border-green-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("amber")||e.includes("yellow")?{on:"bg-amber-500/30 text-amber-300 border-amber-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("purple")?{on:"bg-purple-500/30 text-purple-300 border-purple-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:{on:"bg-cyan-500/30 text-cyan-300 border-cyan-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"};function As({label:e,value:o,onChange:t,options:a,color:r="bg-cyan-600",onLfoToggle:i,isLfoActive:n,icon:s,disabled:l=!1,variant:d="default",labelSuffix:u,onContextMenu:f,...p}){const h=m=>{l||t(m)},g=()=>{l||t(!o)},x=eo(r);if(d==="dense"&&!a&&typeof o=="boolean"){const m=eo(r);return c.jsxs("div",{className:`flex items-center justify-between px-3 py-1 border-b border-white/5 hover:bg-white/5 transition-colors ${l?"opacity-50 pointer-events-none":"cursor-pointer"}`,"data-help-id":p["data-help-id"],onContextMenu:f,onClick:g,children:[c.jsxs("div",{className:"flex items-center gap-2",children:[s,c.jsx("span",{className:"text-[10px] text-gray-400 font-medium tracking-tight truncate select-none",children:e})]}),c.jsx("div",{className:`px-2 py-0.5 text-[8px] font-bold rounded-sm transition-all border ${o?m.on:m.off} ${l?"":"hover:brightness-125"}`,children:o?"ON":"OFF"})]})}return a?c.jsxs("div",{className:`mb-px animate-slider-entry ${l?"opacity-50 pointer-events-none":""}`,"data-help-id":p["data-help-id"],onContextMenu:f,children:[e&&c.jsxs("div",{className:"flex items-center bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5 px-2 gap-2",children:[s,c.jsx("span",{className:"text-[10px] text-gray-400 font-medium tracking-tight truncate select-none pointer-events-none",children:e})]}),c.jsx("div",{className:`flex h-9 md:h-[26px] overflow-hidden ${e?"rounded-b-sm":"rounded-sm"}`,children:a.map(m=>c.jsx("button",{onClick:()=>h(m.value),disabled:l,className:`
                        ...
                        `,children:c.jsx("span",{className:`text-[8px] ${o?"opacity-90":"opacity-50"}`,children:o?"ON":"OFF"})}),i&&c.jsx("button",{onClick:m=>{m.stopPropagation(),l||i()},disabled:l,className:`
                            ...
                            `,title:"LFO",children:c.jsx("span",{className:`text-[8px] ${n?"opacity-90":"opacity-50"}`,children:"LFO"})})]})]})})}const Oe={text:"text-cyan-400",textSubtle:"text-cyan-600",bgSolid:"bg-cyan-900",bgMed:"bg-cyan-700",bgBright:"bg-cyan-600/40",hoverBg:"hover:bg-cyan-500/50"},Os={bgMed:"bg-purple-700"},to={text:"text-amber-400",bg:"bg-amber-900/20",border:"border-amber-500/20",btnBg:"bg-amber-600",btnHover:"hover:bg-amber-500",btnText:"text-black"},je={dock:"bg-[#080808]",tabBar:"bg-black/40",nested:"bg-black/20",divider:"bg-neutral-800",panelHeader:"bg-gray-800/80",input:"bg-gray-900",tint:"bg-white/5",hoverSubtle:"hover:bg-white/5",hoverMed:"hover:bg-white/10"},_e={primary:"text-white",label:"text-gray-400",dimLabel:"text-gray-500",faint:"text-gray-600",ghost:"text-gray-700"},Ro={subtle:"border-white/5",standard:"border-white/10"},js=`${je.dock} ${Oe.text} border-x border-t ${Ro.standard} z-10 -mb-px pb-2`,Ns=`${_e.dimLabel} ${je.hoverSubtle} hover:text-gray-300 border border-transparent`,$s=`${Oe.bgSolid} ${Oe.text}`,Bs=`${_e.faint} ${je.hoverMed}`,Hs=`${Oe.textSubtle}`,Vs=`${_e.ghost}`,Gs=`${je.nested} p-2 rounded border ${Ro.subtle}`,Us=`${to.bg} border ${to.border}`,qs=`${Oe.bgMed} ${_e.primary}`,Ws=`${_e.dimLabel} hover:text-gray-300`,Xs=`${_e.ghost} cursor-not-allowed opacity-50 bg-transparent`,Ys=`${Oe.bgBright} text-cyan-300 shadow-[inset_0_0_10px_rgba(34,211,238,0.1)]`,Ks=`bg-transparent ${_e.dimLabel} hover:text-gray-300 ${je.hoverSubtle}`,ki={primary:`text-[10px] font-bold ${_e.label}`,secondary:`text-[9px] font-bold ${_e.dimLabel}`,tiny:`text-[8px] ${_e.faint}`},Ti=({children:e,variant:o="primary",className:t="",color:a})=>{const r=ki[o],i=a||"";return c.jsx("span",{className:`${r} ${i} select-none ${t}`,children:e})},Js=()=>c.jsxs(c.Fragment,{children:[c.jsx("div",{className:`h-1.5 ${je.divider} rounded-b-lg`}),c.jsx("div",{className:"h-2",style:{background:"linear-gradient(to bottom, transparent, rgba(255,255,255,0.08))"}})]});function Zs({label:e,value:o,options:t,onChange:a,fullWidth:r,className:i="",selectClassName:n="",labelSuffix:s,onContextMenu:l,disabled:d=!1,...u}){const f=p=>{var x;const h=p.target.value,g=typeof((x=t[0])==null?void 0:x.value)=="number";a(g?Number(h):h)};return c.jsxs("div",{className:`flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5 ${r?"w-full":""} ${d?"opacity-50 pointer-events-none":""} ${i}`,"data-help-id":u["data-help-id"],onContextMenu:l,children:[e&&c.jsx("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:c.jsxs("label",{className:"text-[10px] font-medium tracking-tight select-none truncate pointer-events-none text-gray-400",children:[e,s]})}),c.jsxs("div",{className:`${e?"w-1/2":"w-full"} relative border-l border-white/10 bg-white/[0.02] border-t border-t-white/5`,children:[c.jsx("select",{value:o,onChange:f,disabled:d,className:`w-full h-full bg-transparent text-[10px] font-medium text-gray-200 px-2 pr-6 outline-none cursor-pointer appearance-none text-center ${n}`,children:t.map(p=>c.jsx("option",{value:String(p.value),className:"bg-[#111] text-gray-300",children:p.label},String(p.value)))}),c.jsx("div",{className:"absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500",children:c.jsx("div",{className:"w-2.5 h-2.5",children:c.jsx(Mi,{})})})]})]})}const Se=({axisIndex:e,value:o,min:t,max:a,step:r,onUpdate:i,onDragStart:n,onDragEnd:s,disabled:l,highlight:d,mapping:u,mapTextInput:f,liveValue:p,defaultValue:h,hardMin:g,hardMax:x,customLabel:m})=>{const y=Ei[e],b=m||y.label;return c.jsxs("div",{"data-axis-index":e,className:`relative flex-1 h-9 md:h-[26px] overflow-hidden group transition-all duration-150 ${l?"opacity-50 pointer-events-none":""}`,children:[c.jsx("div",{className:`
                ...
                `,onDoubleClick:C=>{C.preventDefault(),C.stopPropagation(),h!==void 0&&(n==null||n(),i(h),s==null||s())},title:h!==void 0?`Double-click to reset to ${h}`:"No default value",children:c.jsx("span",{className:`text-[10px] font-bold ${y.text} pointer-events-none`,children:b})}),c.jsx("div",{className:"absolute inset-0 left-5",children:c.jsx(Li,{value:o,onChange:i,onDragStart:n,onDragEnd:s,step:r,min:t,max:a,hardMin:g,hardMax:x,mapping:u,mapTextInput:f,disabled:l,highlight:d,liveValue:p,defaultValue:h,variant:"compact",showTrack:!0})})]})},oo=[{label:"X",color:"bg-red-500",text:"text-red-400",border:"group-focus-within:border-red-500/50",hoverBg:"hover:bg-red-500/20",accent:"#ef4444"},{label:"Y",color:"bg-green-500",text:"text-green-400",border:"group-focus-within:border-green-500/50",hoverBg:"hover:bg-green-500/20",accent:"#22c55e"},{label:"Z",color:"bg-blue-500",text:"text-blue-400",border:"group-focus-within:border-blue-500/50",hoverBg:"hover:bg-blue-500/20",accent:"#3b82f6"},{label:"W",color:"bg-purple-500",text:"text-purple-400",border:"group-focus-within:border-purple-500/50",hoverBg:"hover:bg-purple-500/20",accent:"#a855f7"}],Xe=({primaryAxis:e,secondaryAxis:o,primaryIndex:t,secondaryIndex:a,primaryValue:r,secondaryValue:i,min:n,max:s,step:l,onUpdate:d,onDragStart:u,onDragEnd:f,disabled:p,onHover:h})=>{const[g,x]=L.useState(!1),m=L.useRef(!1),y=L.useRef(!1),b=L.useRef({x:0,y:0}),C=L.useRef({primary:0,secondary:0}),k=L.useRef(!1),w=L.useRef(!1),I=L.useRef(!1),E=oo[t],P=oo[a],z=()=>{x(!0),h(!0)},v=()=>{m.current||(x(!1),h(!1))},T=S=>{p||S.button!==0&&S.button!==1||(S.preventDefault(),S.stopPropagation(),S.currentTarget.setPointerCapture(S.pointerId),b.current={x:S.clientX,y:S.clientY},C.current={primary:r,secondary:i},k.current=!1,w.current=S.shiftKey,I.current=S.altKey,m.current=!0,y.current=S.button===1,u())},Y=S=>{if(p||!m.current||!S.currentTarget.hasPointerCapture(S.pointerId))return;const V=S.clientX-b.current.x,O=S.clientY-b.current.y;if((Math.abs(V)>1||Math.abs(O)>1)&&(k.current=!0),!k.current&&Math.abs(V)<1&&Math.abs(O)<1)return;S.preventDefault(),S.stopPropagation();const de=w.current!==S.shiftKey,oe=I.current!==S.altKey;if(de||oe){let j=l*.5;w.current&&(j*=10),I.current&&(j*=.1),C.current.primary=C.current.primary+V*j,C.current.secondary=C.current.secondary-O*j,b.current={x:S.clientX,y:S.clientY},w.current=S.shiftKey,I.current=S.altKey}if(y.current){let j=.01;S.shiftKey&&(j*=3),S.altKey&&(j*=.3);const Q=1+O*j;let G=C.current.primary*Q,N=C.current.secondary*Q;!isNaN(G)&&!isNaN(N)&&d(G,N)}else{let j=l*.5;S.shiftKey&&(j*=10),S.altKey&&(j*=.1);let Q=C.current.primary+V*j,G=C.current.secondary-O*j;!isNaN(Q)&&!isNaN(G)&&d(Q,G)}},ce=S=>{p||(S.currentTarget.releasePointerCapture(S.pointerId),m.current=!1,y.current=!1,f(),k.current=!1,S.currentTarget.matches(":hover")||(x(!1),h(!1)))},te=S=>{p||(S.preventDefault(),S.stopPropagation(),u(),d(0,0),f())},W=g||m.current;return c.jsxs("div",{className:`
            ...
            `,onPointerDown:T,onPointerMove:Y,onPointerUp:ce,onMouseEnter:z,onMouseLeave:v,onDoubleClick:te,title:`Drag: Horizontal=${e.toUpperCase()}, Vertical=${o.toUpperCase()} | Middle-click: Scale both proportionally | Double-click: Reset (Shift=Fast, Alt=Slow)`,children:[W&&c.jsx("div",{className:"absolute inset-0 opacity-30",style:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 3px, rgba(255,255,255,0.05) 3px, rgba(255,255,255,0.05) 6px)"}}),c.jsxs("div",{className:"relative w-full h-full",children:[c.jsx("div",{className:`
                    ...
                    `,children:c.jsxs("div",{className:"absolute inset-0 flex items-center justify-center",children:[c.jsx("div",{className:"w-full h-[1px] bg-cyan-400/50 rotate-45"}),c.jsx("div",{className:"absolute w-full h-[1px] bg-cyan-400/50 -rotate-45"})]})})]})]})},ao=({azimuth:e,pitch:o,onChange:t,onDragStart:a,onDragEnd:r,disabled:i=!1,size:n=80})=>{const s=L.useRef(null),l=L.useRef(!1),[d,u]=L.useState(!1),[f,p]=L.useState(!1),[h,g]=L.useState(!1),x=L.useRef({x:0,y:0}),m=L.useRef({azimuth:e,pitch:o}),y=L.useRef({azimuth:e,pitch:o}),b=L.useRef(null);L.useEffect(()=>{m.current={azimuth:e,pitch:o}},[e,o]);const w=f?.05:.5,I=n/2,E=n*.38,P=L.useCallback((S,V,O)=>{const de=S/(Math.PI/2)*O,oe=-(V/(Math.PI/2))*O;return{x:de,y:oe}},[]),z=L.useMemo(()=>P(e,o,E),[e,o,E,P]),v=L.useMemo(()=>{const S=Math.cos(o),V=Math.sin(o),O=Math.cos(e),oe=Math.sin(e)*S,j=V,Q=-O*S,G=oe,N=-j,q=Math.sqrt(G*G+N*N),re=Q>0,ze=q>.001?Math.min(q,1)*E:0,K=Q<=0?1+(1-Math.min(q,1))*.5:1-Q*.95,ie=q>.001?G/q*ze:0,J=q>.001?N/q*ze:0;return{x:ie,y:J,isBack:re,length:ze,headScale:K,dirX:oe,dirY:j,dirZ:Q}},[e,o,E]),T=L.useCallback((S,V,O)=>{const de=S/O*(Math.PI/2),oe=-(V/O)*(Math.PI/2);return{azimuth:de,pitch:oe}},[]),Y=L.useCallback((S,V)=>{let O=S,de=V;h&&b.current&&(b.current==="x"?de=0:O=0);const oe=O*w,j=de*w,Q=P(m.current.azimuth,m.current.pitch,E),G=Q.x+oe,N=Q.y+j,{azimuth:q,pitch:re}=T(G,N,E);h&&b.current?b.current==="x"?(m.current={azimuth:q,pitch:y.current.pitch},t(q,y.current.pitch)):(m.current={azimuth:y.current.azimuth,pitch:re},t(y.current.azimuth,re)):(m.current={azimuth:q,pitch:re},t(q,re))},[P,T,t,E,w,h]),ce=S=>{i||S.button===0&&(S.preventDefault(),S.stopPropagation(),S.currentTarget.setPointerCapture(S.pointerId),l.current=!0,u(!0),x.current={x:S.clientX,y:S.clientY},m.current={azimuth:e,pitch:o},y.current={azimuth:e,pitch:o},b.current=null,a==null||a(),p(S.altKey),g(S.shiftKey))},te=S=>{if(i||!l.current)return;const V=S.clientX-x.current.x,O=S.clientY-x.current.y;x.current={x:S.clientX,y:S.clientY},p(S.altKey),g(S.shiftKey),h&&!b.current&&(Math.abs(V)>2||Math.abs(O)>2)&&(b.current=Math.abs(V)>Math.abs(O)?"x":"y"),Y(V,O)},W=S=>{l.current&&(l.current=!1,u(!1),p(!1),g(!1),b.current=null,r==null||r())};return c.jsxs("div",{ref:s,className:`
            ...
            `,style:{width:n,height:n,touchAction:"none",boxShadow:d?"0 0 20px rgba(34, 211, 238, 0.3)":"none"},onPointerDown:ce,onPointerMove:te,onPointerUp:W,onPointerLeave:W,onDoubleClick:S=>{i||(S.preventDefault(),S.stopPropagation(),a==null||a(),t(0,0),r==null||r())},onContextMenu:S=>{},title:"Drag to rotate direction, Double-click to reset",children:[c.jsx("div",{className:"absolute rounded-full border border-white/10 pointer-events-none",style:{width:E*2,height:E*2,left:I-E,top:I-E}}),c.jsx("div",{className:"absolute w-full h-px bg-white/10 pointer-events-none",style:{top:I}}),c.jsx("div",{className:"absolute h-full w-px bg-white/10 pointer-events-none",style:{left:I}}),c.jsx("div",{className:"absolute w-1.5 h-1.5 bg-white/40 rounded-full pointer-events-none",style:{left:I-3,top:I-3}}),c.jsx("div",{className:"absolute pointer-events-none rounded-full transition-transform duration-75",style:{left:I+z.x,top:I+z.y,width:8,height:8,marginLeft:-4,marginTop:-4,background:v.isBack?"#ef4444":"#22d3ee",boxShadow:`0 0 8px ${v.isBack?"#ef4444":"#22d3ee"}`,transform:d?"scale(1.2)":"scale(1)"}}),v.isBack&&c.jsx("div",{className:"absolute inset-0 rounded-full border-2 border-red-500/30 pointer-events-none animate-pulse"}),c.jsxs(c.Fragment,{children:[c.jsxs("svg",{className:"absolute inset-0 pointer-events-none",style:{width:n,height:n},children:[Math.abs(e)>.01&&c.jsxs(c.Fragment,{children:[c.jsx("ellipse",{cx:I,cy:I,rx:E*Math.abs(Math.sin(e)),ry:E,fill:"none",stroke:v.isBack?"#ef4444":"#22d3ee",strokeWidth:"1.5",opacity:v.isBack?.175:.35,clipPath:v.x>0?"url(#longitudeRight)":"url(#longitudeLeft)"}),c.jsx("ellipse",{cx:I,cy:I,rx:E*Math.abs(Math.sin(e)),ry:E,fill:"none",stroke:v.isBack?"#22d3ee":"#ef4444",strokeWidth:"1.5",opacity:v.isBack?.35:.175,clipPath:v.x>0?"url(#longitudeLeft)":"url(#longitudeRight)"})]}),Math.abs(o)>.01&&c.jsxs(c.Fragment,{children:[c.jsx("ellipse",{cx:I,cy:I,rx:E,ry:E*Math.abs(Math.sin(o)),fill:"none",stroke:v.isBack?"#ef4444":"#22d3ee",strokeWidth:"1.5",opacity:v.isBack?.15:.3,clipPath:v.y<0?"url(#latitudeTop)":"url(#latitudeBottom)"}),c.jsx("ellipse",{cx:I,cy:I,rx:E,ry:E*Math.abs(Math.sin(o)),fill:"none",stroke:v.isBack?"#22d3ee":"#ef4444",strokeWidth:"1.5",opacity:v.isBack?.3:.15,clipPath:v.y<0?"url(#latitudeBottom)":"url(#latitudeTop)"})]}),c.jsxs("defs",{children:[c.jsx("clipPath",{id:"longitudeRight",children:c.jsx("rect",{x:I,y:"0",width:I,height:n})}),c.jsx("clipPath",{id:"longitudeLeft",children:c.jsx("rect",{x:"0",y:"0",width:I,height:n})}),c.jsx("clipPath",{id:"latitudeTop",children:c.jsx("rect",{x:"0",y:"0",width:n,height:I})}),c.jsx("clipPath",{id:"latitudeBottom",children:c.jsx("rect",{x:"0",y:I,width:n,height:I})})]}),c.jsx("line",{x1:I,y1:I,x2:I+v.x,y2:I+v.y,stroke:v.isBack?"#ef4444":"#22d3ee",strokeWidth:"2",strokeDasharray:"4 2",opacity:.3+v.length/E*.5}),c.jsx("polygon",{points:"0,-8 -6,4 6,4",fill:v.isBack?"#ef4444":"#22d3ee",opacity:Math.max(.1,.6+(v.headScale-1)*.4),transform:`translate(${I+v.x}, ${I+v.y}) rotate(${Math.atan2(v.y,v.x)*180/Math.PI+90}) scale(${Math.max(.9,.9+v.headScale*.1)}, ${Math.max(.05,v.headScale)})`})]}),d&&c.jsx("div",{className:"absolute -bottom-5 left-1/2 -translate-x-1/2 whitespace-nowrap",children:c.jsxs("span",{className:"text-[9px] text-cyan-400 font-mono bg-black/60 px-1 rounded",children:[(e*180/Math.PI).toFixed(0),"° / ",(o*180/Math.PI).toFixed(0),"°"]})})]})]})},lt=Math.PI/180,zi=180/Math.PI,Di=["x","y","z","w"],ct={x:0,y:1,z:2,w:3},Fi=e=>{const o=e.length();if(o<1e-9)return{azimuth:0,pitch:0};const t=Math.max(-1,Math.min(1,e.y/o));return{azimuth:Math.atan2(e.x/o,e.z/o),pitch:Math.asin(t)}},Ai=(e,o)=>{const t=Math.cos(o);return new A(t*Math.sin(e),Math.sin(o),t*Math.cos(e))},Qs=({label:e,value:o,onChange:t,min:a=-1e4,max:r=1e4,step:i=.01,disabled:n=!1,convertRadToDeg:s=!1,mode:l="normal",modeToggleable:d=!1,showLiveIndicator:u=!1,liveValue:f,defaultValue:p,hardMin:h,hardMax:g,axisMin:x,axisMax:m,axisStep:y,onDragStart:b,onDragEnd:C,headerRight:k,showDualAxisPads:w=!0,linkable:I=!1,scale:E})=>{const[P,z]=L.useState(o.clone()),[v,T]=L.useState(null),[Y,ce]=L.useState(l),[te,W]=L.useState("degrees"),[S,V]=L.useState("degrees"),[O,de]=L.useState(I),oe=L.useRef(!1),j=L.useRef(null),Q=L.useRef(null);L.useEffect(()=>{ce(l)},[l]);const G=fe(_=>_.openContextMenu),N="w"in o,q="z"in o,re=Y==="rotation",ze=Y==="toggle",K=Y==="mixed",ie=Y==="direction"&&q,J=ie?Fi(P):{azimuth:0,pitch:0},Ue=(_,D)=>{const $=Math.max(-Math.PI/2,Math.min(Math.PI/2,D)),U=Ai(_,$);xe(0,_),xe(1,$),z(U),t(U)};L.useEffect(()=>{if(oe.current)return;const _=1e-4,D=Math.abs(o.x-P.x),$=Math.abs(o.y-P.y),U=q?Math.abs(o.z-P.z):0,he=N?Math.abs(o.w-P.w):0;(D>_||$>_||U>_||he>_)&&z(o.clone())},[o,q,N]);const Ie=()=>{oe.current=!0,j.current=P.clone(),b&&b()},Ce=()=>{j.current=null,oe.current=!1,C&&C()},bt=_=>{if(re)return te==="degrees"?Be:Qt;if(E==="pi")return S==="pi"?Qt:Be;if(s)return Be},vt=_=>{if(re){const ee=te==="degrees"?60*Math.PI/180:.05;return{min:-2*Math.PI,max:2*Math.PI,step:ee,hardMin:void 0,hardMax:void 0}}const D=x||{x:a,y:a,z:a},$=m||{x:r,y:r,z:r},U=y||{x:i,y:i,z:i},he=E==="pi"&&S==="degrees"?zi:1;return{min:D[_],max:$[_],step:(U[_]??i)*he,hardMin:h,hardMax:g}},xe=(_,D)=>{const $=Q.current;if(!$)return;const U=$.querySelector(`[data-axis-index="${_}"]`);if(!U)return;const he=Di[_],ee=bt(),_t=U.querySelector('[data-role="value"]');_t&&(_t.textContent=ee!=null&&ee.format?ee.format(D):Co(D));const It=U.querySelector('[data-role="fill"]');if(It){const Ct=vt(he),Mt=Ct.min??a,Rt=Ct.max??r;if(Mt!==Rt){const $o=Mo(D,Mt,Rt,ee);It.style.width=`${$o}%`}}},xt=(_,D)=>{const $=j.current||P,U=$.clone();if(O&&!re){const he=$[_],ee=D-he;U.x=$.x+ee,U.y=$.y+ee,q&&(U.z=$.z+ee),N&&(U.w=$.w+ee),xe(0,U.x),xe(1,U.y),q&&xe(2,U.z),N&&xe(3,U.w)}else U[_]=D;z(U),t(U)},Qe=(_,D,$,U)=>{const ee=(j.current||P).clone();ee[_]=$,ee[D]=U,xe(ct[_],$),xe(ct[D],U),z(ee),t(ee)},Lo=v==="xy",Eo=v==="xy"||v==="zy",ko=v==="zy"||v==="wz",To=v==="wz",zo=_=>{if(f)return f[_]},Do=_=>{if(p)return p[_]},St=P,Fo={x:Lo,y:Eo,z:ko,w:To},Pe=_=>({axisIndex:ct[_],value:P[_],...vt(_),onUpdate:D=>xt(_,D),onDragStart:Ie,onDragEnd:Ce,disabled:n,highlight:Fo[_],mapping:bt(),mapTextInput:re||E==="pi",liveValue:u?zo(_):void 0,defaultValue:Do(_)}),Ao=[{on:"bg-red-500/30 text-red-300 border-red-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-green-500/30 text-green-300 border-green-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-blue-500/30 text-blue-300 border-blue-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-purple-500/30 text-purple-300 border-purple-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}],wt=(_,D,$)=>{const he=P[_]>.5,ee=Ao[D];return c.jsxs("button",{className:`flex items-center justify-center gap-1 text-[10px] font-bold transition-all border ${he?ee.on:ee.off} ${n?"opacity-40 pointer-events-none":"cursor-pointer hover:brightness-125"} ${$||"flex-1"}`,onClick:()=>xt(_,he?0:1),disabled:n,children:[$?null:c.jsx("span",{children:_}),c.jsx("span",{className:`text-[8px] ${he?"opacity-80":"opacity-70"}`,children:he?"ON":"OFF"})]},_)},Oo=()=>d?c.jsx("button",{onClick:()=>ce(_=>_==="rotation"?"normal":"rotation"),className:`text-[10px] p-1 rounded transition-colors mr-2 ${Y==="rotation"?"text-cyan-400 bg-cyan-500/20":"text-gray-500 hover:text-gray-300"}`,title:Y==="rotation"?"Rotation mode (π units)":"Normal mode",children:"⟳"}):null,jo=()=>!I||re?null:c.jsx("button",{onClick:()=>de(_=>!_),className:`p-1 rounded transition-colors mr-2 ${O?"text-cyan-400 bg-cyan-500/20":"text-gray-600 hover:text-gray-400"}`,title:O?"Axes linked (uniform)":"Link axes",children:c.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[c.jsx("path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"}),c.jsx("path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"})]})}),No=_=>{const D=[];re&&D.push({label:"Rotation Units",action:()=>{},isHeader:!0},{label:"Degrees (°)",checked:te==="degrees",action:()=>W("degrees")},{label:"Radians (π)",checked:te==="radians",action:()=>W("radians")}),!re&&E==="pi"&&D.push({label:"Display Units",action:()=>{},isHeader:!0},{label:"Radians (π)",checked:S==="pi",action:()=>V("pi")},{label:"Degrees (°)",checked:S==="degrees",action:()=>V("degrees")}),q&&(l==="rotation"||l==="axes")&&D.push({label:"Display Mode",action:()=>{},isHeader:!0},{label:"Azimuth / Pitch (A/P)",checked:Y==="rotation",action:()=>ce("rotation")},{label:"Per-Axis (X/Y/Z)",checked:Y==="axes"||Y==="normal",action:()=>ce("normal")}),D.length!==0&&(_.preventDefault(),_.stopPropagation(),G(_.clientX,_.clientY,D,["ui.vector"]))};return c.jsxs("div",{className:"mb-px animate-slider-entry",children:[e&&c.jsxs("div",{className:"flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5",children:[c.jsxs("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:[d&&Oo(),k,c.jsx("label",{className:`text-[10px] font-medium tracking-tight select-none flex items-center gap-2 truncate pointer-events-none ${n?"text-gray-600":"text-gray-400"}`,children:e})]}),I&&!re&&c.jsx("div",{className:"flex items-center px-1 border-l border-white/5",children:jo()})]}),c.jsx("div",{className:"relative h-9 md:h-[26px] flex items-center touch-none overflow-hidden rounded-b-sm",style:{touchAction:"none"},onContextMenu:No,"data-help-id":"ui.vector",children:c.jsx("div",{ref:Q,className:"flex gap-px w-full h-full",children:ze?c.jsx(c.Fragment,{children:["x","y","z","w"].slice(0,N?4:q?3:2).map((_,D)=>wt(_,D))}):K?c.jsxs(c.Fragment,{children:[wt("x",0,"w-14 flex-shrink-0"),c.jsx(Se,{...Pe("y"),disabled:n||P.x<.5})]}):ie?c.jsxs(c.Fragment,{children:[c.jsx("div",{className:"flex items-center justify-center px-1 flex-shrink-0",children:c.jsx(ao,{azimuth:J.azimuth,pitch:J.pitch,onChange:(_,D)=>{Ue(_,D)},onDragStart:Ie,onDragEnd:Ce,disabled:n,size:56})}),c.jsx(Se,{axisIndex:0,value:J.azimuth,min:-Math.PI,max:Math.PI,step:lt,onUpdate:_=>Ue(_,J.pitch),onDragStart:Ie,onDragEnd:Ce,disabled:n,mapping:Be,mapTextInput:!0,customLabel:"Az"}),c.jsx(Xe,{primaryAxis:"x",secondaryAxis:"y",primaryIndex:0,secondaryIndex:1,primaryValue:J.azimuth,secondaryValue:J.pitch,min:-Math.PI,max:Math.PI,step:lt,onUpdate:(_,D)=>Ue(_,D),onDragStart:Ie,onDragEnd:Ce,disabled:n,onHover:_=>T(_?"xy":null)}),c.jsx(Se,{axisIndex:1,value:J.pitch,min:-Math.PI/2,max:Math.PI/2,step:lt,onUpdate:_=>Ue(J.azimuth,_),onDragStart:Ie,onDragEnd:Ce,disabled:n,mapping:Be,mapTextInput:!0,customLabel:"Pt"})]}):re?c.jsxs(c.Fragment,{children:[q&&c.jsx(Se,{...Pe("z"),customLabel:"∠"}),c.jsx("div",{className:"flex items-center justify-center px-1",children:c.jsx(ao,{azimuth:P.x,pitch:P.y,onChange:(_,D)=>{const $=P.clone();$.x=_,$.y=D,xe(0,_),xe(1,D),z($),t($)},onDragStart:Ie,onDragEnd:Ce,disabled:n,size:56})}),c.jsx("div",{className:"contents",children:c.jsx(Se,{...Pe("x"),customLabel:"A"})}),c.jsx(Se,{...Pe("y"),customLabel:"P"})]}):c.jsxs(c.Fragment,{children:[c.jsx("div",{className:"contents",children:c.jsx(Se,{...Pe("x")})}),w&&c.jsx(Xe,{primaryAxis:"x",secondaryAxis:"y",primaryIndex:0,secondaryIndex:1,primaryValue:P.x,secondaryValue:P.y,min:a,max:r,step:i,onUpdate:(_,D)=>Qe("x","y",_,D),onDragStart:Ie,onDragEnd:Ce,disabled:n,onHover:_=>T(_?"xy":null)}),c.jsx(Se,{...Pe("y")}),q&&w&&c.jsx(Xe,{primaryAxis:"z",secondaryAxis:"y",primaryIndex:2,secondaryIndex:1,primaryValue:St.z,secondaryValue:St.y,min:a,max:r,step:i,onUpdate:(_,D)=>Qe("z","y",_,D),onDragStart:Ie,onDragEnd:Ce,disabled:n,onHover:_=>T(_?"zy":null)}),q&&c.jsx(Se,{...Pe("z")}),N&&w&&c.jsx(Xe,{primaryAxis:"x",secondaryAxis:"z",primaryIndex:3,secondaryIndex:2,primaryValue:P.w,secondaryValue:P.z,min:a,max:r,step:i,onUpdate:(_,D)=>Qe("w","z",_,D),onDragStart:Ie,onDragEnd:Ce,disabled:n,onHover:_=>T(_?"wz":null)}),N&&c.jsx(Se,{...Pe("w")})]})})})]})},Oi={default:"",panel:"px-2 py-0.5 text-[9px] font-bold text-gray-500 hover:text-gray-300 bg-neutral-800 rounded-sm"},ji=({open:e})=>c.jsx("svg",{className:`w-2 h-2 transition-transform ${e?"rotate-90":""}`,viewBox:"0 0 6 10",fill:"currentColor",children:c.jsx("path",{d:"M0 0l6 5-6 5z"})}),el=({label:e,children:o,defaultOpen:t=!0,count:a,labelVariant:r="secondary",labelColor:i,rightContent:n,className:s="",headerClassName:l="",variant:d="default",open:u,onToggle:f})=>{const p=l||Oi[d],[h,g]=L.useState(t),x=u!==void 0,m=x?u:h,y=()=>{f&&f(),x||g(b=>!b)};return c.jsxs("div",{className:s,children:[c.jsxs("div",{className:`flex items-center gap-1.5 w-full px-2 py-1 text-left select-none hover:bg-white/5 transition-colors rounded-sm ${p}`,children:[c.jsxs("button",{onClick:y,className:"flex items-center gap-1.5 flex-1 min-w-0",children:[c.jsx(ji,{open:m}),c.jsx(Ti,{variant:r,color:i,children:e}),a!==void 0&&c.jsx("span",{className:"text-[8px] bg-white/10 text-gray-400 px-1.5 py-0.5 rounded ml-1",children:a})]}),n&&c.jsx("div",{className:"ml-auto flex items-center gap-1",children:n})]}),m&&o]})},Ni=`
  /*
...
`)},$i=(e,o)=>{var s;const{shader:t,...a}=e,r={};(s=t.preambleVars)!=null&&s.length&&(r.preambleVars=t.preambleVars),t.usesSharedRotation&&(r.usesSharedRotation=!0);const i={...a,...Object.keys(r).length>0?{shaderMeta:r}:{},defaultPreset:o};let n=`<!--
...
`),n},Bi=e=>{const o=u=>{const f=new RegExp(`<${u}>([\\s\\S]*?)<\\/${u}>`),p=e.match(f);return p?p[1].trim():null},t=o("Metadata");if(!t){try{const u=JSON.parse(e);if(u.id&&u.shader)return u}catch{}throw new Error("Invalid GMF: Missing Metadata tag")}const a=JSON.parse(t),r=o("Shader_Preamble"),i=o("Shader_Function"),n=o("Shader_Loop"),s=o("Shader_Init"),l=o("Shader_Dist");if(!i||!n)throw new Error("Invalid GMF: Missing essential shader blocks (<Shader_Function> or <Shader_Loop>)");const d={function:i,loopBody:n,preamble:r||void 0,loopInit:s||void 0,getDist:l||void 0};return a.shaderMeta&&(a.shaderMeta.preambleVars&&(d.preambleVars=a.shaderMeta.preambleVars),a.shaderMeta.usesSharedRotation&&(d.usesSharedRotation=!0),delete a.shaderMeta),{...a,shader:d}},Hi=e=>{const o=e.trimStart();return o.startsWith("<!--")||o.startsWith("<Metadata>")},tl=e=>{const o=pe.get(e.formula);if(!o)return JSON.stringify(e,null,2);let t=$i(o,o.defaultPreset);return t+=`<!-- Full scene state (camera, lights, features, quality, animations) -->
`,t+=`<Scene>
${Po(e)}
</Scene>
`,t},ol=e=>{if(Hi(e)){const t=Bi(e),a=e.match(/<Scene>([\s\S]*?)<\/Scene>/);if(a){const i=JSON.parse(a[1].trim());return{def:t,preset:i}}const r=t.defaultPreset||{formula:t.id};return r.formula||(r.formula=t.id),{def:t,preset:r}}return{preset:JSON.parse(e)}};export{tl as $,Re as A,Zs as B,Ve as C,Hn as D,Qs as E,R as F,As as G,el as H,Un as I,en as J,fs as K,Zi as L,Mi as M,_n as N,os as O,vs as P,ts as Q,ss as R,Li as S,En as T,X as U,Vn as V,es as W,On as X,jn as Y,Nn as Z,as as _,mt as a,Os as a$,aa as a0,pe as a1,ps as a2,zn as a3,Dn as a4,Tn as a5,Xn as a6,Rn as a7,An as a8,Yn as a9,je as aA,Ro as aB,js as aC,Ns as aD,Hs as aE,Vs as aF,Ln as aG,Oe as aH,Pn as aI,qn as aJ,ls as aK,Zn as aL,Qn as aM,Js as aN,hn as aO,to as aP,_e as aQ,Gn as aR,ys as aS,bs as aT,$i as aU,Us as aV,H as aW,Gs as aX,qs as aY,Ws as aZ,Xs as a_,Xi as aa,ol as ab,Fn as ac,Bn as ad,cs as ae,Kn as af,_i as ag,kn as ah,Sn as ai,ln as aj,B as ak,Wn as al,us as am,ds as an,Gt as ao,Ki as ap,Ji as aq,Qi as ar,Io as as,Cn as at,Mn as au,wn as av,bn as aw,In as ax,$s as ay,Bs as az,un as b,Ys as b0,Ks as b1,Qt as b2,Ei as b3,Na as b4,qe as b5,Wa as b6,Xa as b7,Ka as b8,Ya as b9,on as bA,tn as bB,rn as bC,an as bD,ms as bE,vn as bF,Zt as bG,Ur as bH,Ja as ba,Vr as bb,ae as bc,ui as bd,nn as be,sn as bf,gs as bg,Jn as bh,Fs as bi,Ls as bj,Es as bk,ks as bl,Ts as bm,zs as bn,Ms as bo,Ds as bp,cn as bq,dn as br,Ss as bs,ws as bt,Ps as bu,Rs as bv,Is as bw,_s as bx,Cs as by,hs as bz,De as c,se as d,Co as e,F as f,Te as g,$n as h,yn as i,gn as j,Ge as k,yt as l,xs as m,we as n,rs as o,ns as p,is as q,Yi as r,xn as s,We as t,fe as u,fn as v,Gr as w,pn as x,Ti as y,mn as z};
