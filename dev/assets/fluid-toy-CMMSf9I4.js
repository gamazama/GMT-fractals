...
out vec4 fragColor;
uniform vec4 uValue;
void main() { fragColor = uValue; }`,Rn=`#version 300 es
precision highp float;
in vec2 vUv;
out vec4 fragColor;
uniform sampler2D uSource;
void main() { fragColor = texture(uSource, vUv); }`,En=`#version 300 es
precision highp float;
in vec2 vUv;
layout(location=0) out vec4 outMain;
layout(location=1) out vec4 outFx;
 ...
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at https://mozilla.org/MPL/2.0/.
 */const Tl=[48e3,44100,32e3],Cl=[24e3,22050,16e3];/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at https://mozilla.org/MPL/2.0/.
 */var Je;(function(t){t[t.NON_IDR_SLICE=1]="NON_IDR_SLICE",t[t.SLICE_DPA=2]="SLICE_DPA",t[t.SLICE_DPB=3]="SLICE_DPB",t[t.SLICE_DPC=4]="SLICE_DPC",t[t.IDR=5]="IDR",t[t.SEI=6]="SEI",t[t.SPS=7]="SPS",t[t.PPS=8]="PPS",t[t.AUD=9]="AUD",t[t.SPS_EXT=13]="SPS_EXT"})(Je||(Je={}));var oe;(function(t){t[t.RASL_N=8]="RASL_N",t[t.RASL_R=9]="RASL_R",t[t.BLA_W_LP=16]="BLA_W_LP",t[t.RSV_IRAP_VCL23=23]="RSV_IRAP_VCL23",t[t.VPS_NUT=32]="VPS_NUT",t[t.SPS_NUT=33]="SPS_NUT",t[t.PPS_NUT=34]="PPS_NUT",t[t.AUD_NUT=35]="AUD_NUT",t[t.PREFIX_SEI_NUT=39]="PREFIX_SEI_NUT",t[t.SUFFIX_SEI_NUT=40]="SUFFIX_SEI_NUT"})(oe||(oe={}));const Kt=function*(t){let e=0,i=-1;for(;e<t.length-2;){const r=t.indexOf(0,e);if(r===-1||r>=t.length-2)break;e=r;let s=0;if(e+3<t.length&&t[e+1]===0&&t[e+2]===0&&t[e+3]===1?s=4:t[e+1]===0&&t[e+2]===1&&(s=3),s===0){e++;continue}i!==-1&&e>i&&(yield{offset:i,length:e-i}),i=e+s,e=i}i!==-1&&i<t.length&&(yield{offset:i,length:t.length-i})},Sl=t=>t&31,Qt=t=>{const e=[],i=t.length;for(let r=0;r<i;r++)r+2<i&&t[r]===0&&t[r+1]===0&&t[r+2]===3?(e.push(0,0),r+=2):e.push(t[r]);return new Uint8Array(e)},kl=(t,e)=>{const i=t.reduce((a,o)=>a+e+o.byteLength,0),r=new Uint8Array(i);let s=0;for(const a of t){const o=new DataView(r.buffer,r.byteOffset,r.byteLength);switch(e){case 1:o.setUint8(s,a.byteLength);break;case 2:o.setUint16(s,a.byteLength,!1);break;case 3:qs(o,s,a.byteLength);break;case 4:o.setUint32(s,a.byteLength,!1);break}s+=e,r.set(a,s),s+=a.byteLength}return r},Al=t=>{try{const e=[],i=[],r=[];for(const n of Kt(t)){const l=t.subarray(n.offset,n.offset+n.length),c=Sl(l[0]);c===Je.SPS?e.push(l):c===Je.PPS?i.push(l):c===Je.SPS_EXT&&r.push(l)}if(e.length===0||i.length===0)return null;const s=e[0],a=Ml(s);F(a!==null);const o=a.profileIdc===100||a.profileIdc===110||a.profileIdc===122||a.profileIdc===144;return{configurationVersion:1,avcProfileIndication:a.profileIdc,profileCompatibility:a.constraintFlags,avcLevelIndication:a.levelIdc,lengthSizeMinusOne:3,sequenceParameterSets:e,pictureParameterSets:i,chromaFormat:o?a.chromaFormatIdc:null,bitDepthLumaMinus8:o?a.bitDepthLumaMinus8:null,bitDepthChromaMinus8:o?a.bitDepthChromaMinus8:null,sequenceParameterSetExt:o?r:null}}catch(e){return console.error("Error building AVC Decoder Configuration Record:",e),null}},Fl=t=>{const e=[];e.push(t.configurationVersion),e.push(t.avcProfileIndication),e.push(t.profileCompatibility),e.push(t.avcLevelIndication),e.push(252|t.lengthSizeMinusOne&3),e.push(224|t.sequenceParameterSets.length&31);for(const i of t.sequenceParameterSets){const r=i.byteLength;e.push(r>>8),e.push(r&255);for(let s=0;s<r;s++)e.push(i[s])}e.push(t.pictureParameterSets.length);for(const i of t.pictureParameterSets){const r=i.byteLength;e.push(r>>8),e.push(r&255);for(let s=0;s<r;s++)e.push(i[s])}if(t.avcProfileIndication===100||t.avcProfileIndication===110||t.avcProfileIndication===122||t.avcProfileIndication===144){F(t.chromaFormat!==null),F(t.bitDepthLumaMinus8!==null),F(t.bitDepthChromaMinus8!==null),F(t.sequenceParameterSetExt!==null),e.push(252|t.chromaFormat&3),e.push(248|t.bitDepthLumaMinus8&7),e.push(248|t.bitDepthChromaMinus8&7),e.push(t.sequenceParameterSetExt.length);for(const i of t.sequenceParameterSetExt){const r=i.byteLength;e.push(r>>8),e.push(r&255);for(let s=0;s<r;s++)e.push(i[s])}}return new Uint8Array(e)},gr={1:{num:1,den:1},2:{num:12,den:11},3:{num:10,den:11},4:{num:16,den:11},5:{num:40,den:33},6:{num:24,den:11},7:{num:20,den:11},8:{num:32,den:11},9:{num:80,den:33},10:{num:18,den:11},11:{num:15,den:11},12:{num:64,den:33},13:{num:160,den:99},14:{num:4,den:3},15:{num:3,den:2},16:{num:2,den:1}},Ml=t=>{try{const e=new te(Qt(t));if(e.skipBits(1),e.skipBits(2),e.readBits(5)!==7)return null;const r=e.readAlignedByte(),s=e.readAlignedByte(),a=e.readAlignedByte();S(e);let o=1,n=0,l=0,c=0;if((r===100||r===110||r===122||r===244||r===44||r===83||r===86||r===118||r===128)&&(o=S(e),o===3&&(c=e.readBits(1)),n=S(e),l=S(e),e.skipBits(1),e.readBits(1))){for(let I=0;I<(o!==3?8:12);I++)if(e.readBits(1)){const H=I<6?16:64;let U=8,V=8;for(let G=0;G<H;G++){if(V!==0){const K=de(e);V=(U+K+256)%256}U=V===0?U:V}}}S(e);const u=S(e);if(u===0)S(e);else if(u===1){e.skipBits(1),de(e),de(e);const N=S(e);for(let I=0;I<N;I++)de(e)}S(e),e.skipBits(1);const h=S(e),p=S(e),m=16*(h+1),b=16*(p+1);let f=m,y=b;const C=e.readBits(1);if(C||e.skipBits(1),e.skipBits(1),e.readBits(1)){const N=S(e),I=S(e),R=S(e),H=S(e);let U,V;if((c===0?o:0)===0)U=1,V=2-C;else{const K=o===3?1:2,ce=o===1?2:1;U=K,V=ce*(2-C)}f-=U*(N+I),y-=V*(R+H)}let O=2,E=2,v=2,T=0,B={num:1,den:1},j=null,z=null;if(e.readBits(1)){if(e.readBits(1)){const ce=e.readBits(8);if(ce===255)B={num:e.readBits(16),den:e.readBits(16)};else{const Te=gr[ce];Te&&(B=Te)}}e.readBits(1)&&e.skipBits(1),e.readBits(1)&&(e.skipBits(3),T=e.readBits(1),e.readBits(1)&&(O=e.readBits(8),E=e.readBits(8),v=e.readBits(8))),e.readBits(1)&&(S(e),S(e)),e.readBits(1)&&(e.skipBits(32),e.skipBits(32),e.skipBits(1));const V=e.readBits(1);V&&wi(e);const G=e.readBits(1);G&&wi(e),(V||G)&&e.skipBits(1),e.skipBits(1),e.readBits(1)&&(e.skipBits(1),S(e),S(e),S(e),S(e),j=S(e),z=S(e))}if(j===null){F(z===null);const N=s&16;if((r===44||r===86||r===100||r===110||r===122||r===244)&&N)j=0,z=0;else{const I=h+1,R=p+1,H=(2-C)*R,U=ci.find(G=>G.level>=a)??Me(ci),V=Math.min(Math.floor(U.maxDpbMbs/(I*H)),16);j=V,z=V}}return F(z!==null),{profileIdc:r,constraintFlags:s,levelIdc:a,frameMbsOnlyFlag:C,chromaFormatIdc:o,bitDepthLumaMinus8:n,bitDepthChromaMinus8:l,codedWidth:m,codedHeight:b,displayWidth:f,displayHeight:y,pixelAspectRatio:B,colourPrimaries:O,matrixCoefficients:v,transferCharacteristics:E,fullRangeFlag:T,numReorderFrames:j,maxDecFrameBuffering:z}}catch(e){return console.error("Error parsing AVC SPS:",e),null}},wi=t=>{const e=S(t);t.skipBits(4),t.skipBits(4);for(let i=0;i<=e;i++)S(t),S(t),t.skipBits(1);t.skipBits(5),t.skipBits(5),t.skipBits(5),t.skipBits(5)},Ti=t=>t>>1&63,Rl=t=>{try{const e=new te(Qt(t));e.skipBits(16),e.readBits(4);const i=e.readBits(3),r=e.readBits(1),{general_profile_space:s,general_tier_flag:a,general_profile_idc:o,general_profile_compatibility_flags:n,general_constraint_indicator_flags:l,general_level_idc:c}=Pl(e,i);S(e);const u=S(e);let h=0;u===3&&(h=e.readBits(1));const p=S(e),m=S(e);let b=p,f=m;if(e.readBits(1)){const I=S(e),R=S(e),H=S(e),U=S(e);let V=1,G=1;const K=h===0?u:0;K===1?(V=2,G=2):K===2&&(V=2,G=1),b-=(I+R)*V,f-=(H+U)*G}const y=S(e),C=S(e);S(e);const O=e.readBits(1)?0:i;let E=0;for(let I=O;I<=i;I++)S(e),E=S(e),S(e);S(e),S(e),S(e),S(e),S(e),S(e),e.readBits(1)&&e.readBits(1)&&_l(e),e.skipBits(1),e.skipBits(1),e.readBits(1)&&(e.skipBits(4),e.skipBits(4),S(e),S(e),e.skipBits(1));const v=S(e);if(Dl(e,v),e.readBits(1)){const I=S(e);for(let R=0;R<I;R++)S(e),e.skipBits(1)}e.skipBits(1),e.skipBits(1);let T=2,B=2,j=2,z=0,D=0,N={num:1,den:1};if(e.readBits(1)){const I=Bl(e,i);N=I.pixelAspectRatio,T=I.colourPrimaries,B=I.transferCharacteristics,j=I.matrixCoefficients,z=I.fullRangeFlag,D=I.minSpatialSegmentationIdc}return{displayWidth:b,displayHeight:f,pixelAspectRatio:N,colourPrimaries:T,transferCharacteristics:B,matrixCoefficients:j,fullRangeFlag:z,maxDecFrameBuffering:E+1,spsMaxSubLayersMinus1:i,spsTemporalIdNestingFlag:r,generalProfileSpace:s,generalTierFlag:a,generalProfileIdc:o,generalProfileCompatibilityFlags:n,generalConstraintIndicatorFlags:l,generalLevelIdc:c,chromaFormatIdc:u,bitDepthLumaMinus8:y,bitDepthChromaMinus8:C,minSpatialSegmentationIdc:D}}catch(e){return console.error("Error parsing HEVC SPS:",e),null}},El=t=>{try{const e=[],i=[],r=[],s=[];for(const c of Kt(t)){const u=t.subarray(c.offset,c.offset+c.length),h=Ti(u[0]);h===oe.VPS_NUT?e.push(u):h===oe.SPS_NUT?i.push(u):h===oe.PPS_NUT?r.push(u):(h===oe.PREFIX_SEI_NUT||h===oe.SUFFIX_SEI_NUT)&&s.push(u)}if(i.length===0||r.length===0)return null;const a=Rl(i[0]);if(!a)return null;let o=0;if(r.length>0){const c=r[0],u=new te(Qt(c));u.skipBits(16),S(u),S(u),u.skipBits(1),u.skipBits(1),u.skipBits(3),u.skipBits(1),u.skipBits(1),S(u),S(u),de(u),u.skipBits(1),u.skipBits(1),u.readBits(1)&&S(u),de(u),de(u),u.skipBits(1),u.skipBits(1),u.skipBits(1),u.skipBits(1);const h=u.readBits(1),p=u.readBits(1);!h&&!p?o=0:h&&!p?o=2:!h&&p?o=3:o=0}const n=[...e.length?[{arrayCompleteness:1,nalUnitType:oe.VPS_NUT,nalUnits:e}]:[],...i.length?[{arrayCompleteness:1,nalUnitType:oe.SPS_NUT,nalUnits:i}]:[],...r.length?[{arrayCompleteness:1,nalUnitType:oe.PPS_NUT,nalUnits:r}]:[],...s.length?[{arrayCompleteness:1,nalUnitType:Ti(s[0][0]),nalUnits:s}]:[]];return{configurationVersion:1,generalProfileSpace:a.generalProfileSpace,generalTierFlag:a.generalTierFlag,generalProfileIdc:a.generalProfileIdc,generalProfileCompatibilityFlags:a.generalProfileCompatibilityFlags,generalConstraintIndicatorFlags:a.generalConstraintIndicatorFlags,generalLevelIdc:a.generalLevelIdc,minSpatialSegmentationIdc:a.minSpatialSegmentationIdc,parallelismType:o,chromaFormatIdc:a.chromaFormatIdc,bitDepthLumaMinus8:a.bitDepthLumaMinus8,bitDepthChromaMinus8:a.bitDepthChromaMinus8,avgFrameRate:0,constantFrameRate:0,numTemporalLayers:a.spsMaxSubLayersMinus1+1,temporalIdNested:a.spsTemporalIdNestingFlag,lengthSizeMinusOne:3,arrays:n}}catch(e){return console.error("Error building HEVC Decoder Configuration Record:",e),null}},Pl=(t,e)=>{const i=t.readBits(2),r=t.readBits(1),s=t.readBits(5);let a=0;for(let u=0;u<32;u++)a=a<<1|t.readBits(1);const o=new Uint8Array(6);for(let u=0;u<6;u++)o[u]=t.readBits(8);const n=t.readBits(8),l=[],c=[];for(let u=0;u<e;u++)l.push(t.readBits(1)),c.push(t.readBits(1));if(e>0)for(let u=e;u<8;u++)t.skipBits(2);for(let u=0;u<e;u++)l[u]&&t.skipBits(88),c[u]&&t.skipBits(8);return{general_profile_space:i,general_tier_flag:r,general_profile_idc:s,general_profile_compatibility_flags:a,general_constraint_indicator_flags:o,general_level_idc:n}},_l=t=>{for(let e=0;e<4;e++)for(let i=0;i<(e===3?2:6);i++)if(!t.readBits(1))S(t);else{const s=Math.min(64,1<<4+(e<<1));e>1&&de(t);for(let a=0;a<s;a++)de(t)}},Dl=(t,e)=>{const i=[];for(let r=0;r<e;r++)i[r]=Il(t,r,e,i)},Il=(t,e,i,r)=>{let s=0,a=0,o=0;if(e!==0&&(a=t.readBits(1)),a){if(e===i){const l=S(t);o=e-(l+1)}else o=e-1;t.readBits(1),S(t);const n=r[o]??0;for(let l=0;l<=n;l++)t.readBits(1)||t.readBits(1);s=r[o]}else{const n=S(t),l=S(t);for(let c=0;c<n;c++)S(t),t.readBits(1);for(let c=0;c<l;c++)S(t),t.readBits(1);s=n+l}return s},Bl=(t,e)=>{let i=2,r=2,s=2,a=0,o=0,n={num:1,den:1};if(t.readBits(1)){const l=t.readBits(8);if(l===255)n={num:t.readBits(16),den:t.readBits(16)};else{const c=gr[l];c&&(n=c)}}return t.readBits(1)&&t.readBits(1),t.readBits(1)&&(t.readBits(3),a=t.readBits(1),t.readBits(1)&&(i=t.readBits(8),r=t.readBits(8),s=t.readBits(8))),t.readBits(1)&&(S(t),S(t)),t.readBits(1),t.readBits(1),t.readBits(1),t.readBits(1)&&(S(t),S(t),S(t),S(t)),t.readBits(1)&&(t.readBits(32),t.readBits(32),t.readBits(1)&&S(t),t.readBits(1)&&jl(t,!0,e)),t.readBits(1)&&(t.readBits(1),t.readBits(1),t.readBits(1),o=S(t),S(t),S(t),S(t),S(t)),{pixelAspectRatio:n,colourPrimaries:i,transferCharacteristics:r,matrixCoefficients:s,fullRangeFlag:a,minSpatialSegmentationIdc:o}},jl=(t,e,i)=>{let r=!1,s=!1,a=!1;r=t.readBits(1)===1,s=t.readBits(1)===1,(r||s)&&(a=t.readBits(1)===1,a&&(t.readBits(8),t.readBits(5),t.readBits(1),t.readBits(5)),t.readBits(4),t.readBits(4),a&&t.readBits(4),t.readBits(5),t.readBits(5),t.readBits(5));for(let o=0;o<=i;o++){const n=t.readBits(1)===1;let l=!0;n||(l=t.readBits(1)===1);let c=!1;l?S(t):c=t.readBits(1)===1;let u=1;c||(u=S(t)+1),r&&Ci(t,u,a),s&&Ci(t,u,a)}},Ci=(t,e,i)=>{for(let r=0;r<e;r++)S(t),S(t),i&&(S(t),S(t)),t.readBits(1)},zl=t=>{const e=[];e.push(t.configurationVersion),e.push((t.generalProfileSpace&3)<<6|(t.generalTierFlag&1)<<5|t.generalProfileIdc&31),e.push(t.generalProfileCompatibilityFlags>>>24&255),e.push(t.generalProfileCompatibilityFlags>>>16&255),e.push(t.generalProfileCompatibilityFlags>>>8&255),e.push(t.generalProfileCompatibilityFlags&255),e.push(...t.generalConstraintIndicatorFlags),e.push(t.generalLevelIdc&255),e.push(240|t.minSpatialSegmentationIdc>>8&15),e.push(t.minSpatialSegmentationIdc&255),e.push(252|t.parallelismType&3),e.push(252|t.chromaFormatIdc&3),e.push(248|t.bitDepthLumaMinus8&7),e.push(248|t.bitDepthChromaMinus8&7),e.push(t.avgFrameRate>>8&255),e.push(t.avgFrameRate&255),e.push((t.constantFrameRate&3)<<6|(t.numTemporalLayers&7)<<3|(t.temporalIdNested&1)<<2|t.lengthSizeMinusOne&3),e.push(t.arrays.length&255);for(const i of t.arrays){e.push((i.arrayCompleteness&1)<<7|0|i.nalUnitType&63),e.push(i.nalUnits.length>>8&255),e.push(i.nalUnits.length&255);for(const r of i.nalUnits){e.push(r.length>>8&255),e.push(r.length&255);for(let s=0;s<r.length;s++)e.push(r[s])}}return new Uint8Array(e)},br=t=>{const e=Gi(t),i=e.getUint8(9),r=e.getUint16(10,!0),s=e.getUint32(12,!0),a=e.getInt16(16,!0),o=e.getUint8(18);let n=null;return o&&(n=t.subarray(19,21+i)),{outputChannelCount:i,preSkip:r,inputSampleRate:s,outputGain:a,channelMappingFamily:o,channelMappingTable:n}};var Si;(function(t){t[t.STREAMINFO=0]="STREAMINFO",t[t.VORBIS_COMMENT=4]="VORBIS_COMMENT",t[t.PICTURE=6]="PICTURE"})(Si||(Si={}));const Ol=t=>{if(t.length<7||t[0]!==11||t[1]!==119)return null;const e=new te(t);e.skipBits(16),e.skipBits(16);const i=e.readBits(2);if(i===3)return null;const r=e.readBits(6),s=e.readBits(5);if(s>8)return null;const a=e.readBits(3),o=e.readBits(3);o&1&&o!==1&&e.skipBits(2),o&4&&e.skipBits(2),o===2&&e.skipBits(2);const n=e.readBits(1),l=Math.floor(r/2);return{fscod:i,bsid:s,bsmod:a,acmod:o,lfeon:n,bitRateCode:l}},Ul=[1,2,3,6],Ll=t=>{if(t.length<6||t[0]!==11||t[1]!==119)return null;const e=new te(t);e.skipBits(16);const i=e.readBits(2);if(e.skipBits(3),i!==0&&i!==2)return null;const r=e.readBits(11),s=e.readBits(2);let a=0,o;s===3?(a=e.readBits(2),o=3):o=e.readBits(2);const n=e.readBits(3),l=e.readBits(1),c=e.readBits(5);if(c<11||c>16)return null;const u=Ul[o];let h;return s<3?h=Tl[s]/1e3:h=Cl[a]/1e3,{dataRate:Math.round((r+1)*h/(u*16)),substreams:[{fscod:s,fscod2:a,bsid:c,bsmod:0,acmod:n,lfeon:l,numDepSub:0,chanLoc:0}]}};/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 ...
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at https://mozilla.org/MPL/2.0/.
 */const Nl=t=>{let i=(t.hasVideo?"video/":t.hasAudio?"audio/":"application/")+(t.isQuickTime?"quicktime":"mp4");if(t.codecStrings.length>0){const r=[...new Set(t.codecStrings)];i+=`; codecs="${r.join(", ")}"`}return i};/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
