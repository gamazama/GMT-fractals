...
}`}function vn(e){const t=e.definition,o=Eo(e),n=e.interlace,s=n?St(n):null,i=Po(t),a=Ao(o,!!t.shader.getDist,"uVoxelSize * 0.5",e.estimator);return`#version 300 es
precision highp float;
...
}`}function xn(e){const t=e.definition,o=Eo(e),n=e.interlace,s=n?St(n):null,i=Po(t),a=o==="ifs"?"0.0":"0.001",r=Ao(o,!!t.shader.getDist,a,e.estimator);return`#version 300 es
...
`)),p=no(this.renderMode),F=Tn(this.postProcessLogic.join(`
`)),h=[["Defines",t],["Uniforms",o],["Headers",n],["Math",l],["BlueNoise",ut],["Coloring",ct],["Preambles",s],["Formulas",i],["DE",m],["PostDE",a],["MatEval",v],["MissHandler",d],["Ray",p],["Trace",x],["TraceLean",g],["Integrators",r],["Post",F],["Main",M]];return h.filter(([,y])=>y.length>0).map(([y,S])=>`${y}: ${(S.length/1024).toFixed(1)}kb`).join(" | "),h.reduce((y,[,S])=>y+S.length,0),`
${t}
${o}
${n}
${l}
