var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,z as D,B as j,H as $,I as p,J as g,K as S,u as m,M as w,N as R,O as B,S as O,E as k,D as N,l as V,P as G,T as H,n as q,o as X,G as Y,i as Q,q as W,t as K,Q as Z,v as J,w as ee,R as te,x as ae,y as ie}from"./Undo-ZT1vKsQw.js";import{r as v,j as l,R as oe}from"./three-fiber-OZZ-CFAc.js";import{V as re,i as ne,c as se}from"./Camera-17nA4u8f.js";import{c as le}from"./three-drei-B0ZqTV5-.js";import{C as ce}from"./CompilingIndicator-BZK7cdLM.js";import{r as fe}from"./cameraKeyRegistry-RijtvO-I.js";import"./three-CAXFefdI.js";import"./pako-DwGzBETv.js";const u=new Map,A=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),D(t.name)||j({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},me=`
