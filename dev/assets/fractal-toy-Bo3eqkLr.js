var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,h as D,F as p,i as g,u as m}from"./CollapsibleSection-CQwPkFXk.js";import{r as v,j as l,R as j}from"./three-fiber-GKfjny8F.js";import{k as $,l as k,m as S,u as w,v as R,n as B,S as O,E as N,D as V,b as G,P as H,T as q,d as X,e as Y,G as W,a as Q,f as Z,r as K,o as J,i as ee,g as te,q as ae,h as ie,j as oe}from"./Undo-CTCtE7Oc.js";import{V as re,i as ne,c as se}from"./Camera-FcWJIQs1.js";import{c as le}from"./three-drei-CNorP-x_.js";import{C as ce}from"./CompilingIndicator-5xO0ksCx.js";import{r as fe}from"./cameraKeyRegistry-VEijEHoN.js";import"./three-DQWx7qFd.js";import"./pako-DwGzBETv.js";const u=new Map,A=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),$(t.name)||k({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},me=`
