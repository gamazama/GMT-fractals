var C=Object.defineProperty;var S=(a,t,i)=>t in a?C(a,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):a[t]=i;var n=(a,t,i)=>S(a,typeof t!="symbol"?t+"":t,i);const N=256;class U{constructor(t){n(this,"mainTex",null);n(this,"collisionTex",null);n(this,"version",0);this.gl=t}getTexture(t){return t==="main"?this.mainTex:this.collisionTex}setBuffer(t,i){const e=this.gl,r=256*4;i.length!==r&&console.warn(`[GradientLut] ${t} buffer length ${i.length} (want ${r})`);let o=this.getTexture(t);o||(o=e.createTexture(),t==="main"?this.mainTex=o:this.collisionTex=o),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,o),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.REPEAT),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,256,1,0,e.RGBA,e.UNSIGNED_BYTE,i),this.version++}ensure(t){if(this.getTexture(t))return;const i=256,e=new Uint8Array(i*4);if(t==="main")for(let r=0;r<i;++r)e[r*4+0]=r,e[r*4+1]=r,e[r*4+2]=r,e[r*4+3]=255;else for(let r=0;r<i;++r)e[r*4+3]=255;this.setBuffer(t,e)}dispose(){const t=this.gl;this.mainTex&&(t.deleteTexture(this.mainTex),this.mainTex=null),this.collisionTex&&(t.deleteTexture(this.collisionTex),this.collisionTex=null)}}const f=(a,t)=>{const i=a+t,e=i-a,r=a-(i-e)+(t-e);return[i,r]},j=(a,t,i)=>{const[e,r]=f(a,i),[o,s]=f(e,t+r);return[o,s]},T=(a,t,i,e)=>{const[r,o]=f(a,-i),[s,l]=f(r,o+(t-e));return[s,l]},Z=`
