...
`,ln={id:"materials",shortId:"m",name:"Material",category:"Rendering",tabConfig:{label:"Shader",componentId:"panel-shading",order:40},params:{diffuse:{type:"float",default:1,label:"Diffuse (Color)",shortId:"di",uniform:"uDiffuse",min:0,max:2,step:.01,group:"surface"},reflection:{type:"float",default:0,label:"Metallic",shortId:"re",uniform:"uReflection",min:0,max:1,step:.01,group:"surface"},specular:{type:"float",default:.3,label:"Reflectivity",shortId:"sp",uniform:"uSpecular",min:0,max:2,step:.01,group:"surface"},roughness:{type:"float",default:.5,label:"Roughness",shortId:"ro",uniform:"uRoughness",min:.001,max:1,step:.001,group:"surface"},rim:{type:"float",default:0,label:"Rim Light",shortId:"ri",uniform:"uRim",min:0,max:10,step:.01,scale:"log",group:"surface"},rimExponent:{type:"float",default:4,label:"Rim Sharpness",shortId:"rx",uniform:"uRimExponent",min:1,max:16,step:.1,group:"surface",parentId:"rim",condition:{gt:0}},envStrength:{type:"float",default:0,label:"Environment Light",shortId:"es",uniform:"uEnvStrengthSlider",min:0,max:5,step:.01,group:"env"},envBackgroundStrength:{type:"float",default:0,label:"BG Visibility",shortId:"eb",uniform:"uEnvBackgroundStrength",min:0,max:2,step:.01,group:"env",parentId:"envStrength",condition:{gt:0,param:"envStrength"}},envSource:{type:"float",default:1,label:"Source",shortId:"eo",uniform:"uEnvSource",group:"env",parentId:"envStrength",condition:{gt:0,param:"envStrength"},options:[{label:"Sky Image",value:0},{label:"Gradient",value:1}]},envMapData:{type:"image",default:null,label:"Upload Texture",shortId:"et",group:"env",parentId:"envSource",condition:{eq:0},uniform:"uEnvMapTexture",textureSettings:{mapping:Ri,minFilter:Ti,generateMipmaps:!0},linkedParams:{colorSpace:"envMapColorSpace"}},envMapColorSpace:{type:"float",default:0,label:"Env Profile",shortId:"ec",uniform:"uEnvMapColorSpace",group:"env",hidden:!0},useEnvMap:{type:"boolean",default:!1,label:"Use Env Map",shortId:"eu",uniform:"uUseEnvMap",hidden:!0,group:"env"},envRotation:{type:"float",default:0,label:"Rotation",shortId:"er",uniform:"uEnvRotation",min:0,max:6.28,step:.01,group:"env",parentId:"envSource",condition:[{param:"envStrength",gt:0},{param:"envSource",eq:0}]},envGradientStops:{type:"gradient",default:[{id:"sky",position:0,color:"#000000",bias:.5,interpolation:"smooth"},{id:"hor",position:.5,color:"#223344",bias:.5,interpolation:"smooth"},{id:"zen",position:1,color:"#88ccff",bias:.5,interpolation:"smooth"}],label:"Sky Gradient",shortId:"eg",uniform:"uEnvGradient",group:"env",parentId:"envSource",condition:{eq:1}},emission:{type:"float",default:0,label:"Self-illumination",shortId:"em",uniform:"uEmission",min:0,max:5,step:.001,scale:"square",group:"emission"},emissionMode:{type:"float",default:0,label:"Emission Source",shortId:"ec",uniform:"uEmissionMode",min:0,max:4,step:1,group:"emission",parentId:"emission",condition:{gt:1e-4},options:[{label:"Full Surface",value:0},{label:"Layer 1",value:1},{label:"Layer 2",value:2},{label:"Layer 3",value:3},{label:"Solid Color",value:4}]},emissionColor:{type:"color",default:new Oe(1,1,1),label:"Solid Color",shortId:"el",uniform:"uEmissionColor",group:"emission",parentId:"emissionMode",condition:{eq:4}},ptEmissionMult:{type:"float",default:1,label:"Illumination Power",shortId:"ep",uniform:"uPTEmissionMult",min:0,max:10,step:.1,group:"emission",parentId:"emission",condition:[{gt:1e-4},{param:"$renderMode",eq:"PathTracing"}]}},inject:e=>{e.addHeader(sn),e.addMaterialLogic(nn),e.addFunction(rn)}},cn={id:"colorGrading",shortId:"cg",name:"Color Grading",category:"Post Process",customUI:[{componentId:"scene-histogram",group:"grading",parentId:"active",condition:{param:"active",bool:!0}}],params:{toneMapping:{type:"float",default:0,label:"Tone Mapping",shortId:"tm",uniform:"uToneMapping",group:"grading",noReset:!0,options:[{label:"ACES",value:0},{label:"AgX",value:1},{label:"Reinhard",value:2},{label:"Neutral",value:3},{label:"None",value:4}]},active:{type:"boolean",default:!1,label:"Color Correction",shortId:"ac",uniform:"uGradingActive",group:"grading",noReset:!0},saturation:{type:"float",default:1,label:"Saturation",shortId:"sa",uniform:"uSaturation",min:0,max:2,step:.01,group:"grading",parentId:"active",condition:{bool:!0},noReset:!0},levelsMin:{type:"float",default:0,label:"Black Point",shortId:"ln",uniform:"uLevelsMin",min:0,max:1,step:.01,group:"grading",parentId:"active",condition:{bool:!0},noReset:!0,hidden:!0},levelsMax:{type:"float",default:1,label:"White Point",shortId:"lx",uniform:"uLevelsMax",min:0,max:2,step:.01,group:"grading",parentId:"active",condition:{bool:!0},noReset:!0,hidden:!0},levelsGamma:{type:"float",default:1,label:"Gamma",shortId:"lg",uniform:"uLevelsGamma",min:.1,max:3,step:.01,group:"grading",parentId:"active",condition:{bool:!0},noReset:!0,hidden:!0}},postShader:{functions:`
    ...
    `;return nr.forEach((o,a)=>{const r=a===0,n=`if (mode < ${o.value}.5)`,s=`
        ${r?n:"else "+n} {
            // ${o.label}
            ${o.glsl}
        }`;e+=s}),e+=`
...
void initHybridTransform() {}
void formula_Hybrid(inout vec4 z, inout float dr, inout float trap, vec4 c) {}`);else{const d=(a==null?void 0:a.hybridFoldType)??0,u=Mn(d);e.addFunction(u.glsl);const f=(a==null?void 0:a.hybridPermute)??0,p=Cn(f);e.addFunction(kn(p,u.rotMode??"wrap"))}let i="",l="";if(o.formula!=="MandelTerrain"&&(l+="if (uBurningEnabled > 0.5) z.xyz = abs(z.xyz);"),s)if(!(a&&a.hybridComplex))i+=`
                if (uHybrid > 0.5) {
                    initHybridTransform();
...
This rotation is bound to 'ParamC' (Slider below). Try dragging it!`},{id:"rot-1",type:"Rotate",enabled:!0,params:{x:0,y:0,z:0},bindings:{z:"ParamC"}},{id:"bulb-1",type:"Mandelbulb",enabled:!0,params:{power:8}},{id:"add-c",type:"AddConstant",enabled:!0,params:{scale:1}}],et=ue(),E=er()(ar((e,o,a)=>({...Ei(e,o),...Ni(e,o),...qi(e,o),...Ki(e,o),...ps(e,o),formula:"Mandelbulb",pipeline:Ea,pipelineRevision:1,graph:bo(Ea),projectSettings:{name:"Mandelbulb",version:0},lastSavedHash:null,animations:[],liveModulations:{},setFormula:(r,n={})=>{const s=o(),i=s.formula;if(i===r&&r!=="Modular")return;n.skipDefaultPreset||o().resetParamHistory();const l=s.projectSettings.name;let c=l;if((l===i||l==="Untitled"||l==="Custom Preset")&&(c=r),e({formula:r,projectSettings:{...s.projectSettings,name:c}}),Z.emit(pe.CONFIG,{formula:r,pipeline:s.pipeline,graph:s.graph}),r!=="Modular"&&!n.skipDefaultPreset){const d=xe.get(r),u=d&&d.defaultPreset?JSON.parse(JSON.stringify(d.defaultPreset)):{formula:r};u.features||(u.features={});const f=o();if(ne.getEngineFeatures().forEach(h=>{const x=f[h.id];if(!x)return;const z=u.features[h.id]||{},y={},b=h.engineConfig.toggleParam;x[b]!==void 0&&z[b]===void 0&&(y[b]=x[b]),Object.entries(h.params).forEach(([g,m])=>{m.onUpdate==="compile"&&x[g]!==void 0&&z[g]===void 0&&(y[g]=x[g])}),u.features[h.id]||(u.features[h.id]={}),Object.assign(u.features[h.id],y)}),o().lockSceneOnSwitch){const h=o().getPreset(),x={...h.features||{}},z=u.features||{};z.coreMath&&(x.coreMath=z.coreMath),z.geometry&&(x.geometry=z.geometry);const y={...h,formula:r,features:x};o().loadPreset(y)}else o().loadPreset(u)}o().handleInteractionEnd()},setProjectSettings:r=>e(n=>{const s={...n.projectSettings,...r};return r.name&&r.name!==n.projectSettings.name?(s.version=0,{projectSettings:s,lastSavedHash:null}):{projectSettings:s}}),prepareExport:()=>{const r=o(),n=r.getPreset({includeScene:!0}),{version:s,name:i,...l}=n,c=JSON.stringify(l);if(r.lastSavedHash===null||r.projectSettings.version===0){const d=Math.max(1,r.projectSettings.version+1);return e({projectSettings:{...r.projectSettings,version:d},lastSavedHash:c}),d}if(r.lastSavedHash!==c){const d=r.projectSettings.version+1;return e({projectSettings:{...r.projectSettings,version:d},lastSavedHash:c}),d}return r.projectSettings.version},setAnimations:r=>{const n=o().animations,s=r.map(i=>{const l=n.find(c=>c.id===i.id);if(!l)return i;if(i.period!==l.period&&i.period>0){const c=performance.now()/1e3,d=(c/l.period+l.phase-c/i.period)%1;return{...i,phase:(d+1)%1}}return i});e({animations:s})},setLiveModulations:r=>e({liveModulations:r}),setGraph:r=>{const n=yo(r.nodes,r.edges),s=o();if(Ls(s.pipeline,n))Es(s.pipeline,n)?e({graph:r}):(e({graph:r,pipeline:n}),Z.emit(pe.CONFIG,{pipeline:n}));else if(s.autoCompile){const i=s.pipelineRevision+1;e({graph:r,pipeline:n,pipelineRevision:i}),Z.emit(pe.CONFIG,{pipeline:n,graph:r,pipelineRevision:i})}else e({graph:r})},setPipeline:r=>{const n=o().pipelineRevision+1,s=bo(r);e({pipeline:r,graph:s,pipelineRevision:n}),Z.emit(pe.CONFIG,{pipeline:r,graph:s,pipelineRevision:n})},refreshPipeline:()=>{const r=o(),n=yo(r.graph.nodes,r.graph.edges),s=r.pipelineRevision+1;e({pipeline:n,pipelineRevision:s}),Z.emit(pe.CONFIG,{pipeline:n,graph:r.graph,pipelineRevision:s})},loadPreset:r=>{o().resetParamHistory();const n=xe.get(r.formula),s=n?n.id:r.formula;e({formula:s}),Z.emit(pe.CONFIG,{formula:s});let i=r.name;(!i||i==="Untitled"||i==="Custom Preset")&&(i=s),e({projectSettings:{name:i,version:0},lastSavedHash:null}),Is(r,e,o),setTimeout(()=>{const l=o().getPreset({includeScene:!0}),{version:c,name:d,...u}=l;e({lastSavedHash:JSON.stringify(u)})},50)},getPreset:r=>{var l,c;const n=o(),s={version:n.projectSettings.version,name:n.projectSettings.name,formula:n.formula,features:{}};if((r==null?void 0:r.includeScene)!==!1){if(et.activeCamera&&et.virtualSpace){const d=et.virtualSpace.getUnifiedCameraState(et.activeCamera,n.targetDistance);s.cameraPos=d.position,s.cameraRot=d.rotation,s.sceneOffset=d.sceneOffset,s.targetDistance=d.targetDistance}else s.cameraPos=n.cameraPos,s.cameraRot=n.cameraRot,s.sceneOffset=n.sceneOffset,s.targetDistance=n.targetDistance;s.cameraMode=n.cameraMode,s.lights=[],s.renderMode=n.renderMode,s.quality={aaMode:n.aaMode,aaLevel:n.aaLevel,msaa:n.msaaSamples,accumulation:n.accumulation}}ne.getAll().forEach(d=>{const u=n[d.id];u&&(s.features||(s.features={}),s.features[d.id]=Kt(u))}),s.animations=n.animations,n.formula==="Modular"&&(s.graph=n.graph,s.pipeline=n.pipeline);try{const d=(c=(l=window.useAnimationStore)==null?void 0:l.getState)==null?void 0:c.call(l);d&&(s.sequence=d.sequence,s.duration=d.durationFrames)}catch(d){console.warn("Failed to save animation sequence:",d)}return s},getShareString:r=>{const n=o().getPreset({includeScene:!0}),s=o().advancedMode;return _s(n,s,r)},loadShareString:r=>{const n=mr(r);return n?(o().loadPreset(n),!0):!1}}))),gr=e=>e.isUserInteracting||e.interactionMode!=="none",Aa=e=>{var a;if(e.isGizmoDragging||e.interactionMode!=="none"||e.isExporting)return!0;const o=ne.getAll();for(const r of o)if((a=r.interactionConfig)!=null&&a.blockCamera&&r.interactionConfig.activeParam){const n=e[r.id];if(n&&n[r.interactionConfig.activeParam])return!0}return!1},xr=e=>{const o={formula:e.formula,pipeline:e.pipeline,pipelineRevision:e.pipelineRevision,graph:e.graph,msaaSamples:e.msaaSamples,previewMode:e.previewMode,renderMode:e.renderMode,compilerHardCap:e.compilerHardCap,shadows:!0,quality:e.quality};return ne.getAll().forEach(r=>{const n=e[r.id];n&&(o[r.id]=n)}),o},As=()=>{const e=E.getState();ta.connect(window.useAnimationStore,E),et.isPaused=e.isPaused,et.setPreviewSampleCap(e.sampleCap),et.onBooted=()=>{const r=E.getState().sceneOffset;if(r){const n={x:r.x,y:r.y,z:r.z,xL:r.xL??0,yL:r.yL??0,zL:r.zL??0};et.setShadowOffset(n),et.post({type:"OFFSET_SET",offset:n})}},E.subscribe(a=>a.isPaused,a=>{et.isPaused=a}),E.subscribe(a=>a.sampleCap,a=>{et.setPreviewSampleCap(a)}),E.subscribe(a=>[a.cameraPos,a.cameraRot,a.sceneOffset,a.targetDistance,a.optics],a=>{var u,f;const[r,n,s,i,l]=a,c=E.getState(),d=(f=(u=window.useAnimationStore)==null?void 0:u.getState)==null?void 0:f.call(u).isPlaying;c.activeCameraId&&!d&&c.updateCamera(c.activeCameraId,{position:r,rotation:n,sceneOffset:s,targetDistance:i,optics:l})},{fireImmediately:!1,equalityFn:(a,r)=>JSON.stringify(a)===JSON.stringify(r)});const o=window.useAnimationStore;if(o){let a=!1;o.subscribe(r=>r.isPlaying,r=>{if(!r&&a){const n=E.getState();n.activeCameraId&&n.updateCamera(n.activeCameraId,{position:n.cameraPos,rotation:n.cameraRot,sceneOffset:n.sceneOffset,targetDistance:n.targetDistance,optics:n.optics})}a=r})}E.subscribe(a=>{var r;return(r=a.lighting)==null?void 0:r.renderMode},a=>{const r=a===1?"PathTracing":"Direct";E.getState().renderMode!==r&&E.setState({renderMode:r})}),Z.on(pe.BUCKET_STATUS,({isRendering:a})=>{E.getState().setIsBucketRendering(a)})};typeof window<"u"&&(window.__store=E);const Tt=()=>t.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:t.jsx("polyline",{points:"6 9 12 15 18 9"})}),Ns=()=>t.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:t.jsx("polyline",{points:"18 15 12 9 6 15"})}),vo=()=>t.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:t.jsx("polyline",{points:"15 18 9 12 15 6"})}),aa=()=>t.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:t.jsx("polyline",{points:"9 18 15 12 9 6"})}),Bs=()=>t.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:t.jsx("polyline",{points:"9 18 15 12 9 6"})}),Os=()=>t.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:t.jsx("path",{d:"M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"})}),$s=()=>t.jsx("svg",{width:"100%",height:"100%",viewBox:"0 0 10 10",children:t.jsx("path",{d:"M 6 10 L 10 6 L 10 10 Z",fill:"currentColor",opacity:"0.5"})}),yr=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("line",{x1:"4",y1:"9",x2:"20",y2:"9"}),t.jsx("line",{x1:"4",y1:"15",x2:"20",y2:"15"})]}),St=()=>t.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:t.jsx("path",{d:"M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"})}),Xa=()=>t.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),t.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]}),Hs=()=>t.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("line",{x1:"3",y1:"12",x2:"21",y2:"12"}),t.jsx("line",{x1:"3",y1:"6",x2:"21",y2:"6"}),t.jsx("line",{x1:"3",y1:"18",x2:"21",y2:"18"})]}),wo=()=>t.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"}),t.jsx("path",{d:"M17 21v-8H7v8"}),t.jsx("path",{d:"M7 3v5h8"})]}),Na=()=>t.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),t.jsx("polyline",{points:"7 10 12 15 17 10"}),t.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),br=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("circle",{cx:"12",cy:"12",r:"10"}),t.jsx("line",{x1:"12",cy:"16",x2:"12",y2:"12"}),t.jsx("line",{x1:"12",cy:"8",x2:"12.01",y2:"8"})]}),vr=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("circle",{cx:"12",cy:"12",r:"10"}),t.jsx("path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"}),t.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]}),Gs=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[t.jsx("path",{d:"M3 10h10a5 5 0 0 1 5 5v2"}),t.jsx("path",{d:"M7 6l-4 4 4 4"})]}),Vs=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[t.jsx("path",{d:"M21 10h-10a5 5 0 0 0 -5 5v2"}),t.jsx("path",{d:"M17 6l4 4 -4 4"})]}),Us=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[t.jsx("path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}),t.jsx("path",{d:"M3 3v5h5"})]}),pt=()=>t.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:t.jsx("polyline",{points:"20 6 9 17 4 12"})}),wr=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),t.jsx("polyline",{points:"17 8 12 3 7 8"}),t.jsx("line",{x1:"12",y1:"3",x2:"12",y2:"15"})]}),Sr=()=>t.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),t.jsx("polyline",{points:"7 10 12 15 17 10"}),t.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),fa=()=>t.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"4",children:[t.jsx("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),t.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"})]}),Rt=()=>t.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:t.jsx("path",{d:"M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"})}),Ws=()=>t.jsxs("svg",{width:"64",height:"64",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("rect",{x:"5",y:"2",width:"14",height:"20",rx:"2",ry:"2"}),t.jsx("path",{d:"M12 18h.01"})]}),Mr=({className:e})=>t.jsxs("svg",{className:e,xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",children:[t.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4"}),t.jsx("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}),oa=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("polyline",{points:"16 18 22 12 16 6"}),t.jsx("polyline",{points:"8 6 2 12 8 18"})]}),qs=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("circle",{cx:"12",cy:"12",r:"10"}),t.jsx("path",{d:"M8 14s1.5 2 4 2 4-2 4-2"}),t.jsx("line",{x1:"9",y1:"9",x2:"9.01",y2:"9"}),t.jsx("line",{x1:"15",y1:"9",x2:"15.01",y2:"9"})]}),pa=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"}),t.jsx("polyline",{points:"3.27 6.96 12 12.01 20.73 6.96"}),t.jsx("line",{x1:"12",y1:"22.08",x2:"12",y2:"12"})]}),vu=()=>t.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",strokeDasharray:"4 4"}),t.jsx("path",{d:"M9 12l2 2 4-4"})]}),Xs=()=>t.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:t.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"})}),Ys=()=>t.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:t.jsx("circle",{cx:"12",cy:"12",r:"10"})}),So=()=>t.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"}),t.jsx("circle",{cx:"12",cy:"13",r:"4"})]}),Zs=()=>t.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M12 3v18"}),t.jsx("path",{d:"M3 12h18"}),t.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),Qs=()=>t.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:t.jsx("path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"})}),Ya=()=>t.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("polygon",{points:"12 2 2 7 12 12 22 7 12 2"}),t.jsx("polyline",{points:"2 17 12 22 22 17"}),t.jsx("polyline",{points:"2 12 12 17 22 12"})]}),Ks=()=>t.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M12 2l-5 9h10l-5 9"}),t.jsx("path",{d:"M12 2v20"})]}),zr=()=>t.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M6 2v14a2 2 0 0 0 2 2h14"}),t.jsx("path",{d:"M18 22V8a2 2 0 0 0-2-2H2"})]}),Js=()=>t.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),t.jsx("line",{x1:"9",y1:"9",x2:"15",y2:"15"}),t.jsx("line",{x1:"15",y1:"9",x2:"9",y2:"15"})]}),el=()=>t.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("rect",{x:"3",y:"3",width:"7",height:"7"}),t.jsx("rect",{x:"14",y:"3",width:"7",height:"7"}),t.jsx("rect",{x:"14",y:"14",width:"7",height:"7"}),t.jsx("path",{d:"M3 14h7v7H3z",fill:"currentColor",stroke:"none"})]}),tl=()=>t.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:t.jsx("path",{d:"M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM7 10h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"})}),Cr=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("rect",{x:"3",y:"3",width:"7",height:"7"}),t.jsx("rect",{x:"14",y:"3",width:"7",height:"7"}),t.jsx("rect",{x:"14",y:"14",width:"7",height:"7"}),t.jsx("path",{d:"M10 7h4"}),t.jsx("path",{d:"M17 10v4"})]}),al=()=>t.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M12 22V8"}),t.jsx("path",{d:"M5 12H2a10 10 0 0 0 20 0h-3"}),t.jsx("circle",{cx:"12",cy:"5",r:"3"})]}),ol=()=>t.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M12 18V8"}),t.jsx("path",{d:"M5 12H2a10 10 0 0 0 20 0h-3"}),t.jsx("circle",{cx:"12",cy:"5",r:"3"}),t.jsx("line",{x1:"3",y1:"21",x2:"21",y2:"3",stroke:"currentColor",opacity:"0.9"})]}),rl=({status:e})=>{let o="currentColor";e==="keyed"||e==="partial"?o="#f59e0b":(e==="dirty"||e==="keyed-dirty")&&(o="#ef4444");const a=e==="keyed"||e==="keyed-dirty"?o:"none";return t.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:o,strokeWidth:"2.5",children:t.jsx("path",{d:"M12 2L2 12l10 10 10-10L12 2z",fill:a})})},Ba=({active:e})=>t.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"#666",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"}),t.jsx("path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"})]}),wu=()=>t.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[t.jsx("path",{d:"M10 13l-4 4"}),t.jsx("path",{d:"M14 11l4 -4"})]}),Su=({active:e})=>t.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:e?"#f59e0b":"#666",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("polyline",{points:"16 18 22 12 16 6"}),t.jsx("polyline",{points:"8 6 2 12 8 18"})]}),Mu=({open:e})=>t.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:`transition-transform ${e?"rotate-90":""}`,children:t.jsx("path",{d:"M9 18l6-6-6-6"})}),kr=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("rect",{x:"2",y:"2",width:"20",height:"20",rx:"5",ry:"5"}),t.jsx("path",{d:"M16 8h.01"}),t.jsx("path",{d:"M8 8h.01"}),t.jsx("path",{d:"M8 16h.01"}),t.jsx("path",{d:"M16 16h.01"}),t.jsx("path",{d:"M12 12h.01"})]}),il=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("polyline",{points:"16 3 21 3 21 8"}),t.jsx("line",{x1:"4",y1:"20",x2:"21",y2:"3"}),t.jsx("polyline",{points:"21 16 21 21 16 21"}),t.jsx("line",{x1:"15",y1:"15",x2:"21",y2:"21"}),t.jsx("line",{x1:"4",y1:"4",x2:"9",y2:"9"})]}),nl=()=>t.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{d:"M8 5v14l11-7z"})}),sl=()=>t.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{d:"M6 19h4V5H6v14zm8-14v14h4V5h-4z"})}),zu=()=>t.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{d:"M6 6h12v12H6z"})}),Cu=({active:e})=>t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:e?"currentColor":"none",stroke:"currentColor",strokeWidth:"2",children:t.jsx("circle",{cx:"12",cy:"12",r:"10",stroke:e?"none":"currentColor",fill:e?"#ef4444":"none"})}),ku=({active:e})=>t.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",children:t.jsx("path",{d:"M3 18C3 18 6 5 12 12C18 19 21 5 21 5"})}),ju=({active:e})=>t.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",children:[t.jsx("rect",{x:"3",y:"8",width:"6",height:"8"}),t.jsx("rect",{x:"15",y:"8",width:"6",height:"8"})]}),Pu=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"}),t.jsx("path",{d:"M4 22v-7"}),t.jsx("path",{d:"M8 4v10"}),t.jsx("path",{d:"M12 5v10"}),t.jsx("path",{d:"M16 4v10"}),t.jsx("path",{d:"M4 8h16"}),t.jsx("path",{d:"M4 12h16"})]}),Tu=({active:e})=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),t.jsx("line",{x1:"3",y1:"9",x2:"21",y2:"9"}),t.jsx("line",{x1:"3",y1:"15",x2:"21",y2:"15"}),t.jsx("line",{x1:"9",y1:"3",x2:"9",y2:"21"}),t.jsx("line",{x1:"15",y1:"3",x2:"15",y2:"21"})]}),Ru=({mode:e})=>t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e==="Loop"||e==="PingPong"?t.jsx("path",{d:"M17 2l4 4-4 4 M3 11v-1a4 4 0 0 1 4-4h14 M7 22l-4-4 4-4 M21 13v1a4 4 0 0 1-4 4H3"}):t.jsx("path",{d:"M5 12h14 M12 5l7 7-7 7"})}),Iu=({active:e,arming:o})=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M3 12h18",strokeOpacity:e||o?.3:.2}),t.jsx("path",{d:"M3 12 Q 6 2, 9 12 T 15 12 T 21 12",stroke:e?"#ef4444":o?"#fca5a5":"currentColor"}),o&&!e&&t.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"#fca5a5",stroke:"none"})]}),Fu=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("polyline",{points:"4 14 10 14 10 20"}),t.jsx("polyline",{points:"20 10 14 10 14 4"}),t.jsx("line",{x1:"14",y1:"10",x2:"21",y2:"3"}),t.jsx("line",{x1:"3",y1:"21",x2:"10",y2:"14"})]}),_u=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"}),t.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"currentColor",stroke:"none"})]}),Du=({active:e})=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("line",{x1:"4",y1:"20",x2:"20",y2:"20"}),t.jsx("line",{x1:"4",y1:"4",x2:"20",y2:"4"}),t.jsx("polyline",{points:"4 14 8 10 12 14 16 10 20 14"})]}),Lu=()=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"}),t.jsx("path",{d:"M4 12h16"}),t.jsx("path",{d:"M12 4v16"}),t.jsx("path",{d:"M16 16l-4 4-4-4"})]}),Eu=({active:e})=>t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M19 13l-7-7-7 7"}),t.jsx("path",{d:"M5 19l7-7 7 7"}),t.jsx("path",{d:"M12 5l2-2 2 2-2 2-2-2z",fill:e?"#22d3ee":"none",stroke:"none"}),t.jsx("path",{d:"M12 5l-2-2-2 2 2 2 2-2z",fill:e?"#22d3ee":"none",stroke:"none"})]}),Au=({active:e})=>t.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:t.jsx("path",{d:"M2 12s3-7 7-7 7 7 7 7 3-7 7-7"})}),Nu=({active:e})=>t.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",className:e?"text-gray-200":"text-gray-600",children:[t.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),t.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),Ye={frameCount:0,lastTime:performance.now(),ref:null,workerFrameCount:0};Hi(()=>{Ye.workerFrameCount++});const ll=()=>{const e=performance.now();Ye.frameCount++,e-Ye.lastTime>=1e3&&(Ye.ref&&(Ye.ref.innerText=`${Ye.workerFrameCount} FPS`),Ye.frameCount=0,Ye.workerFrameCount=0,Ye.lastTime=e)},cl=()=>{const e=E(i=>i.isPaused),o=E(gr),a=ce(i=>i.isCameraInteracting),r=ce(i=>i.isScrubbing),n=e&&!o&&!a&&!r,s=S.useRef(null);return S.useEffect(()=>(Ye.ref=s.current,()=>{Ye.ref===s.current&&(Ye.ref=null)}),[]),t.jsx("span",{ref:s,className:`text-[10px] font-mono w-12 text-right transition-colors duration-300 ${n?"text-gray-600":"text-cyan-500/80"}`,title:e?"Rendering Paused (Battery Saver)":"Frames Per Second",children:"-- FPS"})},Ee=e=>{var r;const o=new Set;let a=e;for(;a&&a!==document.body;)(r=a.dataset)!=null&&r.helpId&&a.dataset.helpId.split(/\s+/).forEach(s=>{s&&o.add(s)}),a=a.parentElement;return Array.from(o)},Mo=ue(),Ma=(e,o,a,r)=>{if(o)return 0;const n=E.getState();n.geometry;const s=n.lighting;if(e.startsWith("camera.unified")){const l=Ne()||Mo.activeCamera,c=l?l.position:n.cameraPos,d=We.getUnifiedPosition(c,n.sceneOffset);if(e==="camera.unified.x")return d.x;if(e==="camera.unified.y")return d.y;if(e==="camera.unified.z")return d.z}if(e.startsWith("camera.rotation")){const l=Ne()||Mo.activeCamera;if(l){const c=new Pe().setFromQuaternion(l.quaternion);if(e==="camera.rotation.x")return c.x;if(e==="camera.rotation.y")return c.y;if(e==="camera.rotation.z")return c.z}return 0}if(e.startsWith("lights.")||e.startsWith("lighting.")){const l=e.match(/lighting\.light(\d+)_(\w+)/);if(l){const c=parseInt(l[1]),d=l[2],u=bt(s,c);if(u){if(d==="intensity")return u.intensity;if(d==="falloff")return u.falloff;if(d==="posX")return u.position.x;if(d==="posY")return u.position.y;if(d==="posZ")return u.position.z}}}if(e.includes(".")){const l=e.split("."),c=l[0],d=l[1];if(ne.get(c)){const u=n[c];if(u){if(u[d]!==void 0){const p=u[d];if(typeof p=="boolean")return p?1:0;if(typeof p=="number")return p}const f=d.match(/^(.+)_(x|y|z)$/);if(f){const p=f[1],h=f[2],x=u[p];if(x&&typeof x=="object"&&h in x)return x[h]}}}}const i=n.coreMath;if(i){if(e==="paramA")return i.paramA;if(e==="paramB")return i.paramB;if(e==="paramC")return i.paramC;if(e==="paramD")return i.paramD;if(e==="paramE")return i.paramE;if(e==="paramF")return i.paramF;if(e==="iterations")return i.iterations}return 0},Je=(e,o,a)=>{if(e.length===0)return 0;if(o<=e[0].frame)return e[0].value;if(o>=e[e.length-1].frame)return e[e.length-1].value;for(let r=0;r<e.length-1;r++){const n=e[r],s=e[r+1];if(o>=n.frame&&o<s.frame)return qe.interpolate(o,n,s,a)}return e[0].value},Bu=(e,o,a)=>{if(!e)return{angle:0,length:0};const r=a?-e.x:e.x,n=a?-e.y:e.y,s=Math.atan2(n,r)*(180/Math.PI);let i=0;return o&&Math.abs(o)>1e-9?i=Math.abs(e.x)/Math.abs(o)*100:i=Math.abs(e.x)*10,{angle:s,length:i}},Ou=(e,o,a,r)=>{const s=Math.max(-89.9,Math.min(89.9,o))*(Math.PI/180),i=Math.abs(r)<1e-4?10:Math.abs(r),l=(e?-1:1)*(a/100)*i,c=Math.abs(l)*Math.tan(s)*(e?-1:1);return{x:l,y:c}},$u=qe.constrainHandles,Hu=qe.calculateSoftFalloff,Gu=qe.scaleHandles,Vu=(e,o)=>{const a=[],r=Math.PI*2;return e.forEach(n=>{const s=o.tracks[n],i=/rotation|rot|phase|twist/i.test(n)||/param[C-F]/i.test(n);if(s&&s.keyframes.length>1&&i){const l=[...s.keyframes].sort((u,f)=>u.frame-f.frame),d=[...l.map(u=>u.value)];for(let u=1;u<d.length;u++){let f=d[u]-d[u-1];f-=Math.round(f/r)*r,d[u]=d[u-1]+f}l.forEach((u,f)=>{Math.abs(u.value-d[f])>1e-4&&a.push({trackId:n,keyId:u.id,patch:{value:d[f]}})})}}),a},Uu=(e,o,a,r=1,n,s=.5,i=.6)=>{const l=[],c=a.length>0,d=new Set(a),u=r<0,f=Math.abs(r);if(f===0)return n&&e.forEach(y=>{const b=n.tracks[y],g=o.tracks[y];!b||!g||b.keyframes.forEach(m=>{const v=g.keyframes.find(C=>C.id===m.id);v&&(!c||d.has(`${y}::${m.id}`))&&Math.abs(v.value-m.value)>1e-9&&l.push({trackId:y,keyId:m.id,patch:{value:m.value}})})}),l;const p=n||o,h=Math.max(.1,f/2.5),x=2*h*h,z=Math.ceil(f);return e.forEach(y=>{const b=p.tracks[y];if(!b||b.keyframes.length<2)return;const g=/rotation|rot|phase|twist/i.test(y)||/param[C-F]/i.test(y),m=[...b.keyframes].sort((C,M)=>C.frame-M.frame);if(u){const C=Math.min(f,5)/5,M=s*(1-C*.9),w=i*(1-C*.8);let j=m[0].value,k=0;const P=m[0].frame,I=m[m.length-1].frame;let F=Je(m,P+1,g)-j;g&&(F>Math.PI?F-=Math.PI*2:F<-Math.PI&&(F+=Math.PI*2)),k=F;for(let A=P;A<=I;A++){let N=Je(m,A,g);if(g){const X=N-j;X>Math.PI?N-=Math.PI*2:X<-Math.PI&&(N+=Math.PI*2)}const R=(N-j)*M,q=-k*w,L=R+q;k+=L,j+=k;const $=m.find(X=>Math.abs(X.frame-A)<.1);if($)if(!c||d.has(`${y}::${$.id}`))l.push({trackId:y,keyId:$.id,patch:{value:j}});else{j=$.value;let H=Je(m,A+1,g)-j;g&&(H>Math.PI?H-=Math.PI*2:H<-Math.PI&&(H+=Math.PI*2)),k=H}}return}let v=[];if(c){let C=[];m.forEach((M,w)=>{d.has(`${y}::${M.id}`)?C.push(w):C.length>0&&(v.push(C),C=[])}),C.length>0&&v.push(C)}else v.push(m.map((C,M)=>M));v.forEach(C=>{const M=w=>w<0?m[0].value:w>=m.length?m[m.length-1].value:m[w].value;for(let w=0;w<C.length;w++){const j=C[w],k=m[j];let P=0,I=0;for(let _=-z;_<=z;_++){const F=j+_,A=Math.exp(-(_*_)/x);let N=M(F);I+=N*A,P+=A}if(P>0){let _=I/P;const F=o.tracks[y],A=F?F.keyframes.find(N=>N.id===k.id):null;A&&Math.abs(_-A.value)>1e-9&&l.push({trackId:y,keyId:k.id,patch:{value:_}})}}})}),l},Wu=(e,o,a=1)=>{const r=[];return e.forEach(n=>{const s=o.tracks[n];if(!s||s.keyframes.length===0)return;const i=[...s.keyframes].sort((f,p)=>f.frame-p.frame),l=Math.ceil(i[0].frame),c=Math.floor(i[i.length-1].frame),d=n.startsWith("camera.rotation"),u=[];for(let f=l;f<=c;f+=a){const p=Je(i,f,d);u.push({id:Qe(),frame:f,value:p,interpolation:"Linear",autoTangent:!1,brokenTangents:!1})}u.length>0&&r.push({trackId:n,newKeys:u})}),r},dl=(e,o,a)=>{const{sequence:r,currentFrame:n,addTrack:s,addKeyframe:i,removeKeyframe:l,isRecording:c,snapshot:d}=ce(),u=(()=>{if(!e||!r.tracks[e])return"none";const x=r.tracks[e],z=x.keyframes.find(y=>Math.abs(y.frame-n)<.1);if(z)return Math.abs(z.value-o)>1e-4?"keyed-dirty":"keyed";{const y=/rotation|rot|phase|twist/i.test(e)||/param[C-F]/i.test(e),b=Je(x.keyframes,n,y);return Math.abs(b-o)>.001?"dirty":"partial"}})();return{status:u,toggleKey:()=>{if(e){if(d(),u==="keyed"){const x=r.tracks[e].keyframes.find(z=>Math.abs(z.frame-n)<.1);x&&l(e,x.id)}else r.tracks[e]||s(e,a),i(e,n,o);Z.emit(pe.TRACK_FOCUS,e)}},autoKeyOnChange:x=>{e&&c&&(r.tracks[e]||s(e,a),i(e,n,x))},autoKeyOnDragStart:()=>{e&&c&&(d(),Z.emit(pe.TRACK_FOCUS,e))}}},$t=({status:e,onClick:o,className:a=""})=>t.jsx("button",{onClick:r=>{r.stopPropagation(),o()},tabIndex:-1,className:`p-0.5 rounded hover:bg-white/10 transition-colors shrink-0 ${e==="keyed"?"text-amber-400":e==="keyed-dirty"||e==="dirty"?"text-red-500":e==="partial"?"text-orange-500 hover:text-amber-300":"text-gray-600 hover:text-amber-200"} ${a}`,title:e==="none"?"Add Keyframe":e==="dirty"?"Add Key (Value mismatch)":e==="keyed-dirty"?"Update Key (Value changed)":e==="partial"?"Add Key (Track exists)":"Remove Key",children:t.jsx(rl,{status:e})}),ul=e=>{const{value:o,onChange:a,onDragStart:r,onDragEnd:n,step:s=.01,sensitivity:i=1,hardMin:l,hardMax:c,mapping:d,disabled:u,dragThreshold:f=2}=e,[p,h]=S.useState(!1),x=S.useRef(0),z=S.useRef(0),y=S.useRef(!1),b=S.useRef(!1),g=S.useRef(!1),m=S.useRef(null),v=S.useCallback((k,P)=>{let I=s*.5*i;return k&&(I*=10),P&&(I*=.1),I},[s,i]),C=S.useCallback(k=>{if(u||k.button!==0)return;k.preventDefault(),k.stopPropagation(),k.currentTarget.setPointerCapture(k.pointerId),m.current=k.pointerId,x.current=k.clientX;const P=d?d.toDisplay(o):o;z.current=isNaN(P)?0:P,y.current=!1,b.current=k.shiftKey,g.current=k.altKey,h(!0),r==null||r()},[o,d,u,r]),M=S.useCallback(k=>{if(u||!p||!k.currentTarget.hasPointerCapture(k.pointerId))return;const P=k.clientX-x.current;if(Math.abs(P)>f&&(y.current=!0),!y.current)return;k.preventDefault(),k.stopPropagation();const I=b.current!==k.shiftKey,_=g.current!==k.altKey;if(I||_){const R=v(b.current,g.current),q=z.current+P*R;z.current=q,x.current=k.clientX,b.current=k.shiftKey,g.current=k.altKey}const F=v(k.shiftKey,k.altKey);let A=z.current+P*F;l!==void 0&&(A=Math.max(l,A)),c!==void 0&&(A=Math.min(c,A));const N=d?d.fromDisplay(A):A;isNaN(N)||a(N)},[p,u,s,l,c,d,a,v,f]),w=S.useCallback(k=>{u||(k.currentTarget.releasePointerCapture(k.pointerId),m.current=null,h(!1),n==null||n())},[u,n]),j=S.useCallback(()=>{const k=!y.current;return y.current=!1,k},[]);return{isDragging:p,handlePointerDown:C,handlePointerMove:M,handlePointerUp:w,handleClick:j}},fl=e=>{const{value:o,mapping:a,onChange:r,onDragStart:n,onDragEnd:s,disabled:i,mapTextInput:l=!1}=e,[c,d]=S.useState(!1),[u,f]=S.useState(""),p=S.useRef(null),h=S.useCallback(()=>{if(i)return;d(!0);const v=l&&a?a.toDisplay(o):o,C=typeof v=="number"?parseFloat(v.toFixed(6)):v??0;f(String(C)),setTimeout(()=>{p.current&&(p.current.focus(),p.current.select())},10)},[o,a,i,l]),x=S.useCallback(()=>{let v;if(a!=null&&a.parseInput&&l?v=a.parseInput(u):(v=parseFloat(u),isNaN(v)&&(v=null)),v!==null){const C=l&&a?a.fromDisplay(v):v;n==null||n(),r(C),s==null||s()}d(!1)},[u,a,r,n,s,l]),z=S.useCallback(()=>{d(!1)},[]),y=S.useCallback(v=>{f(v)},[]),b=S.useCallback(v=>{v.key==="Enter"?(v.preventDefault(),x()):v.key==="Escape"&&(v.preventDefault(),z()),v.key!=="Tab"&&v.stopPropagation()},[x,z]),g=S.useCallback(()=>{c||h()},[c,h]),m=S.useCallback(()=>{c&&x()},[c,x]);return{isEditing:c,inputValue:u,inputRef:p,startEditing:h,commitEdit:x,cancelEdit:z,handleInputChange:y,handleKeyDown:b,handleFocus:g,handleBlur:m}},jr=e=>e===0||Math.abs(e)<1e-9?"0":parseFloat(e.toFixed(8)).toString(),zo={toDisplay:e=>e/Math.PI,fromDisplay:e=>e*Math.PI,format:e=>{const o=e/Math.PI,a=Math.abs(o),r=o<0?"-":"";if(a<.001)return"0";if(Math.abs(a-1)<.001)return`${r}π`;if(Math.abs(a-.5)<.001)return`${r}π/2`;if(Math.abs(a-.25)<.001)return`${r}π/4`;if(Math.abs(a-.75)<.001)return`${r}3π/4`;if(Math.abs(a-2)<.001)return`${r}2π`;const n=Math.round(a*3);if(Math.abs(a-n/3)<.001&&n!==0){if(n===1)return`${r}π/3`;if(n===2)return`${r}2π/3`;if(n===3)return`${r}π`;if(n===4)return`${r}4π/3`;if(n===5)return`${r}5π/3`}return`${r}${a.toFixed(2)}π`},parseInput:e=>{const o=e.trim().toLowerCase().replace(/\s/g,"");if(o==="π"||o==="pi")return Math.PI;if(o==="-π"||o==="-pi")return-Math.PI;if(o.includes("π")||o.includes("pi")){const r=o.replace(/[πpi]/g,"");if(r.includes("/")){const[i,l]=r.split("/").map(d=>parseFloat(d)||1);return(o.startsWith("-")?-1:1)*(Math.abs(i)/l)*Math.PI}const n=r?parseFloat(r):1;return isNaN(n)?null:(o.startsWith("-")?-1:1)*Math.abs(n)*Math.PI}const a=parseFloat(o);return isNaN(a)?null:a}},Dt={toDisplay:e=>e*(180/Math.PI),fromDisplay:e=>e*(Math.PI/180),format:e=>`${(e*(180/Math.PI)).toFixed(1)}°`,parseInput:e=>{const o=e.trim().replace(/°/g,""),a=parseFloat(o);return isNaN(a)?null:a}},za=({value:e,onChange:o,onDragStart:a,onDragEnd:r,step:n=.01,sensitivity:s=1,min:i,max:l,hardMin:c,hardMax:d,mapping:u,format:f,mapTextInput:p,disabled:h=!1,highlight:x=!1,liveValue:z,defaultValue:y})=>{const{isDragging:b,handlePointerDown:g,handlePointerMove:m,handlePointerUp:v,handleClick:C}=ul({value:e,onChange:o,onDragStart:a,onDragEnd:r,step:n,sensitivity:s,hardMin:c,hardMax:d,mapping:u,disabled:h}),{isEditing:M,inputValue:w,inputRef:j,startEditing:k,handleInputChange:P,handleKeyDown:I,handleBlur:_}=fl({value:e,mapping:u,onChange:o,onDragStart:a,onDragEnd:r,disabled:h,mapTextInput:p}),F=ze.useMemo(()=>f?f(e):u!=null&&u.format?u.format(e):jr(e),[e,f,u]),A=ze.useCallback(()=>{!h&&!M&&k()},[h,M,k]),N=ze.useCallback(L=>{if(h)return;C()&&k()},[h,C,k]),q=`
    ...
    `;return M?t.jsx("input",{ref:j,type:"text",value:w,onChange:L=>P(L.target.value),onBlur:_,onKeyDown:I,className:"w-full h-full bg-gray-900 text-white text-xs border-none outline-none font-mono text-center px-1",onClick:L=>L.stopPropagation(),autoFocus:!0}):t.jsx("div",{tabIndex:h?-1:0,onPointerDown:g,onPointerMove:m,onPointerUp:v,onClick:N,onFocus:A,className:q,title:h?"Disabled":"Click to edit, Drag to adjust (Shift=Fast, Alt=Slow)",children:F})},Za=({value:e,onChange:o,onDragStart:a,onDragEnd:r,step:n=.01,min:s,max:i,hardMin:l,hardMax:c,mapping:d,format:u,overrideText:f,mapTextInput:p,label:h,labelSuffix:x,headerRight:z,showTrack:y=!0,trackPosition:b="below",trackHeight:g=20,variant:m="full",className:v="",defaultValue:C,onReset:M,liveValue:w,showLiveIndicator:j=!0,onContextMenu:k,dataHelpId:P,disabled:I=!1,highlight:_=!1})=>{const F=s!==void 0&&i!==void 0&&s!==i,A=ze.useMemo(()=>{if(!F)return 0;const D=d?d.toDisplay(e):e,T=d?d.toDisplay(s):s,O=d?d.toDisplay(i):i;return Math.max(0,Math.min(100,(D-T)/(O-T)*100))},[e,s,i,d,F]),N=ze.useMemo(()=>{if(!F||w===void 0)return 0;const D=d?d.toDisplay(w):w,T=d?d.toDisplay(s):s,O=d?d.toDisplay(i):i;return Math.max(0,Math.min(100,(D-T)/(O-T)*100))},[w,s,i,d,F]),R=ze.useMemo(()=>{if(!F||C===void 0)return null;const D=d?d.toDisplay(C):C,T=d?d.toDisplay(s):s,O=d?d.toDisplay(i):i;return(D-T)/(O-T)*100},[C,s,i,d,F]),q=ze.useCallback(D=>{if(I)return;const T=parseFloat(D.target.value),O=d?d.fromDisplay(T):T;o(O)},[I,d,o]),L=ze.useCallback(()=>{C!==void 0&&!I&&(a==null||a(),o(C),r==null||r(),M==null||M())},[C,I,o,a,r,M]),$=_||w!==void 0,X=m==="compact";return m==="minimal"?t.jsx("div",{className:v,children:t.jsx(za,{value:e,onChange:o,onDragStart:a,onDragEnd:r,step:n,hardMin:l,hardMax:c,mapping:d,format:f?()=>f:u,mapTextInput:p,defaultValue:C,disabled:I,highlight:$})}):X?t.jsxs("div",{className:`relative flex-1 h-9 md:h-[26px] overflow-hidden group transition-all duration-150 ${I?"opacity-70 pointer-events-none":""} ${v}`,onContextMenu:k,"data-help-id":P,children:[t.jsx("div",{className:"absolute inset-0 bg-white/[0.12]",style:I?{}:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255,255,255,0.03) 5px, rgba(255,255,255,0.03) 10px)"}}),y&&F&&t.jsx("div",{className:`absolute top-0 bottom-0 left-0 pointer-events-none ${I?"bg-gray-500/20":$?"bg-cyan-500/30":"bg-cyan-500/20"}`,style:{width:`${A}%`}}),j&&w!==void 0&&!I&&F&&t.jsx("div",{className:"absolute top-0 bottom-0 w-1.5 bg-purple-500 blur-[1px] transition-all duration-75 ease-out z-0",style:{left:`calc(${N}% - 0.75px)`}}),t.jsx("div",{className:"absolute inset-0",children:t.jsx(za,{value:e,onChange:o,onDragStart:a,onDragEnd:r,step:n,hardMin:l,hardMax:c,mapping:d,format:f?()=>f:u,mapTextInput:p,defaultValue:C,disabled:I,highlight:$})}),$&&!I&&t.jsx("div",{className:"absolute inset-0 bg-cyan-500/10 pointer-events-none"})]}):t.jsxs("div",{className:`mb-px animate-slider-entry ${I?"opacity-70 pointer-events-none":""} ${v}`,"data-help-id":P,onContextMenu:k,children:[h&&t.jsxs("div",{className:"flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5",children:[t.jsxs("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:[z,t.jsxs("label",{className:`text-[10px] font-medium tracking-tight select-none flex items-center gap-2 truncate pointer-events-none ${I?"text-gray-600":"text-gray-400"}`,children:[h,x,w!==void 0&&!I&&t.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-purple-500 animate-pulse shadow-[0_0_4px_#a855f7]"})]})]}),t.jsx("div",{className:"w-1/2 relative bg-white/[0.02] border-l border-white/10 group/num-area touch-none",style:I?{}:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255,255,255,0.03) 5px, rgba(255,255,255,0.03) 10px)"},children:t.jsx(za,{value:e,onChange:o,onDragStart:a,onDragEnd:r,step:n,hardMin:l,hardMax:c,mapping:d,format:f?()=>f:u,mapTextInput:p,defaultValue:C,disabled:I,highlight:$})})]}),y&&F&&t.jsxs("div",{className:"relative flex items-center touch-none overflow-hidden",style:{touchAction:"none",height:g},children:[t.jsx("input",{type:"range",min:d?d.toDisplay(s):s,max:d?d.toDisplay(i):i,step:n,value:d?d.toDisplay(e):e,onChange:q,disabled:I,onPointerDown:D=>{I||(D.stopPropagation(),a==null||a())},onPointerUp:()=>{I||r==null||r()},className:`precision-slider w-full h-full appearance-none cursor-pointer focus:outline-none z-10 ${$&&!I?"accent-cyan-500":"accent-gray-400"}`,style:{background:"transparent",touchAction:"none"},tabIndex:-1}),t.jsxs("div",{className:"absolute inset-0 bg-white/10 pointer-events-none",children:[t.jsx("div",{className:`absolute top-0 bottom-0 left-0 ${I?"bg-gray-400/20":"bg-cyan-500/30"}`,style:{width:`${A}%`}}),j&&w!==void 0&&!I&&t.jsx("div",{className:"absolute top-0 bottom-0 w-1.5 bg-purple-500 blur-[1px] transition-all duration-75 ease-out z-0",style:{left:`calc(${N}% - 0.75px)`}})]}),R!==null&&t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"absolute w-0.5 h-full bg-white/40 pointer-events-none z-0 transform -translate-x-1/2",style:{left:`${R}%`}}),t.jsx("button",{onClick:D=>{D.preventDefault(),D.stopPropagation(),L()},className:"absolute top-0 bottom-0 right-0 w-2 bg-gray-500/20 hover:bg-gray-400/50 cursor-pointer z-20 transition-colors border-l border-black/10",title:`Reset to ${C}`,"aria-label":"Reset to default",tabIndex:-1})]})]})]})},pl=[{label:"X",color:"bg-red-500",text:"text-red-400",border:"group-focus-within:border-red-500/50",hoverBg:"hover:bg-red-500/20",accent:"#ef4444"},{label:"Y",color:"bg-green-500",text:"text-green-400",border:"group-focus-within:border-green-500/50",hoverBg:"hover:bg-green-500/20",accent:"#22c55e"},{label:"Z",color:"bg-blue-500",text:"text-blue-400",border:"group-focus-within:border-blue-500/50",hoverBg:"hover:bg-blue-500/20",accent:"#3b82f6"}],Pr=({value:e,onChange:o,step:a,min:r,max:n,hardMin:s,hardMax:i,highlight:l,overrideText:c,onDragStart:d,onDragEnd:u,sensitivity:f=1,disabled:p=!1})=>t.jsx(Za,{value:e,onChange:o,onDragStart:d,onDragEnd:u,step:a,min:r,max:n,hardMin:s,hardMax:i,variant:"minimal",disabled:p,highlight:l,overrideText:c,showTrack:!1}),ot=e=>{const{handleInteractionStart:o,handleInteractionEnd:a}=E();return t.jsx(Pr,{...e,onDragStart:()=>{o("param"),e.onDragStart&&e.onDragStart()},onDragEnd:()=>{a(),e.onDragEnd&&e.onDragEnd()}})},de=({trackId:e,onKeyToggle:o,defaultValue:a,overrideInputText:r,dataHelpId:n,onChange:s,...i})=>{var M,w,j;const{openContextMenu:l,handleInteractionStart:c,handleInteractionEnd:d}=E(),{status:u,toggleKey:f,autoKeyOnChange:p,autoKeyOnDragStart:h}=dl(e,i.value??0,i.label),x=[];e&&x.push(e),n&&x.push(n),x.push("ui.slider");const z=x.join(" "),y=k=>{if(i.disabled)return;k.preventDefault(),k.stopPropagation();const P=[];a!==void 0&&P.push({label:"Reset to Default",action:()=>{c("param"),e&&h(),s(a),p(a),d()}});const I=Ee(k.currentTarget);l(k.clientX,k.clientY,P,I)},b=k=>{s(k),p(k)},g=()=>{c("param"),h(),i.onDragStart&&i.onDragStart()},m=()=>{d(),i.onDragEnd&&i.onDragEnd()},v=e&&!i.disabled?t.jsx($t,{status:u,onClick:()=>{f(),o&&o()}}):void 0;a!==void 0&&!i.disabled&&(t.Fragment,((i.customMapping?i.customMapping.toSlider(a):a)-(((M=i.customMapping)==null?void 0:M.min)??i.min??0))/((((w=i.customMapping)==null?void 0:w.max)??i.max??1)-(((j=i.customMapping)==null?void 0:j.min)??i.min??0))*100,`${a}`);const C=ze.useMemo(()=>{if(i.customMapping)return{toDisplay:i.customMapping.toSlider,fromDisplay:i.customMapping.fromSlider,format:jr,parseInput:k=>{const P=parseFloat(k);return isNaN(P)?null:P}}},[i.customMapping]);return t.jsx(Za,{label:i.label,value:i.value,onChange:b,onDragStart:g,onDragEnd:m,step:i.step??.01,min:i.min,max:i.max,hardMin:i.hardMin,hardMax:i.hardMax,mapping:C,format:r?()=>r:void 0,mapTextInput:i.mapTextInput,variant:"full",showTrack:!0,trackPosition:"below",disabled:i.disabled,highlight:i.highlight||u!=="none",liveValue:i.liveValue,showLiveIndicator:!0,headerRight:v,labelSuffix:i.labelSuffix,onContextMenu:y,dataHelpId:z,className:i.className,defaultValue:a,onReset:()=>{c("param"),e&&h(),s(a),p(a),d()}})},Co=e=>e.includes("red")?{on:"bg-red-500/30 text-red-300 border-red-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("green")?{on:"bg-green-500/30 text-green-300 border-green-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("amber")||e.includes("yellow")?{on:"bg-amber-500/30 text-amber-300 border-amber-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("purple")?{on:"bg-purple-500/30 text-purple-300 border-purple-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:{on:"bg-cyan-500/30 text-cyan-300 border-cyan-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"};function Le({label:e,value:o,onChange:a,options:r,helpId:n,color:s="bg-cyan-600",onLfoToggle:i,isLfoActive:l,icon:c,disabled:d=!1,variant:u="default",labelSuffix:f}){const{openContextMenu:p,handleInteractionStart:h,handleInteractionEnd:x}=E(),z=m=>{if(d)return;const v=Ee(m.currentTarget);v.length>0&&(m.preventDefault(),m.stopPropagation(),p(m.clientX,m.clientY,[],v))};if(u==="dense"&&!r&&typeof o=="boolean"){const m=Co(s);return t.jsxs("div",{className:`flex items-center justify-between px-3 py-1 border-b border-white/5 hover:bg-white/5 transition-colors ${d?"opacity-50 pointer-events-none":""}`,"data-help-id":n,onContextMenu:z,children:[t.jsxs("div",{className:"flex items-center gap-2",children:[c,t.jsx("span",{className:"text-[10px] text-gray-400 font-medium tracking-tight truncate select-none",children:e})]}),t.jsx("button",{onClick:()=>{h("param"),a(!o),x()},className:`px-2 py-0.5 text-[8px] font-bold rounded-sm transition-all border cursor-pointer ${o?m.on:m.off} ${d?"":"hover:brightness-125"}`,children:o?"ON":"OFF"})]})}const y=m=>{d||(h("param"),a(m),x())},b=()=>{d||(h("param"),a(!o),x())},g=Co(s);return r?t.jsxs("div",{className:`mb-px animate-slider-entry ${d?"opacity-50 pointer-events-none":""}`,"data-help-id":n,onContextMenu:z,children:[e&&t.jsxs("div",{className:"flex items-center bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5 px-2 gap-2",children:[c,t.jsx("span",{className:"text-[10px] text-gray-400 font-medium tracking-tight truncate select-none pointer-events-none",children:e})]}),t.jsx("div",{className:`flex h-9 md:h-[26px] overflow-hidden ${e?"rounded-b-sm":"rounded-sm"}`,children:r.map(m=>t.jsx("button",{onClick:()=>y(m.value),disabled:d,className:`
                ...
                `,onDoubleClick:m=>{m.preventDefault(),m.stopPropagation(),h!==void 0&&(i==null||i(),s(h),l==null||l())},title:h!==void 0?`Double-click to reset to ${h}`:"No default value",children:t.jsx("span",{className:`text-[10px] font-bold ${b.text} pointer-events-none`,children:g})}),t.jsx("div",{className:"absolute inset-0 left-5",children:t.jsx(Za,{value:o,onChange:s,onDragStart:i,onDragEnd:l,step:n,min:a,max:r,hardMin:x,hardMax:z,mapping:u,mapTextInput:f,disabled:c,highlight:d,liveValue:p,defaultValue:h,variant:"compact",showTrack:!0})})]})},ko=[{label:"X",color:"bg-red-500",text:"text-red-400",border:"group-focus-within:border-red-500/50",hoverBg:"hover:bg-red-500/20",accent:"#ef4444"},{label:"Y",color:"bg-green-500",text:"text-green-400",border:"group-focus-within:border-green-500/50",hoverBg:"hover:bg-green-500/20",accent:"#22c55e"},{label:"Z",color:"bg-blue-500",text:"text-blue-400",border:"group-focus-within:border-blue-500/50",hoverBg:"hover:bg-blue-500/20",accent:"#3b82f6"}],Ca=({primaryAxis:e,secondaryAxis:o,primaryIndex:a,secondaryIndex:r,primaryValue:n,secondaryValue:s,min:i,max:l,step:c,onUpdate:d,onDragStart:u,onDragEnd:f,disabled:p,onHover:h})=>{const[x,z]=S.useState(!1),y=S.useRef(!1),b=S.useRef(!1),g=S.useRef({x:0,y:0}),m=S.useRef({primary:0,secondary:0}),v=S.useRef(!1),C=S.useRef(!1),M=S.useRef(!1),w=ko[a],j=ko[r],k=()=>{z(!0),h(!0)},P=()=>{y.current||(z(!1),h(!1))},I=R=>{p||R.button!==0&&R.button!==1||(R.preventDefault(),R.stopPropagation(),R.currentTarget.setPointerCapture(R.pointerId),g.current={x:R.clientX,y:R.clientY},m.current={primary:n,secondary:s},v.current=!1,C.current=R.shiftKey,M.current=R.altKey,y.current=!0,b.current=R.button===1,u())},_=R=>{if(p||!y.current||!R.currentTarget.hasPointerCapture(R.pointerId))return;const q=R.clientX-g.current.x,L=R.clientY-g.current.y;if((Math.abs(q)>1||Math.abs(L)>1)&&(v.current=!0),!v.current&&Math.abs(q)<1&&Math.abs(L)<1)return;R.preventDefault(),R.stopPropagation();const $=C.current!==R.shiftKey,X=M.current!==R.altKey;if($||X){let H=c*.5;C.current&&(H*=10),M.current&&(H*=.1),m.current.primary=m.current.primary+q*H,m.current.secondary=m.current.secondary-L*H,g.current={x:R.clientX,y:R.clientY},C.current=R.shiftKey,M.current=R.altKey}if(b.current){let H=.01;R.shiftKey&&(H*=3),R.altKey&&(H*=.3);const V=1+L*H;let D=m.current.primary*V,T=m.current.secondary*V;!isNaN(D)&&!isNaN(T)&&d(D,T)}else{let H=c*.5;R.shiftKey&&(H*=10),R.altKey&&(H*=.1);let V=m.current.primary+q*H,D=m.current.secondary-L*H;!isNaN(V)&&!isNaN(D)&&d(V,D)}},F=R=>{p||(R.currentTarget.releasePointerCapture(R.pointerId),y.current=!1,b.current=!1,f(),v.current=!1,R.currentTarget.matches(":hover")||(z(!1),h(!1)))},A=R=>{p||(R.preventDefault(),R.stopPropagation(),u(),d(0,0),f())},N=x||y.current;return t.jsxs("div",{className:`
            ...
            `,onPointerDown:I,onPointerMove:_,onPointerUp:F,onMouseEnter:k,onMouseLeave:P,onDoubleClick:A,title:`Drag: Horizontal=${e.toUpperCase()}, Vertical=${o.toUpperCase()} | Middle-click: Scale both proportionally | Double-click: Reset (Shift=Fast, Alt=Slow)`,children:[N&&t.jsx("div",{className:"absolute inset-0 opacity-30",style:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 3px, rgba(255,255,255,0.05) 3px, rgba(255,255,255,0.05) 6px)"}}),t.jsxs("div",{className:"relative w-full h-full",children:[t.jsx("div",{className:`
                    ...
                    `,children:t.jsxs("div",{className:"absolute inset-0 flex items-center justify-center",children:[t.jsx("div",{className:"w-full h-[1px] bg-cyan-400/50 rotate-45"}),t.jsx("div",{className:"absolute w-full h-[1px] bg-cyan-400/50 -rotate-45"})]})})]})]})},jo=({azimuth:e,pitch:o,onChange:a,onDragStart:r,onDragEnd:n,disabled:s=!1,size:i=80})=>{const l=S.useRef(null),c=S.useRef(!1),[d,u]=S.useState(!1),[f,p]=S.useState(!1),[h,x]=S.useState(!1),z=S.useRef({x:0,y:0}),y=S.useRef({azimuth:e,pitch:o}),b=S.useRef({azimuth:e,pitch:o}),g=S.useRef(null);S.useEffect(()=>{y.current={azimuth:e,pitch:o}},[e,o]);const C=f?.05:.5,M=i/2,w=i*.38,j=S.useCallback((R,q,L)=>{const $=R/(Math.PI/2)*L,X=-(q/(Math.PI/2))*L;return{x:$,y:X}},[]),k=S.useMemo(()=>j(e,o,w),[e,o,w,j]),P=S.useMemo(()=>{const R=Math.cos(o),q=Math.sin(o),L=Math.cos(e),X=Math.sin(e)*R,H=q,V=-L*R,D=X,T=-H,O=Math.sqrt(D*D+T*T),B=V>0,G=O>.001?Math.min(O,1)*w:0,Y=V<=0?1+(1-Math.min(O,1))*.5:1-V*.95,W=O>.001?D/O*G:0,Q=O>.001?T/O*G:0;return{x:W,y:Q,isBack:B,length:G,headScale:Y,dirX:X,dirY:H,dirZ:V}},[e,o,w]),I=S.useCallback((R,q,L)=>{const $=R/L*(Math.PI/2),X=-(q/L)*(Math.PI/2);return{azimuth:$,pitch:X}},[]),_=S.useCallback((R,q)=>{let L=R,$=q;h&&g.current&&(g.current==="x"?$=0:L=0);const X=L*C,H=$*C,V=j(y.current.azimuth,y.current.pitch,w),D=V.x+X,T=V.y+H,{azimuth:O,pitch:B}=I(D,T,w);h&&g.current?g.current==="x"?(y.current={azimuth:O,pitch:b.current.pitch},a(O,b.current.pitch)):(y.current={azimuth:b.current.azimuth,pitch:B},a(b.current.azimuth,B)):(y.current={azimuth:O,pitch:B},a(O,B))},[j,I,a,w,C,h]),F=R=>{s||R.button===0&&(R.preventDefault(),R.stopPropagation(),R.currentTarget.setPointerCapture(R.pointerId),c.current=!0,u(!0),z.current={x:R.clientX,y:R.clientY},y.current={azimuth:e,pitch:o},b.current={azimuth:e,pitch:o},g.current=null,r==null||r(),p(R.altKey),x(R.shiftKey))},A=R=>{if(s||!c.current)return;const q=R.clientX-z.current.x,L=R.clientY-z.current.y;z.current={x:R.clientX,y:R.clientY},p(R.altKey),x(R.shiftKey),h&&!g.current&&(Math.abs(q)>2||Math.abs(L)>2)&&(g.current=Math.abs(q)>Math.abs(L)?"x":"y"),_(q,L)},N=R=>{c.current&&(c.current=!1,u(!1),p(!1),x(!1),g.current=null,n==null||n())};return t.jsxs("div",{ref:l,className:`
            ...
            `,style:{width:i,height:i,touchAction:"none",boxShadow:d?"0 0 20px rgba(34, 211, 238, 0.3)":"none"},onPointerDown:F,onPointerMove:A,onPointerUp:N,onPointerLeave:N,onDoubleClick:R=>{s||(R.preventDefault(),R.stopPropagation(),r==null||r(),a(0,0),n==null||n())},onContextMenu:R=>{},title:"Drag to rotate direction, Double-click to reset",children:[t.jsx("div",{className:"absolute rounded-full border border-white/10 pointer-events-none",style:{width:w*2,height:w*2,left:M-w,top:M-w}}),t.jsx("div",{className:"absolute w-full h-px bg-white/10 pointer-events-none",style:{top:M}}),t.jsx("div",{className:"absolute h-full w-px bg-white/10 pointer-events-none",style:{left:M}}),t.jsx("div",{className:"absolute w-1.5 h-1.5 bg-white/40 rounded-full pointer-events-none",style:{left:M-3,top:M-3}}),t.jsx("div",{className:"absolute pointer-events-none rounded-full transition-transform duration-75",style:{left:M+k.x,top:M+k.y,width:8,height:8,marginLeft:-4,marginTop:-4,background:P.isBack?"#ef4444":"#22d3ee",boxShadow:`0 0 8px ${P.isBack?"#ef4444":"#22d3ee"}`,transform:d?"scale(1.2)":"scale(1)"}}),P.isBack&&t.jsx("div",{className:"absolute inset-0 rounded-full border-2 border-red-500/30 pointer-events-none animate-pulse"}),t.jsxs(t.Fragment,{children:[t.jsxs("svg",{className:"absolute inset-0 pointer-events-none",style:{width:i,height:i},children:[Math.abs(e)>.01&&t.jsxs(t.Fragment,{children:[t.jsx("ellipse",{cx:M,cy:M,rx:w*Math.abs(Math.sin(e)),ry:w,fill:"none",stroke:P.isBack?"#ef4444":"#22d3ee",strokeWidth:"1.5",opacity:P.isBack?.175:.35,clipPath:P.x>0?"url(#longitudeRight)":"url(#longitudeLeft)"}),t.jsx("ellipse",{cx:M,cy:M,rx:w*Math.abs(Math.sin(e)),ry:w,fill:"none",stroke:P.isBack?"#22d3ee":"#ef4444",strokeWidth:"1.5",opacity:P.isBack?.35:.175,clipPath:P.x>0?"url(#longitudeLeft)":"url(#longitudeRight)"})]}),Math.abs(o)>.01&&t.jsxs(t.Fragment,{children:[t.jsx("ellipse",{cx:M,cy:M,rx:w,ry:w*Math.abs(Math.sin(o)),fill:"none",stroke:P.isBack?"#ef4444":"#22d3ee",strokeWidth:"1.5",opacity:P.isBack?.15:.3,clipPath:P.y<0?"url(#latitudeTop)":"url(#latitudeBottom)"}),t.jsx("ellipse",{cx:M,cy:M,rx:w,ry:w*Math.abs(Math.sin(o)),fill:"none",stroke:P.isBack?"#22d3ee":"#ef4444",strokeWidth:"1.5",opacity:P.isBack?.3:.15,clipPath:P.y<0?"url(#latitudeBottom)":"url(#latitudeTop)"})]}),t.jsxs("defs",{children:[t.jsx("clipPath",{id:"longitudeRight",children:t.jsx("rect",{x:M,y:"0",width:M,height:i})}),t.jsx("clipPath",{id:"longitudeLeft",children:t.jsx("rect",{x:"0",y:"0",width:M,height:i})}),t.jsx("clipPath",{id:"latitudeTop",children:t.jsx("rect",{x:"0",y:"0",width:i,height:M})}),t.jsx("clipPath",{id:"latitudeBottom",children:t.jsx("rect",{x:"0",y:M,width:i,height:M})})]}),t.jsx("line",{x1:M,y1:M,x2:M+P.x,y2:M+P.y,stroke:P.isBack?"#ef4444":"#22d3ee",strokeWidth:"2",strokeDasharray:"4 2",opacity:.3+P.length/w*.5}),t.jsx("polygon",{points:"0,-8 -6,4 6,4",fill:P.isBack?"#ef4444":"#22d3ee",opacity:Math.max(.1,.6+(P.headScale-1)*.4),transform:`translate(${M+P.x}, ${M+P.y}) rotate(${Math.atan2(P.y,P.x)*180/Math.PI+90}) scale(${Math.max(.9,.9+P.headScale*.1)}, ${Math.max(.05,P.headScale)})`})]}),d&&t.jsx("div",{className:"absolute -bottom-5 left-1/2 -translate-x-1/2 whitespace-nowrap",children:t.jsxs("span",{className:"text-[9px] text-cyan-400 font-mono bg-black/60 px-1 rounded",children:[(e*180/Math.PI).toFixed(0),"° / ",(o*180/Math.PI).toFixed(0),"°"]})})]})]})},ka=Math.PI/180,Ml=180/Math.PI,zl=e=>{const o=e.length();if(o<1e-9)return{azimuth:0,pitch:0};const a=Math.max(-1,Math.min(1,e.y/o));return{azimuth:Math.atan2(e.x/o,e.z/o),pitch:Math.asin(a)}},Cl=(e,o)=>{const a=Math.cos(o);return new U(a*Math.sin(e),Math.sin(o),a*Math.cos(e))},Rr=({label:e,value:o,onChange:a,min:r=-1e4,max:n=1e4,step:s=.01,disabled:i=!1,convertRadToDeg:l=!1,mode:c="normal",modeToggleable:d=!1,showLiveIndicator:u=!1,liveValue:f,defaultValue:p,hardMin:h,hardMax:x,axisMin:z,axisMax:y,axisStep:b,onDragStart:g,onDragEnd:m,headerRight:v,showDualAxisPads:C=!0,linkable:M=!1,scale:w})=>{const[j,k]=S.useState(o.clone()),[P,I]=S.useState(null),[_,F]=S.useState(c),[A,N]=S.useState("degrees"),[R,q]=S.useState("degrees"),[L,$]=S.useState(M),X=S.useRef(!1),H=S.useRef(null);S.useEffect(()=>{F(c)},[c]);const V=E(oe=>oe.openContextMenu),D="z"in o,T=_==="rotation",O=_==="toggle",B=_==="mixed",G=_==="direction"&&D,Y=G?zl(j):{azimuth:0,pitch:0},W=(oe,me)=>{const _e=Math.max(-Math.PI/2,Math.min(Math.PI/2,me)),Ve=Cl(oe,_e);k(Ve),a(Ve)};S.useEffect(()=>{if(X.current)return;const oe=1e-4,me=Math.abs(o.x-j.x),_e=Math.abs(o.y-j.y),Ve=D?Math.abs(o.z-j.z):0;(me>oe||_e>oe||Ve>oe)&&k(o.clone())},[o,D]);const Q=()=>{X.current=!0,H.current=j.clone(),g&&g()},K=()=>{H.current=null,X.current=!1,m&&m()},re=oe=>{if(T)return A==="degrees"?Dt:zo;if(w==="pi")return R==="pi"?zo:Dt;if(l)return Dt},te=oe=>{if(T){const Ue=A==="degrees"?60*Math.PI/180:.05;return{min:-2*Math.PI,max:2*Math.PI,step:Ue,hardMin:void 0,hardMax:void 0}}const me=z||{x:r,y:r,z:r},_e=y||{x:n,y:n,z:n},Ve=b||{x:s,y:s,z:s},rt=w==="pi"&&R==="degrees"?Ml:1;return{min:me[oe],max:_e[oe],step:Ve[oe]*rt,hardMin:h,hardMax:x}},ae=(oe,me)=>{const _e=H.current||j,Ve=_e.clone();if(L&&!T){const rt=_e[oe],Ue=me-rt;Ve.x=_e.x+Ue,Ve.y=_e.y+Ue,D&&(Ve.z=_e.z+Ue)}else Ve[oe]=me;k(Ve),a(Ve)},ie=(oe,me,_e,Ve)=>{const Ue=(H.current||j).clone();Ue[oe]=_e,Ue[me]=Ve,k(Ue),a(Ue)},he=P==="xy",fe=P==="xy"||P==="zy",ye=P==="zy",Ce=oe=>{if(f)return f[oe]},Ge=oe=>{if(p)return p[oe]},ee=j,be={x:0,y:1,z:2},De={x:he,y:fe,z:ye},Re=oe=>({axisIndex:be[oe],value:j[oe],...te(oe),onUpdate:me=>ae(oe,me),onDragStart:Q,onDragEnd:K,disabled:i,highlight:De[oe],mapping:re(),mapTextInput:T||w==="pi",liveValue:u?Ce(oe):void 0,defaultValue:Ge(oe)}),Ie=[{on:"bg-red-500/30 text-red-300 border-red-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-green-500/30 text-green-300 border-green-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-blue-500/30 text-blue-300 border-blue-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}],ct=(oe,me,_e)=>{const rt=j[oe]>.5,Ue=Ie[me];return t.jsxs("button",{className:`flex items-center justify-center gap-1 text-[10px] font-bold transition-all border ${rt?Ue.on:Ue.off} ${i?"opacity-40 pointer-events-none":"cursor-pointer hover:brightness-125"} ${_e||"flex-1"}`,onClick:()=>ae(oe,rt?0:1),disabled:i,children:[_e?null:t.jsx("span",{children:oe}),t.jsx("span",{className:`text-[8px] ${rt?"opacity-80":"opacity-70"}`,children:rt?"ON":"OFF"})]},oe)},dt=()=>d?t.jsx("button",{onClick:()=>F(oe=>oe==="rotation"?"normal":"rotation"),className:`text-[10px] p-1 rounded transition-colors mr-2 ${_==="rotation"?"text-cyan-400 bg-cyan-500/20":"text-gray-500 hover:text-gray-300"}`,title:_==="rotation"?"Rotation mode (π units)":"Normal mode",children:"⟳"}):null,Fe=()=>!M||T?null:t.jsx("button",{onClick:()=>$(oe=>!oe),className:`p-1 rounded transition-colors mr-2 ${L?"text-cyan-400 bg-cyan-500/20":"text-gray-600 hover:text-gray-400"}`,title:L?"Axes linked (uniform)":"Link axes",children:t.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[t.jsx("path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"}),t.jsx("path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"})]})}),ut=oe=>{const me=[];T&&me.push({label:"Rotation Units",action:()=>{},isHeader:!0},{label:"Degrees (°)",checked:A==="degrees",action:()=>N("degrees")},{label:"Radians (π)",checked:A==="radians",action:()=>N("radians")}),!T&&w==="pi"&&me.push({label:"Display Units",action:()=>{},isHeader:!0},{label:"Radians (π)",checked:R==="pi",action:()=>q("pi")},{label:"Degrees (°)",checked:R==="degrees",action:()=>q("degrees")}),D&&(c==="rotation"||c==="axes")&&me.push({label:"Display Mode",action:()=>{},isHeader:!0},{label:"Azimuth / Pitch (A/P)",checked:_==="rotation",action:()=>F("rotation")},{label:"Per-Axis (X/Y/Z)",checked:_==="axes"||_==="normal",action:()=>F("normal")}),me.length!==0&&(oe.preventDefault(),oe.stopPropagation(),V(oe.clientX,oe.clientY,me,["ui.vector"]))};return t.jsxs("div",{className:"mb-px animate-slider-entry",children:[e&&t.jsxs("div",{className:"flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5",children:[t.jsxs("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:[d&&dt(),v,t.jsx("label",{className:`text-[10px] font-medium tracking-tight select-none flex items-center gap-2 truncate pointer-events-none ${i?"text-gray-600":"text-gray-400"}`,children:e})]}),M&&!T&&t.jsx("div",{className:"flex items-center px-1 border-l border-white/5",children:Fe()})]}),t.jsx("div",{className:"relative h-9 md:h-[26px] flex items-center touch-none overflow-hidden rounded-b-sm",style:{touchAction:"none"},onContextMenu:ut,"data-help-id":"ui.vector",children:t.jsx("div",{className:"flex gap-px w-full h-full",children:O?t.jsx(t.Fragment,{children:["x","y","z"].slice(0,D?3:2).map((oe,me)=>ct(oe,me))}):B?t.jsxs(t.Fragment,{children:[ct("x",0,"w-14 flex-shrink-0"),t.jsx(it,{...Re("y"),disabled:i||j.x<.5})]}):G?t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"flex items-center justify-center px-1 flex-shrink-0",children:t.jsx(jo,{azimuth:Y.azimuth,pitch:Y.pitch,onChange:(oe,me)=>{W(oe,me)},onDragStart:Q,onDragEnd:K,disabled:i,size:56})}),t.jsx(it,{axisIndex:0,value:Y.azimuth,min:-Math.PI,max:Math.PI,step:ka,onUpdate:oe=>W(oe,Y.pitch),onDragStart:Q,onDragEnd:K,disabled:i,mapping:Dt,mapTextInput:!0,customLabel:"Az"}),t.jsx(Ca,{primaryAxis:"x",secondaryAxis:"y",primaryIndex:0,secondaryIndex:1,primaryValue:Y.azimuth,secondaryValue:Y.pitch,min:-Math.PI,max:Math.PI,step:ka,onUpdate:(oe,me)=>W(oe,me),onDragStart:Q,onDragEnd:K,disabled:i,onHover:oe=>I(oe?"xy":null)}),t.jsx(it,{axisIndex:1,value:Y.pitch,min:-Math.PI/2,max:Math.PI/2,step:ka,onUpdate:oe=>W(Y.azimuth,oe),onDragStart:Q,onDragEnd:K,disabled:i,mapping:Dt,mapTextInput:!0,customLabel:"Pt"})]}):T?t.jsxs(t.Fragment,{children:[D&&t.jsx(it,{...Re("z"),customLabel:"∠"}),t.jsx("div",{className:"flex items-center justify-center px-1",children:t.jsx(jo,{azimuth:j.x,pitch:j.y,onChange:(oe,me)=>{const _e=j.clone();_e.x=oe,_e.y=me,k(_e),a(_e)},onDragStart:Q,onDragEnd:K,disabled:i,size:56})}),t.jsx("div",{className:"contents",children:t.jsx(it,{...Re("x"),customLabel:"A"})}),t.jsx(it,{...Re("y"),customLabel:"P"})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"contents",children:t.jsx(it,{...Re("x")})}),C&&t.jsx(Ca,{primaryAxis:"x",secondaryAxis:"y",primaryIndex:0,secondaryIndex:1,primaryValue:j.x,secondaryValue:j.y,min:r,max:n,step:s,onUpdate:(oe,me)=>ie("x","y",oe,me),onDragStart:Q,onDragEnd:K,disabled:i,onHover:oe=>I(oe?"xy":null)}),t.jsx(it,{...Re("y")}),D&&C&&t.jsx(Ca,{primaryAxis:"z",secondaryAxis:"y",primaryIndex:2,secondaryIndex:1,primaryValue:ee.z,secondaryValue:ee.y,min:r,max:n,step:s,onUpdate:(oe,me)=>ie("z","y",oe,me),onDragStart:Q,onDragEnd:K,disabled:i,onHover:oe=>I(oe?"zy":null)}),D&&t.jsx(it,{...Re("z")})]})})})]})},Ir=({interactionMode:e="param",trackKeys:o,trackLabels:a,...r})=>{var b,g;const{handleInteractionStart:n,handleInteractionEnd:s}=E(),{sequence:i,isRecording:l,addTrack:c,addKeyframe:d,snapshot:u}=ce(),f=S.useRef(r.value);S.useEffect(()=>{f.current=r.value},[(b=r.value)==null?void 0:b.x,(g=r.value)==null?void 0:g.y]);const p=()=>{n(e),l&&o&&(u(),o.forEach((m,v)=>{if(m){const C=a?a[v]:m;i.tracks[m]||c(m,C)}}))},h=()=>{if(l&&o){const m=["x","y"];o.forEach((v,C)=>{if(v){let M=f.current[m[C]];d(v,Math.round(ce.getState().currentFrame),M)}})}s()},x=m=>{f.current=new je(m.x,m.y),r.onChange(new je(m.x,m.y))},z=()=>{if(!o||o.length===0)return"none";const m=Math.round(ce.getState().currentFrame),v=["x","y"];let C=!1,M=!1;return o.forEach((j,k)=>{if(!j)return;const P=i.tracks[j];if(P){const I=P.keyframes.find(_=>Math.abs(_.frame-m)<.5);I&&(C=!0,Math.abs(I.value-f.current[v[k]])>1e-4&&(M=!0))}}),C?M?"keyed-dirty":"keyed":o.some(j=>j&&i.tracks[j])?o.some((k,P)=>{if(!k)return!1;const I=i.tracks[k];if(!I||I.keyframes.length===0)return!1;const _=Je(I.keyframes,m,!1);return Math.abs(_-f.current[v[P]])>.001})?"dirty":"partial":"none"},y=r.disabled?void 0:t.jsx($t,{status:z(),onClick:()=>{const m=Math.round(ce.getState().currentFrame),v=["x","y"],C=z();u(),C==="keyed"?o==null||o.forEach(M=>{if(!M)return;const w=i.tracks[M];if(w){const j=w.keyframes.find(k=>Math.abs(k.frame-m)<.5);j&&ce.getState().removeKeyframe(M,j.id)}}):(o==null||o.forEach((M,w)=>{M&&(i.tracks[M]||c(M,a?a[w]:M),d(M,m,f.current[v[w]]))}),o!=null&&o[0]&&Z.emit(pe.TRACK_FOCUS,o[0]))}});return t.jsx(Rr,{...r,value:r.value,onChange:x,onDragStart:p,onDragEnd:h,headerRight:y,showDualAxisPads:!0})},vt=({interactionMode:e="param",trackKeys:o,trackLabels:a,...r})=>{var b,g,m;const{handleInteractionStart:n,handleInteractionEnd:s}=E(),{sequence:i,isRecording:l,addTrack:c,addKeyframe:d,snapshot:u}=ce(),f=S.useRef(r.value);S.useEffect(()=>{f.current=r.value},[(b=r.value)==null?void 0:b.x,(g=r.value)==null?void 0:g.y,(m=r.value)==null?void 0:m.z]);const p=()=>{n(e),l&&o&&(u(),o.forEach((v,C)=>{if(v){const M=a?a[C]:v;i.tracks[v]||c(v,M)}}))},h=()=>{if(l&&o){const v=["x","y","z"];o.forEach((C,M)=>{if(C){let w=f.current[v[M]];d(C,Math.round(ce.getState().currentFrame),w)}})}s()},x=v=>{f.current=new U(v.x,v.y,v.z??0),r.onChange(new U(v.x,v.y,v.z??0))},z=()=>{if(!o||o.length===0)return"none";const v=Math.round(ce.getState().currentFrame),C=["x","y","z"];let M=!1,w=!1;return o.forEach((k,P)=>{if(!k)return;const I=i.tracks[k];if(I){const _=I.keyframes.find(F=>Math.abs(F.frame-v)<.5);_&&(M=!0,Math.abs(_.value-f.current[C[P]])>1e-4&&(w=!0))}}),M?w?"keyed-dirty":"keyed":o.some(k=>k&&i.tracks[k])?o.some((P,I)=>{if(!P)return!1;const _=i.tracks[P];if(!_||_.keyframes.length===0)return!1;const F=Je(_.keyframes,v,!1);return Math.abs(F-f.current[C[I]])>.001})?"dirty":"partial":"none"},y=r.disabled?void 0:t.jsx($t,{status:z(),onClick:()=>{const v=Math.round(ce.getState().currentFrame),C=["x","y","z"],M=z();u(),M==="keyed"?o==null||o.forEach(w=>{if(!w)return;const j=i.tracks[w];if(j){const k=j.keyframes.find(P=>Math.abs(P.frame-v)<.5);k&&ce.getState().removeKeyframe(w,k.id)}}):(o==null||o.forEach((w,j)=>{w&&(i.tracks[w]||c(w,a?a[j]:w),d(w,v,f.current[C[j]]))}),o!=null&&o[0]&&Z.emit(pe.TRACK_FOCUS,o[0]))}});return t.jsx(Rr,{...r,value:r.value,onChange:x,onDragStart:p,onDragEnd:h,headerRight:y,showDualAxisPads:!0})},kl=({label:e,value:o,min:a,max:r,step:n=.01,onChange:s,size:i=40,color:l="#22d3ee",tooltip:c,unconstrained:d=!1,defaultValue:u,onDragStart:f,onDragEnd:p})=>{const[h,x]=S.useState(!1),z=S.useRef(0),y=S.useRef(0),b=r-a,g=Math.max(a,Math.min(r,o)),m=Math.max(0,Math.min(1,(g-a)/b)),v=-135+m*270,C=i/2-4,M=i/2,w=i/2,j=2*Math.PI*C,k=j,P=j*(1-m*.75),I=N=>{N.preventDefault(),N.stopPropagation(),x(!0),z.current=N.clientY,y.current=o,f&&f(),N.target.setPointerCapture(N.pointerId)},_=N=>{if(!h)return;N.preventDefault();const R=z.current-N.clientY;let q=.005;N.shiftKey&&(q*=5),N.altKey&&(q*=.1);const L=R*q*b;let $=y.current+L;d||($=Math.max(a,Math.min(r,$))),n&&($=Math.round($/n)*n),s($)},F=N=>{x(!1),p&&p(),N.target.releasePointerCapture(N.pointerId)},A=N=>{N.preventDefault(),N.stopPropagation(),u!==void 0&&(f&&f(),s(u),p&&p())};return t.jsxs("div",{className:"flex flex-col items-center gap-1 select-none touch-none group",title:c||`${o.toFixed(2)}`,onDoubleClick:A,children:[t.jsxs("div",{className:"relative cursor-ns-resize",style:{width:i,height:i},onPointerDown:I,onPointerMove:_,onPointerUp:F,children:[t.jsxs("svg",{width:i,height:i,className:"overflow-visible transform rotate-90",children:[t.jsx("circle",{cx:M,cy:w,r:C,fill:"none",stroke:"#333",strokeWidth:"3",strokeDasharray:j,strokeDashoffset:j*.25,strokeLinecap:"round"}),t.jsx("circle",{cx:M,cy:w,r:C,fill:"none",stroke:h?"#fff":l,strokeWidth:"3",strokeDasharray:k,strokeDashoffset:P,strokeLinecap:"round",className:"transition-colors duration-200"})]}),t.jsx("div",{className:"absolute w-1.5 h-1.5 bg-white rounded-full shadow-sm pointer-events-none",style:{top:"50%",left:"50%",marginTop:-3,marginLeft:-3,transform:`rotate(${v}deg) translate(0, -${C}px)`}})]}),t.jsx("div",{className:"h-3 min-w-[30px] flex items-center justify-center bg-black/40 rounded px-1 border border-white/5 hover:border-white/20 transition-colors",children:t.jsx(Pr,{value:o,onChange:s,min:d?void 0:a,max:d?void 0:r,step:n,onDragStart:f,onDragEnd:p})}),e&&t.jsx("span",{className:"text-[8px] text-gray-500 font-bold group-hover:text-gray-300 transition-colors -mt-0.5",children:e})]})},zt=e=>{const{handleInteractionStart:o,handleInteractionEnd:a}=E();return t.jsx(kl,{...e,onDragStart:()=>{o("param"),e.onDragStart&&e.onDragStart()},onDragEnd:()=>{a(),e.onDragEnd&&e.onDragEnd()}})};class jl{constructor(){J(this,"components",new Map)}register(o,a){this.components.has(o)&&console.warn(`ComponentRegistry: Overwriting component '${o}'`),this.components.set(o,a)}get(o){return this.components.get(o)}}const ge=new jl,Pl=({open:e})=>t.jsx("svg",{className:`w-2 h-2 transition-transform ${e?"rotate-90":""}`,viewBox:"0 0 6 10",fill:"currentColor",children:t.jsx("path",{d:"M0 0l6 5-6 5z"})}),Ot=({label:e,children:o,defaultOpen:a=!0,count:r,labelVariant:n="secondary",labelColor:s,rightContent:i,className:l="",headerClassName:c="",open:d,onToggle:u})=>{const[f,p]=S.useState(a),h=d!==void 0,x=h?d:f,z=()=>{u&&u(),h||p(y=>!y)};return t.jsxs("div",{className:l,children:[t.jsxs("button",{onClick:z,className:`flex items-center gap-1.5 w-full px-2 py-1 text-left select-none hover:bg-white/5 transition-colors rounded-sm ${c}`,children:[t.jsx(Pl,{open:x}),t.jsx(Me,{variant:n,color:s,children:e}),r!==void 0&&t.jsx("span",{className:"text-[8px] bg-white/10 text-gray-400 px-1.5 py-0.5 rounded ml-1",children:r}),i&&t.jsx("div",{className:"ml-auto flex items-center gap-1",onClick:y=>y.stopPropagation(),children:i})]}),x&&o]})},Tl={active:"bg-green-500 shadow-[0_0_4px_rgba(34,197,94,0.4)]",pending:"bg-amber-500 animate-pulse shadow-[0_0_4px_rgba(245,158,11,0.4)]",off:"bg-red-900",instant:"bg-cyan-500 shadow-[0_0_4px_rgba(6,182,212,0.4)]"},na=({status:e,className:o="",title:a})=>t.jsx("span",{className:`inline-block w-1.5 h-1.5 rounded-full shrink-0 ${Tl[e]} ${o}`,title:a}),Oa=({label:e,isActive:o,onToggle:a,numericValue:r,onNumericChange:n,options:s,onOptionChange:i,status:l,disabled:c=!1,hideCheckbox:d=!1,description:u,min:f,max:p,step:h})=>{var I;const[x,z]=S.useState(!1),y=S.useRef(null),[b,g]=S.useState({top:0,x:0,side:"right"}),m=()=>{if(u&&y.current){const _=y.current.getBoundingClientRect(),F=_.left<window.innerWidth/2;g({top:_.top+_.height/2,x:F?_.right+6:window.innerWidth-_.left+6,side:F?"left":"right"}),z(!0)}},v=()=>z(!1),C=l==="pending"?"text-amber-400":o?"text-gray-300":"text-gray-500";let M="",w="";switch(l){case"pending":M="bg-amber-500 shadow-[0_0_6px_rgba(245,158,11,0.6)] animate-pulse",w="Pending Compilation (Click Apply)";break;case"runtime":M="bg-blue-500 shadow-[0_0_4px_rgba(59,130,246,0.5)]",w="Runtime Uniform (Instant Update)";break;case"synced":default:M=o?"bg-green-500 shadow-[0_0_4px_rgba(34,197,94,0.4)]":"bg-gray-700",w="Compiled & Active";break}const j=s&&r!==void 0?(I=s.find(_=>_.value==r))==null?void 0:I.label:"",k=h??(r!==void 0&&Number.isInteger(r)?1:.01);let P=1;return f!==void 0&&p!==void 0&&p>f&&(P=(p-f)*.01/k),t.jsxs(t.Fragment,{children:[t.jsxs("div",{ref:y,className:`flex items-center justify-between px-3 py-1.5 border-b border-white/5 hover:bg-white/5 transition-colors ${c?"opacity-30 pointer-events-none":""}`,onMouseEnter:m,onMouseLeave:v,children:[t.jsxs("div",{className:"flex items-center gap-2.5 flex-1 min-w-0",children:[t.jsx("div",{className:`w-1.5 h-1.5 rounded-full flex-shrink-0 transition-all duration-300 ${M}`,title:w}),t.jsxs("span",{className:`text-[10px] font-sans font-medium tracking-tight truncate ${C}`,children:[e," ",l==="pending"&&"*"]})]}),t.jsxs("div",{className:"flex items-center gap-3",children:[s&&i?t.jsxs("div",{className:"relative w-20 h-4 bg-black/40 border border-white/10 rounded-sm hover:border-white/30 transition-colors",children:[t.jsx("select",{className:"absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10",value:r,onChange:_=>i(Number(_.target.value)),children:s.map(_=>t.jsx("option",{value:_.value,children:_.label},_.value))}),t.jsxs("div",{className:"absolute inset-0 flex items-center justify-between px-1.5 pointer-events-none",children:[t.jsx("span",{className:"text-[9px] text-cyan-400 font-mono font-medium truncate pr-1",children:j}),t.jsx("span",{className:"text-[6px] text-gray-500",children:"▼"})]})]}):n&&r!==void 0&&t.jsx("div",{className:"w-10 h-4 bg-black/40 border border-white/10 relative overflow-hidden rounded-sm",children:t.jsx(ot,{value:r,onChange:n,step:k,min:f,max:p,sensitivity:P,highlight:o})}),!d&&t.jsx("input",{type:"checkbox",checked:o,onChange:()=>a(!o),className:`w-3 h-3 appearance-none border rounded-[2px] cursor-pointer transition-colors ${o?l==="pending"?"bg-amber-600 border-amber-500":"bg-cyan-600 border-cyan-500":"bg-black/40 border-gray-600 hover:border-gray-400"}`})]})]}),x&&Pt.createPortal(t.jsx("div",{className:"fixed z-[9999] pointer-events-none flex items-center animate-fade-in",style:{top:b.top,[b.side==="left"?"left":"right"]:b.x,transform:"translateY(-50%)"},children:t.jsxs("div",{className:"bg-black text-white text-[9px] px-2 py-1 rounded border border-white/20 shadow-xl whitespace-nowrap",children:[u,b.side==="left"?t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"absolute top-1/2 -left-1 -translate-y-1/2 border-t-4 border-b-4 border-r-4 border-t-transparent border-b-transparent border-r-white/20"}),t.jsx("div",{className:"absolute top-1/2 -left-[3px] -translate-y-1/2 border-t-[3px] border-b-[3px] border-r-[3px] border-t-transparent border-b-transparent border-r-black"})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"absolute top-1/2 -right-1 -translate-y-1/2 border-t-4 border-b-4 border-l-4 border-t-transparent border-b-transparent border-l-white/20"}),t.jsx("div",{className:"absolute top-1/2 -right-[3px] -translate-y-1/2 border-t-[3px] border-b-[3px] border-l-[3px] border-t-transparent border-b-transparent border-l-black"})]})]})}),document.body)]})},Rl=ze.lazy(()=>ht(()=>import("./AdvancedGradientEditor-DsJhhxEM.js"),__vite__mapDeps([0,1,2,3,4]),import.meta.url)),sa=(e,o,a,r)=>{if(e.or)return e.or.some(i=>sa(i,o,a,r));if(e.and)return e.and.every(i=>sa(i,o,a,r));let n=e.param||r,s;if(n&&n.startsWith("$")){const i=n.slice(1);if(i.includes(".")){const l=i.split(".");let c=a;for(const d of l){if(c==null){c=void 0;break}c=c[d]}s=c}else s=a[i]}else if(n)s=o[n];else return!0;if(e.eq===void 0&&e.neq===void 0&&e.gt===void 0&&e.lt===void 0&&e.bool===void 0)return typeof s=="boolean"?s:typeof s=="number"?s>0:!!s;if(e.eq!==void 0||e.neq!==void 0){let i=s;if(typeof s=="object"&&s&&s.getHexString&&(i="#"+s.getHexString()),e.eq!==void 0)return i==e.eq;if(e.neq!==void 0)return i!=e.neq}return e.bool!==void 0?!!s===e.bool:e.gt!==void 0?s>e.gt:e.lt!==void 0?s<e.lt:!0},At=(e,o,a,r)=>{if(!e){if(r){const n=o[r];return typeof n=="boolean"?n:typeof n=="number"?n>0:!!n}return!0}return Array.isArray(e)?e.every(n=>sa(n,o,a,r)):sa(e,o,a,r)},Il=e=>{const o=e.min??0,a=e.max??1;if(e.scale==="pi")return{min:o/Math.PI,max:a/Math.PI,toSlider:r=>r/Math.PI,fromSlider:r=>r*Math.PI};if(!(!e.scale||e.scale==="linear")){if(e.scale==="square")return{min:0,max:100,toSlider:r=>Math.sqrt((r-o)/(a-o))*100,fromSlider:r=>o+Math.pow(r/100,2)*(a-o)};if(e.scale==="log"){const r=Math.max(1e-6,o);return{min:0,max:100,toSlider:n=>n<=o?0:(Math.log10(Math.max(r,n))-Math.log10(r))/(Math.log10(a)-Math.log10(r))*100,fromSlider:n=>n<=0?o:Math.pow(10,Math.log10(r)+n/100*(Math.log10(a)-Math.log10(r)))}}}},se=({featureId:e,groupFilter:o,className:a,isDisabled:r=!1,disabledParams:n=[],excludeParams:s=[],whitelistParams:i=[],variant:l="default",forcedState:c,onChangeOverride:d,pendingChanges:u})=>{var V;const f=ne.get(e),p=E(D=>D[e]),h=c||p,x=E(D=>D.liveModulations),z=ze.useRef(E.getState());z.current=E.getState();const y=z.current,b=y,g=E(D=>D.advancedMode),m=E(D=>D.openContextMenu),v=E(D=>D.showHints),[C,M]=S.useState(null),[w,j]=S.useState(new Set),k=S.useMemo(()=>`set${e.charAt(0).toUpperCase()+e.slice(1)}`,[e]),P=(D,T)=>{if(r||n.includes(D))return;if(d){d(D,T);return}const O=f.params[D];if((O==null?void 0:O.onUpdate)==="compile"){E.getState().movePanel("Engine","left"),setTimeout(()=>Z.emit("engine_queue",{featureId:e,param:D,value:T}),50);return}if(O!=null&&O.confirmation&&T===!0&&h[D]===!1){M({key:D,value:T,message:O.confirmation});return}const B=b[k];B&&B({[D]:T})},I=()=>{if(!C)return;if(d){d(C.key,C.value),M(null);return}const D=b[k];D&&(Z.emit("is_compiling","Optimizing Shader..."),setTimeout(()=>{D({[C.key]:C.value}),M(null)},50))},_=D=>{if(r)return;const T=Ee(D.currentTarget);T.length>0&&(D.preventDefault(),D.stopPropagation(),m(D.clientX,D.clientY,[],T))},F=(D,T)=>{if(!(r||n.includes(T))&&D.target.files&&D.target.files[0]){const O=new FileReader;O.onload=B=>{var G;(G=B.target)!=null&&G.result&&P(T,B.target.result)},O.readAsDataURL(D.target.files[0])}};if(!f||!h)return null;const A=(D,T)=>{var G,Y,W,Q,K,re;const O=h[D]??T.default,B=r||n.includes(D);if(l==="dense"){let te="runtime";if(T.onUpdate==="compile"&&(te=u&&u[`${e}.${D}`]!==void 0?"pending":"synced"),T.type==="boolean")return t.jsx(Oa,{label:T.label,description:T.description,isActive:!!O,onToggle:ae=>P(D,ae),status:te,disabled:B});if(T.type==="float"||T.type==="int")return t.jsx(Oa,{label:T.label,description:T.description,isActive:!0,onToggle:()=>{},numericValue:O,onNumericChange:ae=>P(D,ae),options:T.options,onOptionChange:T.options?ae=>P(D,ae):void 0,status:te,disabled:B,hideCheckbox:!0,step:T.step,min:T.min,max:T.max})}if(T.type==="color"){let te=O;return typeof O=="object"&&O.getHexString&&(te="#"+O.getHexString()),T.layout==="embedded"||T.parentId?t.jsx("div",{className:`mb-px pr-1 ${B?"opacity-30 pointer-events-none":""}`,children:t.jsx(ha,{color:te,onColorChange:ae=>P(D,ae)})}):t.jsxs("div",{className:`flex items-center justify-between px-3 py-1 bg-gray-800/20 mb-px ${B?"opacity-30 pointer-events-none":""}`,children:[t.jsx(Me,{children:T.label}),t.jsx(ia,{color:te,onChange:ae=>P(D,ae),label:T.label})]})}if(T.type==="boolean"){const te=T.onUpdate==="compile"?t.jsx("span",{className:"ml-1.5",title:O?"Compiled & Active":"Compiled Off — toggle to queue change",children:t.jsx(na,{status:O?"active":"off"})}):null;return T.ui==="checkbox"?t.jsx("div",{className:B?"opacity-30 pointer-events-none":"",children:t.jsx(Le,{label:T.label,value:O,onChange:ae=>P(D,ae),disabled:B,variant:"dense",labelSuffix:te})}):t.jsx("div",{children:t.jsx(Le,{label:T.label,value:O,onChange:ae=>P(D,ae),options:T.options,disabled:B,labelSuffix:te})})}if(T.type==="float"||T.type==="int"){const te=T.onUpdate==="compile"?t.jsx("span",{className:"ml-1.5",title:"Compile-time setting — changes queue to Engine Panel",children:t.jsx(na,{status:"active"})}):null;if(T.options)return t.jsx("div",{className:`mb-px ${B?"opacity-30 pointer-events-none":""}`,children:t.jsx(jt,{label:T.label,value:O,onChange:ee=>P(D,ee),options:T.options,fullWidth:!0,labelSuffix:te})});if(T.ui==="knob")return t.jsx("div",{className:T.layout==="half"?"flex flex-col items-center justify-center py-2":"flex justify-center p-2",children:t.jsx(zt,{label:T.label,value:O,min:T.min??0,max:T.max??1,step:T.step,onChange:ee=>P(D,ee),color:O>(T.min??0)?"#22d3ee":"#444",size:40})});const ae=Il(T);let ie=T.format?T.format(O):void 0;T.scale==="pi"&&(ie=`${(O/Math.PI).toFixed(2)}π`);let he=T.max??1;T.dynamicMaxRef&&h[T.dynamicMaxRef]!==void 0&&(he=h[T.dynamicMaxRef]);const fe=`${e}.${D}`,ye=x[fe],Ce=O!==T.default||!!T.condition,Ge=T.condition?"!animate-none !overflow-visible":"";return t.jsx("div",{children:t.jsx(de,{label:T.label,value:O,min:T.min??0,max:he,step:T.step??.01,onChange:ee=>P(D,ee),highlight:Ce,trackId:fe,liveValue:ye,defaultValue:T.default,customMapping:ae,overrideInputText:ie,mapTextInput:T.scale==="pi",disabled:B,labelSuffix:te,className:Ge})})}if(T.type==="vec2"){const te=(O==null?void 0:O.x)??((G=T.default)==null?void 0:G.x)??0,ae=(O==null?void 0:O.y)??((Y=T.default)==null?void 0:Y.y)??0;return t.jsx("div",{className:`mb-px ${B?"opacity-30 pointer-events-none":""}`,children:t.jsx(Ir,{label:T.label,value:new je(te,ae),min:T.min??-1,max:T.max??1,onChange:ie=>P(D,{x:ie.x,y:ie.y}),mode:T.mode,scale:T.scale,linkable:T.linkable})})}if(T.type==="vec3"){const te=(O==null?void 0:O.x)??((W=T.default)==null?void 0:W.x)??0,ae=(O==null?void 0:O.y)??((Q=T.default)==null?void 0:Q.y)??0,ie=(O==null?void 0:O.z)??((K=T.default)==null?void 0:K.z)??0,he=new U(te,ae,ie),fe=T.composeFrom?T.composeFrom.map(Ce=>`${e}.${Ce}`):[`${e}.${D}_x`,`${e}.${D}_y`,`${e}.${D}_z`],ye=T.composeFrom?void 0:[`${T.label} X`,`${T.label} Y`,`${T.label} Z`];return t.jsx("div",{className:`mb-px ${B?"opacity-30 pointer-events-none":""}`,children:t.jsx(vt,{label:T.label,value:he,min:T.min??-10,max:T.max??10,step:T.step,onChange:Ce=>P(D,Ce),disabled:B,trackKeys:fe,trackLabels:ye,mode:T.mode,scale:T.scale,linkable:T.linkable})})}if(T.type==="image"){const te=((re=T.linkedParams)==null?void 0:re.colorSpace)||"colorSpace",ae=f.params[te],ie=h[te],he=()=>{if(ae&&typeof ie=="number"){const ye=(ie+1)%3;P(te,ye)}},fe=ie===1?"LIN":ie===2?"ACES":"sRGB";return t.jsx("div",{className:`mb-px ${B?"opacity-30 pointer-events-none":""}`,children:t.jsxs("div",{className:"bg-gray-800/30 border border-white/5 text-center overflow-hidden relative group",children:[t.jsx("input",{type:"file",accept:"image/*,.hdr,.exr",onChange:ye=>F(ye,D),className:"hidden",id:`file-input-${D}`}),t.jsx("label",{htmlFor:`file-input-${D}`,className:"block bg-cyan-900/40 hover:bg-cyan-800/60 text-cyan-300 w-full py-2 text-xs font-bold transition-colors cursor-pointer",children:O?"Replace Texture":T.label}),ae&&t.jsx("div",{className:"absolute right-1 top-1/2 -translate-y-1/2 text-[8px] font-bold text-gray-500 bg-black/50 px-1.5 py-0.5 rounded cursor-pointer hover:text-white hover:bg-cyan-900/80 transition-colors select-none",onClick:ye=>{ye.preventDefault(),he()},title:"Input Color Profile: sRGB / Linear / ACES",children:fe})]})})}return T.type==="gradient"?t.jsx("div",{className:`pr-1 ${B?"opacity-30 pointer-events-none":""}`,children:t.jsx(S.Suspense,{fallback:null,children:t.jsx(Rl,{value:O,onChange:te=>P(D,te)})})}):null},N=(D,T=!1)=>{var te,ae;const O=f.params[D];if(!O||O.hidden||s.includes(D)||!At(O.condition,h,y,O.parentId)||O.isAdvanced&&!g)return null;const B=A(D,O),G=Object.keys(f.params).filter(ie=>f.params[ie].parentId===D),Y=G.map(ie=>N(ie)).filter(Boolean);(te=f.customUI)==null||te.forEach(ie=>{if(ie.parentId!==D||o&&ie.group!==o||!At(ie.condition,h,y,ie.parentId))return;const he=ge.get(ie.componentId);he&&Y.push(t.jsx("div",{children:t.jsx(he,{featureId:e,sliceState:h,actions:b,...ie.props})},`custom-${ie.componentId}`))});const W=T?"flex-1 min-w-0":"flex flex-col",Q=Y.length>0,K=((ae=f.customUI)==null?void 0:ae.some(ie=>ie.parentId===D))??!1,re=G.length>0||K;return t.jsxs("div",{className:`w-full ${W} ${re?"rounded-t-sm relative":""}`,children:[re&&t.jsx("div",{className:`absolute inset-0 bg-white/[0.06] rounded-t-sm pointer-events-none transition-opacity ${Q?"opacity-100":"opacity-0"}`}),B,v&&O.description&&!r&&l!=="dense"&&t.jsx("p",{className:"px-3 py-1.5 text-[9px] text-gray-600 leading-tight bg-white/[0.06] hover:text-gray-300 transition-colors cursor-default",children:O.description}),Y.length>0&&t.jsxs("div",{className:"flex flex-col",children:[Y.map((ie,he)=>{const fe=he===Y.length-1;return t.jsxs("div",{className:"flex",children:[t.jsx("div",{className:`w-2 shrink-0 self-stretch border-l border-white/20 bg-white/[0.12] ${fe?"border-b border-b-white/20 rounded-bl-lg":""}`}),t.jsxs("div",{className:`flex-1 min-w-0 relative ${fe?"border-b border-b-white/20":""}`,children:[t.jsx("div",{className:"absolute inset-0 bg-black/20 pointer-events-none z-10"}),ie]})]},he)}),t.jsx("div",{className:"h-2",style:{background:"linear-gradient(to bottom, transparent, rgba(255,255,255,0.08))"}})]})]},D)},R=Object.keys(f.params).filter(D=>f.params[D].parentId?!1:i&&i.length>0?i.includes(D):o?f.params[D].group===o:!0),q=D=>{const T=[];for(let O=0;O<D.length;O++){const B=D[O],G=f.params[B];if(!(G.hidden||s.includes(B)||!At(G.condition,h,y))){if(G.layout==="half"&&l!=="dense"){let Y=D[O+1],W=Y?f.params[Y]:null;if(W&&W.layout==="half"&&!W.hidden&&!s.includes(Y)&&At(W.condition,h,y)){T.push(t.jsxs("div",{className:"flex gap-0.5 mb-px",children:[N(B,!0),N(Y,!0)]},`${B}-${Y}`)),O++;continue}}T.push(N(B))}}return T},L=D=>{j(T=>{const O=new Set(T);return O.has(D)?O.delete(D):O.add(D),O})},$=f.groups,X=$&&!o&&!(i!=null&&i.length)&&Object.values($).some(D=>D.collapsible),H=[];if(X&&$){const D=[],T={},O=[];for(const B of R){const G=f.params[B].group;G&&$[G]?(T[G]||(T[G]=[],D.push(G)),T[G].push(B)):O.push(B)}H.push(...q(O));for(const B of D){const G=$[B],Y=T[B];w.has(B);const W=q(Y);if(!W.every(Q=>Q===null))if(G.collapsible){const Q=W.filter(Boolean);H.push(t.jsx(Ot,{label:G.label,open:!w.has(B),onToggle:()=>L(B),defaultOpen:!0,headerClassName:"px-2 py-0.5 text-[9px] font-bold text-gray-500 hover:text-gray-300 bg-neutral-800 rounded-sm",children:t.jsxs("div",{className:"flex flex-col",children:[Q.map((K,re)=>t.jsx("div",{children:K},re)),t.jsx("div",{className:"ml-[9px] border-b border-white/10 rounded-bl mb-0.5"})]})},`group-${B}`))}else H.push(...W)}}else H.push(...q(R));return(V=f.customUI)==null||V.forEach(D=>{if(i&&i.length>0||D.parentId||o&&D.group!==o||!At(D.condition,h,y))return;const T=ge.get(D.componentId);T&&H.push(t.jsx("div",{className:`flex flex-col mb-px ${r?"grayscale opacity-30 pointer-events-none":""}`,children:t.jsx(T,{featureId:e,sliceState:h,actions:b,...D.props})},`custom-${D.componentId}`))}),t.jsxs("div",{className:`flex flex-col relative ${a||""}`,onContextMenu:_,children:[H,C&&t.jsx("div",{className:"absolute inset-0 z-50 animate-pop-in",children:t.jsxs("div",{className:"bg-black/95 border border-white/20 rounded shadow-2xl overflow-hidden h-full flex flex-col",children:[t.jsxs("div",{className:"flex items-center gap-2 p-2 border-b border-white/10 bg-white/5",children:[t.jsx(Rt,{}),t.jsx(Me,{color:"text-gray-300",children:"Warning"})]}),t.jsxs("div",{className:"p-3 flex-1 flex flex-col justify-between",children:[t.jsx("p",{className:"text-[10px] text-gray-400 leading-relaxed whitespace-pre-wrap",children:C.message}),t.jsxs("div",{className:"flex gap-1 mt-4",children:[t.jsx("button",{onClick:()=>M(null),className:"flex-1 py-1.5 bg-gray-800 text-gray-300 text-[9px] font-bold rounded border border-white/10 hover:bg-gray-700 transition-colors",children:"Cancel"}),t.jsx("button",{onClick:I,className:"flex-1 py-1.5 bg-cyan-900/50 text-cyan-300 text-[9px] font-bold rounded border border-cyan-500/30 hover:bg-cyan-900 transition-colors",children:"Confirm"})]})]})]})})]})},Fl=()=>{const e=E(n=>{var s;return(s=n.lighting)==null?void 0:s.shadows}),o=E(n=>n.setLighting),a=E(n=>n.handleInteractionStart),r=E(n=>n.handleInteractionEnd);return t.jsx(wt,{width:"w-52",children:t.jsxs("div",{className:"relative space-y-2",children:[t.jsxs("div",{className:"flex items-center justify-between border-b border-white/10 pb-2 px-1",children:[t.jsx(Me,{children:"Shadows"}),t.jsx("button",{onClick:()=>{a("param"),o({shadows:!e}),r()},className:`text-[9px] font-bold px-2 py-0.5 rounded border transition-colors ${e?"bg-yellow-500/20 text-yellow-300 border-yellow-500/50":"bg-gray-800 text-gray-500 border-gray-600"}`,children:e?"Enabled":"Disabled"})]}),e&&t.jsx("div",{className:"space-y-1",children:t.jsx(se,{featureId:"lighting",groupFilter:"shadows"})})]})})},_l=({isMobileMode:e,vibrate:o})=>{var _;const a=E(),r=a.lighting,{openContextMenu:n,handleInteractionStart:s,handleInteractionEnd:i}=E(),[l,c]=S.useState(null),[d,u]=S.useState(null),[f,p]=S.useState(!1),[h,x]=S.useState(!1),z=S.useRef(null),y=S.useRef(null),b=S.useRef(null),g=S.useRef(null);S.useEffect(()=>{const F=A=>{const N=A.target;y.current&&!y.current.contains(N)&&!N.closest(".shadow-toggle-btn")&&p(!1),e&&d!==null&&!N.closest(".light-orb-wrapper")&&u(null),h&&g.current&&!g.current.contains(N)&&!N.closest(".expand-trigger")&&x(!1)};return document.addEventListener("mousedown",F),document.addEventListener("touchstart",F),()=>{document.removeEventListener("mousedown",F),document.removeEventListener("touchstart",F)}},[d,e,h]);const m=(F,A)=>{F.preventDefault(),F.stopPropagation(),n(F.clientX,F.clientY,[],A)},v=(F,A)=>{F.preventDefault(),F.stopPropagation();const N=bt(a.lighting,A),R=[{label:`Light ${A+1}`,isHeader:!0,action:()=>{}},{label:"Enabled",checked:N.visible,action:()=>{s("param"),a.updateLight({index:A,params:{visible:!N.visible}}),i()}},{label:"Type",isHeader:!0,action:()=>{}},{label:"Point",checked:N.type==="Point",action:()=>{s("param"),a.updateLight({index:A,params:{type:"Point"}}),i()}},{label:"Directional (Sun)",checked:N.type==="Directional",action:()=>{s("param"),a.updateLight({index:A,params:{type:"Directional"}}),i()}}];n(F.clientX,F.clientY,R,["panel.light"])},C=F=>{const A=bt(a.lighting,F);if(!e){o(5),s("param"),a.updateLight({index:F,params:{visible:!A.visible}}),i();return}A.visible?d!==F?(o(5),u(F)):(o([10,30,10]),s("param"),a.updateLight({index:F,params:{visible:!1}}),i(),u(null)):(o(10),s("param"),a.updateLight({index:F,params:{visible:!0}}),i(),u(null))},M=(F,A)=>{e||A.nativeEvent.pointerType==="touch"||(z.current&&clearTimeout(z.current),c(F))},w=()=>{e||(z.current=window.setTimeout(()=>{c(null)},400))},j=F=>{o(5);const A=P[F];a.setDraggedLight((A==null?void 0:A.id)??null),e||(u(null),c(null))},k=()=>{a.addLight()},P=((_=a.lighting)==null?void 0:_.lights)||[],I=F=>{const A=P[F];return A?t.jsxs("div",{className:"relative light-orb-wrapper flex justify-center w-8 h-8",onMouseEnter:N=>M(F,N),onMouseLeave:w,onContextMenu:N=>v(N,F),children:[t.jsx(vl,{index:F,color:A.color,active:A.visible,type:A.type,rotation:A.rotation,onClick:()=>C(F),onDragStart:()=>j(F)}),a.draggedLightIndex!==A.id&&(l===F||d===F)&&t.jsx(wl,{index:F})]},F):F<Se?t.jsx("div",{className:"flex justify-center items-center w-8 h-8",children:t.jsx("button",{onClick:k,className:"w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-gray-500 hover:text-cyan-400 hover:border-cyan-500/50 hover:bg-white/5 transition-all",title:"Add Light",children:t.jsx(fa,{})})},F):t.jsx("div",{className:"w-8 h-8"},F)};return t.jsxs("div",{ref:b,className:"absolute left-1/2 -translate-x-1/2 flex items-center bg-white/5 pr-2 pl-6 py-1.5 rounded-full border border-white/5 shadow-inner z-[65]",children:[t.jsxs("div",{className:"relative",children:[t.jsxs("div",{className:`flex items-center gap-6 transition-opacity duration-200 ${h?"opacity-0 pointer-events-none":"opacity-100"}`,children:[[0,1,2].map(F=>I(F)),t.jsx("button",{onClick:()=>{o(5),x(!0)},className:"expand-trigger w-5 h-5 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white transition-colors ml-[-8px]",title:"Expand Light Studio",children:t.jsx(Tt,{})})]}),h&&t.jsx("div",{ref:g,className:"absolute top-[-20px] left-[-20px] bg-black/95 border border-white/20 p-5 rounded-2xl shadow-2xl animate-fade-in z-[80]",children:t.jsxs("div",{className:"grid grid-cols-3 gap-6",children:[Array.from({length:8}).map((F,A)=>I(A)),t.jsx("div",{className:"flex justify-center items-center w-8 h-8",children:t.jsx("button",{onClick:()=>x(!1),className:"w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-gray-500 hover:text-white hover:bg-white/10 transition-colors",title:"Collapse",children:t.jsx(Ns,{})})})]})})]}),t.jsx("div",{className:"h-6 w-px bg-white/10 mx-4"}),t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsxs("div",{className:"relative",ref:y,children:[t.jsx("button",{onClick:F=>{F.stopPropagation(),o(5),p(!f)},onContextMenu:F=>m(F,["shadows"]),className:`shadow-toggle-btn p-2 rounded-full border transition-all duration-300 ${r!=null&&r.shadows?"bg-yellow-500/10 border-yellow-500/50 text-yellow-300 shadow-[0_0_10px_rgba(234,179,8,0.1)]":"bg-transparent border-transparent text-gray-600 hover:text-gray-300 hover:bg-white/5"}`,title:"Shadow Settings",children:t.jsx(Qs,{})}),f&&t.jsx(Fl,{})]}),t.jsx("button",{onClick:()=>{o(5),s("param"),a.setShowLightGizmo(!a.showLightGizmo),i()},onContextMenu:F=>m(F,["ui.viewport"]),className:`p-2 rounded-full border transition-all duration-300 ${a.showLightGizmo?"bg-cyan-500/20 border-cyan-500 text-cyan-300 shadow-[0_0_10px_rgba(34,211,238,0.2)]":"bg-transparent border-transparent text-gray-600 hover:text-gray-300 hover:bg-white/5"}`,children:t.jsx(Zs,{})})]})]})},Fr=(e,o,a,r)=>{const n=e.replace(/[^a-zA-Z0-9 \-_]/g,"").trim().replace(/\s+/g,"_")||"Untitled",s=`v${o}`;return`${["GMT",n,s].join("_")}.${a}`},Po=ue(),Dl=({isMobileMode:e,vibrate:o,btnBase:a,btnActive:r,btnInactive:n})=>{const s=E(),{movePanel:i}=s,[l,c]=S.useState(!1),[d,u]=S.useState(!1),f=S.useRef(null),p=S.useRef(null),h=async()=>{if(Po.isBooted){c(!1);try{const g=await Po.captureSnapshot();if(u(!0),!g){console.error("Snapshot generation returned null.");return}const m=s.getPreset({includeScene:!0}),v=JSON.stringify(m),C=s.prepareExport(),M=Fr(s.projectSettings.name,C,"png");try{const w=await rr(g,"FractalData",v),j=URL.createObjectURL(w),k=document.createElement("a");k.download=M,k.href=j,k.click(),URL.revokeObjectURL(j),o(50)}catch(w){console.error("Metadata injection failed, saving raw image",w);const j=URL.createObjectURL(g),k=document.createElement("a");k.download=M,k.href=j,k.click(),URL.revokeObjectURL(j)}}catch(g){console.error("Snapshot failed",g)}finally{u(!1)}}},x=g=>{g.stopPropagation(),e?(o(5),c(!l)):h()},z=()=>{e||(f.current&&clearTimeout(f.current),c(!0))},y=()=>{e||(f.current=window.setTimeout(()=>{c(!1)},200))},b=()=>{o(5),i("Camera Manager","left"),c(!1)};return S.useEffect(()=>{if(!e||!l)return;const g=m=>{const v=m.target;p.current&&!p.current.contains(v)&&!v.closest(".camera-menu-trigger")&&c(!1)};return document.addEventListener("mousedown",g),document.addEventListener("touchstart",g),()=>{document.removeEventListener("mousedown",g),document.removeEventListener("touchstart",g)}},[l,e]),t.jsxs(t.Fragment,{children:[d&&t.jsx("div",{className:"fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm animate-fade-in",children:t.jsxs("div",{className:"bg-gray-900 border border-cyan-500/50 rounded-xl px-6 py-4 shadow-2xl flex items-center gap-3",children:[t.jsx("div",{className:"w-5 h-5 border-2 border-cyan-400 border-t-transparent rounded-full animate-spin"}),t.jsx("span",{className:"text-cyan-300 font-bold text-sm",children:"Capturing..."})]})}),t.jsxs("div",{className:"relative",ref:p,onMouseEnter:z,onMouseLeave:y,children:[t.jsx("button",{onClick:x,className:`camera-menu-trigger ${a} ${l?r:n}`,title:e?"Camera Menu":"Click: Take Snapshot / Hover: Camera Menu",children:t.jsx(So,{})}),l&&t.jsxs(wt,{width:"w-48",align:"end",children:[t.jsx("div",{className:"px-2 py-1 text-[10px] font-bold text-gray-500 border-b border-white/10 mb-1",children:"Camera Tools"}),t.jsxs("div",{className:"space-y-1",children:[t.jsxs("button",{onClick:()=>{o(5),s.undoCamera()},disabled:s.undoStack.length===0,className:"w-full flex items-center justify-between p-2 rounded hover:bg-white/10 disabled:opacity-30 text-xs text-gray-300 text-left",children:[t.jsxs("span",{className:"flex items-center gap-2",children:[t.jsx(Gs,{})," Undo Move"]}),t.jsx("kbd",{className:"text-[8px] text-gray-500 bg-gray-800 px-1 rounded",children:"Ctrl+Shift+Z"})]}),t.jsxs("button",{onClick:()=>{o(5),s.redoCamera()},disabled:s.redoStack.length===0,className:"w-full flex items-center justify-between p-2 rounded hover:bg-white/10 disabled:opacity-30 text-xs text-gray-300 text-left",children:[t.jsxs("span",{className:"flex items-center gap-2",children:[t.jsx(Vs,{})," Redo Move"]}),t.jsx("kbd",{className:"text-[8px] text-gray-500 bg-gray-800 px-1 rounded",children:"Ctrl+Shift+Y"})]}),t.jsxs("button",{onClick:()=>{o(30),s.resetCamera(),s.setShowLightGizmo(!1)},className:"w-full flex items-center gap-2 p-2 rounded hover:bg-white/10 text-xs text-gray-300 text-left",children:[t.jsx(Us,{})," Reset Position"]}),t.jsx("div",{className:"h-px bg-white/10 my-1"}),t.jsxs("button",{onClick:b,className:"w-full flex items-center gap-2 p-2 rounded hover:bg-white/10 text-xs text-cyan-300 text-left",children:[t.jsx(Ya,{})," Camera Manager"]}),t.jsx("div",{className:"h-px bg-white/10 my-1"}),t.jsxs("button",{onClick:h,className:"w-full flex items-center gap-2 p-2 rounded hover:bg-cyan-900/50 text-xs text-cyan-400 font-bold text-left",title:"Save PNG with embedded scene data",children:[t.jsx(So,{})," Take Snapshot"]})]})]})]})]})},To=ue(),Ll=({isMobileMode:e,vibrate:o,btnBase:a,btnActive:r,btnInactive:n})=>{const s=E(),i=s,[l,c]=S.useState(!1),[d,u]=S.useState(!1),[f,p]=S.useState(""),[h,x]=S.useState(null),[z,y]=S.useState(null),b=S.useRef(null),g=S.useRef(null),m=ne.getMenuFeatures(),v=ne.getExtraMenuItems(),C=dr(s),M=C.charAt(0).toUpperCase()+C.slice(1);S.useEffect(()=>{const L=To.gpuInfo;if(L)p(L);else{const $=setTimeout(()=>{p(To.gpuInfo||"Generic WebGL Device")},3e3);return()=>clearTimeout($)}},[]),S.useEffect(()=>{const L=$=>{const X=$.target;if(b.current&&!b.current.contains(X)){if(X.closest(".portal-dropdown-content")||X.closest(".t-dropdown"))return;c(!1),u(!1)}};return l&&(document.addEventListener("mousedown",L),document.addEventListener("touchstart",L)),()=>{document.removeEventListener("mousedown",L),document.removeEventListener("touchstart",L)}},[l]);const w=L=>{L.stopPropagation(),o(5),c(!l)},j=()=>{const L=s.prepareExport(),$=s.projectSettings,X=s.getPreset(),H=new Blob([JSON.stringify(X,null,2)],{type:"application/json"}),V=URL.createObjectURL(H),D=document.createElement("a");D.href=V,D.download=Fr($.name,L,"json"),D.click(),URL.revokeObjectURL(V)},k=()=>{var L;return(L=g.current)==null?void 0:L.click()},P=async L=>{var X;const $=(X=L.target.files)==null?void 0:X[0];if($){Z.emit("is_compiling","Processing..."),await new Promise(H=>setTimeout(H,50));try{let H="";if($.type==="image/png"){const D=await ir($,"FractalData");if(D)H=D;else throw new Error("No Fractal Data found in this image.")}else H=await $.text();const V=JSON.parse(H);s.loadPreset(V),o(50),c(!1)}catch(H){console.error("Load Failed:",H),Z.emit("is_compiling",!1),y("Error!"),setTimeout(()=>y(null),2e3),alert("Could not load preset. "+(H instanceof Error?H.message:String(H)))}L.target.value=""}},I=()=>{let $=s.getShareString({includeAnimations:!0}),X="";if($.length>4096){const V=s.getShareString({includeAnimations:!1});V.length<$.length&&V.length<4096?($=V,X=" (Anims Removed)"):X=" (Long URL)"}const H=`${window.location.origin}${window.location.pathname}#s=${$}`;navigator.clipboard.writeText(H).then(()=>{x(`Copied!${X}`),o(50),setTimeout(()=>x(null),2500)})},_=(L,$,X)=>{var T,O;const H=ne.get(L);if(((T=H==null?void 0:H.engineConfig)==null?void 0:T.mode)==="compile"&&((O=H.params[$])==null?void 0:O.onUpdate)==="compile"){s.movePanel("Engine","left"),setTimeout(()=>Z.emit("engine_queue",{featureId:L,param:$,value:X}),50);return}const V=`set${L.charAt(0).toUpperCase()+L.slice(1)}`,D=s[V];if(D&&(D({[$]:X}),H!=null&&H.tabConfig)){const B=H.tabConfig.label;L==="engineSettings"?X&&s.movePanel(B,"left"):X?s.floatTab(B):s.dockTab(B)}},F=(L,$=!1)=>{const X=i[L.id||L.featureId];if(!X)return null;const H=!!X[L.toggleParam];L.id;const V=L.id==="audio"?"text-green-400":"text-cyan-400";if($){const T={Code:t.jsx(oa,{}),Info:t.jsx(br,{})},O=L.icon?T[L.icon]:null;return t.jsxs("button",{onClick:B=>{B.stopPropagation(),o(5),_(L.featureId,L.toggleParam,!H),c(!1)},className:`w-full flex items-center justify-between p-2 rounded transition-colors group ${H?"bg-white/10 text-cyan-400":"hover:bg-white/5 text-gray-300"}`,children:[t.jsx("span",{className:"text-xs font-bold",children:L.label}),O]},`${L.featureId}-${L.toggleParam}`)}const D=H?L.id==="audio"?"bg-green-500/30 text-green-300 border-green-500/40":"bg-cyan-500/30 text-cyan-300 border-cyan-500/40":"bg-white/[0.04] text-gray-600 border-white/5";return t.jsxs("div",{className:"flex items-center justify-between p-2 rounded hover:bg-white/5 cursor-pointer animate-fade-in-left",onClick:()=>{o(5),_(L.id,L.toggleParam,!H)},children:[t.jsx("span",{className:`text-xs font-bold ${H?V:"text-gray-300"}`,children:L.label}),t.jsx("span",{className:`px-2 py-0.5 text-[8px] font-bold rounded-sm border transition-all ${D}`,children:H?"ON":"OFF"})]},L.id)},A=L=>{o(10),Z.emit("is_compiling","Switching Profile..."),setTimeout(()=>{s.applyPreset({mode:L.toLowerCase(),actions:s})},10)},N=m.filter(L=>!L.advancedOnly),R=m.filter(L=>L.advancedOnly),q=v.filter(L=>L.advancedOnly);return t.jsxs(t.Fragment,{children:[!e&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{onClick:I,className:`${a} ${n} relative`,title:"Copy Share Link",children:[t.jsx(Ba,{}),h&&t.jsx("div",{className:"absolute top-full mt-2 left-1/2 -translate-x-1/2 px-2 py-1 bg-green-600 text-white text-[9px] font-bold rounded whitespace-nowrap animate-fade-in",children:h})]}),t.jsx("button",{onClick:j,className:`${a} ${n}`,title:"Save Preset (JSON)",children:t.jsx(wo,{})}),t.jsxs("button",{onClick:k,className:`${a} ${n} relative`,title:"Load Preset (JSON or PNG)",children:[t.jsx(Na,{}),z&&t.jsx("div",{className:"absolute top-full mt-2 left-1/2 -translate-x-1/2 px-2 py-1 bg-blue-600 text-white text-[9px] font-bold rounded whitespace-nowrap animate-fade-in",children:z})]})]}),t.jsx("input",{ref:g,type:"file",accept:".json,.png",className:"hidden",onChange:P}),t.jsxs("div",{className:"relative",ref:b,children:[t.jsx("button",{onClick:w,className:`${a} ${l?r:n}`,children:t.jsx(Hs,{})}),l&&t.jsx(wt,{width:"w-64",align:"end",className:"p-2 custom-scroll overflow-y-auto max-h-[85vh]",onClose:w,children:t.jsxs("div",{className:"space-y-1",children:[t.jsxs("button",{onClick:L=>{L.stopPropagation(),I()},className:"w-full flex items-center justify-between p-2 rounded hover:bg-white/5 text-gray-300 transition-colors group",children:[t.jsx("span",{className:`text-xs font-bold ${h?"text-green-400":"group-hover:text-white"}`,children:h||"Copy Share Link"}),t.jsx(Ba,{active:!!h})]}),t.jsx("div",{className:"h-px bg-white/10 my-1"}),e&&t.jsxs(t.Fragment,{children:[t.jsxs("button",{onClick:L=>{L.stopPropagation(),w(L),j()},className:"w-full flex items-center justify-between p-2 rounded hover:bg-white/5 text-gray-300 transition-colors group border-b border-white/10 mb-1",children:[t.jsx("span",{className:"text-xs font-bold group-hover:text-white",children:"Save Preset"}),t.jsx(wo,{})]}),t.jsxs("button",{onClick:L=>{L.stopPropagation(),w(L),k()},className:"w-full flex items-center justify-between p-2 rounded hover:bg-white/5 text-gray-300 transition-colors group border-b border-white/10 mb-1",children:[t.jsx("span",{className:"text-xs font-bold group-hover:text-white",children:"Load Preset"}),t.jsx(Na,{})]}),t.jsx("div",{className:"h-px bg-white/10 my-1"})]}),N.map(L=>F(L)),t.jsx("div",{className:"h-px bg-white/10 my-1"}),F({id:"engineSettings",toggleParam:"showEngineTab",label:"Engine Settings"}),t.jsx("div",{className:"px-2 mb-1 mt-0.5",children:t.jsx(jt,{value:M,onChange:A,selectClassName:"!text-left pl-2",options:[{label:"Fastest (Bare)",value:"Fastest"},{label:"Lite (Fast)",value:"Lite"},{label:"Balanced",value:"Balanced"},{label:"Ultra",value:"Ultra"},{label:"---",value:"Custom"}],fullWidth:!0})}),t.jsxs("button",{onClick:L=>{L.stopPropagation(),o(5),s.openWorkshop(),c(!1)},className:"w-full flex items-center justify-between p-2 rounded hover:bg-white/5 text-gray-300 transition-colors group",children:[t.jsx("span",{className:"text-xs font-bold group-hover:text-purple-400",children:"Formula Workshop"}),t.jsx(oa,{})]}),t.jsxs("button",{onClick:L=>{L.stopPropagation(),s.setIsBroadcastMode(!0)},className:"w-full flex items-center justify-between p-2 rounded hover:bg-white/5 text-gray-300 transition-colors group",children:[t.jsxs("span",{className:"text-xs font-bold group-hover:text-cyan-400",children:["Hide Interface ",t.jsx("span",{className:"text-gray-500 font-normal",children:"[B]"})]}),t.jsx(Os,{})]}),t.jsxs("div",{className:"flex items-center justify-between p-2 rounded hover:bg-white/5 cursor-pointer",onClick:()=>{o(5),s.setInvertY(!s.invertY)},children:[t.jsx("span",{className:"text-xs text-gray-300 font-bold",children:"Invert Look Y"}),t.jsx("span",{className:`px-2 py-0.5 text-[8px] font-bold rounded-sm border transition-all ${s.invertY?"bg-cyan-500/30 text-cyan-300 border-cyan-500/40":"bg-white/[0.04] text-gray-600 border-white/5"}`,children:s.invertY?"ON":"OFF"})]}),t.jsx("div",{className:"h-px bg-white/10 my-1"}),t.jsxs("div",{className:"flex items-center justify-between p-2 rounded hover:bg-white/5 cursor-pointer",title:"Keyboard: ` (tilde)",onClick:()=>s.setAdvancedMode(!s.advancedMode),children:[t.jsxs("span",{className:"text-xs text-gray-300 font-bold",children:["Advanced Mode ",t.jsx("span",{className:"text-gray-500 font-normal",children:"[`]"})]}),t.jsx("span",{className:`px-2 py-0.5 text-[8px] font-bold rounded-sm border transition-all ${s.advancedMode?"bg-purple-500/30 text-purple-300 border-purple-500/40":"bg-white/[0.04] text-gray-600 border-white/5"}`,children:s.advancedMode?"ON":"OFF"})]}),s.advancedMode&&t.jsxs("div",{className:"mt-1 pl-2 border-l border-white/10 ml-2",children:[R.map(L=>F(L)),q.map(L=>F(L,!0)),t.jsxs("div",{className:"flex items-center justify-between p-2 rounded hover:bg-white/5 cursor-pointer",onClick:()=>s.setDebugMobileLayout(!s.debugMobileLayout),children:[t.jsx("span",{className:"text-xs text-gray-300 font-bold",children:"Force Mobile UI"}),t.jsx("span",{className:`px-2 py-0.5 text-[8px] font-bold rounded-sm border transition-all ${s.debugMobileLayout?"bg-purple-500/30 text-purple-300 border-purple-500/40":"bg-white/[0.04] text-gray-600 border-white/5"}`,children:s.debugMobileLayout?"ON":"OFF"})]})]}),t.jsx("div",{className:"h-px bg-white/10 my-1"}),t.jsxs("div",{className:"flex items-center justify-between p-2 rounded hover:bg-white/5 cursor-pointer",title:"Keyboard: H",onClick:()=>{o(5),s.setShowHints(!s.showHints)},children:[t.jsxs("span",{className:"text-xs text-gray-300 font-bold",children:["Show Hints ",t.jsx("span",{className:"text-gray-500 font-normal",children:"[H]"})]}),t.jsx("span",{className:`px-2 py-0.5 text-[8px] font-bold rounded-sm border transition-all ${s.showHints?"bg-green-500/30 text-green-300 border-green-500/40":"bg-white/[0.04] text-gray-600 border-white/5"}`,children:s.showHints?"ON":"OFF"})]}),t.jsxs("button",{onClick:L=>{L.stopPropagation(),o(5),s.openHelp("general.shortcuts"),c(!1)},className:"w-full flex items-center justify-between p-2 rounded hover:bg-white/5 text-cyan-400 transition-colors group",children:[t.jsx("span",{className:"text-xs font-bold group-hover:text-cyan-200",children:"Help"}),t.jsx(vr,{})]}),t.jsxs("button",{onClick:L=>{L.stopPropagation(),o(5),u(!d)},className:`w-full flex items-center justify-between p-2 rounded transition-colors ${d?"bg-white/10 text-cyan-400":"hover:bg-white/5 text-gray-300"}`,children:[t.jsx("span",{className:"text-xs font-bold",children:"About GMT"}),t.jsx(qs,{})]}),d&&t.jsx("div",{className:"p-3 bg-white/5 rounded-lg border border-white/5 animate-fade-in mt-1",children:t.jsxs("div",{className:"text-[10px] text-gray-400 leading-relaxed space-y-2",children:[f&&t.jsxs("div",{className:"mb-2 pb-2 border-b border-white/10",children:[t.jsx("div",{className:"text-[8px] text-gray-500 font-bold mb-1",children:"Active Renderer"}),t.jsx("div",{className:"text-[9px] text-green-400 font-mono break-all",children:f})]}),t.jsx("p",{className:"text-[9px] text-gray-500 font-mono mb-1",children:"v0.8.9"}),t.jsxs("p",{children:["GMT was crafted with ❤️ by ",t.jsx("span",{className:"text-white font-bold",children:"Guy Zack"})," using ",t.jsx("a",{href:"https://aistudio.google.com",target:"_blank",rel:"noopener noreferrer",className:"text-cyan-400 hover:underline",children:"Gemini"})," and ",t.jsx("a",{href:"https://claude.ai",target:"_blank",rel:"noopener noreferrer",className:"text-cyan-400 hover:underline",children:"Claude"}),"."]}),t.jsxs("div",{className:"pt-2 border-t border-white/10",children:[t.jsx("div",{className:"text-[8px] text-gray-500 font-bold mb-1",children:"Tech Stack"}),t.jsx("div",{className:"text-[9px] text-gray-500 font-mono",children:"React + TypeScript + Three.js + GLSL + Zustand + Vite"})]}),t.jsxs("div",{className:"flex flex-col gap-1 pt-2 border-t border-white/10",children:[t.jsxs("a",{href:"https://www.reddit.com/r/GMT_fractals/",target:"_blank",rel:"noopener noreferrer",className:"flex items-center gap-2 hover:text-white transition-colors",children:[t.jsx("span",{children:"Community:"}),t.jsx("span",{className:"text-cyan-400 hover:underline",children:"r/GMT_fractals"})]}),t.jsxs("a",{href:"https://github.com/gamazama/GMT-fractals",target:"_blank",rel:"noopener noreferrer",className:"flex items-center gap-2 hover:text-white transition-colors",children:[t.jsx("span",{children:"Source:"}),t.jsx("span",{className:"text-cyan-400 hover:underline",children:"GitHub (GPL-3.0)"})]})]})]})})]})})]})]})},El=()=>{const e=E(),[o,a]=S.useState(window.innerWidth),[r,n]=S.useState(!1);S.useEffect(()=>{const u=()=>a(window.innerWidth),f=()=>n(window.matchMedia("(pointer: coarse)").matches);return window.addEventListener("resize",u),f(),()=>window.removeEventListener("resize",u)},[]);const s=e.debugMobileLayout||o<768||r,i=(u=10)=>{navigator.vibrate&&navigator.vibrate(u)},l="p-2.5 rounded-lg transition-all active:scale-95 border flex items-center justify-center",c="bg-transparent border-transparent text-gray-400 hover:text-white hover:bg-white/10 hover:border-white/10",d="bg-gray-800 border-gray-600 text-white";return t.jsxs("header",{className:"relative shrink-0 w-full h-14 z-[500] bg-black/90 border-b border-white/10 flex items-center justify-between px-6 animate-fade-in-down select-none",children:[t.jsx(xl,{isMobileMode:s,vibrate:i}),t.jsx(_l,{isMobileMode:s,vibrate:i}),t.jsxs("div",{className:"flex gap-2 relative items-center",children:[t.jsx(Dl,{isMobileMode:s,vibrate:i,btnBase:l,btnActive:d,btnInactive:c}),t.jsx("div",{className:"h-6 w-px bg-white/10 mx-1"}),t.jsx(Ll,{isMobileMode:s,vibrate:i,btnBase:l,btnActive:d,btnInactive:c})]})]})},Qa=()=>{const[e,o]=S.useState(typeof window<"u"?window.innerHeight>window.innerWidth:!1),[a,r]=S.useState(!1);return S.useEffect(()=>{const n=()=>{o(window.innerHeight>window.innerWidth),r(window.matchMedia("(pointer: coarse)").matches||window.innerWidth<768)};return window.addEventListener("resize",n),n(),()=>window.removeEventListener("resize",n)},[]),{isPortrait:e,isMobile:a}},Ro=({onMove:e,label:o,active:a})=>{const[r,n]=S.useState(!1),[s,i]=S.useState({x:0,y:0}),l=S.useRef(null),c=S.useRef(null),d=S.useRef({x:0,y:0}),u=S.useCallback((p,h)=>{if(!l.current)return;const x=l.current.getBoundingClientRect(),z=x.left+x.width/2,y=x.top+x.height/2,b=x.width/2;let g=(p-z)/b,m=(h-y)/b;const v=Math.sqrt(g*g+m*m);v>1&&(g/=v,m/=v);const C=30,M=Math.min(1,v),w=(v>0?g:0)*M*C,j=(v>0?m:0)*M*C;i({x:w,y:j}),d.current={x:g,y:-m}},[]),f=p=>{a&&(p.stopPropagation(),c.current=p.pointerId,n(!0),u(p.clientX,p.clientY),navigator.vibrate&&navigator.vibrate(10))};return S.useEffect(()=>{if(!r)return;const p=x=>{x.pointerId===c.current&&(x.cancelable&&x.preventDefault(),u(x.clientX,x.clientY),e(d.current.x,d.current.y))},h=x=>{x.pointerId===c.current&&(d.current={x:0,y:0},e(0,0),n(!1),i({x:0,y:0}),c.current=null,navigator.vibrate&&navigator.vibrate(5))};return window.addEventListener("pointermove",p,{passive:!1}),window.addEventListener("pointerup",h),window.addEventListener("pointercancel",h),()=>{window.removeEventListener("pointermove",p),window.removeEventListener("pointerup",h),window.removeEventListener("pointercancel",h)}},[r,u,e]),t.jsx("div",{ref:l,className:`w-36 h-36 rounded-full transition-all duration-200 relative flex items-center justify-center touch-none select-none ${r?"scale-110 shadow-[0_0_30px_rgba(34,211,238,0.1)]":"scale-100"} ${a?"pointer-events-auto":"pointer-events-none"}`,style:{touchAction:"none"},onPointerDown:f,children:t.jsxs("div",{className:`w-24 h-24 rounded-full border transition-all duration-500 flex items-center justify-center ${r?"bg-cyan-500/10 border-cyan-400":"bg-white/5 border-white/10"} ${a?"opacity-100":"opacity-0 scale-50"}`,children:[t.jsx("div",{className:`absolute -top-6 text-[8px] font-bold pointer-events-none transition-colors ${r?"text-cyan-400":"text-white/30"}`,children:o}),t.jsx("div",{className:"absolute inset-2 rounded-full border border-white/5 pointer-events-none"}),t.jsx("div",{className:`w-10 h-10 rounded-full border shadow-xl transition-transform duration-75 pointer-events-none ${r?"bg-cyan-400 border-white shadow-[0_0_20px_rgba(34,211,238,0.5)]":"bg-white/10 border-white/20"}`,style:{transform:`translate(${s.x}px, ${s.y}px)`}})]})})},Al=()=>{const{cameraMode:e,setCameraMode:o,debugMobileLayout:a}=E(),{isMobile:r}=Qa(),[n,s]=S.useState(!1);S.useEffect(()=>{s(r||a)},[a,r]);const i=S.useCallback((d,u)=>{window.dispatchEvent(new CustomEvent("joyMove",{detail:{x:d,y:u}}))},[]),l=S.useCallback((d,u)=>{window.dispatchEvent(new CustomEvent("joyLook",{detail:{x:d,y:u}}))},[]);if(!n)return null;const c=e==="Fly";return t.jsxs("div",{className:"absolute inset-0 pointer-events-none z-[100] flex flex-col justify-between p-6 pb-10",children:[t.jsx("div",{className:"flex justify-start pt-16",children:t.jsxs("button",{onClick:()=>{navigator.vibrate&&navigator.vibrate(20),o(c?"Orbit":"Fly")},className:"pointer-events-auto flex items-center gap-2 bg-black/80 border border-white/20 px-4 py-2.5 rounded-full backdrop-blur-xl shadow-2xl active:scale-90 transition-all active:border-cyan-400",children:[t.jsx("div",{className:`w-2 h-2 rounded-full ${c?"bg-cyan-400 animate-pulse shadow-[0_0_5px_cyan]":"bg-purple-400"}`}),t.jsxs("span",{className:"text-[10px] font-bold text-white",children:[e," Mode"]})]})}),t.jsxs("div",{className:"flex justify-between items-end transition-all duration-500",children:[t.jsx("div",{className:c?"pointer-events-auto":"pointer-events-none",children:t.jsx(Ro,{label:"Move",onMove:i,active:c})}),t.jsx("div",{className:c?"pointer-events-auto":"pointer-events-none",children:t.jsx(Ro,{label:"Look",onMove:l,active:c})})]})]})};class Nl{constructor(o){J(this,"ctx",null);J(this,"imageData",null);const a=o.getContext("2d",{alpha:!0});a&&(this.ctx=a)}render(o,a){if(!this.ctx)return;const r=this.ctx.canvas;(r.width!==r.clientWidth||r.height!==r.clientHeight)&&(r.width=r.clientWidth,r.height=r.clientHeight,this.imageData=null);const n=r.width,s=r.height;if(n===0||s===0)return;(!this.imageData||this.imageData.width!==n||this.imageData.height!==s)&&(this.imageData=this.ctx.createImageData(n,s));const i=this.imageData.data,l=o*.001,c=l*.5,d=Math.cos(c)*.7885,u=Math.sin(c)*.7885,f=1.5-.9*Math.pow(a,.5),p=(1-Math.pow(a,.2))*.5,h=Math.sin(p),x=Math.cos(p),z=(1-a)*.5,y=10+80*Math.pow(a,1.5),b=Math.min(Math.floor(y),90),g=1/s,m=n*.5,v=s*.5;for(let C=0;C<s;C++){const M=s-1-C,w=1/n;for(let j=0;j<n;j++){let k=(j-m)*g,P=(M-v)*g;k+=z,k*=f,P*=f;const I=x*k-h*P,_=h*k+x*P;let F=I,A=_,N=0;for(let q=0;q<b;q++){const L=F*F,$=A*A;if(L+$>4)break;A=2*F*A+u,F=L-$+d,N++}const R=(C*n+j)*4;if(N>=b)i[R]=0,i[R+1]=0,i[R+2]=0,i[R+3]=0;else{const q=F*F+A*A,X=3+(N-Math.log2(Math.log2(q))+4)/64*10;let H=.5+.5*Math.cos(X),V=.5+.5*Math.cos(X+.6),D=.5+.5*Math.cos(X+1);const T=j*w,O=.1*Math.sin(T*30-l*8)*a;H+=O,V+=O,D+=O,i[R]=Math.max(0,Math.min(255,H*255|0)),i[R+1]=Math.max(0,Math.min(255,V*255|0)),i[R+2]=Math.max(0,Math.min(255,D*255|0)),i[R+3]=255}}}this.ctx.putImageData(this.imageData,0,0)}dispose(){this.ctx=null,this.imageData=null}}ue();const Io=["Generative Math Tracer","GPU Manifold Tracer","GPU Mandelorus Tracer","Geometric Morphology Toolkit","GLSL Marching Toolkit","Generative Morphology Theater","Grand Mathematical Topography","Geometric Manifold Traversal","Gradient Mapped Topology","Generalized Mesh Tracer","Gravitational Manifold Theory","Glass Mountain Telescope","Ghost Manifold Terminal","Garden of Mathematical Terrain","Glimpse Machine Terminal","Grey Matter Telescope","Grotesque Math Theater","Geometry Mutation Terminal","Galactic Morphology Telescope","Grand Mythos Terminal","Glowing Mathematical Topologies","God's Math Toy","Gnarly Math Thing","Generally Mesmerizing Thingamajig","Give Me Tentacles","Gloriously Melted Teapots","Gaze-into Mathematical Twilight","Greenwich Mean Time","Geometrically Mangled Tesseracts","Gratuitous Mandelbulb Torture","Got More Tentacles","Groovy Morphing Thingamabob"],Bl=()=>Io[Math.floor(Math.random()*Io.length)],Fo=e=>`thumbnails/fractal_${e}.jpg`,Ol=({isReady:e,onFinished:o,startupMode:a,bootEngine:r})=>{var L;const n=S.useRef(null),s=S.useRef(null),i=S.useRef(!1),l=S.useRef(e),c=S.useRef(r),d=S.useRef(!1);S.useEffect(()=>{l.current=e},[e]),S.useEffect(()=>{c.current=r},[r]);const u=S.useRef(null),f=E($=>$.formula),p=E($=>$.setFormula),h=E($=>$.loadPreset),x=E($=>$.applyPreset),z=E($=>$.quality),y=(z==null?void 0:z.precisionMode)===1,[b,g]=S.useState(0),m=S.useRef(0),[v,C]=S.useState(1),[M,w]=S.useState(!0),[j,k]=S.useState(!1);S.useEffect(()=>{i.current=j},[j]);const[P,I]=S.useState(null),[_]=S.useState(Bl),F=()=>{d.current||(d.current=!0,c.current&&c.current())},A=$=>{const X=xe.get($);X&&X.defaultPreset&&h(X.defaultPreset),p($),k(!1),g(0),m.current=0,d.current&&c.current&&c.current(!0)},N=async $=>{var H;const X=(H=$.target.files)==null?void 0:H[0];if(X)try{let V="";if(X.type==="image/png"){const T=await ir(X,"FractalData");if(T)V=T;else throw new Error("No Fractal Data found in PNG.")}else V=await X.text();const D=JSON.parse(V);h(D),k(!1),g(0),m.current=0,d.current&&c.current&&c.current(!0)}catch(V){alert("Load failed: "+(V instanceof Error?V.message:String(V)))}},R=()=>{const $=y?"balanced":"lite";if(Z.emit("is_compiling",`Switching to ${$} mode...`),x){const X=E.getState();x({mode:$,actions:X})}},q=S.useMemo(()=>xe.getAll(),[]);return S.useEffect(()=>{if(!n.current)return;s.current=new Nl(n.current);let $=0,X=0,H=performance.now();const V=2500,D=T=>{const O=performance.now(),B=Math.min(O-H,60);H=O;const G=i.current;X<100&&(X+=B*(100/V)),X>100&&(X=100),Math.floor(X)>Math.floor(m.current)&&(m.current=X,g(X)),s.current&&s.current.render(T,X/100),X>=100&&!G?(F(),l.current?(s.current&&(s.current.dispose(),s.current=null),C(0),setTimeout(()=>{w(!1),o()},800)):$=requestAnimationFrame(D)):$=requestAnimationFrame(D)};return $=requestAnimationFrame(D),()=>{cancelAnimationFrame($),s.current&&(s.current.dispose(),s.current=null)}},[]),S.useEffect(()=>{F()},[]),M?t.jsxs("div",{className:"fixed inset-0 z-[100] flex flex-col items-center justify-center bg-black transition-opacity duration-1000",style:{opacity:v},children:[t.jsxs("div",{className:"text-center mb-10 relative animate-fade-in-up z-10",children:[t.jsxs("h1",{className:"text-7xl font-black text-white tracking-tighter drop-shadow-[0_0_15px_rgba(34,211,238,0.5)] mb-2",children:["G",t.jsx("span",{className:"text-cyan-400",children:"M"}),"T"]}),t.jsx("div",{className:"text-xs text-gray-400 font-mono uppercase tracking-[0.4em]",children:_})]}),t.jsxs("div",{className:"relative z-10 w-[500px] h-16 bg-gray-900/80 rounded-full border border-gray-700/50 overflow-hidden shadow-[0_0_50px_rgba(0,255,255,0.1)] backdrop-blur-sm",children:[t.jsx("div",{className:"absolute top-0 left-0 h-full overflow-hidden will-change-[width] transition-[width] duration-75 ease-linear",style:{width:`${b}%`},children:t.jsx("canvas",{ref:n,className:"absolute top-0 left-0 w-[500px] h-16"})}),t.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-white/5 to-transparent pointer-events-none"})]}),t.jsx("div",{className:"mt-6 font-mono text-sm text-cyan-500/80 z-20 flex flex-col items-center h-10",children:a==="url"?t.jsxs("span",{className:"animate-pulse",children:["LOADING SHARED SCENE... ",Math.floor(b),"%"]}):t.jsxs("div",{className:"relative flex flex-col items-center",children:[t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx("span",{className:"text-cyan-600/80",children:"LOADING"}),t.jsxs("button",{onClick:()=>k(!j),className:"flex items-center gap-1 text-cyan-400 hover:text-white transition-colors border-b border-dashed border-cyan-500/30 hover:border-cyan-400 pb-0.5 outline-none",children:[t.jsxs("span",{className:"font-bold",children:["[",f,"]"]}),t.jsx("span",{className:`text-[10px] transform transition-transform ${j?"rotate-180":""}`,children:t.jsx(Tt,{})})]}),t.jsxs("span",{className:"text-cyan-600/80",children:[Math.floor(b),"%"]})]}),t.jsx("button",{onClick:R,className:`mt-4 px-3 py-1.5 text-[9px] font-bold rounded border transition-all ${y?"bg-orange-900/40 text-orange-200 border-orange-500/40 hover:bg-orange-800/50":"bg-white/5 text-gray-500 border-white/5 hover:text-white hover:border-white/20"}`,children:y?"Lite Render Active":"Enable Lite Render"}),j&&t.jsxs("div",{className:"absolute bottom-full mb-4 w-[340px] bg-black/95 border border-white/20 rounded-xl shadow-[0_10px_60px_rgba(0,0,0,0.9)] backdrop-blur-xl animate-fade-in text-xs z-[110]",onMouseLeave:()=>I(null),children:[P&&P!=="Modular"&&t.jsxs("div",{className:"absolute left-[350px] bottom-0 w-[256px] h-[256px] bg-black border border-cyan-500/50 rounded-lg shadow-[0_0_50px_rgba(0,0,0,1)] overflow-hidden animate-fade-in pointer-events-none",children:[t.jsx("img",{src:Fo(P),className:"w-full h-full object-cover",alt:"Preview",onError:$=>{$.currentTarget.style.display="none"}}),t.jsx("div",{className:"absolute inset-0 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.1)_50%),linear-gradient(90deg,rgba(255,0,0,0.03),rgba(0,255,0,0.01),rgba(0,0,255,0.03))] bg-[length:100%_4px,4px_100%] pointer-events-none"}),t.jsx("div",{className:"absolute bottom-0 left-0 right-0 p-3 bg-black/60 text-cyan-300 font-bold text-[9px] border-t border-white/5",children:(L=xe.get(P))==null?void 0:L.name})]}),t.jsxs("div",{className:"p-1 max-h-[400px] overflow-y-auto custom-scroll",children:[t.jsxs("button",{onClick:()=>{var $;return($=u.current)==null?void 0:$.click()},className:"w-full flex items-center gap-2 px-3 py-2 text-left text-gray-300 hover:bg-white/10 hover:text-white rounded transition-colors mb-1 border-b border-white/10",children:[t.jsx(wr,{})," ",t.jsx("span",{className:"font-bold text-[10px]",children:"Load From File..."})]}),t.jsx("input",{type:"file",ref:u,className:"hidden",accept:".json,.png",onChange:N}),t.jsx("div",{className:"px-3 py-1.5 text-[9px] font-bold text-gray-500 bg-white/5 mb-1",children:"Select Engine"}),q.map($=>t.jsxs("button",{onClick:()=>A($.id),onMouseEnter:()=>I($.id),className:`w-full text-left px-3 py-2.5 transition-all flex gap-3 border-b border-white/5 last:border-b-0 ${$.id===f?"bg-cyan-900/30":"hover:bg-white/5"}`,children:[t.jsxs("div",{className:"w-16 h-10 shrink-0 bg-black rounded border border-white/10 overflow-hidden relative",children:[$.id!=="Modular"?t.jsx("img",{src:Fo($.id),alt:$.name,className:"w-full h-full object-cover",onError:X=>{X.currentTarget.style.display="none",X.currentTarget.nextElementSibling&&(X.currentTarget.nextElementSibling.style.display="flex")}}):null,t.jsx("div",{className:`w-full h-full items-center justify-center text-gray-700 bg-gray-900 ${$.id!=="Modular"?"hidden":"flex"}`,children:$.id==="Modular"?t.jsx(Cr,{}):t.jsx(pa,{})})]}),t.jsx("div",{className:"flex flex-col min-w-0",children:t.jsx("span",{className:`text-[11px] font-bold tracking-tight mb-0.5 ${$.id===f?"text-cyan-400":"text-gray-200"}`,children:$.name})})]},$.id))]})]})]})})]}):null},$l=(e,o)=>{const a=E,r=ce;S.useEffect(()=>{const n=s=>{const i=s.target,l=i.tagName==="INPUT"&&i.type==="range";if(i.tagName==="INPUT"&&!l||i.tagName==="TEXTAREA"||i.isContentEditable)return;const d=s.ctrlKey||s.metaKey,u=s.shiftKey;if(d&&!s.altKey){const f=a.getState().isTimelineHovered;if(s.code==="KeyZ"&&u){s.preventDefault(),s.stopPropagation(),a.getState().undoCamera();return}if(s.code==="KeyY"&&u){s.preventDefault(),s.stopPropagation(),a.getState().redoCamera();return}if(s.code==="KeyZ"&&!u){s.preventDefault(),s.stopPropagation(),f&&r.getState().undo()||a.getState().undoParam();return}if(s.code==="KeyY"&&!u){s.preventDefault(),s.stopPropagation(),f&&r.getState().redo()||a.getState().redoParam();return}}switch(s.code){case"Tab":s.preventDefault(),a.getState().setCameraMode(a.getState().cameraMode==="Fly"?"Orbit":"Fly");break;case"KeyT":d||o(y=>!y);break;case"Escape":a.getState().isBroadcastMode&&a.getState().setIsBroadcastMode(!1),a.getState().interactionMode!=="none"&&a.getState().setInteractionMode("none"),r.getState().deselectAll();break;case"KeyH":a.getState().setShowHints(!a.getState().showHints);break;case"Backquote":a.getState().setAdvancedMode(!a.getState().advancedMode);break;case"KeyB":if(!d){const y=a.getState();y.setIsBroadcastMode(!y.isBroadcastMode)}break;case"Space":const{cameraMode:f,isTimelineHovered:p}=a.getState(),{sequence:h,isPlaying:x}=r.getState();let z=!1;if(e)z=f!=="Fly"||p;else{const y=Object.keys(h.tracks).length>0;f!=="Fly"&&y&&(z=!0)}z&&(s.preventDefault(),x?r.getState().pause():r.getState().play());break}};return window.addEventListener("keydown",n,{capture:!0}),()=>window.removeEventListener("keydown",n,{capture:!0})},[e,o])},Hl=ue(),_o=({onUpdate:e,autoUpdate:o,trigger:a,source:r})=>{const n=S.useRef(a);return S.useEffect(()=>{let s=0,i=0;const l=()=>{const c=a!==n.current;c&&(n.current=a),i++,(o&&i%60===0||c)&&Hl.requestHistogramReadback(r).then(u=>{u.length>0&&e(u)}),s=requestAnimationFrame(l)};return l(),()=>cancelAnimationFrame(s)},[o,a,r,e]),null},Gl=({state:e,actions:o,isMobile:a,hudRefs:r})=>{var f;const n=S.useRef(null),s=S.useRef(null),i=e.tabSwitchCount,l=o.incrementTabSwitchCount;S.useEffect(()=>{const p=ce.subscribe(h=>h.isCameraInteracting,h=>{r.container.current&&(h?(r.container.current.style.opacity="1",s.current&&(clearTimeout(s.current),s.current=null)):(s.current&&clearTimeout(s.current),s.current=window.setTimeout(()=>{r.container.current&&(r.container.current.style.opacity="0")},2e3)))});return()=>{p(),s.current&&clearTimeout(s.current)}},[]),S.useEffect(()=>E.subscribe(h=>h.cameraMode,()=>l()),[l]);const c=p=>{if(!n.current||e.cameraMode==="Orbit")return;const h=n.current.getBoundingClientRect(),x=b=>{const g=Math.max(0,Math.min(1,(b-h.left)/h.width)),m=Math.pow(10,g*3-3);o.setNavigation({flySpeed:m}),(g===0||g===1)&&navigator.vibrate&&navigator.vibrate(5)};x(p.clientX);const z=b=>x(b.clientX),y=()=>{window.removeEventListener("pointermove",z),window.removeEventListener("pointerup",y)};window.addEventListener("pointermove",z),window.addEventListener("pointerup",y)},d=((f=e.navigation)==null?void 0:f.flySpeed)??.5,u=(Math.log10(d)+3)/3;return t.jsx("div",{ref:r.container,className:"absolute inset-0 pointer-events-none z-10 transition-opacity duration-500 opacity-0",children:t.jsxs("div",{className:"absolute inset-0 flex items-center justify-center",children:[t.jsx("div",{className:"absolute pointer-events-none opacity-20",children:e.cameraMode==="Fly"?t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40px] h-[1px] bg-cyan-400"}),t.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1px] h-[40px] bg-cyan-400"})]}):t.jsxs("div",{className:"relative flex items-center justify-center",children:[t.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[20px] h-[1px] bg-cyan-400"}),t.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1px] h-[20px] bg-cyan-400"}),t.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[24px] h-[24px] rounded-full border border-cyan-400 opacity-60"})]})}),t.jsxs("div",{ref:r.reticle,className:"absolute w-8 h-8 pointer-events-none opacity-0 transition-opacity duration-150 ease-out will-change-transform",children:[t.jsx("div",{className:"absolute inset-0 border-2 border-cyan-400 rounded-full shadow-[0_0_15px_cyan] opacity-80"}),t.jsx("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1 h-1 bg-white rounded-full"})]}),t.jsxs("div",{className:"absolute left-1/2 -translate-x-1/2 flex flex-col items-center pointer-events-none transition-all duration-300 ease-out",style:{bottom:e.showHints&&!a?"4rem":"3.5rem"},children:[t.jsx("button",{ref:r.reset,onClick:()=>{o.resetCamera(),navigator.vibrate&&navigator.vibrate(30)},className:"pointer-events-auto px-4 py-1.5 bg-black/60 hover:bg-cyan-900/80 text-cyan-400 hover:text-white text-[9px] font-bold rounded-t-lg border-x border-t border-white/10 backdrop-blur-md hidden animate-fade-in shadow-xl mb-[-1px]",children:"Reset Camera"}),t.jsxs("div",{className:"flex items-stretch gap-px bg-black/40 rounded-full border border-white/10 backdrop-blur-md overflow-hidden pointer-events-auto shadow-2xl",children:[e.cameraMode==="Fly"&&t.jsxs(t.Fragment,{children:[t.jsxs("div",{ref:n,onPointerDown:c,className:"relative flex items-center px-6 py-3 cursor-ew-resize group min-w-[120px]",children:[t.jsx("div",{className:"absolute inset-0 bg-cyan-500/10 border-r border-cyan-500/20 transition-all duration-300 ease-out",style:{width:`${u*100}%`}}),t.jsxs("span",{ref:r.speed,className:"relative z-10 font-bold text-cyan-300 font-mono text-[10px] group-hover:text-white transition-colors",children:["Spd x",d.toFixed(3)]})]}),t.jsx("div",{className:"w-px bg-white/5"})]}),t.jsx("div",{className:"px-6 py-3 bg-white/5 flex items-center min-w-[100px] justify-center",children:t.jsx("span",{ref:r.dist,className:"text-cyan-500/80 font-mono text-[10px]",children:"Dst ---"})})]}),e.showHints&&!a&&t.jsxs("div",{className:"mt-3 text-[9px] font-medium text-white/40 text-center animate-fade-in text-shadow-sm whitespace-nowrap",children:[t.jsxs("span",{className:"text-cyan-400/60 font-bold mr-2",children:["[",e.cameraMode,"]"]}),e.cameraMode==="Fly"?"WASD Move · Space/C Vert · Shift Boost":"L-Drag Rotate · R-Drag Pan · Scroll Zoom"]}),i<2&&!a&&e.showHints&&t.jsxs("div",{className:"mt-2 text-[10px] font-bold text-cyan-300 animate-pulse bg-cyan-950/40 px-3 py-1 rounded border border-cyan-500/30 shadow-lg",children:["Press ",t.jsx("span",{className:"text-white border border-white/20 rounded px-1 bg-white/10 mx-0.5",children:"Tab"})," for ",e.cameraMode==="Orbit"?"Fly":"Orbit"," navigation"]})]})]})})};class Do{constructor(o){J(this,"element");J(this,"sourceNode",null);J(this,"gainNode",null);J(this,"fileUrl",null);J(this,"fileName",null);J(this,"isActive",!1);this.element=new Audio,this.element.loop=!0,this.element.crossOrigin="anonymous"}get isPlaying(){return!this.element.paused&&!!this.sourceNode}load(o,a,r){this.fileUrl&&URL.revokeObjectURL(this.fileUrl),this.fileUrl=URL.createObjectURL(o),this.fileName=o.name,this.element.src=this.fileUrl,this.isActive=!0,this.sourceNode||(this.sourceNode=a.createMediaElementSource(this.element),this.gainNode=a.createGain(),this.sourceNode.connect(this.gainNode),this.gainNode.connect(r))}play(){this.element.play().catch(o=>console.warn("Deck play failed",o))}pause(){this.element.pause()}stop(){this.element.pause(),this.element.currentTime=0}seek(o){this.element.currentTime=o}setVolume(o){this.gainNode&&(this.gainNode.gain.value=o)}get duration(){return this.element.duration||0}get currentTime(){return this.element.currentTime||0}}class Vl{constructor(){J(this,"audioContext",null);J(this,"analyser",null);J(this,"micSource",null);J(this,"decks",[null,null]);J(this,"masterGain",null);J(this,"dataArray",null);J(this,"isMicActive",!1);J(this,"crossfade",.5)}init(){this.audioContext||(this.audioContext=new(window.AudioContext||window.webkitAudioContext),this.masterGain=this.audioContext.createGain(),this.masterGain.gain.value=.8,this.masterGain.connect(this.audioContext.destination),this.analyser=this.audioContext.createAnalyser(),this.analyser.fftSize=2048,this.analyser.smoothingTimeConstant=.8,this.dataArray=new Uint8Array(this.analyser.frequencyBinCount),this.masterGain.connect(this.analyser),this.decks[0]=new Do(this.audioContext),this.decks[1]=new Do(this.audioContext),this.setCrossfade(.5))}setSmoothing(o){this.analyser&&(this.analyser.smoothingTimeConstant=Math.max(0,Math.min(.99,o)))}async connectMicrophone(){if(this.init(),!(!this.audioContext||!this.masterGain)){this.decks.forEach(o=>o==null?void 0:o.pause());try{const o=await navigator.mediaDevices.getUserMedia({audio:!0});this.micSource&&this.micSource.disconnect(),this.micSource=this.audioContext.createMediaStreamSource(o),this.micSource.connect(this.analyser),this.isMicActive=!0,this.audioContext.state==="suspended"&&this.audioContext.resume()}catch(o){console.error("AudioEngine: Mic access denied",o),alert("Microphone access denied.")}}}async connectSystemAudio(){if(this.init(),!!this.audioContext)try{const o=await navigator.mediaDevices.getDisplayMedia({video:!0,audio:!0});if(o.getVideoTracks().forEach(a=>a.stop()),o.getAudioTracks().length===0)return;this.micSource&&this.micSource.disconnect(),this.micSource=this.audioContext.createMediaStreamSource(o),this.micSource.connect(this.analyser),this.micSource.connect(this.audioContext.destination),this.isMicActive=!0,this.audioContext.state==="suspended"&&this.audioContext.resume()}catch(o){console.error("AudioEngine: System audio capture failed",o),alert("System audio capture failed. Check browser permissions.")}}loadTrack(o,a){var r;this.init(),!(!this.audioContext||!this.masterGain)&&(this.micSource&&(this.micSource.disconnect(),this.micSource=null,this.isMicActive=!1),(r=this.decks[o])==null||r.load(a,this.audioContext,this.masterGain),this.setCrossfade(this.crossfade),this.audioContext.state==="suspended"&&this.audioContext.resume())}play(o){var a;(a=this.decks[o])==null||a.play()}pause(o){var a;(a=this.decks[o])==null||a.pause()}stop(o){var a;(a=this.decks[o])==null||a.stop()}deactivateDeck(o){const a=this.decks[o];a&&(a.stop(),a.isActive=!1)}seek(o,a){var r;(r=this.decks[o])==null||r.seek(a)}getTrackInfo(o){const a=this.decks[o];return{duration:(a==null?void 0:a.duration)||1,currentTime:(a==null?void 0:a.currentTime)||0,hasTrack:!!(a!=null&&a.sourceNode),fileName:(a==null?void 0:a.fileName)||null,isPlaying:(a==null?void 0:a.isPlaying)||!1,isActive:(a==null?void 0:a.isActive)||!1}}setCrossfade(o){this.crossfade=o;const a=Math.cos(o*.5*Math.PI),r=Math.cos((1-o)*.5*Math.PI);this.decks[0]&&this.decks[0].setVolume(a),this.decks[1]&&this.decks[1].setVolume(r)}setMasterGain(o){this.masterGain&&this.masterGain.gain.setTargetAtTime(o,this.audioContext.currentTime,.1)}update(){!this.analyser||!this.dataArray||this.analyser.getByteFrequencyData(this.dataArray)}getRawData(){return this.dataArray}}const _r=new Vl;class Ul{constructor(){J(this,"ruleValues",{});J(this,"lfoValues",{});J(this,"lfoStates",{});J(this,"outputValues",{});J(this,"lfoPrevOffsets",{});J(this,"offsets",{})}getRuleValue(o){return this.ruleValues[o]||0}updateOscillators(o,a,r){for(let n=0;n<o.length;n++){const s=o[n];if(!s.enabled)continue;const i=(a/s.period+s.phase)%1;let l=0;switch(s.shape){case"Sine":l=Math.sin(i*Math.PI*2);break;case"Triangle":l=1-Math.abs(i*2-1)*2;break;case"Sawtooth":l=i*2-1;break;case"Pulse":l=i<.5?1:-1;break;case"Noise":const p=s.id;this.lfoStates[p]||(this.lfoStates[p]=Math.random()),this.lfoStates[p]+=r*5,l=Math.sin(this.lfoStates[p])*Math.cos(this.lfoStates[p]*.73);break}const c=l*.5+.5;this.lfoValues[`lfo-${n+1}`]=c;const d=l*s.amplitude,u=this.lfoPrevOffsets[s.id]??d;let f=d;if(s.smoothing>.001){const p=50*Math.pow(1-s.smoothing,2)+.1,h=1-Math.exp(-p*r);f=u+(d-u)*h}this.lfoPrevOffsets[s.id]=f,this.offsets[s.target]=(this.offsets[s.target]||0)+f}}update(o,a){const r=_r.getRawData();for(const n of o){if(!n.enabled)continue;let s=0;n.source==="audio"?r&&(s=this.processAudioSignal(n,r)):n.source.startsWith("lfo-")&&(s=this.lfoValues[n.source]||0);const i=this.ruleValues[n.id]||0;let l=i;if(s>i){const u=1-Math.pow(n.attack,.2);l=i+(s-i)*u}else{const u=1-Math.pow(n.decay,.2);l=i+(s-i)*u}this.ruleValues[n.id]=l;let c=l;if(n.smoothing&&n.smoothing>.001){const u=this.outputValues[n.id]||0,f=1-Math.pow(n.smoothing,.5);c=u+(l-u)*f}this.outputValues[n.id]=c;const d=c*n.gain+n.offset;this.offsets[n.target]=(this.offsets[n.target]||0)+d}}resetOffsets(){this.offsets={}}processAudioSignal(o,a){const r=a.length,n=Math.floor(o.freqStart*r),s=Math.floor(o.freqEnd*r);if(n>=r||s<=n)return 0;let i=0,l=0;for(let f=n;f<s;f++)i+=a[f],l++;if(l===0)return 0;const c=i/l/255;if(c<o.thresholdMin)return 0;const d=Math.max(.001,o.thresholdMax-o.thresholdMin),u=(c-o.thresholdMin)/d;return Math.min(1,u)}}const Wt=new Ul,$e=ue(),Lo={current:new Set},Eo=new U,Ao=new yt,No=new Fi,qt={current:new U(-1e3,-1e3,-1e3)},$a={current:-1},at={current:{}},Wl=e=>{var F,A,N;const o=ce.getState(),a=E.getState(),n=Object.keys(o.sequence.tracks).length>0,s=a.animations.length>0,i=((A=(F=a.modulation)==null?void 0:F.rules)==null?void 0:A.length)>0,l=((N=a.audio)==null?void 0:N.isEnabled)??!1;if(!n&&!s&&!i&&!l)return;ta.tick(e);const c=a.modulation,d=a.audio;d&&d.isEnabled&&_r.update(),Wt.resetOffsets(),$e.modulations={};const u=a.animations;Wt.updateOscillators(u,performance.now()/1e3,e),c&&c.rules&&Wt.update(c.rules,e);const f=Wt.offsets,p={},h=new Set(Object.keys(f)),x=Lo.current,z=new Set;h.forEach(R=>z.add(R)),x.forEach(R=>z.add(R));let y=0,b=0,g=0,m=!1,v=0,C=0,M=0,w=!1;const j=Math.floor(o.currentFrame),k=ce.getState().isRecordingModulation,P=k&&j>$a.current;P&&($a.current=j);const I=[];if(k&&z.size>0&&ta.setOverriddenTracks(z),z.forEach(R=>{var D,T,O;const q=!h.has(R),L=q?0:f[R]??0;Math.abs(L)>1e-4&&(w=!0);let $=0,X="",H=!1;if(R.includes(".")){const[B,G]=R.split("."),Y=ne.get(B),W=a[B];if(Y&&W){const Q=G.match(/^(vec[23][ABC])_(x|y|z)$/);if(Q){const K=Q[1],re=Q[2],te=Y.params[K];if(te){const ae=W[K];ae&&typeof ae=="object"&&($=ae[re]||0),te.uniform&&(X=`${te.uniform}_${re}`),te.noReset&&(H=!0)}}else{const K=Y.params[G];K&&(typeof W[G]=="number"&&($=W[G]),K.uniform&&(X=K.uniform),K.noReset&&(H=!0))}}}else R==="iterations"?(X="uIterations",$=((D=a.coreMath)==null?void 0:D.iterations)??0):R.startsWith("param")&&(X="u"+R.charAt(0).toUpperCase()+R.slice(1),$=((T=a.coreMath)==null?void 0:T[R])??0);if(P&&Math.abs(L)>1e-6){let B=$;const G=o.recordingSnapshot;if(G&&G.tracks[R]){const Y=G.tracks[R],W=R.includes("rotation");B=Je(Y.keyframes,o.currentFrame,W)}else at.current[R]===void 0&&(at.current[R]=$),B=at.current[R];I.push({trackId:R,value:B+L}),$=B}if(R.startsWith("coloring.")){if(R==="coloring.repeats"){const B=a.coloring;if(B&&Math.abs(B.repeats)>.001){const G=P?$:B.repeats,Y=B.scale/G,W=(G+L)*Y;q||(p[R]=G+L),$e.setUniform("uColorScale",W)}return}if(R==="coloring.phase"){const B=a.coloring,G=P?$:B.phase;q||(p[R]=G+L),$e.setUniform("uColorOffset",B.offset+L);return}if(R==="coloring.repeats2"){const B=a.coloring;if(B&&Math.abs(B.repeats2)>.001){const G=P?$:B.repeats2,Y=B.scale2/G,W=(G+L)*Y;q||(p[R]=G+L),$e.setUniform("uColorScale2",W)}return}if(R==="coloring.phase2"){const B=a.coloring,G=P?$:B.phase2;q||(p[R]=G+L),$e.setUniform("uColorOffset2",B.offset2+L);return}}if(R.startsWith("julia.")||R.startsWith("geometry.julia")){const B=a.geometry,G=(B==null?void 0:B.juliaX)??0,Y=(B==null?void 0:B.juliaY)??0,W=(B==null?void 0:B.juliaZ)??0;R.endsWith("juliaX")||R.endsWith("x")?(y=G+L,p[R]=y,P&&I.push({trackId:"geometry.juliaX",value:y})):R.endsWith("juliaY")||R.endsWith("y")?(b=Y+L,p[R]=b,P&&I.push({trackId:"geometry.juliaY",value:b})):(R.endsWith("juliaZ")||R.endsWith("z"))&&(g=W+L,p[R]=g,P&&I.push({trackId:"geometry.juliaZ",value:g})),m=!0;return}if(R.startsWith("camera.")){R.startsWith("camera.unified")?R.endsWith("x")?$e.modulations["camera.unified.x"]=L:R.endsWith("y")?$e.modulations["camera.unified.y"]=L:R.endsWith("z")&&($e.modulations["camera.unified.z"]=L):R.startsWith("camera.rotation")&&(R.endsWith("x")?$e.modulations["camera.rotation.x"]=L:R.endsWith("y")?$e.modulations["camera.rotation.y"]=L:R.endsWith("z")&&($e.modulations["camera.rotation.z"]=L)),p[R]=L;return}if(R.startsWith("geometry.preRot")){R.endsWith("X")?(v=L,p[R]=L):R.endsWith("Y")?(C=L,p[R]=L):R.endsWith("Z")&&(M=L,p[R]=L);return}if(R.startsWith("lighting.light")){const B=R.match(/lighting\.light(\d+)_(\w+)/);if(B){const G=parseInt(B[1]),Y=B[2],W=(O=a.lighting)==null?void 0:O.lights;if(W&&W[G]){const Q=W[G];let K=0,re=!1;if(Y==="intensity"?(K=Q.intensity,re=!0):Y==="falloff"?(K=Q.falloff,re=!0):Y==="posX"?(K=Q.position.x,re=!0):Y==="posY"?(K=Q.position.y,re=!0):Y==="posZ"&&(K=Q.position.z,re=!0),re){if(P){let te=K;o.recordingSnapshot&&o.recordingSnapshot.tracks[R]?te=Je(o.recordingSnapshot.tracks[R].keyframes,o.currentFrame,!1):(at.current[R]===void 0&&(at.current[R]=K),te=at.current[R]),I.push({trackId:R,value:te+L}),p[R]=te+L}else p[R]=K+L;$e.modulations[R]=L}}}return}const V=R.match(/^(coreMath|geometry)\.(vec[23][ABC])_(x|y|z)$/);if(V){const B=V[1],G=V[2],Y=V[3],W=a[B];if(W&&W[G]){const Q=W[G],K=Q[Y]??0,re=K+L;if(P){let ie=K;o.recordingSnapshot&&o.recordingSnapshot.tracks[R]?ie=Je(o.recordingSnapshot.tracks[R].keyframes,o.currentFrame,!1):(at.current[R]===void 0&&(at.current[R]=K),ie=at.current[R]),I.push({trackId:R,value:ie+L}),p[R]=ie+L}else p[R]=re;const te="u"+G.charAt(0).toUpperCase()+G.slice(1),ae={...Q,[Y]:re};$e.setUniform(te,ae)}return}if(X){const B=$+L;q||(p[R]=B),$e.setUniform(X,B,H)}}),I.length>0&&o.batchAddKeyframes(j,I,"Linear"),m){const R=a.geometry;p["geometry.juliaX"]===void 0&&p["julia.x"]===void 0&&(y=(R==null?void 0:R.juliaX)??0),p["geometry.juliaY"]===void 0&&p["julia.y"]===void 0&&(b=(R==null?void 0:R.juliaY)??0),p["geometry.juliaZ"]===void 0&&p["julia.z"]===void 0&&(g=(R==null?void 0:R.juliaZ)??0),Eo.set(y,b,g),$e.setUniform("uJulia",Eo)}const _=a.geometry;if(_&&_.preRotMaster){const R=_.preRotX+v,q=_.preRotY+C,L=_.preRotZ+M;if(Math.abs(R-qt.current.x)>1e-6||Math.abs(q-qt.current.y)>1e-6||Math.abs(L-qt.current.z)>1e-6){const $=new yt().makeRotationX(R),X=new yt().makeRotationY(q),H=new yt().makeRotationZ(L);Ao.identity().multiply(H).multiply($).multiply(X),No.setFromMatrix4(Ao),$e.setUniform("uPreRotMatrix",No),qt.current.set(R,q,L),w=!0}}w&&$e.resetAccumulation(),(Object.keys(p).length>0||Object.keys(a.liveModulations).length>0)&&E.getState().setLiveModulations(p),Lo.current=h},ql=()=>{const e=ce(o=>o.isRecordingModulation);return S.useEffect(()=>{e?(at.current={},$a.current=-1):ta.setOverriddenTracks(new Set)},[e]),null},nt=ue(),Xl=e=>{const o=S.useRef(!1),a=S.useRef(new U),r=S.useRef(new U),n=S.useRef(!1),s=S.useRef(!1),i=S.useRef(null),l=S.useRef({x:0,y:0}),c=ce;S.useEffect(()=>{const d=p=>{const h=E.getState(),x=h.interactionMode;if(e.current){const z=e.current.getBoundingClientRect(),y=(p.clientX-z.left)/z.width*2-1,b=-((p.clientY-z.top)/z.height)*2+1;if(l.current={x:y,y:b},x==="picking_focus"){n.current=!0;let g=!1,m=!1,v=-1;const C=E.getState();C.focusLock&&C.setFocusLock(!1),nt.startFocusPick(y,b).then(w=>{n.current&&(g=!0,w>0&&w!==v&&(v=w,E.getState().setOptics({dofFocus:w})))});const M=()=>{n.current&&(g&&!m&&(m=!0,nt.sampleFocusPick(l.current.x,l.current.y).then(w=>{if(m=!1,!!n.current&&w>0&&w!==v){v=w,E.getState().setOptics({dofFocus:w});const{isRecording:j,isPlaying:k,addKeyframe:P,addTrack:I,currentFrame:_,sequence:F}=c.getState();if(j){const A="optics.dofFocus";F.tracks[A]||I(A,"Focus Distance"),P(A,_,w,k?"Linear":"Bezier")}}})),i.current=requestAnimationFrame(M))};i.current=requestAnimationFrame(M)}if(x==="picking_julia"){o.current=!0;const g=h.geometry;r.current.set(g.juliaX,g.juliaY,g.juliaZ),a.current.copy(r.current);const m=(M,w,j)=>{if(w==="MandelTerrain"){const k=j.coreMath,P=Math.pow(2,k.paramB);a.current.set(M.x*(2/P)+k.paramE,M.z*(2/P)+k.paramF,0)}else w==="JuliaMorph"?a.current.set(M.x,M.y,0):a.current.copy(M)};nt.pickWorldPosition(y,b,!0).then(M=>{M&&o.current&&m(M,h.formula,h)});let v=!1;const C=()=>{if(o.current){if(v||(v=!0,nt.pickWorldPosition(l.current.x,l.current.y,!0).then(M=>{if(v=!1,!!o.current&&M){const w=E.getState();m(M,w.formula,w)}})),r.current.lerp(a.current,.1),r.current.distanceToSquared(a.current)>1e-8){E.getState().setGeometry({juliaX:r.current.x,juliaY:r.current.y,juliaZ:r.current.z});const{isRecording:w,isPlaying:j,addKeyframe:k,addTrack:P,currentFrame:I,sequence:_}=c.getState();if(w){_.tracks["geometry.juliaX"]||P("geometry.juliaX","Julia X"),_.tracks["geometry.juliaY"]||P("geometry.juliaY","Julia Y"),_.tracks["geometry.juliaZ"]||P("geometry.juliaZ","Julia Z");const F=j?"Linear":"Bezier";k("geometry.juliaX",I,r.current.x,F),k("geometry.juliaY",I,r.current.y,F),k("geometry.juliaZ",I,r.current.z,F)}}i.current=requestAnimationFrame(C)}};i.current=requestAnimationFrame(C)}}},u=p=>{var h,x;if(e.current){const z=e.current.getBoundingClientRect(),y=(p.clientX-z.left)/z.width*2-1,b=-((p.clientY-z.top)/z.height)*2+1;(o.current||n.current)&&(l.current={x:y,y:b});const g=E.getState();if(g.draggedLightIndex!==null&&!nt.isGizmoInteracting){const m=Ne(),v=((x=(h=g.lighting)==null?void 0:h.lights)==null?void 0:x.findIndex(C=>C.id===g.draggedLightIndex))??-1;if(m&&v>=0){if(!s.current&&g.cameraMode==="Fly"){s.current=!0;const _=nt.sceneOffset,F={x:_.x,y:_.y,z:_.z,xL:(_.xL??0)+m.position.x,yL:(_.yL??0)+m.position.y,zL:(_.zL??0)+m.position.z};m.position.set(0,0,0),m.updateMatrixWorld(),g.setSceneOffset(F)}const C=new Wa;C.setFromCamera(new je(y,b),m);const M=Math.max(2e-4,Math.min(20,nt.lastMeasuredDistance*.5)),w=new U().copy(C.ray.direction).multiplyScalar(M).add(C.ray.origin),j=nt.sceneOffset,k={x:w.x+(j.x+j.xL),y:w.y+(j.y+j.yL),z:w.z+(j.z+j.zL)},P=g.lighting.lights[v],I={visible:!0,castShadow:!0,position:k};P.visible||(I.fixed=!1),g.updateLight({index:v,params:I}),g.lighting.shadows||g.setLighting({shadows:!0}),g.showLightGizmo||g.setShowLightGizmo(!0)}}}},f=()=>{s.current=!1;const p=E.getState();p.draggedLightIndex!==null&&p.setDraggedLight(null),o.current&&(o.current=!1,i.current&&cancelAnimationFrame(i.current),p.setInteractionMode("none"),navigator.vibrate&&navigator.vibrate(20)),n.current&&(n.current=!1,i.current&&cancelAnimationFrame(i.current),nt.endFocusPick(),p.setInteractionMode("none"),navigator.vibrate&&navigator.vibrate(20))};return window.addEventListener("pointerdown",d),window.addEventListener("pointermove",u),window.addEventListener("pointerup",f),()=>{window.removeEventListener("pointerdown",d),window.removeEventListener("pointermove",u),window.removeEventListener("pointerup",f),i.current&&cancelAnimationFrame(i.current)}},[e])},Yl=e=>{const{interactionMode:o,setInteractionMode:a,setRenderRegion:r,renderRegion:n}=E(),s=o==="selecting_region",[i,l]=S.useState(null),[c,d]=S.useState(null),[u,f]=S.useState(null),p=S.useRef(null),h=S.useRef(null),x=S.useRef(null),z=(y,b)=>({x:Math.max(0,Math.min(1,(y.clientX-b.left)/b.width)),y:Math.max(0,Math.min(1,(y.clientY-b.top)/b.height))});return S.useEffect(()=>{if(!e.current)return;const y=e.current,b=v=>{const C=v.target,M=y.getBoundingClientRect(),w=z(v,M);if(n&&!s){const j=C.dataset.handle;if(j||C.closest(".region-box")){v.stopPropagation(),p.current=j||"move",l({x:w.x,y:w.y}),h.current={...n},f({...n}),x.current={...n};return}}if(s){v.stopPropagation(),p.current="draw";const j=v.clientX-M.left,k=v.clientY-M.top;l({x:j,y:k}),d({x:j,y:k})}},g=v=>{if(!p.current)return;v.stopPropagation(),v.preventDefault();const C=y.getBoundingClientRect();if(p.current==="draw"){const M=Math.max(0,Math.min(C.width,v.clientX-C.left)),w=Math.max(0,Math.min(C.height,v.clientY-C.top));d({x:M,y:w})}else if(h.current&&i){const M=z(v,C),w=M.x-i.x,j=1-M.y-(1-i.y);let k={...h.current};const P=p.current;if(P==="move"){const _=k.maxX-k.minX,F=k.maxY-k.minY;k.minX+=w,k.maxX+=w,k.minY+=j,k.maxY+=j,k.minX<0&&(k.minX=0,k.maxX=_),k.maxX>1&&(k.maxX=1,k.minX=1-_),k.minY<0&&(k.minY=0,k.maxY=F),k.maxY>1&&(k.maxY=1,k.minY=1-F)}else P!=null&&P.includes("e")&&(k.maxX=Math.min(1,h.current.maxX+w)),P!=null&&P.includes("w")&&(k.minX=Math.max(0,h.current.minX+w)),P!=null&&P.includes("n")&&(k.maxY=Math.min(1,h.current.maxY+j)),P!=null&&P.includes("s")&&(k.minY=Math.max(0,h.current.minY+j));const I={minX:Math.min(k.minX,k.maxX),maxX:Math.max(k.minX,k.maxX),minY:Math.min(k.minY,k.maxY),maxY:Math.max(k.minY,k.maxY)};I.maxX-I.minX<.01&&(I.maxX=I.minX+.01),I.maxY-I.minY<.01&&(I.maxY=I.minY+.01),f(I),x.current=I}},m=v=>{if(p.current){if(v.stopPropagation(),p.current==="draw"&&i&&c){const C=y.getBoundingClientRect(),M=Math.min(i.x,c.x),w=Math.max(i.x,c.x),j=Math.min(i.y,c.y),k=Math.max(i.y,c.y),P=w-M,I=k-j;if(P>10&&I>10){const _=M/C.width,F=w/C.width,A=1-k/C.height,N=1-j/C.height;r({minX:_,minY:A,maxX:F,maxY:N})}a("none")}else x.current&&r(x.current);p.current=null,l(null),d(null),h.current=null,f(null),x.current=null}};return y.addEventListener("mousedown",b),window.addEventListener("mousemove",g),window.addEventListener("mouseup",m),()=>{y.removeEventListener("mousedown",b),window.removeEventListener("mousemove",g),window.removeEventListener("mouseup",m)}},[s,n,i,c,a,r,e]),{visualRegion:u,isGhostDragging:!!u,renderRegion:n,isSelectingRegion:s}},kt=ue(),le={lowFpsBuffer:0,lastTime:performance.now(),lastFrameCount:0,setShowWarning:null,setCurrentFps:null,isPaused:!1,isScrubbing:!1,isExporting:!1,isBroadcastMode:!1,renderMode:"PathTracing",frameTimestamps:[]},Zl=()=>{const e=performance.now();le.frameTimestamps.push(e);const o=e-2e3;if(le.frameTimestamps=le.frameTimestamps.filter(r=>r>o),e-le.lastTime>=500){let r=0;if(le.frameTimestamps.length>1){const l=le.frameTimestamps[0],d=le.frameTimestamps[le.frameTimestamps.length-1]-l;r=(le.frameTimestamps.length-1)/d*1e3}le.lastTime=e,le.lastFrameCount=kt.frameCount;const n=E.getState(),s=n.sampleCap>0&&kt.accumulationCount>=n.sampleCap;if(le.isPaused||le.isScrubbing||document.hidden||kt.isCompiling||le.isExporting||s)le.lowFpsBuffer=0;else if(e<8e3)le.lowFpsBuffer=0;else{le.setCurrentFps&&le.setCurrentFps(r);const l=le.renderMode==="PathTracing",c=l?10:15,d=l?22:30;r<c?le.lowFpsBuffer+=r<5?2:1:r>=d&&(le.lowFpsBuffer=Math.max(0,le.lowFpsBuffer-3),le.lowFpsBuffer===0&&le.setShowWarning&&le.setShowWarning(!1)),le.lowFpsBuffer>=5&&le.setShowWarning&&le.setShowWarning(!0)}}},Ql=()=>{const e=S.useRef(0);S.useRef(performance.now()),S.useRef(0);const{resolutionMode:o,setResolutionMode:a,setFixedResolution:r,fixedResolution:n,isExporting:s,isBroadcastMode:i,openContextMenu:l,aaLevel:c,setAALevel:d,renderMode:u,quality:f}=E(),p=E(A=>A.isPaused),h=ce(A=>A.isScrubbing),[x,z]=S.useState(!1),[y,b]=S.useState(60);S.useEffect(()=>(le.setShowWarning=z,le.setCurrentFps=b,le.isPaused=p,le.isScrubbing=h,le.isExporting=s,le.isBroadcastMode=i,le.renderMode=u,le.lastTime=performance.now(),le.lastFrameCount=kt.frameCount,()=>{le.setShowWarning===z&&(le.setShowWarning=null),le.setCurrentFps===b&&(le.setCurrentFps=null)}),[p,h,s,i,u]);const g=A=>{const N=Ee(A.currentTarget);N.length>0&&(A.preventDefault(),A.stopPropagation(),l(A.clientX,A.clientY,[],N))};if(i||!x)return null;let m=window.innerWidth,v=window.innerHeight;if(kt.renderer){const A=kt.renderer.domElement;m=A.width,v=A.height}else o==="Fixed"&&(m=n[0],v=n[1]);const C=m>480,M=()=>{const A=Math.max(320,Math.round(m*.66/8)*8),N=Math.max(240,Math.round(v*.66/8)*8);a("Fixed"),r(A,N),F()},w=c>1,j=()=>{d(1),F()},k=f,I=!((k==null?void 0:k.precisionMode)===1),_=()=>{const A=E.getState().setQuality,N=E.getState().setLighting;A&&A({precisionMode:1,bufferPrecision:1}),N&&N({shadows:!1}),F()},F=()=>{z(!1),e.current=-10};return t.jsx("div",{className:"absolute top-2 right-4 z-[50] pointer-events-auto animate-fade-in-left origin-top-right max-w-[200px]","data-help-id":"ui.performance",onContextMenu:g,children:t.jsxs("div",{className:"flex flex-col gap-1 bg-red-950/90 border border-red-500/30 rounded-lg shadow-xl backdrop-blur-md p-2",children:[t.jsxs("div",{className:"flex items-center justify-between mb-1",children:[t.jsxs("div",{className:"flex items-center gap-2 text-red-200 text-[10px] font-bold",children:[t.jsx(Rt,{}),t.jsxs("span",{children:["Low FPS (",y.toFixed(1),")"]})]}),t.jsx("button",{onClick:()=>{z(!1),e.current=-40},className:"text-red-400 hover:text-white transition-colors p-0.5",title:"Dismiss",children:t.jsx(Xa,{})})]}),t.jsxs("div",{className:"flex flex-col gap-1",children:[w&&t.jsxs("button",{onClick:j,className:"flex items-center justify-between bg-black/40 hover:bg-white/10 text-gray-300 text-[9px] px-2 py-1.5 rounded transition-colors border border-white/5",children:[t.jsxs("span",{className:"flex items-center gap-1.5",children:[t.jsx(Ya,{})," Reset Scale (1x)"]}),t.jsx("span",{className:"text-cyan-400 font-bold",children:"Fix"})]}),I&&t.jsxs("button",{onClick:_,className:"flex items-center justify-between bg-black/40 hover:bg-white/10 text-gray-300 text-[9px] px-2 py-1.5 rounded transition-colors border border-white/5",children:[t.jsxs("span",{className:"flex items-center gap-1.5",children:[t.jsx(pa,{})," Enable Lite Mode"]}),t.jsx("span",{className:"text-cyan-400 font-bold",children:"Fix"})]}),C&&t.jsxs("button",{onClick:M,className:"flex items-center justify-between bg-black/40 hover:bg-white/10 text-gray-300 text-[9px] px-2 py-1.5 rounded transition-colors border border-white/5",children:[t.jsxs("span",{className:"flex items-center gap-1.5",children:[t.jsx(pt,{})," Reduce Resolution"]}),t.jsx("span",{className:"text-cyan-400 font-bold",children:"-33%"})]})]})]})})},Kl=[{label:"Maximum",ratio:"Max"},{label:"Square (1:1)",ratio:1},{label:"Landscape (16:9)",ratio:1.7777},{label:"Portrait (4:5)",ratio:.8},{label:"Social (9:16)",ratio:.5625},{label:"Cinematic (2.35:1)",ratio:2.35},{label:"Classic (4:3)",ratio:1.3333},{label:"Skybox (2:1)",ratio:2}],Jl=({width:e,height:o,top:a,left:r,maxAvailableWidth:n,maxAvailableHeight:s,onSetResolution:i,onSetMode:l})=>{const[c,d]=S.useState(!1),u=S.useRef(null),f=S.useRef(null),p=E(g=>g.openContextMenu);S.useEffect(()=>{if(!c)return;const g=m=>{u.current&&!u.current.contains(m.target)&&d(!1)};return window.addEventListener("mousedown",g),()=>window.removeEventListener("mousedown",g)},[c]);const h=g=>{const m=Ee(g.currentTarget);m.length>0&&(g.preventDefault(),g.stopPropagation(),p(g.clientX,g.clientY,[],m))},x=g=>{g.preventDefault(),g.stopPropagation(),g.target.setPointerCapture(g.pointerId),f.current={startX:g.clientX,startY:g.clientY,startW:e,startH:o,hasMoved:!1}},z=g=>{if(!f.current)return;const m=f.current.startX-g.clientX,v=f.current.startY-g.clientY;(Math.abs(m)>3||Math.abs(v)>3)&&(f.current.hasMoved=!0);const C=Math.round(v/4),M=Math.round(m/20),j=(C+M)*8;if(j!==0){const k=f.current.startW/f.current.startH,P=Math.max(64,f.current.startW+j),I=Math.round(P/8)*8,_=I/k,F=Math.max(64,Math.round(_/8)*8);i(I,F)}},y=g=>{g.target.releasePointerCapture(g.pointerId),f.current&&!f.current.hasMoved&&d(m=>!m),f.current=null},b=g=>{const v=Math.max(100,n-40),C=Math.max(100,s-40);let M,w;g==="Max"?(M=v,w=C):v/C>g?(w=C,M=w*g):(M=v,w=M/g);const j=Math.round(M/8)*8,k=Math.round(w/8)*8;i(j,k),d(!1)};return t.jsxs("div",{className:"absolute flex items-center gap-2 z-50 transition-all duration-100 ease-out",style:{top:a,left:r},"data-help-id":"ui.resolution",onContextMenu:h,children:[t.jsxs("div",{className:"relative text-[10px] font-mono text-gray-400 bg-black/80 px-2 py-1 rounded border border-white/10 shadow-sm backdrop-blur-md cursor-ns-resize hover:text-white hover:border-cyan-500/50 transition-colors select-none flex items-center gap-2",onPointerDown:x,onPointerMove:z,onPointerUp:y,title:"Drag Up or Left to Increase Size",children:[t.jsxs("span",{children:[e," ",t.jsx("span",{className:"text-gray-600",children:"x"})," ",o]}),t.jsx("span",{className:"opacity-50",children:t.jsx(Tt,{})})]}),c&&t.jsxs("div",{ref:u,className:"absolute top-8 left-0 w-32 bg-black border border-white/20 rounded shadow-xl z-50 overflow-hidden flex flex-col py-1 animate-fade-in",children:[t.jsx("div",{className:"px-3 py-1 text-[8px] font-bold text-gray-500 border-b border-white/10 mb-1",children:"Fit to Window"}),Kl.map(g=>t.jsx("button",{onClick:()=>b(g.ratio),className:"text-left px-3 py-1.5 text-[10px] text-gray-300 hover:bg-white/10 hover:text-white transition-colors flex justify-between",children:t.jsx("span",{children:g.label})},g.label))]}),t.jsxs("button",{onClick:g=>{g.stopPropagation(),l("Full")},className:"flex items-center gap-1.5 text-[9px] font-bold text-gray-300 bg-black/80 px-2 py-1 rounded border border-white/10 hover:border-cyan-500/50 hover:text-cyan-400 hover:bg-cyan-900/30 transition-all shadow-sm backdrop-blur-md group",title:"Return to Fullscreen Mode",children:[t.jsx("span",{className:"w-2 h-2 border border-current rounded-sm group-hover:scale-110 transition-transform"}),"Fill"]})]})},ec=({width:e,height:o})=>{const a=E(c=>c.compositionOverlay),r=E(c=>c.compositionOverlaySettings);if(a==="none"||!a)return null;const{opacity:n,lineThickness:s,color:i}=r;let l=i;if(i.startsWith("#")){const c=lt(i);c&&(l=`rgba(${c.r},${c.g},${c.b},${n})`)}else i.startsWith("rgba")?l=i.replace(/rgba\(([^,]+),([^,]+),([^,]+),([^)]+)\)/,`rgba($1,$2,$3,${n})`):i.startsWith("rgb(")&&(l=i.replace(/rgb\(([^,]+),([^,]+),([^)]+)\)/,`rgba($1,$2,$3,${n})`));return t.jsxs("svg",{className:"absolute inset-0 pointer-events-none z-[15]",width:e,height:o,style:{mixBlendMode:"difference"},children:[a==="grid"&&t.jsx(tc,{width:e,height:o,strokeColor:l,lineThickness:s,divisionsX:r.gridDivisionsX,divisionsY:r.gridDivisionsY}),a==="thirds"&&t.jsx(ac,{width:e,height:o,strokeColor:l,lineThickness:s}),a==="golden"&&t.jsx(Dr,{width:e,height:o,strokeColor:l,lineThickness:s}),a==="spiral"&&t.jsx(oc,{width:e,height:o,strokeColor:l,lineThickness:s,rotation:r.spiralRotation,positionX:r.spiralPositionX,positionY:r.spiralPositionY,scale:r.spiralScale,ratio:r.spiralRatio}),a==="center"&&t.jsx(Bo,{width:e,height:o,strokeColor:l,lineThickness:s}),a==="diagonal"&&t.jsx(rc,{width:e,height:o,strokeColor:l,lineThickness:s}),a==="safearea"&&t.jsx(Oo,{width:e,height:o,strokeColor:l,lineThickness:s}),r.showCenterMark&&a!=="center"&&t.jsx(Bo,{width:e,height:o,strokeColor:l,lineThickness:s}),r.showSafeAreas&&a!=="safearea"&&t.jsx(Oo,{width:e,height:o,strokeColor:l,lineThickness:s*.5})]})},tc=({width:e,height:o,strokeColor:a,lineThickness:r,divisionsX:n=4,divisionsY:s=4})=>{const i=[];for(let l=1;l<n;l++){const c=e/n*l;i.push(t.jsx("line",{x1:c,y1:0,x2:c,y2:o,stroke:a,strokeWidth:r*.5},`v${l}`))}for(let l=1;l<s;l++){const c=o/s*l;i.push(t.jsx("line",{x1:0,y1:c,x2:e,y2:c,stroke:a,strokeWidth:r*.5},`h${l}`))}return t.jsx(t.Fragment,{children:i})},ac=({width:e,height:o,strokeColor:a,lineThickness:r})=>{const n=e/3,s=o/3;return t.jsxs(t.Fragment,{children:[t.jsx("line",{x1:n,y1:0,x2:n,y2:o,stroke:a,strokeWidth:r}),t.jsx("line",{x1:n*2,y1:0,x2:n*2,y2:o,stroke:a,strokeWidth:r}),t.jsx("line",{x1:0,y1:s,x2:e,y2:s,stroke:a,strokeWidth:r}),t.jsx("line",{x1:0,y1:s*2,x2:e,y2:s*2,stroke:a,strokeWidth:r}),t.jsx("circle",{cx:n,cy:s,r:r*3,fill:a}),t.jsx("circle",{cx:n*2,cy:s,r:r*3,fill:a}),t.jsx("circle",{cx:n,cy:s*2,r:r*3,fill:a}),t.jsx("circle",{cx:n*2,cy:s*2,r:r*3,fill:a})]})},Dr=({width:e,height:o,strokeColor:a,lineThickness:r})=>{const n=1.618033988749895,s=e/n,i=o/n;return t.jsxs(t.Fragment,{children:[t.jsx("line",{x1:s,y1:0,x2:s,y2:o,stroke:a,strokeWidth:r}),t.jsx("line",{x1:e-s,y1:0,x2:e-s,y2:o,stroke:a,strokeWidth:r}),t.jsx("line",{x1:0,y1:i,x2:e,y2:i,stroke:a,strokeWidth:r}),t.jsx("line",{x1:0,y1:o-i,x2:e,y2:o-i,stroke:a,strokeWidth:r}),t.jsx("circle",{cx:s,cy:i,r:r*3,fill:a}),t.jsx("circle",{cx:e-s,cy:i,r:r*3,fill:a}),t.jsx("circle",{cx:s,cy:o-i,r:r*3,fill:a}),t.jsx("circle",{cx:e-s,cy:o-i,r:r*3,fill:a})]})},oc=({width:e,height:o,strokeColor:a,lineThickness:r,rotation:n=0,positionX:s=.5,positionY:i=.5,scale:l=1,ratio:c=1.618033988749895})=>{const d=Math.min(e,o),u=e*s,f=o*i,p=d*.45*l,h=n*Math.PI/180,x=[],z=3,y=100;for(let b=0;b<=y;b++){const g=b/y*z*2*Math.PI,m=p*Math.pow(c,-g/(2*Math.PI)),v=u+m*Math.cos(g+h),C=f+m*Math.sin(g+h);x.push(`${b===0?"M":"L"} ${v} ${C}`)}return t.jsxs(t.Fragment,{children:[t.jsx("path",{d:x.join(" "),fill:"none",stroke:a,strokeWidth:r*1.5,strokeLinecap:"round"}),t.jsx(Dr,{width:e,height:o,strokeColor:a.replace(/[\d.]+\)$/,"0.2)"),lineThickness:r*.5})]})},Bo=({width:e,height:o,strokeColor:a,lineThickness:r})=>{const n=e/2,s=o/2,i=Math.min(e,o)*.05;return t.jsxs(t.Fragment,{children:[t.jsx("line",{x1:n-i,y1:s,x2:n+i,y2:s,stroke:a,strokeWidth:r}),t.jsx("line",{x1:n,y1:s-i,x2:n,y2:s+i,stroke:a,strokeWidth:r}),t.jsx("circle",{cx:n,cy:s,r:i*.3,fill:"none",stroke:a,strokeWidth:r})]})},rc=({width:e,height:o,strokeColor:a,lineThickness:r})=>t.jsxs(t.Fragment,{children:[t.jsx("line",{x1:0,y1:0,x2:e,y2:o,stroke:a,strokeWidth:r}),t.jsx("line",{x1:e,y1:0,x2:0,y2:o,stroke:a,strokeWidth:r}),t.jsx("line",{x1:e/2,y1:0,x2:e/2,y2:o,stroke:a,strokeWidth:r*.5,strokeDasharray:"4 4"}),t.jsx("line",{x1:0,y1:o/2,x2:e,y2:o/2,stroke:a,strokeWidth:r*.5,strokeDasharray:"4 4"})]}),Oo=({width:e,height:o,strokeColor:a,lineThickness:r})=>{const s=e*.05,i=o*.05,l=e*(1-.05*2),c=o*(1-.05*2),d=.1,u=e*d,f=o*d,p=e*(1-d*2),h=o*(1-d*2);return t.jsxs(t.Fragment,{children:[t.jsx("rect",{x:s,y:i,width:l,height:c,fill:"none",stroke:a,strokeWidth:r}),t.jsx("rect",{x:u,y:f,width:p,height:h,fill:"none",stroke:a,strokeWidth:r*.5,strokeDasharray:"4 4"}),[[s,i],[s+l,i],[s,i+c],[s+l,i+c]].map(([x,z],y)=>t.jsx("circle",{cx:x,cy:z,r:r*2,fill:a},y))]})},ic=(e,o,a,r)=>{const{gl:n}=ca(),s=E(g=>g.invertY),i=E(g=>g.debugMobileLayout),l=S.useRef({forward:!1,backward:!1,left:!1,right:!1,up:!1,down:!1,rollLeft:!1,rollRight:!1,boost:!1}),c=S.useRef(!1),d=S.useRef({x:0,y:0}),u=S.useRef({x:0,y:0}),f=S.useRef(0),p=S.useRef(0),h=S.useRef({x:0,y:0}),x=S.useRef({x:0,y:0}),z=S.useRef(o);S.useEffect(()=>{z.current=o},[o]);const y=()=>{f.current=performance.now()};return S.useEffect(()=>{h.current={x:0,y:0},x.current={x:0,y:0},p.current=0,y()},[e]),da((g,m)=>{const v=l.current.rollLeft?1:l.current.rollRight?-1:0,M=1-Math.exp(-(v!==0?1:3)*m),w=Math.max(.1,z.current);p.current+=(v*w-p.current)*M,v===0&&Math.abs(p.current)<.001&&(p.current=0)}),S.useEffect(()=>{const g=j=>{if(j.target.tagName==="INPUT"||j.target.tagName==="TEXTAREA"||((j.ctrlKey||j.metaKey)&&(j.key==="w"||j.code==="KeyW")&&j.preventDefault(),j.code==="Space"&&j.preventDefault(),j.key==="Alt"&&j.preventDefault(),E.getState().isTimelineHovered))return;let P=!0;switch(j.code){case"KeyW":l.current.forward=!0;break;case"KeyS":l.current.backward=!0;break;case"KeyA":l.current.left=!0;break;case"KeyD":l.current.right=!0;break;case"KeyQ":l.current.rollLeft=!0;break;case"KeyE":l.current.rollRight=!0;break;case"Space":l.current.up=!0;break;case"KeyC":l.current.down=!0;break;case"ShiftLeft":case"ShiftRight":l.current.boost=!0;break;default:P=!1}P&&y()},m=j=>{switch(j.key==="Alt"&&j.preventDefault(),j.code){case"KeyW":l.current.forward=!1;break;case"KeyS":l.current.backward=!1;break;case"KeyA":l.current.left=!1;break;case"KeyD":l.current.right=!1;break;case"KeyQ":l.current.rollLeft=!1;break;case"KeyE":l.current.rollRight=!1;break;case"Space":l.current.up=!1;break;case"KeyC":l.current.down=!1;break;case"ShiftLeft":case"ShiftRight":l.current.boost=!1;break}},v=j=>{const k=E.getState();if(Aa(k))return;if(k.optics&&Math.abs(k.optics.camType-1)<.1){const _=j.deltaY>0?1:-1,A=k.optics.orthoScale*(1+_*.1);k.setOptics({orthoScale:Math.max(1e-10,Math.min(1e3,A))}),y();return}if(e==="Fly"){const _=j.deltaY>0?-1:1;let F=z.current,A=.01;F<.05&&(A=.005),F>.1&&(A=.02);let N=Math.max(.001,Math.min(1,F+_*A));z.current=N,a(N),y()}else e==="Orbit"&&y()},C=()=>{l.current={forward:!1,backward:!1,left:!1,right:!1,up:!1,down:!1,rollLeft:!1,rollRight:!1,boost:!1}},M=j=>{h.current=j.detail,y()},w=j=>{x.current=j.detail,y()};return window.addEventListener("keydown",g),window.addEventListener("keyup",m),window.addEventListener("blur",C),window.addEventListener("joyMove",M),window.addEventListener("joyLook",w),n.domElement.addEventListener("wheel",v,{passive:!0}),()=>{window.removeEventListener("keydown",g),window.removeEventListener("keyup",m),window.removeEventListener("blur",C),window.removeEventListener("joyMove",M),window.removeEventListener("joyLook",w),n.domElement.removeEventListener("wheel",v)}},[e,n,a]),S.useEffect(()=>{const g=n.domElement,m=(w,j)=>{const k=g.getBoundingClientRect();return{x:(w-k.left)/k.width*2-1,y:-((j-k.top)/k.height)*2+1}},v=w=>{const j=E.getState();if(Aa(j))return;if(r){if(Object.values(r).some(I=>I.current&&I.current.contains(w.target)))return}else if(w.target.closest(".pointer-events-auto"))return;if(!((i||window.innerWidth<768||w.pointerType==="touch")&&e==="Fly")&&(y(),w.button===0&&e==="Fly")){c.current=!0;const{x:P,y:I}=m(w.clientX,w.clientY);d.current={x:P,y:I},u.current={x:P,y:I}}},C=w=>{if(c.current){const{x:j,y:k}=m(w.clientX,w.clientY);u.current={x:j,y:k},y()}else e==="Orbit"&&w.buttons>0&&(w.target===g||g.contains(w.target))&&y()},M=()=>c.current=!1;return g.addEventListener("mousedown",v),window.addEventListener("mousemove",C),window.addEventListener("mouseup",M),()=>{g.removeEventListener("mousedown",v),window.removeEventListener("mousemove",C),window.removeEventListener("mouseup",M)}},[e,n,i,r]),{moveState:l,isDraggingRef:c,dragStart:d,mousePos:u,speedRef:z,joystickMove:h,joystickLook:x,invertY:s,rollVelocity:p,isInteracting:()=>{const g=l.current,m=g.forward||g.backward||g.left||g.right||g.up||g.down||g.rollLeft||g.rollRight,v=Math.abs(h.current.x)>.01||Math.abs(h.current.y)>.01||Math.abs(x.current.x)>.01||Math.abs(x.current.y)>.01,C=performance.now()-f.current<200;return c.current||m||v||C}}},gt=ue(),nc=(e,o)=>{const{camera:a}=ca(),r=E(u=>u.quality),n=S.useRef(10),s=S.useRef(10),i=S.useRef(0);S.useRef(!1);const l=S.useRef(null),c=S.useRef(new Float32Array(4)),d=u=>{if(u<0||u>=1e3||!Number.isFinite(u)){n.current>0&&n.current,e.dist.current&&(e.dist.current.innerText="DST INF",e.dist.current.style.color="#888"),e.reset.current&&(e.reset.current.style.display="block");return}if(n.current=u,s.current=u,gt.lastMeasuredDistance=u,e.dist.current&&(e.dist.current.innerText=`DST ${u<.001?u.toExponential(2):u.toFixed(4)}`,e.dist.current.style.color=u<1?"#ff4444":"#00ffff"),e.reset.current){const f=u>100||u<.001;e.reset.current.style.display=f?"block":"none"}};return da(u=>{var y,b,g,m,v;if(i.current++,!gt.hasCompiledShader||i.current<15){e.dist.current&&i.current%10===0&&(e.dist.current.innerText=`DST ${n.current.toFixed(4)}`),e.speed.current&&i.current%10===0&&(e.speed.current.innerText=`SPD ${(o.current*100).toFixed(1)}%`);return}if(!r)return;if((r.physicsProbeMode??0)===2){const C=r.manualDistance;if(n.current=C,s.current=C,gt.lastMeasuredDistance=C,e.dist.current&&(e.dist.current.innerText=`DST ${C<.001?C.toExponential(2):C.toFixed(4)}`,e.dist.current.style.color=C<1?"#ff4444":"#00ffff"),e.reset.current){const M=C>100||C<.001;e.reset.current.style.display=M?"block":"none"}e.speed.current&&i.current%10===0&&(e.speed.current.innerText=`SPD ${(o.current*100).toFixed(1)}%`);return}const p=gt.renderer;if(!p){const C=gt.lastMeasuredDistance;if(C!==n.current){d(C);const M=E.getState();if(M.focusLock&&C>0&&C<1e3){const w=((y=M.optics)==null?void 0:y.dofFocus)??0;Math.abs(C-w)/Math.max(w,1e-4)>.01&&M.setOptics({dofFocus:C})}}e.speed.current&&i.current%10===0&&(e.speed.current.innerText=`SPD ${(o.current*100).toFixed(1)}%`);return}const h=(g=(b=gt.pipeline)==null?void 0:b.getPreviousRenderTarget)==null?void 0:g.call(b);if(!h){e.dist.current&&i.current%10===0&&(e.dist.current.innerText=`DST ${n.current.toFixed(4)}`),e.speed.current&&i.current%10===0&&(e.speed.current.innerText=`SPD ${(o.current*100).toFixed(1)}%`);return}const x=h.width||1,z=h.height||1;if(x<=0||z<=0){e.dist.current&&i.current%10===0&&(e.dist.current.innerText=`DST ${n.current.toFixed(4)}`),e.speed.current&&i.current%10===0&&(e.speed.current.innerText=`SPD ${(o.current*100).toFixed(1)}%`);return}(!l.current||l.current.length!==64)&&(l.current=new Float32Array(64));try{const C=Math.floor(x/2),M=Math.floor(z/2),j=Math.floor(3/2);let k=0,P=0;for(let I=-j;I<=j;I++){for(let _=-j;_<=j;_++){const F=C+I,A=M+_;if(F>=0&&F<x&&A>=0&&A<z&&((v=(m=gt.pipeline)==null?void 0:m.readPixels)==null?void 0:v.call(m,p,F,A,1,1,c.current))){const R=c.current[3];R>0&&R<1e3&&Number.isFinite(R)&&(k+=R,P++)}}if(P>0){const _=k/P;d(_)}}if(P>0){const I=k/P;if(I>=1e3){const _=n.current>0?n.current:10;e.dist.current&&(e.dist.current.innerText="DST INF",e.dist.current.style.color="#888"),e.reset.current&&(e.reset.current.style.display="block")}else d(I)}}catch(C){console.warn("Depth readback failed:",C)}e.speed.current&&i.current%10===0&&(e.speed.current.innerText=`SPD ${(o.current*100).toFixed(1)}%`)}),{distAverageRef:n,distMinRef:s}};class sc{constructor(){J(this,"currentRotVelocity",new U);J(this,"rollVelocity",0);J(this,"smoothedDistEstimate",10);J(this,"ROTATION_SMOOTHING",20);J(this,"ROLL_SMOOTHING",3);J(this,"SENSITIVITY",2.5);J(this,"DIST_INCREASE_LERP_RATE",2)}reset(){this.currentRotVelocity.set(0,0,0),this.rollVelocity=0,this.smoothedDistEstimate=10}applyCurve(o){return Math.sign(o)*Math.pow(Math.abs(o),2)}update(o,a,r,n){let s=!1;const i=n.distEstimate,l=Math.min(a,.1);if(i>this.smoothedDistEstimate){const C=1-Math.exp(-this.DIST_INCREASE_LERP_RATE*l);this.smoothedDistEstimate+=(i-this.smoothedDistEstimate)*C}else this.smoothedDistEstimate=i;const c=this.smoothedDistEstimate,d=r.move.boost?4:1,u=n.autoSlow?Math.max(c*n.baseSpeed*d,1e-6):2*n.baseSpeed*d,f=new U(0,0,0);if(r.move.forward&&(f.z-=1),r.move.backward&&(f.z+=1),r.move.left&&(f.x-=1),r.move.right&&(f.x+=1),r.move.up&&(f.y+=1),r.move.down&&(f.y-=1),(Math.abs(r.moveJoy.x)>.01||Math.abs(r.moveJoy.y)>.01)&&(f.z-=this.applyCurve(r.moveJoy.y),f.x+=this.applyCurve(r.moveJoy.x)),f.lengthSq()>0){f.normalize().multiplyScalar(u*l);const C=f.clone().applyQuaternion(o.quaternion);Z.emit("offset_shift",{x:C.x,y:C.y,z:C.z}),s=!0}const h=r.move.rollLeft?1:r.move.rollRight?-1:0,x=h!==0?1:this.ROLL_SMOOTHING,z=1-Math.exp(-x*a),y=Math.max(.1,n.baseSpeed);this.rollVelocity+=(h*y-this.rollVelocity)*z,h===0&&Math.abs(this.rollVelocity)<.001&&(this.rollVelocity=0);const b=new U(0,0,0),g=r.invertY?-1:1,m=Math.abs(r.look.x)>.01||Math.abs(r.look.y)>.01;r.isDragging?(b.y=-r.dragDelta.x*2,b.x=r.dragDelta.y*2*g):m&&(b.y=-this.applyCurve(r.look.x)*.66,b.x=this.applyCurve(r.look.y)*.66*g),b.z=this.rollVelocity*.62;const v=1-Math.exp(-this.ROTATION_SMOOTHING*l);if(this.currentRotVelocity.lerp(b,v),this.currentRotVelocity.lengthSq()<1e-6&&this.currentRotVelocity.set(0,0,0),this.currentRotVelocity.lengthSq()>1e-8){const C=this.currentRotVelocity;o.rotateX(C.x*l*this.SENSITIVITY),o.rotateY(C.y*l*this.SENSITIVITY),o.rotateZ(C.z*l*this.SENSITIVITY),s=!0}return s}}const He=ue(),lc=({mode:e,onStart:o,onEnd:a,hudRefs:r,setSceneOffset:n,fitScale:s=1})=>{const{camera:i,gl:l}=ca(),c=S.useRef(null),d=E(Aa),u=E(ee=>ee.optics),f=u&&Math.abs(u.camType-1)<.1,p=E(ee=>ee.navigation),h=E(ee=>ee.setNavigation),x=ce(ee=>ee.setIsCameraInteracting),[z,y]=S.useState(new U(0,0,0)),[b,g]=S.useState(e==="Orbit"),[m,v]=S.useState(0),C=S.useRef(new sc),M=S.useRef(new U),w=S.useRef(new Te),j=S.useRef(new U),k=S.useRef(new U);S.useRef(0);const{moveState:P,isDraggingRef:I,dragStart:_,mousePos:F,speedRef:A,joystickMove:N,joystickLook:R,invertY:q,rollVelocity:L,isInteracting:$}=ic(e,(p==null?void 0:p.flySpeed)??.5,ee=>h({flySpeed:ee}),r),{distAverageRef:X}=nc(r,A),H=(ee,be=!1)=>{i.updateMatrixWorld();const De=new U(0,1,0).applyQuaternion(i.quaternion);i.up.copy(De);let Re=ee||He.lastMeasuredDistance;(Re<=1e-7||Re>=1e3)&&(Re=E.getState().targetDistance||3.5);const Ie=new U(0,0,-1).applyQuaternion(i.quaternion),ct=new U().copy(i.position).addScaledVector(Ie,Re);y(ct.clone()),be?v(dt=>dt+1):c.current&&(c.current.target.copy(ct),c.current.update()),g(!0)};S.useEffect(()=>{const ee=E.getState();i.position.set(ee.cameraPos.x,ee.cameraPos.y,ee.cameraPos.z),i.quaternion.set(ee.cameraRot.x,ee.cameraRot.y,ee.cameraRot.z,ee.cameraRot.w),i.updateMatrixWorld(),M.current.copy(i.position),w.current.copy(i.quaternion),ee.targetDistance&&(X.current=ee.targetDistance),e==="Orbit"&&H(ee.targetDistance,!0)},[]),S.useEffect(()=>{const ee=Ie=>{i.position.set(Ie.position.x,Ie.position.y,Ie.position.z),i.quaternion.set(Ie.rotation.x,Ie.rotation.y,Ie.rotation.z,Ie.rotation.w),i.updateMatrixWorld(),j.current.set(0,0,0),k.current.set(0,0,0),C.current.reset(),M.current.copy(i.position),w.current.copy(i.quaternion),Ie.targetDistance&&Ie.targetDistance>.001&&(X.current=Ie.targetDistance,He.lastMeasuredDistance=Ie.targetDistance),Ie.sceneOffset&&(n(Ie.sceneOffset),He.shouldSnapCamera=!0,He.dirty=!0),e==="Orbit"&&!re.current&&H(Ie.targetDistance,!1)},be=()=>{},De=Z.on("camera_teleport",ee),Re=Z.on("reset_accum",be);return()=>{De(),Re()}},[e,i]);const V=ce(ee=>ee.isPlaying),D=ce(ee=>ee.isScrubbing),T=ce(ee=>ee.isRecording),O=ce(ee=>ee.recordCamera),B=ce(ee=>ee.currentFrame),G=ce(ee=>ee.sequence),Y=ce(ee=>ee.captureCameraFrame),W=S.useRef(!1),Q=S.useRef(null),K=S.useRef(e),re=S.useRef(!1),te=S.useRef(!1),ae=S.useRef(null),ie=S.useRef(V),he=S.useRef(D),fe=S.useRef(1),ye=S.useRef(!1),Ce=S.useRef(!1);S.useEffect(()=>{const ee=l.domElement,be=()=>{te.current=!0,ae.current&&clearTimeout(ae.current),ae.current=setTimeout(()=>{te.current=!1},100)};return ee.addEventListener("wheel",be,{passive:!0}),()=>{ee.removeEventListener("wheel",be),ae.current&&clearTimeout(ae.current)}},[l]),S.useEffect(()=>{if(e!=="Orbit")return;const ee=l.domElement,be=Re=>{if(Re.target.closest(".pointer-events-auto")){Ce.current=!1;return}Ce.current=!0,c.current&&(c.current.enabled=!0)},De=()=>{Ce.current=!1};return ee.addEventListener("pointerdown",be,{capture:!0}),window.addEventListener("pointerup",De),()=>{ee.removeEventListener("pointerdown",be,{capture:!0}),window.removeEventListener("pointerup",De)}},[e,l]);const Ge=V&&(!T||!O)&&Object.keys(G.tracks).some(ee=>ee.startsWith("camera."))||D;return ye.current=Ge,S.useEffect(()=>{Ge?g(!1):e==="Orbit"&&!b&&H(void 0,!0)},[Ge,e]),S.useLayoutEffect(()=>{if(K.current!==e){if(Z.emit("camera_snap",void 0),e==="Fly"){const ee=He.sceneOffset,be={x:ee.x,y:ee.y,z:ee.z,xL:(ee.xL??0)+i.position.x,yL:(ee.yL??0)+i.position.y,zL:(ee.zL??0)+i.position.z};i.position.set(0,0,0),i.updateMatrixWorld(),n(be),Z.emit("camera_snap",void 0),M.current.set(0,0,0),j.current.set(0,0,0),k.current.set(0,0,0),C.current.reset(),g(!1);const De=He.lastMeasuredDistance;De>.001&&(X.current=De)}else e==="Orbit"&&H(void 0,!0);K.current=e}},[e,i]),da((ee,be)=>{const De=ie.current&&!V,Re=he.current&&!D;if(De||Re){if(Z.emit("camera_snap",void 0),e==="Orbit")H(void 0,!1);else if(e==="Fly"){const Fe=He.sceneOffset,ut={x:Fe.x,y:Fe.y,z:Fe.z,xL:(Fe.xL??0)+i.position.x,yL:(Fe.yL??0)+i.position.y,zL:(Fe.zL??0)+i.position.z};i.position.set(0,0,0),i.updateMatrixWorld(),n(ut)}}if(ie.current=V,he.current=D,Ge){c.current&&(c.current.enabled=!1),x&&x(!1),He.isCameraInteracting=!1;return}e==="Orbit"&&!b&&H(void 0,!0);const Ie=i.position.distanceToSquared(M.current)>1e-12,ct=i.quaternion.angleTo(w.current)>1e-11,dt=$()||re.current||te.current;if(x&&x(dt),He.isCameraInteracting=dt,dt&&(Ie||ct)){if(He.dirty=!0,!W.current&&o){W.current=!0;const Fe=He.virtualSpace?He.virtualSpace.getUnifiedCameraState(i,He.lastMeasuredDistance):{position:{x:i.position.x,y:i.position.y,z:i.position.z},rotation:{x:i.quaternion.x,y:i.quaternion.y,z:i.quaternion.z,w:i.quaternion.w},sceneOffset:{...He.sceneOffset},targetDistance:He.lastMeasuredDistance};o(Fe)}T&&O&&Y(B,!0,V?"Linear":"Bezier")}if((Ie||ct||dt)&&(Q.current&&clearTimeout(Q.current),Q.current=setTimeout(()=>{if(W.current=!1,a&&a(),E.getState().isUserInteracting)return;let Fe=He.lastMeasuredDistance;if((Fe<=0||Fe>=1e3)&&(Fe=E.getState().targetDistance||3.5),e==="Orbit"){const ut=i.position.length();ut>1e-4&&(Fe=ut)}E.setState({cameraPos:{x:i.position.x,y:i.position.y,z:i.position.z},cameraRot:{x:i.quaternion.x,y:i.quaternion.y,z:i.quaternion.z,w:i.quaternion.w},sceneOffset:He.sceneOffset,targetDistance:Fe})},100),M.current.copy(i.position),w.current.copy(i.quaternion)),e==="Fly"){if(d)return;const Fe=I.current?F.current.x-_.current.x:0,ut=I.current?F.current.y-_.current.y:0;C.current.update(i,be,{move:P.current,look:R.current,moveJoy:N.current,isDragging:I.current,dragDelta:{x:Fe,y:ut},invertY:q},{baseSpeed:A.current,distEstimate:X.current,autoSlow:(p==null?void 0:p.autoSlow)??!0})}else if(e==="Orbit"&&c.current&&(c.current.enabled=!d&&!ye.current&&(Ce.current||re.current||te.current),c.current.zoomSpeed=fe.current,c.current.rotateSpeed=1/(s||1),Math.abs(L.current)>.01)){const Fe=new U;i.getWorldDirection(Fe),i.up.applyAxisAngle(Fe,-L.current*2*be).normalize(),c.current.update()}}),e!=="Orbit"||!b||Ge?null:t.jsx(ji,{ref:c,enabled:!d,makeDefault:!0,enableDamping:!1,target:z,enableZoom:!f,mouseButtons:{LEFT:xa.ROTATE,MIDDLE:xa.DOLLY,RIGHT:xa.PAN},touches:{ONE:eo.ROTATE,TWO:eo.DOLLY_PAN},onStart:()=>{if(re.current=!0,c.current){const ee=X.current>0?X.current:E.getState().targetDistance||3.5,be=new U(0,0,-1).applyQuaternion(i.quaternion),De=new U().copy(i.position).addScaledVector(be,ee);c.current.target.copy(De),c.current.update(),c.current.saveState();const Re=i.position.distanceTo(De);Re>1e-8&&(fe.current=Math.max(.001,ee/Re*1.25))}},onEnd:()=>{re.current=!1}},`orbit-controls-${m}`)},cc=ue(),dc=()=>{const[e,o]=S.useState(!1),[a,r]=S.useState(0),n=S.useRef(0),s=S.useRef(0),i=S.useRef(15e3);S.useEffect(()=>{cc.isCompiling&&o(!0);const h=y=>{o(y)},x=Z.on("is_compiling",h),z=Z.on("compile_estimate",y=>{i.current=Math.max(2e3,y)});return()=>{x(),z()}},[]),S.useEffect(()=>{if(e){s.current=performance.now(),r(0);const h=i.current,x=()=>{const y=(performance.now()-s.current)/h,b=Math.min(95,95*(1-Math.exp(-3*y)));r(b),n.current=requestAnimationFrame(x)};n.current=requestAnimationFrame(x)}else a>0&&(cancelAnimationFrame(n.current),r(100));return()=>cancelAnimationFrame(n.current)},[!!e]);const l=!!e||a>=100,[c,d]=S.useState(!1);S.useEffect(()=>{if(a>=100&&!e){const h=setTimeout(()=>d(!0),800),x=setTimeout(()=>{d(!1),r(0)},1400);return()=>{clearTimeout(h),clearTimeout(x)}}},[a>=100&&!e]);const u=typeof e=="string"?e:"Compiling Shader...",f=typeof e=="string"&&e.includes("Lighting"),p=l&&!c;return t.jsx("div",{className:`fixed top-16 left-1/2 -translate-x-1/2 z-[99999] pointer-events-none transition-opacity duration-500 ${p?f?"opacity-60":"opacity-100":"opacity-0"}`,children:t.jsxs("div",{className:"bg-black/80 backdrop-blur-sm border border-white/10 px-3 py-1.5 rounded-full flex flex-col items-center gap-1.5 shadow-lg min-w-[200px]",children:[t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx(Mr,{className:`animate-spin h-3 w-3 ${f?"text-amber-400":"text-cyan-400"}`}),t.jsx("span",{className:`text-[9px] font-bold ${f?"text-amber-200":"text-cyan-200"}`,children:u}),t.jsxs("span",{className:"text-[9px] font-mono text-gray-500",children:[Math.floor(a),"%"]})]}),t.jsx("div",{className:"w-full h-1 bg-white/5 rounded-full overflow-hidden",children:t.jsx("div",{className:`h-full rounded-full transition-[width] duration-150 ease-linear ${a>=100?"bg-green-400":f?"bg-amber-400/60":"bg-cyan-400/60"}`,style:{width:`${a}%`}})})]})})},It={SNAPSHOT:0,ANIMATE:1,OVERLAY:2,UI:3},xt=[];let Ha=!1;function Ft(e,o,a){if(xt.some(n=>n.name===e))return()=>{};const r={name:e,phase:o,fn:a};return xt.push(r),Ha=!0,()=>{const n=xt.indexOf(r);n>=0&&xt.splice(n,1)}}function $o(e){Ha&&(xt.sort((o,a)=>o.phase-a.phase),Ha=!1);for(let o=0;o<xt.length;o++)xt[o].fn(e)}const uc=.15,fc=.4,Be={X:"#ff4444",Y:"#44ff44",Z:"#4444ff",Hover:"#ffffff",PlaneXY:"#4444ff",PlaneXZ:"#44ff44",PlaneYZ:"#ff4444"},Ke=new U,Bt=new U,Ho=(e,o,a)=>(Ke.set(e.position.x,e.position.y,e.position.z),e.fixed?Ke.applyQuaternion(o.quaternion).add(o.position):Ke.sub({x:a.x+a.xL,y:a.y+a.yL,z:a.z+a.zL}),Ke.clone()),pc=(e,o,a,r)=>{o.updateMatrixWorld();const n=o.matrixWorldInverse;if(Bt.copy(e).applyMatrix4(n),Bt.z>-5e-5)return null;Ke.copy(e).project(o);const s=a/2,i=r/2,l=Ke.x*s+s,c=-(Ke.y*i)+i;return Math.abs(l)>5e4||Math.abs(c)>5e4?null:{x:l,y:c,z:Bt.z,isBehindCamera:!1}},ja=(e,o,a,r,n,s,i,l)=>{const c=e.clone().add(o.clone().multiplyScalar(a));if(Bt.copy(c).applyMatrix4(n),Bt.z>-5e-5)return null;Ke.copy(c).project(r),Ke.x*i/2,-(Ke.y*l/2);const d=Ke.x*i/2+i/2,u=-(Ke.y*l/2)+l/2;return{x:d-s.x,y:u-s.y}},Pa=ue(),hc=ze.forwardRef((e,o)=>{const{index:a,light:r,onDragStart:n}=e,s=S.useRef(null),[i,l]=S.useState(null),c=E(y=>y.updateLight),{handleInteractionStart:d,handleInteractionEnd:u}=E(),f=E(y=>{var b,g,m;return((m=(g=(b=y.lighting)==null?void 0:b.lights)==null?void 0:g[a])==null?void 0:m.fixed)??r.fixed}),p=y=>l({part:y}),h=()=>l(null),x=()=>{var v,C;const y=(C=(v=E.getState().lighting)==null?void 0:v.lights)==null?void 0:C[a];if(!y)return;const b=y.fixed;let g=y.position;const m=Ne();if(m){const M=Pa.sceneOffset;if(b){const w=new U(g.x,g.y,g.z);w.applyQuaternion(m.quaternion),w.add(m.position),g={x:w.x+M.x+(M.xL??0),y:w.y+M.y+(M.yL??0),z:w.z+M.z+(M.zL??0)}}else{const w=new U(g.x-M.x-(M.xL??0),g.y-M.y-(M.yL??0),g.z-M.z-(M.zL??0));w.sub(m.position),w.applyQuaternion(m.quaternion.clone().invert()),g={x:w.x,y:w.y,z:w.z}}}d("param"),c({index:a,params:{fixed:!b,position:g}}),u()};ze.useImperativeHandle(o,()=>({hide:()=>{s.current&&(s.current.style.display="none")},update:()=>{var H,V;const y=((V=(H=E.getState().lighting)==null?void 0:H.lights)==null?void 0:V[a])??r,b=bs(),g=ea(),m=s.current;if(!b||!g||!m)return;const v=g.getBoundingClientRect(),C=v.width,M=v.height,w=Pa.sceneOffset,j=Ho(y,b,w),k=pc(j,b,C,M);if(!k){m.style.display="none";return}m.style.display="flex",m.style.transform=`translate3d(${k.x}px, ${k.y}px, 0)`;const I=j.distanceTo(b.position)*uc,_=b.matrixWorldInverse,F=new U(1,0,0),A=new U(0,1,0),N=new U(0,0,1);y.fixed&&(F.applyQuaternion(b.quaternion),A.applyQuaternion(b.quaternion),N.applyQuaternion(b.quaternion));const R=ja(j,F,I,b,_,k,C,M),q=ja(j,A,I,b,_,k,C,M),L=ja(j,N,I,b,_,k,C,M),$=(D,T)=>{m.querySelectorAll(`.${D}`).forEach(B=>{T?(B.setAttribute("x2",String(T.x)),B.setAttribute("y2",String(T.y)),B.setAttribute("visibility","visible")):B.setAttribute("visibility","hidden")})};$("axis-x-line",R),$("axis-y-line",q),$("axis-z-line",L);const X=(D,T,O)=>{const B=m.querySelector(`.${D}`);if(B)if(T&&O){const G=fc,Y=T.x*G,W=T.y*G,Q=O.x*G,K=O.y*G,re=Y+Q,te=W+K;B.setAttribute("d",`M0,0 L${Y},${W} L${re},${te} L${Q},${K} Z`),B.setAttribute("visibility","visible")}else B.setAttribute("visibility","hidden")};X("plane-xy",R,q),X("plane-xz",R,L),X("plane-yz",q,L)}}));const z=(y,b)=>{const g=Ne();if(!g)return;const m=Ho(r,g,Pa.sceneOffset);n(y,a,b,m)};return r.type==="Directional"?null:t.jsxs("div",{ref:s,className:"absolute flex items-center justify-center w-0 h-0 pointer-events-auto",style:{display:"none",willChange:"transform"},children:[t.jsxs("svg",{className:"absolute overflow-visible pointer-events-none",style:{left:0,top:0},children:[t.jsxs("defs",{children:[t.jsx("marker",{id:`arrow-${a}-x`,markerWidth:"6",markerHeight:"6",refX:"5",refY:"3",orient:"auto",children:t.jsx("path",{d:"M0,0 L0,6 L6,3 z",fill:(i==null?void 0:i.part)==="axis-x"?Be.Hover:Be.X})}),t.jsx("marker",{id:`arrow-${a}-y`,markerWidth:"6",markerHeight:"6",refX:"5",refY:"3",orient:"auto",children:t.jsx("path",{d:"M0,0 L0,6 L6,3 z",fill:(i==null?void 0:i.part)==="axis-y"?Be.Hover:Be.Y})}),t.jsx("marker",{id:`arrow-${a}-z`,markerWidth:"6",markerHeight:"6",refX:"5",refY:"3",orient:"auto",children:t.jsx("path",{d:"M0,0 L0,6 L6,3 z",fill:(i==null?void 0:i.part)==="axis-z"?Be.Hover:Be.Z})})]}),t.jsx("path",{className:"plane-xy cursor-move pointer-events-auto transition-opacity duration-150",fill:(i==null?void 0:i.part)==="plane-xy"?Be.Hover:Be.PlaneXY,fillOpacity:"0.3",stroke:"none",onPointerDown:y=>z(y,"plane-xy"),onPointerEnter:()=>p("plane-xy"),onPointerLeave:h}),t.jsx("path",{className:"plane-xz cursor-move pointer-events-auto transition-opacity duration-150",fill:(i==null?void 0:i.part)==="plane-xz"?Be.Hover:Be.PlaneXZ,fillOpacity:"0.3",stroke:"none",onPointerDown:y=>z(y,"plane-xz"),onPointerEnter:()=>p("plane-xz"),onPointerLeave:h}),t.jsx("path",{className:"plane-yz cursor-move pointer-events-auto transition-opacity duration-150",fill:(i==null?void 0:i.part)==="plane-yz"?Be.Hover:Be.PlaneYZ,fillOpacity:"0.3",stroke:"none",onPointerDown:y=>z(y,"plane-yz"),onPointerEnter:()=>p("plane-yz"),onPointerLeave:h}),t.jsxs("g",{onPointerEnter:()=>p("axis-z"),onPointerLeave:h,children:[t.jsx("line",{className:"axis-z-line pointer-events-none transition-all duration-150",x1:"0",y1:"0",x2:"0",y2:"0",stroke:(i==null?void 0:i.part)==="axis-z"?Be.Hover:Be.Z,strokeWidth:"2",markerEnd:`url(#arrow-${a}-z)`}),t.jsx("line",{className:"axis-z-line cursor-pointer pointer-events-auto",x1:"0",y1:"0",x2:"0",y2:"0",stroke:"rgba(0,0,0,0)",strokeWidth:"12",onPointerDown:y=>z(y,"axis-z")})]}),t.jsxs("g",{onPointerEnter:()=>p("axis-y"),onPointerLeave:h,children:[t.jsx("line",{className:"axis-y-line pointer-events-none transition-all duration-150",x1:"0",y1:"0",x2:"0",y2:"0",stroke:(i==null?void 0:i.part)==="axis-y"?Be.Hover:Be.Y,strokeWidth:"2",markerEnd:`url(#arrow-${a}-y)`}),t.jsx("line",{className:"axis-y-line cursor-pointer pointer-events-auto",x1:"0",y1:"0",x2:"0",y2:"0",stroke:"rgba(0,0,0,0)",strokeWidth:"12",onPointerDown:y=>z(y,"axis-y")})]}),t.jsxs("g",{onPointerEnter:()=>p("axis-x"),onPointerLeave:h,children:[t.jsx("line",{className:"axis-x-line pointer-events-none transition-all duration-150",x1:"0",y1:"0",x2:"0",y2:"0",stroke:(i==null?void 0:i.part)==="axis-x"?Be.Hover:Be.X,strokeWidth:"2",markerEnd:`url(#arrow-${a}-x)`}),t.jsx("line",{className:"axis-x-line cursor-pointer pointer-events-auto",x1:"0",y1:"0",x2:"0",y2:"0",stroke:"rgba(0,0,0,0)",strokeWidth:"12",onPointerDown:y=>z(y,"axis-x")})]}),t.jsx("circle",{cx:"0",cy:"0",r:"6",fill:r.color,stroke:"white",strokeWidth:"2",className:`cursor-move pointer-events-auto transition-all duration-150 ${(i==null?void 0:i.part)==="free"?"stroke-cyan-400 r-[8px]":""}`,onPointerDown:y=>z(y,"free"),onPointerEnter:()=>p("free"),onPointerLeave:h})]}),t.jsxs("div",{className:"absolute top-[50px] left-0 transform -translate-x-1/2 flex items-center gap-1 bg-black/80 backdrop-blur px-1.5 py-0.5 rounded border border-white/20 select-none z-20 pointer-events-auto transition-transform hover:scale-105",children:[t.jsxs("span",{className:"text-[9px] font-bold text-white",children:["L",a+1]}),t.jsx("button",{className:"anchor-btn p-0.5 hover:text-cyan-400 transition-colors text-[9px]",onPointerDown:y=>y.stopPropagation(),onClick:y=>{y.stopPropagation(),x()},title:f?"Attached to Camera":"World Anchored",children:f?t.jsx(ol,{}):t.jsx(al,{})})]})]})}),Ta=ue(),Lr={current:{}};let Go=!1;const mc=()=>{var a,r,n,s;const e=(a=E.getState().lighting)==null?void 0:a.lights;if(!e)return;if(!Go){Go=!0;const i=$n(e);i!==e&&((n=(r=E.getState()).setLighting)==null||n.call(r,{lights:i}))}const o=new Map(e.map(i=>[i.id,i]));for(const[i,l]of Object.entries(Lr.current)){const c=o.get(i);if(!c||!c.visible||c.type==="Directional"){(s=l.hide)==null||s.call(l);continue}try{l.update()}catch(d){console.error("Error updating light gizmo:",d)}}},gc=()=>{const e=E(h=>h.showLightGizmo),o=E(h=>{var x;return((x=h.lighting)==null?void 0:x.lights)||[]}),a=E(h=>h.setGizmoDragging);E(h=>h.updateLight);const r=E(h=>h.setDraggedLight),{handleInteractionStart:n,handleInteractionEnd:s}=E(),i=S.useRef(null),l=S.useMemo(()=>new tr,[]),c=S.useMemo(()=>new Wa,[]),d=Lr,u=(h,x,z,y)=>{h.preventDefault(),h.stopPropagation();const b=o[x];if(!b)return;n("param"),a(!0),Ta.isGizmoInteracting=!0,r(b.id),h.target.setPointerCapture(h.pointerId);const g=Ne(),m=ea();if(!g||!m)return;const v=Ta.sceneOffset||E.getState().sceneOffset,C={x:v.x,y:v.y,z:v.z,xL:v.xL??0,yL:v.yL??0,zL:v.zL??0},M=m.getBoundingClientRect(),w=new je((h.clientX-M.left)/M.width*2-1,-((h.clientY-M.top)/M.height)*2+1);if(c.setFromCamera(w,g),z.startsWith("plane")||z==="free"){let j=new U;z==="free"?g.getWorldDirection(j):z==="plane-xy"?j.set(0,0,1):z==="plane-xz"?j.set(0,1,0):z==="plane-yz"&&j.set(1,0,0),b.fixed&&z!=="free"&&j.applyQuaternion(g.quaternion),l.setFromNormalAndCoplanarPoint(j,y);const k=new U,I=c.ray.intersectPlane(l,k)?new U().subVectors(y,k):new U(0,0,0);i.current={active:!0,index:x,mode:z,startX:h.clientX,startY:h.clientY,startPos:y.clone(),sceneOffset:C,planeNormal:j,planeOrigin:y,offsetFromIntersection:I,screenAxis:new je,worldAxis:new U}}else if(z.startsWith("axis")){let j=new U;z==="axis-x"&&j.set(1,0,0),z==="axis-y"&&j.set(0,1,0),z==="axis-z"&&j.set(0,0,1),b.fixed&&j.applyQuaternion(g.quaternion);const k=y.distanceTo(g.position)*.15,P=y.clone().addScaledVector(j,k),I=y.clone().project(g),_=P.clone().project(g),F=m.getBoundingClientRect();let A=(_.x-I.x)*F.width*.5,N=-(_.y-I.y)*F.height*.5;P.applyMatrix4(g.matrixWorldInverse).z>0&&(A=-A,N=-N);let q=new je(A,N);q.lengthSq()<.5&&q.set(1,0),q.normalize(),i.current={active:!0,index:x,mode:z,startX:h.clientX,startY:h.clientY,startPos:y.clone(),sceneOffset:C,planeNormal:new U,planeOrigin:new U,offsetFromIntersection:new U,screenAxis:q,worldAxis:j}}window.addEventListener("pointermove",f),window.addEventListener("pointerup",p)},f=h=>{var v;const x=i.current;if(!x||!x.active)return;h.preventDefault(),h.stopPropagation();const z=Ne();if(!z)return;const b=(((v=E.getState().lighting)==null?void 0:v.lights)||[])[x.index];if(!b)return;let g=new U;if(x.mode.startsWith("plane")||x.mode==="free"){const C=ea();if(!C)return;const M=C.getBoundingClientRect(),w=new je((h.clientX-M.left)/M.width*2-1,-((h.clientY-M.top)/M.height)*2+1);c.setFromCamera(w,z),l.setFromNormalAndCoplanarPoint(x.planeNormal,x.planeOrigin);const j=new U;if(c.ray.intersectPlane(l,j))g.copy(j).add(x.offsetFromIntersection);else return}else{const C=h.clientX-x.startX,M=h.clientY-x.startY,w=C*x.screenAxis.x+M*x.screenAxis.y,k=x.startPos.distanceTo(z.position)*.0025;g.copy(x.startPos).addScaledVector(x.worldAxis,w*k)}h.shiftKey&&(g.x=Math.round(g.x/.25)*.25,g.y=Math.round(g.y/.25)*.25,g.z=Math.round(g.z/.25)*.25);let m={x:0,y:0,z:0};if(b.fixed){const C=g.clone().sub(z.position).applyQuaternion(z.quaternion.clone().invert());m={x:C.x,y:C.y,z:C.z}}else{const C=x.sceneOffset;m={x:g.x+(C.x+C.xL),y:g.y+(C.y+C.yL),z:g.z+(C.z+C.zL)}}E.getState().updateLight({index:x.index,params:{position:m}})},p=h=>{i.current&&(a(!1),r(null),Ta.isGizmoInteracting=!1,s(),i.current=null,window.removeEventListener("pointermove",f),window.removeEventListener("pointerup",p))};return e?t.jsx("div",{className:"absolute inset-0 pointer-events-none",children:o.map((h,x)=>t.jsx(hc,{index:x,light:h,onDragStart:u,ref:z=>{const y=h.id;y&&(z?d.current[y]=z:delete d.current[y])}},h.id||x))}):null},Ga={displays:new Map},Va={diamonds:new Map},xc={diamonds:new Map},Xt=(e,o)=>{o?(e.style.setProperty("background-color","#991b1b","important"),e.style.setProperty("border-color","#f87171","important")):(e.style.removeProperty("background-color"),e.style.removeProperty("border-color"))},yc=()=>{const e=ce.getState(),{isPlaying:o,currentFrame:a,sequence:r}=e;Ga.displays.forEach((n,s)=>{if(n)try{const i=Ma(s,o,a,r);n.innerText=i.toFixed(2)}catch(i){console.error("Error updating live value display:",i)}}),o||(Va.diamonds.forEach(n=>{const{el:s,frame:i,tid:l}=n;if(Math.abs(i-a)<.1){const d=r.tracks[l];if(d){const u=d.keyframes.find(f=>Math.abs(f.frame-i)<.1);if(u){const f=Ma(l,!1),p=Math.abs(u.value-f)>.001;Xt(s,p)}}}else Xt(s,!1)}),xc.diamonds.forEach(n=>{const{el:s,frame:i,tids:l}=n;if(Math.abs(i-a)<.1){let d=!1;for(const u of l){const f=r.tracks[u];if(f){const p=f.keyframes.find(h=>Math.abs(h.frame-i)<.1);if(p){const h=Ma(u,!1);if(Math.abs(p.value-h)>.001){d=!0;break}}}}Xt(s,d)}else Xt(s,!1)}))},bc=({tid:e})=>{const o=S.useRef(null);return S.useEffect(()=>(o.current&&Ga.displays.set(e,o.current),()=>{Ga.displays.delete(e)}),[e]),t.jsx("span",{ref:o,className:"text-[9px] font-mono text-gray-600 w-12 text-right",children:"--"})},vc=({tid:e,kid:o,frame:a,isSelected:r,interpolation:n})=>{const s=S.useRef(null),i=`${e}::${o}`;S.useEffect(()=>(s.current&&Va.diamonds.set(i,{el:s.current,frame:a,tid:e}),()=>{Va.diamonds.delete(i)}),[i,a,e]);const l=n==="Linear"?"rotate-45 rounded-sm":n==="Step"?"rounded-none":"rounded-full";return t.jsx("div",{ref:s,className:`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 border transition-transform ${r?"bg-white border-white scale-125 z-30":"bg-cyan-900 border-cyan-400 group-hover/key:scale-125 group-hover/key:bg-cyan-400"} ${l}`})},qu=S.memo(({tid:e,sequence:o,frameWidth:a,isSelected:r,selectedKeys:n,onSelect:s,onRemove:i,onAddKey:l,onKeyMouseDown:c})=>{const d=E(f=>f.openContextMenu),u=f=>{const p=Ee(f.currentTarget);p.length>0&&(f.preventDefault(),f.stopPropagation(),d(f.clientX,f.clientY,[],p))};return t.jsxs("div",{className:"flex border-b border-white/5 bg-transparent hover:bg-white/5",style:{height:32},"data-help-id":"anim.tracks",children:[t.jsxs("div",{className:`sticky left-0 z-30 w-[220px] bg-black/80 backdrop-blur-sm border-r border-white/10 shrink-0 flex items-center justify-between px-3 cursor-pointer group select-none ${r?"border-l-2 border-l-cyan-500":""}`,onClick:f=>s(f,e),onMouseDown:f=>f.stopPropagation(),onContextMenu:u,"data-help-id":"anim.tracks",children:[t.jsx("div",{className:"truncate text-[10px] font-bold text-gray-400 group-hover:text-cyan-400 pl-4",title:o.tracks[e].label,children:o.tracks[e].label}),t.jsxs("div",{className:"flex items-center gap-2",children:[t.jsx(bc,{tid:e}),t.jsx("button",{onClick:f=>{f.stopPropagation(),i()},className:"opacity-0 group-hover:opacity-100 text-red-500 hover:text-red-400",children:t.jsx(St,{})})]})]}),t.jsxs("div",{className:"flex-1 relative group/track z-10",onDoubleClick:f=>{f.stopPropagation();const p=f.currentTarget.getBoundingClientRect(),h=Math.max(0,Math.round((f.clientX-p.left)/a));l(h)},children:[t.jsx("div",{className:"absolute inset-0 opacity-0 group-hover/track:opacity-5 bg-white pointer-events-none"}),o.tracks[e].keyframes.map(f=>{const p=n.includes(`${e}::${f.id}`);return t.jsx("div",{className:"absolute top-1/2 -translate-y-1/2 z-20 cursor-grab group/key",style:{left:`${f.frame*a-10}px`,width:"20px",height:"20px"},onMouseDown:h=>c(h,e,f.id),"data-help-id":"anim.keyframes",children:t.jsx(vc,{tid:e,kid:f.id,frame:f.frame,isSelected:p,interpolation:f.interpolation})},f.id)})]})]})});Ft("snapshotDisplayCamera",It.SNAPSHOT,()=>{const e=Ne();e&&ys(e)});Ft("animationTick",It.ANIMATE,Wl);Ft("lightGizmoTick",It.OVERLAY,mc);Ft("fpsCounterTick",It.UI,ll);Ft("performanceMonitorTick",It.UI,Zl);Ft("trackRowTick",It.UI,yc);const wc=({onLoaded:e})=>{const{camera:o,size:a,gl:r}=ca(),[n,s]=S.useState(!1),i=ue(),l=E(d=>d.dpr);S.useEffect(()=>{gs(o),xs(r.domElement)},[o,r]),S.useEffect(()=>{let d=!0;return(async()=>{let f=0;for(;!i.isBooted;){if(!d)return;if(++f>=300){console.error("[WorkerTickScene] Worker boot timeout after 30s");return}await new Promise(p=>setTimeout(p,100))}for(;i.isCompiling;){if(!d)return;await new Promise(p=>setTimeout(p,100))}d&&(i.resizeWorker(a.width,a.height,l),s(!0),e&&e())})(),()=>{d=!1}},[]),S.useEffect(()=>{i.resizeWorker(a.width,a.height,l)},[a.width,a.height,l]),S.useEffect(()=>{const d=[Z.on(pe.CONFIG,u=>{i.sendConfig(u)}),Z.on(pe.UNIFORM,({key:u,value:f,noReset:p})=>{i.setUniform(u,f,p)}),Z.on(pe.RESET_ACCUM,()=>{i.resetAccumulation()}),Z.on(pe.OFFSET_SET,u=>{const f={x:u.x,y:u.y,z:u.z,xL:u.xL??0,yL:u.yL??0,zL:u.zL??0};i.setShadowOffset(f),i.post({type:"OFFSET_SET",offset:f})}),Z.on(pe.OFFSET_SHIFT,({x:u,y:f,z:p})=>{i.applyOffsetShift(u,f,p),i.post({type:"OFFSET_SHIFT",x:u,y:f,z:p})}),Z.on(pe.CAMERA_SNAP,()=>{i.shouldSnapCamera=!0}),Z.on(pe.TEXTURE,({textureType:u,dataUrl:f})=>{i.updateTexture(u,f)}),Z.on(pe.REGISTER_FORMULA,({id:u,shader:f})=>{i.registerFormula(u,f)})];return()=>{d.forEach(u=>u())}},[]);const c=ze.useRef({lastYield:0,fps:60,frames:0,lastSample:0});return da((d,u)=>{var C;if(!n)return;const f=Math.min(u,.1),p=performance.now(),h=c.current;if(h.frames++,p-h.lastSample>=500&&(h.fps=h.frames*1e3/(p-h.lastSample),h.frames=0,h.lastSample=p),h.fps<20&&p-h.lastYield>=1e3){h.lastYield=p,$o(f);return}$o(f);const x=o,z=((C=E.getState().optics)==null?void 0:C.camFov)??60;x.fov!==z&&(x.fov=z,x.updateProjectionMatrix());const y={position:[x.position.x,x.position.y,x.position.z],quaternion:[x.quaternion.x,x.quaternion.y,x.quaternion.z,x.quaternion.w],fov:x.fov||60,aspect:x.aspect||a.width/a.height},b=E.getState(),g=b.sceneOffset||{x:0,y:0,z:0,xL:0,yL:0,zL:0},m={x:g.x,y:g.y,z:g.z,xL:g.xL??0,yL:g.yL??0,zL:g.zL??0},v={cameraMode:b.cameraMode,isCameraInteracting:ce.getState().isCameraInteracting,optics:b.optics??null,lighting:b.lighting??null,quality:b.quality??null,geometry:b.geometry??null};i.sendRenderTick(y,m,f,v)},1),null},Sc=({width:e,height:o})=>{const a=S.useRef(null),r=S.useRef(!1);return S.useEffect(()=>{const n=ue();return n.onCrash=s=>{console.error(`[WorkerDisplay] Worker crashed: ${s}.`)},()=>{n.onCrash=null}},[]),S.useEffect(()=>{var x,z;if(r.current||!a.current)return;r.current=!0;const n=window.devicePixelRatio||1,s=document.createElement("canvas");s.width=e*n,s.height=o*n,s.style.cssText="position:absolute;inset:0;width:100%;height:100%;pointer-events:none",a.current.appendChild(s);const i=E.getState(),l=xr(i),c=((x=window.matchMedia)==null?void 0:x.call(window,"(pointer: coarse)").matches)||window.innerWidth<768,d=ue(),u=i.cameraPos||{x:0,y:0,z:3},f=i.cameraRot||{x:0,y:0,z:0,w:1},p=((z=i.optics)==null?void 0:z.camFov)??60;d.initWorkerMode(s,l,e,o,n,c,{position:[u.x,u.y,u.z],quaternion:[f.x,f.y,f.z,f.w],fov:p});const h=i.sceneOffset;if(h){const y={x:h.x,y:h.y,z:h.z,xL:h.xL??0,yL:h.yL??0,zL:h.zL??0};d.setShadowOffset(y),d.post({type:"OFFSET_SET",offset:y})}},[]),t.jsx("div",{ref:a,style:{position:"absolute",inset:0,width:"100%",height:"100%",pointerEvents:"none"}})},Vo=12,Mc=40,zc=()=>{const e=ne.getViewportOverlays().filter(r=>r.type==="dom"),o=E(),a=E();return t.jsx("div",{className:"absolute inset-0 pointer-events-none z-[20]",children:e.map(r=>{const n=ge.get(r.componentId),s=r.id,i=o[s];return n&&i?t.jsx(n,{featureId:s,sliceState:i,actions:a},r.id):null})})},Cc=()=>{const e=ne.getViewportOverlays().filter(r=>!r.type||r.type==="scene"),o=E(),a=E();return t.jsx(t.Fragment,{children:e.map(r=>{const n=ge.get(r.componentId),s=r.id,i=o[s];return n&&i?t.jsx(n,{featureId:s,sliceState:i,actions:a},r.id):null})})},kc=({hudRefs:e,onSceneReady:o})=>{const a=E(),r=S.useRef(null),n=S.useRef(null),{drawing:s,interactionMode:i}=a,l=s==null?void 0:s.active,c=i==="selecting_region",{visualRegion:d,isGhostDragging:u,renderRegion:f}=Yl(r);Xl(r);const{isMobile:p}=Qa(),[h,x]=S.useState({w:0,h:0});S.useLayoutEffect(()=>{if(!n.current)return;const R=new ResizeObserver(L=>{for(const $ of L){const X=Math.max(1,$.contentRect.width),H=Math.max(1,$.contentRect.height);x({w:X,h:H})}});R.observe(n.current);const q=n.current.getBoundingClientRect();return q.width>0&&q.height>0&&x({w:q.width,h:q.height}),()=>R.disconnect()},[]);const z=a.resolutionMode==="Fixed",[y,b]=a.fixedResolution,g=d||f,m=a.isBroadcastMode,v=40,C=Math.max(1,h.w-v),M=Math.max(1,h.h-v);let w=1;z&&(w=Math.min(1,C/y,M/b));const j=z?{width:y,height:b,transform:`scale(${w})`,transformOrigin:"center center",boxShadow:"0 0 50px rgba(0,0,0,0.5)",border:"1px solid rgba(255,255,255,0.1)",flexShrink:0}:{width:"100%",height:"100%"},k=z?y*w:h.w,P=z?b*w:h.h,I=(h.h-P)/2,_=(h.w-k)/2,F=Math.max(Vo,I-Mc),A=Math.max(Vo,_),N=R=>{};return t.jsxs("div",{ref:n,className:`relative flex-1 flex items-center justify-center overflow-hidden bg-[#050505] touch-none ${c||l?"cursor-crosshair":""}`,style:{backgroundImage:z?"radial-gradient(circle at center, #111 0%, #050505 100%)":"none"},onContextMenu:R=>{R.preventDefault(),R.stopPropagation()},children:[z&&t.jsx("div",{className:"absolute inset-0 opacity-20 pointer-events-none",style:{backgroundImage:"linear-gradient(#333 1px, transparent 1px), linear-gradient(90deg, #333 1px, transparent 1px)",backgroundSize:"40px 40px"}}),!m&&t.jsx(Gl,{state:a,actions:a,isMobile:a.debugMobileLayout||p,hudRefs:e}),!m&&t.jsx(dc,{}),!m&&t.jsx(Ql,{}),!m&&t.jsx(ql,{}),t.jsxs("div",{ref:r,style:j,className:"relative bg-[#111] group z-0",children:[(c||l)&&t.jsx("div",{className:"absolute inset-0 z-50 cursor-crosshair bg-transparent pointer-events-none"}),g&&!c&&!m&&t.jsx("div",{className:`absolute border-2 z-40 group/box region-box cursor-move transition-opacity duration-75 ${u?"border-cyan-400 border-dashed opacity-80":"border-cyan-500 opacity-100"}`,style:{left:`${g.minX*100}%`,bottom:`${g.minY*100}%`,right:`${(1-g.maxX)*100}%`,top:`${(1-g.maxY)*100}%`},children:t.jsxs("div",{className:"absolute top-0 right-0 bg-cyan-600 text-white text-[9px] font-bold px-1.5 py-0.5 flex items-center gap-2 pointer-events-auto shadow-md",children:[t.jsx("span",{children:u?"Moving...":"Active Region"}),t.jsx("div",{className:"w-px h-2 bg-cyan-400/50"}),t.jsx("button",{onClick:R=>{R.stopPropagation(),a.setRenderRegion(null)},className:"hover:text-black transition-colors",title:"Clear Region",children:"✕"})]})}),h.w>0&&h.h>0&&t.jsx(Sc,{width:z?y:h.w,height:z?b:h.h}),t.jsxs(ki,{gl:{alpha:!0,depth:!1,antialias:!1,powerPreference:"high-performance",preserveDrawingBuffer:!1},camera:{position:[0,0,0],fov:60},style:{position:"absolute",inset:0,pointerEvents:"auto"},dpr:a.dpr,onPointerDown:R=>R.target.setPointerCapture(R.pointerId),onPointerMove:N,onWheel:N,children:[t.jsx(lc,{mode:a.cameraMode,hudRefs:e,onStart:R=>a.handleInteractionStart(R),onEnd:()=>a.handleInteractionEnd(),setSceneOffset:a.setSceneOffset,fitScale:w}),t.jsx(wc,{onLoaded:o}),t.jsx(Cc,{})]}),t.jsx(zc,{}),!m&&t.jsx(ec,{width:z?y:h.w,height:z?b:h.h}),!m&&a.histogramActiveCount>0&&t.jsx(_o,{onUpdate:R=>a.setHistogramData(R),autoUpdate:a.histogramAutoUpdate,trigger:a.histogramTrigger,source:"geometry"}),!m&&a.sceneHistogramActiveCount>0&&t.jsx(_o,{onUpdate:R=>a.setSceneHistogramData(R),autoUpdate:!0,trigger:a.sceneHistogramTrigger,source:"color"}),c&&!m&&t.jsx("div",{className:"absolute top-4 left-1/2 -translate-x-1/2 bg-cyan-900/80 text-cyan-100 text-[10px] font-bold px-3 py-1 rounded-full border border-cyan-500/50 shadow-lg animate-pulse pointer-events-none z-[60]",children:"Drag to select render region"})]}),z&&!m&&t.jsx(Jl,{width:y,height:b,top:F,left:A,maxAvailableWidth:h.w,maxAvailableHeight:h.h,onSetResolution:a.setFixedResolution,onSetMode:a.setResolutionMode})]})},jc=()=>{const e=E(o=>o.openContextMenu);S.useEffect(()=>{const o=a=>{if(a.defaultPrevented)return;const r=Ee(a.target);r.length>0&&(a.preventDefault(),e(a.clientX,a.clientY,[],r))};return window.addEventListener("contextmenu",o),()=>window.removeEventListener("contextmenu",o)},[e])},Pc={"general.undo":{id:"general.undo",category:"General",title:"Undo & History",content:`
...
`}},Tc={"formula.active":{id:"formula.active",category:"Formulas",title:"Active Formula",content:`
...
`}},Rc={"formula.mandelbulb":{id:"formula.mandelbulb",category:"Formulas",title:"Mandelbulb",parentId:"formula.active",content:`
## The Math
...
`}},Ic={"panel.formula":{id:"panel.formula",category:"Parameters",title:"Formula Parameters",content:`
...
`}},Fc={"ui.controls":{id:"ui.controls",category:"UI",title:"Control Deck",content:`
...
`}},_c={"ui.timeline":{id:"ui.timeline",category:"Timeline",title:"Animation Timeline",content:`
...
`}},Dc={"panel.light":{id:"panel.light",category:"Lighting",title:"Light Studio",content:`
...
`}},Lc={"panel.render":{id:"panel.render",category:"Rendering",title:"Shading & Materials",content:`
...
`}},Ec={"panel.gradient":{id:"panel.gradient",category:"Coloring",title:"Coloring Engine",content:`
...
`}},Ac={"ui.graph":{id:"ui.graph",category:"Graph",title:"Modular Graph Editor",content:`
...
`}},Nc={"panel.scene":{id:"panel.scene",category:"UI",title:"Scene Panel",content:`
...
**Note**: DOF requires **Temporal Accumulation** to look smooth. It uses stochastic jittering of the camera ray.
`}},Bc={"effect.droste":{id:"effect.droste",category:"Effects",title:"Escher Droste (Spiral)",content:`
...
`}},Oc={"panel.audio":{id:"panel.audio",category:"Audio",title:"Audio Engine",content:`
