...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2}},$a={id:"mirror",label:"Mirror",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = foldLimit - abs(abs(z) - foldLimit);
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},Ba={id:"half",label:"Half-fold",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = abs(z + foldLimit);
}
`,defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:2}},Ha={id:"decoupled",label:"Decoupled",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,extraParams:{hybridFoldingValue:{type:"vec3",default:new N(2,2,2),label:"Folding Value",shortId:"hfv",uniform:"uHybridFoldingValue",min:.1,max:5,step:.01,group:"hybrid"}},defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2,hybridFoldingValue:{x:2,y:2,z:2}}},Va={id:"kali",label:"Kali",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = uHybridKaliConstant - abs(z);
}
`,rotMode:"post",extraParams:{hybridKaliConstant:{type:"vec3",default:new N(1,1,1),label:"Kali Constant",shortId:"hkc",uniform:"uHybridKaliConstant",min:-3,max:3,step:.01,group:"hybrid"}},defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.6,hybridFixedR:1,hybridIter:3,hybridKaliConstant:{x:.5,y:.5,z:.5}}},Ga={id:"tetra",label:"Tetrahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    if (z.x + z.y < 0.0) z.xy = -z.yx;
    if (z.x + z.z < 0.0) z.xz = -z.zx;
    if (z.y + z.z < 0.0) z.yz = -z.zy;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.25,hybridFixedR:1,hybridIter:3}},Ua={id:"octa",label:"Octahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},qa={id:"icosa",label:"Icosahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:4}},Wa={id:"menger",label:"Menger (Cubic)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,selfContained:!0,extraParams:{hybridMengerOffset:{type:"vec3",default:new N(1,1,1),label:"Offset",shortId:"hmo",uniform:"uHybridMengerOffset",min:0,max:2,step:.01,group:"hybrid",linkable:!0},hybridMengerCenterZ:{type:"boolean",default:!0,label:"Center Z",shortId:"hmz",uniform:"uHybridMengerCenterZ",group:"hybrid"}},defaults:{hybridScale:3,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3,hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0}},ct=[Na,$a,Ba,Ha,Va,Ga,Ua,qa,Wa],Xa=ct.map((e,o)=>({label:e.label,value:o}));function Ya(e){return ct[e]??ct[0]}const Ka=`
...
`,Ja=["xyz","xzy","yxz","yzx","zxy","zyx"];function Za(e){const o=Ja[e]??"xyz";return o==="xyz"?"vec3 c_perm = c.xyz;":`vec3 c_perm = c.${o};`}function Qa(e,o,t=!1){return`
mat3 hybridRotMat;
bool hybridHasRot;
...
`,l+=`
                ...
                `}e.addHybridFold("",n,l)}},Yt=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF"],Kt=["uVec2A","uVec2B","uVec2C"],Jt=["uVec3A","uVec3B","uVec3C"],Zt=["uVec4A","uVec4B","uVec4C"],Co=["uInterlaceParamA","uInterlaceParamB","uInterlaceParamC","uInterlaceParamD","uInterlaceParamE","uInterlaceParamF"],Mo=["uInterlaceVec2A","uInterlaceVec2B","uInterlaceVec2C"],Ro=["uInterlaceVec3A","uInterlaceVec3B","uInterlaceVec3C"],Lo=["uInterlaceVec4A","uInterlaceVec4B","uInterlaceVec4C"];function or(){const e=[];for(let o=0;o<Yt.length;o++)e.push([new RegExp(`\\b${Yt[o]}\\b`,"g"),Co[o]]);for(let o=0;o<Kt.length;o++)e.push([new RegExp(`\\b${Kt[o]}\\b`,"g"),Mo[o]]);for(let o=0;o<Jt.length;o++)e.push([new RegExp(`\\b${Jt[o]}\\b`,"g"),Ro[o]]);for(let o=0;o<Zt.length;o++)e.push([new RegExp(`\\b${Zt[o]}\\b`,"g"),Lo[o]]);return e}const ar=or();function Pt(e){let o=e;for(const[t,a]of ar)o=o.replace(t,a);return o}function Tt(e,o){const t=[...o].sort((r,i)=>i.length-r.length);let a=e;for(const r of t)a=a.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return a}function rr(e,o,t){let a=e;return a=a.replace(new RegExp(`\\b${o}_\\w+\\b`,"g"),r=>`interlace_${r}`),t&&t.length>0&&(a=Tt(a,t)),a=Pt(a),a}function ir(e,o,t){let a=e;return a=a.replace(new RegExp(`\\bformula_${o}\\b`,"g"),"formula_Interlace"),a=Pt(a),t&&t.length>0&&(a=Tt(a,t)),a}function nr(e,o){return e.replace(new RegExp(`\\bformula_${o}\\b`,"g"),"formula_Interlace")}function sr(e,o,t){let a=e;return a=a.replace(new RegExp(`\\b${o}_\\w+\\b`,"g"),r=>`interlace_${r}`),a=Pt(a),t&&t.length>0&&(a=Tt(a,t)),a}function lr(e,o,t){let a="";o&&(a=`
...
`});U.register({id:"Custom",label:"Custom (Legacy)",category:"Utils",description:"Legacy node.",inputs:[],glsl:e=>""});const mr=(e,o)=>{const t=new Set,a=["root-end"],r=new Set;for(;a.length>0;){const f=a.pop();if(r.has(f))continue;r.add(f),f!=="root-end"&&f!=="root-start"&&t.add(f),o.filter(h=>h.target===f).forEach(h=>a.push(h.source))}const i=e.filter(f=>t.has(f.id));if(!i||i.length===0)return`
    ...
    `;const l=new Map;l.set("root-start","v_start");let s=0;i.forEach((f,p)=>{const g=`v_${f.id.replace(/[^a-zA-Z0-9]/g,"")}`;l.set(f.id,g);const v=o.filter(E=>E.target===f.id),m=v.find(E=>!E.targetHandle||E.targetHandle==="a"),y=v.find(E=>E.targetHandle==="b"),b=m&&l.get(m.source)||"v_start",_=y&&l.get(y.source)||"v_start";if(n+=`    // Node: ${f.type} (${f.id})
`,n+=`    vec3 ${g}_p = ${b}_p;
`,n+=`    float ${g}_d = ${b}_d;
`,n+=`    float ${g}_dr = ${b}_dr;
`,f.enabled){const E=U.get(f.type);if(E){const S=f.condition&&f.condition.active;let C="    ";if(S){const L=Math.round(Math.max(1,f.condition.mod)),F=Math.round(f.condition.rem);n+=`    if ( (i - (i/${L})*${L}) == ${F} ) {
`,C="        "}const T=L=>f.bindings&&f.bindings[L]?`u${f.bindings[L]}`:s<It?`uModularParams[${s++}]`:"0.0";n+=E.glsl({varName:g,in1:b,in2:_,getParam:T,indent:C}),S&&(n+=`    }
`)}}n+=`
`});const c=o.find(f=>f.target==="root-end");let u="v_start";return c&&c.source!=="root-start"&&(u=l.get(c.source)||"v_start"),n+=`
    z.xyz = ${u}_p;
    dr = ${u}_dr;
...
`},gr=e=>{let o="d = 0.5 * log(max(r, 1.0e-5)) * r / dr_safe;";return e<.5?o=`
        float logR2 = log2(m2);
        ...
        }`},yr={id:"coreMath",shortId:"cm",name:"Formula Math",category:"Formulas",tabConfig:{label:"Formula",componentId:"panel-formula",order:10},extraUniforms:[{name:ue.ModularParams,type:"float",arraySize:It,default:new Float32Array(It)}],params:{iterations:{type:"float",default:16,label:"Iterations",shortId:"it",uniform:"uIterations",min:1,max:500,step:1,group:"main"},paramA:{type:"float",default:8,label:"Param A",shortId:"pa",uniform:"uParamA",min:-10,max:10,step:.001,group:"params"},paramB:{type:"float",default:0,label:"Param B",shortId:"pb",uniform:"uParamB",min:-10,max:10,step:.001,group:"params"},paramC:{type:"float",default:0,label:"Param C",shortId:"pc",uniform:"uParamC",min:-10,max:10,step:.001,group:"params"},paramD:{type:"float",default:0,label:"Param D",shortId:"pd",uniform:"uParamD",min:-10,max:10,step:.001,group:"params"},paramE:{type:"float",default:0,label:"Param E",shortId:"pe",uniform:"uParamE",min:-10,max:10,step:.001,group:"params"},paramF:{type:"float",default:0,label:"Param F",shortId:"pf",uniform:"uParamF",min:-10,max:10,step:.001,group:"params"},vec2A:{type:"vec2",default:{x:0,y:0},label:"Vec2 A",shortId:"v2a",uniform:"uVec2A",min:-10,max:10,step:.001,group:"params"},vec2B:{type:"vec2",default:{x:0,y:0},label:"Vec2 B",shortId:"v2b",uniform:"uVec2B",min:-10,max:10,step:.001,group:"params"},vec2C:{type:"vec2",default:{x:0,y:0},label:"Vec2 C",shortId:"v2c",uniform:"uVec2C",min:-10,max:10,step:.001,group:"params"},vec3A:{type:"vec3",default:new N(0,0,0),label:"Vec3 A",shortId:"v3a",uniform:"uVec3A",min:-10,max:10,step:.001,group:"params"},vec3B:{type:"vec3",default:new N(0,0,0),label:"Vec3 B",shortId:"v3b",uniform:"uVec3B",min:-10,max:10,step:.001,group:"params"},vec3C:{type:"vec3",default:new N(0,0,0),label:"Vec3 C",shortId:"v3c",uniform:"uVec3C",min:-10,max:10,step:.001,group:"params"},vec4A:{type:"vec4",default:new pt(0,0,0,0),label:"Vec4 A",shortId:"v4a",uniform:"uVec4A",min:-10,max:10,step:.001,group:"params"},vec4B:{type:"vec4",default:new pt(0,0,0,0),label:"Vec4 B",shortId:"v4b",uniform:"uVec4B",min:-10,max:10,step:.001,group:"params"},vec4C:{type:"vec4",default:new pt(0,0,0,0),label:"Vec4 C",shortId:"v4c",uniform:"uVec4C",min:-10,max:10,step:.001,group:"params"}},inject:(e,o)=>{var u;const t=o.formula,a=o.quality;t==="Modular"&&e.addDefine("PIPELINE_REV",(o.pipelineRevision||0).toString()),["JuliaMorph","MandelTerrain"].includes(t)&&e.addDefine("SKIP_PRE_BAILOUT","1");const r=he.get(t);let i="",n="",l="";const s=(a==null?void 0:a.estimator)||0;let c=gr(s);if(t==="Modular"){const f=mr(o.pipeline||[],((u=o.graph)==null?void 0:u.edges)||[]);i+=f+`
...
`,n=r.shader.loopBody,l=r.shader.loopInit||"",r.shader.preamble&&e.addPreamble(r.shader.preamble),r.shader.getDist&&(c=`vec2 getDist(float r, float dr, float iter, vec4 z) { ${r.shader.getDist} }`));e.addFunction(i),e.setFormula(n,l,c)}};let br=0;function Ve(){return`l${++br}`}const vr=(e,o)=>{if(!e)return`
...
`,Zr=`
    ...
    col += fogScatter;
`,Qr={id:"volumetric",shortId:"vol",name:"Volumetric Scatter",category:"Rendering",engineConfig:{toggleParam:"ptVolumetric",mode:"compile",label:"Volumetric Scattering",description:"Henyey-Greenstein single scatter. Enables god rays, colored haze, and directional fog.",groupFilter:"engine_settings"},panelConfig:{compileParam:"ptVolumetric",runtimeToggleParam:"volEnabled",label:"Volumetric Scatter",compileMessage:"Compiling Volumetric Shader...",helpId:"render.volumetric"},groups:{density:{label:"Density & Shadow Rays",collapsible:!0},emissive:{label:"Color Scatter",collapsible:!0},height:{label:"Height Fog",collapsible:!0}},params:{ptVolumetric:{type:"boolean",default:!1,label:"Volume Scatter",shortId:"pvs",group:"engine_settings",noReset:!0,onUpdate:"compile",estCompileMs:5500},volEnabled:{type:"boolean",default:!1,label:"Enabled",shortId:"ven",uniform:"uVolEnabled",hidden:!0},volDensity:{type:"float",default:.01,label:"Density",shortId:"vd",uniform:"uVolDensity",min:.001,max:5,step:.01,scale:"log",group:"density",condition:{param:"ptVolumetric",bool:!0}},volAnisotropy:{type:"float",default:.3,label:"Anisotropy (g)",shortId:"va",uniform:"uVolAnisotropy",min:-.99,max:.99,step:.01,group:"density",parentId:"volDensity",condition:{gt:0},description:"0=isotropic, +0.9=forward (god rays), -0.9=back scatter."},volMaxLights:{type:"float",default:1,label:"Light Sources",shortId:"vml",uniform:"uVolMaxLights",min:1,max:3,step:1,group:"density",parentId:"volDensity",condition:{gt:0},isAdvanced:!0,description:"Max lights for shadow rays. More = more expensive."},volScatterTint:{type:"color",default:new le(1,1,1),label:"Scatter Tint",shortId:"vst",uniform:"uVolScatterTint",group:"density",parentId:"volDensity",condition:{gt:0}},volEmissive:{type:"float",default:0,label:"Color Scatter",shortId:"ves",uniform:"uVolEmissive",min:0,max:100,step:.1,scale:"log",group:"emissive",condition:{param:"ptVolumetric",bool:!0},description:"Orbit trap color field scattered through the volume. No shadow rays needed."},volStepJitter:{type:"float",default:1,label:"Step Jitter",shortId:"vsj",uniform:"uVolStepJitter",min:0,max:1,step:.01,group:"density",parentId:"volDensity",condition:{gt:0},description:"1 = smooth (temporal accumulation removes noise). 0 = fixed slicing pattern (artistic, broken fog look)."},volEmissiveFalloff:{type:"float",default:0,label:"Surface Falloff",shortId:"vef",uniform:"uVolEmissiveFalloff",min:0,max:5,step:.01,scale:"log",group:"emissive",parentId:"volEmissive",condition:{gt:0},description:"Concentrate color near fractal surface."},volHeightFalloff:{type:"float",default:0,label:"Height Falloff",shortId:"vhf",uniform:"uVolHeightFalloff",min:0,max:5,step:.01,scale:"log",group:"height",condition:{param:"ptVolumetric",bool:!0},description:"Density varies with Y. Creates ground fog, rising mist."},volHeightOrigin:{type:"float",default:0,label:"Height Origin",shortId:"vho",uniform:"uVolHeightOrigin",min:-5,max:5,step:.01,group:"height",parentId:"volHeightFalloff",condition:{gt:0}}},inject:(e,o,t)=>{if(t!=="Main")return;const a=o.volumetric;a!=null&&a.ptVolumetric&&(e.addDefine("PT_VOLUMETRIC","1"),e.addVolumeTracing(Jr,""),e.addPostProcessLogic(Zr))}},ei=()=>{j.register(yr),j.register(tr),j.register(fr),j.register(Lr),j.register(Pr),j.register($r),j.register(Gr),j.register(Ra),j.register(Qr),j.register(Aa),j.register(Yr),j.register(ja),j.register(Da),j.register(pr),j.register(Pa),j.register(Ta),j.register(Fa),j.register(Tr),j.register(Er),j.register(Kr),j.register(kr),j.register(zr),j.register(Ar),j.register(Fr),j.register(Dr),j.register(jr)},He=e=>{const o=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return o?{r:parseInt(o[1],16),g:parseInt(o[2],16),b:parseInt(o[3],16)}:null},Ao=(e,o,t)=>(typeof e=="object"&&(o=e.g,t=e.b,e=e.r),"#"+((1<<24)+(Math.round(e)<<16)+(Math.round(o)<<8)+Math.round(t)).toString(16).slice(1).toUpperCase()),dt=({r:e,g:o,b:t})=>{e/=255,o/=255,t/=255;const a=Math.max(e,o,t),r=Math.min(e,o,t);let i=0,n=0,l=a;const s=a-r;if(n=a===0?0:s/a,a!==r){switch(a){case e:i=(o-t)/s+(o<t?6:0);break;case o:i=(t-e)/s+2;break;case t:i=(e-o)/s+4;break}i/=6}return{h:i*360,s:n*100,v:l*100}},Fo=(e,o,t)=>{e/=360,o/=100,t/=100;let a=0,r=0,i=0;const n=Math.floor(e*6),l=e*6-n,s=t*(1-o),c=t*(1-l*o),u=t*(1-(1-l)*o);switch(n%6){case 0:a=t,r=u,i=s;break;case 1:a=c,r=t,i=s;break;case 2:a=s,r=t,i=u;break;case 3:a=s,r=c,i=t;break;case 4:a=u,r=s,i=t;break;case 5:a=t,r=s,i=c;break}return{r:a*255,g:r*255,b:i*255}},ti=(e,o,t)=>({r:e.r+(o.r-e.r)*t,g:e.g+(o.g-e.g)*t,b:e.b+(o.b-e.b)*t}),oi=(e,o,t)=>{const a=dt(e),r=dt(o);let i=r.h-a.h;i>180&&(i-=360),i<-180&&(i+=360);const n=((a.h+i*t)%360+360)%360,l=a.s+(r.s-a.s)*t,s=a.v+(r.v-a.v)*t;return Fo(n,l,s)},ai=(e,o,t)=>{const a=dt(e),r=dt(o);let i=r.h-a.h;i>=0&&i<=180&&(i-=360),i<0&&i>=-180&&(i+=360);const n=((a.h+i*t)%360+360)%360,l=a.s+(r.s-a.s)*t,s=a.v+(r.v-a.v)*t;return Fo(n,l,s)},nt=e=>{const o=e/255;return o<=.04045?o/12.92:Math.pow((o+.055)/1.055,2.4)},gt=e=>{const o=Math.max(0,Math.min(1,e));return(o<=.0031308?o*12.92:1.055*Math.pow(o,1/2.4)-.055)*255},ao=e=>{const o=nt(e.r),t=nt(e.g),a=nt(e.b),r=Math.cbrt(.4122214708*o+.5363325363*t+.0514459929*a),i=Math.cbrt(.2119034982*o+.6806995451*t+.1073969566*a),n=Math.cbrt(.0883024619*o+.2817188376*t+.6299787005*a);return{L:.2104542553*r+.793617785*i-.0040720468*n,a:1.9779984951*r-2.428592205*i+.4505937099*n,b:.0259040371*r+.7827717662*i-.808675766*n}},ro=e=>{const o=e.L+.3963377774*e.a+.2158037573*e.b,t=e.L-.1055613458*e.a-.0638541728*e.b,a=e.L-.0894841775*e.a-1.291485548*e.b,r=o*o*o,i=t*t*t,n=a*a*a;return{r:gt(4.0767416621*r-3.3077115913*i+.2309699292*n),g:gt(-1.2684380046*r+2.6097574011*i-.3413193965*n),b:gt(-.0041960863*r-.7034186147*i+1.707614701*n)}},ri=(e,o,t)=>{const a=ao(e),r=ao(o),i=Math.sqrt(a.a*a.a+a.b*a.b),n=Math.sqrt(r.a*r.a+r.b*r.b);if(i<.005||n<.005)return ro({L:a.L+(r.L-a.L)*t,a:a.a+(r.a-a.a)*t,b:a.b+(r.b-a.b)*t});const l=Math.atan2(a.b,a.a);let c=Math.atan2(r.b,r.a)-l;c>Math.PI&&(c-=2*Math.PI),c<-Math.PI&&(c+=2*Math.PI);const u=l+c*t,f=i+(n-i)*t,p=a.L+(r.L-a.L)*t;return ro({L:p,a:f*Math.cos(u),b:f*Math.sin(u)})},Do=(e,o,t,a)=>{switch(a){case"hsv":return oi(e,o,t);case"hsv-far":return ai(e,o,t);case"oklab":return ri(e,o,t);default:return ti(e,o,t)}},Oo=(e,o)=>{if(Math.abs(o-.5)<.001)return e;const t=Math.max(.001,Math.min(.999,o)),a=Math.log(.5)/Math.log(t);return Math.pow(e,a)},Rn=(e,o=1)=>{let t,a="rgb";if(!e)return"linear-gradient(90deg, #000 0%, #fff 100%)";if(Array.isArray(e))t=e;else if(e&&Array.isArray(e.stops))t=e.stops,a=e.blendSpace||"oklab";else return"linear-gradient(90deg, #000 0%, #fff 100%)";if(!t||t.length===0)return"linear-gradient(90deg, #000 0%, #fff 100%)";const r=[...t].sort((l,s)=>l.position-s.position),i=a!=="rgb",n=[];for(let l=0;l<r.length;l++){const s=r[l];let c=Math.pow(s.position,1/o);if(c=Math.max(0,Math.min(1,c))*100,n.push(`${s.color} ${c.toFixed(2)}%`),l<r.length-1){const u=r[l+1],f=s.bias??.5,p=s.interpolation||"linear";if(p==="step"){let h=Math.pow(u.position,1/o);h=Math.max(0,Math.min(1,h))*100,n.push(`${s.color} ${h.toFixed(2)}%`),n.push(`${u.color} ${h.toFixed(2)}%`)}else if(i){const h=He(s.color)||{r:0,g:0,b:0},g=He(u.color)||{r:0,g:0,b:0},v=12;for(let m=1;m<v;m++){let y=m/v;Math.abs(f-.5)>.001&&(y=Oo(y,f)),(p==="smooth"||p==="cubic")&&(y=y*y*(3-2*y));const b=Do(h,g,y,a),_=s.position+(u.position-s.position)*(m/v);let E=Math.pow(_,1/o)*100;E=Math.max(0,Math.min(100,E)),n.push(`${Ao(b)} ${E.toFixed(2)}%`)}}else if(Math.abs(f-.5)>.001){const h=s.position+(u.position-s.position)*f;let g=Math.pow(h,1/o)*100;g=Math.max(0,Math.min(100,g)),n.push(`${g.toFixed(2)}%`)}}}return`linear-gradient(90deg, ${n.join(", ")})`},yt=e=>nt(e)*255,bt=e=>{const o=e/255;if(o>=.99)return 255;const t=(Math.sqrt(-10127*o*o+13702*o+9)+59*o-3)/(502-486*o);return Math.max(0,t)*255},io=e=>{const t=new Uint8Array(1024);let a,r="srgb",i="oklab";if(Array.isArray(e))a=e;else if(e&&Array.isArray(e.stops))a=e.stops,r=e.colorSpace||"srgb",i=e.blendSpace||"oklab";else return t;if(a.length===0){for(let s=0;s<256;s++){const c=Math.floor(s/255*255);t[s*4]=c,t[s*4+1]=c,t[s*4+2]=c,t[s*4+3]=255}return t}const n=[...a].sort((s,c)=>s.position-c.position),l=s=>{let c={r:0,g:0,b:0};if(s<=n[0].position)c=He(n[0].color)||{r:0,g:0,b:0};else if(s>=n[n.length-1].position)c=He(n[n.length-1].color)||{r:0,g:0,b:0};else for(let u=0;u<n.length-1;u++)if(s>=n[u].position&&s<=n[u+1].position){const f=n[u],p=n[u+1];let h=(s-f.position)/(p.position-f.position);const g=f.bias??.5;Math.abs(g-.5)>.001&&(h=Oo(h,g));const v=f.interpolation||"linear";v==="step"?h=0:(v==="smooth"||v==="cubic")&&(h=h*h*(3-2*h));const m=He(f.color)||{r:0,g:0,b:0},y=He(p.color)||{r:0,g:0,b:0};c=Do(m,y,h,i);break}return r==="linear"?{r:yt(c.r),g:yt(c.g),b:yt(c.b)}:r==="aces_inverse"?{r:bt(c.r),g:bt(c.g),b:bt(c.b)}:c};for(let s=0;s<256;s++){const c=s/255,u=l(c);t[s*4]=u.r,t[s*4+1]=u.g,t[s*4+2]=u.b,t[s*4+3]=255}return t},ii=e=>{const o=Math.max(1e3,Math.min(4e4,e))/100;let t,a,r;return o<=66?t=255:(t=o-60,t=329.698727446*Math.pow(t,-.1332047592),t=Math.max(0,Math.min(255,t))),o<=66?(a=o,a=99.4708025861*Math.log(a)-161.1195681661,a=Math.max(0,Math.min(255,a))):(a=o-60,a=288.1221695283*Math.pow(a,-.0755148492),a=Math.max(0,Math.min(255,a))),o>=66?r=255:o<=19?r=0:(r=o-10,r=138.5177312231*Math.log(r)-305.0447927307,r=Math.max(0,Math.min(255,r))),{r:Math.round(t),g:Math.round(a),b:Math.round(r)}},Ln=e=>{const{r:o,g:t,b:a}=ii(e);return Ao(o,t,a)},ni=(e,o)=>{const t={};return ei(),j.getAll().forEach(r=>{const i={},n={};r.state&&Object.assign(i,r.state),Object.entries(r.params).forEach(([s,c])=>{c.composeFrom?c.composeFrom.forEach(u=>{n[u]=s}):i[s]===void 0&&(i[s]=c.default)}),t[r.id]=i;const l=`set${r.id.charAt(0).toUpperCase()+r.id.slice(1)}`;t[l]=s=>{let c=!1;const u={};e(f=>{const p=f[r.id],h={...s};Object.keys(s).forEach(m=>{const y=r.params[m];if(y){const b=s[m];if(b==null)return;y.type==="vec2"&&!(b instanceof ve)&&(h[m]=new ve(b.x,b.y)),y.type==="vec3"&&!(b instanceof N)&&(h[m]=new N(b.x,b.y,b.z)),y.type==="color"&&!(b instanceof le)&&(typeof b=="string"?h[m]=new le(b):typeof b=="number"?h[m]=new le(b):typeof b=="object"&&"r"in b&&(h[m]=new le(b.r,b.g,b.b)))}}),Object.keys(h).forEach(m=>{const y=r.params[m];if(y!=null&&y.onSet){const b=y.onSet(h[m],p);b&&Object.entries(b).forEach(([_,E])=>{s[_]===void 0&&(h[_]=E)})}});const g={...p,...h},v=new Set;return Object.keys(h).forEach(m=>{const y=r.params[m];if(n[m]&&v.add(n[m]),y&&(y.noReset||(c=!0),y.type!=="image"&&(u[r.id]||(u[r.id]={}),u[r.id][m]=g[m]),y.uniform)){const b=g[m];if(y.type==="image"){const _=y.uniform.toLowerCase().includes("env")?"env":"color";b&&typeof b=="string"?(R.emit("texture",{textureType:_,dataUrl:b}),m==="envMapData"&&g.useEnvMap===!1&&(g.useEnvMap=!0,R.emit("uniform",{key:"uUseEnvMap",value:1,noReset:!1})),m==="layer1Data"&&g.active===!1&&(g.active=!0,R.emit("uniform",{key:"uUseTexture",value:1,noReset:!1}))):(R.emit("texture",{textureType:_,dataUrl:null}),m==="envMapData"&&g.useEnvMap===!0&&(g.useEnvMap=!1,R.emit("uniform",{key:"uUseEnvMap",value:0,noReset:!1})),m==="layer1Data"&&g.active===!0&&(g.active=!1,R.emit("uniform",{key:"uUseTexture",value:0,noReset:!1})))}else if(y.type==="gradient"){const _=io(b);R.emit("uniform",{key:y.uniform,value:{isGradientBuffer:!0,buffer:_},noReset:!!y.noReset})}else{let _=b;y.type==="boolean"&&(_=b?1:0),y.type==="color"&&!(_ instanceof le)&&(_=new le(_)),R.emit("uniform",{key:y.uniform,value:_,noReset:!!y.noReset})}}}),v.forEach(m=>{const y=r.params[m];if(y&&y.composeFrom&&y.uniform){const b=y.composeFrom.map(_=>g[_]);if(y.type==="gradient"){const _=g[m];if(_){const E=io(_);R.emit("uniform",{key:y.uniform,value:{isGradientBuffer:!0,buffer:E},noReset:!!y.noReset}),y.noReset||(c=!0)}}else if(y.type==="vec2"){const _=new ve(b[0],b[1]);R.emit("uniform",{key:y.uniform,value:_,noReset:!!y.noReset}),y.noReset||(c=!0)}else if(y.type==="vec3"){const _=new N(b[0],b[1],b[2]);R.emit("uniform",{key:y.uniform,value:_,noReset:!!y.noReset}),y.noReset||(c=!0)}}}),{[r.id]:g}}),Object.keys(u).length>0&&R.emit("config",u),c&&R.emit("reset_accum",void 0)},r.actions&&Object.entries(r.actions).forEach(([s,c])=>{t[s]=u=>{const p=o()[r.id],h=c(p,u);h&&Object.keys(h).length>0&&(e({[r.id]:{...p,...h}}),R.emit("reset_accum",void 0))}})}),t},si={id:"shadows",label:"Shadows",renderContext:"direct",controlledParams:["lighting.shadowsCompile","lighting.shadowAlgorithm","lighting.ptStochasticShadows"],tiers:[{label:"Off",overrides:{lighting:{shadows:!1,shadowsCompile:!1,ptStochasticShadows:!1}},estCompileMs:0},{label:"Hard",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:2,ptStochasticShadows:!1}},estCompileMs:500},{label:"Soft",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!1}},estCompileMs:3e3},{label:"Full",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!0}},estCompileMs:3800}]},li={id:"reflections",label:"Reflections (Direct)",renderContext:"direct",controlledParams:["reflections.reflectionMode","reflections.bounceShadows","reflections.bounces"],tiers:[{label:"Off",overrides:{reflections:{reflectionMode:0,bounceShadows:!1}},estCompileMs:0},{label:"Env Map",overrides:{reflections:{reflectionMode:1,bounceShadows:!1}},estCompileMs:0},{label:"Raymarched",overrides:{reflections:{reflectionMode:3,bounceShadows:!1,bounces:1}},estCompileMs:7500},{label:"Full",overrides:{reflections:{reflectionMode:3,bounceShadows:!0,bounces:2}},estCompileMs:12e3}]},ci={id:"lighting_quality",label:"Lighting",isAdvanced:!0,controlledParams:["lighting.specularModel","lighting.ptEnabled","lighting.ptNEEAllLights","lighting.ptEnvNEE"],tiers:[{label:"Preview",overrides:{lighting:{advancedLighting:!1,ptEnabled:!1}},estCompileMs:-2500},{label:"Path Traced",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!1,ptEnvNEE:!1}},estCompileMs:1900},{label:"PT + NEE",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!0,ptEnvNEE:!0}},estCompileMs:2500}]},di={id:"atmosphere_quality",label:"Atmosphere",controlledParams:["atmosphere.glowEnabled","atmosphere.glowQuality","volumetric.ptVolumetric"],tiers:[{label:"Off",overrides:{atmosphere:{glowEnabled:!1},volumetric:{ptVolumetric:!1}},estCompileMs:0},{label:"Fast Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:1},volumetric:{ptVolumetric:!1}},estCompileMs:200},{label:"Color Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!1}},estCompileMs:400},{label:"Volumetric",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!0}},estCompileMs:5900}]},Et=[si,li,ci,di],tt=[{id:"preview",label:"Preview",description:"Instant preview shader — navigate without waiting for compile.",subsystems:{shadows:0,reflections:0,lighting_quality:0,atmosphere_quality:0}},{id:"fastest",label:"Fastest",description:"Path traced lighting with fast glow.",subsystems:{shadows:0,reflections:0,lighting_quality:1,atmosphere_quality:1}},{id:"lite",label:"Lite",description:"Hard shadows, env map reflections, color glow.",subsystems:{shadows:1,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"balanced",label:"Balanced",description:"Soft shadows, env map reflections, color glow.",subsystems:{shadows:2,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"full",label:"Full",description:"Full shadows, raymarched reflections, volumetric.",subsystems:{shadows:3,reflections:3,lighting_quality:1,atmosphere_quality:3}},{id:"ultra",label:"Ultra",description:"Full + PT NEE. Experimental.",isAdvanced:!0,subsystems:{shadows:3,reflections:3,lighting_quality:2,atmosphere_quality:3}}],ui={activePreset:"balanced",subsystems:{...tt[3].subsystems},isCustomized:!1};function fi(e){return tt.find(o=>o.id===e)}function pi(e){for(const o of tt)if(Object.keys(o.subsystems).every(a=>o.subsystems[a]===e[a]))return o.id;return null}function Pn(e){if(!e.activePreset)return"Custom";const o=fi(e.activePreset);if(!o)return"Custom";if(!e.isCustomized)return o.label;const t=[];for(const a of Et){const r=o.subsystems[a.id],i=e.subsystems[a.id];if(r!==i){const n=a.tiers[i];t.push(`${a.label}=${(n==null?void 0:n.label)??"?"}`)}}return`${o.label} (${t.join(", ")})`}const hi=4200;function Tn(e){let o=hi;for(const t of Et){const a=e[t.id]??0,r=t.tiers[a];r&&(o+=r.estCompileMs)}return o}let Ct=null;function mi(e){Ct=e}function no(e,o){const t=o(),a={};for(const r of Et){const i=e[r.id]??0,n=r.tiers[i];if(n)for(const[l,s]of Object.entries(n.overrides))a[l]||(a[l]={}),Object.assign(a[l],s)}for(const[r,i]of Object.entries(a)){const n=`set${r.charAt(0).toUpperCase()+r.slice(1)}`,l=t[n];typeof l=="function"&&l(i)}}function gi(e){if(!Ct)return;const o=Ct(e());R.emit(se.CONFIG,o)}const yi=(e,o)=>({scalability:{...ui},hardwareProfile:null,applyScalabilityPreset:t=>{const a=tt.find(r=>r.id===t);a&&(e({scalability:{activePreset:t,subsystems:{...a.subsystems},isCustomized:!1}}),no(a.subsystems,o))},setSubsystemTier:(t,a)=>{const r=o().scalability,i={...r.subsystems,[t]:a};let n=!1;if(r.activePreset){const s=tt.find(c=>c.id===r.activePreset);s&&(n=Object.keys(i).some(c=>i[c]!==s.subsystems[c]))}else n=!0;const l=pi(i);e({scalability:{activePreset:l??r.activePreset,subsystems:i,isCustomized:l?!1:n}}),no(i,o)},setHardwareProfile:t=>{e({hardwareProfile:t});const r=o().setQuality;typeof r=="function"&&r({compilerHardCap:t.caps.compilerHardCap,precisionMode:t.caps.precisionMode,bufferPrecision:t.caps.bufferPrecision}),gi(o)}});class Mt{constructor(o,t=null){M(this,"defaultState");M(this,"dictionary");M(this,"reverseDictCache",new Map);this.defaultState=o,this.dictionary=t}encode(o,t){try{const a=this.getDiff(o,this.defaultState);if(!a||Object.keys(a).length===0)return"";let r=this.quantize(a);if(!r||Object.keys(r).length===0)return"";this.dictionary&&(r=this.applyDictionary(r,this.dictionary,!0));const i=JSON.stringify(r),n=$t.deflate(i),l=Array.from(n).map(c=>String.fromCharCode(c)).join("");return btoa(l).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}catch(a){return console.error("UrlStateEncoder: Error encoding",a),""}}decode(o){try{if(!o)return null;let t=o.replace(/-/g,"+").replace(/_/g,"/");for(;t.length%4;)t+="=";const a=atob(t),r=new Uint8Array(a.length);for(let l=0;l<a.length;l++)r[l]=a.charCodeAt(l);const i=$t.inflate(r,{to:"string"});let n=JSON.parse(i);return this.dictionary&&(n=this.applyDictionary(n,this.dictionary,!1)),this.deepMerge({...this.defaultState},n)}catch(t){return console.error("UrlStateEncoder: Error decoding",t),null}}getReverseDict(o){if(this.reverseDictCache.has(o))return this.reverseDictCache.get(o);const t={};return Object.keys(o).forEach(a=>{const r=o[a];typeof r=="string"?t[r]=a:t[r._alias]=a}),this.reverseDictCache.set(o,t),t}applyDictionary(o,t,a){if(!o||typeof o!="object"||Array.isArray(o))return o;const r={};if(a)Object.keys(o).forEach(i=>{let n=i,l=null;const s=t[i];s&&(typeof s=="string"?n=s:(n=s._alias,l=s.children));const c=o[i];l&&c&&typeof c=="object"&&!Array.isArray(c)?r[n]=this.applyDictionary(c,l,!0):r[n]=c});else{const i=this.getReverseDict(t);Object.keys(o).forEach(n=>{const l=i[n]||n,s=o[n],c=t[l],u=c&&typeof c=="object"?c.children:null;u&&s&&typeof s=="object"&&!Array.isArray(s)?r[l]=this.applyDictionary(s,u,!1):r[l]=s})}return r}isEqual(o,t){if(o===t)return!0;if(o==null||t==null)return o===t;if(typeof o=="number"&&typeof t=="number")return Math.abs(o-t)<1e-4;if(Array.isArray(o)&&Array.isArray(t))return o.length!==t.length?!1:o.every((a,r)=>this.isEqual(a,t[r]));if(typeof o=="object"&&typeof t=="object"){const a=o,r=t,i=Object.keys(a).filter(l=>!l.startsWith("is")),n=Object.keys(r).filter(l=>!l.startsWith("is"));return i.length!==n.length?!1:i.every(l=>this.isEqual(a[l],r[l]))}return!1}quantize(o){if(typeof o=="string")return o.startsWith("data:image")?void 0:o;if(typeof o=="number")return o===0||Math.abs(o)<1e-9?0:parseFloat(o.toFixed(5));if(Array.isArray(o))return o.map(t=>this.quantize(t));if(o!==null&&typeof o=="object"){const t={};let a=!1;const r=Object.keys(o).filter(i=>!i.startsWith("is"));for(const i of r){const n=this.quantize(o[i]);n!==void 0&&(t[i]=n,a=!0)}return a?t:void 0}return o}getDiff(o,t){if(this.isEqual(o,t))return;if(typeof o!="object"||o===null||typeof t!="object"||t===null||Array.isArray(o))return o;const a={};let r=!1;const i=o,n=t;return Object.keys(i).forEach(l=>{if(l.startsWith("is")||l==="histogramData"||l==="interactionSnapshot"||l==="liveModulations"||l.endsWith("Stack"))return;const s=this.getDiff(i[l],n[l]);s!==void 0&&(a[l]=s,r=!0)}),r?a:void 0}deepMerge(o,t){if(typeof t!="object"||t===null)return t;const a={...o};return Object.keys(t).forEach(r=>{typeof t[r]=="object"&&t[r]!==null&&!Array.isArray(t[r])?a[r]=this.deepMerge(o[r]||{},t[r]):a[r]=t[r]}),a}}const bi=(e,o)=>({isPlaying:!1,isRecording:!1,isScrubbing:!1,recordCamera:!0,isCameraInteracting:!1,currentFrame:0,fps:30,durationFrames:300,loopMode:"Loop",isArmingModulation:!1,isRecordingModulation:!1,recordingSnapshot:null,play:()=>{const t=o();if(t.currentFrame>=t.durationFrames-.1&&e({currentFrame:0}),t.isArmingModulation){t.snapshot();const a=JSON.parse(JSON.stringify(t.sequence));e({isRecordingModulation:!0,isArmingModulation:!1,recordingSnapshot:a,isPlaying:!0,currentFrame:0})}else e({isPlaying:!0})},pause:()=>e({isPlaying:!1,isRecordingModulation:!1,recordingSnapshot:null}),stop:()=>e({isPlaying:!1,currentFrame:0,isRecordingModulation:!1,recordingSnapshot:null}),toggleRecording:()=>e(t=>({isRecording:!t.isRecording})),toggleRecordCamera:()=>e(t=>({recordCamera:!t.recordCamera})),toggleArmModulation:()=>e(t=>({isArmingModulation:!t.isArmingModulation,isRecording:!1})),stopModulationRecording:()=>e({isRecordingModulation:!1,isPlaying:!1,recordingSnapshot:null}),setLoopMode:t=>e({loopMode:t}),setIsScrubbing:t=>e({isScrubbing:t}),setIsCameraInteracting:t=>e({isCameraInteracting:t}),seek:t=>e({currentFrame:Math.max(0,Math.min(o().durationFrames,t))}),setDuration:t=>{e({durationFrames:t})},setFps:t=>{e({fps:t})}}),vi=(e,o)=>({selectedTrackIds:[],selectedKeyframeIds:[],softSelectionRadius:0,softSelectionEnabled:!1,softSelectionType:"S-Curve",bounceTension:.5,bounceFriction:.6,selectTrack:(t,a)=>e(r=>({selectedTrackIds:a?r.selectedTrackIds.includes(t)?r.selectedTrackIds.filter(i=>i!==t):[...r.selectedTrackIds,t]:[t]})),selectTracks:(t,a)=>e(r=>{const i=new Set(r.selectedTrackIds);return a?t.forEach(n=>i.add(n)):t.forEach(n=>i.delete(n)),{selectedTrackIds:Array.from(i)}}),selectKeyframe:(t,a,r)=>e(i=>{const n=`${t}::${a}`;return{selectedKeyframeIds:r?i.selectedKeyframeIds.includes(n)?i.selectedKeyframeIds.filter(l=>l!==n):[...i.selectedKeyframeIds,n]:[n]}}),selectKeyframes:(t,a)=>e(r=>({selectedKeyframeIds:a?Array.from(new Set([...r.selectedKeyframeIds,...t])):t})),deselectAll:()=>e({selectedTrackIds:[],selectedKeyframeIds:[]}),deselectAllKeys:()=>e({selectedKeyframeIds:[]}),setSoftSelection:(t,a)=>e({softSelectionRadius:t,softSelectionEnabled:a}),setSoftSelectionType:t=>e({softSelectionType:t}),setBouncePhysics:(t,a)=>e({bounceTension:t,bounceFriction:a})});function jo(e,o,t,a,r){const i=1-e,n=e*e,l=i*i,s=l*i,c=n*e;return s*o+3*l*e*t+3*i*n*a+c*r}function so(e,o){let t=o[0],a=o[o.length-1];for(let u=0;u<o.length-1;u++)if(e>=o[u].frame&&e<o[u+1].frame){t=o[u],a=o[u+1];break}if(e>=a.frame)return a.value;if(e<=t.frame)return t.value;const r=a.frame-t.frame,i=(e-t.frame)/r;if(t.interpolation==="Step")return t.value;if(t.interpolation==="Linear")return t.value+(a.value-t.value)*i;const n=t.value,l=t.value+(t.rightTangent?t.rightTangent.y:0),s=a.value+(a.leftTangent?a.leftTangent.y:0),c=a.value;return jo(i,n,l,s,c)}function xi(e,o=1){const t=[],a=e[0].frame,r=e[e.length-1].frame,i=Math.max(o,(r-a)/50);for(let n=a;n<=r;n+=i)t.push({t:n,val:so(n,e)});return t.length>0&&t[t.length-1].t<r&&t.push({t:r,val:so(r,e)}),t}function Si(e,o,t){let a=0,r=0,i=0,n=0,l=0,s=0,c=0;for(let m=0;m<e.length;m++){const y=e[m].t,b=1-y,_=e[m].val;s+=_,c+=_*_;const E=3*b*b*y,S=3*b*y*y,C=b*b*b*o+y*y*y*t,T=_-C;a+=E*E,r+=E*S,i+=S*S,n+=T*E,l+=T*S}const u=e.length,f=s/u;if(c/u-f*f<1e-9)return null;const h=a*i-r*r;if(Math.abs(h)<1e-9)return null;const g=(i*n-r*l)/h,v=(a*l-r*n)/h;return{h1:g,h2:v}}function wi(e,o){const t=e.length;if(t<2){const h=e[0].val;return{leftY:h,rightY:h}}const a=e[0].val,r=e[t-1].val,i=r-a,n=a+i*.333,l=a+i*.666,s=Si(e,a,r);let c=n,u=l;s&&(c=s.h1,u=s.h2);const f=n+(c-n)*o,p=l+(u-l)*o;return{leftY:f,rightY:p}}function Rt(e,o,t,a){if(e.length<2)return;const r=e[0],i=e[e.length-1],n=i.t-r.t,l=e.map(p=>({t:(p.t-r.t)/n,val:p.val})),{leftY:s,rightY:c}=wi(l,a);let u=0,f=-1;if(n<1)u=0;else for(let p=1;p<l.length-1;p++){const h=l[p].t,g=jo(h,r.val,s,c,i.val),v=Math.abs(g-l[p].val);v>u&&(u=v,f=p)}if(u<=t||e.length<=2){const p=o[o.length-1];p&&(p.rightTangent={x:n*.333,y:s-r.val});const h={id:Me(),frame:i.t,value:i.val,interpolation:"Bezier",brokenTangents:!1,autoTangent:!1,leftTangent:{x:-n*.333,y:c-i.val},rightTangent:{x:1,y:0}};o.push(h)}else{const p=e.slice(0,f+1),h=e.slice(f);Rt(p,o,t,a),Rt(h,o,t,a)}}const _i=(e,o,t=1)=>{if(e.length<2)return e;t=Math.max(0,Math.min(1,t));const a=[...e].sort((l,s)=>l.frame-s.frame),r=xi(a,1),i=[],n=r[0];return i.push({id:Me(),frame:n.t,value:n.val,interpolation:"Bezier",brokenTangents:!1,autoTangent:!1,leftTangent:{x:-1,y:0},rightTangent:{x:1,y:0}}),Rt(r,i,o,t),i.length>0&&(i[0].leftTangent={x:-1,y:0},i[i.length-1].rightTangent={x:1,y:0}),i},Ii=4;function No(e,o,t,a,r){const i=1-e,n=e*e,l=i*i,s=l*i,c=n*e;return s*o+3*l*e*t+3*i*n*a+c*r}function Ci(e,o,t,a,r){const i=1-e;return 3*i*i*(t-o)+6*i*e*(a-t)+3*e*e*(r-a)}function Mi(e,o,t,a,r){const i=r-o;if(i<=1e-9)return 0;let n=(e-o)/i;for(let l=0;l<Ii;++l){const s=No(n,o,t,a,r),c=Ci(n,o,t,a,r);if(Math.abs(c)<1e-9)break;const u=s-e;n-=u/c}return Math.max(0,Math.min(1,n))}function Ri(e,o,t,a,r,i,n,l,s){const c=o,u=t,f=o+a,p=t+r,h=i+l,g=n+s,v=i,m=n,y=Mi(e,c,f,h,v);return No(y,u,p,g,m)}const be=.333,ke={interpolate:(e,o,t,a=!1)=>{if(o.interpolation==="Step")return o.value;let r=o.value,i=t.value;if(a){const s=Math.PI*2,c=i-r;c>Math.PI?i-=s:c<-Math.PI&&(i+=s)}if(o.interpolation==="Bezier"){const s=o.rightTangent?o.rightTangent.x:(t.frame-o.frame)*be,c=o.rightTangent?o.rightTangent.y:0,u=t.leftTangent?t.leftTangent.x:-(t.frame-o.frame)*be,f=t.leftTangent?t.leftTangent.y:0;return Ri(e,o.frame,r,s,c,t.frame,i,u,f)}const n=t.frame-o.frame;if(n<1e-9)return r;const l=(e-o.frame)/n;return r+(i-r)*l},scaleHandles:(e,o,t,a,r)=>{const i={};if(e.interpolation!=="Bezier")return i;if(o&&e.leftTangent){const n=a-o.frame,l=r-o.frame;if(Math.abs(n)>1e-5&&Math.abs(l)>1e-5){const s=l/n;i.leftTangent={x:e.leftTangent.x*s,y:e.leftTangent.y*s}}}if(t&&e.rightTangent){const n=t.frame-a,l=t.frame-r;if(Math.abs(n)>1e-5&&Math.abs(l)>1e-5){const s=l/n;i.rightTangent={x:e.rightTangent.x*s,y:e.rightTangent.y*s}}}return i},calculateTangents:(e,o,t,a)=>{if(a==="Ease"){const m=o?(e.frame-o.frame)*be:10,y=t?(t.frame-e.frame)*be:10;return{l:{x:-m,y:0},r:{x:y,y:0}}}if(!o&&!t)return{l:{x:-10,y:0},r:{x:10,y:0}};if(!o){const m=(t.value-e.value)/(t.frame-e.frame),y=(t.frame-e.frame)*be;return{l:{x:-10,y:0},r:{x:y,y:y*m}}}if(!t){const m=(e.value-o.value)/(e.frame-o.frame),y=(e.frame-o.frame)*be;return{l:{x:-y,y:-y*m},r:{x:10,y:0}}}const r=e.frame-o.frame,i=e.value-o.value,n=r===0?0:i/r,l=t.frame-e.frame,s=t.value-e.value,c=l===0?0:s/l;if(n*c<=0){const m=r*be,y=l*be;return{l:{x:-m,y:0},r:{x:y,y:0}}}const u=t.frame-o.frame,f=t.value-o.value;let p=u===0?0:f/u;const h=3*Math.min(Math.abs(n),Math.abs(c));Math.abs(p)>h&&(p=Math.sign(p)*h);const g=r*be,v=l*be;return{l:{x:-g,y:-g*p},r:{x:v,y:v*p}}},constrainHandles:(e,o,t)=>{var r,i;const a={};if(e.leftTangent&&o){const n=e.frame-o.frame;if(n>.001){const l=n*be;if(Math.abs(e.leftTangent.x)>l){const s=l/Math.abs(e.leftTangent.x);a.leftTangent={x:e.leftTangent.x*s,y:e.leftTangent.y*s}}e.leftTangent.x>0&&(a.leftTangent={x:0,y:((r=a.leftTangent)==null?void 0:r.y)??e.leftTangent.y})}}if(e.rightTangent&&t){const n=t.frame-e.frame;if(n>.001){const l=n*be;if(Math.abs(e.rightTangent.x)>l){const s=l/Math.abs(e.rightTangent.x);a.rightTangent={x:e.rightTangent.x*s,y:e.rightTangent.y*s}}e.rightTangent.x<0&&(a.rightTangent={x:0,y:((i=a.rightTangent)==null?void 0:i.y)??e.rightTangent.y})}}return a},calculateSoftFalloff:(e,o,t)=>{if(e>=o)return 0;const a=e/o;switch(t){case"Linear":return 1-a;case"Dome":return Math.sqrt(1-a*a);case"Pinpoint":return Math.pow(1-a,4);case"S-Curve":return .5*(1+Math.cos(a*Math.PI));default:return 1-a}}},vt={updateNeighbors:(e,o)=>{const t=e[o],a=o===e.length-1,r=o-1;if(r>=0){const n={...e[r]};if(e[r]=n,n.interpolation==="Bezier"){const l=t.frame-n.frame;if(n.autoTangent){const s=e[r-1],{l:c,r:u}=ke.calculateTangents(n,s,t,"Auto");n.leftTangent=c,n.rightTangent=u}else{const s=ke.constrainHandles(n,e[r-1],t);Object.assign(n,s)}if(a&&l>1e-4){const s=l*.3,c=n.rightTangent||{x:10,y:0};if(c.x<s){const u=s/Math.max(1e-4,Math.abs(c.x));n.rightTangent={x:s,y:c.y*u}}}}}const i=o+1;if(i<e.length){const n={...e[i]};if(e[i]=n,n.interpolation==="Bezier")if(n.autoTangent){const l=e[i+1],{l:s,r:c}=ke.calculateTangents(n,t,l,"Auto");n.leftTangent=s,n.rightTangent=c}else{const l=ke.constrainHandles(n,t,e[i+1]);Object.assign(n,l)}}},inferInterpolation:(e,o)=>{const t=e.filter(a=>a.frame<o).sort((a,r)=>r.frame-a.frame);return t.length===0||t[0].interpolation==="Linear"?"Linear":t[0].interpolation==="Step"?"Step":"Bezier"}},Li=Oe(),Pi={durationFrames:300,fps:30,tracks:{}},Ti=(e,o)=>({sequence:Pi,clipboard:null,undoStack:[],redoStack:[],snapshot:()=>{const t=o().sequence,a=JSON.parse(JSON.stringify(t));e(r=>{const i=[...r.undoStack,{type:"SEQUENCE",data:a}];return{undoStack:i.length>50?i.slice(1):i,redoStack:[]}})},undo:()=>{const{undoStack:t,redoStack:a,sequence:r}=o();if(t.length===0)return!1;const i=t[t.length-1],n=t.slice(0,-1),s={type:"SEQUENCE",data:JSON.parse(JSON.stringify(r))};return e({sequence:i.data,undoStack:n,redoStack:[...a,s]}),!0},redo:()=>{const{undoStack:t,redoStack:a,sequence:r}=o();if(a.length===0)return!1;const i=a[a.length-1],n=a.slice(0,-1),s={type:"SEQUENCE",data:JSON.parse(JSON.stringify(r))};return e({sequence:i.data,undoStack:[...t,s],redoStack:n}),!0},setSequence:t=>{o().snapshot(),e({sequence:t})},addTrack:(t,a)=>{o().snapshot(),e(r=>r.sequence.tracks[t]?r:{sequence:{...r.sequence,tracks:{...r.sequence.tracks,[t]:{id:t,type:"float",label:a,keyframes:[]}}}})},removeTrack:t=>{o().snapshot(),e(a=>{const r={...a.sequence.tracks};return delete r[t],{sequence:{...a.sequence,tracks:r},selectedTrackIds:a.selectedTrackIds.filter(i=>i!==t)}})},setTrackBehavior:(t,a)=>{o().snapshot(),e(r=>{const i=r.sequence.tracks[t];return i?{sequence:{...r.sequence,tracks:{...r.sequence.tracks,[t]:{...i,postBehavior:a}}}}:r})},addKeyframe:(t,a,r,i)=>{e(n=>{const l=n.sequence.tracks[t];if(!l)return n;let s=i||"Bezier";i||(s=vt.inferInterpolation(l.keyframes,a));const c=s==="Bezier",u={id:Me(),frame:a,value:r,interpolation:s,autoTangent:c,brokenTangents:!1},p=[...l.keyframes.filter(g=>Math.abs(g.frame-a)>.001),u].sort((g,v)=>g.frame-v.frame),h=p.findIndex(g=>g.id===u.id);if(s==="Bezier"){const g=h>0?p[h-1]:void 0,v=h<p.length-1?p[h+1]:void 0,{l:m,r:y}=ke.calculateTangents(u,g,v,"Auto");u.leftTangent=m,u.rightTangent=y}return vt.updateNeighbors(p,h),{sequence:{...n.sequence,tracks:{...n.sequence.tracks,[t]:{...l,keyframes:p}}}}})},batchAddKeyframes:(t,a,r)=>{e(i=>{const n={...i.sequence.tracks};let l=!1;return a.forEach(({trackId:s,value:c})=>{n[s]||(n[s]={id:s,type:"float",label:s,keyframes:[]},l=!0);const u=n[s],f=[...u.keyframes],p=f.length>0?f[f.length-1]:null,h={id:Me(),frame:t,value:c,interpolation:r||"Linear",autoTangent:r==="Bezier",brokenTangents:!1};if(p)if(t>p.frame)f.push(h);else if(Math.abs(t-p.frame)<.001)h.id=p.id,f[f.length-1]=h;else{const g=f.filter(v=>Math.abs(v.frame-t)>.001);g.push(h),g.sort((v,m)=>v.frame-m.frame),u.keyframes=g,l=!0;return}else f.push(h);u.keyframes=f,l=!0}),l?{sequence:{...i.sequence,tracks:n}}:i})},removeKeyframe:(t,a)=>{o().snapshot(),e(r=>{const i=r.sequence.tracks[t];return i?{sequence:{...r.sequence,tracks:{...r.sequence.tracks,[t]:{...i,keyframes:i.keyframes.filter(n=>n.id!==a)}}}}:r})},updateKeyframe:(t,a,r)=>{e(i=>{const n=i.sequence.tracks[t];if(!n)return i;const l=n.keyframes.map(s=>s.id===a?{...s,...r}:s).sort((s,c)=>s.frame-c.frame);return{sequence:{...i.sequence,tracks:{...i.sequence.tracks,[t]:{...n,keyframes:l}}}}})},updateKeyframes:t=>{e(a=>{const r={...a.sequence.tracks};return t.forEach(({trackId:i,keyId:n,patch:l})=>{const s=r[i];if(s){const c=s.keyframes.findIndex(u=>u.id===n);if(c!==-1){const u=s.keyframes[c];l.interpolation==="Bezier"&&u.interpolation!=="Bezier"&&(l.autoTangent=!0),s.keyframes[c]={...u,...l}}}}),Object.keys(r).forEach(i=>{r[i].keyframes.sort((n,l)=>n.frame-l.frame)}),{sequence:{...a.sequence,tracks:r}}})},deleteSelectedKeyframes:()=>{o().snapshot(),e(t=>{const a={...t.sequence.tracks},r=new Set(t.selectedKeyframeIds);return Object.keys(a).forEach(i=>{a[i]={...a[i],keyframes:a[i].keyframes.filter(n=>!r.has(`${i}::${n.id}`))}}),{sequence:{...t.sequence,tracks:a},selectedKeyframeIds:[]}})},deleteAllKeys:()=>{o().snapshot(),e(t=>{const a={...t.sequence.tracks};return Object.keys(a).forEach(r=>{a[r]={...a[r],keyframes:[]}}),{sequence:{...t.sequence,tracks:a},selectedKeyframeIds:[]}})},deleteAllTracks:()=>{o().snapshot(),e({sequence:{...o().sequence,tracks:{}},selectedTrackIds:[],selectedKeyframeIds:[]})},setTangents:t=>{o().snapshot(),e(a=>{const r={...a.sequence.tracks};return a.selectedKeyframeIds.forEach(i=>{const[n,l]=i.split("::"),s=r[n];if(s){const c=s.keyframes.findIndex(f=>f.id===l);if(c===-1)return;const u=s.keyframes[c];if(t==="Split")s.keyframes[c]={...u,brokenTangents:!0,autoTangent:!1};else if(t==="Unified"){let f=u.rightTangent,p=u.leftTangent;if(f&&p){const h=Math.sqrt(f.x*f.x+f.y*f.y),g=Math.sqrt(p.x*p.x+p.y*p.y);f={x:-p.x*(h/Math.max(.001,g)),y:-p.y*(h/Math.max(.001,g))}}s.keyframes[c]={...u,rightTangent:f,brokenTangents:!1,autoTangent:!1}}else if(t==="Auto"||t==="Ease"){const f=s.keyframes[c-1],p=s.keyframes[c+1],{l:h,r:g}=ke.calculateTangents(u,f,p,t);s.keyframes[c]={...u,autoTangent:t==="Auto",brokenTangents:!1,leftTangent:h,rightTangent:g}}}}),{sequence:{...a.sequence,tracks:r}}})},setGlobalInterpolation:(t,a)=>{o().snapshot(),e(r=>{const i={...r.sequence.tracks};return Object.keys(i).forEach(n=>{const l=i[n];l.keyframes.length!==0&&l.keyframes.forEach((s,c)=>{if(s.interpolation=t,t==="Bezier"&&a){const u=l.keyframes[c-1],f=l.keyframes[c+1],{l:p,r:h}=ke.calculateTangents(s,u,f,a);s.leftTangent=p,s.rightTangent=h,s.autoTangent=a==="Auto",s.brokenTangents=!1}})}),{sequence:{...r.sequence,tracks:i}}})},copySelectedKeyframes:()=>{const{sequence:t,selectedKeyframeIds:a}=o();if(a.length===0)return;let r=1/0;a.forEach(n=>{var u,f;const[l,s]=n.split("::"),c=(f=(u=t.tracks[l])==null?void 0:u.keyframes.find(p=>p.id===s))==null?void 0:f.frame;c!==void 0&&c<r&&(r=c)});const i=[];a.forEach(n=>{var u;const[l,s]=n.split("::"),c=(u=t.tracks[l])==null?void 0:u.keyframes.find(f=>f.id===s);c&&i.push({relativeFrame:c.frame-r,value:c.value,interpolation:c.interpolation,leftTangent:c.leftTangent,rightTangent:c.rightTangent,originalTrackId:l})}),i.length>0&&e({clipboard:i})},pasteKeyframes:t=>{const{clipboard:a,currentFrame:r}=o();a&&(o().snapshot(),e(i=>{const n={...i.sequence.tracks},l=t!==void 0?t:r;return a.forEach(s=>{const c=n[s.originalTrackId];if(c){const u=l+s.relativeFrame,f={id:Me(),frame:u,value:s.value,interpolation:s.interpolation,leftTangent:s.leftTangent,rightTangent:s.rightTangent,autoTangent:!1,brokenTangents:!1};c.keyframes=[...c.keyframes.filter(p=>Math.abs(p.frame-u)>.001),f].sort((p,h)=>p.frame-h.frame)}}),{sequence:{...i.sequence,tracks:n}}}))},duplicateSelection:()=>{o().copySelectedKeyframes(),o().pasteKeyframes(o().currentFrame)},loopSelection:t=>{const a=o();if(a.selectedKeyframeIds.length<1)return;a.snapshot();let r=1/0,i=-1/0;if(a.selectedKeyframeIds.forEach(l=>{const[s,c]=l.split("::"),u=a.sequence.tracks[s],f=u==null?void 0:u.keyframes.find(p=>p.id===c);f&&(f.frame<r&&(r=f.frame),f.frame>i&&(i=f.frame))}),r===1/0||i===-1/0)return;const n=Math.max(1,i-r);e(l=>{const s={...l.sequence.tracks};for(let c=1;c<=t;c++){const u=n*c;l.selectedKeyframeIds.forEach(f=>{const[p,h]=f.split("::"),g=s[p];if(!g)return;const v=g.keyframes.find(m=>m.id===h);if(v){const m=v.frame+u,y={...v,id:Me(),frame:m};g.keyframes=[...g.keyframes.filter(b=>Math.abs(b.frame-m)>.001),y]}})}return Object.values(s).forEach(c=>c.keyframes.sort((u,f)=>u.frame-f.frame)),{sequence:{...l.sequence,tracks:s}}})},captureCameraFrame:(t,a=!1,r)=>{const i=Be()||Li.activeCamera;if(!i)return;a||o().snapshot();const n=et.getUnifiedFromEngine(),l=i.quaternion,s=new Ge().setFromQuaternion(l),c=[{id:"camera.unified.x",val:n.x,label:"Position X"},{id:"camera.unified.y",val:n.y,label:"Position Y"},{id:"camera.unified.z",val:n.z,label:"Position Z"},{id:"camera.rotation.x",val:s.x,label:"Rotation X"},{id:"camera.rotation.y",val:s.y,label:"Rotation Y"},{id:"camera.rotation.z",val:s.z,label:"Rotation Z"}];e(u=>{const f={...u.sequence.tracks},p=f["camera.unified.x"],h=!p||p.keyframes.length===0,g=r||(h?"Linear":"Bezier");return c.forEach(v=>{let m=f[v.id];m||(m={id:v.id,type:"float",label:v.label,keyframes:[],hidden:!1},f[v.id]=m);const y={id:Me(),frame:t,value:v.val,interpolation:g,autoTangent:g==="Bezier",brokenTangents:!1},_=[...m.keyframes.filter(S=>Math.abs(S.frame-t)>.001),y].sort((S,C)=>S.frame-C.frame),E=_.findIndex(S=>S.id===y.id);if(g==="Bezier"){const S=E>0?_[E-1]:void 0,C=E<_.length-1?_[E+1]:void 0,{l:T,r:L}=ke.calculateTangents(y,S,C,"Auto");y.leftTangent=T,y.rightTangent=L}vt.updateNeighbors(_,E),m.keyframes=_}),{sequence:{...u.sequence,tracks:f}}})},simplifySelectedKeys:(t=.01)=>{o().snapshot(),e(a=>{const r=a,i={...r.sequence.tracks},n=new Set(r.selectedKeyframeIds),l={};r.selectedKeyframeIds.forEach(c=>{const[u,f]=c.split("::");l[u]||(l[u]=[]);const p=r.sequence.tracks[u],h=p==null?void 0:p.keyframes.find(g=>g.id===f);h&&l[u].push(h)});const s=[];return Object.entries(l).forEach(([c,u])=>{const f=i[c];if(!f)return;const p={...f};if(i[c]=p,u.length<3)return;const h=u.sort((v,m)=>v.frame-m.frame);p.keyframes=p.keyframes.filter(v=>!n.has(`${c}::${v.id}`));const g=_i(h,t);p.keyframes=[...p.keyframes,...g].sort((v,m)=>v.frame-m.frame),g.forEach(v=>s.push(`${c}::${v.id}`))}),{sequence:{...r.sequence,tracks:i},selectedKeyframeIds:s}})}}),Lt=bo()(vo((e,o,t)=>({...bi(e,o),...vi(e),...Ti(e,o)})));typeof window<"u"&&(window.useAnimationStore=Lt);const Ke=Oe(),st=e=>{const o={};return e&&Object.keys(e).forEach(t=>{if(t.startsWith("is"))return;const a=e[t];if(a&&typeof a=="object"&&"isColor"in a)o[t]="#"+a.getHexString();else if(a&&typeof a=="object"&&("isVector2"in a||"isVector3"in a)){const r={...a};delete r.isVector2,delete r.isVector3,o[t]=r}else o[t]=a}),o},$o=e=>{const o=he.get(e),t=o&&o.defaultPreset?o.defaultPreset:{},a={version:5,name:e,formula:e,features:{}};return j.getAll().forEach(r=>{const i={};Object.entries(r.params).forEach(([n,l])=>{l.composeFrom||(i[n]=l.default)}),a.features[r.id]=st(i)}),t.features&&Object.entries(t.features).forEach(([r,i])=>{a.features[r]?a.features[r]={...a.features[r],...st(i)}:a.features[r]=st(i)}),t.lights&&(a.features.lighting||(a.features.lighting={}),a.features.lighting.lights=t.lights),t.renderMode&&(a.features.lighting||(a.features.lighting={}),a.features.lighting.renderMode=t.renderMode==="PathTracing"?1:0),a.cameraMode=t.cameraMode||"Orbit",a.quality={aaMode:"Always",aaLevel:1,msaa:1,accumulation:!0,...t.quality||{}},a.lights=[],a.animations=t.animations||[],a.navigation={flySpeed:.5,autoSlow:!0,...t.navigation||{}},a.sceneOffset=t.sceneOffset||{x:0,y:0,z:0,xL:0,yL:0,zL:0},a.cameraPos=t.cameraPos||{x:0,y:0,z:3.5},a.cameraRot=t.cameraRot||{x:0,y:0,z:0,w:1},a.targetDistance=t.targetDistance||3.5,a.duration=t.duration||300,a.sequence=t.sequence||{durationFrames:300,fps:30,tracks:{}},a},Ei=(e,o,t)=>{const a=t(),r=e.features||{};if(e.renderMode&&(r.lighting||(r.lighting={}),r.lighting.renderMode===void 0&&(r.lighting.renderMode=e.renderMode==="PathTracing"?1:0)),r.atmosphere&&!r.ao){const b={};r.atmosphere.aoIntensity!==void 0&&(b.aoIntensity=r.atmosphere.aoIntensity),r.atmosphere.aoSpread!==void 0&&(b.aoSpread=r.atmosphere.aoSpread),r.atmosphere.aoMode!==void 0&&(b.aoMode=r.atmosphere.aoMode),r.atmosphere.aoEnabled!==void 0&&(b.aoEnabled=r.atmosphere.aoEnabled),Object.keys(b).length>0&&(r.ao=b)}const i=new Set(["compilerHardCap","precisionMode","bufferPrecision"]);if(j.getAll().forEach(b=>{const _=`set${b.id.charAt(0).toUpperCase()+b.id.slice(1)}`,E=a[_];if(typeof E=="function"){const S=r[b.id],C={},T=b.id==="quality"?t().quality:null;if(b.state&&Object.assign(C,b.state),Object.entries(b.params).forEach(([L,F])=>{if(b.id==="quality"&&i.has(L)&&T){C[L]=T[L];return}if(S&&S[L]!==void 0){let x=S[L];F.type==="vec2"&&x&&!(x instanceof ve)?x=new ve(x.x,x.y):F.type==="vec3"&&x&&!(x instanceof N)?x=new N(x.x,x.y,x.z):F.type==="color"&&x&&!(x instanceof le)&&(x=new le(x)),C[L]=x}else if(C[L]===void 0){let x=F.default;x&&typeof x=="object"&&(typeof x.clone=="function"?x=x.clone():Array.isArray(x)?x=[...x]:x={...x}),C[L]=x}}),b.id==="lighting"&&S){if(S.lights)C.lights=eo(S.lights.map(L=>({...L,type:L.type||"Point",rotation:L.rotation||{x:0,y:0,z:0}})));else if(S.light0_posX!==void 0){const L=[];for(let F=0;F<3;F++)if(S[`light${F}_posX`]!==void 0){let x=S[`light${F}_color`]||"#ffffff";x.getHexString&&(x="#"+x.getHexString()),L.push({type:"Point",position:{x:S[`light${F}_posX`],y:S[`light${F}_posY`],z:S[`light${F}_posZ`]},rotation:{x:0,y:0,z:0},color:x,intensity:S[`light${F}_intensity`]??1,falloff:S[`light${F}_falloff`]??0,falloffType:S[`light${F}_type`]?"Linear":"Quadratic",fixed:S[`light${F}_fixed`]??!1,visible:S[`light${F}_visible`]??F===0,castShadow:S[`light${F}_castShadow`]??!0})}L.length>0&&(C.lights=L)}}b.id==="materials"&&S&&S.envMapVisible!==void 0&&S.envBackgroundStrength===void 0&&(C.envBackgroundStrength=S.envMapVisible?1:0),E(C)}}),e.lights&&e.lights.length>0){const b=a.setLighting;if(typeof b=="function"){const _=eo(e.lights.map(E=>({...E,type:E.type||"Point",rotation:E.rotation||{x:0,y:0,z:0}})));b({lights:_})}}e.sequence&&Lt.getState().setSequence(e.sequence),a.setAnimations(e.animations||[]),e.savedCameras&&Array.isArray(e.savedCameras)&&e.savedCameras.length>0&&o({savedCameras:e.savedCameras,activeCameraId:e.savedCameras[0].id||null});const n=e.cameraPos||{x:0,y:0,z:3.5},l=e.sceneOffset||{x:0,y:0,z:0,xL:0,yL:0,zL:0},s=e.targetDistance||3.5,c=e.cameraRot||{x:0,y:0,z:0,w:1},u=l.x+l.xL+n.x,f=l.y+l.yL+n.y,p=l.z+l.zL+n.z,h=G.split(u),g=G.split(f),v=G.split(p),m={x:h.high,y:g.high,z:v.high,xL:h.low,yL:g.low,zL:v.low};o({cameraRot:c,targetDistance:s,sceneOffset:m,cameraMode:e.cameraMode||t().cameraMode}),Ke.activeCamera&&Ke.virtualSpace&&Ke.virtualSpace.applyCameraState(Ke.activeCamera,{position:{x:0,y:0,z:0},rotation:c,sceneOffset:m,targetDistance:s});const y={position:{x:0,y:0,z:0},rotation:c,sceneOffset:m,targetDistance:s};Ke.pendingTeleport=y,R.emit("camera_teleport",y),e.duration&&Lt.getState().setDuration(e.duration),e.formula==="Modular"&&a.refreshPipeline(),a.refreshHistogram(),R.emit("reset_accum",void 0)},ki={formula:"Mandelbulb",cameraPos:{x:0,y:0,z:0},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:0,xL:0,yL:0,zL:0},targetDistance:3.5,cameraMode:"Orbit"},zi=(e,o,t={includeAnimations:!0})=>{try{e.quality&&(delete e.quality.aaLevel,delete e.quality.aaMode,delete e.quality.msaa),e.features&&e.features.quality&&delete e.features.quality.resolutionMode,t.includeAnimations===!1&&(delete e.sequence,delete e.animations);const a=$o(e.formula);a.formula="";const r=j.getDictionary();return new Mt(a,r).encode(e,o)}catch(a){return console.error("Sharing: Failed to generate share string",a),""}},En=e=>{if(!e)return null;try{const o=j.getDictionary(),a=new Mt(ki,o).decode(e);if(a&&a.formula){const r=$o(a.formula);return new Mt(r,o).decode(e)}}catch(o){console.error("Sharing: Failed to load share string",o)}return null},xt=Oe();class Ai{constructor(){M(this,"pendingCam");M(this,"binders",new Map);M(this,"overriddenTracks",new Set);M(this,"lastCameraIndex",-1);M(this,"animStore",null);M(this,"fractalStore",null);this.pendingCam={rot:new Ge,unified:new N,rotDirty:!1,unifiedDirty:!1}}connect(o,t){this.animStore=o,this.fractalStore=t}setOverriddenTracks(o){this.overriddenTracks=o}getBinder(o){if(this.binders.has(o))return this.binders.get(o);let t=()=>{};if(o==="camera.active_index")t=a=>{const r=Math.round(a);if(r!==this.lastCameraIndex){const i=this.fractalStore.getState(),n=i.savedCameras;n&&n[r]&&(i.selectCamera(n[r].id),this.lastCameraIndex=r)}};else if(o.startsWith("camera.")){const a=o.split("."),r=a[1],i=a[2];r==="unified"?t=n=>{this.pendingCam.unified[i]=n,this.pendingCam.unifiedDirty=!0}:r==="rotation"&&(t=n=>{this.pendingCam.rot[i]=n,this.pendingCam.rotDirty=!0})}else if(o.startsWith("lights.")){const a=o.split("."),r=parseInt(a[1]),i=a[2];let n="";i==="position"?n=`pos${a[3].toUpperCase()}`:i==="color"?n="color":n=i;const l=`lighting.light${r}_${n}`;return this.getBinder(l)}else if(o.startsWith("lighting.light")){const a=o.match(/lighting\.light(\d+)_(\w+)/);if(a){const r=parseInt(a[1]),i=a[2],n=this.fractalStore.getState();if(i==="intensity")t=l=>n.updateLight({index:r,params:{intensity:l}});else if(i==="falloff")t=l=>n.updateLight({index:r,params:{falloff:l}});else if(i.startsWith("pos")){const l=i.replace("pos","").toLowerCase();t=s=>{var f;const u=(f=this.fractalStore.getState().lighting)==null?void 0:f.lights[r];if(u){const p={...u.position,[l]:s};n.updateLight({index:r,params:{position:p}})}}}else if(i.startsWith("rot")){const l=i.replace("rot","").toLowerCase();t=s=>{var f;const u=(f=this.fractalStore.getState().lighting)==null?void 0:f.lights[r];if(u){const p={...u.rotation,[l]:s};n.updateLight({index:r,params:{rotation:p}})}}}}}else if(o.includes(".")){const a=o.split("."),r=a[0],i=a[1];if(j.get(r)){const l=this.fractalStore.getState(),s=`set${r.charAt(0).toUpperCase()+r.slice(1)}`,c=l[s];if(c&&typeof c=="function"){const u=i.match(/^(vec[23][ABC])_(x|y|z)$/);if(u){const f=u[1],p=u[2];t=h=>{var m;const v=(m=this.fractalStore.getState()[r])==null?void 0:m[f];if(v){const y=v.clone();y[p]=h,c({[f]:y})}}}else t=f=>c({[i]:f})}else console.warn(`AnimationEngine: Setter ${s} not found for feature ${r}`)}}else{const a=this.fractalStore.getState(),r="set"+o.charAt(0).toUpperCase()+o.slice(1);typeof a[r]=="function"&&(t=i=>a[r](i))}return this.binders.set(o,t),t}tick(o){if(!this.animStore)return;const t=this.animStore.getState();if(!t.isPlaying)return;const a=t.fps,r=t.currentFrame,i=t.durationFrames,n=t.loopMode,l=o*a;let s=r+l;if(s>=i)if(n==="Once"||t.isRecordingModulation){s=i,this.scrub(i),this.animStore.setState({isPlaying:!1,currentFrame:i}),t.isRecordingModulation&&t.stopModulationRecording();return}else s=0;this.animStore.setState({currentFrame:s}),this.scrub(s)}scrub(o){if(!this.animStore)return;const{sequence:t,isPlaying:a,isRecording:r,recordCamera:i}=this.animStore.getState(),n=Object.values(t.tracks);this.syncBuffersFromEngine();const l=a&&r&&i;for(let s=0;s<n.length;s++){const c=n[s];if(this.overriddenTracks.has(c.id)||c.keyframes.length===0||c.type!=="float"||c.id.includes("camera.position")||c.id.includes("camera.offset")||l&&c.id.startsWith("camera."))continue;const u=this.interpolate(c,o);this.getBinder(c.id)(u)}this.commitState()}syncBuffersFromEngine(){const o=Be()||xt.activeCamera;if(o){this.pendingCam.rot.setFromQuaternion(o.quaternion);const t=xt.sceneOffset;this.pendingCam.unified.set(t.x+t.xL+o.position.x,t.y+t.yL+o.position.y,t.z+t.zL+o.position.z),this.pendingCam.rotDirty=!1,this.pendingCam.unifiedDirty=!1}}interpolate(o,t){const a=o.keyframes;if(a.length===0)return 0;const r=a[0],i=a[a.length-1],n=o.id.startsWith("camera.rotation")||o.id.includes("rot")||o.id.includes("phase")||o.id.includes("twist");if(t>i.frame){const l=o.postBehavior||"Hold";if(l==="Hold")return i.value;if(l==="Continue"){let h=0;if(a.length>1){const g=a[a.length-2];i.interpolation==="Linear"?h=(i.value-g.value)/(i.frame-g.frame):i.interpolation==="Bezier"&&(i.leftTangent&&Math.abs(i.leftTangent.x)>.001?h=i.leftTangent.y/i.leftTangent.x:h=(i.value-g.value)/(i.frame-g.frame))}return i.value+h*(t-i.frame)}const s=i.frame-r.frame;if(s<=.001)return i.value;const c=t-r.frame,u=Math.floor(c/s),f=r.frame+c%s,p=this.evaluateCurveInternal(a,f,n);if(l==="Loop")return p;if(l==="PingPong"){if(u%2===1){const g=i.frame-c%s;return this.evaluateCurveInternal(a,g,n)}return p}if(l==="OffsetLoop"){const h=i.value-r.value;return p+h*u}}return t<r.frame?r.value:this.evaluateCurveInternal(a,t,n)}evaluateCurveInternal(o,t,a){for(let r=0;r<o.length-1;r++){const i=o[r],n=o[r+1];if(t>=i.frame&&t<=n.frame)return ke.interpolate(t,i,n,a)}return o[o.length-1].value}commitState(){if(this.pendingCam.unifiedDirty||this.pendingCam.rotDirty){xt.shouldSnapCamera=!0;const o=new De().setFromEuler(this.pendingCam.rot),t={x:o.x,y:o.y,z:o.z,w:o.w},a=G.split(this.pendingCam.unified.x),r=G.split(this.pendingCam.unified.y),i=G.split(this.pendingCam.unified.z);R.emit(se.CAMERA_TELEPORT,{position:{x:0,y:0,z:0},rotation:t,sceneOffset:{x:a.high,y:r.high,z:i.high,xL:a.low,yL:r.low,zL:i.low}}),this.fractalStore.setState({cameraRot:t})}}}const Fi=new Ai,kn=(e,o)=>{const t={};e.forEach(n=>t[n.id]=[]),o.forEach(n=>{t[n.source]&&t[n.source].push(n.target)});const a=new Set,r=new Set,i=n=>{if(!a.has(n)){a.add(n),r.add(n);const l=t[n]||[];for(const s of l)if(!a.has(s)&&i(s)||r.has(s))return!0}return r.delete(n),!1};for(const n of e)if(i(n.id))return!0;return!1},lo=(e,o)=>{const t={},a={};e.forEach(n=>{t[n.id]=[],a[n.id]=0}),o.forEach(n=>{t[n.source]&&(t[n.source].push(n.target),a[n.target]=(a[n.target]||0)+1)});const r=[];e.forEach(n=>{a[n.id]===0&&r.push(n.id)});const i=[];for(;r.length>0;){r.sort();const n=r.shift(),l=e.find(s=>s.id===n);if(l){const{position:s,...c}=l;i.push(c)}if(t[n])for(const s of t[n])a[s]--,a[s]===0&&r.push(s)}return i},co=e=>{const o=e.map((a,r)=>({...a,position:{x:250,y:150+r*200}})),t=[];if(o.length>0){t.push({id:`e-root-start-${o[0].id}`,source:"root-start",target:o[0].id});for(let a=0;a<o.length-1;a++)t.push({id:`e-${o[a].id}-${o[a+1].id}`,source:o[a].id,target:o[a+1].id});t.push({id:`e-${o[o.length-1].id}-root-end`,source:o[o.length-1].id,target:"root-end"})}return{nodes:o,edges:t}},Di=(e,o)=>{if(e.length!==o.length)return!1;for(let t=0;t<e.length;t++){const a=e[t],r=o[t];if(a.id!==r.id||a.type!==r.type||a.enabled!==r.enabled)return!1;const i=a.bindings||{},n=r.bindings||{},l=Object.keys(i).filter(f=>i[f]!==void 0),s=Object.keys(n).filter(f=>n[f]!==void 0);if(l.length!==s.length)return!1;for(const f of l)if(i[f]!==n[f])return!1;const c=a.condition||{active:!1,mod:0,rem:0},u=r.condition||{active:!1,mod:0,rem:0};if(c.active!==u.active||c.active&&(c.mod!==u.mod||c.rem!==u.rem))return!1}return!0},Oi=(e,o)=>e.length!==o.length?!1:JSON.stringify(e)===JSON.stringify(o),uo=[{id:"note-1",type:"Note",enabled:!0,params:{},text:`Infinite Repetition
...
This rotation is bound to 'ParamC' (Slider below). Try dragging it!`},{id:"rot-1",type:"Rotate",enabled:!0,params:{x:0,y:0,z:0},bindings:{z:"ParamC"}},{id:"bulb-1",type:"Mandelbulb",enabled:!0,params:{power:8}},{id:"add-c",type:"AddConstant",enabled:!0,params:{scale:1}}];class ji{constructor(){M(this,"_pendingWork",null);M(this,"_newCyclePending",!1)}queue(o,t){this._pendingWork=t,this._newCyclePending=!0,R.emit(se.IS_COMPILING,o)}consumeNewCycle(){return this._newCyclePending?(this._newCyclePending=!1,!0):!1}flush(){if(this._pendingWork){const o=this._pendingWork;this._pendingWork=null,o()}}}const fo=new ji,re=Oe(),pe=bo()(vo((e,o,t)=>({...la(e,o),...da(e,o),...ba(e,o),..._a(e,o),...ni(e,o),...yi(e,o),formula:"Mandelbulb",pipeline:uo,pipelineRevision:1,graph:co(uo),projectSettings:{name:"Mandelbulb",version:0},lastSavedHash:null,animations:[],liveModulations:{},setFormula:(a,r={})=>{const i=o(),n=i.formula;if(n===a&&a!=="Modular")return;r.skipDefaultPreset||(o().resetParamHistory(),e({undoStack:[],redoStack:[]}));const l=i.projectSettings.name;let s=l;(l===n||l==="Untitled"||l==="Custom Preset")&&(s=a),e({formula:a,projectSettings:{...i.projectSettings,name:s}}),fo.queue("Loading Preview...",()=>{if(R.emit(se.CONFIG,{formula:a,pipeline:i.pipeline,graph:i.graph}),a!=="Modular"&&!r.skipDefaultPreset){const c=he.get(a),u=c&&c.defaultPreset?JSON.parse(JSON.stringify(c.defaultPreset)):{formula:a};u.features||(u.features={});const f=o();if(j.getEngineFeatures().forEach(h=>{const g=f[h.id];if(!g)return;const v=u.features[h.id]||{},m={},y=h.engineConfig.toggleParam;g[y]!==void 0&&v[y]===void 0&&(m[y]=g[y]),Object.entries(h.params).forEach(([b,_])=>{_.onUpdate==="compile"&&g[b]!==void 0&&v[b]===void 0&&(m[b]=g[b])}),u.features[h.id]||(u.features[h.id]={}),Object.assign(u.features[h.id],m)}),o().lockSceneOnSwitch){const h=o().getPreset(),g={...h.features||{}},v=u.features||{};v.coreMath&&(g.coreMath=v.coreMath),v.geometry&&(g.geometry=v.geometry);const m={...h,formula:a,features:g};o().loadPreset(m)}else o().loadPreset(u)}o().handleInteractionEnd(),re.post({type:"CONFIG_DONE"})})},setProjectSettings:a=>e(r=>{const i={...r.projectSettings,...a};return a.name&&a.name!==r.projectSettings.name?(i.version=0,{projectSettings:i,lastSavedHash:null}):{projectSettings:i}}),prepareExport:()=>{const a=o(),r=a.getPreset({includeScene:!0}),{version:i,name:n,...l}=r,s=JSON.stringify(l);if(a.lastSavedHash===null||a.projectSettings.version===0){const c=Math.max(1,a.projectSettings.version+1);return e({projectSettings:{...a.projectSettings,version:c},lastSavedHash:s}),c}if(a.lastSavedHash!==s){const c=a.projectSettings.version+1;return e({projectSettings:{...a.projectSettings,version:c},lastSavedHash:s}),c}return a.projectSettings.version},setAnimations:a=>{const r=o().animations,i=a.map(n=>{const l=r.find(s=>s.id===n.id);if(!l)return n;if(n.period!==l.period&&n.period>0){const s=performance.now()/1e3,c=(s/l.period+l.phase-s/n.period)%1;return{...n,phase:(c+1)%1}}return n});e({animations:i})},setLiveModulations:a=>e({liveModulations:a}),setGraph:a=>{const r=lo(a.nodes,a.edges),i=o();if(Di(i.pipeline,r))Oi(i.pipeline,r)?e({graph:a}):(e({graph:a,pipeline:r}),R.emit(se.CONFIG,{pipeline:r}));else if(i.autoCompile){const n=i.pipelineRevision+1;e({graph:a,pipeline:r,pipelineRevision:n}),R.emit(se.CONFIG,{pipeline:r,graph:a,pipelineRevision:n})}else e({graph:a})},setPipeline:a=>{const r=o().pipelineRevision+1,i=co(a);e({pipeline:a,graph:i,pipelineRevision:r}),R.emit(se.CONFIG,{pipeline:a,graph:i,pipelineRevision:r})},refreshPipeline:()=>{const a=o(),r=lo(a.graph.nodes,a.graph.edges),i=a.pipelineRevision+1;e({pipeline:r,pipelineRevision:i}),R.emit(se.CONFIG,{pipeline:r,graph:a.graph,pipelineRevision:i})},loadPreset:a=>{a._formulaDef&&!he.get(a.formula)&&he.register(a._formulaDef),o().resetParamHistory();const r=he.get(a.formula),i=r?r.id:a.formula;e({formula:i}),R.emit(se.CONFIG,{formula:i});let n=a.name;(!n||n==="Untitled"||n==="Custom Preset")&&(n=i),e({projectSettings:{name:n,version:0},lastSavedHash:null}),Ei(a,e,o),setTimeout(()=>{const l=o().getPreset({includeScene:!0}),{version:s,name:c,...u}=l;e({lastSavedHash:JSON.stringify(u)})},50)},loadScene:({def:a,preset:r})=>{if(a&&(he.get(a.id)||he.register(a),R.emit(se.REGISTER_FORMULA,{id:a.id,shader:a.shader})),!re.isBooted&&!re.bootSent){o().loadPreset(r);return}fo.queue("Loading Preview...",()=>{o().loadPreset(r);const i=Bo(o());R.emit(se.CONFIG,i);const n=o().sceneOffset;if(n){const l={x:n.x,y:n.y,z:n.z,xL:n.xL??0,yL:n.yL??0,zL:n.zL??0};re.setShadowOffset(l),re.post({type:"OFFSET_SET",offset:l})}re.post({type:"CONFIG_DONE"})})},getPreset:a=>{var l,s;const r=o(),i={version:r.projectSettings.version,name:r.projectSettings.name,formula:r.formula,features:{}};if((a==null?void 0:a.includeScene)!==!1){if(i.cameraPos={x:0,y:0,z:0},re.activeCamera&&re.virtualSpace){const c=re.virtualSpace.getUnifiedCameraState(re.activeCamera,r.targetDistance);i.cameraRot=c.rotation,i.sceneOffset=c.sceneOffset,i.targetDistance=c.targetDistance}else i.cameraRot=r.cameraRot,i.sceneOffset=r.sceneOffset,i.targetDistance=r.targetDistance;i.cameraMode=r.cameraMode,i.lights=[],i.renderMode=r.renderMode,i.quality={aaMode:r.aaMode,aaLevel:r.aaLevel,msaa:r.msaaSamples,accumulation:r.accumulation}}j.getAll().forEach(c=>{const u=r[c.id];u&&(i.features||(i.features={}),i.features[c.id]=st(u))}),i.animations=r.animations,r.savedCameras.length>0&&(i.savedCameras=r.savedCameras.map(c=>({id:c.id,label:c.label,position:c.position,rotation:c.rotation,sceneOffset:c.sceneOffset,targetDistance:c.targetDistance,optics:c.optics}))),r.formula==="Modular"&&(i.graph=r.graph,i.pipeline=r.pipeline);try{const c=(s=(l=window.useAnimationStore)==null?void 0:l.getState)==null?void 0:s.call(l);c&&(i.sequence=c.sequence,i.duration=c.durationFrames)}catch(c){console.warn("Failed to save animation sequence:",c)}return i},getShareString:a=>{const r=o().getPreset({includeScene:!0}),i=o().advancedMode;return zi(r,i,a)}}))),zn=e=>e.isUserInteracting||e.interactionMode!=="none",An=e=>{var t;if(e.isGizmoDragging||e.interactionMode!=="none"||e.isExporting||e.isBucketRendering||e.tutorialActive&&e.tutorialLessonId===1)return!0;const o=j.getAll();for(const a of o)if((t=a.interactionConfig)!=null&&t.blockCamera&&a.interactionConfig.activeParam){const r=e[a.id];if(r&&r[a.interactionConfig.activeParam])return!0}return!1},Bo=e=>{var a;const o={formula:e.formula,pipeline:e.pipeline,pipelineRevision:e.pipelineRevision,graph:e.graph,msaaSamples:e.msaaSamples,previewMode:e.previewMode,renderMode:e.renderMode,compilerHardCap:e.compilerHardCap,shadows:!0,quality:{...e.quality}};if(j.getAll().forEach(r=>{const i=e[r.id];i&&(o[r.id]={...i})}),e.hardwareProfile){const r=e.hardwareProfile,i=o.quality;i&&(i.precisionMode=Math.max(i.precisionMode??0,r.caps.precisionMode),i.bufferPrecision=Math.max(i.bufferPrecision??0,r.caps.bufferPrecision),i.compilerHardCap=Math.min(i.compilerHardCap??Qe,r.caps.compilerHardCap)),o.compilerHardCap=((a=o.quality)==null?void 0:a.compilerHardCap)??o.compilerHardCap}return o};mi(Bo);const Fn=()=>{const e=pe.getState();Fi.connect(window.useAnimationStore,pe),re.isPaused=e.isPaused,re.setPreviewSampleCap(e.sampleCap),re.onBooted=()=>{const t=pe.getState(),a=t.sceneOffset;if(a){const r={x:a.x,y:a.y,z:a.z,xL:a.xL??0,yL:a.yL??0,zL:a.zL??0};re.setShadowOffset(r),re.post({type:"OFFSET_SET",offset:r})}re.setPreviewSampleCap(t.sampleCap)},pe.subscribe(t=>t.isPaused,t=>{re.isPaused=t}),pe.subscribe(t=>t.sampleCap,t=>{re.setPreviewSampleCap(t)}),pe.subscribe(t=>{var a;return(a=t.lighting)==null?void 0:a.renderMode},t=>{if(t===void 0)return;const a=t===1?"PathTracing":"Direct";pe.getState().renderMode!==a&&pe.setState({renderMode:a})});let o;pe.subscribe(t=>{var a;return(a=t.optics)==null?void 0:a.camType},t=>{var i;if(t===void 0)return;const a=o!==void 0&&o<.5,r=t>.5&&t<1.5;if(a&&r){const n=pe.getState();if(!n.activeCameraId){const l=((i=n.optics)==null?void 0:i.camFov)||60;let s=re.lastMeasuredDistance;(!s||s>=1e3||s<=0)&&(s=n.targetDistance||3.5);const c=s*Math.tan(l*Math.PI/360),u=n.setOptics;typeof u=="function"&&u({orthoScale:c})}}o=t}),R.on(se.BUCKET_STATUS,({isRendering:t})=>{const a=pe.getState();a.setIsBucketRendering(t),a.setIsExporting(t)})};typeof window<"u"&&(window.__store=pe);const Ni=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("polyline",{points:"6 9 12 15 18 9"})}),Dn=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("polyline",{points:"18 15 12 9 6 15"})}),On=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("polyline",{points:"15 18 9 12 15 6"})}),jn=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("polyline",{points:"9 18 15 12 9 6"})}),Nn=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("polyline",{points:"9 18 15 12 9 6"})}),$n=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("path",{d:"M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"})}),Bn=()=>d.jsx("svg",{width:"100%",height:"100%",viewBox:"0 0 10 10",children:d.jsx("path",{d:"M 6 10 L 10 6 L 10 10 Z",fill:"currentColor",opacity:"0.5"})}),Hn=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"4",y1:"9",x2:"20",y2:"9"}),d.jsx("line",{x1:"4",y1:"15",x2:"20",y2:"15"})]}),Vn=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("path",{d:"M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"})}),Gn=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),d.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]}),Un=()=>d.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"3",y1:"12",x2:"21",y2:"12"}),d.jsx("line",{x1:"3",y1:"6",x2:"21",y2:"6"}),d.jsx("line",{x1:"3",y1:"18",x2:"21",y2:"18"})]}),qn=()=>d.jsx("svg",{width:"16",height:"16",viewBox:"0 0 512 512",fill:"currentColor",children:d.jsx("path",{d:"M0,0v512h512V106.9l-6.5-7.3L412.4,6.5L405.1,0H0z M46.5,46.5h69.8v139.6h279.3V56.7l69.8,69.8v338.9h-46.5V256H93.1v209.5H46.5V46.5z M162.9,46.5H256V93h46.5V46.5H349v93.1H162.9V46.5z M139.6,302.5h232.7v162.9H139.6V302.5z"})}),Wn=()=>d.jsx("svg",{width:"16",height:"16",viewBox:"190 230 680 620",fill:"currentColor",children:d.jsx("path",{d:"M257.3312 451.84V332.8c0-42.3936 34.2016-76.8 76.4416-76.8h107.8272c29.5936 0 56.5248 17.152 69.12 44.032l14.8992 31.6416a25.4976 25.4976 0 0 0 23.04 14.6944h192.8192c42.1888 0 76.4416 34.3552 76.4416 76.8v28.672a76.8 76.8 0 0 1 50.9952 88.064l-43.3152 217.6A76.544 76.544 0 0 1 750.6432 819.2H324.5568a76.544 76.544 0 0 1-74.9568-61.7472l-43.3152-217.6a76.8512 76.8512 0 0 1 51.0464-88.0128z m509.5936-3.84v-24.832c0-14.1312-11.4176-25.6-25.4464-25.6h-192.8192a76.4416 76.4416 0 0 1-69.12-44.032l-14.848-31.6928A25.4976 25.4976 0 0 0 441.6 307.2H333.7216a25.5488 25.5488 0 0 0-25.4976 25.6v115.2h458.6496z m-485.6832 51.2a25.6 25.6 0 0 0-24.9856 30.6176l43.3152 217.6c2.4064 11.9808 12.8512 20.5824 24.9856 20.5824h426.0864a25.4976 25.4976 0 0 0 24.9856-20.5824l43.3152-217.6a25.7024 25.7024 0 0 0-24.9856-30.6176H281.2416z"})}),Xn=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("circle",{cx:"12",cy:"12",r:"10"}),d.jsx("line",{x1:"12",cy:"16",x2:"12",y2:"12"}),d.jsx("line",{x1:"12",cy:"8",x2:"12.01",y2:"8"})]}),Yn=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("circle",{cx:"12",cy:"12",r:"10"}),d.jsx("path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"}),d.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]}),Kn=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M3 10h10a5 5 0 0 1 5 5v2"}),d.jsx("path",{d:"M7 6l-4 4 4 4"})]}),Jn=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M21 10h-10a5 5 0 0 0 -5 5v2"}),d.jsx("path",{d:"M17 6l4 4 -4 4"})]}),Zn=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}),d.jsx("path",{d:"M3 3v5h5"})]}),Qn=()=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("polyline",{points:"20 6 9 17 4 12"})}),es=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),d.jsx("polyline",{points:"17 8 12 3 7 8"}),d.jsx("line",{x1:"12",y1:"3",x2:"12",y2:"15"})]}),ts=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),d.jsx("polyline",{points:"7 10 12 15 17 10"}),d.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),os=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"4",children:[d.jsx("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),d.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"})]}),as=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}),d.jsx("path",{d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"})]}),rs=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("path",{d:"M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"})}),is=()=>d.jsxs("svg",{width:"64",height:"64",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"5",y:"2",width:"14",height:"20",rx:"2",ry:"2"}),d.jsx("path",{d:"M12 18h.01"})]}),ns=({className:e})=>d.jsxs("svg",{className:e,xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",children:[d.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4"}),d.jsx("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}),ss=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"16 18 22 12 16 6"}),d.jsx("polyline",{points:"8 6 2 12 8 18"})]}),ls=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("circle",{cx:"12",cy:"12",r:"10"}),d.jsx("path",{d:"M8 14s1.5 2 4 2 4-2 4-2"}),d.jsx("line",{x1:"9",y1:"9",x2:"9.01",y2:"9"}),d.jsx("line",{x1:"15",y1:"9",x2:"15.01",y2:"9"})]}),cs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"}),d.jsx("polyline",{points:"3.27 6.96 12 12.01 20.73 6.96"}),d.jsx("line",{x1:"12",y1:"22.08",x2:"12",y2:"12"})]}),ds=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",strokeDasharray:"4 4"}),d.jsx("path",{d:"M9 12l2 2 4-4"})]}),us=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"})}),fs=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("circle",{cx:"12",cy:"12",r:"10"})}),ps=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 512 512",fill:"currentColor",children:d.jsx("path",{d:"M167.4,59.1l-6.2,8l-23.4,31.4h-19.7V78.8H39.4v19.7H0v354.5h512V98.5H374.2l-23.4-31.4l-6.2-8H167.4z M187.1,98.5h137.8l23.4,31.4l6.2,8h118.2v78.8H358.2c-20.5-35.2-58.7-59.1-102.2-59.1s-81.6,23.9-102.2,59.1H39.4v-78.8h118.2l6.2-8L187.1,98.5z M393.8,157.5v39.4h39.4v-39.4H393.8z M256,196.9c43.8,0,78.8,35,78.8,78.8s-35,78.8-78.8,78.8s-78.8-35-78.8-78.8S212.2,196.9,256,196.9z M39.4,256h100.3c-1.1,6.3-1.8,13.1-1.8,19.7c0,65,53.2,118.2,118.2,118.2s118.2-53.2,118.2-118.2c0-6.6-0.8-13.4-1.8-19.7h100.3v157.5H39.4V256z"})}),hs=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 3v18"}),d.jsx("path",{d:"M3 12h18"}),d.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),ms=()=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"})}),gs=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polygon",{points:"12 2 2 7 12 12 22 7 12 2"}),d.jsx("polyline",{points:"2 17 12 22 22 17"}),d.jsx("polyline",{points:"2 12 12 17 22 12"})]}),ys=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 2l-5 9h10l-5 9"}),d.jsx("path",{d:"M12 2v20"})]}),bs=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M6 2v14a2 2 0 0 0 2 2h14"}),d.jsx("path",{d:"M18 22V8a2 2 0 0 0-2-2H2"})]}),vs=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),d.jsx("line",{x1:"9",y1:"9",x2:"15",y2:"15"}),d.jsx("line",{x1:"15",y1:"9",x2:"9",y2:"15"})]}),xs=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"14",width:"7",height:"7"}),d.jsx("path",{d:"M3 14h7v7H3z",fill:"currentColor",stroke:"none"})]}),Ss=()=>d.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:d.jsx("path",{d:"M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM7 10h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"})}),ws=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"3",width:"7",height:"7"}),d.jsx("rect",{x:"14",y:"14",width:"7",height:"7"}),d.jsx("path",{d:"M10 7h4"}),d.jsx("path",{d:"M17 10v4"})]}),_s=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 22V8"}),d.jsx("path",{d:"M5 12H2a10 10 0 0 0 20 0h-3"}),d.jsx("circle",{cx:"12",cy:"5",r:"3"})]}),Is=()=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M12 18V8"}),d.jsx("path",{d:"M5 12H2a10 10 0 0 0 20 0h-3"}),d.jsx("circle",{cx:"12",cy:"5",r:"3"}),d.jsx("line",{x1:"3",y1:"21",x2:"21",y2:"3",stroke:"currentColor",opacity:"0.9"})]}),Cs=({status:e})=>{let o="currentColor";e==="keyed"||e==="partial"?o="#f59e0b":(e==="dirty"||e==="keyed-dirty")&&(o="#ef4444");const t=e==="keyed"||e==="keyed-dirty"?o:"none";return d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:o,strokeWidth:"2.5",children:d.jsx("path",{d:"M12 2L2 12l10 10 10-10L12 2z",fill:t})})},Ms=({active:e})=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"#666",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"}),d.jsx("path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"})]}),Rs=()=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[d.jsx("path",{d:"M10 13l-4 4"}),d.jsx("path",{d:"M14 11l4 -4"})]}),Ls=({active:e})=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:e?"#f59e0b":"#666",strokeWidth:"3",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"16 18 22 12 16 6"}),d.jsx("polyline",{points:"8 6 2 12 8 18"})]}),Ps=({open:e})=>d.jsx("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:`transition-transform ${e?"rotate-90":""}`,children:d.jsx("path",{d:"M9 18l6-6-6-6"})}),Ts=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"2",y:"2",width:"20",height:"20",rx:"5",ry:"5"}),d.jsx("path",{d:"M16 8h.01"}),d.jsx("path",{d:"M8 8h.01"}),d.jsx("path",{d:"M8 16h.01"}),d.jsx("path",{d:"M16 16h.01"}),d.jsx("path",{d:"M12 12h.01"})]}),Es=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"16 3 21 3 21 8"}),d.jsx("line",{x1:"4",y1:"20",x2:"21",y2:"3"}),d.jsx("polyline",{points:"21 16 21 21 16 21"}),d.jsx("line",{x1:"15",y1:"15",x2:"21",y2:"21"}),d.jsx("line",{x1:"4",y1:"4",x2:"9",y2:"9"})]}),ks=()=>d.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:d.jsx("path",{d:"M8 5v14l11-7z"})}),zs=()=>d.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:d.jsx("path",{d:"M6 19h4V5H6v14zm8-14v14h4V5h-4z"})}),As=()=>d.jsx("svg",{width:"12",height:"12",fill:"currentColor",viewBox:"0 0 24 24",children:d.jsx("path",{d:"M6 6h12v12H6z"})}),Fs=({active:e})=>d.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:e?"currentColor":"none",stroke:"currentColor",strokeWidth:"2",children:d.jsx("circle",{cx:"12",cy:"12",r:"10",stroke:e?"none":"currentColor",fill:e?"#ef4444":"none"})}),Ds=({active:e})=>d.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",children:d.jsx("path",{d:"M3 18C3 18 6 5 12 12C18 19 21 5 21 5"})}),Os=({active:e})=>d.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",children:[d.jsx("rect",{x:"3",y:"8",width:"6",height:"8"}),d.jsx("rect",{x:"15",y:"8",width:"6",height:"8"})]}),js=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"}),d.jsx("path",{d:"M4 22v-7"}),d.jsx("path",{d:"M8 4v10"}),d.jsx("path",{d:"M12 5v10"}),d.jsx("path",{d:"M16 4v10"}),d.jsx("path",{d:"M4 8h16"}),d.jsx("path",{d:"M4 12h16"})]}),Ns=({active:e})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2",ry:"2"}),d.jsx("line",{x1:"3",y1:"9",x2:"21",y2:"9"}),d.jsx("line",{x1:"3",y1:"15",x2:"21",y2:"15"}),d.jsx("line",{x1:"9",y1:"3",x2:"9",y2:"21"}),d.jsx("line",{x1:"15",y1:"3",x2:"15",y2:"21"})]}),$s=({mode:e})=>d.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e==="Loop"||e==="PingPong"?d.jsx("path",{d:"M17 2l4 4-4 4 M3 11v-1a4 4 0 0 1 4-4h14 M7 22l-4-4 4-4 M21 13v1a4 4 0 0 1-4 4H3"}):d.jsx("path",{d:"M5 12h14 M12 5l7 7-7 7"})}),Bs=({active:e,arming:o})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M3 12h18",strokeOpacity:e||o?.3:.2}),d.jsx("path",{d:"M3 12 Q 6 2, 9 12 T 15 12 T 21 12",stroke:e?"#ef4444":o?"#fca5a5":"currentColor"}),o&&!e&&d.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"#fca5a5",stroke:"none"})]}),Hs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("polyline",{points:"4 14 10 14 10 20"}),d.jsx("polyline",{points:"20 10 14 10 14 4"}),d.jsx("line",{x1:"14",y1:"10",x2:"21",y2:"3"}),d.jsx("line",{x1:"3",y1:"21",x2:"10",y2:"14"})]}),Vs=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"}),d.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"currentColor",stroke:"none"})]}),Gs=({active:e})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("line",{x1:"4",y1:"20",x2:"20",y2:"20"}),d.jsx("line",{x1:"4",y1:"4",x2:"20",y2:"4"}),d.jsx("polyline",{points:"4 14 8 10 12 14 16 10 20 14"})]}),Us=()=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"}),d.jsx("path",{d:"M4 12h16"}),d.jsx("path",{d:"M12 4v16"}),d.jsx("path",{d:"M16 16l-4 4-4-4"})]}),qs=({active:e})=>d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M19 13l-7-7-7 7"}),d.jsx("path",{d:"M5 19l7-7 7 7"}),d.jsx("path",{d:"M12 5l2-2 2 2-2 2-2-2z",fill:e?"#22d3ee":"none",stroke:"none"}),d.jsx("path",{d:"M12 5l-2-2-2 2 2 2 2-2z",fill:e?"#22d3ee":"none",stroke:"none"})]}),Ws=({active:e})=>d.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:e?"#22d3ee":"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:d.jsx("path",{d:"M2 12s3-7 7-7 7 7 7 7 3-7 7-7"})}),Xs=({active:e})=>d.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round",strokeLinejoin:"round",className:e?"text-gray-200":"text-gray-600",children:[d.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),d.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),$i=e=>{const{value:o,onChange:t,onDragStart:a,onDragEnd:r,step:i=.01,sensitivity:n=1,hardMin:l,hardMax:s,mapping:c,disabled:u,dragThreshold:f=2}=e,[p,h]=P.useState(!1),g=P.useRef(null),v=P.useRef(0),m=P.useRef(0),y=P.useRef(!1),b=P.useRef(!1),_=P.useRef(!1),E=P.useRef(null),S=P.useCallback((x,z)=>{let K=i*.5*n;return x&&(K*=10),z&&(K*=.1),K},[i,n]),C=P.useCallback(x=>{if(u||x.button!==0)return;x.preventDefault(),x.stopPropagation(),x.currentTarget.setPointerCapture(x.pointerId),E.current=x.pointerId,v.current=x.clientX;const z=c?c.toDisplay(o):o;m.current=isNaN(z)?0:z,y.current=!1,b.current=x.shiftKey,_.current=x.altKey,h(!0),a==null||a()},[o,c,u,a]),T=P.useCallback(x=>{if(u||!p||!x.currentTarget.hasPointerCapture(x.pointerId))return;const z=x.clientX-v.current;if(Math.abs(z)>f&&(y.current=!0),!y.current)return;x.preventDefault(),x.stopPropagation();const K=b.current!==x.shiftKey,ce=_.current!==x.altKey;if(K||ce){const O=S(b.current,_.current),$=m.current+z*O;m.current=$,v.current=x.clientX,b.current=x.shiftKey,_.current=x.altKey}const oe=S(x.shiftKey,x.altKey);let J=m.current+z*oe;l!==void 0&&(J=Math.max(l,J)),s!==void 0&&(J=Math.min(s,J));const w=c?c.fromDisplay(J):J;isNaN(w)||(g.current=w,t(w))},[p,u,i,l,s,c,t,S,f]),L=P.useCallback(x=>{u||(x.currentTarget.releasePointerCapture(x.pointerId),E.current=null,h(!1),g.current=null,r==null||r())},[u,r]),F=P.useCallback(()=>{const x=!y.current;return y.current=!1,x},[]);return{isDragging:p,immediateValueRef:g,handlePointerDown:C,handlePointerMove:T,handlePointerUp:L,handleClick:F}},Bi=e=>{const{value:o,mapping:t,onChange:a,onDragStart:r,onDragEnd:i,disabled:n,mapTextInput:l=!1}=e,[s,c]=P.useState(!1),[u,f]=P.useState(""),p=P.useRef(null),h=P.useRef(""),g=P.useCallback(()=>{if(n)return;c(!0);const S=l&&t?t.toDisplay(o):o,C=typeof S=="number"?parseFloat(S.toFixed(6)):S??0,T=String(C);f(T),h.current=T,setTimeout(()=>{p.current&&(p.current.focus(),p.current.select())},10)},[o,t,n,l]),v=P.useCallback(()=>{const S=h.current;let C;if(t!=null&&t.parseInput&&l?C=t.parseInput(S):(C=parseFloat(S),isNaN(C)&&(C=null)),C!==null){const T=l&&t?t.fromDisplay(C):C;r==null||r(),a(T),i==null||i()}c(!1)},[t,a,r,i,l]),m=P.useCallback(()=>{c(!1)},[]),y=P.useCallback(S=>{f(S),h.current=S},[]),b=P.useCallback(S=>{S.key==="Enter"?(S.preventDefault(),v()):S.key==="Escape"&&(S.preventDefault(),m()),S.key!=="Tab"&&S.stopPropagation()},[v,m]),_=P.useCallback(()=>{s||g()},[s,g]),E=P.useCallback(()=>{s&&v()},[s,v]);return{isEditing:s,inputValue:u,inputRef:p,startEditing:g,commitEdit:v,cancelEdit:m,handleInputChange:y,handleKeyDown:b,handleFocus:_,handleBlur:E}},Ho=e=>e===0||Math.abs(e)<1e-9?"0":parseFloat(e.toFixed(8)).toString(),po={toDisplay:e=>e/Math.PI,fromDisplay:e=>e*Math.PI,format:e=>{const o=e/Math.PI,t=Math.abs(o),a=o<0?"-":"";if(t<.001)return"0";if(Math.abs(t-1)<.001)return`${a}π`;if(Math.abs(t-.5)<.001)return`${a}π/2`;if(Math.abs(t-.25)<.001)return`${a}π/4`;if(Math.abs(t-.75)<.001)return`${a}3π/4`;if(Math.abs(t-2)<.001)return`${a}2π`;const r=Math.round(t*3);if(Math.abs(t-r/3)<.001&&r!==0){if(r===1)return`${a}π/3`;if(r===2)return`${a}2π/3`;if(r===3)return`${a}π`;if(r===4)return`${a}4π/3`;if(r===5)return`${a}5π/3`}return`${a}${t.toFixed(2)}π`},parseInput:e=>{const o=e.trim().toLowerCase().replace(/\s/g,"");if(o==="π"||o==="pi")return Math.PI;if(o==="-π"||o==="-pi")return-Math.PI;if(o.includes("π")||o.includes("pi")){const a=o.replace(/[πpi]/g,"");if(a.includes("/")){const[n,l]=a.split("/").map(c=>parseFloat(c)||1);return(o.startsWith("-")?-1:1)*(Math.abs(n)/l)*Math.PI}const r=a?parseFloat(a):1;return isNaN(r)?null:(o.startsWith("-")?-1:1)*Math.abs(r)*Math.PI}const t=parseFloat(o);return isNaN(t)?null:t}},Je={toDisplay:e=>e*(180/Math.PI),fromDisplay:e=>e*(Math.PI/180),format:e=>`${(e*(180/Math.PI)).toFixed(1)}°`,parseInput:e=>{const o=e.trim().replace(/°/g,""),t=parseFloat(o);return isNaN(t)?null:t}},Vo=(e,o,t,a)=>{const r=a?a.toDisplay(e):e,i=a?a.toDisplay(o):o,n=a?a.toDisplay(t):t;return Math.max(0,Math.min(100,(r-i)/(n-i)*100))},St=({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r=.01,sensitivity:i=1,min:n,max:l,hardMin:s,hardMax:c,mapping:u,format:f,mapTextInput:p,disabled:h=!1,highlight:g=!1,liveValue:v,defaultValue:m,onImmediateChange:y})=>{const b=te.useRef(null),_=te.useCallback(B=>f?f(B):u!=null&&u.format?u.format(B):Ho(B),[f,u]),{isDragging:E,immediateValueRef:S,handlePointerDown:C,handlePointerMove:T,handlePointerUp:L,handleClick:F}=$i({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,sensitivity:i,hardMin:s,hardMax:c,mapping:u,disabled:h}),x=te.useCallback(B=>{T(B);const Z=S.current;Z!==null&&(b.current&&(b.current.textContent=_(Z)),y==null||y(Z))},[T,S,_,y]),{isEditing:z,inputValue:K,inputRef:ce,startEditing:oe,handleInputChange:J,handleKeyDown:w,handleBlur:O}=Bi({value:e,mapping:u,onChange:o,onDragStart:t,onDragEnd:a,disabled:h,mapTextInput:p}),$=te.useMemo(()=>_(e),[e,_]),de=te.useCallback(()=>{!h&&!z&&oe()},[h,z,oe]),ae=te.useCallback(B=>{if(h)return;F()&&oe()},[h,F,oe]),q=`
        ...
        ${E?"bg-cyan-500/20 text-cyan-300":(E||g||v!==void 0&&!h)&&!h?"text-cyan-400":h?"":"text-gray-300 hover:text-white"}
    `;return z?d.jsx("input",{ref:ce,type:"text",value:K,onChange:B=>J(B.target.value),onBlur:O,onKeyDown:w,className:"w-full h-full bg-gray-900 text-white text-xs border-none outline-none font-mono text-center px-1",onClick:B=>B.stopPropagation(),autoFocus:!0}):d.jsx("div",{ref:b,"data-role":"value",tabIndex:h?-1:0,onPointerDown:C,onPointerMove:x,onPointerUp:L,onClick:ae,onFocus:de,className:q,title:h?"Disabled":"Click to edit, Drag to adjust (Shift=Fast, Alt=Slow)",children:$})},Hi=({value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r=.01,min:i,max:n,hardMin:l,hardMax:s,mapping:c,format:u,overrideText:f,mapTextInput:p,label:h,labelSuffix:g,headerRight:v,showTrack:m=!0,trackPosition:y="below",trackHeight:b=20,variant:_="full",className:E="",defaultValue:S,onReset:C,liveValue:T,showLiveIndicator:L=!0,onContextMenu:F,dataHelpId:x,disabled:z=!1,highlight:K=!1})=>{const ce=te.useRef(null),oe=te.useRef(null),J=te.useRef(null),w=te.useRef({active:!1,startX:0,startValue:0,lastShift:!1,lastAlt:!1}),O=i!==void 0&&n!==void 0&&i!==n,$=te.useMemo(()=>{if(!O)return 0;const k=c?c.toDisplay(e):e,A=c?c.toDisplay(i):i,fe=c?c.toDisplay(n):n;return Math.max(0,Math.min(100,(k-A)/(fe-A)*100))},[e,i,n,c,O]),de=te.useMemo(()=>{if(!O||T===void 0)return 0;const k=c?c.toDisplay(T):T,A=c?c.toDisplay(i):i,fe=c?c.toDisplay(n):n;return Math.max(0,Math.min(100,(k-A)/(fe-A)*100))},[T,i,n,c,O]),ae=te.useMemo(()=>{if(!O||S===void 0)return null;const k=c?c.toDisplay(S):S,A=c?c.toDisplay(i):i,fe=c?c.toDisplay(n):n;return(k-A)/(fe-A)*100},[S,i,n,c,O]),H=te.useCallback(k=>O?Vo(k,i,n,c):0,[O,i,n,c]),q=te.useCallback(k=>{var ne;const A=H(k),fe=`${A}%`;ce.current&&(ce.current.style.width=fe),oe.current&&(oe.current.style.width=fe);const _e=(ne=J.current)==null?void 0:ne.querySelector('[data-role="thumb"]');_e&&(_e.style.left=`calc(${A}% - 8px)`)},[H]),B=te.useCallback(k=>r?Math.round(k/r)*r:k,[r]),Z=te.useCallback(k=>{if(z||!O||k.button!==0)return;k.preventDefault(),k.stopPropagation(),k.currentTarget.setPointerCapture(k.pointerId);const A=k.currentTarget.getBoundingClientRect(),fe=Math.max(0,Math.min(1,(k.clientX-A.left)/A.width)),_e=c?c.toDisplay(i):i,ne=c?c.toDisplay(n):n,Pe=B(_e+fe*(ne-_e));let Se=c?c.fromDisplay(Pe):Pe;l!==void 0&&(Se=Math.max(l,Se)),s!==void 0&&(Se=Math.min(s,Se)),o(Se),q(Se);const Ie=w.current;Ie.active=!0,Ie.startX=k.clientX,Ie.startValue=Pe,Ie.lastShift=k.shiftKey,Ie.lastAlt=k.altKey,t==null||t()},[z,O,i,n,c,l,s,o,t,q,B]),X=te.useCallback(k=>{const A=w.current;if(!A.active||z||!O)return;k.preventDefault();const _e=k.currentTarget.getBoundingClientRect().width,ne=c?c.toDisplay(i):i,Pe=c?c.toDisplay(n):n,Ie=(Pe-ne)/_e;if(A.lastShift!==k.shiftKey||A.lastAlt!==k.altKey){const ft=Ie*(A.lastShift?10:1)*(A.lastAlt?.1:1),ot=k.clientX-A.startX;A.startValue=A.startValue+ot*ft,A.startX=k.clientX,A.lastShift=k.shiftKey,A.lastAlt=k.altKey}let Xe=Ie;k.shiftKey&&(Xe*=10),k.altKey&&(Xe*=.1);const ut=k.clientX-A.startX;let Ne=B(A.startValue+ut*Xe);Ne=Math.max(ne,Math.min(Pe,Ne));let Te=c?c.fromDisplay(Ne):Ne;l!==void 0&&(Te=Math.max(l,Te)),s!==void 0&&(Te=Math.min(s,Te)),isNaN(Te)||(o(Te),q(Te))},[z,O,i,n,c,l,s,o,q,B]),ie=te.useCallback(k=>{const A=w.current;A.active&&(A.active=!1,k.currentTarget.releasePointerCapture(k.pointerId),a==null||a())},[a]),Fe=te.useCallback(()=>{S!==void 0&&!z&&(t==null||t(),o(S),a==null||a(),C==null||C())},[S,z,o,t,a,C]),Le=K||T!==void 0,je=_==="compact";return _==="minimal"?d.jsx("div",{className:E,children:d.jsx(St,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:l,hardMax:s,mapping:c,format:f?()=>f:u,mapTextInput:p,defaultValue:S,disabled:z,highlight:Le,onImmediateChange:q})}):je?d.jsxs("div",{className:`relative flex-1 h-9 md:h-[26px] overflow-hidden group transition-all duration-150 ${z?"opacity-70 pointer-events-none":""} ${E}`,onContextMenu:F,"data-help-id":x,children:[d.jsx("div",{className:"absolute inset-0 bg-white/[0.12]",style:z?{}:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255,255,255,0.03) 5px, rgba(255,255,255,0.03) 10px)"}}),m&&O&&d.jsx("div",{ref:ce,"data-role":"fill",className:`absolute top-0 bottom-0 left-0 pointer-events-none ${z?"bg-gray-500/20":Le?"bg-cyan-500/30":"bg-cyan-500/20"}`,style:{width:`${$}%`}}),L&&T!==void 0&&!z&&O&&d.jsx("div",{className:"absolute top-0 bottom-0 w-1.5 bg-purple-500 blur-[1px] transition-all duration-75 ease-out z-0",style:{left:`calc(${de}% - 0.75px)`}}),d.jsx("div",{className:"absolute inset-0",children:d.jsx(St,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:l,hardMax:s,mapping:c,format:f?()=>f:u,mapTextInput:p,defaultValue:S,disabled:z,highlight:Le,onImmediateChange:q})}),Le&&!z&&d.jsx("div",{className:"absolute inset-0 bg-cyan-500/10 pointer-events-none"})]}):d.jsxs("div",{className:`mb-px animate-slider-entry ${z?"opacity-70 pointer-events-none":""} ${E}`,"data-help-id":x,onContextMenu:F,children:[h&&d.jsxs("div",{className:"flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5",children:[d.jsxs("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:[v,d.jsxs("label",{className:`text-[10px] font-medium tracking-tight select-none flex items-center gap-2 truncate pointer-events-none ${z?"text-gray-600":"text-gray-400"}`,children:[h,g,T!==void 0&&!z&&d.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-purple-500 animate-pulse shadow-[0_0_4px_#a855f7]"})]})]}),d.jsx("div",{className:"w-1/2 relative bg-white/[0.02] border-l border-white/10 group/num-area touch-none",style:z?{}:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 5px, rgba(255,255,255,0.03) 5px, rgba(255,255,255,0.03) 10px)"},children:d.jsx(St,{value:e,onChange:o,onDragStart:t,onDragEnd:a,step:r,hardMin:l,hardMax:s,mapping:c,format:f?()=>f:u,mapTextInput:p,defaultValue:S,disabled:z,highlight:Le,onImmediateChange:q})})]}),m&&O&&d.jsxs("div",{ref:J,className:`relative flex items-center touch-none overflow-hidden ${z?"cursor-not-allowed":"cursor-ew-resize"}`,style:{touchAction:"none",height:b},onPointerDown:Z,onPointerMove:X,onPointerUp:ie,children:[d.jsxs("div",{className:"absolute inset-0 bg-white/10",children:[d.jsx("div",{ref:oe,className:`absolute top-0 bottom-0 left-0 ${z?"bg-gray-400/20":"bg-cyan-500/30"}`,style:{width:`${$}%`}}),L&&T!==void 0&&!z&&d.jsx("div",{className:"absolute top-0 bottom-0 w-1.5 bg-purple-500 blur-[1px] transition-all duration-75 ease-out z-0",style:{left:`calc(${de}% - 0.75px)`}})]}),d.jsx("div",{"data-role":"thumb",className:"absolute top-0 bottom-0 w-4 z-10 pointer-events-none border-l border-r transition-colors",style:{left:`calc(${$}% - 8px)`,borderColor:z?"rgba(255,255,255,0.1)":"rgba(255,255,255,0.25)"}}),ae!==null&&d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"absolute w-0.5 h-full bg-white/40 pointer-events-none z-0 transform -translate-x-1/2",style:{left:`${ae}%`}}),d.jsx("button",{onPointerDown:k=>{k.preventDefault(),k.stopPropagation()},onClick:k=>{k.preventDefault(),k.stopPropagation(),Fe()},className:"absolute top-0 bottom-0 right-0 w-2 bg-gray-500/20 hover:bg-gray-400/50 cursor-pointer z-20 transition-colors border-l border-black/10",title:`Reset to ${S}`,"aria-label":"Reset to default",tabIndex:-1})]})]})]})},Vi=[{label:"X",color:"bg-red-500",text:"text-red-400",border:"group-focus-within:border-red-500/50",hoverBg:"hover:bg-red-500/20",accent:"#ef4444"},{label:"Y",color:"bg-green-500",text:"text-green-400",border:"group-focus-within:border-green-500/50",hoverBg:"hover:bg-green-500/20",accent:"#22c55e"},{label:"Z",color:"bg-blue-500",text:"text-blue-400",border:"group-focus-within:border-blue-500/50",hoverBg:"hover:bg-blue-500/20",accent:"#3b82f6"},{label:"W",color:"bg-purple-500",text:"text-purple-400",border:"group-focus-within:border-purple-500/50",hoverBg:"hover:bg-purple-500/20",accent:"#a855f7"}],ho=e=>e.includes("red")?{on:"bg-red-500/30 text-red-300 border-red-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("green")?{on:"bg-green-500/30 text-green-300 border-green-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("amber")||e.includes("yellow")?{on:"bg-amber-500/30 text-amber-300 border-amber-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:e.includes("purple")?{on:"bg-purple-500/30 text-purple-300 border-purple-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}:{on:"bg-cyan-500/30 text-cyan-300 border-cyan-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"};function Ys({label:e,value:o,onChange:t,options:a,color:r="bg-cyan-600",onLfoToggle:i,isLfoActive:n,icon:l,disabled:s=!1,variant:c="default",labelSuffix:u,onContextMenu:f,...p}){const h=m=>{s||t(m)},g=()=>{s||t(!o)},v=ho(r);if(c==="dense"&&!a&&typeof o=="boolean"){const m=ho(r);return d.jsxs("div",{className:`flex items-center justify-between px-3 py-1 border-b border-white/5 hover:bg-white/5 transition-colors ${s?"opacity-50 pointer-events-none":"cursor-pointer"}`,"data-help-id":p["data-help-id"],onContextMenu:f,onClick:g,children:[d.jsxs("div",{className:"flex items-center gap-2",children:[l,d.jsx("span",{className:"text-[10px] text-gray-400 font-medium tracking-tight truncate select-none",children:e})]}),d.jsx("div",{className:`px-2 py-0.5 text-[8px] font-bold rounded-sm transition-all border ${o?m.on:m.off} ${s?"":"hover:brightness-125"}`,children:o?"ON":"OFF"})]})}return a?d.jsxs("div",{className:`mb-px animate-slider-entry ${s?"opacity-50 pointer-events-none":""}`,"data-help-id":p["data-help-id"],onContextMenu:f,children:[e&&d.jsxs("div",{className:"flex items-center bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5 px-2 gap-2",children:[l,d.jsx("span",{className:"text-[10px] text-gray-400 font-medium tracking-tight truncate select-none pointer-events-none",children:e})]}),d.jsx("div",{className:`flex h-9 md:h-[26px] overflow-hidden ${e?"rounded-b-sm":"rounded-sm"}`,children:a.map(m=>d.jsx("button",{onClick:()=>h(m.value),disabled:s,className:`
                            ...
                            `,title:m.tooltip||m.label,children:m.label},String(m.value)))})]}):d.jsx("div",{className:`mb-px animate-slider-entry ${s?"opacity-50 pointer-events-none":""}`,"data-help-id":p["data-help-id"],onContextMenu:f,children:d.jsxs("div",{className:`group/toggle flex items-stretch h-9 md:h-[26px] overflow-hidden rounded-sm transition-colors ${e?"bg-white/[0.12]":""} ${s?"":"cursor-pointer hover:bg-white/[0.18]"}`,onClick:g,children:[e&&d.jsxs("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0 select-none",children:[l,d.jsx("span",{className:"text-[10px] text-gray-400 group-hover/toggle:text-gray-300 font-medium tracking-tight truncate transition-colors",children:e}),u]}),d.jsxs("div",{className:`flex ${e?"border-l border-white/5":"flex-1"}`,children:[d.jsx("div",{className:`
                            flex items-center justify-center gap-1 px-3 text-[10px] font-bold transition-all border-0 ${o?v.on:v.off} ${s?"opacity-40":"hover:brightness-125"}
                            ${e?"":"flex-1"}
                        `,children:d.jsx("span",{className:`text-[8px] ${o?"opacity-90":"opacity-50"}`,children:o?"ON":"OFF"})}),i&&d.jsx("button",{onClick:m=>{m.stopPropagation(),s||i()},disabled:s,className:`
                            ...
                            `,title:"LFO",children:d.jsx("span",{className:`text-[8px] ${n?"opacity-90":"opacity-50"}`,children:"LFO"})})]})]})})}const Ue={text:"text-cyan-400",textSubtle:"text-cyan-600",bgSolid:"bg-cyan-900",bgMed:"bg-cyan-700",bgBright:"bg-cyan-600/40",hoverBg:"hover:bg-cyan-500/50"},Ks={bgMed:"bg-purple-700"},mo={text:"text-amber-400",bg:"bg-amber-900/20",border:"border-amber-500/20",btnBg:"bg-amber-600",btnHover:"hover:bg-amber-500",btnText:"text-black"},qe={dock:"bg-[#080808]",tabBar:"bg-black/40",nested:"bg-black/20",divider:"bg-neutral-800",panelHeader:"bg-gray-800/80",input:"bg-gray-900",tint:"bg-white/5",hoverSubtle:"hover:bg-white/5",hoverMed:"hover:bg-white/10"},Re={primary:"text-white",label:"text-gray-400",dimLabel:"text-gray-500",faint:"text-gray-600",ghost:"text-gray-700"},Go={subtle:"border-white/5",standard:"border-white/10"},Js=`${qe.dock} ${Ue.text} border-x border-t ${Go.standard} z-10 -mb-px pb-2`,Zs=`${Re.dimLabel} ${qe.hoverSubtle} hover:text-gray-300 border border-transparent`,Qs=`${Ue.bgSolid} ${Ue.text}`,el=`${Re.faint} ${qe.hoverMed}`,tl=`${Ue.textSubtle}`,ol=`${Re.ghost}`,al=`${qe.nested} p-2 rounded border ${Go.subtle}`,rl=`${mo.bg} border ${mo.border}`,il=`${Ue.bgMed} ${Re.primary}`,nl=`${Re.dimLabel} hover:text-gray-300`,sl=`${Re.ghost} cursor-not-allowed opacity-50 bg-transparent`,ll=`${Ue.bgBright} text-cyan-300 shadow-[inset_0_0_10px_rgba(34,211,238,0.1)]`,cl=`bg-transparent ${Re.dimLabel} hover:text-gray-300 ${qe.hoverSubtle}`,Gi={primary:`text-[10px] font-bold ${Re.label}`,secondary:`text-[9px] font-bold ${Re.dimLabel}`,tiny:`text-[8px] ${Re.faint}`},Ui=({children:e,variant:o="primary",className:t="",color:a})=>{const r=Gi[o],i=a||"";return d.jsx("span",{className:`${r} ${i} select-none ${t}`,children:e})},dl=()=>d.jsxs(d.Fragment,{children:[d.jsx("div",{className:`h-1.5 ${qe.divider} rounded-b-lg`}),d.jsx("div",{className:"h-2",style:{background:"linear-gradient(to bottom, transparent, rgba(255,255,255,0.08))"}})]});function ul({label:e,value:o,options:t,onChange:a,fullWidth:r,className:i="",selectClassName:n="",labelSuffix:l,onContextMenu:s,disabled:c=!1,...u}){const f=p=>{var v;const h=p.target.value,g=typeof((v=t[0])==null?void 0:v.value)=="number";a(g?Number(h):h)};return d.jsxs("div",{className:`flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5 ${r?"w-full":""} ${c?"opacity-50 pointer-events-none":""} ${i}`,"data-help-id":u["data-help-id"],onContextMenu:s,children:[e&&d.jsx("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:d.jsxs("label",{className:"text-[10px] font-medium tracking-tight select-none truncate pointer-events-none text-gray-400",children:[e,l]})}),d.jsxs("div",{className:`${e?"w-1/2":"w-full"} relative border-l border-white/10 bg-white/[0.02] border-t border-t-white/5`,children:[d.jsx("select",{value:o,onChange:f,disabled:c,className:`w-full h-full bg-transparent text-[10px] font-medium text-gray-200 px-2 pr-6 outline-none cursor-pointer appearance-none text-center ${n}`,children:t.map(p=>d.jsx("option",{value:String(p.value),className:"bg-[#111] text-gray-300",children:p.label},String(p.value)))}),d.jsx("div",{className:"absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500",children:d.jsx("div",{className:"w-2.5 h-2.5",children:d.jsx(Ni,{})})})]})]})}const Ce=({axisIndex:e,value:o,min:t,max:a,step:r,onUpdate:i,onDragStart:n,onDragEnd:l,disabled:s,highlight:c,mapping:u,mapTextInput:f,liveValue:p,defaultValue:h,hardMin:g,hardMax:v,customLabel:m})=>{const y=Vi[e],b=m||y.label;return d.jsxs("div",{"data-axis-index":e,className:`relative flex-1 h-9 md:h-[26px] overflow-hidden group transition-all duration-150 ${s?"opacity-50 pointer-events-none":""}`,children:[d.jsx("div",{className:`
                ...
                `,onDoubleClick:_=>{_.preventDefault(),_.stopPropagation(),h!==void 0&&(n==null||n(),i(h),l==null||l())},title:h!==void 0?`Double-click to reset to ${h}`:"No default value",children:d.jsx("span",{className:`text-[10px] font-bold ${y.text} pointer-events-none`,children:b})}),d.jsx("div",{className:"absolute inset-0 left-5",children:d.jsx(Hi,{value:o,onChange:i,onDragStart:n,onDragEnd:l,step:r,min:t,max:a,hardMin:g,hardMax:v,mapping:u,mapTextInput:f,disabled:s,highlight:c,liveValue:p,defaultValue:h,variant:"compact",showTrack:!0})})]})},go=[{label:"X",color:"bg-red-500",text:"text-red-400",border:"group-focus-within:border-red-500/50",hoverBg:"hover:bg-red-500/20",accent:"#ef4444"},{label:"Y",color:"bg-green-500",text:"text-green-400",border:"group-focus-within:border-green-500/50",hoverBg:"hover:bg-green-500/20",accent:"#22c55e"},{label:"Z",color:"bg-blue-500",text:"text-blue-400",border:"group-focus-within:border-blue-500/50",hoverBg:"hover:bg-blue-500/20",accent:"#3b82f6"},{label:"W",color:"bg-purple-500",text:"text-purple-400",border:"group-focus-within:border-purple-500/50",hoverBg:"hover:bg-purple-500/20",accent:"#a855f7"}],rt=({primaryAxis:e,secondaryAxis:o,primaryIndex:t,secondaryIndex:a,primaryValue:r,secondaryValue:i,min:n,max:l,step:s,onUpdate:c,onDragStart:u,onDragEnd:f,disabled:p,onHover:h})=>{const[g,v]=P.useState(!1),m=P.useRef(!1),y=P.useRef(!1),b=P.useRef({x:0,y:0}),_=P.useRef({primary:0,secondary:0}),E=P.useRef(!1),S=P.useRef(!1),C=P.useRef(!1),T=go[t],L=go[a],F=()=>{v(!0),h(!0)},x=()=>{m.current||(v(!1),h(!1))},z=w=>{p||w.button!==0&&w.button!==1||(w.preventDefault(),w.stopPropagation(),w.currentTarget.setPointerCapture(w.pointerId),b.current={x:w.clientX,y:w.clientY},_.current={primary:r,secondary:i},E.current=!1,S.current=w.shiftKey,C.current=w.altKey,m.current=!0,y.current=w.button===1,u())},K=w=>{if(p||!m.current||!w.currentTarget.hasPointerCapture(w.pointerId))return;const O=w.clientX-b.current.x,$=w.clientY-b.current.y;if((Math.abs(O)>1||Math.abs($)>1)&&(E.current=!0),!E.current&&Math.abs(O)<1&&Math.abs($)<1)return;w.preventDefault(),w.stopPropagation();const de=S.current!==w.shiftKey,ae=C.current!==w.altKey;if(de||ae){let H=s*.5;S.current&&(H*=10),C.current&&(H*=.1),_.current.primary=_.current.primary+O*H,_.current.secondary=_.current.secondary-$*H,b.current={x:w.clientX,y:w.clientY},S.current=w.shiftKey,C.current=w.altKey}if(y.current){let H=.01;w.shiftKey&&(H*=3),w.altKey&&(H*=.3);const q=1+$*H;let B=_.current.primary*q,Z=_.current.secondary*q;!isNaN(B)&&!isNaN(Z)&&c(B,Z)}else{let H=s*.5;w.shiftKey&&(H*=10),w.altKey&&(H*=.1);let q=_.current.primary+O*H,B=_.current.secondary-$*H;!isNaN(q)&&!isNaN(B)&&c(q,B)}},ce=w=>{p||(w.currentTarget.releasePointerCapture(w.pointerId),m.current=!1,y.current=!1,f(),E.current=!1,w.currentTarget.matches(":hover")||(v(!1),h(!1)))},oe=w=>{p||(w.preventDefault(),w.stopPropagation(),u(),c(0,0),f())},J=g||m.current;return d.jsxs("div",{className:`
            ...
            `,onPointerDown:z,onPointerMove:K,onPointerUp:ce,onMouseEnter:F,onMouseLeave:x,onDoubleClick:oe,title:`Drag: Horizontal=${e.toUpperCase()}, Vertical=${o.toUpperCase()} | Middle-click: Scale both proportionally | Double-click: Reset (Shift=Fast, Alt=Slow)`,children:[J&&d.jsx("div",{className:"absolute inset-0 opacity-30",style:{backgroundImage:"repeating-linear-gradient(45deg, transparent, transparent 3px, rgba(255,255,255,0.05) 3px, rgba(255,255,255,0.05) 6px)"}}),d.jsxs("div",{className:"relative w-full h-full",children:[d.jsx("div",{className:`
                        absolute bottom-0 left-0 h-[2px] ${T.color}
                        transition-all duration-150
                        ${J?"opacity-60 w-full":"opacity-0 w-0"}
                    `}),d.jsx("div",{className:`
                        absolute bottom-0 left-0 w-[2px] ${L.color}
                        transition-all duration-150
                    ...
                    `,children:[d.jsx("div",{className:`absolute w-2 h-[1px] ${T.color} -translate-x-1/2`}),d.jsx("div",{className:`absolute h-2 w-[1px] ${L.color} -translate-y-1/2`})]}),d.jsx("div",{className:`
                        absolute inset-0 pointer-events-none
                        transition-opacity duration-150
                        ${y.current?"opacity-100":"opacity-0"}
                    `,children:d.jsxs("div",{className:"absolute inset-0 flex items-center justify-center",children:[d.jsx("div",{className:"w-full h-[1px] bg-cyan-400/50 rotate-45"}),d.jsx("div",{className:"absolute w-full h-[1px] bg-cyan-400/50 -rotate-45"})]})})]})]})},yo=({azimuth:e,pitch:o,onChange:t,onDragStart:a,onDragEnd:r,disabled:i=!1,size:n=80})=>{const l=P.useRef(null),s=P.useRef(!1),[c,u]=P.useState(!1),[f,p]=P.useState(!1),[h,g]=P.useState(!1),v=P.useRef({x:0,y:0}),m=P.useRef({azimuth:e,pitch:o}),y=P.useRef({azimuth:e,pitch:o}),b=P.useRef(null);P.useEffect(()=>{m.current={azimuth:e,pitch:o}},[e,o]);const S=f?.05:.5,C=n/2,T=n*.38,L=P.useCallback((w,O,$)=>{const de=w/(Math.PI/2)*$,ae=-(O/(Math.PI/2))*$;return{x:de,y:ae}},[]),F=P.useMemo(()=>L(e,o,T),[e,o,T,L]),x=P.useMemo(()=>{const w=Math.cos(o),O=Math.sin(o),$=Math.cos(e),ae=Math.sin(e)*w,H=O,q=-$*w,B=ae,Z=-H,X=Math.sqrt(B*B+Z*Z),ie=q>0,Fe=X>.001?Math.min(X,1)*T:0,Le=q<=0?1+(1-Math.min(X,1))*.5:1-q*.95,je=X>.001?B/X*Fe:0,xe=X>.001?Z/X*Fe:0;return{x:je,y:xe,isBack:ie,length:Fe,headScale:Le,dirX:ae,dirY:H,dirZ:q}},[e,o,T]),z=P.useCallback((w,O,$)=>{const de=w/$*(Math.PI/2),ae=-(O/$)*(Math.PI/2);return{azimuth:de,pitch:ae}},[]),K=P.useCallback((w,O)=>{let $=w,de=O;h&&b.current&&(b.current==="x"?de=0:$=0);const ae=$*S,H=de*S,q=L(m.current.azimuth,m.current.pitch,T),B=q.x+ae,Z=q.y+H,{azimuth:X,pitch:ie}=z(B,Z,T);h&&b.current?b.current==="x"?(m.current={azimuth:X,pitch:y.current.pitch},t(X,y.current.pitch)):(m.current={azimuth:y.current.azimuth,pitch:ie},t(y.current.azimuth,ie)):(m.current={azimuth:X,pitch:ie},t(X,ie))},[L,z,t,T,S,h]),ce=w=>{i||w.button===0&&(w.preventDefault(),w.stopPropagation(),w.currentTarget.setPointerCapture(w.pointerId),s.current=!0,u(!0),v.current={x:w.clientX,y:w.clientY},m.current={azimuth:e,pitch:o},y.current={azimuth:e,pitch:o},b.current=null,a==null||a(),p(w.altKey),g(w.shiftKey))},oe=w=>{if(i||!s.current)return;const O=w.clientX-v.current.x,$=w.clientY-v.current.y;v.current={x:w.clientX,y:w.clientY},p(w.altKey),g(w.shiftKey),h&&!b.current&&(Math.abs(O)>2||Math.abs($)>2)&&(b.current=Math.abs(O)>Math.abs($)?"x":"y"),K(O,$)},J=w=>{s.current&&(s.current=!1,u(!1),p(!1),g(!1),b.current=null,r==null||r())};return d.jsxs("div",{ref:l,className:`
            ...
            `,style:{width:n,height:n,touchAction:"none",boxShadow:c?"0 0 20px rgba(34, 211, 238, 0.3)":"none"},onPointerDown:ce,onPointerMove:oe,onPointerUp:J,onPointerLeave:J,onDoubleClick:w=>{i||(w.preventDefault(),w.stopPropagation(),a==null||a(),t(0,0),r==null||r())},onContextMenu:w=>{},title:"Drag to rotate direction, Double-click to reset",children:[d.jsx("div",{className:"absolute rounded-full border border-white/10 pointer-events-none",style:{width:T*2,height:T*2,left:C-T,top:C-T}}),d.jsx("div",{className:"absolute w-full h-px bg-white/10 pointer-events-none",style:{top:C}}),d.jsx("div",{className:"absolute h-full w-px bg-white/10 pointer-events-none",style:{left:C}}),d.jsx("div",{className:"absolute w-1.5 h-1.5 bg-white/40 rounded-full pointer-events-none",style:{left:C-3,top:C-3}}),d.jsx("div",{className:"absolute pointer-events-none rounded-full transition-transform duration-75",style:{left:C+F.x,top:C+F.y,width:8,height:8,marginLeft:-4,marginTop:-4,background:x.isBack?"#ef4444":"#22d3ee",boxShadow:`0 0 8px ${x.isBack?"#ef4444":"#22d3ee"}`,transform:c?"scale(1.2)":"scale(1)"}}),x.isBack&&d.jsx("div",{className:"absolute inset-0 rounded-full border-2 border-red-500/30 pointer-events-none animate-pulse"}),d.jsxs(d.Fragment,{children:[d.jsxs("svg",{className:"absolute inset-0 pointer-events-none",style:{width:n,height:n},children:[Math.abs(e)>.01&&d.jsxs(d.Fragment,{children:[d.jsx("ellipse",{cx:C,cy:C,rx:T*Math.abs(Math.sin(e)),ry:T,fill:"none",stroke:x.isBack?"#ef4444":"#22d3ee",strokeWidth:"1.5",opacity:x.isBack?.175:.35,clipPath:x.x>0?"url(#longitudeRight)":"url(#longitudeLeft)"}),d.jsx("ellipse",{cx:C,cy:C,rx:T*Math.abs(Math.sin(e)),ry:T,fill:"none",stroke:x.isBack?"#22d3ee":"#ef4444",strokeWidth:"1.5",opacity:x.isBack?.35:.175,clipPath:x.x>0?"url(#longitudeLeft)":"url(#longitudeRight)"})]}),Math.abs(o)>.01&&d.jsxs(d.Fragment,{children:[d.jsx("ellipse",{cx:C,cy:C,rx:T,ry:T*Math.abs(Math.sin(o)),fill:"none",stroke:x.isBack?"#ef4444":"#22d3ee",strokeWidth:"1.5",opacity:x.isBack?.15:.3,clipPath:x.y<0?"url(#latitudeTop)":"url(#latitudeBottom)"}),d.jsx("ellipse",{cx:C,cy:C,rx:T,ry:T*Math.abs(Math.sin(o)),fill:"none",stroke:x.isBack?"#22d3ee":"#ef4444",strokeWidth:"1.5",opacity:x.isBack?.3:.15,clipPath:x.y<0?"url(#latitudeBottom)":"url(#latitudeTop)"})]}),d.jsxs("defs",{children:[d.jsx("clipPath",{id:"longitudeRight",children:d.jsx("rect",{x:C,y:"0",width:C,height:n})}),d.jsx("clipPath",{id:"longitudeLeft",children:d.jsx("rect",{x:"0",y:"0",width:C,height:n})}),d.jsx("clipPath",{id:"latitudeTop",children:d.jsx("rect",{x:"0",y:"0",width:n,height:C})}),d.jsx("clipPath",{id:"latitudeBottom",children:d.jsx("rect",{x:"0",y:C,width:n,height:C})})]}),d.jsx("line",{x1:C,y1:C,x2:C+x.x,y2:C+x.y,stroke:x.isBack?"#ef4444":"#22d3ee",strokeWidth:"2",strokeDasharray:"4 2",opacity:.3+x.length/T*.5}),d.jsx("polygon",{points:"0,-8 -6,4 6,4",fill:x.isBack?"#ef4444":"#22d3ee",opacity:Math.max(.1,.6+(x.headScale-1)*.4),transform:`translate(${C+x.x}, ${C+x.y}) rotate(${Math.atan2(x.y,x.x)*180/Math.PI+90}) scale(${Math.max(.9,.9+x.headScale*.1)}, ${Math.max(.05,x.headScale)})`})]}),c&&d.jsx("div",{className:"absolute -bottom-5 left-1/2 -translate-x-1/2 whitespace-nowrap",children:d.jsxs("span",{className:"text-[9px] text-cyan-400 font-mono bg-black/60 px-1 rounded",children:[(e*180/Math.PI).toFixed(0),"° / ",(o*180/Math.PI).toFixed(0),"°"]})})]})]})},wt=Math.PI/180,qi=180/Math.PI,Wi=["x","y","z","w"],_t={x:0,y:1,z:2,w:3},Xi=e=>{const o=e.length();if(o<1e-9)return{azimuth:0,pitch:0};const t=Math.max(-1,Math.min(1,e.y/o));return{azimuth:Math.atan2(e.x/o,e.z/o),pitch:Math.asin(t)}},Yi=(e,o)=>{const t=Math.cos(o);return new N(t*Math.sin(e),Math.sin(o),t*Math.cos(e))},fl=({label:e,value:o,onChange:t,min:a=-1e4,max:r=1e4,step:i=.01,disabled:n=!1,convertRadToDeg:l=!1,mode:s="normal",modeToggleable:c=!1,showLiveIndicator:u=!1,liveValue:f,defaultValue:p,hardMin:h,hardMax:g,axisMin:v,axisMax:m,axisStep:y,onDragStart:b,onDragEnd:_,headerRight:E,showDualAxisPads:S=!0,linkable:C=!1,scale:T})=>{const[L,F]=P.useState(o.clone()),[x,z]=P.useState(null),[K,ce]=P.useState(s),[oe,J]=P.useState("degrees"),[w,O]=P.useState("degrees"),[$,de]=P.useState(C),ae=P.useRef(!1),H=P.useRef(null),q=P.useRef(null);P.useEffect(()=>{ce(s)},[s]);const B=pe(I=>I.openContextMenu),Z="w"in o,X="z"in o,ie=K==="rotation",Fe=K==="toggle",Le=K==="mixed",je=K==="direction"&&X,xe=je?Xi(L):{azimuth:0,pitch:0},We=(I,D)=>{const V=Math.max(-Math.PI/2,Math.min(Math.PI/2,D)),W=Yi(I,V);ne(0,I),ne(1,V),F(W),t(W)};P.useEffect(()=>{if(ae.current)return;const I=1e-4,D=Math.abs(o.x-L.x),V=Math.abs(o.y-L.y),W=X?Math.abs(o.z-L.z):0,me=Z?Math.abs(o.w-L.w):0;(D>I||V>I||W>I||me>I)&&F(o.clone())},[o,X,Z]);const k=()=>{ae.current=!0,H.current=L.clone(),b&&b()},A=()=>{H.current=null,ae.current=!1,_&&_()},fe=I=>{if(ie)return oe==="degrees"?Je:po;if(T==="pi")return w==="pi"?po:Je;if(l)return Je},_e=I=>{if(ie){const ee=oe==="degrees"?60*Math.PI/180:.05;return{min:-2*Math.PI,max:2*Math.PI,step:ee,hardMin:void 0,hardMax:void 0}}const D=v||{x:a,y:a,z:a},V=m||{x:r,y:r,z:r},W=y||{x:i,y:i,z:i},me=T==="pi"&&w==="degrees"?qi:1;return{min:D[I],max:V[I],step:(W[I]??i)*me,hardMin:h,hardMax:g}},ne=(I,D)=>{const V=q.current;if(!V)return;const W=V.querySelector(`[data-axis-index="${I}"]`);if(!W)return;const me=Wi[I],ee=fe(),zt=W.querySelector('[data-role="value"]');zt&&(zt.textContent=ee!=null&&ee.format?ee.format(D):Ho(D));const At=W.querySelector('[data-role="fill"]');if(At){const Ft=_e(me),Dt=Ft.min??a,Ot=Ft.max??r;if(Dt!==Ot){const Jo=Vo(D,Dt,Ot,ee);At.style.width=`${Jo}%`}}},Pe=(I,D)=>{const V=H.current||L,W=V.clone();if($&&!ie){const me=V[I],ee=D-me;W.x=V.x+ee,W.y=V.y+ee,X&&(W.z=V.z+ee),Z&&(W.w=V.w+ee),ne(0,W.x),ne(1,W.y),X&&ne(2,W.z),Z&&ne(3,W.w)}else W[I]=D;F(W),t(W)},Se=(I,D,V,W)=>{const ee=(H.current||L).clone();ee[I]=V,ee[D]=W,ne(_t[I],V),ne(_t[D],W),F(ee),t(ee)},Ie=x==="xy",Xe=x==="xy"||x==="zy",ut=x==="zy"||x==="wz",Ne=x==="wz",Te=I=>{if(f)return f[I]},ft=I=>{if(p)return p[I]},ot=L,qo={x:Ie,y:Xe,z:ut,w:Ne},ze=I=>({axisIndex:_t[I],value:L[I],..._e(I),onUpdate:D=>Pe(I,D),onDragStart:k,onDragEnd:A,disabled:n,highlight:qo[I],mapping:fe(),mapTextInput:ie||T==="pi",liveValue:u?Te(I):void 0,defaultValue:ft(I)}),Wo=[{on:"bg-red-500/30 text-red-300 border-red-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-green-500/30 text-green-300 border-green-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-blue-500/30 text-blue-300 border-blue-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"},{on:"bg-purple-500/30 text-purple-300 border-purple-500/40",off:"bg-white/[0.04] text-gray-600 border-white/5"}],kt=(I,D,V)=>{const me=L[I]>.5,ee=Wo[D];return d.jsxs("button",{className:`flex items-center justify-center gap-1 text-[10px] font-bold transition-all border ${me?ee.on:ee.off} ${n?"opacity-40 pointer-events-none":"cursor-pointer hover:brightness-125"} ${V||"flex-1"}`,onClick:()=>Pe(I,me?0:1),disabled:n,children:[V?null:d.jsx("span",{children:I}),d.jsx("span",{className:`text-[8px] ${me?"opacity-80":"opacity-70"}`,children:me?"ON":"OFF"})]},I)},Xo=()=>c?d.jsx("button",{onClick:()=>ce(I=>I==="rotation"?"normal":"rotation"),className:`text-[10px] p-1 rounded transition-colors mr-2 ${K==="rotation"?"text-cyan-400 bg-cyan-500/20":"text-gray-500 hover:text-gray-300"}`,title:K==="rotation"?"Rotation mode (π units)":"Normal mode",children:"⟳"}):null,Yo=()=>!C||ie?null:d.jsx("button",{onClick:()=>de(I=>!I),className:`p-1 rounded transition-colors mr-2 ${$?"text-cyan-400 bg-cyan-500/20":"text-gray-600 hover:text-gray-400"}`,title:$?"Axes linked (uniform)":"Link axes",children:d.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[d.jsx("path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"}),d.jsx("path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"})]})}),Ko=I=>{const D=[];ie&&D.push({label:"Rotation Units",action:()=>{},isHeader:!0},{label:"Degrees (°)",checked:oe==="degrees",action:()=>J("degrees")},{label:"Radians (π)",checked:oe==="radians",action:()=>J("radians")}),!ie&&T==="pi"&&D.push({label:"Display Units",action:()=>{},isHeader:!0},{label:"Radians (π)",checked:w==="pi",action:()=>O("pi")},{label:"Degrees (°)",checked:w==="degrees",action:()=>O("degrees")}),X&&(s==="rotation"||s==="axes")&&D.push({label:"Display Mode",action:()=>{},isHeader:!0},{label:"Azimuth / Pitch (A/P)",checked:K==="rotation",action:()=>ce("rotation")},{label:"Per-Axis (X/Y/Z)",checked:K==="axes"||K==="normal",action:()=>ce("normal")}),D.length!==0&&(I.preventDefault(),I.stopPropagation(),B(I.clientX,I.clientY,D,["ui.vector"]))};return d.jsxs("div",{className:"mb-px animate-slider-entry",children:[e&&d.jsxs("div",{className:"flex items-stretch bg-white/[0.12] rounded-t-sm h-9 md:h-[26px] overflow-hidden border-b border-white/5",children:[d.jsxs("div",{className:"flex-1 flex items-center gap-2 px-2 min-w-0",children:[c&&Xo(),E,d.jsx("label",{className:`text-[10px] font-medium tracking-tight select-none flex items-center gap-2 truncate pointer-events-none ${n?"text-gray-600":"text-gray-400"}`,children:e})]}),C&&!ie&&d.jsx("div",{className:"flex items-center px-1 border-l border-white/5",children:Yo()})]}),d.jsx("div",{className:"relative h-9 md:h-[26px] flex items-center touch-none overflow-hidden rounded-b-sm",style:{touchAction:"none"},onContextMenu:Ko,"data-help-id":"ui.vector",children:d.jsx("div",{ref:q,className:"flex gap-px w-full h-full",children:Fe?d.jsx(d.Fragment,{children:["x","y","z","w"].slice(0,Z?4:X?3:2).map((I,D)=>kt(I,D))}):Le?d.jsxs(d.Fragment,{children:[kt("x",0,"w-14 flex-shrink-0"),d.jsx(Ce,{...ze("y"),disabled:n||L.x<.5})]}):je?d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"flex items-center justify-center px-1 flex-shrink-0",children:d.jsx(yo,{azimuth:xe.azimuth,pitch:xe.pitch,onChange:(I,D)=>{We(I,D)},onDragStart:k,onDragEnd:A,disabled:n,size:56})}),d.jsx(Ce,{axisIndex:0,value:xe.azimuth,min:-Math.PI,max:Math.PI,step:wt,onUpdate:I=>We(I,xe.pitch),onDragStart:k,onDragEnd:A,disabled:n,mapping:Je,mapTextInput:!0,customLabel:"Az"}),d.jsx(rt,{primaryAxis:"x",secondaryAxis:"y",primaryIndex:0,secondaryIndex:1,primaryValue:xe.azimuth,secondaryValue:xe.pitch,min:-Math.PI,max:Math.PI,step:wt,onUpdate:(I,D)=>We(I,D),onDragStart:k,onDragEnd:A,disabled:n,onHover:I=>z(I?"xy":null)}),d.jsx(Ce,{axisIndex:1,value:xe.pitch,min:-Math.PI/2,max:Math.PI/2,step:wt,onUpdate:I=>We(xe.azimuth,I),onDragStart:k,onDragEnd:A,disabled:n,mapping:Je,mapTextInput:!0,customLabel:"Pt"})]}):ie?d.jsxs(d.Fragment,{children:[X&&d.jsx(Ce,{...ze("z"),customLabel:"∠"}),d.jsx("div",{className:"flex items-center justify-center px-1",children:d.jsx(yo,{azimuth:L.x,pitch:L.y,onChange:(I,D)=>{const V=L.clone();V.x=I,V.y=D,ne(0,I),ne(1,D),F(V),t(V)},onDragStart:k,onDragEnd:A,disabled:n,size:56})}),d.jsx("div",{className:"contents",children:d.jsx(Ce,{...ze("x"),customLabel:"A"})}),d.jsx(Ce,{...ze("y"),customLabel:"P"})]}):d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"contents",children:d.jsx(Ce,{...ze("x")})}),S&&d.jsx(rt,{primaryAxis:"x",secondaryAxis:"y",primaryIndex:0,secondaryIndex:1,primaryValue:L.x,secondaryValue:L.y,min:a,max:r,step:i,onUpdate:(I,D)=>Se("x","y",I,D),onDragStart:k,onDragEnd:A,disabled:n,onHover:I=>z(I?"xy":null)}),d.jsx(Ce,{...ze("y")}),X&&S&&d.jsx(rt,{primaryAxis:"z",secondaryAxis:"y",primaryIndex:2,secondaryIndex:1,primaryValue:ot.z,secondaryValue:ot.y,min:a,max:r,step:i,onUpdate:(I,D)=>Se("z","y",I,D),onDragStart:k,onDragEnd:A,disabled:n,onHover:I=>z(I?"zy":null)}),X&&d.jsx(Ce,{...ze("z")}),Z&&S&&d.jsx(rt,{primaryAxis:"x",secondaryAxis:"z",primaryIndex:3,secondaryIndex:2,primaryValue:L.w,secondaryValue:L.z,min:a,max:r,step:i,onUpdate:(I,D)=>Se("w","z",I,D),onDragStart:k,onDragEnd:A,disabled:n,onHover:I=>z(I?"wz":null)}),Z&&d.jsx(Ce,{...ze("w")})]})})})]})},Ki={default:"",panel:"px-2 py-0.5 text-[9px] font-bold text-gray-500 hover:text-gray-300 bg-neutral-800 rounded-sm"},Ji=({open:e})=>d.jsx("svg",{className:`w-2 h-2 transition-transform ${e?"rotate-90":""}`,viewBox:"0 0 6 10",fill:"currentColor",children:d.jsx("path",{d:"M0 0l6 5-6 5z"})}),pl=({label:e,children:o,defaultOpen:t=!0,count:a,labelVariant:r="secondary",labelColor:i,rightContent:n,className:l="",headerClassName:s="",variant:c="default",open:u,onToggle:f})=>{const p=s||Ki[c],[h,g]=P.useState(t),v=u!==void 0,m=v?u:h,y=()=>{f&&f(),v||g(b=>!b)};return d.jsxs("div",{className:l,children:[d.jsxs("div",{className:`flex items-center gap-1.5 w-full px-2 py-1 text-left select-none hover:bg-white/5 transition-colors rounded-sm ${p}`,children:[d.jsxs("button",{onClick:y,className:"flex items-center gap-1.5 flex-1 min-w-0",children:[d.jsx(Ji,{open:m}),d.jsx(Ui,{variant:r,color:i,children:e}),a!==void 0&&d.jsx("span",{className:"text-[8px] bg-white/10 text-gray-400 px-1.5 py-0.5 rounded ml-1",children:a})]}),n&&d.jsx("div",{className:"ml-auto flex items-center gap-1",children:n})]}),m&&o]})},Zi=`
  /*
...
`)},Qi=(e,o)=>{var l;const{shader:t,...a}=e,r={};(l=t.preambleVars)!=null&&l.length&&(r.preambleVars=t.preambleVars),t.usesSharedRotation&&(r.usesSharedRotation=!0);const i={...a,...Object.keys(r).length>0?{shaderMeta:r}:{},defaultPreset:o};let n=`<!--
...
`),n},en=e=>{const o=u=>{const f=new RegExp(`<${u}>([\\s\\S]*?)<\\/${u}>`),p=e.match(f);return p?p[1].trim():null},t=o("Metadata");if(!t){try{const u=JSON.parse(e);if(u.id&&u.shader)return u}catch{}throw new Error("Invalid GMF: Missing Metadata tag")}const a=JSON.parse(t),r=o("Shader_Preamble"),i=o("Shader_Function"),n=o("Shader_Loop"),l=o("Shader_Init"),s=o("Shader_Dist");if(!i||!n)throw new Error("Invalid GMF: Missing essential shader blocks (<Shader_Function> or <Shader_Loop>)");const c={function:i,loopBody:n,preamble:r||void 0,loopInit:l||void 0,getDist:s||void 0};return a.shaderMeta&&(a.shaderMeta.preambleVars&&(c.preambleVars=a.shaderMeta.preambleVars),a.shaderMeta.usesSharedRotation&&(c.usesSharedRotation=!0),delete a.shaderMeta),{...a,shader:c}},tn=e=>{const o=e.trimStart();return o.startsWith("<!--")||o.startsWith("<Metadata>")},hl=e=>{const o=he.get(e.formula);if(!o)return JSON.stringify(e,null,2);let t=Qi(o,o.defaultPreset);return t+=`<!-- Full scene state (camera, lights, features, quality, animations) -->
`,t+=`<Scene>
${Uo(e)}
</Scene>
`,t},ml=e=>{if(tn(e)){const t=en(e),a=e.match(/<Scene>([\s\S]*?)<\/Scene>/);if(a){const i=JSON.parse(a[1].trim());return{def:t,preset:i}}const r=t.defaultPreset||{formula:t.id};return r.formula||(r.formula=t.id),{def:t,preset:r}}return{preset:JSON.parse(e)}};export{gs as $,ke as A,ul as B,et as C,ts as D,fl as E,R as F,Ys as G,pl as H,rs as I,dl as J,Cs as K,pn as L,un as M,Ni as N,Dn as O,ks as P,ms as Q,xs as R,Hi as S,Vn as T,hs as U,Y as V,os as W,ps as X,Kn as Y,Jn as Z,Zn as _,Lt as a,al as a$,hl as a0,ha as a1,wn as a2,Qe as a3,he as a4,Ms as a5,qn as a6,Wn as a7,Un as a8,ss as a9,Fn as aA,En as aB,On as aC,Qs as aD,el as aE,qe as aF,Go as aG,Js as aH,Zs as aI,tl as aJ,ol as aK,Hn as aL,Ue as aM,Bn as aN,is as aO,Ss as aP,us as aQ,fs as aR,Rn as aS,mo as aT,Re as aU,as as aV,Ts as aW,Es as aX,Qi as aY,rl as aZ,U as a_,$n as aa,ln as ab,ml as ac,Xn as ad,ls as ae,es as af,ws as ag,cs as ah,Fi as ai,Gn as aj,An as ak,_n as al,G as am,fo as an,ns as ao,Is as ap,_s as aq,eo as ar,cn as as,dn as at,fn as au,Bo as av,hn as aw,jn as ax,Yn as ay,Nn as az,Mn as b,il as b0,nl as b1,sl as b2,Ks as b3,ll as b4,cl as b5,po as b6,Vi as b7,Ka as b8,at as b9,Os as bA,Ds as bB,js as bC,Rs as bD,yn as bE,gn as bF,vn as bG,bn as bH,Ls as bI,kn as bJ,uo as bK,Do as bL,rr as ba,ir as bb,sr as bc,nr as bd,lr as be,ei as bf,ue as bg,_i as bh,xn as bi,Sn as bj,Ps as bk,ds as bl,Xs as bm,Hs as bn,Vs as bo,Gs as bp,Us as bq,qs as br,Ns as bs,Ws as bt,In as bu,Cn as bv,As as bw,Fs as bx,Bs as by,$s as bz,Be as c,se as d,Ho as e,j as f,Oe as g,Qn as h,Tn as i,Pn as j,tt as k,Et as l,mn as m,Me as n,zs as o,ys as p,vs as q,bs as r,zn as s,He as t,pe as u,dt as v,Ao as w,Fo as x,Ui as y,Ln as z};
