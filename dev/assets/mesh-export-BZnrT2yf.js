...
`}function St(e){const t=e.definition;let o="";t.shader.preamble&&(o=cn(t.shader.preamble,t.id,t.shader.preambleVars));const n=un(t.shader.function,t.id,t.shader.preambleVars);let s="";return t.shader.loopInit&&(s=Fo(t.shader.loopInit,t.id,t.shader.preambleVars)),{preamble:o,func:n,loopInit:s}}function He(e,t){return!!e.shader.supportsCuttingPlane||!!(t!=null&&t.definition.shader.supportsCuttingPlane)}function Ct(e,t,o){let n="",s="";if(o){const i=fn(o.definition.shader.loopBody,o.definition.id);let l="";o.definition.shader.loopInit&&(l=Fo(o.definition.shader.loopInit,o.definition.id,o.definition.shader.preambleVars));const f=!!o.definition.shader.usesSharedRotation;({preLoop:n,inLoop:s}=dn(i,l,f))}const r=o?`if (!skipMainFormula) { ${e.shader.loopBody} }`:e.shader.loopBody;return`  vec4 z = vec4(pos, 0.0);
...
}`;function wn(e){const t=e.definition,o=e.interlace,n=o?St(o):null;return`#version 300 es
...
}`}function Sn(e){const t=e.definition,o=Lo(e),n=e.interlace,s=n?St(n):null,r=_o(t),a=Bo(o,!!t.shader.getDist,"uVoxelSize * 0.5",e.estimator,He(t,n));return`#version 300 es
precision highp float;
...
}`}function Cn(e){const t=e.definition,o=Lo(e),n=e.interlace,s=n?St(n):null,r=_o(t),a=o==="ifs"?"0.0":"0.001",i=Bo(o,!!t.shader.getDist,a,e.estimator,He(t,n));return`#version 300 es
...
void main() {
  ...
  fragColor = vec4(col, 1.0);
}`}const qe=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF","uVec2A","uVec2B","uVec2C","uVec3A","uVec3B","uVec3C","uVec4A","uVec4B","uVec4C","uJulia","uJuliaMode","uEscapeThresh","uDistanceMetric",...ot.scalars,...ot.vec2s,...ot.vec3s,...ot.vec4s,"uInterlaceEnabled","uInterlaceInterval","uInterlaceStartIter","uFudgeFactor","uDetail","uPixelThreshold","uSurfaceThreshold","uClipBounds","uBoundsMin","uBoundsMax"];mn();const ko=[{name:me.Time,type:"float",default:0},{name:me.FrameCount,type:"int",default:0},{name:me.Resolution,type:"vec2",default:new Be(100,100)},{name:me.SceneOffsetHigh,type:"vec3",default:new Ve},{name:me.SceneOffsetLow,type:"vec3",default:new Ve},{name:me.CameraPosition,type:"vec3",default:new Ve},{name:me.CamBasisX,type:"vec3",default:new Ve},{name:me.CamBasisY,type:"vec3",default:new Ve},{name:me.CamForward,type:"vec3",default:new Ve},{name:me.RegionMin,type:"vec2",default:new Be(0,0)},{name:me.RegionMax,type:"vec2",default:new Be(1,1)},{name:me.ImageTileOrigin,type:"vec2",default:new Be(0,0)},{name:me.ImageTileSize,type:"vec2",default:new Be(1,1)},{name:me.FullOutputResolution,type:"vec2",default:new Be(100,100)},{name:me.TilePixelOrigin,type:"vec2",default:new Be(0,0)},{name:me.HistoryTexture,type:"sampler2D",default:null},{name:me.BlendFactor,type:"float",default:1},{name:me.Jitter,type:"vec2",default:new Be(0,0)},{name:me.BlueNoiseTexture,type:"sampler2D",default:null},{name:me.BlueNoiseResolution,type:"vec2",default:new Be(128,128)},{name:me.HistogramLayer,type:"int",default:0},{name:me.InternalScale,type:"float",default:1},{name:me.PixelSizeBase,type:"float",default:.01,comment:"CPU: length(uCamBasisY)/resolution.y*2, avoids per-fragment sqrt"},{name:me.OutputPass,type:"float",default:0,comment:"0=beauty, 1=alpha, 2=depth"},{name:me.DepthMin,type:"float",default:0},{name:me.DepthMax,type:"float",default:5},{name:me.PreRotMatrix,type:"mat3",default:new Lt},{name:me.PostRotMatrix,type:"mat3",default:new Lt},{name:me.WorldRotMatrix,type:"mat3",default:new Lt},{name:me.EnvRotationMatrix,type:"mat2",default:[1,0,0,1]},{name:me.FogColorLinear,type:"vec3",default:new Ve(0,0,0),comment:"CPU: InverseACESFilm(uFogColor)"}],Wt=Eo.getUniformDefinitions(),Mn=new Set(ko.map(e=>e.name)),ro=Wt.filter(e=>Mn.has(e.name)).map(e=>e.name);if(ro.length>0)throw new Error(`[UniformSchema] Feature uniform(s) shadow base schema: ${ro.join(", ")}. Rename in the feature def (themed prefix: uPT*/uLight*/uModular*) or remove the base entry.`);const io=new Set,$t=[];for(const e of Wt)io.has(e.name)?$t.push(e.name):io.add(e.name);if($t.length>0)throw new Error(`[UniformSchema] Two features declare the same uniform: ${$t.join(", ")}. Rename one (themed prefix convention: uPT*/uLight*/uModular*).`);const Oo=[...ko,...Wt];Oo.reduce((e,t)=>(e[t.name]=t.default,e),{});const Tn=()=>{let e=`precision highp float;
precision highp int;
...
`)}),e+=`
in vec2 vUv;
`,e},En=Tn(),lo=(e,t="",o,n="",s="",r="",a="",i="",l="",f="",v="",m="",d="")=>{const x=r.includes("skipMainFormula");return`
${o}
...
`}),t}buildUniformsString(){let t=En+`
...
`);this.integrators.push(In(h))}const i=this.integrators.join(`
`),l=yn(this.useRotation),f=lo(this.formulaLoopBody,this.formulaInit,this.formulaDist,this.hybridInit.join(`
`),this.hybridPreLoop.join(`
`),this.hybridInLoop.join(`
`),this.distOverrideInit,this.distOverrideInLoopFull,this.distOverrideInLoopGeom,this.distOverridePostFull,this.distOverridePostGeom,this.postMapCode.join(`
`),this.postDistCode.join(`
...
`}const v=Fn(this.materialLogic.join(`
...
`)),g=d?Bt(this.isLite,!1,this.precisionMode,0,"","","traceSceneLean"):"",y=Pn(d,this.maxLights,this.compositeLogic.join(`
`)),p=co(this.renderMode),E=An(this.postProcessLogic.join(`
`));return`
${t}
${o}
${n}
...
${E}
${y}
`}}class Dn{static generateFragmentShader(t){return this.buildShader(t,"Main")}static generatePhysicsShader(t){return this.buildShader(t,"Physics")}static generateHistogramShader(t){return this.buildShader(t,"Histogram")}static generateMeshSDFLibrary(t){return this.buildShader(t,"Mesh")}static buildShader(t,o){const n=new Rn(o),s=t.lighting,a=(s==null?void 0:s.ptEnabled)!==!1&&(t.renderMode==="PathTracing"||(s==null?void 0:s.renderMode)===1);n.setRenderMode(a?"PathTracing":"Direct");const i=t.quality||{};return n.setQuality(i.precisionMode===1,i.precisionMode??0),Eo.getAll().forEach(f=>{f.inject&&f.inject(n,t,o)}),n.buildFragment()}}class mt{constructor(t=65536){oe(this,"data");oe(this,"length");this.data=new Float32Array(t),this.length=0}push3(t,o,n){if(this.length+3>this.data.length){const s=this.data.length*2,r=new Float32Array(s);r.set(this.data),this.data=r}this.data[this.length++]=t,this.data[this.length++]=o,this.data[this.length++]=n}trim(){return this.data.subarray(0,this.length)}}class jo{constructor(t=65536){oe(this,"data");oe(this,"length");this.data=new Uint32Array(t),this.length=0}push3(t,o,n){if(this.length+3>this.data.length){const s=this.data.length*2,r=new Uint32Array(s);r.set(this.data),this.data=r}this.data[this.length++]=t,this.data[this.length++]=o,this.data[this.length++]=n}trim(){return this.data.subarray(0,this.length)}}function Ue(e,t,o,n,s){return o=o|0,n=n|0,s=s|0,o=o<0?0:o>=t?t-1:o,n=n<0?0:n>=t?t-1:n,s=s<0?0:s>=t?t-1:s,e[(s*t+n)*t+o]}function Xe(e,t,o,n,s){const r=Math.floor(o),a=Math.floor(n),i=Math.floor(s),l=o-r,f=n-a,v=s-i,m=Ue(e,t,r,a,i),d=Ue(e,t,r+1,a,i),x=Ue(e,t,r,a+1,i),g=Ue(e,t,r+1,a+1,i),y=Ue(e,t,r,a,i+1),p=Ue(e,t,r+1,a,i+1),E=Ue(e,t,r,a+1,i+1),h=Ue(e,t,r+1,a+1,i+1),S=m*(1-l)+d*l,C=x*(1-l)+g*l,N=y*(1-l)+p*l,k=E*(1-l)+h*l,F=S*(1-f)+C*f,R=N*(1-f)+k*f;return F*(1-v)+R*v}function uo(e,t,o,n,s){const a=Xe(e,t,o+.5,n,s)-Xe(e,t,o-.5,n,s),i=Xe(e,t,o,n+.5,s)-Xe(e,t,o,n-.5,s),l=Xe(e,t,o,n,s+.5)-Xe(e,t,o,n,s-.5),f=Math.sqrt(a*a+i*i+l*l);if(f<1e-10)return[0,1,0];const v=1/f;return[a*v,i*v,l*v]}function Se(e,t,o,n){return o+e/(t-1)*(n-o)}function We(e,t,o,n){return(e-o)/(n-o)*(t-1)}const ht=[[0,1],[2,3],[4,5],[6,7],[0,2],[1,3],[4,6],[5,7],[0,4],[1,5],[2,6],[3,7]];function Uo(e,t,o){if(e.length===0)return null;let n=0,s=0,r=0;for(let R=0;R<e.length;R++)n+=e[R].point[0],s+=e[R].point[1],r+=e[R].point[2];const a=1/e.length;n*=a,s*=a,r*=a;let i=0,l=0,f=0,v=0,m=0,d=0,x=0,g=0,y=0;for(let R=0;R<e.length;R++){const V=e[R].normal,u=e[R].point,c=V[0]*u[0]+V[1]*u[1]+V[2]*u[2];i+=V[0]*V[0],l+=V[0]*V[1],f+=V[0]*V[2],v+=V[1]*V[1],m+=V[1]*V[2],d+=V[2]*V[2],x+=V[0]*c,g+=V[1]*c,y+=V[2]*c}const p=.01;i+=p,v+=p,d+=p,x+=p*n,g+=p*s,y+=p*r;const E=i*(v*d-m*m)-l*(l*d-m*f)+f*(l*m-v*f);let h,S,C;if(Math.abs(E)<1e-6)h=n,S=s,C=r;else{const R=1/E;h=R*(x*(v*d-m*m)-l*(g*d-m*y)+f*(g*m-v*y)),S=R*(i*(g*d-m*y)-x*(l*d-m*f)+f*(l*y-g*f)),C=R*(i*(v*y-g*m)-l*(l*y-g*f)+x*(l*m-v*f))}const N=(o[0]-t[0])*.1,k=(o[1]-t[1])*.1,F=(o[2]-t[2])*.1;return h=Math.max(t[0]-N,Math.min(o[0]+N,h)),S=Math.max(t[1]-k,Math.min(o[1]+k,S)),C=Math.max(t[2]-F,Math.min(o[2]+F,C)),[h,S,C]}let Zt=!1;function Ln(){Zt=!0}function fo(){Zt=!1}function mo(){return new Promise(e=>setTimeout(e,0)).then(()=>{if(Zt)throw new Error("CANCELLED")})}async function _n(e,t,o,n,s,r=()=>{}){const a=t-1;r("contouring",0);const i=new Map,l=new mt(8192),f=new mt(8192);let v=0;for(let k=0;k<a;k++){k&7||(r("contouring",Math.round(40*k/a)),await mo());for(let F=0;F<a;F++)for(let R=0;R<a;R++){const V=e[(k*t+F)*t+R],u=V>=0,c=[V,e[(k*t+F)*t+R+1],e[(k*t+(F+1))*t+R],e[(k*t+(F+1))*t+R+1],e[((k+1)*t+F)*t+R],e[((k+1)*t+F)*t+R+1],e[((k+1)*t+(F+1))*t+R],e[((k+1)*t+(F+1))*t+R+1]];let L=!1;for(let M=1;M<8;M++)if(c[M]>=0!==u){L=!0;break}if(!L)continue;const P=[];for(let M=0;M<12;M++){const _=ht[M],D=c[_[0]],O=c[_[1]];if(D>=0==O>=0)continue;const w=R+(_[0]&1),I=F+(_[0]>>1&1),G=k+(_[0]>>2&1),H=R+(_[1]&1),X=F+(_[1]>>1&1),$=k+(_[1]>>2&1);let U=w,Z=I,Q=G,ne=H,K=X,ee=$,re=D;for(let W=0;W<8;W++){const te=(U+ne)*.5,ce=(Z+K)*.5,se=(Q+ee)*.5,J=Xe(e,t,te,ce,se);J>=0==re>=0?(U=te,Z=ce,Q=se,re=J):(ne=te,K=ce,ee=se)}const ie=(U+ne)*.5,le=(Z+K)*.5,ve=(Q+ee)*.5,q=uo(e,t,ie,le,ve);P.push({point:[Se(ie,t,o[0],n[0]),Se(le,t,o[1],n[1]),Se(ve,t,o[2],n[2])],normal:q})}if(P.length===0)continue;const B=[Se(R,t,o[0],n[0]),Se(F,t,o[1],n[1]),Se(k,t,o[2],n[2])],z=[Se(R+1,t,o[0],n[0]),Se(F+1,t,o[1],n[1]),Se(k+1,t,o[2],n[2])],T=Uo(P,B,z);if(!T)continue;const j=uo(e,t,We(T[0],t,o[0],n[0]),We(T[1],t,o[1],n[1]),We(T[2],t,o[2],n[2])),A=(k*a+F)*a+R;i.set(A,v),l.push3(T[0],T[1],T[2]),f.push3(j[0],j[1],j[2]),v++}}if(r("contouring",50),console.log("DC: "+v+" vertices from "+i.size+" cells"),v===0)return{positions:new Float32Array(0),normals:new Float32Array(0),indices:new Uint32Array(0),vertexCount:0,faceCount:0};const m=new jo(8192),d=new Set;let x=0,g=0,y=0;const p=i.size,E=Array.from(i.entries());for(let k=0;k<E.length;k++){E[k][1];const F=E[k][0];y++;const R=F%a,V=(F/a|0)%a,u=F/(a*a)|0;for(let c=0;c<12;c++){const L=ht[c],P=R+(L[0]&1),B=V+(L[0]>>1&1),z=u+(L[0]>>2&1),T=R+(L[1]&1),j=V+(L[1]>>1&1),A=u+(L[1]>>2&1),M=e[(z*t+B)*t+P],_=e[(A*t+j)*t+T];if(M>=0==_>=0)continue;let D;const O=Math.min(P,T),w=Math.min(B,j),I=Math.min(z,A);P!==T?D=0:B!==j?D=1:D=2;const G=(I*t+w)*t*4+O*4+D;if(d.has(G))continue;d.add(G),x++;const H=(D+1)%3,X=(D+2)%3,$=[O,w,I],U=[-1,-1,-1,-1];let Z=!0;for(let ne=0;ne<4;ne++){const K=[$[0],$[1],$[2]];if(K[H]-=ne&1?0:1,K[X]-=ne&2?0:1,K[0]<0||K[1]<0||K[2]<0||K[0]>=a||K[1]>=a||K[2]>=a){Z=!1;break}const ee=(K[2]*a+K[1])*a+K[0],re=i.get(ee);if(re===void 0){Z=!1;break}U[ne]=re}if(!Z){g++;continue}const Q=M>=0;U[0]!==U[1]&&U[0]!==U[3]&&U[1]!==U[3]&&(Q?m.push3(U[0],U[3],U[1]):m.push3(U[0],U[1],U[3])),U[0]!==U[2]&&U[0]!==U[3]&&U[2]!==U[3]&&(Q?m.push3(U[0],U[2],U[3]):m.push3(U[0],U[3],U[2]))}y&4095||(r("contouring",50+Math.round(50*y/p)),await mo())}r("contouring",100),console.log("DC: "+x+" sign-change edges, "+g+" dropped (boundary), "+m.length/3+" faces");const h=l.trim(),S=f.trim(),C=m.trim(),N=Math.floor(m.length/3);return{positions:h,normals:S,indices:C,vertexCount:v,faceCount:N}}let Jt=!1;function Bn(){Jt=!0}function ho(){Jt=!1}function Ot(){return new Promise(e=>setTimeout(e,0)).then(()=>{if(Jt)throw new Error("CANCELLED")})}class zn{constructor(t,o=8,n=1){oe(this,"N");oe(this,"blockSize");oe(this,"defaultValue");oe(this,"blocksPerAxis");oe(this,"blockCellCount");oe(this,"blocks");oe(this,"allocatedCount");this.N=t,this.blockSize=o,this.defaultValue=n,this.blocksPerAxis=Math.ceil(t/o),this.blockCellCount=o*o*o,this.blocks=new Map,this.allocatedCount=0}blockKey(t,o,n){return(n*this.blocksPerAxis+o)*this.blocksPerAxis+t}allocateBlock(t,o,n){const s=this.blockKey(t,o,n);if(!this.blocks.has(s)){const r=new Float32Array(this.blockCellCount);r.fill(this.defaultValue),this.blocks.set(s,r),this.allocatedCount++}return this.blocks.get(s)}hasBlock(t,o,n){return this.blocks.has(this.blockKey(t,o,n))}set(t,o,n,s){const r=this.blockSize,a=t/r|0,i=o/r|0,l=n/r|0,f=this.allocateBlock(a,i,l),v=t-a*r,m=o-i*r,d=n-l*r;f[(d*r+m)*r+v]=s}get(t,o,n){if(t<0||o<0||n<0||t>=this.N||o>=this.N||n>=this.N)return this.defaultValue;const s=this.blockSize,r=t/s|0,a=o/s|0,i=n/s|0,l=this.blockKey(r,a,i),f=this.blocks.get(l);if(!f)return this.defaultValue;const v=t-r*s,m=o-a*s,d=n-i*s;return f[(d*s+m)*s+v]}lerp(t,o,n){const s=Math.floor(t),r=Math.floor(o),a=Math.floor(n),i=t-s,l=o-r,f=n-a,v=this.get(s,r,a),m=this.get(s+1,r,a),d=this.get(s,r+1,a),x=this.get(s+1,r+1,a),g=this.get(s,r,a+1),y=this.get(s+1,r,a+1),p=this.get(s,r+1,a+1),E=this.get(s+1,r+1,a+1),h=v*(1-i)+m*i,S=d*(1-i)+x*i,C=g*(1-i)+y*i,N=p*(1-i)+E*i,k=h*(1-l)+S*l,F=C*(1-l)+N*l;return k*(1-f)+F*f}gradient(t,o,n){const r=this.lerp(t+.5,o,n)-this.lerp(t-.5,o,n),a=this.lerp(t,o+.5,n)-this.lerp(t,o-.5,n),i=this.lerp(t,o,n+.5)-this.lerp(t,o,n-.5),l=Math.sqrt(r*r+a*a+i*i);if(l<1e-10)return[0,1,0];const f=1/l;return[r*f,a*f,i*f]}memoryMB(){return this.allocatedCount*this.blockCellCount*4/(1024*1024)}}function kn(e,t,o,n=8,s=2){const r=o/t,a=Math.ceil(o/n),i=new Set;for(let v=0;v<t-1;v++)for(let m=0;m<t-1;m++)for(let d=0;d<t-1;d++){const g=e[(v*t+m)*t+d]>=0;let y=!1;for(let p=0;p<=1&&!y;p++)for(let E=0;E<=1&&!y;E++)for(let h=0;h<=1;h++){if(h===0&&E===0&&p===0)continue;if(e[((v+p)*t+(m+E))*t+(d+h)]>=0!==g){y=!0;break}}if(y)for(let p=-s;p<=s;p++)for(let E=-s;E<=s;E++)for(let h=-s;h<=s;h++){const S=d+h,C=m+E,N=v+p;S>=0&&C>=0&&N>=0&&S<t&&C<t&&N<t&&i.add((N*t+C)*t+S)}}const l=new zn(o,n,1);let f=0;return i.forEach(v=>{const m=v%t,d=(v/t|0)%t,x=v/(t*t)|0,g=Math.floor(m*r),y=Math.floor(d*r),p=Math.floor(x*r),E=Math.ceil((m+1)*r),h=Math.ceil((d+1)*r),S=Math.ceil((x+1)*r),C=g/n|0,N=y/n|0,k=p/n|0,F=Math.min(a-1,E/n|0),R=Math.min(a-1,h/n|0),V=Math.min(a-1,S/n|0);for(let u=k;u<=V;u++)for(let c=N;c<=R;c++)for(let L=C;L<=F;L++)l.hasBlock(L,c,u)||(l.allocateBlock(L,c,u),f++)}),console.log("Narrow band: "+i.size+" coarse surface cells -> "+f+" fine blocks ("+l.memoryMB().toFixed(1)+" MB) out of "+a*a*a+" total blocks"),{grid:l,surfaceCells:i,bandBlockCount:f}}function Qt(e,t){const o=e.blockSize,n=e.blocksPerAxis;e.blocks.forEach((s,r)=>{const a=r%n,i=(r/n|0)%n,l=r/(n*n)|0;t(a,i,l,a*o,i*o,l*o)})}async function On(e,t,o,n=()=>{}){const s=e.N,r=s-1,a=e.blockSize,i=e.blocksPerAxis;let l=new Map,f=null;function v(T,j,A,M){const _=T/a|0,D=j/a|0,O=A/a|0,w=e.blockKey(_,D,O),I=T-_*a,G=j-D*a,X=((A-O*a)*a+G)*a+I;let $=l.get(w);$||($={locals:[],globals:[]},l.set(w,$)),$.locals.push(X),$.globals.push(M)}function m(T,j,A){const M=T/a|0,_=j/a|0,D=A/a|0,O=e.blockKey(M,_,D),w=f.get(O);if(!w)return-1;const I=T-M*a,G=j-_*a,X=((A-D*a)*a+G)*a+I,$=w.locals;let U=0,Z=$.length-1;for(;U<=Z;){const Q=U+Z>>1;if($[Q]===X)return w.globals[Q];$[Q]<X?U=Q+1:Z=Q-1}return-1}const d=new Map;function x(T,j,A,M){const _=T/a|0,D=j/a|0,O=A/a|0,w=e.blockKey(_,D,O);let I=d.get(w);I||(I=new Uint8Array(e.blockCellCount),d.set(w,I));const G=T-_*a,H=j-D*a,$=((A-O*a)*a+H)*a+G,U=1<<M;return I[$]&U?!0:(I[$]|=U,!1)}n("contouring",0);const g=new mt(262144),y=new mt(262144);let p=0,E=0;const h=e.allocatedCount,S=[];Qt(e,(T,j,A,M,_,D)=>{S.push([T,j,A,M,_,D])});for(let T=0;T<S.length;T++){const j=S[T],A=j[3],M=j[4],_=j[5];E++;const D=Math.min(A+a,r),O=Math.min(M+a,r),w=Math.min(_+a,r);for(let I=_;I<w;I++)for(let G=M;G<O;G++)for(let H=A;H<D;H++){const X=e.get(H,G,I),$=X>=0,U=[X,e.get(H+1,G,I),e.get(H,G+1,I),e.get(H+1,G+1,I),e.get(H,G,I+1),e.get(H+1,G,I+1),e.get(H,G+1,I+1),e.get(H+1,G+1,I+1)];let Z=!1;for(let ie=1;ie<8;ie++)if(U[ie]>=0!==$){Z=!0;break}if(!Z)continue;const Q=[];for(let ie=0;ie<12;ie++){const le=ht[ie],ve=U[le[0]],q=U[le[1]];if(ve>=0==q>=0)continue;const W=H+(le[0]&1),te=G+(le[0]>>1&1),ce=I+(le[0]>>2&1),se=H+(le[1]&1),J=G+(le[1]>>1&1),ae=I+(le[1]>>2&1);let fe=W,pe=te,be=ce,Fe=se,Ee=J,ue=ae,we=ve;for(let Pe=0;Pe<8;Pe++){const Le=(fe+Fe)*.5,$e=(pe+Ee)*.5,Ge=(be+ue)*.5,Ke=e.lerp(Le,$e,Ge);Ke>=0==we>=0?(fe=Le,pe=$e,be=Ge,we=Ke):(Fe=Le,Ee=$e,ue=Ge)}const ye=(fe+Fe)*.5,xe=(pe+Ee)*.5,he=(be+ue)*.5,Me=e.gradient(ye,xe,he);Q.push({point:[Se(ye,s,t[0],o[0]),Se(xe,s,t[1],o[1]),Se(he,s,t[2],o[2])],normal:Me})}if(Q.length===0)continue;const ne=[Se(H,s,t[0],o[0]),Se(G,s,t[1],o[1]),Se(I,s,t[2],o[2])],K=[Se(H+1,s,t[0],o[0]),Se(G+1,s,t[1],o[1]),Se(I+1,s,t[2],o[2])],ee=Uo(Q,ne,K);if(!ee)continue;const re=e.gradient(We(ee[0],s,t[0],o[0]),We(ee[1],s,t[1],o[1]),We(ee[2],s,t[2],o[2]));v(H,G,I,p),g.push3(ee[0],ee[1],ee[2]),y.push3(re[0],re[1],re[2]),p++}E&63||(n("contouring",Math.round(40*E/h)),await Ot())}if(n("contouring",50),console.log("DC sparse: "+p+" vertices ("+((g.data.byteLength+y.data.byteLength)/(1024*1024)).toFixed(0)+" MB vertex data)"),p===0)return{positions:new Float32Array(0),normals:new Float32Array(0),indices:new Uint32Array(0),vertexCount:0,faceCount:0};const C=new Map,N=e.blockCellCount+7>>3,k=e.memoryMB();let F=Array.from(e.blocks.keys());for(let T=0;T<F.length;T++){const j=F[T],A=e.blocks.get(j),M=new Uint8Array(N);for(let _=0;_<A.length;_++)A[_]>=0&&(M[_>>3]|=1<<(_&7));C.set(j,M),e.blocks.delete(j),T&255||await Ot()}F=null,e.allocatedCount=0;const R=(C.size*N/(1024*1024)).toFixed(0);console.log("Sign compression: freed "+k.toFixed(0)+" MB float data, using "+R+" MB sign maps"),f=new Map,l.forEach((T,j)=>{const A=T.locals.length,M=new Array(A);for(let I=0;I<A;I++)M[I]=I;const _=T.locals,D=T.globals;M.sort((I,G)=>_[I]-_[G]);const O=new Uint16Array(A),w=new Uint32Array(A);for(let I=0;I<A;I++)O[I]=_[M[I]],w[I]=D[M[I]];f.set(j,{locals:O,globals:w})}),l.clear(),l=null,console.log("Vertex map compaction: "+f.size+" blocks with vertices");function V(T,j,A){if(T<0||j<0||A<0||T>=s||j>=s||A>=s)return!0;const M=T/a|0,_=j/a|0,D=A/a|0,O=e.blockKey(M,_,D),w=C.get(O);if(!w)return!0;const I=T-M*a,G=j-_*a,X=((A-D*a)*a+G)*a+I;return(w[X>>3]&1<<(X&7))!==0}const u=new jo(262144);let c=0,L=0,P=0;const B=f.size;let z=Array.from(f.entries());for(let T=0;T<z.length;T++){const j=z[T],A=j[0],M=j[1];P++;const _=A%i,D=(A/i|0)%i,O=A/(i*i)|0,w=_*a,I=D*a,G=O*a;for(let H=0;H<M.locals.length;H++){const X=M.locals[H],$=X%a,U=(X/a|0)%a,Z=X/(a*a)|0,Q=w+$,ne=I+U,K=G+Z;if(!(Q>=r||ne>=r||K>=r))for(let ee=0;ee<12;ee++){const re=ht[ee],ie=Q+(re[0]&1),le=ne+(re[0]>>1&1),ve=K+(re[0]>>2&1),q=Q+(re[1]&1),W=ne+(re[1]>>1&1),te=K+(re[1]>>2&1),ce=V(ie,le,ve),se=V(q,W,te);if(ce===se)continue;let J;const ae=Math.min(ie,q),fe=Math.min(le,W),pe=Math.min(ve,te);if(ie!==q?J=0:le!==W?J=1:J=2,x(ae,fe,pe,J))continue;c++;const be=(J+1)%3,Fe=(J+2)%3,Ee=[ae,fe,pe],ue=[-1,-1,-1,-1];let we=!0;for(let xe=0;xe<4;xe++){const he=[Ee[0],Ee[1],Ee[2]];if(he[be]-=xe&1?0:1,he[Fe]-=xe&2?0:1,he[0]<0||he[1]<0||he[2]<0||he[0]>=r||he[1]>=r||he[2]>=r){we=!1;break}const Me=m(he[0],he[1],he[2]);if(Me<0){we=!1;break}ue[xe]=Me}if(!we){L++;continue}const ye=ce;ue[0]!==ue[1]&&ue[0]!==ue[3]&&ue[1]!==ue[3]&&(ye?u.push3(ue[0],ue[3],ue[1]):u.push3(ue[0],ue[1],ue[3])),ue[0]!==ue[2]&&ue[0]!==ue[3]&&ue[2]!==ue[3]&&(ye?u.push3(ue[0],ue[2],ue[3]):u.push3(ue[0],ue[3],ue[2]))}}P&63||(n("contouring",50+Math.round(50*P/B)),await Ot())}return f=null,z=null,n("contouring",100),console.log("DC sparse: "+c+" sign-change edges, "+L+" dropped, "+u.length/3+" faces"),{positions:g.trim(),normals:y.trim(),indices:u.trim(),vertexCount:p,faceCount:Math.floor(u.length/3)}}const No=new Float32Array(1),jn=new Uint32Array(No.buffer);function Un(e){No[0]=e;const t=jn[0],o=t>>16&32768,n=(t>>23&255)-127+15,s=t&8388607;return n<=0?o:n>=31?o|31744:o|n<<10|s>>13}const Vo=new Uint16Array(256);for(let e=0;e<256;e++)Vo[e]=Un(e/255);class $o{constructor(t){oe(this,"buf");oe(this,"a");oe(this,"v");oe(this,"pos");this.buf=new ArrayBuffer(t||8*1024*1024),this.a=new Uint8Array(this.buf),this.v=new DataView(this.buf),this.pos=0}grow(t){let o=this.pos+t;this.buf.byteLength<256*1024*1024?o=Math.max(this.buf.byteLength*2,o):o=Math.max(Math.round(this.buf.byteLength*1.25),o);const n=new ArrayBuffer(o);new Uint8Array(n).set(this.a),this.buf=n,this.a=new Uint8Array(n),this.v=new DataView(n)}en(t){this.pos+t>this.buf.byteLength&&this.grow(t)}u8(t){this.en(1),this.v.setUint8(this.pos,t),this.pos++}u16(t){this.en(2),this.v.setUint16(this.pos,t,!0),this.pos+=2}u32(t){this.en(4),this.v.setUint32(this.pos,t,!0),this.pos+=4}i32(t){this.en(4),this.v.setInt32(this.pos,t,!0),this.pos+=4}u64(t){this.en(8),this.v.setBigUint64(this.pos,t,!0),this.pos+=8}f64(t){this.en(8),this.v.setFloat64(this.pos,t,!0),this.pos+=8}raw(t){this.en(t.length),this.a.set(t,this.pos),this.pos+=t.length}str(t){this.en(t.length);for(let o=0;o<t.length;o++)this.a[this.pos++]=t.charCodeAt(o)}name(t){this.u32(t.length),this.str(t)}zeros(t){this.en(t),this.pos+=t}bulk64(t){const o=t.length*8;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}bulk16(t){const o=t.length*2;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}bulkF32(t){const o=t.length*4;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}result(){return new Uint8Array(this.buf,0,this.pos)}}const pt=0xFFFFFFFFFFFFFFFFn;function Nn(){return{n5childMask:new BigUint64Array(512),n5valueMask:new BigUint64Array(512),n5tileValues:new Uint16Array(32768),n4map:new Map}}function Vn(){return{childMask:new BigUint64Array(64),valueMask:new BigUint64Array(64),tileValues:new Uint16Array(4096),leafMap:new Map}}function $n(e,t,o,n,s){const r=new BigUint64Array(8),a=new Uint16Array(512);let i=0;for(let g=0;g<512;g++)s[g]>0&&(r[g>>6]|=1n<<BigInt(g&63),a[g]=Vo[s[g]],i++);if(i===0)return 0;const l=t<<3,f=o<<3,v=n<<3,m=(v&4095)>>7|(f&4095)>>7<<5|(l&4095)>>7<<10;e.n5childMask[m>>6]|=1n<<BigInt(m&63);let d=e.n4map.get(m);d||(d=Vn(),e.n4map.set(m,d));const x=(v&127)>>3|(f&127)>>3<<4|(l&127)>>3<<8;return d.childMask[x>>6]|=1n<<BigInt(x&63),d.leafMap.set(x,{mask:r,data:a}),i}function Gn(e){let t=0,o=0;return e.n4map.forEach(function(n,s){const r=[];n.leafMap.forEach(function(a,i){let l=!0;for(let m=0;m<8;m++)if(a.mask[m]!==pt){l=!1;break}if(!l)return;const f=a.data[0];let v=!0;for(let m=1;m<512;m++)if(a.data[m]!==f){v=!1;break}v&&r.push([i,f])});for(let a=0;a<r.length;a++){const i=r[a][0],l=r[a][1];n.leafMap.delete(i),n.childMask[i>>6]&=~(1n<<BigInt(i&63)),n.valueMask[i>>6]|=1n<<BigInt(i&63),n.tileValues[i]=l,t++}if(n.leafMap.size===0){let a=!0;for(let i=0;i<64;i++)if(n.valueMask[i]!==pt){a=!1;break}if(a){const i=n.tileValues[0];let l=!0;for(let f=1;f<4096;f++)if(n.tileValues[f]!==i){l=!1;break}l&&(e.n4map.delete(s),e.n5childMask[s>>6]&=~(1n<<BigInt(s&63)),e.n5valueMask[s>>6]|=1n<<BigInt(s&63),e.n5tileValues[s]=i,o++)}}}),{promotedLeaves:t,promotedN4s:o}}function Xn(){return{n5childMask:new BigUint64Array(512),n5valueMask:new BigUint64Array(512),n5tileValues:new Float32Array(32768*3),n4map:new Map}}function Hn(){return{childMask:new BigUint64Array(64),valueMask:new BigUint64Array(64),tileValues:new Float32Array(4096*3),leafMap:new Map}}function Yn(e,t,o,n,s,r,a){const i=new BigUint64Array(8),l=new Float32Array(512*3);let f=0;for(let p=0;p<512;p++)(s[p]>0||r[p]>0||a[p]>0)&&(i[p>>6]|=1n<<BigInt(p&63),l[p*3]=s[p]/255,l[p*3+1]=r[p]/255,l[p*3+2]=a[p]/255,f++);if(f===0)return 0;const v=t<<3,m=o<<3,d=n<<3,x=(d&4095)>>7|(m&4095)>>7<<5|(v&4095)>>7<<10;e.n5childMask[x>>6]|=1n<<BigInt(x&63);let g=e.n4map.get(x);g||(g=Hn(),e.n4map.set(x,g));const y=(d&127)>>3|(m&127)>>3<<4|(v&127)>>3<<8;return g.childMask[y>>6]|=1n<<BigInt(y&63),g.leafMap.set(y,{mask:i,data:l}),f}function qn(e){let t=0,o=0;return e.n4map.forEach(function(n,s){const r=[];n.leafMap.forEach(function(a,i){let l=!0;for(let x=0;x<8;x++)if(a.mask[x]!==pt){l=!1;break}if(!l)return;const f=a.data[0],v=a.data[1],m=a.data[2];let d=!0;for(let x=1;x<512;x++)if(a.data[x*3]!==f||a.data[x*3+1]!==v||a.data[x*3+2]!==m){d=!1;break}d&&r.push([i,f,v,m])});for(const[a,i,l,f]of r)n.leafMap.delete(a),n.childMask[a>>6]&=~(1n<<BigInt(a&63)),n.valueMask[a>>6]|=1n<<BigInt(a&63),n.tileValues[a*3]=i,n.tileValues[a*3+1]=l,n.tileValues[a*3+2]=f,t++;if(n.leafMap.size===0){let a=!0;for(let i=0;i<64;i++)if(n.valueMask[i]!==pt){a=!1;break}if(a){const i=n.tileValues[0],l=n.tileValues[1],f=n.tileValues[2];let v=!0;for(let m=1;m<4096;m++)if(n.tileValues[m*3]!==i||n.tileValues[m*3+1]!==l||n.tileValues[m*3+2]!==f){v=!1;break}v&&(e.n4map.delete(s),e.n5childMask[s>>6]&=~(1n<<BigInt(s&63)),e.n5valueMask[s>>6]|=1n<<BigInt(s&63),e.n5tileValues[s*3]=i,e.n5tileValues[s*3+1]=l,e.n5tileValues[s*3+2]=f,o++)}}}),{promotedLeaves:t,promotedN4s:o}}function Ze(e){return Array.from(e.keys()).sort(function(t,o){return t-o})}function ke(e,t,o){e.name(t),e.name("string"),e.name(o)}function Kt(e,t,o){e.name(t),e.name("bool"),e.u32(1),e.u8(o?1:0)}function Go(e,t){e.u32(1),e.u32(0),e.u32(0),e.u32(1),e.i32(0),e.i32(0),e.i32(0),e.bulk64(t.n5childMask),e.bulk64(t.n5valueMask),e.u8(6),e.bulk16(t.n5tileValues);const o=Ze(t.n4map);for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]);e.bulk64(s.childMask),e.bulk64(s.valueMask),e.u8(6),e.bulk16(s.tileValues);const r=Ze(s.leafMap);for(let a=0;a<r.length;a++)e.bulk64(s.leafMap.get(r[a]).mask)}for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]),r=Ze(s.leafMap);for(let a=0;a<r.length;a++){const i=s.leafMap.get(r[a]);e.bulk64(i.mask),e.u8(6),e.bulk16(i.data),i.data=null}}}function Wn(e,t){e.u32(1),e.f64(0),e.u32(0),e.u32(0),e.u32(1),e.i32(0),e.i32(0),e.i32(0),e.bulk64(t.n5childMask),e.bulk64(t.n5valueMask),e.u8(6),e.bulkF32(t.n5tileValues);const o=Ze(t.n4map);for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]);e.bulk64(s.childMask),e.bulk64(s.valueMask),e.u8(6),e.bulkF32(s.tileValues);const r=Ze(s.leafMap);for(let a=0;a<r.length;a++)e.bulk64(s.leafMap.get(r[a]).mask)}for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]),r=Ze(s.leafMap);for(let a=0;a<r.length;a++){const i=s.leafMap.get(r[a]);e.bulk64(i.mask),e.u8(6),e.bulkF32(i.data),i.data=null}}}function Xo(e,t,o,n){const s=n/t;e.name("AffineMap"),e.f64(s),e.f64(0),e.f64(0),e.f64(0),e.f64(0),e.f64(s),e.f64(0),e.f64(0),e.f64(0),e.f64(0),e.f64(s),e.f64(0),e.f64(o[0]),e.f64(o[1]),e.f64(o[2]),e.f64(1)}function Zn(e,t,o,n,s,r){e.u32(0),e.u32(4),ke(e,"class","unknown"),ke(e,"file_compression","none"),Kt(e,"is_saved_as_half_float",!0),ke(e,"name",o),Xo(e,n,s,r),Go(e,t)}function Jn(e,t,o,n,s,r){e.u32(0),e.u32(4),ke(e,"class","unknown"),ke(e,"file_compression","none"),Kt(e,"is_saved_as_half_float",!1),ke(e,"name",o),Xo(e,n,s,r),Wn(e,t)}function Qn(e,t,o,n){let s=0;e.n4map.forEach(function(l){s+=l.leafMap.size});const r=2e5+s*1200+e.n4map.size*1e4,a=new $o(Math.max(r,1024*1024));a.raw(new Uint8Array([32,66,68,86,0,0,0,0])),a.u32(224),a.u32(8),a.u32(1),a.u8(0),a.str("d2b59639-ac2f-4047-9c50-9648f951180c"),a.u32(0),a.u32(1),a.name("density"),a.name("Tree_float_5_4_3_HalfFloat"),a.u32(0),a.u64(BigInt(a.pos+24)),a.u64(0n),a.u64(0n),a.u32(0),a.u32(4),ke(a,"class","unknown"),ke(a,"file_compression","none"),Kt(a,"is_saved_as_half_float",!0),ke(a,"name","density");const i=n/t;return a.name("AffineMap"),a.f64(i),a.f64(0),a.f64(0),a.f64(0),a.f64(0),a.f64(i),a.f64(0),a.f64(0),a.f64(0),a.f64(0),a.f64(i),a.f64(0),a.f64(o[0]),a.f64(o[1]),a.f64(o[2]),a.f64(1),Go(a,e),a.result()}function Kn(e,t,o,n,s){let r=0;e.n4map.forEach(function(f){r+=f.leafMap.size});let a=0;t.n4map.forEach(function(f){a+=f.leafMap.size});const i=2e5+r*1200+e.n4map.size*1e4+2e5+a*7200+t.n4map.size*6e4,l=new $o(Math.max(i,2*1024*1024));return l.raw(new Uint8Array([32,66,68,86,0,0,0,0])),l.u32(224),l.u32(8),l.u32(1),l.u8(0),l.str("d2b59639-ac2f-4047-9c50-9648f951180c"),l.u32(0),l.u32(2),l.name("density"),l.name("Tree_float_5_4_3_HalfFloat"),l.u32(0),l.u64(BigInt(l.pos+24)),l.u64(0n),l.u64(0n),Zn(l,e,"density",o,n,s),l.name("Cd"),l.name("Tree_vec3s_5_4_3"),l.u32(0),l.u64(BigInt(l.pos+24)),l.u64(0n),l.u64(0n),Jn(l,t,"Cd",o,n,s),l.result()}function ea(e,t,o){return{formula:e.id,pipelineRevision:0,quality:o?{estimator:o.estimator??0,distanceMetric:o.distanceMetric??0}:void 0,interlace:t?{interlaceCompiled:!0,interlaceFormula:t.definition.id,interlaceEnabled:t.enabled,interlaceInterval:t.interval,interlaceStartIter:t.startIter,interlaceParamA:0,interlaceParamB:0,interlaceParamC:0,interlaceParamD:0,interlaceParamE:0,interlaceParamF:0,interlaceVec2A:{x:0,y:0},interlaceVec2B:{x:0,y:0},interlaceVec2C:{x:0,y:0},interlaceVec3A:{x:0,y:0,z:0},interlaceVec3B:{x:0,y:0,z:0},interlaceVec3C:{x:0,y:0,z:0}}:void 0}}function st(e,t,o){const n=o||{};t.uParamA&&e.uniform1f(t.uParamA,n.paramA??8),t.uParamB&&e.uniform1f(t.uParamB,n.paramB??0),t.uParamC&&e.uniform1f(t.uParamC,n.paramC??0),t.uParamD&&e.uniform1f(t.uParamD,n.paramD??0),t.uParamE&&e.uniform1f(t.uParamE,n.paramE??0),t.uParamF&&e.uniform1f(t.uParamF,n.paramF??0);const s=p=>p?[p.x??p[0]??0,p.y??p[1]??0]:[0,0],r=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0]:[0,0,0],a=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0,p.w??p[3]??0]:[0,0,0,0],i=s(n.vec2A);t.uVec2A&&e.uniform2f(t.uVec2A,i[0],i[1]);const l=s(n.vec2B);t.uVec2B&&e.uniform2f(t.uVec2B,l[0],l[1]);const f=s(n.vec2C);t.uVec2C&&e.uniform2f(t.uVec2C,f[0],f[1]);const v=r(n.vec3A);t.uVec3A&&e.uniform3f(t.uVec3A,v[0],v[1],v[2]);const m=r(n.vec3B);t.uVec3B&&e.uniform3f(t.uVec3B,m[0],m[1],m[2]);const d=r(n.vec3C);t.uVec3C&&e.uniform3f(t.uVec3C,d[0],d[1],d[2]);const x=a(n.vec4A);t.uVec4A&&e.uniform4f(t.uVec4A,x[0],x[1],x[2],x[3]);const g=a(n.vec4B);t.uVec4B&&e.uniform4f(t.uVec4B,g[0],g[1],g[2],g[3]);const y=a(n.vec4C);if(t.uVec4C&&e.uniform4f(t.uVec4C,y[0],y[1],y[2],y[3]),t.uJulia){const p=n.julia;Array.isArray(p)?e.uniform3f(t.uJulia,p[0]??0,p[1]??0,p[2]??0):p&&typeof p=="object"?e.uniform3f(t.uJulia,p.x??0,p.y??0,p.z??0):e.uniform3f(t.uJulia,0,0,0)}t.uJuliaMode&&e.uniform1f(t.uJuliaMode,n.juliaMode?1:0),t.uEscapeThresh&&e.uniform1f(t.uEscapeThresh,n.escapeThresh??10),t.uDistanceMetric&&e.uniform1f(t.uDistanceMetric,n.distanceMetric??0)}function rt(e,t,o){if(!o){t.uInterlaceEnabled&&e.uniform1f(t.uInterlaceEnabled,0);return}t.uInterlaceEnabled&&e.uniform1f(t.uInterlaceEnabled,o.enabled?1:0),t.uInterlaceInterval&&e.uniform1f(t.uInterlaceInterval,o.interval??2),t.uInterlaceStartIter&&e.uniform1f(t.uInterlaceStartIter,o.startIter??0);const n=o.params||{},s=p=>p?[p.x??p[0]??0,p.y??p[1]??0]:[0,0],r=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0]:[0,0,0],a=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0,p.w??p[3]??0]:[0,0,0,0];t.uInterlaceParamA&&e.uniform1f(t.uInterlaceParamA,n.paramA??0),t.uInterlaceParamB&&e.uniform1f(t.uInterlaceParamB,n.paramB??0),t.uInterlaceParamC&&e.uniform1f(t.uInterlaceParamC,n.paramC??0),t.uInterlaceParamD&&e.uniform1f(t.uInterlaceParamD,n.paramD??0),t.uInterlaceParamE&&e.uniform1f(t.uInterlaceParamE,n.paramE??0),t.uInterlaceParamF&&e.uniform1f(t.uInterlaceParamF,n.paramF??0);const i=s(n.vec2A);t.uInterlaceVec2A&&e.uniform2f(t.uInterlaceVec2A,i[0],i[1]);const l=s(n.vec2B);t.uInterlaceVec2B&&e.uniform2f(t.uInterlaceVec2B,l[0],l[1]);const f=s(n.vec2C);t.uInterlaceVec2C&&e.uniform2f(t.uInterlaceVec2C,f[0],f[1]);const v=r(n.vec3A);t.uInterlaceVec3A&&e.uniform3f(t.uInterlaceVec3A,v[0],v[1],v[2]);const m=r(n.vec3B);t.uInterlaceVec3B&&e.uniform3f(t.uInterlaceVec3B,m[0],m[1],m[2]);const d=r(n.vec3C);t.uInterlaceVec3C&&e.uniform3f(t.uInterlaceVec3C,d[0],d[1],d[2]);const x=a(n.vec4A);t.uInterlaceVec4A&&e.uniform4f(t.uInterlaceVec4A,x[0],x[1],x[2],x[3]);const g=a(n.vec4B);t.uInterlaceVec4B&&e.uniform4f(t.uInterlaceVec4B,g[0],g[1],g[2],g[3]);const y=a(n.vec4C);t.uInterlaceVec4C&&e.uniform4f(t.uInterlaceVec4C,y[0],y[1],y[2],y[3])}function po(e,t,o,n){const s=e.createShader(t);if(!s)throw new Error("Failed to create shader");if(e.shaderSource(s,o),e.compileShader(s),!e.getShaderParameter(s,e.COMPILE_STATUS)){const r=e.getShaderInfoLog(s)||"",a=t===e.VERTEX_SHADER?"vertex":"fragment";n("Shader compile error ("+a+"): "+r,"error");const i=o.split(`
...
}`,v=it(e,Qe,f,s);e.useProgram(v);const m=e.createTexture();e.bindTexture(e.TEXTURE_2D,m),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,t,t);const d=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,d),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,m,0),e.viewport(0,0,t,t),e.bindVertexArray(e.createVertexArray());const x=["uZ","uPower","uIters","uInvRes","uTileOffset","uBoundsMin","uBoundsRange",...qe],g={};for(let y=0;y<x.length;y++)g[x[y]]=e.getUniformLocation(v,x[y]);return{prog:v,loc:g,fbo:d,tex:m}}function lt(e,t,o,n,s,r,a,i,l,f){e.useProgram(t.prog),e.uniform1f(t.loc.uPower,n),e.uniform1i(t.loc.uIters,s),e.uniform1f(t.loc.uInvRes,1/o),e.uniform3f(t.loc.uBoundsMin,r[0],r[1],r[2]),e.uniform1f(t.loc.uBoundsRange,a),t.loc.uSurfaceThreshold&&e.uniform1f(t.loc.uSurfaceThreshold,f??0),st(e,t.loc,i),rt(e,t.loc,l),e.bindFramebuffer(e.FRAMEBUFFER,t.fbo)}async function Ho(e,t,o,n,s,r,a,i,l,f,v,m,d){const{log:x,setPhase:g,setStatus:y,tick:p}=f,E=128,h=i[0]-a[0];let S=0,C=n-1;if(n>E){x("Coarse pre-pass: sampling "+E+"³ to detect Z range...","info"),g("Coarse Pre-pass",0),y("Coarse pre-pass ("+E+"³)..."),await p();const N=Je(e,E,t,1,x,v,m);lt(e,N,E,s,r,a,h,o,v,d),e.viewport(0,0,E,E);const k=new Float32Array(E*E*4);let F=E,R=-1;for(let V=0;V<E;V++){e.uniform1f(N.loc.uZ,(V+.5)/E),e.uniform2f(N.loc.uTileOffset,0,0),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,E,E,e.RGBA,e.FLOAT,k);let u=!1;for(let c=0;c<E*E;c++)if(k[c*4]<l*3){u=!0;break}u&&(V<F&&(F=V),R=V)}if(e.deleteTexture(N.tex),e.deleteFramebuffer(N.fbo),e.deleteProgram(N.prog),R>=F){const u=n/E;S=Math.max(0,Math.floor((F-2)*u)),C=Math.min(n-1,Math.ceil((R+2+1)*u)),S=S&-8,C=Math.min(n-1,C|7);const c=(100*(1-(C-S+1)/n)).toFixed(0);x("Coarse pre-pass: data in Z ["+F+","+R+"] of "+E+" → fine Z ["+S+","+C+"] of "+n+" (skipping "+c+"% of slices)","data")}else x("Coarse pre-pass: no data found — sampling all slices","warn");g("Coarse Pre-pass",100)}return{zSliceMin:S,zSliceMax:C}}function Yo(e,t,o,n,s,r,a,i,l){function f(v,m){if(e.useProgram(t.prog),e.bindFramebuffer(e.FRAMEBUFFER,t.fbo),e.uniform1f(t.loc.uZ,v),o<=n){e.uniform2f(t.loc.uTileOffset,0,0),e.viewport(0,0,o,o),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,o,o,e.RGBA,e.FLOAT,s);for(let d=0;d<o*o;d++)m[d]=s[d*4]}else for(let d=0;d<o;d+=n)for(let x=0;x<o;x+=n){const g=Math.min(n,o-x),y=Math.min(n,o-d);e.uniform2f(t.loc.uTileOffset,x,d),e.viewport(0,0,g,y),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,g,y,e.RGBA,e.FLOAT,s);for(let p=0;p<y;p++)for(let E=0;E<g;E++)m[(d+p)*o+(x+E)]=s[(p*g+E)*4]}}if(!i||i<=1)f((a+.5)/o,r);else{r.fill(0);const v=1/i;for(let m=0;m<i;m++){const d=(a+(m+.5)*v)/o;f(d,l);for(let x=0;x<o*o;x++)r[x]+=l[x]}for(let m=0;m<o*o;m++)r[m]*=v}}function qo(e,t,o,n){const s=t/n,r=new ImageData(n,n);for(let a=0;a<n;a++){const i=Math.min(Math.round(a*s),t-1);for(let l=0;l<n;l++){const f=Math.min(Math.round(l*s),t-1),v=e[i*t+f],m=Math.abs(v),d=m<o*2?Math.round(255*(1-m/(o*2))):0,x=v<0?50:0,g=(a*n+l)*4;r.data[g]=d+x,r.data[g+1]=v<0?30:d,r.data[g+2]=d,r.data[g+3]=255}}return r}async function vo(e,t,o,n,s,r,a,i,l,f,v,m,d,x,g,y){const{setProgress:p,setPhase:E,setStatus:h,tick:S,log:C,onSlicePreview:N}=x,k=Math.min(o,2048),F=i[0]-a[0];(!v||v<1)&&(v=1),m==null&&(m=0),d==null&&(d=o-1),lt(e,t,o,n,s,a,F,r,g,y),e.viewport(0,0,k,k);const R=new Float32Array(k*k*4),V=new Float32Array(o*o*o),u=F/o,c=new Float32Array(o*o),L=v>1?new Float32Array(o*o):null,P=Math.min(o,512);(m>0||d<o-1)&&V.fill(1),v>1&&C("Z sub-slicing: "+v+" sub-samples per voxel layer (smooths Z-axis banding)","info");const B=d-m+1;let z=0;for(let T=m;T<=d;T++){if(Yo(e,t,o,k,R,c,T,v,L),V.set(c,T*o*o),N){const j=qo(c,o,u,P);N(j,P,P)}z++,p(l+Math.round(z/B*f)),E("SDF Sampling",Math.round(z/B*100)),z&3||(h("Sampling SDF... slice "+z+"/"+B),await S())}return V}function ta(e,t,o,n,s,r,a,i,l){const f=a/l,v=new ImageData(l,l);for(let m=0;m<l;m++){const d=Math.round(m*f);for(let x=0;x<l;x++){const g=Math.round(x*f),y=(m*l+x)*4;if(g>=t&&g<n&&d>=o&&d<s){const p=((d-o)*r+(g-t))*4,E=e[p],h=Math.abs(E),S=h<i*2?Math.round(255*(1-h/(i*2))):0,C=E<0?50:0;v.data[y]=S+C,v.data[y+1]=E<0?30:S,v.data[y+2]=S}else v.data[y]=15,v.data[y+1]=15,v.data[y+2]=20;v.data[y+3]=255}}return v}async function oa(e,t,o,n,s,r,a,i,l,f,v,m,d){const{setProgress:x,setPhase:g,setStatus:y,tick:p,onSlicePreview:E}=v,h=o.N,S=o.blockSize,C=Math.min(h,2048),N=i[0]-a[0];lt(e,t,h,n,s,a,N,r,m,d),e.viewport(0,0,C,C);const k=new Map;Qt(o,(P,B,z,T,j,A)=>{for(let M=0;M<S;M++){const _=A+M;if(_>=h)continue;let D=k.get(_);D||(D={entries:[],minX:T,minY:j,maxX:T+S,maxY:j+S},k.set(_,D)),D.entries.push({startX:T,startY:j}),T<D.minX&&(D.minX=T),j<D.minY&&(D.minY=j),T+S>D.maxX&&(D.maxX=T+S),j+S>D.maxY&&(D.maxY=j+S)}});const F=Array.from(k.keys()).sort((P,B)=>P-B);let R=0;for(let P=0;P<F.length;P++){const B=k.get(F[P]),z=Math.min(h,B.maxX)-Math.max(0,B.minX),T=Math.min(h,B.maxY)-Math.max(0,B.minY),j=z*T*4;j>R&&(R=j)}const V=new Float32Array(R),u=Math.min(h,512),c=N/h;let L=0;for(let P=0;P<F.length;P++){const B=F[P],z=k.get(B);e.uniform1f(t.loc.uZ,(B+.5)/h);const T=Math.max(0,z.minX),j=Math.max(0,z.minY),A=Math.min(h,z.maxX),M=Math.min(h,z.maxY),_=A-T,D=M-j;e.uniform2f(t.loc.uTileOffset,T,j),e.viewport(0,0,_,D),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,_,D,e.RGBA,e.FLOAT,V);const O=z.entries;for(let w=0;w<O.length;w++){const I=O[w];for(let G=0;G<S;G++){const H=I.startX+G;if(!(H<T||H>=A))for(let X=0;X<S;X++){const $=I.startY+X;if($<j||$>=M)continue;const U=(($-j)*_+(H-T))*4;o.set(H,$,B,V[U])}}}if(L++,!(L&7)){if(E){const w=ta(V,T,j,A,M,_,h,c,u);E(w,u,u)}x(l+Math.round(L/F.length*f)),g("Fine SDF Sampling",Math.round(L/F.length*100)),y("Sampling fine SDF... slice "+L+"/"+F.length+" (narrow-band)"),await p()}}return o}async function na(e,t,o,n,s,r,a,i,l,f,v,m,d,x,g,y){const{log:p,setProgress:E,setPhase:h,setStatus:S,tick:C,onSlicePreview:N}=m,k=i[0]-a[0],F=k/n,R=8,V=n/R|0,u=Math.min(n,2048);(!v||v<1)&&(v=1);const c=await Ho(e,t,o,n,s,r,a,i,F,m,d,x,g),{zSliceMin:L,zSliceMax:P}=c,B=Je(e,u,t,f||1,p,d,x);lt(e,B,n,s,r,a,k,o,d,g);const z=new Float32Array(u*u*4),T=Nn();let j=0;const A=new Array(R);for(let X=0;X<R;X++)A[X]=new Float32Array(n*n);const M=v>1?new Float32Array(n*n):null,_=Math.min(n,512),D=P-L+1;let O=0;v>1&&p("Z sub-slicing: "+v+" sub-samples per voxel layer (smooths Z-axis banding)","info");for(let X=L;X<=P;X++){const $=A[X%R];if(Yo(e,B,n,u,z,$,X,v,M),X%R===R-1){const U=X/R|0;for(let Z=0;Z<V;Z++)for(let Q=0;Q<V;Q++){const ne=new Uint8Array(512);let K=!1;for(let ee=0;ee<R;ee++){const re=A[ee];for(let ie=0;ie<R;ie++)for(let le=0;le<R;le++){const ve=Q*R+le,q=Z*R+ie,W=re[q*n+ve],te=ee|ie<<3|le<<6;let ce;W<0?ce=255:ce=Math.round(Math.max(0,Math.min(255,255*(1-W/(F*2.5))))),ne[te]=ce,ce>0&&(K=!0)}}K&&(j+=$n(T,Q,Z,U,ne))}}if(O++,!(O&7)){const U=Math.round(O/D*80);if(E(U),h("VDB Sampling",Math.round(O/D*100)),S("VDB sampling slice "+O+"/"+D+(L>0||P<n-1?" (Z "+L+"–"+P+")":"")),N){const Z=qo(A[X%R],n,F,_);N(Z,_,_)}await C()}}if(e.deleteTexture(B.tex),e.deleteFramebuffer(B.fbo),e.deleteProgram(B.prog),m.memAlloc){let X=0;T.n4map.forEach(U=>{X+=U.leafMap.size});const $=Math.round((X*1.1+T.n4map.size*10)/1024);m.memAlloc("vdbDensity","VDB Density",$,"#8c6")}let w=null;if(y){h("VDB Color",0),S("Sampling voxel colors..."),p("Color pass: sampling orbit-trap colors for active voxels","phase");let X=0;if(T.n4map.forEach($=>{$.leafMap.forEach(U=>{for(let Z=0;Z<8;Z++){let Q=U.mask[Z];for(;Q!==0n;)Q&=Q-1n,X++}})}),p("Color pass: "+X.toLocaleString()+" active voxels to colorize","data"),X>0){const $=Xn(),U=Math.min(e.getParameter(e.MAX_TEXTURE_SIZE),2048),Z=U*U,Q=zo({definition:t,interlace:d}),ne=it(e,Qe,Q,p),K=eo(e,ne),ee=e.createVertexArray(),re=e.getUniformLocation(ne,"uPositions"),ie=e.getUniformLocation(ne,"uPower"),le=e.getUniformLocation(ne,"uIters"),ve=e.getUniformLocation(ne,"uWidth"),q=e.getUniformLocation(ne,"uJitterOffset"),W=[];T.n4map.forEach((xe,he)=>{xe.leafMap.forEach((Me,Pe)=>{W.push(he,Pe)})});const te=W.length>>1,ce=Math.ceil(Math.sqrt(Z)),se=Math.ceil(Z/ce),J=ce*se,ae=new Float32Array(J*4),fe=new Uint8Array(J*4),pe=new Uint16Array(Z),be=new Uint32Array(Z),Fe=new Uint8Array(512),Ee=new Uint8Array(512),ue=new Uint8Array(512);let we=0,ye=0;for(;ye<te;){let xe=0,he=ye;for(;he<te&&xe+512<=Z;){const Re=W[he*2],je=W[he*2+1],et=T.n4map.get(Re).leafMap.get(je),Mt=(Re>>10&31)<<7,Tt=(Re>>5&31)<<7,Et=(Re&31)<<7,Ft=(je>>8&15)<<3,Pt=(je>>4&15)<<3,At=(je&15)<<3,It=Mt+Ft,Rt=Tt+Pt,Dt=Et+At;for(let Ae=0;Ae<512;Ae++){if((et.mask[Ae>>6]&1n<<BigInt(Ae&63))===0n)continue;const Jo=Ae&7,Qo=Ae>>3&7,Ko=Ae>>6&7;ae[xe*4]=a[0]+(It+Ko+.5)*F,ae[xe*4+1]=a[1]+(Rt+Qo+.5)*F,ae[xe*4+2]=a[2]+(Dt+Jo+.5)*F,ae[xe*4+3]=1,pe[xe]=Ae,be[xe]=he,xe++}he++}const Me=xe;if(Me===0){ye=he;continue}const Pe=Math.ceil(Math.sqrt(Me)),Le=Math.ceil(Me/Pe);e.useProgram(ne);const $e=e.createTexture();e.bindTexture(e.TEXTURE_2D,$e),e.texImage2D(e.TEXTURE_2D,0,e.RGBA32F,Pe,Le,0,e.RGBA,e.FLOAT,ae.subarray(0,Pe*Le*4)),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE);const Ge=e.createTexture();e.bindTexture(e.TEXTURE_2D,Ge),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA8,Pe,Le);const Ke=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,Ke),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,Ge,0),e.viewport(0,0,Pe,Le),e.bindVertexArray(ee),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,$e),e.uniform1i(re,0),e.uniform1f(ie,s),e.uniform1i(le,r),e.uniform1i(ve,Pe),e.uniform3f(q,0,0,0),st(e,K,o),rt(e,K,d),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,Pe,Le,e.RGBA,e.UNSIGNED_BYTE,fe),e.deleteTexture($e),e.deleteTexture(Ge),e.deleteFramebuffer(Ke);let _e=0;for(let Re=ye;Re<he;Re++){if(_e>=Me||be[_e]!==Re)continue;const je=W[Re*2],et=W[Re*2+1],Mt=(je>>10&31)<<7,Tt=(je>>5&31)<<7,Et=(je&31)<<7,Ft=(et>>8&15)<<3,Pt=(et>>4&15)<<3,At=(et&15)<<3,It=Mt+Ft>>3,Rt=Tt+Pt>>3,Dt=Et+At>>3;for(Fe.fill(0),Ee.fill(0),ue.fill(0);_e<Me&&be[_e]===Re;){const Ae=pe[_e];Fe[Ae]=fe[_e*4],Ee[Ae]=fe[_e*4+1],ue[Ae]=fe[_e*4+2],_e++}Yn($,It,Rt,Dt,Fe,Ee,ue)}we+=Me,ye=he;const oo=Math.round(we/X*100);E(80+Math.round(oo*.12)),h("VDB Color",oo),S("Color pass: "+we.toLocaleString()+"/"+X.toLocaleString()+" voxels"),await C()}if(e.deleteProgram(ne),e.deleteVertexArray(ee),qn($),w=$,m.memAlloc){let xe=0;$.n4map.forEach(Me=>{xe+=Me.leafMap.size});const he=Math.round((xe*6.2+$.n4map.size*60)/1024);m.memAlloc("vdbColor","VDB Color",he,"#e6a")}p("Color pass complete: Cd vec3s grid built","success")}h("VDB Color",100),await C()}E(92),h("VDB Optimize",0),S("Optimizing VDB tree...");const I=Gn(T);E(95),h("VDB Serialize",50),S("Serializing VDB..."),await C();let G=0;T.n4map.forEach(X=>{G+=X.leafMap.size});let H;if(w?H=Kn(T,w,n,a,k):H=Qn(T,n,a,k),m.memFree&&(m.memFree("vdbDensity"),w&&m.memFree("vdbColor")),m.memAlloc){const X=Math.round(H.byteLength/1048576);m.memAlloc("vdbBlob","VDB File",X,"#5af")}return E(100),h("VDB Complete",100),{blob:new Blob([H.buffer.slice(H.byteOffset,H.byteOffset+H.byteLength)],{type:"application/octet-stream"}),voxelCount:j,leafCount:G,promoted:I,zRange:[L,P],skippedSlices:n-D}}async function aa(e,t,o,n,s,r,a,i,l,f,v){const{log:m,tick:d}=l,x=t.N,g=t.blockSize,y=t.blocksPerAxis,p=Math.min(x,2048),E=i[0]-a[0],h=t.blockCellCount+7>>3,S=wn({definition:o,interlace:v}),C=it(e,Qe,S,m);e.useProgram(C);const N=["uZ","uPower","uIters","uInvRes","uTileOffset","uBoundsMin","uBoundsRange",...qe],k={};for(let z=0;z<N.length;z++)k[N[z]]=e.getUniformLocation(C,N[z]);const F=e.createTexture();e.bindTexture(e.TEXTURE_2D,F),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,p,p);const R=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,R),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,F,0),e.uniform1f(k.uPower,n),e.uniform1i(k.uIters,s),e.uniform1f(k.uInvRes,1/x),e.uniform3f(k.uBoundsMin,a[0],a[1],a[2]),e.uniform1f(k.uBoundsRange,E),st(e,k,r),rt(e,k,v),e.bindVertexArray(e.createVertexArray());const V=new Map;Qt(t,(z,T,j,A,M,_)=>{for(let D=0;D<g;D++){const O=_+D;if(O>=x)continue;let w=V.get(O);w||(w={entries:[],minX:A,minY:M,maxX:A+g,maxY:M+g},V.set(O,w)),w.entries.push({startX:A,startY:M}),A<w.minX&&(w.minX=A),M<w.minY&&(w.minY=M),A+g>w.maxX&&(w.maxX=A+g),M+g>w.maxY&&(w.maxY=M+g)}});const u=Array.from(V.keys()).sort((z,T)=>z-T);let c=0;for(let z=0;z<u.length;z++){const T=V.get(u[z]),j=Math.min(x,T.maxX)-Math.max(0,T.minX),A=Math.min(x,T.maxY)-Math.max(0,T.minY);j*A*4>c&&(c=j*A*4)}const L=new Float32Array(c),P=new Map;t.blocks.forEach((z,T)=>{P.set(T,new Uint8Array(h))});let B=0;for(let z=0;z<u.length;z++){const T=u[z],j=V.get(T);e.uniform1f(k.uZ,(T+.5)/x);const A=Math.max(0,j.minX),M=Math.max(0,j.minY),_=Math.min(x,j.maxX),D=Math.min(x,j.maxY),O=_-A,w=D-M;e.uniform2f(k.uTileOffset,A,M),e.viewport(0,0,O,w),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readPixels(0,0,O,w,e.RGBA,e.FLOAT,L);const I=j.entries;for(let G=0;G<I.length;G++){const H=I[G],X=H.startX/g|0,$=H.startY/g|0,U=T/g|0,Z=(U*y+$)*y+X,Q=P.get(Z);if(!Q)continue;const ne=T-U*g;for(let K=0;K<g;K++){const ee=H.startX+K;if(!(ee<A||ee>=_))for(let re=0;re<g;re++){const ie=H.startY+re;if(ie<M||ie>=D)continue;const le=((ie-M)*O+(ee-A))*4;if(L[le]>.5){const ve=(ne*g+re)*g+K;Q[ve>>3]|=1<<(ve&7),B++}}}}!(z&7)&&f&&(f(Math.round(z/u.length*100)),await d())}return e.deleteTexture(F),e.deleteFramebuffer(R),e.deleteProgram(C),{escapeMap:P,solidCount:B}}function sa(e,t,o,n,s,r,a,i,l,f){i||(i=6);const v=t.vertexCount,m=Math.ceil(Math.sqrt(v)),d=Math.ceil(v/m),x=new Float32Array(m*d*4);for(let F=0;F<v;F++)x[F*4]=t.positions[F*3],x[F*4+1]=t.positions[F*3+1],x[F*4+2]=t.positions[F*3+2],x[F*4+3]=1;const g=e.createTexture();e.bindTexture(e.TEXTURE_2D,g),e.texImage2D(e.TEXTURE_2D,0,e.RGBA32F,m,d,0,e.RGBA,e.FLOAT,x),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE);const y=e.createTexture();e.bindTexture(e.TEXTURE_2D,y),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,m,d);const p=e.createTexture();e.bindTexture(e.TEXTURE_2D,p),e.texStorage2D(e.TEXTURE_2D,1,e.RGBA32F,m,d);const E=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,E),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,y,0),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT1,e.TEXTURE_2D,p,0),e.drawBuffers([e.COLOR_ATTACHMENT0,e.COLOR_ATTACHMENT1]);const h=Sn({definition:o,deType:"auto",interlace:f}),S=it(e,Qe,h,l);e.useProgram(S),e.viewport(0,0,m,d),e.bindVertexArray(e.createVertexArray()),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,g),e.uniform1i(e.getUniformLocation(S,"uPositions"),0),e.uniform1f(e.getUniformLocation(S,"uPower"),s),e.uniform1i(e.getUniformLocation(S,"uIters"),r),e.uniform1f(e.getUniformLocation(S,"uVoxelSize"),a),e.uniform1i(e.getUniformLocation(S,"uNewtonSteps"),i);const C=eo(e,S);st(e,C,n),rt(e,C,f),e.drawArrays(e.TRIANGLE_STRIP,0,4),e.readBuffer(e.COLOR_ATTACHMENT0);const N=new Float32Array(m*d*4);e.readPixels(0,0,m,d,e.RGBA,e.FLOAT,N),e.readBuffer(e.COLOR_ATTACHMENT1);const k=new Float32Array(m*d*4);e.readPixels(0,0,m,d,e.RGBA,e.FLOAT,k);for(let F=0;F<v;F++)t.positions[F*3]=N[F*4],t.positions[F*3+1]=N[F*4+1],t.positions[F*3+2]=N[F*4+2],t.normals[F*3]=k[F*4],t.normals[F*3+1]=k[F*4+1],t.normals[F*3+2]=k[F*4+2];return e.deleteTexture(g),e.deleteTexture(y),e.deleteTexture(p),e.deleteFramebuffer(E),e.deleteProgram(S),t}async function ra(e,t,o,n,s,r,a,i,l,f){const{log:v,setProgress:m,setPhase:d,setStatus:x,tick:g}=l;(!a||a<1)&&(a=1),i||(i=0);const y=t.vertexCount,p=Math.ceil(Math.sqrt(y)),E=Math.ceil(y/p);v("Color texture: "+p+"x"+E+" ("+(p*E*16/(1024*1024)).toFixed(0)+" MB position data)"+(a>1?" | "+a+" samples, radius="+i.toFixed(5):""),"mem");let h=new Float32Array(p*E*4);for(let L=0;L<y;L++)h[L*4]=t.positions[L*3],h[L*4+1]=t.positions[L*3+1],h[L*4+2]=t.positions[L*3+2],h[L*4+3]=1;const S=zo({definition:o,interlace:f}),C=it(e,Qe,S,v);e.useProgram(C);const N=e.createTexture();e.bindTexture(e.TEXTURE_2D,N),e.texImage2D(e.TEXTURE_2D,0,e.RGBA32F,p,E,0,e.RGBA,e.FLOAT,h),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),h=null;const k=a>1,F=e.createTexture();e.bindTexture(e.TEXTURE_2D,F),e.texStorage2D(e.TEXTURE_2D,1,k?e.RGBA32F:e.RGBA8,p,E);const R=e.createFramebuffer();e.bindFramebuffer(e.FRAMEBUFFER,R),e.framebufferTexture2D(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,F,0),e.viewport(0,0,p,E),e.bindVertexArray(e.createVertexArray());const V=eo(e,C),u=e.getUniformLocation(C,"uJitterOffset");if(e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,N),e.uniform1i(e.getUniformLocation(C,"uPositions"),0),e.uniform1f(e.getUniformLocation(C,"uPower"),s),e.uniform1i(e.getUniformLocation(C,"uIters"),r),e.uniform1i(e.getUniformLocation(C,"uWidth"),p),st(e,V,n),rt(e,V,f),a<=1)e.uniform3f(u,0,0,0),e.drawArrays(e.TRIANGLE_STRIP,0,4);else{e.clearColor(0,0,0,0),e.clear(e.COLOR_BUFFER_BIT),e.enable(e.BLEND),e.blendFunc(e.ONE,e.ONE);const L=Math.PI*(3-Math.sqrt(5));for(let P=0;P<a;P++){const B=Math.acos(1-2*(P+.5)/a),z=L*P,T=i*Math.cbrt((P+.5)/a),j=T*Math.sin(B)*Math.cos(z),A=T*Math.sin(B)*Math.sin(z),M=T*Math.cos(B);if(e.uniform3f(u,j,A,M),e.drawArrays(e.TRIANGLE_STRIP,0,4),!(P&3)||P===a-1){const _=Math.round((P+1)/a*100);m(80+Math.round((P+1)/a*10)),d("Phase 5: Vertex Coloring",_),x("Color sample "+(P+1)+"/"+a),await g()}}e.disable(e.BLEND)}const c=new Uint8Array(y*4);if(k){const L=new Float32Array(p*E*4);e.readPixels(0,0,p,E,e.RGBA,e.FLOAT,L);const P=1/a;for(let B=0;B<y;B++)c[B*4]=Math.min(255,Math.round(L[B*4]*P*255)),c[B*4+1]=Math.min(255,Math.round(L[B*4+1]*P*255)),c[B*4+2]=Math.min(255,Math.round(L[B*4+2]*P*255)),c[B*4+3]=255}else{const L=new Uint8Array(p*E*4);e.readPixels(0,0,p,E,e.RGBA,e.UNSIGNED_BYTE,L);for(let P=0;P<y;P++)c[P*4]=L[P*4],c[P*4+1]=L[P*4+1],c[P*4+2]=L[P*4+2],c[P*4+3]=255}return e.deleteTexture(N),e.deleteTexture(F),e.deleteFramebuffer(R),e.deleteProgram(C),c}async function ia(e,t,o,n,s,r,a){var g;const i=vt(),l=64,f=6,v=[-f/2,-f/2,-f/2],m=f,d=m/l,x=a??0;try{const y=Je(i,l,e,1,()=>{},s,r);lt(i,y,l,n,o,v,m,t,s,x),i.viewport(0,0,l,l);const p=new Float32Array(l*l*4);let E=1/0,h=1/0,S=1/0,C=-1/0,N=-1/0,k=-1/0,F=!1;for(let P=0;P<l;P++){i.uniform1f(y.loc.uZ,(P+.5)/l),i.uniform2f(y.loc.uTileOffset,0,0),i.drawArrays(i.TRIANGLE_STRIP,0,4),i.readPixels(0,0,l,l,i.RGBA,i.FLOAT,p);const B=v[2]+(P+.5)*d;for(let z=0;z<l;z++)for(let T=0;T<l;T++)if(p[(z*l+T)*4]<d*2){const A=v[0]+(T+.5)*d,M=v[1]+(z+.5)*d;A<E&&(E=A),A>C&&(C=A),M<h&&(h=M),M>N&&(N=M),B<S&&(S=B),B>k&&(k=B),F=!0}}if(i.deleteTexture(y.tex),i.deleteFramebuffer(y.fbo),i.deleteProgram(y.prog),!F)return null;const R=.15,V=(C-E)*(1+R),u=(N-h)*(1+R),c=(k-S)*(1+R),L=Math.max(V,u,c,.5);return{center:[(E+C)/2,(h+N)/2,(S+k)/2],size:[L,L,L]}}finally{(g=i.getExtension("WEBGL_lose_context"))==null||g.loseContext()}}function la(){const e=Y(m=>m.bboxCenter),t=Y(m=>m.bboxSize),o=Y(m=>m.setBboxCenter),n=Y(m=>m.setBboxSize),s=Y(m=>m.resetBounds),[r,a]=de.useState(!1),i=m=>{o([m.x,m.y,m.z??0])},l=de.useMemo(()=>new Ve(t[0],t[1],t[2]),[t[0],t[1],t[2]]),f=de.useCallback(m=>{n([m.x,m.y,m.z])},[n]),v=async()=>{const m=Y.getState(),d=m.loadedDefinition||Oe.get(m.selectedFormulaId);if(d){a(!0);try{let x;m.interlaceState&&(x={definition:m.interlaceState.definition,params:m.interlaceState.params,enabled:m.interlaceState.enabled,interval:m.interlaceState.interval,startIter:m.interlaceState.startIter});const g=m.qualitySettings,y={estimator:g.estimator,distanceMetric:g.distanceMetric},p=await ia(d,m.formulaParams,m.iters,m.formulaParams.paramA||8,x,y,g.surfaceThreshold);p&&(o(p.center),n(p.size))}catch(x){console.error("Auto-fit failed:",x)}finally{a(!1)}}};return b.jsxs("div",{className:"flex flex-col gap-px mt-1",children:[b.jsx(Vt,{label:"Center",value:{x:e[0],y:e[1],z:e[2]},onChange:i,axisConfig:{min:-100,max:100,step:.1},showDualAxisPads:!1}),b.jsx(nn,{label:"Size",value:l,onChange:f,min:.1,max:100,step:.1,showDualAxisPads:!1,linkable:!0}),b.jsxs("div",{className:"flex items-center gap-2 mt-1 px-0.5",children:[b.jsx("button",{onClick:s,className:"text-[10px] px-2 py-0.5 bg-white/10 text-gray-300 border border-white/10 rounded-sm hover:bg-white/15 cursor-pointer",children:"Reset"}),b.jsx("button",{onClick:v,disabled:r,className:"text-[10px] px-2 py-0.5 bg-emerald-900/40 text-emerald-300 border border-emerald-700/30 rounded-sm hover:bg-emerald-800/40 cursor-pointer disabled:opacity-50 disabled:cursor-default",children:r?"Fitting...":"Auto-fit"}),b.jsxs("span",{className:"text-[10px] text-gray-600",children:[t[0].toFixed(1)," × ",t[1].toFixed(1)," × ",t[2].toFixed(1)]})]})]})}const xo={info:"text-gray-400",phase:"text-emerald-400 font-bold",data:"text-sky-400",warn:"text-amber-400",error:"text-red-400 font-bold",success:"text-emerald-400",mem:"text-pink-300"},ca=()=>{const e=Y(h=>h.status),t=Y(h=>h.progress),o=Y(h=>h.phaseName),n=Y(h=>h.phaseProgress),s=Y(h=>h.memoryBlocks),r=Y(h=>h.logEntries),a=Y(h=>h.clearLog),i=Y(h=>h.lastMesh),l=Y(h=>h.lastTimings),f=Y(h=>h.smoothingSkipped),v=Y(h=>h.useNarrowBand),m=Y(h=>h.resolution),d=Y(h=>h.newton),x=Y(h=>h.isRunning),g=de.useRef(null);de.useEffect(()=>{var h;(h=g.current)==null||h.scrollIntoView({behavior:"smooth"})},[r.length]);const y=s.reduce((h,S)=>h+(S.freed?0:S.mb),0),p=Math.max(1,...s.map(h=>h.mb)),E=()=>{const h=r.map(S=>`[${S.time}] ${S.msg}`).join(`
`);navigator.clipboard.writeText(h).catch(()=>{})};return b.jsxs("div",{className:"font-mono flex flex-col gap-2",children:[e&&b.jsx("div",{className:"text-[13px] text-amber-400 font-bold",children:e}),b.jsx("div",{className:"h-1 bg-gray-800 rounded overflow-hidden",children:b.jsx("div",{className:"h-full bg-gradient-to-r from-emerald-700 to-emerald-400 transition-[width] duration-300",style:{width:`${Math.min(100,Math.max(0,t))}%`}})}),o&&b.jsx("div",{className:"text-[11px] text-gray-500",children:o}),b.jsx("div",{className:"h-[3px] bg-gray-800 rounded overflow-hidden",children:b.jsx("div",{className:"h-full bg-gradient-to-r from-sky-700 to-sky-400 transition-[width] duration-300",style:{width:`${Math.min(100,Math.max(0,n))}%`}})}),i&&l&&!x&&b.jsxs("div",{className:"text-[11px] leading-relaxed bg-black/40 border border-white/10 rounded px-2 py-1.5",children:[b.jsxs("span",{className:"text-emerald-400",children:[m,"³ · ",i.vertexCount.toLocaleString()," vertices · ",i.faceCount.toLocaleString()," faces"]})," · ",b.jsxs("span",{className:"text-sky-400",children:[Math.round((i.positions.byteLength+i.normals.byteLength+i.indices.byteLength)/(1024*1024))," MB mesh"]}),d&&b.jsx("span",{className:"text-gray-400",children:" · Newton projected"}),f&&b.jsx("span",{className:"text-amber-400",children:" · smoothing skipped (>5M verts)"}),b.jsx("br",{}),b.jsxs("span",{className:"text-gray-500",children:[v?`Coarse: ${(l.coarse/1e3).toFixed(1)}s · Fine: ${(l.fine/1e3).toFixed(1)}s`:`SDF: ${(l.sdf/1e3).toFixed(1)}s`," · ","DC: ",(l.dc/1e3).toFixed(1),"s",l.newton>100&&` · Newton: ${(l.newton/1e3).toFixed(1)}s`," · ","Post: ",(l.post/1e3).toFixed(1),"s"," · ","Color: ",(l.color/1e3).toFixed(1),"s"," · ","Total: ",(l.total/1e3).toFixed(1),"s"]})]}),s.length>0&&b.jsxs("div",{children:[b.jsx("div",{className:"flex gap-px h-[18px] rounded overflow-hidden",children:s.map(h=>b.jsx("div",{title:`${h.label}: ${h.mb} MB${h.freed?" (freed)":""}`,className:"flex items-center justify-center text-[9px] text-black font-bold overflow-hidden whitespace-nowrap rounded-sm transition-opacity",style:{flex:Math.max(h.mb/p,.08),background:h.color,opacity:h.freed?.25:1},children:h.label},h.id))}),b.jsxs("div",{className:"text-[10px] text-gray-600 mt-0.5",children:["Memory: ",y," MB active"]})]}),r.length>0&&b.jsxs("div",{children:[b.jsxs("div",{className:"max-h-[200px] overflow-y-auto bg-black/80 border border-white/10 rounded p-1.5 text-[11px] leading-relaxed",children:[r.map((h,S)=>b.jsxs("div",{className:xo[h.type]||xo.info,children:[b.jsx("span",{className:"text-gray-600",children:h.time})," ",h.msg]},S)),b.jsx("div",{ref:g})]}),b.jsxs("div",{className:"flex gap-1.5 mt-1",children:[b.jsx("button",{onClick:E,className:"text-[10px] px-2 py-0.5 bg-white/10 text-gray-400 border border-white/10 rounded-sm hover:bg-white/15 cursor-pointer",children:"Copy"}),b.jsx("button",{onClick:a,className:"text-[10px] px-2 py-0.5 bg-white/10 text-gray-400 border border-white/10 rounded-sm hover:bg-white/15 cursor-pointer",children:"Clear"})]})]})]})};function ua(e,t,o){let n=0;for(let s=0;s<e.length;s++)e[s]<-o&&(e[s]=o,n++);return n}function fa(e,t){let o=0;return e.blocks.forEach(n=>{for(let s=0;s<n.length;s++)n[s]<-t&&(n[s]=t,o++)}),o}function go(e,t,o,n,s){const r=new Float32Array(e.length);for(let i=0;i<o;i++)for(let l=0;l<o;l++){const f=i*o*o+l*o;for(let v=0;v<o;v++){let m=e[f+v];for(let d=-n;d<=n;d++){const x=v+d;x>=0&&x<o&&(m=s(m,e[f+x]))}r[f+v]=m}}const a=new Float32Array(e.length);for(let i=0;i<o;i++)for(let l=0;l<o;l++)for(let f=0;f<o;f++){const v=i*o*o+f*o+l;let m=r[v];for(let d=-n;d<=n;d++){const x=f+d;x>=0&&x<o&&(m=s(m,r[i*o*o+x*o+l]))}a[v]=m}for(let i=0;i<o;i++)for(let l=0;l<o;l++)for(let f=0;f<o;f++){const v=f*o*o+i*o+l;let m=a[v];for(let d=-n;d<=n;d++){const x=f+d;x>=0&&x<o&&(m=s(m,a[x*o*o+i*o+l]))}t[v]=m}}async function da(e,t,o,n){const s=n||(()=>{});if(o<=0)return;const r=Math.round(o),a=t*t*t,i=new Float32Array(a);s(0),go(e,i,t,r,Math.min),s(25),await new Promise(l=>{setTimeout(l,0)}),go(i,e,t,r,Math.max),s(50)}async function ma(e,t,o){const n=o||(()=>{});if(t<=0)return;const s=Math.round(t);e.N;const r=e.blockSize;for(let a=0;a<2;a++){const i=a===0?Math.min:Math.max,l=new Map;e.blocks.forEach((f,v)=>{const m=new Float32Array(f.length),d=e.blocksPerAxis,x=v%d,g=(v/d|0)%d,y=v/(d*d)|0,p=x*r,E=g*r,h=y*r;for(let S=0;S<r;S++)for(let C=0;C<r;C++)for(let N=0;N<r;N++){let k=f[(S*r+C)*r+N];for(let F=-s;F<=s;F++)for(let R=-s;R<=s;R++)for(let V=-s;V<=s;V++){const u=p+N+V,c=E+C+R,L=h+S+F;k=i(k,e.get(u,c,L))}m[(S*r+C)*r+N]=k}l.set(v,m)}),l.forEach((f,v)=>{e.blocks.set(v,f)}),n(a===0?50:100),await new Promise(f=>{setTimeout(f,0)})}}async function ha(e,t,o,n){const s=o||(()=>{}),r=n||(()=>{}),a=t*t*t,i=a+7>>3,l=new Uint8Array(i),f=(R,V,u)=>(u*t+V)*t+R,v=R=>(l[R>>3]&1<<(R&7))!==0,m=R=>{l[R>>3]|=1<<(R&7)};let d=Math.min(a,4*1024*1024),x=new Int32Array(d),g=0,y=0,p=0;const E=R=>{if(p>=d){const V=d*2,u=new Int32Array(V);for(let c=0;c<p;c++)u[c]=x[(g+c)%d];x=u,g=0,y=p,d=V}x[y]=R,y=(y+1)%d,p++},h=()=>{const R=x[g];return g=(g+1)%d,p--,R};for(let R=0;R<t;R++)for(let V=0;V<t;V++)for(let u=0;u<t;u++)if(u===0||u===t-1||V===0||V===t-1||R===0||R===t-1){const c=f(u,V,R);e[c]>=0&&!v(c)&&(m(c),E(c))}s(5);let S=0;const C=[-1,1,0,0,0,0],N=[0,0,-1,1,0,0],k=[0,0,0,0,-1,1];for(;p>0;){const R=h(),V=R%t,u=(R/t|0)%t,c=R/(t*t)|0;for(let L=0;L<6;L++){const P=V+C[L],B=u+N[L],z=c+k[L];if(P<0||B<0||z<0||P>=t||B>=t||z>=t)continue;const T=f(P,B,z);v(T)||e[T]>=0&&(m(T),E(T))}S++,S&1048575||(s(5+Math.round(85*S/a)),await new Promise(L=>{setTimeout(L,0)}),r())}let F=0;for(let R=0;R<a;R++)e[R]>=0&&!v(R)&&(e[R]=-Math.abs(e[R])-.001,F++);return s(100),F}async function pa(e,t,o,n){const s=o||(()=>{}),r=n||(()=>{}),a=e.N,i=e.blockSize,l=e.blocksPerAxis,f=e.blockCellCount+7>>3;function v(_,D,O,w){if(D<0||O<0||w<0||D>=a||O>=a||w>=a)return!1;const I=D/i|0,G=O/i|0,H=w/i|0,X=(H*l+G)*l+I,$=_.get(X);if(!$)return!1;const U=D-I*i,Z=O-G*i,ne=((w-H*i)*i+Z)*i+U;return($[ne>>3]&1<<(ne&7))!==0}function m(_,D,O,w){const I=D/i|0,G=O/i|0,H=w/i|0,X=(H*l+G)*l+I,$=_.get(X);if(!$)return;const U=D-I*i,Z=O-G*i,ne=((w-H*i)*i+Z)*i+U;$[ne>>3]|=1<<(ne&7)}let d=2*1024*1024,x=new Int32Array(d),g=new Uint8Array(d),y=0,p=0;function E(){const _=p-y,D=d*2,O=new Int32Array(D),w=new Uint8Array(D);for(let I=0;I<_;I++)O[I]=x[(y+I)%d],w[I]=g[(y+I)%d];x=O,g=w,y=0,p=_,d=D}function h(_,D){p-y>=d-1&&E(),x[p%d]=_,g[p%d]=D,p++}function S(){const _=x[y%d],D=g[y%d];return y++,{coord:_,dist:D}}let C=2*1024*1024,N=new Int32Array(C),k=0,F=0;function R(){const _=F-k,D=C*2,O=new Int32Array(D);for(let w=0;w<_;w++)O[w]=N[(k+w)%C];N=O,k=0,F=_,C=D}function V(_){F-k>=C-1&&R(),N[F++%C]=_}function u(){return N[k++%C]}const c=new Map;e.blocks.forEach((_,D)=>{const O=new Uint8Array(f);for(let w=0;w<_.length;w++)_[w]<0&&(O[w>>3]|=1<<(w&7));c.set(D,O)});let L=0;e.blocks.forEach((_,D)=>{const O=D%l,w=(D/l|0)%l,I=D/(l*l)|0,G=O*i,H=w*i,X=I*i;for(let $=0;$<i;$++)for(let U=0;U<i;U++)for(let Z=0;Z<i;Z++){const Q=($*i+U)*i+Z;if(_[Q]<0)continue;const ne=G+Z,K=H+U,ee=X+$;let re=!1;for(let ie=0;ie<6&&!re;ie++){const le=ne+(ie===0?-1:ie===1?1:0),ve=K+(ie===2?-1:ie===3?1:0),q=ee+(ie===4?-1:ie===5?1:0);e.get(le,ve,q)<0&&(re=!0)}re&&(m(c,ne,K,ee),h((ee*a+K)*a+ne,1),L++)}}),console.log("[CavityFill] Dilate by "+t+": "+L+" surface seeds"),s(5);let P=0,B=0;for(;y<p;){const _=S(),D=_.coord,O=_.dist,w=D%a,I=(D/a|0)%a,G=D/(a*a)|0;for(let H=0;H<6;H++){const X=w+(H===0?-1:H===1?1:0),$=I+(H===2?-1:H===3?1:0),U=G+(H===4?-1:H===5?1:0);X<0||$<0||U<0||X>=a||$>=a||U>=a||v(c,X,$,U)||(m(c,X,$,U),P++,O+1<t&&h((U*a+$)*a+X,O+1))}++B&262143||(s(5+Math.round(20*Math.min(1,P/(L*t+1)))),await new Promise(H=>{setTimeout(H,0)}),r())}console.log("[CavityFill] Dilate done: "+P+" cells expanded"),s(30);const z=new Map;e.blocks.forEach((_,D)=>{z.set(D,new Uint8Array(f))}),e.blocks.forEach((_,D)=>{const O=c.get(D),w=D%l,I=(D/l|0)%l,G=D/(l*l)|0,H=w*i,X=I*i,$=G*i;for(let U=0;U<i;U++)for(let Z=0;Z<i;Z++)for(let Q=0;Q<i;Q++){const ne=(U*i+Z)*i+Q;if(O[ne>>3]&1<<(ne&7))continue;const K=H+Q,ee=X+Z,re=$+U;let ie=!1;if(K===0||K===a-1||ee===0||ee===a-1||re===0||re===a-1)ie=!0;else if(Q===0||Q===i-1||Z===0||Z===i-1||U===0||U===i-1)for(let le=0;le<6&&!ie;le++){const ve=K+(le===0?-1:le===1?1:0),q=ee+(le===2?-1:le===3?1:0),W=re+(le===4?-1:le===5?1:0),te=ve/i|0,ce=q/i|0,se=W/i|0;e.hasBlock(te,ce,se)||(ie=!0)}if(ie){const le=z.get(D);le[ne>>3]|=1<<(ne&7),V((re*a+ee)*a+K)}}}),console.log("[CavityFill] Flood fill: "+F+" boundary seeds"),s(40);let j=0,A=0;for(;k<F;){const _=u(),D=_%a,O=(_/a|0)%a,w=_/(a*a)|0;for(let I=0;I<6;I++){const G=D+(I===0?-1:I===1?1:0),H=O+(I===2?-1:I===3?1:0),X=w+(I===4?-1:I===5?1:0);if(G<0||H<0||X<0||G>=a||H>=a||X>=a)continue;const $=G/i|0,U=H/i|0,Z=X/i|0,Q=(Z*l+U)*l+$,ne=G-$*i,K=H-U*i,re=((X-Z*i)*i+K)*i+ne,ie=z.get(Q);ie&&(ie[re>>3]&1<<(re&7)||v(c,G,H,X)||(ie[re>>3]|=1<<(re&7),V((X*a+H)*a+G),j++))}++A&262143||(s(40+Math.round(40*j/(j+(F-k)+1))),await new Promise(I=>{setTimeout(I,0)}),r())}console.log("[CavityFill] Flood done: "+j+" cells reached"),s(85);let M=0;return e.blocks.forEach((_,D)=>{const O=z.get(D);for(let w=0;w<_.length;w++)_[w]>=0&&!(O[w>>3]&1<<(w&7))&&(_[w]=-Math.abs(_[w])-.001,M++)}),s(100),console.log("[CavityFill] Filled: "+M+" cavity cells"),{filled:M,dilated:P,seeds:L}}function va(e,t){const o=new Array(t);for(let s=0;s<t;s++)o[s]=new Set;for(let s=0,r=e.length;s<r;s+=3){const a=e[s],i=e[s+1],l=e[s+2];o[a].add(i),o[a].add(l),o[i].add(a),o[i].add(l),o[l].add(a),o[l].add(i)}const n=new Array(t);for(let s=0;s<t;s++){const r=o[s],a=new Uint32Array(r.size);let i=0;for(const l of r)a[i++]=l;n[s]=a}return n}function bo(e,t,o,n){const s=t.length;n.set(e);for(let r=0;r<s;r++){const a=t[r],i=a.length;if(i===0)continue;const l=r*3,f=n[l],v=n[l+1],m=n[l+2];let d=0,x=0,g=0;for(let p=0;p<i;p++){const E=a[p]*3;d+=n[E]-f,x+=n[E+1]-v,g+=n[E+2]-m}const y=o/i;e[l]=f+d*y,e[l+1]=v+x*y,e[l+2]=m+g*y}}function xa(e,t=.5,o=-.53,n=5){const s=va(e.indices,e.vertexCount),r=new Float32Array(e.positions.length);for(let a=0;a<n;a++)bo(e.positions,s,t,r),bo(e.positions,s,o,r);return e}function ga(e,t=1e-6){const o=e.positions,n=e.normals,s=e.indices,r=e.vertexCount,i=1/(t>0?t:1e-6),l=new Map,f=new Int32Array(r);f.fill(-1);const v=[],m=[];let d=0;function x(y,p,E){return y+","+p+","+E}for(let y=0;y<r;y++){const p=y*3,E=o[p],h=o[p+1],S=o[p+2],C=Math.floor(E*i),N=Math.floor(h*i),k=Math.floor(S*i);let F=!1;for(let u=-1;u<=1&&!F;u++)for(let c=-1;c<=1&&!F;c++)for(let L=-1;L<=1&&!F;L++){const P=x(C+u,N+c,k+L),B=l.get(P);if(B!==void 0)for(let z=0;z<B.length;z++){const T=B[z],j=T*3,A=o[j]-E,M=o[j+1]-h,_=o[j+2]-S;if(A*A+M*M+_*_<=t*t){f[y]=f[T],F=!0;break}}}F||(f[y]=d,v.push(E,h,S),m.push(n[p],n[p+1],n[p+2]),d++);const R=x(C,N,k),V=l.get(R);V===void 0?l.set(R,[y]):V.push(y)}const g=new Uint32Array(s.length);for(let y=0,p=s.length;y<p;y++)g[y]=f[s[y]];return{positions:new Float32Array(v),normals:new Float32Array(m),indices:g,vertexCount:d,faceCount:e.faceCount}}function ba(e){const t=e.positions,o=e.indices,n=e.faceCount,s=[];for(let r=0;r<n;r++){const a=r*3,i=o[a]*3,l=o[a+1]*3,f=o[a+2]*3,v=t[l]-t[i],m=t[l+1]-t[i+1],d=t[l+2]-t[i+2],x=t[f]-t[i],g=t[f+1]-t[i+1],y=t[f+2]-t[i+2],p=m*y-d*g,E=d*x-v*y,h=v*g-m*x;p*p+E*E+h*h>=1e-20&&s.push(o[a],o[a+1],o[a+2])}return{positions:e.positions,normals:e.normals,indices:new Uint32Array(s),vertexCount:e.vertexCount,faceCount:s.length/3}}function ya(e){const t=e.positions,o=e.indices,n=e.normals,s=e.vertexCount,r=e.faceCount;for(let a=0;a<s*3;a++)n[a]=0;for(let a=0;a<r;a++){const i=a*3,l=o[i],f=o[i+1],v=o[i+2],m=l*3,d=f*3,x=v*3,g=t[d]-t[m],y=t[d+1]-t[m+1],p=t[d+2]-t[m+2],E=t[x]-t[m],h=t[x+1]-t[m+1],S=t[x+2]-t[m+2],C=y*S-p*h,N=p*E-g*S,k=g*h-y*E;n[m]+=C,n[m+1]+=N,n[m+2]+=k,n[d]+=C,n[d+1]+=N,n[d+2]+=k,n[x]+=C,n[x+1]+=N,n[x+2]+=k}for(let a=0;a<s;a++){const i=a*3,l=n[i],f=n[i+1],v=n[i+2],m=Math.sqrt(l*l+f*f+v*v);if(m>1e-12){const d=1/m;n[i]*=d,n[i+1]*=d,n[i+2]*=d}}return e}function wa(e){const t=e.positions,o=e.indices,n=e.vertexCount,s=e.faceCount;let r=0,a=0,i=0;for(let f=0;f<n;f++){const v=f*3;r+=t[v],a+=t[v+1],i+=t[v+2]}const l=1/n;r*=l,a*=l,i*=l;for(let f=0;f<s;f++){const v=f*3,m=o[v],d=o[v+1],x=o[v+2],g=m*3,y=d*3,p=x*3,E=(t[g]+t[y]+t[p])/3,h=(t[g+1]+t[y+1]+t[p+1])/3,S=(t[g+2]+t[y+2]+t[p+2])/3,C=t[y]-t[g],N=t[y+1]-t[g+1],k=t[y+2]-t[g+2],F=t[p]-t[g],R=t[p+1]-t[g+1],V=t[p+2]-t[g+2],u=N*V-k*R,c=k*F-C*V,L=C*R-N*F;if(u*(E-r)+c*(h-a)+L*(S-i)<0){const P=o[v+1];o[v+1]=o[v+2],o[v+2]=P}}return e}function Sa(e,t){const o=t??{},n=o.smoothing??!0,s=o.smoothIterations??5,r=o.lambda??.5,a=o.mu??-(r+.03);return o.mergeVertices&&(e=ga(e,o.mergeEpsilon??1e-6)),e.faceCount<5e6&&(e=ba(e)),n&&s>0&&(e.vertexCount>5e6?console.warn("Skipping smoothing: "+e.vertexCount.toLocaleString()+" vertices too large (>5M limit)"):e=xa(e,r,a,s)),o.consistentWinding&&(e=wa(e)),e=ya(e),e}class Ca{constructor(t){oe(this,"_buf");oe(this,"_view");oe(this,"_u8");oe(this,"_pos");t||(t=1024*1024),this._buf=new ArrayBuffer(t),this._view=new DataView(this._buf),this._u8=new Uint8Array(this._buf),this._pos=0}get pos(){return this._pos}set pos(t){this._pos=t}_grow(t){const o=this._pos+t;if(o<=this._buf.byteLength)return;let n=this._buf.byteLength;for(;n<o;)n*=2;const s=new ArrayBuffer(n);new Uint8Array(s).set(this._u8),this._buf=s,this._view=new DataView(this._buf),this._u8=new Uint8Array(this._buf)}u8(t){this._grow(1),this._view.setUint8(this._pos,t),this._pos+=1}u16(t){this._grow(2),this._view.setUint16(this._pos,t,!0),this._pos+=2}u32(t){this._grow(4),this._view.setUint32(this._pos,t,!0),this._pos+=4}i32(t){this._grow(4),this._view.setInt32(this._pos,t,!0),this._pos+=4}f32(t){this._grow(4),this._view.setFloat32(this._pos,t,!0),this._pos+=4}raw(t){const o=t.length;this._grow(o),this._u8.set(t,this._pos),this._pos+=o}str(t){const o=t.length;this._grow(o);for(let n=0;n<o;n++)this._u8[this._pos++]=t.charCodeAt(n)&127}strNull(t){this.str(t),this.u8(0)}pad(t){this.padWith(t,0)}padWith(t,o){const n=this._pos%t;if(n===0)return;const s=t-n;this._grow(s);for(let r=0;r<s;r++)this._u8[this._pos++]=o}bulkF32(t){const o=t.byteLength;this._grow(o),this._u8.set(new Uint8Array(t.buffer,t.byteOffset,o),this._pos),this._pos+=o}bulkU32(t){const o=t.byteLength;this._grow(o),this._u8.set(new Uint8Array(t.buffer,t.byteOffset,o),this._pos),this._pos+=o}bulkU8(t){this.raw(t)}result(){return this._buf.slice(0,this._pos)}}function Ma(e){const t=e.positions,o=e.normals,n=e.colors,s=e.indices,r=e.vertexCount,a=e.faceCount,i=n!=null&&n.length>0,l=[1/0,1/0,1/0],f=[-1/0,-1/0,-1/0];for(let D=0;D<r;D++){const O=t[D*3],w=t[D*3+1],I=t[D*3+2];O<l[0]&&(l[0]=O),w<l[1]&&(l[1]=w),I<l[2]&&(l[2]=I),O>f[0]&&(f[0]=O),w>f[1]&&(f[1]=w),I>f[2]&&(f[2]=I)}const v=r*12,m=r*12,d=i?r*16:0,x=a*3*4,g=0,y=v,p=v+m,E=v+m+d,h=v+m+d+x,S=(4-h%4)%4,C=h+S,N=[],k=[],F={};let R=0,V=0;N.push({buffer:0,byteOffset:g,byteLength:v,target:34962}),k.push({bufferView:R,byteOffset:0,componentType:5126,count:r,type:"VEC3",min:[l[0],l[1],l[2]],max:[f[0],f[1],f[2]]}),F.POSITION=V,R++,V++,N.push({buffer:0,byteOffset:y,byteLength:m,target:34962}),k.push({bufferView:R,byteOffset:0,componentType:5126,count:r,type:"VEC3"}),F.NORMAL=V,R++,V++,i&&(N.push({buffer:0,byteOffset:p,byteLength:d,target:34962}),k.push({bufferView:R,byteOffset:0,componentType:5126,count:r,type:"VEC4"}),F.COLOR_0=V,R++,V++);const u=V;N.push({buffer:0,byteOffset:E,byteLength:x,target:34963}),k.push({bufferView:R,byteOffset:0,componentType:5125,count:a*3,type:"SCALAR"});const c={attributes:F,indices:u,mode:4},L={asset:{version:"2.0",generator:"GMT Fractal Explorer"},scene:0,scenes:[{nodes:[0]}],nodes:[{mesh:0}],meshes:[{primitives:[c]}],accessors:k,bufferViews:N,buffers:[{byteLength:h}]};i&&(L.materials=[{name:"FractalVertexColor",pbrMetallicRoughness:{baseColorFactor:[1,1,1,1],metallicFactor:0,roughnessFactor:1}}],c.material=0);const P=JSON.stringify(L),B=(4-P.length%4)%4,z=P.length+B,T=20+z+8+C,j=20+z+8,A=new Ca(j+16);A.u32(1179937895),A.u32(2),A.u32(T),A.u32(z),A.u32(1313821514),A.str(P);for(let D=0;D<B;D++)A.u8(32);A.u32(C),A.u32(5130562);const M=D=>D.buffer.slice(D.byteOffset,D.byteOffset+D.byteLength),_=[A._buf.slice(0,A._pos),M(t),M(o)];if(i){const D=new Float32Array(r*4);for(let O=0;O<r*4;O++)D[O]=n[O]/255;_.push(D.buffer)}return _.push(M(s)),S>0&&_.push(new ArrayBuffer(S)),new Blob(_,{type:"application/octet-stream"})}async function Ta(e,t){const o=t||function(){},n=e.positions,s=e.indices,r=e.faceCount,a=new ArrayBuffer(84),i=new DataView(a),l="Fractal Mesh Export - GMT Fractal Explorer";for(let d=0;d<l.length;d++)i.setUint8(d,l.charCodeAt(d)&127);for(let d=l.length;d<80;d++)i.setUint8(d,32);i.setUint32(80,r,!0);const f=[new Uint8Array(a)],v=65536,m=Math.ceil(r/v);for(let d=0;d<r;d+=v){const x=Math.min(d+v,r),g=x-d,y=new ArrayBuffer(g*50),p=new DataView(y);let E=0;for(let S=d;S<x;S++){const C=s[S*3],N=s[S*3+1],k=s[S*3+2],F=n[C*3],R=n[C*3+1],V=n[C*3+2],u=n[N*3],c=n[N*3+1],L=n[N*3+2],P=n[k*3],B=n[k*3+1],z=n[k*3+2],T=u-F,j=c-R,A=L-V,M=P-F,_=B-R,D=z-V;let O=j*D-A*_,w=A*M-T*D,I=T*_-j*M;const G=Math.sqrt(O*O+w*w+I*I);G>1e-12&&(O/=G,w/=G,I/=G),p.setFloat32(E,O,!0),p.setFloat32(E+4,w,!0),p.setFloat32(E+8,I,!0),p.setFloat32(E+12,F,!0),p.setFloat32(E+16,R,!0),p.setFloat32(E+20,V,!0),p.setFloat32(E+24,u,!0),p.setFloat32(E+28,c,!0),p.setFloat32(E+32,L,!0),p.setFloat32(E+36,P,!0),p.setFloat32(E+40,B,!0),p.setFloat32(E+44,z,!0),p.setUint16(E+48,0,!0),E+=50}f.push(new Uint8Array(y));const h=d/v|0;h&7||(o(Math.round(100*(h+1)/m)),await new Promise(function(S){setTimeout(S,0)}))}return o(100),new Blob(f,{type:"application/octet-stream"})}function yo(e,t){if(t==="stl")return 84+e.faceCount*50;{const n=e.colors!=null&&e.colors.length>0?e.vertexCount*16:0;return 1024+e.vertexCount*24+n+e.faceCount*12}}function Ea(e,t){const o=document.createElement("a");o.href=URL.createObjectURL(e),o.download=t,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(o.href)}function De(e){return e.tick?e.tick():new Promise(t=>setTimeout(t,0))}async function Fa(e,t){const{N:o,iters:n,smoothPasses:s,useNewton:r,newtonSteps:a,smoothLambda:i,definition:l,formulaParams:f,power:v,deType:m,deSamples:d,zSubSlices:x,minFeatureSel:g,closingRadius:y,colorSamples:p,colorJitterMul:E,cavityFillMode:h,cavityFillLevel:S,gridMin:C,gridMax:N,boundsRange:k,interlace:F,estimator:R,distanceMetric:V}=e;let u=e.surfaceThreshold??0;const L=(m==="auto"?qt(l):m)==="ifs"&&R!==void 0&&R>=1.5&&R<2.5?1:R,P=L!==void 0||V!==void 0?{estimator:L??0,distanceMetric:V??0}:void 0,B={log:t.log,setStatus:t.setStatus,setProgress:t.setProgress,setPhase:t.setPhase,tick:t.tick,onSlicePreview:t.onSlicePreview},z=o>256,T=k/o,j=performance.now();let A=null,M=null,_,D,O=0,w=0,I=0,G=0,H=0,X=0,$=null,U=null,Z=!1,Q=!1;const ne=l.name||l.id||"unknown";t.log("=== Generate: "+ne+" ===","phase"),t.log("Resolution: "+o+"³ | Iterations: "+n+" | DE: "+m+" | SS: "+d+"³="+d*d*d+(x>1?" | Z-SS: "+x:"")+" | Newton: "+(r?a+" steps":"off")+" | Smooth: "+s+"×λ"+i+(p>1?" | Color-SS: "+p+"×r"+E:"")+" | MinFeat: "+g+" | CavityFill: "+(h==="escape"?"escape-test":S+"x")+" | Closing: "+y,"data"),t.log("Params: "+JSON.stringify(f).substring(0,200),"data"),t.log("Bounds: min=["+C[0].toFixed(2)+","+C[1].toFixed(2)+","+C[2].toFixed(2)+"] max=["+N[0].toFixed(2)+","+N[1].toFixed(2)+","+N[2].toFixed(2)+"] range="+k.toFixed(2),"data");let K;if(m==="ifs")K=Math.ceil(Math.log2(k/T));else{const ee=Math.max(v,2);K=Math.ceil(Math.log(k/T)/Math.log(ee))}n>K+2&&t.log("Note: At "+o+"³ (voxel="+T.toFixed(5)+"), ~"+K+" iterations resolve detail at voxel scale. Using "+n+" adds "+(n-K)+" levels of sub-voxel interior detail. Min Feature filter will clamp this. Consider reducing iterations for faster export.","warn");try{try{if(t.log("[Phase 1] GPU SDF Sampling","phase"),t.setPhase("Phase 1: SDF Sampling",0),t.memAlloc("webgl","WebGL",8,t.MEM_COLORS.webgl),t.setStatus("Initializing WebGL2..."),await De(t),M=vt(),t.log("WebGL2 initialized (max texture: "+M.getParameter(M.MAX_TEXTURE_SIZE)+")","info"),z){t.log("Pass 1: Coarse SDF 128³ ("+(128*128*128*4/(1024*1024)).toFixed(1)+" MB)","info"),t.setStatus("Pass 1: Coarse SDF (128³)..."),await De(t);const W=Je(M,Math.min(128,2048),l,d,t.log,F,P),te=Math.round(128*128*128*4/(1024*1024));t.memAlloc("coarseGrid","Coarse SDF",te,t.MEM_COLORS.coarseGrid);let ce=await vo(M,W,128,v,n,f,C,N,0,10,1,null,null,B,F,u);_=performance.now();let se=0,J=0,ae=1/0;for(let ue=0;ue<ce.length;ue++){const we=ce[ue];we>=0?se++:J++,we<ae&&(ae=we)}if(t.log("Coarse: "+se.toLocaleString()+" outside, "+J.toLocaleString()+" inside ("+((_-j)/1e3).toFixed(1)+"s)","data"),J===0&&ae<10&&u===0){const ue=k/128,we=ae+ue*2;t.log("Auto-threshold: DE always positive (IFS/surface fractal), min="+ae.toFixed(6)+" → threshold="+we.toFixed(6)+". Set “Surface Threshold” in Quality to control shell thickness.","warn");for(let ye=0;ye<ce.length;ye++)ce[ye]-=we;u=we,J=0;for(let ye=0;ye<ce.length;ye++)ce[ye]<0&&J++;t.log("After auto-threshold: "+J.toLocaleString()+" interior coarse cells","data")}else J===0&&t.log("WARNING: No interior voxels in coarse grid — surface may not be found","warn");t.setStatus("Building narrow band for "+o+"³..."),await De(t);const fe=kn(ce,128,o,8,2);ce=null,t.memFree("coarseGrid"),$=fe.grid;const pe=Math.pow(o/$.blockSize,3),be=($.allocatedCount/pe*100).toFixed(1),Fe=Math.round($.memoryMB());t.memAlloc("sparseGrid","Sparse SDF",Fe,t.MEM_COLORS.sparseGrid),t.log("Narrow band: "+$.allocatedCount.toLocaleString()+" blocks ("+be+"% of "+pe.toLocaleString()+"), "+Fe+" MB","data"),t.log("Pass 2: Fine SDF "+o+"³ (narrow-band, "+$.memoryMB().toFixed(0)+" MB allocated)","info"),t.setStatus("Pass 2: Fine SDF ("+o+"³ narrow-band)..."),await De(t),M.deleteTexture(W.tex),M.deleteFramebuffer(W.fbo);const Ee=Je(M,Math.min(o,2048),l,d,t.log,F,P);await oa(M,Ee,$,v,n,f,C,N,10,25,B,F,u),O=performance.now(),D=O,t.log("Fine sampling done: "+((D-_)/1e3).toFixed(1)+"s","success")}else{const q=Math.round(o*o*o*4/1048576);t.memAlloc("sdfGrid","SDF Grid",q,t.MEM_COLORS.sdfGrid),t.log("Dense SDF "+o+"³ ("+q+" MB grid)","info");const W=await Ho(M,l,f,o,v,n,C,N,T,B,F,P,u),te=Je(M,Math.min(o,2048),l,d,t.log,F,P);U=await vo(M,te,o,v,n,f,C,N,0,35,x,W.zSliceMin,W.zSliceMax,B,F,u),O=performance.now();let ce=0,se=0,J=0;for(let ae=0;ae<U.length;ae++){const fe=U[ae];isNaN(fe)?J++:fe>0?ce++:se++}if(t.log("SDF: "+ce.toLocaleString()+" outside, "+se.toLocaleString()+" inside"+(J>0?", "+J+" NaN!":"")+" ("+((O-j)/1e3).toFixed(1)+"s)","data"),se===0&&u===0){let ae=1/0;for(let fe=0;fe<U.length;fe++)U[fe]<ae&&(ae=U[fe]);if(ae<10){const fe=ae+T*2;t.log("Auto-threshold: DE always positive (IFS/surface fractal), min="+ae.toFixed(6)+" → threshold="+fe.toFixed(6)+". Set “Surface Threshold” in Quality to control shell thickness.","warn");for(let pe=0;pe<U.length;pe++)U[pe]-=fe;u=fe}}}}catch(q){t.checkCancel();const W=q;throw t.log("PHASE 1 FAILED: "+W.message,"error"),t.log(W.stack||"","error"),t.setStatus("Error in SDF sampling: "+W.message),q}t.checkCancel();let ee=0;g==="auto"?ee=T*1.5:parseFloat(g)>0&&(ee=T*parseFloat(g));{let q=1/0,W=-1/0,te=0,ce=0;if(z&&$)$.blocks.forEach(se=>{for(let J=0;J<se.length;J++){const ae=se[J];ae<q&&(q=ae),ae>W&&(W=ae),ae<0&&te++,ce++}});else if(U){ce=U.length;for(let se=0;se<U.length;se++){const J=U[se];J<q&&(q=J),J>W&&(W=J),J<0&&te++}}if(t.log("SDF range: ["+q.toFixed(6)+", "+W.toFixed(6)+"] | "+te.toLocaleString()+" interior cells of "+ce.toLocaleString()+" | threshold="+(ee>0?ee.toFixed(6):"off"),"data"),te===0&&q>0&&q<10){const se=q+T*2;if(t.log("Auto-threshold: no interior found, SDF min="+q.toFixed(6)+" → applying threshold "+se.toFixed(6)+" (set Surface Threshold manually to control shell thickness)","warn"),z&&$)$.blocks.forEach(J=>{for(let ae=0;ae<J.length;ae++)J[ae]-=se});else if(U)for(let J=0;J<U.length;J++)U[J]-=se;te=z&&$?(()=>{let J=0;return $.blocks.forEach(ae=>{for(let fe=0;fe<ae.length;fe++)ae[fe]<0&&J++}),J})():U?U.reduce((J,ae)=>J+(ae<0?1:0),0):0,t.log("After auto-threshold: "+te.toLocaleString()+" interior cells","data")}if(S>0||ee>0||y>0){if(t.log("[Phase 1b] SDF Filtering","phase"),t.setPhase("Phase 1b: SDF Filtering",0),t.setStatus("Filtering SDF..."),await De(t),S>0){if(h==="escape"&&z&&$&&M){t.setStatus("Cavity fill (escape test)..."),t.setPhase("Phase 1b: Escape Test",0);const se=await aa(M,$,l,v,n,f,C,N,B,ae=>{t.setPhase("Phase 1b: Escape Test",ae)},F);let J=0;$.blocks.forEach((ae,fe)=>{const pe=se.escapeMap.get(fe);if(pe)for(let be=0;be<ae.length;be++)ae[be]>=0&&pe[be>>3]&1<<(be&7)&&(ae[be]=-Math.abs(ae[be])-.001,J++)}),t.log("Cavity fill (escape test): "+se.solidCount.toLocaleString()+" escape-interior cells, "+J.toLocaleString()+" positive cells filled","data")}else if(z&&$){t.setStatus("Cavity fill (dilate r="+S+", then flood)..."),t.setPhase("Phase 1b: Cavity Fill",0);const se=await pa($,S,J=>{t.setPhase("Phase 1b: Cavity Fill (r="+S+")",J)},()=>{t.checkCancel()});t.log("Cavity fill: dilate="+S+" | "+se.dilated.toLocaleString()+" dilated, "+se.filled.toLocaleString()+" filled solid","data")}else if(U){t.setStatus("Cavity fill (flood)..."),t.setPhase("Phase 1b: Cavity Fill",0);const se=await ha(U,o,J=>{t.setPhase("Phase 1b: Cavity Fill",J)},()=>{t.checkCancel()});t.log("Cavity fill: "+se.toLocaleString()+" cells filled solid","data")}}if(ee>0){let se;z&&$?se=fa($,ee):U?se=ua(U,o,ee):se=0,t.log("Min feature clamp: threshold="+ee.toFixed(6)+" ("+(ee/T).toFixed(1)+"x voxel), "+se.toLocaleString()+" cells clamped","data")}y>0&&(t.setStatus("Morphological closing (r="+y+" voxels)..."),z&&$?await ma($,y,se=>{t.setPhase("Phase 1b: Morph Closing",se)}):U&&await da(U,o,y,se=>{t.setPhase("Phase 1b: Morph Closing",se)}),t.log("Morphological closing: radius="+y+" voxels","data")),t.setPhase("Phase 1b: SDF Filtering",100)}}t.checkCancel();try{if(t.log("[Phase 2] Dual Contouring","phase"),t.setPhase("Phase 2: Dual Contouring",0),t.setProgress(35),await De(t),z&&$)t.setStatus("Dual contouring (sparse, "+o+"³)..."),A=await On($,C,N,(se,J)=>{t.setProgress(35+Math.round(J*.25)),t.setPhase("Phase 2: Dual Contouring",J)});else if(U){t.setStatus("Dual contouring ("+o+"³)...");const ce=Math.round(Math.log2(o));A=await _n(U,o,C,N,ce,(J,ae)=>{t.setProgress(35+Math.round(ae*.25)),t.setPhase("Phase 2: Dual Contouring",ae)}),U=null,t.memFree("sdfGrid")}if(w=performance.now(),!A||A.vertexCount===0)return t.log("No surface found — check parameters and bounds","error"),t.setStatus("No surface found! Try different parameters."),{mesh:null,timings:null,baseName:"",newtonApplied:!1,useNarrowBand:z,gl:M};t.log("DC result: "+A.vertexCount.toLocaleString()+" vertices, "+A.faceCount.toLocaleString()+" faces ("+((w-O)/1e3).toFixed(1)+"s)","data");const q=(A.positions.byteLength/(1024*1024)).toFixed(0),W=(A.normals.byteLength/(1024*1024)).toFixed(0),te=(A.indices.byteLength/(1024*1024)).toFixed(0);t.log("Mesh memory: positions="+q+"MB normals="+W+"MB indices="+te+"MB (total "+(parseInt(q)+parseInt(W)+parseInt(te))+"MB)","mem"),$&&($=null,t.memFree("sparseGrid"),t.log("Sparse grid freed","mem")),t.memAlloc("meshPos","Positions",parseInt(q),t.MEM_COLORS.meshPos),t.memAlloc("meshNrm","Normals",parseInt(W),t.MEM_COLORS.meshNrm),t.memAlloc("meshIdx","Indices",parseInt(te),t.MEM_COLORS.meshIdx),t.setStatus("Mesh: "+A.vertexCount.toLocaleString()+" verts, "+A.faceCount.toLocaleString()+" faces"),t.setProgress(60),await De(t)}catch(q){t.checkCancel();const W=q;throw t.log("PHASE 2 FAILED: "+W.message,"error"),t.log(W.stack||"","error"),t.setStatus("Error in dual contouring: "+W.message),q}t.checkCancel(),X=w;const re=k/o;if(r&&A&&M)try{t.log("[Phase 3] Newton Projection","phase"),t.setPhase("Phase 3: Newton Projection",0),t.log("Mode: GPU (float32, generic formula) — "+A.vertexCount.toLocaleString()+" vertices","info");const q=Math.ceil(Math.sqrt(A.vertexCount));t.log("Newton texture: "+q+"x"+q+" ("+(q*q*16*3/(1024*1024)).toFixed(0)+" MB GPU)","mem"),t.setStatus("GPU Newton projection ("+A.vertexCount.toLocaleString()+" vertices)..."),t.setPhase("Phase 3: Newton Projection",50),await De(t),sa(M,A,l,f,v,n,re,a,t.log,F),X=performance.now(),Q=!0,t.setPhase("Phase 3: Newton Projection",100),t.log("GPU Newton done: "+((X-w)/1e3).toFixed(1)+"s","success")}catch(q){t.checkCancel(),X=performance.now();const W=q;t.log("Newton FAILED: "+W.message,"error"),t.log(W.stack||"","error"),t.setStatus("Newton failed — continuing without projection"),await De(t)}t.setProgress(70),t.checkCancel();try{t.log("[Phase 4] Post-processing","phase"),t.setPhase("Phase 4: Post-processing",0),t.setStatus("Post-processing (smoothing, normals)..."),await De(t),Z=A.vertexCount>5e6,Z&&t.log("Large mesh ("+A.vertexCount.toLocaleString()+" verts) — smoothing disabled to avoid OOM","warn"),A=Sa(A,{smoothing:s>0,smoothIterations:s,lambda:i}),I=performance.now(),t.setPhase("Phase 4: Post-processing",100),t.log("Post-processing done: "+((I-X)/1e3).toFixed(1)+"s","success")}catch(q){t.checkCancel(),I=performance.now();const W=q;throw t.log("PHASE 4 FAILED: "+W.message,"error"),t.log(W.stack||"","error"),t.setStatus("Error in post-processing: "+W.message),q}t.setProgress(80),t.checkCancel();try{t.log("[Phase 5] Vertex Coloring","phase"),t.setPhase("Phase 5: Vertex Coloring",0),t.setStatus("Colorizing vertices..."),await De(t),(!M||M.isContextLost())&&(t.log("Re-initializing WebGL for colorizer","warn"),M=vt());const q=T*E;A.colors=await ra(M,A,l,f,v,n,p,q,B,F),G=performance.now(),t.setPhase("Phase 5: Vertex Coloring",100);const W=(A.vertexCount*3/(1024*1024)).toFixed(1);t.memAlloc("meshCol","Colors",parseFloat(W),t.MEM_COLORS.meshCol),t.log("Coloring done: "+((G-I)/1e3).toFixed(1)+"s"+(p>1?" ("+p+" samples)":""),"success")}catch(q){t.checkCancel(),G=performance.now();const W=q;t.log("PHASE 5 FAILED: "+W.message,"error"),t.log(W.stack||"","error"),t.log("Continuing without vertex colors","warn")}t.setProgress(90),t.checkCancel(),H=performance.now(),t.setProgress(100),t.setPhase("Complete",100),t.setStatus("Done — choose format and export");const ie=((H-j)/1e3).toFixed(1);t.log("=== Complete in "+ie+"s ===","phase");const le=(l.name||l.id||"fractal").toLowerCase().replace(/\s+/g,"-"),ve={total:H-j,sdf:O-j,coarse:_?_-j:0,fine:D&&_?D-_:0,dc:w-O,newton:X-w,post:I-X,color:G-I};return{mesh:A,baseName:le,smoothingSkipped:Z,newtonApplied:Q,timings:ve,useNarrowBand:z,gl:M}}catch(ee){if(M)try{const re=M.getExtension("WEBGL_lose_context");re&&re.loseContext()}catch{}throw ee}}async function Pa(e,t,o,n,s){const r=performance.now();let a,i;if(s.log("[Export] Encoding "+e.toUpperCase()+"...","phase"),s.setStatus("Encoding "+e.toUpperCase()+"..."),s.setPhase("Export "+e.toUpperCase(),0),e==="vdb"){const{definition:v,formulaParams:m,N:d,iters:x,power:g,gridMin:y,gridMax:p,deSamples:E,zSubSlices:h,interlace:S,estimator:C,distanceMetric:N,surfaceThreshold:k}=n,F=C!==void 0||N!==void 0?{estimator:C??0,distanceMetric:N??0}:void 0,R=v.name||v.id||"unknown";s.log("=== VDB Export: "+R+" ===","phase"),s.log("Resolution: "+d+"³ | Iterations: "+x+" | Mode: solid | Z Sub-slices: "+h,"data");const V=vt(),u={log:s.log,setStatus:s.setStatus,setProgress:s.setProgress,setPhase:s.setPhase,tick:s.tick,onSlicePreview:s.onSlicePreview,memAlloc:s.memAlloc,memFree:s.memFree},c=await na(V,v,m,d,g,x,y,p,"solid",E,h,u,S,F,k,n.vdbColor);try{const z=V.getExtension("WEBGL_lose_context");z&&z.loseContext()}catch{}a=c.blob;const L=(v.name||v.id||"fractal").toLowerCase().replace(/\s+/g,"-"),P=new Date().toISOString().replace(/[-:T]/g,"").slice(0,12),B=n.vdbColor?"-density-color":"-density";i=L+"-"+d+B+"-"+P+".vdb",s.log("VDB: "+c.voxelCount.toLocaleString()+" active voxels, "+c.leafCount+" leaf blocks"+(c.promoted.promotedLeaves?", "+c.promoted.promotedLeaves+" tiles promoted":"")+(c.skippedSlices>0?", "+c.skippedSlices+" empty slices skipped":""),"data")}else if(e==="glb"){const v=yo(t,e);s.log("Estimated size: ~"+(v/(1024*1024)).toFixed(0)+" MB","mem"),a=Ma(t),i=o+".glb",s.setPhase("Export GLB",100)}else{const v=yo(t,e);s.log("Estimated size: ~"+(v/(1024*1024)).toFixed(0)+" MB","mem"),a=await Ta(t,m=>{s.setPhase("Export STL",m),s.setStatus("Encoding STL... "+m+"%")}),i=o+".stl"}const l=performance.now(),f=(a.size/(1024*1024)).toFixed(2);return s.memAlloc("exportBlob",e.toUpperCase()+" Blob",parseFloat(f),s.MEM_COLORS.exportBlob),s.log("Export: "+f+" MB "+e.toUpperCase()+" ("+((l-r)/1e3).toFixed(1)+"s)","success"),s.setStatus(f+" MB "+e.toUpperCase()+" ready"),s.setPhase("Export complete",100),{blob:a,filename:i}}const Aa={webgl:"#47a",coarseGrid:"#7af",sparseGrid:"#5a8",sdfGrid:"#7af",meshPos:"#f80",meshNrm:"#fa0",meshIdx:"#fc0",meshCol:"#f5a",exportBlob:"#5af"},ut="font-mono text-[13px] font-bold border-none rounded px-4 py-2 cursor-pointer transition-opacity disabled:bg-gray-800 disabled:text-gray-600 disabled:cursor-default",Ia=()=>{const e=Y(),t=Y(h=>h.isRunning),o=Y(h=>h.exportFormat),n=Y(h=>h.lastMesh),s=Y(h=>h.lastBlob),r=Y(h=>h.lastFilename),a=Y(h=>h.loadedDefinition),i=Y(h=>h.selectedFormulaId),l=Y(h=>h.customFilename),f=Y(h=>h.vdbColor),v=!!(a||Oe.get(i)),m=o==="vdb";function d(){const h=Y.getState(),S=h.loadedDefinition||Oe.get(h.selectedFormulaId),C=h.bboxSize.map(c=>c/2),N=[h.bboxCenter[0]-C[0],h.bboxCenter[1]-C[1],h.bboxCenter[2]-C[2]],k=[h.bboxCenter[0]+C[0],h.bboxCenter[1]+C[1],h.bboxCenter[2]+C[2]];let F,R;h.cavityFill==="escape"?(F="escape",R=1):(F="dilate",R=parseInt(h.cavityFill)||0);let V;h.interlaceState&&(V={definition:h.interlaceState.definition,params:h.interlaceState.params,enabled:h.interlaceState.enabled,interval:h.interlaceState.interval,startIter:h.interlaceState.startIter});const u=h.qualitySettings;return{N:h.resolution,iters:h.iters,smoothPasses:h.smoothPasses,useNewton:h.newton,newtonSteps:h.newtonSteps,smoothLambda:h.smoothLambda,definition:S,formulaParams:h.formulaParams,power:h.formulaParams.paramA||8,deType:h.deType,deSamples:h.deSamples,zSubSlices:h.zSubSlices,minFeatureSel:h.minFeature,closingRadius:h.closingRadius,colorSamples:h.colorSamples,colorJitterMul:h.colorJitter,cavityFillMode:F,cavityFillLevel:R,gridMin:N,gridMax:k,boundsRange:k[0]-N[0],interlace:V,estimator:u.estimator,distanceMetric:u.distanceMetric,surfaceThreshold:u.surfaceThreshold}}function x(){return{setStatus:h=>Y.getState().setStatus(h),setProgress:h=>Y.getState().setProgress(h),setPhase:(h,S)=>Y.getState().setPhase(h,S),log:(h,S)=>Y.getState().addLog(h,S),memAlloc:(h,S,C,N)=>Y.getState().memAlloc(h,S,C,N),memFree:h=>Y.getState().memFree(h),tick:async()=>{if(await new Promise(h=>setTimeout(h,0)),Y.getState().isCancelled)throw new Error("Cancelled")},checkCancel:()=>{if(Y.getState().isCancelled)throw new Error("Cancelled")},onSlicePreview:(h,S,C)=>{vn(h,S,C)},MEM_COLORS:Aa}}const g=async()=>{const h=Y.getState();h.setMesh(null,""),h.setExportBlob(null,""),h.setRunning(!0),h.setCancelled(!1),h.setProgress(0),h.setPhase("",0),h.clearMemory(),fo(),ho();try{const S=await Fa(d(),x()),C=Y.getState();C.setMesh(S.mesh,S.baseName),C.setTimings(S.timings,S.smoothingSkipped??!1,S.useNarrowBand),S.gl&&C.setGL(S.gl)}catch(S){const C=S;C.message!=="Cancelled"?(Y.getState().addLog("ERROR: "+C.message,"error"),Y.getState().setStatus("Error: "+C.message)):(Y.getState().addLog("Cancelled","warn"),Y.getState().setStatus("Cancelled"))}finally{Y.getState().setRunning(!1)}},y=()=>{Ln(),Bn(),Y.getState().setCancelled(!0)},p=async()=>{const h=Y.getState();h.setRunning(!0),h.setCancelled(!1),fo(),ho();try{const S=d(),C=await Pa(h.exportFormat,h.lastMesh,h.lastBaseName,{definition:S.definition,formulaParams:S.formulaParams,N:S.N,iters:S.iters,power:S.power,gridMin:S.gridMin,gridMax:S.gridMax,deSamples:S.deSamples,zSubSlices:S.zSubSlices,interlace:S.interlace,estimator:S.estimator,distanceMetric:S.distanceMetric,surfaceThreshold:S.surfaceThreshold,vdbColor:h.vdbColor},x()),N=Y.getState().customFilename.trim(),k=N?N.replace(/\.[^.]+$/,"")+"."+C.filename.split(".").pop():C.filename;Y.getState().setExportBlob(C.blob,k)}catch(S){const C=S;C.message!=="Cancelled"&&(Y.getState().addLog("Export error: "+C.message,"error"),Y.getState().setStatus("Export error: "+C.message))}finally{Y.getState().setRunning(!1)}},E=()=>{s&&r&&Ea(s,r)};return b.jsxs("div",{className:"font-mono flex flex-col gap-2 mt-1",children:[b.jsx(Te,{label:"Format",value:o,options:[{label:"GLB (Binary glTF)",value:"glb"},{label:"STL (Binary)",value:"stl"},{label:"VDB (OpenVDB)",value:"vdb"}],onChange:e.setExportFormat,fullWidth:!0}),b.jsxs("div",{className:"flex items-center gap-2",children:[b.jsx("span",{className:"text-[10px] text-gray-500 uppercase tracking-wide shrink-0",children:"Filename"}),b.jsx("input",{type:"text",value:l,onChange:h=>e.setCustomFilename(h.target.value),placeholder:((a==null?void 0:a.name)||i||"fractal").toLowerCase().replace(/\s+/g,"-"),className:"flex-1 h-[26px] bg-gray-800 border border-gray-700 rounded px-2 text-[11px] text-gray-200 font-mono placeholder:text-gray-600"}),b.jsxs("span",{className:"text-[10px] text-gray-600",children:[".",o]})]}),m&&b.jsx("div",{className:"text-[11px] text-sky-400 bg-sky-900/20 px-2 py-1 rounded",children:"VDB exports directly — no Generate needed"}),m&&b.jsxs("label",{className:"flex items-center gap-2 text-[11px] text-gray-300 cursor-pointer select-none",children:[b.jsx("input",{type:"checkbox",checked:f,onChange:h=>e.setVdbColor(h.target.checked),className:"accent-amber-500"}),"Include color grids (slower)"]}),b.jsxs("div",{className:"flex gap-2 flex-wrap",children:[!m&&b.jsxs("button",{disabled:t||!v,onClick:g,className:`${ut} bg-emerald-700 text-white hover:bg-emerald-600`,children:[b.jsx("span",{className:"bg-white/15 rounded px-1 mr-1 text-[10px]",children:"1"}),"Generate"]}),t&&b.jsx("button",{onClick:y,className:`${ut} bg-red-700 text-white hover:bg-red-600`,children:"Cancel"}),b.jsxs("button",{disabled:t||!n&&!m,onClick:p,className:`${ut} bg-amber-700 text-white hover:bg-amber-600`,children:[b.jsx("span",{className:"bg-white/15 rounded px-1 mr-1 text-[10px]",children:m?"1":"2"}),"Export"]}),b.jsxs("button",{disabled:!s,onClick:E,className:`${ut} bg-sky-700 text-white hover:bg-sky-600`,children:[b.jsx("span",{className:"bg-white/15 rounded px-1 mr-1 text-[10px]",children:m?"2":"3"}),"Download",r?` (${r})`:""]})]})]})};function Wo(e,t){return[e[0]-t[0],e[1]-t[1],e[2]-t[2]]}function xt(e,t){return[e[0]+t[0],e[1]+t[1],e[2]+t[2]]}function Gt(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]}function gt(e,t){return[e[0]*t,e[1]*t,e[2]*t]}function Ra(e,t){return[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]]}function to(e,t){const o=Math.cos(e),n=Math.sin(e),s=Math.cos(t),r=Math.sin(t),a=[o,0,-n],i=[-s*n,-r,-s*o],l=Ra(a,i);return{pos:Wo([0,0,0],gt(i,10)),fwd:i,right:a,up:l}}function wo(e,t,o,n,s,r,a){const i=to(t,o),l=a||[0,0,0],f=xt(i.pos,l),v=Wo(e,f),m=Gt(v,i.right),d=Gt(v,i.up),x=r/n;return[s*.5+m*x,r*.5-d*x,0]}function jt(e,t,o,n,s,r){const a=r/s,i=to(o,n),l=e/a,f=-t/a;return xt(gt(i.right,l),gt(i.up,f))}const ft=Math.PI*.5,So=[{angle:0,pitch:0,label:"Front (-Z)"},{angle:Math.PI,pitch:0,label:"Back (+Z)"},{angle:ft,pitch:0,label:"Right (+X)"},{angle:-ft,pitch:0,label:"Left (-X)"},{angle:0,pitch:ft,label:"Top (+Y)"},{angle:0,pitch:-ft,label:"Bottom (-Y)"}],Co=15*Math.PI/180;function Xt(e){return e=e%(2*Math.PI),e>Math.PI&&(e-=2*Math.PI),e<-Math.PI&&(e+=2*Math.PI),e}function Ut(e,t,o){const n=Xt(e);let s=null,r=1/0;for(let a=0;a<So.length;a++){const i=So[a];let l,f;Math.abs(i.pitch)>1?(l=0,f=Math.abs(t-i.pitch)):(l=Math.abs(Xt(n-i.angle)),f=Math.abs(t-i.pitch));const v=Math.sqrt(l*l+f*f);v<o&&v<r&&(r=v,s={angle:Math.abs(i.pitch)>1?n:i.angle,pitch:i.pitch,label:i.label})}return s}function Da(){return{positions:null,indices:null,normals:null,vertexCount:0,faceCount:0,rotX:-.4,rotY:.6,zoom:1,cx:0,cy:0,cz:0,scale:1,dragging:!1,lastMX:0,lastMY:0}}function Mo(e,t,o,n,s,r){e.positions=t,e.indices=o,e.vertexCount=n,e.faceCount=s;let a=1/0,i=1/0,l=1/0,f=-1/0,v=-1/0,m=-1/0;for(let d=0;d<n;d++){const x=t[d*3],g=t[d*3+1],y=t[d*3+2];x<a&&(a=x),g<i&&(i=g),y<l&&(l=y),x>f&&(f=x),g>v&&(v=g),y>m&&(m=y)}e.cx=(a+f)/2,e.cy=(i+v)/2,e.cz=(l+m)/2,e.scale=r/(Math.max(f-a,v-i,m-l)*1.15)}function dt(e,t,o,n){if(t.fillStyle="#111",t.fillRect(0,0,o,n),!e.positions||!e.indices||e.vertexCount===0)return;const s=Math.cos(e.rotX),r=Math.sin(e.rotX),a=Math.cos(e.rotY),i=Math.sin(e.rotY),l=e.scale*e.zoom,f=e.positions,v=e.cx,m=e.cy,d=e.cz;function x(E){const h=f[E*3]-v,S=f[E*3+1]-m,C=f[E*3+2]-d,N=h*a-C*i,k=h*i+C*a,F=S*s-k*r;return[N*l+o/2,n/2-F*l]}const g=15e4,y=e.faceCount>g?Math.ceil(e.faceCount/g):1;let p=0;t.strokeStyle="rgba(42,170,85,0.12)",t.lineWidth=.5,t.beginPath();for(let E=0;E<e.faceCount&&p<g;E+=y){const h=x(e.indices[E*3]),S=x(e.indices[E*3+1]),C=x(e.indices[E*3+2]);t.moveTo(h[0],h[1]),t.lineTo(S[0],S[1]),t.lineTo(C[0],C[1]),t.lineTo(h[0],h[1]),p++}t.stroke(),t.fillStyle="#888",t.font="11px monospace",t.fillText(e.vertexCount.toLocaleString()+" verts, "+e.faceCount.toLocaleString()+" faces",4,n-4),t.fillStyle="#555",t.fillText("drag to rotate, scroll to zoom",4,14)}function To(e,t,o){const n=e.createShader(t);if(e.shaderSource(n,o),e.compileShader(n),!e.getShaderParameter(n,e.COMPILE_STATUS)){const s=e.getShaderInfoLog(n)||"";throw e.deleteShader(n),new Error("Shader compile: "+s)}return n}function La(e,t,o){const n=e.createProgram();if(e.attachShader(n,To(e,e.VERTEX_SHADER,t)),e.attachShader(n,To(e,e.FRAGMENT_SHADER,o)),e.linkProgram(n),!e.getProgramParameter(n,e.LINK_STATUS)){const s=e.getProgramInfoLog(n)||"";throw e.deleteProgram(n),new Error("Program link: "+s)}return n}function _a(e,t,o){var s,r,a,i,l,f,v,m,d,x,g,y,p,E,h,S,C,N,k,F,R,V,u,c,L,P,B,z,T,j;const n=o||{};t.uParamA&&e.uniform1f(t.uParamA,n.paramA??8),t.uParamB&&e.uniform1f(t.uParamB,n.paramB??0),t.uParamC&&e.uniform1f(t.uParamC,n.paramC??0),t.uParamD&&e.uniform1f(t.uParamD,n.paramD??0),t.uParamE&&e.uniform1f(t.uParamE,n.paramE??0),t.uParamF&&e.uniform1f(t.uParamF,n.paramF??0),t.uVec2A&&e.uniform2f(t.uVec2A,((s=n.vec2A)==null?void 0:s.x)??0,((r=n.vec2A)==null?void 0:r.y)??0),t.uVec2B&&e.uniform2f(t.uVec2B,((a=n.vec2B)==null?void 0:a.x)??0,((i=n.vec2B)==null?void 0:i.y)??0),t.uVec2C&&e.uniform2f(t.uVec2C,((l=n.vec2C)==null?void 0:l.x)??0,((f=n.vec2C)==null?void 0:f.y)??0),t.uVec3A&&e.uniform3f(t.uVec3A,((v=n.vec3A)==null?void 0:v.x)??0,((m=n.vec3A)==null?void 0:m.y)??0,((d=n.vec3A)==null?void 0:d.z)??0),t.uVec3B&&e.uniform3f(t.uVec3B,((x=n.vec3B)==null?void 0:x.x)??0,((g=n.vec3B)==null?void 0:g.y)??0,((y=n.vec3B)==null?void 0:y.z)??0),t.uVec3C&&e.uniform3f(t.uVec3C,((p=n.vec3C)==null?void 0:p.x)??0,((E=n.vec3C)==null?void 0:E.y)??0,((h=n.vec3C)==null?void 0:h.z)??0),t.uVec4A&&e.uniform4f(t.uVec4A,((S=n.vec4A)==null?void 0:S.x)??0,((C=n.vec4A)==null?void 0:C.y)??0,((N=n.vec4A)==null?void 0:N.z)??0,((k=n.vec4A)==null?void 0:k.w)??0),t.uVec4B&&e.uniform4f(t.uVec4B,((F=n.vec4B)==null?void 0:F.x)??0,((R=n.vec4B)==null?void 0:R.y)??0,((V=n.vec4B)==null?void 0:V.z)??0,((u=n.vec4B)==null?void 0:u.w)??0),t.uVec4C&&e.uniform4f(t.uVec4C,((c=n.vec4C)==null?void 0:c.x)??0,((L=n.vec4C)==null?void 0:L.y)??0,((P=n.vec4C)==null?void 0:P.z)??0,((B=n.vec4C)==null?void 0:B.w)??0),t.uJulia&&e.uniform3f(t.uJulia,((z=n.julia)==null?void 0:z.x)??0,((T=n.julia)==null?void 0:T.y)??0,((j=n.julia)==null?void 0:j.z)??0),t.uJuliaMode&&e.uniform1f(t.uJuliaMode,n.juliaMode??0),t.uEscapeThresh&&e.uniform1f(t.uEscapeThresh,n.escapeThresh??4),t.uDistanceMetric&&e.uniform1f(t.uDistanceMetric,n.distanceMetric??0)}const ge=512,Ne=Math.PI*.5;function Ba(){const e=Y(u=>u.isRunning),t=Y(u=>u.lastMesh),o=Y(u=>u.loadedDefinition),n=Y(u=>u.bboxCenter),s=Y(u=>u.bboxSize),r=Y(u=>u.formulaParams),a=Y(u=>u.interlaceState),i=Y(u=>u.iters),l=Y(u=>u.qualitySettings),f=Y(u=>u.clipOutsideBounds),v=de.useRef(null),m=de.useRef(null),d=de.useRef(null),x=de.useRef(null),g=de.useRef({gl:null,prog:null,loc:{},defId:null,rawAngle:.6,rawPitch:.3,camAngle:.6,camPitch:.3,camDist:3.5,camTarget:[0,0,0],dragging:!1,dragMode:null,hover:null,lastX:0,lastY:0,shiftHeld:!1,snapped:!1,snapTarget:null,snapAnimId:0,rafId:0}),y=de.useRef(Da()),p=t?"mesh":e?"slice":"fractal",E=de.useCallback(()=>{const u=g.current,c=Y.getState(),L=c.loadedDefinition;if(!u.gl||!L)return;const P=u.gl;let B;c.interlaceState&&(B={definition:c.interlaceState.definition,params:c.interlaceState.params,enabled:c.interlaceState.enabled,interval:c.interlaceState.interval,startIter:c.interlaceState.startIter});const z=c.qualitySettings,j=qt(L)==="ifs"&&z.estimator>=1.5&&z.estimator<2.5?1:z.estimator,A=L.id+(B?"+"+B.definition.id:"")+":e"+(j??0);if(u.defId===A&&u.prog)return;u.prog&&(P.deleteProgram(u.prog),u.prog=null);try{const _=Cn({definition:L,deType:"auto",interlace:B,estimator:j});console.log("[Preview] Compiling shader for",L.id,"| estimator:",j,"| length:",_.length),u.prog=La(P,Qe,_),console.log("[Preview] Shader compiled OK for",L.id)}catch(_){console.warn("Preview shader compile failed for",L.id+":",_.message),u.prog=null,u.defId=null;return}P.useProgram(u.prog),P.bindVertexArray(P.createVertexArray()),u.loc={};const M=["uPower","uIters","uResolution","uCamPos","uCamTarget","uCamRight","uFov","uFudgeFactor","uDetail","uPixelThreshold","uClipBounds","uBoundsMin","uBoundsMax",...qe];for(const _ of M)u.loc[_]=P.getUniformLocation(u.prog,_);u.defId=A},[]),h=de.useCallback(()=>{const u=m.current;if(!u)return;const c=u.getContext("2d"),L=u.width,P=u.height;c.clearRect(0,0,L,P);const B=g.current,z=Y.getState(),[T,j,A]=z.bboxCenter,[M,_,D]=z.bboxSize,O=M*.5,w=_*.5,I=D*.5,G=q=>wo(q,B.camAngle,B.camPitch,B.camDist,ge,ge,B.camTarget),H=[];for(let q=0;q<2;q++)for(let W=0;W<2;W++)for(let te=0;te<2;te++)H.push([T+(q?O:-O),j+(W?w:-w),A+(te?I:-I)]);const X=H.map(G),$=[{color:"#f554",edges:[[0,4],[1,5],[2,6],[3,7]]},{color:"#5f54",edges:[[0,2],[1,3],[4,6],[5,7]]},{color:"#55f4",edges:[[0,1],[2,3],[4,5],[6,7]]}];for(const q of $){c.strokeStyle=q.color,c.lineWidth=1,c.setLineDash([4,3]),c.beginPath();for(const[W,te]of q.edges)c.moveTo(X[W][0],X[W][1]),c.lineTo(X[te][0],X[te][1]);c.stroke()}c.setLineDash([]);const U={"sizeX+":[T+O,j,A],"sizeX-":[T-O,j,A],"sizeY+":[T,j+w,A],"sizeY-":[T,j-w,A],"sizeZ+":[T,j,A+I],"sizeZ-":[T,j,A-I]},Z={"sizeX+":"#f55","sizeX-":"#f55","sizeY+":"#5f5","sizeY-":"#5f5","sizeZ+":"#55f","sizeZ-":"#55f"},Q=Object.keys(U);for(const q of Q){const W=G(U[q]),te=B.hover===q?7:5;c.fillStyle=Z[q],c.beginPath(),c.moveTo(W[0],W[1]-te),c.lineTo(W[0]+te,W[1]),c.lineTo(W[0],W[1]+te),c.lineTo(W[0]-te,W[1]),c.closePath(),c.fill(),B.hover===q&&(c.strokeStyle="#fff",c.lineWidth=1,c.stroke())}const ne=[T,j,A],K=G(ne),ee=B.camDist*.12,re=["#f55","#5f5","#55f"],ie=[[1,0,0],[0,1,0],[0,0,1]],le=["X","Y","Z"];for(let q=0;q<3;q++){const W=xt(ne,gt(ie[q],ee)),te=G(W),ce=te[0]-K[0],se=te[1]-K[1],J=Math.sqrt(ce*ce+se*se);if(J<2)continue;const ae=B.hover==="center";c.strokeStyle=re[q],c.lineWidth=ae?3:2,c.beginPath(),c.moveTo(K[0],K[1]),c.lineTo(te[0],te[1]),c.stroke();const fe=ce/J,pe=se/J;c.fillStyle=re[q],c.beginPath(),c.moveTo(te[0],te[1]),c.lineTo(te[0]-fe*6+pe*3,te[1]-pe*6-fe*3),c.lineTo(te[0]-fe*6-pe*3,te[1]-pe*6+fe*3),c.closePath(),c.fill(),c.font="bold 9px monospace",c.fillStyle=re[q],c.fillText(le[q],te[0]+fe*6-3,te[1]+pe*6+3)}const ve=B.hover==="center"?5:3;if(c.fillStyle=B.hover==="center"?"#fc0":"#fa0",c.beginPath(),c.arc(K[0],K[1],ve,0,Math.PI*2),c.fill(),B.hover==="center"&&(c.strokeStyle="#fff",c.lineWidth=1,c.stroke()),B.snapTarget){const q=Ut(B.snapTarget.angle,B.snapTarget.pitch,.1);q&&(c.font="bold 11px monospace",c.fillStyle="#fa0",c.textAlign="right",c.fillText(q.label,L-6,14),c.textAlign="left")}else if(B.shiftHeld){const q=Ut(B.camAngle,B.camPitch,Co);q&&(c.font="10px monospace",c.fillStyle="#888",c.textAlign="right",c.fillText("snap: "+q.label,L-6,14),c.textAlign="left")}},[]),S=de.useCallback(()=>{const u=g.current;if(!u.gl||!u.prog){console.log("[Preview] Render skipped: gl=",!!u.gl,"prog=",!!u.prog);return}const c=u.gl,L=c.canvas;c.viewport(0,0,L.width,L.height),c.useProgram(u.prog);const P=to(u.camAngle,u.camPitch),B=u.camTarget;c.uniform2f(u.loc.uResolution,L.width,L.height),c.uniform3f(u.loc.uCamPos,P.pos[0]+B[0],P.pos[1]+B[1],P.pos[2]+B[2]),c.uniform3f(u.loc.uCamTarget,B[0],B[1],B[2]),c.uniform3f(u.loc.uCamRight,P.right[0],P.right[1],P.right[2]),c.uniform1f(u.loc.uFov,u.camDist);const z=Y.getState(),T=z.formulaParams;if(c.uniform1f(u.loc.uPower,T.paramA??8),c.uniform1i(u.loc.uIters,z.iters),_a(c,u.loc,T),z.interlaceState){const A=z.interlaceState,M=A.params||{};u.loc.uInterlaceEnabled&&c.uniform1f(u.loc.uInterlaceEnabled,A.enabled?1:0),u.loc.uInterlaceInterval&&c.uniform1f(u.loc.uInterlaceInterval,A.interval??2),u.loc.uInterlaceStartIter&&c.uniform1f(u.loc.uInterlaceStartIter,A.startIter??0),u.loc.uInterlaceParamA&&c.uniform1f(u.loc.uInterlaceParamA,M.paramA??0),u.loc.uInterlaceParamB&&c.uniform1f(u.loc.uInterlaceParamB,M.paramB??0),u.loc.uInterlaceParamC&&c.uniform1f(u.loc.uInterlaceParamC,M.paramC??0),u.loc.uInterlaceParamD&&c.uniform1f(u.loc.uInterlaceParamD,M.paramD??0),u.loc.uInterlaceParamE&&c.uniform1f(u.loc.uInterlaceParamE,M.paramE??0),u.loc.uInterlaceParamF&&c.uniform1f(u.loc.uInterlaceParamF,M.paramF??0);const _=(O,w)=>{u.loc[O]&&c.uniform2f(u.loc[O],(w==null?void 0:w.x)??0,(w==null?void 0:w.y)??0)},D=(O,w)=>{u.loc[O]&&c.uniform3f(u.loc[O],(w==null?void 0:w.x)??0,(w==null?void 0:w.y)??0,(w==null?void 0:w.z)??0)};_("uInterlaceVec2A",M.vec2A),_("uInterlaceVec2B",M.vec2B),_("uInterlaceVec2C",M.vec2C),D("uInterlaceVec3A",M.vec3A),D("uInterlaceVec3B",M.vec3B),D("uInterlaceVec3C",M.vec3C)}else u.loc.uInterlaceEnabled&&c.uniform1f(u.loc.uInterlaceEnabled,0);const j=z.qualitySettings;if(u.loc.uFudgeFactor&&c.uniform1f(u.loc.uFudgeFactor,(j.fudgeFactor??1)*.75),u.loc.uDetail&&c.uniform1f(u.loc.uDetail,j.detail??1),u.loc.uPixelThreshold&&c.uniform1f(u.loc.uPixelThreshold,j.pixelThreshold??.5),u.loc.uDistanceMetric&&c.uniform1f(u.loc.uDistanceMetric,j.distanceMetric??0),u.loc.uClipBounds&&c.uniform1f(u.loc.uClipBounds,z.clipOutsideBounds?1:0),u.loc.uBoundsMin){const A=z.bboxSize.map(M=>M/2);c.uniform3f(u.loc.uBoundsMin,z.bboxCenter[0]-A[0],z.bboxCenter[1]-A[1],z.bboxCenter[2]-A[2]),c.uniform3f(u.loc.uBoundsMax,z.bboxCenter[0]+A[0],z.bboxCenter[1]+A[1],z.bboxCenter[2]+A[2])}c.drawArrays(c.TRIANGLE_STRIP,0,4),h()},[h]),C=de.useCallback(()=>{const u=g.current;u.rafId||(u.rafId=requestAnimationFrame(()=>{u.rafId=0;const c=Y.getState();(c.lastMesh?"mesh":c.isRunning?"slice":"fractal")==="fractal"&&(E(),S())}))},[E,S]),N=de.useCallback((u,c)=>{const L=g.current,P=Y.getState(),[B,z,T]=P.bboxCenter,[j,A,M]=P.bboxSize,_=j*.5,D=A*.5,O=M*.5,w=X=>wo(X,L.camAngle,L.camPitch,L.camDist,ge,ge,L.camTarget),I=8,G=w([B,z,T]);if(Math.abs(u-G[0])<I&&Math.abs(c-G[1])<I)return"center";const H=[["sizeX+",[B+_,z,T]],["sizeX-",[B-_,z,T]],["sizeY+",[B,z+D,T]],["sizeY-",[B,z-D,T]],["sizeZ+",[B,z,T+O]],["sizeZ-",[B,z,T-O]]];for(const[X,$]of H){const U=w($);if(Math.abs(u-U[0])<I&&Math.abs(c-U[1])<I)return X}return null},[]),k=de.useCallback(()=>{const u=g.current;if(u.shiftHeld){const c=Ut(u.rawAngle,u.rawPitch,Co);if(c){if(u.snapped=!0,u.snapTarget=c,!u.snapAnimId){const L=()=>{if(u.snapAnimId=0,!u.snapTarget)return;const P=Xt(u.snapTarget.angle-u.camAngle),B=u.snapTarget.pitch-u.camPitch;if(Math.sqrt(P*P+B*B)<.002){u.camAngle=u.snapTarget.angle,u.camPitch=u.snapTarget.pitch,C(),u.snapped&&(u.snapAnimId=requestAnimationFrame(L));return}u.camAngle+=P*.2,u.camPitch+=B*.2,C(),u.snapAnimId=requestAnimationFrame(L)};u.snapAnimId=requestAnimationFrame(L)}return}}u.snapped=!1,u.snapTarget=null,u.snapAnimId&&(cancelAnimationFrame(u.snapAnimId),u.snapAnimId=0),u.camAngle=u.rawAngle,u.camPitch=u.rawPitch},[C]);de.useEffect(()=>{const u=v.current;if(!u)return;const c=g.current;return c.gl=u.getContext("webgl2",{antialias:!1,preserveDrawingBuffer:!0}),c.gl||console.warn("Preview: WebGL2 not available"),()=>{c.prog&&c.gl&&c.gl.deleteProgram(c.prog),c.prog=null,c.defId=null}},[]),de.useEffect(()=>{const u=d.current;if(!u)return;const c=u.getContext("2d");if(c)return hn((L,P,B)=>{const z=document.createElement("canvas");z.width=P,z.height=B,z.getContext("2d").putImageData(L,0,0),c.clearRect(0,0,ge,ge),c.imageSmoothingEnabled=!1,c.drawImage(z,0,0,ge,ge)}),()=>{pn()}},[]),de.useEffect(()=>{if(p!=="fractal")return;const u=g.current,L=Y.getState().interlaceState,P=((o==null?void 0:o.id)??"")+(L?"+"+L.definition.id:"");o&&u.defId!==P&&(u.defId=null),C()},[o,a,p,C]),de.useEffect(()=>{p==="fractal"&&C()},[r,a,i,n,s,f,l,p,C]),de.useEffect(()=>{if(!t)return;const u=x.current;if(!u)return;const c=u.getContext("2d");if(!c)return;const L=y.current;Mo(L,t.positions,t.indices,t.vertexCount,t.faceCount,u.width),dt(L,c,u.width,u.height)},[t]),de.useEffect(()=>{const u=m.current;if(!u)return;const c=g.current,L=M=>{const _=u.getBoundingClientRect(),D=M.clientX-_.left,O=M.clientY-_.top;if(c.lastX=M.clientX,c.lastY=M.clientY,M.button===1||M.button===2){c.dragMode="pan",c.dragging=!0,u.style.cursor="all-scroll",M.preventDefault();return}const w=N(D,O);c.dragMode=w||"orbit",c.dragging=!0,u.style.cursor=c.dragMode==="orbit"?"grabbing":"ew-resize",M.preventDefault()},P=M=>{M.preventDefault()},B=M=>{if(!c.dragging){const O=u.getBoundingClientRect(),w=M.clientX-O.left,I=M.clientY-O.top,G=c.hover;c.hover=N(w,I),u.style.cursor=c.hover?c.hover==="center"?"move":"ew-resize":"grab",c.hover!==G&&C();return}const _=M.clientX-c.lastX,D=M.clientY-c.lastY;if(c.lastX=M.clientX,c.lastY=M.clientY,c.dragMode==="pan"){const O=jt(-_,-D,c.camAngle,c.camPitch,c.camDist,ge);c.camTarget=xt(c.camTarget,O),C()}else if(c.dragMode==="orbit")c.rawAngle+=_*.008,c.rawPitch=Math.max(-Ne,Math.min(Ne,c.rawPitch+D*.008)),k(),C();else if(c.dragMode==="center"){const O=jt(_,D,c.camAngle,c.camPitch,c.camDist,ge),w=Y.getState(),[I,G,H]=w.bboxCenter;w.setBboxCenter([I+O[0],G+O[1],H+O[2]]),C()}else if(c.dragMode){const O=c.dragMode.charAt(4),w=c.dragMode.charAt(5)==="+"?1:-1,I=O==="X"?[1,0,0]:O==="Y"?[0,1,0]:[0,0,1],G=jt(_,D,c.camAngle,c.camPitch,c.camDist,ge),H=Gt(G,I)*w,X=O==="X"?0:O==="Y"?1:2,$=Y.getState(),U=[...$.bboxSize],Z=[...$.bboxCenter],Q=Math.max(.1,U[X]+H*2),ne=Q-U[X];$.bboxLock?$.setBboxSize([Q,Q,Q]):(U[X]=Q,Z[X]+=ne*.5*w,$.setBboxSize(U),$.setBboxCenter(Z)),C()}},z=()=>{c.dragging=!1,c.dragMode=null,u.style.cursor=c.hover?c.hover==="center"?"move":"ew-resize":"grab"},T=M=>{M.preventDefault(),c.camDist=Math.max(.5,Math.min(20,c.camDist*(1+M.deltaY*.001))),C()},j=M=>{M.key==="Shift"&&!c.shiftHeld&&(c.shiftHeld=!0,k(),C())},A=M=>{M.key==="Shift"&&(c.shiftHeld=!1,k(),C())};return u.addEventListener("mousedown",L),window.addEventListener("mousemove",B),window.addEventListener("mouseup",z),u.addEventListener("wheel",T,{passive:!1}),u.addEventListener("contextmenu",P),window.addEventListener("keydown",j),window.addEventListener("keyup",A),()=>{u.removeEventListener("mousedown",L),window.removeEventListener("mousemove",B),window.removeEventListener("mouseup",z),u.removeEventListener("wheel",T),u.removeEventListener("contextmenu",P),window.removeEventListener("keydown",j),window.removeEventListener("keyup",A)}},[N,k,C]),de.useEffect(()=>{const u=x.current;if(!u)return;const c=y.current;let L=null;const P=()=>{const M=u.getContext("2d");M&&dt(c,M,u.width,u.height)},B=M=>{c.dragging=!0,c.lastMX=M.clientX,c.lastMY=M.clientY,L=M.button===1||M.button===2?"pan":"orbit"},z=()=>{c.dragging=!1,L=null},T=M=>{if(!c.dragging||!c.positions)return;const _=M.clientX-c.lastMX,D=M.clientY-c.lastMY;if(c.lastMX=M.clientX,c.lastMY=M.clientY,L==="pan"){const O=1/(c.scale*c.zoom);c.cx-=_*O,c.cy+=D*O,P()}else c.rotY+=_*.01,c.rotX+=D*.01,c.rotX=Math.max(-Ne,Math.min(Ne,c.rotX)),P()},j=M=>{M.preventDefault(),c.zoom*=M.deltaY>0?.9:1.1,c.zoom=Math.max(.1,Math.min(10,c.zoom)),c.positions&&P()},A=M=>{M.preventDefault()};return u.addEventListener("mousedown",B),window.addEventListener("mouseup",z),window.addEventListener("mousemove",T),u.addEventListener("wheel",j,{passive:!1}),u.addEventListener("contextmenu",A),()=>{u.removeEventListener("mousedown",B),window.removeEventListener("mouseup",z),window.removeEventListener("mousemove",T),u.removeEventListener("wheel",j),u.removeEventListener("contextmenu",A)}},[]);const F=de.useCallback((u,c,L)=>{const P=g.current;P.rawAngle=u,P.rawPitch=c,P.camAngle=u,P.camPitch=c,P.snapped=!1,P.snapTarget=null,P.snapAnimId&&(cancelAnimationFrame(P.snapAnimId),P.snapAnimId=0);const B=y.current;if(B.rotX=-c,B.rotY=u,B.positions){const z=x.current;if(z){const T=z.getContext("2d");T&&dt(B,T,z.width,z.height)}}C()},[C]),R=de.useCallback(()=>{const u=g.current;u.camTarget=[0,0,0];const c=y.current;if(c.positions){Mo(c,c.positions,c.indices,c.vertexCount,c.faceCount,ge);const L=x.current;if(L){const P=L.getContext("2d");P&&dt(c,P,L.width,L.height)}}C()},[C]),V=[{label:"F",title:"Front (-Z)",angle:0,pitch:0},{label:"B",title:"Back (+Z)",angle:Math.PI,pitch:0},{label:"L",title:"Left (-X)",angle:-Ne,pitch:0},{label:"R",title:"Right (+X)",angle:Ne,pitch:0},{label:"T",title:"Top (+Y)",angle:0,pitch:Ne},{label:"D",title:"Bottom (-Y)",angle:0,pitch:-Ne}];return b.jsxs("div",{className:"relative",style:{width:ge,height:ge},children:[b.jsx("canvas",{ref:v,width:ge,height:ge,className:"border border-white/10 rounded-sm",style:{imageRendering:"pixelated",display:p==="fractal"?"block":"none"}}),b.jsx("canvas",{ref:m,width:ge,height:ge,style:{position:"absolute",top:0,left:0,cursor:"grab",display:p==="fractal"?"block":"none"}}),b.jsx("canvas",{ref:d,width:ge,height:ge,className:"border border-white/10 rounded-sm",style:{imageRendering:"pixelated",display:p==="slice"?"block":"none"}}),b.jsx("canvas",{ref:x,width:ge,height:ge,className:"border border-white/10 rounded-sm",style:{cursor:"grab",display:p==="mesh"?"block":"none"}}),b.jsxs("div",{className:"absolute top-2 left-2 text-[10px] text-gray-500 uppercase tracking-wider pointer-events-none",children:[p==="fractal"&&"SDF Preview",p==="slice"&&"Sampling...",p==="mesh"&&"Mesh Preview"]}),p!=="slice"&&b.jsxs("div",{className:"absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-0.5 bg-black/70 backdrop-blur rounded px-1 py-0.5 pointer-events-auto",children:[V.map(u=>b.jsx("button",{title:u.title,onClick:()=>F(u.angle,u.pitch,u.label),className:"w-[22px] h-[20px] text-[10px] font-bold text-gray-400 hover:text-white hover:bg-white/10 rounded transition-colors",children:u.label},u.label)),b.jsx("div",{className:"w-px h-3 bg-gray-700 mx-0.5"}),b.jsx("button",{title:"Reset pan (re-center view)",onClick:R,className:"w-[22px] h-[20px] text-[10px] font-bold text-gray-400 hover:text-white hover:bg-white/10 rounded transition-colors",children:"C"})]}),p==="fractal"&&b.jsxs("label",{className:"absolute top-2 right-2 flex items-center gap-1 bg-black/70 backdrop-blur rounded px-1.5 py-0.5 cursor-pointer pointer-events-auto select-none",children:[b.jsx("input",{type:"checkbox",checked:f,onChange:u=>Y.getState().setClipOutsideBounds(u.target.checked),className:"accent-amber-500 w-3 h-3"}),b.jsx("span",{className:"text-[9px] text-gray-400",children:"Clip bounds"})]}),p!=="slice"&&b.jsx("div",{className:"absolute bottom-8 left-1/2 -translate-x-1/2 text-[9px] text-gray-600 pointer-events-none whitespace-nowrap",children:"LMB orbit · RMB pan · Scroll zoom · Shift snap"})]})}function za(){const e=Y(),t=Y(o=>o.interlaceState);return t?b.jsxs("div",{className:"flex flex-col gap-1.5 border border-purple-700/40 rounded px-2 py-1.5 bg-purple-900/10 mt-1",children:[b.jsxs("div",{className:"text-[11px] text-purple-300 font-bold flex items-center justify-between",children:[b.jsxs("span",{children:["Interlace: ",t.definition.name]}),b.jsxs("label",{className:"flex items-center gap-1 cursor-pointer",children:[b.jsx("input",{type:"checkbox",checked:t.enabled,onChange:o=>e.setInterlaceState({...t,enabled:o.target.checked})}),b.jsx("span",{className:"text-[10px] text-purple-400",children:"enabled"})]})]}),b.jsxs("div",{className:"flex gap-3 text-[11px] text-gray-400",children:[b.jsxs("label",{className:"flex items-center gap-1",children:["Interval",b.jsx("input",{type:"number",min:1,max:16,step:1,value:t.interval,onChange:o=>e.setInterlaceState({...t,interval:Math.max(1,parseInt(o.target.value)||1)}),className:"w-12 bg-gray-800 border border-gray-700 rounded px-1 text-gray-200 text-center"})]}),b.jsxs("label",{className:"flex items-center gap-1",children:["Start iter",b.jsx("input",{type:"number",min:0,max:64,step:1,value:t.startIter,onChange:o=>e.setInterlaceState({...t,startIter:Math.max(0,parseInt(o.target.value)||0)}),className:"w-12 bg-gray-800 border border-gray-700 rounded px-1 text-gray-200 text-center"})]})]}),b.jsx(Io,{definition:t.definition,params:t.params,onUpdate:(o,n)=>e.setInterlaceState({...t,params:{...t.params,[o]:n}})})]}):null}function ka(){const e=Ce.useRef(null),t=Ce.useRef(null),o=Ce.useRef(0),n=Ce.useRef(!1),s=Ce.useCallback(()=>{n.current=!0,clearTimeout(o.current);const a=e.current,i=t.current;i.style.transition="none",i.style.transform="scale(1)",a.offsetHeight,a.style.transition="max-height 0.35s ease-out",a.style.maxHeight="200px"},[]),r=Ce.useCallback(()=>{n.current=!1;const a=e.current,i=t.current;i.style.transition="transform 0.3s ease-in",i.style.transform="scale(0) translateY(0)",i.style.transformOrigin="bottom center",o.current=window.setTimeout(()=>{n.current||(a.style.transition="none",a.style.maxHeight="0")},310)},[]);return b.jsxs("div",{className:"fixed bottom-5 right-5 z-50 inline-flex flex-col items-stretch",onMouseEnter:s,onMouseLeave:r,children:[b.jsx("div",{ref:e,className:"overflow-hidden",style:{maxHeight:0},children:b.jsx("img",{ref:t,src:"guy.png",alt:"",className:"pointer-events-none object-contain block w-full",style:{transform:"scale(0)",transformOrigin:"bottom center"}})}),b.jsx("a",{href:"https://ko-fi.com/gmtfractals",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 px-3 py-1 rounded bg-[#13C3FF] hover:bg-[#00b0f0] text-white text-[11px] font-bold transition-colors",children:"Support GMT"})]})}function Oa(){const e=Y(o=>o.iters),t=Y(o=>o.setIters);return b.jsxs("div",{className:"font-mono bg-[#080808] text-gray-200 h-screen flex flex-col overflow-hidden",children:[b.jsx("h1",{className:"text-sm font-bold text-white tracking-wide px-5 pt-4 pb-2 shrink-0",children:"GMT — Fractal Mesh Export"}),b.jsxs("div",{className:"flex gap-4 flex-1 min-h-0 px-5 pb-4",children:[b.jsxs("div",{className:"flex flex-col gap-2.5 w-[340px] shrink-0 overflow-y-auto pr-1",children:[b.jsx("div",{className:"bg-black/60 border border-white/10 rounded p-3",children:b.jsx(tt,{label:"Export",defaultOpen:!0,children:b.jsx(Ia,{})})}),b.jsx("div",{className:"bg-black/60 border border-white/10 rounded p-3",children:b.jsx(bn,{})}),b.jsx("div",{className:"bg-black/60 border border-white/10 rounded p-3",children:b.jsx(tt,{label:"Bounds",defaultOpen:!0,children:b.jsx(la,{})})})]}),b.jsxs("div",{className:"flex flex-col gap-2.5 flex-1 min-w-0 items-center",children:[b.jsx(Ba,{}),b.jsx(ca,{})]}),b.jsxs("div",{className:"flex flex-col gap-2.5 w-[300px] shrink-0 overflow-y-auto pl-1",children:[b.jsx("div",{className:"bg-black/60 border border-white/10 rounded p-3",children:b.jsx(tt,{label:"Formula",defaultOpen:!0,children:b.jsxs("div",{className:"flex flex-col gap-2 mt-1",children:[b.jsx(gn,{}),b.jsx(Ie,{label:"Iterations",value:e,onChange:t,min:2,max:64,step:1,variant:"full"})]})})}),b.jsx("div",{className:"bg-black/60 border border-white/10 rounded p-3",children:b.jsx(tt,{label:"Parameters",defaultOpen:!0,children:b.jsxs("div",{className:"flex flex-col gap-1 mt-1",children:[b.jsx(Io,{}),b.jsx(za,{})]})})})]})]}),b.jsx(ka,{})]})}function ja(){const e=de.useRef(!1);return de.useEffect(()=>{if(e.current)return;e.current=!0;try{const o=localStorage.getItem("gmt-mesh-export-scene");if(o){localStorage.removeItem("gmt-mesh-export-scene"),Ao(o,"(from main app)");return}}catch(o){console.warn("[MeshExport] Auto-load from main app failed:",o)}const t=Y.getState();if(!t.loadedDefinition){const o=Oe.get(t.selectedFormulaId);o&&(t.setLoadedDefinition(o),t.setFormulaParams(Po(o)))}},[]),b.jsx(Oa,{})}const Zo=document.getElementById("root");if(!Zo)throw new Error("Could not find root element to mount to");const Ua=sn.createRoot(Zo);Ua.render(b.jsx(Ce.StrictMode,{children:b.jsx(ja,{})}));
