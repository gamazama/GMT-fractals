var ye=Object.defineProperty;var be=(e,a,t)=>a in e?ye(e,a,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[a]=t;var O=(e,a,t)=>be(e,typeof a!="symbol"?a+"":a,t);import{D as R,b2 as M,U as S,a2 as u,f as c,b3 as ve,b4 as xe,b5 as ze,b6 as Se,b7 as we,b8 as _e}from"./CollapsibleSection-dTXB12Gn.js";import{n as w,d as j,p as Fe,q as Me,r as q,s as Z,c as m,l as V}from"./three-DQWx7qFd.js";const X=`
...
`,r+=`    float ${g}_d = ${T}_d;
`,r+=`    float ${g}_dr = ${T}_dr;
`,n.enabled){const F=p.get(n.type);if(F){const $=n.condition&&n.condition.active;let H="    ";if($){const A=s<M?`uModularParams[${s++}]`:"2.0",ge=s<M?`uModularParams[${s++}]`:"0.0";r+=`    { int ${g}_cmod = max(1, int(${A})); int ${g}_crem = int(${ge});
`,r+=`    if ( (i - (i/${g}_cmod)*${g}_cmod) == ${g}_crem ) {
`,H="        "}const he=A=>n.bindings&&n.bindings[A]?`u${n.bindings[A]}`:s<M?`uModularParams[${s++}]`:"0.0";r+=F.glsl({varName:g,in1:T,in2:me,getParam:he,indent:H}),$&&(r+=`    }}
`)}}r+=`
