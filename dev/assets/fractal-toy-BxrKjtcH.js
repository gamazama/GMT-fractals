var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,o as D,q as j,u as m,t as p,v as g,w as $,S as B,E as O,D as k,l as N,P as V,n as G,T as H,G as q,c as X,x as Y,r as W,y as Q}from"./ui-BCzb-_pD.js";import{r as v,j as l,R as Z}from"./three-fiber-OZZ-CFAc.js";import{m as S,u as w,v as R,a as K,T as J,V as ee,i as te,b as ae,c as oe,d as ie,e as re,f as ne,g as se}from"./Camera-lxNz6s33.js";import{c as le}from"./three-drei-TKsZgtGL.js";import{C as ce}from"./CompilingIndicator-Cj6MLq8w.js";import{r as fe}from"./cameraKeyRegistry-DPlaVrE0.js";import"./three-CAXFefdI.js";import"./pako-DwGzBETv.js";const u=new Map,A=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),D(t.name)||j({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},me=`
