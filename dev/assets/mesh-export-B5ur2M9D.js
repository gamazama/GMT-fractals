...
`;function Xt(e){if(e.shader.getDist)return"custom";const t=e.shader.function+" "+e.shader.loopBody+" "+(e.shader.preamble||"");return/boxFold|sphereFold/.test(t)||/dr\s*=\s*dr\s*\*\s*\w/.test(t)&&!/pow\s*\(/.test(t)||/abs\s*\(\s*z/.test(t)&&/dr\s*[\*=]/.test(t)&&!/pow\s*\(/.test(t)?"ifs":"power"}function Fo(e){return e.deType!=="auto"?e.deType:Xt(e.definition)}function Po(e){return e.shader.getDist?`
...
`)}if(e!=="ifs")return`if (r > 2.0) { ${s} }
    ...
    if (r > 2.0) { ${to(0)} }
    return -1.0;`:`return (r - 1.0) / safeDr - ${o};`}function wt(){const{scalars:e,vec2s:t,vec3s:o,vec4s:n}=tt;return`
...
`}function St(e){const t=e.definition;let o="";t.shader.preamble&&(o=on(t.shader.preamble,t.id,t.shader.preambleVars));const n=nn(t.shader.function,t.id,t.shader.preambleVars);let s="";return t.shader.loopInit&&(s=wo(t.shader.loopInit,t.id,t.shader.preambleVars)),{preamble:o,func:n,loopInit:s}}function Ct(e,t,o){let n="",s="";if(o){const a=an(o.definition.shader.loopBody,o.definition.id);let r="";o.definition.shader.loopInit&&(r=wo(o.definition.shader.loopInit,o.definition.id,o.definition.shader.preambleVars));const l=!!o.definition.shader.usesSharedRotation;({preLoop:n,inLoop:s}=sn(a,r,l))}const i=o?`if (!skipMainFormula) { ${e.shader.loopBody} }`:e.shader.loopBody;return`  vec4 z = vec4(pos, 0.0);
...
}`;function pn(e){const t=e.definition,o=e.interlace,n=o?St(o):null;return`#version 300 es
...
}`}function vn(e){const t=e.definition,o=Fo(e),n=e.interlace,s=n?St(n):null,i=Po(t),a=Ao(o,!!t.shader.getDist,"uVoxelSize * 0.5",e.estimator);return`#version 300 es
precision highp float;
...
}`}function Io(e){const t=e.definition,o=e.interlace,n=o?St(o):null;return`#version 300 es
...
}`}function xn(e){const t=e.definition,o=Fo(e),n=e.interlace,s=n?St(n):null,i=Po(t),a=o==="ifs"?"0.0":"0.001",r=Ao(o,!!t.shader.getDist,a,e.estimator);return`#version 300 es
...
`)}),e+=`
in vec2 vUv;
`,e},Sn=wn(),oo=(e,t="",o,n="",s="",i="",a="",r="",l="",m="",v="",d="",f="")=>{const x=i.includes("skipMainFormula");return`
${o}
...
`}),t}buildUniformsString(){let t=Sn+`
...
`;if(this.variant==="Histogram"){const y=Bt(!1,!1,this.precisionMode,0,"",""),S=no("Direct");return`
${t}
${o}
${l}
${ut}
...
`)),p=no(this.renderMode),E=Tn(this.postProcessLogic.join(`
`)),h=[["Defines",t],["Uniforms",o],["Headers",n],["Math",l],["BlueNoise",ut],["Coloring",ct],["Preambles",s],["Formulas",i],["DE",m],["PostDE",a],["MatEval",v],["MissHandler",d],["Ray",p],["Trace",x],["TraceLean",g],["Integrators",r],["Post",E],["Main",M]];return h.filter(([,y])=>y.length>0).map(([y,S])=>`${y}: ${(S.length/1024).toFixed(1)}kb`).join(" | "),h.reduce((y,[,S])=>y+S.length,0),`
${t}
${o}
${n}
${l}
...
${E}
${M}
`}}class Pn{static generateFragmentShader(t){return this.buildShader(t,"Main")}static generatePhysicsShader(t){return this.buildShader(t,"Physics")}static generateHistogramShader(t){return this.buildShader(t,"Histogram")}static generateMeshSDFLibrary(t){return this.buildShader(t,"Mesh")}static buildShader(t,o){const n=new Fn(o),s=t.lighting,a=(s==null?void 0:s.ptEnabled)!==!1&&(t.renderMode==="PathTracing"||(s==null?void 0:s.renderMode)===1);n.setRenderMode(a?"PathTracing":"Direct");const r=t.quality||{};return n.setQuality(r.precisionMode===1,r.precisionMode??0),yo.getAll().forEach(m=>{m.inject&&m.inject(n,t,o)}),n.buildFragment()}}class ht{constructor(t=65536){ae(this,"data");ae(this,"length");this.data=new Float32Array(t),this.length=0}push3(t,o,n){if(this.length+3>this.data.length){const s=this.data.length*2,i=new Float32Array(s);i.set(this.data),this.data=i}this.data[this.length++]=t,this.data[this.length++]=o,this.data[this.length++]=n}trim(){return this.data.subarray(0,this.length)}}class Lo{constructor(t=65536){ae(this,"data");ae(this,"length");this.data=new Uint32Array(t),this.length=0}push3(t,o,n){if(this.length+3>this.data.length){const s=this.data.length*2,i=new Uint32Array(s);i.set(this.data),this.data=i}this.data[this.length++]=t,this.data[this.length++]=o,this.data[this.length++]=n}trim(){return this.data.subarray(0,this.length)}}function Ue(e,t,o,n,s){return o=o|0,n=n|0,s=s|0,o=o<0?0:o>=t?t-1:o,n=n<0?0:n>=t?t-1:n,s=s<0?0:s>=t?t-1:s,e[(s*t+n)*t+o]}function Xe(e,t,o,n,s){const i=Math.floor(o),a=Math.floor(n),r=Math.floor(s),l=o-i,m=n-a,v=s-r,d=Ue(e,t,i,a,r),f=Ue(e,t,i+1,a,r),x=Ue(e,t,i,a+1,r),g=Ue(e,t,i+1,a+1,r),M=Ue(e,t,i,a,r+1),p=Ue(e,t,i+1,a,r+1),E=Ue(e,t,i,a+1,r+1),h=Ue(e,t,i+1,a+1,r+1),y=d*(1-l)+f*l,S=x*(1-l)+g*l,V=M*(1-l)+p*l,k=E*(1-l)+h*l,R=y*(1-m)+S*m,D=V*(1-m)+k*m;return R*(1-v)+D*v}function ao(e,t,o,n,s){const a=Xe(e,t,o+.5,n,s)-Xe(e,t,o-.5,n,s),r=Xe(e,t,o,n+.5,s)-Xe(e,t,o,n-.5,s),l=Xe(e,t,o,n,s+.5)-Xe(e,t,o,n,s-.5),m=Math.sqrt(a*a+r*r+l*l);if(m<1e-10)return[0,1,0];const v=1/m;return[a*v,r*v,l*v]}function ye(e,t,o,n){return o+e/(t-1)*(n-o)}function qe(e,t,o,n){return(e-o)/(n-o)*(t-1)}const pt=[[0,1],[2,3],[4,5],[6,7],[0,2],[1,3],[4,6],[5,7],[0,4],[1,5],[2,6],[3,7]];function _o(e,t,o){if(e.length===0)return null;let n=0,s=0,i=0;for(let D=0;D<e.length;D++)n+=e[D].point[0],s+=e[D].point[1],i+=e[D].point[2];const a=1/e.length;n*=a,s*=a,i*=a;let r=0,l=0,m=0,v=0,d=0,f=0,x=0,g=0,M=0;for(let D=0;D<e.length;D++){const N=e[D].normal,u=e[D].point,c=N[0]*u[0]+N[1]*u[1]+N[2]*u[2];r+=N[0]*N[0],l+=N[0]*N[1],m+=N[0]*N[2],v+=N[1]*N[1],d+=N[1]*N[2],f+=N[2]*N[2],x+=N[0]*c,g+=N[1]*c,M+=N[2]*c}const p=.01;r+=p,v+=p,f+=p,x+=p*n,g+=p*s,M+=p*i;const E=r*(v*f-d*d)-l*(l*f-d*m)+m*(l*d-v*m);let h,y,S;if(Math.abs(E)<1e-6)h=n,y=s,S=i;else{const D=1/E;h=D*(x*(v*f-d*d)-l*(g*f-d*M)+m*(g*d-v*M)),y=D*(r*(g*f-d*M)-x*(l*f-d*m)+m*(l*M-g*m)),S=D*(r*(v*M-g*d)-l*(l*M-g*m)+x*(l*d-v*m))}const V=(o[0]-t[0])*.1,k=(o[1]-t[1])*.1,R=(o[2]-t[2])*.1;return h=Math.max(t[0]-V,Math.min(o[0]+V,h)),y=Math.max(t[1]-k,Math.min(o[1]+k,y)),S=Math.max(t[2]-R,Math.min(o[2]+R,S)),[h,y,S]}let Ht=!1;function An(){Ht=!0}function so(){Ht=!1}function ro(){return new Promise(e=>setTimeout(e,0)).then(()=>{if(Ht)throw new Error("CANCELLED")})}async function In(e,t,o,n,s,i=()=>{}){const a=t-1;i("contouring",0);const r=new Map,l=new ht(8192),m=new ht(8192);let v=0;for(let k=0;k<a;k++){k&7||(i("contouring",Math.round(40*k/a)),await ro());for(let R=0;R<a;R++)for(let D=0;D<a;D++){const N=e[(k*t+R)*t+D],u=N>=0,c=[N,e[(k*t+R)*t+D+1],e[(k*t+(R+1))*t+D],e[(k*t+(R+1))*t+D+1],e[((k+1)*t+R)*t+D],e[((k+1)*t+R)*t+D+1],e[((k+1)*t+(R+1))*t+D],e[((k+1)*t+(R+1))*t+D+1]];let _=!1;for(let C=1;C<8;C++)if(c[C]>=0!==u){_=!0;break}if(!_)continue;const P=[];for(let C=0;C<12;C++){const L=pt[C],A=c[L[0]],O=c[L[1]];if(A>=0==O>=0)continue;const w=D+(L[0]&1),F=R+(L[0]>>1&1),G=k+(L[0]>>2&1),H=D+(L[1]&1),X=R+(L[1]>>1&1),$=k+(L[1]>>2&1);let j=w,Z=F,oe=G,ne=H,W=X,re=$,le=A;for(let se=0;se<8;se++){const K=(j+ne)*.5,ee=(Z+W)*.5,Q=(oe+re)*.5,te=Xe(e,t,K,ee,Q);te>=0==le>=0?(j=K,Z=ee,oe=Q,le=te):(ne=K,W=ee,re=Q)}const ie=(j+ne)*.5,ce=(Z+W)*.5,J=(oe+re)*.5,q=ao(e,t,ie,ce,J);P.push({point:[ye(ie,t,o[0],n[0]),ye(ce,t,o[1],n[1]),ye(J,t,o[2],n[2])],normal:q})}if(P.length===0)continue;const B=[ye(D,t,o[0],n[0]),ye(R,t,o[1],n[1]),ye(k,t,o[2],n[2])],z=[ye(D+1,t,o[0],n[0]),ye(R+1,t,o[1],n[1]),ye(k+1,t,o[2],n[2])],T=_o(P,B,z);if(!T)continue;const U=ao(e,t,qe(T[0],t,o[0],n[0]),qe(T[1],t,o[1],n[1]),qe(T[2],t,o[2],n[2])),I=(k*a+R)*a+D;r.set(I,v),l.push3(T[0],T[1],T[2]),m.push3(U[0],U[1],U[2]),v++}}if(i("contouring",50),console.log("DC: "+v+" vertices from "+r.size+" cells"),v===0)return{positions:new Float32Array(0),normals:new Float32Array(0),indices:new Uint32Array(0),vertexCount:0,faceCount:0};const d=new Lo(8192),f=new Set;let x=0,g=0,M=0;const p=r.size,E=Array.from(r.entries());for(let k=0;k<E.length;k++){E[k][1];const R=E[k][0];M++;const D=R%a,N=(R/a|0)%a,u=R/(a*a)|0;for(let c=0;c<12;c++){const _=pt[c],P=D+(_[0]&1),B=N+(_[0]>>1&1),z=u+(_[0]>>2&1),T=D+(_[1]&1),U=N+(_[1]>>1&1),I=u+(_[1]>>2&1),C=e[(z*t+B)*t+P],L=e[(I*t+U)*t+T];if(C>=0==L>=0)continue;let A;const O=Math.min(P,T),w=Math.min(B,U),F=Math.min(z,I);P!==T?A=0:B!==U?A=1:A=2;const G=(F*t+w)*t*4+O*4+A;if(f.has(G))continue;f.add(G),x++;const H=(A+1)%3,X=(A+2)%3,$=[O,w,F],j=[-1,-1,-1,-1];let Z=!0;for(let ne=0;ne<4;ne++){const W=[$[0],$[1],$[2]];if(W[H]-=ne&1?0:1,W[X]-=ne&2?0:1,W[0]<0||W[1]<0||W[2]<0||W[0]>=a||W[1]>=a||W[2]>=a){Z=!1;break}const re=(W[2]*a+W[1])*a+W[0],le=r.get(re);if(le===void 0){Z=!1;break}j[ne]=le}if(!Z){g++;continue}const oe=C>=0;j[0]!==j[1]&&j[0]!==j[3]&&j[1]!==j[3]&&(oe?d.push3(j[0],j[3],j[1]):d.push3(j[0],j[1],j[3])),j[0]!==j[2]&&j[0]!==j[3]&&j[2]!==j[3]&&(oe?d.push3(j[0],j[2],j[3]):d.push3(j[0],j[3],j[2]))}M&4095||(i("contouring",50+Math.round(50*M/p)),await ro())}i("contouring",100),console.log("DC: "+x+" sign-change edges, "+g+" dropped (boundary), "+d.length/3+" faces");const h=l.trim(),y=m.trim(),S=d.trim(),V=Math.floor(d.length/3);return{positions:h,normals:y,indices:S,vertexCount:v,faceCount:V}}let Yt=!1;function Rn(){Yt=!0}function io(){Yt=!1}function zt(){return new Promise(e=>setTimeout(e,0)).then(()=>{if(Yt)throw new Error("CANCELLED")})}class Dn{constructor(t,o=8,n=1){ae(this,"N");ae(this,"blockSize");ae(this,"defaultValue");ae(this,"blocksPerAxis");ae(this,"blockCellCount");ae(this,"blocks");ae(this,"allocatedCount");this.N=t,this.blockSize=o,this.defaultValue=n,this.blocksPerAxis=Math.ceil(t/o),this.blockCellCount=o*o*o,this.blocks=new Map,this.allocatedCount=0}blockKey(t,o,n){return(n*this.blocksPerAxis+o)*this.blocksPerAxis+t}allocateBlock(t,o,n){const s=this.blockKey(t,o,n);if(!this.blocks.has(s)){const i=new Float32Array(this.blockCellCount);i.fill(this.defaultValue),this.blocks.set(s,i),this.allocatedCount++}return this.blocks.get(s)}hasBlock(t,o,n){return this.blocks.has(this.blockKey(t,o,n))}set(t,o,n,s){const i=this.blockSize,a=t/i|0,r=o/i|0,l=n/i|0,m=this.allocateBlock(a,r,l),v=t-a*i,d=o-r*i,f=n-l*i;m[(f*i+d)*i+v]=s}get(t,o,n){if(t<0||o<0||n<0||t>=this.N||o>=this.N||n>=this.N)return this.defaultValue;const s=this.blockSize,i=t/s|0,a=o/s|0,r=n/s|0,l=this.blockKey(i,a,r),m=this.blocks.get(l);if(!m)return this.defaultValue;const v=t-i*s,d=o-a*s,f=n-r*s;return m[(f*s+d)*s+v]}lerp(t,o,n){const s=Math.floor(t),i=Math.floor(o),a=Math.floor(n),r=t-s,l=o-i,m=n-a,v=this.get(s,i,a),d=this.get(s+1,i,a),f=this.get(s,i+1,a),x=this.get(s+1,i+1,a),g=this.get(s,i,a+1),M=this.get(s+1,i,a+1),p=this.get(s,i+1,a+1),E=this.get(s+1,i+1,a+1),h=v*(1-r)+d*r,y=f*(1-r)+x*r,S=g*(1-r)+M*r,V=p*(1-r)+E*r,k=h*(1-l)+y*l,R=S*(1-l)+V*l;return k*(1-m)+R*m}gradient(t,o,n){const i=this.lerp(t+.5,o,n)-this.lerp(t-.5,o,n),a=this.lerp(t,o+.5,n)-this.lerp(t,o-.5,n),r=this.lerp(t,o,n+.5)-this.lerp(t,o,n-.5),l=Math.sqrt(i*i+a*a+r*r);if(l<1e-10)return[0,1,0];const m=1/l;return[i*m,a*m,r*m]}memoryMB(){return this.allocatedCount*this.blockCellCount*4/(1024*1024)}}function Ln(e,t,o,n=8,s=2){const i=o/t,a=Math.ceil(o/n),r=new Set;for(let v=0;v<t-1;v++)for(let d=0;d<t-1;d++)for(let f=0;f<t-1;f++){const g=e[(v*t+d)*t+f]>=0;let M=!1;for(let p=0;p<=1&&!M;p++)for(let E=0;E<=1&&!M;E++)for(let h=0;h<=1;h++){if(h===0&&E===0&&p===0)continue;if(e[((v+p)*t+(d+E))*t+(f+h)]>=0!==g){M=!0;break}}if(M)for(let p=-s;p<=s;p++)for(let E=-s;E<=s;E++)for(let h=-s;h<=s;h++){const y=f+h,S=d+E,V=v+p;y>=0&&S>=0&&V>=0&&y<t&&S<t&&V<t&&r.add((V*t+S)*t+y)}}const l=new Dn(o,n,1);let m=0;return r.forEach(v=>{const d=v%t,f=(v/t|0)%t,x=v/(t*t)|0,g=Math.floor(d*i),M=Math.floor(f*i),p=Math.floor(x*i),E=Math.ceil((d+1)*i),h=Math.ceil((f+1)*i),y=Math.ceil((x+1)*i),S=g/n|0,V=M/n|0,k=p/n|0,R=Math.min(a-1,E/n|0),D=Math.min(a-1,h/n|0),N=Math.min(a-1,y/n|0);for(let u=k;u<=N;u++)for(let c=V;c<=D;c++)for(let _=S;_<=R;_++)l.hasBlock(_,c,u)||(l.allocateBlock(_,c,u),m++)}),console.log("Narrow band: "+r.size+" coarse surface cells -> "+m+" fine blocks ("+l.memoryMB().toFixed(1)+" MB) out of "+a*a*a+" total blocks"),{grid:l,surfaceCells:r,bandBlockCount:m}}function qt(e,t){const o=e.blockSize,n=e.blocksPerAxis;e.blocks.forEach((s,i)=>{const a=i%n,r=(i/n|0)%n,l=i/(n*n)|0;t(a,r,l,a*o,r*o,l*o)})}async function _n(e,t,o,n=()=>{}){const s=e.N,i=s-1,a=e.blockSize,r=e.blocksPerAxis;let l=new Map,m=null;function v(T,U,I,C){const L=T/a|0,A=U/a|0,O=I/a|0,w=e.blockKey(L,A,O),F=T-L*a,G=U-A*a,X=((I-O*a)*a+G)*a+F;let $=l.get(w);$||($={locals:[],globals:[]},l.set(w,$)),$.locals.push(X),$.globals.push(C)}function d(T,U,I){const C=T/a|0,L=U/a|0,A=I/a|0,O=e.blockKey(C,L,A),w=m.get(O);if(!w)return-1;const F=T-C*a,G=U-L*a,X=((I-A*a)*a+G)*a+F,$=w.locals;let j=0,Z=$.length-1;for(;j<=Z;){const oe=j+Z>>1;if($[oe]===X)return w.globals[oe];$[oe]<X?j=oe+1:Z=oe-1}return-1}const f=new Map;function x(T,U,I,C){const L=T/a|0,A=U/a|0,O=I/a|0,w=e.blockKey(L,A,O);let F=f.get(w);F||(F=new Uint8Array(e.blockCellCount),f.set(w,F));const G=T-L*a,H=U-A*a,$=((I-O*a)*a+H)*a+G,j=1<<C;return F[$]&j?!0:(F[$]|=j,!1)}n("contouring",0);const g=new ht(262144),M=new ht(262144);let p=0,E=0;const h=e.allocatedCount,y=[];qt(e,(T,U,I,C,L,A)=>{y.push([T,U,I,C,L,A])});for(let T=0;T<y.length;T++){const U=y[T],I=U[3],C=U[4],L=U[5];E++;const A=Math.min(I+a,i),O=Math.min(C+a,i),w=Math.min(L+a,i);for(let F=L;F<w;F++)for(let G=C;G<O;G++)for(let H=I;H<A;H++){const X=e.get(H,G,F),$=X>=0,j=[X,e.get(H+1,G,F),e.get(H,G+1,F),e.get(H+1,G+1,F),e.get(H,G,F+1),e.get(H+1,G,F+1),e.get(H,G+1,F+1),e.get(H+1,G+1,F+1)];let Z=!1;for(let ie=1;ie<8;ie++)if(j[ie]>=0!==$){Z=!0;break}if(!Z)continue;const oe=[];for(let ie=0;ie<12;ie++){const ce=pt[ie],J=j[ce[0]],q=j[ce[1]];if(J>=0==q>=0)continue;const se=H+(ce[0]&1),K=G+(ce[0]>>1&1),ee=F+(ce[0]>>2&1),Q=H+(ce[1]&1),te=G+(ce[1]>>1&1),fe=F+(ce[1]>>2&1);let he=se,ve=K,Te=ee,Ae=Q,we=te,ue=fe,ge=J;for(let Ee=0;Ee<8;Ee++){const Le=(he+Ae)*.5,$e=(ve+we)*.5,Ge=(Te+ue)*.5,Qe=e.lerp(Le,$e,Ge);Qe>=0==ge>=0?(he=Le,ve=$e,Te=Ge,ge=Qe):(Ae=Le,we=$e,ue=Ge)}const Ie=(he+Ae)*.5,xe=(ve+we)*.5,pe=(Te+ue)*.5,Ce=e.gradient(Ie,xe,pe);oe.push({point:[ye(Ie,s,t[0],o[0]),ye(xe,s,t[1],o[1]),ye(pe,s,t[2],o[2])],normal:Ce})}if(oe.length===0)continue;const ne=[ye(H,s,t[0],o[0]),ye(G,s,t[1],o[1]),ye(F,s,t[2],o[2])],W=[ye(H+1,s,t[0],o[0]),ye(G+1,s,t[1],o[1]),ye(F+1,s,t[2],o[2])],re=_o(oe,ne,W);if(!re)continue;const le=e.gradient(qe(re[0],s,t[0],o[0]),qe(re[1],s,t[1],o[1]),qe(re[2],s,t[2],o[2]));v(H,G,F,p),g.push3(re[0],re[1],re[2]),M.push3(le[0],le[1],le[2]),p++}E&63||(n("contouring",Math.round(40*E/h)),await zt())}if(n("contouring",50),console.log("DC sparse: "+p+" vertices ("+((g.data.byteLength+M.data.byteLength)/(1024*1024)).toFixed(0)+" MB vertex data)"),p===0)return{positions:new Float32Array(0),normals:new Float32Array(0),indices:new Uint32Array(0),vertexCount:0,faceCount:0};const S=new Map,V=e.blockCellCount+7>>3,k=e.memoryMB();let R=Array.from(e.blocks.keys());for(let T=0;T<R.length;T++){const U=R[T],I=e.blocks.get(U),C=new Uint8Array(V);for(let L=0;L<I.length;L++)I[L]>=0&&(C[L>>3]|=1<<(L&7));S.set(U,C),e.blocks.delete(U),T&255||await zt()}R=null,e.allocatedCount=0;const D=(S.size*V/(1024*1024)).toFixed(0);console.log("Sign compression: freed "+k.toFixed(0)+" MB float data, using "+D+" MB sign maps"),m=new Map,l.forEach((T,U)=>{const I=T.locals.length,C=new Array(I);for(let F=0;F<I;F++)C[F]=F;const L=T.locals,A=T.globals;C.sort((F,G)=>L[F]-L[G]);const O=new Uint16Array(I),w=new Uint32Array(I);for(let F=0;F<I;F++)O[F]=L[C[F]],w[F]=A[C[F]];m.set(U,{locals:O,globals:w})}),l.clear(),l=null,console.log("Vertex map compaction: "+m.size+" blocks with vertices");function N(T,U,I){if(T<0||U<0||I<0||T>=s||U>=s||I>=s)return!0;const C=T/a|0,L=U/a|0,A=I/a|0,O=e.blockKey(C,L,A),w=S.get(O);if(!w)return!0;const F=T-C*a,G=U-L*a,X=((I-A*a)*a+G)*a+F;return(w[X>>3]&1<<(X&7))!==0}const u=new Lo(262144);let c=0,_=0,P=0;const B=m.size;let z=Array.from(m.entries());for(let T=0;T<z.length;T++){const U=z[T],I=U[0],C=U[1];P++;const L=I%r,A=(I/r|0)%r,O=I/(r*r)|0,w=L*a,F=A*a,G=O*a;for(let H=0;H<C.locals.length;H++){const X=C.locals[H],$=X%a,j=(X/a|0)%a,Z=X/(a*a)|0,oe=w+$,ne=F+j,W=G+Z;if(!(oe>=i||ne>=i||W>=i))for(let re=0;re<12;re++){const le=pt[re],ie=oe+(le[0]&1),ce=ne+(le[0]>>1&1),J=W+(le[0]>>2&1),q=oe+(le[1]&1),se=ne+(le[1]>>1&1),K=W+(le[1]>>2&1),ee=N(ie,ce,J),Q=N(q,se,K);if(ee===Q)continue;let te;const fe=Math.min(ie,q),he=Math.min(ce,se),ve=Math.min(J,K);if(ie!==q?te=0:ce!==se?te=1:te=2,x(fe,he,ve,te))continue;c++;const Te=(te+1)%3,Ae=(te+2)%3,we=[fe,he,ve],ue=[-1,-1,-1,-1];let ge=!0;for(let xe=0;xe<4;xe++){const pe=[we[0],we[1],we[2]];if(pe[Te]-=xe&1?0:1,pe[Ae]-=xe&2?0:1,pe[0]<0||pe[1]<0||pe[2]<0||pe[0]>=i||pe[1]>=i||pe[2]>=i){ge=!1;break}const Ce=d(pe[0],pe[1],pe[2]);if(Ce<0){ge=!1;break}ue[xe]=Ce}if(!ge){_++;continue}const Ie=ee;ue[0]!==ue[1]&&ue[0]!==ue[3]&&ue[1]!==ue[3]&&(Ie?u.push3(ue[0],ue[3],ue[1]):u.push3(ue[0],ue[1],ue[3])),ue[0]!==ue[2]&&ue[0]!==ue[3]&&ue[2]!==ue[3]&&(Ie?u.push3(ue[0],ue[2],ue[3]):u.push3(ue[0],ue[3],ue[2]))}}P&63||(n("contouring",50+Math.round(50*P/B)),await zt())}return m=null,z=null,n("contouring",100),console.log("DC sparse: "+c+" sign-change edges, "+_+" dropped, "+u.length/3+" faces"),{positions:g.trim(),normals:M.trim(),indices:u.trim(),vertexCount:p,faceCount:Math.floor(u.length/3)}}const Bo=new Float32Array(1),Bn=new Uint32Array(Bo.buffer);function zn(e){Bo[0]=e;const t=Bn[0],o=t>>16&32768,n=(t>>23&255)-127+15,s=t&8388607;return n<=0?o:n>=31?o|31744:o|n<<10|s>>13}const zo=new Uint16Array(256);for(let e=0;e<256;e++)zo[e]=zn(e/255);class ko{constructor(t){ae(this,"buf");ae(this,"a");ae(this,"v");ae(this,"pos");this.buf=new ArrayBuffer(t||8*1024*1024),this.a=new Uint8Array(this.buf),this.v=new DataView(this.buf),this.pos=0}grow(t){let o=this.pos+t;this.buf.byteLength<256*1024*1024?o=Math.max(this.buf.byteLength*2,o):o=Math.max(Math.round(this.buf.byteLength*1.25),o);const n=new ArrayBuffer(o);new Uint8Array(n).set(this.a),this.buf=n,this.a=new Uint8Array(n),this.v=new DataView(n)}en(t){this.pos+t>this.buf.byteLength&&this.grow(t)}u8(t){this.en(1),this.v.setUint8(this.pos,t),this.pos++}u16(t){this.en(2),this.v.setUint16(this.pos,t,!0),this.pos+=2}u32(t){this.en(4),this.v.setUint32(this.pos,t,!0),this.pos+=4}i32(t){this.en(4),this.v.setInt32(this.pos,t,!0),this.pos+=4}u64(t){this.en(8),this.v.setBigUint64(this.pos,t,!0),this.pos+=8}f64(t){this.en(8),this.v.setFloat64(this.pos,t,!0),this.pos+=8}raw(t){this.en(t.length),this.a.set(t,this.pos),this.pos+=t.length}str(t){this.en(t.length);for(let o=0;o<t.length;o++)this.a[this.pos++]=t.charCodeAt(o)}name(t){this.u32(t.length),this.str(t)}zeros(t){this.en(t),this.pos+=t}bulk64(t){const o=t.length*8;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}bulk16(t){const o=t.length*2;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}bulkF32(t){const o=t.length*4;this.en(o),this.a.set(new Uint8Array(t.buffer,t.byteOffset,o),this.pos),this.pos+=o}result(){return new Uint8Array(this.buf,0,this.pos)}}const vt=0xFFFFFFFFFFFFFFFFn;function kn(){return{n5childMask:new BigUint64Array(512),n5valueMask:new BigUint64Array(512),n5tileValues:new Uint16Array(32768),n4map:new Map}}function On(){return{childMask:new BigUint64Array(64),valueMask:new BigUint64Array(64),tileValues:new Uint16Array(4096),leafMap:new Map}}function jn(e,t,o,n,s){const i=new BigUint64Array(8),a=new Uint16Array(512);let r=0;for(let g=0;g<512;g++)s[g]>0&&(i[g>>6]|=1n<<BigInt(g&63),a[g]=zo[s[g]],r++);if(r===0)return 0;const l=t<<3,m=o<<3,v=n<<3,d=(v&4095)>>7|(m&4095)>>7<<5|(l&4095)>>7<<10;e.n5childMask[d>>6]|=1n<<BigInt(d&63);let f=e.n4map.get(d);f||(f=On(),e.n4map.set(d,f));const x=(v&127)>>3|(m&127)>>3<<4|(l&127)>>3<<8;return f.childMask[x>>6]|=1n<<BigInt(x&63),f.leafMap.set(x,{mask:i,data:a}),r}function Un(e){let t=0,o=0;return e.n4map.forEach(function(n,s){const i=[];n.leafMap.forEach(function(a,r){let l=!0;for(let d=0;d<8;d++)if(a.mask[d]!==vt){l=!1;break}if(!l)return;const m=a.data[0];let v=!0;for(let d=1;d<512;d++)if(a.data[d]!==m){v=!1;break}v&&i.push([r,m])});for(let a=0;a<i.length;a++){const r=i[a][0],l=i[a][1];n.leafMap.delete(r),n.childMask[r>>6]&=~(1n<<BigInt(r&63)),n.valueMask[r>>6]|=1n<<BigInt(r&63),n.tileValues[r]=l,t++}if(n.leafMap.size===0){let a=!0;for(let r=0;r<64;r++)if(n.valueMask[r]!==vt){a=!1;break}if(a){const r=n.tileValues[0];let l=!0;for(let m=1;m<4096;m++)if(n.tileValues[m]!==r){l=!1;break}l&&(e.n4map.delete(s),e.n5childMask[s>>6]&=~(1n<<BigInt(s&63)),e.n5valueMask[s>>6]|=1n<<BigInt(s&63),e.n5tileValues[s]=r,o++)}}}),{promotedLeaves:t,promotedN4s:o}}function Vn(){return{n5childMask:new BigUint64Array(512),n5valueMask:new BigUint64Array(512),n5tileValues:new Float32Array(32768*3),n4map:new Map}}function Nn(){return{childMask:new BigUint64Array(64),valueMask:new BigUint64Array(64),tileValues:new Float32Array(4096*3),leafMap:new Map}}function $n(e,t,o,n,s,i,a){const r=new BigUint64Array(8),l=new Float32Array(512*3);let m=0;for(let p=0;p<512;p++)(s[p]>0||i[p]>0||a[p]>0)&&(r[p>>6]|=1n<<BigInt(p&63),l[p*3]=s[p]/255,l[p*3+1]=i[p]/255,l[p*3+2]=a[p]/255,m++);if(m===0)return 0;const v=t<<3,d=o<<3,f=n<<3,x=(f&4095)>>7|(d&4095)>>7<<5|(v&4095)>>7<<10;e.n5childMask[x>>6]|=1n<<BigInt(x&63);let g=e.n4map.get(x);g||(g=Nn(),e.n4map.set(x,g));const M=(f&127)>>3|(d&127)>>3<<4|(v&127)>>3<<8;return g.childMask[M>>6]|=1n<<BigInt(M&63),g.leafMap.set(M,{mask:r,data:l}),m}function Gn(e){let t=0,o=0;return e.n4map.forEach(function(n,s){const i=[];n.leafMap.forEach(function(a,r){let l=!0;for(let x=0;x<8;x++)if(a.mask[x]!==vt){l=!1;break}if(!l)return;const m=a.data[0],v=a.data[1],d=a.data[2];let f=!0;for(let x=1;x<512;x++)if(a.data[x*3]!==m||a.data[x*3+1]!==v||a.data[x*3+2]!==d){f=!1;break}f&&i.push([r,m,v,d])});for(const[a,r,l,m]of i)n.leafMap.delete(a),n.childMask[a>>6]&=~(1n<<BigInt(a&63)),n.valueMask[a>>6]|=1n<<BigInt(a&63),n.tileValues[a*3]=r,n.tileValues[a*3+1]=l,n.tileValues[a*3+2]=m,t++;if(n.leafMap.size===0){let a=!0;for(let r=0;r<64;r++)if(n.valueMask[r]!==vt){a=!1;break}if(a){const r=n.tileValues[0],l=n.tileValues[1],m=n.tileValues[2];let v=!0;for(let d=1;d<4096;d++)if(n.tileValues[d*3]!==r||n.tileValues[d*3+1]!==l||n.tileValues[d*3+2]!==m){v=!1;break}v&&(e.n4map.delete(s),e.n5childMask[s>>6]&=~(1n<<BigInt(s&63)),e.n5valueMask[s>>6]|=1n<<BigInt(s&63),e.n5tileValues[s*3]=r,e.n5tileValues[s*3+1]=l,e.n5tileValues[s*3+2]=m,o++)}}}),{promotedLeaves:t,promotedN4s:o}}function We(e){return Array.from(e.keys()).sort(function(t,o){return t-o})}function ke(e,t,o){e.name(t),e.name("string"),e.name(o)}function Wt(e,t,o){e.name(t),e.name("bool"),e.u32(1),e.u8(o?1:0)}function Oo(e,t){e.u32(1),e.u32(0),e.u32(0),e.u32(1),e.i32(0),e.i32(0),e.i32(0),e.bulk64(t.n5childMask),e.bulk64(t.n5valueMask),e.u8(6),e.bulk16(t.n5tileValues);const o=We(t.n4map);for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]);e.bulk64(s.childMask),e.bulk64(s.valueMask),e.u8(6),e.bulk16(s.tileValues);const i=We(s.leafMap);for(let a=0;a<i.length;a++)e.bulk64(s.leafMap.get(i[a]).mask)}for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]),i=We(s.leafMap);for(let a=0;a<i.length;a++){const r=s.leafMap.get(i[a]);e.bulk64(r.mask),e.u8(6),e.bulk16(r.data),r.data=null}}}function Xn(e,t){e.u32(1),e.f64(0),e.u32(0),e.u32(0),e.u32(1),e.i32(0),e.i32(0),e.i32(0),e.bulk64(t.n5childMask),e.bulk64(t.n5valueMask),e.u8(6),e.bulkF32(t.n5tileValues);const o=We(t.n4map);for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]);e.bulk64(s.childMask),e.bulk64(s.valueMask),e.u8(6),e.bulkF32(s.tileValues);const i=We(s.leafMap);for(let a=0;a<i.length;a++)e.bulk64(s.leafMap.get(i[a]).mask)}for(let n=0;n<o.length;n++){const s=t.n4map.get(o[n]),i=We(s.leafMap);for(let a=0;a<i.length;a++){const r=s.leafMap.get(i[a]);e.bulk64(r.mask),e.u8(6),e.bulkF32(r.data),r.data=null}}}function jo(e,t,o,n){const s=n/t;e.name("AffineMap"),e.f64(s),e.f64(0),e.f64(0),e.f64(0),e.f64(0),e.f64(s),e.f64(0),e.f64(0),e.f64(0),e.f64(0),e.f64(s),e.f64(0),e.f64(o[0]),e.f64(o[1]),e.f64(o[2]),e.f64(1)}function Hn(e,t,o,n,s,i){e.u32(0),e.u32(4),ke(e,"class","unknown"),ke(e,"file_compression","none"),Wt(e,"is_saved_as_half_float",!0),ke(e,"name",o),jo(e,n,s,i),Oo(e,t)}function Yn(e,t,o,n,s,i){e.u32(0),e.u32(4),ke(e,"class","unknown"),ke(e,"file_compression","none"),Wt(e,"is_saved_as_half_float",!1),ke(e,"name",o),jo(e,n,s,i),Xn(e,t)}function qn(e,t,o,n){let s=0;e.n4map.forEach(function(l){s+=l.leafMap.size});const i=2e5+s*1200+e.n4map.size*1e4,a=new ko(Math.max(i,1024*1024));a.raw(new Uint8Array([32,66,68,86,0,0,0,0])),a.u32(224),a.u32(8),a.u32(1),a.u8(0),a.str("d2b59639-ac2f-4047-9c50-9648f951180c"),a.u32(0),a.u32(1),a.name("density"),a.name("Tree_float_5_4_3_HalfFloat"),a.u32(0),a.u64(BigInt(a.pos+24)),a.u64(0n),a.u64(0n),a.u32(0),a.u32(4),ke(a,"class","unknown"),ke(a,"file_compression","none"),Wt(a,"is_saved_as_half_float",!0),ke(a,"name","density");const r=n/t;return a.name("AffineMap"),a.f64(r),a.f64(0),a.f64(0),a.f64(0),a.f64(0),a.f64(r),a.f64(0),a.f64(0),a.f64(0),a.f64(0),a.f64(r),a.f64(0),a.f64(o[0]),a.f64(o[1]),a.f64(o[2]),a.f64(1),Oo(a,e),a.result()}function Wn(e,t,o,n,s){let i=0;e.n4map.forEach(function(m){i+=m.leafMap.size});let a=0;t.n4map.forEach(function(m){a+=m.leafMap.size});const r=2e5+i*1200+e.n4map.size*1e4+2e5+a*7200+t.n4map.size*6e4,l=new ko(Math.max(r,2*1024*1024));return l.raw(new Uint8Array([32,66,68,86,0,0,0,0])),l.u32(224),l.u32(8),l.u32(1),l.u8(0),l.str("d2b59639-ac2f-4047-9c50-9648f951180c"),l.u32(0),l.u32(2),l.name("density"),l.name("Tree_float_5_4_3_HalfFloat"),l.u32(0),l.u64(BigInt(l.pos+24)),l.u64(0n),l.u64(0n),Hn(l,e,"density",o,n,s),l.name("Cd"),l.name("Tree_vec3s_5_4_3"),l.u32(0),l.u64(BigInt(l.pos+24)),l.u64(0n),l.u64(0n),Yn(l,t,"Cd",o,n,s),l.result()}function Zn(e,t,o){return{formula:e.id,pipelineRevision:0,quality:o?{estimator:o.estimator??0,distanceMetric:o.distanceMetric??0}:void 0,interlace:t?{interlaceCompiled:!0,interlaceFormula:t.definition.id,interlaceEnabled:t.enabled,interlaceInterval:t.interval,interlaceStartIter:t.startIter,interlaceParamA:0,interlaceParamB:0,interlaceParamC:0,interlaceParamD:0,interlaceParamE:0,interlaceParamF:0,interlaceVec2A:{x:0,y:0},interlaceVec2B:{x:0,y:0},interlaceVec2C:{x:0,y:0},interlaceVec3A:{x:0,y:0,z:0},interlaceVec3B:{x:0,y:0,z:0},interlaceVec3C:{x:0,y:0,z:0}}:void 0}}function at(e,t,o){const n=o||{};t.uParamA&&e.uniform1f(t.uParamA,n.paramA??8),t.uParamB&&e.uniform1f(t.uParamB,n.paramB??0),t.uParamC&&e.uniform1f(t.uParamC,n.paramC??0),t.uParamD&&e.uniform1f(t.uParamD,n.paramD??0),t.uParamE&&e.uniform1f(t.uParamE,n.paramE??0),t.uParamF&&e.uniform1f(t.uParamF,n.paramF??0);const s=p=>p?[p.x??p[0]??0,p.y??p[1]??0]:[0,0],i=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0]:[0,0,0],a=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0,p.w??p[3]??0]:[0,0,0,0],r=s(n.vec2A);t.uVec2A&&e.uniform2f(t.uVec2A,r[0],r[1]);const l=s(n.vec2B);t.uVec2B&&e.uniform2f(t.uVec2B,l[0],l[1]);const m=s(n.vec2C);t.uVec2C&&e.uniform2f(t.uVec2C,m[0],m[1]);const v=i(n.vec3A);t.uVec3A&&e.uniform3f(t.uVec3A,v[0],v[1],v[2]);const d=i(n.vec3B);t.uVec3B&&e.uniform3f(t.uVec3B,d[0],d[1],d[2]);const f=i(n.vec3C);t.uVec3C&&e.uniform3f(t.uVec3C,f[0],f[1],f[2]);const x=a(n.vec4A);t.uVec4A&&e.uniform4f(t.uVec4A,x[0],x[1],x[2],x[3]);const g=a(n.vec4B);t.uVec4B&&e.uniform4f(t.uVec4B,g[0],g[1],g[2],g[3]);const M=a(n.vec4C);if(t.uVec4C&&e.uniform4f(t.uVec4C,M[0],M[1],M[2],M[3]),t.uJulia){const p=n.julia;Array.isArray(p)?e.uniform3f(t.uJulia,p[0]??0,p[1]??0,p[2]??0):p&&typeof p=="object"?e.uniform3f(t.uJulia,p.x??0,p.y??0,p.z??0):e.uniform3f(t.uJulia,0,0,0)}t.uJuliaMode&&e.uniform1f(t.uJuliaMode,n.juliaMode?1:0),t.uEscapeThresh&&e.uniform1f(t.uEscapeThresh,n.escapeThresh??10),t.uDistanceMetric&&e.uniform1f(t.uDistanceMetric,n.distanceMetric??0)}function st(e,t,o){if(!o){t.uInterlaceEnabled&&e.uniform1f(t.uInterlaceEnabled,0);return}t.uInterlaceEnabled&&e.uniform1f(t.uInterlaceEnabled,o.enabled?1:0),t.uInterlaceInterval&&e.uniform1f(t.uInterlaceInterval,o.interval??2),t.uInterlaceStartIter&&e.uniform1f(t.uInterlaceStartIter,o.startIter??0);const n=o.params||{},s=p=>p?[p.x??p[0]??0,p.y??p[1]??0]:[0,0],i=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0]:[0,0,0],a=p=>p?[p.x??p[0]??0,p.y??p[1]??0,p.z??p[2]??0,p.w??p[3]??0]:[0,0,0,0];t.uInterlaceParamA&&e.uniform1f(t.uInterlaceParamA,n.paramA??0),t.uInterlaceParamB&&e.uniform1f(t.uInterlaceParamB,n.paramB??0),t.uInterlaceParamC&&e.uniform1f(t.uInterlaceParamC,n.paramC??0),t.uInterlaceParamD&&e.uniform1f(t.uInterlaceParamD,n.paramD??0),t.uInterlaceParamE&&e.uniform1f(t.uInterlaceParamE,n.paramE??0),t.uInterlaceParamF&&e.uniform1f(t.uInterlaceParamF,n.paramF??0);const r=s(n.vec2A);t.uInterlaceVec2A&&e.uniform2f(t.uInterlaceVec2A,r[0],r[1]);const l=s(n.vec2B);t.uInterlaceVec2B&&e.uniform2f(t.uInterlaceVec2B,l[0],l[1]);const m=s(n.vec2C);t.uInterlaceVec2C&&e.uniform2f(t.uInterlaceVec2C,m[0],m[1]);const v=i(n.vec3A);t.uInterlaceVec3A&&e.uniform3f(t.uInterlaceVec3A,v[0],v[1],v[2]);const d=i(n.vec3B);t.uInterlaceVec3B&&e.uniform3f(t.uInterlaceVec3B,d[0],d[1],d[2]);const f=i(n.vec3C);t.uInterlaceVec3C&&e.uniform3f(t.uInterlaceVec3C,f[0],f[1],f[2]);const x=a(n.vec4A);t.uInterlaceVec4A&&e.uniform4f(t.uInterlaceVec4A,x[0],x[1],x[2],x[3]);const g=a(n.vec4B);t.uInterlaceVec4B&&e.uniform4f(t.uInterlaceVec4B,g[0],g[1],g[2],g[3]);const M=a(n.vec4C);t.uInterlaceVec4C&&e.uniform4f(t.uInterlaceVec4C,M[0],M[1],M[2],M[3])}function lo(e,t,o,n){const s=e.createShader(t);if(!s)throw new Error("Failed to create shader");if(e.shaderSource(s,o),e.compileShader(s),!e.getShaderParameter(s,e.COMPILE_STATUS)){const i=e.getShaderInfoLog(s)||"",a=t===e.VERTEX_SHADER?"vertex":"fragment";n("Shader compile error ("+a+"): "+i,"error");const r=o.split(`
...
`)[0])}return s}function rt(e,t,o,n){const s=e.createProgram();if(!s)throw new Error("Failed to create program");if(e.attachShader(s,lo(e,e.VERTEX_SHADER,t,n)),e.attachShader(s,lo(e,e.FRAGMENT_SHADER,o,n)),e.linkProgram(s),!e.getProgramParameter(s,e.LINK_STATUS)){const i=e.getProgramInfoLog(s)||"";throw n("Program link error: "+i,"error"),new Error("Program link: "+i)}return s}function xt(){const e=document.createElement("canvas");e.width=2048,e.height=2048;const t=e.getContext("webgl2",{antialias:!1});if(!t)throw new Error("WebGL2 not supported");return t.getExtension("EXT_color_buffer_float"),t.getExtension("OES_texture_float_linear"),t}function Zt(e,t){const o={};for(let n=0;n<Ye.length;n++)o[Ye[n]]=e.getUniformLocation(t,Ye[n]);return o}function Ze(e,t,o,n,s,i,a){Oe.register(o),i&&Oe.register(i.definition);const r=Pn.generateMeshSDFLibrary(Zn(o,i,a)),l=n,m=`#version 300 es
precision highp float;
uniform float uZ;
uniform float uPower;
uniform int   uIters;
