var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,h as D,F as p,i as g,u as m}from"./CollapsibleSection-dtWTYN6x.js";import{r as v,j as l,R as j}from"./three-fiber-GKfjny8F.js";import{m as $,n as k,o as S,q as w,v as R,t as B,S as O,E as N,D as V,b as G,P as H,T as q,d as X,e as Y,G as W,a as Q,f as Z,r as K,w as J,i as ee,h as te,l as ae,j as ie,k as oe}from"./Undo-CnDbGaGV.js";import{V as re,i as ne,a as se,c as le}from"./Camera-DRDpJS1w.js";import{c as ce}from"./three-drei-D6d-dyvY.js";import{C as fe}from"./CompilingIndicator-Brzv0jZ9.js";import{r as me}from"./cameraKeyRegistry-J_NsxgyV.js";import"./three-DQWx7qFd.js";import"./pako-DwGzBETv.js";const u=new Map,A=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),$(t.name)||k({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},ue=`
