var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,h as j,F as p,j as g,u as m,c as D,i as $}from"./SceneFormat-BInXfF9u.js";import{r as v,j as l,R as k}from"./three-fiber-GKfjny8F.js";import{j as B,k as O,m as S,l as w,v as R,n as N,S as V,E as G,D as H,a as X,P as q,T as Y,b as W,c as Q,G as Z,d as K,r as J,o as ee,i as te,h as ae,e as ie,g as oe,f as re}from"./PwaUpdate-DIre3IOB.js";import{V as ne,i as se,c as le}from"./Camera-C4RCgc5o.js";import{c as ce}from"./three-drei-BSHBGk0S.js";import{C as fe}from"./CompilingIndicator--STjvkoG.js";import{r as me}from"./cameraKeyRegistry-BSTCEPS5.js";import"./three-DQWx7qFd.js";import"./pako-DwGzBETv.js";import"./CompositionOverlay-BjwcP-7v.js";const u=new Map,A=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),B(t.name)||O({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},ue=`
