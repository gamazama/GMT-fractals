var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,e as D,F as p,h as g,u as m}from"./CollapsibleSection-koiYRr9u.js";import{r as v,j as l,R as j}from"./three-fiber-GKfjny8F.js";import{k as $,l as k,m as S,n as w,v as R,o as B,S as O,E as N,D as V,b as G,P as H,T as q,d as X,e as Y,G as W,a as Q,f as Z,r as K,q as J,i as ee,g as te,t as ae,h as oe,j as ie}from"./Undo-BIGUyb7d.js";import{V as re,i as ne,c as se}from"./Camera-DRERZ4Ru.js";import{c as le}from"./three-drei-2g7QvUdQ.js";import{C as ce}from"./CompilingIndicator-k-8q6Hu5.js";import{r as fe}from"./cameraKeyRegistry-p9NkKZ4D.js";import"./three-DQWx7qFd.js";import"./pako-DwGzBETv.js";const u=new Map,A=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),$(t.name)||k({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},me=`
