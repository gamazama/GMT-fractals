var Se=Object.defineProperty;var we=(e,t,a)=>t in e?Se(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var $=(e,t,a)=>we(e,typeof t!="symbol"?t+"":t,a);import{a1 as x,a9 as A,by as I,U as y,ao as m,f,bz as _e,bA as Fe,bB as Me,bC as Ie,bD as Ce,bE as Pe}from"./SceneFormat-44ZdMSMs.js";import{n as w,d as L,p as Ee,q as Te,r as Z,s as X,c as g,l as V}from"./three-DQWx7qFd.js";import{w as De,a as Ae,b as j,H as ie,J as Re,s as Be,K as Le}from"./gradientSeam-DL77rble.js";import{a as ke}from"./three-drei-BSHBGk0S.js";function Oe(e,t,a){var o,i;return!!((o=e.shader.capabilities)!=null&&o.has(a)||(i=t==null?void 0:t.shader.capabilities)!=null&&i.has(a))}const U=`
...
#endif
            `)),a==="Main"||a==="Histogram"?e.addFunction(We()):e.addFunction(`
                float getMappingValue(float mode, vec3 p, vec4 result, vec3 n, float repeatScale) { return 0.0; }
            `)}},Ke={id:"standard",label:"Standard (Tglad)",glsl:`
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},et={id:"half",label:"Half-fold",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = abs(z + foldLimit);
}
`,defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:2}},tt={id:"decoupled",label:"Decoupled",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,extraParams:{hybridFoldingValue:{type:"vec3",default:new g(2,2,2),label:"Folding Value",shortId:"hfv",uniform:"uHybridFoldingValue",min:.1,max:5,step:.01,group:"hybrid"}},defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2,hybridFoldingValue:{x:2,y:2,z:2}}},at={id:"kali",label:"Kali",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = uHybridKaliConstant - abs(z);
}
`,rotMode:"post",extraParams:{hybridKaliConstant:{type:"vec3",default:new g(1,1,1),label:"Kali Constant",shortId:"hkc",uniform:"uHybridKaliConstant",min:-3,max:3,step:.01,group:"hybrid"}},defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.6,hybridFixedR:1,hybridIter:3,hybridKaliConstant:{x:.5,y:.5,z:.5}}},ot={id:"tetra",label:"Tetrahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    if (z.x + z.y < 0.0) z.xy = -z.yx;
    if (z.x + z.z < 0.0) z.xz = -z.zx;
    if (z.y + z.z < 0.0) z.yz = -z.zy;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.25,hybridFixedR:1,hybridIter:3}},it={id:"octa",label:"Octahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},rt={id:"icosa",label:"Icosahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:4}},nt={id:"menger",label:"Menger (Cubic)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,selfContained:!0,extraParams:{hybridMengerOffset:{type:"vec3",default:new g(1,1,1),label:"Offset",shortId:"hmo",uniform:"uHybridMengerOffset",min:0,max:2,step:.01,group:"hybrid",linkable:!0},hybridMengerCenterZ:{type:"boolean",default:!0,label:"Center Z",shortId:"hmz",uniform:"uHybridMengerCenterZ",group:"hybrid"}},defaults:{hybridScale:3,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3,hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0}},k=[Ke,Je,et,tt,at,ot,it,rt,nt],lt=k.map((e,t)=>({label:e.label,value:t}));function st(e){return k[e]??k[0]}const dt=`
...
`,ct=["xyz","xzy","yxz","yzx","zxy","zyx"];function pt(e){const t=ct[e]??"xyz";return t==="xyz"?"vec3 c_perm = c.xyz;":`vec3 c_perm = c.${t};`}function ft(e,t,a=!1){return`
mat3 hybridRotMat;
bool hybridHasRot;
...
void formula_Hybrid(inout vec4 z, inout float dr, inout float trap, vec4 c) {}`);else{const h=(a==null?void 0:a.hybridFoldType)??0,c=st(h);e.addFunction(c.glsl);const v=(a==null?void 0:a.hybridPermute)??0,M=pt(v);e.addFunction(ft(M,c.rotMode??"wrap",c.selfContained??!1))}let n="",d="";const p=t.formula,s=((b=x.get(p))==null?void 0:b.shader.selfContainedSDE)??!1,l=(a==null?void 0:a.burningEnabled)??!1;if(!s&&l&&(d+="z.xyz = mix(z.xyz, abs(z.xyz), uBurningRuntime * uBurningMix);"),r&&!s)if(!(a&&a.hybridComplex))n+=`
                ...
                `;else{const c=(a==null?void 0:a.hybridSwap)??!1;n+=`if (uHybrid > 0.5) { initHybridTransform(); }
`,d+=`
                if (uHybrid > 0.5) {
                ...
                `}e.addHybridFold("",n,d)}},W=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF"],Q=["uVec2A","uVec2B","uVec2C"],K=["uVec3A","uVec3B","uVec3C"],J=["uVec4A","uVec4B","uVec4C"],ne=["uInterlaceParamA","uInterlaceParamB","uInterlaceParamC","uInterlaceParamD","uInterlaceParamE","uInterlaceParamF"],le=["uInterlaceVec2A","uInterlaceVec2B","uInterlaceVec2C"],se=["uInterlaceVec3A","uInterlaceVec3B","uInterlaceVec3C"],de=["uInterlaceVec4A","uInterlaceVec4B","uInterlaceVec4C"];function ht(){const e=[];for(let t=0;t<W.length;t++)e.push([new RegExp(`\\b${W[t]}\\b`,"g"),ne[t]]);for(let t=0;t<Q.length;t++)e.push([new RegExp(`\\b${Q[t]}\\b`,"g"),le[t]]);for(let t=0;t<K.length;t++)e.push([new RegExp(`\\b${K[t]}\\b`,"g"),se[t]]);for(let t=0;t<J.length;t++)e.push([new RegExp(`\\b${J[t]}\\b`,"g"),de[t]]);return e}const gt=ht();function G(e){let t=e;for(const[a,o]of gt)t=t.replace(a,o);return t}function O(e,t){const a=[...t].sort((i,r)=>r.length-i.length);let o=e;for(const i of a)o=o.replace(new RegExp(`\\b${i}\\b`,"g"),`interlace_${i}`);return o}function B(e){const t=[],a=/\b(?:void|vec[234]|float|int|mat[234]|bool)\s+(\w+)\s*\(/g,o=/^\s*(?:const\s+)?(?:vec[234]|float|int|mat[234]|bool)\s+([^;]+);/,i=/^\s*(\w+)/;let r=0;for(const n of e.split(`
`)){if(r===0){a.lastIndex=0;let d;for(;(d=a.exec(n))!==null;){const s=d[1];!s.startsWith("formula_")&&!t.includes(s)&&t.push(s)}const p=o.exec(n);if(p){const s=[];let l=0,b="";for(const h of p[1]){if(h==="(")l++;else if(h===")")l--;else if(h===","&&l===0){s.push(b),b="";continue}b+=h}b&&s.push(b);for(const h of s){const c=i.exec(h);c&&!t.includes(c[1])&&t.push(c[1])}}}for(const d of n)d==="{"?r++:d==="}"&&r--}return t}function yt(e,t,a){let o=e;o=o.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`);const i=B(e);for(const r of i)o=o.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return a&&a.length>0&&(o=O(o,a)),o=G(o),o}function bt(e,t,a,o){let i=e;if(i=i.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace"),i=G(i),a&&a.length>0&&(i=O(i,a)),o&&o.length>0)for(const r of o)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function vt(e,t,a){let o=e.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace");return o=o.replace(/(\bformula_Interlace\s*\(\s*[^,]+,\s*[^,]+,\s*[^,]+,\s*)c\b/,"$1cInterlace"),a&&a.length>0&&(o=O(o,a)),o}function xt(e,t,a,o){let i=e;if(i=i.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`),i=G(i),a&&a.length>0&&(i=O(i,a)),o&&o.length>0)for(const r of o)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function zt(e,t,a){let o=`
...
`});u.register({id:"Custom",label:"Custom (Legacy)",category:"Utils",description:"Legacy node.",inputs:[],glsl:e=>""});const Ct=e=>{const t=new Map;return e.forEach(a=>{t.has(a.target)||t.set(a.target,[]),t.get(a.target).push(a)}),t},Pt=e=>{const t=new Set,a=["root-end"],o=new Set;for(;a.length>0;){const i=a.pop();o.has(i)||(o.add(i),i!=="root-end"&&i!=="root-start"&&t.add(i),(e.get(i)??[]).forEach(r=>a.push(r.source)))}return t},Et=(e,t)=>{const a=Ct(t),o=Pt(a),i=e.filter(l=>o.has(l.id));if(!i||i.length===0)return`
    ...
    `;const n=new Map;n.set("root-start","v_start");let d=0;i.forEach((l,b)=>{const c=`v_${l.id.replace(/[^a-zA-Z0-9]/g,"")}`;n.set(l.id,c);const v=a.get(l.id)??[],M=v.find(F=>!F.targetHandle||F.targetHandle==="a"),E=v.find(F=>F.targetHandle==="b"),T=M&&n.get(M.source)||"v_start",ve=E&&n.get(E.source)||"v_start";if(r+=`    // Node: ${l.type} (${l.id})
`,r+=`    vec3 ${c}_p = ${T}_p;
`,r+=`    float ${c}_d = ${T}_d;
`,r+=`    float ${c}_dr = ${T}_dr;
`,l.enabled){const F=u.get(l.type);if(F){const H=l.condition&&l.condition.active;let q="    ";if(H){const D=d<I?`uModularParams[${d++}]`:"2.0",ze=d<I?`uModularParams[${d++}]`:"0.0";r+=`    { int ${c}_cmod = max(1, int(${D})); int ${c}_crem = int(${ze});
`,r+=`    if ( (i - (i/${c}_cmod)*${c}_cmod) == ${c}_crem ) {
`,q="        "}const xe=D=>l.bindings&&l.bindings[D]?`u${l.bindings[D]}`:d<I?`uModularParams[${d++}]`:"0.0";r+=F.glsl({varName:c,in1:T,in2:ve,getParam:xe,indent:q}),H&&(r+=`    }}
`)}}r+=`
`});const p=t.find(l=>l.target==="root-end");let s="v_start";return p&&p.source!=="root-start"&&(s=n.get(p.source)||"v_start"),r+=`
    z.xyz = ${s}_p;
    dr = ${s}_dr;
...
cp_scale = 1.0;
cp_trap = 1e10;
`,Rt={id:"coreMath",shortId:"cm",name:"Formula Math",category:"Formulas",tabConfig:{label:"Formula"},extraUniforms:[{name:y.ModularParams,type:"float",arraySize:I,default:new Float32Array(I),backingOnly:!0}],params:{iterations:{type:"float",default:16,label:"Iterations",shortId:"it",uniform:"uIterations",min:1,max:500,step:1,group:"main"},paramA:{type:"float",default:8,label:"Param A",shortId:"pa",uniform:"uParamA",min:-10,max:10,step:.001,group:"params"},paramB:{type:"float",default:0,label:"Param B",shortId:"pb",uniform:"uParamB",min:-10,max:10,step:.001,group:"params"},paramC:{type:"float",default:0,label:"Param C",shortId:"pc",uniform:"uParamC",min:-10,max:10,step:.001,group:"params"},paramD:{type:"float",default:0,label:"Param D",shortId:"pd",uniform:"uParamD",min:-10,max:10,step:.001,group:"params"},paramE:{type:"float",default:0,label:"Param E",shortId:"pe",uniform:"uParamE",min:-10,max:10,step:.001,group:"params"},paramF:{type:"float",default:0,label:"Param F",shortId:"pf",uniform:"uParamF",min:-10,max:10,step:.001,group:"params"},vec2A:{type:"vec2",default:{x:0,y:0},label:"Vec2 A",shortId:"v2a",uniform:"uVec2A",min:-10,max:10,step:.001,group:"params"},vec2B:{type:"vec2",default:{x:0,y:0},label:"Vec2 B",shortId:"v2b",uniform:"uVec2B",min:-10,max:10,step:.001,group:"params"},vec2C:{type:"vec2",default:{x:0,y:0},label:"Vec2 C",shortId:"v2c",uniform:"uVec2C",min:-10,max:10,step:.001,group:"params"},vec3A:{type:"vec3",default:new g(0,0,0),label:"Vec3 A",shortId:"v3a",uniform:"uVec3A",min:-10,max:10,step:.001,group:"params"},vec3B:{type:"vec3",default:new g(0,0,0),label:"Vec3 B",shortId:"v3b",uniform:"uVec3B",min:-10,max:10,step:.001,group:"params"},vec3C:{type:"vec3",default:new g(0,0,0),label:"Vec3 C",shortId:"v3c",uniform:"uVec3C",min:-10,max:10,step:.001,group:"params"},vec4A:{type:"vec4",default:new V(0,0,0,0),label:"Vec4 A",shortId:"v4a",uniform:"uVec4A",min:-10,max:10,step:.001,group:"params"},vec4B:{type:"vec4",default:new V(0,0,0,0),label:"Vec4 B",shortId:"v4b",uniform:"uVec4B",min:-10,max:10,step:.001,group:"params"},vec4C:{type:"vec4",default:new V(0,0,0,0),label:"Vec4 C",shortId:"v4c",uniform:"uVec4C",min:-10,max:10,step:.001,group:"params"}},inject:(e,t)=>{var c;const a=t.formula,o=t.quality;a==="Modular"&&(e.addDefine("PIPELINE_REV",(t.pipelineRevision||0).toString()),e.addUniform(y.ModularParams,"float",I));const i=x.get(a);i!=null&&i.shader.selfContainedSDE&&(e.addDefine("SKIP_PRE_BAILOUT","1"),e.addDefine("SELF_CONTAINED_SDE","1"));let r="",n="",d="";const p=t.interlace,s=p!=null&&p.interlaceCompiled&&p.interlaceFormula?x.get(p.interlaceFormula):void 0,l=i?Oe(i,s,"estimator:cutting-plane"):!1,b=(o==null?void 0:o.estimator)||0;let h=Tt(b,l);if(a==="Modular"){const v=Et(t.pipeline||[],((c=t.graph)==null?void 0:c.edges)||[]);r+=v+`
...
`,n=i.shader.loopBody,d=i.shader.loopInit||"",i.shader.preamble&&e.addPreamble(i.shader.preamble),l&&(e.addPreamble(Dt),d=At+d),i.shader.getDist&&b<4.5&&(h=`vec2 getDist(float r, float dr, float iter, vec4 z) { ${i.shader.getDist} }`));e.addFunction(r),e.setFormula(n,d,h)}};let Bt=0;function C(){return`l${++Bt}`}const Lt={id:"shadows",label:"Shadows",renderContext:"direct",controlledParams:["lighting.shadowsCompile","lighting.shadowAlgorithm","lighting.ptStochasticShadows"],tiers:[{label:"Off",overrides:{lighting:{shadows:!1,shadowsCompile:!1,ptStochasticShadows:!1}},estCompileMs:0},{label:"Hard",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:2,ptStochasticShadows:!1}},estCompileMs:500},{label:"Soft",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!1}},estCompileMs:3e3},{label:"Full",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!0}},estCompileMs:3800}]},kt={id:"reflections",label:"Reflections (Direct)",renderContext:"direct",controlledParams:["reflections.reflectionMode","reflections.bounceShadows","reflections.bounces"],tiers:[{label:"Off",overrides:{reflections:{reflectionMode:0,bounceShadows:!1}},estCompileMs:0},{label:"Env Map",overrides:{reflections:{reflectionMode:1,bounceShadows:!1}},estCompileMs:0},{label:"Raymarched",overrides:{reflections:{reflectionMode:3,bounceShadows:!1,bounces:1}},estCompileMs:7500},{label:"Full",overrides:{reflections:{reflectionMode:3,bounceShadows:!0,bounces:2}},estCompileMs:12e3}]},Ot={id:"lighting_quality",label:"Lighting",isAdvanced:!0,controlledParams:["lighting.specularModel","lighting.ptEnabled","lighting.ptNEEAllLights","lighting.ptEnvNEE"],tiers:[{label:"Preview",overrides:{lighting:{advancedLighting:!1,ptEnabled:!1}},estCompileMs:-2500},{label:"Path Traced",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!1,ptEnvNEE:!1}},estCompileMs:1900},{label:"PT + NEE",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!0,ptEnvNEE:!0}},estCompileMs:2500}]},Vt={id:"atmosphere_quality",label:"Atmosphere",controlledParams:["atmosphere.glowEnabled","atmosphere.glowQuality","volumetric.ptVolumetric"],tiers:[{label:"Off",overrides:{atmosphere:{glowEnabled:!1},volumetric:{ptVolumetric:!1}},estCompileMs:0},{label:"Fast Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:1},volumetric:{ptVolumetric:!1}},estCompileMs:200},{label:"Color Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!1}},estCompileMs:400},{label:"Volumetric",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!0}},estCompileMs:5900}]},fe=[Lt,kt,Ot,Vt],ue=[{id:"preview",label:"Preview",description:"Instant preview shader — navigate without waiting for compile.",subsystems:{shadows:0,reflections:0,lighting_quality:0,atmosphere_quality:0}},{id:"fastest",label:"Fastest",description:"Hard shadows, path traced lighting with fast glow.",subsystems:{shadows:1,reflections:0,lighting_quality:1,atmosphere_quality:1}},{id:"lite",label:"Lite",description:"Soft shadows, env map reflections, color glow.",subsystems:{shadows:2,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"balanced",label:"Balanced",description:"Full shadows, env map reflections, color glow.",subsystems:{shadows:3,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"full",label:"Full",description:"Full shadows, raymarched reflections, volumetric.",subsystems:{shadows:3,reflections:3,lighting_quality:1,atmosphere_quality:3}},{id:"ultra",label:"Ultra",description:"Full + PT NEE. Experimental.",isAdvanced:!0,subsystems:{shadows:3,reflections:3,lighting_quality:2,atmosphere_quality:3}}];({...ue[3].subsystems});function Nt(e){return ue.find(t=>t.id===e)}function Fo(e){if(!e.activePreset)return"Custom";const t=Nt(e.activePreset);if(!t)return"Custom";if(!e.isCustomized)return t.label;const a=[];for(const o of fe){const i=t.subsystems[o.id],r=e.subsystems[o.id];if(i!==r){const n=o.tiers[r];a.push(`${o.label}=${(n==null?void 0:n.label)??"?"}`)}}return`${t.label} (${a.join(", ")})`}const jt=4200;function Mo(e){let t=jt;for(const a of fe){const o=e[a.id]??0,i=a.tiers[o];i&&(t+=i.estCompileMs)}return t}const Gt=(e,t)=>{if(!e)return`
...
`,capabilities:new Set(["shape:per-iteration","iter:c-constant","render:writes-trap","render:writes-iter"])},parameters:[{label:"Klein R",id:"paramA",min:.5,max:3,step:.001,default:1.9605},{label:"Klein I",id:"paramB",min:-2,max:2,step:.001,default:.0179},{label:"Scale",id:"paramC",min:.1,max:3,step:.001,default:1},{label:"Rot Z",id:"paramD",min:-2,max:2,step:.001,default:0},{label:"DE Min",id:"paramE",min:.01,max:1,step:.001,default:.056},{label:"Twist",id:"paramF",min:-5,max:5,step:.01,default:0},{label:"Box Size XZ",id:"vec2A",type:"vec2",min:-4,max:4,step:.001,default:{x:-.9702,y:.526}},{label:"Inv Sphere (xyz=center, w=radius)",id:"vec4A",type:"vec4",min:-3,max:3,step:.001,default:{x:-.18,y:1.032,z:1.022,w:1.147}},{label:"Box Offset",id:"vec3C",type:"vec3",min:-3,max:3,step:.001,default:{x:0,y:0,z:0}}],defaultPreset:{formula:"KleinianJos",features:{coreMath:{iterations:24,paramA:1.9605,paramB:.0179,paramC:1,paramD:0,paramE:.056,paramF:0,vec2A:{x:-.9702,y:.526},vec4A:{x:-.18,y:1.032,z:1.022,w:1.147},vec3C:{x:0,y:0,z:0}},coloring:{mode:0,gradient:[{id:"kj0",position:0,color:"#050210",bias:.5,interpolation:"linear"},{id:"kj1",position:.3,color:"#1A3060",bias:.5,interpolation:"linear"},{id:"kj2",position:.6,color:"#4090C0",bias:.5,interpolation:"linear"},{id:"kj3",position:.85,color:"#90D0F0",bias:.5,interpolation:"linear"},{id:"kj4",position:1,color:"#F0F8FF",bias:.5,interpolation:"linear"}],scale:3,offset:0,repeats:1,phase:0,bias:1,twist:0,escape:2,gradient2:[{id:"1",position:0,color:"#000000",bias:.5,interpolation:"linear"},{id:"2",position:1,color:"#ffffff",bias:.5,interpolation:"linear"}],mode2:0,blendMode:0,blendOpacity:0,layer3Color:"#ffffff",layer3Scale:89,layer3Strength:0,layer3Bump:0,layer3Turbulence:0},atmosphere:{fogIntensity:.5,fogNear:0,fogFar:20,fogColor:"#020408",fogDensity:.05,glowIntensity:0,glowSharpness:3,glowMode:!1,glowColor:"#ffffff",aoIntensity:.3,aoSpread:.1,aoMode:!1},lighting:{shadows:!0,shadowSoftness:12,shadowIntensity:1,shadowBias:.002},quality:{detail:2,fudgeFactor:.9,pixelThreshold:.5,maxSteps:220,estimator:1,distanceMetric:0},geometry:{juliaMode:!0},materials:{diffuse:1.2,reflection:.05,specular:.8,roughness:.55,rim:.1,rimExponent:3,envStrength:0,envBackgroundStrength:1,envSource:1,useEnvMap:!1,envRotation:0,emission:0,emissionMode:0,emissionColor:"#ffffff",envGradientStops:[{id:"bg0",position:0,color:"#050210"},{id:"bg1",position:.5,color:"#0A1830"},{id:"bg2",position:1,color:"#050210"}]},optics:{camFov:60,dofStrength:0,dofFocus:5}},cameraPos:{x:0,y:0,z:0},cameraRot:{x:.763,y:-.1644,z:0,w:.6254},sceneOffset:{x:.42,y:1.6998,z:2.3338,xL:0,yL:0,zL:0},targetDistance:1.587,cameraMode:"Orbit",lights:[{type:"Point",position:{x:10,y:10,z:10},rotation:{x:0,y:0,z:0},color:"#FFFFFF",intensity:3.6,falloff:.5,falloffType:"Quadratic",fixed:!0,visible:!0,castShadow:!0},{type:"Point",position:{x:-10,y:-10,z:-10},rotation:{x:0,y:0,z:0},color:"#AACCFF",intensity:1,falloff:.5,falloffType:"Quadratic",fixed:!0,visible:!0,castShadow:!1}]}},mo={id:"SineJulia3D",name:"Sine Julia 3D",shortDescription:"Julia sets of a 3D extension of s·sin(z)+c (amoser). Kleinian-like limit-set forms.",description:`Julia sets of a 3D extension of the complex family s·sin(z)+c. The 3D map and its distance estimator are from amoser's "Sine Fractal 3D" Shadertoy (2026, CC-BY-NC-SA); the family is discussed on fractalforums.org thread 5591, where Pupukuusikko developed an independent DE. The map is not conformal, so the Julia sets stretch and distort — but for many parameters they look strikingly like Kleinian limit groups. A pre-iteration sphere inversion and per-axis rotation control the framing. Only the formula + DE are ported; shading is GMT's standard pipeline, not the original Shadertoy's post-stack.`,juliaType:"julia",shader:{preamble:`
   ...
   */
`,be=e=>JSON.stringify(e,null,2).replace(/\{\n\s+"label":[\s\S]+?\}/g,t=>t.includes('"id": "param')?t.replace(/\n\s+/g," "):t).replace(/"(cameraPos|cameraRot|sceneOffset|julia|position)": \{\n\s+"[xyz]":[\s\S]+?\}/g,t=>t.replace(/\n\s+/g," ")).replace(/"params": \{\n\s+"A":[\s\S]+?\}/g,t=>t.replace(/\n\s+/g," ")),P=e=>{const t=e.split(`
`);for(;t.length>0&&t[0].trim()==="";)t.shift();for(;t.length>0&&t[t.length-1].trim()==="";)t.pop();if(t.length===0)return"";if(t.length===1)return t[0].trim();let a=1/0;for(const o of t){if(o.trim().length===0)continue;const i=o.match(/^(\s*)/);i&&(a=Math.min(a,i[1].length))}return a===0||a===1/0?t.join(`
`):t.map(o=>o.slice(a)).join(`
`)},yo=(e,t)=>{var d;const{shader:a,...o}=e,i={};(d=a.preambleVars)!=null&&d.length&&(i.preambleVars=a.preambleVars),a.usesSharedRotation&&(i.usesSharedRotation=!0),a.supportsCuttingPlane&&(i.supportsCuttingPlane=!0),a.selfContainedSDE&&(i.selfContainedSDE=!0),a.capabilities&&a.capabilities.size>0&&(i.capabilities=[...a.capabilities].sort());const r={...o,...Object.keys(i).length>0?{shaderMeta:i}:{},defaultPreset:t};let n=`<!--
...
`,a.preamble&&(n+=`<!-- Global scope code: variables and helper functions (before formula) -->
`,n+=`<Shader_Preamble>
${P(a.preamble)}
</Shader_Preamble>

`),a.loopInit&&(n+=`<!-- Code executed once before the loop (Setup) -->
`,n+=`<Shader_Init>
${P(a.loopInit)}
</Shader_Init>
...
`,a.getDist&&(n+=`<!-- Optional: Custom Distance/Iteration Smoothing -->
`,n+=`<Shader_Dist>
${P(a.getDist)}
</Shader_Dist>

`),n},bo=e=>{const t=l=>{const b=new RegExp(`<${l}>([\\s\\S]*?)<\\/${l}>`),h=e.match(b);return h?h[1].trim():null},a=t("Metadata");if(!a){try{const l=JSON.parse(e);if(l.id&&l.shader)return l}catch{}throw new Error("Invalid GMF: Missing Metadata tag")}const o=JSON.parse(a),i=t("Shader_Preamble"),r=t("Shader_Function"),n=t("Shader_Loop"),d=t("Shader_Init"),p=t("Shader_Dist");if((!r||!n)&&o.id!=="Modular")throw new Error("Invalid GMF: Missing essential shader blocks (<Shader_Function> or <Shader_Loop>)");const s={function:r??"",loopBody:n??"",preamble:i||void 0,loopInit:d||void 0,getDist:p||void 0};if(o.shaderMeta&&(o.shaderMeta.preambleVars&&(s.preambleVars=o.shaderMeta.preambleVars),o.shaderMeta.usesSharedRotation&&(s.usesSharedRotation=!0),o.shaderMeta.supportsCuttingPlane&&(s.supportsCuttingPlane=!0),o.shaderMeta.selfContainedSDE&&(s.selfContainedSDE=!0),Array.isArray(o.shaderMeta.capabilities)&&(s.capabilities=new Set(o.shaderMeta.capabilities)),delete o.shaderMeta),!s.supportsCuttingPlane){const l=`${s.function} ${s.loopBody} ${s.preamble||""} ${s.loopInit||""}`;/\bcp_(dmin|scale|trap)\b/.test(l)&&(s.supportsCuttingPlane=!0)}if(!s.capabilities){const l=new Set;o.id==="Modular"?l.add("shape:modular"):(l.add(s.selfContainedSDE?"shape:self-contained":"shape:per-iteration"),s.usesSharedRotation&&l.add("iter:shared-rotation"),s.supportsCuttingPlane&&l.add("estimator:cutting-plane")),s.capabilities=l}return{...o,shader:s}},vo=e=>{const t=e.trimStart();return t.startsWith("<!--")||t.startsWith("<Metadata>")},Eo=e=>{const t=x.get(e.formula);if(!t)return JSON.stringify(e,null,2);let a=yo(t,t.defaultPreset);return a+=`<!-- Full scene state (camera, lights, features, quality, animations) -->
`,a+=`<Scene>
${be(e)}
</Scene>
`,a},To=e=>{if(vo(e)){const a=bo(e),o=e.match(/<Scene>([\s\S]*?)<\/Scene>/);if(o){const r=JSON.parse(o[1].trim());return{def:a,preset:r}}const i=a.defaultPreset||{formula:a.id};return i.formula||(i.formula=a.id),{def:a,preset:i}}return{preset:JSON.parse(e)}};export{fe as A,lt as F,R as I,Ga as J,ue as S,Co as a,u as b,Mo as c,Fo as d,Po as e,dt as f,yo as g,bt as h,xt as i,vt as j,zt as k,To as l,va as m,Io as n,Oe as p,yt as r,Eo as s,xa as u};
