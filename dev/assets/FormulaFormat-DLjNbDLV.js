var ze=Object.defineProperty;var Se=(e,t,a)=>t in e?ze(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var V=(e,t,a)=>Se(e,typeof t!="symbol"?t+"":t,a);import{H as A,b4 as I,U as y,$ as m,f,b5 as _e,b6 as we,b7 as Fe,b8 as Me,b9 as Ie,ba as Ce}from"./CollapsibleSection-6nKWBs7U.js";import{n as _,d as B,p as Pe,q as Ee,r as X,s as U,c as g,l as N}from"./three-DQWx7qFd.js";const Y=`
...
`,extraParams:{hybridFoldingValue:{type:"vec3",default:new g(2,2,2),label:"Folding Value",shortId:"hfv",uniform:"uHybridFoldingValue",min:.1,max:5,step:.01,group:"hybrid"}},defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2,hybridFoldingValue:{x:2,y:2,z:2}}},Ye={id:"kali",label:"Kali",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = uHybridKaliConstant - abs(z);
}
`,rotMode:"post",extraParams:{hybridKaliConstant:{type:"vec3",default:new g(1,1,1),label:"Kali Constant",shortId:"hkc",uniform:"uHybridKaliConstant",min:-3,max:3,step:.01,group:"hybrid"}},defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.6,hybridFixedR:1,hybridIter:3,hybridKaliConstant:{x:.5,y:.5,z:.5}}},We={id:"tetra",label:"Tetrahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    if (z.x + z.y < 0.0) z.xy = -z.yx;
    if (z.x + z.z < 0.0) z.xz = -z.zx;
    if (z.y + z.z < 0.0) z.yz = -z.zy;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.25,hybridFixedR:1,hybridIter:3}},Qe={id:"octa",label:"Octahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},Ke={id:"icosa",label:"Icosahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:4}},Je={id:"menger",label:"Menger (Cubic)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,selfContained:!0,extraParams:{hybridMengerOffset:{type:"vec3",default:new g(1,1,1),label:"Offset",shortId:"hmo",uniform:"uHybridMengerOffset",min:0,max:2,step:.01,group:"hybrid",linkable:!0},hybridMengerCenterZ:{type:"boolean",default:!0,label:"Center Z",shortId:"hmz",uniform:"uHybridMengerCenterZ",group:"hybrid"}},defaults:{hybridScale:3,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3,hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0}},k=[$e,Ze,Xe,Ue,Ye,We,Qe,Ke,Je],et=k.map((e,t)=>({label:e.label,value:t}));function tt(e){return k[e]??k[0]}const at=`
...
`;class ot{constructor(){V(this,"definitions",new Map)}register(t){this.definitions.set(t.id,t)}registerAlias(t,a){const o=this.definitions.get(a);o?this.definitions.set(t,o):console.warn(`FractalRegistry: Cannot register alias '${t}' for unknown target '${a}'`)}get(t){return this.definitions.get(t)}getAll(){return Array.from(new Set(this.definitions.values()))}getIds(){return Array.from(this.definitions.keys())}}const x=new ot,it=["xyz","xzy","yxz","yzx","zxy","zyx"];function rt(e){const t=it[e]??"xyz";return t==="xyz"?"vec3 c_perm = c.xyz;":`vec3 c_perm = c.${t};`}function nt(e,t,a=!1){return`
mat3 hybridRotMat;
bool hybridHasRot;
...
`,l+=`
                ...
                `}e.addHybridFold("",n,l)}},K=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF"],J=["uVec2A","uVec2B","uVec2C"],ee=["uVec3A","uVec3B","uVec3C"],te=["uVec4A","uVec4B","uVec4C"],re=["uInterlaceParamA","uInterlaceParamB","uInterlaceParamC","uInterlaceParamD","uInterlaceParamE","uInterlaceParamF"],ne=["uInterlaceVec2A","uInterlaceVec2B","uInterlaceVec2C"],le=["uInterlaceVec3A","uInterlaceVec3B","uInterlaceVec3C"],se=["uInterlaceVec4A","uInterlaceVec4B","uInterlaceVec4C"];function dt(){const e=[];for(let t=0;t<K.length;t++)e.push([new RegExp(`\\b${K[t]}\\b`,"g"),re[t]]);for(let t=0;t<J.length;t++)e.push([new RegExp(`\\b${J[t]}\\b`,"g"),ne[t]]);for(let t=0;t<ee.length;t++)e.push([new RegExp(`\\b${ee[t]}\\b`,"g"),le[t]]);for(let t=0;t<te.length;t++)e.push([new RegExp(`\\b${te[t]}\\b`,"g"),se[t]]);return e}const ct=dt();function q(e){let t=e;for(const[a,o]of ct)t=t.replace(a,o);return t}function O(e,t){const a=[...t].sort((i,r)=>r.length-i.length);let o=e;for(const i of a)o=o.replace(new RegExp(`\\b${i}\\b`,"g"),`interlace_${i}`);return o}function L(e){const t=[],a=/\b(?:void|vec[234]|float|int|mat[234]|bool)\s+(\w+)\s*\(/g,o=/^\s*(?:const\s+)?(?:vec[234]|float|int|mat[234]|bool)\s+([^;]+);/,i=/^\s*(\w+)/;let r=0;for(const n of e.split(`
`)){if(r===0){a.lastIndex=0;let l;for(;(l=a.exec(n))!==null;){const d=l[1];!d.startsWith("formula_")&&!t.includes(d)&&t.push(d)}const p=o.exec(n);if(p){const d=[];let s=0,b="";for(const h of p[1]){if(h==="(")s++;else if(h===")")s--;else if(h===","&&s===0){d.push(b),b="";continue}b+=h}b&&d.push(b);for(const h of d){const c=i.exec(h);c&&!t.includes(c[1])&&t.push(c[1])}}}for(const l of n)l==="{"?r++:l==="}"&&r--}return t}function pt(e,t,a){let o=e;o=o.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`);const i=L(e);for(const r of i)o=o.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return a&&a.length>0&&(o=O(o,a)),o=q(o),o}function ft(e,t,a,o){let i=e;if(i=i.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace"),i=q(i),a&&a.length>0&&(i=O(i,a)),o&&o.length>0)for(const r of o)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function ut(e,t,a){let o=e.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace");return a&&a.length>0&&(o=O(o,a)),o}function mt(e,t,a,o){let i=e;if(i=i.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`),i=q(i),a&&a.length>0&&(i=O(i,a)),o&&o.length>0)for(const r of o)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function ht(e,t,a){let o="";t&&(o=`
...
`});u.register({id:"Custom",label:"Custom (Legacy)",category:"Utils",description:"Legacy node.",inputs:[],glsl:e=>""});const St=e=>{const t=new Map;return e.forEach(a=>{t.has(a.target)||t.set(a.target,[]),t.get(a.target).push(a)}),t},_t=e=>{const t=new Set,a=["root-end"],o=new Set;for(;a.length>0;){const i=a.pop();o.has(i)||(o.add(i),i!=="root-end"&&i!=="root-start"&&t.add(i),(e.get(i)??[]).forEach(r=>a.push(r.source)))}return t},wt=(e,t)=>{const a=St(t),o=_t(a),i=e.filter(s=>o.has(s.id));if(!i||i.length===0)return`
    ...
    `;const n=new Map;n.set("root-start","v_start");let l=0;i.forEach((s,b)=>{const c=`v_${s.id.replace(/[^a-zA-Z0-9]/g,"")}`;n.set(s.id,c);const v=a.get(s.id)??[],M=v.find(F=>!F.targetHandle||F.targetHandle==="a"),E=v.find(F=>F.targetHandle==="b"),T=M&&n.get(M.source)||"v_start",be=E&&n.get(E.source)||"v_start";if(r+=`    // Node: ${s.type} (${s.id})
`,r+=`    vec3 ${c}_p = ${T}_p;
`,r+=`    float ${c}_d = ${T}_d;
`,r+=`    float ${c}_dr = ${T}_dr;
`,s.enabled){const F=u.get(s.type);if(F){const $=s.condition&&s.condition.active;let Z="    ";if($){const D=l<I?`uModularParams[${l++}]`:"2.0",xe=l<I?`uModularParams[${l++}]`:"0.0";r+=`    { int ${c}_cmod = max(1, int(${D})); int ${c}_crem = int(${xe});
`,r+=`    if ( (i - (i/${c}_cmod)*${c}_cmod) == ${c}_crem ) {
`,Z="        "}const ve=D=>s.bindings&&s.bindings[D]?`u${s.bindings[D]}`:l<I?`uModularParams[${l++}]`:"0.0";r+=F.glsl({varName:c,in1:T,in2:be,getParam:ve,indent:Z}),$&&(r+=`    }}
`)}}r+=`
`});const p=t.find(s=>s.target==="root-end");let d="v_start";return p&&p.source!=="root-start"&&(d=n.get(p.source)||"v_start"),r+=`
    z.xyz = ${d}_p;
    dr = ${d}_dr;
...
cp_scale = 1.0;
cp_trap = 1e10;
`,Ct={id:"coreMath",shortId:"cm",name:"Formula Math",category:"Formulas",tabConfig:{label:"Formula"},extraUniforms:[{name:y.ModularParams,type:"float",arraySize:I,default:new Float32Array(I),backingOnly:!0}],params:{iterations:{type:"float",default:16,label:"Iterations",shortId:"it",uniform:"uIterations",min:1,max:500,step:1,group:"main"},paramA:{type:"float",default:8,label:"Param A",shortId:"pa",uniform:"uParamA",min:-10,max:10,step:.001,group:"params"},paramB:{type:"float",default:0,label:"Param B",shortId:"pb",uniform:"uParamB",min:-10,max:10,step:.001,group:"params"},paramC:{type:"float",default:0,label:"Param C",shortId:"pc",uniform:"uParamC",min:-10,max:10,step:.001,group:"params"},paramD:{type:"float",default:0,label:"Param D",shortId:"pd",uniform:"uParamD",min:-10,max:10,step:.001,group:"params"},paramE:{type:"float",default:0,label:"Param E",shortId:"pe",uniform:"uParamE",min:-10,max:10,step:.001,group:"params"},paramF:{type:"float",default:0,label:"Param F",shortId:"pf",uniform:"uParamF",min:-10,max:10,step:.001,group:"params"},vec2A:{type:"vec2",default:{x:0,y:0},label:"Vec2 A",shortId:"v2a",uniform:"uVec2A",min:-10,max:10,step:.001,group:"params"},vec2B:{type:"vec2",default:{x:0,y:0},label:"Vec2 B",shortId:"v2b",uniform:"uVec2B",min:-10,max:10,step:.001,group:"params"},vec2C:{type:"vec2",default:{x:0,y:0},label:"Vec2 C",shortId:"v2c",uniform:"uVec2C",min:-10,max:10,step:.001,group:"params"},vec3A:{type:"vec3",default:new g(0,0,0),label:"Vec3 A",shortId:"v3a",uniform:"uVec3A",min:-10,max:10,step:.001,group:"params"},vec3B:{type:"vec3",default:new g(0,0,0),label:"Vec3 B",shortId:"v3b",uniform:"uVec3B",min:-10,max:10,step:.001,group:"params"},vec3C:{type:"vec3",default:new g(0,0,0),label:"Vec3 C",shortId:"v3c",uniform:"uVec3C",min:-10,max:10,step:.001,group:"params"},vec4A:{type:"vec4",default:new N(0,0,0,0),label:"Vec4 A",shortId:"v4a",uniform:"uVec4A",min:-10,max:10,step:.001,group:"params"},vec4B:{type:"vec4",default:new N(0,0,0,0),label:"Vec4 B",shortId:"v4b",uniform:"uVec4B",min:-10,max:10,step:.001,group:"params"},vec4C:{type:"vec4",default:new N(0,0,0,0),label:"Vec4 C",shortId:"v4c",uniform:"uVec4C",min:-10,max:10,step:.001,group:"params"}},inject:(e,t)=>{var c;const a=t.formula,o=t.quality;a==="Modular"&&(e.addDefine("PIPELINE_REV",(t.pipelineRevision||0).toString()),e.addUniform(y.ModularParams,"float",I));const i=x.get(a);i!=null&&i.shader.selfContainedSDE&&(e.addDefine("SKIP_PRE_BAILOUT","1"),e.addDefine("SELF_CONTAINED_SDE","1"));let r="",n="",l="";const p=t.interlace,d=p!=null&&p.interlaceCompiled&&p.interlaceFormula?x.get(p.interlaceFormula):void 0,s=!!(i!=null&&i.shader.supportsCuttingPlane)||!!(d!=null&&d.shader.supportsCuttingPlane),b=(o==null?void 0:o.estimator)||0;let h=Ft(b,s);if(a==="Modular"){const v=wt(t.pipeline||[],((c=t.graph)==null?void 0:c.edges)||[]);r+=v+`
...
`,n=i.shader.loopBody,l=i.shader.loopInit||"",i.shader.preamble&&e.addPreamble(i.shader.preamble),s&&(e.addPreamble(Mt),l=It+l),i.shader.getDist&&b<4.5&&(h=`vec2 getDist(float r, float dr, float iter, vec4 z) { ${i.shader.getDist} }`));e.addFunction(r),e.setFormula(n,l,h)}};let Pt=0;function C(){return`l${++Pt}`}const Et={id:"shadows",label:"Shadows",renderContext:"direct",controlledParams:["lighting.shadowsCompile","lighting.shadowAlgorithm","lighting.ptStochasticShadows"],tiers:[{label:"Off",overrides:{lighting:{shadows:!1,shadowsCompile:!1,ptStochasticShadows:!1}},estCompileMs:0},{label:"Hard",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:2,ptStochasticShadows:!1}},estCompileMs:500},{label:"Soft",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!1}},estCompileMs:3e3},{label:"Full",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!0}},estCompileMs:3800}]},Tt={id:"reflections",label:"Reflections (Direct)",renderContext:"direct",controlledParams:["reflections.reflectionMode","reflections.bounceShadows","reflections.bounces"],tiers:[{label:"Off",overrides:{reflections:{reflectionMode:0,bounceShadows:!1}},estCompileMs:0},{label:"Env Map",overrides:{reflections:{reflectionMode:1,bounceShadows:!1}},estCompileMs:0},{label:"Raymarched",overrides:{reflections:{reflectionMode:3,bounceShadows:!1,bounces:1}},estCompileMs:7500},{label:"Full",overrides:{reflections:{reflectionMode:3,bounceShadows:!0,bounces:2}},estCompileMs:12e3}]},Dt={id:"lighting_quality",label:"Lighting",isAdvanced:!0,controlledParams:["lighting.specularModel","lighting.ptEnabled","lighting.ptNEEAllLights","lighting.ptEnvNEE"],tiers:[{label:"Preview",overrides:{lighting:{advancedLighting:!1,ptEnabled:!1}},estCompileMs:-2500},{label:"Path Traced",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!1,ptEnvNEE:!1}},estCompileMs:1900},{label:"PT + NEE",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!0,ptEnvNEE:!0}},estCompileMs:2500}]},At={id:"atmosphere_quality",label:"Atmosphere",controlledParams:["atmosphere.glowEnabled","atmosphere.glowQuality","volumetric.ptVolumetric"],tiers:[{label:"Off",overrides:{atmosphere:{glowEnabled:!1},volumetric:{ptVolumetric:!1}},estCompileMs:0},{label:"Fast Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:1},volumetric:{ptVolumetric:!1}},estCompileMs:200},{label:"Color Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!1}},estCompileMs:400},{label:"Volumetric",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!0}},estCompileMs:5900}]},pe=[Et,Tt,Dt,At],fe=[{id:"preview",label:"Preview",description:"Instant preview shader — navigate without waiting for compile.",subsystems:{shadows:0,reflections:0,lighting_quality:0,atmosphere_quality:0}},{id:"fastest",label:"Fastest",description:"Path traced lighting with fast glow.",subsystems:{shadows:0,reflections:0,lighting_quality:1,atmosphere_quality:1}},{id:"lite",label:"Lite",description:"Hard shadows, env map reflections, color glow.",subsystems:{shadows:1,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"balanced",label:"Balanced",description:"Soft shadows, env map reflections, color glow.",subsystems:{shadows:2,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"full",label:"Full",description:"Full shadows, raymarched reflections, volumetric.",subsystems:{shadows:3,reflections:3,lighting_quality:1,atmosphere_quality:3}},{id:"ultra",label:"Ultra",description:"Full + PT NEE. Experimental.",isAdvanced:!0,subsystems:{shadows:3,reflections:3,lighting_quality:2,atmosphere_quality:3}}];({...fe[3].subsystems});function Rt(e){return fe.find(t=>t.id===e)}function uo(e){if(!e.activePreset)return"Custom";const t=Rt(e.activePreset);if(!t)return"Custom";if(!e.isCustomized)return t.label;const a=[];for(const o of pe){const i=t.subsystems[o.id],r=e.subsystems[o.id];if(i!==r){const n=o.tiers[r];a.push(`${o.label}=${(n==null?void 0:n.label)??"?"}`)}}return`${t.label} (${a.join(", ")})`}const Lt=4200;function mo(e){let t=Lt;for(const a of pe){const o=e[a.id]??0,i=a.tiers[o];i&&(t+=i.estCompileMs)}return t}const Bt=(e,t)=>{if(!e)return`
...
`,oa={id:"reflections",shortId:"rf",name:"Reflections",category:"Rendering",engineConfig:{toggleParam:"enabled",mode:"compile",label:"Reflection Tracing",groupFilter:"engine_settings"},groups:{shading:{label:"Reflections",description:"Screen-space reflection tracing for glossy surfaces.",helpId:"render.reflections"}},params:{reflectionMode:{type:"float",default:j,label:"Reflection Method",shortId:"rm",group:"engine_settings",options:[{label:"Off",value:oe,estCompileMs:0},{label:"Environment Map",value:j,estCompileMs:0},{label:"Raymarched (Quality)",value:w,estCompileMs:7500}],description:"Reflection technique. Higher quality = longer compile time. Raymarched adds ~9s.",onUpdate:"compile",noReset:!0},bounceShadows:{type:"boolean",default:!1,label:"Bounce Shadows",shortId:"bs",group:"engine_settings",ui:"checkbox",condition:{param:"reflectionMode",eq:w},description:"Compute shadows on reflected surfaces. Adds ~3-4s compile time.",onUpdate:"compile",noReset:!0,estCompileMs:4500},mixStrength:{type:"float",default:1,label:"Raymarch Mix",shortId:"mx",uniform:"uReflStrength",min:0,max:1,step:.01,group:"engine_settings",condition:{param:"reflectionMode",eq:w},description:"Blends between Raymarched Reflections (1.0) and Environment Map (0.0)."},roughnessThreshold:{type:"float",default:.62,label:"Roughness Cutoff",shortId:"rc",uniform:"uReflRoughnessCutoff",min:0,max:1,step:.01,group:"engine_settings",condition:{param:"reflectionMode",eq:w},description:"Surfaces rougher than this will skip raymarching to save performance."},bounces:{type:"int",default:1,label:"Max Bounces",shortId:"rb",min:1,max:3,step:1,group:"engine_settings",uniform:"uReflBounces",ui:"numeric",description:"Maximum recursion depth. Clamped to 3. Default 1 for performance.",noReset:!0,onUpdate:"compile",condition:{param:"reflectionMode",eq:w}},steps:{type:"int",default:64,label:"Trace Steps",shortId:"rs",min:16,max:128,step:8,group:"engine_settings",uniform:"uReflSteps",ui:"numeric",description:"Precision of the reflection ray.",noReset:!0,condition:{param:"reflectionMode",eq:w}},enabled:{type:"boolean",default:!0,label:"Enable Reflections",shortId:"re",group:"main",hidden:!0,noReset:!0,onUpdate:"compile"}},inject:(e,t,a)=>{if(a!=="Main")return;const o=t.reflections;if(!o||o.enabled===!1)return;const i=o.reflectionMode??j;if(i!==oe){if(i!==w){e.addShadingLogic(ta);return}if(i===w){e.addPostDEFunction(ea());const r=Math.max(1,Math.min(3,o.bounces??1));e.addDefine("MAX_REFL_BOUNCES",r.toString()),o.bounceShadows&&e.addDefine("REFL_BOUNCE_SHADOWS","1"),e.addShadingLogic(aa)}}}},ia=`
// --- WATER PLANE LOGIC ---
...
This rotation is bound to 'ParamC' (Slider below). Try dragging it!`},{id:"rot-1",type:"Rotate",enabled:!0,params:{x:0,y:0,z:0},bindings:{z:"ParamC"}},{id:"bulb-1",type:"Mandelbulb",enabled:!0,params:{power:8}},{id:"add-c",type:"AddConstant",enabled:!0,params:{scale:1}}],Ra={id:"Modular",name:"Modular Builder",shortDescription:"Construct custom fractal equations using a Node Graph.",description:"Construct your own fractal equation by chaining operations together. Combine folds, rotations, and logic via the Graph tab.",juliaType:"julia",shader:{function:"",loopBody:"",getDist:""},parameters:[null,null,null,null],defaultPreset:{formula:"Modular",features:{coreMath:{iterations:16,paramA:8,paramB:0,paramC:0,paramD:0,paramE:0,paramF:0},lighting:{shadows:!0,shadowSoftness:16,shadowIntensity:1,shadowBias:.002}},pipeline:Aa,cameraPos:{x:0,y:0,z:4},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:0,xL:0,yL:0,zL:0}}},La={id:"MandelTerrain",name:"MandelTerrain",shortDescription:'3D Heightmap of the Mandelbrot set. Creates alien landscapes and "Math Mountains".',description:"A 3D Heightmap of the Mandelbrot set. Iterations slider controls terrain detail.",juliaType:"julia",shader:{function:`
...
#ifdef TRAP_ENABLED
            // c-plane orbit projected to XZ (Y=0) so 3D trap shapes evaluate
            // against the same plane the terrain renders on. Skip i=0 (z2 is
            // the raw sample, projecting the trap shape onto every surface).
            // uColorIter freezes accumulation past the cap, matching the
            // savedGeomTrap snapshot path used for non-self-contained
            // formulas in de.ts. Self-contained — de.ts skips the outer trap.
            if (i > 0 && (uColorIter < 0.5 || float(i) <= uColorIter)) {
                g_geomTrap = min(g_geomTrap, trapDistance(vec3(z2.x, 0.0, z2.y)));
            }
#endif
...
`)},no=(e,t)=>{var l;const{shader:a,...o}=e,i={};(l=a.preambleVars)!=null&&l.length&&(i.preambleVars=a.preambleVars),a.usesSharedRotation&&(i.usesSharedRotation=!0);const r={...o,...Object.keys(i).length>0?{shaderMeta:i}:{},defaultPreset:t};let n=`<!--
...
`),n},lo=e=>{const t=s=>{const b=new RegExp(`<${s}>([\\s\\S]*?)<\\/${s}>`),h=e.match(b);return h?h[1].trim():null},a=t("Metadata");if(!a){try{const s=JSON.parse(e);if(s.id&&s.shader)return s}catch{}throw new Error("Invalid GMF: Missing Metadata tag")}const o=JSON.parse(a),i=t("Shader_Preamble"),r=t("Shader_Function"),n=t("Shader_Loop"),l=t("Shader_Init"),p=t("Shader_Dist");if((!r||!n)&&o.id!=="Modular")throw new Error("Invalid GMF: Missing essential shader blocks (<Shader_Function> or <Shader_Loop>)");const d={function:r??"",loopBody:n??"",preamble:i||void 0,loopInit:l||void 0,getDist:p||void 0};return o.shaderMeta&&(o.shaderMeta.preambleVars&&(d.preambleVars=o.shaderMeta.preambleVars),o.shaderMeta.usesSharedRotation&&(d.usesSharedRotation=!0),delete o.shaderMeta),{...o,shader:d}},so=e=>{const t=e.trimStart();return t.startsWith("<!--")||t.startsWith("<Metadata>")},bo=e=>{const t=x.get(e.formula);if(!t)return JSON.stringify(e,null,2);let a=no(t,t.defaultPreset);return a+=`<!-- Full scene state (camera, lights, features, quality, animations) -->
`,a+=`<Scene>
${ye(e)}
</Scene>
`,a},vo=e=>{if(so(e)){const a=lo(e),o=e.match(/<Scene>([\s\S]*?)<\/Scene>/);if(o){const r=JSON.parse(o[1].trim());return{def:a,preset:r}}const i=a.defaultPreset||{formula:a.id};return i.formula||(i.formula=a.id),{def:a,preset:i}}return{preset:JSON.parse(e)}};export{pe as A,R as I,Aa as J,fe as S,go as a,u as b,mo as c,uo as d,yo as e,at as f,no as g,pt as h,ft as i,mt as j,ut as k,vo as l,ht as m,ho as n,ua as o,x as r,bo as s};
