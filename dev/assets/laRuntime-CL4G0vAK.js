var I=Object.defineProperty;var D=(a,t,i)=>t in a?I(a,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):a[t]=i;var s=(a,t,i)=>D(a,typeof t!="symbol"?t+"":t,i);const W=256;class X{constructor(t){s(this,"mainTex",null);s(this,"collisionTex",null);s(this,"version",0);this.gl=t}getTexture(t){return t==="main"?this.mainTex:this.collisionTex}setBuffer(t,i){const e=this.gl,r=256*4;i.length!==r&&console.warn(`[GradientLut] ${t} buffer length ${i.length} (want ${r})`);let o=this.getTexture(t);o||(o=e.createTexture(),t==="main"?this.mainTex=o:this.collisionTex=o),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,o),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.REPEAT),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,256,1,0,e.RGBA,e.UNSIGNED_BYTE,i),this.version++}ensure(t){if(this.getTexture(t))return;const i=256,e=new Uint8Array(i*4);if(t==="main")for(let r=0;r<i;++r)e[r*4+0]=r,e[r*4+1]=r,e[r*4+2]=r,e[r*4+3]=255;else for(let r=0;r<i;++r)e[r*4+3]=255;this.setBuffer(t,e)}dispose(){const t=this.gl;this.mainTex&&(t.deleteTexture(this.mainTex),this.mainTex=null),this.collisionTex&&(t.deleteTexture(this.collisionTex),this.collisionTex=null)}}const A=(a,t)=>{const i=a+t,e=i-a,r=a-(i-e)+(t-e);return[i,r]},K=(a,t,i)=>{const[e,r]=A(a,i),[o,n]=A(e,t+r);return[o,n]},z=(a,t,i,e)=>{const[r,o]=A(a,-i),[n,l]=A(r,o+(t-e));return[n,l]},J=`
