var ut=Object.defineProperty;var dt=(r,e,i)=>e in r?ut(r,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):r[e]=i;var m=(r,e,i)=>dt(r,typeof e!="symbol"?e+"":e,i);import{j as We,f as B,r as pt,k as ft,m as k,u as w,a as Te,F as mt,i as ht,n as gt,l as xt,o as vt,P as bt,V as yt,e as _e,p as Tt,q as wt}from"./CollapsibleSection-CveZPWwR.js";import{r as C,j as u,R as Mt}from"./three-fiber-7P7NVz0J.js";import{a as fe,s as ne,v as St,q as Ke,t as Ct,S as Rt,E as At,D as Ft,b as Et,P as Dt,T as Pt,d as Be,e as kt,G as Lt,f as It,A as jt,r as zt,w as _t,i as Bt,h as Ot,j as Ut,k as Gt,l as Nt}from"./Undo-C79Y2JO_.js";import{V as Vt,i as Ht,a as Jt,c as Xt}from"./Camera-5bRs76XS.js";import{c as Zt}from"./three-drei-DUAUHEcP.js";import{H as Wt,a as Kt,M as qt,b as $t,c as Yt,d as Qt,e as ei,i as ti,h as ii,g as ri,f as oi}from"./index-DiHa8Dy1.js";import{a as q,b as O,u as qe,R as ai}from"./typedSlices-CZfiyILp.js";import{g as we,i as si,S as ni,C as li,a as ci,b as ui}from"./CompositionOverlayControls-CLUDzmQ-.js";import{r as di}from"./cameraKeyRegistry-CLZYDNwi.js";import"./three-DQWx7qFd.js";import"./pako-DwGzBETv.js";import"./ModulationEngine-BPMAuy12.js";import"./AudioAnalysisEngine-DyaB3DyZ.js";import"./renderPopupRegistry-DFd-6fyz.js";const pi=r=>r.charAt(0).toUpperCase()+r.slice(1).replace(/-/g," "),G=(r,e,i={})=>{const t=i.defaultIndex??0,o=r.map((n,l)=>{var c,d;return{label:((c=i.optionLabels)==null?void 0:c[n])??pi(n),value:l,hint:(d=i.optionHints)==null?void 0:d[n]}});return{config:{type:"float",default:t,label:e,options:o,...i.extra},fromIndex:n=>{const l=Math.floor(n??t);return l<0||l>=r.length||Number.isNaN(l)?r[t]:r[l]},values:r}},Ce=G(["julia","mandelbrot"],"Fractal Kind",{defaultIndex:1,optionHints:{julia:"Iterate z² + c with fixed c. Pixels are starting z values.",mandelbrot:"Iterate z² + c with z₀=0. Pixels are c values."}}),Me=Ce.values,fi=Ce.fromIndex,mi={id:"julia",name:"Fractal",category:"Fractal",tabConfig:{label:"Fractal"},customUI:[{componentId:"julia-c-picker",parentId:"juliaC",condition:{param:"kind",eq:0}}],params:{kind:Ce.config,juliaC:{type:"vec2",default:{x:-.36303304426511473,y:.16845183018751916},min:-2,max:2,step:.001,label:"Julia c",description:"Julia constant. Move me to reshape the entire fractal — and the forces it emits.",condition:{param:"kind",eq:0}},zoom:{type:"float",default:1.2904749020480561,min:1e-5,max:8,step:1e-4,scale:"log",label:"Zoom",description:"Zoom into the fractal. Scroll wheel + middle-click-drag on the canvas go much deeper (to 0.00001)."},center:{type:"vec2",default:{x:0,y:0},min:-2,max:2,step:.01,label:"Center",description:"Pan the fractal window."},centerLow:{type:"vec2",default:{x:0,y:0},min:-1,max:1,step:1e-12,label:"Center (low bits)",description:"Internal — sub-f64 pan accumulator.",hidden:!0},maxIter:{type:"int",default:310,min:16,max:512,step:1,label:"Iter",description:"More iterations → sharper escape gradients → finer force detail."},power:{type:"float",default:2,min:2,max:8,step:1,label:"Power",description:"z-power in the iteration. 2 = classic z²+c; higher exponents make more lobes."}}},hi=(r,e,i)=>{var n,l;const t=e.juliaC.x,o=e.juliaC.y,a=i["julia.juliaC_x"]??t,s=i["julia.juliaC_y"]??o;r.setParams({kind:fi(e.kind),juliaC:[a,s],maxIter:e.maxIter,power:e.power,center:[e.center.x,e.center.y],centerLow:[((n=e.centerLow)==null?void 0:n.x)??0,((l=e.centerLow)==null?void 0:l.y)??0],zoom:e.zoom})},gi=(r,e,i)=>{const t=i["julia.juliaC_x"]??e.juliaC.x,o=i["julia.juliaC_y"]??e.juliaC.y;r.setParams({juliaC:[t,o]})},xi={id:"deepZoom",name:"Deep Zoom",category:"Fractal",tabConfig:{label:"Deep Zoom"},params:{enabled:{type:"boolean",default:!1,label:"Enable deep zoom",description:"Master toggle. Switches the iteration kernel to perturbation + LA, unlocking zoom past 1e-5 (eventually past 1e-300). Off by default — costs nothing when off."},useLA:{type:"boolean",default:!0,label:"Use Linear Approximation",condition:{param:"enabled",bool:!0},description:"Skip iterations via the LA stage table. 10–100× faster at depth. Off = pure perturbation (slow, but useful for sanity-checking LA output)."},useAT:{type:"boolean",default:!0,label:"Use AT front-load",condition:{param:"enabled",bool:!0},description:"Fast-forward the front of the orbit via Approximation Terms (a single z²+c loop in plain f32). Free perf when applicable. No effect when LA is off."},maxRefIter:{type:"int",default:5e4,min:5e3,max:5e5,step:1e3,label:"Reference orbit length",condition:{param:"enabled",bool:!0},description:"Maximum iterations the high-precision reference orbit runs to. Higher = supports deeper zooms but costs CPU at build time and GPU memory at runtime. Auto-suggested per zoom depth in later phases."},deepMaxIter:{type:"int",default:2e3,min:200,max:5e4,step:100,label:"Iter (deep)",condition:{param:"enabled",bool:!0},description:"Maximum iterations per pixel when deep zoom is on. Overrides the Fractal-tab Iter slider while deep is enabled. Without LA every iteration costs the full HDR step — push gently until phase 6 (LA runtime) lands."},showStats:{type:"boolean",default:!1,label:"Show stats",condition:{param:"enabled",bool:!0},description:"Overlay reference-orbit length, LA stage count, table size, and build time. Diagnostic."},disableFluid:{type:"boolean",default:!1,label:"Disable fluid sim (debug)",condition:{param:"enabled",bool:!0},description:"Skip every fluid pass (motion, advect, pressure, dye decay) so render time reflects the fractal kernel only. Use to isolate deep-zoom perf from fluid sim cost."}}},vi=(r,e,i)=>{e.enabled?(r.setParams({deepZoomEnabled:!0,maxIter:e.deepMaxIter}),r.setForceFluidPaused(e.disableFluid)):(r.setParams({deepZoomEnabled:!1,maxIter:i.maxIter}),r.deepZoom.clearReferenceOrbit(),r.deepZoom.clearLATable(),r.deepZoom.setLAEnabled(!1),r.deepZoom.clearAT(),r.setForceFluidPaused(!1))},Re=G(["gradient","curl","iterate","c-track","hue"],"Operator",{optionLabels:{iterate:"Direct","c-track":"Temporal Δ",gradient:"Gradient",curl:"Curl",hue:"Hue"},optionHints:{gradient:"Push along ∇S — fluid flows from low to high source.",curl:"Swirl along level sets. Divergence-free.",iterate:"Push along ∇S with magnitude ∝ S itself.","c-track":"React to frame-to-frame change in S.",hue:"Palette colour IS the velocity field. Ignores Source."}}),bi=Re.values,yi=Re.fromIndex,Ae=G(["smoothPot","de","stripe","paletteLuma","mask"],"Source",{optionLabels:{smoothPot:"Smooth potential",de:"Distance estimate",stripe:"Stripe average",paletteLuma:"Palette luminance",mask:"Collision mask"},optionHints:{smoothPot:"Classic outside-the-set gradient.",de:"Smooth across the set boundary.",stripe:"Aesthetic banded flow.",paletteLuma:"Tracks whatever colour-mapping mode is active.",mask:"Drive flow toward / away from collision walls."}}),Ti=Ae.values,wi=Ae.fromIndex,Mi={id:"coupling",name:"Coupling",category:"Simulation",tabConfig:{label:"Coupling"},params:{forceMode:Re.config,forceSource:Ae.config,forceGain:{type:"float",default:-1200,min:-2e3,max:2e3,step:.1,label:"Force gain",description:"Multiplier on the fractal-derived force. How loudly the fractal shouts at the fluid. Negative inverts the force direction."},interiorDamp:{type:"float",default:.59,min:0,max:1,step:.01,label:"Interior damp",description:"How much to suppress force inside the set. 1 = still lake in the interior, 0 = full bleed."},forceCap:{type:"float",default:40,min:1,max:40,step:.5,label:"Force cap",description:"Per-pixel cap on the fractal force magnitude."},edgeMargin:{type:"float",default:.04,min:0,max:.25,step:.005,label:"Edge margin",description:'Fades force / dye injection near the canvas edges. Fixes "gushing from the borders" under fast c-changes.'}}};function Fe(r,e){const i=e,t={current:e},o=new Set;let a=0;const s=h=>(o.add(h),()=>{o.delete(h)}),n=()=>{a++,o.forEach(h=>h())};return{name:r,ref:t,useSnapshot:()=>(C.useSyncExternalStore(s,()=>a,()=>a),t.current),subscribe:s,notify:n,reset:()=>{t.current=i,n()}}}const le=Math.PI*2,he=(r,e,i)=>(i<0&&(i+=1),i>1&&(i-=1),i<1/6?r+(e-r)*6*i:i<1/2?e:i<2/3?r+(e-r)*(2/3-i)*6:r),$e=(r,e,i)=>{if(e===0)return[i,i,i];const t=i<.5?i*(1+e):i+e-i*e,o=2*i-t;return[he(o,t,r+1/3),he(o,t,r),he(o,t,r-1/3)]},Si=(r,e,i)=>{const t=Math.max(r,e,i),o=Math.min(r,e,i),a=(t+o)/2;if(t===o)return[0,0,a];const s=t-o,n=a>.5?s/(2-t-o):s/(t+o);let l;return t===r?l=(e-i)/s+(e<i?6:0):t===e?l=(i-r)/s+2:l=(r-e)/s+4,[l/6,n,a]},Ci=(r,e)=>{if(e<=0)return r;const[i,t,o]=Si(r[0],r[1],r[2]),a=(i+(Math.random()-.5)*e+1)%1;return $e(a,t,o)},Ri=(r,e)=>{if(!r||r.length<4)return[1,1,1];const i=(e%1+1)%1,t=r.length/4,o=Math.min(t-1,Math.floor(i*t))*4;return[r[o]/255,r[o+1]/255,r[o+2]/255]},Ye=r=>{let e;switch(r.mode){case"solid":e=[r.solidColor[0],r.solidColor[1],r.solidColor[2]];break;case"gradient":e=Ri(r.gradientLut,(r.u+r.v)*.5);break;case"velocity":{const i=Math.min(1,Math.hypot(r.vx,r.vy)*.2),t=(Math.atan2(r.vy,r.vx)/le+1)%1;e=$e(t,.9,.35+.3*i);break}case"rainbow":default:{const i=r.rainbowPhase;e=[.5+.5*Math.cos(le*i),.5+.5*Math.cos(le*(i+.33)),.5+.5*Math.cos(le*(i+.67))];break}}return Ci(e,r.jitter)},Se=300,Ai=(r,e)=>{if(r.length>=Se)return;const t=Math.atan2(e.dirY,e.dirX)+(Math.random()-.5)*2*e.particleSpread*Math.PI,o=e.particleVelocity*(.4+Math.random()*.6),a=e.brushSize*.35;r.push({x:e.u+(Math.random()-.5)*a,y:e.v+(Math.random()-.5)*a,vx:Math.cos(t)*o,vy:Math.sin(t)*o,life:e.particleLifetime,lifeMax:e.particleLifetime,color:[e.color[0],e.color[1],e.color[2]],size:e.brushSize*e.particleSizeScale*(.85+Math.random()*.3)})},Fi=(r,e,i,t)=>{const o=2*(r*i+e*t);return[r-o*i,e-o*t]},Ei=.5,Di=(r,e)=>{const i=Math.exp(-e.particleDrag*e.dtSec),t=e.restitution??.55,o=.01;let a=0;for(let s=r.length-1;s>=0;s--){const n=r[s];n.vx*=i,n.vy*=i,n.vy+=e.particleGravity*e.dtSec;const l=n.x,c=n.y;if(n.x+=n.vx*e.dtSec,n.y+=n.vy*e.dtSec,n.life-=e.dtSec,e.sampleMask&&e.sampleMask(n.x,n.y)>=Ei){let d=e.sampleMask(n.x+o,n.y)-e.sampleMask(n.x-o,n.y),h=e.sampleMask(n.x,n.y+o)-e.sampleMask(n.x,n.y-o),p=Math.hypot(d,h);if(p<=1e-6){const f=o*3;d=e.sampleMask(n.x+f,n.y)-e.sampleMask(n.x-f,n.y),h=e.sampleMask(n.x,n.y+f)-e.sampleMask(n.x,n.y-f),p=Math.hypot(d,h)}let x,M;if(p>1e-6)x=-d/p,M=-h/p;else{const f=Math.hypot(n.vx,n.vy);f>1e-6?(x=-n.vx/f,M=-n.vy/f):(x=1,M=0)}[n.vx,n.vy]=Fi(n.vx,n.vy,x,M),n.vx*=t,n.vy*=t,n.x=l+x*o,n.y=c+M*o}(n.life<=0||n.x<-.2||n.x>1.2||n.y<-.2||n.y>1.2)&&(r.splice(s,1),a++)}return a},Pi=()=>({particles:[],rainbowPhase:0,distSinceSplat:0,spawnAcc:0}),ki=(r,e)=>{r.rainbowPhase=e.wallClockMs*.001%1;const i=e.params;if(e.dragging&&i.particleEmitter&&e.cursorUv){r.spawnAcc+=e.dtSec*i.particleRate;const t=e.cursorVelUv??{vx:0,vy:0},o=Math.hypot(t.vx,t.vy),a=o<=1e-4;for(;r.spawnAcc>=1&&r.particles.length<Se;){r.spawnAcc-=1;let s,n;if(a){const c=Math.random()*Math.PI*2;s=Math.cos(c),n=Math.sin(c)}else s=t.vx/o,n=t.vy/o;const l=Ye({mode:i.colorMode,solidColor:i.solidColor,gradientLut:i.gradientLut,rainbowPhase:r.rainbowPhase,u:e.cursorUv.u,v:e.cursorUv.v,vx:t.vx,vy:t.vy,jitter:i.jitter});Ai(r.particles,{u:e.cursorUv.u,v:e.cursorUv.v,dirX:s,dirY:n,color:l,brushSize:i.size,particleVelocity:i.particleVelocity,particleSpread:i.particleSpread,particleLifetime:i.particleLifetime,particleSizeScale:i.particleSizeScale})}r.particles.length>=Se&&(r.spawnAcc=0)}if(r.particles.length>0){Di(r.particles,{dtSec:e.dtSec,particleGravity:i.particleGravity,particleDrag:i.particleDrag,sampleMask:(t,o)=>e.engine.sampleMask(t,o)});for(const t of r.particles){const o=Math.max(0,t.life/t.lifeMax);e.engine.brush(t.x,t.y,t.vx*i.flow,t.vy*i.flow,t.color,t.size,i.hardness,i.strength*o,i.mode)}}},Li=(r,e)=>{const i=e.params;return i.particleEmitter||r.distSinceSplat<Math.max(1e-5,i.spacing)?!1:(r.distSinceSplat=0,Qe(r,e),!0)},Ii=(r,e)=>{e.params.particleEmitter||(Qe(r,e),r.distSinceSplat=0)},Qe=(r,e)=>{r.rainbowPhase=e.wallClockMs*.001%1;const i=e.params,t=Ye({mode:i.colorMode,solidColor:i.solidColor,gradientLut:i.gradientLut,rainbowPhase:r.rainbowPhase,u:e.u,v:e.v,vx:e.dvx,vy:e.dvy,jitter:i.jitter});e.engine.brush(e.u,e.v,e.dvx*i.flow,e.dvy*i.flow,t,i.size,i.hardness,i.strength,i.mode)},ji=r=>{r.distSinceSplat=1/0,r.spawnAcc=0},oe=Fe("fluid-toy.engine",null),Y=Fe("fluid-toy.brush",{runtime:Pi(),gradientLut:null}),$=Fe("fluid-toy.cursor",{dragging:!1,uv:null,velUv:null}),zi={colorSpace:"srgb",blendSpace:"oklab",stops:[{id:"0",position:0,color:"#000000",bias:.5,interpolation:"linear"},{id:"1",position:.15,color:"#1a0a00",bias:.5,interpolation:"linear"},{id:"2",position:.35,color:"#8b1a00",bias:.5,interpolation:"linear"},{id:"3",position:.6,color:"#ff6b00",bias:.5,interpolation:"linear"},{id:"4",position:.85,color:"#ffdd66",bias:.5,interpolation:"linear"},{id:"5",position:1,color:"#ffffff",bias:.5,interpolation:"linear"}]},Ee=G(["add","screen","max","over"],"Dye blend",{optionHints:{add:"Linear accumulate — bright strokes build up, can clip.",screen:"1−(1−d)(1−i). Glowy, never exceeds 1.",max:"Hold the brightest. Vivid strokes survive over faded.",over:"Alpha-composite: new dye stamps cleanly over old."}}),_i=Ee.values,Bi=Ee.fromIndex,De=G(["linear","perceptual","vivid"],"Colour space",{optionHints:{linear:"RGB multiply — fades to black through grey.",perceptual:"OKLab L-decay — hue + chroma stable while dimming.",vivid:"OKLab + chroma boost — colours stay punchy near black."}}),Oi=De.values,Ui=De.fromIndex,Pe=G(["iterations","angle","magnitude","decomposition","bands","orbit-point","orbit-circle","orbit-cross","orbit-line","stripe","distance","derivative","potential","trap-iter"],"Color mapping",{optionLabels:{decomposition:"Decomp","orbit-point":"Trap · Point","orbit-circle":"Trap · Circle","orbit-cross":"Trap · Cross","orbit-line":"Trap · Line","trap-iter":"Trap Iteration",distance:"Distance Estimate",potential:"Continuous Potential",derivative:"Derivative (log|dz|)"},optionHints:{iterations:"Smooth escape iter — classic Mandelbrot/Julia colouring.",angle:"Argument of final z. Spirals + radial fans.",magnitude:"Distance from origin at escape. Radial intensity.",decomposition:"Sign of imag(z) — black/white binary split.",bands:"Hard step function on iter — sharp colour bands.","orbit-point":"Closest approach to a point trap (use Trap shape).","orbit-circle":"Closest approach to a circle trap.","orbit-cross":"Closest approach to an axis-cross trap.","orbit-line":"Signed distance to a line trap.",stripe:"Härkönen sin-stripe average. Smooth banded swirls.",distance:"Hubbard distance estimate. Crisp, edge-aware.",derivative:"log|dz| — highlights chaotic fast-stretching regions.",potential:"Böttcher potential. Like iter but C¹ smooth.","trap-iter":"Iteration at which the trap minimum was reached."}}),Gi=Pe.values,Ni=Pe.fromIndex,Vi=5,Oe=6,Hi=7,Ue=8,Ji=9,Xi=13,Zi={id:"palette",name:"Palette",category:"Look",tabConfig:{label:"Palette"},params:{gradient:{type:"gradient",default:zi,label:"Palette",description:"Colors both the fractal AND the dye injected into the fluid. In Hue-mode (Coupling), this IS the vector field."},colorMapping:{...Pe.config,description:"How the iteration-space scalar becomes a t-value into the gradient. Each mode exposes its own extra controls below."},gradientRepeat:{type:"float",default:1,min:.1,max:8,step:.01,label:"Repetition",description:"Tiles the gradient across the mapped axis. 1 = one sweep, 3 = three bands."},gradientPhase:{type:"float",default:0,min:0,max:1,step:.005,label:"Phase",description:"Phase shift — rotates the colors without changing their layout."},colorIter:{type:"int",default:310,min:1,max:1024,step:1,label:"Color iter",description:"Iterations used for the coloring accumulators (orbit trap, stripe, DE). Separate from escape-test maxIter — reduce for fresher colours."},trapCenter:{type:"vec2",default:{x:0,y:0},min:-2,max:2,step:.01,label:"Trap center",description:"Trap centre (complex coord). Move to pick which point in the orbit to trap against.",condition:{or:[{param:"colorMapping",eq:Vi},{param:"colorMapping",eq:Oe},{param:"colorMapping",eq:Hi},{param:"colorMapping",eq:Xi}]}},trapRadius:{type:"float",default:1,min:.01,max:4,step:.01,label:"Trap radius",condition:{param:"colorMapping",eq:Oe},description:"Circle radius for the trap. Orbit pixels are coloured by how close they approach this ring."},trapNormal:{type:"vec2",default:{x:1,y:0},min:-1,max:1,step:.01,label:"Trap normal",condition:{param:"colorMapping",eq:Ue},description:"Line trap: z lies on dot(z, normal) = offset. Normal should be unit-length."},trapOffset:{type:"float",default:0,min:-2,max:2,step:.01,label:"Trap offset",condition:{param:"colorMapping",eq:Ue},description:"Line-trap offset (scalar position along the normal direction)."},stripeFreq:{type:"float",default:4,min:1,max:16,step:.1,label:"Stripe freq",condition:{param:"colorMapping",eq:Ji},description:"Stripe frequency — k in ½ + ½·sin(k·arg z). Higher = more stripes per iteration."},interiorColor:{type:"vec3",default:{x:.02,y:.02,z:.04},min:0,max:1,step:.001,label:"Interior color",description:"Colour for bounded points (pixels that never escape the iteration)."},escapeR:{type:"float",default:32,min:2,max:1024,step:.1,label:"Escape R",scale:"log",hidden:!0}}},Wi=(r,e)=>{const i=e.trapNormal.x,t=e.trapNormal.y,o=Math.hypot(i,t),a=o>1e-6?[i/o,t/o]:[1,0],s=e.interiorColor;if(r.setParams({colorMapping:Ni(e.colorMapping),colorIter:e.colorIter,escapeR:e.escapeR,interiorColor:[s.x,s.y,s.z],trapCenter:[e.trapCenter.x,e.trapCenter.y],trapRadius:e.trapRadius,trapNormal:a,trapOffset:e.trapOffset,stripeFreq:e.stripeFreq,gradientRepeat:e.gradientRepeat,gradientPhase:e.gradientPhase}),e.gradient){const n=We(e.gradient);r.setGradientBuffer(n),Y.ref.current.gradientLut=n}},Ki={colorSpace:"srgb",blendSpace:"rgb",stops:[{id:"0",position:0,color:"#000000",bias:.5,interpolation:"linear"},{id:"1",position:1,color:"#000000",bias:.5,interpolation:"linear"}]},qi={id:"collision",name:"Collision",category:"Simulation",tabConfig:{label:"Collision"},params:{enabled:{type:"boolean",default:!1,label:"Collision walls",description:"Paints solid walls the fluid bounces off, sculpted by the gradient below. Same t-axis mapping as the main palette — edit stops to black = fluid, white = wall."},gradient:{type:"gradient",default:Ki,label:"Collision pattern",condition:{param:"enabled",bool:!0},description:"B&W gradient defining where walls sit along the iteration-space t-axis."},repeat:{type:"float",default:1,min:.1,max:8,step:.01,label:"Collision repeat",condition:{param:"enabled",bool:!0},description:"Tile the collision pattern along t — independent of the dye gradient repeat."},phase:{type:"float",default:0,min:0,max:1,step:.001,label:"Collision phase",condition:{param:"enabled",bool:!0},description:"Phase-shift the collision pattern so walls land where the dye doesn't."},preview:{type:"boolean",default:!1,label:"Preview walls on canvas",condition:{param:"enabled",bool:!0},description:"Overlays diagonal cyan hatching on solid cells so you can see the wall shape while tuning the gradient."}}},$i=(r,e)=>{if(r.setParams({collisionEnabled:e.enabled,collisionPreview:e.preview,collisionRepeat:e.repeat,collisionPhase:e.phase}),e.gradient){const i=We(e.gradient);r.setCollisionGradientBuffer(i)}},Yi={id:"fluidSim",name:"Fluid",category:"Simulation",tabConfig:{label:"Fluid"},params:{vorticity:{type:"float",default:22.1,min:0,max:50,step:.1,label:"Vorticity",description:"Amplifies existing curl — keeps fractal-induced swirls from smearing away."},vorticityScale:{type:"float",default:1,min:.5,max:8,step:.1,label:"Vorticity scale",condition:{param:"vorticity",gt:0},description:"Spatial scale of the vorticity confinement (in sim texels). 1 = tight pixel-scale swirls, 4+ = larger organised vortices."},dissipation:{type:"float",default:.17,min:0,max:5,step:.01,label:"Velocity dissipation /s",description:"How fast velocity decays. High = fluid forgets the fractal quickly."},dyeInject:{type:"float",default:1.5,min:0,max:3,step:.01,label:"Dye inject",description:"How much of the fractal's color bleeds into the fluid each frame."},dyeBlend:{...Ee.config,description:"How new dye mixes with what the fluid already carries. Gradient stop alpha acts as a per-colour injection mask."},pressureIters:{type:"int",default:50,min:4,max:60,step:1,label:"Pressure iters",description:"Jacobi iterations for incompressibility. More = stricter but slower."},dyeDecayMode:{...De.config,description:"How dye fades over time. Colour space controls whether it greys out (linear) or stays hue-stable (perceptual / vivid)."},dyeDissipation:{type:"float",default:1.03,min:0,max:5,step:.01,label:"Dye dissipation /s",description:"How fast dye fades. In linear mode this is a straight RGB multiply; in perceptual / vivid it's the OKLab luminance fade (chroma fades on its own schedule below)."},dyeChromaDecayHz:{type:"float",default:1.03,min:0,max:5,step:.01,label:"Chroma decay /s",condition:{param:"dyeDecayMode",neq:0},description:"Per-second fade on OKLab a/b (chroma). Lower than Dye dissipation → colour stays saturated longer than it stays bright."},dyeSaturationBoost:{type:"float",default:1,min:.5,max:1.1,step:.001,scale:"log",label:"Saturation boost",condition:{param:"dyeDecayMode",eq:2},description:"Per-frame chroma gain. 1 = neutral, <1 washes out, >1 pushes toward max saturation. Gamut-mapped in OKLab so it pegs at the saturation ceiling rather than hue-shifting to white."},timeScale:{type:"float",default:1,min:0,max:4,step:.01,label:"Sim speed",description:"Wall-clock dt multiplier on the sim. 0.5 = slow-mo, 2 = double speed. 0 freezes the fluid (Pause is the cleaner way for hard-stop)."},paused:{type:"boolean",default:!1,label:"Pause sim",description:"Freeze the fluid state. Splats and param changes still land; they just don't integrate forward."}}},Qi=(r,e,i)=>{r.setParams({vorticity:e.vorticity,vorticityScale:e.vorticityScale,pressureIters:e.pressureIters,dissipation:e.dissipation,paused:e.paused,timeScale:e.timeScale,dyeInject:e.dyeInject,dyeBlend:Bi(e.dyeBlend),dyeDecayMode:Ui(e.dyeDecayMode),dyeDissipation:e.dyeDissipation,dyeChromaDecayHz:e.dyeChromaDecayHz,dyeSaturationBoost:e.dyeSaturationBoost,forceMode:yi(i.forceMode),forceSource:wi(i.forceSource),forceGain:i.forceGain,interiorDamp:i.interiorDamp,forceCap:i.forceCap,edgeMargin:i.edgeMargin})},er={id:"presets",name:"Presets",category:"Library",tabConfig:{label:"Presets"},customUI:[{componentId:"preset-grid"}],params:{_anchor:{type:"float",default:0,min:0,max:1,step:1,label:"",hidden:!0}}},Ge=(r,e,i,t,o)=>({id:r,target:`julia.juliaC_${e}`,shape:"Sine",period:i,phase:o,amplitude:t,baseValue:0,smoothing:0,enabled:!0}),ge=(r,e)=>{const i=1/Math.max(.001,e);return[Ge("preset.orbit.juliaC.x","x",i,r,0),Ge("preset.orbit.juliaC.y","y",i,r,.25)]},N=r=>r.map(([e,i],t)=>({id:`s${t}`,position:e,color:i,bias:.5,interpolation:"linear"})),tr=[{id:"bench-julia-only",name:"Bench (Julia only)",desc:"Isolation preset for performance benchmarking. All post-FX, fluid coupling, dye, collision, and palette tricks are off — only the raw Julia/Mandelbrot fractal layer renders. Pair with the Disable-fluid-sim toggle on the Deep Zoom panel and accumulation off (topbar) for a clean GPU-time read.",params:{juliaC:[-.36303304426511473,.16845183018751916],center:[-.8139175130270945,-.054649908357858296],zoom:1.2904749020480561,maxIter:310,power:2,kind:"mandelbrot",forceMode:"gradient",forceSource:"smoothPot",forceGain:0,interiorDamp:1,dissipation:0,dyeDissipation:0,dyeInject:0,vorticity:0,vorticityScale:1,pressureIters:1,show:"julia",juliaMix:1,dyeMix:0,velocityViz:0,gradientRepeat:.1,gradientPhase:0,colorMapping:"iterations",colorIter:310,stripeFreq:4,dyeBlend:"max",dyeDecayMode:"linear",dyeChromaDecayHz:0,dyeSaturationBoost:1,toneMapping:"none",exposure:1,vibrance:1,bloomAmount:0,bloomThreshold:1,aberration:0,refraction:0,refractSmooth:1,refractRoughness:0,caustics:0,interiorColor:[0,0,0],edgeMargin:0,forceCap:1,collisionEnabled:!1,paused:!0},gradient:{stops:N([[0,"#000000"],[1,"#FFFFFF"]]),colorSpace:"linear",blendSpace:"rgb"}},{id:"coral-gyre",name:"Coral Gyre",desc:"Orbit-point colouring on a negative curl — teal interior feeds a coral halo, with filmic bloom + aberration.",params:{juliaC:[-.8173594132029339,.15279058679706603],center:[0,0],zoom:1.5,maxIter:182,power:2,kind:"julia",forceMode:"curl",forceSource:"paletteLuma",forceGain:-760,interiorDamp:.9,dissipation:.1,dyeDissipation:.63,dyeInject:2.28,vorticity:25.9,vorticityScale:4.2,pressureIters:30,show:"composite",juliaMix:.55,dyeMix:1,velocityViz:0,gradientRepeat:.56,gradientPhase:.09,colorMapping:"orbit-point",colorIter:96,trapCenter:[1.17,0],dyeBlend:"add",dyeDecayMode:"vivid",dyeSaturationBoost:1.01,toneMapping:"filmic",exposure:2.295,vibrance:1.87,bloomAmount:1.35,bloomThreshold:1,aberration:1.12,refraction:0,refractSmooth:1,caustics:3.9,interiorColor:[.02,.04,.08],edgeMargin:.04,forceCap:12,collisionEnabled:!0},gradient:{stops:N([[0,"#000000"],[.202,"#05233d"],[.362,"#0f6884"],[.521,"#56c6c0"],[.681,"#f0fff1"],[.84,"#e7bd69"],[1,"#8a3f19"]]),colorSpace:"linear",blendSpace:"oklab"},collisionGradient:{stops:[{id:"c0",position:0,color:"#000000",bias:.5,interpolation:"step"},{id:"c1",position:.513,color:"#FFFFFF",bias:.5,interpolation:"step"},{id:"c2",position:.573,color:"#000000",bias:.5,interpolation:"step"}],colorSpace:"srgb",blendSpace:"rgb"}},{id:"ink-canyon",name:"Ink Canyon",desc:"Monochrome dye threading between twin collision walls — one at the near edge, one deep in the field.",params:{juliaC:[-.7763636363636364,.19684858842329547],center:[.019054061889010376,-.007321977964897804],zoom:1.2904749020480561,maxIter:310,power:2,kind:"julia",forceMode:"curl",forceSource:"smoothPot",forceGain:1200,interiorDamp:.59,dissipation:.05,dyeDissipation:1.95,dyeInject:8,vorticity:5.9,pressureIters:50,show:"dye",juliaMix:.45,dyeMix:1,velocityViz:0,gradientRepeat:1,gradientPhase:0,colorMapping:"iterations",colorIter:310,dyeBlend:"add",aberration:.27,refraction:0,caustics:0,interiorColor:[.02,.02,.04],edgeMargin:.04,forceCap:40,collisionEnabled:!0},gradient:{stops:N([[0,"#000000"],[1,"#FFFFFF"]]),colorSpace:"linear",blendSpace:"oklab"},collisionGradient:{stops:[{id:"c0",position:0,color:"#000000",bias:.5,interpolation:"step"},{id:"c1",position:.02,color:"#FFFFFF",bias:.5,interpolation:"step"},{id:"c2",position:.07,color:"#000000",bias:.5,interpolation:"step"},{id:"c3",position:.833,color:"#FFFFFF",bias:.5,interpolation:"step"},{id:"c4",position:.883,color:"#000000",bias:.5,interpolation:"step"}],colorSpace:"srgb",blendSpace:"rgb"}},{id:"plasma-vein",name:"Plasma Vein",desc:"Fractional power (1.5) with 7× repeated blue/red bands. Vivid chroma decay keeps the refracted dye electric.",params:{juliaC:[-.1764262149580809,.1951288073545453],center:[.21016359187729639,-.014585098813268887],zoom:.975889617512663,maxIter:310,power:1.5,kind:"julia",forceMode:"curl",forceSource:"paletteLuma",forceGain:1200,interiorDamp:.59,dissipation:.05,dyeDissipation:1.95,dyeInject:8,vorticity:5.9,pressureIters:50,show:"dye",juliaMix:.7,dyeMix:1,velocityViz:0,gradientRepeat:7.43,gradientPhase:0,colorMapping:"iterations",colorIter:310,dyeBlend:"add",dyeDecayMode:"vivid",toneMapping:"filmic",exposure:1.86,vibrance:1.645,aberration:.5,refraction:.006,refractSmooth:11.8,caustics:0,interiorColor:[.02,.02,.04],edgeMargin:.04,forceCap:40},gradient:{stops:N([[0,"#000000"],[.143,"#001830"],[.286,"#004060"],[.429,"#00BFFF"],[.571,"#006080"],[.714,"#600000"],[.857,"#DC0000"],[1,"#FF4040"]]),colorSpace:"linear",blendSpace:"rgb"},collisionGradient:{stops:[{id:"c0",position:0,color:"#000000",bias:.5,interpolation:"step"},{id:"c1",position:.536,color:"#FFFFFF",bias:.5,interpolation:"step"},{id:"c2",position:.586,color:"#000000",bias:.5,interpolation:"step"}],colorSpace:"srgb",blendSpace:"rgb"}},{id:"crater-drift",name:"Crater Drift",desc:"Mandelbrot under inward curl, inferno-magenta palette. Slow auto-orbit carves craters through the bloom.",params:{juliaC:[.56053050672182,.468459152016546],center:[-.9313160617349564,-.15288948147190096],zoom:1.1807159194396142,maxIter:604,power:2,kind:"mandelbrot",forceMode:"curl",forceSource:"smoothPot",forceGain:-535.6,interiorDamp:0,dissipation:.16,dyeDissipation:.05,dyeInject:3,vorticity:2.9,vorticityScale:1.2,pressureIters:48,show:"composite",juliaMix:0,dyeMix:1.01,velocityViz:0,gradientRepeat:.66,gradientPhase:0,colorMapping:"iterations",colorIter:263,trapCenter:[1.51,-1.37],dyeBlend:"max",dyeDecayMode:"perceptual",dyeChromaDecayHz:0,toneMapping:"filmic",exposure:20.63,vibrance:1.645,bloomAmount:.63,bloomThreshold:.76,aberration:.4,refraction:0,caustics:0,interiorColor:[.02,.02,.03],edgeMargin:.04,forceCap:38.5,collisionEnabled:!0},gradient:{stops:N([[.084,"#000004"],[.215,"#280B54"],[.346,"#65156E"],[.477,"#9F2A63"],[.607,"#D44842"],[.738,"#F52D15"],[.869,"#FA2727"],[1,"#FF7983"]]),colorSpace:"srgb",blendSpace:"oklab"},collisionGradient:{stops:[{id:"c0",position:0,color:"#000000",bias:.5,interpolation:"step"},{id:"c1",position:.532,color:"#FFFFFF",bias:.5,interpolation:"step"},{id:"c2",position:.659,color:"#000000",bias:.5,interpolation:"step"}],colorSpace:"srgb",blendSpace:"rgb"},animations:ge(.01,.05)},{id:"quartic-strata",name:"Quartic Strata",desc:"Power-4 Julia drifting on a subtle c-track. Strata of blue/red dye held by a near-edge wall.",params:{juliaC:[.7072727272727275,-.1398788174715911],center:[-.0013928986324417691,-.010035496866822907],zoom:.975889617512663,maxIter:310,power:4,kind:"julia",forceMode:"c-track",forceSource:"smoothPot",forceGain:1,interiorDamp:.59,dissipation:.05,dyeDissipation:1.95,dyeInject:8,vorticity:1,pressureIters:50,show:"dye",juliaMix:.45,dyeMix:1,velocityViz:0,gradientRepeat:2,gradientPhase:0,colorMapping:"iterations",colorIter:310,dyeBlend:"add",aberration:.27,refraction:.037,caustics:1,interiorColor:[.02,.02,.04],edgeMargin:.04,forceCap:40,collisionEnabled:!0},gradient:{stops:N([[0,"#000000"],[.143,"#001830"],[.286,"#004060"],[.429,"#00BFFF"],[.571,"#006080"],[.714,"#600000"],[.857,"#DC0000"],[1,"#FF4040"]]),colorSpace:"linear",blendSpace:"rgb"},collisionGradient:{stops:[{id:"c0",position:0,color:"#000000",bias:.5,interpolation:"step"},{id:"c1",position:.113,color:"#FFFFFF",bias:.5,interpolation:"step"},{id:"c2",position:.163,color:"#000000",bias:.5,interpolation:"step"}],colorSpace:"srgb",blendSpace:"rgb"},animations:ge(.01,.2)},{id:"sunset-bands",name:"Sunset Bands",desc:"Force-gradient mode with hard band colouring — sunset strata pushed inward at 1536 sim.",params:{juliaC:[-.16545454545454558,.6455757279829545],center:[-.1012543995130697,.03079433116134145],zoom:1.086757425434934,maxIter:175,power:2,kind:"julia",forceMode:"gradient",forceSource:"paletteLuma",forceGain:1500,interiorDamp:5.8,dissipation:.22,dyeDissipation:.5,dyeInject:.55,vorticity:0,pressureIters:30,show:"composite",juliaMix:.55,dyeMix:2,velocityViz:0,gradientRepeat:1.35,gradientPhase:.055,colorMapping:"bands",colorIter:175,dyeBlend:"over",aberration:.27,refraction:0,caustics:1,interiorColor:[.02,.02,.03],edgeMargin:.04,forceCap:12},gradient:{stops:N([[0,"#04001f"],[.167,"#1a1049"],[.333,"#4e2085"],[.5,"#b13a8a"],[.667,"#ff7657"],[.833,"#ffc569"],[1,"#fff9d0"]]),colorSpace:"linear",blendSpace:"oklab"}},{id:"verdant-pulse",name:"Verdant Pulse",desc:"Viridis-to-magenta orbit-circle ring, wide vorticity, slow auto-orbit — the set breathes green and pink.",params:{juliaC:[-.7,.27015],center:[-.15958346356258324,-.09244114001481094],zoom:1.3957783246444389,maxIter:160,power:2,kind:"julia",forceMode:"c-track",forceSource:"paletteLuma",forceGain:10,interiorDamp:.45,dissipation:.2,dyeDissipation:.17,dyeInject:.9,vorticity:16,vorticityScale:5.8,pressureIters:30,show:"composite",juliaMix:0,dyeMix:3.805,velocityViz:0,gradientRepeat:1,gradientPhase:.03,colorMapping:"orbit-circle",colorIter:94,dyeBlend:"over",dyeDecayMode:"perceptual",exposure:.35,vibrance:1.645,aberration:.27,refraction:.037,caustics:1,interiorColor:[.02,0,.04],edgeMargin:.04,forceCap:12,collisionEnabled:!0},gradient:{stops:N([[0,"#000000"],[.061,"#440154"],[.143,"#46327F"],[.286,"#365C8D"],[.429,"#277F8E"],[.571,"#1FA187"],[.714,"#4AC26D"],[.857,"#3ADA62"],[1,"#FD25B6"]]),colorSpace:"linear",blendSpace:"oklab"},collisionGradient:{stops:[{id:"c0",position:0,color:"#000000",bias:.5,interpolation:"step"},{id:"c1",position:.037,color:"#000000",bias:.5,interpolation:"linear"},{id:"c2",position:.943,color:"#000000",bias:.5,interpolation:"step"},{id:"c3",position:1,color:"#626262",bias:.5,interpolation:"step"}],colorSpace:"srgb",blendSpace:"rgb"},animations:ge(.035,.02)}],ke=G(["none","reinhard","agx","filmic"],"Tone mapping",{optionLabels:{agx:"AgX"},optionHints:{none:"Linear — clamp at 1.0. Crushes highlights.",reinhard:"c/(1+c). Smooth but desaturates highlights.",agx:"Sobotka AgX. Hue-stable, vibrant.",filmic:"Hable Uncharted-2 filmic. Cinematic s-curve."}}),ir=ke.values,rr=ke.fromIndex,or={id:"postFx",name:"Post FX",category:"Look",tabConfig:{label:"Post-FX"},params:{bloomAmount:{type:"float",default:0,min:0,max:3,step:.01,label:"Bloom",description:"Bloom strength — wide soft glow on bright pixels. Core of the electric look."},bloomThreshold:{type:"float",default:1,min:0,max:3,step:.01,label:"Bloom threshold",condition:{param:"bloomAmount",gt:0},description:"Luminance threshold: pixels below this don't contribute to bloom. Lower = more of the image glows."},aberration:{type:"float",default:.27,min:0,max:3,step:.01,label:"Aberration",description:"Chromatic aberration keyed to local velocity — plasma fringing on fast-moving dye regions. Affects dye only; fractal stays sharp."},refraction:{type:"float",default:.037,min:0,max:.3,step:.001,label:"Refraction",description:"Screen-space refraction: dye's luminance acts as a height field — the fractal underneath warps like glass."},refractSmooth:{type:"float",default:3,min:1,max:12,step:.1,label:"Refract smooth",condition:{param:"refraction",gt:0},description:"Stencil width (in dye texels) for the refraction gradient. Higher = smoother distortion, less pixel jitter; 1 = raw single-pixel gradient."},refractRoughness:{type:"float",default:0,min:0,max:1,step:.01,label:"Refract roughness",condition:{param:"refraction",gt:0},description:"Frosted-glass scatter for the refracted fractal. 0 = crisp polished glass (single-tap). 1 = ~5px Vogel-disc blur — light scatters into a cone like real rough surfaces. Mask + walls blur in step so glass edges stay consistent."},caustics:{type:"float",default:1,min:0,max:25,step:.1,label:"Caustics",description:"Laplacian-of-dye highlight — simulates focused-light caustics where the liquid surface bends."},toneMapping:{...ke.config,description:"How final colour gets compressed. None = maximally vivid (may clip). AgX = 2023 hue-stable roll-off (best for rich colours). Reinhard desaturates highlights."},exposure:{type:"float",default:1,min:.1,max:5,step:.01,label:"Exposure",description:"Multiplier on final colour BEFORE tone mapping. Crank up to make dim gradient stops punch."},vibrance:{type:"float",default:1.645,min:0,max:1,step:.01,label:"Vibrance",description:"Chroma-aware saturation — boosts dull pixels without posterising already-vivid ones."}}},ar=(r,e)=>{r.setParams({toneMapping:rr(e.toneMapping),exposure:e.exposure,vibrance:e.vibrance,bloomAmount:e.bloomAmount,bloomThreshold:e.bloomThreshold,aberration:e.aberration,refraction:e.refraction,refractSmooth:e.refractSmooth,refractRoughness:e.refractRoughness,caustics:e.caustics})},Le=G(["composite","julia","dye","velocity"],"Show",{optionLabels:{composite:"Mixed",julia:"Fractal"},optionHints:{composite:"Fractal + dye + velocity overlay (the full picture).",julia:"Just the fractal — no fluid layer.",dye:"Just the dye — no fractal underneath.",velocity:"Velocity field as colour. Diagnostic only."}}),sr=Le.values,nr=Le.fromIndex,xe=0,lr={id:"composite",name:"Composite",category:"Look",tabConfig:{label:"Composite"},params:{show:{...Le.config,description:"What you see. The simulation runs the same either way. Mixed = fractal + dye + optional velocity overlay. Fractal = pure fractal, fluid hidden. Dye = fluid dye only (what the fractal wrote). Velocity = per-pixel velocity as a hue wheel."},juliaMix:{type:"float",default:.4,min:0,max:2,step:.01,label:"Julia mix",condition:{param:"show",eq:xe},description:"How much fractal color shows through in Mixed view."},dyeMix:{type:"float",default:2,min:0,max:2,step:.01,label:"Dye mix",condition:{param:"show",eq:xe},description:"How much fluid dye shows through in Mixed view."},velocityViz:{type:"float",default:.02,min:0,max:2,step:.01,label:"Velocity viz",condition:{param:"show",eq:xe},description:"Overlay velocity-hue on top of the composite. Diagnostic."}}},cr=(r,e)=>{r.setParams({show:nr(e.show),juliaMix:e.juliaMix,dyeMix:e.dyeMix,velocityViz:e.velocityViz})},Z=r=>{const e=B.get(r);if(!e)return{};const i={};for(const[t,o]of Object.entries(e.params)){const a=o.default;a&&typeof a=="object"&&!Array.isArray(a)?i[t]={...a}:Array.isArray(a)?i[t]=[...a]:i[t]=a}return i},V=(r,e)=>{if(typeof e!="string")return;const i=r.indexOf(e);return i>=0?i:void 0},ce=r=>r?{x:r[0],y:r[1]}:void 0,ur=r=>r?{x:r[0],y:r[1],z:r[2]}:void 0,dr=r=>{const e=globalThis.__store;if(!e){console.warn("[applyRefPreset] store not ready — window.__store is undefined");return}const i=e.getState(),t=r.params,o={},a=V(Me,t.kind);a!==void 0&&(o.kind=a),t.juliaC&&(o.juliaC=ce(t.juliaC)),t.center&&(o.center=ce(t.center),o.centerLow={x:0,y:0}),t.zoom!==void 0&&(o.zoom=t.zoom),t.maxIter!==void 0&&(o.maxIter=t.maxIter),t.power!==void 0&&(o.power=t.power),i.setJulia({...Z("julia"),...o});const s={},n=V(bi,t.forceMode);n!==void 0&&(s.forceMode=n);const l=V(Ti,t.forceSource);l!==void 0&&(s.forceSource=l),t.forceGain!==void 0&&(s.forceGain=t.forceGain),t.interiorDamp!==void 0&&(s.interiorDamp=t.interiorDamp),t.forceCap!==void 0&&(s.forceCap=t.forceCap),t.edgeMargin!==void 0&&(s.edgeMargin=t.edgeMargin),i.setCoupling({...Z("coupling"),...s}),typeof i.setAnimations=="function"&&i.setAnimations(r.animations??[]);const c={};t.vorticity!==void 0&&(c.vorticity=t.vorticity),t.vorticityScale!==void 0&&(c.vorticityScale=t.vorticityScale),t.dissipation!==void 0&&(c.dissipation=t.dissipation),t.pressureIters!==void 0&&(c.pressureIters=t.pressureIters),t.dyeInject!==void 0&&(c.dyeInject=t.dyeInject),t.dyeDissipation!==void 0&&(c.dyeDissipation=t.dyeDissipation),t.dyeChromaDecayHz!==void 0&&(c.dyeChromaDecayHz=t.dyeChromaDecayHz),t.dyeSaturationBoost!==void 0&&(c.dyeSaturationBoost=t.dyeSaturationBoost);const d=V(Oi,t.dyeDecayMode);d!==void 0&&(c.dyeDecayMode=d);const h=V(_i,t.dyeBlend);h!==void 0&&(c.dyeBlend=h),i.setFluidSim({...Z("fluidSim"),...c});const p={},x=V(Gi,t.colorMapping);x!==void 0&&(p.colorMapping=x),t.colorIter!==void 0&&(p.colorIter=t.colorIter),t.gradientRepeat!==void 0&&(p.gradientRepeat=t.gradientRepeat),t.gradientPhase!==void 0&&(p.gradientPhase=t.gradientPhase),t.trapCenter&&(p.trapCenter=ce(t.trapCenter)),t.trapRadius!==void 0&&(p.trapRadius=t.trapRadius),t.trapNormal&&(p.trapNormal=ce(t.trapNormal)),t.trapOffset!==void 0&&(p.trapOffset=t.trapOffset),t.stripeFreq!==void 0&&(p.stripeFreq=t.stripeFreq),t.interiorColor&&(p.interiorColor=ur(t.interiorColor)),r.gradient&&(p.gradient=r.gradient),i.setPalette({...Z("palette"),...p});const M={enabled:!!t.collisionEnabled};r.collisionGradient&&(M.gradient=r.collisionGradient),i.setCollision({...Z("collision"),...M});const f={},b=V(ir,t.toneMapping);b!==void 0&&(f.toneMapping=b),t.exposure!==void 0&&(f.exposure=t.exposure),t.vibrance!==void 0&&(f.vibrance=t.vibrance),t.bloomAmount!==void 0&&(f.bloomAmount=t.bloomAmount),t.bloomThreshold!==void 0&&(f.bloomThreshold=t.bloomThreshold),t.aberration!==void 0&&(f.aberration=t.aberration),t.refraction!==void 0&&(f.refraction=t.refraction),t.refractSmooth!==void 0&&(f.refractSmooth=t.refractSmooth),t.caustics!==void 0&&(f.caustics=t.caustics),i.setPostFx({...Z("postFx"),...f});const y={},v=V(sr,t.show);v!==void 0&&(y.show=v),t.juliaMix!==void 0&&(y.juliaMix=t.juliaMix),t.dyeMix!==void 0&&(y.dyeMix=t.dyeMix),t.velocityViz!==void 0&&(y.velocityViz=t.velocityViz),i.setComposite({...Z("composite"),...y}),typeof i.setIsPaused=="function"&&i.setIsPaused(t.paused??!1),typeof i.setAccumulation=="function"&&i.setAccumulation(t.accumulation??!0)},pr=()=>u.jsxs("div",{className:"flex flex-col gap-3 py-2",children:[u.jsx("div",{className:"text-[10px] text-gray-500 leading-snug",children:"Each preset is a curated fractal ↔ fluid coupling. Applying one resets the grid and restores known params."}),u.jsx("div",{className:"grid grid-cols-2 gap-1",children:tr.map(r=>u.jsx("button",{type:"button",title:r.desc,onClick:()=>{var e;dr(r),(e=oe.ref.current)==null||e.resetFluid()},className:"px-2 py-1 text-[10px] rounded border bg-white/[0.04] border-white/10 text-gray-300 hover:bg-white/[0.08] hover:border-cyan-500/40 transition-colors text-left",children:r.name},r.id))})]}),et=G(["paint","erase","stamp","smudge"],"Mode"),fr=et.fromIndex,tt=G(["rainbow","solid","gradient","velocity"],"Colour"),mr=tt.fromIndex,hr={id:"brush",name:"Brush",category:"Input",tabConfig:{label:"Brush"},params:{mode:{...et.config,description:"What left-drag does on the canvas. Paint = dye + force; Erase subtracts dye; Stamp deposits dye only; Smudge pushes velocity without adding dye."},size:{type:"float",default:.15,min:.003,max:.4,step:.001,label:"Size (UV)",description:"Radius in UV units (0..1 across the canvas). B+drag the canvas to resize live."},hardness:{type:"float",default:0,min:0,max:1,step:.01,label:"Hardness",description:"0 = soft gaussian edge (airbrush). 1 = hard disc (stamp)."},strength:{type:"float",default:1,min:0,max:3,step:.01,label:"Strength",description:"Dye amount per splat. 0 = dry brush, 3 = saturated. Erase mode: how much dye each splat removes."},flow:{type:"float",default:50,min:0,max:200,step:.5,label:"Flow",condition:{or:[{param:"mode",eq:0},{param:"mode",eq:3}]},description:"How much of the pointer's velocity is injected into the force field. Low = delicate, 50 = paints, 200 = whip."},spacing:{type:"float",default:.005,min:0,max:.1,step:.001,label:"Spacing (UV)",condition:{param:"particleEmitter",bool:!1},description:"Minimum travel between splats along a drag. Low = smooth stroke, high = dotted trail."},colorMode:{...tt.config,condition:{or:[{param:"mode",eq:0},{param:"mode",eq:2}]},description:"Where each splat gets its RGB. Gradient samples the palette; Solid uses the picker below; Rainbow cycles hue on its own clock."},solidColor:{type:"vec3",default:{x:1,y:1,z:1},min:0,max:1,step:.001,label:"Solid color",condition:{param:"colorMode",eq:1},description:"Explicit colour for Solid mode. Hue jitter still applies."},jitter:{type:"float",default:0,min:0,max:1,step:.01,label:"Hue jitter",condition:{and:[{param:"mode",neq:1},{param:"mode",neq:3}]},description:"Random hue wiggle per splat. 0 = exact colour, 1 = full hue wheel. Builds natural variation in long strokes. Stacks on rainbow/velocity mode too."},particleEmitter:{type:"boolean",default:!1,label:"Particle emitter",description:"Dragging spawns independent particles on their own layer. Each live particle flies with its own velocity / lifespan and acts as a mini brush — painting into the fluid with the selected mode at its own position."},particleRate:{type:"float",default:120,min:1,max:600,step:1,label:"Rate /s",condition:{param:"particleEmitter",bool:!0},description:"Particles emitted per second while dragging. Hard-capped at 300 live at once."},particleVelocity:{type:"float",default:.3,min:0,max:3,step:.01,label:"Velocity",condition:{param:"particleEmitter",bool:!0},description:"Initial speed in UV/sec. 0.3 = gentle spray, 2 = shotgun."},particleSpread:{type:"float",default:.35,min:0,max:1,step:.01,label:"Spread",condition:{param:"particleEmitter",bool:!0},description:"Angular spread around the drag direction. 0 = beam, 1 = full 360° burst."},particleGravity:{type:"float",default:0,min:-3,max:3,step:.01,label:"Gravity",condition:{param:"particleEmitter",bool:!0},description:"UV/sec² acceleration. Negative = falls down the canvas, positive = rises."},particleDrag:{type:"float",default:.6,min:0,max:4,step:.01,label:"Drag /s",condition:{param:"particleEmitter",bool:!0},description:"Air drag — 0 = ballistic (keeps speed), 2 = quickly slows, 4 = fast stop."},particleLifetime:{type:"float",default:1.2,min:.1,max:6,step:.05,label:"Lifetime",condition:{param:"particleEmitter",bool:!0},description:"Seconds before each particle is culled. Longer = more persistent streaks."},particleSizeScale:{type:"float",default:.35,min:.05,max:1.5,step:.01,label:"Size ×",condition:{param:"particleEmitter",bool:!0},description:"Per-particle stamp size as a fraction of the brush size. 0.35 = dabs a third of the brush."}}},Ne=96,gr=(r,e)=>{const t=(e-Math.floor(e))*256,o=Math.floor(t)%256,a=(o+1)%256,s=t-Math.floor(t),n=r[o*4+0]*(1-s)+r[a*4+0]*s,l=r[o*4+1]*(1-s)+r[a*4+1]*s,c=r[o*4+2]*(1-s)+r[a*4+2]*s;return[n,l,c]},xr=16,W=new Map,Ve=new WeakMap;let vr=0;const br=r=>{const e=Ve.get(r);if(e!==void 0)return e;const i=`lut${vr++}`;return Ve.set(r,i),i},yr=(r,e,i,t,o,a,s,n,l)=>`${r}|${e}|${i}|${t}|${br(o)}|${a}|${s}|${n[0]},${n[1]},${n[2]}|${l}`,Tr=(r,e,i,t,o,a,s,n,l)=>{const c=new ImageData(r,r),d=c.data,h=Math.round(n[0]*255),p=Math.round(n[1]*255),x=Math.round(n[2]*255),M=Math.round(l),f=Math.abs(l-M)<.01&&M>=2&&M<=8;for(let b=0;b<r;b++){const y=i+(b/r*2-1)*t;for(let v=0;v<r;v++){const A=e+(v/r*2-1)*t;let R=0,g=0,T=0;for(;T<Ne;T++){const S=R*R,E=g*g;if(S+E>16)break;let D,z;if(f){let _=R,j=g;for(let U=1;U<M;U++){const P=_*R-j*g;j=_*g+j*R,_=P}D=_,z=j}else{const _=Math.sqrt(S+E),j=Math.atan2(g,R),U=Math.pow(_,l),P=j*l;D=U*Math.cos(P),z=U*Math.sin(P)}R=D+A,g=z+y}const F=((r-1-b)*r+v)*4;if(T>=Ne)d[F+0]=h,d[F+1]=p,d[F+2]=x;else{const D=(T+1-Math.log2(Math.max(1e-6,.5*Math.log2(R*R+g*g))))*.05*a+s,[z,_,j]=gr(o,D);d[F+0]=Math.round(z),d[F+1]=Math.round(_),d[F+2]=Math.round(j)}d[F+3]=255}}return c},wr=(r,e,i,t,o,a,s,n,l)=>{const c=yr(r,e,i,t,o,a,s,n,l),d=W.get(c);if(d)return W.delete(c),W.set(c,d),d;const h=Tr(r,e,i,t,o,a,s,n,l);for(W.set(c,h);W.size>xr;){const p=W.keys().next().value;if(p===void 0)break;W.delete(p)}return h},Mr=(()=>{const r=new Uint8Array(1024);for(let e=0;e<256;e++)r[e*4]=r[e*4+1]=r[e*4+2]=e,r[e*4+3]=255;return r})(),Sr=({cx:r,cy:e,onChange:i,halfExtent:t=1.6,centerX:o=-.5,centerY:a=0,size:s=220,gradientLut:n,gradientRepeat:l=1,gradientPhase:c=0,interiorColor:d=[.04,.04,.06],power:h=2})=>{const p=C.useRef(null),x=C.useRef(null),M=C.useRef(!1);C.useEffect(()=>{const y=p.current;if(!y)return;const v=y.getContext("2d");if(!v)return;y.width=s,y.height=s;const R=wr(s,o,a,t,n??Mr,l,c,d,h);x.current=R,v.putImageData(R,0,0),f()},[s,o,a,t,n,l,c,d[0],d[1],d[2],h]);const f=C.useCallback(()=>{const y=p.current;if(!y||!x.current)return;const v=y.getContext("2d");if(!v)return;v.putImageData(x.current,0,0);const A=(r-o)/t*.5+.5,R=(e-a)/t*.5+.5,g=A*s,T=(1-R)*s;v.strokeStyle="#fff",v.lineWidth=1,v.beginPath(),v.moveTo(g-8,T),v.lineTo(g-2,T),v.moveTo(g+2,T),v.lineTo(g+8,T),v.moveTo(g,T-8),v.lineTo(g,T-2),v.moveTo(g,T+2),v.lineTo(g,T+8),v.stroke(),v.strokeStyle="rgba(0,255,200,0.9)",v.beginPath(),v.arc(g,T,4,0,2*Math.PI),v.stroke()},[r,e,o,a,t,s]);C.useEffect(()=>{f()},[f]);const b=y=>{const v=p.current;if(!v)return;const A=v.getBoundingClientRect(),R=(y.clientX-A.left)/A.width,g=1-(y.clientY-A.top)/A.height,T=o+(R*2-1)*t,F=a+(g*2-1)*t;i(T,F)};return u.jsxs("div",{className:"flex flex-col gap-1",children:[u.jsx("div",{className:"text-[10px] text-gray-400 uppercase tracking-wide",children:"Pick Julia c"}),u.jsx("canvas",{ref:p,className:"rounded border border-white/10 cursor-crosshair",style:{width:s,height:s,imageRendering:"pixelated"},onPointerDown:y=>{M.current=!0,y.target.setPointerCapture(y.pointerId),b(y)},onPointerMove:y=>{M.current&&b(y)},onPointerUp:y=>{M.current=!1;try{y.target.releasePointerCapture(y.pointerId)}catch{}}}),u.jsxs("div",{className:"text-[10px] font-mono text-gray-500",children:["c = (",r.toFixed(4),", ",e.toFixed(4),")"]})]})},Cr=({sliceState:r,actions:e})=>{const i=r.juliaC??{x:-.36303304426511473,y:.16845183018751916},t=r.power??2,o=C.useMemo(()=>{},[]);return u.jsx(Sr,{cx:i.x,cy:i.y,power:t,gradientLut:o,onChange:(a,s)=>e.setJulia({juliaC:{x:a,y:s}})})};fe.register("julia-c-picker",Cr);fe.register("preset-grid",pr);B.register(mi);B.register(xi);B.register(Mi);B.register(Zi);B.register(qi);B.register(Yi);B.register(or);B.register(lr);B.register(hr);B.register(er);pt({version:1,id:"fluid-toy.tab-parity-restructure",apply:r=>(r!=null&&r.features&&(ft(r,"dye","palette"),k(r,"palette.collisionEnabled","collision.enabled"),k(r,"palette.collisionPreview","collision.preview"),k(r,"palette.collisionGradient","collision.gradient"),k(r,"palette.collisionRepeat","collision.repeat"),k(r,"palette.collisionPhase","collision.phase"),k(r,"palette.dyeMix","composite.dyeMix"),k(r,"palette.dyeInject","fluidSim.dyeInject"),k(r,"palette.dyeDissipation","fluidSim.dyeDissipation"),k(r,"palette.dyeDecayMode","fluidSim.dyeDecayMode"),k(r,"palette.dyeChromaDecayHz","fluidSim.dyeChromaDecayHz"),k(r,"palette.dyeSaturationBoost","fluidSim.dyeSaturationBoost"),k(r,"fluidSim.forceMode","coupling.forceMode"),k(r,"fluidSim.forceGain","coupling.forceGain"),k(r,"fluidSim.interiorDamp","coupling.interiorDamp"),k(r,"fluidSim.forceCap","coupling.forceCap"),k(r,"fluidSim.edgeMargin","coupling.edgeMargin"),k(r,"orbit.enabled","coupling.orbitEnabled"),k(r,"orbit.radius","coupling.orbitRadius"),k(r,"orbit.speed","coupling.orbitSpeed"),r.features.orbit&&Object.keys(r.features.orbit).length===0&&delete r.features.orbit,k(r,"sceneCamera.center","julia.center"),k(r,"sceneCamera.zoom","julia.zoom"),r.features.sceneCamera&&Object.keys(r.features.sceneCamera).length===0&&delete r.features.sceneCamera),r)});const Rr=()=>({mode:"idle",pointerId:-1,lastX:0,lastY:0,lastT:0,startX:0,startY:0,startCx:0,startCy:0,startCxLow:0,startCyLow:0,startZoom:1,zoomAnchorX:0,zoomAnchorY:0,zoomAnchorXLow:0,zoomAnchorYLow:0,zoomAnchorU:.5,zoomAnchorV:.5,rightDragged:!1,startBrushSize:.15}),Ar=1e-5,it=8,Fr=1e-300,Er=5,Dr=.002,Pr=.005,kr=5,Lr=.2,ve=256,Ir=.5,J={b:!1,c:!1},jr=()=>{const r=document.activeElement;if(!r)return!1;const e=r.tagName;return e==="INPUT"||e==="TEXTAREA"||r.isContentEditable},zr=()=>{C.useEffect(()=>{const r=t=>{jr()||(t.code==="KeyB"&&(J.b=!0),t.code==="KeyC"&&(J.c=!0))},e=t=>{t.code==="KeyB"&&(J.b=!1),t.code==="KeyC"&&(J.c=!1)},i=()=>{J.b=!1,J.c=!1};return window.addEventListener("keydown",r),window.addEventListener("keyup",e),window.addEventListener("blur",i),()=>{window.removeEventListener("keydown",r),window.removeEventListener("keyup",e),window.removeEventListener("blur",i)}},[])},ae=(r,e)=>r?kr:e?Lr:1,_r=(r,e,i)=>{const t=w(o=>o.openContextMenu);C.useEffect(()=>{const o=r.current;if(!o)return;const a=s=>{var x,M,f,b,y;s.preventDefault();const n=i.current;if(!n)return;if(n.rightDragged){n.rightDragged=!1;return}const l=w.getState(),c=(x=l.julia)==null?void 0:x.juliaC,d=!!((M=l.coupling)!=null&&M.orbitEnabled),h=!!((f=l.fluidSim)!=null&&f.paused),p=[{label:`Copy Julia c (${((b=c==null?void 0:c.x)==null?void 0:b.toFixed(3))??"?"}, ${((y=c==null?void 0:c.y)==null?void 0:y.toFixed(3))??"?"})`,action:()=>{var A;if(!c)return;const v=`${c.x.toFixed(6)}, ${c.y.toFixed(6)}`;(A=navigator.clipboard)==null||A.writeText(v).catch(()=>{})}},{label:h?"Resume Sim":"Pause Sim",action:()=>{l.setFluidSim({paused:!h})}},{label:d?"Stop Auto Orbit":"Start Auto Orbit",action:()=>{l.setCoupling({orbitEnabled:!d})}},{label:"Recenter View",action:()=>{l.setJulia({center:{x:0,y:0},zoom:1.5})}},{label:"Reset Fluid Fields",action:()=>{var v;(v=e.current)==null||v.resetFluid()}}];t(s.clientX,s.clientY,p,["ui.fluid-canvas"])};return o.addEventListener("contextmenu",a),()=>o.removeEventListener("contextmenu",a)},[r,e,i,t])},de=(r,e)=>{const i=r+e,t=i-r,o=r-(i-t)+(e-t);return[i,o]},X=(r,e,i)=>{const[t,o]=de(r,i),[a,s]=de(t,e+o);return[a,s]},He=(r,e,i,t)=>{const[o,a]=de(r,-i),[s,n]=de(o,a+(e-t));return[s,n]},Br=(r,e)=>{var o,a,s,n,l,c,d,h;const i=e.stateRef.current,t=w.getState();i.mode="pan-pending",i.startCx=((a=(o=t.julia)==null?void 0:o.center)==null?void 0:a.x)??0,i.startCy=((n=(s=t.julia)==null?void 0:s.center)==null?void 0:n.y)??0,i.startCxLow=((c=(l=t.julia)==null?void 0:l.centerLow)==null?void 0:c.x)??0,i.startCyLow=((h=(d=t.julia)==null?void 0:d.centerLow)==null?void 0:h.y)??0,i.rightDragged=!1,e.canvas.setPointerCapture(r.pointerId),e.handleInteractionStart("camera")},Or=(r,e)=>{var b,y;const i=e.stateRef.current,t=e.canvas.getBoundingClientRect();if(t.width<1||t.height<1)return;if(i.mode==="pan-pending"){if(Math.hypot(r.clientX-i.startX,r.clientY-i.startY)<=Er)return;i.mode="pan",i.rightDragged=!0}const a=((b=w.getState().julia)==null?void 0:b.zoom)??1.5,s=t.width/t.height,n=ae(r.shiftKey,r.altKey),l=r.clientX-i.startX,c=r.clientY-i.startY,d=-(l/t.width)*2*s*a*n,h=c/t.height*2*a*n,[p,x]=X(i.startCx,i.startCxLow,d),[M,f]=X(i.startCy,i.startCyLow,h);e.pendingViewRef.current={center:{x:p,y:M},centerLow:{x,y:f},zoom:a},(y=e.engineRef.current)==null||y.setParams({center:[p,M],centerLow:[x,f]}),i.lastX=r.clientX,i.lastY=r.clientY},rt=()=>{const r=w.getState().deepZoom;return r&&r.enabled?Fr:Ar},Ur=(r,e)=>{var b,y,v,A,R,g;r.preventDefault();const i=e.canvas.getBoundingClientRect();if(i.width<1||i.height<1)return;const t=e.stateRef.current,o=w.getState(),a=((b=o.julia)==null?void 0:b.center)??{x:0,y:0},s=((y=o.julia)==null?void 0:y.zoom)??1.5,n=(r.clientX-i.left)/i.width,l=1-(r.clientY-i.top)/i.height,c=i.width/i.height;t.mode="zoom",t.startZoom=s,t.zoomAnchorU=n,t.zoomAnchorV=l;const d=((A=(v=o.julia)==null?void 0:v.centerLow)==null?void 0:A.x)??0,h=((g=(R=o.julia)==null?void 0:R.centerLow)==null?void 0:g.y)??0,p=(n*2-1)*c*s,x=(l*2-1)*s,M=X(a.x,d,p),f=X(a.y,h,x);t.zoomAnchorX=M[0],t.zoomAnchorXLow=M[1],t.zoomAnchorY=f[0],t.zoomAnchorYLow=f[1],e.canvas.setPointerCapture(r.pointerId),e.handleInteractionStart("camera")},Gr=(r,e)=>{var f;const i=e.stateRef.current,t=e.canvas.getBoundingClientRect();if(t.width<1||t.height<1)return;const o=ae(r.shiftKey,r.altKey),a=r.clientY-i.startY,s=Math.exp(a*Pr*o),n=Math.max(rt(),Math.min(it,i.startZoom*s)),l=t.width/t.height,c=-(i.zoomAnchorU*2-1)*l*n,d=-(i.zoomAnchorV*2-1)*n,[h,p]=X(i.zoomAnchorX,i.zoomAnchorXLow,c),[x,M]=X(i.zoomAnchorY,i.zoomAnchorYLow,d);e.pendingViewRef.current={center:{x:h,y:x},centerLow:{x:p,y:M},zoom:n},(f=e.engineRef.current)==null||f.setParams({center:[h,x],centerLow:[p,M],zoom:n}),i.lastX=r.clientX,i.lastY=r.clientY},Nr=r=>{let e=null;return{onWheel:o=>{var F;o.preventDefault();const a=r.canvas.getBoundingClientRect();if(a.width<1||a.height<1)return;const s=r.pendingViewRef.current??(()=>{var E,D,z;const S=w.getState();return{center:((E=S.julia)==null?void 0:E.center)??{x:0,y:0},centerLow:((D=S.julia)==null?void 0:D.centerLow)??{x:0,y:0},zoom:((z=S.julia)==null?void 0:z.zoom)??1.5}})(),n=s.center,l=s.centerLow,c=s.zoom,d=ae(o.shiftKey,o.altKey),h=Math.pow(.9,-o.deltaY*Dr*d),p=(o.clientX-a.left)/a.width,x=1-(o.clientY-a.top)/a.height,M=a.width/a.height,f=Math.max(rt(),Math.min(it,c*h)),b=c-f,y=(p*2-1)*M*b,v=(x*2-1)*b,[A,R]=X(n.x,l.x,y),[g,T]=X(n.y,l.y,v);r.pendingViewRef.current={center:{x:A,y:g},centerLow:{x:R,y:T},zoom:f},(F=r.engineRef.current)==null||F.setParams({center:[A,g],centerLow:[R,T],zoom:f}),e!==null&&window.clearTimeout(e),e=window.setTimeout(()=>{if(e=null,!r.pendingViewRef.current)return;const S=r.pendingViewRef.current;r.pendingViewRef.current=null,w.getState().setJulia({center:S.center,centerLow:S.centerLow,zoom:S.zoom})},100)},cleanup:()=>{e!==null&&window.clearTimeout(e)}}},Ie=()=>{const r=w.getState(),e=q(r.brush,"brush",r.liveModulations??{});return{mode:fr(e.mode),colorMode:mr(e.colorMode),solidColor:[e.solidColor.x,e.solidColor.y,e.solidColor.z],gradientLut:Y.ref.current.gradientLut,size:e.size,hardness:e.hardness,strength:e.strength,flow:e.flow,spacing:e.spacing,jitter:e.jitter,particleEmitter:e.particleEmitter,particleRate:e.particleRate,particleVelocity:e.particleVelocity,particleSpread:e.particleSpread,particleGravity:e.particleGravity,particleDrag:e.particleDrag,particleLifetime:e.particleLifetime,particleSizeScale:e.particleSizeScale}},Vr=(r,e)=>{const i=e.stateRef.current;i.mode="splat",e.handleInteractionStart("param"),ji(Y.ref.current.runtime),$.ref.current.dragging=!0;const t=e.canvas.getBoundingClientRect();if(t.width<1||t.height<1||!e.engineRef.current)return;const o=(r.clientX-t.left)/t.width,a=1-(r.clientY-t.top)/t.height;$.ref.current.uv={u:o,v:a},$.ref.current.velUv=null,Ii(Y.ref.current.runtime,{u:o,v:a,dvx:0,dvy:0,params:Ie(),engine:e.engineRef.current,wallClockMs:performance.now()})},Hr=(r,e)=>{const i=e.engineRef.current;if(!i)return;const t=e.stateRef.current,o=e.canvas.getBoundingClientRect();if(o.width<1||o.height<1)return;const a=performance.now(),s=Math.max(.001,(a-t.lastT)/1e3),n=r.clientX-t.lastX,l=r.clientY-t.lastY,c=(r.clientX-o.left)/o.width,d=1-(r.clientY-o.top)/o.height,h=n/o.width/s,p=-(l/o.height)/s,x=Math.hypot(n/o.width,l/o.height);Y.ref.current.runtime.distSinceSplat+=x,$.ref.current.uv={u:c,v:d},$.ref.current.velUv={vx:h,vy:p},Li(Y.ref.current.runtime,{u:c,v:d,dvx:h,dvy:p,params:Ie(),engine:i,wallClockMs:a}),t.lastX=r.clientX,t.lastY=r.clientY,t.lastT=a},Jr=(r,e)=>{var o,a,s,n;const i=e.stateRef.current,t=w.getState();i.mode="pick-c",i.startCx=((a=(o=t.julia)==null?void 0:o.juliaC)==null?void 0:a.x)??0,i.startCy=((n=(s=t.julia)==null?void 0:s.juliaC)==null?void 0:n.y)??0,e.canvas.setPointerCapture(r.pointerId),e.handleInteractionStart("param")},Xr=(r,e)=>{var p;const i=e.stateRef.current,t=e.canvas.getBoundingClientRect();if(t.width<1||t.height<1)return;const o=w.getState(),a=((p=o.julia)==null?void 0:p.zoom)??1.5,s=t.width/t.height,n=ae(r.shiftKey,r.altKey),l=r.clientX-i.startX,c=r.clientY-i.startY,d=l/t.width*2*s*a*n,h=-(c/t.height)*2*a*n;o.setJulia({juliaC:{x:i.startCx+d,y:i.startCy+h}}),i.lastX=r.clientX,i.lastY=r.clientY},Zr=(r,e)=>{var o;const i=e.stateRef.current,t=w.getState();i.mode="resize-brush",i.startBrushSize=((o=t.brush)==null?void 0:o.size)??.15,e.canvas.setPointerCapture(r.pointerId),e.handleInteractionStart("param")},Wr=(r,e)=>{const i=e.stateRef.current,t=w.getState(),o=ae(r.shiftKey,r.altKey),a=r.clientX-i.startX,s=Math.exp(a*.0033*o),n=Math.max(.003,Math.min(.4,i.startBrushSize*s));t.setBrush({size:n}),i.lastX=r.clientX,i.lastY=r.clientY},Kr=(r,e,i,t)=>{const o=w(s=>s.handleInteractionStart),a=w(s=>s.handleInteractionEnd);C.useEffect(()=>{const s=r.current;if(!s||!i.current)return;const n={canvas:s,engineRef:e,pendingViewRef:t,stateRef:i,handleInteractionStart:o,handleInteractionEnd:a},l=p=>{const x=i.current;if(x.pointerId=p.pointerId,x.lastX=p.clientX,x.lastY=p.clientY,x.lastT=performance.now(),x.startX=p.clientX,x.startY=p.clientY,p.button===2)return Br(p,n);if(p.button===1)return Ur(p,n);if(p.button===0)return J.c?Jr(p,n):J.b?Zr(p,n):Vr(p,n)},c=p=>{switch(i.current.mode){case"idle":return;case"pick-c":return Xr(p,n);case"resize-brush":return Wr(p,n);case"pan-pending":case"pan":return Or(p,n);case"zoom":return Gr(p,n);case"splat":return Hr(p,n)}},d=p=>{const x=i.current;if(x.pointerId===p.pointerId){try{s.releasePointerCapture(p.pointerId)}catch{}x.pointerId=-1}if(t.current){const M=t.current;t.current=null,w.getState().setJulia({center:M.center,centerLow:M.centerLow,zoom:M.zoom})}x.mode="idle",$.ref.current.dragging=!1,a()},h=Nr(n);return s.addEventListener("pointerdown",l),s.addEventListener("pointermove",c),s.addEventListener("pointerup",d),s.addEventListener("pointercancel",d),s.addEventListener("pointerleave",d),s.addEventListener("wheel",h.onWheel,{passive:!1}),()=>{s.removeEventListener("pointerdown",l),s.removeEventListener("pointermove",c),s.removeEventListener("pointerup",d),s.removeEventListener("pointercancel",d),s.removeEventListener("pointerleave",d),s.removeEventListener("wheel",h.onWheel),h.cleanup()}},[r,e,i,t,o,a])},qr=({canvasRef:r,engineRef:e})=>{const i=C.useRef(Rr()),t=C.useRef(null);return zr(),_r(r,e,i),Kr(r,e,i,t),null},$r=()=>{const r=B.getViewportOverlays().filter(e=>e.type==="dom");return u.jsx("div",{className:"absolute inset-0 pointer-events-none z-[20]",children:r.map(e=>{const i=fe.get(e.componentId);return i?u.jsx(Yr,{cfg:e,Component:i},e.id):null})})},Yr=({cfg:r,Component:e})=>{const i=w(o=>o[r.id]);if(!i)return null;const t=w.getState();return u.jsx(e,{featureId:r.id,sliceState:i,actions:t})},ot={orbitLength:0,precisionBits:0,orbitBuildMs:0,laStageCount:0,laCount:0,laBuildMs:0,laStagesPerLevel:[],juliaMs:0};let ie=ot;const pe=new Set,at=r=>{ie=r,pe.forEach(e=>e(r))},Qr=r=>{Math.abs(ie.juliaMs-r)<.05||(ie={...ie,juliaMs:r},pe.forEach(e=>e(ie)))},eo=()=>{at(ot)},to=()=>{const[r,e]=C.useState(ie);return C.useEffect(()=>(pe.add(e),()=>{pe.delete(e)}),[]),r},io=()=>{const r=w(l=>{var c;return((c=l.julia)==null?void 0:c.zoom)??1}),e=w(l=>{var c,d;return((d=(c=l.julia)==null?void 0:c.center)==null?void 0:d.x)??0}),i=w(l=>{var c,d;return((d=(c=l.julia)==null?void 0:c.center)==null?void 0:d.y)??0}),t=to(),o=r>0?Math.log10(r):0,a=r>0?`1e${o.toFixed(2)} (${r.toExponential(2)})`:"invalid",s=t.laCount>0,n=t.laStagesPerLevel.length>0?t.laStagesPerLevel.join(","):"—";return u.jsxs("div",{style:{fontSize:"10.5px",lineHeight:"1.5",fontFamily:'ui-monospace, "SF Mono", Menlo, monospace',color:"#9ca3af",padding:"6px 8px",background:"rgba(255,255,255,0.03)",borderRadius:"4px",margin:"4px 0"},children:[u.jsxs("div",{children:["zoom: ",u.jsx("span",{style:{color:"#e5e7eb"},children:a})]}),u.jsxs("div",{children:["centre: ",u.jsxs("span",{style:{color:"#e5e7eb"},children:["(",e.toExponential(3),", ",i.toExponential(3),")"]})]}),t.orbitLength>0&&u.jsxs("div",{children:["orbit: ",u.jsx("span",{style:{color:"#e5e7eb"},children:t.orbitLength})," iters @ ",t.precisionBits,"b (",t.orbitBuildMs.toFixed(0),"ms)"]}),s&&u.jsxs("div",{children:["LA: ",u.jsx("span",{style:{color:"#e5e7eb"},children:t.laStageCount})," stages, ",u.jsx("span",{style:{color:"#e5e7eb"},children:t.laCount})," nodes [",n,"] (",t.laBuildMs.toFixed(0),"ms)"]}),t.juliaMs>0&&u.jsxs("div",{children:["GPU: ",u.jsxs("span",{style:{color:"#e5e7eb"},children:[t.juliaMs.toFixed(2),"ms"]})," per Julia pass (~",Math.round(1e3/Math.max(.1,t.juliaMs))," fps)"]})]})},ue=r=>new Promise(e=>{let i=0;const t=()=>{i++,i>=r?e():requestAnimationFrame(t)};requestAnimationFrame(t)}),ro=r=>{if(r.length===0)return 0;const e=[...r].sort((i,t)=>i-t);return e[Math.floor(e.length/2)]},st=[{name:"standard / shallow",center:[-.81,-.054],zoom:1.29,iter:310,deep:!1,useLA:!1,useAT:!1},{name:"deep shallow / no LA / no AT",center:[-.81,-.054],zoom:1.29,iter:1e3,deep:!0,useLA:!1,useAT:!1},{name:"deep shallow / LA",center:[-.81,-.054],zoom:1.29,iter:1e3,deep:!0,useLA:!0,useAT:!1},{name:"deep shallow / LA + AT",center:[-.81,-.054],zoom:1.29,iter:1e3,deep:!0,useLA:!0,useAT:!0},{name:"deep 1e-5 / no LA / no AT",center:[-.81,-.054],zoom:1e-5,iter:2e3,deep:!0,useLA:!1,useAT:!1},{name:"deep 1e-5 / LA",center:[-.81,-.054],zoom:1e-5,iter:2e3,deep:!0,useLA:!0,useAT:!1},{name:"deep 1e-5 / LA + AT",center:[-.81,-.054],zoom:1e-5,iter:2e3,deep:!0,useLA:!0,useAT:!0},{name:"deep 1e-10 / no LA / no AT",center:[-.81,-.054],zoom:1e-10,iter:5e3,deep:!0,useLA:!1,useAT:!1},{name:"deep 1e-10 / LA",center:[-.81,-.054],zoom:1e-10,iter:5e3,deep:!0,useLA:!0,useAT:!1},{name:"deep 1e-10 / LA + AT",center:[-.81,-.054],zoom:1e-10,iter:5e3,deep:!0,useLA:!0,useAT:!0},{name:"deep 1e-10 / 20k iter / LA+AT",center:[-.81,-.054],zoom:1e-10,iter:2e4,deep:!0,useLA:!0,useAT:!0}],oo=async(r,e,i,t=3e3)=>{if(!i){await ue(20);return}const o=performance.now();for(;performance.now()-o<t;){if(r.getJuliaMs()>0){await ue(15);return}await ue(5)}},ao=async(r,e,i)=>{const t=r.getState();t.setJulia({center:{x:i.center[0],y:i.center[1]},zoom:i.zoom}),t.setDeepZoom({enabled:i.deep,useLA:i.useLA,useAT:i.useAT,deepMaxIter:i.iter}),await oo(e,i.iter,i.deep)},so=async(r,e,i=st,t)=>{const o=[],a=r,s=e.getState();s.accumulation,a.setForceFluidPaused(!0),a.setParams({tsaaSampleCap:1,tsaaPerFrameSamples:1}),s.setAccumulation&&s.setAccumulation(!1);try{for(let n=0;n<i.length;n++){const l=i[n];t==null||t(n,i.length,l),await ao(e,r,l);const c=[];for(let p=0;p<30;p++){await ue(1);const x=r.getJuliaMs();x>0&&c.push(x)}const d=ro(c),h=c.length>0?Math.min(...c):0;o.push({...l,juliaMs:d,juliaMsMin:h,samples:c,timerOk:c.length>0,orbitLength:0,laStageCount:0,laCount:0,atEngaged:!1})}}finally{a.setForceFluidPaused(!1),a.setParams({tsaaSampleCap:64,tsaaPerFrameSamples:1}),s.setAccumulation&&s.setAccumulation(!0)}return o},no=r=>{const e="| Case | Iter | Deep | LA | AT | Julia ms | min ms |",i="|------|------|------|----|----|---------|--------|",t=r.map(o=>{const a=o.timerOk?o.juliaMs.toFixed(2):"—",s=o.timerOk?o.juliaMsMin.toFixed(2):"—";return`| ${o.name} | ${o.iter} | ${o.deep?"✓":""} | ${o.useLA?"✓":""} | ${o.useAT?"✓":""} | ${a} | ${s} |`});return[e,i,...t].join(`
`)},lo=r=>{const e=[],i=o=>`${o.zoom}|${o.iter}|${o.deep}`,t=new Map;for(const o of r){const a=i(o);t.has(a)||t.set(a,[]),t.get(a).push(o)}for(const[o,a]of t){const s=a.find(c=>!c.useLA&&!c.useAT),n=a.find(c=>c.useLA&&!c.useAT),l=a.find(c=>c.useLA&&c.useAT);if(!(!s||s.juliaMs===0)){if(n&&n.juliaMs>0){const c=s.juliaMs/n.juliaMs;e.push(`${o}: LA speedup = ${c.toFixed(2)}×`)}if(l&&l.juliaMs>0){const c=s.juliaMs/l.juliaMs;e.push(`${o}: LA+AT speedup = ${c.toFixed(2)}×`)}}}return e},H={padding:"2px 6px",borderBottom:"1px solid rgba(255,255,255,0.08)",whiteSpace:"nowrap"},K={...H,fontWeight:600,color:"#cbd5e1",borderBottom:"1px solid rgba(255,255,255,0.2)"},co=({engineRef:r})=>{const[e,i]=C.useState(!1),[t,o]=C.useState({i:0,total:0,name:""}),[a,s]=C.useState(null),n=async()=>{const l=r.current;if(!(!l||e)){i(!0),s(null);try{const c=await so(l,w,st,(p,x,M)=>{o({i:p,total:x,name:M.name})});s(c);const d=no(c),h=lo(c);console.log(`[deepZoom bench]
`+d),h.length>0&&console.log(`[deepZoom bench]
`+h.join(`
`))}finally{i(!1)}}};return u.jsxs("div",{style:{fontSize:"10.5px",lineHeight:"1.5",fontFamily:'ui-monospace, "SF Mono", Menlo, monospace',color:"#9ca3af",padding:"6px 8px",background:"rgba(255,255,255,0.03)",borderRadius:"4px",margin:"4px 0",pointerEvents:"auto",maxWidth:480},children:[u.jsx("button",{onClick:()=>{n()},disabled:e||r.current===null,style:{fontFamily:"inherit",fontSize:"inherit",padding:"4px 10px",background:e?"#444":"#1f6feb",color:"white",border:"none",borderRadius:3,cursor:e?"wait":"pointer"},children:e?`Running ${t.i+1}/${t.total}: ${t.name}`:"Run perf benchmark"}),a&&u.jsxs("div",{style:{marginTop:8,overflow:"auto",maxHeight:320},children:[u.jsxs("table",{style:{borderCollapse:"collapse",fontSize:"10.5px"},children:[u.jsx("thead",{children:u.jsxs("tr",{children:[u.jsx("th",{style:K,children:"Case"}),u.jsx("th",{style:K,children:"Iter"}),u.jsx("th",{style:K,children:"D"}),u.jsx("th",{style:K,children:"LA"}),u.jsx("th",{style:K,children:"AT"}),u.jsx("th",{style:K,children:"ms (med)"}),u.jsx("th",{style:K,children:"min"})]})}),u.jsx("tbody",{children:a.map((l,c)=>u.jsxs("tr",{children:[u.jsx("td",{style:H,children:l.name}),u.jsx("td",{style:H,children:l.iter}),u.jsx("td",{style:H,children:l.deep?"✓":""}),u.jsx("td",{style:H,children:l.useLA?"✓":""}),u.jsx("td",{style:H,children:l.useAT?"✓":""}),u.jsx("td",{style:{...H,color:"#e5e7eb",textAlign:"right"},children:l.timerOk?l.juliaMs.toFixed(2):"—"}),u.jsx("td",{style:{...H,textAlign:"right"},children:l.timerOk?l.juliaMsMin.toFixed(2):"—"})]},c))})]}),u.jsx("div",{style:{marginTop:4,color:"#94a3b8"},children:a.some(l=>!l.timerOk)?"(— = GPU timer unavailable on this device)":"Open devtools console for markdown + speedup ratios."})]})]})},uo=`
...
out vec4 fragColor;
uniform sampler2D uSource;
void main() { fragColor = texture(uSource, vUv); }`,ko=`#version 300 es
precision highp float;
in vec2 vUv;
layout(location=0) out vec4 outMain;
layout(location=1) out vec4 outFx;
