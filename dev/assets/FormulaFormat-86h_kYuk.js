var be=Object.defineProperty;var ve=(e,t,a)=>t in e?be(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var V=(e,t,a)=>ve(e,typeof t!="symbol"?t+"":t,a);import{H as A,b4 as I,U as y,$ as m,f,b5 as xe,b6 as ze,b7 as Se,b8 as _e,b9 as we,ba as Fe}from"./CollapsibleSection-vbdwAc1S.js";import{n as _,d as B,p as Me,q as Ie,r as $,s as Z,c as g,l as N}from"./three-DQWx7qFd.js";const X=`
...
#endif
            `)),a==="Main"||a==="Histogram"?e.addFunction(Ve()):e.addFunction(`
                float getMappingValue(float mode, vec3 p, vec4 result, vec3 n, float repeatScale) { return 0.0; }
            `)}},Ge={id:"standard",label:"Standard (Tglad)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = clamp(z, -foldLimit, foldLimit) * 2.0 - z;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2}},He={id:"mirror",label:"Mirror",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = foldLimit - abs(abs(z) - foldLimit);
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},je={id:"half",label:"Half-fold",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = abs(z + foldLimit);
}
...
`,extraParams:{hybridFoldingValue:{type:"vec3",default:new g(2,2,2),label:"Folding Value",shortId:"hfv",uniform:"uHybridFoldingValue",min:.1,max:5,step:.01,group:"hybrid"}},defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:2,hybridFoldingValue:{x:2,y:2,z:2}}},$e={id:"kali",label:"Kali",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    z = uHybridKaliConstant - abs(z);
}
`,rotMode:"post",extraParams:{hybridKaliConstant:{type:"vec3",default:new g(1,1,1),label:"Kali Constant",shortId:"hkc",uniform:"uHybridKaliConstant",min:-3,max:3,step:.01,group:"hybrid"}},defaults:{hybridScale:1.5,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.6,hybridFixedR:1,hybridIter:3,hybridKaliConstant:{x:.5,y:.5,z:.5}}},Ze={id:"tetra",label:"Tetrahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
    if (z.x + z.y < 0.0) z.xy = -z.yx;
    if (z.x + z.z < 0.0) z.xz = -z.zx;
    if (z.y + z.z < 0.0) z.yz = -z.zy;
}
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.25,hybridFixedR:1,hybridIter:3}},Xe={id:"octa",label:"Octahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3}},Ue={id:"icosa",label:"Icosahedral (KIFS)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,defaults:{hybridScale:2,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.3,hybridFixedR:1,hybridIter:4}},Ye={id:"menger",label:"Menger (Cubic)",glsl:`
void foldOperation(inout vec3 z, inout float dr, vec3 foldLimit) {
...
`,selfContained:!0,extraParams:{hybridMengerOffset:{type:"vec3",default:new g(1,1,1),label:"Offset",shortId:"hmo",uniform:"uHybridMengerOffset",min:0,max:2,step:.01,group:"hybrid",linkable:!0},hybridMengerCenterZ:{type:"boolean",default:!0,label:"Center Z",shortId:"hmz",uniform:"uHybridMengerCenterZ",group:"hybrid"}},defaults:{hybridScale:3,hybridFoldLimitVec:{x:1,y:1,z:1},hybridMinR:.5,hybridFixedR:1,hybridIter:3,hybridMengerOffset:{x:1,y:1,z:1},hybridMengerCenterZ:!0}},k=[Ge,He,je,qe,$e,Ze,Xe,Ue,Ye],We=k.map((e,t)=>({label:e.label,value:t}));function Qe(e){return k[e]??k[0]}const Ke=`
...
`,l+=`
                ...
                `}e.addHybridFold("",n,l)}},Y=["uParamA","uParamB","uParamC","uParamD","uParamE","uParamF"],W=["uVec2A","uVec2B","uVec2C"],Q=["uVec3A","uVec3B","uVec3C"],K=["uVec4A","uVec4B","uVec4C"],ae=["uInterlaceParamA","uInterlaceParamB","uInterlaceParamC","uInterlaceParamD","uInterlaceParamE","uInterlaceParamF"],oe=["uInterlaceVec2A","uInterlaceVec2B","uInterlaceVec2C"],ie=["uInterlaceVec3A","uInterlaceVec3B","uInterlaceVec3C"],re=["uInterlaceVec4A","uInterlaceVec4B","uInterlaceVec4C"];function rt(){const e=[];for(let t=0;t<Y.length;t++)e.push([new RegExp(`\\b${Y[t]}\\b`,"g"),ae[t]]);for(let t=0;t<W.length;t++)e.push([new RegExp(`\\b${W[t]}\\b`,"g"),oe[t]]);for(let t=0;t<Q.length;t++)e.push([new RegExp(`\\b${Q[t]}\\b`,"g"),ie[t]]);for(let t=0;t<K.length;t++)e.push([new RegExp(`\\b${K[t]}\\b`,"g"),re[t]]);return e}const nt=rt();function H(e){let t=e;for(const[a,o]of nt)t=t.replace(a,o);return t}function O(e,t){const a=[...t].sort((i,r)=>r.length-i.length);let o=e;for(const i of a)o=o.replace(new RegExp(`\\b${i}\\b`,"g"),`interlace_${i}`);return o}function L(e){const t=[],a=/\b(?:void|vec[234]|float|int|mat[234]|bool)\s+(\w+)\s*\(/g,o=/^\s*(?:const\s+)?(?:vec[234]|float|int|mat[234]|bool)\s+([^;]+);/,i=/^\s*(\w+)/;let r=0;for(const n of e.split(`
`)){if(r===0){a.lastIndex=0;let l;for(;(l=a.exec(n))!==null;){const d=l[1];!d.startsWith("formula_")&&!t.includes(d)&&t.push(d)}const p=o.exec(n);if(p){const d=[];let s=0,b="";for(const h of p[1]){if(h==="(")s++;else if(h===")")s--;else if(h===","&&s===0){d.push(b),b="";continue}b+=h}b&&d.push(b);for(const h of d){const c=i.exec(h);c&&!t.includes(c[1])&&t.push(c[1])}}}for(const l of n)l==="{"?r++:l==="}"&&r--}return t}function lt(e,t,a){let o=e;o=o.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`);const i=L(e);for(const r of i)o=o.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return a&&a.length>0&&(o=O(o,a)),o=H(o),o}function st(e,t,a,o){let i=e;if(i=i.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace"),i=H(i),a&&a.length>0&&(i=O(i,a)),o&&o.length>0)for(const r of o)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function dt(e,t,a){let o=e.replace(new RegExp(`\\bformula_${t}\\b`,"g"),"formula_Interlace");return a&&a.length>0&&(o=O(o,a)),o}function ct(e,t,a,o){let i=e;if(i=i.replace(new RegExp(`\\b${t}_\\w+\\b`,"g"),r=>`interlace_${r}`),i=H(i),a&&a.length>0&&(i=O(i,a)),o&&o.length>0)for(const r of o)i=i.replace(new RegExp(`\\b${r}\\b`,"g"),`interlace_${r}`);return i}function pt(e,t,a){let o="";t&&(o=`
...
`});u.register({id:"Custom",label:"Custom (Legacy)",category:"Utils",description:"Legacy node.",inputs:[],glsl:e=>""});const bt=e=>{const t=new Map;return e.forEach(a=>{t.has(a.target)||t.set(a.target,[]),t.get(a.target).push(a)}),t},vt=e=>{const t=new Set,a=["root-end"],o=new Set;for(;a.length>0;){const i=a.pop();o.has(i)||(o.add(i),i!=="root-end"&&i!=="root-start"&&t.add(i),(e.get(i)??[]).forEach(r=>a.push(r.source)))}return t},xt=(e,t)=>{const a=bt(t),o=vt(a),i=e.filter(s=>o.has(s.id));if(!i||i.length===0)return`
    ...
    `;const n=new Map;n.set("root-start","v_start");let l=0;i.forEach((s,b)=>{const c=`v_${s.id.replace(/[^a-zA-Z0-9]/g,"")}`;n.set(s.id,c);const v=a.get(s.id)??[],M=v.find(F=>!F.targetHandle||F.targetHandle==="a"),E=v.find(F=>F.targetHandle==="b"),T=M&&n.get(M.source)||"v_start",he=E&&n.get(E.source)||"v_start";if(r+=`    // Node: ${s.type} (${s.id})
`,r+=`    vec3 ${c}_p = ${T}_p;
`,r+=`    float ${c}_d = ${T}_d;
`,r+=`    float ${c}_dr = ${T}_dr;
`,s.enabled){const F=u.get(s.type);if(F){const j=s.condition&&s.condition.active;let q="    ";if(j){const D=l<I?`uModularParams[${l++}]`:"2.0",ye=l<I?`uModularParams[${l++}]`:"0.0";r+=`    { int ${c}_cmod = max(1, int(${D})); int ${c}_crem = int(${ye});
`,r+=`    if ( (i - (i/${c}_cmod)*${c}_cmod) == ${c}_crem ) {
`,q="        "}const ge=D=>s.bindings&&s.bindings[D]?`u${s.bindings[D]}`:l<I?`uModularParams[${l++}]`:"0.0";r+=F.glsl({varName:c,in1:T,in2:he,getParam:ge,indent:q}),j&&(r+=`    }}
`)}}r+=`
...
`,n=i.shader.loopBody,l=i.shader.loopInit||"",i.shader.preamble&&e.addPreamble(i.shader.preamble),s&&(e.addPreamble(St),l=_t+l),i.shader.getDist&&b<4.5&&(h=`vec2 getDist(float r, float dr, float iter, vec4 z) { ${i.shader.getDist} }`));e.addFunction(r),e.setFormula(n,l,h)}};let Ft=0;function C(){return`l${++Ft}`}const Mt={id:"shadows",label:"Shadows",renderContext:"direct",controlledParams:["lighting.shadowsCompile","lighting.shadowAlgorithm","lighting.ptStochasticShadows"],tiers:[{label:"Off",overrides:{lighting:{shadows:!1,shadowsCompile:!1,ptStochasticShadows:!1}},estCompileMs:0},{label:"Hard",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:2,ptStochasticShadows:!1}},estCompileMs:500},{label:"Soft",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!1}},estCompileMs:3e3},{label:"Full",overrides:{lighting:{shadows:!0,shadowsCompile:!0,shadowAlgorithm:0,ptStochasticShadows:!0}},estCompileMs:3800}]},It={id:"reflections",label:"Reflections (Direct)",renderContext:"direct",controlledParams:["reflections.reflectionMode","reflections.bounceShadows","reflections.bounces"],tiers:[{label:"Off",overrides:{reflections:{reflectionMode:0,bounceShadows:!1}},estCompileMs:0},{label:"Env Map",overrides:{reflections:{reflectionMode:1,bounceShadows:!1}},estCompileMs:0},{label:"Raymarched",overrides:{reflections:{reflectionMode:3,bounceShadows:!1,bounces:1}},estCompileMs:7500},{label:"Full",overrides:{reflections:{reflectionMode:3,bounceShadows:!0,bounces:2}},estCompileMs:12e3}]},Ct={id:"lighting_quality",label:"Lighting",isAdvanced:!0,controlledParams:["lighting.specularModel","lighting.ptEnabled","lighting.ptNEEAllLights","lighting.ptEnvNEE"],tiers:[{label:"Preview",overrides:{lighting:{advancedLighting:!1,ptEnabled:!1}},estCompileMs:-2500},{label:"Path Traced",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!1,ptEnvNEE:!1}},estCompileMs:1900},{label:"PT + NEE",overrides:{lighting:{specularModel:1,ptEnabled:!0,advancedLighting:!0,ptNEEAllLights:!0,ptEnvNEE:!0}},estCompileMs:2500}]},Pt={id:"atmosphere_quality",label:"Atmosphere",controlledParams:["atmosphere.glowEnabled","atmosphere.glowQuality","volumetric.ptVolumetric"],tiers:[{label:"Off",overrides:{atmosphere:{glowEnabled:!1},volumetric:{ptVolumetric:!1}},estCompileMs:0},{label:"Fast Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:1},volumetric:{ptVolumetric:!1}},estCompileMs:200},{label:"Color Glow",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!1}},estCompileMs:400},{label:"Volumetric",overrides:{atmosphere:{glowEnabled:!0,glowQuality:0},volumetric:{ptVolumetric:!0}},estCompileMs:5900}]},se=[Mt,It,Ct,Pt],de=[{id:"preview",label:"Preview",description:"Instant preview shader — navigate without waiting for compile.",subsystems:{shadows:0,reflections:0,lighting_quality:0,atmosphere_quality:0}},{id:"fastest",label:"Fastest",description:"Path traced lighting with fast glow.",subsystems:{shadows:0,reflections:0,lighting_quality:1,atmosphere_quality:1}},{id:"lite",label:"Lite",description:"Hard shadows, env map reflections, color glow.",subsystems:{shadows:1,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"balanced",label:"Balanced",description:"Soft shadows, env map reflections, color glow.",subsystems:{shadows:2,reflections:1,lighting_quality:1,atmosphere_quality:2}},{id:"full",label:"Full",description:"Full shadows, raymarched reflections, volumetric.",subsystems:{shadows:3,reflections:3,lighting_quality:1,atmosphere_quality:3}},{id:"ultra",label:"Ultra",description:"Full + PT NEE. Experimental.",isAdvanced:!0,subsystems:{shadows:3,reflections:3,lighting_quality:2,atmosphere_quality:3}}];({...de[3].subsystems});function Et(e){return de.find(t=>t.id===e)}function so(e){if(!e.activePreset)return"Custom";const t=Et(e.activePreset);if(!t)return"Custom";if(!e.isCustomized)return t.label;const a=[];for(const o of se){const i=t.subsystems[o.id],r=e.subsystems[o.id];if(i!==r){const n=o.tiers[r];a.push(`${o.label}=${(n==null?void 0:n.label)??"?"}`)}}return`${t.label} (${a.join(", ")})`}const Tt=4200;function co(e){let t=Tt;for(const a of se){const o=e[a.id]??0,i=a.tiers[o];i&&(t+=i.estCompileMs)}return t}const Dt=(e,t)=>{if(!e)return`
...
This rotation is bound to 'ParamC' (Slider below). Try dragging it!`},{id:"rot-1",type:"Rotate",enabled:!0,params:{x:0,y:0,z:0},bindings:{z:"ParamC"}},{id:"bulb-1",type:"Mandelbulb",enabled:!0,params:{power:8}},{id:"add-c",type:"AddConstant",enabled:!0,params:{scale:1}}],Ea={id:"Modular",name:"Modular Builder",shortDescription:"Construct custom fractal equations using a Node Graph.",description:"Construct your own fractal equation by chaining operations together. Combine folds, rotations, and logic via the Graph tab.",juliaType:"julia",shader:{function:"",loopBody:"",getDist:""},parameters:[null,null,null,null],defaultPreset:{formula:"Modular",features:{coreMath:{iterations:16,paramA:8,paramB:0,paramC:0,paramD:0,paramE:0,paramF:0},lighting:{shadows:!0,shadowSoftness:16,shadowIntensity:1,shadowBias:.002}},pipeline:Pa,cameraPos:{x:0,y:0,z:4},cameraRot:{x:0,y:0,z:0,w:1},sceneOffset:{x:0,y:0,z:0,xL:0,yL:0,zL:0}}},Ta={id:"MandelTerrain",name:"MandelTerrain",shortDescription:'3D Heightmap of the Mandelbrot set. Creates alien landscapes and "Math Mountains".',description:"A 3D Heightmap of the Mandelbrot set. Iterations slider controls terrain detail.",juliaType:"julia",shader:{function:`
...
`)},ao=(e,t)=>{var l;const{shader:a,...o}=e,i={};(l=a.preambleVars)!=null&&l.length&&(i.preambleVars=a.preambleVars),a.usesSharedRotation&&(i.usesSharedRotation=!0),a.supportsCuttingPlane&&(i.supportsCuttingPlane=!0);const r={...o,...Object.keys(i).length>0?{shaderMeta:i}:{},defaultPreset:t};let n=`<!--
...
`),n},oo=e=>{const t=s=>{const b=new RegExp(`<${s}>([\\s\\S]*?)<\\/${s}>`),h=e.match(b);return h?h[1].trim():null},a=t("Metadata");if(!a){try{const s=JSON.parse(e);if(s.id&&s.shader)return s}catch{}throw new Error("Invalid GMF: Missing Metadata tag")}const o=JSON.parse(a),i=t("Shader_Preamble"),r=t("Shader_Function"),n=t("Shader_Loop"),l=t("Shader_Init"),p=t("Shader_Dist");if((!r||!n)&&o.id!=="Modular")throw new Error("Invalid GMF: Missing essential shader blocks (<Shader_Function> or <Shader_Loop>)");const d={function:r??"",loopBody:n??"",preamble:i||void 0,loopInit:l||void 0,getDist:p||void 0};if(o.shaderMeta&&(o.shaderMeta.preambleVars&&(d.preambleVars=o.shaderMeta.preambleVars),o.shaderMeta.usesSharedRotation&&(d.usesSharedRotation=!0),o.shaderMeta.supportsCuttingPlane&&(d.supportsCuttingPlane=!0),delete o.shaderMeta),!d.supportsCuttingPlane){const s=`${d.function} ${d.loopBody} ${d.preamble||""} ${d.loopInit||""}`;/\bcp_(dmin|scale|trap)\b/.test(s)&&(d.supportsCuttingPlane=!0)}return{...o,shader:d}},io=e=>{const t=e.trimStart();return t.startsWith("<!--")||t.startsWith("<Metadata>")},mo=e=>{const t=x.get(e.formula);if(!t)return JSON.stringify(e,null,2);let a=ao(t,t.defaultPreset);return a+=`<!-- Full scene state (camera, lights, features, quality, animations) -->
`,a+=`<Scene>
${me(e)}
</Scene>
`,a},ho=e=>{if(io(e)){const a=oo(e),o=e.match(/<Scene>([\s\S]*?)<\/Scene>/);if(o){const r=JSON.parse(o[1].trim());return{def:a,preset:r}}const i=a.defaultPreset||{formula:a.id};return i.formula||(i.formula=a.id),{def:a,preset:i}}return{preset:JSON.parse(e)}};export{se as A,R as I,Pa as J,de as S,fo as a,u as b,co as c,so as d,uo as e,Ke as f,ao as g,lt as h,st as i,ct as j,dt as k,ho as l,pt as m,po as n,da as o,x as r,mo as s};
