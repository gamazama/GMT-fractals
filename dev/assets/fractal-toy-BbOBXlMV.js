var M=Object.defineProperty;var _=(t,e,a)=>e in t?M(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var f=(t,e,a)=>_(t,typeof e!="symbol"?e+"":e,a);import{f as h,j,F as p,k as g,u as m,S as D,c as $,i as k}from"./toastStore-D9E9kUoO.js";import{r as v,j as l,R as B}from"./three-fiber-GKfjny8F.js";import{j as O,k as N,m as S,l as w,v as R,n as V,E as G,D as H,a as X,P as q,T as Y,b as W,c as Q,G as Z,d as K,r as J,o as ee,i as te,h as ae,e as ie,g as oe,f as re}from"./PwaUpdate-f_Tf7Kwy.js";import{V as ne,i as se,c as le}from"./Camera-B2iVSZzA.js";import{c as ce}from"./three-drei-BQSiXBFe.js";import{C as fe}from"./CompilingIndicator-CzbISuqj.js";import{r as me}from"./cameraKeyRegistry-BNqqX1En.js";import"./three-DQWx7qFd.js";import"./pako-DwGzBETv.js";import"./CompositionOverlay-0MvLf-Sv.js";const u=new Map,A=t=>{if(u.has(t.id))throw new Error(`[formulaRegistry] duplicate formula id: ${t.id}`);u.set(t.id,t);const e=t.id.toLowerCase(),a={id:e,name:t.name,category:"Fractal",tabConfig:{label:t.name},params:t.params};h.register(a),O(t.name)||N({id:t.name,dock:"right",order:0,active:!0,features:[e]})},d={get:t=>u.get(t),getAll:()=>Array.from(u.values()),has:t=>u.has(t),resolve:t=>t&&u.has(t)?u.get(t):u.values().next().value},ue=`
