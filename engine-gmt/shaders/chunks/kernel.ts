 ...
 *
 * (The `mb3dFaithful` gate was RETIRED by ADR-0092 — the MB3D-faithful step is no
 * longer a gated feature, it is THE marcher, emitted unconditionally in trace.ts.)
 */
