...
import { mappingForScale, mappingForVirtual, LIGHT_RADIUS_SCALE } from '../../../../engine/features/modulation/paramMapping';
...
const RADIUS_MAPPING = mappingForScale(
    LIGHT_RADIUS_SCALE.scale, LIGHT_RADIUS_SCALE.min, LIGHT_RADIUS_SCALE.max,
...
export const LightSettingsContent = ({ index, onClose, detached = false, onHandlePointerDown }: { index: number; onClose?: () => void; detached?: boolean; onHandlePointerDown?: (e: React.PointerEvent) => void }) => {
    ...
    const handleMenuClick = (e: React.MouseEvent) => {
        ...
        if (!r) return;
        const allLights = useEngineStore.getState().lighting?.lights ?? [];
        const items = [
