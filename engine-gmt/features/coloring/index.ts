...
export const ColoringFeature: FeatureDefinition = {
    ...
    params: {
        ...
        repeats: { type: 'float', default: 1.0, label: 'Repeats', shortId: 'r1', min: 0.1, max: 100, step: 0.1, scale: 'log', group: 'layer1_hist', hidden: true },
        ...
        repeats2: { type: 'float', default: 1.0, label: 'Repeats', shortId: 'r2', min: 0.1, max: 100, step: 0.1, scale: 'log', group: 'layer2_hist', hidden: true },
