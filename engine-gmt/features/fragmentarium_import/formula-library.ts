 ...
 *
 * @invariant The `v3-v4-catalog.json` file is generated by `npm run catalog:build`
 * from honest harness snapshots (`debug/v3-honest-snapshot.jsonl`,
 * `debug/v4-honest-snapshot.jsonl`). After changing either pipeline or adding
 * library formulas, regenerate the catalog or auto-pick will be stale. See
 * ADR-0058.
 */
