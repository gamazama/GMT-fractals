...
import { UploadIcon, NetworkIcon, ChevronDown, CheckIcon, CubeIcon, LoadIcon, CodeIcon } from '../../../../components/Icons';
    ...
    const categories = useMemo(() => {
        ...
        for (const pref of PREDEFINED_CATEGORIES) {
            const items = pref.match.filter(id => {
                if (availableIds.has(id as any)) {
                    availableIds.delete(id as any);
                    return true;
                }
                return false;
            });
