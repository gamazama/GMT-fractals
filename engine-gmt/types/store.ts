...
export type FractalState = EngineStoreState;
// Alias kept so verbatim-ported GMT code (HudOverlay, etc.) compiles
// unchanged. EngineActions is declared below.
...
// Alias kept so verbatim-ported GMT code compiles without edits.
export type FractalActions = EngineActions;
